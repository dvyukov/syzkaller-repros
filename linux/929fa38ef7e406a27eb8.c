...
// https://syzkaller.appspot.com/bug?id=929fa38ef7e406a27eb8
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    *(uint32_t*)0x20000154 = 9;
    *(uint64_t*)0x20000158 = 0;
    *(uint64_t*)0x20000160 = 0;
    *(uint64_t*)0x20000168 = 0;
    *(uint32_t*)0x20000170 = 0;
    *(uint32_t*)0x20000174 = 0;
    syscall(__NR_sched_setattr, 0, 0x20000140ul, 0ul);
    break;
  case 2:
    ...
    *(uint64_t*)0x200000f8 = 0;
    syscall(__NR_perf_event_open, 0x20000080ul, 0, -1ul, -1, 0ul);
    break;
  case 3:
