...
// https://syzkaller.appspot.com/bug?id=9d59123ecf0619973399
// status:0
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x200002d0 = 0x13;
  *(uint8_t*)0x200002d1 = 0;
  *(uint16_t*)0x200002d2 = 0;
  *(uint16_t*)0x200002d4 = 8;
  *(uint16_t*)0x200002d6 = 3;
  *(uint32_t*)0x200002d8 = r[2];
  *(uint16_t*)0x200002dc = 6;
  *(uint16_t*)0x200002de = 0x13;
  STORE_BY_BITMASK(uint8_t, , 0x200002e0, 0x18, 0, 7);
  STORE_BY_BITMASK(uint8_t, , 0x200002e0, 0, 7, 1);
  STORE_BY_BITMASK(uint8_t, , 0x200002e1, 0x1b, 0, 7);
  STORE_BY_BITMASK(uint8_t, , 0x200002e1, 1, 7, 1);
  *(uint16_t*)0x200002e4 = 6;
  *(uint16_t*)0x200002e6 = 0x12;
  *(uint16_t*)0x200002e8 = 0;
  *(uint16_t*)0x200002ec = 0xa;
  *(uint16_t*)0x200002ee = 6;
  *(uint8_t*)0x200002f0 = 8;
  *(uint8_t*)0x200002f1 = 2;
  *(uint8_t*)0x200002f2 = 0x11;
  *(uint8_t*)0x200002f3 = 0;
  *(uint8_t*)0x200002f4 = 0;
  *(uint8_t*)0x200002f5 = 1;
  *(uint16_t*)0x200002f8 = 6;
  *(uint16_t*)0x200002fa = 0x10;
  *(uint16_t*)0x200002fc = 0x374;
  ...
  *(uint32_t*)0x20000370 = 0;
  syscall(__NR_sendmsg, r[4], 0x20000340ul, 0ul);
}
int main(void)
{
