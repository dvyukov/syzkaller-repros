...
// https://syzkaller.appspot.com/bug?id=e1177a291a90109731d7297a903d14a14c6ca610
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_fcntl, r[0], 0x406, r[0]);
    break;
  case 2:
    syscall(__NR_close, r[0]);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000200, "net/igmp", 9));
  ...
  case 6:
    ...
    break;
  case 7:
    NONFAILING(memcpy((void*)0x20000080, "io", 3));
    res = syz_open_procfs(0, 0x20000080);
    if (res != -1)
      r[2] = res;
    break;
  case 8:
    syscall(__NR_pread64, r[2], 0x200000c0, 0x592, 0);
    break;
  }
}
int main(void)
