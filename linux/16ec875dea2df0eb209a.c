...
// https://syzkaller.appspot.com/bug?id=16ec875dea2df0eb209a
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000040, "/dev/rfkill\000", 12));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000040ul, 0x40501ul,
                  0ul);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
    ...
    NONFAILING(memcpy((void*)0x20000080, "\x02\x00\x00\x00\x02\x03\x19", 7));
    NONFAILING(*(uint64_t*)0x20000008 = 7);
    syscall(__NR_writev, r[0], 0x20000000ul, 1ul);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000040, "./bus\000", 6));
    syscall(__NR_unlink, 0x20000040ul);
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000040, "/dev/rfkill\000", 12));
    syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000040ul, 0x40501ul, 0ul);
    break;
  case 5:
