...
// https://syzkaller.appspot.com/bug?id=b938c323ea7bdeab5ef183049d52187a4695677f
// status:fixed
...
void execute_call(int call)
{
  ...
  case 5:
    ...
    syscall(__NR_unlink, 0x200000c0);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000100, "./file0/file1", 14));
    syscall(__NR_mkdir, 0x20000100, 0x101);
    break;
  case 7:
    NONFAILING(memcpy((void*)0x20000180, "./file0/file1/file0", 20));
