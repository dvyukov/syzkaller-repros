// BUG: Dentry still in use [unmount of incremental-fs incremental-fs]
// https://syzkaller.appspot.com/bug?id=3ec337052432c73f8713
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    NONFAILING(memcpy((void*)0x20000140, "incremental-fs\000", 15));
    syscall(__NR_mount, 0x20000000ul, 0x20000080ul, 0x20000140ul, 0x2000c1ul,
            0ul);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000500, "./file0\000", 8));
    syscall(__NR_chdir, 0x20000500ul);
    break;
  }
}
int main(void)
