...
// https://syzkaller.appspot.com/bug?id=023cf961ae91847486ed6fe26c930da4023db3dd
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    syscall(__NR_bind, r[0], 0x20000280, 0x10);
    break;
  case 2:
    ...
    syscall(__NR_sendto, r[0], 0, 0xffffffffffffff72, 0x200007fd, 0x20e68000,
            0x10);
    break;
  case 3:
  ...
  case 4:
    NONFAILING(memcpy(
        ...
        77));
    syscall(__NR_sendto, r[0], 0x200012c0, 0xfffffffffffffec4, 0x11, 0, 0xffc8);
    break;
  case 5:
    NONFAILING(*(uint32_t*)0x20000040 = 0);
    syscall(__NR_setsockopt, r[1], 1, 0x20, 0x20000040, 4);
    break;
  }
}
int main(void)
