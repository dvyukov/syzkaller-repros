...
void execute_one(void)
{
  ...
  *(uint8_t*)0x2000006c = 0;
  ...
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x20001bc0 = 0x34;
  *(uint64_t*)0x20001bc4 = 0;
  *(uint64_t*)0x20001bcc = 0;
  *(uint64_t*)0x20001bd4 = 0;
  *(uint64_t*)0x20001bdc = 0;
  *(uint64_t*)0x20001be4 = 0;
  *(uint64_t*)0x20001bec = 0;
  *(uint32_t*)0x20001ec0 = 0x54;
  *(uint64_t*)0x20001ec4 = 0x20001c00;
  *(uint8_t*)0x20001c00 = 0x60;
  *(uint8_t*)0x20001c01 = 0;
  *(uint32_t*)0x20001c02 = 0x62;
  memcpy((void*)0x20001c06,
         "\x2e\xd7\xdf\x2f\x25\xd5\xec\x47\x41\x92\x49\x7b\x1f\x25\x32\x6f\x21"
         "\x8c\xeb\xf2\x39\x04\xd9\x4b\xa6\x2c\xd6\x4c\xe8\x40\xf5\x0e\x11\x96"
         "\x6a\xdf\x94\x50\xc4\x1e\x12\x90\x51\x5d\xc8\x12\xc6\x35\xb1\x69\xa1"
         "\xb5\x53\xc6\x9d\xac\x87\x9d\xd8\x97\x5e\x18\xe5\x3f\x78\xd7\xfc\x90"
         "\xda\x6a\x1b\x0f\xc3\x7d\xd2\xfa\x6d\xdc\x1a\x8d\xfe\xa3\x9c\xd4\x5c"
         "\x97\x80\x69\xc7\x9f\x0f\x70\x5c\x61\x9a\xb5\x20\x14",
         98);
  *(uint64_t*)0x20001ecc = 0;
  *(uint64_t*)0x20001ed4 = 0;
  *(uint64_t*)0x20001edc = 0;
  *(uint64_t*)0x20001ee4 = 0;
  *(uint64_t*)0x20001eec = 0;
  *(uint64_t*)0x20001ef4 = 0;
  *(uint64_t*)0x20001efc = 0;
  *(uint64_t*)0x20001f04 = 0;
  *(uint64_t*)0x20001f0c = 0;
  syz_usb_control_io(r[0], 0x20001bc0, 0x20001ec0);
}
int main(void)
{
