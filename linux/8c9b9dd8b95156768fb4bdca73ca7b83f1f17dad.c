// BUG: using __this_cpu_read() in preemptible [ADDR] code: syzkaller7NUM/3326
// https://syzkaller.appspot.com/bug?id=8c9b9dd8b95156768fb4bdca73ca7b83f1f17dad
// status:invalid
...
void test()
{
  ...
  *(uint64_t*)0x2083d000 = (uint64_t)0x0;
  *(uint32_t*)0x2083d008 = (uint32_t)0x0;
  *(uint64_t*)0x2083d010 = (uint64_t)0x208feff0;
  *(uint64_t*)0x2083d018 = (uint64_t)0x1;
  *(uint64_t*)0x2083d020 = (uint64_t)0x0;
  *(uint64_t*)0x2083d028 = (uint64_t)0x0;
  *(uint32_t*)0x2083d030 = (uint32_t)0x0;
  ...
  *(uint8_t*)0x208fe04f = (uint8_t)0x0;
  r[59] = syscall(__NR_sendmsg, r[1], 0x2083d000ul, 0x0ul);
}
