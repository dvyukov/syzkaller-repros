...
// https://syzkaller.appspot.com/bug?id=a36286c38cd8ead29be5
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint8_t*)0x20000288 = 0xd5);
    ...
    NONFAILING(*(uint64_t*)0x20000290 = 0x8001);
    NONFAILING(*(uint64_t*)0x20000298 = 0x524);
    ...
    NONFAILING(*(uint32_t*)0x200002b4 = 1);
    ...
    NONFAILING(*(uint64_t*)0x200002e0 = 0x20000000000000);
    NONFAILING(*(uint32_t*)0x200002e8 = 0);
    NONFAILING(*(uint16_t*)0x200002ec = 4);
    NONFAILING(*(uint16_t*)0x200002ee = 0);
    syscall(__NR_perf_event_open, 0x20000280ul, 0, 0ul, -1, 0ul);
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000000, "q", 1));
    syscall(__NR_msgsnd, 0, 0x20000000ul, 0x2000ul, 0ul);
    break;
  case 2:
