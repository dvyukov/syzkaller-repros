...
// https://syzkaller.appspot.com/bug?id=a1eb62c681423ee5c0d7
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    *(uint32_t*)0x2000016c = htobe32(0x3c);
    ...
    *(uint16_t*)0x20000174 = 7;
    *(uint16_t*)0x20000176 = 1;
    memcpy((void*)0x20000178, "ct\000", 3);
    ...
    *(uint16_t*)0x20000188 = 8;
    STORE_BY_BITMASK(uint16_t, , 0x2000018a, 2, 0, 14);
    STORE_BY_BITMASK(uint16_t, , 0x2000018b, 1, 6, 1);
    STORE_BY_BITMASK(uint16_t, , 0x2000018b, 0, 7, 1);
    *(uint32_t*)0x2000018c = htobe32(0x11);
    *(uint32_t*)0x20000190 = 0x14;
    ...
    *(uint16_t*)0x200001a2 = htobe16(0xa);
    *(uint64_t*)0x20000008 = 0xa4;
