// UBSAN: undefined-behaviour in maybe_deliver
// https://syzkaller.appspot.com/bug?id=8ee42b5f2c98ccd97a25
// status:0
...
void execute_call(int call)
{
  ...
  case 6:
    ...
    *(uint64_t*)0x20000000 = 0x20000340;
    memcpy((void*)0x20000340, "\x50\x00\x00\x00\x10\x00\x81\x05\x00\x00\x00\x00"
                              "\x9b\xbd\x0b\x6d\x69\x98\x49\xe2",
           20);
    *(uint32_t*)0x20000354 = 0;
    memcpy((void*)0x20000358, "\x01\x00\x00\x00\x00\x00\x00\x00\x28\x00\x12\x80"
                              "\x09\x00\x01\x00\x76\x6c\x61\x6e\x00\x00\x00\x00"
                              "\x18\x00\x02\x80\x06\x00\x01\x00\x04\x00\x00\x00"
                              "\x0c\x00\x02\x00\x0c\x00\x00\x00\x0d\x00\x00\x00"
                              "\x08\x00\x05\x00",
           52);
    *(uint32_t*)0x2000038c = r[2];
  ...
  case 9:
    ...
    break;
  case 10:
    syscall(__NR_getsockname, r[3], 0ul, 0ul);
    break;
  }
}
int main(void)
