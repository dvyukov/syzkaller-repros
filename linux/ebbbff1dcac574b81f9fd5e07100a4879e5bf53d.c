...
// https://syzkaller.appspot.com/bug?id=ebbbff1dcac574b81f9fd5e07100a4879e5bf53d
// status:open
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    syscall(__NR_ioctl, r[0], 0xc018aa3f, 0x200000c0);
    break;
  case 3:
    NONFAILING(*(uint64_t*)0x20ee3fe0 = 0x20012000);
    NONFAILING(*(uint64_t*)0x20ee3fe8 = 0x2000);
    NONFAILING(*(uint64_t*)0x20ee3ff0 = 1);
    NONFAILING(*(uint64_t*)0x20ee3ff8 = 0);
    syscall(__NR_ioctl, r[0], 0xc020aa00, 0x20ee3fe0);
    break;
  case 4:
    syscall(__NR_clone, 0x2102001ffc, 0, 0x9999999999999999, 0x20000640, -1);
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20000000, "/dev/input/event#", 18));
    res = syz_open_dev(0x20000000, 0, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 6:
    syscall(__NR_ioctl, r[1], 0x8040450a, 0x20013000);
    break;
  }
}
int main(void)
