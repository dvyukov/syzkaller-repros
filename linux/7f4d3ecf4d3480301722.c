...
// https://syzkaller.appspot.com/bug?id=7f4d3ecf4d3480301722
// status:0 arch:386
...
void execute_call(int call)
{
  ...
  case 0:
    NONFAILING(memcpy((void*)0x20000040,
                      "\x02\xc8\x00\x1c\x62\x18\x00\x01\x00\x02\x6f\x04\x00\x03"
                      "\x00\xb2\x04\x0f\x03\x04",
                      20));
    NONFAILING(syz_emit_vhci(0x20000040, 0x21));
    break;
  case 1:
    NONFAILING(*(uint8_t*)0x20000580 = 4);
    NONFAILING(*(uint8_t*)0x20000581 = 0x40);
    NONFAILING(*(uint8_t*)0x20000582 = 2);
    NONFAILING(*(uint8_t*)0x20000583 = 0);
    NONFAILING(*(uint8_t*)0x20000584 = 0);
    NONFAILING(syz_emit_vhci(0x20000580, 5));
    break;
  }
}
int main(void)
