// BUG: stack guard page was hit in sys_creat (4)
// https://syzkaller.appspot.com/bug?id=092274cda1459fb0fb02
// status:3
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    memcpy((void*)0x200001c0, "security.ima\000", 13);
    syscall(__NR_lsetxattr, 0x20000180ul, 0x200001c0ul, 0ul, 0ul, 2ul);
    {
      int i;
      for (i = 0; i < 64; i++) {
        syscall(__NR_lsetxattr, 0x20000180ul, 0x200001c0ul, 0ul, 0ul, 2ul);
