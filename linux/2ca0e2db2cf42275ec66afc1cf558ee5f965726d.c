...
// https://syzkaller.appspot.com/bug?id=2ca0e2db2cf42275ec66afc1cf558ee5f965726d
// status:open
...
void execute_one(void)
{
  ...
  memcpy((void*)0x20000240, "nfsd\000", 5);
  inject_fault(8);
  syscall(__NR_mount, 0, 0x20000000, 0x20000240, 0, 0);
}
int main(void)
{
