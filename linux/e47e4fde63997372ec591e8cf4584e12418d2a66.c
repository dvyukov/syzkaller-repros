...
// https://syzkaller.appspot.com/bug?id=e47e4fde63997372ec591e8cf4584e12418d2a66
// status:fixed
...
void loop()
{
  ...
  *(uint32_t*)0x20008018 = 0;
  syscall(__NR_sendto, r[0], 0x20011000, 0, 0, 0x20008000, 0x1c);
  memcpy((void*)0x2005cfa2, "\x9a\x52\x43\x8e\x82\x27", 6);
  *(uint8_t*)0x2005cfa8 = 0xaa;
  *(uint8_t*)0x2005cfa9 = 0xaa;
  *(uint8_t*)0x2005cfaa = 0xaa;
  *(uint8_t*)0x2005cfab = 0xaa;
  *(uint8_t*)0x2005cfac = 0;
  *(uint8_t*)0x2005cfad = 0xbb;
  *(uint16_t*)0x2005cfae = htobe16(0x800);
  STORE_BY_BITMASK(uint8_t, 0x2005cfb0, 0x8d, 0, 4);
  STORE_BY_BITMASK(uint8_t, 0x2005cfb0, 4, 4, 4);
  STORE_BY_BITMASK(uint8_t, 0x2005cfb1, 0, 0, 2);
  STORE_BY_BITMASK(uint8_t, 0x2005cfb1, 0, 2, 6);
  *(uint16_t*)0x2005cfb2 = htobe16(0x28);
  *(uint16_t*)0x2005cfb4 = 0;
  *(uint16_t*)0x2005cfb6 = htobe16(0);
  *(uint8_t*)0x2005cfb8 = 0;
  *(uint8_t*)0x2005cfb9 = 0;
  *(uint16_t*)0x2005cfba = 0;
  *(uint32_t*)0x2005cfbc = htobe32(0);
  *(uint32_t*)0x2005cfc0 = htobe32(0xe0000001);
  *(uint8_t*)0x2005cfc4 = 0xd;
  *(uint8_t*)0x2005cfc5 = 0;
  *(uint16_t*)0x2005cfc6 = 0;
  *(uint16_t*)0x2005cfc8 = htobe16(0);
  *(uint16_t*)0x2005cfca = htobe16(0);
  *(uint32_t*)0x2005cfcc = htobe32(0);
  *(uint32_t*)0x2005cfd0 = htobe32(0);
  *(uint32_t*)0x2005cfd4 = htobe32(0);
  *(uint32_t*)0x207ff000 = 0;
  *(uint32_t*)0x207ff004 = 0;
  struct csum_inet csum_1;
  csum_inet_init(&csum_1);
  csum_inet_update(&csum_1, (const uint8_t*)0x2005cfc4, 20);
  *(uint16_t*)0x2005cfc6 = csum_inet_digest(&csum_1);
  struct csum_inet csum_2;
  csum_inet_init(&csum_2);
  csum_inet_update(&csum_2, (const uint8_t*)0x2005cfb0, 20);
  *(uint16_t*)0x2005cfba = csum_inet_digest(&csum_2);
  syz_emit_ethernet(0x36, 0x2005cfa2, 0x207ff000);
}
