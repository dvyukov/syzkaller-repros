...
// https://syzkaller.appspot.com/bug?id=990626a4ef6f043ed4cd
// status:0
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x20000084 = 0x7c;
  *(uint8_t*)0x20000085 = 0x11;
  *(uint8_t*)0x20000086 = 0x4c;
  *(uint8_t*)0x20000087 = 0x40;
  *(uint16_t*)0x20000088 = 0x46d;
  *(uint16_t*)0x2000008a = 0x840;
  *(uint16_t*)0x2000008c = 0xce99;
  ...
  *(uint8_t*)0x200000a0 = 0x75;
  *(uint8_t*)0x200000a1 = 0x2a;
  *(uint8_t*)0x200000a2 = 0xfc;
  ...
  *(uint64_t*)0x200007a4 = 0x20000480;
  *(uint8_t*)0x20000480 = 0x20;
  *(uint8_t*)0x20000481 = 0;
  *(uint32_t*)0x20000482 = 4;
  *(uint16_t*)0x20000486 = 0x10;
  ...
  *(uint64_t*)0x200007fc = 0;
  syz_usb_control_io(-1, 0, 0x20000780);
  syz_usb_control_io(r[0], 0, 0);
  syz_usb_control_io(r[0], 0, 0);
  syz_usb_control_io(r[0], 0, 0);
  syz_usb_control_io(r[0], 0, 0);
  *(uint32_t*)0x20000340 = 0x34;
  *(uint64_t*)0x20000344 = 0x20000480;
