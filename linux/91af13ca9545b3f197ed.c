...
// https://syzkaller.appspot.com/bug?id=91af13ca9545b3f197ed
// status:0
...
void loop(void)
{
  ...
  *(uint16_t*)0x20000224 = 9;
  *(uint16_t*)0x20000226 = 1;
  memcpy((void*)0x20000228, "vlan\000", 5);
  *(uint16_t*)0x20000230 = 0x68;
  ...
  *(uint16_t*)0x20000234 = 6;
  *(uint16_t*)0x20000236 = 1;
  *(uint16_t*)0x20000238 = 0;
  *(uint16_t*)0x2000023c = 0x28;
  STORE_BY_BITMASK(uint16_t, , 0x2000023e, 3, 0, 14);
  STORE_BY_BITMASK(uint16_t, , 0x2000023f, 0, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x2000023f, 1, 7, 1);
  *(uint16_t*)0x20000240 = 0xc;
  ...
  *(uint32_t*)0x20000254 = 0x40;
  *(uint16_t*)0x20000258 = 0xc;
  *(uint16_t*)0x2000025a = 1;
  *(uint32_t*)0x2000025c = 0x80000001;
  *(uint32_t*)0x20000260 = 0x7e79464b;
  *(uint16_t*)0x20000264 = 0x34;
  ...
  *(uint32_t*)0x2000026c = 0x802;
  *(uint32_t*)0x20000270 = 0x6bc;
  *(uint16_t*)0x20000274 = 0xc;
  *(uint16_t*)0x20000276 = 1;
  *(uint32_t*)0x20000278 = 0x3fe;
  *(uint32_t*)0x2000027c = 0;
  *(uint16_t*)0x20000280 = 0xc;
  *(uint16_t*)0x20000282 = 1;
  *(uint32_t*)0x20000284 = 2;
  *(uint32_t*)0x20000288 = 0x401;
  ...
  *(uint16_t*)0x2000029a = 3;
  memcpy((void*)0x2000029c, "vlan0\000\000\000\000\000\000\000\000\000\000\000",
         16);
  *(uint16_t*)0x200002ac = 8;
  *(uint16_t*)0x200002ae = 0xa;
  *(uint32_t*)0x200002b0 = r[1];
  *(uint16_t*)0x200002b4 = 8;
  *(uint16_t*)0x200002b6 = 4;
  *(uint32_t*)0x200002b8 = 6;
  *(uint64_t*)0x200001c8 = 0xbc;
