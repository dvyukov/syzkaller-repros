...
// https://syzkaller.appspot.com/bug?id=c970edc8464d7458d4f9611b3586e53ecc744bdc
// status:open
...
void execute_one(void)
{
  ...
  syscall(__NR_request_key, 0, 0, 0, 0xfffffff9);
  syscall(__NR_add_key, 0, 0, 0, 0, 0xfffffffe);
  syscall(__NR_fstat, -1, 0);
  syscall(__NR_sched_rr_get_interval, 0, 0);
