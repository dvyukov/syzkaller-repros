// KMSAN: uninit-value in dib3000mb_attach
// https://syzkaller.appspot.com/bug?id=201ac43c284fa2260c5d45792623a9b20bbfd724
// status:invalid
...
int main(void)
{
  ...
  *(uint8_t*)0x20000004 = 0xad;
  *(uint8_t*)0x20000005 = 0x1e;
  *(uint8_t*)0x20000006 = 0x66;
  *(uint8_t*)0x20000007 = 8;
  *(uint16_t*)0x20000008 = 0x5032;
  *(uint16_t*)0x2000000a = 0xfa1;
  *(uint16_t*)0x2000000c = 0x2180;
  ...
  *(uint8_t*)0x2000001d = 0xb7;
  *(uint8_t*)0x2000001e = 0;
  *(uint8_t*)0x2000001f = 0;
  *(uint8_t*)0x20000020 = 0xa;
  *(uint8_t*)0x20000021 = 0x7f;
  *(uint8_t*)0x20000022 = 0x25;
  *(uint8_t*)0x20000023 = 0;
  syz_usb_connect(2, 0x3fe, 0x20000000, 0);
  return 0;
}
