...
// https://syzkaller.appspot.com/bug?id=305a91e025a73e4fd6ce
// status:0
...
void loop(void)
{
  memcpy((void*)0x20000100, "\x04\x46\x00\x00\x00\x00", 6);
  syz_emit_vhci(0x20000100, 6);
  syz_init_net_socket(0x1f, 3, 4);
}
int main(void)
{
