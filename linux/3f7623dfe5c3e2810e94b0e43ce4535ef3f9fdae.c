...
// https://syzkaller.appspot.com/bug?id=3f7623dfe5c3e2810e94b0e43ce4535ef3f9fdae
// status:dup
...
void execute_one(void)
{
  ...
  syz_open_dev(0x20000000, 0, 0xa8041);
  ...
  *(uint16_t*)0x20000048 = 0x54c;
  *(uint16_t*)0x2000004a = 0x374;
  ...
  *(uint8_t*)0x20000075 = 0;
  res = syz_usb_connect(0, 0x322, 0x20000040, 0);
  if (res != -1)
    r[0] = res;
  ...
  *(uint64_t*)0x2000065c = 0x200004c0;
  memcpy((void*)0x200004c0, "\x00\x22\x22\x00\x00\x00\x03\xa9\x25\x1b\xe7\x31"
                            "\xc5\x89\x47\xe9\xc5\xaf\xa1\xdf\xc7\xaa\xd3\x9c"
                            "\x00\x10\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                            "\x00\x00\x00\x00",
         40);
  *(uint64_t*)0x20000664 = 0;
  *(uint64_t*)0x2000066c = 0;
  *(uint32_t*)0x20000d80 = 0xcc;
