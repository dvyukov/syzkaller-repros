...
// https://syzkaller.appspot.com/bug?id=d7581744d5fd27c9fbe1
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint64_t*)0x2001d048 = 0x401ca);
  ...
  case 2:
    ...
    syscall(__NR_preadv, -1, 0x20000080ul, 1ul, 0, 0);
    break;
  case 3:
  ...
  case 10:
    ...
    syscall(__NR_ioctl, r[3], 0x40087602, 0x20000000ul);
    break;
  case 11:
    syscall(__NR_setsockopt, -1, 0x10e, 7, 0ul, 0ul);
    break;
  case 12:
  ...
  case 14:
    ...
    syscall(__NR_sendfile, -1, -1, 0x200001c0ul, 0ul);
    break;
  case 15:
    syscall(__NR_gettid);
    break;
  case 16:
    NONFAILING(*(uint32_t*)0x200001c0 = 0x10000);
    NONFAILING(*(uint32_t*)0x200001c4 = 0);
    NONFAILING(*(uint64_t*)0x200001c8 = 0);
    syscall(__NR_io_uring_register, -1, 6ul, 0x200001c0ul, 0ul);
    break;
  case 17:
    ...
    break;
  case 18:
    syscall(__NR_mmap, 0x20ffc000ul, 0x3000ul, 1ul, 0x11ul, r[4], 0x8001ul);
    break;
  }
}
int main(void)
