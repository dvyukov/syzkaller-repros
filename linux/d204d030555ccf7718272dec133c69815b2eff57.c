...
// https://syzkaller.appspot.com/bug?id=d204d030555ccf7718272dec133c69815b2eff57
// status:open
...
void loop(void)
{
  ...
  *(uint8_t*)0x20000444 = 0xb4;
  *(uint8_t*)0x20000445 = 0xbb;
  *(uint8_t*)0x20000446 = 0xef;
  *(uint8_t*)0x20000447 = 0x40;
  *(uint16_t*)0x20000448 = 0x4f1;
  *(uint16_t*)0x2000044a = 0x1001;
  *(uint16_t*)0x2000044c = 0xc3b5;
  ...
  *(uint8_t*)0x2000045d = 0x9d;
  *(uint8_t*)0x2000045e = 0;
  *(uint8_t*)0x2000045f = 0;
  *(uint8_t*)0x20000460 = 0xa5;
  *(uint8_t*)0x20000461 = 0xc2;
  *(uint8_t*)0x20000462 = 0xef;
  *(uint8_t*)0x20000463 = 0;
  syz_usb_connect(0, 0x24, 0x20000440, 0);
  close_fds();
}
int main(void)
{
