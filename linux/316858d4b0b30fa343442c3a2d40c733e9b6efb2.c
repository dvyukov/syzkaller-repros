...
// https://syzkaller.appspot.com/bug?id=316858d4b0b30fa343442c3a2d40c733e9b6efb2
// status:open
...
uint64_t r[8] = {0xffffffffffffffff, 0xffffffffffffffff, 0x0,
...
void execute_call(int call)
{
  ...
  case 10:
    ...
    *(uint8_t*)0x20000194 = 0;
    syscall(__NR_connect, r[3], 0x20000180ul, 0x18ul);
    break;
  case 11:
  ...
  case 12:
    ...
    break;
  case 13:
    syscall(__NR_ftruncate, r[7], 0x80080ul);
    break;
  case 14:
    syscall(__NR_sendfile, r[6], r[7], 0ul, 0x200800100000001ul);
    break;
  case 15:
    ...
    *(uint32_t*)0x20000128 = 8;
    syscall(__NR_write, -1, 0x20000040ul, 0xf0ul);
    break;
  case 16:
