...
// https://syzkaller.appspot.com/bug?id=a10a3d280be23be45d04
// status:0
...
void execute_call(int call)
{
  ...
  case 5:
    ...
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20001040, "nbd\000", 4));
    res = -1;
    NONFAILING(res = syz_genetlink_get_family_id(0x20001040, r[3]));
    if (res != -1)
      r[4] = res;
    break;
  case 7:
    ...
    NONFAILING(*(uint64_t*)0x20000500 = 0x20000100);
    NONFAILING(memcpy((void*)0x20000100, ",\000\000\000", 4));
    NONFAILING(*(uint16_t*)0x20000104 = r[4]);
    NONFAILING(memcpy((void*)0x20000106,
                      "\x01\x00\x00\x00\x00\x00\xff\x00\x00\x00\x01\x00\x48\x00"
                      "\x04\x00\x07\x80\x0c\x00\x02\x00\x00\x97\xff\xff\xff\x00"
                      "\x00\x00\x08\x00\x01\x00\x00\x00\xfb\xa1",
                      38));
    NONFAILING(*(uint64_t*)0x20000508 = 0x2c);
  ...
  case 8:
    ...
    NONFAILING(*(uint32_t*)0x20000188 = 0x1800000);
    NONFAILING(*(uint32_t*)0x200002c8 = 0xc);
    NONFAILING(*(uint64_t*)0x200002d0 = 0x20000280);
    NONFAILING(*(uint64_t*)0x20000280 = 0x20000240);
    NONFAILING(*(uint32_t*)0x20000240 = 0x38);
    NONFAILING(*(uint16_t*)0x20000244 = 0);
    NONFAILING(*(uint16_t*)0x20000246 = 0x200);
    NONFAILING(*(uint32_t*)0x20000248 = 0x70bd2b);
    NONFAILING(*(uint32_t*)0x2000024c = 0x25dfdbfe);
    NONFAILING(*(uint8_t*)0x20000250 = 8);
    ...
    NONFAILING(*(uint8_t*)0x20000258 = 0xac);
    NONFAILING(*(uint8_t*)0x20000259 = 0x14);
    NONFAILING(*(uint8_t*)0x2000025a = 0x14);
    NONFAILING(*(uint8_t*)0x2000025b = 0x2a);
    NONFAILING(*(uint16_t*)0x2000025c = 8);
    NONFAILING(*(uint16_t*)0x2000025e = 4);
    NONFAILING(*(uint32_t*)0x20000260 = htobe32(0xe0000001));
    NONFAILING(*(uint16_t*)0x20000264 = 0x14);
    NONFAILING(*(uint16_t*)0x20000266 = 3);
    NONFAILING(memset((void*)0x20000268, 0, 10));
    NONFAILING(memset((void*)0x20000272, 255, 2));
    NONFAILING(*(uint32_t*)0x20000274 = htobe32(0x64010100));
    ...
    NONFAILING(*(uint32_t*)0x200002f0 = 0x4008041);
    syscall(__NR_sendmsg, r[3], 0x200002c0ul, 0x40000ul);
    break;
  case 9:
    NONFAILING(*(uint32_t*)0x20000200 = 0x2ba);
    syscall(__NR_getsockname, r[2], 0x20000100ul, 0x20000200ul);
    break;
  case 10:
    res = syscall(__NR_socket, 0x10ul, 3ul, 0);
    if (res != -1)
  ...
  case 12:
    NONFAILING(*(uint64_t*)0x20000000 = 0);
    NONFAILING(*(uint32_t*)0x20000008 = 0);
    NONFAILING(*(uint64_t*)0x20000010 = 0x20000200);
    NONFAILING(*(uint64_t*)0x20000200 = 0x20000240);
    NONFAILING(*(uint32_t*)0x20000240 = 0x34);
    NONFAILING(*(uint16_t*)0x20000244 = 0x1a);
    ...
    NONFAILING(*(uint32_t*)0x20000258 = 0x2900);
    NONFAILING(*(uint16_t*)0x2000025c = 8);
    NONFAILING(*(uint16_t*)0x2000025e = 0x10);
    NONFAILING(*(uint32_t*)0x20000260 = 0);
    NONFAILING(*(uint16_t*)0x20000264 = 8);
    NONFAILING(*(uint16_t*)0x20000266 = 0x19);
    NONFAILING(*(uint32_t*)0x20000268 = 0);
    NONFAILING(*(uint16_t*)0x2000026c = 8);
    NONFAILING(*(uint16_t*)0x2000026e = 3);
    NONFAILING(*(uint32_t*)0x20000270 = 0);
    NONFAILING(*(uint64_t*)0x20000208 = 0x34);
    NONFAILING(*(uint64_t*)0x20000018 = 1);
    NONFAILING(*(uint64_t*)0x20000020 = 0);
    NONFAILING(*(uint64_t*)0x20000028 = 0);
    NONFAILING(*(uint32_t*)0x20000030 = 0);
  ...
  case 13:
    NONFAILING(memcpy((void*)0x200003c0,
                      "ip6_vti0\000\000\000\000\000\000\000\000", 16));
    NONFAILING(*(uint64_t*)0x200003d0 = 0x20000300);
    NONFAILING(memcpy((void*)0x20000300,
                      "ip6gre0\000\000\000\000\000\000\000\000\000", 16));
    NONFAILING(*(uint32_t*)0x20000310 = 0);
    NONFAILING(*(uint8_t*)0x20000314 = 4);
    NONFAILING(*(uint8_t*)0x20000315 = 5);
    NONFAILING(*(uint8_t*)0x20000316 = 0x81);
    NONFAILING(*(uint32_t*)0x20000318 = htobe32(3));
    NONFAILING(*(uint32_t*)0x2000031c = 0x40);
    NONFAILING(*(uint8_t*)0x20000320 = 0xfc);
    NONFAILING(*(uint8_t*)0x20000321 = 0);
    NONFAILING(memset((void*)0x20000322, 0, 13));
    NONFAILING(*(uint8_t*)0x2000032f = 1);
    NONFAILING(*(uint8_t*)0x20000330 = -1);
    NONFAILING(*(uint8_t*)0x20000331 = 2);
    NONFAILING(memset((void*)0x20000332, 0, 13));
    NONFAILING(*(uint8_t*)0x2000033f = 1);
    NONFAILING(*(uint16_t*)0x20000340 = htobe16(0x20));
    NONFAILING(*(uint16_t*)0x20000342 = htobe16(0x20));
    NONFAILING(*(uint32_t*)0x20000344 = htobe32(0x1a));
    NONFAILING(*(uint32_t*)0x20000348 = htobe32(9));
    syscall(__NR_ioctl, r[0], 0x89f0, 0x200003c0ul);
    break;
  case 14:
  ...
  case 15:
    ...
    syscall(__NR_getsockname, r[0], 0x200000c0ul, 0x20000140ul);
    break;
  }
}
int main(void)
