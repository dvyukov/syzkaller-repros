...
// https://syzkaller.appspot.com/bug?id=694deebd17dcc89c73f8
// status:2
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x200002d8 = -1;
  ...
  res = -1;
  res = syz_io_uring_setup(0x183, 0x200002c0, 0x20148000, 0x20ffb000,
  ...
  *(uint8_t*)0x20000081 = 4;
  *(uint16_t*)0x20000082 = 0;
  *(uint32_t*)0x20000084 = 0;
  *(uint64_t*)0x20000088 = 4;
  ...
  *(uint16_t*)0x200000aa = 0;
  ...
  syz_io_uring_submit(r[1], r[2], 0x20000080, 8);
  ...
  *(uint16_t*)0x200002aa = 0;
  ...
  syscall(__NR_io_uring_enter, r[0], 0x4efb, 0, 0ul, 0ul, 0xf5fffffful);
}
int main(void)
{
