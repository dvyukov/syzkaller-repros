// KMSAN: uninit-value in wp512_process_buffer
// https://syzkaller.appspot.com/bug?id=16bfc85701ad946854fd6bfc990621b7a3da635f
// status:invalid
...
void loop()
{
  ...
  *(uint32_t*)0x20000094 = 0;
  memcpy((void*)0x20000098,
         "\x77\x70\x32\x35\x36\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
  ...
  if (res != -1)
    r[2] = res;
  syscall(__NR_fallocate, r[2], 0, 0, 0x73e1);
  *(uint64_t*)0x20145000 = 0;
  syscall(__NR_sendfile, r[1], r[2], 0x20145000, 0x5abc);
}
