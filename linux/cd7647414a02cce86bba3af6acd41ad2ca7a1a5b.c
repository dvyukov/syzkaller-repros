...
// https://syzkaller.appspot.com/bug?id=cd7647414a02cce86bba3af6acd41ad2ca7a1a5b
// status:open
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    *(uint32_t*)0x20000018 = 0;
    syscall(__NR_bind, r[2], 0x20000000, 0x1c);
    break;
  case 4:
    ...
    *(uint32_t*)0x20000058 = 0;
    syscall(__NR_sendto, r[2], 0, 0, 0x20000001, 0x20000040, 0x1c);
    break;
  case 5:
    syscall(__NR_splice, r[2], 0, r[1], 0, 0x1000000000000003, 0);
    break;
  case 6:
    syscall(__NR_sendto, r[2], 0, 0, 0x57, 0, 0);
    break;
  case 7:
