...
// https://syzkaller.appspot.com/bug?id=70cbd1b4257a8631183e
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint8_t*)0x20000388 = 8);
    NONFAILING(*(uint8_t*)0x20000389 = 3);
    NONFAILING(*(uint8_t*)0x2000038a = 0);
    NONFAILING(*(uint8_t*)0x2000038b = 0x15);
    NONFAILING(*(uint32_t*)0x2000038c = 0);
    NONFAILING(*(uint64_t*)0x20000390 = 9);
    NONFAILING(*(uint64_t*)0x20000398 = 0x2420);
    NONFAILING(*(uint64_t*)0x200003a0 = 9);
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 1, 0, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0, 1, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 1, 2, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0, 3, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0, 4, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0, 5, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 1, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 1, 7, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 1, 8, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 1, 9, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 1, 10, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0, 11, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 1, 12, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0, 13, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0, 14, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0, 15, 2));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0, 17, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 1, 18, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 1, 19, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0, 20, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0, 21, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 1, 22, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 1, 23, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0, 24, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0, 25, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0, 26, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 1, 27, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0, 28, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0, 29, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0x83d, 30, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0, 31, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0, 32, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 3, 33, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 7, 34, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 5, 35, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0, 36, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0, 37, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003a8, 0xffff, 38, 26));
    NONFAILING(*(uint32_t*)0x200003b0 = 0);
    NONFAILING(*(uint32_t*)0x200003b4 = 0);
    NONFAILING(*(uint64_t*)0x200003b8 = 0x20000000);
    ...
    NONFAILING(*(uint16_t*)0x200003ec = 0);
    NONFAILING(*(uint16_t*)0x200003ee = 0);
    NONFAILING(*(uint32_t*)0x200003f0 = 0);
    NONFAILING(*(uint32_t*)0x200003f4 = 0);
    NONFAILING(*(uint64_t*)0x200003f8 = 0);
    syscall(__NR_perf_event_open, 0x20000380ul, 0, 0x10ul, -1, 3ul);
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000000, "/dev/kvm\000", 9));
  ...
  case 3:
    ...
    NONFAILING(
        memcpy((void*)0x20000080,
               "\xba\xa1\x00\x00\xee\xf3\x6c\xba\x21\x00\xec\x66\xb9\x80\x00"
               "\x00\xc0\x0f\x32\x66\x35\x00\x10\x00\x00\x0f\x30\xba\xd1\x04"
               "\xec\xc8\x00\x80\xd2\x67\xd9\xf8\xf3\x0f\x1b\xb4\x29\x00\x0f"
               "\x20\xc0\x66\x35\x20\x00\x00\x00\x0f\x22\xc0\x67\xf3\xaf",
               59));
    NONFAILING(*(uint64_t*)0x200000d0 = 0x3b);
    NONFAILING(syz_kvm_setup_cpu(-1, -1, 0x20000000, 0x200000c0, 1, 0, 0, 0));
    break;
  case 4:
  ...
  case 5:
    ...
    NONFAILING(*(uint64_t*)0x20000058 = 0xc1028);
  ...
  case 6:
    ...
    NONFAILING(*(uint64_t*)0x20bf7010 = 0x1000);
  ...
  case 7:
    ...
    NONFAILING(*(uint64_t*)0x20000230 = 0x4000000000ff);
    ...
    NONFAILING(*(uint64_t*)0x20000280 = 0x1f000);
  ...
  case 9:
    ...
    NONFAILING(
        syz_kvm_setup_cpu(r[1], -1, 0x207ac000, 0x200002c0, 1, 0x28, 0, 0));
    break;
  case 10:
