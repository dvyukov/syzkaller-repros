...
// https://syzkaller.appspot.com/bug?id=a46477687e1dbb03f38e46c9b65d6541db2cc96a
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    memcpy((void*)0x200004c0, "stack", 6);
  ...
  case 1:
    ...
    *(uint64_t*)0x20000488 = 0xf2;
    syscall(__NR_preadv, r[0], 0x20000480, 1, 0);
    break;
  }
}
int main()
