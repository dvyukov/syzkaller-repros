...
// https://syzkaller.appspot.com/bug?id=b57abf7ee60829090495
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    *(uint32_t*)0x20000264 = 0;
    res = -1;
    res = syz_io_uring_setup(0xcf1, 0x20000240, 0x20ffd000, 0x206d4000,
  ...
  case 2:
    ...
    *(uint8_t*)0x2000023f = 0;
    syz_io_uring_submit(r[0], r[1], 0x20000200, 0);
    break;
  }
}
int main(void)
