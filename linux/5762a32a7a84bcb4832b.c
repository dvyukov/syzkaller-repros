...
// https://syzkaller.appspot.com/bug?id=5762a32a7a84bcb4832b
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    syscall(__NR_perf_event_open, 0x2001d000ul, 0, 0xffffeffffffffffful, -1,
            0ul);
    break;
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_ioctl, -1, 0x2400, 0ul);
    break;
  case 3:
  ...
  case 5:
    ...
    NONFAILING(*(uint32_t*)0x20002d88 = 0);
    ...
    NONFAILING(*(uint32_t*)0x20002db0 = 0);
    NONFAILING(*(uint32_t*)0x20002db8 = 0x8e1);
    syscall(__NR_recvmmsg, -1, 0x20002d80ul, 1ul, 0ul, 0ul);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x200004c0, "stack\000", 6));
    res = -1;
    NONFAILING(res = syz_open_procfs(0, 0x200004c0));
    if (res != -1)
      r[0] = res;
    break;
  case 7:
    syscall(__NR_preadv, r[0], 0x200017c0ul, 0x2bful, 0, 0);
    break;
  case 8:
    NONFAILING(memcpy((void*)0x20000140, "hugetlbfs\000", 10));
    syscall(__NR_mount, 0ul, 0ul, 0x20000140ul, 0ul, 0ul);
    break;
  case 9:
  ...
  case 12:
    ...
    NONFAILING(*(uint64_t*)0x20000510 = 0x20000380);
    NONFAILING(memcpy((void*)0x20000380, "![@\000", 4));
    ...
    NONFAILING(*(uint64_t*)0x20000538 = 0x200004c0);
    NONFAILING(memcpy((void*)0x200004c0, "overlay\000", 8));
    syscall(__NR_execve, 0x20000040ul, 0x20000500ul, 0ul);
    break;
  case 13:
    NONFAILING(memcpy((void*)0x20000080, "fdinfo/3\000", 9));
    res = -1;
    NONFAILING(res = syz_open_procfs(0, 0x20000080));
    if (res != -1)
      r[1] = res;
    break;
  case 14:
    NONFAILING(memcpy((void*)0x20000040, "./file0\000", 8));
    res = syscall(__NR_open, 0x20000040ul, 0x143042ul, 0ul);
    if (res != -1)
      r[2] = res;
    break;
  case 15:
    syscall(__NR_sendfile, r[2], r[1], 0ul, 0x283ul);
    break;
  }
}
int main(void)
