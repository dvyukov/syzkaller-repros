...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(*(uint64_t*)0x200005c0 = 0x20000140);
    NONFAILING(*(uint16_t*)0x20000140 = 0x10);
    NONFAILING(*(uint16_t*)0x20000142 = 0);
    NONFAILING(*(uint32_t*)0x20000144 = 0);
    NONFAILING(*(uint32_t*)0x20000148 = 0);
    NONFAILING(*(uint32_t*)0x200005c8 = 0xc);
    NONFAILING(*(uint64_t*)0x200005d0 = 0x20000580);
    NONFAILING(*(uint64_t*)0x20000580 = 0x20000000);
    NONFAILING(memcpy((void*)0x20000000,
                      "\x40\x00\x00\x00\x10\x00\x55\x34\x00\x00\x00\x00\x00\x00"
                      "\x00\x00\x00\x00\x00\x00",
                      20));
    NONFAILING(*(uint32_t*)0x20000014 = 0);
    NONFAILING(memcpy(
        (void*)0x20000018,
        "\x00\x00\x00\x00\x00\x00\x00\x00\x20\x00\x12\x00\x10\x00\x01\x00\x69"
        "\x70\x36\x67\x72\x65\x74\x61\x70\x00\x00\x00\x0c\x00\x02\x00\x08\x00"
        "\x01\x00\x95\xea\x7e\x44\x9e\xd9\xde\x02\xf5\xe2\x6e\x39\xad\x0f\x8a"
        "\x05\xc1\x36\xee\x64\xbf\x26\xb5\x01\x44\xc9\xa7\x44\x82\x22\xf7\xde"
        "\x06\xf1\xaf\xc4\x22\x71\x52\xdf\x5b\x5f\x3a\xc5\x2c\x7c\xa3\xb5\xaa"
        "\xf9\x5f\xcd\x9f\x88\x81\x07\x83\x57\xfb\xa0\x96\x33\xd8\xc4\x01\x87"
        "\xb4\x00\x5a\xef\xfc\x38\x04\xb1\x18\x4e\xac\x67\x6d\xb7\x57\xa3\xcd"
        "\x9d\x59\x87\x57\xa4\x9d\x9c\xe6\x33\x82\xf6\x93\xfe\xc0\x0a\xe5\x86"
        "\xf8\x90\x26\x90\x03\x0a\x37\x76\xeb\xde\xdd\x10\xef\x22\xfa\xb5\xd7"
        "\x31\x78\xa1\x81\xd4\x95\x5f\xf2\x7f\xf3\x44\xfd\xbf\x43\x2e\xc9\xbd"
        "\xfd\xf7\x2a\x8a\x78\xfb\x66\xbf\xc2\xf0\x07\xd9\x73\xfd\x30\xa9\xb9"
        "\xf1\x8b\x5a\xcc\x96\x04\x72\xc8\x66\x0e\x8e\x7a\x56\xe4\x40",
        202));
    NONFAILING(*(uint32_t*)0x200000e2 = 0);
    NONFAILING(*(uint64_t*)0x20000588 = 4);
