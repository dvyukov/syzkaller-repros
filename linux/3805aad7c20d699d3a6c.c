...
// https://syzkaller.appspot.com/bug?id=3805aad7c20d699d3a6c
// status:0
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[0] = res;
  NONFAILING(*(uint64_t*)0x20000340 = 0x20000040);
  NONFAILING(*(uint64_t*)0x20000348 = 2);
  NONFAILING(*(uint64_t*)0x20000350 = 0x20000100);
  NONFAILING(*(uint64_t*)0x20000358 = 0x79);
  NONFAILING(*(uint64_t*)0x20000360 = 0x20000080);
  NONFAILING(*(uint64_t*)0x20000368 = 0x2d);
  NONFAILING(*(uint64_t*)0x20000370 = 0);
  NONFAILING(*(uint64_t*)0x20000378 = 0);
  NONFAILING(*(uint64_t*)0x20000380 = 0x200001c0);
  NONFAILING(*(uint64_t*)0x20000388 = 0xe7);
  syscall(__NR_preadv, r[0], 0x20000340ul, 5ul, 0x100, 9);
