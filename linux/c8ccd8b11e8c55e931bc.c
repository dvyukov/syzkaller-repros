// KASAN: invalid-free in skb_release_data
// https://syzkaller.appspot.com/bug?id=c8ccd8b11e8c55e931bc
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(*(uint32_t*)0x20000188 = 0x18);
  NONFAILING(*(uint64_t*)0x20000190 = 0x200000c0);
  NONFAILING(*(uint64_t*)0x200000c0 = 0x20000000);
  NONFAILING(*(uint64_t*)0x200000c8 = 0xffef);
  NONFAILING(*(uint64_t*)0x20000198 = 1);
  NONFAILING(*(uint64_t*)0x200001a0 = 0xfdffffff00000000);
