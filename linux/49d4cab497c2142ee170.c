...
// https://syzkaller.appspot.com/bug?id=49d4cab497c2142ee170
// status:6
...
void loop(void)
{
  ...
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x20002080, "nl80211\000", 8);
  res = -1;
  res = syz_genetlink_get_family_id(0x20002080);
  if (res != -1)
    r[1] = res;
  res = syscall(__NR_socket, 0x10ul, 3ul, 0x10);
  if (res != -1)
    r[2] = res;
  memcpy((void*)0x20000200, "wlan1\000\000\000\000\000\000\000\000\000\000\000",
         16);
  res = syscall(__NR_ioctl, r[2], 0x8933, 0x20000200ul);
  if (res != -1)
    r[3] = *(uint32_t*)0x20000210;
  ...
  *(uint8_t*)0x20000068 = 8;
  *(uint8_t*)0x20000069 = 2;
  *(uint8_t*)0x2000006a = 0x11;
  *(uint8_t*)0x2000006b = 0;
  *(uint8_t*)0x2000006c = 0;
  *(uint8_t*)0x2000006d = 0;
  *(uint16_t*)0x20000070 = 4;
  *(uint16_t*)0x20000072 = 0x28;
  *(uint16_t*)0x20000074 = 9;
  *(uint16_t*)0x20000076 = 7;
  memcpy((void*)0x20000078, "\xa4\x81\xe6\xbd\xb6", 5);
  *(uint64_t*)0x200000c8 = 0x40;
  *(uint64_t*)0x20000118 = 1;
  *(uint64_t*)0x20000120 = 0;
  *(uint64_t*)0x20000128 = 0;
  *(uint32_t*)0x20000130 = 0xc014;
  syscall(__NR_sendmsg, r[0], 0x20000100ul, 0x8800ul);
  close_fds();
}
int main(void)
{
