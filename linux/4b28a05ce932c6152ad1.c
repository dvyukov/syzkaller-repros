// BUG: unable to handle kernel paging request in eventfd_signal
// https://syzkaller.appspot.com/bug?id=4b28a05ce932c6152ad1
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    res = -1;
    NONFAILING(res = syz_io_uring_setup(0x17a4, 0x20000240, 0x20002000,
                                        0x20ff9000, 0x20000340, 0x20000140));
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    syscall(__NR_io_uring_enter, r[0], 0, 0xab2, 1ul, 0ul, 0ul);
    break;
  case 2:
    NONFAILING(*(uint64_t*)0x20002040 = 0x20000180);
    NONFAILING(*(uint16_t*)0x20000180 = 0xa);
    NONFAILING(*(uint16_t*)0x20000182 = htobe16(0));
    NONFAILING(*(uint32_t*)0x20000184 = htobe32(0));
    NONFAILING(*(uint8_t*)0x20000188 = 0xfc);
    NONFAILING(*(uint8_t*)0x20000189 = 0);
    NONFAILING(memset((void*)0x2000018a, 0, 13));
  ...
  case 4:
    ...
    syscall(__NR_io_uring_register, r[0], 4ul, 0x20000040ul, 1ul);
    break;
  }
}
int main(void)
