...
// https://syzkaller.appspot.com/bug?id=4e14e4ba4a93853e73f4ac60dc6cea03189bdf4f
// status:dup
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x200004c0,
                      "nr0\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
                      16));
    NONFAILING(*(uint32_t*)0x200004d0 = 6);
    syscall(__NR_ioctl, -1, 0x8935, 0x200004c0);
    break;
  case 1:
  ...
  case 3:
    ...
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000740, "/dev/snd/pcmC#D#c\x00", 18));
    res = syz_open_dev(0x20000740, 0x101, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_ioctl, -1, 0xae9a);
    break;
  case 7:
    NONFAILING(*(uint32_t*)0x200008c0 = 0);
    syscall(__NR_getsockopt, -1, 0, 0x23, 0, 0x200008c0);
    break;
  case 8:
    ...
    NONFAILING(
        memcpy((void*)0x20000182,
               "port0\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
    ...
    syscall(__NR_ioctl, -1, 0x40a85321, 0x20000180);
    break;
  case 9:
    NONFAILING(memcpy((void*)0x20000440, "/dev/dlm_plock\x00", 15));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000440, 1, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 10:
    syscall(__NR_ioctl, r[1], 0xc208ae62, 0x200009c0);
    break;
  case 11:
    NONFAILING(memcpy((void*)0x20027ff3, "/dev/snd/seq\x00", 13));
    res = syz_open_dev(0x20027ff3, 0, 0);
    if (res != -1)
      r[2] = res;
    break;
  case 12:
    NONFAILING(*(uint64_t*)0x20000540 = 0x20ffb000);
    NONFAILING(*(uint64_t*)0x20000548 = 0x20ff9000);
    NONFAILING(*(uint64_t*)0x20000550 = 0x3000);
    NONFAILING(*(uint64_t*)0x20000558 = 1);
    NONFAILING(*(uint64_t*)0x20000560 = 0);
    syscall(__NR_ioctl, r[0], 0xc028aa03, 0x20000540);
    break;
  case 13:
    NONFAILING(*(uint32_t*)0x200005c0 = 0);
    NONFAILING(*(uint16_t*)0x200005c4 = 0x18);
    NONFAILING(*(uint16_t*)0x200005c6 = 0xfa00);
    NONFAILING(*(uint64_t*)0x200005c8 = 3);
    NONFAILING(*(uint64_t*)0x200005d0 = 0x20000580);
    NONFAILING(*(uint16_t*)0x200005d8 = 0x106);
    NONFAILING(*(uint8_t*)0x200005da = 0xb);
    ...
    syscall(__NR_write, r[2], 0x200005c0, 0x20);
    break;
  case 14:
    ...
    NONFAILING(*(uint16_t*)0x200000d8 = 0x113);
    ...
    res = syscall(__NR_write, r[2], 0x200000c0, 0x20);
    if (res != -1)
      NONFAILING(r[3] = *(uint32_t*)0x20000080);
    break;
  case 15:
    NONFAILING(*(uint64_t*)0x20000600 = 2);
    NONFAILING(*(uint32_t*)0x20000608 = 0);
    NONFAILING(*(uint32_t*)0x2000060c = 0);
    syscall(__NR_ioctl, r[0], 0x401070ca, 0x20000600);
    break;
  case 16:
    NONFAILING(*(uint32_t*)0x20000100 = 0x13);
    NONFAILING(*(uint16_t*)0x20000104 = 0x10);
    NONFAILING(*(uint16_t*)0x20000106 = 0xfa00);
    NONFAILING(*(uint64_t*)0x20000108 = 0x20000240);
    NONFAILING(*(uint32_t*)0x20000110 = -1);
    NONFAILING(*(uint32_t*)0x20000114 = 1);
    syscall(__NR_write, r[0], 0x20000100, 0x18);
    break;
  case 17:
    NONFAILING(memcpy((void*)0x20000140, "tls\x00", 4));
    syscall(__NR_setsockopt, -1, 6, 0x1f, 0x20000140, 4);
    break;
  case 18:
    NONFAILING(*(uint16_t*)0x20000940 = 0x6445);
    NONFAILING(*(uint16_t*)0x20000942 = 0);
    NONFAILING(*(uint16_t*)0x20000944 = 0x800d);
    NONFAILING(*(uint32_t*)0x20000948 = 0);
    NONFAILING(*(uint32_t*)0x2000094c = 1);
    NONFAILING(*(uint32_t*)0x20000950 = 0x6bc6);
    NONFAILING(*(uint32_t*)0x20000954 = 0xfffff04b);
    NONFAILING(*(uint32_t*)0x20000958 = 0);
    NONFAILING(*(uint32_t*)0x2000095c = 0);
    NONFAILING(*(uint32_t*)0x20000980 = 0x20);
    syscall(__NR_getsockopt, -1, 0x84, 0xa, 0x20000940, 0x20000980);
    break;
  case 19:
    NONFAILING(*(uint32_t*)0x20000640 = 0);
    syscall(__NR_getsockopt, -1, 0x84, 0x1b, 0x20000440, 0x20000640);
    break;
  case 20:
    NONFAILING(*(uint32_t*)0x20000780 = 0);
    NONFAILING(*(uint16_t*)0x20000788 = 2);
    NONFAILING(*(uint16_t*)0x2000078a = htobe16(0));
    NONFAILING(*(uint32_t*)0x2000078c = htobe32(0xe0000002));
    NONFAILING(*(uint64_t*)0x20000808 = 6);
    NONFAILING(*(uint64_t*)0x20000810 = 0x100000001);
    NONFAILING(*(uint64_t*)0x20000818 = 0x7ff);
    NONFAILING(*(uint64_t*)0x20000820 = 1);
    NONFAILING(*(uint64_t*)0x20000828 = 0x80000000);
    NONFAILING(*(uint64_t*)0x20000830 = 3);
    NONFAILING(*(uint64_t*)0x20000838 = 0x763);
    NONFAILING(*(uint64_t*)0x20000840 = 8);
    NONFAILING(*(uint64_t*)0x20000848 = 0x20);
    NONFAILING(*(uint64_t*)0x20000850 = 5);
    NONFAILING(*(uint64_t*)0x20000858 = 0x7fff);
    NONFAILING(*(uint64_t*)0x20000860 = 0x13d);
    NONFAILING(*(uint64_t*)0x20000868 = 4);
    NONFAILING(*(uint64_t*)0x20000870 = 0);
    NONFAILING(*(uint64_t*)0x20000878 = 4);
    syscall(__NR_getsockopt, -1, 0x84, 0x70, 0x20000780, 0);
    break;
  case 21:
    NONFAILING(*(uint32_t*)0x20000500 = 0xf);
    NONFAILING(*(uint16_t*)0x20000504 = 8);
    NONFAILING(*(uint16_t*)0x20000506 = 0xfa00);
    NONFAILING(*(uint32_t*)0x20000508 = r[3]);
    NONFAILING(*(uint32_t*)0x2000050c = 0x10);
    syscall(__NR_write, -1, 0x20000500, 0x10);
    break;
  }
}
int main(void)
