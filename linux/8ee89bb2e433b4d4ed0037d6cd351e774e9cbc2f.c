...
// https://syzkaller.appspot.com/bug?id=8ee89bb2e433b4d4ed0037d6cd351e774e9cbc2f
// status:fixed
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000140, ".\x00", 2));
    res = syscall(__NR_open, 0x20000140, 0, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    syscall(__NR_write, -1, 0, 0xfffffffffffffe5b);
    break;
  case 2:
  ...
  case 7:
    ...
    syscall(__NR_stat, 0x200001c0, 0);
    break;
  case 8:
    syscall(__NR_mount, 0, 0, 0, 0x10030, 0);
    break;
  case 9:
    syscall(__NR_getdents64, r[0], 0x20000300, 0xd9);
    break;
  case 10:
    NONFAILING(*(uint64_t*)0x20000080 = 0);
    NONFAILING(*(uint64_t*)0x20000088 = 0x1c9c380);
    NONFAILING(*(uint64_t*)0x20000090 = 0);
    NONFAILING(*(uint64_t*)0x20000098 = 9);
    syscall(__NR_timer_settime, 0, 0, 0x20000080, 0);
    break;
  case 11:
