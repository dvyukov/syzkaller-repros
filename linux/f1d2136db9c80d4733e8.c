...
// https://syzkaller.appspot.com/bug?id=f1d2136db9c80d4733e8
// status:6
...
int main(void)
{
  ...
  *(uint64_t*)0x20000050 = 0;
  syz_kvm_setup_cpu(-1, r[2], 0x20000000, 0x20000040, 1, 0x4b, 0, 0);
  syscall(__NR_ioctl, r[2], 0xae80, 0ul);
  *(uint64_t*)0x20000240 = 0x10001;
  *(uint64_t*)0x20000248 = 0x71;
  *(uint64_t*)0x20000250 = 8;
  *(uint64_t*)0x20000258 = 2;
  *(uint64_t*)0x20000260 = 0x400;
  *(uint64_t*)0x20000268 = 0x100000001;
  *(uint64_t*)0x20000270 = 0x80000000000000;
  *(uint64_t*)0x20000278 = 0x164;
  *(uint64_t*)0x20000280 = 8;
  *(uint64_t*)0x20000288 = 0x7ff;
  *(uint64_t*)0x20000290 = 8;
  *(uint64_t*)0x20000298 = 0xff;
  *(uint64_t*)0x200002a0 = 3;
  *(uint64_t*)0x200002a8 = 0x80000001;
  *(uint64_t*)0x200002b0 = 8;
  *(uint64_t*)0x200002b8 = 0x732;
  *(uint64_t*)0x200002c0 = 0x10000;
  *(uint64_t*)0x200002c8 = 0x20000;
  syscall(__NR_ioctl, r[2], 0x4090ae82, 0x20000240ul);
  syscall(__NR_ioctl, r[2], 0xae80, 0ul);
  return 0;
}
