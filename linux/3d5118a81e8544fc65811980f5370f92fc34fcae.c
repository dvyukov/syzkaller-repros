...
// https://syzkaller.appspot.com/bug?id=3d5118a81e8544fc65811980f5370f92fc34fcae
// status:invalid
...
{
  memset(r, -1, sizeof(r));
  r[0] = syscall(__NR_mmap, 0x20000000ul, 0xaf3000ul, 0x3ul, 0x32ul,
                 0xfffffffffffffffful, 0x0ul);
  memcpy((void*)0x2034eff7, "\x2f\x64\x65\x76\x2f\x6b\x76\x6d\x00", 9);
  r[2] = syscall(__NR_openat, 0xffffffffffffff9cul, 0x2034eff7ul, 0x1ul,
                 0x0ul);
  r[3] = syscall(__NR_ioctl, r[2], 0xae01ul, 0x0ul);
  r[4] = syscall(__NR_ioctl, r[3], 0xae41ul, 0x0ul);
  *(uint64_t*)0x20777000 = (uint64_t)0x40;
  *(uint64_t*)0x20777008 = (uint64_t)0x20add000;
  *(uint64_t*)0x20777010 = (uint64_t)0x66;
  memcpy((void*)0x20add000,
         "\x66\xb8\x34\x01\x0f\x00\xd0\x26\x65\x67\x66\x48\x0f\x38\x82"
         "\x74\xfb\x6a\x3e\x4c\x0f\x01\xcb\xc4\x82\x0d\xbe\x75\xfa\xc4"
         "\xe3\xfd\x6d\x0d\x5f\x09\x00\x00\x80\x3e\x36\x0f\x01\xd1\xc4"
         "\xe1\x39\x58\x6d\x00\x36\xf2\x41\x0f\x59\x34\xf0\x66\xba\xf8"
         "\x0c\xb8\x22\xea\xf0\x82\xef\x66\xba\xfc\x0c\xb0\x62\xee\xc7"
         "\x44\x24\x00\x74\x24\x00\x00\xc7\x44\x24\x02\x52\x00\x00\x00"
         "\xc7\x44\x24\x06\x00\x00\x00\x00\x0f\x01\x14\x24",
         102);
  r[9] = syz_kvm_setup_cpu(r[3], r[4], 0x201b3000ul, 0x20777000ul,
                           0x1ul, 0x41ul, 0x20ad8000ul, 0x0ul);
  r[10] = syscall(__NR_mremap, 0x20998000ul, 0x1000ul, 0x4000ul, 0x3ul,
                  0x200fa000ul);
  r[11] = syscall(__NR_ioctl, r[4], 0xae80ul, 0x0ul);
  *(uint64_t*)0x20001ff8 = (uint64_t)0x0;
  r[13] = syscall(__NR_mbind, 0x20000000ul, 0x2000ul, 0x0ul,
                  0x20001ff8ul, 0x2ul, 0x2ul);
}
