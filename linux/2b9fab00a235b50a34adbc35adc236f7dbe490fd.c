...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000100, "/dev/dsp#", 10));
    res = syz_open_dev(0x20000100, 0x3fe, 0x400);
    if (res != -1)
      r[1] = res;
    break;
  case 2:
  ...
  case 3:
    ...
    break;
  case 4:
    syscall(__NR_mincore, 0x20ffc000, 0x1000, 0x200003c0);
    break;
  case 5:
    NONFAILING(*(uint64_t*)0x20000000 = 0);
    NONFAILING(*(uint64_t*)0x20000008 = 0);
    syscall(__NR_setrlimit, 0, 0x20000000);
    break;
  case 6:
    syscall(__NR_readahead, r[1], 3, 0x9a6);
    break;
  case 7:
    NONFAILING(*(uint32_t*)0x200002c0 = 4);
    NONFAILING(*(uint32_t*)0x200002c4 = -1);
    NONFAILING(*(uint32_t*)0x200002c8 = 0);
    syscall(__NR_ioctl, r[2], 0xc00caee0, 0x200002c0);
    break;
  case 8:
    NONFAILING(*(uint32_t*)0x200001c0 = 9);
    syscall(__NR_setsockopt, r[1], 0x84, 0x12, 0x200001c0, 4);
    break;
  }
}
int main(void)
