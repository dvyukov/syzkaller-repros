// WARNING: ODEBUG bug in pppol2tp_release
// https://syzkaller.appspot.com/bug?id=5f4eae1a76c7c99bd2ad
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    NONFAILING(*(uint16_t*)0x20000140 = 0x18);
    NONFAILING(*(uint32_t*)0x20000142 = 1);
    NONFAILING(*(uint32_t*)0x20000146 = 0);
    NONFAILING(*(uint32_t*)0x2000014a = -1);
    NONFAILING(*(uint16_t*)0x2000014e = 2);
    NONFAILING(*(uint16_t*)0x20000150 = 0);
    NONFAILING(*(uint16_t*)0x20000152 = 0);
    NONFAILING(*(uint16_t*)0x20000154 = 0);
    NONFAILING(*(uint16_t*)0x20000156 = 0xa);
    NONFAILING(*(uint16_t*)0x20000158 = htobe16(0));
    NONFAILING(*(uint32_t*)0x2000015a = htobe32(0));
    NONFAILING(memcpy(
        (void*)0x2000015e,
        " \001\000\000\000\000\000\000\000\000\000\000\000\000\000\000", 16));
    NONFAILING(*(uint32_t*)0x2000016e = 0);
    syscall(__NR_connect, r[1], 0x20000140ul, 0x32ul);
    break;
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_ioctl, r[0], 0x8901, 0ul);
    break;
  case 6:
    res = syscall(__NR_socket, 0x18ul, 1ul, 1);
    if (res != -1)
  ...
  case 7:
    ...
    NONFAILING(memcpy(
        ...
        " \001\000\000\000\000\000\000\000\000\000\000\000\000\000\000", 16));
    NONFAILING(*(uint32_t*)0x2000016e = 0);
    syscall(__NR_connect, r[3], 0x20000140ul, 0x32ul);
    break;
  case 8:
    syscall(__NR_kcmp, 0, r[2], 4ul, r[3], -1);
    break;
  }
}
int main(void)
