...
// https://syzkaller.appspot.com/bug?id=29b33f3f410e564731f1
// status:2
...
void loop(void)
{
  ...
  *(uint16_t*)0x200002c8 = 0x458;
  *(uint16_t*)0x200002ca = 0x5013;
  ...
  *(uint8_t*)0x200002df = 0x49;
  *(uint8_t*)0x200002e0 = 3;
  ...
  *(uint16_t*)0x200002eb = 0x1dc;
  *(uint8_t*)0x200002ed = 9;
  *(uint8_t*)0x200002ee = 5;
  *(uint8_t*)0x200002ef = 0x81;
  *(uint8_t*)0x200002f0 = 3;
  *(uint16_t*)0x200002f1 = 0;
  *(uint8_t*)0x200002f3 = 0;
  *(uint8_t*)0x200002f4 = 0;
  *(uint8_t*)0x200002f5 = 0;
  res = syz_usb_connect(0, 0x36, 0x200002c0, 0);
  if (res != -1)
    r[0] = res;
  syz_usb_control_io(r[0], 0, 0);
  *(uint32_t*)0x20000140 = 0x2c;
  *(uint64_t*)0x20000144 = 0x20000200;
  memcpy((void*)0x20000200, "\x00\x10\xb8\x03", 4);
