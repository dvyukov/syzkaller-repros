...
// https://syzkaller.appspot.com/bug?id=13010b6a10bbd82cc79c
// status:0
...
void execute_call(int call)
{
  ...
  case 9:
    ...
    break;
  case 10:
    NONFAILING(memcpy((void*)0x200000c0, "syz1", 4));
    syscall(__NR_write, r[2], 0x200000c0ul, 4ul);
    break;
  case 11:
  ...
  case 13:
    ...
    break;
  case 14:
    syscall(__NR_ioctl, -1, 0x6612, 0);
    break;
  case 15:
    NONFAILING(*(uint32_t*)0x20000180 = 0);
    syscall(__NR_getsockopt, -1, 1, 0x41, 0ul, 0x20000180ul);
    break;
  }
}
int main(void)
