...
// https://syzkaller.appspot.com/bug?id=d702fd2351989927037c
// status:0
...
void execute_call(int call)
{
  ...
  case 5:
    ...
    *(uint32_t*)0x20000554 = r[3];
    memcpy((void*)0x20000558, "\x00\x00\x00\x00\x00\x00\x00\x00\x28\x00\x12\x00"
                              "\x0c\x00\x01\x00\x76\x65\x74\x68",
           20);
  ...
  case 6:
    ...
    *(uint16_t*)0x20000264 = 9;
    *(uint16_t*)0x20000266 = 1;
    memcpy((void*)0x20000268, "vlan\000", 5);
    *(uint16_t*)0x20000270 = 0x18;
    ...
    *(uint16_t*)0x20000274 = 6;
    *(uint16_t*)0x20000276 = 1;
    *(uint16_t*)0x20000278 = 0;
    *(uint16_t*)0x2000027c = 0xc;
    *(uint16_t*)0x2000027e = 2;
    *(uint32_t*)0x20000280 = 0;
    *(uint32_t*)0x20000284 = 0xd;
    *(uint16_t*)0x20000288 = 8;
    *(uint16_t*)0x2000028a = 5;
    *(uint32_t*)0x2000028c = r[3];
  ...
  case 10:
    ...
    *(uint64_t*)0x20000280 = 0x20000080;
    memcpy((void*)0x20000080, "\x20\x00\x00\x00\x11\x00\x25\x19\x00\xb1\x00\x00"
                              "\x00\x00\x00\x00\x10\x00\x00\x00",
           20);
    *(uint32_t*)0x20000094 = r[6];
    *(uint64_t*)0x20000288 = 0x20;
