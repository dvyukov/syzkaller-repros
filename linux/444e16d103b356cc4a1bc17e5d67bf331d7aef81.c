...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    *(uint32_t*)0x20000140 = 0xf;
    *(uint32_t*)0x20000144 = 0;
    *(uint32_t*)0x20000148 = 0x81;
    *(uint32_t*)0x2000014c = 5;
    *(uint32_t*)0x20000150 = 0x39;
    *(uint32_t*)0x20000154 = -1;
    *(uint32_t*)0x20000158 = 0x88f;
    ...
    *(uint8_t*)0x2000016b = 0;
    syscall(__NR_bpf, 0, 0x20000140, 0x2c);
    break;
  case 1:
    *(uint32_t*)0x20000400 = 0xe;
    ...
    *(uint8_t*)0x2000042b = 0;
    res = syscall(__NR_bpf, 0, 0x20000400, 0x2c);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
    ...
    *(uint64_t*)0x20000210 = 0x200001c0;
    memcpy((void*)0x200001c0, "\x0b", 1);
    *(uint64_t*)0x20000218 = 0;
    syscall(__NR_bpf, 2, 0x20000200, 0x20);
    break;
  }
}
