...
// https://syzkaller.appspot.com/bug?id=64d6789c6c3f8fc6e3801d20ceb2541525c7be3c
// status:fixed
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x20000484 = 0x23;
  *(uint8_t*)0x20000485 = 0x48;
  *(uint8_t*)0x20000486 = 0x1f;
  *(uint8_t*)0x20000487 = 8;
  *(uint16_t*)0x20000488 = 0x4fa;
  *(uint16_t*)0x2000048a = 0x2490;
  *(uint16_t*)0x2000048c = 0x74f9;
  ...
  *(uint8_t*)0x2000049d = 0x1c;
  *(uint8_t*)0x2000049e = 0;
  *(uint8_t*)0x2000049f = 0;
  *(uint8_t*)0x200004a0 = 2;
  *(uint8_t*)0x200004a1 = 0x6a;
  *(uint8_t*)0x200004a2 = 0xae;
  *(uint8_t*)0x200004a3 = 0;
  res = syz_usb_connect(3, 0x24, 0x20000480, 0);
  if (res != -1)
    r[0] = res;
