...
void execute_call(int call)
{
  ...
  case 3:
    NONFAILING(
        memcpy((void*)0x20000280, "ip6_vti0\000 \000\000\000\000\000\000", 16));
    syscall(__NR_setsockopt, r[1], 1, 0x19, 0x20000280, 0xfd7a);
    break;
  case 4:
    NONFAILING(*(uint16_t*)0x20000080 = 2);
    NONFAILING(*(uint16_t*)0x20000082 = htobe16(0));
    NONFAILING(*(uint8_t*)0x20000084 = 0xac);
    NONFAILING(*(uint8_t*)0x20000085 = 0x1e);
  ...
  case 5:
    NONFAILING(memcpy((void*)0x200002c0,
                      "\x60\x00\x00\x01\x00\x00\x00\x00\x00\x0a\x00\x00\x00\x00"
                      "\x00\x00\x00\x00\x00\x00",
                      20));
    syscall(__NR_write, r[0], 0x200002c0, 0x14);
    break;
  }
}
int main(void)
