...
// https://syzkaller.appspot.com/bug?id=db39e0cfce102e04e0e7078cbc788c4d52760ad6
// status:fixed
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    res = syscall(__NR_socket, 1ul, 5ul, 0ul);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    res = syscall(__NR_socket, 1ul, 1ul, 0ul);
    if (res != -1)
      r[1] = res;
    break;
  case 2:
  ...
  case 6:
    ...
    break;
  case 7:
    syscall(__NR_utimensat, r[2], 0ul, 0ul, 0x100ul);
    break;
  case 8:
  ...
  case 11:
    ...
    break;
  case 12:
    res = syscall(__NR_accept4, r[3], 0ul, 0ul, 0ul);
    if (res != -1)
      r[4] = res;
    break;
  case 13:
    syscall(__NR_setsockopt, r[4], 0x10eul, 3ul, 0ul, 0ul);
    break;
  case 14:
  ...
  case 15:
    ...
    break;
  case 16:
    syscall(__NR_ioctl, r[6], 0xb702ul, 0ul);
    break;
  case 17:
    syscall(__NR_ioctl, r[5], 0x8901ul, 0ul);
    break;
  case 18:
  ...
  case 19:
    ...
    break;
  case 20:
    res = syz_open_pts(r[7], 0);
    if (res != -1)
      r[8] = res;
    break;
  case 21:
    syscall(__NR_fchown, r[8], 0, 0);
    break;
  case 22:
    syz_open_pts(r[8], 0x50b300);
    break;
  }
}
int main(void)
