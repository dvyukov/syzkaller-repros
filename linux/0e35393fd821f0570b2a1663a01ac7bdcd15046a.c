...
void execute_one(void)
{
  ...
  *(uint8_t*)0x20000004 = 0x36;
  *(uint8_t*)0x20000005 = 0x9e;
  *(uint8_t*)0x20000006 = 0xe2;
  *(uint8_t*)0x20000007 = 8;
  *(uint16_t*)0x20000008 = 0x8ca;
  *(uint16_t*)0x2000000a = 0x22;
  *(uint16_t*)0x2000000c = 0x6d4a;
  ...
  *(uint8_t*)0x2000001d = 0xed;
  *(uint8_t*)0x2000001e = 0;
  *(uint8_t*)0x2000001f = 1;
  *(uint8_t*)0x20000020 = 0xc3;
  *(uint8_t*)0x20000021 = 0xf1;
  *(uint8_t*)0x20000022 = 0x60;
  *(uint8_t*)0x20000023 = 0;
  *(uint8_t*)0x20000024 = 7;
  *(uint8_t*)0x20000025 = 5;
  *(uint8_t*)0x20000026 = 0x83;
  *(uint8_t*)0x20000027 = 0xfe;
  *(uint16_t*)0x20000028 = 0xff;
  *(uint8_t*)0x2000002a = 0xfe;
  *(uint8_t*)0x2000002b = 0;
  *(uint8_t*)0x2000002c = 0;
  syz_usb_connect(5, 0x2d, 0x20000000, 0);
}
int main(void)
{
