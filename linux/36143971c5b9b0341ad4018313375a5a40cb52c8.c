...
void execute_one(void)
{
  ...
  *(uint16_t*)0x20000008 = 0x46d;
  *(uint16_t*)0x2000000a = 0xc29c;
  ...
  *(uint8_t*)0x20000035 = 0;
  res = syz_usb_connect(0, 0x1d1, 0x20000000, 0);
  if (res != -1)
    r[0] = res;
  syz_usb_control_io(r[0], 0, 0);
  *(uint32_t*)0x20000300 = 0xffffffcc;
  *(uint64_t*)0x20000304 = 0;
  *(uint64_t*)0x2000030c = 0;
  *(uint64_t*)0x20000314 = 0;
  *(uint64_t*)0x2000031c = 0x20000480;
  *(uint8_t*)0x20000480 = 0;
  *(uint8_t*)0x20000481 = 0x22;
  *(uint32_t*)0x20000482 = 0x29;
  STORE_BY_BITMASK(uint8_t, , 0x20000486, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000486, 0, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000486, 0, 4, 4);
  memcpy((void*)0x20000487, "\xc9\x09\x52\xc8", 4);
  ...
  *(uint64_t*)0x200001f4 = 0;
  *(uint64_t*)0x200001fc = 0;
  *(uint64_t*)0x20000204 = 0;
  *(uint64_t*)0x2000020c = 0;
  *(uint64_t*)0x20000214 = 0;
  *(uint64_t*)0x2000021c = 0;
  *(uint64_t*)0x20000224 = 0;
  *(uint64_t*)0x2000022c = 0;
  *(uint64_t*)0x20000234 = 0;
  *(uint64_t*)0x2000023c = 0;
  *(uint64_t*)0x20000244 = 0;
  syz_usb_control_io(r[0], 0x20000300, 0x20000180);
  memcpy((void*)0x20000040, "/dev/hidraw#\000", 13);
  syz_open_dev(0x20000040, 9, 0x800);
}
int main(void)
{
