// INFO: rcu detected stall in ext4_file_write_iter (4)
// https://syzkaller.appspot.com/bug?id=03464269af631f4a4bdf
// status:2
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000288 = 0x20000009;
  syscall(__NR_prlimit64, 0, 0xeul, 0x20000280ul, 0ul);
  *(uint32_t*)0x20000200 = 0x38;
  ...
  *(uint32_t*)0x20000234 = 0;
  syscall(__NR_sched_setattr, 0, 0x20000200ul, 0ul);
  ...
  if (res != -1)
    r[1] = res;
  syscall(__NR_fallocate, r[1], 0x20ul, 0ul, 0xfffffeff000ul);
  memcpy((void*)0x200000c0, "./bus\000", 6);
  res = syscall(__NR_open, 0x200000c0ul, 0ul, 0ul);
  if (res != -1)
    r[2] = res;
  syscall(__NR_sendfile, r[0], r[2], 0ul, 0x8400fffffffaul);
}
int main(void)
{
