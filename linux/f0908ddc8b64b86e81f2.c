...
// https://syzkaller.appspot.com/bug?id=f0908ddc8b64b86e81f2
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000148 = 0x2710;
  syscall(__NR_setsockopt, r[0], 1, 0x15, 0x20000140ul, 0x10ul);
  *(uint16_t*)0x200000c0 = 0x1f;
  *(uint16_t*)0x200000c2 = 0;
  *(uint16_t*)0x200000c4 = 0;
  syscall(__NR_connect, r[0], 0x200000c0ul, 0x80ul);
}
int main(void)
{
