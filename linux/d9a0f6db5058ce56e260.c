// WARNING in fixup_exception
// https://syzkaller.appspot.com/bug?id=d9a0f6db5058ce56e260
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_ioctl, r[0], 0xaf01, 0ul);
    break;
  case 2:
    NONFAILING(memcpy((void*)0x200005c0, "/dev/net/tun\000", 13));
  ...
  case 3:
    ...
    syscall(__NR_ioctl, r[0], 0x4028af11, 0x20000040ul);
    break;
  case 4:
    NONFAILING(*(uint64_t*)0x20000100 = 0x300000000);
    syscall(__NR_ioctl, r[0], 0x4008af00, 0x20000100ul);
    break;
  case 5:
    ...
    NONFAILING(*(uint8_t*)0x20000320 = 3);
    NONFAILING(*(uint8_t*)0x20000321 = 2);
    syscall(__NR_write, r[0], 0x20000300ul, 0x48ul);
    break;
  case 6:
  ...
  case 7:
    ...
    syscall(__NR_ioctl, r[0], 0x4008af03, 0x200001c0ul);
    break;
  case 8:
    NONFAILING(*(uint32_t*)0x20000000 = 0);
    NONFAILING(*(uint32_t*)0x20000004 = r[2]);
    syscall(__NR_ioctl, r[0], 0x4008af30, 0x20000000ul);
    break;
  case 9:
    NONFAILING(memset((void*)0x20000040, 0, 16));
    NONFAILING(*(uint32_t*)0x20000050 = 4);
    NONFAILING(*(uint8_t*)0x20000054 = 2);
    NONFAILING(*(uint8_t*)0x20000055 = 2);
    NONFAILING(*(uint16_t*)0x20000056 = 6);
    NONFAILING(*(uint16_t*)0x20000058 = 0xfff8);
    NONFAILING(*(uint16_t*)0x2000005a = 4);
    NONFAILING(*(uint32_t*)0x2000005c = 0);
    syscall(__NR_setsockopt, r[2], 0x29, 0x20, 0x20000040ul, 0ul);
    break;
  }
}
int main(void)
