...
// https://syzkaller.appspot.com/bug?id=12cf5fbfdeba210a89dd
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    NONFAILING(*(uint32_t*)0x20000200 = 0xc8);
    ...
    NONFAILING(*(uint16_t*)0x2000021c = 0xc);
    NONFAILING(*(uint16_t*)0x2000021e = 6);
    NONFAILING(*(uint64_t*)0x20000220 = 2);
    NONFAILING(*(uint16_t*)0x20000228 = 0x3c);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x2000022a, 0x25, 0, 14));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x2000022b, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x2000022b, 1, 7, 1));
    NONFAILING(*(uint16_t*)0x2000022c = 0x24);
    NONFAILING(*(uint16_t*)0x2000022e = 3);
    NONFAILING(memcpy(
        (void*)0x20000230,
        "\x3c\xf8\x48\xb0\x87\xc6\x72\x74\xe8\x5f\x5d\x3c\xe4\xba\xf3\x07\xf0"
        "\x6d\x1e\x70\x4a\x1c\xcc\xf9\xf2\x4b\x6b\xce\x07\xc3\xb8\x6a",
        32));
    NONFAILING(*(uint16_t*)0x20000250 = 5);
    NONFAILING(*(uint16_t*)0x20000252 = 2);
    NONFAILING(*(uint8_t*)0x20000254 = 4);
    NONFAILING(*(uint16_t*)0x20000258 = 5);
    NONFAILING(*(uint16_t*)0x2000025a = 2);
    ...
    NONFAILING(*(uint16_t*)0x2000026c = 0xc);
    NONFAILING(*(uint16_t*)0x2000026e = 6);
    NONFAILING(*(uint64_t*)0x20000270 = 0x300000003);
    NONFAILING(*(uint16_t*)0x20000278 = 8);
    NONFAILING(*(uint16_t*)0x2000027a = 3);
    NONFAILING(*(uint32_t*)0x2000027c = 0);
    NONFAILING(*(uint16_t*)0x20000280 = 0xc);
    NONFAILING(*(uint16_t*)0x20000282 = 6);
    NONFAILING(*(uint64_t*)0x20000284 = 0x100000001);
    NONFAILING(*(uint16_t*)0x2000028c = 0x3c);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x2000028e, 0x25, 0, 14));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x2000028f, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x2000028f, 1, 7, 1));
    NONFAILING(*(uint16_t*)0x20000290 = 0x14);
    NONFAILING(*(uint16_t*)0x20000292 = 4);
    NONFAILING(memcpy(
        (void*)0x20000294,
        "\x66\x00\xb1\x8d\xfd\x63\xeb\x0f\xae\xce\x9f\x0e\x1d\xa3\xec\xa3",
        16));
    NONFAILING(*(uint16_t*)0x200002a4 = 5);
    NONFAILING(*(uint16_t*)0x200002a6 = 2);
    NONFAILING(*(uint8_t*)0x200002a8 = 0);
    NONFAILING(*(uint16_t*)0x200002ac = 0x1c);
    ...
    NONFAILING(*(uint16_t*)0x200002b2 = 4);
    NONFAILING(*(uint32_t*)0x200002b4 = 0);
    NONFAILING(*(uint16_t*)0x200002b8 = 8);
    NONFAILING(*(uint16_t*)0x200002ba = 1);
    NONFAILING(*(uint32_t*)0x200002bc = 2);
    NONFAILING(*(uint16_t*)0x200002c0 = 5);
    NONFAILING(*(uint16_t*)0x200002c2 = 2);
    NONFAILING(*(uint8_t*)0x200002c4 = 0);
    NONFAILING(*(uint64_t*)0x20000488 = 0xc8);
