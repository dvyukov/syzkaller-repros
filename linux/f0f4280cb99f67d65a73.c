...
// https://syzkaller.appspot.com/bug?id=f0f4280cb99f67d65a73
// status:6
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000000, "mountinfo\000", 10));
    res = -1;
    NONFAILING(res = syz_open_procfs(0, 0x20000000));
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_epoll_ctl, r[1], 1ul, r[0], 0ul);
    break;
  case 3:
    res = syscall(__NR_epoll_create, 0x410b24f);
    if (res != -1)
      r[2] = res;
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000140, "/dev/null\000", 10));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000140ul, 0x101000ul,
                  0ul);
    if (res != -1)
      r[3] = res;
    break;
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_setsockopt, r[3], 0x28, 6, 0ul, 0ul);
    break;
  case 7:
    res = syscall(__NR_epoll_create, 7);
    if (res != -1)
  ...
  case 8:
    ...
    syscall(__NR_epoll_ctl, r[2], 1ul, r[0], 0x20000080ul);
    break;
  case 9:
    ...
    break;
  case 10:
    syscall(__NR_setsockopt, r[5], 6, 9, 0ul, 0ul);
    break;
  case 11:
    syscall(__NR_connect, r[5], 0ul, 0ul);
    break;
  case 12:
    syscall(__NR_getsockopt, r[5], 6, 0x1e, 0ul, 0ul);
    break;
  case 13:
    NONFAILING(*(uint32_t*)0x2050aff4 = 0);
    NONFAILING(*(uint64_t*)0x2050aff8 = 0);
    syscall(__NR_epoll_ctl, r[4], 1ul, r[2], 0x2050aff4ul);
    break;
  }
}
int main(void)
