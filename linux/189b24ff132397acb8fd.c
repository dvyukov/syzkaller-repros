...
// https://syzkaller.appspot.com/bug?id=189b24ff132397acb8fd
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    *(uint32_t*)0x20000358 = -1;
    ...
    res = -1;
    res = syz_io_uring_setup(0x7760, 0x20000340, 0x20ee8000, 0x20eea000,
  ...
  case 3:
    ...
    *(uint8_t*)0x20000210 = 0;
    memset((void*)0x20000211, 0, 19);
    syscall(__NR_ioctl, r[3], 0x40045431, 0x20000200ul);
    break;
  case 4:
    res = -1;
    res = syz_open_pts(r[3], 0);
    if (res != -1)
      r[4] = res;
    break;
  case 5:
