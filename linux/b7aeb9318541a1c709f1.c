...
// https://syzkaller.appspot.com/bug?id=b7aeb9318541a1c709f1
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(syz_mount_image(0x20000000, 0, 0x200000, 0, 0, 0, 0x20014a00));
    break;
  case 1:
    NONFAILING(memcpy((void*)0x200000c0, "./file0\000", 8));
    syscall(__NR_setxattr, 0x200000c0ul, 0ul, 0ul, 0ul, 0ul);
    break;
  }
}
int main(void)
