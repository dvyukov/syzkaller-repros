...
// https://syzkaller.appspot.com/bug?id=d73594a6f633cc42ce6ca6a018d6c55b3e751b03
// status:open
...
{
  intptr_t res = 0;
  memcpy((void*)0x20000340, "/dev/infiniband/rdma_cm\000", 24);
  res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000340, 2, 0);
  if (res != -1)
    r[0] = res;
