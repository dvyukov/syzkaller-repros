...
{
  long res = 0;
  memcpy((void*)0x20000080, "xfs", 4);
  memcpy((void*)0x20000240, "./file0", 8);
  memcpy((void*)0x20001740, "nouuid,", 7);
  memcpy((void*)0x20001747, "grpquota", 8);
  *(uint8_t*)0x2000174f = 0x2c;
  memcpy((void*)0x20001750, "largeio", 7);
  *(uint8_t*)0x20001757 = 0x2c;
  memcpy((void*)0x20001758, "uquota", 6);
  *(uint8_t*)0x2000175e = 0x2c;
  memcpy((void*)0x2000175f, "nobarrier", 9);
  *(uint8_t*)0x20001768 = 0x2c;
  memcpy((void*)0x20001769, "rtdev", 5);
  *(uint8_t*)0x2000176e = 0x3d;
  memcpy((void*)0x2000176f, "./file0", 8);
  *(uint8_t*)0x20001777 = 0x2c;
  *(uint8_t*)0x20001778 = 0;
  syz_mount_image(0x20000080, 0x20000240, 0, 0, 0x20001680, 0, 0x20001740);
  memcpy((void*)0x20000040, "./cgroup", 9);
  res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000040, 0x200002, 0);
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x20000100, "memory.high", 12);
  res = syscall(__NR_openat, r[0], 0x20000100, 2, 0);
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x20000000, "khreaded", 9);
