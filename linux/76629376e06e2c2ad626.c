...
// https://syzkaller.appspot.com/bug?id=76629376e06e2c2ad626
// status:0
...
void execute_call(int call)
{
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000840, "/dev/bus/usb/00#/00#\000", 21));
    NONFAILING(syz_open_dev(0x20000840, 0x90f, 0x28101));
    break;
  case 1:
