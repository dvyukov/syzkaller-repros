...
// https://syzkaller.appspot.com/bug?id=1f68113fa907bf0695a8
// status:0
...
void execute_one(void)
{
  intptr_t res = 0;
  res = -1;
  NONFAILING(res = syz_init_net_socket(0x24, 3, 0));
  if (res != -1)
    r[0] = res;
  NONFAILING(memcpy((void*)0x20001340, "\xf1\x3a\x93\xd7\xff\x35\x47\x23", 8));
  syscall(__NR_sendto, r[0], 0x20001340ul, 8ul, 0ul, 0ul, 0ul);
}
int main(void)
{
