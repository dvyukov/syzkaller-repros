...
// https://syzkaller.appspot.com/bug?id=df97e3c33b1571fd171218075b5cf102a63682cc
// status:open
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    NONFAILING(*(uint32_t*)0x20000248 = 0x2000);
    ...
    syscall(__NR_sendmsg, -1, 0x20000380ul, 0x659d2369f0013242ul);
    break;
  case 4:
    syscall(__NR_recvmmsg, -1, 0x20008880ul, 0x400000000000249ul, 0ul, 0ul);
    break;
  case 5:
    res = syscall(__NR_pipe, 0x20000440ul);
    if (res != -1) {
      NONFAILING(r[1] = *(uint32_t*)0x20000440);
      NONFAILING(r[2] = *(uint32_t*)0x20000444);
    }
    break;
  case 6:
    ...
    break;
  case 7:
    syscall(__NR_write, r[2], 0x20000340ul, 0x41395527ul);
    break;
  case 8:
    ...
    break;
  case 9:
    syscall(__NR_perf_event_open, 0ul, 0, 0x800008000000003ul, -1, 0ul);
    break;
  case 10:
  ...
  case 11:
    ...
    break;
  case 12:
    res = syscall(__NR_ioctl, r[3], 0xae01ul, 0ul);
    if (res != -1)
      r[4] = res;
    break;
  case 13:
    ...
    syz_kvm_setup_cpu(-1, -1, 0x20e93000, 0x200000c0, 1, 0, 0, 0);
    break;
  case 14:
    NONFAILING(*(uint64_t*)0x200002c0 = 0x20000380);
    NONFAILING(memcpy(
        (void*)0x20000380,
        "\x9f\xeb\x01\x00\x18\x00\x00\x00\xea\xb8\xad\x0e\xb4\x31\xce\x00\x80"
        "\x00\x00\x00\x00\x00\x00\x04\x8c\x1f\x0b\x10\x6f\x95\x5a\xf1\xbc\x54"
        "\xed\x52\x46\xb0\x33\x9f\xb1\xc8\x21\x80\x0a\xc8\xcc\x9c\x83\xf4\xb2"
        "\x5f\x47\xe0\x71\x58\x03\x63\x06\x8b\xeb\x7f\x5b\x9e",
        64));
    NONFAILING(*(uint64_t*)0x200002c8 = 0);
    NONFAILING(*(uint32_t*)0x200002d0 = 0x40);
    NONFAILING(*(uint32_t*)0x200002d4 = 0);
    NONFAILING(*(uint32_t*)0x200002d8 = 0);
    syscall(__NR_bpf, 0x12ul, 0x200002c0ul, 0x20ul);
    break;
  case 15:
    res = syscall(__NR_ioctl, r[4], 0xae41ul, 0ul);
    if (res != -1)
      r[5] = res;
    break;
  case 16:
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000068, 0x8001, 1, 1));
  ...
  case 17:
    ...
    syscall(__NR_ioctl, r[4], 0x4020ae46ul, 0x20bf7000ul);
    break;
  case 18:
    ...
    NONFAILING(*(uint64_t*)0x20000230 = 0xff);
    ...
    syscall(__NR_ioctl, r[5], 0x4090ae82ul, 0x20000200ul);
    break;
  case 19:
    syscall(__NR_ioctl, r[5], 0xae80ul, 0ul);
    break;
  case 20:
