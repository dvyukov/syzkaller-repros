...
// https://syzkaller.appspot.com/bug?id=22b5ef302c7c40d94ea8
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint64_t*)0x20000048 = 0x200000000);
  ...
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_ioctl, r[0], 0x8912, 0x400200ul);
    break;
  case 4:
    syscall(__NR_sendmsg, r[0], 0ul, 0x40000ul);
    break;
  case 5:
    ...
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x20000500 = 0x200);
    NONFAILING(*(uint32_t*)0x20000504 = 3);
    NONFAILING(*(uint32_t*)0x20000508 = 0xfffffffe);
    NONFAILING(*(uint32_t*)0x2000050c = 0x10001);
    NONFAILING(*(uint8_t*)0x20000510 = 5);
    NONFAILING(memcpy((void*)0x20000511,
                      "\x40\x88\x2a\x9e\x39\x17\x78\x32\xc0\xd1\xf0\x89\x54\x37"
                      "\x5a\x29\x1f\xae\xe4",
                      19));
    NONFAILING(*(uint32_t*)0x20000524 = 0xf09);
    NONFAILING(*(uint32_t*)0x20000528 = 9);
    syscall(__NR_ioctl, -1, 0x402c542d, 0x20000500ul);
    break;
  case 7:
    NONFAILING(memcpy(
        (void*)0x20000080,
        "\x8d\xa0\x25\x01\x92\xf0\x9c\x09\xc7\xe7\x28\xd4\x92\x30\x53\x8d\x39"
        "\x3e\x69\x3b\x61\xda\xd5\x24\xe3\xed\xc4\x65\x22\xd1\xfd\x57\xc6\x52"
        "\x4c\x4f\x25\xa7\xd2\x2c\x25\xc7\x0c\x6c\xfe\xaf\x67\xf7\xec\x2a\xd0"
        "\x90\xf7\xe8\x82\xa0\x1c\x83\xa9\x62\xe1\xe3\xae\x8e\x29\xec\x71\xf5"
        "\x98\x11\xd4\xf8\xa4\x04\xdc\xeb\x9d\xaf\x59\x57\x79\x08\x38\x63\xcc"
        "\xa2\x6b\x2d\x81\x4f\x48\x61\x66\xbf\x58\x77\x70\x19\xc6\x41\x14\x91"
        "\xb9\x37\x25\x15\x16\xa5\x64\x85\x9e\x41\xcf\x82\x46\x3e\x89\xe4\x6a"
        "\x4e\xe4\x6a\x33\x2f\x83\x64\xb0\xf7\xac\x63\xba\x3a",
        132));
    NONFAILING(memcpy((void*)0x20000200, "./file0\000", 8));
    NONFAILING(memcpy((void*)0x20000b00, "nfs\000", 4));
    syscall(__NR_mount, 0x20000080ul, 0x20000200ul, 0x20000b00ul, 0x4000ul,
            0x20000000ul);
    break;
  case 8:
