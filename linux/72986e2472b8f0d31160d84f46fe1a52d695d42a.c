...
// https://syzkaller.appspot.com/bug?id=72986e2472b8f0d31160d84f46fe1a52d695d42a
// status:open
...
void loop(void)
{
  ...
  *(uint8_t*)0x20000084 = 0xab;
  *(uint8_t*)0x20000085 = 0xfc;
  *(uint8_t*)0x20000086 = 0xab;
  *(uint8_t*)0x20000087 = 8;
  *(uint16_t*)0x20000088 = 0x9c0;
  *(uint16_t*)0x2000008a = 0x206;
  *(uint16_t*)0x2000008c = 0xcec9;
  ...
  *(uint8_t*)0x200000a1 = 0xd0;
  *(uint8_t*)0x200000a2 = 0xce;
  *(uint8_t*)0x200000a3 = 0;
  syz_usb_connect(2, 0x24, 0x20000080, 0);
  close_fds();
}
int main(void)
{
