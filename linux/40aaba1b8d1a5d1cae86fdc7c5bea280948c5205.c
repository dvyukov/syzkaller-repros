...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    NONFAILING(*(uint64_t*)0x20000100 = 0x20006000);
    ...
    NONFAILING(*(uint32_t*)0x20000108 = 0x80);
    NONFAILING(*(uint64_t*)0x20000110 = 0x20007f80);
    NONFAILING(*(uint64_t*)0x20007f80 = 0x200001c0);
    NONFAILING(memcpy((void*)0x200001c0, "\xde", 1));
    NONFAILING(*(uint64_t*)0x20007f88 = 1);
  ...
  case 4:
    ...
    NONFAILING(*(uint32_t*)0x20000284 = 0x77);
    NONFAILING(memcpy(
        (void*)0x20000288,
        "\x25\xe3\x60\x89\x5e\xbf\x09\x2a\x2a\x86\x3a\x16\xb0\xc5\x55\xf9\x57"
        "\x8f\x75\x94\x83\xcc\x12\x73\x58\xbf\xaf\x5c\x33\xec\xbd\x06\x76\x52"
        "\x5a\x25\xb1\x01\x03\x9c\xdc\x79\xd8\xc1\xef\x1c\xc4\xaf\x7a\x68\xe4"
        "\x07\x99\xe1\x90\x8c\x6a\x32\x2a\xb8\xe5\x54\x6e\x68\x5e\x52\x5a\x92"
        "\x4a\x89\x81\xc1\x9e\xdc\x0e\x85\x69\x5e\x36\xb4\xf3\x8e\x72\xa0\x22"
        "\xe8\xd6\xc1\x86\x0d\xdd\x96\xd3\xae\xe8\x43\x47\x8e\x83\x04\x8f\x19"
        "\xab\x07\x6f\x38\x2e\x3f\x10\x09\xe4\x7d\xe1\xa1\xe4\xe7\x6e\xab\x1e",
        119));
    syscall(__NR_getsockopt, r[1], 0x84, 0x6c, 0x20000280, 0);
    break;
  }
}
int main(void)
