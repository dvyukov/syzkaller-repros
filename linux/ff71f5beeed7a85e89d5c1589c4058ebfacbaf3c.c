...
// https://syzkaller.appspot.com/bug?id=ff71f5beeed7a85e89d5c1589c4058ebfacbaf3c
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x200002c0, "/dev/infiniband/rdma_cm\000", 24));
  ...
  case 1:
    ...
    NONFAILING(*(uint64_t*)0x200005d0 = 0x20000600);
    NONFAILING(*(uint16_t*)0x200005d8 = 0x13f);
    ...
    res = syscall(__NR_write, r[0], 0x200005c0, 0x20);
    if (res != -1)
      NONFAILING(r[1] = *(uint32_t*)0x20000600);
    break;
  case 2:
    syscall(__NR_write, r[0], 0, 0);
    break;
  case 3:
    NONFAILING(*(uint32_t*)0x20000380 = 2);
    NONFAILING(*(uint16_t*)0x20000384 = 0x28);
    ...
    NONFAILING(*(uint32_t*)0x20000394 = htobe32(0x7fffffff));
    NONFAILING(*(uint8_t*)0x20000398 = -1);
    NONFAILING(*(uint8_t*)0x20000399 = 1);
    ...
    NONFAILING(*(uint8_t*)0x200003a7 = 1);
    NONFAILING(*(uint32_t*)0x200003a8 = 0);
    NONFAILING(*(uint32_t*)0x200003ac = r[1]);
    syscall(__NR_write, r[0], 0x20000380, 0x30);
    break;
  case 4:
