// WARNING in hid_alloc_report_buf
// https://syzkaller.appspot.com/bug?id=ab02336a647181a886a6
// status:0
...
int main(void)
{
  ...
  *(uint16_t*)0x200000c8 = 0xd8c;
  *(uint16_t*)0x200000ca = 0x22;
  ...
  *(uint32_t*)0x20000642 = 1;
  ...
  STORE_BY_BITMASK(uint8_t, , 0x20000646, 0xb, 4, 4);
  *(uint64_t*)0x200006dc = 0;
  syz_usb_control_io(r[0], 0x200006c0, 0);
  memcpy((void*)0x200000c0, "/dev/usb/hiddev#\000", 17);
  res = -1;
  ...
  *(uint32_t*)0x20000094 = 0;
  syscall(__NR_ioctl, r[1], 0x400c4808, 0x20000080ul);
  return 0;
}
