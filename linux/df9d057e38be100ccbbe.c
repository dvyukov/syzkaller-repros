...
// https://syzkaller.appspot.com/bug?id=df9d057e38be100ccbbe
// status:3
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    *(uint64_t*)0x20000270 = 0x4400;
    syz_mount_image(0x20000000, 0x20000440, 0x200003, 5, 0x20000200, 0,
                    0x200000c0);
    break;
  case 1:
    ...
    break;
  case 2:
    memcpy((void*)0x20000040, "clear_refs\000", 11);
    res = -1;
  ...
  case 3:
    ...
    *(uint8_t*)0x2000027b = 0;
    syscall(__NR_mount, 0ul, 0x20000300ul, 0x20000080ul, 0ul, 0x20000240ul);
    break;
  case 4:
  ...
  case 6:
    *(uint64_t*)0x20002080 = 0x1e;
    syscall(__NR_sendfile, r[3], r[2], 0x20002080ul, 0x262ul);
    break;
  }
}
int main(void)
