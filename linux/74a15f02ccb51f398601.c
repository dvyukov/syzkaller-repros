...
// https://syzkaller.appspot.com/bug?id=74a15f02ccb51f398601
// status:6
...
void execute_one(void)
{
  ...
  memcpy((void*)0x200020c0, "./file0\000", 8);
  memcpy((void*)0x20002100, "fuse\000", 5);
  memcpy((void*)0x200004c0, "fd=", 3);
  sprintf((char*)0x200004c3, "0x%016llx", (long long)r[0]);
  memcpy((void*)0x200004d5, ",rootmode=00000000000000000100000,user_id=", 42);
  sprintf((char*)0x200004ff, "%020llu", (long long)0);
  sprintf((char*)0x20000513, "%020llu", (long long)0);
  syscall(__NR_mount, 0ul, 0x200020c0ul, 0x20002100ul, 0ul, 0x200004c0ul);
}
int main(void)
{
