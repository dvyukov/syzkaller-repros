...
// https://syzkaller.appspot.com/bug?id=7f3e22297f1da1c61ae0a7733d20c95a25f6f0c0
// status:open
...
void loop(void)
{
  ...
  *(uint32_t*)0x200000e4 = 0;
  syscall(__NR_setsockopt, -1, 0ul, 0x23ul, 0x20000000ul, 0xe8ul);
  ...
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x20001840, "vcan0\000\000\000\000\000\000\000\000\000\000\000",
         16);
  *(uint32_t*)0x20001850 = 0;
  res = syscall(__NR_ioctl, r[1], 0x8933ul, 0x20001840ul);
  if (res != -1)
    r[2] = *(uint32_t*)0x20001850;
  ...
  *(uint64_t*)0x20000080 = 0x20000180;
  memcpy((void*)0x20000180, "\x34\x9e\xfd\x82\xfa\x01\xd0\xa4\xbc", 9);
  ...
  *(uint16_t*)0x200000c0 = 0x1d;
  *(uint16_t*)0x200000c2 = 0;
  *(uint32_t*)0x200000c4 = 0xe;
  *(uint32_t*)0x200000c8 = 0;
  *(uint32_t*)0x20000148 = 0x200000cc;
  ...
  *(uint64_t*)0x20000100 = 0x20000400;
  memcpy((void*)0x20000400, "\000\000\000\000", 4);
  *(uint16_t*)0x20000404 = 0;
  memcpy((void*)0x20000406,
         "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x06\x00\x00\x00\x51\xd2\x42"
         "\x36\xb6\x67\xf0\xd8\x8e\xbf\x72\x04\xec\xdc\xab\x35\xc3\x50\x80\x79"
         "\xe9\x23\x8e\x34\x21\xd4\x4c\x5a\xa2\x1e\x65\x2e\x94\x06\x26\x46\x57"
         "\x4c\xc4\xe7\x19\x3a\xb8\x12\xbc\x88\x7b",
         61);
  *(uint64_t*)0x20000108 = 0x1f3;
  *(uint64_t*)0x20000158 = 1;
  *(uint64_t*)0x20000160 = 0;
