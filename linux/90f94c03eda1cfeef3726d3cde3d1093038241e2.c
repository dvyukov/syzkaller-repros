...
// https://syzkaller.appspot.com/bug?id=90f94c03eda1cfeef3726d3cde3d1093038241e2
// status:open
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    memcpy((void*)0x20000180, "/dev/vsock\000", 11);
  ...
  case 5:
    ...
    *(uint16_t*)0x200007c2 = 0;
    *(uint16_t*)0x200007c4 = 1;
    syscall(__NR_bind, r[3], 0x200007c0ul, 6ul);
    break;
  }
}
int main(void)
