// INFO: task hung in ctrl_cdev_ioctl
// https://syzkaller.appspot.com/bug?id=ff2f56803049ffa34d8e2b0c0621d6c253329ff1
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_setsockopt, -1, 1ul, 0ul, 0ul, 0xe0ul);
    break;
  case 1:
  ...
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_ioctl, r[0], 0x40186f40ul, 0x76006eul);
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000080, "/dev/ubi_ctrl\000", 14));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000080ul, 0ul, 0ul);
    ...
    break;
  case 5:
    syscall(__NR_ioctl, r[1], 0x40046f41ul, 0x76006eul);
    break;
  }
}
int main(void)
