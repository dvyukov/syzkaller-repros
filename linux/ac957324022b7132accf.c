...
// https://syzkaller.appspot.com/bug?id=ac957324022b7132accf
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000040, "/dev/vim2m\000", 11));
    syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000040ul, 2ul, 0ul);
    break;
  case 2:
    NONFAILING(*(uint32_t*)0x20001504 = 0x96d5);
    NONFAILING(*(uint32_t*)0x20001508 = 2);
    NONFAILING(*(uint32_t*)0x2000150c = 4);
    NONFAILING(*(uint32_t*)0x20001510 = 0x66);
    NONFAILING(*(uint32_t*)0x20001518 = -1);
    NONFAILING(memset((void*)0x2000151c, 0, 12));
    res = -1;
    NONFAILING(res = syz_io_uring_setup(1, 0x20001500, 0x20ffe000, 0x20ee7000,
                                        0x20000100, 0x20000140));
    if (res != -1) {
      NONFAILING(r[0] = *(uint64_t*)0x20000100);
  ...
  case 3:
    ...
    NONFAILING(syz_io_uring_submit(r[0], r[1], 0x20000200, 0));
    break;
  }
}
int main(void)
