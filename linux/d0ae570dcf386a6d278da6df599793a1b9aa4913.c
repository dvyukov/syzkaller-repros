...
// https://syzkaller.appspot.com/bug?id=d0ae570dcf386a6d278da6df599793a1b9aa4913
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000000, "/selinux/avc/hash_stats\000", 24));
    syscall(__NR_openat, 0xffffffffffffff9c, 0x20000000, 0, 0);
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000140, "/dev/video#\000", 12));
    syz_open_dev(0x20000140, 0x3f, 0);
    break;
  case 2:
    NONFAILING(memcpy((void*)0x200000c0, "fd/4\000", 5));
    res = syz_open_procfs(0, 0x200000c0);
    if (res != -1)
      r[0] = res;
    break;
  case 3:
    syscall(__NR_read, r[0], 0x20000100, 0x8a);
    break;
  case 4:
