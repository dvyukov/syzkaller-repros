...
// https://syzkaller.appspot.com/bug?id=d448b63291df9f64b6bc
// status:0
...
void execute_one(void)
{
  ...
  memcpy((void*)0x20000100,
         "\x12\x01\x00\x00\x00\x00\x00\x08\x3a\x09\x01\x80\x00\x00\x00\x00\x00"
         "\x01\x09\x02\x24\x00\x01\x00\x00\x00\x00\x09\x04\x00\x00\x09\x03\x00"
         "\x00\x00\x09\x21\x13\x00\x00\x01\x22\x22\x00\x09\x05\x81\x03",
         49);
  res = -1;
  ...
  *(uint64_t*)0x200001d4 = 0x20000200;
  memcpy((void*)0x20000200, "\x00\x22\x22\x00\x00\x00\x07\x04\x0e\xcc\xf5\xa2"
                            "\x01\x10\x07\x20\x00\x17\x20\xa0\x0b\x00\x00\x00"
                            "\x00\xc3\xf7\x6e\x2b\x87\x07\xec\x6b\xef\x33\xc3",
         36);
