...
// https://syzkaller.appspot.com/bug?id=921b1c05b62b10255ce0107b9ac04a3528861d40
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_mbind, 0x20ffb000, 0x3000, 0, 0, 0, 2);
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000140, "/dev/kvm\x00", 9));
  ...
  case 3:
    ...
    break;
  case 4:
    syz_kvm_setup_cpu(r[1], r[2], 0x20fe8000, 0, 0, 0, 0, 0xfffffffffffffeec);
    break;
  case 5:
