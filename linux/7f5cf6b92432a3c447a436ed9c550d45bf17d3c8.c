...
// https://syzkaller.appspot.com/bug?id=7f5cf6b92432a3c447a436ed9c550d45bf17d3c8
// status:fixed
...
void loop(void)
{
  ...
  *(uint32_t*)0x20000000 = -1;
  syscall(__NR_setsockopt, r[0], 0x107, 0xf, 0x20000000, 0x2b5);
  *(uint64_t*)0x20000440 = 0x20000240;
  *(uint32_t*)0x20000448 = 0xfe7e;
  *(uint64_t*)0x20000450 = 0x20003840;
  *(uint64_t*)0x20003840 = 0x200004c0;
  *(uint64_t*)0x20003848 = 0x9e;
  *(uint64_t*)0x20003850 = 0x20001740;
  *(uint64_t*)0x20003858 = 0x1000;
  *(uint64_t*)0x20003860 = 0x20002740;
  *(uint64_t*)0x20003868 = 0x62;
  *(uint64_t*)0x20003870 = 0x200027c0;
  *(uint64_t*)0x20003878 = 0x1000;
  *(uint64_t*)0x20003880 = 0x200037c0;
  *(uint64_t*)0x20003888 = 0xfffffef3;
  *(uint64_t*)0x20000458 = 5;
  *(uint64_t*)0x20000460 = 0;
  *(uint64_t*)0x20000468 = 0;
  *(uint32_t*)0x20000470 = 0;
  syscall(__NR_recvmsg, -1, 0x20000440, 0);
  *(uint64_t*)0x20000480 = 0x200000c0;
  *(uint16_t*)0x200000c0 = 0x1100;
