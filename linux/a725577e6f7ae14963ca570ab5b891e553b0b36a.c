...
// https://syzkaller.appspot.com/bug?id=a725577e6f7ae14963ca570ab5b891e553b0b36a
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_mount, 0x20000000, 0, 0, 0, 0);
    break;
  case 1:
    syscall(__NR_pipe, 0);
    break;
  ...
  case 6:
    ...
    *(uint32_t*)0x20000198 = 0;
    syscall(__NR_sendto, r[0], 0, 0, 0x2404c8c1, 0x20000180, 0x1c);
    break;
  case 7:
    memcpy((void*)0x200003c0, "\xf8", 1);
    syscall(__NR_sendto, r[0], 0x200003c0, 0xffb3, 0x4000000, 0, 0);
    break;
  case 8:
  ...
  case 9:
    ...
    *(uint32_t*)0x20000098 = 0x40000;
    *(uint32_t*)0x2000009c = 0;
    *(uint16_t*)0x200000a0 = 8;
    *(uint16_t*)0x200000a2 = 0x1b;
  ...
  case 10:
    ...
    *(uint64_t*)0x2001d020 = 0;
    ...
    STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0, 2, 1);
    STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0, 3, 1);
    STORE_BY_BITMASK(uint64_t, , 0x2001d028, 1, 4, 1);
    STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0, 5, 1);
    STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0, 6, 1);
    STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0, 7, 1);
    STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0, 8, 1);
    ...
    STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0, 21, 1);
    STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0, 22, 1);
    STORE_BY_BITMASK(uint64_t, , 0x2001d028, 1, 23, 1);
    STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0, 24, 1);
    STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0, 25, 1);
    STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0, 26, 1);
    STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0, 27, 1);
    ...
    *(uint16_t*)0x2001d06e = 0;
    ...
    break;
  case 11:
    syscall(__NR_ioctl, -1, 0x894b, 0x20000100);
    break;
  }
}
int main(void)
