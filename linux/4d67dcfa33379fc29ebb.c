...
// https://syzkaller.appspot.com/bug?id=4d67dcfa33379fc29ebb
// status:0
...
void execute_call(int call)
{
  ...
  case 7:
    ...
    *(uint8_t*)0x20000107 = 0xa;
    syscall(__NR_sendto, r[3], 0ul, 0ul, 0x2400067eul, 0x20000100ul, 0x10ul);
    break;
  case 8:
