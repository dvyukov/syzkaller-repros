...
// https://syzkaller.appspot.com/bug?id=07d4348050896876d4b6585c2c0fe510eb262fa4
// status:open
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x200001d8 = 0;
  syscall(__NR_sendto, r[0], 0, 0, 0, 0x200001c0, 0x1c);
  res = syscall(__NR_socket, 0xa, 0x1000000000002, 0);
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x200000c0, "syz_tun\x00\x00\x00\x00\x00\x00\x00\x00\x00", 16);
  *(uint32_t*)0x200000d0 = 1;
  *(uint32_t*)0x200000d4 = -1;
  *(uint64_t*)0x200000d8 = 0;
  syscall(__NR_ioctl, r[1], 0x8943, 0x200000c0);
}
int main(void)
{
