...
// https://syzkaller.appspot.com/bug?id=cde43a581a8e5f317bc2
// status:0
...
uint64_t r[7] = {0xffffffffffffffff, 0xffffffffffffffff, 0x0, 0x0,
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x20000480, "802.15.4 MAC\000", 13);
  res = -1;
  res = syz_genetlink_get_family_id(0x20000480, r[0]);
  if (res != -1)
    r[2] = res;
  ...
  *(uint32_t*)0x200004c0 = 0x28;
  *(uint16_t*)0x200004c4 = r[2];
  *(uint16_t*)0x200004c6 = 1;
  *(uint32_t*)0x200004c8 = 0;
  *(uint32_t*)0x200004cc = 0;
  *(uint8_t*)0x200004d0 = 0x21;
  *(uint8_t*)0x200004d1 = 0;
  *(uint16_t*)0x200004d2 = 0;
  *(uint16_t*)0x200004d4 = 9;
  *(uint16_t*)0x200004d6 = 0x1f;
  memcpy((void*)0x200004d8, "phy1\000", 5);
  *(uint16_t*)0x200004e0 = 5;
  *(uint16_t*)0x200004e2 = 0x20;
  *(uint8_t*)0x200004e4 = 1;
  *(uint64_t*)0x20000508 = 0x28;
  ...
  *(uint32_t*)0x20000570 = 0;
  ...
  if (res != -1)
    r[5] = res;
  memcpy((void*)0x20000080, "wpan3\000\000\000\000\000\000\000\000\000\000\000",
         16);
  res = syscall(__NR_ioctl, r[5], 0x8933, 0x20000080ul);
  if (res != -1)
