...
// https://syzkaller.appspot.com/bug?id=c63745cb0e718ef69011
// status:0
...
void execute_one(void)
{
  ...
  memcpy((void*)0x20000040, "wlan1\000\000\000\000\000\000\000\000\000\000\000",
         16);
  res = syscall(__NR_ioctl, r[3], 0x8933, 0x20000040ul);
  if (res != -1)
    r[5] = *(uint32_t*)0x20000050;
  ...
  *(uint16_t*)0x20000086 = 0x21d;
  *(uint32_t*)0x20000088 = 0;
  *(uint32_t*)0x2000008c = 0;
  *(uint8_t*)0x20000090 = 0x37;
  *(uint8_t*)0x20000091 = 0;
  *(uint16_t*)0x20000092 = 0;
  *(uint16_t*)0x20000094 = 8;
  *(uint16_t*)0x20000096 = 3;
  *(uint32_t*)0x20000098 = r[5];
  *(uint16_t*)0x2000009c = 8;
  *(uint16_t*)0x2000009e = 0x57;
  *(uint32_t*)0x200000a0 = 0xc1e;
  *(uint16_t*)0x200000a4 = 8;
  *(uint16_t*)0x200000a6 = 0x26;
  *(uint32_t*)0x200000a8 = 0x96c;
