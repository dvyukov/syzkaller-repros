...
// https://syzkaller.appspot.com/bug?id=060f9ce2b428f88a288f
// status:0
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x200000f0 = 0xc001;
  syscall(__NR_sendmsg, r[3], 0x200000c0ul, 0x4000004ul);
  *(uint64_t*)0x20000340 = 0;
  *(uint32_t*)0x20000348 = 0;
  *(uint64_t*)0x20000350 = 0x20000300;
  ...
  *(uint16_t*)0x20000384 = r[1];
  memcpy((void*)0x20000386,
         "\x05\x00\x00\x00\x00\x00\x00\x00\x00\x00\x0f\x00\x00\x00\x08\x00\x03"
         "\x00",
         18);
