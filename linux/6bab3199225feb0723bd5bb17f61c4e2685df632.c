...
// https://syzkaller.appspot.com/bug?id=6bab3199225feb0723bd5bb17f61c4e2685df632
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    *(uint64_t*)0x20000020 = 0;
    ...
    STORE_BY_BITMASK(uint64_t, , 0x20000028, 4, 2, 1);
    ...
    *(uint64_t*)0x20000038 = 0xfffffffffffffffd;
