// memory leak in dev_exception_add
// https://syzkaller.appspot.com/bug?id=988c8a25ad1677559236
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(memcpy(
      (void*)0x20000500,
      "\x12\x01\x00\x00\x55\x20\xf0\x10\x40\x20\x38\xb1\x42\x01\x04\x00\x00\x01"
      "\x09\x02\x38\x00\x01\x00\x00\x00\x00\x09\x04\x00\x00\x03\x71\x05\x59\x00"
      "\x09\x05\x82\xef\x10\x00\x00\x00\x01\x02\x00\x09\x05\x02\x12",
      51));
  res = -1;
