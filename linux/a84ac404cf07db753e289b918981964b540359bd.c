...
// https://syzkaller.appspot.com/bug?id=a84ac404cf07db753e289b918981964b540359bd
// status:open
...
void execute_one(void)
{
  ...
  res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000640, 0, 0);
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x200000c0,
         "\x00\xac\x72\x00\x00\x00\x00\x00\xec\x97\x3f\x82\x0f\x7c\x40\x00",
         16);
  *(uint16_t*)0x200000d0 = 0x102;
  syscall(__NR_ioctl, r[0], 0x400454ca, 0x200000c0);
  syscall(__NR_ioctl, r[0], 0x400454cd, 0x30a);
  ...
  *(uint32_t*)0x200001d8 = 3;
  *(uint32_t*)0x200001dc = 0;
  *(uint16_t*)0x200001e0 = 8;
  *(uint16_t*)0x200001e2 = 0x1b;
