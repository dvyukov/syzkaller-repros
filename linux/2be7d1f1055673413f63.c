// general protection fault in loop_clr_fd (2)
// https://syzkaller.appspot.com/bug?id=2be7d1f1055673413f63
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(*(uint64_t*)0x2001d010 = 0x103);
  ...
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2001d028, 6, 36, 1));
  ...
  NONFAILING(*(uint64_t*)0x200001a8 = 0x600);
  NONFAILING(*(uint64_t*)0x200001b0 = 0);
  NONFAILING(*(uint64_t*)0x200001b8 = 0);
  NONFAILING(*(uint64_t*)0x200001c0 = 0x4000000000010e00);
  NONFAILING(syz_mount_image(0, 0, 0, 3, 0x20000180, 0, 0x20000240));
}
int main(void)
{
