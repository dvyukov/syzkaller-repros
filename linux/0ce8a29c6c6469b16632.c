...
// https://syzkaller.appspot.com/bug?id=0ce8a29c6c6469b16632
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    NONFAILING(*(uint16_t*)0x20000002 = 5);
    NONFAILING(memcpy((void*)0x20000004, "\x34\x0a\x9a", 3));
    NONFAILING(*(uint8_t*)0x20000007 = 0x20);
    NONFAILING(*(uint8_t*)0x20000008 = 6);
    syscall(__NR_ioctl, r[0], 0x800448f0, 0x20000000ul);
    break;
  case 3:
    res = -1;
    NONFAILING(res = syz_init_net_socket(0x1f, 1, 6));
    if (res != -1)
      r[1] = res;
    break;
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_ioctl, r[1], 0x400448c9, 0ul);
    break;
  case 6:
    res = -1;
    NONFAILING(res = syz_init_net_socket(0x1f, 1, 0));
    if (res != -1)
      r[2] = res;
    break;
  case 7:
    NONFAILING(*(uint32_t*)0x20000040 = 0x81);
    syscall(__NR_setsockopt, -1, 1, 0x1d, 0x20000040ul, 4ul);
    break;
  case 8:
    syscall(__NR_getsockopt, r[2], 0x112, 4, 0ul, 0x400000ul);
    break;
  case 9:
    NONFAILING(syz_init_net_socket(0x1f, 5, 0));
    break;
  case 10:
    syscall(__NR_accept4, r[1], 0x200001c0ul, 0ul, 0x800ul);
    break;
  case 11:
