...
// https://syzkaller.appspot.com/bug?id=0472f587206363fdf382
// status:0
...
void loop(void)
{
  ...
  syscall(__NR_socket, 0xaul, 0x40000080806ul, 0);
  ...
  NONFAILING(*(uint8_t*)0x20000192 = -1);
  NONFAILING(*(uint8_t*)0x20000193 = -1);
  NONFAILING(*(uint8_t*)0x20000194 = 0xac);
  NONFAILING(*(uint8_t*)0x20000195 = 0x14);
  NONFAILING(*(uint8_t*)0x20000196 = 0x14);
  NONFAILING(*(uint8_t*)0x20000197 = 0xbb);
  NONFAILING(*(uint32_t*)0x20000198 = 0);
  NONFAILING(*(uint16_t*)0x2000019c = 2);
  NONFAILING(*(uint16_t*)0x2000019e = htobe16(0));
  NONFAILING(*(uint8_t*)0x200001a0 = 0xac);
  NONFAILING(*(uint8_t*)0x200001a1 = 0x14);
  NONFAILING(*(uint8_t*)0x200001a2 = 0x14);
  NONFAILING(*(uint8_t*)0x200001a3 = 0xbb);
  syscall(__NR_setsockopt, r[0], 0x84, 0x64, 0x20000180ul, 0x2cul);
  ...
  NONFAILING(*(uint16_t*)0x20000010 = 2);
  NONFAILING(*(uint16_t*)0x20000012 = htobe16(0x4e22));
  ...
  syscall(__NR_setsockopt, r[0], 0x84, 0x6e, 0x20000000ul, 0x20ul);
  res = syscall(__NR_socket, 0xaul, 5ul, 0x84);
  if (res != -1)
    r[1] = res;
  NONFAILING(*(uint16_t*)0x20000180 = 0xa);
  ...
  NONFAILING(*(uint8_t*)0x20000195 = 0x14);
  NONFAILING(*(uint8_t*)0x20000196 = 0x14);
  NONFAILING(*(uint8_t*)0x20000197 = 0xaa);
  NONFAILING(*(uint32_t*)0x20000198 = 0);
  NONFAILING(*(uint16_t*)0x2000019c = 2);
  NONFAILING(*(uint16_t*)0x2000019e = htobe16(0));
  NONFAILING(*(uint8_t*)0x200001a0 = 0xac);
  ...
  NONFAILING(*(uint8_t*)0x200001a2 = 0x14);
  NONFAILING(*(uint8_t*)0x200001a3 = 0xbb);
  syscall(__NR_setsockopt, r[1], 0x84, 0x64, 0x20000180ul, 0x2cul);
  NONFAILING(*(uint16_t*)0x20000000 = 2);
  NONFAILING(*(uint16_t*)0x20000002 = htobe16(0x4e22));
  NONFAILING(*(uint8_t*)0x20000004 = 0xac);
  NONFAILING(*(uint8_t*)0x20000005 = 0x14);
  ...
  NONFAILING(*(uint8_t*)0x20000016 = 0x14);
  NONFAILING(*(uint8_t*)0x20000017 = 0xaa);
  syscall(__NR_setsockopt, r[1], 0x84, 0x6e, 0x20000000ul, 0x20ul);
  close_fds();
}
int main(void)
{
