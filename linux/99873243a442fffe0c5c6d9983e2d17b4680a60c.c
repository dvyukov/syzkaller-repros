...
// https://syzkaller.appspot.com/bug?id=99873243a442fffe0c5c6d9983e2d17b4680a60c
// status:fixed
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000100, "/dev/bus/usb/00#/00#", 21));
    res = syz_open_dev(0x20000100, 0x80000000005, 1);
    if (res != -1)
      r[2] = res;
    break;
  case 3:
    NONFAILING(*(uint32_t*)0x20000040 = 0);
    NONFAILING(*(uint16_t*)0x20000044 = 0xa);
    NONFAILING(*(uint16_t*)0x20000046 = htobe16(0x4e23));
    NONFAILING(*(uint32_t*)0x20000048 = 0x81);
    ...
    NONFAILING(*(uint32_t*)0x20000058 = htobe32(-1));
    NONFAILING(*(uint32_t*)0x2000005c = 0x977a);
    NONFAILING(*(uint32_t*)0x20000140 = 0x84);
    res = syscall(__NR_getsockopt, r[2], 0x84, 6, 0x20000040, 0x20000140);
    if (res != -1)
  ...
  case 4:
    ...
    NONFAILING(*(uint32_t*)0x20000200 = 8);
    syscall(__NR_getsockopt, r[1], 0x84, 0x6d, 0x20000180, 0x20000200);
    break;
  case 5:
    syscall(__NR_ioctl, r[2], 0x4b70, 0x20000000);
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x200001c0 = 0);
    NONFAILING(*(uint32_t*)0x200001c4 = 0x5517);
    NONFAILING(*(uint32_t*)0x200001c8 = 0x70f000);
    NONFAILING(*(uint32_t*)0x200001cc = 0);
    NONFAILING(*(uint32_t*)0x200001d0 = 0);
    NONFAILING(*(uint64_t*)0x200001d8 = 0);
    syscall(__NR_ioctl, r[2], 0xc0105512, 0x200001c0);
    break;
  case 7:
    NONFAILING(*(uint32_t*)0x2001d000 = 1);
    NONFAILING(*(uint32_t*)0x2001d004 = 0x70);
  ...
  case 9:
    NONFAILING(*(uint32_t*)0x200001c0 = 0);
    NONFAILING(*(uint32_t*)0x200001c4 = 0x5516);
    NONFAILING(*(uint32_t*)0x200001c8 = 0x70f000);
    NONFAILING(*(uint32_t*)0x200001cc = 0);
    NONFAILING(*(uint32_t*)0x200001d0 = 0);
    NONFAILING(*(uint64_t*)0x200001d8 = 0);
    syscall(__NR_ioctl, r[4], 0xc0105512, 0x200001c0);
    break;
  }
}
int main(void)
