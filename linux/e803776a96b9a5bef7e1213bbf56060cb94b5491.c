...
// https://syzkaller.appspot.com/bug?id=e803776a96b9a5bef7e1213bbf56060cb94b5491
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000300, "security.ima\000", 13));
    syscall(__NR_lsetxattr, 0ul, 0x20000300ul, 0ul, 0ul, 0ul);
    break;
  }
}
int main(void)
