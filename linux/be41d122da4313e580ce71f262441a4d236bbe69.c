...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint16_t*)0x2000008c = htobe16(0x86dd));
    NONFAILING(STORE_BY_BITMASK(uint8_t, 0x2000008e, 0, 0, 4));
    NONFAILING(STORE_BY_BITMASK(uint8_t, 0x2000008e, 6, 4, 4));
    NONFAILING(memcpy((void*)0x2000008f, "\x50\xa0\x9c", 3));
    NONFAILING(*(uint16_t*)0x20000092 = htobe16(8));
    NONFAILING(*(uint8_t*)0x20000094 = 0);
    NONFAILING(*(uint8_t*)0x20000095 = 0);
    NONFAILING(*(uint8_t*)0x20000096 = 0xfe);
    NONFAILING(*(uint8_t*)0x20000097 = 0x80);
    ...
    NONFAILING(*(uint8_t*)0x200000a5 = 0xbb);
    NONFAILING(*(uint8_t*)0x200000a6 = 0xfe);
    NONFAILING(*(uint8_t*)0x200000a7 = 0x80);
    ...
    NONFAILING(*(uint8_t*)0x200000b5 = 0xaa);
    NONFAILING(*(uint16_t*)0x200000b6 = htobe16(0));
    NONFAILING(*(uint16_t*)0x200000b8 = htobe16(0));
    NONFAILING(*(uint16_t*)0x200000ba = htobe16(8));
    ...
    NONFAILING(csum_inet_update(&csum_1, (const uint8_t*)0x20000096, 16));
    NONFAILING(csum_inet_update(&csum_1, (const uint8_t*)0x200000a6, 16));
    ...
    NONFAILING(csum_inet_update(&csum_1, (const uint8_t*)0x200000b6, 8));
    NONFAILING(*(uint16_t*)0x200000bc = csum_inet_digest(&csum_1));
    syz_emit_ethernet(0x29, 0x20000080, 0x20000040);
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000180, "/dev/dsp#", 10));
    res = syz_open_dev(0x20000180, 0x80000000, 0x2000);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
    NONFAILING(*(uint32_t*)0x200001c0 = 0);
    res = syscall(__NR_accept, r[0], 0, 0x200001c0);
    if (res != -1)
      r[1] = res;
    break;
  case 3:
  ...
  case 4:
    ...
    NONFAILING(memcpy((void*)0x200000c0,
                      ...
                      21));
    syscall(__NR_ioctl, -1, 0x8946, 0x20000100);
    break;
  case 5:
    NONFAILING(*(uint32_t*)0x20000080 = 0);
    syscall(__NR_setsockopt, r[2], 0, 0x40, 0x20000080, 4);
    break;
  case 6:
    NONFAILING(*(uint16_t*)0x200003c0 = 2);
    NONFAILING(*(uint16_t*)0x200003c2 = htobe16(0x4e22));
    NONFAILING(*(uint32_t*)0x200003c4 = htobe32(0xe0000001));
    ...
    syscall(__NR_connect, r[1], 0x200003c0, 0x10);
    break;
  case 7:
    NONFAILING(memcpy(
        (void*)0x20000140,
    ...
    NONFAILING(*(uint32_t*)0x20000000 = 0x4c);
    NONFAILING(*(uint32_t*)0x20000004 = 2);
    NONFAILING(*(uint8_t*)0x20000008 = 6);
    NONFAILING(*(uint8_t*)0x20000009 = 5);
    NONFAILING(*(uint8_t*)0x2000000a = 0x36);
    NONFAILING(*(uint8_t*)0x2000000b = 2);
    NONFAILING(*(uint8_t*)0x2000000c = 5);
    NONFAILING(*(uint8_t*)0x2000000d = 0);
    NONFAILING(*(uint8_t*)0x2000000e = 0x69);
    NONFAILING(*(uint8_t*)0x2000000f = 0);
    NONFAILING(*(uint32_t*)0x20000010 = 0x401);
    NONFAILING(*(uint32_t*)0x20000014 = 2);
    NONFAILING(*(uint32_t*)0x20000018 = 8);
    NONFAILING(*(uint32_t*)0x2000001c = 7);
    NONFAILING(*(uint32_t*)0x20000020 = 0);
    NONFAILING(*(uint32_t*)0x20000024 = 0xc73e);
    NONFAILING(*(uint32_t*)0x20000028 = 0xfffffff9);
    NONFAILING(*(uint32_t*)0x2000002c = 0xfffffff9);
    NONFAILING(*(uint32_t*)0x20000030 = 1);
    NONFAILING(*(uint32_t*)0x20000034 = 2);
    NONFAILING(*(uint32_t*)0x20000038 = 0);
    syscall(__NR_ioctl, r[2], 0x8946, 0x20000140);
    break;
  case 8:
    NONFAILING(memcpy((void*)0x200002c0, "id_legacy", 10));
    NONFAILING(*(uint8_t*)0x20000300 = 0x73);
    NONFAILING(*(uint8_t*)0x20000301 = 0x79);
    NONFAILING(*(uint8_t*)0x20000302 = 0x7a);
    NONFAILING(*(uint8_t*)0x20000303 = 0x20 + procid * 4);
    NONFAILING(*(uint8_t*)0x20000304 = 0);
    NONFAILING(memcpy(
        (void*)0x20000340,
        "\xdc\xa7\xac\xdf\x8e\x0b\x27\x0e\x60\x81\xdc\xa2\xb1\xab\x6e\x30\x27"
        "\xfe\xa1\x98\x5b\xd5\x11\x82\x6e\x4e\xb5\x1f\xda\x8c\x45\xe3\xfa\x9e"
        "\xa1\xc6\x40\x3e\x75\x80\x07\x6f\xab\x3f\x25\xa7\xae\x6e\xf0\x05\x28"
        "\x04\xd6\x6f\xe4\x9f\xe0\x16\xdf\xa0\x6e\x6a\x5d\x66\x16\x15\x41\xaf"
        "\xae\x00\xd8\x2a\x0f\x90\x72\x0f\xb8\xbb\x13\xf3\xe9\xa8\xae\xdd\x27"
        "\xe3\x6e\x28\x47\x76\x5c\x01\xbe\x15\xe5\xb5\x03\xa5\x71\xe7\x44\xfe"
        "\x20\x04\x39\x39\x8f\x76\xbf\x4d\x6e\x4d\x90",
        113));
    res = syscall(__NR_add_key, 0x200002c0, 0x20000300, 0x20000340, 0x71,
                  0xfffffffc);
    if (res != -1)
      r[3] = res;
    break;
  case 9:
    NONFAILING(memcpy((void*)0x20000200, "asymmetric", 11));
    NONFAILING(*(uint8_t*)0x20000240 = 0x73);
    NONFAILING(*(uint8_t*)0x20000241 = 0x79);
    NONFAILING(*(uint8_t*)0x20000242 = 0x7a);
    NONFAILING(*(uint8_t*)0x20000243 = 0x22 + procid * 4);
    NONFAILING(*(uint8_t*)0x20000244 = 0);
    NONFAILING(memcpy((void*)0x20000280, "/dev/dsp#", 10));
    syscall(__NR_request_key, 0x20000200, 0x20000240, 0x20000280, r[3]);
    break;
  }
}
