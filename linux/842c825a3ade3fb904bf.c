// WARNING in percpu_ref_switch_to_atomic_rcu (2)
// https://syzkaller.appspot.com/bug?id=842c825a3ade3fb904bf
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000480ul, 2ul, 0ul);
    if (res != -1)
      r[1] = res;
    break;
  case 2:
    NONFAILING(memcpy(
        (void*)0x20000080,
        "\xfc\x00\x00\x00\x1c\x00\x07\x25\xab\x09\x25\x00\x09\x00\x07\x00\x0a"
        "\xab\x08\x00\x08\x00\x00\x00\x81\x00\x61\x93\x21\x00\x01\xc0\x00\x00"
        "\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x03\x98\x15\xfa\x2c\x1e"
        "\xc2\x86\x56\xaa\xa7\x9b\xb9\x4b\x46\x7e\x00\x00\x00\x0a\x00\x02\x00"
        "\x03\x5a\x02\x01\x85\x6c\x25\x6f\x1a\x27\x2f\xdf\x0d",
        81));
    syscall(__NR_write, -1, 0x20000080ul, 0x51ul);
    break;
  case 3:
    NONFAILING(memset((void*)0x200000c0, 0, 16));
