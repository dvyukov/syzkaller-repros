...
// https://syzkaller.appspot.com/bug?id=010c4b4afd138414b3fb
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    res = syscall(__NR_perf_event_open, 0ul, 0, -1ul, -1, 0ul);
    if (res != -1)
      r[1] = res;
    break;
  case 4:
    syscall(__NR_ioctl, r[1], 0x80046402, 0ul);
    break;
  case 5:
    syscall(__NR_ioctl, r[1], 0x40082406, 0ul);
    break;
  case 6:
  ...
  case 7:
    ...
    break;
  case 8:
    NONFAILING(memcpy((void*)0x20000180, "/dev/ion\000", 9));
  ...
  case 9:
    ...
    res = syscall(__NR_ioctl, r[4], 0xc0184900, 0x200001c0ul);
    if (res != -1)
      NONFAILING(r[5] = *(uint32_t*)0x200001d0);
    break;
  case 10:
    res = syscall(__NR_dup, r[5]);
    if (res != -1)
      r[6] = res;
    break;
  case 11:
    NONFAILING(*(uint32_t*)0x200000c4 = 0);
    NONFAILING(*(uint32_t*)0x200000c8 = r[6]);
    res = syscall(__NR_ioctl, r[3], 0xc00c642e, 0x200000c0ul);
    if (res != -1)
      NONFAILING(r[7] = *(uint32_t*)0x200000c0);
    break;
  case 12:
    NONFAILING(*(uint32_t*)0x200000c0 = 6);
    NONFAILING(*(uint32_t*)0x200000c4 = 0x1f);
    NONFAILING(*(uint32_t*)0x200000c8 = 5);
    NONFAILING(*(uint32_t*)0x200000cc = 0);
    res = syscall(__NR_ioctl, r[2], 0xc02064b2, 0x200000c0ul);
    if (res != -1)
      NONFAILING(r[8] = *(uint32_t*)0x200000d0);
    break;
  case 13:
    NONFAILING(*(uint32_t*)0x20000140 = r[8]);
    syscall(__NR_ioctl, r[2], 0xc10c5541, 0x20000140ul);
    break;
  case 14:
    NONFAILING(*(uint32_t*)0x20000040 = r[7]);
    NONFAILING(*(uint32_t*)0x20000044 = 0);
    syscall(__NR_ioctl, r[2], 0xc00c642d, 0x20000040ul);
    break;
  }
}
int main(void)
