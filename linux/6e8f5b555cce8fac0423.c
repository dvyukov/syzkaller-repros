...
// https://syzkaller.appspot.com/bug?id=6e8f5b555cce8fac0423
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    syz_open_dev(0x20000140, 2 + procid * 4, 2);
    break;
  case 1:
    memcpy((void*)0x20000200, "/dev/cec#\000", 10);
    syz_open_dev(0x20000200, 1 + procid * 4, 2);
    break;
  case 2:
    memcpy((void*)0x20000000, "fd\000", 3);
    syz_open_procfs(0, 0x20000000);
    break;
  case 3:
    *(uint64_t*)0x20000180 = 0;
    syscall(__NR_signalfd, -1, 0x20000180ul, 8ul);
    break;
  case 4:
    ...
    *(uint32_t*)0x200000a4 = 0;
    res = -1;
    res = syz_io_uring_setup(0x88, 0x20000080, 0x20ee7000, 0x206d4000,
