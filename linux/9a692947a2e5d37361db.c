...
// https://syzkaller.appspot.com/bug?id=9a692947a2e5d37361db
// status:0
...
void loop(void)
{
  ...
  *(uint64_t*)0x20000040 = 0x20000280;
  memcpy((void*)0x20000280, "\x44\x00\x00\x00\x10\x00\x01\x04\x00\x00\x00\x00"
                            "\x00\x00\x00\x00\x00\x00\x20\x00",
         20);
  *(uint32_t*)0x20000294 = -1;
  memcpy((void*)0x20000298, "\x00\x01\x00\x00\x00\x00\x00\x00\x24\x00\x12\x00"
  ...
  *(uint32_t*)0x20000030 = 0;
  ...
  if (res != -1)
    r[0] = res;
  syscall(__NR_sendmmsg, r[0], 0x20000000ul, 0xbul, 0ul);
  res = syscall(__NR_socket, 0x10ul, 3ul, 0);
  if (res != -1)
    r[1] = res;
  res = syscall(__NR_socket, 0xaul, 0x80003ul, 0x6b);
  if (res != -1)
    r[2] = res;
  res = syscall(__NR_socket, 0x200000000000011ul, 3ul, 0);
  if (res != -1)
    r[3] = res;
  memcpy((void*)0x20000300, "team0\000\000\000\000\000\000\000\000\000\000\000",
         16);
  *(uint32_t*)0x20000310 = 0;
  res = syscall(__NR_ioctl, r[2], 0x8933, 0x20000300ul);
  if (res != -1)
    r[4] = *(uint32_t*)0x20000310;
  ...
  *(uint64_t*)0x20000140 = 0x200000c0;
  memcpy((void*)0x200000c0, "\x44\x00\x00\x00\x10\x00\x01\x04\x00\x00\x00\x00"
                            "\x00\x00\x00\x00\x00\x00\x00\x00",
         20);
  *(uint32_t*)0x200000d4 = 0;
  memcpy((void*)0x200000d8, "\x00\x00\x00\x00\x00\x00\x00\x00\x14\x00\x12\x80"
                            "\x0c\x00\x01\x00\x6d\x61\x63\x76\x74\x61\x70\x00"
                            "\x04\x00\x02\x80\x08\x00\x05\x00",
         32);
  *(uint32_t*)0x200000f8 = -1;
  memcpy((void*)0x200000fc, "\b\000\n\000", 4);
  *(uint32_t*)0x20000100 = r[5];
