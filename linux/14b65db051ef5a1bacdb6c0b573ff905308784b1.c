...
// https://syzkaller.appspot.com/bug?id=14b65db051ef5a1bacdb6c0b573ff905308784b1
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000040, "/dev/rtc\000\000", 10));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000040, 0, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    NONFAILING(*(uint64_t*)0x20000e00 = 0x20000240);
    NONFAILING(*(uint64_t*)0x20000e08 = 0xe6);
    syscall(__NR_preadv, r[0], 0x20000e00, 1, 0);
    break;
  case 2:
    syscall(__NR_ioctl, r[0], 0x7003, 0);
    break;
  case 3:
    NONFAILING(*(uint64_t*)0x20000080 = 0x77359400);
    NONFAILING(*(uint64_t*)0x20000088 = 0);
    syscall(__NR_clock_settime, 0, 0x20000080);
    break;
  case 4:
    NONFAILING(*(uint64_t*)0x20000140 = 0xb97);
    ...
    NONFAILING(*(uint64_t*)0x20000190 = 0xf423f);
    ...
    syscall(__NR_clock_adjtime, 0, 0x20000140);
    break;
  }
}
int main(void)
