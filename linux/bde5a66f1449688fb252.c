...
// https://syzkaller.appspot.com/bug?id=bde5a66f1449688fb252
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x200002d0 = 0x200004c0;
  *(uint64_t*)0x200002d8 = 0;
  *(uint64_t*)0x200002e0 = 0;
  syscall(__NR_ioctl, r[2], 0x4028af11, 0x200002c0ul);
  *(uint32_t*)0x20000000 = 0;
  *(uint32_t*)0x20000004 = r[4];
  syscall(__NR_ioctl, r[2], 0x4008af30, 0x20000000ul);
  *(uint32_t*)0x20000000 = 0;
