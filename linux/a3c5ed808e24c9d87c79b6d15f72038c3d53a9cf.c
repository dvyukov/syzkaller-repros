...
void execute_one()
{
  memcpy((void*)0x20d69ff7, "net/unix", 9);
  syz_open_procfs(0, 0x20d69ff7);
  syscall(__NR_madvise, 0x20c91000, 0x4000, 0x400000000000000a);
  syscall(__NR_clone, 0, 0x20001f37, 0x20001ffc, 0x20001000, 0x20007000);
  syscall(__NR_madvise, 0x2092d000, 0x400000, 0x10200000008);
}
