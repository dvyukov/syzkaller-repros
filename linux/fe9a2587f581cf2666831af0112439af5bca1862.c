...
void execute_call(int call)
{
  ...
  case 1:
    NONFAILING(memcpy(
        ...
        16));
    NONFAILING(*(uint32_t*)0x20001590 = 0);
    res = syscall(__NR_ioctl, r[0], 0x8933, 0x20001580);
    if (res != -1)
      NONFAILING(r[1] = *(uint32_t*)0x20001590);
    break;
  case 2:
    NONFAILING(*(uint64_t*)0x20000300 = 0x20000040);
    ...
    NONFAILING(memcpy((void*)0x20000080,
                      "\x40\x00\x00\x00\x14\x00\x11\x01\x00\x00\x00\x00\x00\x00"
                      "\x00\x00\x0a\x00\x00\x00",
                      20));
    NONFAILING(*(uint32_t*)0x20000094 = r[1]);
    NONFAILING(
        memcpy((void*)0x20000098,
               "\x14\x00\x02\x00\x2c\x00\x00\x00\x06\x00\x00\x00\x00\x00\x00"
               "\x00\x00\x00\x00\x00\x14\x00\x01\x00\x00\x00\x00\x00\x00\x00"
               "\x00\x00\x00\x91\x2f\x62\x00\x00\x00\x00\x00\x00\x01",
               43));
    NONFAILING(*(uint64_t*)0x20000008 = 3);
