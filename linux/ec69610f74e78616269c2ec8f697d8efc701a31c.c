...
void test()
{
  ...
  *(uint16_t*)0x20e6f002 = htobe16(2);
  *(uint32_t*)0x20e6f004 = 0;
  *(uint8_t*)0x20e6f008 = -1;
  *(uint8_t*)0x20e6f009 = 2;
  ...
  *(uint8_t*)0x20e6f012 = 0;
  *(uint8_t*)0x20e6f013 = 0;
  *(uint8_t*)0x20e6f014 = 0;
  *(uint8_t*)0x20e6f015 = 0;
  *(uint8_t*)0x20e6f016 = 0;
  *(uint8_t*)0x20e6f017 = 1;
  *(uint32_t*)0x20e6f018 = 5;
  syscall(__NR_connect, r[0], 0x20e6f000, 0x1c);
  res = syscall(__NR_socket, 0x18, 1, 1);
  if (res != -1)
    r[1] = res;
  *(uint16_t*)0x20000200 = 0xa;
  *(uint16_t*)0x20000202 = htobe16(0x4e20);
  *(uint32_t*)0x20000204 = 0x7ff;
  ...
  *(uint8_t*)0x20000482 = -1;
  *(uint8_t*)0x20000483 = -1;
  *(uint8_t*)0x20000484 = -1;
  *(uint8_t*)0x20000485 = -1;
  *(uint8_t*)0x20000486 = -1;
  *(uint8_t*)0x20000487 = -1;
  *(uint8_t*)0x20000488 = -1;
  *(uint8_t*)0x20000489 = -1;
  *(uint8_t*)0x2000048a = -1;
  *(uint8_t*)0x2000048b = -1;
  *(uint16_t*)0x2000048c = htobe16(0x86dd);
  STORE_BY_BITMASK(uint8_t, 0x2000048e, 0, 0, 4);
  STORE_BY_BITMASK(uint8_t, 0x2000048e, 6, 4, 4);
  memcpy((void*)0x2000048f, "\x17\x4b\xbd", 3);
  *(uint16_t*)0x20000492 = htobe16(2);
  *(uint8_t*)0x20000494 = 0x3c;
  ...
  *(uint8_t*)0x200004b5 = 1;
  *(uint16_t*)0x200004b6 = htobe16(0);
  *(uint16_t*)0x200004b8 = htobe16(0);
  *(uint16_t*)0x200004ba = htobe16(8);
  ...
  *(uint32_t*)0x20000514 = 0;
  ...
  csum_inet_update(&csum_1, (const uint8_t*)0x20000496, 16);
  csum_inet_update(&csum_1, (const uint8_t*)0x200004a6, 16);
  ...
  csum_inet_update(&csum_1, (const uint8_t*)0x200004b6, 8);
  *(uint16_t*)0x200004bc = csum_inet_digest(&csum_1);
  syz_emit_ethernet(0x3e, 0x20000480, 0x20000500);
}
