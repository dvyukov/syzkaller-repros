// WARNING in sigsuspend
// https://syzkaller.appspot.com/bug?id=450bcdb23bb2031f1a8e7bc175288c9e79508734
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    *(uint32_t*)0x203b9ffc = 0;
    ...
    break;
  case 2:
    res = syz_open_pts(r[0], 0x4000000000000002);
    if (res != -1)
      r[1] = res;
    break;
  case 3:
  ...
  case 4:
    ...
    break;
  case 5:
    *(uint64_t*)0x20000000 = 0x9000000;
    syscall(__NR_rt_sigsuspend, 0x20000000, 8);
    break;
  }
}
int main(void)
