...
// https://syzkaller.appspot.com/bug?id=7b6548ae483d6f4c64ae
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint32_t*)0x20000104 = 0xa2);
    NONFAILING(*(uint32_t*)0x20000108 = 4);
  ...
  case 3:
    ...
    NONFAILING(*(uint16_t*)0x20000002 = htobe16(0x4001));
    ...
    syscall(__NR_sendmsg, r[0], 0x20000080ul, 0x2c000811ul);
    break;
  case 4:
    ...
    NONFAILING(*(uint64_t*)0x20000190 = 0x200);
