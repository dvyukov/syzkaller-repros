// INFO: task can't die in reclaim_throttle
// https://syzkaller.appspot.com/bug?id=dcea9eda277e1090b35f
// status:0
...
void execute_call(int call)
{
  ...
  case 4:
    ...
    break;
  case 5:
    memcpy((void*)0x200002c0, "syz1\000", 5);
    res = syscall(__NR_openat, r[1], 0x200002c0ul, 0x200002ul, 0ul);
    if (res != -1)
      r[2] = res;
    break;
  case 6:
    memcpy((void*)0x20000180, "memory.high\000", 12);
    res = syscall(__NR_openat, r[2], 0x20000180ul, 2ul, 0ul);
    if (res != -1)
      r[3] = res;
    break;
  case 7:
    syscall(__NR_sendfile, r[3], r[3], 0ul, 3ul);
    break;
  case 8:
