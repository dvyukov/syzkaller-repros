...
// https://syzkaller.appspot.com/bug?id=f1f5fadb1e03d4d54b6b
// status:6
...
void execute_one(void)
{
  ...
  NONFAILING(*(uint64_t*)0x20000018 = 0x422);
  ...
  NONFAILING(*(uint32_t*)0x20000030 = 9);
  ...
  NONFAILING(*(uint32_t*)0x20000058 = 0xfffffffe);
  NONFAILING(*(uint32_t*)0x2000005c = 8);
