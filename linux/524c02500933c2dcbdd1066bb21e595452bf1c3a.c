// KMSAN: kernel-infoleak in fuzzer_ioctl
// https://syzkaller.appspot.com/bug?id=524c02500933c2dcbdd1066bb21e595452bf1c3a
// status:invalid
...
int main(void)
{
  ...
  *(uint8_t*)0x20000004 = 0x3c;
  *(uint8_t*)0x20000005 = 0x81;
  *(uint8_t*)0x20000006 = 0x57;
  *(uint8_t*)0x20000007 = 0x40;
  *(uint16_t*)0x20000008 = 0x1b80;
  *(uint16_t*)0x2000000a = 0xe755;
  *(uint16_t*)0x2000000c = 0x1e97;
