...
// https://syzkaller.appspot.com/bug?id=96b43810dfe9c3bb95ed
// status:0
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000018 = -1;
  ...
  res = -1;
  res = syz_io_uring_setup(0x2de7, 0x20000000, 0x20002000, 0x20ffc000,
                           0x20000100, 0x20000080);
  if (res != -1) {
    r[0] = res;
  ...
  *(uint16_t*)0x200001ea = 0;
  ...
  syscall(__NR_io_uring_enter, r[0], 0x302, 0, 0ul, 0ul, 0x8000000ul);
}
int main(void)
{
