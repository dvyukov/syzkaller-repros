...
// https://syzkaller.appspot.com/bug?id=4bbd040ddada1c7801f4
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(syz_emit_ethernet(0x36, 0, 0));
    break;
  case 1:
  ...
  case 2:
    ...
    if (res != -1) {
      NONFAILING(r[0] = *(uint64_t*)0x20000000);
  ...
  case 4:
    ...
    NONFAILING(*(uint8_t*)0x20000201 = 4);
