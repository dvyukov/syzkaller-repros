...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint8_t*)0x20000004 = 0x81);
    NONFAILING(*(uint8_t*)0x20000005 = 0xa2);
    NONFAILING(*(uint8_t*)0x20000006 = 0x42);
    NONFAILING(*(uint8_t*)0x20000007 = 8);
    NONFAILING(*(uint16_t*)0x20000008 = 0x15a9);
    NONFAILING(*(uint16_t*)0x2000000a = 2);
    NONFAILING(*(uint16_t*)0x2000000c = 0x822c);
    ...
    NONFAILING(*(uint8_t*)0x2000001d = 0x8f);
    NONFAILING(*(uint8_t*)0x2000001e = 3);
    NONFAILING(*(uint8_t*)0x2000001f = 0);
    NONFAILING(*(uint8_t*)0x20000020 = 0xd7);
    NONFAILING(*(uint8_t*)0x20000021 = 0x27);
    NONFAILING(*(uint8_t*)0x20000022 = 0x3f);
  ...
  case 1:
    ...
    NONFAILING(*(uint64_t*)0x20000484 = 0x20000040);
    NONFAILING(*(uint8_t*)0x20000040 = 0x40);
    NONFAILING(*(uint8_t*)0x20000041 = 0);
    NONFAILING(*(uint32_t*)0x20000042 = 2);
    NONFAILING(*(uint8_t*)0x20000046 = 2);
    NONFAILING(*(uint8_t*)0x20000047 = 0x22);
    ...
    NONFAILING(*(uint64_t*)0x200007cc = 0x20000580);
    NONFAILING(*(uint8_t*)0x20000580 = 0);
    NONFAILING(*(uint8_t*)0x20000581 = 0xb);
    NONFAILING(*(uint32_t*)0x20000582 = 0);
    ...
    syz_usb_control_io(r[0], 0x20000480, 0x200007c0);
    break;
  case 2:
