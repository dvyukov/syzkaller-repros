...
// https://syzkaller.appspot.com/bug?id=2f3044a22f272a726a57
// status:6
...
int main(void)
{
  ...
  NONFAILING(*(uint8_t*)0x200000c4 = 0xba);
  NONFAILING(*(uint8_t*)0x200000c5 = 0xe4);
  NONFAILING(*(uint8_t*)0x200000c6 = 0x13);
  NONFAILING(*(uint8_t*)0x200000c7 = 0x40);
  NONFAILING(*(uint16_t*)0x200000c8 = 0x5e3);
  NONFAILING(*(uint16_t*)0x200000ca = 0x502);
  NONFAILING(*(uint16_t*)0x200000cc = 0x6421);
  ...
  NONFAILING(*(uint16_t*)0x200000d4 = 0x12);
  ...
  NONFAILING(*(uint8_t*)0x200000e0 = 0x29);
  NONFAILING(*(uint8_t*)0x200000e1 = 0x2b);
  NONFAILING(*(uint8_t*)0x200000e2 = 5);
  NONFAILING(*(uint8_t*)0x200000e3 = 0);
  NONFAILING(syz_usb_connect(2, 0x24, 0x200000c0, 0));
  return 0;
}
