...
// https://syzkaller.appspot.com/bug?id=b07d8440edb5f8988eea
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint64_t*)0x20000140 = 9);
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000bc0, "ethtool\000", 8));
    NONFAILING(syz_genetlink_get_family_id(0x20000bc0, -1));
    break;
  case 2:
    NONFAILING(*(uint32_t*)0x20000180 = 0xe8);
    res = syscall(__NR_getsockopt, -1, 0x29, 0x22, 0x20000000ul, 0x20000180ul);
    if (res != -1)
      NONFAILING(r[0] = *(uint32_t*)0x20000030);
    break;
  case 3:
  ...
  case 7:
    ...
    NONFAILING(*(uint64_t*)0x20000000 = 0x200008c0);
    NONFAILING(memcpy((void*)0x200008c0,
                      "\x48\x00\x00\x00\x10\x00\x05\x07\x00\x00\x00\x00\x00\x00"
                      "\x00\x40\x00\x00\x00\x00",
                      20));
    NONFAILING(*(uint32_t*)0x200008d4 = r[3]);
    NONFAILING(memcpy((void*)0x200008d8,
                      "\x00\x00\x00\x00\x00\x00\x00\x00\x28\x00\x12\x00\x0c\x00"
                      "\x01\x00\x76\x65\x74\x68",
                      20));
  ...
  case 8:
    ...
    NONFAILING(*(uint64_t*)0x20000490 = 0x20000440);
    NONFAILING(*(uint64_t*)0x20000440 = 0x20000540);
    NONFAILING(*(uint32_t*)0x20000540 = 0xa8);
    NONFAILING(*(uint16_t*)0x20000544 = 0);
    NONFAILING(*(uint16_t*)0x20000546 = 0x200);
    NONFAILING(*(uint32_t*)0x20000548 = 0x70bd25);
    NONFAILING(*(uint32_t*)0x2000054c = 0x25dfdbfc);
    NONFAILING(*(uint8_t*)0x20000550 = 0xb);
    NONFAILING(*(uint8_t*)0x20000551 = 0);
    NONFAILING(*(uint16_t*)0x20000552 = 0);
    NONFAILING(*(uint16_t*)0x20000554 = 0x1c);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000556, 1, 0, 14));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000557, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000557, 1, 7, 1));
    NONFAILING(*(uint16_t*)0x20000558 = 8);
    NONFAILING(*(uint16_t*)0x2000055a = 3);
    NONFAILING(*(uint32_t*)0x2000055c = 3);
    NONFAILING(*(uint16_t*)0x20000560 = 8);
    NONFAILING(*(uint16_t*)0x20000562 = 1);
    NONFAILING(*(uint32_t*)0x20000564 = r[3]);
    NONFAILING(*(uint16_t*)0x20000568 = 8);
    NONFAILING(*(uint16_t*)0x2000056a = 3);
    NONFAILING(*(uint32_t*)0x2000056c = 3);
    NONFAILING(*(uint16_t*)0x20000570 = 0x18);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000572, 1, 0, 14));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000573, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000573, 1, 7, 1));
    NONFAILING(*(uint16_t*)0x20000574 = 0x14);
    NONFAILING(*(uint16_t*)0x20000576 = 2);
    NONFAILING(memcpy((void*)0x20000578, "veth1_to_bridge\000", 16));
    NONFAILING(*(uint16_t*)0x20000588 = 0x30);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x2000058a, 1, 0, 14));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x2000058b, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x2000058b, 1, 7, 1));
    NONFAILING(*(uint16_t*)0x2000058c = 8);
    NONFAILING(*(uint16_t*)0x2000058e = 3);
    NONFAILING(*(uint32_t*)0x20000590 = 0);
    NONFAILING(*(uint16_t*)0x20000594 = 8);
    NONFAILING(*(uint16_t*)0x20000596 = 1);
    NONFAILING(*(uint32_t*)0x20000598 = 0);
    NONFAILING(*(uint16_t*)0x2000059c = 0x14);
    NONFAILING(*(uint16_t*)0x2000059e = 2);
    NONFAILING(
        memcpy((void*)0x200005a0, "syzkaller1\000\000\000\000\000\000", 16));
    NONFAILING(*(uint16_t*)0x200005b0 = 8);
    NONFAILING(*(uint16_t*)0x200005b2 = 3);
    NONFAILING(*(uint32_t*)0x200005b4 = 2);
    NONFAILING(*(uint16_t*)0x200005b8 = 0x30);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200005ba, 1, 0, 14));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200005bb, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200005bb, 1, 7, 1));
    NONFAILING(*(uint16_t*)0x200005bc = 8);
    NONFAILING(*(uint16_t*)0x200005be = 1);
    NONFAILING(*(uint32_t*)0x200005c0 = r[0]);
    NONFAILING(*(uint16_t*)0x200005c4 = 0x14);
    NONFAILING(*(uint16_t*)0x200005c6 = 2);
    NONFAILING(memcpy((void*)0x200005c8,
                      "caif0\000\000\000\000\000\000\000\000\000\000\000", 16));
    NONFAILING(*(uint16_t*)0x200005d8 = 8);
    NONFAILING(*(uint16_t*)0x200005da = 3);
    NONFAILING(*(uint32_t*)0x200005dc = 0);
    NONFAILING(*(uint16_t*)0x200005e0 = 8);
    NONFAILING(*(uint16_t*)0x200005e2 = 3);
    NONFAILING(*(uint32_t*)0x200005e4 = 2);
    NONFAILING(*(uint64_t*)0x20000448 = 0xa8);
    NONFAILING(*(uint64_t*)0x20000498 = 1);
    NONFAILING(*(uint64_t*)0x200004a0 = 0);
    NONFAILING(*(uint64_t*)0x200004a8 = 0);
    NONFAILING(*(uint32_t*)0x200004b0 = 0x20000001);
    syscall(__NR_sendmsg, -1, 0x20000480ul, 0x4040045ul);
    break;
  case 9:
    res = syscall(__NR_socket, 0x10ul, 3ul, 0);
    if (res != -1)
  ...
  case 12:
    ...
    NONFAILING(*(uint64_t*)0x20000428 = 0);
    NONFAILING(*(uint32_t*)0x20000430 = 0);
    syscall(__NR_sendmsg, r[6], 0x20000400ul, 0ul);
    break;
  case 13:
    NONFAILING(*(uint32_t*)0x20000200 = 0x14);
  ...
  case 14:
    ...
    NONFAILING(memcpy((void*)0x200008c0,
                      ...
                      "\x00\x40\x00\x00\x00\x00",
                      20));
    NONFAILING(*(uint32_t*)0x200008d4 = r[7]);
    NONFAILING(memcpy((void*)0x200008d8,
                      "\x00\x00\x00\x00\x00\x00\x00\x00\x28\x00\x12\x00\x0c\x00"
                      "\x01\x00\x76\x65\x74\x68",
                      20));
  ...
  case 15:
    ...
    NONFAILING(*(uint64_t*)0x20000150 = 0x20000780);
    NONFAILING(*(uint64_t*)0x20000780 = 0x200004c0);
    NONFAILING(*(uint32_t*)0x200004c0 = 0x58);
    NONFAILING(*(uint16_t*)0x200004c4 = 0x24);
    NONFAILING(*(uint16_t*)0x200004c6 = 0xf1d);
    ...
    NONFAILING(*(uint16_t*)0x200004dc = 0xfff1);
    NONFAILING(*(uint16_t*)0x200004de = -1);
    NONFAILING(*(uint16_t*)0x200004e0 = 0);
    NONFAILING(*(uint16_t*)0x200004e2 = 0);
    NONFAILING(*(uint16_t*)0x200004e4 = 0xa);
    NONFAILING(*(uint16_t*)0x200004e6 = 1);
    NONFAILING(memcpy((void*)0x200004e8, "netem\000", 6));
    NONFAILING(*(uint16_t*)0x200004f0 = 0x28);
    ...
    NONFAILING(*(uint16_t*)0x2000050c = 0xc);
    NONFAILING(*(uint16_t*)0x2000050e = 8);
    NONFAILING(*(uint64_t*)0x20000510 = 0xa6f1b3653945b0e1);
    NONFAILING(*(uint64_t*)0x20000788 = 0x58);
    ...
    break;
  case 16:
    NONFAILING(*(uint32_t*)0x200001c0 = 0x80);
    syscall(__NR_getpeername, r[5], 0x20000340ul, 0x200001c0ul);
    break;
  case 17:
