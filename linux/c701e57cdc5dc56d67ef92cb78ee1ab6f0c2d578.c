...
// https://syzkaller.appspot.com/bug?id=c701e57cdc5dc56d67ef92cb78ee1ab6f0c2d578
// status:invalid
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    memcpy((void*)0x20000200, "hugetlbfs\000", 10);
    syscall(__NR_mount, 0, 0x20000000, 0x20000200, 0, 0);
    break;
  case 1:
    memcpy((void*)0x200001c0, "./file0\000", 8);
    syscall(__NR_chdir, 0x200001c0);
    break;
  case 2:
    memcpy((void*)0x200001c0, "./file0\000", 8);
    ...
    break;
  case 3:
    memcpy((void*)0x200009c0, "./file1\000", 8);
    syscall(__NR_mkdir, 0x200009c0, 0);
    break;
  case 4:
    memcpy((void*)0x20000000, "./file0\000", 8);
    ...
    *(uint8_t*)0x20000132 = 0;
    syscall(__NR_mount, 0x40000a, 0x20000000, 0x200000c0, 0, 0x20000100);
    break;
  }
}
int main(void)
