// BUG: soft lockup in kvm_vcpu_ioctl
// https://syzkaller.appspot.com/bug?id=a36047e10146d93e3a5a
// status:0
...
void execute_one(void)
{
  ...
  res = -1;
  NONFAILING(res = syz_open_dev(0, 0x12, 0));
  if (res != -1)
    r[3] = res;
  syscall(__NR_mmap, 0x20000000ul, 0x3000ul, 0ul, 0x10012ul, r[3], 0ul);
}
int main(void)
{
