...
// https://syzkaller.appspot.com/bug?id=281f0bb1029889adf289b49425283c52da8246dc
// status:open
...
int main(void)
{
  ...
  memcpy((void*)0x20000280,
         ...
         24);
  res = syscall(__NR_memfd_create, 0x20000280ul, 3ul);
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x20000c40 = -1;
  syscall(__NR_write, r[0], 0x20000c40ul, 0xff67ul);
  syscall(__NR_fcntl, r[0], 0x409ul, 8ul);
  return 0;
}
