...
// https://syzkaller.appspot.com/bug?id=72868dd424eb66c6b95f
// status:6
...
{
  NONFAILING(memcpy((void*)0x20000140, "..", 2));
  NONFAILING(memcpy((void*)0x200000c0, "./file0\000", 8));
  syscall(__NR_symlink, 0x20000140ul, 0x200000c0ul);
  NONFAILING(*(uint32_t*)0x20000140 = 0);
  NONFAILING(*(uint32_t*)0x20000144 = 0);
  NONFAILING(*(uint32_t*)0x20000148 = 0);
  syscall(__NR_bpf, 0xeul, 0x20000140ul, 0xcul);
  NONFAILING(memcpy((void*)0x20000040, "./file0\000", 8));
  NONFAILING(memcpy((void*)0x20000140, "proc\000", 5));
  inject_fault(19);
  syscall(__NR_mount, 0ul, 0x20000040ul, 0x20000140ul, 0ul, 0ul);
}
int main(void)
{
