...
// https://syzkaller.appspot.com/bug?id=8380012dbffa80d289c0b04415b1773c73189286
// status:open
...
int main(void)
{
  ...
  *(uint32_t*)0x200001dc = 0;
  ...
  memcpy((void*)0x20000040, "/dev/tty1#\000", 11);
  res = syz_open_dev(0x20000040, 0, 0);
  if (res != -1)
    r[1] = res;
  syscall(__NR_ioctl, r[1], 0x5606ul, 7ul);
  return 0;
}
