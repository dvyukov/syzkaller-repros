...
// https://syzkaller.appspot.com/bug?id=70e777a39907d6d5fd0a
// status:0
  ...
  for (call = 0; call < 4; call++) {
    for (thread = 0; thread < (int)(sizeof(threads) / sizeof(threads[0]));
      ...
      event_timedwait(&th->done,
                      50 + (call == 0 ? 3000 : 0) + (call == 2 ? 3000 : 0));
      break;
    }
  }
...
void execute_call(int call)
{
  ...
  case 0:
    NONFAILING(memcpy(
        (void*)0x20000040,
        "\x12\x01\x00\x00\x72\xe1\xbd\x40\x82\x05\x14\x00\x9d\xbb\x00\x00\x00"
        "\x01\x09\x02\x24\x00\x01\x1b\x00\x00\x00\x09\x04\x00\x00\x02\x2a\x3e"
        "\x75\x00\x09\x05\x8b\x33\x06\x00\x00\x00\x00\x09\x05\x0b\xe7\x08",
        50));
    NONFAILING(syz_usb_connect(0, 0x36, 0x20000040, 0));
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000000, "/dev/sequencer2\000", 16));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000000ul, 0x40001ul,
                  0x6000000ul);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
    ...
    NONFAILING(*(uint8_t*)0x20000087 = 0xd7);
    NONFAILING(*(uint16_t*)0x20000088 = 0x1d6b);
    NONFAILING(*(uint16_t*)0x2000008a = 0x101);
    NONFAILING(*(uint16_t*)0x2000008c = 0x40);
    ...
    NONFAILING(*(uint16_t*)0x20000094 = 0x9d);
    NONFAILING(*(uint8_t*)0x20000096 = 3);
    NONFAILING(*(uint8_t*)0x20000097 = 1);
    NONFAILING(*(uint8_t*)0x20000098 = 0);
    NONFAILING(*(uint8_t*)0x20000099 = 0x60);
    NONFAILING(*(uint8_t*)0x2000009a = 3);
    ...
    NONFAILING(*(uint8_t*)0x200000a4 = 0xa);
    NONFAILING(*(uint8_t*)0x200000a5 = 0x24);
    NONFAILING(*(uint8_t*)0x200000a6 = 1);
    NONFAILING(*(uint16_t*)0x200000a7 = 2);
    NONFAILING(*(uint8_t*)0x200000a9 = 0xf9);
    NONFAILING(*(uint8_t*)0x200000aa = 2);
    NONFAILING(*(uint8_t*)0x200000ab = 1);
    NONFAILING(*(uint8_t*)0x200000ac = 2);
    NONFAILING(*(uint8_t*)0x200000ad = 9);
    NONFAILING(*(uint8_t*)0x200000ae = 4);
    NONFAILING(*(uint8_t*)0x200000af = 1);
    ...
    NONFAILING(*(uint8_t*)0x200000b7 = 4);
    NONFAILING(*(uint8_t*)0x200000b8 = 1);
    NONFAILING(*(uint8_t*)0x200000b9 = 1);
    NONFAILING(*(uint8_t*)0x200000ba = 1);
    NONFAILING(*(uint8_t*)0x200000bb = 1);
    NONFAILING(*(uint8_t*)0x200000bc = 2);
    NONFAILING(*(uint8_t*)0x200000bd = 0);
    NONFAILING(*(uint8_t*)0x200000be = 0);
    NONFAILING(*(uint8_t*)0x200000bf = 9);
    NONFAILING(*(uint8_t*)0x200000c0 = 0x24);
    NONFAILING(*(uint8_t*)0x200000c1 = 2);
    NONFAILING(*(uint8_t*)0x200000c2 = 1);
    NONFAILING(*(uint8_t*)0x200000c3 = 0x3c);
    NONFAILING(*(uint8_t*)0x200000c4 = 1);
    NONFAILING(*(uint8_t*)0x200000c5 = 1);
    NONFAILING(*(uint8_t*)0x200000c6 = 1);
    NONFAILING(memset((void*)0x200000c7, 167, 1));
    NONFAILING(*(uint8_t*)0x200000c8 = 9);
    NONFAILING(*(uint8_t*)0x200000c9 = 5);
    NONFAILING(*(uint8_t*)0x200000ca = 1);
    NONFAILING(*(uint8_t*)0x200000cb = 9);
    NONFAILING(*(uint16_t*)0x200000cc = 0x400);
    NONFAILING(*(uint8_t*)0x200000ce = 0xd9);
    NONFAILING(*(uint8_t*)0x200000cf = 8);
    NONFAILING(*(uint8_t*)0x200000d0 = 3);
    NONFAILING(*(uint8_t*)0x200000d1 = 7);
    NONFAILING(*(uint8_t*)0x200000d2 = 0x25);
    NONFAILING(*(uint8_t*)0x200000d3 = 1);
    NONFAILING(*(uint8_t*)0x200000d4 = 0);
    NONFAILING(*(uint8_t*)0x200000d5 = 3);
    NONFAILING(*(uint16_t*)0x200000d6 = 0);
    NONFAILING(*(uint8_t*)0x200000d8 = 9);
    NONFAILING(*(uint8_t*)0x200000d9 = 4);
    NONFAILING(*(uint8_t*)0x200000da = 2);
    NONFAILING(*(uint8_t*)0x200000db = 0);
    NONFAILING(*(uint8_t*)0x200000dc = 0);
    NONFAILING(*(uint8_t*)0x200000dd = 1);
    NONFAILING(*(uint8_t*)0x200000de = 2);
    NONFAILING(*(uint8_t*)0x200000df = 0);
    NONFAILING(*(uint8_t*)0x200000e0 = 0);
    NONFAILING(*(uint8_t*)0x200000e1 = 9);
    NONFAILING(*(uint8_t*)0x200000e2 = 4);
    NONFAILING(*(uint8_t*)0x200000e3 = 2);
    NONFAILING(*(uint8_t*)0x200000e4 = 1);
    NONFAILING(*(uint8_t*)0x200000e5 = 1);
    ...
    NONFAILING(*(uint8_t*)0x200000ea = 0xd);
    NONFAILING(*(uint8_t*)0x200000eb = 0x24);
    NONFAILING(*(uint8_t*)0x200000ec = 2);
    NONFAILING(*(uint8_t*)0x200000ed = 2);
    NONFAILING(*(uint16_t*)0x200000ee = 2);
    NONFAILING(*(uint16_t*)0x200000f0 = 4);
    NONFAILING(*(uint8_t*)0x200000f2 = 0x1f);
    NONFAILING(memcpy((void*)0x200000f3, "\x8a\x1f\x61\xd9", 4));
    NONFAILING(*(uint8_t*)0x200000f7 = 0xc);
    NONFAILING(*(uint8_t*)0x200000f8 = 0x24);
    NONFAILING(*(uint8_t*)0x200000f9 = 2);
    NONFAILING(*(uint8_t*)0x200000fa = 2);
    NONFAILING(*(uint16_t*)0x200000fb = 5);
    NONFAILING(*(uint16_t*)0x200000fd = 8);
    NONFAILING(*(uint8_t*)0x200000ff = 0x3f);
    NONFAILING(memcpy((void*)0x20000100, "\x34\xeb\xff", 3));
    NONFAILING(*(uint8_t*)0x20000103 = 7);
    NONFAILING(*(uint8_t*)0x20000104 = 0x24);
    NONFAILING(*(uint8_t*)0x20000105 = 1);
    NONFAILING(*(uint8_t*)0x20000106 = 0xef);
    NONFAILING(*(uint8_t*)0x20000107 = 0x81);
    NONFAILING(*(uint16_t*)0x20000108 = 0x1001);
    NONFAILING(*(uint8_t*)0x2000010a = 0xa);
    NONFAILING(*(uint8_t*)0x2000010b = 0x24);
    NONFAILING(*(uint8_t*)0x2000010c = 2);
    NONFAILING(*(uint8_t*)0x2000010d = 2);
    NONFAILING(*(uint16_t*)0x2000010e = 4);
    NONFAILING(*(uint16_t*)0x20000110 = 5);
    NONFAILING(*(uint8_t*)0x20000112 = 0);
    NONFAILING(memset((void*)0x20000113, 58, 1));
    NONFAILING(*(uint8_t*)0x20000114 = 0xb);
    NONFAILING(*(uint8_t*)0x20000115 = 0x24);
    NONFAILING(*(uint8_t*)0x20000116 = 2);
    NONFAILING(*(uint8_t*)0x20000117 = 1);
    NONFAILING(*(uint8_t*)0x20000118 = 0);
    NONFAILING(*(uint8_t*)0x20000119 = 2);
    NONFAILING(*(uint8_t*)0x2000011a = 9);
    NONFAILING(*(uint8_t*)0x2000011b = 6);
    NONFAILING(memcpy((void*)0x2000011c, "\x54\x07\x17", 3));
    NONFAILING(*(uint8_t*)0x2000011f = 9);
    NONFAILING(*(uint8_t*)0x20000120 = 5);
    NONFAILING(*(uint8_t*)0x20000121 = 0x82);
    NONFAILING(*(uint8_t*)0x20000122 = 9);
    NONFAILING(*(uint16_t*)0x20000123 = 0x400);
    NONFAILING(*(uint8_t*)0x20000125 = 0x7f);
    NONFAILING(*(uint8_t*)0x20000126 = 0);
    NONFAILING(*(uint8_t*)0x20000127 = 4);
    NONFAILING(*(uint8_t*)0x20000128 = 7);
    NONFAILING(*(uint8_t*)0x20000129 = 0x25);
    NONFAILING(*(uint8_t*)0x2000012a = 1);
    NONFAILING(*(uint8_t*)0x2000012b = 1);
    NONFAILING(*(uint8_t*)0x2000012c = 1);
    NONFAILING(*(uint16_t*)0x2000012d = 0xfffc);
    NONFAILING(syz_usb_connect(1, 0xaf, 0x20000080, 0));
    break;
  case 3:
    NONFAILING(*(uint8_t*)0x20000ec0 = -1);
    NONFAILING(*(uint8_t*)0x20000ec1 = 0);
    NONFAILING(*(uint8_t*)0x20000ec2 = 0xd);
    ...
    syscall(__NR_ioctl, r[0], 0x40085112, 0x20000ec0ul);
    break;
  }
}
int main(void)
