...
// https://syzkaller.appspot.com/bug?id=48d1691ba2166f340a9c
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000248 = 0x20000040;
  memcpy((void*)0x20000040, "\x03\x00\x00\x00\x04\x00\x00\x00\x05\x00\x00\x00"
  ...
  *(uint64_t*)0x200002a8 = 0x20012700;
  ...
  *(uint64_t*)0x200002b8 = 0xc000;
  memcpy((void*)0x200005c0, "errors=remount-ro", 17);
  *(uint8_t*)0x200005d1 = 0x2c;
  memcpy((void*)0x200005d2, "noacl", 5);
  *(uint8_t*)0x200005d7 = 0x2c;
  memcpy((void*)0x200005d8, "nomblk_io_submit", 16);
  *(uint8_t*)0x200005e8 = 0x2c;
  memcpy((void*)0x200005e9, "nomblk_io_submit", 16);
  *(uint8_t*)0x200005f9 = 0x2c;
  memcpy((void*)0x200005fa, "barrier", 7);
  *(uint8_t*)0x20000601 = 0x3d;
  sprintf((char*)0x20000602, "0x%016llx", (long long)0x7f);
  ...
  *(uint8_t*)0x20000615 = 0;
  ...
  syscall(__NR_mkdirat, r[0], 0x20000cc0ul, 0ul);
}
int main(void)
{
