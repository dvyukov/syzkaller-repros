...
// https://syzkaller.appspot.com/bug?id=44e40ac2cfe68e8ce207
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000600, "/dev/vmci\000", 10));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000600ul, 2ul, 0ul);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
    NONFAILING(*(uint32_t*)0x20000140 = 0xa0000);
  ...
  case 4:
    ...
    NONFAILING(*(uint64_t*)0x200000d8 = 4);
