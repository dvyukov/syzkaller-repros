...
// https://syzkaller.appspot.com/bug?id=94641ba6c1d768b1e35e
// status:0
...
void execute_call(int call)
{
  ...
  case 5:
    ...
    *(uint32_t*)0x20e5c004 = htobe32(0);
    syscall(__NR_connect, r[1], 0x20e5c000ul, 0x48ul);
    break;
  case 6:
    *(uint64_t*)0x2000bf40 = 0;
    *(uint32_t*)0x2000bf48 = 0;
    *(uint64_t*)0x2000bf50 = 0x20001600;
    *(uint64_t*)0x20001600 = 0x20000240;
    memset((void*)0x20000240, 77, 1);
    *(uint64_t*)0x20001608 = 1;
    *(uint64_t*)0x2000bf58 = 1;
    *(uint64_t*)0x2000bf60 = 0;
    *(uint64_t*)0x2000bf68 = 0;
    *(uint32_t*)0x2000bf70 = 0;
    *(uint32_t*)0x2000bf78 = 0;
    syscall(__NR_sendmmsg, r[1], 0x2000bf40ul, 1ul, 0ul);
    {
      int i;
      for (i = 0; i < 64; i++) {
        syscall(__NR_sendmmsg, r[1], 0x2000bf40ul, 1ul, 0ul);
  ...
  case 7:
    ...
    *(uint64_t*)0x20000b10 = 0x200001c0;
    *(uint64_t*)0x200001c0 = 0x20000080;
    memcpy(
        (void*)0x20000080,
        "\xd7\x91\x2c\x2e\x8d\xd4\xa7\xc2\x14\x72\xd8\x85\xf6\x27\x88\x11\x5b"
        "\xf5\x08\xe6\x93\x06\x25\x56\xe0\x7b\xcf\x42\x00\xd9\xbd\xf7\xa3\x08"
        "\x3b\x56\x94\x69\x54\x73\x20\xcd\x7e\xbf\x5e\xfa\x49\xdd\x7f\x5e\xe2"
        "\x98\x76\xce\xae\xbd\xaa\x25\x78\x1e\x7f\x3b\xbe\xfc\x7f\x28\x0f\xf5"
        "\x95\xae\x89\xd7\xa1\x4f\x6d\xe8\x0f\x38\x85\xe6\xb4\xc8\x77\x86\x51"
        "\x0e\xf1\x38\xad\x82\x97\x20\x76\x57\xce\x64\x28\x98\xc8\x5e\x73\x64"
        "\xae\x1e\x00\x37\x20\x63\x87\x3e\xde\xdc\x3d\xae\x60\xe1\x02\x77\xaf"
        "\x3c\xd6\x7a\xf7\x05\x03\xe0\x1f\x0c\x17\xa0\xec\x2a\x44\x75\x4a\xd1"
        "\x13\x93\x30\xc3\x5c\x74\x2f\xd9\x38\x37\xf2\x1a\x37\xe2\xe4",
        151);
    *(uint64_t*)0x200001c8 = 0x97;
    ...
    *(uint32_t*)0x20000bf8 = 0;
    syscall(__NR_sendmmsg, r[1], 0x20000b00ul, 4ul, 0x884ul);
    break;
  }
}
int main(void)
