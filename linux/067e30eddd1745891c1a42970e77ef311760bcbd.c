...
// https://syzkaller.appspot.com/bug?id=067e30eddd1745891c1a42970e77ef311760bcbd
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    *(uint8_t*)0x2000004d = 0;
    ...
    break;
  case 2:
    syscall(__NR_sendmmsg, r[0], 0x20001380, 0x3fffffffffffeed,
            0x600000000000000);
    break;
  }
}
