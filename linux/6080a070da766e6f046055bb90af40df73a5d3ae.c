...
void execute_call(int call)
{
  switch (call) {
  case 0:
    syscall(__NR_socket, 0x11, 3, 0);
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000040, ".\x00", 2));
    syscall(__NR_mount, 0, 0x20000040, 0, 0, 0);
    break;
  case 2:
  ...
  case 3:
    NONFAILING(memcpy((void*)0x20000140, "./file0\x00", 8));
    syscall(__NR_mount, 0x20000040, 0x20000140, 0, 0x201000, 0);
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000300, "./file0\x00", 8));
    syscall(__NR_chdir, 0x20000300);
    break;
  case 5:
    NONFAILING(memcpy((void*)0x200004c0, ".\x00", 2));
    NONFAILING(memcpy((void*)0x20000200, "./file0\x00", 8));
    syscall(__NR_pivot_root, 0x200004c0, 0x20000200);
    break;
  }
}
int main(void)
