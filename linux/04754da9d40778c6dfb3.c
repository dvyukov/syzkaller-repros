...
// https://syzkaller.appspot.com/bug?id=04754da9d40778c6dfb3
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    res = syscall(__NR_epoll_create, 8);
    if (res != -1)
      r[2] = res;
    break;
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_io_uring_setup, 0x2cb5, 0ul);
    break;
  case 6:
  ...
  case 7:
    ...
    syscall(__NR_epoll_ctl, r[2], 1ul, r[1], 0x20000180ul);
    break;
  }
}
int main(void)
