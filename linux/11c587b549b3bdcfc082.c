...
// https://syzkaller.appspot.com/bug?id=11c587b549b3bdcfc082
// status:0
...
void execute_call(int call)
{
  ...
  case 6:
    ...
    syscall(__NR_sched_setscheduler, r[2], 5ul, 0x20000380ul);
    break;
  case 7:
    ...
    syscall(__NR_setsockopt, r[1], 0x84, 0x6b, 0x2055bfe4ul, 0x1cul);
    break;
  }
}
int main(void)
