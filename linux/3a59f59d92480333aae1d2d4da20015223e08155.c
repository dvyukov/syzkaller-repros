// KMSAN: uninit-value in build_audio_procunit
// https://syzkaller.appspot.com/bug?id=3a59f59d92480333aae1d2d4da20015223e08155
// status:dup
...
void loop(void)
{
  ...
  *(uint8_t*)0x20000093 = 9;
  *(uint8_t*)0x20000094 = 4;
  ...
  *(uint8_t*)0x200000a5 = 7;
  *(uint8_t*)0x200000a6 = 0x25;
  *(uint8_t*)0x200000a7 = 1;
  *(uint8_t*)0x200000a8 = 0;
  *(uint8_t*)0x200000a9 = 0;
  *(uint16_t*)0x200000aa = 0;
  syz_usb_connect(0, 0xac, 0x20000000, 0);
  close_fds();
}
int main(void)
{
