// KASAN: use-after-free Read in run_filter
// https://syzkaller.appspot.com/bug?id=91bdcd0f3c62f690e1db
// status:0
...
void execute_call(int call)
{
  ...
  case 7:
    ...
    NONFAILING(memcpy((void*)0x200000c0,
                      "\x28\x00\x00\x00\x10\x00\x25\x08\x00\x00\x00\x00\x00\x00"
                      "\x00\x00\x0a\x02\x00\x00",
                      20));
    NONFAILING(*(uint32_t*)0x200000d4 = r[3]);
    NONFAILING(memcpy((void*)0x200000d8,
                      "\x00\x00\x00\x00\x00\x00\x00\x00\x08\x00\x0a\x00\x0f",
                      13));
  ...
  case 10:
    ...
    break;
  case 11:
    NONFAILING(memcpy((void*)0x20000280, "/dev/btrfs-control\000", 19));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000280ul, 0x600040ul,
                  0ul);
    if (res != -1)
      r[6] = res;
    break;
  case 12:
    ...
    NONFAILING(*(uint16_t*)0x200002c8 = htobe16(0x4e22));
    NONFAILING(*(uint32_t*)0x200002cc = 4);
    NONFAILING(memcpy(
        (void*)0x200002d0,
        "dh\000\000\000\000\000\000\000\000\000\000\000\000\000\000", 16));
    NONFAILING(*(uint32_t*)0x200002e0 = 0x16);
    NONFAILING(*(uint32_t*)0x200002e4 = 0x200);
    NONFAILING(*(uint32_t*)0x200002e8 = htobe32(0x5c));
    syscall(__NR_setsockopt, r[6], 0, 0x482, 0x200002c0ul, 0x2cul);
    break;
  case 13:
    NONFAILING(*(uint32_t*)0x20000200 = 0);
    syscall(__NR_getsockname, r[5], 0x20000100ul, 0x20000200ul);
    break;
  case 14:
  ...
  case 15:
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000068, 1, 5, 1));
