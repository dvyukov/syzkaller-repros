...
// https://syzkaller.appspot.com/bug?id=9864cdbab900f52c44d2a15b242e66b9a909e26d
// status:dup
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x20001900 = 0x54);
    NONFAILING(*(uint64_t*)0x20001904 = 0);
    NONFAILING(*(uint64_t*)0x2000190c = 0x20000500);
    NONFAILING(*(uint8_t*)0x20000500 = 0);
    NONFAILING(*(uint8_t*)0x20000501 = 0xb);
    NONFAILING(*(uint32_t*)0x20000502 = 0);
    NONFAILING(*(uint64_t*)0x20001914 = 0);
    NONFAILING(*(uint64_t*)0x2000191c = 0);
    NONFAILING(*(uint64_t*)0x20001924 = 0);
    NONFAILING(*(uint64_t*)0x2000192c = 0);
    NONFAILING(*(uint64_t*)0x20001934 = 0);
    NONFAILING(*(uint64_t*)0x2000193c = 0);
    NONFAILING(*(uint64_t*)0x20001944 = 0);
    NONFAILING(*(uint64_t*)0x2000194c = 0);
    syz_usb_control_io(r[0], 0, 0x20001900);
    break;
  case 2:
