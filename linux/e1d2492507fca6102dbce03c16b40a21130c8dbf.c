...
{
  long res = 0;
  syscall(__NR_ioctl, -1, 0x4400ae8f, 0);
  syz_kvm_setup_cpu(-1, -1, 0x20fe8000, 0, 0, 0, 0, 0);
  ...
  NONFAILING(*(uint8_t*)0x20000047 = 0xbb);
  ...
  NONFAILING(*(uint8_t*)0x20000087 = 0xbb);
  NONFAILING(*(uint32_t*)0x20000348 = 0x10);
  NONFAILING(*(uint64_t*)0x20000350 = 0x20000300);
  NONFAILING(*(uint64_t*)0x20000300 = 0x200000c0);
  NONFAILING(*(uint64_t*)0x20000308 = 0x10);
  ...
  syscall(__NR_sendmsg, r[2], 0x20000340, 0);
}
int main(void)
{
