...
// https://syzkaller.appspot.com/bug?id=0e3358e5ebb1956c271d
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint64_t*)0x20000000 = 0x20000400);
    NONFAILING(memcpy(
        (void*)0x20000400,
  ...
  case 3:
    ...
    NONFAILING(*(uint64_t*)0x20000340 = 0x20000300);
    NONFAILING(*(uint32_t*)0x20000300 = 0x14);
    NONFAILING(*(uint8_t*)0x20000304 = 1);
    NONFAILING(*(uint8_t*)0x20000305 = 0xa);
    NONFAILING(*(uint16_t*)0x20000306 = 0x101);
    NONFAILING(*(uint32_t*)0x20000308 = 0);
    NONFAILING(*(uint32_t*)0x2000030c = 0);
    NONFAILING(*(uint8_t*)0x20000310 = 2);
    NONFAILING(*(uint8_t*)0x20000311 = 0);
    NONFAILING(*(uint16_t*)0x20000312 = htobe16(0xf00));
    NONFAILING(*(uint64_t*)0x20000348 = 0x14);
