...
// https://syzkaller.appspot.com/bug?id=da7dcbe78594718894fe9675714b6e9b5d5f8929
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_ioctl, r[0], 0x4b36, 0);
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000180, "/dev/uinput\000", 12));
  ...
  case 3:
    ...
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000880, "./file0\000", 8));
    syscall(__NR_mkdir, 0x20000880, 0x100);
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20000000, "./file0\000", 8));
    NONFAILING(memcpy((void*)0x200019c0, "bpf\000", 4));
    syscall(__NR_mount, 0, 0x20000000, 0x200019c0, 0, 0);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000680, "./file0/file0\000", 14));
    syscall(__NR_mount, 0x20000000, 0x20000680, 0, 0x2001001, 0);
    break;
  case 7:
    NONFAILING(memcpy((void*)0x20000240, "./file0\000", 8));
    NONFAILING(memcpy((void*)0x20000300, "ramfs\000", 6));
    syscall(__NR_mount, 0, 0x20000240, 0x20000300, 0, 0);
    break;
  case 8:
    NONFAILING(memcpy(
        (void*)0x20000400,
