// KMSAN: uninit-value in device_release_driver_internal
// https://syzkaller.appspot.com/bug?id=5507ed21b962c6fef198356e5826e0c7a7e069e5
// status:invalid
...
void loop(void)
{
  ...
  *(uint8_t*)0x20000004 = 0x89;
  *(uint8_t*)0x20000005 = 0x34;
  *(uint8_t*)0x20000006 = 0xa;
  *(uint8_t*)0x20000007 = 0x10;
  *(uint16_t*)0x20000008 = 0x421;
  *(uint16_t*)0x2000000a = 0x486;
  *(uint16_t*)0x2000000c = 0x14d7;
