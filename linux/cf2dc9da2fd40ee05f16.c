...
// https://syzkaller.appspot.com/bug?id=cf2dc9da2fd40ee05f16
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint8_t*)0x20000108 = 0x26);
    NONFAILING(*(uint8_t*)0x20000109 = 1);
    ...
    syscall(__NR_perf_event_open, 0x20000100ul, 0, 0xfffffffbfffffffful, -1,
            0ul);
    break;
  case 1:
