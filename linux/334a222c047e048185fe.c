...
// https://syzkaller.appspot.com/bug?id=334a222c047e048185fe
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    *(uint32_t*)0x20000098 = -1;
    ...
    res = -1;
    res = syz_io_uring_setup(0x2cce, 0x20000080, 0x20ee7000, 0x206d4000,
                             0x20000040, 0x20000100);
    if (res != -1) {
      r[0] = res;
  ...
  case 1:
    ...
    *(uint32_t*)0x2000002c = r[0];
    memset((void*)0x20000030, 0, 16);
    syz_io_uring_submit(r[1], r[2], 0x20000000, 0x400);
    break;
  case 2:
    syscall(__NR_io_uring_enter, r[0], 0x170f, 0, 0ul, 0ul, 0ul);
    break;
  case 3:
