...
// https://syzkaller.appspot.com/bug?id=5ab0d02a92eedbfa4e4f6c32933cfe2f8c289e4b
// status:fixed
...
int main(void)
{
  ...
  *(uint16_t*)0x20000088 = 0x17ef;
  *(uint16_t*)0x2000008a = 0x6067;
  ...
  *(uint16_t*)0x20000088 = 0x926;
  *(uint16_t*)0x2000008a = 0x3333;
  *(uint16_t*)0x2000008c = 0;
  *(uint8_t*)0x2000008e = 0;
  *(uint8_t*)0x2000008f = 0;
  *(uint8_t*)0x20000090 = 0;
  ...
  *(uint64_t*)0x20000454 = 0x20002580;
  *(uint8_t*)0x20002580 = 0;
  *(uint8_t*)0x20002581 = 0x22;
  *(uint32_t*)0x20002582 = 0x22;
  STORE_BY_BITMASK(uint8_t, , 0x20002586, 2, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20002586, 1, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20002586, 0, 4, 4);
  memcpy((void*)0x20002587, "\xa3\x13", 2);
  STORE_BY_BITMASK(uint8_t, , 0x20002589, 0, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20002589, 2, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20002589, 0, 4, 4);
  STORE_BY_BITMASK(uint8_t, , 0x2000258a, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000258a, 1, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000258a, 0, 4, 4);
  memcpy((void*)0x2000258b, "\x7f\xe5\x28\x45", 4);
  STORE_BY_BITMASK(uint8_t, , 0x2000258f, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000258f, 2, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000258f, 0, 4, 4);
  memcpy((void*)0x20002590, "\xb7\x01\x00\x00", 4);
  STORE_BY_BITMASK(uint8_t, , 0x20002594, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20002594, 0, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20002594, 0, 4, 4);
  memcpy((void*)0x20002595, "\x80\xe3\xbf\xad", 4);
  STORE_BY_BITMASK(uint8_t, , 0x20002599, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20002599, 0, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20002599, 0, 4, 4);
  memcpy((void*)0x2000259a, "\x77\xdd\xb6\x0f", 4);
  STORE_BY_BITMASK(uint8_t, , 0x2000259e, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000259e, 2, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000259e, 0, 4, 4);
  memcpy((void*)0x2000259f, "\x6d\x88\x1a\xce", 4);
  STORE_BY_BITMASK(uint8_t, , 0x200025a3, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x200025a3, 2, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x200025a3, 0, 4, 4);
  memcpy((void*)0x200025a4, "\000\r\000\000", 4);
  *(uint64_t*)0x2000045c = 0;
  syz_usb_control_io(r[1], 0x20000440, 0);
  memcpy((void*)0x20000000, "\x17\x45\xad", 3);
  syz_usb_ep_write(r[1], 0, 3, 0x20000000);
  return 0;
}
