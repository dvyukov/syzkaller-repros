...
// https://syzkaller.appspot.com/bug?id=dbec6695a6565a9c6bc0
// status:0
...
static void execute_one(void)
{
  ...
  for (call = 0; call < 3; call++) {
    for (thread = 0; thread < (int)(sizeof(threads) / sizeof(threads[0]));
      ...
      event_set(&th->ready);
      event_timedwait(&th->done, 45 + (call == 2 ? 3000 : 0));
      break;
    }
  }
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint32_t*)0x20000198 = 0x200);
    NONFAILING(*(uint32_t*)0x2000019c = 0);
    NONFAILING(*(uint16_t*)0x200001a0 = 8);
    NONFAILING(*(uint16_t*)0x200001a2 = 0x1b);
    NONFAILING(*(uint32_t*)0x200001a4 = 0);
    NONFAILING(*(uint64_t*)0x200001c8 = 0x28);
  ...
  case 2:
    NONFAILING(memcpy(
        (void*)0x20000540,
        "\x12\x01\x05\x00\x97\xe6\x1d\x08\x4c\x05\xc1\x06\x66\xd5\x00\x00\x00"
        "\x01\x09\x02\x24\x00\x01\x00\x01\x00\x00\x09\x04\x00\x00\x02\x0d\x36"
        "\xe0\x00\x09\x05\x0e\x02\x00\x02\x00\x00\x00\x09\x05\x82\x02\x5c",
        50));
    NONFAILING(syz_usb_connect(0, 0x36, 0x20000540, 0));
    break;
  }
}
int main(void)
