...
// https://syzkaller.appspot.com/bug?id=ef31f7594f25559e333ecaa27961d2a3b129cb57
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000100, 5, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    *(uint32_t*)0x20001300 = 0xe8;
    res = syscall(__NR_getsockopt, -1, 0, 0x10, 0x20001200, 0x20001300);
    if (res != -1)
      r[1] = *(uint32_t*)0x20001234;
    break;
  case 2:
    *(uint32_t*)0x20001340 = -1;
    *(uint32_t*)0x20001344 = -1;
    res = syscall(__NR_getgroups, 2, 0x20001340);
    if (res != -1)
      r[2] = *(uint32_t*)0x20001340;
    break;
  case 3:
    memcpy((void*)0x20001180, "./file0", 8);
    memcpy((void*)0x200011c0, "./file0", 8);
    syz_fuseblk_mount(0x20001180, 0x200011c0, 0x1000, r[1], r[2], 0x800,
                      0xffffffffffff22fc, 0);
    break;
  case 4:
  ...
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_ioctl, r[0], 0x4b49, 0x20001380);
    break;
  case 7:
    memcpy((void*)0x20000000, "/dev/urandom", 13);
    res = syz_open_dev(0x20000000, 0, 0x100);
    if (res != -1)
      r[4] = res;
    break;
  case 8:
    ...
    *(uint32_t*)0x20000144 = 0;
    syscall(__NR_ioctl, r[4], 0x40085203, 0x20000140);
    break;
  case 9:
    syscall(__NR_write, r[0], 0x20c34fff, 0xffffff0b);
    break;
  case 10:
    *(uint32_t*)0x20000040 = 6;
    syscall(__NR_ioctl, r[3], 0x5412, 0x20000040);
    break;
  }
}
