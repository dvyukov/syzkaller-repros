...
// https://syzkaller.appspot.com/bug?id=84ff1bf058b825b77439e1ced9ede4d39044158c
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    NONFAILING(
        memcpy((void*)0x20002800,
               "\x12\x01\x00\x00\x88\x3d\x1d\x08\xe9\x17\xbb\xb9\x43\x89\x00"
               "\x00\x00\x01\x09\x02\x18\x00\x01\x00\x00\x00\x00\x09\x04\xae"
               "\x00\x00\xff\x00\x00\x00\x06\x5f\x8f\x00\x00\x00",
               42));
    syz_usb_connect(5, 1, 0x20002800, 0);
    break;
  }
}
int main(void)
