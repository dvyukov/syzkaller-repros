...
// https://syzkaller.appspot.com/bug?id=e51249708aaa9b0e4d2c
// status:6
...
int main(void)
{
  ...
  *(uint32_t*)0x20000098 = -1;
  ...
  res = -1;
  res = syz_io_uring_setup(0x187, 0x20000080, 0x20ee7000, 0x20355000,
  ...
  *(uint8_t*)0x20000201 = 0x5f;
  *(uint16_t*)0x20000202 = 0x4004;
