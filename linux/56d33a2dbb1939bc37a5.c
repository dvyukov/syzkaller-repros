// kernel panic: corrupted stack end in sys_futex
// https://syzkaller.appspot.com/bug?id=56d33a2dbb1939bc37a5
// status:0
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    NONFAILING(memcpy((void*)0x200001c0, "incremental-fs\000", 15));
    syscall(__NR_setxattr, 0x20000140ul, 0ul, 0x200001c0ul, 0xful, 0ul);
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000280, "./file0/file0\000", 14));
    syscall(__NR_chown, 0x20000280ul, -1, 0xee01);
    break;
  }
}
int main(void)
