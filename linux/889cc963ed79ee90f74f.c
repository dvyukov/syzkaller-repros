...
// https://syzkaller.appspot.com/bug?id=889cc963ed79ee90f74f
// status:0
...
static void execute_one(void)
{
  ...
  for (call = 0; call < 26; call++) {
    for (thread = 0; thread < (int)(sizeof(threads) / sizeof(threads[0]));
      ...
      event_set(&th->ready);
      event_timedwait(&th->done, 45 + (call == 11 ? 100 : 0));
      break;
    }
  }
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_semop, 0, 0ul, 0ul);
    break;
  case 1:
    syscall(__NR_perf_event_open, 0ul, 0, -1ul, -1, 0ul);
    break;
  case 2:
    syscall(__NR_ioctl, -1, 0xc0285628ul, 0ul);
    break;
  case 3:
  ...
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_semctl, 0, 0ul, 0x13ul, 0ul);
    break;
  case 6:
  ...
  case 7:
    ...
    break;
  case 8:
    syscall(__NR_getdents, r[1], 0ul, 0ul);
    break;
  case 9:
    syscall(__NR_getdents, r[1], 0ul, 0ul);
    break;
  case 10:
    syscall(__NR_ioctl, r[1], 0x400454deul, 0ul);
    break;
  case 11:
    syz_mount_image(0, 0, 0xe000, 0, 0, 0, 0);
    break;
  case 12:
    syscall(__NR_dup, -1);
    break;
  ...
  case 14:
    ...
    break;
  case 15:
    syscall(__NR_sendto, r[2], 0ul, 0ul, 0x210007fdul, 0ul, 0ul);
    break;
  case 16:
  ...
  case 17:
    ...
    break;
  case 18:
    syscall(__NR_ioctl, r[3], 0x4b4eul, 0x24);
    break;
  case 19:
    syscall(__NR_sendfile, r[3], -1, 0ul, 0ul);
    break;
  case 20:
    syscall(__NR_umount2, 0ul, 0ul);
    break;
  case 21:
    syscall(__NR_openat, 0xffffffffffffff9cul, 0ul, 0x5b6ad32104e938aul, 0ul);
    break;
  case 22:
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0ul, 0ul, 0ul);
    if (res != -1)
    ...
    break;
  case 23:
    syscall(__NR_getsockopt, r[4], 0x84ul, 0x71ul, 0ul, 0ul);
    break;
  case 24:
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0ul, 0ul, 0ul);
    if (res != -1)
    ...
    break;
  case 25:
    syscall(__NR_getsockopt, r[5], 0x84ul, 0x71ul, 0ul, 0ul);
    break;
  }
}
int main(void)
