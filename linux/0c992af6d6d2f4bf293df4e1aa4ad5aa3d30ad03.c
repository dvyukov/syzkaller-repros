...
// https://syzkaller.appspot.com/bug?id=0c992af6d6d2f4bf293df4e1aa4ad5aa3d30ad03
// status:open
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    syscall(__NR_ioctl, r[1], 0x5423, 0x20000200);
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x20000100 = 0x11);
    syscall(__NR_ioctl, r[1], 0x5423, 0x20000100);
    break;
  case 5:
    syscall(__NR_ioctl, r[1], 0x5437, 0);
    break;
  case 6:
    syscall(__NR_ioctl, r[0], 0x540b, 0);
    break;
  }
}
int main(void)
