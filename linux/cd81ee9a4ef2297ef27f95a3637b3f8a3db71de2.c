...
// https://syzkaller.appspot.com/bug?id=cd81ee9a4ef2297ef27f95a3637b3f8a3db71de2
// status:open
...
void loop(void)
{
  ...
  *(uint8_t*)0x20000006 = 0xde;
  *(uint8_t*)0x20000007 = 8;
  *(uint16_t*)0x20000008 = 0xac8;
  *(uint16_t*)0x2000000a = 0xc301;
  *(uint16_t*)0x2000000c = 0x14a;
  ...
  *(uint8_t*)0x20000021 = 0x90;
  *(uint8_t*)0x20000022 = 0x6e;
