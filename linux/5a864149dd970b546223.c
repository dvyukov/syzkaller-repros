...
// https://syzkaller.appspot.com/bug?id=5a864149dd970b546223
// status:0
...
void execute_one(void)
{
  ...
  res = -1;
  NONFAILING(res = syz_io_uring_setup(0x87, 0x20000240, 0x20ffa000, 0x20ffd000,
  ...
  NONFAILING(*(uint8_t*)0x20000200 = 0xf);
  ...
  NONFAILING(*(uint64_t*)0x20000210 = 0x20000480);
  NONFAILING(*(uint64_t*)0x20000480 = 0);
  NONFAILING(*(uint64_t*)0x20000488 = 0x989680);
  ...
  NONFAILING(*(uint8_t*)0x200000c0 = 0xb);
  NONFAILING(*(uint8_t*)0x200000c1 = 5);
  NONFAILING(*(uint16_t*)0x200000c2 = 0);
  NONFAILING(*(uint32_t*)0x200000c4 = 0);
  NONFAILING(*(uint64_t*)0x200000c8 = 3);
  NONFAILING(*(uint64_t*)0x200000d0 = 0x20000080);
  NONFAILING(*(uint64_t*)0x20000080 = 0);
  NONFAILING(*(uint64_t*)0x20000088 = 0);
  NONFAILING(*(uint32_t*)0x200000d8 = 1);
  NONFAILING(*(uint32_t*)0x200000dc = 0);
  NONFAILING(*(uint64_t*)0x200000e0 = 1);
  NONFAILING(*(uint16_t*)0x200000e8 = 0);
  NONFAILING(*(uint16_t*)0x200000ea = 0);
  NONFAILING(memset((void*)0x200000ec, 0, 20));
  NONFAILING(syz_io_uring_submit(r[1], r[2], 0x200000c0, 8));
  ...
  NONFAILING(
      syz_io_uring_setup(0x9c2, 0x20000080, 0x20ee7000, 0x206d4000, 0, 0));
