...
// https://syzkaller.appspot.com/bug?id=c8f52ab16178cebd5f5c
// status:3
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint32_t*)0x20000390 = 1);
    ...
    syscall(__NR_ioctl, r[0], 0x4601, 0x20000340ul);
    break;
  case 2:
  ...
  case 5:
    NONFAILING(*(uint32_t*)0x20000340 = 0);
    NONFAILING(*(uint32_t*)0x20000344 = 0x10);
    NONFAILING(*(uint32_t*)0x20000348 = 0xa00);
    NONFAILING(*(uint32_t*)0x2000034c = 0);
    NONFAILING(*(uint32_t*)0x20000350 = 0);
    NONFAILING(*(uint32_t*)0x20000354 = 0);
    NONFAILING(*(uint32_t*)0x20000358 = 4);
    ...
    NONFAILING(*(uint32_t*)0x20000374 = 0);
    NONFAILING(*(uint32_t*)0x20000378 = 0);
    NONFAILING(*(uint32_t*)0x2000037c = 0x81);
    NONFAILING(*(uint32_t*)0x20000380 = 0);
    NONFAILING(*(uint32_t*)0x20000384 = 0);
    NONFAILING(*(uint32_t*)0x20000388 = 0);
    NONFAILING(*(uint32_t*)0x2000038c = 0);
    ...
    NONFAILING(*(uint32_t*)0x200003b8 = 0);
    NONFAILING(*(uint32_t*)0x200003bc = 0);
    NONFAILING(*(uint32_t*)0x200003c0 = 0x15);
    NONFAILING(*(uint32_t*)0x200003c4 = 0);
    NONFAILING(*(uint32_t*)0x200003c8 = 0);
    NONFAILING(*(uint32_t*)0x200003cc = 0);
    NONFAILING(*(uint32_t*)0x200003d0 = 0);
