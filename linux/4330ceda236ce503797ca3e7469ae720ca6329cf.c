...
void execute_one(void)
{
  ...
  if (res != -1)
    r[0] = res;
  syscall(__NR_ioctl, r[0], 0x8912ul, 0x400200ul);
  ...
  NONFAILING(*(uint16_t*)0x20000104 = r[2]);
  NONFAILING(*(uint16_t*)0x20000106 = 0x703);
  NONFAILING(*(uint32_t*)0x20000108 = 0);
  NONFAILING(*(uint32_t*)0x2000010c = 0);
  NONFAILING(*(uint8_t*)0x20000110 = 6);
  NONFAILING(*(uint8_t*)0x20000111 = 0);
  NONFAILING(*(uint16_t*)0x20000112 = 0);
  NONFAILING(*(uint64_t*)0x20000188 = 0x14);
