...
// https://syzkaller.appspot.com/bug?id=fa20b5a614586d65ae48
// status:0
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[1] = res;
  NONFAILING(*(uint64_t*)0x200010c0 = 0x20000080);
  NONFAILING(*(uint64_t*)0x200010c8 = 0xa6);
  NONFAILING(*(uint64_t*)0x200010d0 = 0x200000c0);
  NONFAILING(*(uint64_t*)0x200010d8 = 0x1000);
  syscall(__NR_preadv, r[1], 0x200010c0ul, 2ul, 2, 0x800000);
