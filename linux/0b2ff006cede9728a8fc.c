...
// https://syzkaller.appspot.com/bug?id=0b2ff006cede9728a8fc
// status:6
...
void execute_call(int call)
{
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000000, "./mnt\000", 6));
    NONFAILING(syz_mount_image(0, 0x20000000, 0, 0, 0, 0, 0));
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000100, "mnt/encrypted_dir\000", 18));
    ...
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000040, "./mnt\000", 6));
    NONFAILING(memcpy((void*)0x20000200, "./mnt\000", 6));
    NONFAILING(memcpy((void*)0x20000240, "incremental-fs\000", 15));
    syscall(__NR_mount, 0x20000040ul, 0x20000200ul, 0x20000240ul, 0ul, 0ul);
    {
      int i;
      for (i = 0; i < 64; i++) {
        syscall(__NR_mount, 0x20000040ul, 0x20000200ul, 0x20000240ul, 0ul, 0ul);
