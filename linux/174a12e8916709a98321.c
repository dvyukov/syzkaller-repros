// SYZFAIL: both collide and fault injection are enabled
// https://syzkaller.appspot.com/bug?id=174a12e8916709a98321
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(*(uint64_t*)0x20000338 = 0x20000000);
  NONFAILING(*(uint64_t*)0x20000340 = 0xdc17);
  ...
  NONFAILING(*(uint32_t*)0x20000368 = 0xfffffffe);
  ...
  syscall(__NR_perf_event_open, 0x20000300ul, 0, 0x200000000ul, -1, 0ul);
