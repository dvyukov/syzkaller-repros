...
void execute_call(int call)
{
  ...
  case 2:
    ...
    *(uint32_t*)0x201feffc = 0;
    syscall(__NR_bind, r[0], 0x201fefe4, 0x1c);
    break;
  case 3:
  ...
  case 5:
    ...
    *(uint8_t*)0x200000cf = 0;
    syscall(__NR_connect, r[1], 0x200000c0, 0x10);
    break;
  case 6:
    syscall(__NR_ioctl, r[1], 0x894b, 0x20000140);
    break;
  }
}
int main()
