...
// https://syzkaller.appspot.com/bug?id=46682331b57dc6fd00d4
// status:0
...
void loop(void)
{
  ...
  *(uint8_t*)0x20000041 = 0x3e;
  *(uint8_t*)0x20000042 = 0x11;
  *(uint8_t*)0x20000043 = 0xb;
  ...
  *(uint8_t*)0x20000053 = 0x1e;
  syz_emit_vhci(0x20000040, 0x14);
}
int main(void)
{
