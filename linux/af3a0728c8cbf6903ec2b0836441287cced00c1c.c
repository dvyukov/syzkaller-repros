...
// https://syzkaller.appspot.com/bug?id=af3a0728c8cbf6903ec2b0836441287cced00c1c
// status:fixed
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_socketpair, 2, 1, 0, 0x20000000);
    break;
  case 1:
    NONFAILING(memcpy((void*)0x200000c0, "/dev/ptmx", 10));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x200000c0, 0x80000, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
    res = syz_open_pts(r[0], 0x101080);
    if (res != -1)
      r[1] = res;
    break;
  case 3:
    NONFAILING(*(uint64_t*)0x20000940 = 0x200008c0);
    NONFAILING(*(uint64_t*)0x20000948 = 0x75);
    syscall(__NR_readv, r[1], 0x20000940, 1);
    break;
  }
}
int main()
