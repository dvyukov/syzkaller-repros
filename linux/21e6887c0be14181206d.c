...
// https://syzkaller.appspot.com/bug?id=21e6887c0be14181206d
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    *(uint32_t*)0x20000018 = 0;
    ...
    res = -1;
    res = syz_io_uring_setup(0x2de5, 0x20000000, 0x20002000, 0x20fe8000,
  ...
  case 2:
    ...
    *(uint16_t*)0x200001ea = 0;
    ...
    break;
  case 3:
    syscall(__NR_io_uring_enter, r[0], 0xb2, 0, 0ul, 0ul, 0x7401ul);
    break;
  }
}
int main(void)
