...
void* thr(void* arg)
{
  ...
  case 0:
    ...
    break;
  case 1:
    r[1] = syscall(__NR_ioctl, 0xfffffffffffffffful, 0x540ful,
                   0x20006000ul);
    if (r[1] != -1)
      NONFAILING(r[2] = *(uint32_t*)0x20006000);
    break;
  case 2:
    NONFAILING(memcpy(
        (void*)0x2000d000,
        "\x61\x74\x74\x72\x2f\x63\x75\x72\x72\x65\x6e\x74\x00", 13));
    r[4] = syz_open_procfs(r[2], 0x2000d000ul);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000fff, "\x07", 1));
    r[6] = syscall(__NR_write, r[4], 0x20000ffful, 0x1ul);
    break;
  }
  return 0;
}
