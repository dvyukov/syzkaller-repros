...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint32_t*)0x20000380 = 0x3c);
    NONFAILING(*(uint16_t*)0x20000384 = 0x10);
    NONFAILING(*(uint16_t*)0x20000386 = 0x70d);
    ...
    NONFAILING(*(uint16_t*)0x200003a0 = 0x1c);
    NONFAILING(*(uint16_t*)0x200003a2 = 0x12);
    NONFAILING(*(uint16_t*)0x200003a4 = 0xc);
    NONFAILING(*(uint16_t*)0x200003a6 = 1);
    NONFAILING(memcpy((void*)0x200003a8, "bond\000", 5));
    NONFAILING(*(uint16_t*)0x200003b0 = 0xc);
    NONFAILING(*(uint16_t*)0x200003b2 = 2);
    NONFAILING(*(uint16_t*)0x200003b4 = 8);
    NONFAILING(*(uint16_t*)0x200003b6 = 7);
    NONFAILING(*(uint32_t*)0x200003b8 = 0x400080);
