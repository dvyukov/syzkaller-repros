...
// https://syzkaller.appspot.com/bug?id=9acfe5e3a1bf51a789ddfe1c8763d8ac5d06c360
// status:open
...
void execute_one(void)
{
  ...
  memcpy((void*)0x200000c0, "net/igmp\000", 9);
  ...
  memcpy((void*)0x20000640, "/dev/ttyS3\000", 11);
