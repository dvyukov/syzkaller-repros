...
// https://syzkaller.appspot.com/bug?id=739e5b9d4646ff8618a9
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    NONFAILING(memcpy(
        ...
        50));
    NONFAILING(*(uint16_t*)0x20000032 = -1);
    res = -1;
    NONFAILING(res = syz_usb_connect(0, 0x4a, 0x20000000, 0));
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x20000180 = 0x14);
    NONFAILING(*(uint64_t*)0x20000184 = 0x20000040);
    ...
    NONFAILING(*(uint8_t*)0x20000047 = 0x16);
    NONFAILING(*(uint64_t*)0x2000018c = 0x200001c0);
    NONFAILING(syz_usb_control_io(r[0], 0x20000180, 0));
    break;
  case 2:
    NONFAILING(syz_usb_ep_write(r[0], 0x82, 0x88, 0));
    break;
  }
}
int main(void)
