...
// https://syzkaller.appspot.com/bug?id=0f7e7e5e2f4f40fa89c0
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    NONFAILING(*(uint64_t*)0x20000080 = 0x20000240);
    NONFAILING(*(uint32_t*)0x20000240 = 5);
    NONFAILING(*(uint32_t*)0x20000244 = 0);
    NONFAILING(*(uint32_t*)0x20000248 = 0);
    NONFAILING(*(uint64_t*)0x20000250 = 0);
    NONFAILING(*(uint64_t*)0x20000258 = 0xea60);
    NONFAILING(*(uint64_t*)0x20000260 = 0);
    NONFAILING(*(uint64_t*)0x20000268 = 0xea60);
    NONFAILING(STORE_BY_BITMASK(uint32_t, , 0x20000270, 0, 0, 29));
    NONFAILING(STORE_BY_BITMASK(uint32_t, , 0x20000270, 0, 29, 1));
    NONFAILING(STORE_BY_BITMASK(uint32_t, , 0x20000270, 0, 30, 1));
    NONFAILING(STORE_BY_BITMASK(uint32_t, , 0x20000270, 0, 31, 1));
    NONFAILING(*(uint32_t*)0x20000274 = 1);
    NONFAILING(STORE_BY_BITMASK(uint32_t, , 0x20000278, 0, 0, 29));
    NONFAILING(STORE_BY_BITMASK(uint32_t, , 0x20000278, 0, 29, 1));
    NONFAILING(STORE_BY_BITMASK(uint32_t, , 0x20000278, 0, 30, 1));
    NONFAILING(STORE_BY_BITMASK(uint32_t, , 0x20000278, 0, 31, 1));
    NONFAILING(*(uint8_t*)0x2000027c = 0);
    NONFAILING(*(uint8_t*)0x2000027d = 0);
    NONFAILING(*(uint8_t*)0x2000027e = 0);
    NONFAILING(*(uint8_t*)0x2000027f = 0);
    NONFAILING(
        memcpy((void*)0x20000280, "\xc1\xd0\x0e\x42\x24\x10\xd4\x68", 8));
    NONFAILING(*(uint64_t*)0x20000088 = 0x48);
  ...
  case 3:
    ...
    break;
  case 4:
    res = syscall(__NR_socket, 0x1dul, 2ul, 6);
    if (res != -1)
      r[1] = res;
    break;
  case 5:
  ...
  case 6:
    ...
    break;
  case 7:
    NONFAILING(*(uint16_t*)0x200002c0 = 0x11);
    NONFAILING(*(uint16_t*)0x200002c2 = htobe16(0));
    NONFAILING(*(uint32_t*)0x200002c4 = r[2]);
    NONFAILING(*(uint16_t*)0x200002c8 = 1);
    NONFAILING(*(uint8_t*)0x200002ca = 0x1f);
    NONFAILING(*(uint8_t*)0x200002cb = 6);
    NONFAILING(memset((void*)0x200002cc, 0, 6));
    NONFAILING(memset((void*)0x200002d2, 0, 2));
    syscall(__NR_bind, r[1], 0x200002c0ul, 0x14ul);
    break;
  case 8:
  ...
  case 10:
    ...
    break;
  case 11:
    syscall(__NR_ioctl, r[3], 0x8933, 0ul);
    break;
  case 12:
    syscall(__NR_bind, r[3], 0ul, 0ul);
    break;
  case 13:
    res = syscall(__NR_socket, 0x1dul, 2ul, 6);
    if (res != -1)
    ...
    break;
  case 14:
    syscall(__NR_ioctl, r[4], 0x8933, 0ul);
    break;
  case 15:
  ...
  case 17:
    ...
    NONFAILING(*(uint64_t*)0x200003d0 = 0x20000340);
    NONFAILING(*(uint64_t*)0x20000340 = 0x200002c0);
    NONFAILING(*(uint64_t*)0x200002c0 = 0);
    NONFAILING(*(uint64_t*)0x200002c8 = 0xea60);
    NONFAILING(*(uint64_t*)0x200002d0 = -1);
    NONFAILING(*(uint64_t*)0x200002d8 = -1);
    NONFAILING(*(uint64_t*)0x20000348 = 0x48);
    NONFAILING(*(uint64_t*)0x200003d8 = 1);
    NONFAILING(*(uint64_t*)0x200003e0 = 0);
    NONFAILING(*(uint64_t*)0x200003e8 = 0);
    NONFAILING(*(uint32_t*)0x200003f0 = 0x8000);
    syscall(__NR_sendmsg, r[1], 0x200003c0ul, 4ul);
    break;
  }
}
int main(void)
