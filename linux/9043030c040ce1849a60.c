...
// https://syzkaller.appspot.com/bug?id=9043030c040ce1849a60
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(memcpy(
        (void*)0x20000040,
        "\x20\x00\x00\x00\x00\x02\x00\x00\x19\x00\x00\x00\x50\x01\x00\x00\x0f"
        ...
        102));
    NONFAILING(*(uint64_t*)0x20000388 = 0x66);
    NONFAILING(*(uint64_t*)0x20000390 = 0x400);
    NONFAILING(*(uint64_t*)0x20000398 = 0x20010100);
    NONFAILING(memcpy((void*)0x20010100, "\x00\x00\xe3\x31\x00\x00\x00\x00\x11"
                                         "\x00\x00\x00\xb1\x38\x54\x31\x12\xeb"
                                         "\x43\xac\x9d\xbc\x7e\x14\x11\xf6\x4d"
                                         "\x55\x01\x00\x40",
                      31));
    NONFAILING(*(uint64_t*)0x200003a0 = 0x1f);
    NONFAILING(*(uint64_t*)0x200003a8 = 0x4e0);
    NONFAILING(*(uint64_t*)0x200003b0 = 0x20010200);
    NONFAILING(
        memcpy((void*)0x20010200, "\x01\x00\x00\x00\x00\x00\x05\x00\x40", 9));
    NONFAILING(*(uint64_t*)0x200003b8 = 9);
    NONFAILING(*(uint64_t*)0x200003c0 = 0x560);
    NONFAILING(*(uint64_t*)0x200003c8 = 0x20000540);
    NONFAILING(memcpy(
        (void*)0x20000540,
        "\xff\x07\x00\x00\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff"
        ...
        "\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff"
        "\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff"
        "\xff\xff\x77\xf3\x3a\x49\x4d\xea\x43\x38\x7a\xce\x4e\x87\x1a\xff\xff"
        "\xff\xff",
        155));
    NONFAILING(*(uint64_t*)0x200003d0 = 0x9b);
    NONFAILING(*(uint64_t*)0x200003d8 = 0);
    NONFAILING(*(uint64_t*)0x200003e0 = 0x200000c0);
    NONFAILING(
        memcpy((void*)0x200000c0, "\x50\x4d\x4d\x00\x50\x4d\x4d\xff", 8));
    NONFAILING(*(uint64_t*)0x200003e8 = 8);
    NONFAILING(*(uint64_t*)0x200003f0 = 0x10000);
    NONFAILING(*(uint64_t*)0x200003f8 = 0);
    NONFAILING(*(uint64_t*)0x20000400 = 0);
    NONFAILING(*(uint64_t*)0x20000408 = 0xfffffffffffffffc);
    NONFAILING(*(uint8_t*)0x20000500 = 0);
    NONFAILING(syz_mount_image(0x20000000, 0x20000100, 0, 6, 0x20000380, 0,
                               0x20000500));
    break;
  case 1:
