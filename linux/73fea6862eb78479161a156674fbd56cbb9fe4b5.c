...
// https://syzkaller.appspot.com/bug?id=73fea6862eb78479161a156674fbd56cbb9fe4b5
// status:open
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    NONFAILING(*(uint32_t*)0x20000088 = 0x7ffd);
    NONFAILING(*(uint32_t*)0x2000008c = 0x7d);
    ...
    syscall(__NR_bpf, 0xc00000000000000, 0x20000080, 0x2c);
    break;
  case 3:
  ...
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_ioctl, r[0], 0x6612, 0);
    break;
  case 6:
    syscall(__NR_mount, 0, 0, 0, 0x2288049, 0);
    break;
  case 7:
    ...
    NONFAILING(*(uint64_t*)0x20000190 = 0xa549);
    NONFAILING(*(uint64_t*)0x20000198 = 0);
    NONFAILING(*(uint64_t*)0x200001a0 = 0);
    NONFAILING(*(uint64_t*)0x200001a8 = 7);
    syz_mount_image(0x20000000, 0x20000040, 2, 2, 0x20000180, 0x10008, 0);
    break;
  case 8:
    ...
    break;
  case 9:
    NONFAILING(*(uint32_t*)0x20000100 = 0xf);
    syscall(__NR_ioctl, r[1], 0x5423, 0x20000100);
    break;
  case 10:
    syscall(__NR_ioctl, r[1], 0x400455c8, 2);
    break;
  case 11:
    syscall(__NR_ioctl, r[1], 0x5423, 0);
    break;
  case 12:
    NONFAILING(*(uint16_t*)0x20000480 = 7);
    NONFAILING(*(uint16_t*)0x20000482 = 0);
    NONFAILING(*(uint16_t*)0x20000484 = 0xff);
    syscall(__NR_ioctl, r[1], 0x4b68, 0x20000480);
    break;
  }
}
int main(void)
