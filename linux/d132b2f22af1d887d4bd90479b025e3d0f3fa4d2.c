...
// https://syzkaller.appspot.com/bug?id=d132b2f22af1d887d4bd90479b025e3d0f3fa4d2
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_ioctl, -1, 0x4b66ul, 0ul);
    break;
  case 3:
  ...
  case 6:
    ...
    NONFAILING(*(uint64_t*)0x20000150 = 4);
  ...
  case 9:
    ...
    NONFAILING(*(uint64_t*)0x20000410 = 0x20000080);
    NONFAILING(*(uint64_t*)0x20000080 = 0x200004c0);
    NONFAILING(memcpy(
        (void*)0x200004c0,
        "\x00\x00\x00\xf2\x13\x01\xce\x64\x6b\xa1\xa3\x45\x78\xd3\xab\xdf\x1e"
        "\x15\x56\x67\x01\x80\x01\x00\x00\x00\x00\x00\x67\xa2\xb4\xec\xb7\x5c"
        "\x52\x80\xfb\xca\x3c\xe9\xbb\xdc\x7e\x50\x79\x76\x39\x31\x96\xa1\x46"
        "\x9f\x19\xf4\x44\xf3\x92\x00\x88\x1b\x8a\xfe\xf9\x6d\xbc\xbe\x63\xcb"
        "\x97\x5d\x3b\x99\x83\xc3\xd5\x4c\x3a\x79\x4e\xc3\x59\xa4\x2e\x9c\x72"
        "\xd1\x36\x9f\x22\xee\x5c\x50\xc8\x46\x88\xe0\x4a\x14\x51\x04\xf2\xf5"
        "\x18\x45\x3b\xec\x82\xbd\x0b\x54\xfd\xcb\x0a\x7b\xc4\xac\x6c\xc4\xea"
        "\x5f\x65\x06\xcb\x8e\x72\x80\xb8\x5b\x22\xb1\x67",
        131));
    ...
    break;
  case 10:
    NONFAILING(*(uint32_t*)0x20000740 = 3);
    NONFAILING(*(uint32_t*)0x20000744 = 2);
    NONFAILING(*(uint64_t*)0x20000748 = 0xf000);
    NONFAILING(*(uint64_t*)0x20000750 = 0x1000);
    NONFAILING(*(uint64_t*)0x20000758 = 0x20015000);
    syscall(__NR_ioctl, r[1], 0x4020ae46ul, 0x20000740ul);
    break;
  case 11:
    res = syscall(__NR_ioctl, r[1], 0xae41ul, 0ul);
    if (res != -1)
      r[2] = res;
    break;
  case 12:
    ...
    NONFAILING(*(uint64_t*)0x200000d0 = 0x2000);
    NONFAILING(*(uint64_t*)0x200000d8 = 0x20000000);
    syscall(__NR_ioctl, r[1], 0x4020ae46ul, 0x200000c0ul);
    break;
  case 13:
    ...
    NONFAILING(*(uint64_t*)0x200003b0 = 0xff);
    ...
    NONFAILING(*(uint64_t*)0x20000400 = 0x1f004);
    NONFAILING(*(uint64_t*)0x20000408 = 0);
    syscall(__NR_ioctl, r[2], 0x4090ae82ul, 0x20000380ul);
    break;
  case 14:
    syscall(__NR_ioctl, r[2], 0xae80ul, 0ul);
    break;
  case 15:
    syscall(__NR_ioctl, r[2], 0xae80ul, 0x400000000000000ul);
    break;
  case 16:
