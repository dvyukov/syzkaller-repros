...
// https://syzkaller.appspot.com/bug?id=55f261c9341501c4027386b079a6b59e8b5128d9
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_clone, 0x2102001ff9, 0, 0x9999999999999999, 0, -1);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000040, "[::]::/llb:\000", 12));
    NONFAILING(memcpy((void*)0x20000200, "./file0\000", 8));
    NONFAILING(memcpy((void*)0x20000100, "ceph\000", 5));
    syscall(__NR_mount, 0x20000040, 0x20000200, 0x20000100, 0, 0);
    break;
  }
}
int main(void)
