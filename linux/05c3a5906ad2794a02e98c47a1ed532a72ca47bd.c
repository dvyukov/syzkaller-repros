...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000300, "/dev/vhost-vsock", 17));
  ...
  case 3:
    ...
    syscall(__NR_connect, r[1], 0x20000200, 0x10);
    break;
  case 4:
  ...
  case 5:
    ...
    syscall(__NR_timer_create, 0, 0x20044000, 0x20000000);
    break;
  case 6:
    ...
    break;
  case 7:
    NONFAILING(*(uint16_t*)0x20000400 = 0x27);
    NONFAILING(*(uint32_t*)0x20000404 = 0);
    NONFAILING(*(uint32_t*)0x20000408 = 0);
    NONFAILING(*(uint32_t*)0x2000040c = 0);
    syscall(__NR_connect, r[1], 0x20000400, 0x80);
    break;
  case 8:
    NONFAILING(*(uint64_t*)0x20000080 = 4);
    NONFAILING(*(uint64_t*)0x20000088 = 0x10000);
    NONFAILING(*(uint64_t*)0x20000090 = 8);
    NONFAILING(*(uint64_t*)0x20000098 = 0);
    NONFAILING(*(uint64_t*)0x200000a0 = 0x32);
    syscall(__NR_ioctl, r[3], 0xc008aeb0, 0x20000080);
    break;
  case 9:
    NONFAILING(*(uint64_t*)0x200000c0 = 0);
    NONFAILING(*(uint64_t*)0x200000c8 = 8);
    NONFAILING(*(uint64_t*)0x200000d0 = 0);
    NONFAILING(*(uint64_t*)0x200000d8 = 9);
    syscall(__NR_timer_settime, 0, 0, 0x200000c0, 0x20040000);
    break;
  case 10:
    syscall(__NR_tkill, r[2], 0x16);
    break;
  }
}
int main(void)
