...
// https://syzkaller.appspot.com/bug?id=ee3fbff55fb1db0409d6f160c1f4d41d5c6f026a
// status:open
...
void execute_one(void)
{
  ...
  memcpy((void*)0x20000100, "jdev", 4);
  *(uint8_t*)0x20000104 = 0x3d;
  memcpy((void*)0x20000105, "./file1", 7);
  *(uint8_t*)0x2000010c = 0x38;
  *(uint8_t*)0x2000010d = 0;
  inject_fault(98);
  syz_mount_image(0x20000000, 0x20000140, 0, 0, 0, 0, 0x20000100);
}
int main(void)
{
  inject_fault(98);
