...
{
  long res = 0;
  res = syscall(__NR_socket, 2, 3, 0x33);
  if (res != -1)
    r[0] = res;
  ...
  if (res != -1)
    r[1] = res;
  *(uint64_t*)0x200006c0 = 0x20000280;
  *(uint16_t*)0x20000280 = 0;
  *(uint8_t*)0x20000282 = 0xeb;
  *(uint32_t*)0x20000284 = 0xffffff7f;
  *(uint32_t*)0x200006c8 = 0x6e;
  *(uint64_t*)0x200006d0 = 0;
  *(uint64_t*)0x200006d8 = 0;
  *(uint64_t*)0x200006e0 = 0;
  *(uint64_t*)0x200006e8 = 0;
  *(uint32_t*)0x200006f0 = 0;
  syscall(__NR_sendmmsg, r[1], 0x200006c0, 1, 0);
