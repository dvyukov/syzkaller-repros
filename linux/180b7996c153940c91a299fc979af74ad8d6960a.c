...
// https://syzkaller.appspot.com/bug?id=180b7996c153940c91a299fc979af74ad8d6960a
// status:open
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    NONFAILING(memcpy((void*)0x20000080,
                      "\xba\xa1\x00\xb0\x00\xee\xf3\x6c\xba\x21\x00\xec\x66\xb9"
                      "\x80\x00\x00\xc0\x0f\x32\x66\x35\x00\x10\x00\x00\x0f\x30"
                      "\xba\xd1\x04\xec\xc8\x00\x80\xd2\x67\xd9\xf8\xf3\x0f\x1b"
                      "\xb4\x29\x00\x0f\x20\xc0\x66\x35\x20\x00\x00\x00\x0f\x22"
                      "\xc0\x67\xf3\xaf",
                      60));
  ...
  case 3:
    ...
    break;
  case 4:
    NONFAILING(*(uint64_t*)0x20000140 = 0x40000000000009);
  ...
  case 7:
    ...
    NONFAILING(*(uint64_t*)0x20000248 = 0x80000000000);
    ...
    syscall(__NR_ioctl, r[2], 0x4090ae82, 0x20000200);
    break;
  case 8:
  ...
  case 9:
    ...
    break;
  case 10:
    syz_kvm_setup_cpu(r[1], -1, 0x205cf000, 0, 0, 0, 0, 0xffffffffffffff2b);
    break;
  }
}
int main(void)
