...
// https://syzkaller.appspot.com/bug?id=76c1b763c5c81b019efbfa8095218a4b64cd43fc
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint8_t*)0x200000c4 = 0xac);
    NONFAILING(*(uint8_t*)0x200000c5 = 0x14);
    NONFAILING(*(uint8_t*)0x200000c6 = 0x14);
    NONFAILING(*(uint8_t*)0x200000c7 = 0x16);
    syscall(__NR_connect, r[0], 0x200000c0ul, 0x10ul);
    break;
  case 2:
    NONFAILING(*(uint32_t*)0x20000000 = 0);
    syscall(__NR_setsockopt, r[0], 1ul, 8ul, 0x20000000ul, 4ul);
    break;
  }
}
int main(void)
