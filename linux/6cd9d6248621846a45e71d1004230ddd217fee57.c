// KASAN: stack-out-of-bounds in update_curr
// https://syzkaller.appspot.com/bug?id=6cd9d6248621846a45e71d1004230ddd217fee57
// status:dup
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    NONFAILING(*(uint8_t*)0x20000217 = 0x13);
  ...
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_sendmmsg, r[0], 0x20000240, 0x5c3, 0);
    break;
  }
}
int main(void)
