...
// https://syzkaller.appspot.com/bug?id=a4715dd4b7c866136f79
// status:0
...
void loop(void)
{
  ...
  syscall(__NR_preadv, r[0], 0ul, 0ul, 4, 0);
  ...
  *(uint32_t*)0x200002d8 = -1;
  ...
  inject_fault(6);
  syz_io_uring_setup(0x182, 0x200002c0, 0x20ee7000, 0x20ffc000, 0, 0);
  close_fds();
}
int main(void)
{
