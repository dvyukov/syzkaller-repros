...
// https://syzkaller.appspot.com/bug?id=b35a18756c4aef2fecc7dc21a2e45bcc3a80f014
// status:open
...
void execute_one(void)
{
  ...
  *(uint16_t*)0x200004ae = 0;
  syscall(__NR_perf_event_open, 0x20000440, 0, 1, -1, 0);
  ...
  *(uint64_t*)0x20000060 = 0xc;
  ...
  STORE_BY_BITMASK(uint64_t, , 0x20000068, 0x10000003, 5, 1);
  ...
  *(uint32_t*)0x2000009c = 0x18;
  *(uint64_t*)0x200000a0 = 0;
  *(uint32_t*)0x200000a8 = 0;
  *(uint16_t*)0x200000ac = 0;
  *(uint16_t*)0x200000ae = 0;
  res = syscall(__NR_perf_event_open, 0x20000040, -1, 0, -1, 0);
  if (res != -1)
    r[0] = res;
  *(uint64_t*)0x20000200 = 0x20000180;
  *(uint64_t*)0x20000208 = 0x22;
  syscall(__NR_readv, r[0], 0x20000200, 1);
}
int main(void)
{
