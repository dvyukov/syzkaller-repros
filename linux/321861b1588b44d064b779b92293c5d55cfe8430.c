...
void loop()
{
  ...
  *(uint64_t*)0x20000048 = 0x200000c0;
  memcpy((void*)0x200000c0,
         "\x40\x0f\xc5\xe3\xd6\xb9\x80\x00\x00\xc0\x0f\x32\x35\x00\x01\x00\x00"
         "\x0f\x30\x67\x0f\x35\xb8\x01\x00\x00\x00\x0f\x01\xd9\xc7\x44\x24\x00"
         "\x1f\x01\x00\x00\xc7\x44\x24\x02\x00\x00\x00\x00\xff\x1c\x24\x0f\x20"
         "\xd8\x35\x20\x00\x00\x00\x0f\x22\xd8\x64\x66\xf3\x65\xf2\x46\x0f\x21"
         "\xe4\x0f\x20\xc0\x35\x00\x00\x00\x80\x0f\x22\xc0\xb9\x80\x00\x00\xc0"
         "\x0f\x32\x35\x00\x04\x00\x00\x0f\x30\x0f\x01\xc8",
         97);
  *(uint64_t*)0x20000050 = 0x61;
  syz_kvm_setup_cpu(r[1], r[2], 0x20fe8000, 0x20000040, 1, 0, 0x20000180, 0);
  ...
  *(uint8_t*)0x2000000a = 0x3a;
  *(uint8_t*)0x2000000b = 0xd9;
  *(uint8_t*)0x2000000c = 1;
  *(uint8_t*)0x2000000d = 0;
  *(uint8_t*)0x2000000e = 0;
  *(uint8_t*)0x2000000f = 0;
  *(uint32_t*)0x20000010 = 0x3df6b8ee;
  *(uint32_t*)0x20000014 = 4;
  *(uint8_t*)0x20000018 = -1;
  *(uint8_t*)0x20000019 = 2;
