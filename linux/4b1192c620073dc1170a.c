...
// https://syzkaller.appspot.com/bug?id=4b1192c620073dc1170a
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    syz_mount_image(0x20000100, 0x20000180, 0, 0, 0x20000300, 0x21000,
                    0x20000280);
    break;
  case 2:
    ...
    *(uint64_t*)0x20000200 = 0x20010000;
    memcpy(
        ...
        "\x00\x00\x00\x20\x00\x00\x20\x00\x00\x00\xd2\xf4\x65\x5f\xd2\xf4\x65"
        "\x5f\x01\x00\xff\xff\x53\xef\x01\x00\x01\x00\x00\x00\xd1\xf4\x65\x5f"
  ...
  case 3:
    ...
    break;
  case 4:
    syscall(__NR_fallocate, r[0], 0ul, 0ul, 0x8000ul);
    break;
  }
}
int main(void)
