...
void execute_one()
{
  ...
  *(uint16_t*)0x20000002 = htobe16(0x800);
  ...
  *(uint32_t*)0x20000018 = 0;
  syscall(__NR_sendto, r[0], 0x200001c0, 0, 0, 0x20000000, 0x1c);
  ...
  *(uint16_t*)0x2000000c = htobe16(0xc);
  STORE_BY_BITMASK(uint32_t, 0x2000000e, 2, 0, 29);
  STORE_BY_BITMASK(uint32_t, 0x2000000e, 5, 29, 1);
  STORE_BY_BITMASK(uint32_t, 0x2000000e, 1, 30, 1);
  STORE_BY_BITMASK(uint32_t, 0x2000000e, 0x5c, 31, 1);
  *(uint8_t*)0x20000012 = 0;
  *(uint8_t*)0x20000013 = 1;
  *(uint8_t*)0x20000014 = 0;
  *(uint8_t*)0x20000015 = 0;
  memcpy((void*)0x20000016, "\x3d\x27\x5d\x77\x3d\xe2\x50\x16", 8);
  syz_emit_ethernet(0x1e, 0x20000000, 0);
}
