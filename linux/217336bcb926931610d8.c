...
// https://syzkaller.appspot.com/bug?id=217336bcb926931610d8
// status:0
...
void loop(void)
{
  ...
  *(uint32_t*)0x20000370 = 0;
  ...
  if (res != -1)
    r[5] = res;
  memcpy((void*)0x20000100, "wlan0\000\000\000\000\000\000\000\000\000\000\000",
         16);
  res = syscall(__NR_ioctl, r[3], 0x8933, 0x20000100ul);
  if (res != -1)
  ...
  *(uint32_t*)0x20000230 = 0;
  syscall(__NR_sendmsg, r[4], 0x20000200ul, 0ul);
}
int main(void)
{
