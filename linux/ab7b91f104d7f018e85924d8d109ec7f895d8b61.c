...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000100, "/dev/kvm", 9));
  ...
  case 2:
    NONFAILING(memcpy(
        (void*)0x20008f00,
        "\x39\x3b\x00\x04\x00\xfc\xff\x62\x67\x9f\xc3\xce\xfe\x57\x46\x00",
        16));
    NONFAILING(*(uint32_t*)0x20008f10 = 0);
    syscall(__NR_ioctl, -1, 0x8933, 0x20008f00);
    break;
  case 3:
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 1, 6, 1));
  ...
  case 4:
    NONFAILING(memcpy((void*)0x20000080,
                      "\x0a\x5c\xc8\x07\x00\x31\x5f\x85\x71\x50\x70", 11));
  ...
  case 5:
    ...
    NONFAILING(memcpy(
        (void*)0x20000040,
        "\x0f\x42\x5f\x69\xf2\x0f\x38\xf1\x0b\x65\x0f\xed\xa5\x00\x00\x66\xb9"
        "\x80\x00\x00\xc0\x0f\x32\x66\x35\x00\x40\x00\x00\x0f\x30\xb8\x0d\x00"
        "\x8e\xc8\x66\x66\xde\x3c\x0f\x01\xcf\x26\x0f\x01\xcb\x26\x65\x66\x0f"
        "\x3a\x61\x8c\x00\x60\x54\x0f\xc7\x6b\x39",
        61));
    NONFAILING(*(uint64_t*)0x20000250 = 0x3d);
    syz_kvm_setup_cpu(r[1], -1, 0x20005000, 0x20000240, 1, 0, 0x200002c0, 0);
    break;
  case 6:
