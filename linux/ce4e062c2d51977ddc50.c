...
// https://syzkaller.appspot.com/bug?id=ce4e062c2d51977ddc50
// status:0
...
int main(void)
{
  ...
  intptr_t res = 0;
  memcpy((void*)0x200006c0, "nl802154\000", 9);
  res = -1;
  ...
  *(uint16_t*)0x20000984 = r[0];
  *(uint16_t*)0x20000986 = 1;
  *(uint32_t*)0x20000988 = 0x70bd2c;
  *(uint32_t*)0x2000098c = 0x25dfdbfe;
  *(uint8_t*)0x20000990 = 0x17;
  *(uint8_t*)0x20000991 = 0;
  *(uint16_t*)0x20000992 = 0;
  *(uint16_t*)0x20000994 = 0xc;
  *(uint16_t*)0x20000996 = 6;
