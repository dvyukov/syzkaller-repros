...
// https://syzkaller.appspot.com/bug?id=a1d4267bf7091b153450
// status:0
...
{
  intptr_t res = 0;
  NONFAILING(memcpy((void*)0x20000240, "/dev/rfkill\000", 12));
  res =
      syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000240ul, 0x68902ul, 0ul);
  if (res != -1)
    r[0] = res;
  ...
  NONFAILING(*(uint8_t*)0x20000087 = 1);
