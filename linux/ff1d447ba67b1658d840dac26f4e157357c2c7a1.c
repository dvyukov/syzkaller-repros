...
void execute_call(int call)
{
  ...
  case 1:
    *(uint32_t*)0x20000040 = 0xf;
    ...
    break;
  case 2:
    syscall(__NR_ioctl, r[0], 0x400455c8ul, 0x100000001ul);
    break;
  case 3:
  ...
  case 4:
    ...
    *(uint32_t*)0x20000618 = 0;
    syscall(__NR_bind, r[1], 0x20000600ul, 0x1cul);
    break;
  case 5:
    *(uint16_t*)0x208d4fe4 = 0xa;
    *(uint16_t*)0x208d4fe6 = htobe16(0x4e20);
    *(uint32_t*)0x208d4fe8 = htobe32(9);
    *(uint64_t*)0x208d4fec = htobe64(0);
    *(uint64_t*)0x208d4ff4 = htobe64(1);
    *(uint32_t*)0x208d4ffc = 0;
    syscall(__NR_sendto, r[1], 0ul, 0ul, 0x20000008ul, 0x208d4fe4ul, 0x1cul);
    break;
  case 6:
    syscall(__NR_ftruncate, -1, 0x10099b7ul);
    break;
  }
}
int main(void)
