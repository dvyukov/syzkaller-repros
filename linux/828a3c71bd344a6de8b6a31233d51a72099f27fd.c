...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    memcpy((void*)0x20000440, "/dev/snapshot", 14);
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000440, 0x40001, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    ...
    *(uint16_t*)0x20000058 = 0x111;
    *(uint8_t*)0x2000005a = 0xb;
    ...
    *(uint8_t*)0x2000005f = 0;
    ...
    break;
  case 2:
    syscall(__NR_ioctl, r[0], 0x3305, 0x20000080);
    break;
  }
}
