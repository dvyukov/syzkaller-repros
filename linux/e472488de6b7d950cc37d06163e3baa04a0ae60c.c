...
// https://syzkaller.appspot.com/bug?id=e472488de6b7d950cc37d06163e3baa04a0ae60c
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    NONFAILING(*(uint32_t*)0x20000040 = 0xd);
    ...
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20346fd9, 5, 0, 4));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20346fd9, 1, 4, 4));
    NONFAILING(*(uint16_t*)0x20346fda = 0x9c);
    ...
    NONFAILING(*(uint64_t*)0x20000050 = 0x20000100);
    ...
    syscall(__NR_bpf, 5, 0x20000040, 0x48);
    break;
  }
}
int main(void)
