...
// https://syzkaller.appspot.com/bug?id=9a1e55b8c30bfecdf654
// status:2
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_setsockopt, -1, 0, 0x48a, 0ul, 0ul);
    break;
  case 4:
    syscall(__NR_io_setup, 0x100, 0ul);
    break;
  case 5:
    syscall(__NR_mknod, 0ul, 0x6000ul, 0x700 + procid * 2);
    break;
  case 6:
    syscall(__NR_clone, 0x24300900ul, 0ul, 0x9999999999999999ul, 0ul, -1ul);
    break;
  case 7:
    res = -1;
    NONFAILING(res = syz_open_dev(0xc, 4, 1));
    ...
    break;
  case 8:
    NONFAILING(*(uint8_t*)0x20000000 = 2);
    NONFAILING(*(uint8_t*)0x20000001 = 3);
    NONFAILING(*(uint16_t*)0x20000002 = 0);
    NONFAILING(*(uint16_t*)0x20000004 = 0);
    NONFAILING(*(uint16_t*)0x20000006 = 0x400);
    NONFAILING(*(uint16_t*)0x20000008 = 0x100);
    NONFAILING(*(uint16_t*)0x2000000a = 0);
    syscall(__NR_ioctl, r[1], 0x541c, 0x20000000ul);
    break;
  case 9:
    NONFAILING(*(uint8_t*)0x200000c0 = 3);
    syscall(__NR_ioctl, r[1], 0x541c, 0x200000c0ul);
    break;
  }
}
int main(void)
