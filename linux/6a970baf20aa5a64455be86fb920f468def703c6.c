...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint64_t*)0x20000008 = htobe64(0));
    NONFAILING(*(uint64_t*)0x20000010 = htobe64(1));
  ...
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_pipe, 0x20000040);
    break;
  case 4:
    syscall(__NR_getsockopt, -1, 0x84, 9, 0, 0);
    break;
  case 5:
    NONFAILING(*(uint16_t*)0x20000080 = 0x18);
    NONFAILING(*(uint32_t*)0x20000082 = 1);
    NONFAILING(*(uint32_t*)0x20000086 = 0);
    NONFAILING(*(uint32_t*)0x2000008a = r[0]);
    NONFAILING(*(uint16_t*)0x2000008e = 1);
    NONFAILING(*(uint16_t*)0x20000090 = 0);
    NONFAILING(*(uint16_t*)0x20000092 = 0);
    NONFAILING(*(uint16_t*)0x20000094 = 0);
    NONFAILING(*(uint16_t*)0x20000096 = 0xa);
    NONFAILING(*(uint16_t*)0x20000098 = htobe16(0));
    NONFAILING(*(uint32_t*)0x2000009a = htobe32(0));
    NONFAILING(*(uint8_t*)0x2000009e = 0xfe);
    NONFAILING(*(uint8_t*)0x2000009f = 0x80);
    ...
    NONFAILING(*(uint8_t*)0x200000ad = 0xbb);
    NONFAILING(*(uint32_t*)0x200000ae = 0);
    syscall(__NR_connect, r[1], 0x20000080, 0x32);
    break;
  case 6:
    NONFAILING(*(uint8_t*)0x200002c0 = 0xfe);
    NONFAILING(*(uint8_t*)0x200002c1 = 0x80);
    ...
    NONFAILING(*(uint8_t*)0x200002cf = 0xaa);
    NONFAILING(*(uint32_t*)0x200002d0 = htobe32(0));
    ...
    NONFAILING(*(uint16_t*)0x200002e8 = 0xa);
    ...
    NONFAILING(*(uint8_t*)0x20000360 = 1);
  ...
  case 7:
    ...
    break;
  case 8:
    syscall(__NR_ioctl, r[2], 0x1000008912, 0x20000000);
    break;
  case 9:
    syscall(__NR_sendmmsg, r[1], 0x20005fc0, 0x4000000000004ae, 0xa);
    break;
  }
}
int main(void)
