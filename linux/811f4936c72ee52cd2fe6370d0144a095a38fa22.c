...
// https://syzkaller.appspot.com/bug?id=811f4936c72ee52cd2fe6370d0144a095a38fa22
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    res = syscall(__NR_socket, 0x11, 0x200000000003, 0x300);
    if (res != -1)
      r[1] = res;
    break;
  case 3:
    syscall(__NR_setsockopt, r[1], 0x107, 0x12, 0, 0);
    break;
  case 4:
  ...
  case 6:
    ...
    break;
  case 7:
    NONFAILING(memcpy((void*)0x200001c0, "/dev/ptmx\000", 10));
  ...
  case 11:
    ...
    NONFAILING(*(uint32_t*)0x2000018a = r[2]);
    ...
    syscall(__NR_connect, r[3], 0x20000180, 0x26);
    break;
  case 12:
    ...
    NONFAILING(*(uint32_t*)0x20000094 = htobe32(0xe0000002));
    NONFAILING(*(uint32_t*)0x20000098 = 0);
    syscall(__NR_connect, r[2], 0x20000080, 0x1c);
    break;
  case 13:
    syscall(__NR_sendmmsg, r[3], 0, 0, 0);
    break;
  }
}
int main(void)
