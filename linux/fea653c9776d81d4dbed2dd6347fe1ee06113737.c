...
// https://syzkaller.appspot.com/bug?id=fea653c9776d81d4dbed2dd6347fe1ee06113737
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000300, 0x201, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
  ...
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_setsockopt, r[1], 6, 0x10000000013, 0, 0);
    break;
  case 7:
    syscall(__NR_connect, r[1], 0, 0);
    break;
  case 8:
    syscall(__NR_setsockopt, r[1], 6, 0x14, 0, 0);
    break;
  case 9:
    syscall(__NR_ioctl, -1, 0x5429, 0);
    break;
  case 10:
    syscall(__NR_ioctl, r[0], 0x5403, 0);
    break;
  case 11:
