// BUG: unable to handle kernel NULL pointer dereference in n_tty_set_termios
// https://syzkaller.appspot.com/bug?id=26b80e80dcf0ec9d93c5513b8cffb14a2b72d714
// status:invalid
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_ioctl, r[1], 0x5437, 0x20000280);
    break;
  case 4:
  ...
  case 5:
    ...
    *(uint32_t*)0x20000044 = 0xfffffff9;
