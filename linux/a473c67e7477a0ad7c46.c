// SYZFATAL: executor NUM failed NUM times: failed to create temp dir: mkdir ./syzkaller-testdir2ADDR: read-only file syste
// https://syzkaller.appspot.com/bug?id=a473c67e7477a0ad7c46
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(memset((void*)0x20000640, 0, 1));
  res = syscall(__NR_open_tree, 0xffffff9c, 0x20000640ul, 0x89901ul);
  if (res != -1)
    r[0] = res;
  NONFAILING(memcpy((void*)0x20000140, ".\000", 2));
  NONFAILING(memcpy((void*)0x20000180, "./file0\000", 8));
  syscall(__NR_move_mount, r[0], 0x20000140ul, 0xffffff9c, 0x20000180ul, 0ul);
  NONFAILING(memcpy((void*)0x20000000, "./file0\000", 8));
  syscall(__NR_mount, 0ul, 0x20000000ul, 0ul, 0x18000a1ul, 0ul);
}
int main(void)
{
