...
// https://syzkaller.appspot.com/bug?id=ff5fdc7631dd7c04c65b
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000080, "net/snmp6\000", 10));
    res = syz_open_procfs(0, 0x20000080);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    syscall(__NR_pread64, r[0], 0ul, 0ul, 0x103f00ul);
    break;
  case 2:
    syscall(__NR_ioctl, r[0], 0x80404532, 0ul);
    break;
  case 3:
  ...
  case 4:
    ...
    NONFAILING(memcpy(
        (void*)0x200002c4,
        "virt_wifi0\000\000\000\000\000\000\000\000\000\000\000\000\000\000",
        24));
    NONFAILING(*(uint32_t*)0x200002dc = 0);
    NONFAILING(*(uint16_t*)0x200002f4 = 0);
    syscall(__NR_ioctl, -1, 0x8982, 0x200002c0ul);
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20000240, "/dev/ion\000", 9));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000240ul, 0ul, 0ul);
    if (res != -1)
      r[2] = res;
    break;
  case 6:
    NONFAILING(*(uint64_t*)0x20000040 = 5);
    NONFAILING(*(uint32_t*)0x20000048 = 0x2b);
    NONFAILING(*(uint32_t*)0x2000004c = 0);
    NONFAILING(*(uint32_t*)0x20000050 = -1);
    NONFAILING(*(uint32_t*)0x20000054 = 0);
    res = syscall(__NR_ioctl, r[2], 0xc0184900, 0x20000040ul);
    if (res != -1)
      NONFAILING(r[3] = *(uint32_t*)0x20000050);
    break;
  case 7:
  ...
  case 8:
    ...
    NONFAILING(*(uint32_t*)0x200000c8 = r[4]);
    res = syscall(__NR_ioctl, r[1], 0xc00c642e, 0x200000c0ul);
    if (res != -1)
      NONFAILING(r[5] = *(uint32_t*)0x200000c0);
    break;
  case 9:
    NONFAILING(*(uint32_t*)0x20000100 = r[5]);
    NONFAILING(*(uint32_t*)0x20000104 = 0x7000002);
    syscall(__NR_ioctl, r[1], 0x40046f41, 0x20000100ul);
    break;
  case 10:
    NONFAILING(*(uint32_t*)0x200000c0 = -1);
    NONFAILING(*(uint16_t*)0x200000c4 = 0);
    NONFAILING(*(uint16_t*)0x200000c6 = 0);
    syscall(__NR_ppoll, 0x200000c0ul, 0x20000000000000c3ul, 0ul, 0ul,
            0xffffffffffffff34ul);
    break;
  case 11:
