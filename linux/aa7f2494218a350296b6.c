...
// https://syzkaller.appspot.com/bug?id=aa7f2494218a350296b6
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    res = syscall(__NR_io_setup, 1, 0x20000300ul);
    if (res != -1)
      NONFAILING(r[0] = *(uint64_t*)0x20000300);
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000480, "/dev/net/tun\000", 13));
    res =
        syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000480ul, 0x802ul, 0ul);
    if (res != -1)
      r[1] = res;
    break;
  case 2:
    NONFAILING(memcpy((void*)0x200000c0, "system.posix_acl_access\000", 24));
    syscall(__NR_lsetxattr, 0ul, 0x200000c0ul, 0ul, 0x4cul, 0ul);
    break;
  case 3:
    NONFAILING(*(uint64_t*)0x200002c0 = 0);
    NONFAILING(*(uint32_t*)0x200002c8 = 0);
    NONFAILING(*(uint64_t*)0x200002d0 = 0x20000080);
    ...
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000040, "TIPC\000", 5));
  ...
  case 5:
    NONFAILING(memcpy(
        ...
        16));
    syscall(__NR_ioctl, r[1], 0x400454ca, 0x200000c0ul);
    break;
  case 6:
    NONFAILING(*(uint64_t*)0x20000600 = 0x20000180);
    NONFAILING(*(uint64_t*)0x20000180 = 0);
    NONFAILING(*(uint32_t*)0x20000188 = 0);
    NONFAILING(*(uint32_t*)0x2000018c = 0);
    NONFAILING(*(uint16_t*)0x20000190 = 1);
    NONFAILING(*(uint16_t*)0x20000192 = 0);
    NONFAILING(*(uint32_t*)0x20000194 = r[1]);
    NONFAILING(*(uint64_t*)0x20000198 = 0x20000040);
    NONFAILING(*(uint64_t*)0x200001a0 = 0xe);
    ...
    syscall(__NR_io_submit, r[0], 0xaul, 0x20000600ul);
    break;
  }
}
int main(void)
