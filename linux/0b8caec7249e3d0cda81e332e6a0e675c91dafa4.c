...
void execute_call(int call)
{
  ...
  case 3:
    ...
    break;
  case 4:
    syscall(__NR_sendmsg, r[2], 0, 0xc0);
    break;
  case 5:
  ...
  case 6:
    ...
    NONFAILING(memcpy((void*)0x200002c0, "9p\000", 3));
    NONFAILING(memcpy((void*)0x20000400, "trans=fd,", 9));
    NONFAILING(memcpy((void*)0x20000409, "rfdno", 5));
    NONFAILING(*(uint8_t*)0x2000040e = 0x3d);
    NONFAILING(sprintf((char*)0x2000040f, "0x%016llx", (long long)r[0]));
    NONFAILING(*(uint8_t*)0x20000421 = 0x2c);
    NONFAILING(memcpy((void*)0x20000422, "wfdno", 5));
    NONFAILING(*(uint8_t*)0x20000427 = 0x3d);
    NONFAILING(sprintf((char*)0x20000428, "0x%016llx", (long long)r[1]));
    NONFAILING(*(uint8_t*)0x2000043a = 0x2c);
    NONFAILING(*(uint8_t*)0x2000043b = 0);
    syscall(__NR_mount, 0, 0x20000040, 0x200002c0, 0, 0x20000400);
    break;
  }
}
int main(void)
