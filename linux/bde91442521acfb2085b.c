...
// https://syzkaller.appspot.com/bug?id=bde91442521acfb2085b
// status:6
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    res = syscall(__NR_pipe, 0x200001c0ul);
    if (res != -1) {
    ...
    break;
  case 1:
    res = syscall(__NR_socketpair, 1ul, 5ul, 0, 0x20000480ul);
    if (res != -1)
      r[2] = *(uint32_t*)0x20000484;
    break;
  case 2:
    memcpy((void*)0x20000080, "bridge_slave_1\000\000", 16);
    res = syscall(__NR_ioctl, r[2], 0x8933, 0x20000080ul);
    if (res != -1)
      r[3] = *(uint32_t*)0x20000090;
    break;
  case 3:
    *(uint64_t*)0x20000100 = 0;
    *(uint32_t*)0x20000108 = 0;
    *(uint64_t*)0x20000110 = 0x20000300;
    ...
    *(uint16_t*)0x20000026 = 1;
    memcpy((void*)0x20000028, "bond\000", 5);
    ...
    *(uint16_t*)0x20000036 = 0xb;
    *(uint32_t*)0x20000038 = r[3];
  ...
  case 7:
    ...
    *(uint64_t*)0x20000200 = 0x20000000;
    memcpy((void*)0x20000000,
           "\x48\x00\x00\x00\x10\x00\x5f\xff\x00\x00\x05\x00\x00\x00\x00\x00"
           "\x00\x00\x00\x00",
           20);
    *(uint32_t*)0x20000014 = -1;
    memcpy((void*)0x20000018,
           "\x01\xf8\xff\xff\x00\x00\x00\x00\x28\x00\x12\x80\x0a\x00\x01\x00"
           "\x76\x78\x6c\x61\x6e",
           21);
  ...
  case 8:
    ...
    break;
  case 9:
    syscall(__NR_splice, r[0], 0ul, r[4], 0ul, 0x4ffe2ul, 0ul);
    break;
  case 10:
  ...
  case 11:
    ...
    *(uint64_t*)0x20000140 = 0x20000180;
    memcpy((void*)0x20000180,
           "\x84\x00\x00\x00\x10\x00\x03\x05\x00\x00\x00\x00\x00\x00\x00\x00"
           "\x00\x00\x00\x00",
           20);
    *(uint32_t*)0x20000194 = 0;
    memcpy((void*)0x20000198,
           "\x11\x40\x00\x00\x00\x00\x00\x00\x4c\x00\x12\x80\x0b\x00\x01\x00"
           "\x69\x70\x76\x6c\x61\x6e\x00\x00\x3c\x00\x02\x80\x06\x00\x01\x00"
           "\x00\x00\x00\x00\x06\x00\x02\x00\x01\x00\x00\x00\x06\x00\x02\x00"
           "\x03\x00\x00\x00\x06\x00\x01\x00\x02\x00\x00\x00\x06\x00\x02\x00"
           "\x01\x00\x00\x00\x06\x00\x01\x00\x00\x00\x00\x00\x06\x00\x01\x00"
           "\x00\x00\x00\x00\x08\x00\x05\x00",
           88);
    *(uint32_t*)0x200001f0 = -1;
    *(uint64_t*)0x20000148 = 0x84;
