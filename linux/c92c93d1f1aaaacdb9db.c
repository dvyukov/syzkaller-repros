...
// https://syzkaller.appspot.com/bug?id=c92c93d1f1aaaacdb9db
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    *(uint32_t*)0x20000000 = 0x60000011;
  ...
  case 5:
    ...
    *(uint64_t*)0x200001c4 = 0;
    syscall(__NR_epoll_ctl, r[0], 1ul, r[3], 0x200001c0ul);
    break;
  case 6:
    syscall(__NR_ioctl, -1, 0x8004562e, 0ul);
    break;
  }
}
int main(void)
