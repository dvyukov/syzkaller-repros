...
// https://syzkaller.appspot.com/bug?id=d9bd66f8d352f7eb1955
// status:3
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    res = syscall(__NR_creat, 0ul, 8ul);
    if (res != -1)
      r[1] = res;
    break;
  case 2:
  ...
  case 6:
    ...
    break;
  case 7:
    NONFAILING(memset((void*)0x201c9fff, 3, 1));
    syscall(__NR_setsockopt, r[2], 0x10d, 0xd, 0x201c9ffful, 1ul);
    break;
  case 8:
    NONFAILING(*(uint16_t*)0x20e5c000 = 2);
    NONFAILING(*(uint16_t*)0x20e5c002 = htobe16(0x4e20));
    NONFAILING(*(uint32_t*)0x20e5c004 = htobe32(0));
    syscall(__NR_connect, r[2], 0x20e5c000ul, 0x10ul);
    break;
  case 9:
    NONFAILING(*(uint64_t*)0x20000fc0 = 0);
    NONFAILING(*(uint32_t*)0x20000fc8 = 0);
    NONFAILING(*(uint64_t*)0x20000fd0 = 0x200005c0);
    NONFAILING(*(uint64_t*)0x200005c0 = 0x200002c0);
    NONFAILING(memset((void*)0x200002c0, 81, 1));
    NONFAILING(*(uint64_t*)0x200005c8 = 1);
    NONFAILING(*(uint64_t*)0x20000fd8 = 1);
    NONFAILING(*(uint64_t*)0x20000fe0 = 0);
    NONFAILING(*(uint64_t*)0x20000fe8 = 0);
    NONFAILING(*(uint32_t*)0x20000ff0 = 0);
    NONFAILING(*(uint32_t*)0x20000ff8 = 0);
    syscall(__NR_sendmmsg, r[2], 0x20000fc0ul, 1ul, 0ul);
    {
      int i;
      for (i = 0; i < 64; i++) {
        syscall(__NR_sendmmsg, r[2], 0x20000fc0ul, 1ul, 0ul);
