...
// https://syzkaller.appspot.com/bug?id=5f71e877562004afce9bdc708721dd5a7a3b1593
// status:fixed
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    res = syscall(__NR_open, 0x20000000, 2, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
    NONFAILING(sprintf((char*)0x20000040, "0x%016llx", (long long)0));
    syscall(__NR_write, r[0], 0x20000040, 0xffffffe7);
    break;
  case 3:
    NONFAILING(*(uint32_t*)0x20000080 = 0x401);
    syscall(__NR_ioctl, r[0], 0x5420, 0x20000080);
    break;
  }
}
