...
// https://syzkaller.appspot.com/bug?id=f3a0e80c34b3fc28ac5e
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    *(uint16_t*)0x200001a2 = 0xa;
    *(uint32_t*)0x200001a4 = 0;
    *(uint16_t*)0x200001a8 = 8;
    *(uint16_t*)0x200001aa = 0x1b;
  ...
  case 2:
    ...
    break;
  case 3:
    memcpy((void*)0x200002c0, "net/dev_mcast\000", 14);
    res = syz_open_procfs(0, 0x200002c0);
    if (res != -1)
      r[2] = res;
    break;
  case 4:
    syscall(__NR_sendfile, r[1], r[2], 0ul, 0xedc0ul);
    break;
  case 5:
    syscall(__NR_sendmsg, r[2], 0ul, 0x4040000ul);
    break;
  }
}
int main(void)
