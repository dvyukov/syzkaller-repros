...
// https://syzkaller.appspot.com/bug?id=fad5d91c7158ce568634
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000208 = 0x200002c0;
  memcpy((void*)0x200002c0, "\x18\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                            "\x00\x00\x00\x00\x85\x00\x00\x00\x6d\x00\x00\x00"
                            "\x95",
         25);
  ...
  *(uint64_t*)0x20000000 = 0x200000c0;
  memcpy((void*)0x200000c0, "percpu_alloc_percpu\000", 20);
  *(uint32_t*)0x20000008 = r[0];
  res = syscall(__NR_bpf, 0x11ul, 0x20000000ul, 0x10ul);
  if (res != -1)
    r[1] = res;
