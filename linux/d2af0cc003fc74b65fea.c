...
// https://syzkaller.appspot.com/bug?id=d2af0cc003fc74b65fea
// status:6
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_ioctl, -1, 0x5437, 0ul);
    break;
  case 1:
  ...
  case 3:
    ...
    *(uint32_t*)0x20000018 = 0x32b;
    *(uint32_t*)0x2000001c = 0x2007;
    ...
    *(uint16_t*)0x20000026 = 1;
    memcpy((void*)0x20000028, "geneve\000", 7);
    *(uint16_t*)0x20000030 = 0x10;
    ...
    *(uint16_t*)0x20000036 = 5;
    *(uint16_t*)0x20000038 = htobe16(0x4e21);
    *(uint16_t*)0x2000003c = 4;
    *(uint16_t*)0x2000003e = 6;
    *(uint16_t*)0x20000040 = 8;
    *(uint16_t*)0x20000042 = 0x13;
    ...
    *(uint32_t*)0x200000b0 = 0;
    ...
    break;
  case 4:
    syscall(__NR_unshare, 0x42000000ul);
    break;
  }
}
int main(void)
