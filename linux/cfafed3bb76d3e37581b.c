...
// https://syzkaller.appspot.com/bug?id=cfafed3bb76d3e37581b
// status:0
...
int main(void)
{
  ...
  intptr_t res = 0;
  memcpy((void*)0x200004c0, "/dev/kvm\000", 9);
  ...
  *(uint64_t*)0x20000050 = 0;
  syz_kvm_setup_cpu(r[1], r[2], 0x2003d000, 0x20000040, 1, 0x40, 0, 0);
  ...
  *(uint8_t*)0x2000009b = 0;
  memset((void*)0x2000009c, 0, 27);
  *(uint8_t*)0x200000b7 = 0;
  *(uint64_t*)0x200000b8 = 0;
  syscall(__NR_ioctl, r[2], 0x4040aea0, 0x20000080ul);
  syscall(__NR_ioctl, r[2], 0xae80, 0ul);
  return 0;
}
