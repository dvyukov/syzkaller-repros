...
// https://syzkaller.appspot.com/bug?id=12056a09a0311d758e60
// status:6
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000264 = 0;
  res = -1;
  res = syz_io_uring_setup(0x662a, 0x20000240, 0x20ffc000, 0x20ffd000,
                           0x20000200, 0x20000000);
  if (res != -1) {
    r[0] = res;
    r[1] = *(uint64_t*)0x20000200;
  }
  syscall(__NR_io_uring_register, r[0], 9ul, 0ul, 0ul);
  syz_io_uring_submit(r[1], 0, 0, 7);
  syscall(__NR_socket, 0x2aul, 2ul, 0);
}
int main(void)
{
