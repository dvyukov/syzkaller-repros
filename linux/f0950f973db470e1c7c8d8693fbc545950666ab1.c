...
void execute_call(int call)
{
  ...
  case 0:
    NONFAILING(memcpy(
        ...
        "\255\256\017\265\227ao3\253\315Y\232\343\345\341\364\207\254\255\200"
        "\243P\214\352\234\307\000\353\355X#\3434\200O]\207\335\2114\332l;"
        "w\370\370\v?v\360\270\332=|\244\272\273iq!\330g\267I\022\200",
        84));
  ...
  case 1:
    NONFAILING(memcpy(
        ...
        395));
    syscall(__NR_openat, r[0], 0x200009c0, 0, 0);
    break;
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_lseek, r[1], 0x20400000, 0);
    break;
  case 4:
    ...
    syscall(__NR_write, r[1], 0x20000080, 0x2000008f);
    break;
  case 5:
