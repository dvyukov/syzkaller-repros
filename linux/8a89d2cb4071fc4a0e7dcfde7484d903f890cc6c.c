// BUG: using __this_cpu_read() in preemptible [ADDR] code: syzkaller9NUM/3328
// https://syzkaller.appspot.com/bug?id=8a89d2cb4071fc4a0e7dcfde7484d903f890cc6c
// status:invalid
...
{
  memset(r, -1, sizeof(r));
  r[0] = syscall(__NR_mmap, 0x20000000ul, 0x900000ul, 0x3ul, 0x32ul,
  ...
  *(uint16_t*)0x208fe042 = (uint16_t)0x224e;
