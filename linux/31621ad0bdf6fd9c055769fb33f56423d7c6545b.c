...
// https://syzkaller.appspot.com/bug?id=31621ad0bdf6fd9c055769fb33f56423d7c6545b
// status:open
...
void loop()
{
  ...
  *(uint16_t*)0x20000090 = htobe16(0x28);
  ...
  *(uint32_t*)0x20ea3014 = 0;
  ...
  csum_inet_update(&csum_1, (const uint8_t*)0x200000a2, 20);
  ...
  *(uint16_t*)0x20000098 = csum_inet_digest(&csum_2);
  syz_emit_ethernet(0x36, 0x20000080, 0x20ea3000);
}
