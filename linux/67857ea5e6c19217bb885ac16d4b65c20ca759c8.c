...
// https://syzkaller.appspot.com/bug?id=67857ea5e6c19217bb885ac16d4b65c20ca759c8
// status:open
...
void execute_one(void)
{
  ...
  *(uint16_t*)0x2001d06e = 0;
  ...
  if (res != -1)
    r[2] = res;
  syscall(__NR_mmap, 0x20003000, 0x2000, 0x800002, 0x11, r[2], 0);
  ...
  *(uint16_t*)0x20000102 = 0x33;
  ...
  memcpy((void*)0x20000080, "\x39\xa1\x10", 3);
  syscall(__NR_sendto, r[0], 0x20000080, 0xffffffffffffffc1, 0x40, 0,
          0xfffffffffffffe5b);
}
int main(void)
{
