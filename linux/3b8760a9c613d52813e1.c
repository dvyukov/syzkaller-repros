...
// https://syzkaller.appspot.com/bug?id=3b8760a9c613d52813e1
// status:6
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    memcpy((void*)0x20000080, "/dev/snd/midiC#D#\000", 18);
    res = syz_open_dev(0x20000080, 2, 0xa0001);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    memcpy((void*)0x200001c0, "(", 1);
    syscall(__NR_write, r[0], 0x200001c0ul, 0x20000339ul);
    break;
  case 2:
    *(uint32_t*)0x20000000 = 0;
    *(uint64_t*)0x20000008 = 0x822;
    *(uint64_t*)0x20000010 = 5;
    STORE_BY_BITMASK(uint32_t, , 0x20000018, 0, 0, 1);
    ...
    *(uint8_t*)0x20000028 = 0;
    syscall(__NR_ioctl, r[0], 0xc0305710, 0x20000000ul);
    break;
  }
}
int main(void)
