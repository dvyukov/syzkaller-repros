...
void execute_call(int call)
{
  ...
  case 2:
    NONFAILING(memcpy(
        ...
        16));
    NONFAILING(*(uint16_t*)0x20000310 = 1);
  ...
  case 4:
    NONFAILING(memcpy(
        (void*)0x200000c0,
        "\x02\x01\x81\x00\x01\x04\x8e\x07\x06\x00\x45\x00\x00\x28\x00\x00\x00"
        "\x00\x00\x00\x90\x78\x00\x00\x00\x00\xac\x14\x14\x00\x0d\x00\x00\x00"
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
        50));
    syscall(__NR_write, r[1], 0x200000c0, 1);
    break;
  }
}
