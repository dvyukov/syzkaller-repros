...
// https://syzkaller.appspot.com/bug?id=de271708674e2093097b
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    NONFAILING(*(uint32_t*)0x20000008 = 0xfffffdcf);
    NONFAILING(*(uint64_t*)0x20000010 = 0x20000080);
    NONFAILING(*(uint64_t*)0x20000080 = 0x20000040);
    NONFAILING(memcpy(
        (void*)0x20000040,
        "\xe0\x3f\x03\x00\x22\x00\x09\x05\xd2\x41\x80\x64\x8c\x23\x94\x0d\x7e"
        "\x24\xfc\x60\x10\x00\x3d\x40\x0a\x00\x0a\x00\x05\x35\x82\xc1\x37\x15"
        "\x3e\x37\x02\x48\x03\x80\x47\x00\x00\x00\xd1\xbd",
        46));
