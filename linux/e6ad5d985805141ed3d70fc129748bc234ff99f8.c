...
void execute_one(void)
{
  ...
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200001a8, 0x40000000000000, 6, 1));
  ...
  NONFAILING(*(uint64_t*)0x20003840 = 0x20000040);
  NONFAILING(*(uint16_t*)0x20000040 = 0);
  NONFAILING(*(uint8_t*)0x20000042 = 0);
  NONFAILING(*(uint32_t*)0x20000044 = 0);
  NONFAILING(*(uint32_t*)0x20003848 = 0x80);
  NONFAILING(*(uint64_t*)0x20003850 = 0x200000c0);
  NONFAILING(*(uint64_t*)0x200000c0 = 0x20000100);
  NONFAILING(memcpy((void*)0x20000100,
                    "\xf4\x00\x11\x00\x00\x2b\x2c\x25\xe9\x94\xef\xd1\x00\x00"
                    "\x00\x00\x00\x09\x11\x00\x00\x00\x00\x00\x00\x3a\x00\x00"
                    "\x00\x00\xf6\x8a\xb9\x28\xab\xff\xb7\xa8\xd4\xf3\x2e\xbd"
                    "\xbe\xd8\x28\x84\x7b\xba\xeb\x4e",
                    50));
  NONFAILING(*(uint64_t*)0x200000c8 = 0x32);
  NONFAILING(*(uint64_t*)0x20003858 = 1);
  NONFAILING(*(uint64_t*)0x20003860 = 0);
  NONFAILING(*(uint64_t*)0x20003868 = 0);
  NONFAILING(*(uint32_t*)0x20003870 = 0);
  syscall(__NR_sendmsg, r[0], 0x20003840, 0);
  NONFAILING(memcpy(
      (void*)0x20000380,
      "\x6e\x72\x30\x01\x00\x60\xa1\x9e\xf9\xd2\xc6\x73\xd9\xa1\x57\x1c\xb9\xe1"
      "\x36\x9b\xcd\x61\xef\x7e\x49\x79\x3a\xe1\x87\x12\xec\xeb\x1d\xaa\x76\x94"
      "\x97\x80\x0b\x7f\xbb\xd3\x5b\x17\x0c\x10\x75\x1d\x39\xae\xb6\x60\xd8\x63"
      "\xe4\x9b\x8c\x4f\x3b\x3c\xad\x48\x90\x2b\x5b\x2d\x6c\xfd\x0a\xbd\x37\x2c"
      "\x63\xbc\xf5\xd7\x0d\xf3\xfd\x4d\x2e\x8d\x44\x3c\x88\xc6\x0f\xd7\x14\x0f"
      "\xbc\x0e\x56\x37\xdd\x82\xfc\x34\x35\xbe\xd4\xde\x5d\x69\x3c\x9a\x78\x1c"
      "\x86\x3e\x05\xd8\xa6\xf8\x68\x9a\x5b\xe2\x92\x16\x06\x1f\x3f\xf5\x3f\x8b"
      "\x6b\x39\x66\x78\xe7\xba\x15\x5e\xf9\x15\x2d\x7e\x43\xb1\xec\xcb\x23\x31"
      "\xeb\x8e\xb1\xed\x55\x86\xdc\xf8\xb3\xb0\xb9\x99\x36\x1a\x44\xff\x2c\x22"
      "\xc2\xab\xbe\xf4\x2d\xd2\x4e\xab\xe6\x72\x33\x46\xa6\xe4\x6c\x04\x99\xa2"
      "\x14\x42\xd8\xd0\x0d\xcb\x57\xf0\x13\xff\x75\x95\xed\xd0\xff\x07\x69\x30"
      "\xde\x36\x75\xd3\x41\x17\xa4\x4e\xb0\xe4\xf8\x32\x93\x6d\xa4\x4e",
      214));
