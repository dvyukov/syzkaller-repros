...
// https://syzkaller.appspot.com/bug?id=5b3aef77cddec186d643e13090984ad63edf5abd
// status:open
...
{
  long res = 0;
  memcpy((void*)0x20000600, "/dev/loop#", 11);
  res = syz_open_dev(0x20000600, 3, 0x4000);
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x20000580, "/dev/loop#", 11);
  res = syz_open_dev(0x20000580, 0, 0);
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x20000000, "reiserfs", 9);
  memcpy((void*)0x20000080, "./file0", 8);
  syz_mount_image(0x20000000, 0x20000080, 0, 0x2a0, 0x200000c0, 0, 0x200002c0);
  syscall(__NR_ioctl, r[1], 0x4c00, r[0]);
  syscall(__NR_ioctl, r[1], 0x4c06, r[1]);
}
