...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000160 = 0;
  ...
  STORE_BY_BITMASK(uint64_t, , 0x20000168, 3, 5, 1);
  ...
  *(uint16_t*)0x200001ae = 0;
  ...
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x20000080, "/dev/loop0\000", 11);
  syscall(__NR_mount, 0x20000080ul, 0ul, 0ul, 0ul, 0ul);
  memcpy((void*)0x200005c0,
         "\3507y\330\016\372\316\274`"
         "\v\205\236B\367\301\275\016\024\356G\257\347\263?\307x\275\tR\305\r."
         "\000\000\000\000\000\000\000\000\000\000\000\363\205C\214h\225{"
         "\353\357|\371\211\000\000\000\000d6\313Fw\3542[?",
         68);
  syscall(__NR_memfd_create, 0x200005c0ul, 0x800000000006ul);
  memcpy((void*)0x20000700, "/dev/snd/seq\000", 13);
  syz_open_dev(0x20000700, 0, 0);
  res = syscall(__NR_ioctl, r[0], 0xae01ul, 0ul);
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x20000480, "/dev/dsp\000", 9);
  syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000480ul, 0x305100ul, 0ul);
  *(uint64_t*)0x200008c0 = 0x20;
  *(uint64_t*)0x200008c8 = 0x200000c0;
  memcpy((void*)0x200000c0,
         "\xb8\x05\x00\x00\x00\xb9\x51\x00\x00\x00\x0f\x01\xc1\x0f\x46\xa7\x89"
         "\x00\x00\x00\x66\xba\x21\x00\xb0\x67\xee\x66\xba\x41\x00\xed\xb9\x80"
         "\x00\x00\xc0\x0f\x32\x66\xba\x40\x00\x66\xed\x0f\x30\xc4\xc2\x71\xde"
         "\x9d\x00\x00\x00\x00\x66\xb8\x08\x00\x8e\xd0\x66\x0f\x38\x80\x6f\x00"
         "\x0f\x01\x1c\x26\x66\xb8\xbf\x00\x8e\xe0",
         78);
  *(uint64_t*)0x200008d0 = 0x4e;
  syz_kvm_setup_cpu(-1, -1, 0x2000b000, 0x200008c0, 1, 0, 0, 0);
  syscall(__NR_ioctl, r[1], 0xae60ul, 0);
  res = syscall(__NR_ioctl, r[1], 0xae41ul, 0ul);
  if (res != -1)
    r[2] = res;
  syscall(__NR_socketpair, 1ul, 5ul, 0ul, 0x200000c0ul);
  *(uint32_t*)0x20bf7000 = 0;
  *(uint32_t*)0x20bf7004 = 0;
  *(uint64_t*)0x20bf7008 = 0;
  *(uint64_t*)0x20bf7010 = 0x2000;
  *(uint64_t*)0x20bf7018 = 0x20000000;
  syscall(__NR_ioctl, r[1], 0x4020ae46ul, 0x20bf7000ul);
  ...
  *(uint32_t*)0x2000003c = 0;
  syscall(__NR_ioctl, r[1], 0x4040ae77ul, 0x20000000ul);
  syscall(__NR_socketpair, 1ul, 5ul, 0ul, 0x200000c0ul);
