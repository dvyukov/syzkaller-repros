...
// https://syzkaller.appspot.com/bug?id=65454c239241d3d647da
// status:6
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    *(uint64_t*)0x200001f8 = 0;
    res = syscall(__NR_perf_event_open, 0x20000180ul, 0, 0ul, -1, 0ul);
    if (res != -1)
      r[0] = res;
    break;
  case 3:
    ...
    *(uint32_t*)0x200002d8 = -1;
    ...
    res = -1;
    res = syz_io_uring_setup(0x387, 0x200002c0, 0x20ee7000, 0x20eeb000,
  ...
  case 4:
    *(uint32_t*)0x20000140 = 0x307e;
    syz_memcpy_off(r[2], 0x40, 0x20000140, 0, 4);
    break;
  case 5:
    ...
    *(uint16_t*)0x200000aa = 0;
    ...
    syz_io_uring_submit(r[2], r[3], 0x20000080, 0x2000);
    break;
  case 6:
    syscall(__NR_io_uring_enter, r[1], 0x45f5, 0, 0ul, 0ul, 0ul);
    break;
  }
}
int main(void)
