// KMSAN: uninit-value in gre_rcv
// https://syzkaller.appspot.com/bug?id=e4768fb0f1c9859d45e96430a8030e5569b40ce8
// status:invalid
...
void loop()
{
  ...
  *(uint8_t*)0x20695003 = -1;
  memcpy((void*)0x20695004, "\x93\xbb\x9d\x80\x41\x23", 6);
