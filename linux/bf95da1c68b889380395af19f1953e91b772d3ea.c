...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000000, "TIPCv2\x00", 7));
  ...
  case 2:
    ...
    NONFAILING(*(uint64_t*)0x20000880 = 0x20000040);
    NONFAILING(memcpy((void*)0x20000040, "(\x00\x00\x00", 4));
    NONFAILING(*(uint16_t*)0x20000044 = r[1]);
    NONFAILING(memcpy(
        (void*)0x20000046,
        "\x01\x02\x00\x00\x00\x00\x00\x00\x00\x00\x03\x00\x00\x00\x14\x00\x01"
        "\x00\x10\x00\x01\x00\xe8\xfa\xfe\x96\x90\x3d\xe8\xeb\x5a\x2b\x29\x06"
        "\x8b\x1e\x65\x75\x64\x20\x00\x00\x00\x7a\x32\x00\x00\x00\x00",
        49));
    NONFAILING(*(uint64_t*)0x20000888 = 3);
    ...
    break;
  case 3:
    NONFAILING(*(uint32_t*)0x20000100 = 0xa105);
    syscall(__NR_getsockopt, -1, 0x65, 3, 0, 0x20000100);
    break;
  }
}
int main(void)
