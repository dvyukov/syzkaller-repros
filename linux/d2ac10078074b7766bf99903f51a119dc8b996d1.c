...
// https://syzkaller.appspot.com/bug?id=d2ac10078074b7766bf99903f51a119dc8b996d1
// status:dup
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    memcpy((void*)0x20000000, "./cgroup/syz0", 14);
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000000, 0x200002, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    memcpy((void*)0x20000040, "cpuacct.usage_percpu_sys", 25);
    syscall(__NR_openat, r[0], 0x20000040, 0, 0);
    break;
  case 2:
