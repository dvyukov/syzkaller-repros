...
// https://syzkaller.appspot.com/bug?id=594b77c563cdb028d5d7ee1adc8d09f793f077ce
// status:invalid
...
void execute_one()
{
  ...
  NONFAILING(*(uint8_t*)0x20000722 = 0);
  ...
  NONFAILING(*(uint16_t*)0x20000736 = htobe16(0x2c00));
  ...
  NONFAILING(csum_inet_update(&csum_1, (const uint8_t*)0x20000716, 16));
  NONFAILING(csum_inet_update(&csum_1, (const uint8_t*)0x20000726, 16));
  ...
  NONFAILING(csum_inet_update(&csum_1, (const uint8_t*)0x20000736, 16));
