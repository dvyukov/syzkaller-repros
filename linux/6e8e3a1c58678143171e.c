...
// https://syzkaller.appspot.com/bug?id=6e8e3a1c58678143171e
// status:0
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000130 = 0;
  ...
  if (res != -1)
    r[5] = res;
  memcpy((void*)0x200002c0, "wlan0\000\000\000\000\000\000\000\000\000\000\000",
         16);
