...
// https://syzkaller.appspot.com/bug?id=9b658439133becd38da1
// status:0
...
int main(void)
{
  ...
  *(uint64_t*)0x20000200 = 0x20000280;
  memcpy((void*)0x20000280, "8\000\000\000", 4);
  *(uint16_t*)0x20000284 = r[1];
  memcpy((void*)0x20000286,
         "\x01\x00\x00\xf1\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x08\x00\x01"
         "\x00\x00\x00\x01\x00\x10\x00\x07\x80\x0c\x07\x05\x00\x00\x00\x00\x00"
         "\x00\x00\x00\x00\x0c\x00\x02",
         41);
