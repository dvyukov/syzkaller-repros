...
// https://syzkaller.appspot.com/bug?id=cfc04addc32e7b4500f588f3326063fbe2d02559
// status:open
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_ioctl, r[2], 0x8090ae81, 0x940000);
    break;
  case 4:
  ...
  case 5:
    ...
    NONFAILING(memcpy(
        (void*)0x20000100,
        "\x02\x0b\x00\x01\x02\x00\x00\x00\x00\x00\x40\x00\x00\x00\x00\x00",
        16));
    NONFAILING(*(uint64_t*)0x20000008 = 0x10);
    ...
    break;
  case 6:
    NONFAILING(*(uint64_t*)0x200001c0 = 0x40000000);
    NONFAILING(*(uint32_t*)0x200001c8 = 0);
    NONFAILING(*(uint64_t*)0x200001d0 = 0x20000040);
    NONFAILING(*(uint64_t*)0x20000040 = 0x20000080);
    NONFAILING(memcpy(
        (void*)0x20000080,
        "\x02\x03\x06\x09\x10\x00\x00\x00\x00\x00\x00\x4c\x9e\x00\x00\x00\x02"
        "\x00\x13\x00\x02\x00\x00\x00\x00\x00\x00\x00\x00\x10\x00\x01\x05\x00"
        ...
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x17\x00\x00\x00\x00\x00"
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00",
        128));
    NONFAILING(*(uint64_t*)0x20000048 = 0x80);
    ...
    break;
  case 7:
    syscall(__NR_sendmmsg, r[3], 0x20000180, 0x400000000000002, 0);
    break;
  }
}
int main(void)
