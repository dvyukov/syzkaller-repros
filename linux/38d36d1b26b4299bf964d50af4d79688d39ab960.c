...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000100, "/dev/infiniband/rdma_cm", 24));
  ...
  case 1:
    ...
    NONFAILING(*(uint64_t*)0x20000088 = 0x10000000);
    ...
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000140, "/dev/vhci", 10));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000140, 0x7d, 0);
    if (res != -1)
      r[2] = res;
    break;
  case 3:
    syscall(__NR_ioctl, r[2], 0x81a0ae8c, 0x20000280);
    break;
  case 4:
    NONFAILING(*(uint64_t*)0x20000180 = 0x100000000);
    NONFAILING(*(uint64_t*)0x20000188 = 0);
    NONFAILING(*(uint64_t*)0x20000190 = 0);
    NONFAILING(*(uint64_t*)0x20000198 = 0);
    res = syscall(__NR_ioctl, -1, 0xc0206434, 0x20000180);
    if (res != -1)
      NONFAILING(r[3] = *(uint64_t*)0x20000188);
    break;
  case 5:
    NONFAILING(*(uint64_t*)0x20000240 = r[3]);
    NONFAILING(*(uint64_t*)0x20000248 = 0x119);
    syscall(__NR_ioctl, r[2], 0x40106437, 0x20000240);
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x20000000 = 0xe);
    NONFAILING(*(uint16_t*)0x20000004 = 0x11);
    NONFAILING(*(uint16_t*)0x20000006 = 0xfa00);
    NONFAILING(*(uint64_t*)0x20000008 = 0x200001c0);
    NONFAILING(*(uint32_t*)0x200001c0 = 1);
    NONFAILING(*(uint32_t*)0x20000010 = r[1]);
    NONFAILING(*(uint32_t*)0x20000014 = 0);
    NONFAILING(*(uint32_t*)0x20000018 = 1);
    NONFAILING(*(uint32_t*)0x2000001c = 4);
    syscall(__NR_write, r[0], 0x20000000, 0x6a);
    break;
  case 7:
    ...
    syscall(__NR_write, r[0], 0x200000c0, 0x10);
    break;
  case 8:
    NONFAILING(*(uint32_t*)0x20000200 = 7);
    NONFAILING(*(uint16_t*)0x20000204 = 8);
    NONFAILING(*(uint16_t*)0x20000206 = 0xfa00);
    NONFAILING(*(uint32_t*)0x20000208 = r[1]);
    NONFAILING(*(uint32_t*)0x2000020c = 0);
    syscall(__NR_write, r[0], 0x20000200, 0x10);
    break;
  }
}
int main(void)
