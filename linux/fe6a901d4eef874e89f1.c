...
// https://syzkaller.appspot.com/bug?id=fe6a901d4eef874e89f1
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(
      memcpy((void*)0x20000380,
             "#\'%noY%v\000\177\345\320ql\342m]\'\345+"
             "\350\341g\235\216f\0069\233\223\260\177_,y<~"
             "\253\204\000\000\000\000\000\024\024}\n\201\307\205|"
             "oC\312\v\000\272]fn\r\337!\224\017\257\267\223\350\266\303N\026&"
             "\371{\257;\317\214\250\271\006\257\320\373:\220LNF;\002\000\000/"
             "1\271V\360*\313\334\005n<\317$\273\bLY\337 "
             "\230q\262v\\\251\317*"
             "tM\a\3043\320d\356\023Q\327\364\357\254\247\001\264\214\301\214"
             "\004,\340r\001\377\377\331V!>.\213\3175\017\226\346`\245.j\343D)"
             "0\206\341\201FX\271\252\344\322\257\3661\371_-\243\262dM\356\v ",
             191));
  res = syscall(__NR_memfd_create, 0x20000380ul, 0ul);
  if (res != -1)
    r[0] = res;
  NONFAILING(memset((void*)0x20000700, 47, 1));
  syscall(__NR_write, r[0], 0x20000700ul, 1ul);
  NONFAILING(*(uint64_t*)0x20000200 = 0);
  syscall(__NR_sendfile, r[0], r[0], 0x20000200ul, 0x87ul);
  syscall(__NR_mmap, 0x20000000ul, 0x3000ul, 5ul, 0x11ul, r[0], 0ul);
  NONFAILING(memcpy((void*)0x20000080, "./file0\000", 8));
  syscall(__NR_umount2, 0x20000080ul, 0ul);
}
int main(void)
{
