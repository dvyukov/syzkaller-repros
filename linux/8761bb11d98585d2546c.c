...
// https://syzkaller.appspot.com/bug?id=8761bb11d98585d2546c
// status:6
...
void loop(void)
{
  memcpy((void*)0x20000000, "\x04\x22\x1d\x23\xaa\x93\xaa\xaa\xaa\x12\x00\xfe"
                            "\x05\x7f\xa3\x01\x04\x81\x00\x00\x00",
         21);
  syz_emit_vhci(0x20000000, 0x20);
}
int main(void)
{
