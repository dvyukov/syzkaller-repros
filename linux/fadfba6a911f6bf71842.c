...
// https://syzkaller.appspot.com/bug?id=fadfba6a911f6bf71842
// status:0
...
{
  intptr_t res = 0;
  memcpy((void*)0x20002700, "/sys/kernel/debug/bluetooth/6lowpan_control\000",
         44);
  res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20002700ul, 2ul, 0ul);
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x20000040, "connect aa:aa:aa:aa:aa:11 0", 27);
  syscall(__NR_write, r[0], 0x20000040ul, 0x1bul);
}
int main(void)
{
