...
// https://syzkaller.appspot.com/bug?id=7e8aaf085297c4e60ac463bc4b4b7e6abc323f9f
// status:open
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    if (res != -1)
      NONFAILING(r[0] = *(uint32_t*)0x20000280);
    break;
  case 4:
    res = syscall(__NR_io_setup, 0xfff, 0x200000c0);
    if (res != -1)
      NONFAILING(r[1] = *(uint64_t*)0x200000c0);
    break;
  case 5:
    ...
    syscall(__NR_io_submit, r[1], 1, 0x200018c0);
    break;
  case 6:
