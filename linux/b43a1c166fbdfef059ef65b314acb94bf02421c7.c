...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(*(uint64_t*)0x20000040 = 0x20000280);
    ...
    NONFAILING(memcpy(
        (void*)0x200002c0,
        "\x20\x00\x00\x00\x27\x00\x63\x81\x80\x00\x00\x00\x00\x00\x00\x00\x0f"
        "\x00\x00\x00\x0c\x00\x07\x00\x08\x00\x03\x00\xe0\x00\x00\x02",
        32));
    NONFAILING(*(uint64_t*)0x20000008 = 1);
