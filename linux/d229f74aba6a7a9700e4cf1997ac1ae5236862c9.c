...
// https://syzkaller.appspot.com/bug?id=d229f74aba6a7a9700e4cf1997ac1ae5236862c9
// status:open
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x200000b0 = 0;
  syscall(__NR_sendmsg, r[0], 0x20000080, 0x83);
  *(uint64_t*)0x200015c0 = 0x20000100;
  *(uint16_t*)0x20000100 = -1;
  syscall(__NR_write, r[0], 0x200015c0, 0xfffffd6d);
}
int main(void)
{
