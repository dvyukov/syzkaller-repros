...
void loop(void)
{
  ...
  *(uint8_t*)0x20000044 = 0x23;
  *(uint8_t*)0x20000045 = 0x51;
  *(uint8_t*)0x20000046 = 0xd4;
  *(uint8_t*)0x20000047 = 8;
  *(uint16_t*)0x20000048 = 0x1286;
  *(uint16_t*)0x2000004a = 0x2049;
  *(uint16_t*)0x2000004c = 0xf1a;
  ...
  *(uint8_t*)0x2000005d = 0xb5;
  *(uint8_t*)0x2000005e = 0;
  *(uint8_t*)0x2000005f = 0;
  *(uint8_t*)0x20000060 = 0x4a;
  *(uint8_t*)0x20000061 = 0x38;
  *(uint8_t*)0x20000062 = 8;
  *(uint8_t*)0x20000063 = 7;
  syz_usb_connect(0x1000000000000001, 0x24, 0x20000040, 0);
  close_fds();
}
int main(void)
{
