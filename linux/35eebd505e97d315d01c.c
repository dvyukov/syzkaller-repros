...
// https://syzkaller.appspot.com/bug?id=35eebd505e97d315d01c
// status:0
...
int main(void)
{
  ...
  *(uint16_t*)0x20000548 = 0x44f;
  *(uint16_t*)0x2000054a = 0xb65d;
  *(uint16_t*)0x2000054c = 0x40;
  ...
  *(uint8_t*)0x2000055f = 1;
  *(uint8_t*)0x20000560 = 3;
  *(uint8_t*)0x20000561 = 1;
  *(uint8_t*)0x20000562 = 0;
  *(uint8_t*)0x20000563 = 0;
  *(uint8_t*)0x20000564 = 9;
  *(uint8_t*)0x20000565 = 0x21;
  *(uint16_t*)0x20000566 = 0;
  *(uint8_t*)0x20000568 = 0;
  *(uint8_t*)0x20000569 = 1;
  *(uint8_t*)0x2000056a = 0x22;
  *(uint16_t*)0x2000056b = 1;
  *(uint8_t*)0x2000056d = 9;
  *(uint8_t*)0x2000056e = 5;
  *(uint8_t*)0x2000056f = 0x81;
  *(uint8_t*)0x20000570 = 3;
  *(uint16_t*)0x20000571 = 0;
  *(uint8_t*)0x20000573 = 0;
  *(uint8_t*)0x20000574 = 0xf1;
  *(uint8_t*)0x20000575 = 0;
  res = -1;
  res = syz_usb_connect(2, 0x36, 0x20000540, 0);
  if (res != -1)
    r[0] = res;
  syz_usb_control_io(r[0], 0, 0);
  *(uint32_t*)0x200006c0 = 0x24;
  *(uint64_t*)0x200006c4 = 0;
  *(uint64_t*)0x200006cc = 0;
  *(uint64_t*)0x200006d4 = 0x20000640;
  *(uint8_t*)0x20000640 = 0;
  *(uint8_t*)0x20000641 = 0x22;
  *(uint32_t*)0x20000642 = 1;
  STORE_BY_BITMASK(uint8_t, , 0x20000646, 0, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000646, 0, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000646, 0, 4, 4);
  *(uint64_t*)0x200006dc = 0;
  syz_usb_control_io(r[0], 0x200006c0, 0);
  return 0;
}
