...
// https://syzkaller.appspot.com/bug?id=9a29d5e745bd7523c851
// status:0
...
void execute_one(void)
{
  ...
  memcpy((void*)0x20000280, "/dev/nbd#\000", 10);
  res = -1;
  res = syz_open_dev(0x20000280, 0, 0x40a00);
  if (res != -1)
    r[3] = res;
  syscall(__NR_ioctl, r[3], 0xab07, 0x9f2ul);
  syscall(__NR_ioctl, r[1], 0xab00, r[2]);
  syscall(__NR_ioctl, r[0], 0xab03, -1);
}
int main(void)
{
