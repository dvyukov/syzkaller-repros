...
// https://syzkaller.appspot.com/bug?id=bf068cf224727e479bfa
// status:0
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x20000140, "nbd\000", 4);
  res = -1;
  ...
  *(uint32_t*)0x200002c0 = 0x64;
  *(uint16_t*)0x200002c4 = r[2];
  *(uint16_t*)0x200002c6 = 1;
  *(uint32_t*)0x200002c8 = 0x70bd25;
  *(uint32_t*)0x200002cc = 0x25dfdbfb;
  *(uint8_t*)0x200002d0 = 1;
  *(uint8_t*)0x200002d1 = 0;
  *(uint16_t*)0x200002d2 = 0;
  *(uint16_t*)0x200002d4 = 0xc;
  STORE_BY_BITMASK(uint16_t, , 0x200002d6, 7, 0, 14);
  ...
  *(uint64_t*)0x200002e4 = 1;
  *(uint16_t*)0x200002ec = 0xc;
  *(uint16_t*)0x200002ee = 5;
  *(uint64_t*)0x200002f0 = 2;
  *(uint16_t*)0x200002f8 = 0x14;
  STORE_BY_BITMASK(uint16_t, , 0x200002fa, 7, 0, 14);
  ...
  *(uint16_t*)0x2000030c = 0xc;
  *(uint16_t*)0x2000030e = 4;
  *(uint64_t*)0x20000310 = 7;
  *(uint16_t*)0x20000318 = 0xc;
  *(uint16_t*)0x2000031a = 6;
  *(uint64_t*)0x2000031c = 1;
  *(uint64_t*)0x20000208 = 0x64;
