...
// https://syzkaller.appspot.com/bug?id=cfba89a589babce43df1bc4093465318ee3599f3
// status:open
...
void execute_one()
{
  ...
  *(uint32_t*)0x20000140 = htobe32(0x7f000001);
  *(uint32_t*)0x20000144 = htobe32(0);
  *(uint32_t*)0x20000148 = r[2];
  syscall(__NR_setsockopt, r[0], 0, 0x20, 0x20000140, 0x3c5);
  ...
  *(uint64_t*)0x20000150 = 0x20000240;
  memcpy((void*)0x20000240, "\x9a\x6e\x25\x50\x6c\x7d\x44\x11\x96\xb9\xa5\xed"
                            "\xba\xb1\xa7\xb6\xab\xca\x1f\xa4\x00\x87\x9c\x30"
                            "\x2d\xff\x8a\x38\x8c\xfd\x28\x5a",
         32);
  syscall(__NR_ioctl, r[3], 0x89f3, 0x20000140);
  *(uint8_t*)0x20000280 = 0xaa;
  *(uint8_t*)0x20000281 = 0xaa;
  *(uint8_t*)0x20000282 = 0xaa;
  *(uint8_t*)0x20000283 = 0xaa;
  *(uint8_t*)0x20000284 = 0xaa;
  *(uint8_t*)0x20000285 = 0xaa;
  *(uint8_t*)0x20000286 = 1;
  *(uint8_t*)0x20000287 = 0x80;
  *(uint8_t*)0x20000288 = 0xc2;
  *(uint8_t*)0x20000289 = 0;
  *(uint8_t*)0x2000028a = 0;
  *(uint8_t*)0x2000028b = 0xf;
  *(uint16_t*)0x2000028c = htobe16(4);
  *(uint8_t*)0x2000028e = 0x7e;
  *(uint8_t*)0x2000028f = -1;
  memcpy((void*)0x20000290, "S", 1);
  syz_emit_ethernet(0x11, 0x20000280, 0);
}
