...
// https://syzkaller.appspot.com/bug?id=3bd41ec8bcffeccedda9
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000000, "/proc/mdstat\000", 13));
  ...
  case 2:
    ...
    break;
  case 3:
    NONFAILING(memcpy((void*)0x200000c0, "IPVS\000", 5));
    NONFAILING(syz_genetlink_get_family_id(0x200000c0, r[0]));
    break;
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_mmap, 0x20000000ul, 0x800000ul, 0x1800003ul, 0x12ul, -1, 0ul);
    break;
  case 6:
    ...
    break;
  case 7:
    syscall(__NR_clone, 0x3a3dd4008500af01ul, 0ul, 0x9999999999999999ul, 0ul,
            -1ul);
    break;
  case 8:
    NONFAILING(
        memcpy((void*)0x200004c0,
               ...
               32));
    NONFAILING(*(uint32_t*)0x200004e0 = 8);
    NONFAILING(*(uint32_t*)0x200004e4 = 3);
    NONFAILING(*(uint32_t*)0x200004e8 = 0x260);
    NONFAILING(*(uint32_t*)0x200004ec = 0xd0);
    NONFAILING(*(uint32_t*)0x200004f0 = 0);
    NONFAILING(*(uint32_t*)0x200004f4 = 0x148);
    NONFAILING(*(uint32_t*)0x200004f8 = 0);
    NONFAILING(*(uint32_t*)0x200004fc = 0);
    NONFAILING(*(uint32_t*)0x20000500 = 0x1c8);
    NONFAILING(*(uint32_t*)0x20000504 = 0x2a8);
    NONFAILING(*(uint32_t*)0x20000508 = 0x2a8);
    NONFAILING(*(uint32_t*)0x2000050c = 0x1c8);
    NONFAILING(*(uint32_t*)0x20000510 = 0x2a8);
    NONFAILING(*(uint32_t*)0x20000514 = 3);
    NONFAILING(*(uint64_t*)0x20000518 = 0);
    NONFAILING(*(uint32_t*)0x20000520 = htobe32(0));
    NONFAILING(*(uint8_t*)0x20000524 = 0xac);
    NONFAILING(*(uint8_t*)0x20000525 = 0x1e);
    NONFAILING(*(uint8_t*)0x20000526 = 0);
    NONFAILING(*(uint8_t*)0x20000527 = 1 + procid * 1);
    NONFAILING(*(uint32_t*)0x20000528 = htobe32(0));
    NONFAILING(*(uint32_t*)0x2000052c = htobe32(-1));
    NONFAILING(memcpy((void*)0x20000530, "batadv_slave_1\000\000", 16));
    ...
    NONFAILING(*(uint16_t*)0x20000570 = 0);
    NONFAILING(*(uint8_t*)0x20000572 = 0);
    NONFAILING(*(uint8_t*)0x20000573 = 0);
    NONFAILING(*(uint32_t*)0x20000574 = 0);
    NONFAILING(*(uint16_t*)0x20000578 = 0x70);
    NONFAILING(*(uint16_t*)0x2000057a = 0xd0);
    NONFAILING(*(uint32_t*)0x2000057c = 0);
    NONFAILING(*(uint64_t*)0x20000580 = 0);
    NONFAILING(*(uint64_t*)0x20000588 = 0);
    NONFAILING(*(uint16_t*)0x20000590 = 0x60);
    NONFAILING(memcpy((void*)0x20000592,
                      "CLUSTERIP\000\000\000\000\000\000\000\000\000\000\000"
                      "\000\000\000\000\000\000\000\000\000",
                      29));
    NONFAILING(*(uint8_t*)0x200005af = 0);
    NONFAILING(*(uint32_t*)0x200005b0 = 1);
    NONFAILING(*(uint8_t*)0x200005b4 = 1);
    NONFAILING(*(uint8_t*)0x200005b5 = 0x80);
    NONFAILING(*(uint8_t*)0x200005b6 = 0xc2);
    ...
    NONFAILING(*(uint16_t*)0x200005be = 8);
    NONFAILING(*(uint16_t*)0x200005c0 = 0x1a);
    NONFAILING(*(uint16_t*)0x200005c2 = 0x11);
    NONFAILING(*(uint16_t*)0x200005c4 = 0);
    NONFAILING(*(uint16_t*)0x200005c6 = 0);
    NONFAILING(*(uint16_t*)0x200005c8 = 0);
    NONFAILING(*(uint16_t*)0x200005ca = 0);
    NONFAILING(*(uint16_t*)0x200005cc = 0);
    NONFAILING(*(uint16_t*)0x200005ce = 0);
    NONFAILING(*(uint16_t*)0x200005d0 = 0x22);
    NONFAILING(*(uint16_t*)0x200005d2 = 0);
    NONFAILING(*(uint16_t*)0x200005d4 = 0);
    NONFAILING(*(uint16_t*)0x200005d6 = 0);
    ...
    NONFAILING(memset((void*)0x200005f0, 0, 84));
    NONFAILING(*(uint32_t*)0x20000644 = 0);
    NONFAILING(*(uint16_t*)0x20000648 = 0xd0);
    NONFAILING(*(uint16_t*)0x2000064a = 0xf8);
    NONFAILING(*(uint32_t*)0x2000064c = 0);
    NONFAILING(*(uint64_t*)0x20000650 = 0);
    NONFAILING(*(uint64_t*)0x20000658 = 0);
    NONFAILING(*(uint16_t*)0x20000660 = 0x28);
    NONFAILING(memcpy((void*)0x20000662,
                      "rpfilter\000\000\000\000\000\000\000\000\000\000\000\000"
                      "\000\000\000\000\000\000\000\000\000",
                      29));
    NONFAILING(*(uint8_t*)0x2000067f = 0);
    NONFAILING(*(uint8_t*)0x20000680 = 0);
    NONFAILING(*(uint16_t*)0x20000688 = 0x38);
    NONFAILING(memcpy((void*)0x2000068a,
                      "time\000\000\000\000\000\000\000\000\000\000\000\000\000"
    ...
    NONFAILING(*(uint16_t*)0x200006c0 = 0x28);
    NONFAILING(memcpy((void*)0x200006c2,
                      "SET\000\000\000\000\000\000\000\000\000\000\000\000\000"
                      "\000\000\000\000\000\000\000\000\000\000\000\000\000",
                      29));
    NONFAILING(*(uint8_t*)0x200006df = 1);
    NONFAILING(*(uint16_t*)0x200006e0 = 0);
    NONFAILING(*(uint8_t*)0x200006e2 = 0);
    NONFAILING(*(uint8_t*)0x200006e3 = 0);
    NONFAILING(*(uint16_t*)0x200006e4 = 0);
    NONFAILING(*(uint8_t*)0x200006e6 = 0);
    NONFAILING(*(uint8_t*)0x200006e7 = 0);
    NONFAILING(memset((void*)0x200006e8, 0, 84));
    NONFAILING(*(uint32_t*)0x2000073c = 0);
    NONFAILING(*(uint16_t*)0x20000740 = 0x70);
    NONFAILING(*(uint16_t*)0x20000742 = 0x98);
    NONFAILING(*(uint32_t*)0x20000744 = 0);
    NONFAILING(*(uint64_t*)0x20000748 = 0);
    NONFAILING(*(uint64_t*)0x20000750 = 0x8800000000000000);
    NONFAILING(*(uint16_t*)0x20000758 = 0x28);
    NONFAILING(memset((void*)0x2000075a, 0, 29));
    NONFAILING(*(uint8_t*)0x20000777 = 0);
    NONFAILING(*(uint32_t*)0x20000778 = 0xfffffffe);
    syscall(__NR_setsockopt, r[1], 0, 0x40, 0x200004c0ul, 0x2c0ul);
    break;
  }
}
int main(void)
