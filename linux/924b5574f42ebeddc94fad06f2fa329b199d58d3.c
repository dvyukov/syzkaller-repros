...
void execute_one(void)
{
  ...
  *(uint32_t*)0x200002d0 = 0;
  res = syscall(__NR_ioctl, r[0], 0x8933, 0x200002c0);
  if (res != -1)
    r[1] = *(uint32_t*)0x200002d0;
  *(uint16_t*)0x20000340 = 0x11;
  *(uint16_t*)0x20000342 = htobe16(0);
  *(uint32_t*)0x20000344 = r[1];
  *(uint16_t*)0x20000348 = 1;
  *(uint8_t*)0x2000034a = 0;
  *(uint8_t*)0x2000034b = 6;
  ...
  *(uint8_t*)0x20000353 = 0;
  syscall(__NR_bind, r[0], 0x20000340, 0x14);
  memcpy((void*)0x20000140,
         "\x48\xe0\xff\xe3\x60\xb6\x41\x99\xc6\x1c\x94\x28\xc6\x1c\x58\x55\x26",
         17);
  syscall(__NR_sendto, r[0], 0x20000140, 0x11, 4, 0, 0);
}
int main(void)
{
