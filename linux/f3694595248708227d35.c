// memory leak in bpf
// https://syzkaller.appspot.com/bug?id=f3694595248708227d35
// status:0
...
void execute_call(int call)
{
  switch (call) {
  case 0:
    NONFAILING(*(uint32_t*)0x2001dc00 = 0x1b);
    NONFAILING(*(uint32_t*)0x2001dc04 = 0);
    NONFAILING(*(uint32_t*)0x2001dc08 = 0);
    NONFAILING(*(uint32_t*)0x2001dc0c = 0x2000);
    NONFAILING(*(uint32_t*)0x2001dc10 = 0);
    NONFAILING(*(uint32_t*)0x2001dc14 = -1);
    NONFAILING(*(uint32_t*)0x2001dc18 = 0);
    NONFAILING(*(uint8_t*)0x2001dc1c = 0);
    NONFAILING(*(uint8_t*)0x2001dc1d = 0);
    NONFAILING(*(uint8_t*)0x2001dc1e = 0);
    NONFAILING(*(uint8_t*)0x2001dc1f = 0);
    NONFAILING(*(uint8_t*)0x2001dc20 = 0);
    NONFAILING(*(uint8_t*)0x2001dc21 = 0);
    NONFAILING(*(uint8_t*)0x2001dc22 = 0);
    NONFAILING(*(uint8_t*)0x2001dc23 = 0);
    NONFAILING(*(uint8_t*)0x2001dc24 = 0);
    NONFAILING(*(uint8_t*)0x2001dc25 = 0);
    NONFAILING(*(uint8_t*)0x2001dc26 = 0);
    NONFAILING(*(uint8_t*)0x2001dc27 = 0);
    NONFAILING(*(uint8_t*)0x2001dc28 = 0);
    NONFAILING(*(uint8_t*)0x2001dc29 = 0);
    NONFAILING(*(uint8_t*)0x2001dc2a = 0);
    NONFAILING(*(uint8_t*)0x2001dc2b = 0);
    NONFAILING(*(uint32_t*)0x2001dc2c = 0);
    NONFAILING(*(uint32_t*)0x2001dc30 = -1);
    NONFAILING(*(uint32_t*)0x2001dc34 = 0);
    NONFAILING(*(uint32_t*)0x2001dc38 = 0);
    NONFAILING(*(uint32_t*)0x2001dc3c = 0);
    syscall(__NR_bpf, 0ul, 0x2001dc00ul, 0x40ul);
    break;
  case 1:
    syscall(__NR_clone, 0x84802d80ul, 0ul, 0x9999999999999999ul, 0ul, -1ul);
    break;
  }
}
int main(void)
