...
// https://syzkaller.appspot.com/bug?id=6bfb30abbbdee95159eb
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    *(uint32_t*)0x20001618 = 0;
    ...
    res = -1;
    res = syz_io_uring_setup(0x2deb, 0x20001600, 0x20002000, 0x20ffb000,
  ...
  case 1:
    ...
    break;
  case 2:
    *(uint8_t*)0x200001c0 = 0xb;
    *(uint8_t*)0x200001c1 = 0;
    *(uint16_t*)0x200001c2 = 0;
    *(uint32_t*)0x200001c4 = 0;
    *(uint64_t*)0x200001c8 = 0xa;
    ...
    *(uint16_t*)0x200001ea = 0;
    ...
    syz_io_uring_submit(r[0], r[1], 0x200001c0, 0);
    break;
  }
}
int main(void)
