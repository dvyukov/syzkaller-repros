...
// https://syzkaller.appspot.com/bug?id=f54e3f04854769438c51
// status:0
...
void execute_call(int call)
{
  ...
  case 4:
    ...
    break;
  case 5:
    NONFAILING(memcpy((void*)0x200000c0, "./file2\000", 8));
    syscall(__NR_execve, 0x200000c0ul, 0ul, 0ul);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000180, "./bus\000", 6));
    res = syscall(__NR_open, 0x20000180ul, 0x1612c2ul, 0ul);
    if (res != -1)
      r[0] = res;
    break;
  case 7:
  ...
  case 9:
    ...
    syscall(__NR_preadv, -1, 0x200023c0ul, 1ul, 0, 0);
    break;
  case 10:
    NONFAILING(memcpy((void*)0x200000c0, "stack\000", 6));
    res = -1;
    NONFAILING(res = syz_open_procfs(0, 0x200000c0));
    if (res != -1)
      r[2] = res;
    break;
  case 11:
    syscall(__NR_preadv, r[2], 0x200017c0ul, 0x218ul, 0, 0);
    break;
  }
}
int main(void)
