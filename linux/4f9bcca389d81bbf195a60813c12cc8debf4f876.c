...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    memcpy((void*)0x200000c0, "md5sum", 7);
    res = syscall(__NR_memfd_create, 0x200000c0, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    syscall(__NR_mmap, 0x20001000, 0x1000, 0, 0x51, r[0], 0);
    break;
  case 2:
    memcpy((void*)0x20000040, "./control", 10);
  ...
  case 4:
    *(uint32_t*)0x20000080 = 4;
    syscall(__NR_getsockopt, r[1], 0x84, 7, 0x20000000, 0x20000080);
    break;
  case 5:
    memcpy((void*)0x20000040, "smaps", 6);
    res = syz_open_procfs(0, 0x20000040);
    if (res != -1)
      r[2] = res;
    break;
  case 6:
    *(uint64_t*)0x200021c0 = 0x20000140;
    *(uint64_t*)0x200021c8 = 0x432;
    *(uint64_t*)0x200021d0 = 0x200001c0;
    *(uint64_t*)0x200021d8 = 0x1000;
    syscall(__NR_readv, r[2], 0x200021c0, 2);
    break;
  }
}
