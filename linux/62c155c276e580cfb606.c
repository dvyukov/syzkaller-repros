...
// https://syzkaller.appspot.com/bug?id=62c155c276e580cfb606
// status:6 arch:386
...
void loop(void)
{
  ...
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x20000200, "vxcan0\000\000\000\000\000\000\000\000\000\000",
         16);
  *(uint32_t*)0x20000210 = 0;
  res = syscall(__NR_ioctl, (intptr_t)r[1], 0x8933, 0x20000200);
  if (res != -1)
  ...
  *(uint8_t*)0x20000254 = 0;
  syscall(__NR_bind, (intptr_t)r[0], 0x20000240, 0x18);
  *(uint32_t*)0x200011c0 = 0x20000140;
  ...
  *(uint32_t*)0x200011c4 = 0x18;
  *(uint32_t*)0x200011c8 = 0x20001180;
  *(uint32_t*)0x20001180 = 0x20001200;
  memcpy((void*)0x20001200, "-", 1);
  *(uint32_t*)0x20001184 = 0x7c;
  *(uint32_t*)0x200011cc = 1;
  *(uint32_t*)0x200011d0 = 0;
  *(uint32_t*)0x200011d4 = 0;
  *(uint32_t*)0x200011d8 = 0;
  syscall(__NR_sendmsg, (intptr_t)r[0], 0x200011c0, 0x24000000);
}
int main(void)
{
