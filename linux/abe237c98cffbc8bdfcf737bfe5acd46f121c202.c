...
// https://syzkaller.appspot.com/bug?id=abe237c98cffbc8bdfcf737bfe5acd46f121c202
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_fadvise64, -1, 0ul, 0ul, 5ul);
    break;
  case 2:
    ...
    NONFAILING(*(uint64_t*)0x200001b8 = 0x20000100);
  ...
  case 5:
    ...
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x20000980 = 8);
    NONFAILING(memcpy(
        (void*)0x20000984,
        ...
        4096));
    NONFAILING(*(uint16_t*)0x20001984 = 0);
    syscall(__NR_write, r[1], 0x20000980ul, 0x10a9ul);
    break;
  case 7:
    ...
    break;
  case 8:
    syscall(__NR_fcntl, r[2], 4ul, 0x46000ul);
    break;
  case 9:
    syscall(__NR_lseek, r[2], 0x4200ul, 0ul);
    break;
  case 10:
    NONFAILING(memcpy((void*)0x20000000, "./bus\000", 6));
  ...
  case 11:
    ...
    if (res != -1)
      NONFAILING(r[4] = *(uint64_t*)0x200004c0);
    break;
  case 12:
    ...
    syscall(__NR_io_submit, r[4], 1ul, 0x20000540ul);
    break;
  case 13:
    ...
    break;
  case 14:
    syscall(__NR_sendfile, r[2], r[5], 0ul, 0x8400fffffffbul);
    break;
  case 15:
    syz_open_procfs(0, 0);
    break;
  ...
  case 17:
    ...
    NONFAILING(*(uint32_t*)0x20000208 = 0x4800);
    NONFAILING(*(uint32_t*)0x2000020c = 0);
    NONFAILING(*(uint8_t*)0x20000210 = 0x11);
    NONFAILING(memcpy((void*)0x20000211,
                      "\x00\x00\x00\x00\xf8\xff\xff\xff\x00\x00\x00\x00\x00\x00"
                      "\x00\x20\x00\x00\x00",
                      19));
    syscall(__NR_ioctl, -1, 0x40045431ul, 0x20000200ul);
    break;
  case 18:
    syscall(__NR_fadvise64, r[0], 0ul, 0ul, 0ul);
    break;
  case 19:
    syscall(__NR_ioctl, -1, 0x540aul, 0ul);
    break;
  case 20:
    syscall(__NR_bind, -1, 0ul, 0ul);
    break;
  case 21:
    res = syscall(__NR_perf_event_open, 0ul, 0, 0ul, -1, 3ul);
    if (res != -1)
      r[6] = res;
    break;
  case 22:
    syscall(__NR_dup2, -1, r[6]);
    break;
  case 23:
    ...
    NONFAILING(*(uint64_t*)0x200002c8 = 0x20000100);
  ...
  case 25:
    NONFAILING(*(uint64_t*)0x200000c0 = 0);
    syscall(__NR_sendfile, r[1], r[1], 0x200000c0ul, 0x8080fffffffeul);
    break;
  }
}
int main(void)
