...
int main(void)
{
  ...
  *(uint8_t*)0x20000044 = 0x18;
  *(uint8_t*)0x20000045 = 0x4e;
  *(uint8_t*)0x20000046 = 0x8b;
  *(uint8_t*)0x20000047 = 8;
  *(uint16_t*)0x20000048 = 0x13b1;
  *(uint16_t*)0x2000004a = 0x42;
  *(uint16_t*)0x2000004c = 0xf9d4;
  ...
  *(uint8_t*)0x2000005d = 0x5d;
  *(uint8_t*)0x2000005e = 0;
  *(uint8_t*)0x2000005f = 0;
  *(uint8_t*)0x20000060 = 0x5f;
  *(uint8_t*)0x20000061 = 0xa4;
  *(uint8_t*)0x20000062 = 0x4f;
  *(uint8_t*)0x20000063 = 0;
  *(uint8_t*)0x20000064 = 0xf;
  *(uint8_t*)0x20000065 = 0x21;
  *(uint16_t*)0x20000066 = 5;
  *(uint8_t*)0x20000068 = 0x80;
  *(uint8_t*)0x20000069 = 3;
  *(uint8_t*)0x2000006a = 0;
  *(uint16_t*)0x2000006b = 0x348;
  *(uint8_t*)0x2000006d = 0x21;
  *(uint16_t*)0x2000006e = 0x7bb;
  *(uint8_t*)0x20000070 = 0x23;
  *(uint16_t*)0x20000071 = 0xe2a;
  syz_usb_connect(1, 0x33, 0x20000040, 0);
  return 0;
}
