...
// https://syzkaller.appspot.com/bug?id=6a916267d9bc5fa2d9a6
// status:6
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x20000004 = 0xdb;
  *(uint8_t*)0x20000005 = 0x1a;
  *(uint8_t*)0x20000006 = 0x67;
  *(uint8_t*)0x20000007 = 0x40;
  *(uint16_t*)0x20000008 = 0xdf6;
  *(uint16_t*)0x2000000a = 0x56;
  *(uint16_t*)0x2000000c = 0x426c;
  ...
  *(uint8_t*)0x20000020 = 0x1b;
  *(uint8_t*)0x20000021 = 0xa7;
  *(uint8_t*)0x20000022 = 0x8a;
  ...
  *(uint64_t*)0x20000384 = 0x20000200;
  *(uint8_t*)0x20000200 = 0x40;
  *(uint8_t*)0x20000201 = 5;
  *(uint32_t*)0x20000202 = 0;
  *(uint64_t*)0x2000038c = 0;
  *(uint64_t*)0x20000394 = 0;
  *(uint64_t*)0x2000039c = 0;
  *(uint64_t*)0x200003a4 = 0;
  syz_usb_control_io(r[0], 0, 0x20000380);
  *(uint32_t*)0x20000ec0 = 0x2c;
  *(uint64_t*)0x20000ec4 = 0x20000d80;
  *(uint8_t*)0x20000d80 = 0x40;
  *(uint8_t*)0x20000d81 = 0x15;
  *(uint32_t*)0x20000d82 = 0x38;
  memcpy((void*)0x20000d86,
         "\xfc\xd2\xa0\x0e\x32\x4d\x7e\x7c\x1a\xc2\x9c\x64\x69\xa7\xbd\xd5\xc8"
         "\x93\x25\xc5\xd5\x7f\x03\x6a\x22\xf8\xf5\xe8\x85\x12\x87\x0e\x16\x1d"
         "\x47\x64\x59\x22\x97\x11\x3c\xee\x6d\xf5\x48\x21\xd1\x58\x85\x4c\x32"
         "\xe3\x46\x97\x51\xef",
         56);
  *(uint64_t*)0x20000ecc = 0;
  *(uint64_t*)0x20000ed4 = 0;
  *(uint64_t*)0x20000edc = 0;
  *(uint64_t*)0x20000ee4 = 0;
  syz_usb_control_io(r[0], 0, 0x20000ec0);
}
int main(void)
{
