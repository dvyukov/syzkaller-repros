...
// https://syzkaller.appspot.com/bug?id=d625c772c7814faabef9
// status:0
...
int main(void)
{
  ...
  *(uint16_t*)0x20000248 = 0xcf3;
  *(uint16_t*)0x2000024a = 0x9271;
  *(uint16_t*)0x2000024c = 0x108;
  ...
  *(uint8_t*)0x2000026f = 0x82;
  *(uint8_t*)0x20000270 = 3;
  *(uint16_t*)0x20000271 = 0x200;
  *(uint8_t*)0x20000273 = 0;
  *(uint8_t*)0x20000274 = 0;
  *(uint8_t*)0x20000275 = 0;
  *(uint8_t*)0x20000276 = 9;
  *(uint8_t*)0x20000277 = 5;
  *(uint8_t*)0x20000278 = 0x83;
  *(uint8_t*)0x20000279 = 3;
  *(uint16_t*)0x2000027a = 0x40;
  ...
  *(uint8_t*)0x20000282 = 3;
  *(uint16_t*)0x20000283 = 0x40;
