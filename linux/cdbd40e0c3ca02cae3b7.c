...
// https://syzkaller.appspot.com/bug?id=cdbd40e0c3ca02cae3b7
// status:6
...
{
  intptr_t res = 0;
  res = syscall(__NR_socketpair, 0x1eul, 2ul, 0, 0x20000040ul);
  if (res != -1)
  ...
  *(uint32_t*)0x20000270 = 0x41;
  syscall(__NR_sendmsg, r[0], 0x20000240ul, 0ul);
  *(uint32_t*)0x200002c0 = 0x10;
  syscall(__NR_getpeername, r[0], 0x20000280ul, 0x200002c0ul);
}
int main(void)
{
