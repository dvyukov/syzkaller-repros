...
// https://syzkaller.appspot.com/bug?id=f96f5d9b9771527b3b9bae6c00a98b841edf0f2e
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    *(uint32_t*)0x20001900 = 0xe8;
    syscall(__NR_getsockopt, -1, 0, 0x11, 0x20001800, 0x20001900);
    break;
  case 3:
  ...
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_mmap, 0x20001000, 0x4000, 0x1000003, 0x11, r[0], 0x2000);
    break;
  }
}
int main(void)
