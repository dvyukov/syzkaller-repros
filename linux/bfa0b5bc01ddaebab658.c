// SYZFATAL: executor NUM failed NUM times: failed to create temp dir: mkdir ./syzkaller-testdir1ADDR: no space left on dev
// https://syzkaller.appspot.com/bug?id=bfa0b5bc01ddaebab658
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_msgrcv, r[0], 0ul, 0x24ul, 0ul, 0ul);
    break;
  case 2:
