...
// https://syzkaller.appspot.com/bug?id=154bd5be532a63aa778b
// status:6
...
void execute_one(void)
{
  ...
  *(uint16_t*)0x2000006e = 3;
  memcpy((void*)0x20000070, "wlan1\000\000\000\000\000\000\000\000\000\000\000",
         16);
  ...
  *(uint32_t*)0x20000088 = 0x14;
  *(uint16_t*)0x2000008c = 0x11;
  *(uint16_t*)0x2000008e = 1;
  *(uint32_t*)0x20000090 = 0;
  *(uint32_t*)0x20000094 = 0;
  *(uint8_t*)0x20000098 = 0;
  *(uint8_t*)0x20000099 = 0;
  *(uint16_t*)0x2000009a = htobe16(0xa);
  *(uint64_t*)0x20001d88 = 0x9c;
  *(uint64_t*)0x20001dd8 = 1;
  *(uint64_t*)0x20001de0 = 0;
  *(uint64_t*)0x20001de8 = 0;
  *(uint32_t*)0x20001df0 = 0x20000001;
  syscall(__NR_sendmsg, r[0], 0x20001dc0ul, 0x34004050ul);
  memcpy((void*)0x20000000, "./file0\000", 8);
  syscall(__NR_mkdir, 0x20000000ul, 0x40ul);
  memcpy((void*)0x20000100, "./file0\000", 8);
  syscall(__NR_mount, 0x20000000ul, 0x20000100ul, 0ul, 0x2001001ul, 0ul);
  memcpy((void*)0x20000280, "./file0\000", 8);
  memcpy((void*)0x20000080, "./file0\000", 8);
  syscall(__NR_pivot_root, 0x20000280ul, 0x20000080ul);
}
int main(void)
{
