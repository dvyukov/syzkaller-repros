...
// https://syzkaller.appspot.com/bug?id=e223cf47ec8ae183f2a0
// status:6
...
void loop(void)
{
  ...
  *(uint32_t*)0x20000058 = 6;
  ...
  memcpy((void*)0x20000100, "\x52\xb3", 2);
  syscall(__NR_setsockopt, r[0], 0x29, 0x36, 0x20000100ul, 0x5a0ul);
  *(uint64_t*)0x200002c0 = 0;
  *(uint32_t*)0x200002c8 = 0;
  *(uint64_t*)0x200002d0 = 0x20000000;
  *(uint64_t*)0x20000000 = 0x200000c0;
  memcpy((void*)0x200000c0, "\x1d\x2d", 2);
  *(uint64_t*)0x20000008 = 0xfa5f;
  *(uint64_t*)0x200002d8 = 1;
  *(uint64_t*)0x200002e0 = 0;
  *(uint64_t*)0x200002e8 = 0;
  *(uint32_t*)0x200002f0 = 0;
  *(uint32_t*)0x200002f8 = 0;
  syscall(__NR_sendmmsg, r[0], 0x200002c0ul, 1ul, 0xfe80ul);
}
int main(void)
{
