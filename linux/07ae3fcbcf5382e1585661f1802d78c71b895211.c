...
// https://syzkaller.appspot.com/bug?id=07ae3fcbcf5382e1585661f1802d78c71b895211
// status:invalid
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    *(uint32_t*)0x20e7102e = 4;
    ...
    break;
  case 4:
    syscall(__NR_read, r[1], 0x20784f76, 0x8a);
    break;
  case 5:
    r[2] = syscall(__NR_socket, 0x18, 1, 1);
    break;
  case 6:
    memcpy((void*)0x20013ff8, "./file0", 8);
    syscall(__NR_creat, 0x20013ff8, 0x40);
    break;
  case 7:
