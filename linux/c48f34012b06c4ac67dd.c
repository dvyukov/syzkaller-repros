...
// https://syzkaller.appspot.com/bug?id=c48f34012b06c4ac67dd
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_madvise, 0x20000000ul, 0x400000ul, 0xeul);
    break;
  case 2:
    syscall(__NR_vmsplice, -1, 0ul, 0ul, 1ul);
    break;
  case 3:
  ...
  case 4:
    ...
    syscall(__NR_perf_event_open, 0x20000700ul, r[0], -1ul, -1, 9ul);
    break;
  case 5:
    NONFAILING(*(uint64_t*)0x20000000 = 0);
    NONFAILING(*(uint32_t*)0x20000008 = 0x20);
    NONFAILING(*(uint32_t*)0x2000000c = 4);
    NONFAILING(*(uint32_t*)0x20000010 = r[0]);
    syscall(__NR_timer_create, 3ul, 0x20000000ul, 0ul);
    break;
  case 6:
    ...
    break;
  case 7:
    NONFAILING(*(uint64_t*)0x200000c0 = 0x20075000);
    syscall(__NR_move_pages, 0, 1ul, 0x200000c0ul, 0x2026bfecul, 0ul, 0ul);
    break;
  }
}
int main(void)
