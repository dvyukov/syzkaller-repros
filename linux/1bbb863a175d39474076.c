...
// https://syzkaller.appspot.com/bug?id=1bbb863a175d39474076
// status:6
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    res = syscall(__NR_pipe2, 0x20000100ul, 0x80800ul);
    if (res != -1)
  ...
  case 1:
    ...
    break;
  case 2:
    res = syscall(__NR_epoll_create, 4);
    if (res != -1)
      r[2] = res;
    break;
  case 3:
    NONFAILING(*(uint32_t*)0x20d5dff4 = 0);
    NONFAILING(*(uint64_t*)0x20d5dff8 = 0);
    syscall(__NR_epoll_ctl, r[1], 1ul, r[2], 0x20d5dff4ul);
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x20000240 = 0x80000009);
    NONFAILING(*(uint64_t*)0x20000244 = 0);
    syscall(__NR_epoll_ctl, r[2], 1ul, r[0], 0x20000240ul);
    break;
  }
}
int main(void)
