...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint8_t*)0x20000048 = 0x79);
    NONFAILING(*(uint8_t*)0x20000049 = 0x10);
    NONFAILING(*(uint16_t*)0x2000004a = 0x90);
    NONFAILING(*(uint32_t*)0x2000004c = 0);
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000050, 2, 0, 3));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000050, 0, 3, 2));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000050, 0xb, 5, 3));
    ...
    NONFAILING(memcpy((void*)0x20003ff6, "G\000", 2));
    NONFAILING(*(uint32_t*)0x2000e018 = 5);
    ...
    NONFAILING(*(uint8_t*)0x2000e030 = 0);
    NONFAILING(*(uint8_t*)0x2000e031 = 0);
    NONFAILING(*(uint8_t*)0x2000e032 = 0);
    NONFAILING(*(uint8_t*)0x2000e033 = 0);
    NONFAILING(*(uint8_t*)0x2000e034 = 0);
    NONFAILING(*(uint8_t*)0x2000e035 = 0);
    NONFAILING(*(uint8_t*)0x2000e036 = 0);
    NONFAILING(*(uint8_t*)0x2000e037 = 0);
    NONFAILING(*(uint8_t*)0x2000e038 = 0);
    NONFAILING(*(uint8_t*)0x2000e039 = 0);
    NONFAILING(*(uint8_t*)0x2000e03a = 0);
    NONFAILING(*(uint8_t*)0x2000e03b = 0);
    NONFAILING(*(uint8_t*)0x2000e03c = 0);
    NONFAILING(*(uint8_t*)0x2000e03d = 0);
    NONFAILING(*(uint8_t*)0x2000e03e = 0);
    NONFAILING(*(uint8_t*)0x2000e03f = 0);
    ...
    res = syscall(__NR_bpf, 5, 0x2000e000, 0x48);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    ...
    NONFAILING(*(uint32_t*)0x20000088 = 0x11);
    NONFAILING(*(uint32_t*)0x2000008c = 3);
    syscall(__NR_bpf, 8, 0x20000080, 0x10);
    break;
  case 2:
    NONFAILING(
        memcpy((void*)0x20000000,
               "\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\x00\x08\x00\x45"
               "\x00\x00\x1c\x00\x00\x00\x00\x00\x6c\x90\x78\x00\x00\x00\x00"
               "\xe0\x00\x00\x01\x08\x10\x90\x78\x00\x00\x00\x00",
               42));
