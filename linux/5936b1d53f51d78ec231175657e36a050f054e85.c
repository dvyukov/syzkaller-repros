...
// https://syzkaller.appspot.com/bug?id=5936b1d53f51d78ec231175657e36a050f054e85
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20940028, 5, 1, 1));
    ...
    break;
  case 1:
    syscall(__NR_clone, 0x2102001ffe, 0, 0x9999999999999999, 0, -1);
    break;
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_ioctl, r[0], 0x2403, 0);
    break;
  }
}
int main(void)
