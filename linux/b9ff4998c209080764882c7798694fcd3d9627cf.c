...
// https://syzkaller.appspot.com/bug?id=b9ff4998c209080764882c7798694fcd3d9627cf
// status:dup
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20ee6ff8, "./file0", 8));
    syscall(__NR_execve, 0x20ee6ff8, 0x20578fe8, 0x20000500);
    break;
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_pread64, r[2], 0x200012c0, 0, 0);
    break;
  }
}
int main(void)
