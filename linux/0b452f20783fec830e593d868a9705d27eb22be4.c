// KASAN: stack-out-of-bounds Read in acct_collect
// https://syzkaller.appspot.com/bug?id=0b452f20783fec830e593d868a9705d27eb22be4
// status:invalid
...
void execute_call(int call)
{
  ...
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_ioctl, r[0], 0x2400, 4);
    break;
  case 7:
    NONFAILING(*(uint32_t*)0x20000180 = r[1]);
    NONFAILING(*(uint64_t*)0x20000188 = 0x200002c0);
    NONFAILING(*(uint64_t*)0x20000190 = 0x200003c0);
