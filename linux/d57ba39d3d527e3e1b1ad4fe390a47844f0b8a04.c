...
// https://syzkaller.appspot.com/bug?id=d57ba39d3d527e3e1b1ad4fe390a47844f0b8a04
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    NONFAILING(*(uint16_t*)0x20000180 = 0);
    NONFAILING(*(uint8_t*)0x20000184 = 0xac);
    NONFAILING(*(uint8_t*)0x20000185 = 0x1e);
    NONFAILING(*(uint8_t*)0x20000186 = 0);
    NONFAILING(*(uint8_t*)0x20000187 = 1 + procid * 1);
    NONFAILING(*(uint16_t*)0x20000188 = htobe16(0));
    NONFAILING(*(uint32_t*)0x2000018c = 0);
    NONFAILING(memcpy(
        (void*)0x20000190,
        "sh\000\000\000\000\000\000\000\000\000\000\000\000\000\000", 16));
    NONFAILING(*(uint32_t*)0x200001a0 = 0);
    NONFAILING(*(uint32_t*)0x200001a4 = 0);
    NONFAILING(*(uint32_t*)0x200001a8 = htobe32(0));
    syscall(__NR_setsockopt, -1, 0, 0x482, 0x20000180, 0x2c);
    break;
  case 3:
  ...
  case 4:
    ...
    NONFAILING(*(uint64_t*)0x20000110 = 0x2000);
    NONFAILING(*(uint64_t*)0x20000118 = 0x20000000);
    syscall(__NR_ioctl, r[1], 0x4020ae46, 0x20000100);
    break;
  case 5:
    ...
    NONFAILING(*(uint64_t*)0x20000230 = 0xfb);
