...
void execute_call(int call)
{
  ...
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_openat, 0xffffffffffffff9c, 0, 0x101000, 0x40);
    break;
  case 7:
  ...
  case 8:
    ...
    break;
  case 9:
    syscall(__NR_write, r[1], 0, 0xfe76);
    break;
  case 10:
    NONFAILING(memcpy((void*)0x20000540, "\xe4\x3d\x00\x80", 4));
    syscall(__NR_setsockopt, r[1], 1, 7, 0x20000540, 4);
    break;
  }
}
int main(void)
