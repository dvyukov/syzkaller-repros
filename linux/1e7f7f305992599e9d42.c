...
// https://syzkaller.appspot.com/bug?id=1e7f7f305992599e9d42
// status:0
...
void execute_call(int call)
{
  ...
  case 4:
    ...
    NONFAILING(*(uint64_t*)0x20000780 = 0x20001580);
    NONFAILING(*(uint32_t*)0x20001580 = 0x48);
    NONFAILING(*(uint16_t*)0x20001584 = 0x24);
    NONFAILING(*(uint16_t*)0x20001586 = 0xf0b);
    NONFAILING(*(uint32_t*)0x20001588 = 0);
    NONFAILING(*(uint32_t*)0x2000158c = 0);
    NONFAILING(*(uint8_t*)0x20001590 = 0);
    NONFAILING(*(uint8_t*)0x20001591 = 0);
    NONFAILING(*(uint16_t*)0x20001592 = 0);
    NONFAILING(*(uint32_t*)0x20001594 = r[1]);
    NONFAILING(*(uint16_t*)0x20001598 = 0);
    NONFAILING(*(uint16_t*)0x2000159a = 0);
    NONFAILING(*(uint16_t*)0x2000159c = -1);
    NONFAILING(*(uint16_t*)0x2000159e = -1);
    NONFAILING(*(uint16_t*)0x200015a0 = 0);
    NONFAILING(*(uint16_t*)0x200015a2 = 0);
    NONFAILING(*(uint16_t*)0x200015a4 = 0xd);
    NONFAILING(*(uint16_t*)0x200015a6 = 1);
    NONFAILING(memcpy((void*)0x200015a8, "fq_codel\000", 9));
    NONFAILING(*(uint16_t*)0x200015b4 = 0x14);
    NONFAILING(*(uint16_t*)0x200015b6 = 2);
    NONFAILING(*(uint16_t*)0x200015b8 = 8);
    NONFAILING(*(uint16_t*)0x200015ba = 2);
    NONFAILING(*(uint32_t*)0x200015bc = 0);
    NONFAILING(*(uint16_t*)0x200015c0 = 8);
    NONFAILING(*(uint16_t*)0x200015c2 = 6);
