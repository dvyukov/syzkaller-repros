...
// https://syzkaller.appspot.com/bug?id=a95c7753605c9d219466
// status:3
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    syscall(__NR_futex, 0x2000cffcul, 0x800000000006ul, 0, 0ul, 0ul, 0);
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000040, "./bus\000", 6));
    res = syscall(__NR_open, 0x20000040ul, 0x8001147042ul, 0ul);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
    syscall(__NR_ftruncate, r[0], 0x2008000ul);
    break;
  case 3:
  ...
  case 5:
    ...
    syscall(__NR_timer_create, 0ul, 0x20044000ul, 0x20044000ul);
    break;
  case 6:
    res = syscall(__NR_clock_gettime, 0ul, 0x20000040ul);
    if (res != -1)
      NONFAILING(r[2] = *(uint64_t*)0x20000048);
    break;
  case 7:
    NONFAILING(*(uint64_t*)0x20000000 = 0);
    NONFAILING(*(uint64_t*)0x20000008 = r[2] + 10000000);
