...
// https://syzkaller.appspot.com/bug?id=6d02be72a4c63d746e66c0b7c423d3b7c124bf59
// status:open
...
int main(void)
{
  ...
  *(uint32_t*)0x20e5b004 = htobe32(0xe0000001);
  syscall(__NR_bind, r[2], 0x20e5b000ul, 0x10ul);
  *(uint16_t*)0x20ccb000 = 2;
  *(uint16_t*)0x20ccb002 = htobe16(0x4e20);
  *(uint32_t*)0x20ccb004 = htobe32(0);
  syscall(__NR_connect, r[2], 0x20ccb000ul, 0x10ul);
  ...
  *(uint64_t*)0x20000108 = 0x209ff000;
  memcpy((void*)0x209ff000, "\x18\x00\x00\x00\x03\x00\x00\x00\x00\x00\x00\x00"
                            "\x00\xa5\x00\x00\x95\x00\x2b\x00\x00\x00\x00\x00",
         24);
  ...
  *(uint32_t*)0x20000384 = r[3];
  syscall(__NR_ioctl, r[4], 0x89e0ul, 0x20000380ul);
  *(uint32_t*)0x20000100 = 1;
  *(uint32_t*)0x20000104 = 3;
  *(uint64_t*)0x20000108 = 0x20000180;
  memcpy((void*)0x20000180, "\x18\x00\x00\x00\x03\x00\x00\x00\x00\x00\x00\x00"
                            "\x00\xa5\x00\x00\x95\x00\x2b\x00\x00\x00\x00\x00"
                            "\xe3\xb4\x26\xf5\x14\x36\x84\x4a\xf2\x97\x4b\xc6"
                            "\x74\x04\x9c\xd6\xce\x2d\x09\x1c",
         44);
  *(uint64_t*)0x20000110 = 0x202bf000;
  memcpy((void*)0x202bf000, "syzkaller\000", 10);
  *(uint32_t*)0x20000118 = 4;
  ...
  *(uint32_t*)0x20000170 = -1;
  ...
  if (res != -1)
    r[5] = res;
  res = syscall(__NR_fcntl, r[5], 0x406ul, r[0]);
  if (res != -1)
    r[6] = res;
  *(uint32_t*)0x20000080 = r[2];
  *(uint32_t*)0x20000084 = r[6];
  syscall(__NR_ioctl, r[1], 0x89e0ul, 0x20000080ul);
  return 0;
}
