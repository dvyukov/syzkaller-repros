...
void loop()
{
  ...
  *(uint64_t*)0x20000200 = 0x20010000;
  memcpy((void*)0x20010000,
         ...
         "\x59\xf7\x48\x66\x89\x00\x00\x00\x00\x00\x00\x00\x00\x80\x00\x00\x00"
         "\x00\x04\x00\x00\x00\x00\x00\x00\x00\x00\x00\x07\x00\x00\x00\x04\x00"
         "\x04",
         154);
  ...
  *(uint64_t*)0x20000230 = 0x20010500;
  memcpy((void*)0x20010500, "\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x03"
                            "\x00\x00\x00\x01\x00\x00\x00\x01\x00\x00\x00\x02"
                            "\x00\x00\x00\x01\x00\x00\x00\x01\x80\x00\x00\x25"
                            "\x00\x00\x00\x40",
         40);
  *(uint64_t*)0x20000238 = 0x28;
  *(uint64_t*)0x20000240 = 0x8800;
  syz_mount_image(0x20000000, 0x20000100, 0, 3, 0x20000200, 0, 0x200002c0);
}
