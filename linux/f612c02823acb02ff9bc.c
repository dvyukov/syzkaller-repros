...
// https://syzkaller.appspot.com/bug?id=f612c02823acb02ff9bc
// status:6
...
int main(void)
{
  ...
  *(uint64_t*)0x20000080 = 0x20000100;
  memcpy((void*)0x20000100, "\x2e\x00\x00\x00\x33\x00\x05\x35\xa4\xab\xd3\x2b"
                            "\x80\x18\x00\x7a\x01\x24\xfc\x60\x10\x00\x02\x40"
                            "\x0c\x00\x02\x00\x05\x35\x82\xc1\x37\x15\x3e\x37"
                            "\x09\x00\x01\x80\x04\x00\x1d\x00\xd1\xbd",
         46);
  *(uint64_t*)0x20000088 = 0x2e;
  *(uint64_t*)0x200000d8 = 1;
  *(uint64_t*)0x200000e0 = 0;
  *(uint64_t*)0x200000e8 = 0;
  *(uint32_t*)0x200000f0 = 0x4c;
