...
// https://syzkaller.appspot.com/bug?id=de1acd8124232a3afac4
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    res = syscall(__NR_socket, 0x25ul, 5ul, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 2:
    ...
    syscall(__NR_epoll_ctl, r[0], 1ul, r[1], 0x200001c0ul);
    break;
  case 3:
    syscall(__NR_ioctl, -1, 0x80045006, 0ul);
    break;
  case 4:
    res = syscall(__NR_epoll_create, 0x101);
    if (res != -1)
      r[2] = res;
    break;
  case 5:
    NONFAILING(*(uint32_t*)0x20000040 = 0x60000018);
    NONFAILING(*(uint64_t*)0x20000044 = 0);
    syscall(__NR_epoll_ctl, r[2], 1ul, r[0], 0x20000040ul);
    break;
  }
}
int main(void)
