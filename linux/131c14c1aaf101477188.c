...
// https://syzkaller.appspot.com/bug?id=131c14c1aaf101477188
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    NONFAILING(
        memcpy((void*)0x20000080, "/proc/sys/net/ipv4/vs/conntrack\000", 32));
  ...
  case 1:
    ...
    syscall(__NR_getsockopt, r[0], 0x84, 0x1d, 0ul, 0x20000100ul);
    break;
  case 2:
  ...
  case 3:
    ...
    syscall(__NR_ioctl, r[1], 0xc040565f, 0x200001c0ul);
    break;
  case 4:
    syscall(__NR_ioctl, r[1], 0xc400941b, 0ul);
    break;
  case 5:
    NONFAILING(*(uint32_t*)0x20000040 = 3);
    syscall(__NR_ioctl, r[1], 0xc0045627, 0x20000040ul);
    break;
  case 6:
    syscall(__NR_mmap, 0x20000000ul, 0x800000ul, 0x1800003ul, 0x12ul, -1, 0ul);
    break;
  case 7:
    NONFAILING(memcpy((void*)0x200013c0, "trusted.overlay.origin\000", 23));
    syscall(__NR_fsetxattr, -1, 0x200013c0ul, 0ul, 0ul, 3ul);
    break;
  case 8:
    syscall(__NR_ioctl, -1, 0x89e2, 0ul);
    break;
  case 9:
    syscall(__NR_preadv, -1, 0ul, 0ul, 9, 8);
    break;
  case 10:
    NONFAILING(*(uint32_t*)0x200001c0 = 1);
  ...
  case 12:
    ...
    syscall(__NR_ioctl, r[2], 0xc040565f, 0x20000080ul);
    break;
  case 13:
    NONFAILING(memcpy((void*)0x20000000, "/dev/video#\000", 12));
    res = -1;
  ...
  case 14:
    ...
    syscall(__NR_preadv, r[3], 0x20000100ul, 3ul, 8, 5);
    break;
  }
}
int main(void)
