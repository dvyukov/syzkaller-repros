...
// https://syzkaller.appspot.com/bug?id=aad9153df669ca3bebafb04d01b0b40b45f02f08
// status:open
...
{
  long res = 0;
  memcpy((void*)0x20000080, "/dev/loop-control", 18);
  ...
  *(uint64_t*)0x20000210 = 0x1a0;
  syz_read_part_table(0xfffffffffffffffe, 1, 0x20000200);
}
int main(void)
{
