...
// https://syzkaller.appspot.com/bug?id=703309d49447cffbbcbb
// status:6
...
void loop(void)
{
  ...
  NONFAILING(memcpy((void*)0x20000080, "erofs\000", 6));
  NONFAILING(memcpy((void*)0x20000100, "./file0\000", 8));
  NONFAILING(*(uint64_t*)0x20000200 = 0x20000140);
  NONFAILING(memcpy(
      (void*)0x20000140,
      "\xe2\xe1\xf5\xe0\x95\x21\xe9\x3c\x02\x00\x00\x00\x0c\x00\x24", 15));
  NONFAILING(*(uint64_t*)0x20000208 = 0xf);
  NONFAILING(*(uint64_t*)0x20000210 = 0x400);
  NONFAILING(*(uint64_t*)0x20000218 = 0x200000c0);
  NONFAILING(
      memcpy((void*)0x200000c0, "\x42\x00\x03\x00\x00\x44\x8d\x08\x04", 9));
  NONFAILING(*(uint64_t*)0x20000220 = 0xff18);
  NONFAILING(*(uint64_t*)0x20000228 = 0x480);
  NONFAILING(memset((void*)0x20000040, 0, 1));
  NONFAILING(
      syz_mount_image(0x20000080, 0x20000100, 0, 2, 0x20000200, 0, 0x20000040));
  NONFAILING(memcpy((void*)0x200001c0, "./file0/file0\000", 14));
  syscall(__NR_mount, 0ul, 0x200001c0ul, 0ul, 0ul, 0ul);
  close_fds();
}
int main(void)
{
