...
// https://syzkaller.appspot.com/bug?id=d601416c178e3d67888024bdf7774477a034840b
// status:open
...
int main(void)
{
  ...
  *(uint8_t*)0x20000044 = 0xc9;
  *(uint8_t*)0x20000045 = 0x90;
  *(uint8_t*)0x20000046 = 0x4f;
  *(uint8_t*)0x20000047 = 8;
  *(uint16_t*)0x20000048 = 0x4bb;
  *(uint16_t*)0x2000004a = 0x930;
  *(uint16_t*)0x2000004c = 0xd24a;
  ...
  *(uint8_t*)0x2000005d = 0x98;
  *(uint8_t*)0x2000005e = 0;
  *(uint8_t*)0x2000005f = 0;
  *(uint8_t*)0x20000060 = 0xd3;
  *(uint8_t*)0x20000061 = 4;
  *(uint8_t*)0x20000062 = 0xe8;
  *(uint8_t*)0x20000063 = 0;
  res = syz_usb_connect(0, 0x24, 0x20000040, 0);
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x20000200 = 0x34;
  ...
  *(uint32_t*)0x20000c80 = 0x54;
  *(uint64_t*)0x20000c84 = 0x20000a40;
  *(uint8_t*)0x20000a40 = 0;
  *(uint8_t*)0x20000a41 = 0;
  *(uint32_t*)0x20000a42 = 0;
  *(uint64_t*)0x20000c8c = 0;
  *(uint64_t*)0x20000c94 = 0;
  *(uint64_t*)0x20000c9c = 0;
  *(uint64_t*)0x20000ca4 = 0;
  *(uint64_t*)0x20000cac = 0;
  *(uint64_t*)0x20000cb4 = 0;
  *(uint64_t*)0x20000cbc = 0;
  *(uint64_t*)0x20000cc4 = 0;
  *(uint64_t*)0x20000ccc = 0;
  syz_usb_control_io(r[0], 0x20000200, 0x20000c80);
  return 0;
}
