...
// https://syzkaller.appspot.com/bug?id=1dafe081e90c2a80b7e53cdb2de82df52b9356c1
// status:open
...
void execute_call(int call)
{
  ...
  case 5:
    ...
    break;
  case 6:
    NONFAILING(*(uint64_t*)0x200000c0 = 0x20000180);
    NONFAILING(memcpy((void*)0x20000180,
                      "\x77\x69\x0a\xdd\xcf\xbe\x1f\xbb\x66\xec", 10));
    NONFAILING(*(uint64_t*)0x200000c8 = 0xff3b);
  ...
  case 8:
    ...
    syscall(__NR_creat, 0x20000040ul, 0x10ul);
    break;
  case 9:
    syscall(__NR_splice, r[0], 0ul, r[1], 0ul, 0x100000002ul, 0ul);
    break;
  }
}
int main(void)
