...
{
  long res = 0;
  res = syscall(__NR_socket, 2, 0x6000000000000001, 0);
  if (res != -1)
    r[0] = res;
  ...
  *(uint8_t*)0x2000008f = 0;
  syscall(__NR_sendto, r[0], 0x20000000, 0, 0x20000802, 0x20000080, 0x10);
  ...
  *(uint32_t*)0x20000408 = 0xe;
  *(uint32_t*)0x2000040c = 0x8f;
  *(uint64_t*)0x20000410 = 0x20000100;
  memcpy((void*)0x20000100,
         "\x46\xf1\x26\x3a\xb0\xe2\xd2\x1c\xaa\x64\x2b\x2a\x88\xa8", 14);
  *(uint64_t*)0x20000418 = 0x20000280;
  *(uint32_t*)0x20000420 = 0xfffffffd;
  *(uint32_t*)0x20000424 = 0;
  syscall(__NR_bpf, 0xa, 0x20000400, 0x28);
}
int main()
{
