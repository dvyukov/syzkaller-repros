...
// https://syzkaller.appspot.com/bug?id=bd5330f2bc2e9bb338d7bd9a8d4380d7c887f3ed
// status:open
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    NONFAILING(*(uint64_t*)0x20c34000 = 0xaa);
    NONFAILING(*(uint64_t*)0x20c34008 = 0);
    NONFAILING(*(uint64_t*)0x20c34010 = 0);
    syscall(__NR_ioctl, r[0], 0xc018aa3ful, 0x20c34000ul);
    break;
  case 4:
    NONFAILING(*(uint64_t*)0x200000c0 = 0x20068000);
    NONFAILING(*(uint64_t*)0x200000c8 = 0x800000);
    NONFAILING(*(uint64_t*)0x200000d0 = 1);
    NONFAILING(*(uint64_t*)0x200000d8 = 0);
    syscall(__NR_ioctl, r[0], 0xc020aa00ul, 0x200000c0ul);
    break;
  case 5:
    syscall(__NR_sched_setattr, 0, 0ul, 0ul);
    break;
  ...
  case 9:
    ...
    syscall(__NR_write, r[1], 0x20000000ul, 0x10000000dul);
    break;
  }
}
int main(void)
