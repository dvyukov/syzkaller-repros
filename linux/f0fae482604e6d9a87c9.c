...
// https://syzkaller.appspot.com/bug?id=f0fae482604e6d9a87c9
// status:0
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x20000020 = 0xd0;
  *(uint8_t*)0x20000021 = 0xbb;
  *(uint8_t*)0x20000022 = 0x3a;
  *(uint8_t*)0x20000023 = 0;
  res = -1;
  res = syz_usb_connect(0, 0x24, 0x20000000, 0);
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x20000980 = 0x24;
  *(uint64_t*)0x20000984 = 0x200007c0;
  *(uint8_t*)0x200007c0 = 0;
  *(uint8_t*)0x200007c1 = 0;
  *(uint32_t*)0x200007c2 = 8;
  *(uint8_t*)0x200007c6 = 8;
  *(uint8_t*)0x200007c7 = 1;
  memcpy((void*)0x200007c8, "\x0d\x6f\x29\xcf\x07\x10", 6);
  *(uint64_t*)0x2000098c = 0;
  *(uint64_t*)0x20000994 = 0;
  *(uint64_t*)0x2000099c = 0;
  syz_usb_control_io(r[0], 0x20000980, 0);
  *(uint32_t*)0x20000140 = 0x24;
  *(uint64_t*)0x20000144 = 0x20000180;
  memcpy((void*)0x20000180, "\x00\x00\x02\x00\x00\x00\x02\x01", 8);
