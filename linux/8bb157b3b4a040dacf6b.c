...
// https://syzkaller.appspot.com/bug?id=8bb157b3b4a040dacf6b
// status:0
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000140 = 0x14;
  res = syscall(__NR_getsockname, r[4], 0x200000c0ul, 0x20000140ul);
  if (res != -1)
    r[5] = *(uint32_t*)0x200000c4;
  res = syscall(__NR_socketpair, 1ul, 5ul, 0, 0x200000c0ul);
  if (res != -1)
    r[6] = *(uint32_t*)0x200000c4;
  res = syscall(__NR_dup, r[6]);
  if (res != -1)
    r[7] = res;
  *(uint32_t*)0x20000140 = 0x14;
  res = syscall(__NR_getsockname, r[7], 0x200000c0ul, 0x20000140ul);
  if (res != -1)
    r[8] = *(uint32_t*)0x200000c4;
  *(uint64_t*)0x20000040 = 0;
  *(uint32_t*)0x20000048 = 0xfab;
  ...
  *(uint32_t*)0x200000b4 = r[5];
  *(uint16_t*)0x200000b8 = 8;
  *(uint16_t*)0x200000ba = 1;
  *(uint32_t*)0x200000bc = r[8];
