...
// https://syzkaller.appspot.com/bug?id=c927c937cba8ef66dd4a
// status:6
...
void execute_call(int call)
{
  switch (call) {
  case 0:
    NONFAILING(*(uint32_t*)0x20000204 = 0xf3e);
    NONFAILING(*(uint32_t*)0x20000208 = 2);
    NONFAILING(*(uint32_t*)0x2000020c = 2);
    NONFAILING(*(uint32_t*)0x20000210 = 0x13e);
    ...
    NONFAILING(
        syz_io_uring_setup(0x6923, 0x20000200, 0x20ffc000, 0x20ffc000, 0, 0));
    break;
  }
}
int main(void)
