...
// https://syzkaller.appspot.com/bug?id=31ead562a01d2890d22db7849efad8d7580f18d0
// status:open
...
void loop(void)
{
  ...
  *(uint16_t*)0x2000002a = 1;
  memcpy((void*)0x2000002c, "syz0\000", 5);
  *(uint32_t*)0x20000034 = 0x6c;
  *(uint8_t*)0x20000038 = 0x16;
  ...
  *(uint16_t*)0x20000074 = 0x2c;
  STORE_BY_BITMASK(uint16_t, , 0x20000076, 3, 0, 14);
  STORE_BY_BITMASK(uint16_t, , 0x20000077, 0, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x20000077, 1, 7, 1);
  *(uint16_t*)0x20000078 = 0x14;
  *(uint16_t*)0x2000007a = 1;
  memcpy((void*)0x2000007c, "geneve1\000\000\000\000\000\000\000\000\000", 16);
  *(uint16_t*)0x2000008c = 0x14;
  *(uint16_t*)0x2000008e = 1;
  memcpy((void*)0x20000090,
         "gre0\000\000\000\000\000\000\000\000\000\000\000\000", 16);
  *(uint32_t*)0x200000a0 = 0x14;
  *(uint16_t*)0x200000a4 = 0x10;
  *(uint16_t*)0x200000a6 = 1;
  *(uint32_t*)0x200000a8 = 0;
  *(uint32_t*)0x200000ac = 0;
  *(uint8_t*)0x200000b0 = 0;
  *(uint8_t*)0x200000b1 = 0;
  *(uint16_t*)0x200000b2 = htobe16(0xa);
