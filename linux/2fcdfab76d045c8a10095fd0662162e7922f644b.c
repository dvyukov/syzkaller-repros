...
// https://syzkaller.appspot.com/bug?id=2fcdfab76d045c8a10095fd0662162e7922f644b
// status:open
...
void execute_call(int call)
{
  ...
  case 15:
    ...
    break;
  case 16:
    syscall(__NR_fgetxattr, r[3], 0, 0, 0);
    break;
  case 17:
    syscall(__NR_recvmsg, r[3], 0, 0x109df2e797f0cd47);
    break;
  case 18:
    syscall(__NR_ioctl, r[4], 0x6430, 0);
    break;
  case 19:
  ...
  case 21:
    ...
    break;
  case 22:
    syscall(__NR_ioctl, r[5], 0x4010aeab, 0);
    break;
  case 23:
    syscall(__NR_ioctl, r[5], 0x4008af04, 0);
    break;
  case 24:
    syscall(__NR_setsockopt, r[3], 0x84, 0xb, 0, 0);
    break;
  case 25:
    syscall(__NR_recvmmsg, r[3], 0, 0, 0, 0);
    break;
  case 26:
