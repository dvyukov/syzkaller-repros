...
// https://syzkaller.appspot.com/bug?id=be889269e2b87ab34afb
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_socket, 0xaul, 1ul, 0x106);
    break;
  case 3:
  ...
  case 5:
    ...
    *(uint32_t*)0x200000d8 = 0;
    syscall(__NR_sendto, r[0], 0ul, 0ul, 0x24004044ul, 0x200000c0ul, 0x1cul);
    break;
  }
}
int main(void)
