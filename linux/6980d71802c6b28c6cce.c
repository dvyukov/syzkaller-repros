...
// https://syzkaller.appspot.com/bug?id=6980d71802c6b28c6cce
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000040, "/dev/net/tun\000", 13));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000040ul, 0xc1702ul,
                  0ul);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    ...
    NONFAILING(*(uint16_t*)0x20000110 = 0xa732);
  ...
  case 3:
    ...
    NONFAILING(*(uint32_t*)0x20000014 = htobe32(0));
