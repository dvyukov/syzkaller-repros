// KMSAN: uninit-value in sha256_generic_block_fn
// https://syzkaller.appspot.com/bug?id=3444c8fdf6bb26ae8ace6a9a0cc33dc5730686a4
// status:invalid
...
void loop()
{
  ...
  if (res != -1)
    r[0] = res;
  *(uint16_t*)0x2010ffa8 = 0x26;
  memcpy((void*)0x2010ffaa,
         "\x68\x61\x73\x68\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", 14);
  *(uint32_t*)0x2010ffb8 = 0;
  *(uint32_t*)0x2010ffbc = 0;
  memcpy((void*)0x2010ffc0,
         "\x73\x68\x61\x32\x35\x36\x2d\x67\x65\x6e\x65\x72\x69\x63\x00\x00\x00"
         "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
         "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
         "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
         64);
  syscall(__NR_bind, r[0], 0x2010ffa8, 0x58);
