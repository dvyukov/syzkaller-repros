...
// https://syzkaller.appspot.com/bug?id=676530ea9d4736aad21c
// status:0
...
void loop(void)
{
  ...
  *(uint16_t*)0x20000204 = 0xad;
  memset((void*)0x20000206, 170, 5);
  *(uint8_t*)0x2000020b = 0x10;
  *(uint8_t*)0x2000020c = 1;
  *(uint8_t*)0x2000020d = 0x20;
  *(uint8_t*)0x2000020e = 3;
  *(uint16_t*)0x2000020f = 0xbc;
  *(uint16_t*)0x20000211 = 9;
