...
// https://syzkaller.appspot.com/bug?id=60ff874c7b251129e028c90b5d4926c5b3fccbe2
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000340, "/dev/kvm\000", 9));
  ...
  case 2:
    ...
    syscall(__NR_ioctl, r[1], 0x1000008912, 0x20000000);
    break;
  case 3:
  ...
  case 4:
    ...
    NONFAILING(
        memcpy((void*)0x20000080,
               "\xf2\xa6\xba\xd0\x04\xb0\x0f\xee\x0f\x09\x0f\x30\x36\xf3\x0f"
               "\x1a\x97\x00\x00\x66\x0f\x38\x06\x58\x1e\x0f\x08\xba\xd0\x04"
               "\xb0\xbe\xee\xf3\x0f\x2a\xf8\xba\xa1\x00\xb0\x00\xee",
               43));
    NONFAILING(*(uint64_t*)0x200000d0 = 0x2b);
    syz_kvm_setup_cpu(-1, -1, 0x2000a000, 0x200000c0, 1, 0, 0, 0);
    break;
  case 5:
    syscall(__NR_ioctl, r[2], 0xae60, 0);
    break;
  case 6:
  ...
  case 8:
    ...
    syscall(__NR_getsockopt, -1, 1, 0x11, 0x20000000, 0x20000040);
    break;
  case 9:
    ...
    NONFAILING(*(uint64_t*)0x20000230 = 0x4cb);
    ...
    syscall(__NR_ioctl, r[3], 0x4090ae82, 0x20000200);
    break;
  case 10:
