// KASAN: slab-out-of-bounds Read in __icmp_send
// https://syzkaller.appspot.com/bug?id=ee7cf202a47281cda2e5a76bd1ba0683a10c2a65
// status:invalid
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    syscall(__NR_bind, -1, 0x20000000, 0xfffffffffffffe78);
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x20001740 = 4);
    syscall(__NR_getsockopt, -1, 0x84, 0xc, 0x20001700, 0x20001740);
    break;
  case 2:
    syscall(__NR_setsockopt, -1, 0x112, 0xb, 0, 0);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000080, "./cgroup.net/syz0\000", 18));
    syscall(__NR_mkdirat, 0xffffffffffffff9c, 0x20000080, 0x1ff);
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000100, "./cgroup.cpu/syz0\000", 18));
    syscall(__NR_openat, 0xffffffffffffff9c, 0x20000100, 0x200002, 0);
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20000140,
                      "\x2b\x4c\xbe\x4f\x39\x15\x28\x2c\xe6\xaa\x07\x69\xa3\x57"
                      "\xf4\x85\x84\x2e\xe5\x5a\x14\x09\x0a\x92\xaf\xe4\xc2\x8f"
                      "\xed\xcb\x02\xbd\xed\x6e\x07\x59\xd0\xdf\xe6\x15\x2a",
                      41));
    syscall(__NR_sendto, -1, 0x20000140, 0x29, 0x4000, 0, 0);
    break;
  case 6:
  ...
  case 8:
    ...
    break;
  case 9:
    NONFAILING(*(uint16_t*)0x200001c0 = 2);
    NONFAILING(*(uint16_t*)0x200001c2 = htobe16(0x4e20));
    NONFAILING(*(uint8_t*)0x200001c4 = 0xac);
    NONFAILING(*(uint8_t*)0x200001c5 = 0x14);
    NONFAILING(*(uint8_t*)0x200001c6 = 0x14);
    NONFAILING(*(uint8_t*)0x200001c7 = 0xbb);
    syscall(__NR_bind, -1, 0x200001c0, 0x10);
    break;
  case 10:
  ...
  case 11:
    ...
    NONFAILING(*(uint64_t*)0x20000208 = 0x20000280);
    NONFAILING(
        memcpy((void*)0x20000280,
               "\x12\xc2\xbd\xbd\xef\x38\x37\x52\xac\x64\x0e\xce\x18\x00\x00"
               "\x00\x00\x00\x00\x00\x00\x00\x3d\xb3\x18\x33\x09\x94\x00\x00"
               "\x00\x40\x78\x4e\xcc\xa0\x00\x00\x00\x00\x00\x00",
               42));
  ...
  case 12:
    ...
    break;
  case 13:
    syscall(__NR_setsockopt, -1, 0, 0x25, 0, 0);
    break;
  case 14:
    syscall(__NR_sendto, r[2], 0, 0, 0x200408d4, 0, 0);
    break;
  case 15:
  ...
  case 16:
    ...
    break;
  case 17:
    syscall(__NR_write, -1, 0, 0xfffffffffffffef9);
    break;
  case 18:
    syscall(__NR_pipe, 0);
    break;
  case 19:
    syscall(__NR_writev, -1, 0, 0xffffffffffffffe9);
    break;
  case 20:
    ...
    NONFAILING(*(uint8_t*)0x200000c9 = 2);
    ...
    NONFAILING(*(uint16_t*)0x200000dc = 2);
    NONFAILING(*(uint16_t*)0x200000de = htobe16(0x4e21));
    NONFAILING(*(uint8_t*)0x200000e0 = 0xac);
    NONFAILING(*(uint8_t*)0x200000e1 = 0x14);
    NONFAILING(*(uint8_t*)0x200000e2 = 0x14);
    NONFAILING(*(uint8_t*)0x200000e3 = 0xaa);
    NONFAILING(*(uint16_t*)0x200000ec = 2);
    NONFAILING(*(uint16_t*)0x200000ee = htobe16(0x4e20));
    NONFAILING(*(uint32_t*)0x200000f0 = htobe32(0xe0000002));
    NONFAILING(*(uint16_t*)0x200000fc = 2);
    NONFAILING(*(uint16_t*)0x200000fe = htobe16(0x4e20));
    NONFAILING(*(uint8_t*)0x20000100 = 0xac);
    NONFAILING(*(uint8_t*)0x20000101 = 0x14);
    NONFAILING(*(uint8_t*)0x20000102 = 0x14);
    NONFAILING(*(uint8_t*)0x20000103 = 0x21);
    NONFAILING(*(uint16_t*)0x2000010c = 0xa);
    NONFAILING(*(uint16_t*)0x2000010e = htobe16(0x4e24));
    NONFAILING(*(uint32_t*)0x20000110 = htobe32(2));
    ...
    NONFAILING(*(uint32_t*)0x20000124 = 8);
    NONFAILING(*(uint16_t*)0x20000128 = 2);
    NONFAILING(*(uint16_t*)0x2000012a = htobe16(0x4e23));
    NONFAILING(*(uint8_t*)0x2000012c = 0xac);
    NONFAILING(*(uint8_t*)0x2000012d = 0x14);
    NONFAILING(*(uint8_t*)0x2000012e = 0x14);
    NONFAILING(*(uint8_t*)0x2000012f = 0xbb);
    NONFAILING(*(uint16_t*)0x20000138 = 2);
    NONFAILING(*(uint16_t*)0x2000013a = htobe16(0x4e23));
    NONFAILING(*(uint32_t*)0x2000013c = htobe32(0));
    syscall(__NR_setsockopt, -1, 0x84, 0x6e, 0x200000c0, 0x88);
    break;
  case 21:
    syscall(__NR_setsockopt, -1, 0, 0, 0, 0);
    break;
  case 22:
    syscall(__NR_ioctl, -1, 0x80487436, 0);
    break;
  case 23:
    syscall(__NR_setsockopt, -1, 1, 0x1a, 0, 0);
    break;
  case 24:
    NONFAILING(memcpy((void*)0x20000040, "\x17", 1));
    syscall(__NR_sendto, r[2], 0x20000040, 1, 4, 0, 0);
    break;
  case 25:
    syscall(__NR_poll, 0, 0, 0x200);
    break;
  case 26:
    syscall(__NR_socket, 0x10, 0x80002, 0xc);
    break;
  case 27:
  ...
  case 28:
    ...
    NONFAILING(*(uint64_t*)0x20000160 = 0x20000100);
    NONFAILING(*(uint64_t*)0x20000168 = 0);
    NONFAILING(*(uint32_t*)0x20000170 = 0);
    syscall(__NR_sendmmsg, -1, 0x20000140, 0x492492492492805, 0);
    break;
  case 29:
  ...
  case 30:
    ...
    break;
  case 31:
    syscall(__NR_socket, 0x10, 0x800000000080002, 0);
    break;
  case 32:
    syscall(__NR_socket, 2, 0, 0x84);
    break;
  case 33:
  ...
  case 38:
    ...
    break;
  case 39:
    syscall(__NR_write, -1, 0x20000040, 0x7c774aac);
    break;
  case 40:
    syscall(__NR_mmap, 0x20000000, 0x3000, 2, 0x11, -1, 0);
    break;
  case 41:
    syscall(__NR_ioctl, r[4], 0x1000008912, 0);
    break;
  case 42:
    NONFAILING(*(uint64_t*)0x200000c0 = 0);
    NONFAILING(*(uint32_t*)0x200000c8 = 0);
    ...
    break;
  case 43:
    syscall(__NR_recvfrom, -1, 0, 0, 0, 0, 0);
    break;
  case 44:
    syscall(__NR_accept4, -1, 0, 0, 0);
    break;
  }
}
int main(void)
