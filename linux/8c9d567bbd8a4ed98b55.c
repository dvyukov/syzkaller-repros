// WARNING in i2cdev_detach_adapter
// https://syzkaller.appspot.com/bug?id=8c9d567bbd8a4ed98b55
// status:0
...
void loop(void)
{
  ...
  NONFAILING(*(uint8_t*)0x20000044 = 0xba);
  NONFAILING(*(uint8_t*)0x20000045 = 0xd4);
  NONFAILING(*(uint8_t*)0x20000046 = 4);
  NONFAILING(*(uint8_t*)0x20000047 = 0x40);
  NONFAILING(*(uint16_t*)0x20000048 = 0xccd);
  NONFAILING(*(uint16_t*)0x2000004a = 0x39);
  NONFAILING(*(uint16_t*)0x2000004c = 0x842);
  ...
  NONFAILING(*(uint8_t*)0x20000060 = 0x99);
  NONFAILING(*(uint8_t*)0x20000061 = 0x56);
  NONFAILING(*(uint8_t*)0x20000062 = 0xb6);
  NONFAILING(*(uint8_t*)0x20000063 = 0);
  NONFAILING(syz_usb_connect(0, 0x24, 0x20000040, 0));
  close_fds();
}
int main(void)
{
