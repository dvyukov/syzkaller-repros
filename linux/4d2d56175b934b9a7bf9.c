...
// https://syzkaller.appspot.com/bug?id=4d2d56175b934b9a7bf9
// status:0
...
int main(void)
{
  ...
  *(uint16_t*)0x20000282 = 0x4e00;
  *(uint16_t*)0x20000284 = 0xa;
  *(uint16_t*)0x20000286 = 0x4e00;
  memcpy((void*)0x20000288, "\x15\x11\xe1\x1d\xbc\x29\x5c\x5e\x87\xe2", 10);
  *(uint16_t*)0x20000294 = 0;
  *(uint16_t*)0x20000296 = 0x4e00;
  *(uint16_t*)0x20000298 = 0;
  *(uint16_t*)0x2000029a = 0x4e00;
  *(uint16_t*)0x2000029c = 0;
  *(uint16_t*)0x2000029e = 0x4e00;
  *(uint16_t*)0x200002a0 = 0;
  *(uint16_t*)0x200002a2 = 0x4e00;
  syz_usb_ep_write(r[0], 0x82, 0x24, 0x20000280);
  return 0;
}
