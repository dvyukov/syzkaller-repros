...
// https://syzkaller.appspot.com/bug?id=01321b15cc98e6bf96d6
// status:6
...
{
  intptr_t res = 0;
  NONFAILING(memcpy((void*)0x20000000, "keyring\000", 8));
  NONFAILING(memcpy((void*)0x20000040, "syz", 3));
  NONFAILING(*(uint8_t*)0x20000043 = 0x23 + procid * 4);
  NONFAILING(*(uint8_t*)0x20000044 = 0);
  res = syscall(__NR_add_key, 0x20000000ul, 0x20000040ul, 0ul, 0ul, 0xfffffffb);
  if (res != -1)
    r[0] = res;
  syscall(__NR_keyctl, 9ul, 0, r[0], 0, 0);
}
int main(void)
{
