...
// https://syzkaller.appspot.com/bug?id=c43e2785bc2cc144ca70
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_ioctl, r[0], 0x5423, 0ul);
    break;
  case 2:
  ...
  case 4:
    ...
    *(uint64_t*)0x20000144 = 0;
    syscall(__NR_epoll_ctl, r[2], 1ul, r[0], 0x20000140ul);
    break;
  case 5:
  ...
  case 6:
    ...
    *(uint64_t*)0x20000384 = 0;
    syscall(__NR_epoll_ctl, r[1], 1ul, r[3], 0x20000380ul);
    break;
  }
}
int main(void)
