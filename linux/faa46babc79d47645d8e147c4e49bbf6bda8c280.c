...
// https://syzkaller.appspot.com/bug?id=faa46babc79d47645d8e147c4e49bbf6bda8c280
// status:open
...
void execute_one(void)
{
  ...
  memcpy((void*)0x20000040, "/dev/radio#\000", 12);
  ...
  *(uint8_t*)0x200001ce = 0x3d;
  sprintf((char*)0x200001cf, "0x%016llx", (long long)r[1]);
  ...
  *(uint8_t*)0x200001fb = 0;
  syscall(__NR_mount, 0, 0x20000480, 0x200000c0, 0, 0x200001c0);
}
int main(void)
{
