...
{
  intptr_t res = 0;
  NONFAILING(memcpy((void*)0x20000240, "/dev/sg#\000", 9));
  res = syz_open_dev(0x20000240, 0, 5);
  if (res != -1)
    r[0] = res;
  res = syscall(__NR_dup2, r[0], r[0]);
  if (res != -1)
    r[1] = res;
  NONFAILING(memcpy((void*)0x20000680, "\x6b\x00\x00\x00\x7d\x00\x05\x00\x00"
                                       "\x64\x00\x00\x00\xf9\x87\x00\x00\x00"
                                       "\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                                       "\x00\x00\x00\x00\x00\x00\x08\x00\x00"
                                       "\x00\x00\x00\x00\x00\x00\x00",
                    43));
  syscall(__NR_write, r[1], 0x20000680, 0x2b);
}
int main(void)
{
