...
// https://syzkaller.appspot.com/bug?id=8b84383d8849f332cac01bd2ae810861001db886
// status:fixed
...
void loop()
{
  ...
  *(uint8_t*)0x20000540 = 0x73;
  *(uint8_t*)0x20000541 = 0x79;
  *(uint8_t*)0x20000542 = 0x7a;
  *(uint8_t*)0x20000543 = 0x21;
  *(uint8_t*)0x20000544 = 0;
  res = syscall(__NR_add_key, 0x20000400, 0x20000540, 0, 0, r[0]);
  if (res != -1)
    r[1] = res;
  ...
  *(uint8_t*)0x20752ffe = 0x21;
  *(uint8_t*)0x20752fff = 0;
  memcpy((void*)0x20000000, "\xb3", 1);
  res = syscall(__NR_add_key, 0x20fc0ffb, 0x20752ffb, 0x20000000, 1, r[2]);
  if (res != -1)
    r[4] = res;
  ...
  *(uint64_t*)0x20c61fc8 = 0x200002c0;
  memcpy((void*)0x200002c0,
         "\x77\x70\x33\x38\x34\x2d\x67\x65\x6e\x65\x72\x69\x63\x00\x00\x00\x00"
  ...
  *(uint32_t*)0x20c61ff8 = 0;
  syscall(__NR_keyctl, 0x17, 0x20000040, 0x20000300, 0xfb, 0x20c61fc8);
}
