...
// https://syzkaller.appspot.com/bug?id=48a2d3f5d7c977bc22d7
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    memcpy((void*)0x20000000,
           "\x12\x01\x00\x00\x75\x16\xb7\x10\x8c\x0d\x0e\x00\x8f\xb6\x01\x02"
           "\x03\x01\x09\x02\x1b\x00\x01\x00\x00\x00\x00\x09\x04\x00\x00\x01"
           "\x03\x00\x00\x00\x09\x05\x84",
           39);
    memset((void*)0x20000027, 203, 1);
    res = -1;
  ...
  case 3:
    ...
    break;
  case 4:
    *(uint8_t*)0x20000180 = 0x1b;
    *(uint8_t*)0x20000181 = 0x9b;
    *(uint8_t*)0x20000182 = 7;
    ...
    *(uint64_t*)0x200001a0 = 0x40;
    *(uint64_t*)0x200001a8 = 0;
    *(uint32_t*)0x200001b0 = 0;
    *(uint16_t*)0x200001b4 = 0;
    *(uint16_t*)0x200001b6 = 0x38;
    ...
    *(uint64_t*)0x200001f0 = 0;
    syscall(__NR_write, r[1], 0x20000180ul, 0x78ul);
    break;
  }
}
int main(void)
