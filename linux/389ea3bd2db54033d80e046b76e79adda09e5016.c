...
void* thr(void* arg)
{
  switch ((long)arg) {
  case 0:
    r[0] = syscall(__NR_mmap, 0x20000000ul, 0xfb1000ul, 0x3ul, 0x32ul,
                   0xfffffffffffffffful, 0x0ul);
    break;
  case 1:
    memcpy((void*)0x20099ff7, "\x2f\x64\x65\x76\x2f\x6b\x76\x6d\x00",
           9);
    r[2] = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20099ff7ul,
                   0x2000000800ul, 0x0ul);
    break;
  case 2:
  ...
  case 3:
    ...
    break;
  case 4:
    *(uint64_t*)0x20af0000 = (uint64_t)0x20;
    *(uint64_t*)0x20af0008 = (uint64_t)0x20af0f99;
    *(uint64_t*)0x20af0010 = (uint64_t)0x67;
    memcpy((void*)0x20af0f99,
           "\xc4\xc1\x7d\x2b\x46\x1a\x66\xba\x20\x00\xec\x66\xb8\xd7"
           "\x00\x19\x19\xc8\x66\xb8\x04\x00\x8e\xe8\xc7\x44\x24\x00"
           "\x00\x90\x00\x00\xc7\x44\x24\x02\xb0\x00\x00\x00\xc7\x44"
           "\x24\x06\x00\x00\x00\x00\x0f\x01\x14\x24\x66\xba\xae\xa0"
           "\x00\x66\xba\x43\x00\x66\xb8\x07\x69\x66\xef\x60\x0f\xe1"
           "\x25\xc3\xf4\x25\xc3\xf4\x35\x10\x96\x00\x02\x0f\x23\xf8"
           "\xf6\x77\x46\x66\xba\xa0\x00\xed\x66\xba\x42\xec\xc4\xe2"
           "\x7d\x2a\xa5\x00\x00",
           103);
    r[9] = syz_kvm_setup_cpu(r[3], 0xfffffffffffffffful, 0x2054b000ul,
                             0x20af0000ul, 0x1ul, 0x0ul, 0x20aed000ul,
                             0x0ul);
    break;
  case 5:
    r[10] = syscall(__NR_ioctl, r[4], 0xae80ul, 0x0ul);
    break;
  case 6:
    *(uint32_t*)0x20a52000 = (uint32_t)0x1;
    *(uint32_t*)0x20a52004 = (uint32_t)0x3ff;
    *(uint32_t*)0x20a52008 = (uint32_t)0x9;
    *(uint32_t*)0x20a5200c = (uint32_t)0x1;
    *(uint32_t*)0x20a52010 = (uint32_t)0x5;
    *(uint32_t*)0x20a52014 = (uint32_t)0x9;
    r[17] = syscall(__NR_ioctl, 0xfffffffffffffffful, 0x401845c0ul,
                    0x20a52000ul);
    break;
  }
  return 0;
