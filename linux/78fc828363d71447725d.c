...
// https://syzkaller.appspot.com/bug?id=78fc828363d71447725d
// status:6
...
void loop(void)
{
  ...
  *(uint64_t*)0x20000218 = 0x20010100;
  memcpy((void*)0x20010100, "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                            "\x82\xe3\x67\x24\xc6\xf3\x4c\xaa\x84\x6e\xd2\xe5"
                            "\x27\x70\x33\x78\x01\x00\x40\x00\x0c\x00\x00\x00"
                            "\x00\x00\x00\x00\xda\xf4\x65\x5f\x00\x00\x00\x00"
                            "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
         58);
  *(uint64_t*)0x20000220 = 0x3a;
  *(uint64_t*)0x20000228 = 0x4e0;
  *(uint64_t*)0x20000230 = 0x20000080;
  memcpy((void*)0x20000080, "\x03\x00\x00\x00\x04\x00\x00\x00\x00", 9);
  ...
  *(uint64_t*)0x20000278 = 0x20012600;
  memcpy((void*)0x20012600,
         "\xed\x41\x00\x00\x00\x10\x00\x00\xda\xf4\x65\x5f\xdb\xf4\x65\x5f\xdb"
         ...
         "\x00\x00\x00\x00\x00\x01\x00\x00\x00\x10\x00",
         62);
  *(uint64_t*)0x20000280 = 0x3e;
  *(uint64_t*)0x20000288 = 0x4400;
  *(uint64_t*)0x20000290 = 0;
  *(uint64_t*)0x20000298 = 0;
  *(uint64_t*)0x200002a0 = 0x4480;
  *(uint64_t*)0x200002a8 = 0x20012800;
  memcpy((void*)0x20012800,
         ...
         "\x00\x00\x00\x00\x00\x02\x00\x00\x00\x30\x00",
         62);
  ...
  *(uint64_t*)0x20000390 = 0x31000;
  *(uint64_t*)0x20000398 = 0x20000400;
  memcpy((void*)0x20000400,
         "\x27\x19\xc0\xd9\x01\x00\x00\x00\x80\x3a\x09\x00\x80\x3a\x09\x00\x00"
         "\x00\x00\x00\x06\x00\x71\x10\xf4\x4d\x87\x85\xc2\x96\xf0\xb9\xb0\x7b"
         "\x44\x68\x90\x1f\xd2\x5d\x0f\x9a\xe1\x37\x64\xa0\x2c\x0c\x84\x88\x41"
         "\x84\x77\xcd\x05\x39\x01\xff\x4b\xaf\xaf\x95\x04\x45\x6b\xa4\x67\x4f"
         "\xc2\x06\x3b\x70\xad\xde\x9d\x4a\x98\x21\x09\x74\xd5\x45\xac\xa3\xaf"
         "\xdd\x0b\xe3\x3e\xe8\x8f\x19\x40\x31\x5f\x9d\xac\x0c\xf7\xc1\xce\xf6"
         "\xc4\x63\x89\x3c\x7c\x2b\x85\xa1\xe7\x37\x27\xd8\xb0\x9a\xe2\x1e\xf8"
         "\x13\x9c\xbe\xd3\x23\x3f\x30\x77\x83\x6c\xc1\x6a\x8e\xae\x05\x75\xaf"
         "\x43\x23\x63\x88\x94\x07\x55\x1d\x05\x59\xfa\x2e\x97\x66\xd9\xc5\x16"
         "\x74\x9b\x53\x7b\x3e\x7b\x1e\xa8\x99\xa2\xb3\x2a\x78\x47\x7f\xb4\x6a"
         "\x5e\xba\x64\xc8\xee\x7a\x7b\x9a\xf3\x17\x7a\x42\x76\x87\x89\x65\xbc",
         187);
  *(uint64_t*)0x200003a0 = 0xbb;
  *(uint64_t*)0x200003a8 = 0x40000;
  *(uint64_t*)0x200003b0 = 0;
  *(uint64_t*)0x200003b8 = 0;
  *(uint64_t*)0x200003c0 = 0x40800;
  res = -1;
  res = syz_mount_image(0x20000000, 0x20000100, 0x200000, 0x13, 0x20000200,
                        0x2a08004, 0x200000c0);
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x20000040, ".pending_reads\000", 15);
  syscall(__NR_openat, r[0], 0x20000040ul, 0xc0ul, 0ul);
}
int main(void)
{
