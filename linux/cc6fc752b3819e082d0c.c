...
// https://syzkaller.appspot.com/bug?id=cc6fc752b3819e082d0c
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_ioctl, r[0], 0x40305829, 0);
    break;
  case 2:
  ...
  case 7:
    ...
    res = syscall(__NR_write, r[2], 0x20000080ul, 0x20ul);
    if (res != -1)
      NONFAILING(r[3] = *(uint32_t*)0x20000000);
    break;
  case 8:
  ...
  case 9:
    ...
    NONFAILING(*(uint32_t*)0x200000d0 = r[3]);
    NONFAILING(*(uint32_t*)0x200000d4 = 0);
    syscall(__NR_write, r[2], 0x200000c0ul, 0x18ul);
    break;
  case 10:
    NONFAILING(memcpy((void*)0x20000180, "/dev/infiniband/rdma_cm\000", 24));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000180ul, 2ul, 0ul);
  ...
  case 11:
    ...
    NONFAILING(*(uint8_t*)0x2000009e = 0);
    NONFAILING(*(uint8_t*)0x2000009f = 0);
    res = syscall(__NR_write, r[4], 0x20000080ul, 0x20ul);
    if (res != -1)
      NONFAILING(r[5] = *(uint32_t*)0x20000000);
    break;
  case 12:
  ...
  case 13:
    ...
    NONFAILING(*(uint16_t*)0x200000c6 = 0xfa00);
    NONFAILING(*(uint64_t*)0x200000c8 = 0);
    NONFAILING(*(uint32_t*)0x200000d0 = r[5]);
    NONFAILING(*(uint32_t*)0x200000d4 = 0);
    syscall(__NR_write, r[4], 0x200000c0ul, 0x18ul);
    break;
  case 14:
    ...
    NONFAILING(*(uint16_t*)0x20000086 = 0xfa00);
    NONFAILING(*(uint64_t*)0x20000088 = 0);
    NONFAILING(*(uint32_t*)0x20000090 = r[3]);
    NONFAILING(*(uint32_t*)0x20000094 = r[4]);
