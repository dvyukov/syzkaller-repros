...
int main(void)
{
  ...
  *(uint64_t*)0x200001d4 = 0x20000140;
  *(uint8_t*)0x20000140 = 0;
  *(uint8_t*)0x20000141 = 0x22;
  *(uint32_t*)0x20000142 = 0x22;
  STORE_BY_BITMASK(uint8_t, , 0x20000146, 2, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000146, 1, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000146, 5, 4, 4);
  memcpy((void*)0x20000147, "\xa3\x13", 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000149, 1, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000149, 1, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000149, 9, 4, 4);
  memcpy((void*)0x2000014a, "\xee", 1);
  STORE_BY_BITMASK(uint8_t, , 0x2000014b, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000014b, 1, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000014b, 0, 4, 4);
  memcpy((void*)0x2000014c, "\x7f\xe5\x28\x45", 4);
  STORE_BY_BITMASK(uint8_t, , 0x20000150, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000150, 2, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000150, 0, 4, 4);
  memcpy((void*)0x20000151, "\x8c\x0a\x56\xe4", 4);
  STORE_BY_BITMASK(uint8_t, , 0x20000155, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000155, 0, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000155, 9, 4, 4);
  memcpy((void*)0x20000156, "\x18\xed\x6d\x12", 4);
  STORE_BY_BITMASK(uint8_t, , 0x2000015a, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000015a, 2, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000015a, 0, 4, 4);
  memcpy((void*)0x2000015b, "\x87\x94\xf1\x01", 4);
  STORE_BY_BITMASK(uint8_t, , 0x2000015f, 2, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000015f, 2, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000015f, 0, 4, 4);
  memcpy((void*)0x20000160, "\xf4\x34", 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000162, 0, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000162, 2, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000162, 0xe, 4, 4);
  STORE_BY_BITMASK(uint8_t, , 0x20000163, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000163, 0, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000163, 0, 4, 4);
  memcpy((void*)0x20000164, "\x9f\x5d\x2d\x3f", 4);
