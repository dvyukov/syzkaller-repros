...
// https://syzkaller.appspot.com/bug?id=70b090638bce35fc29b3
// status:6
...
void execute_call(int call)
{
  ...
  case 5:
    ...
    syscall(__NR_epoll_ctl, r[2], 1ul, r[0], 0x20000000ul);
    break;
  case 6:
    syscall(__NR_epoll_ctl, r[2], 1ul, r[1], 0ul);
    break;
  case 7:
    res = syscall(__NR_epoll_create1, 0ul);
    if (res != -1)
    ...
    break;
  case 8:
    syscall(__NR_pwritev2, r[2], 0ul, 0ul, 0, 5, 0x15ul);
    break;
  case 9:
    NONFAILING(*(uint32_t*)0x20000040 = 0);
    NONFAILING(*(uint64_t*)0x20000044 = 0);
    syscall(__NR_epoll_ctl, r[3], 1ul, r[2], 0x20000040ul);
    break;
  }
}
int main(void)
