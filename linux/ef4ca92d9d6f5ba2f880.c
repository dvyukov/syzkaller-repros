...
// https://syzkaller.appspot.com/bug?id=ef4ca92d9d6f5ba2f880
// status:0
...
void loop(void)
{
  ...
  NONFAILING(*(uint16_t*)0x20000100 = 0x11);
  NONFAILING(*(uint16_t*)0x20000102 = htobe16(0));
  NONFAILING(*(uint32_t*)0x20000104 = r[2]);
  NONFAILING(*(uint16_t*)0x20000108 = 1);
  NONFAILING(*(uint8_t*)0x2000010a = 0);
  NONFAILING(*(uint8_t*)0x2000010b = 6);
  NONFAILING(*(uint8_t*)0x2000010c = 0xaa);
  NONFAILING(*(uint8_t*)0x2000010d = 0xaa);
  NONFAILING(*(uint8_t*)0x2000010e = 0xaa);
  NONFAILING(*(uint8_t*)0x2000010f = 0xaa);
  NONFAILING(*(uint8_t*)0x20000110 = 0xaa);
  NONFAILING(*(uint8_t*)0x20000111 = 0xaa);
  NONFAILING(*(uint8_t*)0x20000112 = 0);
  NONFAILING(*(uint8_t*)0x20000113 = 0);
  syscall(__NR_bind, r[0], 0x20000100ul, 0x14ul);
  NONFAILING(memcpy((void*)0x20000000, "\x3d\x0d\x5f\x24\x72\x99\xe9\x66\x10"
                                       "\x50\x09\x32\x60\x00\x00\x00\x00\x00"
                                       "\xee",
                    19));
  syscall(__NR_sendto, r[0], 0x20000000ul, 0x13ul, 0x11ul, 0ul, 0ul);
}
int main(void)
{
