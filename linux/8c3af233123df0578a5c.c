...
// https://syzkaller.appspot.com/bug?id=8c3af233123df0578a5c
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000128, 4, 31, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000128, 0, 32, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000128, 0x402, 33, 1));
  ...
  case 2:
    ...
    NONFAILING(memset((void*)0x20000089, 0, 8));
    syscall(__NR_ioctl, r[0], 0x5406, 0x20000080ul);
    break;
  case 3:
    syscall(__NR_setresuid, 0xee01, 0xee00, 0);
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x200001c0 = 0);
    NONFAILING(*(uint32_t*)0x200001c4 = 0x80);
    NONFAILING(*(uint8_t*)0x200001c8 = 0x29);
    NONFAILING(*(uint8_t*)0x200001c9 = 0);
    NONFAILING(*(uint8_t*)0x200001ca = -1);
    NONFAILING(*(uint8_t*)0x200001cb = 0);
    NONFAILING(*(uint32_t*)0x200001cc = 0);
    NONFAILING(*(uint64_t*)0x200001d0 = 0);
    NONFAILING(*(uint64_t*)0x200001d8 = 0x84802);
    NONFAILING(*(uint64_t*)0x200001e0 = 5);
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 0, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 1, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 2, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 1, 3, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 4, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 5, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 1, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 7, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 8, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 9, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 1, 10, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 1, 11, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 12, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 1, 13, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 14, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 1, 15, 2));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 17, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 1, 18, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 19, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 20, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 21, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 22, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 23, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 24, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 25, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 26, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 27, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 28, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 29, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 30, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 1, 31, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 32, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 1, 33, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 1, 34, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 35, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 36, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 37, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 38, 26));
    NONFAILING(*(uint32_t*)0x200001f0 = 0);
    NONFAILING(*(uint32_t*)0x200001f4 = 0);
    NONFAILING(*(uint64_t*)0x200001f8 = 4);
    NONFAILING(*(uint64_t*)0x20000200 = 0);
    NONFAILING(*(uint64_t*)0x20000208 = 0x41009);
    NONFAILING(*(uint64_t*)0x20000210 = 0xfffffffffffefffe);
    NONFAILING(*(uint32_t*)0x20000218 = 0x8000);
    NONFAILING(*(uint32_t*)0x2000021c = 0);
    NONFAILING(*(uint64_t*)0x20000220 = 0x200);
    NONFAILING(*(uint32_t*)0x20000228 = 6);
    NONFAILING(*(uint16_t*)0x2000022c = 0x8000);
    NONFAILING(*(uint16_t*)0x2000022e = 0);
    NONFAILING(*(uint32_t*)0x20000230 = 0x40000000);
    NONFAILING(*(uint32_t*)0x20000234 = 0);
    NONFAILING(*(uint64_t*)0x20000238 = 0);
    syscall(__NR_perf_event_open, 0x200001c0ul, 0, 8ul, -1, 0xbul);
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20000040, "/dev/ptp0\000", 10));
    syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000040ul, 0x341802ul, 0ul);
    break;
  }
}
int main(void)
