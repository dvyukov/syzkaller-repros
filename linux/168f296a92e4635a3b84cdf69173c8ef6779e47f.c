...
// https://syzkaller.appspot.com/bug?id=168f296a92e4635a3b84cdf69173c8ef6779e47f
// status:fixed
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    res = syscall(__NR_socket, 0x10, 3, 0x200000000000004);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0, 0x402000, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 2:
    syscall(__NR_getsockopt, r[1], 0x84, 4, 0, 0);
    break;
  case 3:
    res = syscall(__NR_socket, 0xa, 0x801, 0x84);
    if (res != -1)
      r[2] = res;
    break;
  case 4:
    NONFAILING(*(uint16_t*)0x20001200 = 2);
    NONFAILING(*(uint16_t*)0x20001202 = htobe16(1));
    NONFAILING(*(uint8_t*)0x20001204 = 0xac);
    NONFAILING(*(uint8_t*)0x20001205 = 0x14);
    NONFAILING(*(uint8_t*)0x20001206 = -1);
    NONFAILING(*(uint8_t*)0x20001207 = 0xbb);
    syscall(__NR_connect, r[2], 0x20001200, 0x10);
    break;
  case 5:
    syscall(__NR_setsockopt, -1, 0x84, 0x21, 0, 0);
    break;
  case 6:
    syscall(__NR_getsockname, r[0], 0, 0);
    break;
  case 7:
  ...
  case 8:
    ...
    break;
  case 9:
    syscall(__NR_setsockopt, r[2], 0, 0x48b, 0, 0);
    break;
  case 10:
    syscall(__NR_listen, r[2], 0xfc0001);
    break;
  case 11:
    res = syscall(__NR_accept4, r[2], 0, 0, 0);
    if (res != -1)
      r[4] = res;
    break;
  case 12:
    syscall(__NR_ioctl, r[1], 0x4008ae61, 0);
    break;
  case 13:
    ...
    break;
  case 14:
    syscall(__NR_getsockopt, r[1], 0x84, 0x66, 0, 0);
    break;
  case 15:
    syscall(__NR_setsockopt, r[1], 0x84, 0x1f, 0, 0);
    break;
  case 16:
    syscall(__NR_ioctl, -1, 0x4018aee2, 0);
    break;
  case 17:
    syscall(__NR_read, r[3], 0, 0);
    break;
  case 18:
    syscall(__NR_fgetxattr, r[4], 0, 0, 0);
    break;
  case 19:
    syscall(__NR_recvmsg, r[4], 0, 0x109df2e797f0cd47);
    break;
  case 20:
    syscall(__NR_ioctl, r[5], 0x6430, 0);
    break;
  case 21:
  ...
  case 22:
    ...
    break;
  case 23:
    syscall(__NR_setsockopt, -1, 0x84, 0x64, 0, 0);
    break;
  case 24:
    syscall(__NR_ioctl, r[6], 0x4010aeab, 0);
    break;
  case 25:
    syscall(__NR_ioctl, r[6], 0x4008af04, 0);
    break;
  case 26:
    syscall(__NR_setsockopt, r[4], 0x84, 0xb, 0, 0);
    break;
  case 27:
    syscall(__NR_recvmmsg, r[4], 0, 0, 0, 0);
    break;
  case 28:
    NONFAILING(*(uint64_t*)0x20000240 = 0x20000080);
    NONFAILING(
        memcpy((void*)0x20000080,
               "\x48\x00\x00\x00\x14\x00\x19\x0d\x09\x00\x4b\xea\xfd\x0d\x8c"
               "\x56\x0a\x84\x47\x00\x0b\xff\xe0\x06\x4e\x23\x0f\x00\x00\x00"
               "\x00\xa2\xbc\x56\x03\xca\x00\x00\x0f\x7f\x89\x00\x00\x00\x20"
               "\x00\x00\x00\x01\x01\xff\x00\x00\x00\x03\x09\xff\x5b\xff\xff"
               "\x00\xc7\xe5\xed\x5e\x00\x00\x00\x00\x00\x00\x00",
               72));
    NONFAILING(*(uint64_t*)0x20000248 = 0x48);
    syscall(__NR_writev, r[0], 0x20000240, 1);
    break;
  }
}
int main(void)
