...
// https://syzkaller.appspot.com/bug?id=3a17a07ec87869f38e9ead0c0dfce38b3f19bad9
// status:fixed
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint8_t*)0x200000c7 = 0x20);
    NONFAILING(*(uint16_t*)0x200000c8 = 0x525);
    NONFAILING(*(uint16_t*)0x200000ca = 0xa4a1);
    ...
    NONFAILING(*(uint16_t*)0x200000d4 = 0x5c);
    ...
    NONFAILING(*(uint8_t*)0x200000e0 = 2);
    NONFAILING(*(uint8_t*)0x200000e1 = 0xd);
    ...
    NONFAILING(*(uint8_t*)0x200000e6 = 6);
    NONFAILING(*(uint8_t*)0x200000e7 = 0);
    NONFAILING(*(uint8_t*)0x200000e8 = 1);
    NONFAILING(*(uint8_t*)0x200000e9 = 5);
    NONFAILING(*(uint8_t*)0x200000ea = 0x24);
    NONFAILING(*(uint8_t*)0x200000eb = 0);
    NONFAILING(*(uint16_t*)0x200000ec = 0);
    NONFAILING(*(uint8_t*)0x200000ee = 0xd);
    NONFAILING(*(uint8_t*)0x200000ef = 0x24);
    NONFAILING(*(uint8_t*)0x200000f0 = 0xf);
    NONFAILING(*(uint8_t*)0x200000f1 = 1);
    NONFAILING(*(uint32_t*)0x200000f2 = 0);
    NONFAILING(*(uint16_t*)0x200000f6 = 0);
    NONFAILING(*(uint16_t*)0x200000f8 = 0);
    NONFAILING(*(uint8_t*)0x200000fa = 0);
    NONFAILING(*(uint8_t*)0x200000fb = 6);
    NONFAILING(*(uint8_t*)0x200000fc = 0x24);
    NONFAILING(*(uint8_t*)0x200000fd = 0x1a);
    NONFAILING(*(uint16_t*)0x200000fe = 0);
    NONFAILING(*(uint8_t*)0x20000100 = 0xfe);
    NONFAILING(*(uint8_t*)0x20000101 = 9);
    NONFAILING(*(uint8_t*)0x20000102 = 5);
    NONFAILING(*(uint8_t*)0x20000103 = 0x81);
    NONFAILING(*(uint8_t*)0x20000104 = 3);
    NONFAILING(*(uint16_t*)0x20000105 = 0x382);
    NONFAILING(*(uint8_t*)0x20000107 = 0);
    NONFAILING(*(uint8_t*)0x20000108 = 0);
    NONFAILING(*(uint8_t*)0x20000109 = 0);
    NONFAILING(*(uint8_t*)0x2000010a = 9);
    NONFAILING(*(uint8_t*)0x2000010b = 4);
    ...
    NONFAILING(*(uint8_t*)0x20000110 = 0xd);
    NONFAILING(*(uint8_t*)0x20000111 = 0);
    NONFAILING(*(uint8_t*)0x20000112 = 0);
    NONFAILING(*(uint8_t*)0x20000113 = 9);
    NONFAILING(*(uint8_t*)0x20000114 = 4);
    NONFAILING(*(uint8_t*)0x20000115 = 1);
    NONFAILING(*(uint8_t*)0x20000116 = 1);
    NONFAILING(*(uint8_t*)0x20000117 = 2);
    NONFAILING(*(uint8_t*)0x20000118 = 2);
    NONFAILING(*(uint8_t*)0x20000119 = 0xd);
    NONFAILING(*(uint8_t*)0x2000011a = 0);
    NONFAILING(*(uint8_t*)0x2000011b = 0);
    NONFAILING(*(uint8_t*)0x2000011c = 9);
    NONFAILING(*(uint8_t*)0x2000011d = 5);
    NONFAILING(*(uint8_t*)0x2000011e = 0x82);
    NONFAILING(*(uint8_t*)0x2000011f = 2);
    NONFAILING(*(uint16_t*)0x20000120 = 0x1d2);
    NONFAILING(*(uint8_t*)0x20000122 = 0);
    NONFAILING(*(uint8_t*)0x20000123 = 0);
    NONFAILING(*(uint8_t*)0x20000124 = 0);
    NONFAILING(*(uint8_t*)0x20000125 = 9);
    NONFAILING(*(uint8_t*)0x20000126 = 5);
    NONFAILING(*(uint8_t*)0x20000127 = 3);
    NONFAILING(*(uint8_t*)0x20000128 = 2);
    NONFAILING(*(uint16_t*)0x20000129 = 0x380);
    NONFAILING(*(uint8_t*)0x2000012b = 0);
    NONFAILING(*(uint8_t*)0x2000012c = 0);
    NONFAILING(*(uint8_t*)0x2000012d = 0);
    res = syz_usb_connect(0, 0x79, 0x200000c0, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    ...
    break;
  case 2:
    NONFAILING(*(uint32_t*)0x20001500 = 0x44);
    NONFAILING(*(uint64_t*)0x20001504 = 0);
    NONFAILING(*(uint64_t*)0x2000150c = 0);
    NONFAILING(*(uint64_t*)0x20001514 = 0);
    NONFAILING(*(uint64_t*)0x2000151c = 0x20000280);
    NONFAILING(*(uint8_t*)0x20000280 = 0x20);
    NONFAILING(*(uint8_t*)0x20000281 = 0x80);
    NONFAILING(*(uint32_t*)0x20000282 = 0x1c);
    NONFAILING(*(uint16_t*)0x20000286 = 0);
    NONFAILING(*(uint16_t*)0x20000288 = 0);
    NONFAILING(*(uint32_t*)0x2000028a = 0x803);
    NONFAILING(*(uint16_t*)0x2000028e = 0);
    NONFAILING(*(uint16_t*)0x20000290 = 0);
    NONFAILING(*(uint16_t*)0x20000292 = 0);
    NONFAILING(*(uint16_t*)0x20000294 = 0);
    NONFAILING(*(uint32_t*)0x20000296 = 0);
    NONFAILING(*(uint16_t*)0x2000029a = 0);
    NONFAILING(*(uint16_t*)0x2000029c = 0);
    NONFAILING(*(uint16_t*)0x2000029e = 0);
    ...
    syz_usb_control_io(r[0], 0, 0x20001500);
    break;
  case 3:
    syz_usb_control_io(r[0], 0, 0);
    break;
  ...
  case 5:
    ...
    NONFAILING(*(uint64_t*)0x2000018c = 0x20000140);
    NONFAILING(*(uint8_t*)0x20000140 = 0);
    NONFAILING(*(uint8_t*)0x20000141 = 3);
    NONFAILING(*(uint32_t*)0x20000142 = 0x1a);
    NONFAILING(*(uint8_t*)0x20000146 = 0x1a);
    NONFAILING(*(uint8_t*)0x20000147 = 3);
    NONFAILING(*(uint64_t*)0x20000148 = htobe64(0x3400320034003200));
    NONFAILING(*(uint64_t*)0x20000150 = htobe64(0x3400320034003200));
    NONFAILING(*(uint64_t*)0x20000158 = htobe64(0x3400320034003200));
    syz_usb_control_io(r[0], 0x20000180, 0);
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x200009c0 = 0xac);
    NONFAILING(*(uint64_t*)0x200009c4 = 0x20000440);
    NONFAILING(*(uint8_t*)0x20000440 = 0);
    NONFAILING(*(uint8_t*)0x20000441 = 0);
    NONFAILING(*(uint32_t*)0x20000442 = 0);
    ...
    NONFAILING(*(uint64_t*)0x20000a04 = 0);
    NONFAILING(*(uint64_t*)0x20000a0c = 0);
    NONFAILING(*(uint64_t*)0x20000a14 = 0);
    NONFAILING(*(uint64_t*)0x20000a1c = 0);
    NONFAILING(*(uint64_t*)0x20000a24 = 0);
    NONFAILING(*(uint64_t*)0x20000a2c = 0);
    NONFAILING(*(uint64_t*)0x20000a34 = 0);
    NONFAILING(*(uint64_t*)0x20000a3c = 0);
    syz_usb_control_io(r[0], 0, 0x200009c0);
    break;
  }
}
int main(void)
