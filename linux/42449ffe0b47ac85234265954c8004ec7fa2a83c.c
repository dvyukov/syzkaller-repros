...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(*(uint32_t*)0x200003c0 = 0x12);
    NONFAILING(*(uint32_t*)0x200003c4 = 0x3a);
    NONFAILING(*(uint32_t*)0x200003c8 = 4);
    NONFAILING(*(uint32_t*)0x200003cc = 0x400);
    NONFAILING(*(uint32_t*)0x200003d0 = 0);
    NONFAILING(*(uint32_t*)0x200003d4 = 1);
    ...
    syscall(__NR_bpf, 0ul, 0x200003c0ul, 0x3cul);
    break;
  case 1:
    syscall(__NR_socket, 0x21ul, 2ul, 0xaul);
    break;
  case 2:
  ...
  case 3:
    ...
    syscall(__NR_setsockopt, r[0], 6ul, 0x13ul, 0x20000040ul, 4ul);
    break;
  case 4:
    ...
    syscall(__NR_connect, r[0], 0x20000140ul, 0x1cul);
    break;
  case 5:
    ...
    syscall(__NR_bpf, 0ul, 0x20000000ul, 0xfffffffffffffdcbul);
    break;
  case 6:
