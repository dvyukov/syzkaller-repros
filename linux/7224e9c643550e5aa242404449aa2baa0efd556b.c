...
void execute_one(void)
{
  ...
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x20000240, "vcan0\000\000\000\000\000\000\000\000\000\000\000",
         16);
  *(uint32_t*)0x20000250 = 0;
  res = syscall(__NR_ioctl, r[0], 0x8933, 0x20000240);
  if (res != -1)
    r[1] = *(uint32_t*)0x20000250;
  *(uint32_t*)0x20000380 = 0x182;
  syscall(__NR_setsockopt, r[0], 1, 0x25, 0x20000380, 4);
  ...
  *(uint64_t*)0x20000080 = 0x20000040;
  STORE_BY_BITMASK(uint32_t, , 0x20000040, 0, 0, 29);
  STORE_BY_BITMASK(uint32_t, , 0x20000040, 0, 29, 1);
  STORE_BY_BITMASK(uint32_t, , 0x20000040, 0, 30, 1);
  STORE_BY_BITMASK(uint32_t, , 0x20000040, 0, 31, 1);
  *(uint8_t*)0x20000044 = 0;
  *(uint8_t*)0x20000045 = 0;
  *(uint8_t*)0x20000046 = 0;
  *(uint8_t*)0x20000047 = 0;
  memcpy((void*)0x20000048, "\x9d\x92\xde\xd5\xec\xad\xbc\x02", 8);
  *(uint64_t*)0x20000088 = 0x10;
