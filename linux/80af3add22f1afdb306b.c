...
// https://syzkaller.appspot.com/bug?id=80af3add22f1afdb306b
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_ioctl, r[0], 0x4c05, 0);
    break;
  case 3:
  ...
  case 5:
    ...
    break;
  case 6:
    NONFAILING(memcpy((void*)0x200000c0, "./bus/file1\000", 12));
  ...
  case 9:
    ...
    NONFAILING(memcpy((void*)0x200002c0, "./bus/file0\000", 12));
    syscall(__NR_link, 0x20000200ul, 0x200002c0ul);
    break;
  case 10:
    NONFAILING(memcpy((void*)0x20000280, "./bus/file0\000", 12));
    syscall(__NR_stat, 0x20000280ul, 0ul);
    break;
  }
}
int main(void)
