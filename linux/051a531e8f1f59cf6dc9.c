...
// https://syzkaller.appspot.com/bug?id=051a531e8f1f59cf6dc9
// status:2 arch:386
...
void loop(void)
{
  ...
  *(uint32_t*)0x20000108 = 0x209;
  *(uint32_t*)0x2000010c = 0;
  *(uint32_t*)0x20000110 = -1;
  *(uint32_t*)0x20000114 = 0;
  syscall(__NR_ioctl, (intptr_t)r[0], 0xc0184900, 0x20000100);
  memcpy((void*)0x20000200, "fdinfo/4\000", 9);
  res = -1;
  ...
  *(uint8_t*)0x2000000d = 0xbb;
  memcpy((void*)0x2000000e, "geneve0\000\000\000\000\000\000\000\000\000", 16);
  syscall(__NR_connect, (intptr_t)r[2], 0x20000000, 0x1e);
  syscall(__NR_sendfile, (intptr_t)r[2], (intptr_t)r[1], 0, 0x7fffffff);
}
int main(void)
{
