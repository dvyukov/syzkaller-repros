...
// https://syzkaller.appspot.com/bug?id=92c2535202f39bd02c8b
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000180, "batadv\000", 7));
    NONFAILING(syz_genetlink_get_family_id(0x20000180));
    break;
  case 4:
  ...
  case 8:
    ...
    NONFAILING(*(uint64_t*)0x2001d010 = 3);
    ...
    NONFAILING(*(uint64_t*)0x2001d048 = 0x58248);
    ...
    syscall(__NR_perf_event_open, 0x2001d000ul, 0, 0xfffffdfffffffffful, -1,
            0ul);
    break;
  case 9:
    syscall(__NR_sendmsg, -1, 0ul, 0x40ul);
    break;
  case 10:
    syscall(__NR_pipe, 0ul);
    break;
  case 11:
    syscall(__NR_ioctl, -1, 0x1260, 0ul);
    break;
  case 12:
    NONFAILING(memcpy((void*)0x20000340, "./file0\000", 8));
    NONFAILING(memcpy((void*)0x20000080, "./file0\000", 8));
    syscall(__NR_pivot_root, 0x20000340ul, 0x20000080ul);
    break;
  case 13:
    NONFAILING(memcpy((void*)0x200002c0, "cpuset\000", 7));
    syscall(__NR_mount, 0ul, 0ul, 0x200002c0ul, 0ul, 0ul);
    break;
  case 14:
    res = syscall(__NR_socket, 0x10ul, 3ul, 0);
    if (res != -1)
  ...
  case 15:
    ...
    NONFAILING(*(uint64_t*)0x20000140 = 0x20000ac0);
    NONFAILING(*(uint32_t*)0x20000ac0 = 0x58);
    NONFAILING(*(uint16_t*)0x20000ac4 = 0x10);
    NONFAILING(*(uint16_t*)0x20000ac6 = 0x401);
    NONFAILING(*(uint32_t*)0x20000ac8 = 0x70bd29);
    NONFAILING(*(uint32_t*)0x20000acc = 0);
    NONFAILING(*(uint8_t*)0x20000ad0 = 0);
    NONFAILING(*(uint8_t*)0x20000ad1 = 0);
    NONFAILING(*(uint16_t*)0x20000ad2 = 0);
    NONFAILING(*(uint32_t*)0x20000ad4 = 0);
    NONFAILING(*(uint32_t*)0x20000ad8 = 0x13);
    NONFAILING(*(uint32_t*)0x20000adc = 0);
    NONFAILING(*(uint16_t*)0x20000ae0 = 0x30);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000ae2, 0x12, 0, 14));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000ae3, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000ae3, 1, 7, 1));
    NONFAILING(*(uint16_t*)0x20000ae4 = 8);
    NONFAILING(*(uint16_t*)0x20000ae6 = 1);
    NONFAILING(memcpy((void*)0x20000ae8, "sit\000", 4));
    NONFAILING(*(uint16_t*)0x20000aec = 0x24);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000aee, 2, 0, 14));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000aef, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000aef, 1, 7, 1));
    NONFAILING(*(uint16_t*)0x20000af0 = 8);
    NONFAILING(*(uint16_t*)0x20000af2 = 0x14);
    NONFAILING(*(uint32_t*)0x20000af4 = 0);
    NONFAILING(*(uint16_t*)0x20000af8 = 8);
    NONFAILING(*(uint16_t*)0x20000afa = 2);
    NONFAILING(*(uint32_t*)0x20000afc = htobe32(0));
    NONFAILING(*(uint16_t*)0x20000b00 = 8);
    NONFAILING(*(uint16_t*)0x20000b02 = 3);
    NONFAILING(*(uint8_t*)0x20000b04 = 0xac);
    NONFAILING(*(uint8_t*)0x20000b05 = 0x1e);
    NONFAILING(*(uint8_t*)0x20000b06 = 0);
    NONFAILING(*(uint8_t*)0x20000b07 = 1 + procid * 1);
    NONFAILING(*(uint16_t*)0x20000b08 = 6);
    NONFAILING(*(uint16_t*)0x20000b0a = 8);
    NONFAILING(*(uint16_t*)0x20000b0c = 0);
    NONFAILING(*(uint16_t*)0x20000b10 = 5);
    NONFAILING(*(uint16_t*)0x20000b12 = 0x10);
  ...
  case 16:
    ...
    NONFAILING(memcpy((void*)0x20000240, "pstore\000", 7));
    NONFAILING(memcpy((void*)0x20000200, "/-*\\%{.:$$$)},{\'&}\006\000", 20));
    syscall(__NR_mount, 0ul, 0x20000180ul, 0x20000240ul, 1ul, 0x20000200ul);
    break;
  case 17:
    syscall(__NR_getitimer, 0ul, 0ul);
    break;
  case 18:
    NONFAILING(*(uint64_t*)0x20000a00 = 0x20000400);
    NONFAILING(*(uint64_t*)0x20000a08 = 0xf6);
    NONFAILING(*(uint64_t*)0x20000a10 = 0x20000500);
    NONFAILING(*(uint64_t*)0x20000a18 = 0xa1);
    NONFAILING(*(uint64_t*)0x20000a20 = 0x20000040);
    NONFAILING(*(uint64_t*)0x20000a28 = 0xe);
    NONFAILING(*(uint64_t*)0x20000a30 = 0x200005c0);
    NONFAILING(*(uint64_t*)0x20000a38 = 0xd4);
    NONFAILING(*(uint64_t*)0x20000a40 = 0x200006c0);
    NONFAILING(*(uint64_t*)0x20000a48 = 0xe3);
    NONFAILING(*(uint64_t*)0x20000a50 = 0x200007c0);
    NONFAILING(*(uint64_t*)0x20000a58 = 0x47);
    NONFAILING(*(uint64_t*)0x20000a60 = 0x20000840);
    NONFAILING(*(uint64_t*)0x20000a68 = 0xc6);
    NONFAILING(*(uint64_t*)0x20000a70 = 0x20001240);
    NONFAILING(*(uint64_t*)0x20000a78 = 0x1000);
    NONFAILING(*(uint64_t*)0x20000a80 = 0x20000940);
    NONFAILING(*(uint64_t*)0x20000a88 = 0x8b);
    syscall(__NR_readv, -1, 0x20000a00ul, 9ul);
    break;
  }
}
int main(void)
