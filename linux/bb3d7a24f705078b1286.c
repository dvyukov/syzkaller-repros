...
// https://syzkaller.appspot.com/bug?id=bb3d7a24f705078b1286
// status:0
...
void execute_call(int call)
{
  ...
  case 8:
    ...
    res = syscall(__NR_getsockname, r[4], 0x20000100ul, 0x20000280ul);
    if (res != -1)
  ...
  case 9:
    ...
    NONFAILING(memcpy((void*)0x20000180,
                      "\x44\x00\x00\x00\x10\x00\x01\x04\x00\x00\x00\x00\x00\x00"
                      "\x00\x00\x00\x00\x00\x00",
                      20));
    NONFAILING(*(uint32_t*)0x20000194 = 0);
    NONFAILING(memcpy(
        (void*)0x20000198,
        "\x00\x00\x00\x00\x00\x00\x00\x00\x14\x00\x12\x80\x0b\x00\x01\x00\x69"
        "\x70\x76\x6c\x61\x6e\x00\x00\x04\x00\x02\x80\x08\x00\x05\x00",
        32));
    NONFAILING(*(uint32_t*)0x200001b8 = r[5]);
  ...
  case 10:
    ...
    NONFAILING(*(uint16_t*)0x20000022 = 0x1c);
    NONFAILING(*(uint8_t*)0x20000024 = 0xef);
