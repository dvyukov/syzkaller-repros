// KASAN: use-after-free Read in j1939_xtp_rx_dat_one (3)
// https://syzkaller.appspot.com/bug?id=a9dce1ff45c3bbeceb3a
// status:0
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[0] = res;
  res = syscall(__NR_socket, 0x18ul, 0ul, 0);
  if (res != -1)
    r[1] = res;
  ...
  if (res != -1)
    r[3] = res;
  memcpy((void*)0x20000300, "vcan0\000\000\000\000\000\000\000\000\000\000\000",
         16);
  res = syscall(__NR_ioctl, r[3], 0x8933, 0x20000300ul);
  if (res != -1)
    r[4] = *(uint32_t*)0x20000310;
  *(uint16_t*)0x20000340 = 0x1d;
  *(uint32_t*)0x20000344 = r[4];
  ...
  *(uint8_t*)0x20000354 = 0;
  syscall(__NR_bind, r[2], 0x20000340ul, 0x18ul);
  ...
  *(uint8_t*)0x20000014 = 0;
  syscall(__NR_connect, r[1], 0x20000000ul, 0x18ul);
  syscall(__NR_sendfile, r[1], r[0], 0ul, 0x80005ul);
}
int main(void)
{
