...
// https://syzkaller.appspot.com/bug?id=6be5dc02975f2dbd76cd
// status:0
...
void execute_call(int call)
{
  ...
  case 6:
    ...
    break;
  case 7:
    syscall(__NR_dup2, r[2], r[3]);
    break;
  case 8:
    syscall(__NR_fcntl, r[3], 0x10ul, 0ul);
    break;
  case 9:
    NONFAILING(*(uint32_t*)0x20000200 = 0);
    NONFAILING(*(uint64_t*)0x20000204 = 0);
  ...
  case 10:
    ...
    break;
  case 11:
    NONFAILING(*(uint32_t*)0x200001c0 = 0x80000013);
    NONFAILING(*(uint64_t*)0x200001c4 = 0);
    syscall(__NR_epoll_ctl, r[4], 1ul, r[1], 0x200001c0ul);
    break;
  }
}
int main(void)
