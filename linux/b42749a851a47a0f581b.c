...
// https://syzkaller.appspot.com/bug?id=b42749a851a47a0f581b
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint32_t*)0x20004a48 = 0);
    NONFAILING(*(uint64_t*)0x20004a50 = 0x20004240);
    NONFAILING(*(uint64_t*)0x20004240 = 0x20003f80);
    NONFAILING(*(uint32_t*)0x20003f80 = 0x14);
    NONFAILING(*(uint16_t*)0x20003f84 = 0);
    NONFAILING(*(uint16_t*)0x20003f86 = 1);
    NONFAILING(*(uint32_t*)0x20003f88 = 0);
    NONFAILING(*(uint32_t*)0x20003f8c = 0);
    NONFAILING(*(uint8_t*)0x20003f90 = 1);
    NONFAILING(*(uint8_t*)0x20003f91 = 0);
    NONFAILING(*(uint16_t*)0x20003f92 = 0);
    NONFAILING(*(uint64_t*)0x20004248 = 0x14);
    NONFAILING(*(uint64_t*)0x20004a58 = 1);
    NONFAILING(*(uint64_t*)0x20004a60 = 0);
    NONFAILING(*(uint64_t*)0x20004a68 = 0);
    NONFAILING(*(uint32_t*)0x20004a70 = 0);
    syscall(__NR_sendmsg, r[0], 0x20004a40ul, 0ul);
    break;
  }
}
int main(void)
