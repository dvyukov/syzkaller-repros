...
// https://syzkaller.appspot.com/bug?id=1724d278c83ca6e6df100a2e320c10d991cf2bce
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_fcntl, -1, 0x400, 0);
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000080, "./file0\000", 8));
    syscall(__NR_unlink, 0x20000080);
    break;
  case 3:
    syscall(__NR_socket, 0x21, 2, 0x400000002);
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x20001000 = 0);
    NONFAILING(*(uint32_t*)0x20001004 = 0x70);
    NONFAILING(*(uint8_t*)0x20001008 = 0);
    NONFAILING(*(uint8_t*)0x20001009 = 0);
    NONFAILING(*(uint8_t*)0x2000100a = 0);
    NONFAILING(*(uint8_t*)0x2000100b = 0);
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 0, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 1, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 2, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 3, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 4, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 5, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 7, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 8, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 9, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 10, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 11, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 12, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 13, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 14, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 15, 2));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 17, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 18, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 19, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 20, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 21, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 22, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 23, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 24, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 25, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 26, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 27, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 28, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001028, 0, 29, 35));
    NONFAILING(*(uint32_t*)0x20001030 = 0);
    NONFAILING(*(uint32_t*)0x20001034 = 0);
    NONFAILING(*(uint64_t*)0x20001038 = 0);
    NONFAILING(*(uint64_t*)0x20001040 = 2);
    NONFAILING(*(uint64_t*)0x20001048 = 0x1000000000c);
    NONFAILING(*(uint64_t*)0x20001050 = 0);
    NONFAILING(*(uint32_t*)0x20001058 = 0);
    NONFAILING(*(uint32_t*)0x2000105c = 0);
    NONFAILING(*(uint64_t*)0x20001060 = 0);
    NONFAILING(*(uint32_t*)0x20001068 = 0);
    NONFAILING(*(uint16_t*)0x2000106c = 0);
    NONFAILING(*(uint16_t*)0x2000106e = 0);
    syscall(__NR_perf_event_open, 0x20001000, 0, 0, -1, 0);
    break;
  case 5:
    syscall(__NR_fcntl, r[0], 0x10, 0x20000040);
    break;
  case 6:
    res = syz_open_dev(0, 1, 0x400000);
    if (res != -1)
      r[1] = res;
    break;
  case 7:
    syscall(__NR_ioctl, r[1], 0x4030ae7b, 0);
    break;
  case 8:
    syscall(__NR_socket, 0x1d, 2, 2);
    break;
  case 9:
    NONFAILING(*(uint64_t*)0x200001c0 = 5);
    syscall(__NR_mbind, 0x20ffa000, 0x4000, 0, 0x200001c0, 0, 2);
    break;
  case 10:
    syscall(__NR_ioctl, -1, 0x894b, 0);
    break;
  case 11:
  ...
  case 12:
    ...
    NONFAILING(*(uint32_t*)0x2000038c = 4);
    NONFAILING(*(uint64_t*)0x20000390 = 0);
    NONFAILING(*(uint64_t*)0x20000398 = 0);
    syscall(__NR_timer_create, 1, 0x20000380, 0);
    break;
  case 13:
    syscall(__NR_gettid);
    break;
  ...
  case 16:
    ...
    NONFAILING(memcpy((void*)0x200002c1,
                      "\x7f\xaa\xea\x44\x4b\xbe\xf2\xf4\x43\x09\x90\x20\x1a\x15"
                      "\x82\x7c\x07\x5c\xb0\x50",
                      20));
    syscall(__NR_lsetxattr, 0, 0, 0x200002c0, 0x15, 0);
    break;
  case 17:
    syscall(__NR_write, -1, 0, 0);
    break;
  case 18:
    syscall(__NR_ioctl, -1, 0x4b41, 0);
    break;
  case 19:
    syscall(__NR_write, -1, 0, 0);
    break;
  case 20:
    syscall(__NR_futex, 0, 0x83, 0, 0, 0, 0);
    break;
  }
}
int main(void)
