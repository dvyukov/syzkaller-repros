...
// https://syzkaller.appspot.com/bug?id=17b1ffc681bc9f575cafe1ff72117b01d8c212fb
// status:fixed
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_sched_setaffinity, 0, 0, 0);
    break;
  case 2:
  ...
  case 3:
    ...
    syscall(__NR_mount, 0, 0x20000000, 0x20000040, 0x200000, 0x20000340);
    break;
  case 4:
    ...
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20001000, "./file0", 8));
    NONFAILING(memcpy((void*)0x20000080, "./file0", 8));
    syscall(__NR_symlink, 0x20001000, 0x20000080);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000200, "./file0", 8));
    syscall(__NR_unlink, 0x20000200);
    break;
  }
}
int main(void)
