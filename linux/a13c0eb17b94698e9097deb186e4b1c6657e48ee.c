// KASAN: stack-out-of-bounds Read in swake_up_one
// https://syzkaller.appspot.com/bug?id=a13c0eb17b94698e9097deb186e4b1c6657e48ee
// status:dup
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint8_t*)0x200000c3 = 8);
    NONFAILING(*(uint32_t*)0x200000c4 = 0);
    syscall(__NR_setsockopt, r[0], 0x29, 0x36, 0x200000c0, 8);
    break;
  case 2:
