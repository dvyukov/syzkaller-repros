...
// https://syzkaller.appspot.com/bug?id=1573c977fd349bb9fc01fc4e8b4154b531b64d01
// status:open
...
void loop(void)
{
  ...
  *(uint16_t*)0x200005c4 = 0x18;
  *(uint16_t*)0x200005c6 = 0xfa00;
  *(uint64_t*)0x200005c8 = 0;
  *(uint64_t*)0x200005d0 = 0x20000600;
  *(uint16_t*)0x200005d8 = 0x13f;
  ...
  *(uint32_t*)0x20000228 = htobe32(0);
  memcpy((void*)0x2000022c,
         "\xa2\x6e\x1c\x23\x15\xc8\x74\x3b\xec\x6d\xaf\x9f\x23\xf7\x73\x06",
         16);
  ...
  *(uint8_t*)0x200005de = 0;
  *(uint8_t*)0x200005df = 0;
  res = syscall(__NR_write, r[2], 0x200005c0, 0x20);
  if (res != -1)
    r[3] = *(uint32_t*)0x20000600;
  *(uint32_t*)0x20000200 = 3;
  *(uint16_t*)0x20000204 = 0x40;
  *(uint16_t*)0x20000206 = 0xfa00;
  *(uint16_t*)0x20000208 = 0xa;
  ...
  *(uint16_t*)0x20000226 = htobe16(0);
  *(uint32_t*)0x20000228 = htobe32(0);
  *(uint64_t*)0x2000022c = htobe64(0);
  *(uint64_t*)0x20000234 = htobe64(1);
  *(uint32_t*)0x2000023c = 0;
