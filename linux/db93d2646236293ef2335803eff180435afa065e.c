...
// https://syzkaller.appspot.com/bug?id=db93d2646236293ef2335803eff180435afa065e
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    *(uint32_t*)0x20000084 = htobe32(0xe0000002);
    ...
    break;
  case 2:
    syscall(__NR_clone, 0x81000000, 0, 0x9999999999999999, 0, -1);
    break;
  case 3:
    ...
    *(uint8_t*)0x20000107 = 0xa;
    syscall(__NR_sendto, r[0], 0, 0, 0x20000802, 0x20000100, 0x10);
    break;
  case 4:
