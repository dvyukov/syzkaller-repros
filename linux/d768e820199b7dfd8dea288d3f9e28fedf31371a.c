...
// https://syzkaller.appspot.com/bug?id=d768e820199b7dfd8dea288d3f9e28fedf31371a
// status:open
...
void execute_one(void)
{
  ...
  res =
      syscall(__NR_openat, 0xffffffffffffff9c, 0x20000180, 0x8000000000006, 0);
  if (res != -1)
    r[0] = res;
  ...
  *(uint32_t*)0x20000620 = 0;
  ...
  memcpy((void*)0x20000800,
         "\x76\xa4\x74\xd8\xd8\xef\x76\x1a\xd9\x51\xef\x00\x80\x7d\x13", 15);
  syscall(__NR_write, r[0], 0x20000800, 0xf);
  syscall(__NR_ioctl, r[1], 0x5406, 0);
