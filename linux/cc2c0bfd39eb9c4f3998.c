...
// https://syzkaller.appspot.com/bug?id=cc2c0bfd39eb9c4f3998
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_ioctl, r[0], 0, 0ul);
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000040, "\x04\x40", 2));
    NONFAILING(sprintf((char*)0x20000042, "0x%016llx", (long long)r[0]));
    NONFAILING(syz_emit_vhci(0x20000040, 2));
    break;
  case 3:
  ...
  case 4:
    NONFAILING(memcpy((void*)0x20000040,
                      "/sys/kernel/debug/bluetooth/6lowpan_control\000", 44));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000040ul, 2ul, 0ul);
    if (res != -1)
      r[1] = res;
    break;
  case 5:
    NONFAILING(memcpy((void*)0x200000c0, "connect aa:aa:aa:aa:aa:11 0", 27));
    syscall(__NR_write, r[1], 0x200000c0ul, 0x1bul);
    break;
  }
}
int main(void)
