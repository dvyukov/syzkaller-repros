...
// https://syzkaller.appspot.com/bug?id=cb4500d8db7b875b297e
// status:6
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    NONFAILING(*(uint8_t*)0x200002c4 = 0xd);
    NONFAILING(*(uint16_t*)0x200002c5 = 0);
    NONFAILING(*(uint8_t*)0x200002c7 = 5);
    NONFAILING(*(uint32_t*)0x200002c8 = 0);
    NONFAILING(*(uint64_t*)0x200002cc = 0);
    NONFAILING(*(uint32_t*)0x200002d4 = 0);
    syscall(__NR_write, r[0], 0x200002c0ul, 0xfdeful);
    break;
  }
}
int main(void)
