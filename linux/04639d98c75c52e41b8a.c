...
// https://syzkaller.appspot.com/bug?id=04639d98c75c52e41b8a
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0ul, 0x151000ul, 0ul);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    syscall(__NR_mknodat, r[0], 0ul, 0x400ul, 0x8001);
    break;
  case 2:
    syscall(__NR_ioctl, r[0], 0x125e, 0ul);
    break;
  case 3:
  ...
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_setsockopt, r[1], 1, 0x35, 0ul, 0ul);
    break;
  case 7:
    syscall(__NR_setsockopt, r[1], 0, 0x15, 0ul, 0ul);
    break;
  case 8:
    NONFAILING(memcpy((void*)0x20000240, "/dev/dri/card#\000", 15));
    res = syz_open_dev(0x20000240, 0, 0);
    if (res != -1)
      r[2] = res;
    break;
  case 9:
    NONFAILING(*(uint32_t*)0x20000000 = 0xffff);
    NONFAILING(*(uint32_t*)0x20000004 = 5);
    NONFAILING(*(uint32_t*)0x20000008 = 0xe0);
    ...
    res = syscall(__NR_ioctl, r[2], 0xc02064b2, 0x20000000ul);
    if (res != -1)
      NONFAILING(r[3] = *(uint32_t*)0x20000010);
    break;
  case 10:
    NONFAILING(*(uint32_t*)0x200001c0 = r[3]);
    syscall(__NR_ioctl, r[2], 0xc00464b4, 0x200001c0ul);
    break;
  }
}
int main(void)
