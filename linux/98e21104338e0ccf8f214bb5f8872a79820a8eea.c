...
// https://syzkaller.appspot.com/bug?id=98e21104338e0ccf8f214bb5f8872a79820a8eea
// status:dup
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    *(uint64_t*)0x20000220 = 0;
    ...
    STORE_BY_BITMASK(uint64_t, 0x20000228, 0x100000000000, 7, 1);
    STORE_BY_BITMASK(uint64_t, 0x20000228, 0, 8, 1);
    STORE_BY_BITMASK(uint64_t, 0x20000228, 0, 9, 1);
    STORE_BY_BITMASK(uint64_t, 0x20000228, 0xffffffffffffbac7, 10, 1);
  ...
  case 4:
    ...
    *(uint8_t*)0x200002ab = 0;
    ...
    break;
  case 5:
    syscall(__NR_socketpair, 0x1b, 0x800, 1, 0x20000040);
    break;
  case 6:
