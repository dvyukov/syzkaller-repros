...
// https://syzkaller.appspot.com/bug?id=29c3c12f3214b85ad081
// status:0
...
void loop(void)
{
  ...
  NONFAILING(*(uint32_t*)0x20000284 = 6);
  ...
  syscall(__NR_socket, 0x21ul, 2ul, 0xa);
  ...
  syscall(__NR_setsockopt, r[0], 6, 0x1f, 0x20000080ul, 4ul);
