...
// https://syzkaller.appspot.com/bug?id=9521e16c9e08325ffe17
// status:0
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[1] = res;
  NONFAILING(*(uint64_t*)0x200004c0 = 0x280022400);
  ...
  NONFAILING(*(uint32_t*)0x20000510 = r[1]);
  NONFAILING(syz_clone3(0x200004c0, 0x58));
  {
    int i;
    for (i = 0; i < 32; i++) {
      NONFAILING(syz_clone3(0x200004c0, 0x58));
