...
// https://syzkaller.appspot.com/bug?id=594acb38acf77fbf0727f4d2db17341a3db18d13
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    memcpy((void*)0x20000100, "./cgroup.cpu\x00", 13);
  ...
  case 3:
    *(uint64_t*)0x20000140 = 0x20008088;
    ...
    break;
  case 4:
    syscall(__NR_setsockopt, -1, 8, 8, 0, 0);
    break;
  case 5:
  ...
  case 7:
    ...
    *(uint32_t*)0x2000001c = 0;
    syscall(__NR_write, r[2], 0x20000000, 0xfffffeba);
    break;
  case 8:
    syscall(__NR_fcntl, r[2], 4, 0x44000);
    break;
  case 9:
    *(uint64_t*)0x20000180 = 0x10000;
    syscall(__NR_ioctl, r[2], 0x40086602, 0x20000180);
    break;
  case 10:
  ...
  case 11:
    ...
    *(uint32_t*)0x200000fc = -1;
    syscall(__NR_io_submit, r[3], 1, 0x20000540);
    break;
  }
}
int main(void)
