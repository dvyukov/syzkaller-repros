...
// https://syzkaller.appspot.com/bug?id=0d9d115141cea79f4f9c
// status:0
...
void execute_one(void)
{
  ...
  syscall(__NR_clone, 0x800500ul, 0ul, 0x9999999999999999ul, 0ul, -1ul);
  NONFAILING(memcpy((void*)0x20000000, "127.0.0.1\000", 10));
  NONFAILING(memcpy((void*)0x20000140, "./file0\000", 8));
  NONFAILING(memcpy((void*)0x200001c0, "9p\000", 3));
  syscall(__NR_mount, 0x20000000ul, 0x20000140ul, 0x200001c0ul, 0ul, 0ul);
}
int main(void)
{
