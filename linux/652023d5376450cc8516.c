// KASAN: use-after-free Read in bcm_can_tx (2)
// https://syzkaller.appspot.com/bug?id=652023d5376450cc8516
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000078 = 0;
  syscall(__NR_perf_event_open, 0x20000000ul, 0, 0xfbfffffffffffffful, -1, 0ul);
  ...
  *(uint32_t*)0x20000348 = 0x3f420f00;
  ...
  *(uint64_t*)0x20000040 = 0x20000580;
  memcpy((void*)0x20000580,
         "\x01\x00\x00\x00\xd7\xfe\x63\xd4\xc0\xd1\x62\x9e\xfc\x0f\x73\xeb",
         16);
  *(uint64_t*)0x20000590 = 0;
  *(uint64_t*)0x20000598 = 0;
  *(uint64_t*)0x200005a0 = 0;
  *(uint64_t*)0x200005a8 = r[0];
  memcpy((void*)0x200005b0, "\x9b\x42\x07\x2e\xbb", 5);
  *(uint64_t*)0x20000048 = 0x20000600;
