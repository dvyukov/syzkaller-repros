...
// https://syzkaller.appspot.com/bug?id=cd66e43794b178bb5cd6
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    syscall(__NR_ioctl, r[0], 0x5414ul, 0x20000080ul);
    break;
  case 2:
  ...
  case 3:
    ...
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x20000000 = 0x550);
    NONFAILING(*(uint32_t*)0x20000004 = 0);
    NONFAILING(*(uint32_t*)0x20000008 = 0);
    NONFAILING(*(uint32_t*)0x2000000c = 0x140);
    ...
    NONFAILING(*(uint32_t*)0x20000050 = 2);
