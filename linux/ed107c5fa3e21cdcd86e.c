...
// https://syzkaller.appspot.com/bug?id=ed107c5fa3e21cdcd86e
// status:6
...
int main(void)
{
  ...
  *(uint64_t*)0x20000180 = 0x20000040;
  memcpy((void*)0x20000040, "\xdc\x00\x00\x00", 4);
  *(uint16_t*)0x20000044 = 0;
  memcpy((void*)0x20000046, "\x00\x04\x2d\xbd\x70\x00\xfe\xdb\xdf\x25\x18\x00"
                            "\x00\x00\x04\x00\x02\x80\x14\x00\x03\x80\x08\x00"
                            "\x02\x00\x99",
         27);
  *(uint64_t*)0x20000188 = 0xdc;
  ...
  *(uint32_t*)0x200001f0 = 0;
  ...
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x20000a00, "nl80211\000", 8);
  res = -1;
  res = syz_genetlink_get_family_id(0x20000a00);
  if (res != -1)
    r[1] = res;
  res = syscall(__NR_socket, 0x10ul, 3ul, 0x10);
  if (res != -1)
  ...
  *(uint32_t*)0x20000208 = 0xffffff8c;
  *(uint64_t*)0x20000210 = 0x20000b00;
  *(uint64_t*)0x20000b00 = 0x20000040;
