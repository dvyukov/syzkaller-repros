...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint8_t*)0x20000004 = 0xd5);
    NONFAILING(*(uint8_t*)0x20000005 = 0x3b);
    NONFAILING(*(uint8_t*)0x20000006 = 0xce);
    NONFAILING(*(uint8_t*)0x20000007 = 8);
    NONFAILING(*(uint16_t*)0x20000008 = 0xbaf);
    NONFAILING(*(uint16_t*)0x2000000a = 0x118);
    NONFAILING(*(uint16_t*)0x2000000c = 0xd778);
    ...
    NONFAILING(*(uint8_t*)0x20000019 = 1);
    NONFAILING(*(uint8_t*)0x2000001a = 0);
    NONFAILING(*(uint8_t*)0x2000001b = 9);
    NONFAILING(*(uint8_t*)0x2000001c = 4);
    NONFAILING(*(uint8_t*)0x2000001d = 0x20);
    NONFAILING(*(uint8_t*)0x2000001e = 1);
    NONFAILING(*(uint8_t*)0x2000001f = 1);
    NONFAILING(*(uint8_t*)0x20000020 = 0xbb);
    NONFAILING(*(uint8_t*)0x20000021 = 0x61);
    NONFAILING(*(uint8_t*)0x20000022 = 0x32);
    NONFAILING(*(uint8_t*)0x20000023 = 0);
    NONFAILING(*(uint8_t*)0x20000024 = 7);
    NONFAILING(*(uint8_t*)0x20000025 = 5);
    NONFAILING(*(uint8_t*)0x20000026 = 4);
    NONFAILING(*(uint8_t*)0x20000027 = 2);
    NONFAILING(*(uint16_t*)0x20000028 = 0);
    NONFAILING(*(uint8_t*)0x2000002a = 7);
    NONFAILING(*(uint8_t*)0x2000002b = 4);
    NONFAILING(*(uint8_t*)0x2000002c = 0);
    res = syz_usb_connect(2, 0x4f, 0x20000000, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x20001940 = 0x34);
    NONFAILING(*(uint64_t*)0x20001944 = 0x20001680);
    NONFAILING(*(uint8_t*)0x20001680 = 0x20);
    NONFAILING(*(uint8_t*)0x20001681 = 0xe);
    NONFAILING(*(uint32_t*)0x20001682 = 2);
    NONFAILING(*(uint8_t*)0x20001686 = 2);
    NONFAILING(*(uint8_t*)0x20001687 = 0x3a);
    NONFAILING(*(uint64_t*)0x2000194c = 0);
    NONFAILING(*(uint64_t*)0x20001954 = 0);
    NONFAILING(*(uint64_t*)0x2000195c = 0);
    NONFAILING(*(uint64_t*)0x20001964 = 0);
    NONFAILING(*(uint64_t*)0x2000196c = 0);
    NONFAILING(*(uint32_t*)0x20001c00 = 0x54);
    NONFAILING(*(uint64_t*)0x20001c04 = 0x20001980);
    NONFAILING(*(uint8_t*)0x20001980 = 0x20);
    NONFAILING(*(uint8_t*)0x20001981 = 0);
    NONFAILING(*(uint32_t*)0x20001982 = 0);
    ...
    syz_usb_control_io(r[0], 0x20001940, 0x20001c00);
    break;
  case 2:
