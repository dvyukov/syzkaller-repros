// KMSAN: uninit-value in ip_rcv
// https://syzkaller.appspot.com/bug?id=52d5f14caba772e6d7f02a49842e20fd9d0dbb2d
// status:invalid
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(*(uint32_t*)0x2001d000 = 6);
    NONFAILING(*(uint32_t*)0x2001d004 = 0x70);
    NONFAILING(*(uint8_t*)0x2001d008 = 2);
    NONFAILING(*(uint8_t*)0x2001d009 = 5);
    NONFAILING(*(uint8_t*)0x2001d00a = 0);
    NONFAILING(*(uint8_t*)0x2001d00b = 1);
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x2001d028, 0x81, 9, 1));
  ...
  case 2:
    ...
    NONFAILING(*(uint16_t*)0x20000102 = htobe16(0x4e20));
  ...
  case 4:
    ...
    syscall(__NR_ioctl, r[1], 0x4000008912, 0x20000000);
    break;
  case 5:
    res = syscall(__NR_socket, 0x40000000002, 3, 8);
    if (res != -1)
      r[2] = res;
    break;
  case 6:
    NONFAILING(memcpy(
        (void*)0x20000140,
        "\x62\x72\x69\x64\x67\x65\x30\x00\x00\x00\x00\x00\x00\x02\x00\x00",
        16));
    syscall(__NR_setsockopt, r[2], 1, 0x19, 0x20000140, 0x10);
    break;
  case 7:
    res = syscall(__NR_fcntl, r[1], 9);
    if (res != -1)
      r[3] = res;
    break;
  case 8:
    ...
    NONFAILING(*(uint8_t*)0x20000048 = 0xf6);
    NONFAILING(*(uint8_t*)0x20000049 = 0xe4);
    ...
    NONFAILING(*(uint64_t*)0x20000060 = 8);
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 1, 0, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 6, 1, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 0, 2, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 0x80, 3, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 0xdbe, 4, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 0, 5, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 4, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 4, 7, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 5, 8, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 7, 9, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 0xfff, 10, 1));
    NONFAILING(
        STORE_BY_BITMASK(uint64_t, 0x20000068, 0xfffffffffffffff8, 11, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 0xb0, 12, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 0x3ff, 13, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 0x117ac5d7, 14, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 2, 15, 2));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 0x81, 17, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 0x1ff, 18, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 0xa902, 19, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 0x20, 20, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 1, 21, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 8, 22, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 0x700000000, 23, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 0xf6be, 24, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 3, 25, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 7, 26, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 0x401, 27, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 5, 28, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000068, 0, 29, 35));
    NONFAILING(*(uint32_t*)0x20000070 = 0xfffff000);
    NONFAILING(*(uint32_t*)0x20000074 = 0);
    NONFAILING(*(uint64_t*)0x20000078 = 0xb6);
    NONFAILING(*(uint64_t*)0x20000080 = 0x401);
    NONFAILING(*(uint64_t*)0x20000088 = 0x400);
    NONFAILING(*(uint64_t*)0x20000090 = 9);
    NONFAILING(*(uint32_t*)0x20000098 = 0x7fff);
    NONFAILING(*(uint32_t*)0x2000009c = 3);
    NONFAILING(*(uint64_t*)0x200000a0 = 0xffff);
    NONFAILING(*(uint32_t*)0x200000a8 = 0x40);
    NONFAILING(*(uint16_t*)0x200000ac = 0x7ff);
    NONFAILING(*(uint16_t*)0x200000ae = 0);
    syscall(__NR_perf_event_open, 0x20000040, r[3], 0xe, -1, 1);
    break;
  case 9:
  ...
  case 11:
    ...
    NONFAILING(*(uint16_t*)0x20000342 = htobe16(0x4e20));
    ...
    syscall(__NR_sendto, r[0], 0x2099bf26, 0, 0x20000000, 0x20000340, 0x10);
    break;
  case 12:
    syscall(__NR_sendto, r[0], 0x20000100, 0x229f, 0x4008000, 0, 0xb4);
    break;
  case 13:
    NONFAILING(memcpy((void*)0x20000140, "\xa5", 1));
    ...
    syscall(__NR_sendto, r[0], 0x20000140, 1, 0x4000002, 0x20000180, 0x10);
    break;
  }
}
