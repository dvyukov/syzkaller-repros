...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    res = syscall(__NR_creat, 0, 0x82);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    syscall(__NR_ioctl, r[0], 0xab09, 6);
    break;
  case 2:
  ...
  case 5:
    ...
    syscall(__NR_getsockopt, r[0], 0x84, 0x75, 0, 0x20000200);
    break;
  case 6:
    syscall(__NR_setsockopt, r[0], 0x84, 6, 0, 0);
    break;
  case 7:
  ...
  case 11:
    ...
    syscall(__NR_connect, r[3], 0x20419000, 0x1c);
    break;
  case 12:
    NONFAILING(memcpy((void*)0x20000300, "security.SMACK64IPIN\x00", 21));
    NONFAILING(memcpy((void*)0x20000340, "keyring\x00", 8));
    syscall(__NR_fsetxattr, r[3], 0x20000300, 0x20000340, 8, 2);
    break;
  case 13:
    syscall(__NR_recvmmsg, r[3], 0, 0, 2, 0);
    break;
  }
}
int main(void)
