...
// https://syzkaller.appspot.com/bug?id=f1e24a0594d4e3a895d3
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x200000c0 = 0x74);
    syscall(__NR_setsockopt, r[0], 6, 2, 0x200000c0ul, 0x25dul);
    break;
  case 2:
    NONFAILING(*(uint16_t*)0x20000280 = 2);
    NONFAILING(*(uint16_t*)0x20000282 = htobe16(0x4e23));
    NONFAILING(*(uint32_t*)0x20000284 = htobe32(0xe0000001));
  ...
  case 3:
    ...
    NONFAILING(*(uint8_t*)0x20000047 = 0xaa);
    syscall(__NR_sendto, r[0], 0ul, 0ul, 0x200007fdul, 0x20000040ul, 0x10ul);
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000000, "cdg\000", 4));
    syscall(__NR_setsockopt, r[0], 6, 0xd, 0x20000000ul, 4ul);
    break;
  case 5:
    NONFAILING(memcpy(
        (void*)0x200012c0,
        "\x0c\x26\x8a\x92\x7f\x1f\x65\x88\xb9\x67\x48\x12\x41\xba\x78\x60\xf4"
        "\x6e\xf6\x5a\xc6\x18\xde\xd8\x97\xc6\x7f\xab\xea\xf4\xb4\x83\x4f\xf9"
        ...
        77));
    syscall(__NR_sendto, r[0], 0x200012c0ul, 0xfe6aul, 0x11ul, 0ul, 0x27ul);
    break;
  }
}
int main(void)
