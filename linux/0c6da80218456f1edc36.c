...
// https://syzkaller.appspot.com/bug?id=0c6da80218456f1edc36
// status:0 arch:386
...
void loop(void)
{
  ...
  *(uint32_t*)0x20000610 = 0;
  res = syscall(__NR_ioctl, (intptr_t)r[0], 0x8933, 0x20000600);
  if (res != -1)
  ...
  *(uint32_t*)0x20000780 = 0x20000180;
  *(uint32_t*)0x20000180 = 0xac;
  ...
  *(uint16_t*)0x200001a6 = 1;
  memcpy((void*)0x200001a8, "taprio\000", 7);
  *(uint16_t*)0x200001b0 = 0x7c;
  *(uint16_t*)0x200001b2 = 2;
  *(uint16_t*)0x200001b4 = 0x56;
  *(uint16_t*)0x200001b6 = 1;
  *(uint8_t*)0x200001b8 = 2;
  ...
  *(uint16_t*)0x200001ca = 8;
  *(uint16_t*)0x200001cc = 4;
  ...
  *(uint32_t*)0x20000220 = 0x400;
  *(uint16_t*)0x20000224 = 8;
  *(uint16_t*)0x20000226 = 5;
  *(uint32_t*)0x20000228 = 0;
  *(uint32_t*)0x20000784 = 0xac;
