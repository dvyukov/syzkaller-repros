...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    res = syscall(__NR_io_setup, 0x400, 0x20000240);
    if (res != -1)
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_ioctl, -1, 0x810c5701, 0x20000100);
    break;
  case 3:
  ...
  case 4:
    ...
    *(uint32_t*)0x20000050 = 0xffffff9c;
    *(uint32_t*)0x20000054 = 0;
    syscall(__NR_ioctl, -1, 0xc0184900, 0x20000040);
    break;
  case 5:
    memcpy((void*)0x20000080, "/proc/self/net/pfkey", 21);
    syscall(__NR_openat, 0xffffffffffffff9c, 0x20000080, 0x10000, 0);
    break;
  case 6:
