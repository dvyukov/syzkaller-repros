...
// https://syzkaller.appspot.com/bug?id=366c6cc3ce81ea8d888da4b9bc4725496e1ffe0f
// status:invalid
...
void loop()
{
  ...
  if (res != -1)
    r[0] = res;
  *(uint16_t*)0x20ee1fa8 = 0x26;
  memcpy((void*)0x20ee1faa,
         "\x68\x61\x73\x68\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", 14);
  *(uint32_t*)0x20ee1fb8 = 0;
  *(uint32_t*)0x20ee1fbc = 0;
  memcpy((void*)0x20ee1fc0,
         "\x67\x68\x61\x73\x68\x2d\x63\x6c\x6d\x75\x6c\x6e\x69\x00\x00\x00\x00"
         "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
         "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
         "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
         64);
  syscall(__NR_bind, r[0], 0x20ee1fa8, 0x58);
  res = syscall(__NR_accept, r[0], 0, 0);
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x20001000,
         "\xa2\x33\x64\xfd\x5e\x58\x0e\xf2\x4d\x71\xa1\x9d\xd9\x3f\xc7\x27",
         16);
  syscall(__NR_setsockopt, r[0], 0x117, 1, 0x20001000, 0x10);
  memcpy((void*)0x20000080, "./file0", 8);
  res = syscall(__NR_open, 0x20000080, 0x28042, 0);
  if (res != -1)
    r[2] = res;
  syscall(__NR_fallocate, r[2], 0, 0, 4);
  *(uint64_t*)0x20e64ff8 = 0;
  syscall(__NR_sendfile, r[1], r[2], 0x20e64ff8, 0xb);
  syscall(__NR_read, r[1], 0x200000c0, 0xa6);
}
