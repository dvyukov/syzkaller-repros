...
int main(void)
{
  ...
  *(uint8_t*)0x20000045 = 0xc1;
  *(uint8_t*)0x20000046 = 0x16;
  *(uint8_t*)0x20000047 = 8;
  *(uint16_t*)0x20000048 = 0x1286;
  *(uint16_t*)0x2000004a = 0x2052;
  *(uint16_t*)0x2000004c = 0x6143;
  ...
  *(uint8_t*)0x2000005d = 0xb6;
  *(uint8_t*)0x2000005e = 0;
  *(uint8_t*)0x2000005f = 0;
  *(uint8_t*)0x20000060 = 0xf4;
  *(uint8_t*)0x20000061 = 0x92;
  *(uint8_t*)0x20000062 = 0x41;
  *(uint8_t*)0x20000063 = 0;
  syz_usb_connect(0, 0x134, 0x20000040, 0);
  return 0;
}
