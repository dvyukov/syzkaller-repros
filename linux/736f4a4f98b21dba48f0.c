// KASAN: use-after-free Read in dst_destroy
// https://syzkaller.appspot.com/bug?id=736f4a4f98b21dba48f0
// status:0
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000198 = 0xd;
  ...
  syscall(__NR_setsockopt, r[0], 1, 0x19, 0ul, 0ul);
  memcpy((void*)0x20000040, "memory.events\000", 14);
  res = syscall(__NR_openat, 0xffffff9c, 0x20000040ul, 0x275aul, 0ul);
  if (res != -1)
    r[1] = res;
  *(uint64_t*)0x20000240 = 0;
  *(uint64_t*)0x20000248 = 0x20be0200;
  *(uint64_t*)0x20000250 = 0x2be1fffd;
  syscall(__NR_ioctl, r[1], 0x40305839, 0x20000240ul);
  memset((void*)0x20000080, 78, 1);
  syscall(__NR_sendto, r[0], 0x20000080ul, 0xfffffdeful, 0ul, 0ul, 0xe001900ul);
}
int main(void)
{
