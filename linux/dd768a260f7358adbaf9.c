...
// https://syzkaller.appspot.com/bug?id=dd768a260f7358adbaf9
// status:6
...
{
  *(uint8_t*)0x20000480 = 4;
  *(uint8_t*)0x20000481 = 0x10;
  *(uint8_t*)0x20000482 = 1;
  *(uint8_t*)0x20000483 = 0;
  syz_emit_vhci(0x20000480, 4);
  *(uint8_t*)0x20002a00 = 4;
  *(uint8_t*)0x20002a01 = 0x22;
  *(uint8_t*)0x20002a02 = 0x1d;
  *(uint8_t*)0x20002a03 = 2;
  *(uint8_t*)0x20002a04 = -1;
  *(uint8_t*)0x20002a05 = -1;
  *(uint8_t*)0x20002a06 = -1;
  *(uint8_t*)0x20002a07 = -1;
  *(uint8_t*)0x20002a08 = -1;
  *(uint8_t*)0x20002a09 = -1;
  *(uint8_t*)0x20002a0a = 0;
  *(uint8_t*)0x20002a0b = 0;
  memcpy((void*)0x20002a0c, "\x85\x13\xe9", 3);
  *(uint16_t*)0x20002a0f = 0;
  *(uint8_t*)0x20002a11 = 0;
  *(uint8_t*)0x20002a12 = -1;
  *(uint8_t*)0x20002a13 = -1;
  *(uint8_t*)0x20002a14 = -1;
  *(uint8_t*)0x20002a15 = -1;
  *(uint8_t*)0x20002a16 = -1;
  *(uint8_t*)0x20002a17 = -1;
  *(uint8_t*)0x20002a18 = 0;
  *(uint8_t*)0x20002a19 = 0;
  memcpy((void*)0x20002a1a, "\x05\x28\xaf", 3);
  *(uint16_t*)0x20002a1d = 0;
  *(uint8_t*)0x20002a1f = 0;
  syz_emit_vhci(0x20002a00, 0x20);
  *(uint8_t*)0x20000040 = 4;
  *(uint8_t*)0x20000041 = 3;
  *(uint8_t*)0x20000042 = 0xb;
