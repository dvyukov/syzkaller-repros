...
// https://syzkaller.appspot.com/bug?id=f3a8311f29f7ded64dd61248d70271dff8995e14
// status:open
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    NONFAILING(memcpy((void*)0x209ff000, "\x18\x00\x00\x00\x03\x00\x00\x00\x00"
                                         "\x00\x00\x00\x00\xa5\x00\x00\x95\x00"
  ...
  case 7:
    ...
    NONFAILING(*(uint64_t*)0x20002800 = 0x200004c0);
    NONFAILING(*(uint64_t*)0x20002808 = 0x1000);
    ...
    break;
  case 8:
    NONFAILING(*(uint32_t*)0x20000300 = 0x80);
