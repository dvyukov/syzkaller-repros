...
// https://syzkaller.appspot.com/bug?id=81b636684a8272d2a1906de4414a72e486460c90
// status:fixed
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    syscall(__NR_symlink, 0x20000180, 0x200001c0);
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20004d00, "./file0\000", 8));
    syscall(__NR_open, 0x20004d00, 0x14140, 0x109);
    break;
  }
}
int main(void)
