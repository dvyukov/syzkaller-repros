...
// https://syzkaller.appspot.com/bug?id=82425f52b09843fe8da85de87f9d590920bbe1fe
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_socketpair, 1, 5, 0, 0x20000080);
    break;
  case 1:
    memcpy((void*)0x20000240, "./bus", 6);
    res = syscall(__NR_creat, 0x20000240, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
    syscall(__NR_fcntl, r[0], 4, 0x8000000000044000);
    break;
  case 3:
    res = syscall(__NR_io_setup, 0x334, 0x20000040);
    if (res != -1)
  ...
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_mmap, 0x20ffd000, 0x3000, 1, 0x10050, r[2], 0x180000000);
    break;
  case 7:
    ...
    *(uint32_t*)0x200000fc = -1;
    syscall(__NR_io_submit, r[1], 8, 0x20000540);
    break;
  }
}
int main(void)
