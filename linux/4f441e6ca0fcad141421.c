...
// https://syzkaller.appspot.com/bug?id=4f441e6ca0fcad141421
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    syscall(__NR_openat, 0xffffff9c, 0x20000080ul, 0x26e1ul, 0ul);
    break;
  case 1:
    res = syscall(__NR_pipe, 0x20003400ul);
    if (res != -1) {
      NONFAILING(r[0] = *(uint32_t*)0x20003400);
      NONFAILING(r[1] = *(uint32_t*)0x20003404);
    }
    break;
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_splice, r[0], 0ul, r[2], 0ul, 0x88000ccul, 0ul);
    break;
  case 4:
    syscall(__NR_fcntl, r[1], 0x407ul, 0x20ffffful);
    break;
  case 5:
    NONFAILING(*(uint64_t*)0x20000240 = 0);
    syscall(__NR_write, r[1], 0x20000240ul, 0xffffff14ul);
    {
      int i;
      for (i = 0; i < 64; i++) {
        syscall(__NR_write, r[1], 0x20000240ul, 0xffffff14ul);
