...
void execute_one(void)
{
  ...
  *(uint8_t*)0x200001e3 = 0;
  res = syz_usb_connect(3, 0x24, 0x200001c0, 0);
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x20000440 = 0x34;
  *(uint64_t*)0x20000444 = 0x20000280;
  *(uint8_t*)0x20000280 = 0;
  *(uint8_t*)0x20000281 = 0;
  *(uint32_t*)0x20000282 = 0x11;
  memcpy((void*)0x20000286,
         "\x6c\x38\x68\xb4\xc4\x23\xc7\xf5\xa9\x51\x44\x32\x26\xa5\xc8\x0b\xc8",
         17);
