...
int main(void)
{
  ...
  *(uint8_t*)0x20000005 = 0x26;
  *(uint8_t*)0x20000006 = 0x75;
  *(uint8_t*)0x20000007 = 8;
  *(uint16_t*)0x20000008 = 0x972f;
  *(uint16_t*)0x2000000a = 0x41a3;
  *(uint16_t*)0x2000000c = 0xd998;
