...
// https://syzkaller.appspot.com/bug?id=e417648b303855b91d8a
// status:6 arch:386
...
int main(void)
{
  ...
  intptr_t res = 0;
  memcpy((void*)0x200006c0, "/dev/i2c-#\000", 11);
  res = -1;
  res = syz_open_dev(0x200006c0, 0, 0);
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x20000700 = 0;
  *(uint32_t*)0x20000704 = 0;
  syscall(__NR_ioctl, (intptr_t)r[0], 0x707, 0x20000700);
  return 0;
}
