...
// https://syzkaller.appspot.com/bug?id=c88fc0ebe0d5935c70da
// status:0
...
int main(void)
{
  ...
  *(uint8_t*)0x20000044 = 0xad;
  *(uint8_t*)0x20000045 = 0x1e;
  *(uint8_t*)0x20000046 = 0x66;
  *(uint8_t*)0x20000047 = 8;
  *(uint16_t*)0x20000048 = 0x5032;
  *(uint16_t*)0x2000004a = 0xfa1;
  *(uint16_t*)0x2000004c = 0x2180;
  ...
  *(uint8_t*)0x2000005d = 0xb7;
  *(uint8_t*)0x2000005e = 0;
  *(uint8_t*)0x2000005f = 0;
  *(uint8_t*)0x20000060 = 0xa;
  *(uint8_t*)0x20000061 = 0x7f;
  *(uint8_t*)0x20000062 = 0x25;
  *(uint8_t*)0x20000063 = 0;
  syz_usb_connect(2, 0x24, 0x20000040, 0);
  return 0;
}
