// SYZFAIL: invalid syscall number
// https://syzkaller.appspot.com/bug?id=4d4383bb1e5b849ff6be
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(*(uint8_t*)0x20000183 = 0x22);
  NONFAILING(*(uint8_t*)0x20000184 = 0);
  syscall(__NR_add_key, 0ul, 0x20000180ul, 0ul, 0ul, -1);
}
int main(void)
{
