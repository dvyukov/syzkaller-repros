...
// https://syzkaller.appspot.com/bug?id=ebc2a828226c7d1f94ec
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(syz_mount_image(0, 0x20000580, 0, 0, 0, 0, 0));
    break;
  case 1:
    NONFAILING(memcpy((void*)0x200000c0, "./file0\000", 8));
    NONFAILING(memcpy((void*)0x20000100, "fusectl\000", 8));
    syscall(__NR_mount, 0ul, 0x200000c0ul, 0x20000100ul, 1ul, 0ul);
    break;
  case 2:
  ...
  case 5:
    ...
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x20004300 = 0x50);
    NONFAILING(*(uint32_t*)0x20004304 = 0);
    NONFAILING(*(uint64_t*)0x20004308 = r[1]);
    NONFAILING(*(uint32_t*)0x20004310 = 7);
    NONFAILING(*(uint32_t*)0x20004314 = 0x23);
    NONFAILING(*(uint32_t*)0x20004318 = 0);
    NONFAILING(*(uint32_t*)0x2000431c = 0);
    NONFAILING(*(uint16_t*)0x20004320 = 0);
    NONFAILING(*(uint16_t*)0x20004322 = 0);
    NONFAILING(*(uint32_t*)0x20004324 = 0);
    NONFAILING(*(uint32_t*)0x20004328 = 0);
    NONFAILING(*(uint16_t*)0x2000432c = 0);
    NONFAILING(*(uint16_t*)0x2000432e = 0);
    NONFAILING(memset((void*)0x20004330, 0, 32));
    syscall(__NR_write, r[0], 0x20004300ul, 0x50ul);
    break;
  case 7:
    NONFAILING(memcpy((void*)0x20004380, "./file0/file0\000", 14));
    syscall(__NR_mkdirat, 0xffffff9c, 0x20004380ul, 0ul);
    break;
  case 8:
    NONFAILING(*(uint32_t*)0x200043c0 = 0x29);
    NONFAILING(*(uint32_t*)0x200043c4 = 3);
    NONFAILING(*(uint64_t*)0x200043c8 = 0);
    NONFAILING(*(uint64_t*)0x200043d0 = 1);
    NONFAILING(*(uint32_t*)0x200043d8 = 8);
    NONFAILING(*(uint32_t*)0x200043dc = 0);
    NONFAILING(memcpy((void*)0x200043e0, "group_id", 8));
    NONFAILING(*(uint8_t*)0x200043e8 = 0);
