...
// https://syzkaller.appspot.com/bug?id=d27cdc6d1f87b2c65bf5
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint64_t*)0x20000110 = 9);
    ...
    NONFAILING(*(uint64_t*)0x20000138 = 0x4a39);
    NONFAILING(*(uint64_t*)0x20000140 = 3);
    NONFAILING(*(uint64_t*)0x20000148 = 0);
    NONFAILING(*(uint64_t*)0x20000150 = 0);
    NONFAILING(*(uint32_t*)0x20000158 = 0xfffff226);
    NONFAILING(*(uint32_t*)0x2000015c = 0);
    NONFAILING(*(uint64_t*)0x20000160 = 0x1000000);
    NONFAILING(*(uint32_t*)0x20000168 = 0);
    NONFAILING(*(uint16_t*)0x2000016c = 0);
    NONFAILING(*(uint16_t*)0x2000016e = 0);
    syscall(__NR_perf_event_open, 0x20000100ul, 0, 0ul, -1, 0xaul);
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000000, "clear_refs\000", 11));
    res = -1;
    ...
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000040, "stat\000", 5));
    res = -1;
    NONFAILING(res = syz_open_procfs(-1, 0x20000040));
    if (res != -1)
      r[1] = res;
    break;
  case 3:
    syscall(__NR_sendfile, r[0], r[1], 0ul, 1ul);
    break;
  case 4:
