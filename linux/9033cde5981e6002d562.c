...
// https://syzkaller.appspot.com/bug?id=9033cde5981e6002d562
// status:0
...
{
  intptr_t res = 0;
  NONFAILING(memcpy((void*)0x201f0000, "/dev/ptmx\000", 10));
  res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x201f0000ul, 0ul, 0ul);
  if (res != -1)
    r[0] = res;
  syscall(__NR_ioctl, r[0], 0x5413, 0x970000ul);
  close_fds();
}
int main(void)
{
