...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_listen, r[0], 0xb);
    break;
  case 3:
    syscall(__NR_accept, r[0], 0x20000000, 0);
    break;
  case 4:
    syscall(__NR_listen, -1, 0);
    break;
  case 5:
    syscall(__NR_shmget, 0x798dd816 + procid * 4, 0x4000, 0x1358, 0x20ffa000);
    break;
  case 6:
    syscall(__NR_ioctl, -1, 0x5428);
    break;
  case 7:
    ...
    NONFAILING(
        STORE_BY_BITMASK(uint64_t, 0x2001d028, 0x400000000000000, 27, 1));
  ...
  case 8:
    ...
    break;
  case 9:
    NONFAILING(*(uint64_t*)0x2051c000 = 0x20000140);
    NONFAILING(
        memcpy((void*)0x20000140,
               "\x48\x00\x00\x00\x14\x00\x19\x0d\x09\x00\x4b\xea\xfd\x0d\x8c"
               "\x56\x02\x84\x47\x00\x80\xff\xe0\x06\x00\x00\x00\x00\x00\x00"
               ...
               72));
    NONFAILING(*(uint64_t*)0x2051c008 = 0x48);
    syscall(__NR_writev, r[1], 0x2051c000, 1);
    break;
  case 10:
