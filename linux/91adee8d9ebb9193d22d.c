...
// https://syzkaller.appspot.com/bug?id=91adee8d9ebb9193d22d
// status:0
...
void execute_one(void)
{
  ...
  memcpy((void*)0x20000040,
         "\x12\x01\x00\x00\x8a\xb7\x6a\x08\x72\x0c\x11\x00\x42\x36\x00\x00\x00"
         "\x01\x09\x02\x12\x00\x01\x00\x00\x00\x00\x09\x04",
         29);
  res = -1;
  res = syz_usb_connect(0, 0x24, 0x20000040, 0);
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x20001a40 = 0x84;
  *(uint64_t*)0x20001a44 = 0x20001600;
  *(uint8_t*)0x20001600 = 0;
  *(uint8_t*)0x20001601 = 0;
  *(uint32_t*)0x20001602 = 0;
  *(uint64_t*)0x20001a4c = 0;
  *(uint64_t*)0x20001a54 = 0;
  *(uint64_t*)0x20001a5c = 0;
  *(uint64_t*)0x20001a64 = 0;
  *(uint64_t*)0x20001a6c = 0;
  *(uint64_t*)0x20001a74 = 0;
  *(uint64_t*)0x20001a7c = 0;
  *(uint64_t*)0x20001a84 = 0;
  *(uint64_t*)0x20001a8c = 0;
  *(uint64_t*)0x20001a94 = 0;
  *(uint64_t*)0x20001a9c = 0;
  *(uint64_t*)0x20001aa4 = 0;
  *(uint64_t*)0x20001aac = 0;
  *(uint64_t*)0x20001ab4 = 0;
  *(uint64_t*)0x20001abc = 0;
  syz_usb_control_io(r[0], 0, 0x20001a40);
