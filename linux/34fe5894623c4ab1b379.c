...
// https://syzkaller.appspot.com/bug?id=34fe5894623c4ab1b379
// status:6
...
{
  intptr_t res = 0;
  res = syscall(__NR_socket, 2ul, 5ul, 0);
  if (res != -1)
    r[0] = res;
  *(uint64_t*)0x20000080 = 0x28;
  ...
  *(uint16_t*)0x200000f0 = 0;
  syscall(__NR_ioctl, r[0], 0x89a0, 0x20000080ul);
