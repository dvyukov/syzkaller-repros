...
// https://syzkaller.appspot.com/bug?id=355f8edb2ff45d5f95fa
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint16_t*)0x20000182 = 0x8007);
  ...
  case 4:
    ...
    syscall(__NR_setsockopt, r[1], 0, 0xa, 0x20000000ul, 4ul);
    break;
  case 5:
    NONFAILING(*(uint16_t*)0x20fd9ff0 = 2);
    NONFAILING(*(uint16_t*)0x20fd9ff2 = htobe16(0x4e20));
    NONFAILING(*(uint32_t*)0x20fd9ff4 = htobe32(0));
    syscall(__NR_sendto, r[1], 0x20865000ul, 0xffe4ul, 0ul, 0x20fd9ff0ul,
            0x10ul);
    break;
  case 6:
    syscall(__NR_perf_event_open, 0ul, -1, 6ul, -1, 4ul);
    break;
  case 7:
    NONFAILING(syz_80211_join_ibss(0, 0, 0, 0));
    break;
  case 8:
    syscall(__NR_socket, 0x1dul, 2ul, 2);
    break;
  }
}
int main(void)
