...
// https://syzkaller.appspot.com/bug?id=999c19450d1efd698a94
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    memcpy((void*)0x20000080, "vxcan0\000\000\000\000\000\000\000\000\000\000",
           16);
  ...
  case 6:
    ...
    *(uint16_t*)0x200002c0 = 0x1d;
    *(uint32_t*)0x200002c4 = r[1];
    *(uint32_t*)0x200002c8 = 0;
    *(uint32_t*)0x200002cc = 0;
    *(uint32_t*)0x20000008 = 0x10;
    *(uint64_t*)0x20000010 = 0x20002ff0;
    *(uint64_t*)0x20002ff0 = 0x20000380;
    memcpy((void*)0x20000380,
           "\x01\x00\x00\x00\x63\x0b\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
           16);
    *(uint64_t*)0x20000390 = 0;
    *(uint64_t*)0x20000398 = 0;
    *(uint64_t*)0x200003a0 = 0;
    *(uint64_t*)0x200003a8 = r[3];
    memcpy((void*)0x200003b0, "\x00\x00\x00\x00\x01", 5);
    *(uint64_t*)0x20002ff8 = 0x80;
