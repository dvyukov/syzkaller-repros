...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000080, "/dev/vhost-net\000", 15));
  ...
  case 1:
    ...
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000100, "/dev/audio\000", 11));
  ...
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_ioctl, r[0], 0x4008af03ul, 0x20001400ul);
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x20d7c000 = 0);
    NONFAILING(*(uint32_t*)0x20d7c004 = r[1]);
    syscall(__NR_ioctl, r[0], 0x4008af30ul, 0x20d7c000ul);
    break;
  }
}
int main(void)
