...
// https://syzkaller.appspot.com/bug?id=3e874e4e8f5befe6ff178e93e1c37c902da745ec
// status:open
...
int main(void)
{
  ...
  *(uint8_t*)0x20000084 = 0x1e;
  *(uint8_t*)0x20000085 = 0x38;
  *(uint8_t*)0x20000086 = 0x87;
  *(uint8_t*)0x20000087 = 8;
  *(uint16_t*)0x20000088 = 0x1781;
  *(uint16_t*)0x2000008a = 0x938;
  *(uint16_t*)0x2000008c = 0x131e;
  ...
  *(uint8_t*)0x2000009d = 0x99;
  *(uint8_t*)0x2000009e = 0;
  *(uint8_t*)0x2000009f = 2;
  *(uint8_t*)0x200000a0 = 0xfb;
  *(uint8_t*)0x200000a1 = 0x4d;
