...
// https://syzkaller.appspot.com/bug?id=4fbe66f8c40f592e0d09
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(memcpy((void*)0x20d06ff8, "./file0\000", 8));
    syscall(__NR_symlinkat, 0x200000c0ul, r[0], 0x20d06ff8ul);
    break;
  case 2:
    syscall(__NR_renameat2, r[0], 0ul, -1, 0ul, 5ul);
    break;
  }
}
int main(void)
