...
// https://syzkaller.appspot.com/bug?id=66dbd7f76c5d8712a1f9
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    *(uint32_t*)0x200002c0 = 0x3fc;
    *(uint32_t*)0x200002c4 = 0;
    *(uint32_t*)0x200002c8 = 0;
    *(uint32_t*)0x200002cc = 0;
    syscall(__NR_setsockopt, r[1], 0x10f, 0x87, 0x200002c0ul, 0x10ul);
    break;
  case 4:
    *(uint32_t*)0x200002c0 = 0x3fc;
    *(uint32_t*)0x200002c4 = 0;
    ...
    *(uint32_t*)0x200002cc = 0;
    syscall(__NR_setsockopt, r[0], 0x10f, 0x87, 0x200002c0ul, 0x10ul);
    break;
  case 5:
    syscall(__NR_sendmmsg, r[0], 0x20000a40ul, 0x8000000000000b0ul, 0ul);
    break;
  }
}
int main(void)
