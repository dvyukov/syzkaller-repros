...
void loop(void)
{
  ...
  *(uint8_t*)0x20000004 = 0x68;
  *(uint8_t*)0x20000005 = 0x99;
  *(uint8_t*)0x20000006 = 0xdb;
  *(uint8_t*)0x20000007 = 8;
  *(uint16_t*)0x20000008 = 0x1164;
  *(uint16_t*)0x2000000a = 0x622;
  *(uint16_t*)0x2000000c = 0x14fd;
