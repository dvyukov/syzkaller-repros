...
// https://syzkaller.appspot.com/bug?id=4f789823c1abc5accf13
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000280, "nbd\000", 4));
    res = -1;
    NONFAILING(res = syz_genetlink_get_family_id(0x20000280, r[1]));
    if (res != -1)
      r[2] = res;
    break;
  case 3:
    ...
    NONFAILING(*(uint32_t*)0x20000300 = 0x5c);
    NONFAILING(*(uint16_t*)0x20000304 = r[2]);
    NONFAILING(*(uint16_t*)0x20000306 = 1);
    NONFAILING(*(uint32_t*)0x20000308 = 0);
    NONFAILING(*(uint32_t*)0x2000030c = 0);
    NONFAILING(*(uint8_t*)0x20000310 = 1);
    NONFAILING(*(uint8_t*)0x20000311 = 0);
    NONFAILING(*(uint16_t*)0x20000312 = 0);
    NONFAILING(*(uint16_t*)0x20000314 = 0xc);
    NONFAILING(*(uint16_t*)0x20000316 = 8);
    NONFAILING(*(uint64_t*)0x20000318 = 0);
    NONFAILING(*(uint16_t*)0x20000320 = 0xc);
    NONFAILING(*(uint16_t*)0x20000322 = 6);
    NONFAILING(*(uint64_t*)0x20000324 = 0);
    NONFAILING(*(uint16_t*)0x2000032c = 0xc);
    NONFAILING(*(uint16_t*)0x2000032e = 2);
    NONFAILING(*(uint64_t*)0x20000330 = 0);
    NONFAILING(*(uint16_t*)0x20000338 = 0xc);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x2000033a, 7, 0, 14));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x2000033b, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x2000033b, 1, 7, 1));
    NONFAILING(*(uint16_t*)0x2000033c = 8);
    NONFAILING(*(uint16_t*)0x2000033e = 1);
    NONFAILING(*(uint32_t*)0x20000340 = -1);
    NONFAILING(*(uint16_t*)0x20000344 = 0xc);
    NONFAILING(*(uint16_t*)0x20000346 = 5);
    NONFAILING(*(uint64_t*)0x20000348 = 0);
    NONFAILING(*(uint16_t*)0x20000350 = 0xc);
    NONFAILING(*(uint16_t*)0x20000352 = 6);
    NONFAILING(*(uint64_t*)0x20000354 = 1);
    NONFAILING(*(uint64_t*)0x20000388 = 0x5c);
