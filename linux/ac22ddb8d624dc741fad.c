...
// https://syzkaller.appspot.com/bug?id=ac22ddb8d624dc741fad
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    *(uint32_t*)0x200004b4 = 0;
    syscall(__NR_sched_setattr, 0, 0x20000480ul, 0ul);
    break;
  case 3:
    *(uint32_t*)0x20000040 = 9;
    *(uint64_t*)0x20000044 = 0;
    syscall(__NR_epoll_ctl, -1, 3ul, -1, 0x20000040ul);
    break;
  case 4:
    memcpy((void*)0x20000840, "/dev/ttyS3\000", 11);
    res =
        syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000840ul, 0x802ul, 0ul);
    if (res != -1)
      r[0] = res;
    break;
  case 5:
    syscall(__NR_sendfile, r[0], -1, 0ul, 0x20000000001000d8ul);
    break;
  }
}
int main(void)
