...
// https://syzkaller.appspot.com/bug?id=7a2ab2cdc14d134de553
// status:6
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x200002e4 = 3;
  *(uint32_t*)0x200002e8 = 0x238;
  *(uint32_t*)0x200002ec = 0;
  *(uint32_t*)0x200002f0 = 0;
  *(uint32_t*)0x200002f4 = 0;
  *(uint32_t*)0x200002f8 = 0;
  *(uint32_t*)0x200002fc = 0xd0;
  *(uint32_t*)0x20000300 = 0x1a0;
  *(uint32_t*)0x20000304 = 0x1a0;
  *(uint32_t*)0x20000308 = 0x1a0;
  *(uint32_t*)0x2000030c = 0x1a0;
  *(uint32_t*)0x20000310 = 0x1a0;
  ...
  *(uint32_t*)0x20000324 = htobe32(0xe0000001);
  *(uint32_t*)0x20000328 = htobe32(0);
  *(uint32_t*)0x2000032c = htobe32(-1);
  memcpy((void*)0x20000330, "team0\000\000\000\000\000\000\000\000\000\000\000",
         16);
  memcpy((void*)0x20000340, "veth1_to_bond\000\000\000", 16);
  ...
  *(uint16_t*)0x2000037a = 0xd0;
  *(uint32_t*)0x2000037c = 0;
  *(uint64_t*)0x20000380 = 0;
  *(uint64_t*)0x20000388 = 0;
  *(uint16_t*)0x20000390 = 0x60;
  memcpy((void*)0x20000392,
         "CLUSTERIP\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"
         "\000\000\000\000\000",
         29);
  ...
  *(uint32_t*)0x200003f4 = htobe32(-1);
  *(uint32_t*)0x200003f8 = htobe32(0);
  *(uint32_t*)0x200003fc = htobe32(-1);
  memcpy((void*)0x20000400,
         "wg0\000\000\000\000\000\000\000\000\000\000\000\000\000", 16);
  memcpy((void*)0x20000410, "team_slave_1\000\000\000\000", 16);
  ...
  *(uint16_t*)0x20000448 = 0x70;
  *(uint16_t*)0x2000044a = 0xd0;
  *(uint32_t*)0x2000044c = 0;
  *(uint64_t*)0x20000450 = 0;
  *(uint64_t*)0x20000458 = 0;
  *(uint16_t*)0x20000460 = 0x60;
  memcpy((void*)0x20000462,
         "CLUSTERIP\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"
         "\000\000\000\000\000",
         29);
  *(uint8_t*)0x2000047f = 0;
  *(uint32_t*)0x20000480 = 1;
  memset((void*)0x20000484, 170, 5);
  *(uint8_t*)0x20000489 = 0xaa;
  ...
  *(uint16_t*)0x200004aa = 0;
  *(uint16_t*)0x200004ac = 0;
  *(uint32_t*)0x200004b0 = 0;
  *(uint32_t*)0x200004b4 = 0;
  *(uint64_t*)0x200004b8 = 0;
  memset((void*)0x200004c0, 0, 84);
  *(uint32_t*)0x20000514 = 0;
  *(uint16_t*)0x20000518 = 0x70;
  *(uint16_t*)0x2000051a = 0x98;
  *(uint32_t*)0x2000051c = 0;
  *(uint64_t*)0x20000520 = 0;
  *(uint64_t*)0x20000528 = 0;
  *(uint16_t*)0x20000530 = 0x28;
  memset((void*)0x20000532, 0, 29);
  *(uint8_t*)0x2000054f = 4;
  *(uint32_t*)0x20000550 = 0xfffffffe;
  ...
  *(uint64_t*)0x20000400 = 0x20000100;
  memcpy((void*)0x20000100,
         "\x50\x00\x00\x00\x10\x00\x07\x47\x90\x27\x06\x00\xfd\x1a\x27\x54\x00"
         "\x01\xa3\x81",
         20);
  *(uint32_t*)0x20000114 = 0;
  memcpy((void*)0x20000118,
         "\x7f\xff\x00\x02\x81\x03\x00\x00\x1c\x00\x12\x00\x0b\x00\x01\x00\x6d"
         "\x61\x63\x73\x65\x63\x00\xe1\x0b\x00\x00\x00\x00\xfc\x9f\x68\x23\x39"
         "\xc3\x00\x0a\x00\x05\xc0\x10\x00\x00\x00\x00\x00\x00\x00\x08\x00\x0a"
         "\x00\x09\xd3\x5b\xf5\x8e\xc0\x20\xfa\xcf\xd2\x76\x3e\xd3\x46\xa3\x01"
         "\x00\x8b\x50\xaf\x42\xc5\x52\x28\x8b\x0b\x1e\x8f\x57\x42\x01\x2d\x9a"
         "\x58\xc4\x8b\x46\xf5\xa7",
         91);
  ...
  *(uint32_t*)0x20000070 = 0;
  ...
  syscall(__NR_sendmmsg, r[1], 0x20000000ul, 0x4924924924924cbul, 0ul);
}
int main(void)
{
