...
// https://syzkaller.appspot.com/bug?id=2cd8c5db4a85f0a04142
// status:0
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x20000244 = 0xf9;
  *(uint8_t*)0x20000245 = 0xb1;
  *(uint8_t*)0x20000246 = 0xa7;
  *(uint8_t*)0x20000247 = 0x40;
  *(uint16_t*)0x20000248 = 0xfd9;
  *(uint16_t*)0x2000024a = 0x2a;
  *(uint16_t*)0x2000024c = 0xe05a;
  ...
  *(uint8_t*)0x20000260 = 0x8b;
  *(uint8_t*)0x20000261 = 0xc3;
  *(uint8_t*)0x20000262 = 0x10;
  *(uint8_t*)0x20000263 = 0;
  res = -1;
  res = syz_usb_connect(0, 0x24, 0x20000240, 0);
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x20000a40 = 0x84;
  *(uint64_t*)0x20000a44 = 0x20000600;
  *(uint8_t*)0x20000600 = 0;
  *(uint8_t*)0x20000601 = 0;
  *(uint32_t*)0x20000602 = 1;
  memcpy((void*)0x20000606, "\x91", 1);
  ...
  *(uint64_t*)0x20000abc = 0;
  syz_usb_control_io(r[0], 0, 0x20000a40);
}
int main(void)
{
