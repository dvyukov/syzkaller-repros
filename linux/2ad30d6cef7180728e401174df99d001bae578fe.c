...
void loop(void)
{
  ...
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x20000640, "hsr0\000\000 \000\000\000\000\000\000\000\000\000",
         16);
  *(uint32_t*)0x20000650 = 0;
  res = syscall(__NR_ioctl, r[0], 0x8933, 0x20000640);
  if (res != -1)
    r[1] = *(uint32_t*)0x20000650;
  *(uint16_t*)0x20000280 = 0x11;
  *(uint16_t*)0x20000282 = htobe16(0);
  *(uint32_t*)0x20000284 = r[1];
  *(uint16_t*)0x20000288 = 1;
  ...
  *(uint8_t*)0x20000293 = 0;
  syscall(__NR_bind, r[0], 0x20000280, 0x14);
  memcpy((void*)0x200000c0,
         "\xe3\x60\xb6\x41\xb3\x7f\x00\x00\x00\x35\x80\x00\x89\x2f", 14);
