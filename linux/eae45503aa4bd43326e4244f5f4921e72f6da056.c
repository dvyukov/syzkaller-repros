...
// https://syzkaller.appspot.com/bug?id=eae45503aa4bd43326e4244f5f4921e72f6da056
// status:fixed
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_clone, 0x100, 0, 0x99999999, 0x20000180, -1);
    break;
  case 1:
  ...
  case 2:
    ...
    *(uint16_t*)0x2001d06e = 0;
    ...
    break;
  case 3:
    syscall(__NR_ptrace, 0x4206, (long)r[0], 0, 0);
    break;
  case 4:
    syscall(__NR_tkill, (long)r[0], 0x1b);
    break;
  case 5:
    memcpy((void*)0x200000c0, "IPVS", 5);
