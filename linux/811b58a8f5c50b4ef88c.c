...
// https://syzkaller.appspot.com/bug?id=811b58a8f5c50b4ef88c
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(memcpy((void*)0x20000000, "./cgroup.cpu/syz1\000", 18));
  ...
  if (res != -1)
    r[0] = res;
  syscall(__NR_fallocate, r[0], 1ul, 0x100000001ul, 0x80000001ul);
