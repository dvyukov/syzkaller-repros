...
// https://syzkaller.appspot.com/bug?id=be0232f1d0792f426874fc0cf149fb1721a62d42
// status:fixed
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_recvmmsg, r[0], 0, 0, 0x101, 0);
    break;
  case 3:
    NONFAILING(*(uint32_t*)0x20001dc0 = 0xdb);
    syscall(__NR_getsockopt, -1, 0x107, 5, 0x20001cc0, 0x20001dc0);
    break;
  case 4:
