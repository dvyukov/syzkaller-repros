...
// https://syzkaller.appspot.com/bug?id=641d482b73464dd5d56e
// status:0
  ...
  case 0:
    ...
    *(uint64_t*)0x20000218 = 0x20010a00;
    memcpy((void*)0x20010a00,
           "\xe7\x37\x6b\x66\x00\x00\x00\x00\x00\x10\x00\x00\x00\x00\x00\x00"
           "\x02\x00\x00\x00\x00\x00\x00\x00\x0d\x00\x00\x00\x10\x00\x00\x00"
           "\x12\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x02\x00\x00\x00"
           "\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff"
           "\xff\xff\xff\xff\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
           "\x00\x00\x00\x00\x03\x00\x00\x00\x0b\x00\x00\x00\x05\x00\x00\x00"
           "\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff"
           "\xff\xff\xff\xff\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
    ...
    *(uint64_t*)0x20000230 = 0x20010b00;
    memcpy((void*)0x20010b00, "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                              ...
                              "\x00\x00\x00\x00\x2b\x8e\xa7\xd1\x01\x00\x03\x00"
                              "\x00\x00\x00\x03\x00\x00\x00\x00\x10",
           45);
    ...
    *(uint64_t*)0x20000248 = 0x20010c00;
    memcpy((void*)0x20010c00, "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                              "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                              "\x00\x00\x00\x06\x00\x00\x00\x00\x00\x01\x0c"
                              "\x80",
           36);
    ...
    *(uint64_t*)0x200002a8 = 0x20011000;
    memcpy((void*)0x20011000, "\000\000\000\000\000\000\000\000\000\000\000\000"
    ...
    *(uint64_t*)0x200002f0 = 0x20011700;
    memcpy((void*)0x20011700, "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                              "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                              "\x00\x00\x00\x00\x2b\x8e\xa7\xd1",
           32);
    *(uint64_t*)0x200002f8 = 0x20;
    *(uint64_t*)0x20000300 = 0x205fe0;
    *(uint64_t*)0x20000308 = 0x20011f00;
    memcpy((void*)0x20011f00, "\xed\x41\x00\x00\x5c\xf9\x01\x00\x53\x5f\x01\x00"
                              "\x02\x00\x00\x00\x00\x10\x00\x00\x00\x00\x00\x00"
                              "\x02",
           25);
    *(uint64_t*)0x20000310 = 0x19;
    *(uint64_t*)0x20000318 = 0x1000000;
    *(uint64_t*)0x20000320 = 0x20012100;
    memcpy((void*)0x20012100,
           "\x00\x00\x00\x00\x00\x00\x00\x00\x03\x00\x00\x00\x03", 13);
    *(uint64_t*)0x20000328 = 0xd;
    *(uint64_t*)0x20000330 = 0x1000fe0;
    memcpy((void*)0x20000880, "jqfmt=vfsv1", 11);
    *(uint8_t*)0x2000088b = 0x2c;
    memcpy((void*)0x2000088c, "prjjquota", 9);
    *(uint8_t*)0x20000895 = 0x3d;
    memcpy((void*)0x20000896, "jffs2\000", 6);
    *(uint8_t*)0x2000089c = 0x2c;
    *(uint8_t*)0x2000089d = 0;
    syz_mount_image(0x20000000, 0x20000100, 0, 0xd, 0x20000200, 0, 0x20000880);
    break;
  }
}
int main(void)
