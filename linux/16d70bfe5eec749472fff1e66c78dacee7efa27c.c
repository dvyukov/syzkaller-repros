...
// https://syzkaller.appspot.com/bug?id=16d70bfe5eec749472fff1e66c78dacee7efa27c
// status:invalid
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    memcpy((void*)0x200003c0, "\x10\xef\x1e\x00\x00\x00\x00\x34\x7d\x23\x1f\x0f"
                              "\x1e\xa2\x7e\x7c\x29\x4d\x00\x00\x00\xc3\x4a"
                              "\x11",
           24);
    syscall(__NR_write, r[0], 0x200003c0, 0x18);
    break;
  case 2:
    ...
    *(uint64_t*)0x20000820 = 0;
    ...
    STORE_BY_BITMASK(uint64_t, , 0x20000828, 0, 5, 1);
    ...
    STORE_BY_BITMASK(uint64_t, , 0x20000828, 0, 14, 1);
    ...
    *(uint16_t*)0x2000086e = 0;
    syscall(__NR_perf_event_open, 0x20000800, 0, 0, -1, 0);
    break;
  case 3:
    *(uint64_t*)0x20000380 = 0;
    syscall(__NR_sendfile, r[0], r[0], 0x20000380, 0x8080fffffffe);
    break;
  case 4:
