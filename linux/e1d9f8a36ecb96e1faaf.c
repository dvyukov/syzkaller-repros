...
// https://syzkaller.appspot.com/bug?id=e1d9f8a36ecb96e1faaf
// status:0
  ...
  case 5:
    ...
    *(uint64_t*)0x20000780 = 0x20000340;
    memcpy((void*)0x20000340,
           "\x3c\x00\x00\x00\x24\x00\x0b\x0e\x00\x00\x00\x00\x00\x00\x00\x00"
           "\x00\x00\x00\x00",
           20);
    *(uint32_t*)0x20000354 = r[2];
    memcpy(
        ...
        "\x61\x6b\x65\x00\x00\x00\x00\x0c\x00\x02\x00\x08\x00\x0a\x00\x03",
        33);
