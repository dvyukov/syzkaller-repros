...
void execute_one(void)
{
  ...
  res = syscall(__NR_socket, 2ul, 0x2000080001ul, 0x84);
  if (res != -1)
    r[0] = res;
  syscall(__NR_setsockopt, r[0], 0x84ul, 0x7bul, 0ul, 0ul);
  *(uint16_t*)0x20000000 = 0xfff;
  *(uint16_t*)0x20000002 = 0;
  *(uint16_t*)0x20000004 = 0;
  *(uint16_t*)0x20000006 = 0;
  syscall(__NR_setsockopt, r[0], 0x84ul, 2ul, 0x20000000ul, 8ul);
  ...
  *(uint32_t*)0x20000180 = 0x10;
  inject_fault(10);
  syscall(__NR_getsockopt, r[0], 0x84ul, 0x6ful, 0x20000140ul, 0x20000180ul);
}
int main(void)
{
