...
// https://syzkaller.appspot.com/bug?id=2a12b45a809eada142c04fea8f37eba628c22de8
// status:fixed
...
int main(void)
{
  ...
  *(uint8_t*)0x20000045 = 0x8f;
  *(uint8_t*)0x20000046 = 0xc3;
  *(uint8_t*)0x20000047 = 8;
  *(uint16_t*)0x20000048 = 0x12d1;
  *(uint16_t*)0x2000004a = 0x14f1;
  *(uint16_t*)0x2000004c = 0xd4d9;
  ...
  *(uint8_t*)0x20000061 = 0x8d;
  *(uint8_t*)0x20000062 = 0x3e;
