...
// https://syzkaller.appspot.com/bug?id=489e7834b590057eb5172f202eaedaa413c6873e
// status:open
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    *(uint8_t*)0x20e68007 = 0x1e;
    syscall(__NR_sendto, r[0], 0, 0, 0x200007fe, 0x20e68000, 0x10);
    break;
  case 3:
    syscall(__NR_sendto, r[0], 0x20000000, 0xfffffdef, 0, 0, 0);
    break;
  case 4:
    *(uint32_t*)0x20000240 = 0;
    syscall(__NR_setsockopt, r[0], 1, 0x20, 0x20000240, 4);
    break;
  }
}
int main(void)
