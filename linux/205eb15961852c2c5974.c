...
// https://syzkaller.appspot.com/bug?id=205eb15961852c2c5974
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    memcpy((void*)0x20000100, "/dev/audio1\000", 12);
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000100ul, 0xa0e02ul,
                  0ul);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    syscall(__NR_ioctl, r[0], 0x5001, 0ul);
    break;
  case 2:
    memset((void*)0x20000500, 32, 1);
    syscall(__NR_write, r[0], 0x20000500ul, 1ul);
    break;
  case 3:
    *(uint32_t*)0x200004c0 = 0x20000000;
    syscall(__NR_ioctl, r[0], 0xc0045002, 0x200004c0ul);
    break;
  }
}
int main(void)
