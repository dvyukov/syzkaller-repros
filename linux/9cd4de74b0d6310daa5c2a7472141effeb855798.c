// WARNING: ODEBUG bug in tipc_subscrb_subscrp_delete
// https://syzkaller.appspot.com/bug?id=9cd4de74b0d6310daa5c2a7472141effeb855798
// status:open
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x200015c0 = 0x20000100;
  *(uint16_t*)0x20000100 = -1;
  syscall(__NR_write, r[0], 0x200015c0ul, 0xfffffd6dul);
  syscall(__NR_sendmmsg, -1, 0ul, 0ul, 0xc048ul);
}
int main(void)
{
