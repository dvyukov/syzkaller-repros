...
// https://syzkaller.appspot.com/bug?id=6e7a8bf684f3da5e895e2d1f5d178ed807f0fa73
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    *(uint32_t*)0x2000045c = 0;
    syscall(__NR_ioctl, r[0], 0x4601ul, 0x200003c0ul);
    break;
  }
}
int main(void)
