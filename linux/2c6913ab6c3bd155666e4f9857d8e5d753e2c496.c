...
// https://syzkaller.appspot.com/bug?id=2c6913ab6c3bd155666e4f9857d8e5d753e2c496
// status:fixed
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x200003c0 = 1;
  inject_fault(7);
  syscall(__NR_ioctl, r[0], 0x5423ul, 0x200003c0ul);
  syscall(__NR_getsockopt, -1, 0x84ul, 0xful, 0ul, 0ul);
}
int main(void)
{
