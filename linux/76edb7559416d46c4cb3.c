...
// https://syzkaller.appspot.com/bug?id=76edb7559416d46c4cb3
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(syz_mount_image(0, 0x20000180, 0, 0, 0, 0, 0));
    break;
  case 2:
  ...
  case 3:
    ...
    syscall(__NR_umount2, 0x20000040ul, 0xbul);
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20004280, "./file0\000", 8));
    res = syscall(__NR_openat, 0xffffff9c, 0x20004280ul, 0ul, 0x49ul);
    if (res != -1)
      r[0] = res;
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20000080, ".pending_reads\000", 15));
  ...
  case 7:
    ...
    NONFAILING(*(uint64_t*)0x20000108 = 0x3938700);
    syscall(__NR_ppoll, 0ul, 0ul, 0x20000100ul, 0ul, 0ul);
    break;
  case 8:
    NONFAILING(*(uint32_t*)0x20000380 = 0x14);
    NONFAILING(*(uint32_t*)0x20000384 = 0);
    NONFAILING(*(uint64_t*)0x20000388 = 0);
    NONFAILING(*(uint64_t*)0x20000390 = 0x200001c0);
    NONFAILING(memcpy((void*)0x200001c0, "GPL\000", 4));
    NONFAILING(*(uint32_t*)0x20000398 = 5);
    NONFAILING(*(uint32_t*)0x2000039c = 0);
    NONFAILING(*(uint64_t*)0x200003a0 = 0);
    NONFAILING(*(uint32_t*)0x200003a8 = 0x41100);
    NONFAILING(*(uint32_t*)0x200003ac = 0x24);
    NONFAILING(memset((void*)0x200003b0, 0, 16));
    NONFAILING(*(uint32_t*)0x200003c0 = 0);
    NONFAILING(*(uint32_t*)0x200003c4 = 0x34);
    NONFAILING(*(uint32_t*)0x200003c8 = r[1]);
    NONFAILING(*(uint32_t*)0x200003cc = 8);
    NONFAILING(*(uint64_t*)0x200003d0 = 0x20000240);
    NONFAILING(*(uint32_t*)0x20000240 = 9);
    NONFAILING(*(uint32_t*)0x20000244 = 3);
    NONFAILING(*(uint32_t*)0x200003d8 = 8);
    NONFAILING(*(uint32_t*)0x200003dc = 0x10);
    NONFAILING(*(uint64_t*)0x200003e0 = 0x20000280);
    NONFAILING(*(uint32_t*)0x20000280 = 2);
    NONFAILING(*(uint32_t*)0x20000284 = 0xc);
    NONFAILING(*(uint32_t*)0x20000288 = 0x8000);
    NONFAILING(*(uint32_t*)0x2000028c = 0x3c7);
    NONFAILING(*(uint32_t*)0x200003e8 = 0x10);
    NONFAILING(*(uint32_t*)0x200003ec = 0);
    NONFAILING(*(uint32_t*)0x200003f0 = r[1]);
    syscall(__NR_bpf, 5ul, 0x20000380ul, 0x78ul);
    break;
  }
}
int main(void)
