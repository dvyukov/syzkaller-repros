...
// https://syzkaller.appspot.com/bug?id=22a310041c3467f85d12
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_ioctl, r[0], 0xc08c5114, 0ul);
    break;
  case 2:
    syscall(__NR_fallocate, r[0], 0x11ul, 0x5ccul, 0x1fful);
    break;
  case 3:
  ...
  case 4:
    ...
    res = -1;
    NONFAILING(res = syz_open_dev(0x20000040, 2, 0x141001));
    if (res != -1)
      r[1] = res;
    break;
  case 5:
    ...
    break;
  case 6:
    NONFAILING(*(uint8_t*)0x20000380 = 1);
    NONFAILING(memcpy((void*)0x20000381,
                      "\x09\xdd\x10\x40\x1c\xa0\x13\x4d\x25\x5f\xb1\x30\xde\xb8"
                      "\xa7\x4a\xc4\x9b\xa4\x88",
                      20));
    syscall(__NR_fsetxattr, r[0], 0ul, 0x20000380ul, 0x15ul, 1ul);
    break;
  case 7:
    NONFAILING(memcpy((void*)0x20000000, "0", 1));
    syscall(__NR_write, r[2], 0x20000000ul, 0xfffffd2cul);
    break;
  case 8:
    NONFAILING(*(uint64_t*)0x20000300 = 0x40);
    syscall(__NR_write, r[2], 0x20000300ul, 8ul);
    break;
  case 9:
    NONFAILING(memcpy((void*)0x20000040, "/dev/snd/midiC#D#\000", 18));
    res = -1;
  ...
  case 11:
    NONFAILING(memcpy((void*)0x20000000, "0", 1));
    syscall(__NR_write, r[4], 0x20000000ul, 0xfffffd2cul);
    break;
  case 12:
  ...
  case 13:
    ...
    break;
  case 14:
    NONFAILING(*(uint32_t*)0x20000440 = 0x980000);
    NONFAILING(*(uint32_t*)0x20000444 = 8);
    NONFAILING(*(uint32_t*)0x20000448 = 0x10000);
    NONFAILING(*(uint32_t*)0x2000044c = -1);
    NONFAILING(*(uint32_t*)0x20000450 = 0);
    NONFAILING(*(uint64_t*)0x20000458 = 0);
    syscall(__NR_ioctl, r[4], 0xc0205647, 0x20000440ul);
    break;
  case 15:
