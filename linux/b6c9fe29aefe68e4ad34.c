...
// https://syzkaller.appspot.com/bug?id=b6c9fe29aefe68e4ad34
// status:0
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    res = -1;
    res = syz_genetlink_get_family_id(0x20000340, -1);
    if (res != -1)
      r[3] = res;
    break;
  case 4:
    ...
    *(uint16_t*)0x20000006 = 0x7d;
    *(uint32_t*)0x20000008 = 0;
    *(uint32_t*)0x2000000c = 0;
    *(uint8_t*)0x20000010 = 0x66;
    ...
    *(uint16_t*)0x2000001e = 0xb7;
    *(uint32_t*)0x20000020 = 0;
    *(uint16_t*)0x20000024 = 8;
    *(uint16_t*)0x20000026 = 0x26;
    *(uint32_t*)0x20000028 = 0x971;
