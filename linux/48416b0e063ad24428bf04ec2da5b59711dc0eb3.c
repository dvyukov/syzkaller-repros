...
void* thr(void* arg)
{
  ...
  case 0:
    ...
    break;
  case 1:
    memcpy((void*)0x20aec000, "\x2f\x64\x65\x76\x2f\x6b\x76\x6d\x00",
           9);
    r[2] = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20aec000ul,
                   0x0ul, 0x0ul);
    break;
  case 2:
  ...
  case 3:
    ...
    break;
  case 4:
    *(uint32_t*)0x20469fb8 = (uint32_t)0x80003;
    *(uint32_t*)0x20469fbc = (uint32_t)0x0;
    *(uint64_t*)0x20469fc0 = (uint64_t)0x2;
    *(uint64_t*)0x20469fc8 = (uint64_t)0x0;
    *(uint64_t*)0x20469fd0 = (uint64_t)0xffffffffffffffe0;
    *(uint64_t*)0x20469fd8 = (uint64_t)0x1000;
    *(uint64_t*)0x20469fe0 = (uint64_t)0x6;
    *(uint64_t*)0x20469fe8 = (uint64_t)0x0;
    *(uint64_t*)0x20469ff0 = (uint64_t)0x4;
    *(uint64_t*)0x20469ff8 = (uint64_t)0x0;
    r[15] = syscall(__NR_ioctl, r[4], 0x4048ae9bul, 0x20469fb8ul);
    break;
  case 5:
    *(uint64_t*)0x20aee000 = (uint64_t)0x40;
    *(uint64_t*)0x20aee008 = (uint64_t)0x209e0ff2;
    *(uint64_t*)0x20aee010 = (uint64_t)0x41;
    memcpy((void*)0x209e0ff2,
           "\xf3\x41\x88\x20\x48\xb8\x04\x00\x00\x00\x00\x00\x00\x00"
           "\x0f\x23\xd0\x0f\x21\xef\x35\x30\x00\x00\x0b\x0f\x23\xf8"
           "\x48\x83\x1a\xf3\x4f\xdc\xe4\x36\xf3\x64\x0f\x09\x26\x0f"
           "\xbd\xe6\x5e\xf3\x4d\xa5\x66\xba\xf8\x0c\xb8\xb2\xc6\xbe"
           "\x83\xef\xec\x0f\x22\xc4\x0f\x06\x85",
           65);
    r[20] = syz_kvm_setup_cpu(r[3], r[4], 0x201b3000ul, 0x20aee000ul,
                              0x1ul, 0x400065ul, 0x20ad8000ul, 0x0ul);
    break;
  case 6:
    r[21] = syscall(__NR_ioctl, r[4], 0xae80ul, 0x0ul);
    break;
  }
  return 0;
}
