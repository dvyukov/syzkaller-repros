...
// https://syzkaller.appspot.com/bug?id=c66c23b1d3271b709121
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    *(uint64_t*)0x20000200 = 0x20010000;
    memcpy((void*)0x20010000,
           "\x20\x00\x00\x00\x80\x00\x00\x00\x06\x00\x00\x00\x66\x00\x00\x00"
           "\x0f\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x01\x00\x00\x00"
           "\x00\x40\x00\x00\x00\x40\x00\x00\x20\x00\x00\x00\xd3\xf4\x65\x5f"
           "\xd4\xf4\x65\x5f\x01\x00\xff\xff\x53\xef\x01\x00\x01\x00\x00\x00"
           "\xd3\xf4\x65\x5f\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00"
           "\x00\x00\x00\x00\x0b\x00\x00\x00\x00\x02",
           90);
    *(uint64_t*)0x20000208 = 0x5a;
    *(uint64_t*)0x20000210 = 0x400;
    *(uint64_t*)0x20000218 = 0x20010300;
    memcpy((void*)0x20010300,
           "\x02\x00\x00\x00\x03\x00\x00\x00\x04\x00\x00\x00\x66\x00\x0f", 15);
    *(uint64_t*)0x20000220 = 0xf;
    *(uint64_t*)0x20000228 = 0x800;
    *(uint64_t*)0x20000230 = 0x20010400;
    memcpy(
        (void*)0x20010400,
        "\xff\xff\xff\x03\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xff"
        ...
        2050);
    *(uint64_t*)0x20000238 = 0x802;
    *(uint64_t*)0x20000240 = 0x1000;
    *(uint64_t*)0x20000248 = 0x20011500;
    memcpy((void*)0x20011500, "\xed\x41\x00\x00\x00\x08\x00\x00\xd3\xf4\x65\x5f"
                              "\xd3\xf4\x65\x5f\xd3\xf4\x65\x5f\x00\x00\x00\x00"
                              "\x00\x00\x04\x00\x04",
           29);
    *(uint64_t*)0x20000250 = 0x1d;
    *(uint64_t*)0x20000258 = 0x2200;
  ...
  case 4:
    ...
    break;
  case 5:
    memcpy((void*)0x20000300, "\x8f", 1);
    syscall(__NR_write, r[2], 0x20000300ul, 0x8100ul);
    break;
  case 6:
    res = -1;
  ...
  case 8:
    *(uint32_t*)0x20001440 = 8;
    memcpy(
        ...
        "\x4f\xe7\xff\x7f\xc6\xe5\x53\x9b\x5b\x0a\x0e\x4c\x54\x6a\x9b\x37\x50"
        "\x94\x37\x08\x90\xe0\x87\x8f\xdb\x1a\xc6\xe7\x04\x9b\x75\xb4\x95\x6c"
        "\x40\x9a\x47\x2a\x5b\x67\xf3\x98\x8f\x7e\xf3\x19\x52\xa9\x81\xff\xe8"
        "\xd1\x78\x70\x8c\x52\x3c\x92\x1b\x1b\x29\x4b\x0a\x16\x9b\x71\xd3\x36"
        ...
        "\xc1\x67\x2d\xb7\xe4\xb6\x8d\x78\x7d\x9a\x7a\x50\x8a\xe5\x4b\x3c\xd7"
        "\x36\x43\xde\x50\xe8\xc7\x7d\x95\xa3\xd3\x61\xc0\x40\xba\xbb\x17\x16"
        ...
        "\x60\x39\x94\x73\x29\x6b\x83\x1d\xbd\x93\x3d\x93\x99\x34\xa3\x06\x42"
        ...
        4096);
    *(uint16_t*)0x20002444 = 0x7f00;
    syscall(__NR_write, r[4], 0x20001440ul, 0x1006ul);
    break;
  }
}
int main(void)
