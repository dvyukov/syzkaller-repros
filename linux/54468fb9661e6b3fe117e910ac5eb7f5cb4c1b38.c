...
// https://syzkaller.appspot.com/bug?id=54468fb9661e6b3fe117e910ac5eb7f5cb4c1b38
// status:open
...
void loop(void)
{
  ...
  *(uint32_t*)0x20000000 = -1;
  syscall(__NR_setsockopt, r[0], 0x107, 0x14, 0x20000000, 4);
  *(uint64_t*)0x20000040 = 0x20000100;
  *(uint16_t*)0x20000100 = 0x25;
  *(uint32_t*)0x20000104 = 5;
  memcpy((void*)0x20000108,
         "\x8d\xe0\x6f\x55\xc7\x42\xae\x7c\x2b\xb7\xed\x77\x67\xc2\x45\xf6",
         16);
