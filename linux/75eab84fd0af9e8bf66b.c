...
// https://syzkaller.appspot.com/bug?id=75eab84fd0af9e8bf66b
// status:6
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    syscall(__NR_mkdir, 0x200009c0ul, 0ul);
    break;
  case 3:
    ...
    *(uint8_t*)0x20000132 = 0;
    syscall(__NR_mount, 0x40000dul, 0x20000000ul, 0x200000c0ul, 0ul,
            0x20000100ul);
    break;
  case 4:
    memcpy((void*)0x20000180, "./file0\000", 8);
    memcpy((void*)0x20000240, "cgroup2\000", 8);
    syscall(__NR_mount, 0ul, 0x20000180ul, 0x20000240ul, 0ul, 0ul);
    break;
  }
}
int main(void)
