...
void loop()
{
  ...
  if (syscall(__NR_socketpair, 0x8000000000001e, 5, 0, 0x2000dff8) != -1) {
    r[0] = *(uint32_t*)0x2000dff8;
    r[1] = *(uint32_t*)0x2000dffc;
  }
  syscall(__NR_close, r[1]);
  *(uint32_t*)0x207f0000 = 0x3fc;
  *(uint32_t*)0x207f0004 = 0;
  *(uint32_t*)0x207f0008 = 1;
  *(uint32_t*)0x207f000c = 0;
  write_file("/sys/kernel/debug/failslab/ignore-gfp-wait", "N");
  write_file("/sys/kernel/debug/fail_futex/ignore-private", "N");
  inject_fault(5);
  syscall(__NR_setsockopt, r[0], 0x10f, 0x87, 0x207f0000, 0x10);
}
