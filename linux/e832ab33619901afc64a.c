...
// https://syzkaller.appspot.com/bug?id=e832ab33619901afc64a
// status:0
...
{
  NONFAILING(*(uint8_t*)0x200000c0 = 8);
  NONFAILING(*(uint8_t*)0x200000c1 = 2);
  NONFAILING(*(uint8_t*)0x200000c2 = 0x11);
  NONFAILING(*(uint8_t*)0x200000c3 = 0);
  NONFAILING(*(uint8_t*)0x200000c4 = 0);
  NONFAILING(*(uint8_t*)0x200000c5 = 1);
  NONFAILING(syz_80211_inject_frame(0x200000c0, 0x20000680, 0x51));
}
int main(void)
{
