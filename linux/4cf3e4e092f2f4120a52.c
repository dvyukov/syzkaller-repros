...
// https://syzkaller.appspot.com/bug?id=4cf3e4e092f2f4120a52
// status:0
...
void execute_one(void)
{
  ...
  res =
      syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000040ul, 0x80001ul, 0ul);
  if (res != -1)
    r[0] = res;
