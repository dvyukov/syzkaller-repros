// WARNING in md_ioctl
// https://syzkaller.appspot.com/bug?id=4ff764aa0daa62edce600676aacbeaba3240acd1
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    *(uint16_t*)0x2001d06e = 0;
    ...
    break;
  case 1:
    memcpy((void*)0x200003c0, "/dev/md0\000", 9);
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x200003c0, 0, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
    memcpy((void*)0x200000c0, "/dev/snd/pcmC#D#c\000", 18);
    syz_open_dev(0x200000c0, 0x401, 0x101100);
    break;
  case 3:
