...
// https://syzkaller.appspot.com/bug?id=ecf6fc9333ecdaa3397503879fdafcd2b9afef48
// status:invalid
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    *(uint8_t*)0x20000003 = 0xfc;
    syscall(__NR_setsockopt, r[2], 0x107, 0x12, 0x20000000, 4);
    break;
  case 3:
  ...
  case 5:
    ...
    break;
  case 6:
    res = syscall(__NR_socket, 2, 3, 0x2a);
    if (res != -1)
      r[4] = res;
    break;
  case 7:
    ...
    *(uint8_t*)0x200001c7 = 0xaa;
    syscall(__NR_bind, r[3], 0x200001c0, 0x10);
    break;
  case 8:
    *(uint16_t*)0x20000100 = 2;
    *(uint16_t*)0x20000102 = htobe16(0);
    *(uint32_t*)0x20000104 = htobe32(0xe0000001);
    syscall(__NR_connect, r[3], 0x20000100, 0x10);
    break;
  case 9:
    syscall(__NR_splice, r[0], 0, r[4], 0, 0x19404, 0);
    break;
  }
}
int main(void)
