...
// https://syzkaller.appspot.com/bug?id=6c1841753a9a3d66b6ba
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_perf_event_open, 0ul, 0, 0xffffeffffffffffful, -1, 0ul);
    break;
  case 1:
  ...
  case 3:
    ...
    break;
  case 4:
    syscall(__NR_poll, 0ul, 0ul, 0x204);
    break;
  case 5:
    res = -1;
    ...
    break;
  case 6:
    syscall(__NR_ioctl, r[0], 0x400448dd, 0x20000040ul);
    break;
  }
}
int main(void)
