...
void loop(void)
{
  ...
  NONFAILING(*(uint8_t*)0x200000c4 = 0xb2);
  NONFAILING(*(uint8_t*)0x200000c5 = 0x4f);
  NONFAILING(*(uint8_t*)0x200000c6 = 0xc8);
  NONFAILING(*(uint8_t*)0x200000c7 = 8);
  NONFAILING(*(uint16_t*)0x200000c8 = 0x55f);
  NONFAILING(*(uint16_t*)0x200000ca = 0xb500);
  NONFAILING(*(uint16_t*)0x200000cc = 0x3345);
  ...
  NONFAILING(*(uint16_t*)0x200000d4 = 0x64);
  ...
  NONFAILING(*(uint8_t*)0x200000dd = 0xbc);
  NONFAILING(*(uint8_t*)0x200000de = 0);
  NONFAILING(*(uint8_t*)0x200000df = 1);
  NONFAILING(*(uint8_t*)0x200000e0 = 0xc9);
  NONFAILING(*(uint8_t*)0x200000e1 = 0x7c);
  NONFAILING(*(uint8_t*)0x200000e2 = 3);
  NONFAILING(*(uint8_t*)0x200000e3 = 0);
  NONFAILING(*(uint8_t*)0x200000e4 = 0x12);
  NONFAILING(*(uint8_t*)0x200000e5 = 0x24);
  NONFAILING(*(uint8_t*)0x200000e6 = 7);
  NONFAILING(*(uint8_t*)0x200000e7 = 0xfd);
  NONFAILING(*(uint16_t*)0x200000e8 = 5);
  NONFAILING(*(uint16_t*)0x200000ea = 0xc51);
  NONFAILING(*(uint16_t*)0x200000ec = 0x81);
  NONFAILING(*(uint16_t*)0x200000ee = 9);
  NONFAILING(*(uint16_t*)0x200000f0 = 0);
  NONFAILING(*(uint16_t*)0x200000f2 = 0x80);
  NONFAILING(*(uint16_t*)0x200000f4 = 0xe37);
  NONFAILING(*(uint8_t*)0x200000f6 = 4);
  NONFAILING(*(uint8_t*)0x200000f7 = 0x24);
  NONFAILING(*(uint8_t*)0x200000f8 = 2);
  NONFAILING(*(uint8_t*)0x200000f9 = 0);
  NONFAILING(*(uint8_t*)0x200000fa = 0x15);
  NONFAILING(*(uint8_t*)0x200000fb = 0x24);
  NONFAILING(*(uint8_t*)0x200000fc = 0x12);
  NONFAILING(*(uint16_t*)0x200000fd = 8);
  NONFAILING(memcpy(
      (void*)0x200000ff,
      "\xd6\x87\x53\x46\x9c\xb0\xb3\xd2\xc0\xda\xf9\x14\x6c\xda\xbb\x01", 16));
  NONFAILING(*(uint8_t*)0x2000010f = 4);
  NONFAILING(*(uint8_t*)0x20000110 = 0x24);
  NONFAILING(*(uint8_t*)0x20000111 = 1);
  NONFAILING(*(uint8_t*)0x20000112 = 2);
  NONFAILING(*(uint8_t*)0x20000113 = 6);
  NONFAILING(*(uint8_t*)0x20000114 = 0x24);
  NONFAILING(*(uint8_t*)0x20000115 = 0x1a);
  NONFAILING(*(uint16_t*)0x20000116 = 0x800);
  NONFAILING(*(uint8_t*)0x20000118 = -1);
  NONFAILING(*(uint8_t*)0x20000119 = 3);
  NONFAILING(*(uint8_t*)0x2000011a = 0x24);
  NONFAILING(*(uint8_t*)0x2000011b = 0x12);
  NONFAILING(*(uint8_t*)0x2000011c = 7);
  NONFAILING(*(uint8_t*)0x2000011d = 0x24);
  NONFAILING(*(uint8_t*)0x2000011e = 0xa);
  NONFAILING(*(uint8_t*)0x2000011f = 1);
  NONFAILING(*(uint8_t*)0x20000120 = 9);
  NONFAILING(*(uint8_t*)0x20000121 = 0xfc);
  NONFAILING(*(uint8_t*)0x20000122 = 5);
  NONFAILING(*(uint8_t*)0x20000123 = 4);
  NONFAILING(*(uint8_t*)0x20000124 = 0x24);
  NONFAILING(*(uint8_t*)0x20000125 = 1);
  NONFAILING(*(uint8_t*)0x20000126 = 1);
  NONFAILING(*(uint8_t*)0x20000127 = 6);
  NONFAILING(*(uint8_t*)0x20000128 = 0x24);
  NONFAILING(*(uint8_t*)0x20000129 = 0x1a);
  NONFAILING(*(uint16_t*)0x2000012a = 9);
  NONFAILING(*(uint8_t*)0x2000012c = 0x81);
  NONFAILING(*(uint8_t*)0x2000012d = 7);
  NONFAILING(*(uint8_t*)0x2000012e = 5);
  NONFAILING(*(uint8_t*)0x2000012f = 0x81);
  NONFAILING(*(uint8_t*)0x20000130 = 0x12);
  NONFAILING(*(uint16_t*)0x20000131 = 0);
  NONFAILING(*(uint8_t*)0x20000133 = 0);
  NONFAILING(*(uint8_t*)0x20000134 = 0);
  NONFAILING(*(uint8_t*)0x20000135 = 0);
  syz_usb_connect(0, 0x76, 0x200000c0, 0);
  close_fds();
}
int main(void)
{
