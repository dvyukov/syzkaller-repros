...
// https://syzkaller.appspot.com/bug?id=db0c9917f71539bc4ad1
// status:0
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x200003c0, "nbd\000", 4);
  res = -1;
  res = syz_genetlink_get_family_id(0x200003c0, r[0]);
  if (res != -1)
    r[2] = res;
