...
// https://syzkaller.appspot.com/bug?id=31d54c60c5b254d6f75b
// status:6
...
int main(void)
{
  ...
  *(uint32_t*)0x20000ed8 = 7;
  *(uint32_t*)0x20000edc = 0;
  *(uint64_t*)0x20000ee0 = 0;
  *(uint32_t*)0x20000ee8 = 0;
  *(uint64_t*)0x20000eec = 0;
  *(uint32_t*)0x20000ef4 = 0x15;
  *(uint64_t*)0x20000ef8 = 0x20000c80;
  *(uint8_t*)0x20000c80 = 0x15;
  *(uint8_t*)0x20000c81 = 3;
  memcpy((void*)0x20000c82,
         "\x68\x2c\x73\x67\x2a\x79\x10\x07\xf2\xed\x1c\x7b\x49\xf6\x5e\x61\x93"
         "\x5e\xcc",
         19);
  ...
  *(uint64_t*)0x20000f28 = 0;
  syz_usb_connect(6, 0, 0, 0x20000ec0);
