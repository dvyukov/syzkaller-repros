...
// https://syzkaller.appspot.com/bug?id=e654d4e15e6b3b9deb53
// status:0
...
int main(void)
{
  ...
  *(uint32_t*)0x200000a4 = 0;
  res = -1;
  res = syz_io_uring_setup(0x86, 0x20000080, 0x20ffc000, 0x206d4000, 0x20000040,
                           0x20000000);
  if (res != -1) {
    r[0] = res;
  ...
  *(uint32_t*)0x20000140 = 0x307e;
  ...
  memcpy((void*)0x20000180, "/dev/dsp\000", 9);
  ...
  *(uint8_t*)0x2000023f = 0;
  ...
  if (res != -1)
    r[4] = *(uint32_t*)0x200001c4;
  syscall(__NR_write, r[4], 0x20000000ul, 0xfffffeccul);
  return 0;
}
