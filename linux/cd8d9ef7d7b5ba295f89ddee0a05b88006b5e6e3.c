...
// https://syzkaller.appspot.com/bug?id=cd8d9ef7d7b5ba295f89ddee0a05b88006b5e6e3
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    res = syz_open_dev(0x20000080, 0 + procid * 1, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
  ...
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_ioctl, r[2], 0xab00ul, r[3]);
    break;
  case 7:
  ...
  case 8:
    ...
    break;
  case 9:
    syscall(__NR_ioctl, r[5], 0x8912ul, 0x400200ul);
    break;
  case 10:
    inject_fault(8);
