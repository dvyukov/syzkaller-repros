...
// https://syzkaller.appspot.com/bug?id=09ad4050dd3a120bfccd
// status:0
...
void execute_one(void)
{
  ...
  syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000840ul, 0xa02ul, 0ul);
  ...
  *(uint32_t*)0x20001618 = -1;
  ...
  res = -1;
  res = syz_io_uring_setup(0x2de7, 0x20001600, 0x20002000, 0x20ffb000,
  ...
  *(uint16_t*)0x200001ea = 0;
  ...
  syscall(__NR_io_uring_enter, r[0], 0x1261, 0, 0ul, 0ul, 0x30000000ul);
}
int main(void)
{
