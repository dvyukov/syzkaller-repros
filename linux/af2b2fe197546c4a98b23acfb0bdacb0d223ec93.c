...
// https://syzkaller.appspot.com/bug?id=af2b2fe197546c4a98b23acfb0bdacb0d223ec93
// status:dup
...
int main(void)
{
  ...
  *(uint8_t*)0x20000004 = 0x84;
  *(uint8_t*)0x20000005 = 0xbf;
  *(uint8_t*)0x20000006 = 0x5f;
  *(uint8_t*)0x20000007 = 0x10;
  *(uint16_t*)0x20000008 = 0x841;
  *(uint16_t*)0x2000000a = 1;
  *(uint16_t*)0x2000000c = 0xc5d0;
  ...
  *(uint8_t*)0x2000001d = 0x85;
  *(uint8_t*)0x2000001e = 0;
  *(uint8_t*)0x2000001f = 0;
  *(uint8_t*)0x20000020 = 0xc9;
  *(uint8_t*)0x20000021 = 0x8c;
  *(uint8_t*)0x20000022 = 0x7e;
