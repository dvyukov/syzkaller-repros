...
void loop()
{
  ...
  *(uint64_t*)0x20000288 = 0x20000500;
  memcpy((void*)0x20000500, "\x0f\x08\x66\xb8\xed\x00\x8e\xc0\x66\xba\x40\x00"
                            "\xb0\x00\xee\xd2\xa8\x07\x00\x00\x00\x41\x0f\x01"
                            "\xca\xb9\x8e\x0b\x00\x00\xb8\x62\x00\x00\x00\xba"
                            "\x00\x00\x00\x00\x0f\x30\xb9\x0b\x08\x00\x00\x0f"
                            "\x32\x0f\xc7\x2a\x8f\x2a\x60\x12\x8f\x00\x00\x00"
                            "\x00\x00\x30\x00\x00\x0f\xc7\xaa\x00\x10\x00\x00",
         72);
  *(uint64_t*)0x20000290 = 0x48;
  syz_kvm_setup_cpu(r[1], r[2], 0x20000000, 0x20000280, 0xaaaaaaaaaaaab97,
                    0xfffffffffffffffc, 0x20000580, 0);
  memcpy((void*)0x20000080, "\x01\x00\x0f\xc7\x7f", 5);
  syscall(__NR_ioctl, -1, 0x4008ae8a, 0x20000080);
