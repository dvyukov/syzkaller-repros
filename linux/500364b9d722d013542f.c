...
// https://syzkaller.appspot.com/bug?id=500364b9d722d013542f
// status:0
...
void execute_one(void)
{
  ...
  syz_init_net_socket(0x1f, 1, 0);
  syz_init_net_socket(0x1f, 5, 0);
  syscall(__NR_getsockopt, -1, 1, 0x2a, 0ul, 0ul);
  *(uint32_t*)0x20000040 = -1;
  *(uint32_t*)0x20000044 = 0x867;
  syscall(__NR_ioctl, -1, 0x400443c8, 0x20000040ul);
}
int main(void)
{
