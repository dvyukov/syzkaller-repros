// BUG: stack guard page was hit in sys_setxattr (2)
// https://syzkaller.appspot.com/bug?id=ec2e451cbe3e4abf3f08
// status:3
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    memcpy((void*)0x200000c0, "user.incfs.size\000", 16);
    syscall(__NR_setxattr, 0x20000000ul, 0x200000c0ul, 0ul, 0ul, 0ul);
    {
      int i;
      for (i = 0; i < 64; i++) {
        syscall(__NR_setxattr, 0x20000000ul, 0x200000c0ul, 0ul, 0ul, 0ul);
