// BUG: unable to handle kernel paging request in do_sys_open
// https://syzkaller.appspot.com/bug?id=d3c104207c25ceef0d5b
// status:0
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    memcpy((void*)0x20000200, "sysfs\000", 6);
    syscall(__NR_mount, 0ul, 0x20000140ul, 0x20000200ul, 0ul, 0ul);
    break;
  case 4:
    memcpy((void*)0x20000000, "./bus\000", 6);
    memcpy((void*)0x20000100, "overlay\000", 8);
    memcpy((void*)0x200003c0, "upperdir=./file1,lowerdir=./bus,workdir=./file0",
           47);
  ...
  case 6:
    ...
    memcpy((void*)0x20000280, "trusted.overlay.redirect\000", 25);
    syscall(__NR_lsetxattr, 0x20000080ul, 0x20000280ul, 0ul, 0ul, 1ul);
    break;
  case 7:
