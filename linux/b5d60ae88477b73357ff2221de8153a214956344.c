...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    res = syscall(__NR_socketpair, 0xfffffffffffffffe, 3, 0xf9, 0x20000140);
    if (res != -1)
  ...
  case 2:
    ...
    *(uint64_t*)0x20000110 = 0x20000040;
    syscall(__NR_bpf, 1, 0x20000100, 0x18);
    break;
  case 3:
  ...
  case 5:
    ...
    *(uint32_t*)0x20000204 = 0x28;
    *(uint64_t*)0x20000208 = 0x200001c0;
    syscall(__NR_bpf, 0xf, 0x20000200, 0x10);
    break;
  case 6:
    *(uint32_t*)0x20000180 = r[1];
