...
// https://syzkaller.appspot.com/bug?id=fac18df4349878ea258e
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000228 = 0x2011e0;
  memcpy((void*)0x20000080, "whint_mode=user-based", 21);
  *(uint8_t*)0x20000095 = 0x2c;
  *(uint8_t*)0x20000096 = 0;
  inject_fault(67);
  syz_mount_image(0x20000000, 0x20000100, 0, 2, 0x20000200, 0, 0x20000080);
}
int main(void)
{
