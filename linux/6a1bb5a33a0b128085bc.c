...
// https://syzkaller.appspot.com/bug?id=6a1bb5a33a0b128085bc
// status:0
...
int main(void)
{
  ...
  intptr_t res = 0;
  memcpy((void*)0x20000300, "\x12\x01\x00\x00\x39\x54\x2f\x10\x8c\x07\x02\x10"
                            "\x47\xe6\x00\x00\x00\x01\x09\x02\x24\x00\x01\x00"
                            "\x00\x00\x00\x09\x04\xdb\x00\x01\x0a\x04\xc8\x00"
                            "\x09\x21\x03\x00\x00\x00\x00\x81\x00\x09\x05\x0a",
         48);
  res = -1;
  res = syz_usb_connect(0, 0x36, 0x20000300, 0);
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x200000c0 = 0x14;
  *(uint64_t*)0x200000c4 = 0x20000100;
  memcpy((void*)0x20000100,
         "\x00\x80\xea\x00\x00\x00\x84\x04\x08\x75\x71\x34\xce\x24\xc8\xb4\xbd"
         "\x98\x53\xd3\xb7\x47\x73\x06\x06\xcc\x54\xd1\xde\x05\x0e\xb1\x11\x51"
         "\x00\x00\x00\x00\xc1\xe7\xe7\x1c\xc7\x0b\xe0\xa1\x68\xaf\xd7\xfc\x06"
         "\x00\x00\x00\x00\x00\x00\x00\x3c\x96\xb9\xb8\x83",
         63);
  *(uint64_t*)0x200000cc = 0;
  syz_usb_control_io(r[0], 0x200000c0, 0);
  return 0;
}
