...
// https://syzkaller.appspot.com/bug?id=3df32ec144d7fabbe9ccba77061f554cab333794
// status:open
...
void execute_call(int call)
{
  ...
  case 4:
    ...
    syscall(__NR_mount, 0, 0x200000c0, 0x20000280, 0, 0);
    break;
  case 5:
  ...
  case 6:
    ...
    *(uint64_t*)0x20000208 = 0xfdad;
    syscall(__NR_preadv, r[1], 0x20000200, 1, 0xfebfffff);
    break;
  case 7:
    syscall(__NR_mmap, 0x20004000, 0x4000, 3, 0x11, r[1], 0);
    break;
  }
}
int main(void)
