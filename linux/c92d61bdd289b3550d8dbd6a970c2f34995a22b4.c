...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_clone, 0x2102009ff8, 0, 0x9999999999999999, 0, -1);
    break;
  case 1:
    NONFAILING(
        memcpy((void*)0x20000040,
               "nat\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"
               "\000\000\000\000\000\000\000\000\000\006\000\000\000\000",
               32));
    NONFAILING(*(uint32_t*)0x20000060 = 0x19);
    NONFAILING(*(uint32_t*)0x20000064 = 2);
    NONFAILING(*(uint32_t*)0x20000068 = 0x130);
    NONFAILING(*(uint64_t*)0x20000070 = 0x20000280);
    NONFAILING(*(uint64_t*)0x20000078 = 0);
    NONFAILING(*(uint64_t*)0x20000080 = 0);
    NONFAILING(*(uint64_t*)0x20000088 = 0x20000350);
    ...
    NONFAILING(*(uint64_t*)0x200000b0 = 0x20000280);
    ...
    NONFAILING(*(uint32_t*)0x200002a8 = -1);
    NONFAILING(*(uint32_t*)0x200002ac = 1);
    NONFAILING(*(uint32_t*)0x200002b0 = 0xb);
    NONFAILING(*(uint32_t*)0x200002b4 = 0);
    NONFAILING(*(uint16_t*)0x200002b8 = htobe16(0));
    NONFAILING(memcpy((void*)0x200002ba, "bridge_slave_0\000\000", 16));
    NONFAILING(memcpy((void*)0x200002ca,
                      "sit0\000\000\000\000\000\000\000\000\000\000\000\000",
                      16));
    NONFAILING(
        memcpy((void*)0x200002da, "ip6gretap0\000\000\000\000\a\377", 16));
    NONFAILING(memcpy((void*)0x200002ea,
                      "ipddp0\000\000\000\000\000\000\000\000\000\000", 16));
    NONFAILING(*(uint8_t*)0x200002fa = -1);
    NONFAILING(*(uint8_t*)0x200002fb = -1);
    NONFAILING(*(uint8_t*)0x200002fc = -1);
    NONFAILING(*(uint8_t*)0x200002fd = -1);
    NONFAILING(*(uint8_t*)0x200002fe = -1);
    NONFAILING(*(uint8_t*)0x200002ff = -1);
    ...
    NONFAILING(*(uint8_t*)0x20000306 = 0xaa);
    NONFAILING(*(uint8_t*)0x20000307 = 0xaa);
    NONFAILING(*(uint8_t*)0x20000308 = 0xaa);
    NONFAILING(*(uint8_t*)0x20000309 = 0xaa);
    NONFAILING(*(uint8_t*)0x2000030a = 0xaa);
    ...
    NONFAILING(*(uint32_t*)0x20000314 = 0x70);
    NONFAILING(*(uint32_t*)0x20000318 = 0x70);
    NONFAILING(*(uint32_t*)0x2000031c = 0xa0);
    NONFAILING(
    ...
    NONFAILING(*(uint32_t*)0x20000378 = -1);
    ...
    NONFAILING(memcpy(
        ...
        "\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000",
        32));
    NONFAILING(*(uint32_t*)0x200003a4 = 1);
    NONFAILING(*(uint32_t*)0x200003a8 = 0);
    NONFAILING(*(uint32_t*)0x200003ac = 0);
    syscall(__NR_setsockopt, -1, 0, 0x80, 0x20000040, 0x1a8);
    break;
  case 2:
    syscall(__NR_clone, 0x2102009ff8, 0, 0x9999999999999999, 0, -1);
    break;
  ...
  case 4:
    ...
    NONFAILING(memcpy(
        (void*)0x20000340,
        "\xb8\x00\x00\x00\x19\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\xff"
        "\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\xe0\x00"
    ...
    NONFAILING(memcpy(
        ...
        "\x08\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x20\x00\x00\x00\x20\x00"
        "\x00\x00\x46\x50\x40\x00\x00\x00\x00\xc7\x00\x00\x00\x00\x00\x00\x00"
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xf2\x7a\x00\x00\x04\xad\x7c"
        "\x63\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x1b\x00\x00"
        "\x00\x00\x00\xd9\x00\x00\x00\x00\x00\x80\x00\x00\x00\x96\xb0\x8e\xce"
