...
// https://syzkaller.appspot.com/bug?id=6c62f40ebb8f17398b7531d171e6dfe994b4f9b9
// status:open
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_openat, 0xffffffffffffff9c, 0, 0x655e4d6ff93b4edb, 0);
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x20000a00 = 0);
    NONFAILING(*(uint16_t*)0x20000a04 = 0);
    NONFAILING(*(uint16_t*)0x20000a06 = 0x70);
    NONFAILING(memcpy(
        (void*)0x20000a08,
        "\x8b\xa7\x55\x9f\x46\x71\x2c\x87\x39\x01\x4a\x4f\x76\x13\xa6\xa5\x58"
        "\xfd\x1d\xcd\xc6\xb1\x00\xf1\x2d\xaf\xc0\x07\xc7\xa9\xe2\xe2\x00\xd3"
        "\xda\xb5\x33\xfd\x79\x26\x9b\x5c\xe4\x92\xad\x67\xfc\xe1\x49\x20\xbf"
        "\xb2\x39\xef\xc2\x8d\xa7\xb8\xf1\xf9\x0a\xd4\xd4\x44\x7a\x66\xdc\xdb"
        "\xd6\xf9\xad\x65\x64\x29\x36\xde\xe1\xf4\x8f\x3d\xdf\x36\x92\x9f\x72"
        "\x38\x64\x13\xdc\x9a\x7a\x3b\xee\xab\xac\x21\xbe\xf3\x92\x9c\x5f\xb8"
        "\x32\xee\x97\x31\x3d\x09\x6b\x5c\x85\x8a",
        112));
    syscall(__NR_setsockopt, -1, 0x84, 0x17, 0x20000a00, 0x78);
    break;
  case 5:
    ...
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000100, "/dev/amidi#\000", 12));
    res = syz_open_dev(0x20000100, 0x101, 0x400);
    if (res != -1)
      r[2] = res;
    break;
  case 7:
    NONFAILING(*(uint16_t*)0x20000b80 = 0x10);
    NONFAILING(*(uint16_t*)0x20000b82 = 0);
    NONFAILING(*(uint32_t*)0x20000b84 = 0);
    NONFAILING(*(uint32_t*)0x20000b88 = 8);
    NONFAILING(*(uint64_t*)0x20000c00 = 0x20000ac0);
    NONFAILING(*(uint64_t*)0x20000c08 = 0xbc);
    NONFAILING(*(uint64_t*)0x20000c10 = 0);
    NONFAILING(*(uint64_t*)0x20000c18 = 4);
    syscall(__NR_setsockopt, r[2], 0x114, 7, 0x20000b80, 0xa0);
    break;
  case 8:
    NONFAILING(*(uint32_t*)0x200005c0 = 0xe8);
    res = syscall(__NR_getsockopt, -1, 0x29, 0x22, 0x200004c0, 0x200005c0);
    if (res != -1)
      NONFAILING(r[3] = *(uint32_t*)0x200004f4);
    break;
  case 9:
  ...
  case 12:
    ...
    break;
  case 13:
    NONFAILING(memcpy((void*)0x20000380, "system.posix_acl_default\000", 25));
    NONFAILING(memcpy(
        (void*)0x200003c0,
        "\x02\x20\x00\x00\x01\x00\x06\x00\x00\x00\x00\x00\x02\x00\x06\x00",
        16));
    NONFAILING(*(uint32_t*)0x200003d0 = -1);
    NONFAILING(memcpy((void*)0x200003d4, "\x02\x00\x03\x00", 4));
    NONFAILING(*(uint32_t*)0x200003d8 = r[3]);
    NONFAILING(*(uint32_t*)0x200003dc = -1);
    NONFAILING(*(uint32_t*)0x200003e0 = r[3]);
    NONFAILING(*(uint32_t*)0x200003e4 = -1);
    syscall(__NR_fsetxattr, r[0], 0x20000380, 0x200003c0, 0xa, 3);
    break;
  case 14:
  ...
  case 16:
    ...
    break;
  case 17:
    NONFAILING(memcpy((void*)0x20000100, "/dev/sequencer2\000", 16));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000100, 0, 0);
    if (res != -1)
      r[5] = res;
    break;
  case 18:
    syscall(__NR_ioctl, -1, 0x8004510b, 0);
    break;
  case 19:
    NONFAILING(*(uint32_t*)0x20000240 = 0x48);
    syscall(__NR_accept4, r[1], 0x200002c0, 0x20000240, 0x800);
    break;
  case 20:
    NONFAILING(*(uint32_t*)0x20000200 = 0);
    syscall(__NR_getsockopt, r[5], 0x84, 9, 0, 0x20000200);
    break;
  case 21:
    syscall(__NR_ioctl, -1, 0x5417, 0);
    break;
  }
}
int main(void)
