// KASAN: use-after-free Read in hso_probe
// https://syzkaller.appspot.com/bug?id=3930f3e416920885c9d4
// status:3
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x20000005 = 0x32;
  *(uint8_t*)0x20000006 = 0xf7;
  *(uint8_t*)0x20000007 = 0x20;
  *(uint16_t*)0x20000008 = 0xaf0;
  *(uint16_t*)0x2000000a = 0xd257;
  *(uint16_t*)0x2000000c = 0x4e87;
  ...
  *(uint64_t*)0x20000084 = 0x200000c0;
  memcpy((void*)0x200000c0, "\x00\x00\x01\x01\x00\x00\x0b", 7);
