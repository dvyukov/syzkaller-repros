...
// https://syzkaller.appspot.com/bug?id=348b571beb5eeb70a582
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint16_t*)0x20000402 = 0x200);
    NONFAILING(*(uint8_t*)0x20000404 = -1);
    NONFAILING(*(uint8_t*)0x20000405 = -1);
    NONFAILING(*(uint8_t*)0x20000406 = -1);
    NONFAILING(*(uint8_t*)0x20000407 = 0x40);
    NONFAILING(*(uint16_t*)0x20000408 = 0xcf3);
    NONFAILING(*(uint16_t*)0x2000040a = 0x9271);
    NONFAILING(*(uint16_t*)0x2000040c = 0x108);
    NONFAILING(*(uint8_t*)0x2000040e = 1);
    NONFAILING(*(uint8_t*)0x2000040f = 2);
    NONFAILING(*(uint8_t*)0x20000410 = 3);
    NONFAILING(*(uint8_t*)0x20000411 = 1);
    NONFAILING(*(uint8_t*)0x20000412 = 9);
    NONFAILING(*(uint8_t*)0x20000413 = 2);
    NONFAILING(*(uint16_t*)0x20000414 = 0x48);
    NONFAILING(*(uint8_t*)0x20000416 = 1);
    NONFAILING(*(uint8_t*)0x20000417 = 1);
    NONFAILING(*(uint8_t*)0x20000418 = 0);
    NONFAILING(*(uint8_t*)0x20000419 = 0x80);
    NONFAILING(*(uint8_t*)0x2000041a = 0xfa);
    ...
    NONFAILING(*(uint8_t*)0x2000041f = 6);
    ...
    NONFAILING(*(uint8_t*)0x20000426 = 1);
    NONFAILING(*(uint8_t*)0x20000427 = 2);
    NONFAILING(*(uint16_t*)0x20000428 = 0x200);
    ...
    NONFAILING(*(uint8_t*)0x2000042f = 0x82);
    NONFAILING(*(uint8_t*)0x20000430 = 2);
    NONFAILING(*(uint16_t*)0x20000431 = 0x200);
    NONFAILING(*(uint8_t*)0x20000433 = 0);
    NONFAILING(*(uint8_t*)0x20000434 = 0);
    NONFAILING(*(uint8_t*)0x20000435 = 0);
    NONFAILING(*(uint8_t*)0x20000436 = 9);
    NONFAILING(*(uint8_t*)0x20000437 = 5);
    NONFAILING(*(uint8_t*)0x20000438 = 0x83);
    NONFAILING(*(uint8_t*)0x20000439 = 3);
    NONFAILING(*(uint16_t*)0x2000043a = 0x40);
    NONFAILING(*(uint8_t*)0x2000043c = 1);
    NONFAILING(*(uint8_t*)0x2000043d = 0);
    NONFAILING(*(uint8_t*)0x2000043e = 0);
    NONFAILING(*(uint8_t*)0x2000043f = 9);
    NONFAILING(*(uint8_t*)0x20000440 = 5);
    NONFAILING(*(uint8_t*)0x20000441 = 4);
    NONFAILING(*(uint8_t*)0x20000442 = 3);
    NONFAILING(*(uint16_t*)0x20000443 = 0x40);
    NONFAILING(*(uint8_t*)0x20000445 = 1);
    NONFAILING(*(uint8_t*)0x20000446 = 0);
    NONFAILING(*(uint8_t*)0x20000447 = 0);
    NONFAILING(*(uint8_t*)0x20000448 = 9);
    NONFAILING(*(uint8_t*)0x20000449 = 5);
    NONFAILING(*(uint8_t*)0x2000044a = 5);
    NONFAILING(*(uint8_t*)0x2000044b = 2);
    NONFAILING(*(uint16_t*)0x2000044c = 0x200);
    NONFAILING(*(uint8_t*)0x2000044e = 0);
    NONFAILING(*(uint8_t*)0x2000044f = 0);
    NONFAILING(*(uint8_t*)0x20000450 = 0);
    NONFAILING(*(uint8_t*)0x20000451 = 9);
    NONFAILING(*(uint8_t*)0x20000452 = 5);
    NONFAILING(*(uint8_t*)0x20000453 = 6);
    NONFAILING(*(uint8_t*)0x20000454 = 2);
    NONFAILING(*(uint16_t*)0x20000455 = 0x200);
    NONFAILING(*(uint8_t*)0x20000457 = 0);
    NONFAILING(*(uint8_t*)0x20000458 = 0);
    NONFAILING(*(uint8_t*)0x20000459 = 0);
    res = -1;
    NONFAILING(res = syz_usb_connect_ath9k(3, 0x5a, 0x20000400, 0));
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    ...
    NONFAILING(*(uint16_t*)0x20000482 = htobe16(8));
    NONFAILING(memcpy((void*)0x20000484, "\xbe\xed\x63\x93", 4));
    NONFAILING(*(uint16_t*)0x20000488 = htobe16(1));
    NONFAILING(*(uint16_t*)0x2000048a = htobe16(0x3ff));
    NONFAILING(*(uint16_t*)0x2000048c = htobe16(0x20));
    NONFAILING(*(uint8_t*)0x2000048e = 3);
    NONFAILING(*(uint8_t*)0x2000048f = 1);
    NONFAILING(syz_usb_ep_write(r[0], 2, 0x10, 0x20000480));
    break;
  }
}
int main(void)
