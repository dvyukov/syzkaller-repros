...
// https://syzkaller.appspot.com/bug?id=ae488dc136a4cc6ba32b
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    *(uint64_t*)0x20000180 = 0x20;
    *(uint64_t*)0x20000188 = 0x200000c0;
    memcpy((void*)0x200000c0, "\xb9\x80\x00\x00\xc0\x0f\x32\x2e\x0f\x01\x78\x00"
                              "\x0f\x30\x9a\x09\x00\x00\x00\x65\x00\x2e\xd8\xdd"
                              "\xc7\x44\x24\x00\x8f\xc4\xbd\x87\xc7\x44\x24\x02"
                              "\xc4\x3a\x72\x7f\xc7\x44\x24\x06\x00\x00\x00\x00"
                              "\x0f\x01\x14\x24\xf3\x0f\x09\x0f\x01\x3a\x36\x0f"
                              "\x06\xc4\xc1\x8d\x72\xd6\x83\xed",
           68);
    *(uint64_t*)0x20000190 = 0x44;
    syz_kvm_setup_cpu(-1, -1, 0x20fe7000, 0x20000180, 1, 0, 0, 0);
    break;
  case 3:
  ...
  case 5:
    ...
    *(uint64_t*)0x20000348 = 0;
    syscall(__NR_ioctl, r[2], 0x4090ae82, 0x200002c0ul);
    break;
  case 6:
  ...
  case 7:
    memcpy((void*)0x20000480,
           "\x02\x00\x00\x00\x14\x80\x00\x00\x01\x00\x00\x00\x00\x66\x09\x00"
           "\x00\x00\x00\x00\x00\x00\x00\x33\xc4\x58\x74\x76\xff\xf0\xb6\x00"
           "\x00\x00\x00\x09\x2a\x22\x1c\xe4\x75\x49\xbc\x00\x00\x00\x00\x00"
           "\x0a\x00\x00\x00\x00\x08\x00\x00\x00\x19\xb1\x17\x92",
           61);
    syscall(__NR_ioctl, r[2], 0x4008ae90, 0x20000480ul);
    break;
  case 8:
    syscall(__NR_ioctl, r[2], 0xae80, 0ul);
    break;
