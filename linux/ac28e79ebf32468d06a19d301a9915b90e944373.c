...
// https://syzkaller.appspot.com/bug?id=ac28e79ebf32468d06a19d301a9915b90e944373
// status:fixed
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    NONFAILING(
        STORE_BY_BITMASK(uint64_t, 0x2001d028, 0xfffffffffffffffe, 9, 1));
  ...
  case 4:
    ...
    NONFAILING(*(uint64_t*)0x200002c8 = 6);
    NONFAILING(*(uint64_t*)0x200002d0 = 0x20000040);
    NONFAILING(*(uint16_t*)0x200002d8 = 0x106);
    NONFAILING(*(uint8_t*)0x200002da = 0xf);
    NONFAILING(*(uint8_t*)0x200002db = 0);
    NONFAILING(*(uint8_t*)0x200002dc = 0);
    NONFAILING(*(uint8_t*)0x200002dd = 0);
    NONFAILING(*(uint8_t*)0x200002de = 0);
    NONFAILING(*(uint8_t*)0x200002df = 0);
    res = syscall(__NR_write, r[0], 0x200002c0, 0x20);
    if (res != -1)
  ...
  case 5:
    ...
    syscall(__NR_write, r[0], 0x20000240, 0x48);
    break;
  case 6:
    syscall(__NR_getrandom, 0x20000340, 0x33, 3);
    break;
  case 7:
    NONFAILING(memcpy((void*)0x20000200, "/dev/infiniband/rdma_cm", 24));
  ...
  case 8:
    ...
    NONFAILING(*(uint16_t*)0x20000144 = 0xe);
    NONFAILING(*(uint16_t*)0x20000146 = 0xfa00);
    NONFAILING(*(uint64_t*)0x20000148 = 0x20000100);
    NONFAILING(*(uint32_t*)0x20000150 = r[1]);
    NONFAILING(*(uint32_t*)0x20000154 = r[0]);
    syscall(__NR_write, r[2], 0x20000140, 0x293);
    break;
  }
}
int main(void)
