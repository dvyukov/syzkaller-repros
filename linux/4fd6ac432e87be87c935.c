...
// https://syzkaller.appspot.com/bug?id=4fd6ac432e87be87c935
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    syscall(__NR_utimensat, -1, 0x20000200ul, 0ul, 0ul);
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000140, "veth1_macvtap\000\000\000", 16));
    NONFAILING(*(uint32_t*)0x20000150 = 7);
    syscall(__NR_ioctl, -1, 0, 0x20000140ul);
    break;
  case 3:
  ...
  case 7:
    ...
    syscall(__NR_getsockopt, -1, 1, 0x20, 0ul, 0x20000180ul);
    break;
  case 8:
    ...
    syscall(__NR_utimensat, -1, 0ul, 0x20000280ul, 0ul);
    break;
  case 9:
    syscall(__NR_ioctl, -1, 0xc0385720, 0ul);
    break;
  case 10:
  ...
  case 11:
    ...
    break;
  case 12:
    syscall(__NR_ioctl, r[0], 0x5429, 0ul);
    break;
  case 13:
    syscall(__NR_perf_event_open, 0ul, 0, 3ul, -1, 8ul);
    break;
  }
}
int main(void)
