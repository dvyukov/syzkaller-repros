...
{
  intptr_t res = 0;
  syscall(__NR_rt_sigprocmask, 0, 0, 0, 0);
  res = syscall(__NR_socket, 0xa, 0x800000000000002, 0);
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x20000080 = 1;
  *(uint32_t*)0x20000084 = 0;
  syscall(__NR_setsockopt, r[0], 1, 0x3c, 0x20000080, 8);
  ...
  *(uint32_t*)0x20000158 = 0;
  syscall(__NR_sendto, r[0], 0, 0, 0x8000, 0x20000140, 0x1c);
  syscall(__NR_sendto, r[0], 0, 4, 0xff600000, 0, 0);
}
int main(void)
{
