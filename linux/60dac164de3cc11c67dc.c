...
// https://syzkaller.appspot.com/bug?id=60dac164de3cc11c67dc
// status:0
...
void execute_one(void)
{
  ...
  *(uint16_t*)0x200001ee = 0;
  ...
  syscall(__NR_setsockopt, -1, 1, 0x32, 0ul, 0ul);
}
int main(void)
{
