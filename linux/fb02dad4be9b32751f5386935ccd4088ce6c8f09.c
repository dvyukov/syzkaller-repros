...
void execute_call(int call)
{
  ...
  case 6:
    *(uint32_t*)0x200000c0 = 4;
    syscall(__NR_setsockopt, r[3], 0x11b, 3, 0x200000c0, 0x1fe);
    break;
  case 7:
    ...
    *(uint32_t*)0x20000114 = 0;
    syscall(__NR_setsockopt, r[3], 0x11b, 4, 0x20000100, 0x12);
    break;
  case 8:
    *(uint32_t*)0x20000240 = 8;
    syscall(__NR_setsockopt, r[3], 0x11b, 5, 0x20000240, 0x10000000b);
    break;
  case 9:
    *(uint32_t*)0x200002c0 = 0x80;
    syscall(__NR_setsockopt, r[3], 0x11b, 6, 0x200002c0, 4);
    break;
  case 10:
    *(uint16_t*)0x20000300 = 0x2c;
    *(uint16_t*)0x20000302 = 0;
    *(uint32_t*)0x20000304 = r[2];
    *(uint32_t*)0x20000308 = 0;
    *(uint32_t*)0x2000030c = -1;
    syscall(__NR_bind, r[3], 0x20000300, 0x10);
    break;
  }
}
int main(void)
