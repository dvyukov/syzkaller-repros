...
// https://syzkaller.appspot.com/bug?id=e7b7d0a1d17c8ec2e943
// status:0
...
void loop(void)
{
  ...
  *(uint8_t*)0x20000007 = 0;
  ...
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x20000340, "nl80211\000", 8);
  res = -1;
  res = syz_genetlink_get_family_id(0x20000340);
  if (res != -1)
    r[2] = res;
  res = syscall(__NR_socket, 0x10ul, 3ul, 0x10);
  if (res != -1)
  ...
  memcpy((void*)0x20000180, "wlan1\000\000\000\000\000\000\000\000\000\000\000",
         16);
  res = syscall(__NR_ioctl, r[3], 0x8933, 0x20000180ul);
  if (res != -1)
    r[4] = *(uint32_t*)0x20000190;
