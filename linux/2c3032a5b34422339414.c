...
// https://syzkaller.appspot.com/bug?id=2c3032a5b34422339414
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint8_t*)0x20000148 = 0xe3);
    ...
    NONFAILING(*(uint64_t*)0x20000150 = 3);
    NONFAILING(*(uint64_t*)0x20000158 = 0x20);
    ...
    NONFAILING(*(uint64_t*)0x20000188 = 0x4008);
    NONFAILING(*(uint64_t*)0x20000190 = 0x18);
    NONFAILING(*(uint32_t*)0x20000198 = 0);
    NONFAILING(*(uint32_t*)0x2000019c = 3);
  ...
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_readahead, r[1], 6ul, 0ul);
    break;
  case 4:
  ...
  case 5:
    ...
    break;
  case 6:
    NONFAILING(*(uint16_t*)0x200000c0 = 0x11);
    NONFAILING(memcpy(
        (void*)0x200000c2,
        "\x00\x00\x01\x00\x00\x00\x00\x00\x08\x00\xff\x7f\x4e\xeb\xa7\x1a\x49"
        ...
        "\x6d\x3a\x09\xff\xc2\xc9\x54",
        126));
    syscall(__NR_bind, r[2], 0x200000c0ul, 0x80ul);
    break;
  case 7:
    syscall(__NR_ftruncate, -1, 0x2008002ul);
    break;
  case 8:
    syscall(__NR_sendfile, r[0], -1, 0ul, 0x200ffful);
    break;
  }
}
int main(void)
