...
// https://syzkaller.appspot.com/bug?id=a208d87dc07db7e0920f
// status:0
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    NONFAILING(memcpy((void*)0x20000680, "upperdir", 8));
    NONFAILING(*(uint8_t*)0x20000688 = 0x3d);
    NONFAILING(memcpy((void*)0x20000689, "./file1", 7));
    NONFAILING(*(uint8_t*)0x20000690 = 0x2c);
    NONFAILING(memcpy((void*)0x20000691, "lowerdir", 8));
    NONFAILING(*(uint8_t*)0x20000699 = 0x3d);
    NONFAILING(memcpy((void*)0x2000069a, "./bus", 5));
    NONFAILING(*(uint8_t*)0x2000069f = 0x2c);
    NONFAILING(memcpy((void*)0x200006a0, "workdir", 7));
    NONFAILING(*(uint8_t*)0x200006a7 = 0x3d);
    NONFAILING(memcpy((void*)0x200006a8, "./file0", 7));
    NONFAILING(*(uint8_t*)0x200006af = 0x2c);
    NONFAILING(*(uint8_t*)0x200006b0 = 0);
    syscall(__NR_mount, 0x400002ul, 0x20000000ul, 0x20000100ul, 0ul,
            0x20000680ul);
    break;
  case 4:
    NONFAILING(memcpy((void*)0x200002c0, "./file1/file0\000", 14));
    syscall(__NR_open, 0x200002c0ul, 0x64440ul, 0ul);
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20000340, "./bus\000", 6));
    syscall(__NR_chdir, 0x20000340ul);
    break;
  case 6:
  ...
  case 8:
    ...
    NONFAILING(memcpy((void*)0x20000440, "security.capability\000", 20));
    syscall(__NR_setxattr, 0x20000080ul, 0x20000440ul, 0ul, 0ul, 0ul);
    break;
  case 9:
    syscall(__NR_ioctl, -1, 0xae01, 0ul);
    break;
  case 10:
  ...
  case 12:
    ...
    NONFAILING(memcpy((void*)0x20000240, "lowerdir=.:file0", 16));
    syscall(__NR_mount, 0ul, 0x20000200ul, 0x200000c0ul, 0ul, 0x20000240ul);
    break;
  case 13:
    NONFAILING(memcpy((void*)0x20000240, "./file1\000", 8));
    syscall(__NR_mkdir, 0x20000240ul, 0ul);
  ...
  case 15:
    ...
    NONFAILING(memcpy((void*)0x20000680,
                      "upperdir=./bus,workdir=./file1,lowerdir=./file0", 47));
    syscall(__NR_mount, 0ul, 0x20000040ul, 0x20000080ul, 0ul, 0x20000680ul);
    break;
  case 16:
    NONFAILING(memcpy((void*)0x20000580, "./bus/file0\000", 12));
    syscall(__NR_rmdir, 0x20000580ul);
    break;
  }
}
int main(void)
