...
// https://syzkaller.appspot.com/bug?id=856297c51366950e115e
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x200002c0 = 0x20000300;
  memcpy((void*)0x20000300, "ext4_journal_start\000", 19);
  *(uint32_t*)0x200002c8 = r[0];
  res = syscall(__NR_bpf, 0x11ul, 0x200002c0ul, 0x10ul);
  if (res != -1)
    r[1] = res;
  *(uint32_t*)0x20000200 = 0x18;
  *(uint32_t*)0x20000204 = 3;
