...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000400, "team", 5));
    res = syscall(__NR_memfd_create, 0x20000400, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20042ff3, "/dev/snd/seq", 13));
    res = syz_open_dev(0x20042ff3, 0, 0x20002);
    if (res != -1)
      r[1] = res;
    break;
  case 2:
    ...
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000040, "/dev/input/mice", 16));
  ...
  case 4:
    ...
    NONFAILING(memcpy(
        (void*)0x200000cc,
        "\x71\x75\x65\x75\x65\x31\x00\x00\x00\x00\x00\x00\x00\x00\x31\x3b\x00"
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
        "\x00\x00\x06\x00\x00\x00\x00\x00\xcc\xbf\x7d\xdd\x00\x00\x00\x00\x00"
    ...
    syscall(__NR_ioctl, r[1], 0xc08c5332, 0x200000c0);
    break;
  case 5:
    NONFAILING(*(uint32_t*)0x200001c0 = 0xf48b);
  ...
  case 6:
    ...
    NONFAILING(
        STORE_BY_BITMASK(uint64_t, 0x2001d028, 0xfffffffffffffffc, 11, 1));
