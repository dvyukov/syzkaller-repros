...
// https://syzkaller.appspot.com/bug?id=3695768a0017837349d596d97a36ece8e937a738
// status:open
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    syscall(__NR_mount, 0, 0x20000380, 0x20000340, 0, 0x20000600);
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x20000080 = 0x3ff);
    NONFAILING(*(uint32_t*)0x20000084 = 0x7fffffff);
    NONFAILING(*(uint32_t*)0x20000088 = 0x84e);
    NONFAILING(*(uint32_t*)0x2000008c = 0);
    NONFAILING(*(uint32_t*)0x20000090 = 0xfff);
    NONFAILING(*(uint64_t*)0x20000098 = 0);
    syscall(__NR_ioctl, r[0], 0x801c581f, 0x20000080);
    break;
  case 5:
  ...
  case 8:
    ...
    NONFAILING(*(uint8_t*)0x2000087b = 0);
