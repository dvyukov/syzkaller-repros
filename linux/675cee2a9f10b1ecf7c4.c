...
// https://syzkaller.appspot.com/bug?id=675cee2a9f10b1ecf7c4
// status:0
...
void loop(void)
{
  ...
  *(uint8_t*)0x20001201 = 0x2c;
  *(uint8_t*)0x20001202 = 0x11;
  *(uint8_t*)0x20001203 = 0;
  *(uint16_t*)0x20001204 = 0xc8;
  memset((void*)0x20001206, 170, 5);
  *(uint8_t*)0x2000120b = 0x10;
  *(uint8_t*)0x2000120c = 1;
  *(uint8_t*)0x2000120d = 5;
  *(uint8_t*)0x2000120e = 1;
  *(uint16_t*)0x2000120f = 0xfffb;
  *(uint16_t*)0x20001211 = 0x100;
  *(uint8_t*)0x20001213 = 4;
  syz_emit_vhci(0x20001200, 0x14);
  *(uint8_t*)0x20000180 = 4;
  *(uint8_t*)0x20000181 = 5;
  *(uint8_t*)0x20000182 = 4;
  *(uint8_t*)0x20000183 = 0;
  *(uint16_t*)0x20000184 = 0xc9;
  *(uint8_t*)0x20000186 = 0x81;
  syz_emit_vhci(0x20000180, 7);
}
int main(void)
{
