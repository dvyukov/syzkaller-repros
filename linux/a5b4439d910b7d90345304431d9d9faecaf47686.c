// kernel BUG at mm/kmsan/kmsan_instr.c:LINE!
// https://syzkaller.appspot.com/bug?id=a5b4439d910b7d90345304431d9d9faecaf47686
// status:invalid
...
{
  long res = 0;
  memcpy((void*)0x20000100, "/dev/kvm\x00", 9);
  ...
  syscall(__NR_socketpair, 1, 0x100000000005, 0, 0);
  ...
  *(uint32_t*)0x200002bc = 0;
  syscall(__NR_ioctl, r[1], 0x4040ae77, 0x20000280);
  syscall(__NR_ioctl, r[1], 0xae60);
  res = syscall(__NR_ioctl, r[1], 0xae41, 0);
  if (res != -1)
    r[2] = res;
  syscall(__NR_ioctl, r[1], 0x4070aea0, 0);
