...
// https://syzkaller.appspot.com/bug?id=1c1c0d391f04584c1611
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000780 = 0x200000c0;
  memcpy((void*)0x200000c0,
         "\xa4\x00\x00\x00\x24\x00\x0b\x0f\x00\x00\x00\x00\x00\x00\x00\x00\x00"
         "\x00\x12\x00",
         20);
  *(uint32_t*)0x200000d4 = r[1];
  memcpy((void*)0x200000d8,
         ...
         "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x15\x00\x00\x00\x00\x08"
  ...
  *(uint64_t*)0x20000008 = 0;
  syscall(__NR_clock_settime, 0ul, 0x20000000ul);
}
int main(void)
{
