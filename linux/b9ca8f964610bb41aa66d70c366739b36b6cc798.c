...
// https://syzkaller.appspot.com/bug?id=b9ca8f964610bb41aa66d70c366739b36b6cc798
// status:dup
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x20000023 = 0;
  ...
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x200008c0 = 0x54;
  *(uint64_t*)0x200008c4 = 0;
  *(uint64_t*)0x200008cc = 0x20000600;
  *(uint8_t*)0x20000600 = 0;
  *(uint8_t*)0x20000601 = 0xb;
  ...
  *(uint64_t*)0x2000090c = 0;
  syz_usb_control_io(r[0], 0, 0x200008c0);
}
int main(void)
{
