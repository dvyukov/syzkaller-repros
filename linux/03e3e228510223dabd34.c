...
// https://syzkaller.appspot.com/bug?id=03e3e228510223dabd34
// status:0
...
void loop(void)
{
  ...
  *(uint64_t*)0x200000c0 = 0x20000040;
  memcpy((void*)0x20000040,
         "\x60\x00\x00\x00\x03\x14\x01\x00\x2b\xbd\x70\x00\xfd\xdb\xdf\x25\x09"
         "\x00\x02\x00\x73\x79\x7a\x30\x00\x00\x00\x00\x08\x00\x41\x00\x72\x78"
         "\x65\x00\x14\x00\x33\x00\x76\x65\x74\x68\x30\x5f\x76\x6c\x61\x6e\x00"
         "\x00\x00\x00\x00\x00\x09\x00\x02\x00\x73\x79\x7a",
         63);
  *(uint64_t*)0x200000c8 = 0x60;
  *(uint64_t*)0x20000118 = 1;
  *(uint64_t*)0x20000120 = 0;
  *(uint64_t*)0x20000128 = 0;
  *(uint32_t*)0x20000130 = 5;
  syscall(__NR_sendmsg, r[0], 0x20000100ul, 0x4000000ul);
  res = -1;
  res = syz_init_net_socket(0x10, 3, 0x10);
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x200006c0, "SMC_PNETID\000", 11);
  res = -1;
  res = syz_genetlink_get_family_id(0x200006c0, -1);
  if (res != -1)
    r[2] = res;
  ...
  *(uint16_t*)0x20000020 = 9;
  *(uint16_t*)0x20000022 = 1;
  memcpy((void*)0x20000024, "syz2\000", 5);
