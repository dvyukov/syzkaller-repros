...
// https://syzkaller.appspot.com/bug?id=99938118dfd9e1b0741a
// status:0
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x200000fc = -1;
  syscall(__NR_io_submit, r[1], 0x1853ul, 0x20000540ul);
  memcpy((void*)0x200005c0, "./bus\000", 6);
  res = syscall(__NR_open, 0x200005c0ul, 0x64842ul, 0ul);
  if (res != -1)
    r[2] = res;
  *(uint64_t*)0x20000240 = 0x20000000;
  memset((void*)0x20000000, 133, 1);
  *(uint64_t*)0x20000248 = 0x307e00;
  syscall(__NR_pwritev2, r[2], 0x20000240ul, 1ul, 0x1400, 0, 3ul);
}
int main(void)
{
