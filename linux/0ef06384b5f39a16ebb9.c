...
// https://syzkaller.appspot.com/bug?id=0ef06384b5f39a16ebb9
// status:6
...
void loop(void)
{
  ...
  memcpy((void*)0x200001c0,
         "\x1c\x00\x00\x00\x12\x00\x05\x0f\x0c\x10\x00\x00\x00\x49\xb2\x3e\x9b"
         "\x20\x0a\x00\x08\x00\x01\xc0\x00\x00\x00\x01",
         28);
  syscall(__NR_sendto, r[0], 0x200001c0ul, 0x1cul, 0ul, 0ul, 0ul);
  ...
  *(uint64_t*)0x20003f10 = 0x20003d80;
  *(uint64_t*)0x20003d80 = 0x20000840;
  *(uint64_t*)0x20003d88 = 0xe3;
  *(uint64_t*)0x20003d90 = 0x20000940;
  *(uint64_t*)0x20003d98 = 0xd0;
  *(uint64_t*)0x20003da0 = 0x20001a40;
  *(uint64_t*)0x20003da8 = 0x1000;
  *(uint64_t*)0x20003db0 = 0x20002a40;
  *(uint64_t*)0x20003db8 = 0xaf;
  *(uint64_t*)0x20003dc0 = 0x20002b80;
  *(uint64_t*)0x20003dc8 = 0x1000;
  *(uint64_t*)0x20003dd0 = 0x20003b80;
  *(uint64_t*)0x20003dd8 = 0xf8;
  *(uint64_t*)0x20003f18 = 6;
  *(uint64_t*)0x20003f20 = 0;
  *(uint64_t*)0x20003f28 = 0;
  *(uint32_t*)0x20003f30 = 0;
  *(uint32_t*)0x20003f38 = 0;
  syscall(__NR_recvmmsg, r[0], 0x20003ec0ul, 2ul, 0ul, 0ul);
  ...
  *(uint32_t*)0x200003f0 = 0;
  syscall(__NR_recvmsg, r[0], 0x200003c0ul, 0ul, 0);
  syscall(__NR_recvfrom, r[0], 0ul, 0ul, 0ul, 0ul, 0ul);
  syscall(__NR_recvfrom, r[0], 0x20000000ul, 0xfffffffffffffd1bul, 0ul, 0ul,
          0ul);
  *(uint64_t*)0x20001700 = 0;
  *(uint32_t*)0x20001708 = 0;
  *(uint64_t*)0x20001710 = 0x20000a40;
  ...
  *(uint64_t*)0x20000a80 = 0x20000640;
  *(uint64_t*)0x20000a88 = 0xb4;
  *(uint64_t*)0x20001718 = 5;
  ...
  *(uint64_t*)0x20000190 = 0x20000500;
  *(uint64_t*)0x20000500 = 0x20000000;
  memcpy((void*)0x20000000, "\x01\x04\x00\x00", 4);
  *(uint16_t*)0x20000004 = 0;
  memcpy((void*)0x20000006,
         "\x01\x06\x00\x00\x00\x00\x94\x00\x0e\x00\x01\x80\x09\x00\xce\xff\x00"
         "\x95\x03\x02\xee\x00",
         22);
  *(uint32_t*)0x2000001c = -1;
  memcpy((void*)0x20000020, "\xc4\x00\x0a", 3);
  *(uint64_t*)0x20000508 = 0x34;
  *(uint64_t*)0x20000198 = 1;
  *(uint64_t*)0x200001a0 = 0;
  *(uint64_t*)0x200001a8 = 0;
  *(uint32_t*)0x200001b0 = 0;
  syscall(__NR_sendmsg, -1, 0x20000180ul, 0ul);
  memcpy((void*)0x20000000, "\x58\xad\x00\x00\x10", 5);
  syscall(__NR_sendto, -1, 0x20000000ul, 0x13ul, 0ul, 0ul,
          0xfffffffffffffc5dul);
  res = syscall(__NR_socket, 0x10ul, 3ul, 0);
  if (res != -1)
    r[1] = res;
  memset((void*)0x20000000, 37, 1);
  inject_fault(28);
  syscall(__NR_sendto, r[1], 0x20000000ul, 0xad2aul, 0x7812ul, 0ul,
          0x4b6ae4f95a5de394ul);
  close_fds();
}
int main(void)
{
