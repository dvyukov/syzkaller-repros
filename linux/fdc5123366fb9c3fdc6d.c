...
// https://syzkaller.appspot.com/bug?id=fdc5123366fb9c3fdc6d
// status:0 arch:386
...
uint64_t r[8] = {0xffffffffffffffff, 0xffffffffffffffff, 0x0, 0x0,
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x20002c40, "nl80211\000", 8);
  res = -1;
  res = syz_genetlink_get_family_id(0x20002c40);
  if (res != -1)
    r[2] = res;
  memcpy((void*)0x20002c80, "wlan0\000\000\000\000\000\000\000\000\000\000\000",
         16);
  res = syscall(__NR_ioctl, (intptr_t)r[0], 0x8933, 0x20002c80);
  if (res != -1)
    r[3] = *(uint32_t*)0x20002c90;
  *(uint32_t*)0x20003980 = 0;
  *(uint32_t*)0x20003984 = 0;
  *(uint32_t*)0x20003988 = 0x20003940;
  *(uint32_t*)0x20003940 = 0x20002cc0;
  *(uint32_t*)0x20002cc0 = 0x28;
  *(uint16_t*)0x20002cc4 = r[2];
  *(uint16_t*)0x20002cc6 = 1;
  *(uint32_t*)0x20002cc8 = 0;
  *(uint32_t*)0x20002ccc = 0;
  *(uint8_t*)0x20002cd0 = 0x39;
  *(uint8_t*)0x20002cd1 = 0;
  *(uint16_t*)0x20002cd2 = 0;
  *(uint16_t*)0x20002cd4 = 8;
  *(uint16_t*)0x20002cd6 = 3;
  *(uint32_t*)0x20002cd8 = r[3];
  *(uint16_t*)0x20002cdc = 0xc;
  STORE_BY_BITMASK(uint16_t, , 0x20002cde, 0x5a, 0, 14);
  STORE_BY_BITMASK(uint16_t, , 0x20002cdf, 0, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x20002cdf, 1, 7, 1);
  *(uint16_t*)0x20002ce0 = 8;
  STORE_BY_BITMASK(uint16_t, , 0x20002ce2, 0, 0, 14);
  STORE_BY_BITMASK(uint16_t, , 0x20002ce3, 0, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x20002ce3, 1, 7, 1);
  *(uint16_t*)0x20002ce4 = 4;
  *(uint16_t*)0x20002ce6 = 1;
  *(uint32_t*)0x20003944 = 0x28;
  *(uint32_t*)0x2000398c = 1;
  *(uint32_t*)0x20003990 = 0;
  *(uint32_t*)0x20003994 = 0;
  *(uint32_t*)0x20003998 = 0;
  syscall(__NR_sendmsg, (intptr_t)r[1], 0x20003980, 0);
  ...
  *(uint8_t*)0x20000085 = 1;
  syz_80211_join_ibss(0x20000000, 0x20000080, 5, 2);
  res = syscall(__NR_socket, 0x10, 3, 0x10);
  if (res != -1)
    r[4] = res;
  res = syscall(__NR_socket, 0x10, 3, 0x10);
  if (res != -1)
    r[5] = res;
  memcpy((void*)0x20000080, "wlan0\000\000\000\000\000\000\000\000\000\000\000",
         16);
  res = syscall(__NR_ioctl, (intptr_t)r[5], 0x8933, 0x20000080);
  if (res != -1)
  ...
  *(uint32_t*)0x20000348 = 0x20000300;
  *(uint32_t*)0x20000300 = 0x20000240;
  ...
  *(uint32_t*)0x20000358 = 0;
  syscall(__NR_sendmsg, (intptr_t)r[4], 0x20000340, 0);
}
int main(void)
{
