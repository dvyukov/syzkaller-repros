...
// https://syzkaller.appspot.com/bug?id=ea9832f8ae588deb0205
// status:0
...
void execute_call(int call)
{
  ...
  case 5:
    ...
    *(uint32_t*)0x20000084 = htobe32(0);
    memcpy((void*)0x20000088, "\x38\xc7\x56\x0f\x9d\x70", 6);
    ...
    *(uint32_t*)0x20001878 = 0;
    ...
    break;
  case 6:
    syscall(__NR_write, r[1], 0x20000080ul, 0xfffffeccul);
    break;
  case 7:
