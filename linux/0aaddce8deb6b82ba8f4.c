...
// https://syzkaller.appspot.com/bug?id=0aaddce8deb6b82ba8f4
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_clone, 0x180000105ul, 0ul, 0x9999999999999999ul, 0ul, -1ul);
    break;
  case 1:
    syscall(__NR_perf_event_open, 0ul, 0, 0ul, -1, 0xaul);
    break;
  case 2:
    res = -1;
    ...
    break;
  case 3:
    *(uint16_t*)0x20001200 = 0x1f;
    *(uint8_t*)0x20001202 = 0xaa;
    *(uint8_t*)0x20001203 = 0xaa;
    *(uint8_t*)0x20001204 = 0xaa;
    *(uint8_t*)0x20001205 = 0xaa;
    *(uint8_t*)0x20001206 = 0xaa;
    *(uint8_t*)0x20001207 = 0x10;
    syscall(__NR_connect, r[0], 0x20001200ul, 8ul);
    break;
  case 4:
  ...
  case 5:
    *(uint32_t*)0x20000140 = 0;
    syscall(__NR_getsockopt, -1, 0, 9, 0ul, 0x20000140ul);
    break;
  case 6:
    syscall(__NR_ioctl, -1, 0x80345631, 0x200001c0ul);
    break;
  }
}
int main(void)
