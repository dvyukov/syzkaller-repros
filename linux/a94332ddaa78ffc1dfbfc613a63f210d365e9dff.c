...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    memcpy((void*)0x20f7dff7, "/dev/kvm", 9);
    r[0] = syscall(__NR_openat, 0xffffffffffffff9c, 0x20f7dff7, 0, 0);
    break;
  case 2:
  ...
  case 3:
    ...
    break;
  case 4:
    r[3] = syscall(__NR_ioctl, r[1], 0xae41, 0);
    break;
  case 5:
    r[4] = syscall(__NR_dup3, r[3], r[2], 0);
    break;
  case 6:
  ...
  case 8:
    ...
    *(uint64_t*)0x20de9010 = 0x3b;
    memcpy((void*)0x20bfefbf, "\x0f\x20\xd8\x35\x20\x00\x00\x00\x0f\x22\xd8\x0f"
           ...
           59);
    syz_kvm_setup_cpu(r[1], -1, 0x20841000, 0x20de9000, 1, 0, 0x20076ff0, 0);
    break;
  case 9:
    syscall(__NR_mmap, 0x20000000, 0xfff000, 3, 0x32, -1, 0);
    break;
  case 10:
    syscall(__NR_mmap, 0x20000000, 0xae0000, 0, 0x4d031, -1, 0);
    break;
  case 11:
    syscall(__NR_mmap, 0x20000000, 0xfff000, 0, 0x32, -1, 0);
    break;
  case 12:
