...
// https://syzkaller.appspot.com/bug?id=964b905e146bce3a85b3cac2a8e7b05662a8c342
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000000, "/dev/ppp", 9));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000000, 0, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 2:
    syscall(__NR_fallocate, r[0], 8, 0xa, 0x80000001);
    break;
  case 3:
    ...
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x20001f88 = 1);
    NONFAILING(*(uint32_t*)0x20001f8c = 0x70);
    NONFAILING(*(uint8_t*)0x20001f90 = 0);
    NONFAILING(*(uint8_t*)0x20001f91 = 0);
    NONFAILING(*(uint8_t*)0x20001f92 = 0);
    NONFAILING(*(uint8_t*)0x20001f93 = 0);
    NONFAILING(*(uint32_t*)0x20001f94 = 0);
    NONFAILING(*(uint64_t*)0x20001f98 = 0);
    NONFAILING(*(uint64_t*)0x20001fa0 = 0);
    NONFAILING(*(uint64_t*)0x20001fa8 = 0);
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 0, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 1, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 2, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 3, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 4, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 5, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 7, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 8, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 9, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 10, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 11, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 12, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 13, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 14, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 15, 2));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 17, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 18, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 19, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 20, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 21, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 22, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 23, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 24, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 25, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 26, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 27, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 28, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20001fb0, 0, 29, 35));
    NONFAILING(*(uint32_t*)0x20001fb8 = 0);
    NONFAILING(*(uint32_t*)0x20001fbc = 0);
    NONFAILING(*(uint64_t*)0x20001fc0 = 0x20000fff);
    NONFAILING(*(uint64_t*)0x20001fc8 = 0);
    NONFAILING(*(uint64_t*)0x20001fd0 = 0);
    NONFAILING(*(uint64_t*)0x20001fd8 = 0);
    NONFAILING(*(uint32_t*)0x20001fe0 = 0);
    NONFAILING(*(uint32_t*)0x20001fe4 = 0);
    NONFAILING(*(uint64_t*)0x20001fe8 = 0);
    NONFAILING(*(uint32_t*)0x20001ff0 = 0);
    NONFAILING(*(uint16_t*)0x20001ff4 = 0);
    NONFAILING(*(uint16_t*)0x20001ff6 = 0);
    res = syscall(__NR_perf_event_open, 0x20001f88, 0, 0, -1, 0);
    if (res != -1)
      r[3] = res;
    break;
  case 5:
    syscall(__NR_mmap, 0x20bf0000, 0x2000, 0, 0x11, r[3], 0);
    break;
  case 6:
    syscall(__NR_ioctl, r[2], 0x2405, r[3]);
    break;
  case 7:
    syscall(__NR_mmap, 0x20941000, 0x2000, 0, 0x4011, r[2], 0);
    break;
  case 8:
    syscall(__NR_mremap, 0x2079c000, 0x2000, 0x800000, 3, 0x207fb000);
    break;
  case 9:
    syscall(__NR_ioctl, r[1], 0xc004743e, 0x20000140);
    break;
  }
}
int main(void)
