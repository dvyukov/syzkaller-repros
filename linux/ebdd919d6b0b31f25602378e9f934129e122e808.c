...
void execute_call(int call)
{
  ...
  case 4:
    ...
    *(uint32_t*)0x200002a4 = 0;
    ...
    break;
  case 5:
    memcpy((void*)0x20000440, "memory.events\000", 14);
    syscall(__NR_openat, 0xffffff9c, 0x20000440, 0x26e1, 0);
    break;
  case 6:
  ...
  case 8:
    *(uint64_t*)0x20000040 = 0;
    syscall(__NR_ioctl, r[2], 0x4030582a, 0x20000040);
    break;
  }
}
int main(void)
