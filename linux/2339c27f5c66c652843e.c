...
// https://syzkaller.appspot.com/bug?id=2339c27f5c66c652843e
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    *(uint8_t*)0x20000011 = 0;
    ...
    break;
  case 3:
    *(uint64_t*)0x20007200 = 0;
    *(uint32_t*)0x20007208 = 0;
    *(uint64_t*)0x20007210 = 0x20002880;
    *(uint64_t*)0x20002880 = 0x20001500;
    memset((void*)0x20001500, 5, 1);
    *(uint64_t*)0x20002888 = 1;
    *(uint64_t*)0x20007218 = 1;
    *(uint64_t*)0x20007220 = 0;
    *(uint64_t*)0x20007228 = 0;
    *(uint32_t*)0x20007230 = 0;
    *(uint32_t*)0x20007238 = 0;
    syscall(__NR_sendmmsg, r[0], 0x20007200ul, 1ul, 0ul);
    {
      int i;
      for (i = 0; i < 64; i++) {
        syscall(__NR_sendmmsg, r[0], 0x20007200ul, 1ul, 0ul);
  ...
  case 4:
    ...
    syz_genetlink_get_family_id(0x20000040, r[0]);
    {
      int i;
      for (i = 0; i < 64; i++) {
        syz_genetlink_get_family_id(0x20000040, r[0]);
