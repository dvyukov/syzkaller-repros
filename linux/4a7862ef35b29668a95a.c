...
// https://syzkaller.appspot.com/bug?id=4a7862ef35b29668a95a
// status:0
...
int main(void)
{
  ...
  *(uint64_t*)0x20000200 = 0x20010000;
  memcpy((void*)0x20010000, "\xce\xfa\xad\x1b\x00\x0e\x00\x00\xff\x7f", 10);
  ...
  *(uint8_t*)0x20010300 = 0;
  syz_mount_image(0x20000000, 0x20000100, 0x8000, 3, 0x20000200, 0, 0x20010300);
