...
// https://syzkaller.appspot.com/bug?id=c40e277e24c1587905bde140fcc23612870939f5
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_ioctl, r[0], 0x3000008912, 0);
    break;
  case 3:
  ...
  case 4:
    ...
    break;
  case 5:
    NONFAILING(*(uint64_t*)0x20000100 = 0x20000800);
    NONFAILING(memcpy(
        (void*)0x20000800,
        "\x58\x00\x00\x00\x14\x00\xad\xfd\x8a\x98\x7e\x40\xda\x2e\x6a\x26\x2b",
        17));
    NONFAILING(*(uint64_t*)0x20000108 = 0x11);
  ...
  case 6:
    ...
    break;
  case 7:
    syscall(__NR_socket, 0x10, 3, 4);
    break;
  case 8:
    syscall(__NR_write, r[2], 0x20000140, 0x4240a2a0);
    break;
  case 9:
    syscall(__NR_splice, r[1], 0, r[3], 0, 0x80000001, 0);
    break;
  }
}
int main(void)
