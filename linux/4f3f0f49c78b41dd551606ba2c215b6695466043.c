...
// https://syzkaller.appspot.com/bug?id=4f3f0f49c78b41dd551606ba2c215b6695466043
// status:open
...
void execute_one(void)
{
  ...
  NONFAILING(*(uint64_t*)0x20000040 = 0x20000140);
  NONFAILING(memcpy((void*)0x20000140,
                    "\x8d\xa4\x36\x3a\xc0\xed\x02\x00\x0a\x00\x00\x00\x00\x01"
  ...
  inject_fault(70);
  syz_mount_image(0x20000000, 0x200001c0, 0, 1, 0x20000040, 0, 0);
}
int main(void)
{
  inject_fault(70);
