...
// https://syzkaller.appspot.com/bug?id=3fbea977bd382a4e6140
// status:3
...
void loop(void)
{
  ...
  *(uint32_t*)0x20000314 = -1;
  memcpy((void*)0x20000318, "\xfe\x00\x00\x00\x00\x00\x00\x00\x1c\x00\x12\x00"
                            ...
                            "\x0c\x00\x02\x00\x08\x00\x01\x00\x01\x00\x61\x58"
  ...
  *(uint64_t*)0x20003180 = 0x20000240;
  *(uint32_t*)0x20000240 = 0x38;
  *(uint16_t*)0x20000244 = 0x1403;
  *(uint16_t*)0x20000246 = 1;
  *(uint32_t*)0x20000248 = 0;
  *(uint32_t*)0x2000024c = 0;
  *(uint16_t*)0x20000250 = 9;
  *(uint16_t*)0x20000252 = 2;
  memcpy((void*)0x20000254, "syz2\000", 5);
  *(uint16_t*)0x2000025c = 8;
  *(uint16_t*)0x2000025e = 0x41;
  memcpy((void*)0x20000260, "siw\000", 4);
  *(uint16_t*)0x20000264 = 0x14;
  *(uint16_t*)0x20000266 = 0x33;
  memcpy((void*)0x20000268, "netdevsim0\000\000\000\000\000\000", 16);
  *(uint64_t*)0x20003188 = 0x38;
  *(uint64_t*)0x200031d8 = 1;
  *(uint64_t*)0x200031e0 = 0;
  *(uint64_t*)0x200031e8 = 0;
  *(uint32_t*)0x200031f0 = 0;
  syscall(__NR_sendmsg, r[2], 0x200031c0ul, 0ul);
}
int main(void)
{
