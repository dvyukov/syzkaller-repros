...
// https://syzkaller.appspot.com/bug?id=29e1f6075bbe07b2beb6
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    memcpy((void*)0x20000195, ",rootmode=000000000100000,user_id=", 34);
    sprintf((char*)0x200001b7, "%020llu", (long long)0);
    memcpy((void*)0x200001cb, ",group_id=", 10);
    sprintf((char*)0x200001d5, "%020llu", (long long)0);
    syscall(__NR_mount, 0ul, 0x20000280ul, 0x20002100ul, 0ul, 0x20000180ul);
    break;
  case 3:
  ...
  case 9:
    ...
    *(uint64_t*)0x200002c8 = 0;
    syscall(__NR_write, r[2], 0x200002c0ul, 0x10ul);
    break;
  case 10:
