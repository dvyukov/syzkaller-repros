...
// https://syzkaller.appspot.com/bug?id=22794221ab96b0bab53a
// status:6
...
int main(void)
{
  ...
  *(uint8_t*)0x20000004 = 0x9e;
  *(uint8_t*)0x20000005 = 0xa7;
  *(uint8_t*)0x20000006 = 0x70;
  *(uint8_t*)0x20000007 = 0x40;
  *(uint16_t*)0x20000008 = 0x50c2;
  *(uint16_t*)0x2000000a = 0x4013;
  *(uint16_t*)0x2000000c = 0x7d0;
  ...
  *(uint8_t*)0x2000001d = 0x28;
  *(uint8_t*)0x2000001e = 0xfd;
  *(uint8_t*)0x2000001f = 2;
  *(uint8_t*)0x20000020 = 0x73;
  *(uint8_t*)0x20000021 = 0xeb;
  *(uint8_t*)0x20000022 = 0xa8;
  ...
  *(uint8_t*)0x2000002f = 0x8b;
  *(uint8_t*)0x20000030 = 0x1e;
  *(uint16_t*)0x20000031 = 0x3ff;
