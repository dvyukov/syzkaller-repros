...
// https://syzkaller.appspot.com/bug?id=ed8813d241a91de15965
// status:0
...
void loop(void)
{
  ...
  *(uint64_t*)0x20000018 = 0;
  syscall(__NR_ioctl, r[0], 0x89a2, 0x20000000ul);
  res = syscall(__NR_socket, 0xaul, 5ul, 0x84);
  if (res != -1)
    r[1] = res;
  *(uint64_t*)0x20000300 = 0;
  *(uint16_t*)0x20000308 = 0x1f;
  memset((void*)0x2000030a, 170, 5);
  *(uint8_t*)0x2000030f = 0;
  *(uint16_t*)0x20000318 = 0x1f;
  memset((void*)0x2000031a, 0, 6);
  *(uint8_t*)0x20000320 = 0;
  *(uint16_t*)0x20000328 = 0x1d;
  ...
  *(uint16_t*)0x20000370 = 0;
  syscall(__NR_ioctl, r[1], 0x89a0, 0x20000300ul);
}
int main(void)
{
