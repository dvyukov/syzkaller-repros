...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint8_t*)0x20000057 = 1);
  ...
  case 5:
    ...
    NONFAILING(*(uint64_t*)0x20000450 = 0x2000d000);
    NONFAILING(*(uint64_t*)0x2000d000 = 0x200000c0);
    NONFAILING(memcpy((void*)0x200000c0,
                      "\x4c\x00\x00\x00\x12\x00\xff\x09\xff\xfe\xfd\x95\x67\xa2"
                      "\x83\xb7\x24\xa6\x00\x80\x00\x00\x00\x00\x00\x00\x00\x68"
                      "\x35\x40\x46\x00\x2c\x00\x1d\x00\x1f\xc4\x00\x08\x00\x00"
                      "\xbc\x59\x3a\xb6\x82\x11\x48\xa7\x30\xde\x33\xa4\x98\x68"
                      "\xc6\x2b\x2c\xa6\x3d\x89\x61\x3b\x6a\xab\xf3\x5d\x4c\x1c"
                      "\xbc\x88\x2b\x07\x98\x81",
                      76));
    NONFAILING(*(uint64_t*)0x2000d008 = 0x4c);
    ...
    syscall(__NR_sendmsg, r[1], 0x20000440, 0);
    break;
  case 6:
    res = syscall(__NR_socket, 0x10, 3, 0);
    if (res != -1)
  ...
  case 7:
    ...
    syscall(__NR_ioctl, r[2], 0x89f0, 0x20000040);
    break;
  case 8:
    ...
    break;
  case 9:
    NONFAILING(*(uint32_t*)0x20fca000 = 1);
    NONFAILING(*(uint16_t*)0x20fca008 = 0xa);
    NONFAILING(*(uint16_t*)0x20fca00a = htobe16(0));
    NONFAILING(*(uint32_t*)0x20fca00c = 0);
    NONFAILING(*(uint8_t*)0x20fca010 = -1);
    NONFAILING(*(uint8_t*)0x20fca011 = 1);
    NONFAILING(*(uint8_t*)0x20fca012 = 0);
    NONFAILING(*(uint8_t*)0x20fca013 = 0);
    NONFAILING(*(uint8_t*)0x20fca014 = 0);
    NONFAILING(*(uint8_t*)0x20fca015 = 0);
    NONFAILING(*(uint8_t*)0x20fca016 = 0);
    NONFAILING(*(uint8_t*)0x20fca017 = 0);
    NONFAILING(*(uint8_t*)0x20fca018 = 0);
    NONFAILING(*(uint8_t*)0x20fca019 = 0);
    NONFAILING(*(uint8_t*)0x20fca01a = 0);
    NONFAILING(*(uint8_t*)0x20fca01b = 0);
    NONFAILING(*(uint8_t*)0x20fca01c = 0);
    NONFAILING(*(uint8_t*)0x20fca01d = 0);
    NONFAILING(*(uint8_t*)0x20fca01e = 0);
    NONFAILING(*(uint8_t*)0x20fca01f = 1);
    NONFAILING(*(uint32_t*)0x20fca020 = 0);
    syscall(__NR_setsockopt, r[3], 0x29, 0x2a, 0x20fca000, 0x88);
    break;
  case 10:
    NONFAILING(*(uint32_t*)0x20000180 = 1);
    NONFAILING(*(uint16_t*)0x20000188 = 0xa);
    NONFAILING(*(uint16_t*)0x2000018a = htobe16(0));
    NONFAILING(*(uint32_t*)0x2000018c = 0);
    NONFAILING(*(uint8_t*)0x20000190 = -1);
    ...
    NONFAILING(*(uint8_t*)0x2000019f = 1);
    NONFAILING(*(uint32_t*)0x200001a0 = 0);
    NONFAILING(*(uint32_t*)0x20000208 = 0);
    NONFAILING(*(uint32_t*)0x2000020c = 4);
    NONFAILING(*(uint16_t*)0x20000210 = 0xa);
    NONFAILING(*(uint16_t*)0x20000212 = htobe16(0x4e21));
    NONFAILING(*(uint32_t*)0x20000214 = 0x200);
    NONFAILING(*(uint8_t*)0x20000218 = 0xfe);
    NONFAILING(*(uint8_t*)0x20000219 = 0x80);
    ...
    NONFAILING(*(uint8_t*)0x20000227 = 0x21);
    NONFAILING(*(uint32_t*)0x20000228 = 3);
    NONFAILING(*(uint16_t*)0x20000290 = 0xa);
    NONFAILING(*(uint16_t*)0x20000292 = htobe16(0x4e22));
    NONFAILING(*(uint32_t*)0x20000294 = 2);
    NONFAILING(*(uint8_t*)0x20000298 = -1);
    NONFAILING(*(uint8_t*)0x20000299 = 1);
    ...
    NONFAILING(*(uint8_t*)0x200002a7 = 1);
    NONFAILING(*(uint32_t*)0x200002a8 = 3);
    NONFAILING(*(uint16_t*)0x20000310 = 0xa);
    NONFAILING(*(uint16_t*)0x20000312 = htobe16(0x4e22));
    ...
    NONFAILING(*(uint16_t*)0x20000390 = 0xa);
    NONFAILING(*(uint16_t*)0x20000392 = htobe16(0));
    NONFAILING(*(uint32_t*)0x20000394 = 0);
    NONFAILING(*(uint64_t*)0x20000398 = htobe64(0));
    NONFAILING(*(uint64_t*)0x200003a0 = htobe64(1));
    NONFAILING(*(uint32_t*)0x200003a8 = 0);
    syscall(__NR_setsockopt, r[3], 0x29, 0x30, 0x20000180, 0x290);
    break;
  case 11:
    res = syscall(__NR_socket, 0xa, 0x4000000000000002, 0);
    if (res != -1)
      r[4] = res;
    break;
  case 12:
    ...
    NONFAILING(*(uint8_t*)0x20000217 = 0xbb);
    NONFAILING(*(uint32_t*)0x20000218 = 2);
    syscall(__NR_connect, r[4], 0x20000200, 0x1c);
    break;
  case 13:
    ...
    NONFAILING(*(uint8_t*)0x20000094 = 0xac);
    NONFAILING(*(uint8_t*)0x20000095 = 0x14);
    NONFAILING(*(uint8_t*)0x20000096 = 0x14);
    NONFAILING(*(uint8_t*)0x20000097 = 0x21);
    NONFAILING(*(uint32_t*)0x20000098 = 0);
    NONFAILING(*(uint32_t*)0x20000148 = 0x80);
