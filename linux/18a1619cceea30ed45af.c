...
// https://syzkaller.appspot.com/bug?id=18a1619cceea30ed45af
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    memcpy((void*)0x200000c0, "./bus/file1\000", 12);
  ...
  case 4:
    ...
    memcpy((void*)0x20000340, "upperdir", 8);
    *(uint8_t*)0x20000348 = 0x3d;
    memcpy((void*)0x20000349, "./file1", 7);
    *(uint8_t*)0x20000350 = 0x2c;
    memcpy((void*)0x20000351, "lowerdir", 8);
    *(uint8_t*)0x20000359 = 0x3d;
    memcpy((void*)0x2000035a, "./bus", 5);
    *(uint8_t*)0x2000035f = 0x2c;
    memcpy((void*)0x20000360, "workdir", 7);
    *(uint8_t*)0x20000367 = 0x3d;
    memcpy((void*)0x20000368, "./file0", 7);
    *(uint8_t*)0x2000036f = 0x2c;
    memcpy((void*)0x20000370, "metacopy=on", 11);
    ...
    *(uint8_t*)0x2000037c = 0;
    ...
    break;
  case 5:
    memcpy((void*)0x20000200, "./bus/file1\000", 12);
    memcpy((void*)0x200002c0, "./bus/file0\000", 12);
    syscall(__NR_link, 0x20000200ul, 0x200002c0ul);
    break;
  case 6:
    memcpy((void*)0x20000080, "./bus/file0\000", 12);
    syscall(__NR_open, 0x20000080ul, 0xbul, 0ul);
    break;
  case 7:
