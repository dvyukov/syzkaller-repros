...
// https://syzkaller.appspot.com/bug?id=5ca851459ed04c778d1d
// status:0
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x20000100, "vcan0\000\000\000\000\000\000\000\000\000\000\000",
         16);
  ...
  *(uint64_t*)0x200000c0 = 0x20000640;
  memcpy((void*)0x20000640,
         "\x01\x00\x00\x00\xb7\xfa\x68\xca\x00\x00\x00\x00\x00\x00\x00\x00",
         16);
  *(uint64_t*)0x20000650 = 0;
  *(uint64_t*)0x20000658 = 0x7530;
  *(uint64_t*)0x20000660 = 0;
  *(uint64_t*)0x20000668 = r[3];
  memcpy((void*)0x20000670, "\x00\x00\x00\x00\x01", 5);
