...
// https://syzkaller.appspot.com/bug?id=b1212b1215db82ff9211
// status:0
  ...
  case 7:
    ...
    NONFAILING(
        memcpy((void*)0x20000580,
               "D\000\000\000,"
               "\000\'\r\000\000\000\000\000\000\000\000\000\000\000\000",
               20));
    NONFAILING(*(uint32_t*)0x20000594 = r[3]);
    NONFAILING(
        memcpy((void*)0x20000598,
               "\x00\x00\x00\x00\x00\x00\x00\x00\x08\x00\xf1\xff\x08\x00\x01"
               "\x00\x75\x33\x32\x00\x18\x00\x02\x00\x14\x00\x05\x00\x00\x00"
               "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x7c\x67\x24",
               44));
  ...
  case 10:
    ...
    NONFAILING(
        memcpy((void*)0x20000580,
               ...
               "\000\'\r\000\000\000\000\000\000\000\000\000\000\000\000",
               20));
    NONFAILING(*(uint32_t*)0x20000594 = r[5]);
    NONFAILING(
        memcpy((void*)0x20000598,
               "\x00\x08\x00\x80\x00\x00\x00\x00\x08\x00\xf1\xff\x08\x00\x01"
               "\x00\x75\x33\x32\x00\x18\x00\x02\x00\x14\x00\x06\x00\x00\x00"
               "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x7c\x67\x24",
               44));
    NONFAILING(*(uint64_t*)0x20000188 = 0x44);
    NONFAILING(*(uint64_t*)0x200001d8 = 1);
