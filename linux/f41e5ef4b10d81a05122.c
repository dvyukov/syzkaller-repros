// BUG: unable to handle kernel NULL pointer dereference in __lookup_hash (2)
// https://syzkaller.appspot.com/bug?id=f41e5ef4b10d81a05122
// status:0
...
int main(void)
{
  ...
  *(uint64_t*)0x20000200 = 0x20010000;
  memcpy((void*)0x20010000,
         ...
         "\x02\x00\x01\x00\x02\x00\x01\x20\x00\x00\x00\x00\x01\x00\x00\x00\x12"
  ...
  *(uint64_t*)0x20000290 = 0x20000380;
  memcpy((void*)0x20000380,
         "\x00\x00\x00\x00\x01\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x20"
         "\x00\x04\x00\x2e\x2e\x00\x00\x00\x00\x00\x00\x2e\x00\x00\x00\x00\x00"
         "\x00\x00\xed\x41\x80\x00\x03\x00\x00\x00\x30\x00\x00\x00\x00\x00\x00"
         "\x00\x5c\x78\x22\xcd\xab\xa2\x4a\xab\xe8\xc1\x65\x5f\x3a\xc1\x65\x5f"
         "\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x37\x82\x11\x19\x1b"
         "\x24\xb9\xf5\x0a\x9c\x09\x2b\xa0\x34\x42\x34\x3f\x62\x5b\x9a\x93\xb5"
         "\x18\xbc\x0f\xd4\x7c\xef\x45\x87\xea\x38\xc1\xb0\x40\xb1\xb3\x00\x00"
         "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
         136);
  *(uint64_t*)0x20000298 = 0x88;
  *(uint64_t*)0x200002a0 = 0x2013fa0;
  *(uint8_t*)0x20011200 = 0;
  syz_mount_image(0x20000000, 0x20000100, 0x4000800, 7, 0x20000200, 0,
                  0x20011200);
  return 0;
}
