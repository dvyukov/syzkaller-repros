...
// https://syzkaller.appspot.com/bug?id=319dabc8f66df6d223b50d129ae60965fa33ea9e
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(*(uint32_t*)0x20000180 = 5);
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 7, 1, 1));
    ...
    NONFAILING(*(uint32_t*)0x200001b4 = 3);
    NONFAILING(*(uint64_t*)0x200001b8 = 0);
    NONFAILING(*(uint64_t*)0x200001c0 = 1);
    ...
    break;
  case 1:
    syscall(__NR_clone, 0x2902001ffb, 0, 0x9999999999999999, 0, -1);
    break;
  case 2:
    NONFAILING(*(uint64_t*)0x20000040 = 0);
    syscall(__NR_rt_sigtimedwait, 0x20000040, 0, 0, 8);
    break;
  case 3:
    ...
    break;
  case 4:
    syscall(__NR_setsockopt, -1, 0, 0x40, 0, 0);
    break;
  case 5:
    NONFAILING(memcpy(
        (void*)0x200002c0,
        "\x87\x3c\xfa\x4b\x18\x44\x69\x08\x93\xef\x63\xbe\xea\x78\x47\x41\xfc"
        "\x73\xd1\x99\xf8\xee\xa8\xc1\xe3\xc6\x1c\x73\xc3\x49\x1f\x94\x95\x69"
        "\x9b\x42\x69\xdb\xe0\x79\x4f\xda\x2f\x16\x1f\xa5\x49\x55\x92\x86\xb9"
        "\xe8\xbf\xbf\x15\x96\xe1\x60\xcf\x28\x46\x99\xec\x8f\x2b\xa4\x94\x83"
        "\xfb\xc1\x80\xbd\xfb\xd1\x19\xa1\x8f\x97\x70\x0d\xf9\x3f\x60\x15\xcb"
        "\xf1\x51\xb9\x2f\x23\x17\xc6\xfe\x94\x80\xe4\x53\x36\xd6\x1d\xc3\x89"
        "\x99\x44\xba\xa0\x2b\xe0\xa2\x5d\x5a\x25\x84\xef\xa7\xf2\x8a\x58\x25"
        "\x82\x58\x95\x6d\x81\xe7\x69\xe7\x50\x81\xbd\x06\x88\x7c\xb4\x41\xce"
        "\x2f\xa9\xa7\xf7\x6e\x82\x25\xec\xb9\x5b\xcc\xc3\xa8\xf8\x91\xa1\xb9"
        "\xab\xc3\xdd\x31\x57\x2a\x82\xfb\x53\x10\xba\x15\x7b\x52\x25\xd0\x25"
        "\x33\x63\xb5\xfc\x68\x52\x6e\x89\x6d\x01\xc0\xc1\xc0\xba\x7c\xce\xf4"
        "\x51\xbf\xd8\x90\x6e\xb2\x2f\x64\x2b\xf4\x5c\x6d\xbe\xb3\x1f\xe9\x9c"
        "\x89\xda\xeb\x1a\x90\x4c\x07\x16\xea\xdd\xaf\xdb\x65\x61\x0e\x3f\xa9"
        "\xd7\xc0\x1e\xf7\xf7\xee\x98\x74\xcd\x3e\xbc\x84\xcb\x78\x2c\x26\xaa",
        238));
    syscall(__NR_clone, 0x4000, 0x200002c0, 0, 0, 0);
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x20000100 = 0);
    NONFAILING(*(uint32_t*)0x20000104 = 0);
    NONFAILING(*(uint32_t*)0x20000108 = 0);
    syscall(__NR_rt_tgsigqueueinfo, r[0], r[0], 0x16, 0x20000100);
    break;
  case 7:
    syscall(__NR_ptrace, 0x10, r[0], 0, 0);
    break;
  case 8:
    syscall(__NR_ptrace, 6, r[0], 0x388, -1);
    break;
  }
}
int main(void)
