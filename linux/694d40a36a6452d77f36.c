...
// https://syzkaller.appspot.com/bug?id=694d40a36a6452d77f36
// status:3
...
void execute_one(void)
{
  ...
  *(uint16_t*)0x20000082 = htobe16(0xa);
  memcpy((void*)0x20000084, "\xdf\xb7\x63\x9a", 4);
  *(uint16_t*)0x20000088 = htobe16(3);
  *(uint16_t*)0x2000008a = htobe16(0);
  *(uint8_t*)0x2000008c = 0;
  *(uint8_t*)0x2000008d = 0xc0;
  *(uint16_t*)0x2000008e = htobe16(0x101);
  *(uint8_t*)0x20000090 = 0xfb;
  *(uint8_t*)0x20000091 = 1;
  syz_usb_ep_write(r[0], 0x83, 0x12, 0x20000080);
}
int main(void)
{
