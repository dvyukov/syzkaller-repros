...
// https://syzkaller.appspot.com/bug?id=50d43beb06a4fa9c4f118b91a40782190b7a24df
// status:open
...
int main(void)
{
  ...
  *(uint64_t*)0x20000008 = 0x200002c0;
  memcpy((void*)0x200002c0,
         "\xb9\x2d\x02\x00\x00\x0f\x32\xb5\x00\x8f\xc8\x38\xcc\xc4\x00\x65\x0f"
         "\x06\xb9\x80\x00\x00\xc0\x0f\x32\x35\x00\x04\x00\x00\x0f\x30\x0f\x01"
         "\xb5\x65\x23\x00\x00\x8f\xe8\x48\x9e\x2a\xa3\xc4\xe2\x6d\x8c\x55\x0c"
         "\x36\x0f\x21\x04\x66\x0f\x38\x82\x99\x1c\x00\x00\x00",
         64);
  *(uint64_t*)0x20000010 = 0x40;
  syz_kvm_setup_cpu(r[1], -1, 0x20000000, 0x20000000, 1, 0, 0x20000280, 0);
  *(uint64_t*)0x200001c0 = 0x40;
  *(uint64_t*)0x200001c8 = 0x20000040;
  memcpy((void*)0x20000040,
         ...
         78);
  *(uint64_t*)0x200001d0 = 0x4e;
  syz_kvm_setup_cpu(-1, r[2], 0x20000000, 0x200001c0, 1, 0x48, 0x20000140, 0);
  syscall(__NR_mremap, 0x20005000, 0x1000, 0x3000, 3, 0x20014000);
