...
// https://syzkaller.appspot.com/bug?id=5371d40fc0c6c5f14a077457a2aa50708b92983a
// status:open
...
int main(void)
{
  ...
  NONFAILING(*(uint8_t*)0x20000004 = 0x84);
  NONFAILING(*(uint8_t*)0x20000005 = 0xbf);
  NONFAILING(*(uint8_t*)0x20000006 = 0x5f);
  NONFAILING(*(uint8_t*)0x20000007 = 0x10);
  NONFAILING(*(uint16_t*)0x20000008 = 0x841);
  NONFAILING(*(uint16_t*)0x2000000a = 1);
  NONFAILING(*(uint16_t*)0x2000000c = 0xc5d0);
  ...
  NONFAILING(*(uint8_t*)0x2000001d = 0x85);
  NONFAILING(*(uint8_t*)0x2000001e = 0);
  NONFAILING(*(uint8_t*)0x2000001f = 0);
  NONFAILING(*(uint8_t*)0x20000020 = 0xc9);
  NONFAILING(*(uint8_t*)0x20000021 = 0x8c);
  NONFAILING(*(uint8_t*)0x20000022 = 0x7e);
