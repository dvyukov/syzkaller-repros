...
// https://syzkaller.appspot.com/bug?id=735bf1ddeace671aa13b
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint64_t*)0x20000628 = 0xffffffffffff8001);
    NONFAILING(syz_mount_image(0x20000200, 0x20000100, 0, 2, 0x20000600, 0,
                               0x20000180));
    break;
  case 1:
  ...
  case 3:
    ...
    break;
  case 4:
    res = syscall(__NR_io_setup, 0x202, 0x200003c0ul);
    if (res != -1)
      NONFAILING(r[1] = *(uint64_t*)0x200003c0);
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20000180, "./bus\000", 6));
    res = syscall(__NR_open, 0x20000180ul, 0x100000169042ul, 0ul);
    if (res != -1)
      r[2] = res;
    break;
  case 6:
    syscall(__NR_ftruncate, r[2], 0x10099b8ul);
    break;
  case 7:
    NONFAILING(*(uint32_t*)0x20000240 = 0);
    NONFAILING(*(uint32_t*)0x20000244 = 0x80);
    NONFAILING(*(uint8_t*)0x20000248 = 0);
    NONFAILING(*(uint8_t*)0x20000249 = 0);
    NONFAILING(*(uint8_t*)0x2000024a = 6);
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000268, 1, 8, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000268, 1, 9, 1));
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000268, 1, 14, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000268, 3, 15, 2));
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000268, 1, 25, 1));
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000268, 0, 29, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000268, 0, 30, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000268, 0, 31, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000268, 0, 32, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000268, 0, 33, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000268, 0, 34, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000268, 0, 35, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000268, 0, 36, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000268, 0, 37, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000268, 0, 38, 26));
    NONFAILING(*(uint32_t*)0x20000270 = 0);
    NONFAILING(*(uint32_t*)0x20000274 = 0);
    NONFAILING(*(uint64_t*)0x20000278 = 0x7ff);
    NONFAILING(*(uint64_t*)0x20000280 = 0);
    NONFAILING(*(uint64_t*)0x20000288 = 0xa206);
    ...
    syscall(__NR_perf_event_open, 0x20000240ul, 0, 6ul, -1, 0ul);
    break;
  case 8:
  ...
  case 9:
    ...
    NONFAILING(*(uint32_t*)0x200000c8 = 0x3a5);
    ...
    NONFAILING(*(uint64_t*)0x200000e0 = 0x16000);
    ...
    syscall(__NR_io_submit, r[1], 0x1801ul, 0x20000540ul);
    break;
  }
}
int main(void)
