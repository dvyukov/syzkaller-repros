...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x200000c0, "/dev/fuse\000", 10));
  ...
  case 2:
    ...
    NONFAILING(memcpy((void*)0x20000240, "fuse\000", 5));
    NONFAILING(memcpy((void*)0x20000280, "fd=", 3));
    NONFAILING(sprintf((char*)0x20000283, "0x%016llx", (long long)r[0]));
    NONFAILING(memcpy((void*)0x20000295,
                      ",rootmode=00000000000000000040000,user_id=", 42));
    NONFAILING(sprintf((char*)0x200002bf, "%020llu", (long long)0));
    NONFAILING(memcpy((void*)0x200002d3, ",group_id=", 10));
    NONFAILING(sprintf((char*)0x200002dd, "%020llu", (long long)0));
    syscall(__NR_mount, 0, 0x20000200, 0x20000240, 0, 0x20000280);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000000, "./file0\000", 8));
    syscall(__NR_umount2, 0x20000000, 2);
    break;
  case 4:
    syscall(__NR_read, r[0], 0x200030c0, 0xfffffed0);
    break;
  }
}
int main(void)
