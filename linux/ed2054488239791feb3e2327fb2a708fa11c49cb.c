...
// https://syzkaller.appspot.com/bug?id=ed2054488239791feb3e2327fb2a708fa11c49cb
// status:open
...
void loop(void)
{
  ...
  if (res != -1)
    r[0] = res;
  syscall(__NR_fcntl, r[0], 0ul, r[0]);
  ...
  *(uint16_t*)0x2025c06e = 0;
  syscall(__NR_perf_event_open, 0x2025c000ul, 0, 0ul, -1, 0ul);
  ...
  *(uint16_t*)0x2001d06e = 0;
  ...
  memcpy((void*)0x20000340, "auxv\000", 5);
  syz_open_procfs(-1, 0x20000340);
  *(uint32_t*)0x2025c000 = 1;
  *(uint32_t*)0x2025c004 = 0x70;
  *(uint8_t*)0x2025c008 = 0;
  *(uint8_t*)0x2025c009 = 0;
  ...
  *(uint16_t*)0x2000033c = 4;
  STORE_BY_BITMASK(uint16_t, , 0x2000033e, 3, 0, 14);
  STORE_BY_BITMASK(uint16_t, , 0x2000033f, 0, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x2000033f, 1, 7, 1);
  *(uint16_t*)0x20000340 = 0x4c;
  STORE_BY_BITMASK(uint16_t, , 0x20000342, 3, 0, 14);
  STORE_BY_BITMASK(uint16_t, , 0x20000343, 0, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x20000343, 1, 7, 1);
