...
// https://syzkaller.appspot.com/bug?id=72ff2fa98097767b5a27
// status:6
...
void loop(void)
{
  *(uint8_t*)0x200007c0 = 0xaa;
  *(uint8_t*)0x200007c1 = 0xaa;
  *(uint8_t*)0x200007c2 = 0xaa;
  *(uint8_t*)0x200007c3 = 0xaa;
  *(uint8_t*)0x200007c4 = 0xaa;
  *(uint8_t*)0x200007c5 = 0xaa;
  *(uint8_t*)0x200007c6 = 1;
  *(uint8_t*)0x200007c7 = 0x80;
  *(uint8_t*)0x200007c8 = 0xc2;
  *(uint8_t*)0x200007c9 = 0;
  *(uint8_t*)0x200007ca = 0;
  *(uint8_t*)0x200007cb = 0;
  *(uint16_t*)0x200007cc = htobe16(0x86dd);
  STORE_BY_BITMASK(uint8_t, , 0x200007ce, 0, 0, 4);
  STORE_BY_BITMASK(uint8_t, , 0x200007ce, 6, 4, 4);
  memcpy((void*)0x200007cf, "\x08\x3f\xf2", 3);
  *(uint16_t*)0x200007d2 = htobe16(0x28);
  *(uint8_t*)0x200007d4 = 0x29;
  *(uint8_t*)0x200007d5 = 0;
  *(uint8_t*)0x200007d6 = 0xfe;
  *(uint8_t*)0x200007d7 = 0x80;
  *(uint8_t*)0x200007d8 = 0;
  *(uint8_t*)0x200007d9 = 0x50;
  ...
  *(uint8_t*)0x200007e5 = 0xbb;
  *(uint8_t*)0x200007e6 = 0xfe;
  *(uint8_t*)0x200007e7 = 0x80;
  ...
  *(uint8_t*)0x200007f5 = 0xaa;
  *(uint16_t*)0x200007f6 = htobe16(0);
  *(uint16_t*)0x200007f8 = htobe16(0);
  *(uint32_t*)0x200007fa = 0x41424344;
  *(uint32_t*)0x200007fe = 0x41424344;
  STORE_BY_BITMASK(uint8_t, , 0x20000802, 0, 0, 1);
  STORE_BY_BITMASK(uint8_t, , 0x20000802, 0, 1, 3);
  STORE_BY_BITMASK(uint8_t, , 0x20000802, 0xa, 4, 4);
  *(uint8_t*)0x20000803 = 0;
  *(uint16_t*)0x20000804 = htobe16(0);
  *(uint16_t*)0x20000806 = htobe16(0);
  *(uint16_t*)0x20000808 = htobe16(0);
  *(uint8_t*)0x2000080a = 0x22;
  *(uint8_t*)0x2000080b = 8;
  memcpy((void*)0x2000080c, "\x91\x14\x86\xdf\x9c\x0a", 6);
  *(uint8_t*)0x20000812 = 0;
  *(uint8_t*)0x20000813 = 5;
  memcpy((void*)0x20000814, "\x04\xe4\xf2", 3);
  *(uint8_t*)0x20000817 = 2;
  *(uint8_t*)0x20000818 = 4;
  *(uint16_t*)0x20000819 = 0;
  struct csum_inet csum_1;
  csum_inet_init(&csum_1);
  csum_inet_update(&csum_1, (const uint8_t*)0x200007d6, 16);
  csum_inet_update(&csum_1, (const uint8_t*)0x200007e6, 16);
  uint32_t csum_1_chunk_2 = 0x28000000;
  ...
  csum_inet_update(&csum_1, (const uint8_t*)0x200007f6, 40);
  *(uint16_t*)0x20000806 = csum_inet_digest(&csum_1);
  syz_emit_ethernet(0x5e, 0x200007c0, 0);
}
int main(void)
{
