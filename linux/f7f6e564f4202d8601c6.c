...
// https://syzkaller.appspot.com/bug?id=f7f6e564f4202d8601c6
// status:6
...
void execute_one(void)
{
  ...
  *(uint16_t*)0x20000144 = 3;
  syscall(__NR_bind, r[0], 0x20000140ul, 6ul);
  memcpy((void*)0x20000140, "\x51\x00\x05\x00\x00\x00", 6);
  syscall(__NR_write, r[0], 0x20000140ul, 6ul);
}
int main(void)
{
