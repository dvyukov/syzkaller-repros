...
// https://syzkaller.appspot.com/bug?id=8de86ced049e882cd68c3ef51cc69c634d8aeb7c
// status:fixed
...
void execute_call(int call)
{
  ...
  case 5:
    ...
    res = syscall(__NR_bpf, 0, 0x20000000, 0xfffffffffffffdcb);
    if (res != -1)
      r[1] = res;
    break;
  case 6:
    ...
    break;
  case 7:
    syscall(__NR_ioctl, r[1], 0x89e2, 0);
    break;
  case 8:
