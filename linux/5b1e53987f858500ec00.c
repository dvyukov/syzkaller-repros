...
// https://syzkaller.appspot.com/bug?id=5b1e53987f858500ec00
// status:0
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x200001c0, "cgroup.subtree_control\000", 23);
  ...
  *(uint8_t*)0x20000105 = 0x20;
  syscall(__NR_write, r[1], 0x20000100ul, 6ul);
  *(uint8_t*)0x200000c0 = 0x2b;
  memcpy((void*)0x200000c1, "pids", 4);
  *(uint8_t*)0x200000c5 = 0x20;
  inject_fault(22);
