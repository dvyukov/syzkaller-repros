...
// https://syzkaller.appspot.com/bug?id=8ef6ff5f114c32e5f49827f00838e06f74c90149
// status:invalid
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(*(uint16_t*)0x20000080 = 0x26);
    NONFAILING(
    ...
    NONFAILING(memcpy(
        (void*)0x20000098,
        "\x64\x72\x62\x67\x5f\x70\x72\x5f\x73\x68\x61\x35\x31\x32\x00\x00\x00"
  ...
  case 2:
    ...
    inject_fault(5);
    syscall(__NR_setsockopt, r[0], 0x117, 1, 0x200001c0, 0);
    break;
  }
}
