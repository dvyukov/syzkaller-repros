...
// https://syzkaller.appspot.com/bug?id=663e49fa871bf5aad3fd
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    NONFAILING(memcpy(
        (void*)0x20000000,
        "\x2e\x00\x00\x00\x22\x00\x81\x51\xe0\x5b\x80\xec\xdb\x4c\xb9\x04\x04"
        "\x48\x65\x16\x0b\x00\x16\x00\x02\x00\x00\x00\x74\x00\x04\x14\x0e\x00"
        "\x11\x00\x02\x4d\x00\x00\xdc\x29\x76\xd1\x53\xb4",
        46));
    NONFAILING(*(uint64_t*)0x200000c8 = 0x2e);
    ...
    break;
  case 3:
    NONFAILING(memcpy((void*)0x200003c0, "nl80211\000", 8));
    NONFAILING(syz_genetlink_get_family_id(0x200003c0, -1));
    break;
  }
}
int main(void)
