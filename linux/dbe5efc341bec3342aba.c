...
// https://syzkaller.appspot.com/bug?id=dbe5efc341bec3342aba
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000000, "/dev/infiniband/rdma_cm\000", 24));
  ...
  case 1:
    ...
    NONFAILING(*(uint16_t*)0x20000158 = 0x13f);
    ...
    res = syscall(__NR_write, r[0], 0x20000140ul, 0x20ul);
    if (res != -1)
      NONFAILING(r[1] = *(uint32_t*)0x20000100);
    break;
  case 2:
    NONFAILING(*(uint32_t*)0x20000180 = 0xe);
    NONFAILING(*(uint16_t*)0x20000184 = 0x18);
    NONFAILING(*(uint16_t*)0x20000186 = 0xfa00);
    NONFAILING(*(uint64_t*)0x20000188 = 0x200000c0);
    NONFAILING(*(uint32_t*)0x200000c0 = 1);
    NONFAILING(*(uint32_t*)0x20000190 = r[1]);
    NONFAILING(*(uint32_t*)0x20000194 = 0);
    NONFAILING(*(uint32_t*)0x20000198 = 1);
    NONFAILING(*(uint32_t*)0x2000019c = 4);
    syscall(__NR_write, r[0], 0x20000180ul, 0x20ul);
    break;
  case 3:
  ...
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_write, r[3], 0ul, 0ul);
    break;
  case 6:
    syscall(__NR_write, r[3], 0ul, 0ul);
    break;
  ...
  case 9:
    ...
    NONFAILING(*(uint16_t*)0x20000048 = 0xa);
    NONFAILING(*(uint16_t*)0x2000004a = htobe16(0x4e22));
    NONFAILING(*(uint32_t*)0x2000004c = htobe32(8));
    NONFAILING(*(uint64_t*)0x20000050 = htobe64(0));
    NONFAILING(*(uint64_t*)0x20000058 = htobe64(1));
    NONFAILING(*(uint32_t*)0x20000060 = 1);
    NONFAILING(*(uint16_t*)0x20000064 = 0xa);
    NONFAILING(*(uint16_t*)0x20000066 = htobe16(0x4e21));
    NONFAILING(*(uint32_t*)0x20000068 = htobe32(6));
    NONFAILING(*(uint8_t*)0x2000006c = 0xfc);
    NONFAILING(*(uint8_t*)0x2000006d = 1);
    ...
    NONFAILING(*(uint32_t*)0x2000007c = 1);
