...
void execute_call(int call)
{
  ...
  case 0:
    ...
    *(uint16_t*)0x2001d06e = 0;
    ...
    break;
  case 1:
    memcpy((void*)0x20000400, "/dev/vhost-net", 15);
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000400, 2, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
    *(uint64_t*)0x200002c0 = 0;
    syscall(__NR_ioctl, r[0], 0x40000000af01, 0x200002c0);
    break;
  case 3:
    memcpy((void*)0x20000380, "/dev/audio", 11);
  ...
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_ioctl, r[0], 0x4008af03, 0x200004c0);
    break;
  case 7:
    ...
    *(uint64_t*)0x20000298 = 0x200001c0;
    *(uint64_t*)0x200002a0 = 0;
    syscall(__NR_ioctl, r[0], 0x4028af11, 0x20000280);
    break;
  case 8:
    memcpy((void*)0x20000340,
           "\x64\x75\x6d\x6d\x79\x30\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
           16);
    *(uint16_t*)0x20000350 = 1;
    syscall(__NR_ioctl, r[2], 0x400454ca, 0x20000340);
    break;
  case 9:
    *(uint32_t*)0x20f1dff8 = 1;
  ...
  case 10:
    ...
    *(uint32_t*)0x20000504 = r[1];
    syscall(__NR_ioctl, r[0], 0x4008af30, 0x20000500);
    break;
  }
}
