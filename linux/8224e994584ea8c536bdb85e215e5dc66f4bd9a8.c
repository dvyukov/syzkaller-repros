...
// https://syzkaller.appspot.com/bug?id=8224e994584ea8c536bdb85e215e5dc66f4bd9a8
// status:open
...
int main(void)
{
  ...
  NONFAILING(*(uint64_t*)0x20000000 = 0x20);
  NONFAILING(*(uint64_t*)0x20000008 = 0x20000140);
  NONFAILING(memcpy(
      (void*)0x20000140,
      "\x66\xb8\xb9\x00\x0f\x00\xd0\xc7\x44\x24\x00\xb7\xfe\x00\x00\xc7\x44\x24"
      "\x02\x50\x26\x00\x00\xc7\x44\x24\x06\x00\x00\x00\x00\x0f\x01\x1c\x24\x0f"
      "\x78\xba\x00\x00\xc0\xfe\x66\x0f\x38\x34\x86\x0a\x00\x00\x00\xc4\xc2\x75"
      "\xac\x7c\x2c\x00\x3e\x3e\x0f\x79\x97\x0c\x00\x00\x00\x66\xba\xf8\x0c\xb8"
      "\xca\xae\x09\x8c\xef\xb8\x00\x00\x00\x00\x0f\x23\xd0\x0f\x21\xf8\x35\x30"
      "\x00\x00\x04\x0f\x23\xf8\xec\xc6\xf8\x4c\x0f\x32\xf3\x0f\xc7\x36",
      106));
  NONFAILING(*(uint64_t*)0x20000010 = 0x47);
  syz_kvm_setup_cpu(-1, r[2], 0x20000000, 0x20000000, 1, 0, 0, 0);
  syz_kvm_setup_cpu(-1, r[2], 0x20000000, 0, 0xfefd, 0x40, 0,
                    0xfffffffffffffdd4);
  NONFAILING(memcpy((void*)0x20000580, "\x28\x00\x00\x00\x02\x00\x00\x00\x00"
                                       "\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                                       "\x00\x00\x00\x00\x00\x00\x00",
                    25));
  syscall(__NR_write, -1, 0x20000580, 0x19);
