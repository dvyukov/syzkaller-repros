...
// https://syzkaller.appspot.com/bug?id=d6d57d324860c94d5836
// status:3
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_mprotect, 0x20005000ul, 0x3000ul, 0ul);
    break;
  case 1:
  ...
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_shmget, 0x798dd814ul + procid * 4, 0x4000ul, 0ul,
            0x2096d000ul);
    break;
  case 4:
  ...
  case 6:
    ...
    break;
  case 7:
    syscall(__NR_setsockopt, -1, 0x10f, 0x87, 0ul, 0ul);
    break;
  case 8:
    syscall(__NR_eventfd2, 0, 0ul);
    break;
  case 9:
    syscall(__NR_getsockopt, -1, 0x65, 6, 0ul, 0ul);
    break;
  case 10:
    NONFAILING(memcpy((void*)0x20000480, "/dev/fb0\000", 9));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000480ul, 0ul, 0ul);
    if (res != -1)
      r[0] = res;
    break;
  case 11:
    NONFAILING(*(uint32_t*)0x20000000 = 0x356);
    NONFAILING(*(uint32_t*)0x20000004 = 0);
    NONFAILING(*(uint32_t*)0x20000008 = 0);
    NONFAILING(*(uint32_t*)0x2000000c = 0x280);
    NONFAILING(*(uint32_t*)0x20000010 = 0);
    NONFAILING(*(uint32_t*)0x20000014 = 0x4b76);
  ...
  case 12:
    ...
    break;
  case 13:
    NONFAILING(*(uint32_t*)0x20000340 = 0x30);
    NONFAILING(*(uint32_t*)0x20000344 = 0x10);
    ...
    NONFAILING(*(uint32_t*)0x20000358 = 4);
    NONFAILING(*(uint32_t*)0x2000035c = 0);
    NONFAILING(*(uint32_t*)0x20000360 = 0);
    NONFAILING(*(uint32_t*)0x20000364 = 0x235df24b);
    ...
    NONFAILING(*(uint32_t*)0x20000384 = 1);
