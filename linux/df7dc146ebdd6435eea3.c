...
// https://syzkaller.appspot.com/bug?id=df7dc146ebdd6435eea3
// status:6
...
void loop(void)
{
  memcpy((void*)0x20000200,
         "\x12\x01\x00\x00\x00\x00\x00\x40\x6b\x1d\x01\x01\x40\x00\x01\x02\x03"
         "\x01\x09\x02\xa0\x00\x03\x01\x05\x80\x00\x09\x04\x00\x00\x00\x01\x01"
         "\x00\x00\x0a\x24\x01\x00\x00\x00\x02\x01\x02\x08\x24\x07\x00\x00\x00"
         "\x05\x70\x09\x04\x01\x00\x00\x01\x02\x00\x00\x09\x04\x01\x01\x01\x01"
         "\x02\x00\x01\x09\x24\x02\x01\xc1\x01\x01\x20\xad\x0a\x24\x02\x02\x02"
         "\x00\x04\x00\x00\x86\x09\x05\x01\x09\x08\x00\x06\x03\x7f\x07\x25\x01"
         "\x83\x01\x01\x80\x09\x04\x02\x00\x00\x01\x02\x00\x09\x09\x04\x02\x01"
         "\x01\x01\x02\x01\x1f\x0e\x24\x02\x01\x07\x04\x00\x00\x7f\x68\x79\x53"
         "\x8c\x6c\x09\x24\x02\x02\x04\x00\x01\x00\x80\x07\x24\x01\x04\x06\x02"
         "\x10\x08\x24\x02\x01\x00\x00\x00\x00\x09\x05\x82\x09\x08",
         167);
  syz_usb_connect(0, 0xb2, 0x20000200, 0);
  close_fds();
}
int main(void)
{
