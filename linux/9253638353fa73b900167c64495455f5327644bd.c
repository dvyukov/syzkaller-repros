...
// https://syzkaller.appspot.com/bug?id=9253638353fa73b900167c64495455f5327644bd
// status:open
...
void loop(void)
{
  ...
  NONFAILING(memcpy((void*)0x20000340, "./file1/file0\000", 14));
  syscall(__NR_creat, 0x20000340, 0);
  ...
  syscall(__NR_mount, 0x400000, 0x20000480, 0x200004c0, 0, 0x20000c40);
  NONFAILING(memcpy((void*)0x20000540, "./file0\000", 8));
  syscall(__NR_chdir, 0x20000540);
  NONFAILING(memcpy((void*)0x20000040, "./file0\000", 8));
  syscall(__NR_open, 0x20000040, 0x927, 0);
  close_fds();
}
int main(void)
{
