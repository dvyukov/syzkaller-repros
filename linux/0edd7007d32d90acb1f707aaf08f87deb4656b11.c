...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20027000, "./file0", 8));
    NONFAILING(memcpy((void*)0x20018ffa, "ramfs", 6));
    syscall(__NR_mount, 0x20000000, 0x20027000, 0x20018ffa, 0x50, 0x2000a000);
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20df1000, "./file0/bus", 12));
    res = syscall(__NR_creat, 0x20df1000, 0xbc9dc8fbd81cb4b1);
    if (res != -1)
      r[0] = res;
    break;
  case 3:
    NONFAILING(*(uint16_t*)0x20027000 = 1);
    NONFAILING(*(uint16_t*)0x20027002 = 0);
    NONFAILING(*(uint64_t*)0x20027008 = 0);
    NONFAILING(*(uint64_t*)0x20027010 = 0);
    NONFAILING(*(uint32_t*)0x20027018 = 0);
  ...
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_ftruncate, r[0], 0x39);
    break;
  case 6:
    NONFAILING(*(uint64_t*)0x20000140 = 0);
    NONFAILING(*(uint64_t*)0x20000148 = 8);
    NONFAILING(*(uint64_t*)0x20000150 = 0);
    NONFAILING(*(uint64_t*)0x20000158 = 9);
    syscall(__NR_timer_settime, 0, 0, 0x20000140, 0x200000c0);
    break;
  }
}
int main(void)
