...
// https://syzkaller.appspot.com/bug?id=cb5546eaaad6d725b7c1
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_read, r[0], 0x200042c0ul, 0x2020ul);
    break;
  case 2:
    syscall(__NR_read, r[0], 0x20002280ul, 0x2020ul);
    break;
  case 3:
    syscall(__NR_ioctl, r[0], 0xd0009411, 0ul);
    break;
  case 4:
  ...
  case 5:
    ...
    NONFAILING(syz_open_dev(0x20000080, 0, 0));
    {
      int i;
      for (i = 0; i < 32; i++) {
        NONFAILING(syz_open_dev(0x20000080, 0, 0));
