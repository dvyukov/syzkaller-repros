...
// https://syzkaller.appspot.com/bug?id=ae62f326a5154c4b908f
// status:0
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[1] = res;
  syscall(__NR_sendmmsg, r[1], 0x20000200ul, 0x10efe10675dec09ul, 0ul);
  *(uint32_t*)0x20000240 = 0x14;
  res = syscall(__NR_getsockname, r[1], 0x20000100ul, 0x20000240ul);
  if (res != -1)
  ...
  *(uint64_t*)0x20000280 = 0x200000c0;
  memcpy((void*)0x200000c0, "\x28\x00\x00\x00\x10\x00\x25\x08\x00\x00\x00\x00"
                            "\x00\x00\x00\x00\x00\x02\xdf\x86",
         20);
