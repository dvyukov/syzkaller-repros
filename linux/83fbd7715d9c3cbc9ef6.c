...
// https://syzkaller.appspot.com/bug?id=83fbd7715d9c3cbc9ef6
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    *(uint64_t*)0x20000178 = 0;
    ...
    break;
  case 3:
    syscall(__NR_open, 0ul, 0x14d842ul, 0ul);
    break;
  case 4:
  ...
  case 12:
    ...
    *(uint64_t*)0x20000140 = 0x20000300;
    memcpy((void*)0x20000300,
           "\x38\x00\x00\x00\x24\x00\x07\x05\x00\x00\x00\x40\x07\xa2\xa3\x00"
           "\x05\x00\x00\x00",
           20);
  ...
  case 16:
    ...
    *(uint32_t*)0x20000288 = 0;
    *(uint64_t*)0x20000290 = 0x20000180;
    *(uint64_t*)0x20000180 = 0x20000340;
    *(uint32_t*)0x20000340 = 0x44;
    *(uint16_t*)0x20000344 = 0x2c;
    *(uint16_t*)0x20000346 = 0xd27;
    ...
    *(uint16_t*)0x2000035e = 0;
    *(uint16_t*)0x20000360 = 0;
    *(uint16_t*)0x20000362 = 0x10;
    *(uint16_t*)0x20000364 = 0xa;
    *(uint16_t*)0x20000366 = 1;
    memcpy((void*)0x20000368, "route\000", 6);
