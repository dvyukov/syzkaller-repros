...
// https://syzkaller.appspot.com/bug?id=2ee261f290af0db073ab91a8d7a7d2c61dc1bbb7
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    res = syz_open_dev(0, 0 + procid * 1, 0x400);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000240, "/dev/nbd#\000", 10));
    res = syz_open_dev(0x20000240, 0 + procid * 1, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 2:
