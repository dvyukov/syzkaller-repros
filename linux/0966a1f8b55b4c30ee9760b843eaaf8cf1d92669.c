...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    memcpy((void*)0x20000040, "/proc/self/attr/current\000", 24);
    syscall(__NR_openat, 0xffffffffffffff9c, 0x20000040, 2, 0);
    break;
  case 4:
    syscall(__NR_write, r[1], 0x20000140, 0xfffffe14);
    break;
  case 5:
    syscall(__NR_splice, r[0], 0, r[2], 0, 0x3000000000000000, 0);
    break;
  case 6:
    memcpy((void*)0x20000100, "./file0\000", 8);
    syscall(__NR_mknod, 0x20000100, 0x103e, 0);
    break;
  case 7:
    memcpy((void*)0x200000c0, "./file0\000", 8);
    syscall(__NR_execve, 0x200000c0, 0, 0);
    break;
  }
}
int main(void)
