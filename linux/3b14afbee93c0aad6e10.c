...
// https://syzkaller.appspot.com/bug?id=3b14afbee93c0aad6e10
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    *(uint32_t*)0x200000bc = 0;
    memcpy((void*)0x200000c0, "\x40\x00\xb2\x00\x00\x00\x00\x00", 8);
  ...
  case 4:
    ...
    *(uint32_t*)0x2000007c = 0;
    syscall(__NR_bpf, 0ul, 0x20000040ul, 0x40ul);
    break;
  case 5:
  ...
  case 7:
    ...
    *(uint32_t*)0x20000014 = -1;
    memcpy((void*)0x20000018, "\x00\x00\x00\x00\x00\x00\x18\x00\x28\x00\x12\x80"
