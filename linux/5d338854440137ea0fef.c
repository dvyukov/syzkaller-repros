...
// https://syzkaller.appspot.com/bug?id=5d338854440137ea0fef
// status:6
...
int main(void)
{
  ...
  *(uint16_t*)0x20000002 = htobe16(8);
  memcpy((void*)0x20000004, "\x8f\x2d\xd6\x55", 4);
  *(uint16_t*)0x20000008 = htobe16(1);
  *(uint16_t*)0x2000000a = htobe16(0);
  *(uint16_t*)0x2000000c = htobe16(0);
  *(uint8_t*)0x2000000e = 0;
  *(uint8_t*)0x2000000f = 0;
  syz_usb_ep_write(r[0], 2, 0x10, 0x20000000);
  *(uint8_t*)0x20000080 = 1;
  *(uint8_t*)0x20000081 = 2;
  *(uint16_t*)0x20000082 = htobe16(0x3f);
  memcpy((void*)0x20000084, "\x30\x5d\xf4\x34", 4);
  memcpy((void*)0x20000088,
         "\xfc\xfe\x04\x3d\xf1\xe9\x96\xbf\x63\xa7\x70\x0c\x11\x43\xe1\xb9\xb9"
         "\x27\x15\x2c\x25\x47\xdf\x84\x19\xc2\xfd\x44\x34\x6c\xa5\x29\x2d\xf8"
         "\x9e\x9a\x0d\xa1\x35\xc2\xee\xb9\x2c\xda\x2f\xd8\x68\x27\x78\x5a\x55"
         "\xbf\x38\x90\xe3\xa7\x15\x5e\xe9\x0a\x4c\xc1\x18",
         63);
  syz_usb_ep_write(r[0], 2, 0x47, 0x20000080);
  return 0;
}
