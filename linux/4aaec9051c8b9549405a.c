...
// https://syzkaller.appspot.com/bug?id=4aaec9051c8b9549405a
// status:0
...
void execute_one(void)
{
  ...
  memcpy((void*)0x20000040, "/dev/ion\000", 9);
  res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000040ul, 0ul, 0ul);
  if (res != -1)
    r[1] = res;
  *(uint64_t*)0x20000080 = 0x80000001;
  *(uint32_t*)0x20000088 = 7;
  *(uint32_t*)0x2000008c = 0;
  *(uint32_t*)0x20000094 = 0;
  syscall(__NR_ioctl, r[1], 0xc0184900, 0x20000080ul);
  ...
  *(uint32_t*)0x200003f0 = 0x20000084;
  syscall(__NR_sendmsg, -1, 0x200003c0ul, 0x40000ul);
}
int main(void)
{
