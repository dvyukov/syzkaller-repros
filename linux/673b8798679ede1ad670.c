...
// https://syzkaller.appspot.com/bug?id=673b8798679ede1ad670
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    res = -1;
    NONFAILING(res = syz_init_net_socket(0x1f, 3, 0));
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    syscall(__NR_setsockopt, r[0], 1, 0x1a, 0ul, 0ul);
    break;
  case 2:
    syscall(__NR_setsockopt, -1, 1, 0x40, 0ul, 0ul);
    break;
  case 3:
  ...
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_ioctl, -1, 0x8008f511, 0ul);
    break;
  case 6:
    syscall(__NR_accept4, -1, 0ul, 0ul, 0x80800ul);
    break;
  case 7:
    syscall(__NR_getsockopt, -1, 0, 0x482, 0ul, 0ul);
    break;
  case 8:
  ...
  case 9:
    ...
    break;
  case 10:
    NONFAILING(*(uint8_t*)0x20000700 = 4);
    NONFAILING(*(uint8_t*)0x20000701 = 0xe);
    NONFAILING(*(uint8_t*)0x20000702 = 0xc);
    NONFAILING(*(uint8_t*)0x20000703 = 0xaa);
    NONFAILING(*(uint16_t*)0x20000704 = 0x1003);
    NONFAILING(*(uint8_t*)0x20000706 = 0);
    NONFAILING(
        memcpy((void*)0x20000707, "\x8f\xe5\x80\xbd\x74\xa8\x3b\x1a", 8));
    NONFAILING(syz_emit_vhci(0x20000700, 0xf));
    break;
  case 11:
    NONFAILING(syz_init_net_socket(0x1f, 5, 2));
    break;
  case 12:
    syscall(__NR_getsockopt, -1, 0xffff, 0, 0ul, 0ul);
    break;
  case 13:
    res = -1;
    NONFAILING(res = syz_init_net_socket(0x1f, 5, 2));
    if (res != -1)
      r[1] = res;
    break;
  case 14:
    ...
    syscall(__NR_connect, r[1], 0x20000140ul, 8ul);
    break;
  case 15:
    NONFAILING(memcpy(
        (void*)0x20000440,
        "\x04\x03\x0b\x05\xc8\x00\x00\x00\x00\x00\x00\x00\x01\x06\x1d\x75\x3c"
        "\x27\xcf\x20\x8f\x83\x01\xf0\x23\x91\x77\xc9\xd2\xe4\xe1\x21\x8b\x70"
        "\x00\x7c\xd0\x7f\xdf\xa7\x5d\xe0\x80\x37\xe3\x6b\xae\x89\xdb\x6c\x0d"
        "\x5e\x16\xb3\x94\x79\x3a\xc0\x81\xf2\x95\x25\x35",
        63));
    NONFAILING(syz_emit_vhci(0x20000440, 0xe));
    break;
  case 16:
    res = -1;
    NONFAILING(res = syz_init_net_socket(0x1f, 5, 2));
  ...
  case 17:
    ...
    syscall(__NR_ioctl, r[2], 0x8946, 0x20000000ul);
    break;
  case 18:
    syscall(__NR_setsockopt, r[2], 1, 0x1a, 0ul, 0ul);
    break;
  case 19:
    syscall(__NR_ioctl, -1, 0x8982, 0ul);
    break;
  case 20:
    syscall(__NR_ioctl, -1, 0x8983, 0ul);
    break;
  case 21:
    res = -1;
    NONFAILING(res = syz_init_net_socket(0x1f, 5, 2));
    ...
    break;
  case 22:
    syscall(__NR_setsockopt, r[3], 1, 0x32, 0ul, 0ul);
    break;
  case 23:
