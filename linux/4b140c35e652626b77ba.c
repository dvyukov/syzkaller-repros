// WARNING: ODEBUG bug in cancel_delayed_work (2)
// https://syzkaller.appspot.com/bug?id=4b140c35e652626b77ba
// status:0
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x200000c0 = 0x33;
  syscall(__NR_setsockopt, r[0], 6, 3, 0x200000c0ul, 4ul);
  *(uint16_t*)0x20000040 = 0x1f;
  *(uint16_t*)0x20000042 = 0;
  memset((void*)0x20000044, 0, 6);
  *(uint16_t*)0x2000004a = 0x8e9;
  *(uint8_t*)0x2000004c = 0;
  syscall(__NR_bind, r[0], 0x20000040ul, 0xeul);
  *(uint16_t*)0x20000000 = 0x1f;
  *(uint16_t*)0x20000002 = 0;
  memset((void*)0x20000004, 170, 5);
  *(uint8_t*)0x20000009 = 0x10;
  *(uint16_t*)0x2000000a = 0xfa;
  *(uint8_t*)0x2000000c = 0;
  syscall(__NR_connect, r[0], 0x20000000ul, 0xeul);
}
int main(void)
{
