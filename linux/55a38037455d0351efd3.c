...
// https://syzkaller.appspot.com/bug?id=55a38037455d0351efd3
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint16_t*)0x20000080 = 0x1e);
    NONFAILING(memcpy(
        (void*)0x20000082,
    ...
    break;
  case 2:
    NONFAILING(*(uint64_t*)0x200015c0 = 0x20000100);
    NONFAILING(*(uint16_t*)0x20000100 = -1);
