...
// https://syzkaller.appspot.com/bug?id=c55162be492189fb4f51
// status:6
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x20000044 = 0x96;
  *(uint8_t*)0x20000045 = 0xcc;
  *(uint8_t*)0x20000046 = 0x15;
  *(uint8_t*)0x20000047 = 0x40;
  *(uint16_t*)0x20000048 = 0x25d4;
  *(uint16_t*)0x2000004a = 0x4cab;
  *(uint16_t*)0x2000004c = 0x7860;
  ...
  *(uint8_t*)0x20000060 = 0x90;
  *(uint8_t*)0x20000061 = 0xcd;
  *(uint8_t*)0x20000062 = 0x26;
  *(uint8_t*)0x20000063 = 0;
  *(uint8_t*)0x20000064 = 2;
  *(uint8_t*)0x20000065 = 0;
  *(uint8_t*)0x20000066 = 9;
  *(uint8_t*)0x20000067 = 4;
  *(uint8_t*)0x20000068 = 0;
  *(uint8_t*)0x20000069 = 0;
  *(uint8_t*)0x2000006a = 0;
  *(uint8_t*)0x2000006b = -1;
  *(uint8_t*)0x2000006c = 0xf2;
  *(uint8_t*)0x2000006d = 0x29;
  *(uint8_t*)0x2000006e = 0;
  res = -1;
  res = syz_usb_connect(0, 0x2f, 0x20000040, 0);
  if (res != -1)
    r[0] = res;
