...
// https://syzkaller.appspot.com/bug?id=15d6d157ed13717f5867
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000780 = 0x200001c0;
  memcpy((void*)0x200001c0,
         "\x48\x00\x00\x00\x24\x00\x0b\x0f\x00\x00\x00\x8b\xfb\xbc\x6e\x00\x60"
         "\x00\x00\x00",
         20);
  ...
  *(uint64_t*)0x20000280 = 0x20000840;
  *(uint32_t*)0x20000840 = 0x478;
  *(uint16_t*)0x20000844 = 0x2c;
  *(uint16_t*)0x20000846 = 0xd27;
  *(uint32_t*)0x20000848 = 0;
  *(uint32_t*)0x2000084c = 0;
  *(uint8_t*)0x20000850 = 0;
  *(uint8_t*)0x20000851 = 0;
  *(uint16_t*)0x20000852 = 0;
  *(uint32_t*)0x20000854 = r[2];
  *(uint16_t*)0x20000858 = 0;
  *(uint16_t*)0x2000085a = 0;
  *(uint16_t*)0x2000085c = 0;
  *(uint16_t*)0x2000085e = 0;
  *(uint16_t*)0x20000860 = 8;
  *(uint16_t*)0x20000862 = 0;
  *(uint16_t*)0x20000864 = 0xa;
  *(uint16_t*)0x20000866 = 1;
  memcpy((void*)0x20000868, "basic\000", 6);
  *(uint16_t*)0x20000870 = 0x448;
  *(uint16_t*)0x20000872 = 2;
  *(uint16_t*)0x20000874 = 0x444;
  *(uint16_t*)0x20000876 = 4;
  *(uint16_t*)0x20000878 = 0x404;
  *(uint16_t*)0x2000087a = 2;
