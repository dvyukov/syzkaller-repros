...
// https://syzkaller.appspot.com/bug?id=498f56aa693f8736a6a9d6e0e6afb1fe50f6f070
// status:fixed
...
void test()
{
  ...
  memcpy((void*)0x20aeb000, "\x2f\x64\x65\x76\x2f\x6b\x76\x6d\x00", 9);
  r[2] = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20aeb000ul, 0x1ul,
                 0x0ul);
  ...
  *(uint64_t*)0x20ae6ff8 = (uint64_t)0x205b3000;
  r[10] = syscall(__NR_ioctl, r[3], 0x4020ae46ul, 0x20ae6fe0ul);
  *(uint64_t*)0x2016dfe8 = (uint64_t)0x20;
  *(uint64_t*)0x2016dff0 = (uint64_t)0x20afe000;
  *(uint64_t*)0x2016dff8 = (uint64_t)0x51;
  memcpy((void*)0x20afe000,
         "\xb8\x01\x00\x00\x00\x0f\x01\xd9\xc7\x44\x24\x00\x00\x00\x00"
         "\x00\xc7\x44\x24\x02\x00\x38\x00\x00\xc7\x44\x24\x06\x00\x00"
         "\x00\x00\x0f\x01\x14\x24\x66\x66\x36\x66\x0f\x38\x81\x32\x0f"
         "\x01\x75\x34\xc4\xe1\x0d\x73\xd4\x00\xdd\xcb\x64\x0f\x38\x00"
         "\x05\x24\x00\x00\x00\x66\xb8\xcd\x00\x8e\xe8\x3e\x0f\x22\x9a"
         "\x3e\x66\x0f\x38\x39\xe9",
         81);
  *(uint64_t*)0x207aefe0 = (uint64_t)0x7;
  *(uint64_t*)0x207aefe8 = (uint64_t)0x0;
  *(uint64_t*)0x207aeff0 = (uint64_t)0x7;
  *(uint64_t*)0x207aeff8 = (uint64_t)0x2;
  r[19] = syz_kvm_setup_cpu(r[3], r[4], 0x205b3000ul, 0x2016dfe8ul,
                            0x1ul, 0x20000000ful, 0x207aefe0ul, 0x2ul);
  r[20] = syscall(__NR_ioctl, r[4], 0xae80ul, 0x0ul);
  *(uint32_t*)0x208a7f88 = (uint32_t)0x4000000002;
  *(uint32_t*)0x208a7f8c = (uint32_t)0x78;
  *(uint8_t*)0x208a7f90 = (uint8_t)0x1d;
