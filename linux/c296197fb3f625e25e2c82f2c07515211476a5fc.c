...
// https://syzkaller.appspot.com/bug?id=c296197fb3f625e25e2c82f2c07515211476a5fc
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    *(uint64_t*)0x20000060 = 0;
    ...
    STORE_BY_BITMASK(uint64_t, , 0x20000068, 2, 5, 1);
    ...
    STORE_BY_BITMASK(uint64_t, , 0x20000068, 0x200000000000, 13, 1);
  ...
  case 1:
    ...
    *(uint16_t*)0x2001d06e = 0;
    ...
    break;
  case 2:
    syscall(__NR_mmap, 0x20ffd000, 0x1000, 0x1000000, 0x11, r[1], 0);
    break;
  case 3:
  ...
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_mmap, 0x20ffd000, 0x3000, 0x2000000, 0x4013, r[1], 0);
    break;
  case 6:
    syscall(__NR_mmap, 0x20fff000, 0x1000, 0, 0x2000000001011, r[0], 0);
    break;
  }
}
int main(void)
