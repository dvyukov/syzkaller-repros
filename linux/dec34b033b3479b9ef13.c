...
// https://syzkaller.appspot.com/bug?id=dec34b033b3479b9ef13
// status:0
...
static void execute_one(void)
{
  ...
  for (call = 0; call < 6; call++) {
    for (thread = 0; thread < (int)(sizeof(threads) / sizeof(threads[0]));
      ...
      event_set(&th->ready);
      event_timedwait(&th->done, 45 + (call == 5 ? 50 : 0));
      break;
    }
  }
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x200000c0 = 0x38);
  ...
  case 3:
    ...
    break;
  case 4:
    syscall(__NR_clone, 0x20000103ul, 0ul, 0x9999999999999999ul, 0ul, -1ul);
    break;
  case 5:
