...
// https://syzkaller.appspot.com/bug?id=cc4c0f394e2611edba66
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(*(uint64_t*)0x20000040 = 0x20000180);
  NONFAILING(
      memcpy((void*)0x20000180,
             "\x2e\x00\x00\x00\x10\x00\x81\x08\x04\x0f\x80\xec\xdb\x4c\xb9\x2e"
             "\x0a\x48\x0e\x0a\x34\x00\x00\x00\xe3\xbd\x6e\xfb\x25\x00\x09\x00"
             "\x0e\x00\x0d\x00\x40\x00\x00\xff\x05\x00\x05\x00\x12\x01",
             46));
  NONFAILING(*(uint64_t*)0x20000048 = 0x2e);
  ...
  if (res != -1)
    r[1] = res;
  syscall(__NR_epoll_ctl, -1, 1ul, -1, 0ul);
  NONFAILING(*(uint32_t*)0x20000040 = 0x2880008);
  NONFAILING(*(uint32_t*)0x20000044 = -1);
  NONFAILING(*(uint64_t*)0x20000048 = -1);
  NONFAILING(*(uint64_t*)0x20000050 = 0x8a49);
  NONFAILING(*(uint64_t*)0x20000058 = 0x10003);
  NONFAILING(*(uint64_t*)0x20000060 = 0x801);
  syscall(__NR_ioctl, r[1], 0xc028660f, 0x20000040ul);
  NONFAILING(
      memcpy((void*)0x20000040, "virt_wifi0\000\000\000\000\000\000", 16));
  NONFAILING(*(uint32_t*)0x20000050 = 0x800000);
  syscall(__NR_ioctl, -1, 0x8934, 0x20000040ul);
  syscall(__NR_ioctl, r[1], 0x8b1a, 0x20000040ul);
}
int main(void)
{
