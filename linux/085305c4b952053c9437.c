...
// https://syzkaller.appspot.com/bug?id=085305c4b952053c9437
// status:0
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x20000700, "vcan0\000\000\000\000\000\000\000\000\000\000\000",
         16);
  ...
  *(uint8_t*)0x20000154 = 0;
  syscall(__NR_bind, r[0], 0x20000140ul, 0x18ul);
  ...
  *(uint64_t*)0x20000100 = 0x20000040;
  memset((void*)0x20000040, 30, 1);
  *(uint64_t*)0x20000108 = 0x37c8;
