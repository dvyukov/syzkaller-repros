...
// https://syzkaller.appspot.com/bug?id=c18f2f6a7b08c51e3025
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    memcpy((void*)0x20000180, "./bus/file1\000", 12);
  ...
  case 4:
    ...
    break;
  case 5:
    memcpy((void*)0x200001c0, "./bus/file1\000", 12);
    syscall(__NR_open, 0x200001c0ul, 0x121307ul, 0ul);
    break;
  case 6:
    memcpy((void*)0x200001c0, "./bus/file1\000", 12);
    syscall(__NR_open, 0x200001c0ul, 7ul, 0ul);
    break;
  }
}
int main(void)
