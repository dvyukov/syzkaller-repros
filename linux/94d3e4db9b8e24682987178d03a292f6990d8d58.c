...
// https://syzkaller.appspot.com/bug?id=94d3e4db9b8e24682987178d03a292f6990d8d58
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_fcntl, r[0], 0x401);
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000000, "/selinux/status\x00", 16));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000000, 0, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 3:
    syscall(__NR_mmap, 0x20ffc000, 0x1000, 0, 0x11, r[1], 0);
    break;
  case 4:
    syscall(__NR_mprotect, 0x20000000, 0x800000, 4);
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20000000, "./file0\x00", 8));
