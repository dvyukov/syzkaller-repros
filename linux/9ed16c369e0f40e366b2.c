...
// https://syzkaller.appspot.com/bug?id=9ed16c369e0f40e366b2
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x200004c4 = 0x200008c0;
  *(uint64_t*)0x200004cc = 0;
  *(uint64_t*)0x200004d4 = 0;
  *(uint64_t*)0x200004dc = 0;
  *(uint64_t*)0x200004e4 = 0;
  syz_usb_control_io(r[0], 0, 0x200004c0);
  *(uint32_t*)0x20000800 = 0x84;
  ...
  *(uint64_t*)0x2000083c = 0x200005c0;
  *(uint8_t*)0x200005c0 = 0x40;
  *(uint8_t*)0x200005c1 = 0xb;
  *(uint32_t*)0x200005c2 = 2;
  memcpy((void*)0x200005c6, "\x40\x14", 2);
  ...
  *(uint64_t*)0x20000204 = 0x20000280;
  *(uint8_t*)0x20000280 = 0;
  *(uint8_t*)0x20000281 = 0;
  *(uint32_t*)0x20000282 = 2;
  memcpy((void*)0x20000286, "\x34\xe3", 2);
  ...
  *(uint64_t*)0x2000023c = 0;
  syz_usb_control_io(r[0], 0, 0x20000200);
