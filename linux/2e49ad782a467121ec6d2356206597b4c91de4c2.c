// WARNING in fpu__restore
// https://syzkaller.appspot.com/bug?id=2e49ad782a467121ec6d2356206597b4c91de4c2
// status:open
...
void execute_call(int call)
{
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000280, "user", 5));
    NONFAILING(*(uint8_t*)0x200002c0 = 0x73);
    NONFAILING(*(uint8_t*)0x200002c1 = 0x79);
    NONFAILING(*(uint8_t*)0x200002c2 = 0x7a);
    NONFAILING(*(uint8_t*)0x200002c3 = 0);
    NONFAILING(*(uint8_t*)0x200002c4 = 0);
    syscall(__NR_add_key, 0x20000280, 0x200002c0, 0x20000300, 0, -1);
    break;
  case 1:
