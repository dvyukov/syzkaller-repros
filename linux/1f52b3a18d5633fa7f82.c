...
// https://syzkaller.appspot.com/bug?id=1f52b3a18d5633fa7f82
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint64_t*)0x20000310 = 0x41c1);
    ...
    break;
  case 2:
    syscall(__NR_mmap, 0x2005d000ul, 0x400000ul, 0ul, 0x392d6ad36ec2c8b2ul, -1,
            0ul);
    break;
  case 3:
    syscall(__NR_madvise, 0x20000000ul, 0x600003ul, 8ul);
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000040, "smaps_rollup\000", 13));
    res = -1;
    NONFAILING(res = syz_open_procfs(0, 0x20000040));
    if (res != -1)
      r[0] = res;
    break;
  case 5:
    NONFAILING(*(uint64_t*)0x20000780 = 0x20000080);
    NONFAILING(*(uint64_t*)0x20000788 = 0xaa);
    syscall(__NR_preadv, r[0], 0x20000780ul, 1ul, 0, 3);
    break;
  }
}
int main(void)
