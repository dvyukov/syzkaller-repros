// BUG: unable to handle kernel NULL pointer dereference in kernel_accept
// https://syzkaller.appspot.com/bug?id=3eacb3c2ab0ea263ef82d4547c018d7efd592883
// status:invalid
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    res = syz_open_dev(0x20000040, 7, 0x101000);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    *(uint32_t*)0x20000080 = 2;
    syscall(__NR_setsockopt, r[0], 0x84, 0x12, 0x20000080, 4);
    break;
  case 2:
  ...
  case 3:
    ...
    *(uint8_t*)0x2000060f = 0;
    syscall(__NR_bind, r[1], 0x20000600, 0x10);
    break;
  case 4:
    ...
    *(uint8_t*)0x2000000f = 0;
    syscall(__NR_sendto, r[1], 0x20000040, 0x50212, 0x2000e803, 0x20000000,
            0x10);
    break;
  case 5:
