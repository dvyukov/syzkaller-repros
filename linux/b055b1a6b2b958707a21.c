...
// https://syzkaller.appspot.com/bug?id=b055b1a6b2b958707a21
// status:6
...
int main(void)
{
  ...
  memcpy((void*)0x200007c0, "mpol", 4);
  *(uint8_t*)0x200007c4 = 0x3d;
  memcpy((void*)0x200007c5, "prefer", 6);
  *(uint8_t*)0x200007cb = 0x3a;
  *(uint8_t*)0x200007cc = 0x2c;
  *(uint8_t*)0x200007cd = 0;
  syz_mount_image(0x20000000, 0x20000080, 0, 0, 0, 0, 0x200007c0);
  return 0;
}
