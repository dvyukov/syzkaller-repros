...
// https://syzkaller.appspot.com/bug?id=d32133ac1a0d3fa4bd45
// status:0
...
{
  intptr_t res = 0;
  NONFAILING(memcpy((void*)0x20000040, "/dev/cpu/#/msr\000", 15));
  NONFAILING(syz_open_dev(0x20000040, 0, 0));
  NONFAILING(memcpy((void*)0x20000180, "fd/3\000", 5));
  res = -1;
  ...
  NONFAILING(*(uint64_t*)0x20000110 = 0x200001c0);
  NONFAILING(memset((void*)0x200001c0, 198, 1));
  NONFAILING(*(uint64_t*)0x20000118 = 0x7ffff000);
  syscall(__NR_pwritev, r[0], 0x20000100ul, 2ul, 0x10, 0);
  NONFAILING(memcpy((void*)0x20002000, "fuse\000", 5));
  syscall(__NR_mount, 0ul, 0ul, 0x20002000ul, 0ul, 0ul);
  syscall(__NR_openat, 0xffffff9c, 0ul, 0ul, 0ul);
  syscall(__NR_getdents, -1, 0ul, 2ul);
}
int main(void)
{
