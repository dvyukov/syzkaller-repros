...
// https://syzkaller.appspot.com/bug?id=6e9fc6ed2622084c544b
// status:0
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    syscall(__NR_mount, 0x20000080ul, 0x200001c0ul, 0x20000200ul, 0x2010050ul,
            0ul);
    break;
  case 4:
  ...
  case 7:
    ...
    *(uint8_t*)0x2000017a = 0x2c;
    memcpy((void*)0x2000017b, "access", 6);
    *(uint8_t*)0x20000181 = 0x3d;
    sprintf((char*)0x20000182, "%020llu", (long long)0);
    *(uint8_t*)0x20000196 = 0x2c;
    *(uint8_t*)0x20000197 = 0x6b;
