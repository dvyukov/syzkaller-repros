...
// https://syzkaller.appspot.com/bug?id=cd814e39df335730d001
// status:6
...
void execute_one(void)
{
  ...
  *(uint16_t*)0x20000384 = r[2];
  memcpy((void*)0x20000386, "\x05\x00\x00\x00\x00\x00\x00\x00\x00\x00\x06\x00"
  ...
  *(uint32_t*)0x20000370 = 0;
  ...
  if (res != -1)
    r[4] = res;
  memcpy((void*)0x20000180, "wlan1\000\000\000\000\000\000\000\000\000\000\000",
         16);
