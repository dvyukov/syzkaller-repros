...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000010 = 0;
  res = syscall(__NR_ioctl, r[0], 0x8933ul, 0x20000000ul);
  if (res != -1)
  ...
  *(uint32_t*)0x20000344 = 0x1f;
  *(uint32_t*)0x20000348 = 0x13;
  *(uint16_t*)0x2000034c = 8;
  *(uint16_t*)0x2000034e = 5;
  *(uint32_t*)0x20000350 = r[1];
  *(uint16_t*)0x20000354 = 8;
  *(uint16_t*)0x20000356 = 0xa;
  *(uint32_t*)0x20000358 = r[1];
