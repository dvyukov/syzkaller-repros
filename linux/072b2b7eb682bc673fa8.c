...
// https://syzkaller.appspot.com/bug?id=072b2b7eb682bc673fa8
// status:0
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x20000180 = 0x7fffffff);
    NONFAILING(*(uint32_t*)0x20000184 = 1);
    NONFAILING(*(uint32_t*)0x20000188 = 2);
    NONFAILING(*(uint32_t*)0x2000018c = 0);
    res = syscall(__NR_ioctl, r[2], 0xc02064b2, 0x20000180ul);
    if (res != -1)
      NONFAILING(r[3] = *(uint32_t*)0x20000190);
    break;
  case 5:
    NONFAILING(*(uint32_t*)0x20000140 = r[3]);
    syscall(__NR_ioctl, r[0], 0xc10c5541, 0x20000140ul);
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x20000040 = r[1]);
    syscall(__NR_ioctl, r[0], 0xc00464b4, 0x20000040ul);
    break;
  }
}
int main(void)
