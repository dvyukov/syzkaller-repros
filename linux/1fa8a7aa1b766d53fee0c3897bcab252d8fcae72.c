...
int main(void)
{
  ...
  memcpy((void*)0x20000000, "\x12\x01\x00\x00\xaa\x3b\x98\x08\x11\x0f\x20\x20"
                            "\xc9\x4a\x00\x00\x00\x01\x09\x02\x24\x00\x01\x00"
                            "\x00\x00\x00\x09\x04\x1c\x00\x02\x91\x26\xc9\x00"
                            "\x09\x05\x98\x45\x00\x00\x00\x00\x00\x09\x05\x87"
  ...
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x20000080, "\xc6", 1);
  syscall(__NR_write, r[0], 0x20000080, 1);
  return 0;
}
