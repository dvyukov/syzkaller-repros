...
// https://syzkaller.appspot.com/bug?id=abfc0f5e668d4099af73
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_write, -1, 0ul, 0xaul);
    break;
  case 4:
  ...
  case 7:
    ...
    break;
  case 8:
    syscall(__NR_write, -1, 0ul, 0xfef0ul);
    break;
  case 9:
    syscall(__NR_splice, -1, 0ul, r[0], 0ul, 0x80000001ul, 0ul);
    break;
  case 10:
    res = -1;
    NONFAILING(res = syz_init_net_socket(0x1f, 2, 0));
    if (res != -1)
      r[1] = res;
    break;
  case 11:
    NONFAILING(*(uint16_t*)0x20000380 = 0x1f);
    NONFAILING(*(uint16_t*)0x20000382 = 0);
    NONFAILING(*(uint8_t*)0x20000384 = 0xaa);
    NONFAILING(*(uint8_t*)0x20000385 = 0xaa);
    NONFAILING(*(uint8_t*)0x20000386 = 0xaa);
    NONFAILING(*(uint8_t*)0x20000387 = 0xaa);
    NONFAILING(*(uint8_t*)0x20000388 = 0xaa);
    NONFAILING(*(uint8_t*)0x20000389 = 0);
    NONFAILING(*(uint16_t*)0x2000038a = 3);
    NONFAILING(*(uint8_t*)0x2000038c = 0);
    syscall(__NR_connect, r[1], 0x20000380ul, 0xeul);
    break;
  case 12:
