...
void execute_one(void)
{
  ...
  *(uint8_t*)0x20000044 = 0xe8;
  *(uint8_t*)0x20000045 = 0xf9;
  *(uint8_t*)0x20000046 = 0x91;
  *(uint8_t*)0x20000047 = 8;
  *(uint16_t*)0x20000048 = 0x2040;
  *(uint16_t*)0x2000004a = 0x6502;
  *(uint16_t*)0x2000004c = 0xca4d;
  ...
  *(uint8_t*)0x2000005d = 0xb0;
  *(uint8_t*)0x2000005e = 0;
  *(uint8_t*)0x2000005f = 1;
  *(uint8_t*)0x20000060 = 0xe4;
  *(uint8_t*)0x20000061 = 0x57;
  *(uint8_t*)0x20000062 = 0x4a;
  *(uint8_t*)0x20000063 = 0;
  *(uint8_t*)0x20000064 = 2;
  *(uint8_t*)0x20000065 = 0xa;
  *(uint8_t*)0x20000066 = 7;
  *(uint8_t*)0x20000067 = 5;
  *(uint8_t*)0x20000068 = 0x82;
  *(uint8_t*)0x20000069 = 3;
  *(uint16_t*)0x2000006a = 0;
  *(uint8_t*)0x2000006c = 4;
  *(uint8_t*)0x2000006d = 0;
  *(uint8_t*)0x2000006e = 0;
  syz_usb_connect(5, 0x2f, 0x20000040, 0);
}
int main(void)
{
