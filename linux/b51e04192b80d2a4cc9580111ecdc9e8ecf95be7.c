...
// https://syzkaller.appspot.com/bug?id=b51e04192b80d2a4cc9580111ecdc9e8ecf95be7
// status:fixed
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    res = syscall(__NR_socket, 0xa, 0x201000000000002, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_listen, r[1], 0xffffff7f);
    break;
  case 3:
    res = syscall(__NR_socket, 0xa, 1, 0x84);
    if (res != -1)
  ...
  case 4:
    ...
    syscall(__NR_sendto, r[2], 0x20e33fe0, 0, 0, 0x2005ffe4, 0x1c);
    break;
  case 5:
    ...
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000000, "\x49\x44\x4c\x45\x54\x49\x4d\x45\x52"
                                         "\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                                         "\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                                         "\x00\x00",
                      29));
    NONFAILING(*(uint8_t*)0x2000001d = 0);
    NONFAILING(*(uint32_t*)0x20000040 = 0x1e);
    syscall(__NR_getsockopt, r[3], 0, 0x43, 0x20000000, 0x20000040);
    break;
  case 7:
