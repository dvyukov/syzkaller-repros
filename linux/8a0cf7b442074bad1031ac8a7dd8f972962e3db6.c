...
// https://syzkaller.appspot.com/bug?id=8a0cf7b442074bad1031ac8a7dd8f972962e3db6
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x20d9bffc = 0);
    syscall(__NR_setsockopt, r[0], 1, 8, 0x20d9bffc, 0xfff9);
    break;
  case 2:
    NONFAILING(memcpy((void*)0x200005c0,
                      "\x12\x00\x00\x00\x12\x00\xe7\xef\x00\x7b\x00\x00\x00\x00"
                      "\x00\x00\x00\xa1",
                      18));
    syscall(__NR_sendto, r[0], 0x200005c0, 0x12, 0, 0, 0);
    break;
  case 3:
    ...
    NONFAILING(memcpy((void*)0x20000080,
                      "\x18\x00\x00\x00\x30\x00\x19\x0c\x00\x00\x00\x00\x00\x00"
                      "\x00\x00\x00\x00\x00\x00\x04\x00\x01\x00",
                      24));
