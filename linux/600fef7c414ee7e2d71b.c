...
// https://syzkaller.appspot.com/bug?id=600fef7c414ee7e2d71b
// status:6
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000140 = 0x38;
  *(uint16_t*)0x20000144 = 0x1403;
  ...
  *(uint16_t*)0x2000015e = 0x41;
  memcpy((void*)0x20000160, "rxe\000", 4);
  *(uint16_t*)0x20000164 = 0x14;
  *(uint16_t*)0x20000166 = 0x33;
  memcpy((void*)0x20000168, "macvtap0\000\000\000\000\000\000\000\000", 16);
  ...
  *(uint64_t*)0x20000080 = 0x20000040;
  memcpy((void*)0x20000040, "\x14\x00\x00\x00\x32\x00\x05\x67\x31\x68\x55\x1b"
                            "\xe9\xed\xfd\x9a\x06\x00\x1b\x61",
         20);
