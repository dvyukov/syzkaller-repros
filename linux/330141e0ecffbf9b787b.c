...
// https://syzkaller.appspot.com/bug?id=330141e0ecffbf9b787b
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(*(uint8_t*)0x20000380 = 8);
    NONFAILING(*(uint8_t*)0x20000381 = 2);
    NONFAILING(*(uint8_t*)0x20000382 = 0x11);
    NONFAILING(*(uint8_t*)0x20000383 = 0);
    NONFAILING(*(uint8_t*)0x20000384 = 0);
    NONFAILING(*(uint8_t*)0x20000385 = 0);
    NONFAILING(syz_80211_inject_frame(0x20000380, 0, 0));
    break;
  case 2:
    ...
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000040, "nl80211\000", 8));
    res = -1;
  ...
  case 5:
    ...
    if (res != -1)
      NONFAILING(r[3] = *(uint32_t*)0x20000090);
    break;
  case 6:
    NONFAILING(*(uint64_t*)0x20000380 = 0);
    NONFAILING(*(uint32_t*)0x20000388 = 0);
    NONFAILING(*(uint64_t*)0x20000390 = 0x20000100);
    NONFAILING(*(uint64_t*)0x20000100 = 0x20000600);
    NONFAILING(*(uint32_t*)0x20000600 = 0x48);
    NONFAILING(*(uint16_t*)0x20000604 = r[1]);
    NONFAILING(*(uint16_t*)0x20000606 = 1);
    NONFAILING(*(uint32_t*)0x20000608 = 0);
    NONFAILING(*(uint32_t*)0x2000060c = 0);
    NONFAILING(*(uint8_t*)0x20000610 = 0x3b);
    NONFAILING(*(uint8_t*)0x20000611 = 0);
    NONFAILING(*(uint16_t*)0x20000612 = 0);
    NONFAILING(*(uint16_t*)0x20000614 = 8);
    NONFAILING(*(uint16_t*)0x20000616 = 3);
    NONFAILING(*(uint32_t*)0x20000618 = r[3]);
    NONFAILING(*(uint16_t*)0x2000061c = 0x2a);
    NONFAILING(*(uint16_t*)0x2000061e = 0x33);
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000620, 0, 0, 2));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000620, 0, 2, 2));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000620, 0xd, 4, 4));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000621, 0, 0, 1));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000621, 0, 1, 1));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000621, 0, 2, 1));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000621, 0, 3, 1));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000621, 0, 4, 1));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000621, 0, 5, 1));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000621, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000621, 0, 7, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000622, 0, 0, 15));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000623, 0, 7, 1));
    NONFAILING(*(uint8_t*)0x20000624 = 8);
    NONFAILING(*(uint8_t*)0x20000625 = 2);
    NONFAILING(*(uint8_t*)0x20000626 = 0x11);
    NONFAILING(*(uint8_t*)0x20000627 = 0);
    NONFAILING(*(uint8_t*)0x20000628 = 0);
    NONFAILING(*(uint8_t*)0x20000629 = 0);
    NONFAILING(*(uint8_t*)0x2000062a = 8);
    NONFAILING(*(uint8_t*)0x2000062b = 2);
    NONFAILING(*(uint8_t*)0x2000062c = 0x11);
    NONFAILING(*(uint8_t*)0x2000062d = 0);
    NONFAILING(*(uint8_t*)0x2000062e = 0);
    NONFAILING(*(uint8_t*)0x2000062f = 1);
    NONFAILING(*(uint8_t*)0x20000630 = 0x50);
    NONFAILING(*(uint8_t*)0x20000631 = 0x50);
    NONFAILING(*(uint8_t*)0x20000632 = 0x50);
    NONFAILING(*(uint8_t*)0x20000633 = 0x50);
    NONFAILING(*(uint8_t*)0x20000634 = 0x50);
    NONFAILING(*(uint8_t*)0x20000635 = 0x50);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000636, 0, 0, 4));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000636, 0, 4, 12));
    NONFAILING(*(uint8_t*)0x20000638 = 4);
    NONFAILING(*(uint8_t*)0x20000639 = 4);
    ...
    NONFAILING(*(uint8_t*)0x2000063e = 0x76);
    NONFAILING(*(uint8_t*)0x2000063f = 6);
    NONFAILING(*(uint8_t*)0x20000640 = 0);
    NONFAILING(*(uint8_t*)0x20000641 = 0);
    NONFAILING(*(uint16_t*)0x20000642 = 0);
    NONFAILING(*(uint16_t*)0x20000644 = 0);
    NONFAILING(*(uint64_t*)0x20000108 = 0x48);
    ...
    break;
  case 7:
    syscall(__NR_sendmsg, -1, 0ul, 0x10ul);
    break;
  }
}
int main(void)
