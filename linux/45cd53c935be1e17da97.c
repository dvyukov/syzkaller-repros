...
// https://syzkaller.appspot.com/bug?id=45cd53c935be1e17da97
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000780 = 0x200007c0;
  *(uint32_t*)0x200007c0 = 0x158;
  *(uint16_t*)0x200007c4 = 0x24;
  *(uint16_t*)0x200007c6 = 0xd8b;
  ...
  *(uint16_t*)0x200007dc = -1;
  *(uint16_t*)0x200007de = -1;
  *(uint16_t*)0x200007e0 = 0;
  *(uint16_t*)0x200007e2 = 0;
  *(uint16_t*)0x200007e4 = 0x2c;
  STORE_BY_BITMASK(uint16_t, , 0x200007e6, 8, 0, 14);
  STORE_BY_BITMASK(uint16_t, , 0x200007e7, 0, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x200007e7, 1, 7, 1);
  *(uint16_t*)0x200007e8 = 0x1c;
  *(uint16_t*)0x200007ea = 1;
  *(uint8_t*)0x200007ec = 0x81;
  *(uint8_t*)0x200007ed = 5;
  *(uint16_t*)0x200007ee = 0x47;
  *(uint32_t*)0x200007f0 = 2;
  *(uint32_t*)0x200007f4 = 0;
  *(uint32_t*)0x200007f8 = 0x2d13;
  *(uint32_t*)0x200007fc = 0xffff;
  *(uint32_t*)0x20000800 = 3;
  ...
  *(uint16_t*)0x20000812 = 1;
  memcpy((void*)0x20000814, "mqprio\000", 7);
  *(uint16_t*)0x2000081c = 0x58;
  *(uint16_t*)0x2000081e = 2;
  *(uint8_t*)0x20000820 = 4;
  *(uint8_t*)0x20000821 = 8;
  *(uint8_t*)0x20000822 = 8;
  *(uint8_t*)0x20000823 = 3;
  *(uint8_t*)0x20000824 = 4;
  *(uint8_t*)0x20000825 = 7;
  *(uint8_t*)0x20000826 = 1;
  *(uint8_t*)0x20000827 = 0xa;
  *(uint8_t*)0x20000828 = 4;
  *(uint8_t*)0x20000829 = 2;
  *(uint8_t*)0x2000082a = 6;
  *(uint8_t*)0x2000082b = 0xfe;
  *(uint8_t*)0x2000082c = 6;
  *(uint8_t*)0x2000082d = 3;
  *(uint8_t*)0x2000082e = 1;
  *(uint8_t*)0x2000082f = 0;
  *(uint8_t*)0x20000830 = 0xf;
  *(uint8_t*)0x20000831 = 1;
  *(uint16_t*)0x20000832 = 0xbc;
  *(uint16_t*)0x20000834 = 0;
  *(uint16_t*)0x20000836 = 1;
  *(uint16_t*)0x20000838 = 9;
  *(uint16_t*)0x2000083a = 9;
  *(uint16_t*)0x2000083c = 1;
  *(uint16_t*)0x2000083e = 0x9bbd;
  *(uint16_t*)0x20000840 = 0x7ff;
  *(uint16_t*)0x20000842 = 8;
  *(uint16_t*)0x20000844 = 0x7f;
  *(uint16_t*)0x20000846 = 8;
  *(uint16_t*)0x20000848 = 6;
  *(uint16_t*)0x2000084a = 0xf06b;
  *(uint16_t*)0x2000084c = 0;
  *(uint16_t*)0x2000084e = 0x7f;
  *(uint16_t*)0x20000850 = 0;
  *(uint16_t*)0x20000852 = 0;
  *(uint16_t*)0x20000854 = 0xb8;
  *(uint16_t*)0x20000856 = 0x7ff;
  *(uint16_t*)0x20000858 = 7;
  *(uint16_t*)0x2000085a = 3;
  *(uint16_t*)0x2000085c = 9;
  *(uint16_t*)0x2000085e = 0;
  *(uint16_t*)0x20000860 = 0x7ff;
  *(uint16_t*)0x20000862 = 0x1ff;
  *(uint16_t*)0x20000864 = 0x200;
  *(uint16_t*)0x20000866 = 7;
  *(uint16_t*)0x20000868 = 1;
  *(uint16_t*)0x2000086a = 0x40;
  *(uint16_t*)0x2000086c = 0x3ff;
  *(uint16_t*)0x2000086e = 6;
  *(uint16_t*)0x20000870 = 3;
  *(uint16_t*)0x20000874 = 8;
  *(uint16_t*)0x20000876 = 1;
  memcpy((void*)0x20000878, "htb\000", 4);
  *(uint16_t*)0x2000087c = 0x9c;
  *(uint16_t*)0x2000087e = 2;
  *(uint16_t*)0x20000880 = 8;
  *(uint16_t*)0x20000882 = 5;
  *(uint32_t*)0x20000884 = 0x200;
  *(uint16_t*)0x20000888 = 0x18;
  *(uint16_t*)0x2000088a = 2;
  *(uint32_t*)0x2000088c = 3;
  *(uint32_t*)0x20000890 = 9;
  *(uint32_t*)0x20000894 = 7;
  *(uint32_t*)0x20000898 = 0;
  *(uint32_t*)0x2000089c = 0;
  *(uint16_t*)0x200008a0 = 8;
  *(uint16_t*)0x200008a2 = 5;
  *(uint32_t*)0x200008a4 = 0;
  *(uint16_t*)0x200008a8 = 0x18;
  *(uint16_t*)0x200008aa = 2;
  *(uint32_t*)0x200008ac = 3;
  *(uint32_t*)0x200008b0 = -1;
  *(uint32_t*)0x200008b4 = 0x7fff;
  *(uint32_t*)0x200008b8 = 0;
  *(uint32_t*)0x200008bc = 0;
  *(uint16_t*)0x200008c0 = 8;
  *(uint16_t*)0x200008c2 = 5;
  *(uint32_t*)0x200008c4 = 1;
  *(uint16_t*)0x200008c8 = 0x18;
  *(uint16_t*)0x200008ca = 2;
  *(uint32_t*)0x200008cc = 3;
  *(uint32_t*)0x200008d0 = 0x7fffffff;
  *(uint32_t*)0x200008d4 = -1;
  *(uint32_t*)0x200008d8 = 0;
  *(uint32_t*)0x200008dc = 0;
  *(uint16_t*)0x200008e0 = 8;
  *(uint16_t*)0x200008e2 = 5;
  *(uint32_t*)0x200008e4 = 0x7f;
  *(uint16_t*)0x200008e8 = 0x18;
  *(uint16_t*)0x200008ea = 2;
  *(uint32_t*)0x200008ec = 3;
  *(uint32_t*)0x200008f0 = 0x649;
  *(uint32_t*)0x200008f4 = 1;
  *(uint32_t*)0x200008f8 = 0;
  *(uint32_t*)0x200008fc = 0;
  *(uint16_t*)0x20000900 = 0x18;
  *(uint16_t*)0x20000902 = 2;
  *(uint32_t*)0x20000904 = 3;
  *(uint32_t*)0x20000908 = 0xffff;
  *(uint32_t*)0x2000090c = -1;
  *(uint32_t*)0x20000910 = 0;
  *(uint32_t*)0x20000914 = 0;
  *(uint64_t*)0x20000788 = 0x158;
