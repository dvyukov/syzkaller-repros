...
// https://syzkaller.appspot.com/bug?id=0fd0e974ce67897b92db
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_preadv, r[0], 0x20000280ul, 1ul, 0, 0);
    break;
  case 3:
  ...
  case 8:
    ...
    if (res != -1)
      NONFAILING(r[5] = *(uint32_t*)0x20000104);
    break;
  case 9:
    ...
    NONFAILING(memcpy((void*)0x20000080,
                      ...
                      20));
    NONFAILING(*(uint32_t*)0x20000094 = r[5]);
  ...
  case 10:
    ...
    NONFAILING(*(uint64_t*)0x20000780 = 0x20000240);
    ...
    NONFAILING(*(uint32_t*)0x20000254 = r[5]);
    ...
    NONFAILING(memcpy((void*)0x20000268, "fq_codel\000", 9));
    NONFAILING(*(uint16_t*)0x20000274 = 4);
    NONFAILING(*(uint16_t*)0x20000276 = 2);
  ...
  case 11:
    ...
    NONFAILING(*(uint64_t*)0x20000180 = 0x20000800);
    NONFAILING(*(uint32_t*)0x20000800 = 0x30);
    NONFAILING(*(uint16_t*)0x20000804 = 0x2c);
    NONFAILING(*(uint16_t*)0x20000806 = 0xd27);
    ...
    NONFAILING(*(uint32_t*)0x20000814 = r[5]);
    NONFAILING(*(uint16_t*)0x20000818 = 0xc);
    NONFAILING(*(uint16_t*)0x2000081a = 0);
    NONFAILING(*(uint16_t*)0x2000081c = 0);
    NONFAILING(*(uint16_t*)0x2000081e = 0);
    NONFAILING(*(uint16_t*)0x20000820 = 0xc);
    NONFAILING(*(uint16_t*)0x20000822 = 0);
    NONFAILING(*(uint16_t*)0x20000824 = 8);
    NONFAILING(*(uint16_t*)0x20000826 = 1);
    NONFAILING(memcpy((void*)0x20000828, "u32\000", 4));
    NONFAILING(*(uint16_t*)0x2000082c = 4);
    NONFAILING(*(uint16_t*)0x2000082e = 2);
    NONFAILING(*(uint64_t*)0x20000188 = 0x30);
