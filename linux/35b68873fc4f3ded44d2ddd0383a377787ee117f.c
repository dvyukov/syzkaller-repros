// BUG: unable to handle kernel NULL pointer dereference in vivid_stop_generating_vid_cap
// https://syzkaller.appspot.com/bug?id=35b68873fc4f3ded44d2ddd0383a377787ee117f
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint32_t*)0x2001d05c = 5);
    ...
    break;
  case 1:
    syscall(__NR_fcntl, r[0], 4, 0x2000);
    break;
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_ioctl, -1, 0xc0385720, 0);
    break;
  case 4:
    NONFAILING(*(uint8_t*)0x200000c0 = 9);
    ...
    NONFAILING(*(uint32_t*)0x200000d4 = 6);
    ...
    syscall(__NR_ioctl, -1, 0xc058534f, 0x200000c0);
    break;
  case 5:
    NONFAILING(*(uint32_t*)0x20000280 = 7);
    NONFAILING(*(uint8_t*)0x20000284 = 0x47);
    NONFAILING(*(uint16_t*)0x20000285 = 2);
    syscall(__NR_write, -1, 0x20000280, 7);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000040,
                      "TPROXY\000\000\000\000\000\000\000\000\000\000\000\000"
                      "\000\000\000\000\000\000\000\000\000\000\000",
                      29));
    NONFAILING(*(uint8_t*)0x2000005d = 0);
    NONFAILING(*(uint32_t*)0x20000080 = 0x1e);
    syscall(__NR_getsockopt, r[1], 0, 0x63, 0x20000040, 0x20000080);
    break;
  case 7:
    syscall(__NR_openat, 0xffffffffffffff9c, 0, 0, 0);
    break;
  case 8:
    NONFAILING(memcpy((void*)0x20000200, "/dev/video#\000", 12));
    res = syz_open_dev(0x20000200, 3, 2);
    if (res != -1)
      r[2] = res;
    break;
  case 9:
    syscall(__NR_splice, r[2], 0, -1, 0, 0, 3);
    break;
  case 10:
    NONFAILING(*(uint64_t*)0x200018c0 = 0x20000040);
    NONFAILING(*(uint64_t*)0x200018c8 = 0);
    NONFAILING(*(uint64_t*)0x200018d0 = 0x20000540);
    NONFAILING(*(uint64_t*)0x200018d8 = 0x1000);
    NONFAILING(*(uint64_t*)0x200018e0 = 0x20001540);
    NONFAILING(*(uint64_t*)0x200018e8 = 0x9e);
    NONFAILING(*(uint64_t*)0x200018f0 = 0);
    NONFAILING(*(uint64_t*)0x200018f8 = 0);
    NONFAILING(*(uint64_t*)0x20001900 = 0x20000400);
    NONFAILING(*(uint64_t*)0x20001908 = 0x50);
    NONFAILING(*(uint64_t*)0x20001910 = 0x200017c0);
    NONFAILING(*(uint64_t*)0x20001918 = 0xdb);
    syscall(__NR_preadv, r[2], 0x200018c0, 6, 0);
    break;
  case 11:
