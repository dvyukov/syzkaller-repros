...
// https://syzkaller.appspot.com/bug?id=b9aad4b8d38cf4339b75d4d85b52fcbb2a35af35
// status:fixed
...
void loop()
{
  ...
  memcpy((void*)0x20004ff7, "\x2f\x64\x65\x76\x2f\x6b\x76\x6d\x00", 9);
  ...
  *(uint64_t*)0x20ae5ff8 = (uint64_t)0x202cb000;
  r[10] = syscall(__NR_ioctl, r[3], 0x4020ae46ul, 0x20ae5fe0ul);
  *(uint64_t*)0x20ae8fe8 = (uint64_t)0x20;
  *(uint64_t*)0x20ae8ff0 = (uint64_t)0x20aecfc8;
  *(uint64_t*)0x20ae8ff8 = (uint64_t)0x38;
  memcpy((void*)0x20aecfc8,
         "\x67\x0f\xae\x8e\x00\x00\x0f\xc7\xfa\xdd\x84\xfc\x2f\xa8\x00"
         "\x00\xf0\x83\x06\x00\x66\x66\x0f\x38\x81\x78\xc0\x0f\xc7\xaa"
         "\xfa\xff\xff\xff\xc4\xc2\x81\xa7\x1f\xb9\x3b\x06\x00\x00\x0f"
         "\x32\x26\xf3\x0f\x23\x8a\xc4\xe1\xe1\xd3\xdc",
         56);
  r[15] = syz_kvm_setup_cpu(r[3], r[4], 0x20077000ul, 0x20ae8fe8ul,
                            0x1ul, 0x1ul, 0x20ae8000ul, 0x0ul);
  r[16] = syscall(__NR_ioctl, r[4], 0xae80ul, 0x0ul);
}
