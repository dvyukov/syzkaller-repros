...
// https://syzkaller.appspot.com/bug?id=a1c27d97870876dcccbac41a965e46f672fc3855
// status:fixed
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000200, "./..", 5));
    res = syscall(__NR_openat, -1, 0x20000200, 0x200002, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000000, "./cgroup.net/syz1", 18));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000000, 0x200002, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000080, "memory.current", 15));
    syscall(__NR_openat, r[0], 0x20000080, 0, 0);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000240, "/dev/net/tun", 13));
    syscall(__NR_openat, 0xffffffffffffff9c, 0x20000240, 0x8000, 0);
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x20000140 = r[1]);
    NONFAILING(*(uint32_t*)0x20000144 = 3);
    NONFAILING(*(uint32_t*)0x20000148 = 1);
    NONFAILING(*(uint32_t*)0x2000014c = 0xe0000000);
    NONFAILING(*(uint64_t*)0x20000150 = 0x200000c0);
    NONFAILING(*(uint32_t*)0x20000158 = 7);
    syscall(__NR_bpf, 0x10, 0x20000140, 0x20);
    break;
  case 5:
    NONFAILING(*(uint32_t*)0x20000000 = 1);
    NONFAILING(*(uint32_t*)0x20000004 = 0xa);
    ...
    NONFAILING(memcpy(
        ...
        "\x00\x00\x00\x00\x00\x15\x01\x00\x00\x00\x00\x00\x00\xb7\x00\x00\x00"
