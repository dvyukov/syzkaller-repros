...
// https://syzkaller.appspot.com/bug?id=2274920d9a6695858d52128ea74f8999f2db2748
// status:open
...
void execute_one(void)
{
  ...
  NONFAILING(*(uint64_t*)0x2001d018 = 0x8038);
  ...
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2001d028, 1, 9, 1));
  ...
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2001d028, 1, 14, 1));
  ...
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2001d028, 1, 19, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0, 20, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0, 21, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2001d028, 1, 22, 1));
  ...
  NONFAILING(*(uint32_t*)0x2001d030 = 0xf06);
  NONFAILING(*(uint32_t*)0x2001d034 = 0);
  NONFAILING(*(uint64_t*)0x2001d038 = 0);
  NONFAILING(*(uint64_t*)0x2001d040 = 0x10);
  ...
  NONFAILING(*(uint64_t*)0x2001d060 = 0xfffffffffffffffc);
  ...
  syscall(__NR_clone, 0x7ffe, 0, 0x9999999999999999, 0, -1);
  syscall(__NR_exit_group, 0);
  NONFAILING(*(uint16_t*)0x20001980 = 1);
  NONFAILING(*(uint64_t*)0x20001988 = 0x20000000);
  NONFAILING(*(uint16_t*)0x20000000 = 6);
  NONFAILING(*(uint8_t*)0x20000002 = 0);
  NONFAILING(*(uint8_t*)0x20000003 = 0);
  NONFAILING(*(uint32_t*)0x20000004 = 0x50000);
  syscall(__NR_seccomp, 1, 3, 0x20001980);
}
int main(void)
{
