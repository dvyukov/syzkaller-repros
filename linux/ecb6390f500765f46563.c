...
// https://syzkaller.appspot.com/bug?id=ecb6390f500765f46563
// status:0
...
void execute_call(int call)
{
  ...
  case 6:
    memcpy((void*)0x20000200,
           "\xf8\x83\x5a\x07\x93\x04\xad\x06\x4c\x2b\x98\x41\x32\x73\x76\x7b"
           "\x8e\xa5\x11\x11",
           20);
    syscall(__NR_write, r[1], 0x20000200ul, 0xfffffeccul);
    break;
  case 7:
    syscall(__NR_splice, r[0], 0ul, r[2], 0ul, 0xfffffffful, 0ul);
    break;
  }
}
int main(void)
