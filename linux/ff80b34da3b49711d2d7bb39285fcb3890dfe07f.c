...
// https://syzkaller.appspot.com/bug?id=ff80b34da3b49711d2d7bb39285fcb3890dfe07f
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0, 0x101000, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
    syscall(__NR_getsockopt, r[0], 0x103, 1, 0, 0);
    break;
  case 3:
  ...
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_ioctl, -1, 0xc0106426, 0);
    break;
  case 7:
  ...
  case 11:
    ...
    NONFAILING(*(uint32_t*)0x2000018a = r[1]);
    ...
    syscall(__NR_connect, r[2], 0x20000180, 0x26);
    break;
  case 12:
