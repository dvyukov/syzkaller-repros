...
// https://syzkaller.appspot.com/bug?id=8670f2d214d37784bc4dc56676bec785421c0a15
// status:fixed
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint8_t*)0x2000645b = 0x14);
    ...
    NONFAILING(*(uint8_t*)0x2000647a = 0x80);
    NONFAILING(*(uint8_t*)0x2000647b = 0x80);
  ...
  case 2:
    ...
    break;
  case 3:
    res = syscall(__NR_socket, 0x10, 0x4000000000003, 6);
    if (res != -1)
      r[1] = res;
    break;
  case 4:
    ...
    NONFAILING(*(uint64_t*)0x20000110 = 0x20009ff0);
    NONFAILING(*(uint64_t*)0x20009ff0 = 0x20000000);
    NONFAILING(memcpy((void*)0x20000000,
                      "\x24\x00\x00\x00\x24\x00\x07\x03\x1d\xff\xfd\x94\x6f\xa2"
                      "\x83\x00\x20\x20\x0a\x00\x09\x00\x04\x00\x00\x1d\x85\x68"
                      "\x0c\x1b\xa3\xa2\x04\x00\xff\x7e",
                      36));
    NONFAILING(*(uint64_t*)0x20009ff8 = 0x24);
    ...
    syscall(__NR_sendmsg, r[1], 0x20000100, 0);
    break;
  }
}
int main(void)
