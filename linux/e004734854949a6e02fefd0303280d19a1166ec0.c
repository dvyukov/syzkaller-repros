...
// https://syzkaller.appspot.com/bug?id=e004734854949a6e02fefd0303280d19a1166ec0
// status:invalid
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000000, "vfat", 5));
    NONFAILING(memcpy((void*)0x200004c0, "./file0", 8));
    syz_mount_image(0x20000000, 0x200004c0, 0, 0, 0x20000500, 0, 0x20000080);
    break;
  case 1:
  ...
  case 2:
    NONFAILING(
        memcpy((void*)0x200000c0, "\x2e\x2f\x66\x69\x2e\x65\x31\x8c", 8));
    syscall(__NR_mknodat, r[0], 0x200000c0, 0, 0);
    break;
  case 3:
    syscall(__NR_socketpair, 1, 0, 0, 0x20000000);
    break;
  case 4:
    res = syscall(__NR_fanotify_init, 7, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 5:
    NONFAILING(
        memcpy((void*)0x200002c0, "\x2e\x2f\x66\x69\x2e\x65\x31\x8c\x00", 9));
    syscall(__NR_fanotify_mark, r[1], 0x11, 0x40010029, r[0], 0x200002c0);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000180, "./file0/file0", 14));
