...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_ioctl, -1, 0xc0c0583b, 0);
    break;
  case 1:
  ...
  case 3:
    ...
    break;
  case 4:
    syscall(__NR_getsockopt, r[0], 0x29, 0x45, 0, 0);
    break;
  case 5:
  ...
  case 13:
    ...
    *(uint32_t*)0x200001f0 = 0;
    syscall(__NR_sendmsg, r[5], 0x200001c0, 0);
    break;
  case 14:
    *(uint32_t*)0x20000200 = 0xa;
    res = syscall(__NR_getsockname, r[5], 0x20000100, 0x20000200);
    if (res != -1)
  ...
  case 15:
    ...
    *(uint32_t*)0x20000070 = 0;
    syscall(__NR_sendmsg, r[4], 0x20000040, 0);
    break;
  case 16:
    ...
    *(uint64_t*)0x20000080 = 0x20000280;
    memcpy((void*)0x20000280, "\x48\x00\x00\x00\x24\x00\x07\x05\x00\x00\x00\x00"
                              "\x00\x00\x00\x00\x00\x00\x00\x00",
           20);
    *(uint32_t*)0x20000294 = r[6];
    memcpy((void*)0x20000298,
           "\x00\x00\x04\x00\xf1\xff\xff\xff\x00\x00\x00\x00\x08\x00\x01\x00"
           "\x68\x74\x62\x00\x1c\x00\x02\x00\x18\x00\x02\x00\x03\x00\x00\x00"
           "\x00\x01\x00\x00\x00\x00\x00\x00\x08\x00\x00\x00\x00\x00\x00\x00"
           "\xce\x20\x4b\x70\x75\x96\x90\x62\x60\xa7\xce\xfc",
           60);
  ...
  case 17:
    ...
    *(uint64_t*)0x20000080 = 0x200004c0;
    memcpy((void*)0x200004c0, "\x34\x00\x00\x00\x64\x00\x07\x05\x00\x00\x00\x00"
                              "\x00\x00\x00\x00\x00\x00\x00\x00",
           20);
    *(uint32_t*)0x200004d4 = r[6];
    memcpy((void*)0x200004d8, "\x00\x00\xff\xff\x00\x00\xff\xff\x00\x00\x00\x00"
                              "\x0c\x00\x01\x00\x67\x72\x65\x64\x00\x00\x00\x00"
                              "\x04\x00\x02\x00",
           28);
