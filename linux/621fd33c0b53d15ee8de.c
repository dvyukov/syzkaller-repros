...
// https://syzkaller.appspot.com/bug?id=621fd33c0b53d15ee8de
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    *(uint64_t*)0x20000040 = 0x20000140;
    memcpy((void*)0x20000140, "\x18", 1);
    *(uint64_t*)0x20000048 = 1;
    *(uint64_t*)0x20000050 = 0x20000000;
    memcpy((void*)0x20000000, "\xe5", 1);
    *(uint64_t*)0x20000058 = 0xfffffe6d;
    syscall(__NR_vmsplice, r[1], 0x20000040ul, 2ul, 0ul);
    break;
  case 2:
  ...
  case 5:
    ...
    *(uint64_t*)0x20000780 = 0x20000000;
    memcpy((void*)0x20000000, "\xa4\x00\x00\x00\x24\x00\x0b\x14\x00\x00\x00\x80"
                              "\x00\x00\x00\x00\x00\x00\x12\x00",
           20);
    *(uint32_t*)0x20000014 = r[2];
    memcpy((void*)0x20000018,
           "\x00\x00\x00\x00\xff\xff\xff\xff\x00\x00\x00\x00\x0b\x00\x01\x00"
           "\x74\x61\x70\x72\x69\x6f\x00\x00\x74\x00\x02\x00\x56\x00\x01\x00"
           "\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
           "\x00\x00\x08\x00\x04\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
           "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
           "\x00\x00\x00\x00\x08\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
           "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
           "\x00\x00\x00\x00\x10\x00\x02\x80\x0c\x00\x01\x80\x08\x00\x04\x00"
           "\x01\x00\x00\x80\x08\x00\x05",
           135);
    ...
    *(uint32_t*)0x200007f0 = 0;
    ...
    break;
  case 6:
    syscall(__NR_splice, r[0], 0ul, r[1], 0ul, 0x10973ul, 0ul);
    break;
  }
}
int main(void)
