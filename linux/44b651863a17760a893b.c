...
// https://syzkaller.appspot.com/bug?id=44b651863a17760a893b
// status:0
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[0] = res;
  syscall(__NR_write, r[0], 0x20000080ul, 0x8aul);
  ...
  *(uint32_t*)0x2000000c = 1;
  ...
  res = syscall(__NR_open, 0x20002000ul, 0x24080ul, 0ul);
  if (res != -1)
    r[3] = res;
  syscall(__NR_sendfile, r[1], r[3], 0ul, 0x200fc0ul);
}
int main(void)
{
