// KASAN: use-after-free Read in icmpv6_sk_exit (2)
// https://syzkaller.appspot.com/bug?id=497d3e91eb557f7dc0aa
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint64_t*)0x200003d0 = 0x1ff);
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200003e8, 1, 5, 1));
    ...
    NONFAILING(*(uint64_t*)0x200003f8 = 0x7fffffff);
    NONFAILING(*(uint64_t*)0x20000400 = 7);
    ...
    syscall(__NR_perf_event_open, 0x200003c0ul, 0, -1ul, -1, 0ul);
    break;
  case 1:
    syscall(__NR_unshare, 0x6c060000ul);
    break;
  case 2:
    syscall(__NR_unshare, 0x6c020000ul);
    break;
  case 3:
  ...
  case 4:
    ...
    NONFAILING(*(uint16_t*)0x20000002 = htobe16(2));
  ...
  case 5:
    ...
    NONFAILING(*(uint16_t*)0x20b63fe6 = htobe16(2));
    NONFAILING(*(uint32_t*)0x20b63fe8 = htobe32(0));
    NONFAILING(*(uint64_t*)0x20b63fec = htobe64(0));
    NONFAILING(*(uint64_t*)0x20b63ff4 = htobe64(1));
    NONFAILING(*(uint32_t*)0x20b63ffc = 0);
    syscall(__NR_sendto, r[0], 0ul, 0ul, 0x22004001ul, 0x20b63fe4ul, 0x1cul);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000540, "reno\000", 5));
    syscall(__NR_setsockopt, r[0], 6, 0xd, 0x20000540ul, 5ul);
    break;
  case 7:
  ...
  case 8:
    ...
    break;
  case 9:
    NONFAILING(*(uint32_t*)0x20000000 = 0x14);
    res = syscall(__NR_getsockname, r[1], 0x20000340ul, 0x20000000ul);
    if (res != -1)
      NONFAILING(r[2] = *(uint32_t*)0x20000344);
    break;
  case 10:
  ...
  case 11:
    ...
    NONFAILING(*(uint64_t*)0x20000810 = 0x20000100);
    NONFAILING(*(uint64_t*)0x20000100 = 0x20000500);
    NONFAILING(*(uint32_t*)0x20000500 = 0x58);
    NONFAILING(*(uint16_t*)0x20000504 = 0x24);
    NONFAILING(*(uint16_t*)0x20000506 = 0xf0b);
    ...
    NONFAILING(memcpy((void*)0x20000528, "netem\000", 6));
    NONFAILING(*(uint16_t*)0x20000530 = 0x28);
    NONFAILING(*(uint16_t*)0x20000532 = 2);
    ...
    NONFAILING(*(uint16_t*)0x2000054c = 0xc);
    NONFAILING(*(uint16_t*)0x2000054e = 0xd);
    NONFAILING(*(uint32_t*)0x20000550 = 0);
    NONFAILING(*(uint32_t*)0x20000554 = 0);
    NONFAILING(*(uint64_t*)0x20000108 = 0x58);
    NONFAILING(*(uint64_t*)0x20000818 = 1);
    NONFAILING(*(uint64_t*)0x20000820 = 0);
    NONFAILING(*(uint64_t*)0x20000828 = 0);
    NONFAILING(*(uint32_t*)0x20000830 = 0);
    syscall(__NR_sendmsg, r[3], 0x20000800ul, 0ul);
    break;
  case 12:
    NONFAILING(memcpy(
        (void*)0x20000080,
        ...
        "\xfb\xe0\xc8\x7f\xbe\x6c\xbc\xda\x46\x62\xd2\xa1\x2f\x6d\x00",
        202));
    syscall(__NR_sendto, r[0], 0x20000080ul, 0xcaul, 0ul, 0ul, 0ul);
    break;
  case 13:
    res = syscall(__NR_perf_event_open, 0ul, 0, 0xcul, -1, 3ul);
    if (res != -1)
      r[4] = res;
    break;
  case 14:
    NONFAILING(memcpy((void*)0x20000200, "/dev/snd/controlC#\000", 19));
    res = -1;
  ...
  case 15:
    ...
    break;
  case 16:
    NONFAILING(memcpy((void*)0x20000180, "syz0", 4));
    NONFAILING(memcpy(
        (void*)0x20000184,
        "\x69\x97\x02\x5e\x05\xd6\x30\xe9\xee\x3b\x44\x19\xeb\x73\xc9\x63\x96"
        "\xd7\x7f\xed\x53\x65\x8f\x56\xc0\x47\x5b\x12\x7d\x6c\x7d\x4e\xaa\xca"
        "\xcc\xaf\x0e\xe3\xae\xa5\xcd\xaa\xf7\xb4\x3f\xd2\xcb\x41\xce\xe4\x77"
        "\x24\xc7\x1a\xed\x69\x94\x6a\x4e\x87\x1f\x6f\x6f\x3f\x22\xa7\x3c\xf7"
        "\x84\xe9\x07\x5b\x27\x86\x30\x31\x9f\xde\xb6\x5b\xe8\x3a\x99\xd4\x35"
        "\x27\xbc\xc9\x84\x01\x4d\xa2",
        92));
    syscall(__NR_write, r[4], 0x20000180ul, 0x60ul);
    break;
  case 17:
    syscall(__NR_gettid);
    break;
  case 18:
    NONFAILING(*(uint32_t*)0x20000040 = 0x400000f);
    NONFAILING(*(uint32_t*)0x20000044 = 0);
    NONFAILING(*(uint32_t*)0x20000048 = 0);
    NONFAILING(*(uint32_t*)0x2000004c = 0);
    NONFAILING(memcpy((void*)0x20000050,
                      "syz0\000\000\000\000\000\000\000\000\000\000\000\000\000"
    ...
    NONFAILING(*(uint32_t*)0x20000088 = 2);
    NONFAILING(*(uint32_t*)0x2000008c = r[6]);
    ...
    NONFAILING(memset((void*)0x200000e4, 0, 44));
    NONFAILING(*(uint16_t*)0x20000110 = 0);
    NONFAILING(*(uint16_t*)0x20000112 = 0);
    NONFAILING(*(uint16_t*)0x20000114 = 0);
    NONFAILING(*(uint16_t*)0x20000116 = 0);
    syscall(__NR_ioctl, r[5], 0xc1105517, 0x20000040ul);
    break;
  case 19:
