...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    r[0] = syscall(__NR_userfaultfd, 0);
    break;
  case 2:
    *(uint64_t*)0x20ffafe8 = 0xaa;
    *(uint64_t*)0x20ffaff0 = 0;
    *(uint64_t*)0x20ffaff8 = 0;
    syscall(__NR_ioctl, r[0], 0xc018aa3f, 0x20ffafe8);
    break;
  case 3:
    *(uint64_t*)0x20a5dfe0 = 0x20000000;
    *(uint64_t*)0x20a5dfe8 = 0x4000;
    *(uint64_t*)0x20a5dff0 = 1;
    *(uint64_t*)0x20a5dff8 = 0;
    syscall(__NR_ioctl, r[0], 0xc020aa00, 0x20a5dfe0);
    break;
  case 4:
    memcpy((void*)0x206a4ff7, "/dev/kvm", 9);
    r[1] = syscall(__NR_openat, 0xffffffffffffff9c, 0x206a4ff7, 0, 0);
    break;
  case 5:
    r[2] = syscall(__NR_ioctl, r[1], 0xae01, 0);
    break;
  case 6:
    if (syscall(__NR_pipe2, 0x20e3eff8, 0) != -1)
      r[3] = *(uint32_t*)0x20e3effc;
    break;
  case 7:
    r[4] = syscall(__NR_ioctl, r[2], 0xae41, 1);
    break;
  case 8:
    syscall(__NR_dup3, r[4], r[3], 0);
    break;
  case 9:
    *(uint32_t*)0x20decfe0 = 0x10005;
    *(uint32_t*)0x20decfe4 = 3;
    *(uint64_t*)0x20decfe8 = 0;
    *(uint64_t*)0x20decff0 = 0x2000;
    *(uint64_t*)0x20decff8 = 0x20000000;
    syscall(__NR_ioctl, r[2], 0x4020ae46, 0x20decfe0);
    break;
  case 10:
    syscall(__NR_ioctl, r[4], 0xaeb7);
    break;
  case 11:
    syscall(__NR_ioctl, r[4], 0xae80, 0);
    break;
  case 12:
    *(uint64_t*)0x20de9000 = 0x40;
    *(uint64_t*)0x20de9008 = 0x20bfefbf;
    *(uint64_t*)0x20de9010 = 0x3b;
    memcpy((void*)0x20bfefbf, "\x0f\x20\xd8\x35\x20\x00\x00\x00\x0f\x22\xd8\x0f"
                              "\x01\x18\x47\x0f\x35\xf3\xab\x77\x64\x4e\xbe\x0f"
                              "\x59\x12\x81\x82\x81\x82\x01\xbc\x8c\x6a\x00\x00"
                              "\x00\x67\x4b\x0f\x01\x5e\x9d\xc4\x83\x99\x6b\xa7"
                              "\xd9\x00\xf3\x00\x00\x4f\x4f\x21\xae\x5d\xdc",
           59);
    *(uint64_t*)0x20753ff0 = 8;
    STORE_BY_BITMASK(uint64_t, 0x20753ff8, 0, 0, 1);
    STORE_BY_BITMASK(uint64_t, 0x20753ff8, 2, 1, 5);
    STORE_BY_BITMASK(uint64_t, 0x20753ff8, 0, 6, 4);
    STORE_BY_BITMASK(uint64_t, 0x20753ff8, 0x2000, 10, 2);
    STORE_BY_BITMASK(uint64_t, 0x20753ff8, 0, 12, 1);
    STORE_BY_BITMASK(uint64_t, 0x20753ff8, 8, 13, 2);
    STORE_BY_BITMASK(uint64_t, 0x20753ff8, 0, 15, 1);
    STORE_BY_BITMASK(uint64_t, 0x20753ff8, 0xbb, 16, 48);
    syz_kvm_setup_cpu(-1, r[3], 0x20841000, 0x20de9000, 1, 0, 0x20753ff0,
                      0x10000000000000ea);
    break;
  }
}
