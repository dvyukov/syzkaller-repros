...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000080, "ip6tnl0\000", 8));
    syscall(__NR_ioctl, r[0], 0x8914, 0x20000080);
    break;
  case 3:
    res = syscall(__NR_socket, 0xa, 0x522000000003, 0x11);
    if (res != -1)
      r[1] = res;
    break;
  case 4:
    ...
    NONFAILING(*(uint64_t*)0x20000050 = 0x200000c0);
    NONFAILING(*(uint64_t*)0x20000058 = 9);
  ...
  case 5:
    ...
    NONFAILING(*(uint32_t*)0x20000044 = 0x7e4c);
    NONFAILING(*(uint32_t*)0x20000048 = 0x80fe);
    NONFAILING(*(uint32_t*)0x20000248 = 0xfddd);
    NONFAILING(*(uint64_t*)0x20000250 = 0x200001c0);
    NONFAILING(*(uint64_t*)0x20000258 = 0x12f);
    ...
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x20001200 = 1);
    NONFAILING(*(uint32_t*)0x20001204 = 0);
    NONFAILING(*(uint64_t*)0x20001208 = 0);
    NONFAILING(*(uint64_t*)0x20001210 = 0);
    NONFAILING(*(uint32_t*)0x20001218 = 0x5c0);
    NONFAILING(*(uint32_t*)0x2000121c = 0);
    NONFAILING(*(uint64_t*)0x20001220 = 0);
    NONFAILING(*(uint32_t*)0x20001228 = 0);
    NONFAILING(*(uint32_t*)0x2000122c = 0);
    NONFAILING(*(uint8_t*)0x20001230 = 0);
    NONFAILING(*(uint8_t*)0x20001231 = 0);
    NONFAILING(*(uint8_t*)0x20001232 = 0);
    NONFAILING(*(uint8_t*)0x20001233 = 0);
    NONFAILING(*(uint8_t*)0x20001234 = 0);
    NONFAILING(*(uint8_t*)0x20001235 = 0);
    NONFAILING(*(uint8_t*)0x20001236 = 0);
    NONFAILING(*(uint8_t*)0x20001237 = 0);
    NONFAILING(*(uint8_t*)0x20001238 = 0);
    NONFAILING(*(uint8_t*)0x20001239 = 0);
    NONFAILING(*(uint8_t*)0x2000123a = 0);
    NONFAILING(*(uint8_t*)0x2000123b = 0);
    NONFAILING(*(uint8_t*)0x2000123c = 0);
    NONFAILING(*(uint8_t*)0x2000123d = 0);
    NONFAILING(*(uint8_t*)0x2000123e = 0);
    NONFAILING(*(uint8_t*)0x2000123f = 0);
    NONFAILING(*(uint32_t*)0x20001240 = 0);
    NONFAILING(*(uint32_t*)0x20001244 = 0);
    NONFAILING(*(uint32_t*)0x20001248 = -1);
    NONFAILING(*(uint32_t*)0x2000124c = 8);
    NONFAILING(*(uint64_t*)0x20001250 = 0);
    NONFAILING(*(uint32_t*)0x20001258 = 0);
    NONFAILING(*(uint32_t*)0x2000125c = 0x10);
    NONFAILING(*(uint64_t*)0x20001260 = 0);
    NONFAILING(*(uint32_t*)0x20001268 = 0);
    res = syscall(__NR_bpf, 5, 0x20001200, 0x70);
    if (res != -1)
      r[2] = res;
    break;
  case 7:
    NONFAILING(*(uint32_t*)0x20000440 = r[2]);
    syscall(__NR_setsockopt, -1, 1, 0x32, 0x20000440, 4);
    break;
  case 8:
    syscall(__NR_setsockopt, -1, 1, 0x3e, 0, 0);
    break;
  case 9:
    syscall(__NR_perf_event_open, 0, 0, 0, -1, 2);
    break;
  case 10:
    syscall(__NR_ioctl, -1, 0x8912, 0x400200);
    break;
  case 11:
    NONFAILING(*(uint64_t*)0x200006c0 = 0x200000c0);
    NONFAILING(*(uint32_t*)0x200006c8 = 0x80);
    NONFAILING(*(uint64_t*)0x200006d0 = 0x20000680);
    NONFAILING(*(uint64_t*)0x20000680 = 0x20000300);
    NONFAILING(*(uint64_t*)0x20000688 = 0x79);
    NONFAILING(*(uint64_t*)0x20000690 = 0x20000580);
    NONFAILING(*(uint64_t*)0x20000698 = 0xe4);
    NONFAILING(*(uint64_t*)0x200006a0 = 0);
    NONFAILING(*(uint64_t*)0x200006a8 = 0);
    NONFAILING(*(uint64_t*)0x200006b0 = 0x20000280);
    NONFAILING(*(uint64_t*)0x200006b8 = 0);
    NONFAILING(*(uint64_t*)0x200006d8 = 4);
    NONFAILING(*(uint64_t*)0x200006e0 = 0);
    NONFAILING(*(uint64_t*)0x200006e8 = 0);
    NONFAILING(*(uint32_t*)0x200006f0 = 0);
    syscall(__NR_recvmsg, r[0], 0x200006c0, 0x2001);
    break;
  }
}
int main(void)
