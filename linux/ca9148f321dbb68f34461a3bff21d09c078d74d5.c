...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_ioctl, r[0], 0xab08ul, 0);
    break;
  case 2:
    ...
    NONFAILING(*(uint64_t*)0x20000088 = 2);
  ...
  case 9:
    ...
    syscall(__NR_ioctl, r[2], 0x4020ae46ul, 0x20000000ul);
    break;
  case 10:
    ...
    NONFAILING(*(uint64_t*)0x200001f0 = 0x20000000fb);
    ...
    NONFAILING(*(uint64_t*)0x20000248 = 0x205211);
    syscall(__NR_ioctl, r[3], 0x4090ae82ul, 0x200001c0ul);
    break;
  case 11:
    NONFAILING(*(uint32_t*)0x20000300 = 0);
    NONFAILING(*(uint32_t*)0x20000304 = 0);
    NONFAILING(*(uint8_t*)0x20000308 = 0);
    NONFAILING(*(uint8_t*)0x20000309 = 8);
    ...
    syscall(__NR_ioctl, r[2], 0x8208ae63ul, 0x20000300ul);
    break;
  case 12:
