...
// https://syzkaller.appspot.com/bug?id=77e5e02c6c81136cdaff
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(syz_init_net_socket(0x1f, 0xc0000000, 1));
    break;
  case 1:
    res = -1;
    ...
    break;
  case 2:
    syscall(__NR_ioctl, r[0], 0x400448de, 0x20000000ul);
    break;
  case 3:
    res = -1;
    NONFAILING(res = syz_init_net_socket(0x1f, 3, 1));
    ...
    break;
  case 4:
    syscall(__NR_ioctl, r[1], 0x400448de, 0ul);
    break;
  }
}
int main(void)
