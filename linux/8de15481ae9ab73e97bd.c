...
// https://syzkaller.appspot.com/bug?id=8de15481ae9ab73e97bd
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000180, "802.15.4 MAC\000", 13));
    NONFAILING(syz_genetlink_get_family_id(0x20000180, -1));
    break;
  case 2:
    syscall(__NR_sendmsg, r[0], 0ul, 0x4000840ul);
    break;
  }
}
int main(void)
