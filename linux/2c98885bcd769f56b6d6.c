...
// https://syzkaller.appspot.com/bug?id=2c98885bcd769f56b6d6
// status:6
...
void execute_one(void)
{
  ...
  res = -1;
  res = syz_genetlink_get_family_id(0x20000080, r[0]);
  if (res != -1)
    r[1] = res;
  ...
  *(uint16_t*)0x20000216 = 6;
  *(uint64_t*)0x20000218 = 9;
  *(uint16_t*)0x20000220 = 0xc;
  *(uint16_t*)0x20000222 = 2;
  *(uint64_t*)0x20000224 = 0;
  *(uint16_t*)0x2000022c = 0xc;
