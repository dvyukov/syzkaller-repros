...
void execute_call(int call)
{
  ...
  case 1:
    ...
    res = syscall(__NR_write, r[0], 0x20000200, 0x20);
    if (res != -1)
  ...
  case 3:
    ...
    syscall(__NR_write, r[2], 0x20000140, 0x18);
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x20000480 = 1);
    NONFAILING(*(uint16_t*)0x20000484 = 0x10);
    NONFAILING(*(uint16_t*)0x20000486 = 0xfa00);
    NONFAILING(*(uint64_t*)0x20000488 = 0x20000440);
    NONFAILING(*(uint32_t*)0x20000490 = r[1]);
    NONFAILING(*(uint32_t*)0x20000494 = 0);
    syscall(__NR_write, r[0], 0x20000480, 0x18);
    break;
  }
}
int main(void)
