...
void execute_one(void)
{
  ...
  *(uint8_t*)0x200008c4 = 0x60;
  *(uint8_t*)0x200008c5 = 0x66;
  *(uint8_t*)0x200008c6 = 0xfa;
  *(uint8_t*)0x200008c7 = 8;
  *(uint16_t*)0x200008c8 = 0x798;
  *(uint16_t*)0x200008ca = 0x2e8c;
  *(uint16_t*)0x200008cc = 0x59eb;
  ...
  *(uint8_t*)0x200008ef = 0x8b;
  *(uint8_t*)0x200008f0 = 2;
  *(uint16_t*)0x200008f1 = 0;
  *(uint8_t*)0x200008f3 = 0;
  *(uint8_t*)0x200008f4 = 0;
  *(uint8_t*)0x200008f5 = 0;
  syz_usb_connect(0, 0x36, 0x200008c0, 0);
  res = syz_open_dev(0xc, 0xb4, 0);
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x20000000 = 2;
  *(uint32_t*)0x20000004 = 3;
  *(uint32_t*)0x20000008 = 0x4f894bad;
  *(uint32_t*)0x2000000c = 0x10000;
  *(uint32_t*)0x20000010 = 0x1f46fa18;
  *(uint32_t*)0x20000014 = 0x100;
  syscall(__NR_ioctl, r[0], 0xc0145b0e, 0x20000000);
}
int main(void)
{
