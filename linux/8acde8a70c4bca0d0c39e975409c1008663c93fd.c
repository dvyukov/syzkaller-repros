...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint16_t*)0x20000242 = htobe16(3));
    ...
    break;
  case 2:
    NONFAILING(*(uint32_t*)0x20000000 = 0x30a9);
    syscall(__NR_setsockopt, r[0], 0x107, 9, 0x20000000, 4);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x200000c0,
                      "\xff\xff\xff\xff\xff\xff\xaa\xaa\xbb\x81\x00\x00\x00\x00"
                      "\x11\x00\x00\xff\x5c\xf4\xc1\x00\x00\x00\x00\x00",
                      26));
    ...
    syz_emit_ethernet(1, 0x200000c0, 0x20000100);
    break;
  }
}
