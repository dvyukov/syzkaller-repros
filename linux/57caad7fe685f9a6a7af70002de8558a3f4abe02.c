...
// https://syzkaller.appspot.com/bug?id=57caad7fe685f9a6a7af70002de8558a3f4abe02
// status:open
...
void execute_call(int call)
{
  ...
  case 6:
    ...
    syscall(__NR_open, 0x20000040, 0x200000, 0);
    break;
  case 7:
    *(uint32_t*)0x20000500 = 0x10;
    *(uint32_t*)0x20000504 = 0;
    *(uint64_t*)0x20000508 = 2;
    syscall(__NR_write, r[0], 0x20000500, 0x10);
    break;
  }
}
