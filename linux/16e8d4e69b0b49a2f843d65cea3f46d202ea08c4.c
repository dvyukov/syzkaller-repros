...
// https://syzkaller.appspot.com/bug?id=16e8d4e69b0b49a2f843d65cea3f46d202ea08c4
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0x3f, 15, 2));
  ...
  case 3:
    ...
    NONFAILING(*(uint32_t*)0x20001478 = htobe32(-1));
    ...
    NONFAILING(*(uint8_t*)0x20001499 = 0xfc);
  ...
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_sendmmsg, r[1], 0x20000240, 0x5c3, 0xf0);
    break;
  case 6:
    ...
    NONFAILING(memcpy(
        (void*)0x20000080,
        "\x02\x07\x00\x09\x02\x00\x00\x00\x00\x00\x00\x00\x89\xda\x00\x00",
        16));
