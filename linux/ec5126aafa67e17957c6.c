...
// https://syzkaller.appspot.com/bug?id=ec5126aafa67e17957c6
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    res = syscall(__NR_creat, 0ul, 0x21ul);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    syscall(__NR_fallocate, r[0], 0ul, 5ul, 0x9f9ul);
    break;
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_write, r[1], 0ul, 0x1a0ul);
    break;
  case 4:
  ...
  case 7:
    ...
    syscall(__NR_execve, 0x20000000ul, 0ul, 0ul);
    break;
  case 8:
