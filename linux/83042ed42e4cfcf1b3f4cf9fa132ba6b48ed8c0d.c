...
// https://syzkaller.appspot.com/bug?id=83042ed42e4cfcf1b3f4cf9fa132ba6b48ed8c0d
// status:open
...
void loop()
{
  ...
  *(uint64_t*)0x20000940 = 0x20000380;
  *(uint32_t*)0x20000948 = 0x80;
  *(uint64_t*)0x20000950 = 0x20000800;
  *(uint64_t*)0x20000958 = 0;
  *(uint64_t*)0x20000960 = 0x20000840;
  *(uint64_t*)0x20000968 = 0xfffffc33;
  *(uint32_t*)0x20000970 = 0;
  *(uint32_t*)0x20000978 = 0;
  *(uint64_t*)0x200009c0 = 0x77359400;
  *(uint64_t*)0x200009c8 = 0;
  syscall(__NR_recvmmsg, r[0], 0x20000940, 0x800002e, 0x12000, 0x200009c0);
  syz_emit_ethernet(1, 0x20000200, 0);
}
