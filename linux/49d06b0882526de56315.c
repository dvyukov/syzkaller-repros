...
// https://syzkaller.appspot.com/bug?id=49d06b0882526de56315
// status:0
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    *(uint64_t*)0x20002990 = 0x20002940;
    *(uint64_t*)0x20002940 = 0x20000800;
    *(uint32_t*)0x20000800 = 0x98;
    *(uint16_t*)0x20000804 = 0x31;
    ...
    *(uint16_t*)0x20000868 = 0x30;
    STORE_BY_BITMASK(uint16_t, , 0x2000086a, 2, 0, 14);
    STORE_BY_BITMASK(uint16_t, , 0x2000086b, 0, 6, 1);
    STORE_BY_BITMASK(uint16_t, , 0x2000086b, 0, 7, 1);
    *(uint16_t*)0x2000086c = 9;
    *(uint16_t*)0x2000086e = 1;
    memcpy((void*)0x20000870, "csum\000", 5);
    *(uint16_t*)0x20000878 = 4;
    STORE_BY_BITMASK(uint16_t, , 0x2000087a, 2, 0, 14);
    STORE_BY_BITMASK(uint16_t, , 0x2000087b, 0, 6, 1);
    STORE_BY_BITMASK(uint16_t, , 0x2000087b, 1, 7, 1);
    *(uint16_t*)0x2000087c = 4;
    *(uint16_t*)0x2000087e = 6;
    *(uint16_t*)0x20000880 = 0xc;
    *(uint16_t*)0x20000882 = 7;
    *(uint32_t*)0x20000884 = 0;
    *(uint32_t*)0x20000888 = 0;
    *(uint16_t*)0x2000088c = 0xc;
    *(uint16_t*)0x2000088e = 8;
