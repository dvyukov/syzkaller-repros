// KMSAN: uninit-value in tgr192_pass
// https://syzkaller.appspot.com/bug?id=d7bc2ad5deee8abf4c9ce05da939c687ae11a0db
// status:invalid
...
void loop()
{
  ...
  *(uint32_t*)0x20ee1fbc = 0;
  memcpy((void*)0x20ee1fc0,
         "\x74\x67\x72\x31\x36\x30\x2d\x67\x65\x6e\x65\x72\x69\x63\x00\x00\x00"
  ...
  *(uint64_t*)0x20e64ff8 = 0;
  syscall(__NR_sendfile, r[1], r[2], 0x20e64ff8, 6);
}
