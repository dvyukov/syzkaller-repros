...
// https://syzkaller.appspot.com/bug?id=c282923e5da93549fa27
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    NONFAILING(*(uint64_t*)0x20000a44 = 0);
    syscall(__NR_epoll_ctl, r[1], 1ul, r[0], 0x20000a40ul);
    break;
  case 3:
  ...
  case 5:
    ...
    syscall(__NR_epoll_ctl, r[2], 1ul, r[1], 0x200003c0ul);
    break;
  }
}
int main(void)
