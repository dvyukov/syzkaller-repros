// general protection fault in device_del (2)
// https://syzkaller.appspot.com/bug?id=0585367e0d0520076b9d7020f0b54da165825b18
// status:invalid
...
void loop(void)
{
  ...
  *(uint8_t*)0x20000045 = 0x28;
  *(uint8_t*)0x20000046 = 0x11;
  *(uint8_t*)0x20000047 = 8;
  *(uint16_t*)0x20000048 = 0x424;
  *(uint16_t*)0x2000004a = 0xc001;
  *(uint16_t*)0x2000004c = 0x450a;
