...
// https://syzkaller.appspot.com/bug?id=00e15cda746c5bc70e24
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(*(uint16_t*)0x2000021c = 0x443);
  ...
  NONFAILING(syz_io_uring_submit(r[2], r[3], 0x20000200, 0));
  syscall(__NR_io_uring_enter, r[1], 0x90e, 0, 0ul, 0ul, 0ul);
  ...
  NONFAILING(memcpy((void*)0x20000191,
                    "\xb2\xa2\x90\xe5\x5a\x80\x9f\x46\x8b\x6a\x2d\x0f\x77\x90"
                    "\x54\x01\x49\x15\xdd",
                    19));
  syscall(__NR_ioctl, r[0], 0x5412, 0x20000180ul);
