...
// https://syzkaller.appspot.com/bug?id=1981c2da5a5ccd375f07c6f4a6dbed14eb46aac8
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000080, "/selinux/load\x00", 14));
  ...
  case 1:
    NONFAILING(memcpy(
        ...
        "\x00\x00\x00\x00\x00\x38\x58\x58\x00\x00\x00\x00\x00\x00\x00\x00\x00"
        "\x00\x00\x00\x00\x00\x6d\xbd\x00\x60\x15\xd8\x00\xcc\xbf\x8e\xf1\x70"
        "\x25\xb5\x4f\x36\xaf\xa1\x82",
        92));
