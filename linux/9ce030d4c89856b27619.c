// unexpected kernel reboot (4)
// https://syzkaller.appspot.com/bug?id=9ce030d4c89856b27619
// status:2
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000280 = 0x24;
  *(uint64_t*)0x20000284 = 0;
  *(uint64_t*)0x2000028c = 0;
  *(uint64_t*)0x20000294 = 0x20000440;
  *(uint8_t*)0x20000440 = 0;
  *(uint8_t*)0x20000441 = 0x22;
  *(uint32_t*)0x20000442 = 5;
  STORE_BY_BITMASK(uint8_t, , 0x20000446, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000446, 0, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000446, 0, 4, 4);
  memcpy((void*)0x20000447, "\xf0\xf8\xab\xae", 4);
  *(uint64_t*)0x2000029c = 0;
  syz_usb_control_io(r[0], 0x20000280, 0);
  memcpy((void*)0x20000140,
         "\x3c\x2c\xde\x6e\xd5\x42\x4d\xa4\xc8\x42\x96\x9e\xa9\xe3\x48\x77\xb2"
         "\x7d\x92\xfd\xa4\xe7\xb0\x25\x14\x62\x47\xd8\xee\x8d\xf0\xff\xf5\x1d"
         "\xd6\xb9\xf3\xb7\xb1\x4d\x3b\xa9\xd3\x80\x98\x4d\x72\x54\x74\xdb\x63"
         "\x1e\x72\xc1\xe4\x05\x47\x04\x6f\x54\xa9\x23\x60\xe7\x3b\x98\x24\x72"
         "\x86\x3b\x0e\x8b\x32",
         73);
  syz_usb_ep_write(r[0], 0, 0x49, 0x20000140);
}
int main(void)
{
