...
// https://syzkaller.appspot.com/bug?id=eeda6c04066577b6a84c
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    *(uint8_t*)0x20000057 = 0x1c;
    *(uint32_t*)0x20000058 = 0xd;
    syscall(__NR_connect, r[0], 0x20000040ul, 0x1cul);
    break;
  case 2:
    *(uint8_t*)0x20000100 = 0x3a;
    *(uint8_t*)0x20000101 = 0xb;
    ...
    *(uint8_t*)0x20000109 = 0x28;
    *(uint32_t*)0x2000010a = htobe32(1);
    *(uint8_t*)0x2000010e = 8;
    *(uint8_t*)0x2000010f = 9;
    *(uint16_t*)0x20000110 = 9;
    *(uint64_t*)0x20000112 = 0xb800000;
    *(uint64_t*)0x2000011a = 6;
    *(uint64_t*)0x20000122 = 0x40;
    *(uint64_t*)0x2000012a = 0xff12;
    *(uint8_t*)0x20000132 = 0xc9;
    *(uint8_t*)0x20000133 = 0x10;
    ...
    *(uint8_t*)0x20000144 = 0xc9;
    *(uint8_t*)0x20000145 = 0x10;
    *(uint8_t*)0x20000146 = 0xfe;
    *(uint8_t*)0x20000147 = 0x80;
    ...
    *(uint8_t*)0x20000156 = 4;
    *(uint8_t*)0x20000157 = 1;
    *(uint8_t*)0x20000158 = 0x9a;
    *(uint8_t*)0x20000159 = 9;
    *(uint8_t*)0x2000015a = 0;
    *(uint8_t*)0x2000015b = 4;
    *(uint8_t*)0x2000015c = 1;
    *(uint8_t*)0x2000015d = 0x81;
    *(uint8_t*)0x2000015e = 0xc2;
    *(uint8_t*)0x2000015f = 4;
    *(uint32_t*)0x20000160 = htobe32(5);
    *(uint8_t*)0x20000164 = 0;
    *(uint8_t*)0x20000165 = 1;
    *(uint8_t*)0x20000166 = 0;
    syscall(__NR_setsockopt, r[0], 0x29, 0x37, 0x20000100ul, 0x68ul);
    break;
  }
}
int main(void)
