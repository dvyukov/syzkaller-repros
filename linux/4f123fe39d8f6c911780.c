...
// https://syzkaller.appspot.com/bug?id=4f123fe39d8f6c911780
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    *(uint32_t*)0x20000100 = 1;
    syscall(__NR_setsockopt, r[0], 6, 0x13, 0x20000100ul, 4ul);
    break;
  case 2:
  ...
  case 4:
    ...
    *(uint32_t*)0x2000001c = 0x919f;
    *(uint32_t*)0x20000020 = 8;
    *(uint32_t*)0x20000024 = 0;
    *(uint32_t*)0x20000028 = 3;
    *(uint16_t*)0x2000002c = 0xfff;
    *(uint16_t*)0x2000002e = 0;
    syscall(__NR_setsockopt, r[0], 6, 0x16, 0x20000000ul, 0x2000019ful);
    break;
  case 5:
    *(uint64_t*)0x20000280 = 4;
    syscall(__NR_splice, r[0], 0x20000280ul, r[0], 0ul, 3ul, 7ul);
    break;
  case 6:
    *(uint32_t*)0x20000200 = 0;
    syscall(__NR_setsockopt, r[0], 6, 0x13, 0x20000200ul, 0x88ul);
    break;
  case 7:
    memcpy(
        (void*)0x20000640,
        ...
        "\x39\x05\xbb\xac\xaf\x0f\xd5\x7f\xb2\x46\xd6\x60\xea\x69\xd7\x55\xb5"
