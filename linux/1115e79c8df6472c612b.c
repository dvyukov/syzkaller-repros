...
// https://syzkaller.appspot.com/bug?id=1115e79c8df6472c612b
// status:6
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000274 = 0;
  syscall(__NR_ioctl, r[0], 0xc0d05605, 0x20000200ul);
}
int main(void)
{
