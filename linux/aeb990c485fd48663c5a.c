...
// https://syzkaller.appspot.com/bug?id=aeb990c485fd48663c5a
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000240, "/dev/net/tun\000", 13));
  ...
  case 4:
    ...
    syscall(__NR_ioctl, r[0], 0x400454da, 0x200000c0ul);
    break;
  case 5:
    NONFAILING(memcpy(
        (void*)0x20000000,
        ...
        16));
    NONFAILING(*(uint16_t*)0x20000010 = 0x7132);
  ...
  case 6:
    ...
    NONFAILING(*(uint16_t*)0x20000050 = 0x400);
    syscall(__NR_ioctl, r[0], 0x400454d9, 0x20000040ul);
    break;
  case 7:
  ...
  case 11:
    ...
    NONFAILING(*(uint64_t*)0x20000150 = 0x20000200);
    NONFAILING(*(uint64_t*)0x20000200 = 0x200006c0);
    NONFAILING(*(uint32_t*)0x200006c0 = 0x20);
    NONFAILING(*(uint16_t*)0x200006c4 = 0x11);
    NONFAILING(*(uint16_t*)0x200006c6 = 0x40d);
    ...
    NONFAILING(*(uint16_t*)0x200006d2 = 0);
    NONFAILING(*(uint32_t*)0x200006d4 = r[5]);
