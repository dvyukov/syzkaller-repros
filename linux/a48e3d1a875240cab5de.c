...
// https://syzkaller.appspot.com/bug?id=a48e3d1a875240cab5de
// status:0
...
void execute_one(void)
{
  ...
  memcpy((void*)0x20000000,
         ...
         "\x01\x09\x02\x2d\x00\x01\x00\x00\x00\x00\x09\x04\x00\x00\x03\xfe\x03"
         "\x01\x00\x09\x05\x8d\x1f\x00\x02\x00\x00\x00\x09\x05\x05\x02\x00\xde"
         "\x7e\x00\x00\x09\x05\x8b\x1e\x20",
         59);
  res = -1;
  ...
  *(uint64_t*)0x20000148 = 0;
  syscall(__NR_ioctl, r[2], 0xc0105b08, 0x20000140ul);
}
int main(void)
{
