...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000040, "/dev/net/tun", 13));
  ...
  case 1:
    NONFAILING(memcpy(
        ...
        16));
    NONFAILING(*(uint16_t*)0x20000010 = 0x33cb);
  ...
  case 4:
    ...
    NONFAILING(*(uint32_t*)0x200003c0 = 0x58);
    NONFAILING(*(uint16_t*)0x200003c4 = 0x11);
    NONFAILING(*(uint16_t*)0x200003c6 = 0x405);
    NONFAILING(*(uint32_t*)0x200003c8 = 0x70bd25);
    NONFAILING(*(uint32_t*)0x200003cc = 0x25dfdbfe);
    ...
    NONFAILING(*(uint16_t*)0x200003e2 = 3);
    NONFAILING(memcpy(
        (void*)0x200003e4,
        "\x69\x66\x62\x30\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
        16));
    NONFAILING(*(uint16_t*)0x200003f4 = 8);
    NONFAILING(*(uint16_t*)0x200003f6 = 0x1e);
    NONFAILING(*(uint32_t*)0x200003f8 = 1);
    NONFAILING(*(uint16_t*)0x200003fc = 8);
    NONFAILING(*(uint16_t*)0x200003fe = 0x16);
    NONFAILING(*(uint16_t*)0x20000400 = 4);
    NONFAILING(*(uint16_t*)0x20000402 = 1);
    NONFAILING(*(uint16_t*)0x20000404 = 0x14);
    NONFAILING(*(uint16_t*)0x20000406 = 0x14);
    NONFAILING(memcpy(
        (void*)0x20000408,
        "\x79\x61\x6d\x30\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
        16));
    NONFAILING(*(uint64_t*)0x20000188 = 0x58);
