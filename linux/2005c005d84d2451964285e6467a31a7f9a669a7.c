...
// https://syzkaller.appspot.com/bug?id=2005c005d84d2451964285e6467a31a7f9a669a7
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint64_t*)0x20000010 = 0x7f);
    NONFAILING(*(uint64_t*)0x20000018 = 0x22);
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000028, 1, 12, 1));
    ...
    syscall(__NR_perf_event_open, 0x20000000, 0, -1, -1, 0);
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x20002a40 = -1);
    NONFAILING(*(uint32_t*)0x20002a44 = 0);
    NONFAILING(*(uint32_t*)0x20002a48 = 0xee00);
    syscall(__NR_getgroups, 3, 0x20002a40);
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000600, "net/fib_trie\000", 13));
    res = syz_open_procfs(0, 0x20000600);
    if (res != -1)
      r[0] = res;
    break;
  case 3:
    syscall(__NR_preadv, r[0], 0x200017c0, 0x199, 0);
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000600, "net/fib_trie\000", 13));
    syz_open_procfs(0, 0x20000600);
    break;
  case 5:
