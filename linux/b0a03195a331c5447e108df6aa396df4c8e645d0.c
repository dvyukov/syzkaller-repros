...
// https://syzkaller.appspot.com/bug?id=b0a03195a331c5447e108df6aa396df4c8e645d0
// status:open
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_clone, 0x2102001ffe, 0, 0x9999999999999999, 0x200001c0, -1);
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x20000540 = 0);
    syscall(__NR_futex, 0, 0xb, 0, 0, 0x20000540, 2);
    break;
  case 5:
    NONFAILING(*(uint16_t*)0x20000100 = 0xa);
    NONFAILING(*(uint16_t*)0x20000102 = htobe16(0x4e22));
    ...
    syscall(__NR_bind, r[0], 0x20000100, 0x1c);
    break;
  case 6:
  ...
  case 8:
    ...
    syscall(__NR_sendto, r[1], 0, 0, 0x20000004, 0x2031e000, 0x1c);
    break;
  case 9:
  ...
  case 10:
    ...
    break;
  case 11:
    syscall(__NR_socketpair, 0, 5, 9, 0x20000440);
    break;
  case 12:
    NONFAILING(memcpy((void*)0x20000180, ".dead\x00", 6));
    syscall(__NR_add_key, 0x20000180, 0, 0, 0, -1);
    break;
  case 13:
    syscall(__NR_getsockname, r[2], 0, 0);
    break;
  }
}
int main(void)
