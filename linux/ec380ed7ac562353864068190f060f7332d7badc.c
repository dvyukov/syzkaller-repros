...
void execute_call(int call)
{
  ...
  case 1:
    ...
    *(uint32_t*)0x20ef8d15 = 0;
    syscall(__NR_bind, r[0], 0x20ef8cfdul, 0x1cul);
    break;
  case 2:
    syscall(__NR_listen, r[0], 0x7ffd);
    break;
  case 3:
  ...
  case 4:
    ...
    *(uint32_t*)0x20000018 = 0;
    syscall(__NR_setsockopt, r[1], 0x84ul, 0x6bul, 0x20000000ul, 0x1cul);
    break;
  case 5:
    *(uint32_t*)0x20000400 = 0;
    *(uint32_t*)0x20000404 = 0x1b0a;
    syscall(__NR_setsockopt, r[1], 0x84ul, 0xdul, 0x20000400ul, 8ul);
    break;
  case 6:
    syscall(__NR_write, r[1], 0x20000100ul, 0x1ede5ul);
    break;
  case 7:
