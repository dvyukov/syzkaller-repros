...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(*(uint32_t*)0x20000000 = 0x13);
    NONFAILING(*(uint32_t*)0x20000004 = 0x10);
    ...
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x2001a840 = 0x13);
    NONFAILING(*(uint32_t*)0x2001a844 = 2);
    NONFAILING(*(uint64_t*)0x2001a848 = 0x20000040);
    NONFAILING(*(uint8_t*)0x20000040 = 0x18);
    NONFAILING(STORE_BY_BITMASK(uint8_t, 0x20000041, 0, 0, 4));
    NONFAILING(STORE_BY_BITMASK(uint8_t, 0x20000041, 1, 4, 4));
    ...
    NONFAILING(*(uint64_t*)0x2001a850 = 0x200000c0);
    NONFAILING(memcpy((void*)0x200000c0, "GPL", 4));
    NONFAILING(*(uint32_t*)0x2001a858 = 1);
    NONFAILING(*(uint32_t*)0x2001a85c = 0x9b);
    NONFAILING(*(uint64_t*)0x2001a860 = 0x20000100);
    NONFAILING(*(uint32_t*)0x2001a868 = 0);
    NONFAILING(*(uint32_t*)0x2001a86c = 0);
    NONFAILING(*(uint8_t*)0x2001a870 = 0);
    NONFAILING(*(uint8_t*)0x2001a871 = 0);
    NONFAILING(*(uint8_t*)0x2001a872 = 0);
    NONFAILING(*(uint8_t*)0x2001a873 = 0);
    NONFAILING(*(uint8_t*)0x2001a874 = 0);
    NONFAILING(*(uint8_t*)0x2001a875 = 0);
    NONFAILING(*(uint8_t*)0x2001a876 = 0);
    NONFAILING(*(uint8_t*)0x2001a877 = 0);
    NONFAILING(*(uint8_t*)0x2001a878 = 0);
    NONFAILING(*(uint8_t*)0x2001a879 = 0);
    NONFAILING(*(uint8_t*)0x2001a87a = 0);
    NONFAILING(*(uint8_t*)0x2001a87b = 0);
    NONFAILING(*(uint8_t*)0x2001a87c = 0);
    NONFAILING(*(uint8_t*)0x2001a87d = 0);
    NONFAILING(*(uint8_t*)0x2001a87e = 0);
    NONFAILING(*(uint8_t*)0x2001a87f = 0);
    NONFAILING(*(uint32_t*)0x2001a880 = 0);
    NONFAILING(*(uint32_t*)0x2001a884 = 0);
    syscall(__NR_bpf, 5, 0x2001a840, 0x48);
    break;
  }
}
int main()
