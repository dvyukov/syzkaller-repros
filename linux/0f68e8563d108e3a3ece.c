...
// https://syzkaller.appspot.com/bug?id=0f68e8563d108e3a3ece
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000100, "./cgroup/syz0\000", 14));
  ...
  case 2:
    ...
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000040, "cgroup.subtree_control\000", 23));
    res = syscall(__NR_openat, r[0], 0x20000040ul, 2ul, 0ul);
    if (res != -1)
      r[1] = res;
    break;
  case 4:
    NONFAILING(*(uint8_t*)0x20000140 = 0x2b);
    NONFAILING(memcpy((void*)0x20000141, "pids", 4));
    NONFAILING(*(uint8_t*)0x20000145 = 0x20);
    inject_fault(4);
