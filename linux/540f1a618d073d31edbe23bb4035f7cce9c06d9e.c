...
void* thr(void* arg)
{
  switch ((long)arg) {
  case 0:
    r[0] = syscall(__NR_mmap, 0x20000000ul, 0xfe5000ul, 0x3ul, 0x32ul,
                   0xfffffffffffffffful, 0x0ul);
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20fd5000,
                      "\x2f\x64\x65\x76\x2f\x6b\x76\x6d\x00", 9));
    r[2] = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20fd5000ul,
                   0x0ul, 0x0ul);
    break;
  case 2:
    ...
    break;
  case 3:
    r[4] = syscall(__NR_ioctl, r[3], 0xc048ae65ul, 0x20fdd000ul);
    break;
  case 4:
    r[5] = syscall(__NR_ioctl, r[3], 0xae41ul, 0x0ul);
    break;
  case 5:
    NONFAILING(*(uint32_t*)0x20ae6fe0 = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x20ae6fe4 = (uint32_t)0x3);
    NONFAILING(*(uint64_t*)0x20ae6fe8 = (uint64_t)0x0);
    NONFAILING(*(uint64_t*)0x20ae6ff0 = (uint64_t)0x2000);
    NONFAILING(*(uint64_t*)0x20ae6ff8 = (uint64_t)0x205b3000);
    r[11] = syscall(__NR_ioctl, r[3], 0x4020ae46ul, 0x20ae6fe0ul);
    break;
  case 6:
    NONFAILING(*(uint64_t*)0x20294000 = (uint64_t)0x10);
    NONFAILING(*(uint64_t*)0x20294008 = (uint64_t)0x20da6000);
    NONFAILING(*(uint64_t*)0x20294010 = (uint64_t)0x62);
    NONFAILING(memcpy(
        (void*)0x20da6000,
        "\x66\xb8\x01\x00\x00\x00\x0f\x01\xd9\x0f\x01\xca\x66\xb8\x06"
        "\x32\x00\x00\x0f\x23\xd0\x0f\x21\xf8\x66\x35\x10\x00\x00\x0b"
        "\x0f\x23\xf8\xba\xf8\x0c\x66\xb8\x34\xb3\xcc\x8a\x66\xef\xba"
        "\xfc\x0c\xe6\xed\x0f\xc7\x6a\x9d\x0f\xc7\x98\x6e\xab\x0f\x01"
        "\xc8\x44\x0f\x20\xc0\x66\x35\x07\x00\x00\x00\x0f\x20\xd8\x66"
        "\x35\x08\x00\x00\x00\x0f\x22\xd8\x0f\xc0\x65\x2e\xf0\xf6\x1a"
        "\x64\x36\x2e\x66\x0f\x71\xd2\x00",
        98));
    r[16] = syz_kvm_setup_cpu(r[2], r[5], 0x205b3000ul, 0x20294000ul,
                              0x1ul, 0x10ul, 0x20fe3ff0ul, 0x0ul);
    break;
  case 7:
    r[17] = syscall(__NR_ioctl, r[5], 0xae80ul, 0x0ul);
    break;
  }
  return 0;
}
