...
// https://syzkaller.appspot.com/bug?id=40390cf64e61d68f937948da2e4f0ef0973f7bcb
// status:invalid
...
{
  memset(r, -1, sizeof(r));
  r[0] = syscall(__NR_mmap, 0x20000000ul, 0xd34000ul, 0x3ul, 0x32ul,
                 0xfffffffffffffffful, 0x0ul);
  memcpy((void*)0x20ae9ff7, "\x2f\x64\x65\x76\x2f\x6b\x76\x6d\x00", 9);
  r[2] = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20ae9ff7ul, 0x0ul,
                 0x0ul);
  r[3] = syscall(__NR_ioctl, r[2], 0xae01ul, 0x0ul);
  r[4] = syscall(__NR_ioctl, r[3], 0xae41ul, 0x0ul);
  *(uint64_t*)0x20054fea = (uint64_t)0x10;
  *(uint64_t*)0x20054ff2 = (uint64_t)0x20af5fa8;
  *(uint64_t*)0x20054ffa = (uint64_t)0x58;
  memcpy((void*)0x20af5fa8,
         "\x0f\x08\x0f\x20\xc0\x66\x35\x10\x00\x00\x00\x0f\x22\xc0\x0f"
         "\x01\xd1\x67\x66\xc7\x44\x24\x00\x00\x00\x00\x00\x67\x66\xc7"
         "\x44\x24\x02\xf4\x1f\x00\x00\x67\x66\xc7\x44\x24\x06\x00\x00"
         "\x00\x00\x67\x0f\x01\x14\x24\x64\x65\x0f\x01\xb3\x0d\x16\x0f"
         "\x2c\x46\x15\x26\x2e\x65\xee\x2e\x67\x36\xf3\x0f\x2d\xc1\x26"
         "\xf2\x0f\x01\xc8\x66\xb8\x01\x00\x00\x00\x0f\x01\xc1",
         88);
  r[9] = syz_kvm_setup_cpu(r[3], r[4], 0x20094000ul, 0x20054feaul,
                           0x1ul, 0x0ul, 0x20aeeff0ul, 0x0ul);
  *(uint64_t*)0x20af3000 = (uint64_t)0x0;
  *(uint64_t*)0x20af3008 = (uint64_t)0x0;
  *(uint64_t*)0x20af3010 = (uint64_t)0x0;
  *(uint64_t*)0x20af3018 = (uint64_t)0x0;
  *(uint64_t*)0x20af3020 = (uint64_t)0x0;
  *(uint64_t*)0x20af3028 = (uint64_t)0x80;
  *(uint64_t*)0x20af3030 = (uint64_t)0x0;
  *(uint64_t*)0x20af3038 = (uint64_t)0x0;
  *(uint64_t*)0x20af3040 = (uint64_t)0x0;
  *(uint64_t*)0x20af3048 = (uint64_t)0x0;
  *(uint64_t*)0x20af3050 = (uint64_t)0x0;
  *(uint64_t*)0x20af3058 = (uint64_t)0x0;
  *(uint64_t*)0x20af3060 = (uint64_t)0x0;
  *(uint64_t*)0x20af3068 = (uint64_t)0x0;
  *(uint64_t*)0x20af3070 = (uint64_t)0x0;
  *(uint64_t*)0x20af3078 = (uint64_t)0x0;
  r[26] = syscall(__NR_ioctl, r[4], 0x4080aea2ul, 0x20af3000ul);
  r[27] = syscall(__NR_ioctl, r[4], 0xae80ul, 0x0ul);
  *(uint16_t*)0x20899000 = (uint16_t)0x2;
  *(uint16_t*)0x20899002 = (uint16_t)0x204e;
  *(uint32_t*)0x20899004 = (uint32_t)0x20000e0;
  *(uint8_t*)0x20899008 = (uint8_t)0x0;
  *(uint8_t*)0x20899009 = (uint8_t)0x0;
  *(uint8_t*)0x2089900a = (uint8_t)0x0;
  *(uint8_t*)0x2089900b = (uint8_t)0x0;
  *(uint8_t*)0x2089900c = (uint8_t)0x0;
  *(uint8_t*)0x2089900d = (uint8_t)0x0;
  *(uint8_t*)0x2089900e = (uint8_t)0x0;
  *(uint8_t*)0x2089900f = (uint8_t)0x0;
  r[39] =
      syscall(__NR_bind, 0xfffffffffffffffful, 0x20899000ul, 0x10ul);
  r[40] =
      syscall(__NR_dup2, 0xfffffffffffffffful, 0xfffffffffffffffful);
  r[41] = syscall(__NR_shutdown, 0xfffffffffffffffful, 0x1ul);
}
