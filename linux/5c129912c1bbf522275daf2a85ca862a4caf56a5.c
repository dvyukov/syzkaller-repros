// KMSAN: uninit-value in x86_emulate_insn
// https://syzkaller.appspot.com/bug?id=5c129912c1bbf522275daf2a85ca862a4caf56a5
// status:invalid
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000340, "/dev/kvm", 9));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000340, 0x40, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
  ...
  case 4:
    ...
    NONFAILING(*(uint64_t*)0x20000148 = 0x200000c0);
    NONFAILING(memcpy(
        (void*)0x200000c0,
        "\x0f\x22\x25\x26\x26\xdd\x3e\xfa\x7f\x0f\x01\xca\x64\x67\x67\x0f\x01"
        "\xb8\x69\x8d\x9c\xfe\x66\xb9\x2d\x0b\x00\x00\x66\xb8\x88\x28\x00\x00"
        "\x66\xba\x00\x00\x00\x00\x0f\x30\x64\x0f\x20\x43\x25\x00\x80\x66\xb9"
        "\xa8\x03\x00\x00\x0f\x32\xdf\x62\xbf\x67\xde\xe8",
        63));
    NONFAILING(*(uint64_t*)0x20000150 = 0x3f);
    syz_kvm_setup_cpu(-1, r[2], 0x20001000, 0x20000140, 1, 0, 0x200001c0, 0);
    break;
  case 5:
  ...
  case 7:
    ...
    NONFAILING(*(uint32_t*)0x20000004 = 0x2a);
    NONFAILING(
        memcpy((void*)0x20000008,
               "\x33\xbf\x89\xb8\xe0\x8c\x98\x0f\xdc\xc8\xd6\xb5\xf2\x51\x24"
               "\x3b\xd0\xc6\x46\x75\xc3\x29\xb3\xd2\xf2\xef\xba\xe4\x23\xde"
               "\x97\x7d\xa1\xec\xd7\xf5\x0c\x9d\x27\x79\x1f\xe7",
               42));
    NONFAILING(*(uint32_t*)0x20000040 = 0x32);
    syscall(__NR_getsockopt, 0xffffff9c, 0x84, 0x1b, 0x20000000, 0x20000040);
    break;
  }
}
int main(void)
