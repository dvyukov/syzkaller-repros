...
void execute_call(int call)
{
  ...
  case 2:
    NONFAILING(memcpy(
        ...
        16));
    NONFAILING(*(uint16_t*)0x20000050 = 0xca9b);
  ...
  case 4:
    NONFAILING(
        memcpy((void*)0x20000180,
               "\x09\x00\x81\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
               "\xe0\x00\x00\x01\xaa\x3a\xe5\x88\x37\xe7\x3b\xe7\x79\x9e\xc5"
               "\xdd\x82\x25\x5b\x3f\x37\x16\xca\x75\x63\x33\xc2\xc9\x7d\xc7"
               "\x3b\xf8\xc7\x35\x05\xdd\xf3\xbd\xe4\x06\xe2\xe8\x36\xd7\x14"
               "\x55\x0c\x7b\xa8\xfd\x70\x7a\x1e\xbe\xbe",
               70));
    syscall(__NR_write, r[1], 0x20000180, 1);
    break;
  }
}
