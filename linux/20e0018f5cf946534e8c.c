...
// https://syzkaller.appspot.com/bug?id=20e0018f5cf946534e8c
// status:0
...
int main(void)
{
  ...
  *(uint64_t*)0x20000338 = 0x20011300;
  memcpy(
      ...
      121);
  *(uint64_t*)0x20000340 = 0x79;
  *(uint64_t*)0x20000348 = 0xa8000;
  ...
  *(uint64_t*)0x20000378 = 0xb0000;
  syz_mount_image(0x20000000, 0x20000100, 0, 0x10, 0x20000200, 0, 0x20013500);
  ...
  if (res != -1)
    r[1] = res;
  syscall(__NR_lseek, r[1], 6ul, 0ul);
  syscall(__NR_getdents64, r[1], 0ul, 0ul);
  return 0;
}
