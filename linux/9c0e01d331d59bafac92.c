...
// https://syzkaller.appspot.com/bug?id=9c0e01d331d59bafac92
// status:0
...
void execute_call(int call)
{
  ...
  case 7:
    ...
    NONFAILING(memcpy(
        (void*)0x200000d8,
        "\x00\x00\x00\x00\x00\x00\x00\x00\x08\x00\x0a\x00\x0f\x00\x00\x00",
        16));
  ...
  case 13:
    ...
    syscall(__NR_open, 0x200000c0ul, 0x1013c1ul, 0ul);
    break;
  case 14:
  ...
  case 15:
    ...
    NONFAILING(*(uint32_t*)0x200000c0 = 0xfff);
    NONFAILING(*(uint32_t*)0x200000c4 = 5);
    NONFAILING(*(uint32_t*)0x200000c8 = 0x800);
    NONFAILING(*(uint32_t*)0x200000cc = 5);
    NONFAILING(*(uint32_t*)0x200000d0 = 0x10000);
    NONFAILING(*(uint32_t*)0x200001c8 = 5);
    NONFAILING(*(uint32_t*)0x200001cc = 0x80800);
    syscall(__NR_ioctl, -1, 0xc01864c6, 0x200001c0ul);
    break;
  case 16:
  ...
  case 17:
    ...
    syscall(__NR_pivot_root, 0x20000340ul, 0ul);
    break;
  }
}
int main(void)
