...
// https://syzkaller.appspot.com/bug?id=5f29dc6a889fc42bd896
// status:0
...
int main(void)
{
  ...
  *(uint8_t*)0x20000004 = 0x9b;
  *(uint8_t*)0x20000005 = 0xa5;
  *(uint8_t*)0x20000006 = 0x27;
  *(uint8_t*)0x20000007 = 8;
  *(uint16_t*)0x20000008 = 0x10cf;
  *(uint16_t*)0x2000000a = 0x5503;
  *(uint16_t*)0x2000000c = 0x8f60;
