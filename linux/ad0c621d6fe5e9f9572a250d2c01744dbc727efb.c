...
void execute_one(void)
{
  ...
  res = syscall(__NR_socket, 0xa, 0, 0);
  if (res != -1)
    r[0] = res;
  syscall(__NR_close, r[0]);
  res = syscall(__NR_socket, 0xa, 0, 0x84);
  if (res != -1)
    r[1] = res;
  syscall(__NR_setsockopt, r[1], 0x84, 0x64, 0, 0);
  syscall(__NR_open, 0, 0x141042, 0);
  syscall(__NR_ftruncate, -1, 0x200004);
