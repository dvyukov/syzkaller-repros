...
// https://syzkaller.appspot.com/bug?id=4305e814f9b267131776
// status:6
...
void loop(void)
{
  ...
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x20000500, "nl80211\000", 8);
  res = -1;
  res = syz_genetlink_get_family_id(0x20000500);
  if (res != -1)
    r[1] = res;
  res = syscall(__NR_socket, 0x10ul, 3ul, 0x10);
  if (res != -1)
    r[2] = res;
  memcpy((void*)0x20000300, "wlan0\000\000\000\000\000\000\000\000\000\000\000",
         16);
  ...
  *(uint64_t*)0x200003c0 = 0x20000540;
  memcpy((void*)0x20000540, "X\000\000\000", 4);
  *(uint16_t*)0x20000544 = r[1];
  memcpy((void*)0x20000546, "\x09\x00\x00\x00\x00\x00\x00\xf0\xff\x00\x07\x00"
                            "\x00\x00\x08\x00\x03\x00",
         18);
  *(uint32_t*)0x20000558 = r[3];
  memcpy((void*)0x2000055c, "\x08\x00\x05\x1d\x0a\x00\x00\x00\x14\x00\x06\x00"
                            "\x76\x65\x74\x68\x31\x5f\x74\x6f\x5f\x74\x1f\x77"
                            "\x6d\x00\x00\x00\x04\x00\xcc\x00\x08\x00\x05\x00"
                            "\x04\x00\x00\x00\x14\x00\x04\x00\x73",
         45);
  *(uint64_t*)0x200003c8 = 0x58;
