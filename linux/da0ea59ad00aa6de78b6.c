...
// https://syzkaller.appspot.com/bug?id=da0ea59ad00aa6de78b6
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    res = syscall(__NR_memfd_create, 0ul, 5ul);
    if (res != -1)
      r[1] = res;
    break;
  case 3:
  ...
  case 5:
    ...
    syscall(__NR_execveat, r[1], 0x20000000ul, 0ul, 0ul, 0x1000ul);
    break;
  case 6:
    ...
    break;
  case 7:
    NONFAILING(memcpy((void*)0x200003c0, ".log\000", 5));
    syscall(__NR_openat, r[3], 0x200003c0ul, 0x129400ul, 0x1d9ul);
    break;
  }
}
int main(void)
