// BUG: using __this_cpu_read() in preemptible [ADDR] code: syzkaller3NUM/3340
// https://syzkaller.appspot.com/bug?id=70a0e8bdfe9f45d531ba3b673fa44ed34e6d8686
// status:invalid
...
{
  memset(r, -1, sizeof(r));
  r[0] = syscall(__NR_mmap, 0x20000000ul, 0xf55000ul, 0x3ul, 0x32ul,
