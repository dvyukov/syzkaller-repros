...
// https://syzkaller.appspot.com/bug?id=22fa47646f6ba9350797
// status:0
...
void execute_call(int call)
{
  ...
  case 4:
    ...
    *(uint16_t*)0x2001d06c = 0;
    *(uint16_t*)0x2001d06e = 0;
    res = syscall(__NR_perf_event_open, 0x2001d000ul, 0, -1ul, r[1], 0ul);
    if (res != -1)
      r[2] = res;
    break;
  case 5:
  ...
  case 7:
    ...
    *(uint8_t*)0x20000107 = 0xa;
    syscall(__NR_sendto, r[0], 0ul, 0x10bul, 0x200007feul, 0x20000100ul,
            0x10ul);
    break;
  case 8:
    syscall(__NR_sendto, r[0], 0x20d7cfcbul, 0xffffffffffffffeful, 0ul, 0ul,
            0x53ul);
    break;
  }
}
