...
// https://syzkaller.appspot.com/bug?id=efc8d6601b9e3ec94275943e623b77cbf873eae8
// status:invalid
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000200, "/dev/ptmx\x00", 10));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000200, 0x106, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_write, r[0], 0x20000080, 0xfffffe36);
    break;
  }
}
int main(void)
