...
// https://syzkaller.appspot.com/bug?id=e6f77e16ff68b2434a2c
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    *(uint16_t*)0x20003000 = 1;
    memcpy((void*)0x20003002,
           "\351\037q\211Y\036\2223aK\000\000\000\000\000\000\000\000\000\000"
  ...
  case 3:
    ...
    break;
  case 4:
    res = syscall(__NR_fanotify_init, 0ul, 0ul);
    if (res != -1)
      r[1] = res;
    break;
  case 5:
    ...
    *(uint8_t*)0x200000bb = 0;
    syscall(__NR_mount, 0ul, 0x20000000ul, 0x20000040ul, 0x1000000ul,
            0x20000080ul);
    break;
  }
}
