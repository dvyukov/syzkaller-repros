...
// https://syzkaller.appspot.com/bug?id=a923008018a2d298247b
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    *(uint32_t*)0x20000040 = 1;
    syscall(__NR_move_pages, 0, 2ul, 0x20000180ul, 0x20000040ul, 0ul, 0ul);
    break;
  case 2:
