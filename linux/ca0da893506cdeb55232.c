// BUG: Dentry ADDR{i=0,n=/} still in use (-128) [unmount of erofs loop0]
// https://syzkaller.appspot.com/bug?id=ca0da893506cdeb55232
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(*(uint64_t*)0x20000208 = 0xf);
  NONFAILING(*(uint64_t*)0x20000210 = 0x400);
  NONFAILING(*(uint64_t*)0x20000218 = 0x20010100);
  NONFAILING(memcpy((void*)0x20010100, "\x05\x00\x00\x00\xc0\x41", 6));
  NONFAILING(*(uint64_t*)0x20000220 = 6);
  NONFAILING(*(uint64_t*)0x20000228 = 0x480);
  NONFAILING(*(uint64_t*)0x20000230 = 0);
  NONFAILING(*(uint64_t*)0x20000238 = 0);
  NONFAILING(*(uint64_t*)0x20000240 = 0x1000);
  NONFAILING(memcpy((void*)0x20000140, "acl", 3));
  NONFAILING(*(uint8_t*)0x20000143 = 0x2c);
  NONFAILING(memcpy((void*)0x20000144, "user_xattr", 10));
  NONFAILING(*(uint8_t*)0x2000014e = 0x2c);
  NONFAILING(*(uint8_t*)0x2000014f = 0);
  inject_fault(58);
  NONFAILING(
      syz_mount_image(0x20000000, 0x20000100, 0, 3, 0x20000200, 0, 0x20000140));
}
int main(void)
{
  inject_fault(58);
