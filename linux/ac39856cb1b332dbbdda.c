...
// https://syzkaller.appspot.com/bug?id=ac39856cb1b332dbbdda
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(*(uint32_t*)0x20000144 = 0xfa00);
    NONFAILING(*(uint32_t*)0x20000148 = 1);
    NONFAILING(*(uint32_t*)0x2000014c = 0);
    NONFAILING(*(uint32_t*)0x20000150 = 0x9e);
    ...
    res = syscall(__NR_io_uring_setup, 0, 0x20000140ul);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x200000c4 = 0x975f);
    NONFAILING(*(uint32_t*)0x200000c8 = 2);
    NONFAILING(*(uint32_t*)0x200000cc = 0);
    NONFAILING(*(uint32_t*)0x200000d0 = 0x217);
    NONFAILING(*(uint32_t*)0x200000d8 = r[0]);
    NONFAILING(*(uint32_t*)0x200000dc = 0);
    NONFAILING(*(uint32_t*)0x200000e0 = 0);
    NONFAILING(*(uint32_t*)0x200000e4 = 0);
    syscall(__NR_io_uring_setup, 0x53fc, 0x200000c0ul);
    break;
  }
}
int main(void)
