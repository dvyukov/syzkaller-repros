// SYZFAIL: tun: can't open /dev/net/tun (2)
// https://syzkaller.appspot.com/bug?id=d9c87edbd47568540d0a
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000140, "./cgroup\000", 9));
  ...
  case 4:
    ...
    NONFAILING(memcpy((void*)0x200001c0, "cgroup2\000", 8));
    syscall(__NR_mount, 0ul, 0x20000040ul, 0x200001c0ul, 0ul, 0ul);
    break;
  case 5:
    ...
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000200, "syz0\000", 5));
    res = syscall(__NR_openat, r[0], 0x20000200ul, 0x200002ul, 0ul);
    if (res != -1)
      r[1] = res;
    break;
  case 7:
    NONFAILING(memcpy((void*)0x20000180, "memory.max\000", 11));
    res = syscall(__NR_openat, r[1], 0x20000180ul, 2ul, 0ul);
    if (res != -1)
      r[2] = res;
    break;
  case 8:
    NONFAILING(sprintf((char*)0x20000080, "0x%016llx", (long long)0));
    syscall(__NR_write, r[2], 0x20000080ul, 0x12ul);
    break;
  }
}
int main(void)
