...
// https://syzkaller.appspot.com/bug?id=ea0ea1495c431e6d12a3
// status:0
...
void loop(void)
{
  ...
  if (res != -1)
    NONFAILING(r[2] = *(uint32_t*)0x20000050);
  NONFAILING(*(uint8_t*)0x20000100 = 0xfc);
  NONFAILING(*(uint8_t*)0x20000101 = 2);
  ...
  NONFAILING(*(uint8_t*)0x20000110 = 0xfc);
  NONFAILING(*(uint8_t*)0x20000111 = 2);
  ...
  NONFAILING(*(uint8_t*)0x20000120 = 0xfc);
  ...
  NONFAILING(*(uint32_t*)0x2000012c = htobe32(-1));
  NONFAILING(*(uint32_t*)0x20000130 = 0);
  NONFAILING(*(uint16_t*)0x20000134 = 0);
  NONFAILING(*(uint16_t*)0x20000136 = 0);
  NONFAILING(*(uint32_t*)0x20000138 = 0);
  NONFAILING(*(uint64_t*)0x20000140 = 0);
  NONFAILING(*(uint32_t*)0x20000148 = 6);
  NONFAILING(*(uint32_t*)0x2000014c = r[2]);
  syscall(__NR_ioctl, r[0], 0x890b, 0x20000100ul);
  res = syscall(__NR_socket, 0xaul, 3ul, 0x3a);
  if (res != -1)
    r[3] = res;
  NONFAILING(*(uint32_t*)0x200000c0 = 9);
  syscall(__NR_setsockopt, r[3], 0x29, 0x24, 0x200000c0ul, 4ul);
  NONFAILING(*(uint16_t*)0x200004c0 = 0xa);
  NONFAILING(*(uint16_t*)0x200004c2 = htobe16(0));
  NONFAILING(*(uint32_t*)0x200004c4 = htobe32(0));
  NONFAILING(*(uint8_t*)0x200004c8 = -1);
  NONFAILING(*(uint8_t*)0x200004c9 = 1);
  ...
  NONFAILING(*(uint8_t*)0x200004d7 = 1);
  NONFAILING(*(uint32_t*)0x200004d8 = 5);
  syscall(__NR_connect, r[3], 0x200004c0ul, 0x1cul);
  NONFAILING(memcpy((void*)0x20000140,
                    "\x27\xe4\x0c\x9c\x81\xcf\x88\x10\x2e\xe6\x86\x92\x82\xe4"
                    "\x99\xfc\x6c\x01\x24\xc5\xcc\xe6\xa9\x26\x53\x11\xec\xb1"
                    "\xfc\xaa\xb1\xda\x91\x62\xc1\xa4\x0d\xde\x46\x9c",
                    40));
  syscall(__NR_write, r[3], 0x20000140ul, 0x28ul);
}
int main(void)
{
