// WARNING: stack going in the wrong direction? ip=do_nanosleep (2)
// https://syzkaller.appspot.com/bug?id=2e524e0c5523a532b0bbd548cd051ddf71ca4b04
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    syscall(__NR_rt_sigtimedwait, 0x20000100, 0, 0, 8);
    break;
  case 2:
    syscall(__NR_rt_tgsigqueueinfo, 0, 0, 0, 0);
    break;
  case 3:
    syz_open_procfs(0, 0);
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000200, "stack\000", 6));
  ...
  case 5:
    ...
    NONFAILING(*(uint64_t*)0x200000d0 = 0xac);
    NONFAILING(*(uint32_t*)0x200000d8 = 0);
    syscall(__NR_fcntl, -1, 0, 0x200000c0);
    break;
  case 6:
    NONFAILING(*(uint64_t*)0x20002340 = 0x20000400);
    NONFAILING(*(uint64_t*)0x20002348 = 0x1000);
    syscall(__NR_readv, -1, 0x20002340, 1);
    break;
  case 7:
    ...
    break;
  case 8:
    syscall(__NR_readv, r[0], 0x20000580, 0x3c1);
    break;
  case 9:
