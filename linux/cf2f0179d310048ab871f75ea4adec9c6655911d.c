...
// https://syzkaller.appspot.com/bug?id=cf2f0179d310048ab871f75ea4adec9c6655911d
// status:open
...
void execute_one(void)
{
  ...
  *(uint16_t*)0x200000a0 = 0x8000;
  *(uint32_t*)0x200000a4 = 0x400;
  *(uint32_t*)0x200000a8 = 0x3fa;
  *(uint64_t*)0x200000b0 = 0x10000;
  *(uint64_t*)0x200000b8 = 0x26;
  *(uint32_t*)0x200000c0 = 0;
  syscall(__NR_ioctl, r[1], 0xc0481273, 0x20000080);
}
int main(void)
{
