...
// https://syzkaller.appspot.com/bug?id=263f8c0d007dc09b2dda
// status:6
...
void loop(void)
{
  ...
  *(uint64_t*)0x20000650 = 0x20000680;
  ...
  *(uint16_t*)0x20000058 = 0x4101;
  *(uint16_t*)0x2000005a = 0;
  *(uint16_t*)0x2000005c = htobe16(0x18);
  *(uint16_t*)0x2000005e = htobe16(0x17);
  *(uint32_t*)0x20000060 = htobe32(0);
  *(uint32_t*)0x20000064 = htobe32(0);
  memcpy((void*)0x20000068, "eth", 3);
  *(uint8_t*)0x2000006b = 0x3a;
  memcpy((void*)0x2000006c, "macsec0\000", 8);
  *(uint64_t*)0x20000688 = 0x34;
  ...
  *(uint16_t*)0x200004d4 = 0x40;
  STORE_BY_BITMASK(uint16_t, , 0x200004d6, 6, 0, 14);
  STORE_BY_BITMASK(uint16_t, , 0x200004d7, 0, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x200004d7, 1, 7, 1);
  *(uint16_t*)0x200004d8 = 0x3c;
  *(uint16_t*)0x200004da = 4;
  memcpy((void*)0x200004dc, "gcm(aes)"
                            "\000\000\000\000\000\000\000\000\000\000\000\000"
                            "\000\000\000\000\000\000\000\000\000\000\000\000",
         32);
  *(uint32_t*)0x200004fc = 0x14;
  memcpy((void*)0x20000500, "\x71\xf0\xfc\xf2\xaa\x12\x02\x40\xb1\x71\x3a\x97"
                            "\x6c\x10\x48\x20\xde\x2b\x91\x00",
         20);
  ...
  *(uint32_t*)0x200004b0 = 0;
  ...
  if (res != -1)
    r[5] = res;
  *(uint64_t*)0x20000640 = 0;
  *(uint32_t*)0x20000648 = 0xfffffe84;
  *(uint64_t*)0x20000650 = 0x20000680;
  *(uint64_t*)0x20000680 = 0x20000040;
  *(uint32_t*)0x20000040 = 0x38;
  *(uint16_t*)0x20000044 = r[5];
  *(uint16_t*)0x20000046 = 1;
  ...
  *(uint16_t*)0x20000058 = 0x4101;
  *(uint16_t*)0x2000005a = 0;
  *(uint16_t*)0x2000005c = htobe16(0x1c);
  *(uint16_t*)0x2000005e = htobe16(0x17);
  *(uint32_t*)0x20000060 = htobe32(0);
  *(uint32_t*)0x20000064 = htobe32(0);
  memcpy((void*)0x20000068, "eth", 3);
  *(uint8_t*)0x2000006b = 0x3a;
  memcpy((void*)0x2000006c, "ip6_vti0\000", 9);
  *(uint64_t*)0x20000688 = 0x38;
  *(uint64_t*)0x20000658 = 1;
  *(uint64_t*)0x20000660 = 0;
  *(uint64_t*)0x20000668 = 0;
  *(uint32_t*)0x20000670 = 0;
  syscall(__NR_sendmsg, r[4], 0x20000640ul, 0ul);
}
int main(void)
{
