...
void loop()
{
  ...
  if (res != -1)
    r[2] = res;
  res = syscall(__NR_dup3, r[2], r[0], 0);
  if (res != -1)
    r[3] = res;
  *(uint64_t*)0x200001c0 = 0x40;
  *(uint64_t*)0x200001c8 = 0x20000280;
  memcpy((void*)0x20000280,
         "\x66\x43\x0f\x38\x80\x90\x80\x00\xc0\xfe\x66\xba\x41\x00\xb8\xfc\x8c"
         "\x00\x00\xef\xb9\x89\x09\x00\x00\x0f\x32\x66\xb8\x25\x00\x8e\xc0\x36"
         "\x65\x46\x0f\xc7\x3e\x66\xb8\x38\x00\x8e\xc0\x36\x67\x0f\x01\xb6\x8b"
         "\x00\x00\x00\x0f\x20\xc0\x35\x00\x00\x00\x40\x0f\x22\xc0\x0f\xc7\x59"
         "\x00\x66\xba\x21\x00\xec",
         74);
  *(uint64_t*)0x200001d0 = 0x4a;
  syz_kvm_setup_cpu(r[1], r[2], 0x20fe7000, 0x200001c0, 1, 0x4c, 0x20000300, 0);
