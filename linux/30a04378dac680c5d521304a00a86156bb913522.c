...
int main(void)
{
  ...
  *(uint8_t*)0x20000044 = 0xa2;
  *(uint8_t*)0x20000045 = 0x3b;
  *(uint8_t*)0x20000046 = 0xc5;
  *(uint8_t*)0x20000047 = 8;
  *(uint16_t*)0x20000048 = 0x742;
  *(uint16_t*)0x2000004a = 0x200a;
  *(uint16_t*)0x2000004c = 0xc297;
  ...
  *(uint8_t*)0x20000060 = 0xc9;
  *(uint8_t*)0x20000061 = 0x55;
  *(uint8_t*)0x20000062 = 0xd3;
  ...
  *(uint8_t*)0x2000006c = 0;
  syz_usb_connect(6, 0x2d, 0x20000040, 0);
  return 0;
}
