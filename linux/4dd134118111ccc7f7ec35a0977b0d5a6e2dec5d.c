...
void execute_call(int call)
{
  switch (call) {
  case 0:
    memcpy((void*)0x20000000, "ext3", 5);
    memcpy((void*)0x20000040, "//file0//./..", 14);
    memcpy((void*)0x20000140, "debug_want_extra_isize", 22);
    *(uint8_t*)0x20000156 = 0x3d;
    *(uint8_t*)0x20000157 = 0x37;
    *(uint8_t*)0x20000158 = 0x36;
    *(uint8_t*)0x20000159 = 0x33;
    *(uint8_t*)0x2000015a = 0x32;
    *(uint8_t*)0x2000015b = 0;
    *(uint8_t*)0x2000015c = 0x2d;
    *(uint8_t*)0x2000015d = 0x39;
    *(uint8_t*)0x2000015e = 0x2c;
    memcpy((void*)0x2000015f, "nomblk_io_submit", 16);
    *(uint8_t*)0x2000016f = 0x2c;
    memcpy((void*)0x20000170, "nouid32", 7);
    *(uint8_t*)0x20000177 = 0x2c;
    memcpy((void*)0x20000178, "grpid", 5);
    *(uint8_t*)0x2000017d = 0x2c;
    memcpy((void*)0x2000017e, "usrjquota=", 10);
    *(uint8_t*)0x20000188 = 0x2c;
    *(uint8_t*)0x20000189 = 0;
    syz_mount_image(0x20000000, 0x20000040, 0, 0xaaaab03, 0x20000940, 0x6462,
                    0x20000140);
    break;
  case 1:
    memcpy((void*)0x20000640, "//file0", 8);
    syscall(__NR_mkdir, 0x20000640, 0);
    break;
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_write, -1, 0x20000440, 0);
    break;
  case 4:
