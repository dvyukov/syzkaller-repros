...
// https://syzkaller.appspot.com/bug?id=e69f297a1502b92520533092ee9a3e598b1549cc
// status:open
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    NONFAILING(*(uint64_t*)0x20000018 = 2);
    syscall(__NR_ioctl, -1, 0xc0206434ul, 0x20000000ul);
    break;
  case 4:
  ...
  case 5:
    ...
    NONFAILING(memcpy(
        (void*)0x20d80f82,
        "\x01\x03\x00\x00\x00\x09\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x09"
        "\xa9\x79\xfd\x21\xb3\x0c\x7b\xc8\x79\x04\x05\xc7\xba\xd6\x2e\x0a\x43"
        "\xa6\x32\xed\x49\x38\xd3\x6d\x73\x00\x00\x00\x00\xa3\xff\x59\x82\x26"
        "\x69\xca\x02\x1f\x6f\x65\xdc\x6f\xf4\x5d\x60\x8f\x35\x79\x00\x02\xf0"
        "\x00\x01\x58\xd1\x9b\xcb\x31\xf1\x31\x4a\x8e\xf1\x51\x62\x2c\xa5\xbd"
        "\xb9\xc8\x04\xd2\x00\x00\x77\xae\xb8\x1c\x90\x00\x1d\x6d\x04\x00\x0e"
        "\xe5\x90\xc8\xb5\xf7\x0d\xc1\x36\xca\x18\x4a\x00\x00\x00\x00\x00\x00"
        "\x00\x00\x00\x00\x00\x00\x00",
        126));
    syscall(__NR_bind, r[0], 0x20d80f80ul, 0x80ul);
    break;
  case 6:
    ...
    break;
  case 7:
    NONFAILING(memcpy((void*)0x20000400, "TIPC\000", 5));
  ...
  case 8:
    ...
    NONFAILING(*(uint32_t*)0x20000280 = 0x1c);
    NONFAILING(*(uint16_t*)0x20000284 = r[2]);
    ...
    NONFAILING(*(uint16_t*)0x20000298 = 6);
    NONFAILING(*(uint16_t*)0x2000029a = 0);
    NONFAILING(*(uint64_t*)0x200002c8 = 0x1c);
