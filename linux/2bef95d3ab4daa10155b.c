...
// https://syzkaller.appspot.com/bug?id=2bef95d3ab4daa10155b
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    *(uint16_t*)0x20000100 = 0x1f;
    ...
    syscall(__NR_connect, r[0], 0x20000100ul, 8ul);
    break;
  case 2:
    *(uint16_t*)0x20000280 = 0x1f;
    memset((void*)0x20000282, 255, 6);
    syscall(__NR_connect, r[0], 0x20000280ul, 8ul);
    break;
  }
}
int main(void)
