...
// https://syzkaller.appspot.com/bug?id=db0f478f48d3e2bae67ce02762bbbde21858e2e8
// status:dup
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x20000200 = 3);
    NONFAILING(*(uint32_t*)0x20000204 = 0x70);
    NONFAILING(*(uint8_t*)0x20000208 = 0xfa);
    NONFAILING(*(uint8_t*)0x20000209 = 9);
    NONFAILING(*(uint8_t*)0x2000020a = 0xd0);
    NONFAILING(*(uint8_t*)0x2000020b = 0x34);
    NONFAILING(*(uint32_t*)0x2000020c = 0);
    NONFAILING(*(uint64_t*)0x20000210 = 6);
    NONFAILING(*(uint64_t*)0x20000218 = 0x2000);
    NONFAILING(*(uint64_t*)0x20000220 = 1);
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 0x35aa, 0, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 0x80000000, 1, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 9, 2, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 6, 3, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 0x7cd, 4, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 4, 5, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 0x3ff, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 7, 7, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 0x7fff, 8, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 7, 9, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 2, 10, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 0x7b3, 11, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 4, 12, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 0xc3, 13, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 8, 14, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 0x16, 15, 2));
    NONFAILING(
        STORE_BY_BITMASK(uint64_t, 0x20000228, 0xffffffffffffff80, 17, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 1, 18, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 7, 19, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 5, 20, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 4, 21, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 0xe36, 22, 1));
    NONFAILING(
        STORE_BY_BITMASK(uint64_t, 0x20000228, 0xffffffff00000001, 23, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 0xffff, 24, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 0x709f, 25, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 0x8001, 26, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 1, 27, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 9, 28, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x20000228, 0, 29, 35));
    NONFAILING(*(uint32_t*)0x20000230 = 9);
    NONFAILING(*(uint32_t*)0x20000234 = 0);
    NONFAILING(*(uint64_t*)0x20000238 = 0x200000c0);
    NONFAILING(*(uint64_t*)0x20000240 = 8);
    NONFAILING(*(uint64_t*)0x20000248 = 0);
    NONFAILING(*(uint64_t*)0x20000250 = 0x40);
    NONFAILING(*(uint32_t*)0x20000258 = 0x20);
    NONFAILING(*(uint32_t*)0x2000025c = 0);
    NONFAILING(*(uint64_t*)0x20000260 = 0x100);
    NONFAILING(*(uint32_t*)0x20000268 = 3);
    NONFAILING(*(uint16_t*)0x2000026c = 0xa);
  ...
  case 2:
    ...
    if (res != -1) {
      NONFAILING(r[1] = *(uint32_t*)0x20000140);
      NONFAILING(r[2] = *(uint32_t*)0x20000144);
    }
    break;
  case 3:
  ...
  case 4:
    ...
    break;
  case 5:
    NONFAILING(*(uint32_t*)0x20000100 = r[1]);
    NONFAILING(*(uint64_t*)0x20000108 = 0x20000380);
    NONFAILING(*(uint64_t*)0x20000110 = 0x20000480);
  ...
  case 7:
    ...
    NONFAILING(*(uint64_t*)0x20000190 = 0x20000300);
