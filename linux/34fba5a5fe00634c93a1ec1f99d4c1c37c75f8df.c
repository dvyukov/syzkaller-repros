...
// https://syzkaller.appspot.com/bug?id=34fba5a5fe00634c93a1ec1f99d4c1c37c75f8df
// status:fixed
...
void loop()
{
  ...
  *(uint8_t*)0x20000284 = 0;
  memcpy((void*)0x20000440, "\x00\x00\x00\x00\x00\x00\x00\x58", 8);
  res = syscall(__NR_add_key, 0x203bd000, 0x20000280, 0x20000440, 8, r[2]);
  if (res != -1)
    r[3] = res;
