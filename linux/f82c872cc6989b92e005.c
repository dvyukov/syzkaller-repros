...
// https://syzkaller.appspot.com/bug?id=f82c872cc6989b92e005
// status:6
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    syscall(__NR_epoll_ctl, r[1], 1ul, r[2], 0x20000080ul);
    break;
  case 4:
    res = syscall(__NR_epoll_create, 0x46c);
    if (res != -1)
      r[3] = res;
    break;
  case 5:
    ...
    syscall(__NR_epoll_ctl, r[2], 1ul, r[0], 0x200000c0ul);
    break;
  case 6:
    ...
    break;
  case 7:
    NONFAILING(*(uint32_t*)0x20c7f000 = 0);
    NONFAILING(*(uint64_t*)0x20c7f004 = 0);
    syscall(__NR_epoll_ctl, r[4], 1ul, r[1], 0x20c7f000ul);
    break;
  case 8:
    syscall(__NR_epoll_ctl, r[3], 1ul, r[4], 0ul);
    break;
  }
}
int main(void)
