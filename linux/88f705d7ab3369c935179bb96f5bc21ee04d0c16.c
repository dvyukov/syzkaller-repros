...
void execute_call(int call)
{
  ...
  case 7:
    ...
    syz_open_dev(0x20000700, 0, 1);
    break;
  case 8:
    syscall(__NR_write, r[1], 0x20000340ul, 0x41395527ul);
    break;
  case 9:
    res = syscall(__NR_clock_gettime, 0ul, 0x20000380ul);
    if (res != -1)
      r[2] = *(uint64_t*)0x20000388;
    break;
  case 10:
    ...
    *(uint64_t*)0x20000428 = 0;
    syscall(__NR_sched_setattr, 0, 0x20000400ul, 0ul);
    break;
  case 11:
    ...
    *(uint64_t*)0x20000208 = r[2] + 30000000;
    syscall(__NR_pselect6, 0x40ul, 0x200000c0ul, 0ul, 0x20000040ul,
            0x20000200ul, 0ul);
    break;
  case 12:
