...
// https://syzkaller.appspot.com/bug?id=37763c1eb5316112abc7
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint32_t*)0x20000144 = 0x80);
    NONFAILING(*(uint8_t*)0x20000148 = 2);
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000168, 0, 29, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000168, 0, 30, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000168, 0, 31, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000168, 0, 32, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000168, 0, 33, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000168, 0, 34, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000168, 0, 35, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000168, 0, 36, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000168, 0, 37, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000168, 0, 38, 26));
  ...
  case 1:
    ...
    NONFAILING(*(uint8_t*)0x200000c8 = 4);
    ...
    syscall(__NR_perf_event_open, 0x200000c0ul, -1, 0ul, r[0], 0ul);
    break;
  case 2:
    NONFAILING(*(uint32_t*)0x200000c0 = 7);
    NONFAILING(*(uint32_t*)0x200000c4 = 0x80);
    NONFAILING(*(uint8_t*)0x200000c8 = 2);
    NONFAILING(*(uint8_t*)0x200000c9 = 0);
    NONFAILING(*(uint8_t*)0x200000ca = 0);
    NONFAILING(*(uint8_t*)0x200000cb = 0);
    NONFAILING(*(uint32_t*)0x200000cc = 0);
    ...
    NONFAILING(*(uint32_t*)0x20000134 = 0);
    NONFAILING(*(uint64_t*)0x20000138 = 0);
    syscall(__NR_perf_event_open, 0x200000c0ul, -1, 0ul, -1, 0ul);
    break;
  }
}
int main(void)
