// KMSAN: kernel-infoleak in kvm_vcpu_ioctl
// https://syzkaller.appspot.com/bug?id=62fd75d1e63266d74869565ae225732095d75396
// status:invalid
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    break;
  case 4:
    NONFAILING(*(uint64_t*)0x200001c0 = 0x40);
    NONFAILING(*(uint64_t*)0x200001c8 = 0x20000040);
    NONFAILING(memcpy(
        (void*)0x20000040,
        ...
        78));
    NONFAILING(*(uint64_t*)0x200001d0 = 0x4e);
    syz_kvm_setup_cpu(-1, r[2], 0x20000000, 0x200001c0, 1, 0x48, 0x200000c0,
                      0x10000000000003e9);
    break;
  case 5:
    NONFAILING(*(uint8_t*)0x20000180 = 0xac);
    NONFAILING(*(uint8_t*)0x20000181 = 0x14);
    NONFAILING(*(uint8_t*)0x20000182 = 0x14);
    NONFAILING(*(uint8_t*)0x20000183 = 0xbb);
    NONFAILING(*(uint32_t*)0x20000184 = htobe32(0));
    syscall(__NR_setsockopt, -1, 0, 0, 0x20000180, 0xfffffffffffffed3);
    break;
  case 6:
