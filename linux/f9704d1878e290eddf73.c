...
// https://syzkaller.appspot.com/bug?id=f9704d1878e290eddf73
// status:6
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000098 = -1;
  ...
  res = -1;
  res = syz_io_uring_setup(0x884, 0x20000080, 0x20ee7000, 0x206d4000,
                           0x20000040, 0x20000000);
  if (res != -1) {
    r[0] = res;
  ...
  *(uint8_t*)0x20002c40 = 9;
  *(uint8_t*)0x20002c41 = 0x18;
  *(uint16_t*)0x20002c42 = 0;
  *(uint32_t*)0x20002c44 = -1;
  *(uint64_t*)0x20002c48 = 0;
  *(uint64_t*)0x20002c50 = 0;
  *(uint32_t*)0x20002c58 = 0;
  *(uint32_t*)0x20002c5c = 0;
  *(uint64_t*)0x20002c60 = 0;
  *(uint16_t*)0x20002c68 = 0;
  *(uint16_t*)0x20002c6a = 0;
  memset((void*)0x20002c6c, 0, 20);
  syz_io_uring_submit(r[1], r[2], 0x20002c40, 0);
