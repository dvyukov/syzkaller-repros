...
// https://syzkaller.appspot.com/bug?id=5a56ebe025ae6b2309a3bb8d2222e28863580a01
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    NONFAILING(memcpy(
        ...
        16));
    NONFAILING(*(uint16_t*)0x20000210 = 2);
    NONFAILING(*(uint16_t*)0x20000212 = htobe16(0x4e20));
    NONFAILING(*(uint32_t*)0x20000214 = htobe32(0));
    ...
    syscall(__NR_ioctl, -1, 0x8917, 0x20000200);
    break;
  case 1:
  ...
  case 4:
    ...
    NONFAILING(*(uint16_t*)0x2000008e = 3);
    NONFAILING(*(uint16_t*)0x20000090 = 0);
    NONFAILING(*(uint16_t*)0x20000092 = 3);
    NONFAILING(*(uint16_t*)0x20000094 = 0);
    NONFAILING(*(uint16_t*)0x20000096 = 0xa);
    NONFAILING(*(uint16_t*)0x20000098 = htobe16(2));
    NONFAILING(*(uint32_t*)0x2000009a = 3);
    ...
    NONFAILING(*(uint32_t*)0x200000ae = 4);
