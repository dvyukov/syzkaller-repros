// INFO: task hung in raw_release (2)
// https://syzkaller.appspot.com/bug?id=600f542d6b472ad60c39
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(*(uint64_t*)0x2001d010 = 5);
  ...
  NONFAILING(*(uint16_t*)0x2001d06c = 0xfffe);
  ...
  syscall(__NR_clone, 0xe1004d7cul, 0ul, 0x9999999999999999ul, 0ul, -1ul);
  syscall(__NR_sched_setattr, 0, 0ul, 0ul);
  syscall(__NR_ioctl, -1, 0x81f8943c, 0x20000780ul);
  syscall(__NR_setsockopt, -1, 0x65, 5, 0ul, 0ul);
