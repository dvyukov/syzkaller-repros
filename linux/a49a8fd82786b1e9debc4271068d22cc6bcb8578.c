...
// https://syzkaller.appspot.com/bug?id=a49a8fd82786b1e9debc4271068d22cc6bcb8578
// status:dup
...
void execute_one()
{
  memcpy((void*)0x20000440, "fou", 4);
  syz_genetlink_get_family_id(0x20000440);
  memcpy((void*)0x20d04000, "./file0", 8);
  memcpy((void*)0x20903000, "./file0", 8);
  memcpy((void*)0x20811ffa, "bdev", 5);
  syscall(__NR_mount, 0x20d04000, 0x20903000, 0x20811ffa, 0, 0x20444000);
  ...
  *(uint16_t*)0x2094006e = 0;
  ...
  memcpy((void*)0x20000280, "rootfs", 7);
  syscall(__NR_mount, 0x20000200, 0x20000240, 0x20000280, 0x1000, 0x200002c0);
  memcpy((void*)0x20000040, "./file0", 8);
  memcpy((void*)0x200000c0, "./file0", 8);
  memcpy((void*)0x20000500, "nsfs", 5);
  syscall(__NR_mount, 0x20000040, 0x200000c0, 0x20000500, 0x20, 0x200004c0);
  *(uint32_t*)0x20000680 = -1;
  *(uint32_t*)0x20000684 = 0x50;
  *(uint64_t*)0x20000688 = 0x200003c0;
  syscall(__NR_bpf, 0xf, 0x20000680, 0x10);
  *(uint32_t*)0x20000100 = 0;
  *(uint32_t*)0x20000104 = 3;
  *(uint32_t*)0x20000108 = 8;
  syscall(__NR_bpf, 0xe, 0x20000100, 0xc);
  *(uint32_t*)0x20000740 = -1;
  *(uint32_t*)0x20000744 = 0x50;
  *(uint64_t*)0x20000748 = 0x200006c0;
  syscall(__NR_bpf, 0xf, 0x20000740, 0x10);
}
