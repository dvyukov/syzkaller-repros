...
// https://syzkaller.appspot.com/bug?id=143350472c5906e7456da2e1667882c711eb9aaf
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_io_cancel, 0, 0, 0);
    break;
  case 3:
    syscall(__NR_write, -1, 0x200000c0, 0xffffff78);
    break;
  case 4:
    syscall(__NR_ioctl, -1, 0xc0e05403, 0);
    break;
  case 5:
    syscall(__NR_ioctl, -1, 0x40045431, 0);
    break;
  case 6:
    syz_open_pts(-1, 0);
    break;
  case 7:
    ...
    break;
  case 8:
    syscall(__NR_setsockopt, -1, 0x29, 0x3f, 0, 0);
    break;
  case 9:
    syscall(__NR_mmap, 0x20000000, 0xb36000, 3, 0x8031, -1, 0);
    break;
  case 10:
    syscall(__NR_ioctl, -1, 0x89f6, 0);
    break;
  case 11:
    NONFAILING(memcpy((void*)0x20000340,
                      "system_u:object_r:sound_device_t:s0\x00", 36));
    syscall(__NR_fsetxattr, r[0], 0, 0x20000340, 0x24, 1);
    break;
  case 12:
    syscall(__NR_mremap, 0x20a94000, 0x2000, 0x800000, 3, 0x20130000);
    break;
  case 13:
