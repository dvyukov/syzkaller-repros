...
void execute_one(void)
{
  ...
  NONFAILING(*(uint16_t*)0x200001c6 = 0);
  NONFAILING(*(uint32_t*)0x200001c8 = 0);
  NONFAILING(*(uint32_t*)0x200001cc = 0);
  NONFAILING(*(uint32_t*)0x200001d0 = 5);
  syscall(__NR_setsockopt, r[0], 0x84, 1, 0x200001c0, 0x14);
  ...
  res = syscall(__NR_socket, 2, 0x801, 0x84);
  if (res != -1)
    r[1] = res;
  ...
  NONFAILING(memcpy((void*)0x20000200, "#", 1));
