...
// https://syzkaller.appspot.com/bug?id=f8c53ea5ec7062610bb9d0c2fcd227016a5d0eb6
// status:open
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    break;
  case 4:
    *(uint64_t*)0x20000080 = 0x20003040;
    memcpy((void*)0x20003040, "\x02", 1);
    *(uint64_t*)0x20000088 = 1;
    syscall(__NR_pwritev, r[0], 0x20000080ul, 1ul, 0ul);
    break;
  case 5:
    syscall(__NR_fallocate, r[0], 0x20ul, 0ul, 0xfffffeff000ul);
    break;
  }
}
int main(void)
