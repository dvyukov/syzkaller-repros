...
// https://syzkaller.appspot.com/bug?id=0a0736596e637d7001468494a9d9425481138e3f
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(memcpy((void*)0x20000280, "tmpfs", 6));
    syscall(__NR_mount, 0x20000180, 0x20000040, 0x20000280, 0, 0x200002c0);
    break;
  case 2:
  ...
  case 4:
    ...
    NONFAILING(*(uint32_t*)0x20000090 = 0x22);
    NONFAILING(*(uint32_t*)0x20000094 = r[1]);
    NONFAILING(*(uint32_t*)0x20000098 = 6);
  ...
  case 8:
    NONFAILING(memcpy((void*)0x20000040, "./file0", 8));
    syscall(__NR_inotify_add_watch, r[3], 0x20000040, 0x20000000);
    break;
  case 9:
    ...
    break;
  case 10:
    NONFAILING(*(uint32_t*)0x20c85000 = 0);
    NONFAILING(*(uint64_t*)0x20c85004 = 0);
    syscall(__NR_epoll_ctl, r[2], 1, r[0], 0x20c85000);
    break;
  case 11:
    NONFAILING(*(uint32_t*)0x20000040 = 1);
    NONFAILING(*(uint64_t*)0x20000044 = 0);
    syscall(__NR_epoll_ctl, r[2], 3, r[2], 0x20000040);
    break;
  case 12:
    NONFAILING(*(uint32_t*)0x20000540 = r[2]);
    NONFAILING(*(uint16_t*)0x20000544 = 0);
    NONFAILING(*(uint16_t*)0x20000546 = 0);
    NONFAILING(*(uint32_t*)0x20000548 = r[3]);
    NONFAILING(*(uint16_t*)0x2000054c = 0x1011);
    NONFAILING(*(uint16_t*)0x2000054e = 0);
    NONFAILING(*(uint64_t*)0x20000580 = 0x77359400);
    NONFAILING(*(uint64_t*)0x20000588 = 0);
    NONFAILING(*(uint64_t*)0x200005c0 = 0);
    syscall(__NR_ppoll, 0x20000540, 2, 0x20000580, 0x200005c0, 8);
    break;
  }
}
int main(void)
