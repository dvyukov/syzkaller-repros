...
void loop()
{
  ...
  *(uint32_t*)0x200001d8 = 9;
  syscall(__NR_connect, r[0], 0x200001c0, 0x1c);
  *(uint32_t*)0x20000000 = 6;
  syscall(__NR_setsockopt, r[0], 0x11, 0x65, 0x20000000, 4);
  *(uint32_t*)0x20000080 = 6;
  syscall(__NR_setsockopt, r[0], 0x11, 0x67, 0x20000080, 4);
  *(uint64_t*)0x20001c40 = 0;
  *(uint32_t*)0x20001c48 = 0;
  *(uint64_t*)0x20001c50 = 0x20001100;
  *(uint64_t*)0x20001c58 = 0x131;
  *(uint64_t*)0x20001c60 = 0;
  *(uint64_t*)0x20001c68 = 0;
  *(uint32_t*)0x20001c70 = 0;
  *(uint32_t*)0x20001c78 = 0;
  syscall(__NR_sendmmsg, r[0], 0x20001c40, 0x40000000000011d, 0);
  ...
  *(uint16_t*)0x2000008c = htobe16(0xd);
  STORE_BY_BITMASK(uint32_t, 0x2000008e, 3, 0, 29);
  STORE_BY_BITMASK(uint32_t, 0x2000008e, 4, 29, 1);
  STORE_BY_BITMASK(uint32_t, 0x2000008e, 3, 30, 1);
  STORE_BY_BITMASK(uint32_t, 0x2000008e, 0x1ff, 31, 1);
  *(uint8_t*)0x20000092 = 0x23;
  *(uint8_t*)0x20000093 = 2;
  *(uint8_t*)0x20000094 = 0;
  *(uint8_t*)0x20000095 = 0;
  memcpy((void*)0x20000096,
         "\x53\xf4\x84\x69\xe6\xbd\xa1\xee\x4f\x26\xf6\x8f\x81\x67\xaa\x20\x22"
         "\xcd\x26\xea\xcf\xda\x98\xbb\xdf\x07\xbd\x3d\x1e\x78\x8e\x33\x7b\xb1"
         "\x86\xe8\xfe\xe4\xcf\x31\xe3\x25\x9b\xd3\xe2\x53\xcf\x2d\x90\xa1\x76"
         "\x0f\x2a\x8f\x51\x9b\x00\x5d\x34\x17\xf8\x8e\xbe\x92",
         64);
  syz_emit_ethernet(0x56, 0x20000080, 0);
}
