...
// https://syzkaller.appspot.com/bug?id=5470940d8c65601e282f
// status:6
...
void execute_call(int call)
{
  ...
  case 7:
    ...
    NONFAILING(*(uint32_t*)0x200004d4 = r[3]);
  ...
  case 9:
    ...
    NONFAILING(*(uint32_t*)0x200002c0 = 0x3c);
    NONFAILING(*(uint16_t*)0x200002c4 = 0x2c);
    NONFAILING(*(uint16_t*)0x200002c6 = 0xd27);
    ...
    NONFAILING(*(uint32_t*)0x200002d4 = r[3]);
    NONFAILING(*(uint16_t*)0x200002d8 = 0x8100);
    NONFAILING(*(uint16_t*)0x200002da = 0);
    NONFAILING(*(uint16_t*)0x200002dc = 0);
    NONFAILING(*(uint16_t*)0x200002de = 0);
    NONFAILING(*(uint16_t*)0x200002e0 = 0);
    NONFAILING(*(uint16_t*)0x200002e2 = 0x10);
    NONFAILING(*(uint16_t*)0x200002e4 = 0xa);
    NONFAILING(*(uint16_t*)0x200002e6 = 1);
    NONFAILING(memcpy((void*)0x200002e8, "route\000", 6));
    NONFAILING(*(uint16_t*)0x200002f0 = 0xc);
    NONFAILING(*(uint16_t*)0x200002f2 = 2);
    NONFAILING(*(uint16_t*)0x200002f4 = 8);
    NONFAILING(*(uint16_t*)0x200002f6 = 3);
  ...
  case 10:
    ...
    NONFAILING(*(uint64_t*)0x20000290 = 0x20000180);
    NONFAILING(*(uint64_t*)0x20000180 = 0x200002c0);
    NONFAILING(*(uint32_t*)0x200002c0 = 0x34);
    NONFAILING(*(uint16_t*)0x200002c4 = 0x2c);
    NONFAILING(*(uint16_t*)0x200002c6 = 0xd27);
    NONFAILING(*(uint32_t*)0x200002c8 = 0);
    NONFAILING(*(uint32_t*)0x200002cc = 0);
    ...
    NONFAILING(*(uint16_t*)0x200002e6 = 1);
    NONFAILING(memcpy((void*)0x200002e8, "route\000", 6));
    NONFAILING(*(uint16_t*)0x200002f0 = 4);
    NONFAILING(*(uint16_t*)0x200002f2 = 2);
    NONFAILING(*(uint64_t*)0x20000188 = 0x34);
    NONFAILING(*(uint64_t*)0x20000298 = 1);
    NONFAILING(*(uint64_t*)0x200002a0 = 0);
