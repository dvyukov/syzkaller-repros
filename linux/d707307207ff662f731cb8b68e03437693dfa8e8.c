...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    res = syscall(__NR_fanotify_init, 0, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 3:
    syscall(__NR_fanotify_mark, r[1], 0x105, 0x4000000a, r[0], 0);
    break;
  case 4:
    memcpy((void*)0x20000080, "./file0\000", 8);
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000080, 0, 0);
    ...
    break;
  case 5:
    res = syscall(__NR_fanotify_init, 0x8000000000260, 0x1800);
    if (res != -1)
      r[3] = res;
    break;
  case 6:
    syscall(__NR_fanotify_mark, r[3], 0x105, 0x4000000a, r[2], 0);
    break;
  }
}
int main(void)
