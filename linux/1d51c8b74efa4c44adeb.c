...
// https://syzkaller.appspot.com/bug?id=1d51c8b74efa4c44adeb
// status:6
...
void execute_call(int call)
{
  ...
  case 7:
    *(uint32_t*)0x20000140 = 0x14;
    res = syscall(__NR_getsockname, r[6], 0x200000c0ul, 0x20000140ul);
    if (res != -1)
  ...
  case 10:
    *(uint32_t*)0x20000140 = 0x14;
    res = syscall(__NR_getsockname, r[9], 0x200000c0ul, 0x20000140ul);
    if (res != -1)
      r[10] = *(uint32_t*)0x200000c4;
    break;
  case 11:
    *(uint64_t*)0x20000040 = 0;
    *(uint32_t*)0x20000048 = 0x227fd;
    *(uint64_t*)0x20000050 = 0x20000400;
    *(uint64_t*)0x20000400 = 0x20000080;
    ...
    *(uint32_t*)0x200000b4 = r[7];
    *(uint16_t*)0x200000b8 = 8;
    *(uint16_t*)0x200000ba = 1;
    *(uint32_t*)0x200000bc = r[10];
    *(uint64_t*)0x20000408 = 0x40;
  ...
  case 12:
    ...
    *(uint32_t*)0x20000034 = r[3];
    *(uint16_t*)0x20000038 = 8;
    *(uint16_t*)0x2000003a = 2;
    *(uint32_t*)0x2000003c = r[10];
    *(uint64_t*)0x20000408 = 0x40;
    *(uint64_t*)0x20000058 = 1;
    *(uint64_t*)0x20000060 = 0;
    *(uint64_t*)0x20000068 = 0;
    *(uint32_t*)0x20000070 = 0x4008001;
