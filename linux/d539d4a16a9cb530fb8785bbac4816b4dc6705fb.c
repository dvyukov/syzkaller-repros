...
void execute_call(int call)
{
  ...
  case 2:
    ...
    sprintf((char*)0x20000043, "0x%016llx", (long long)r[0]);
    memcpy((void*)0x20000055, ",rootmode=00000000000000000040000,user_id=", 42);
    sprintf((char*)0x2000007f, "%020llu", (long long)0);
    memcpy((void*)0x20000093, ",group_id=", 10);
    sprintf((char*)0x2000009d, "%020llu", (long long)0);
    syscall(__NR_mount, 0, 0x20000200, 0x20000240, 0, 0x20000040);
    break;
  case 3:
    syscall(__NR_preadv, r[0], 0, 0, 0);
    break;
  case 4:
  ...
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_clone, 0x1000109, 0, 0x9999999999999999, 0, -1);
    break;
  case 7:
    memcpy((void*)0x20000100, "./file0\000", 8);
    memcpy((void*)0x20000140, "./file0\000", 8);
    syscall(__NR_pivot_root, 0x20000100, 0x20000140);
    break;
  }
}
int main(void)
