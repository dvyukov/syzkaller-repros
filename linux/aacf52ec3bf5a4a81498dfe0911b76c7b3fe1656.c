...
// https://syzkaller.appspot.com/bug?id=aacf52ec3bf5a4a81498dfe0911b76c7b3fe1656
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20046ffa, "./bus", 6));
    syscall(__NR_mkdir, 0x20046ffa, 0);
    break;
  case 2:
    NONFAILING(memcpy((void*)0x2003d000, "./bus", 6));
    NONFAILING(memcpy((void*)0x20043ffa, "./bus", 6));
    NONFAILING(memcpy((void*)0x2002cffa, "ramfs", 6));
    syscall(__NR_mount, 0x2003d000, 0x20043ffa, 0x2002cffa, 0, 0x20043000);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x204edffa, "./bus", 6));
    syscall(__NR_chroot, 0x204edffa);
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20a42ff1, "/dev/sequencer", 15));
    syscall(__NR_openat, 0xffffff9c, 0x20a42ff1, 0x228040, 0);
    break;
  case 5:
    NONFAILING(memcpy((void*)0x209fa000, "./bus", 6));
    syscall(__NR_umount2, 0x209fa000, 2);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20b3d000, "./bus", 6));
    NONFAILING(memcpy((void*)0x20049ffa, "./bus", 6));
    syscall(__NR_pivot_root, 0x20b3d000, 0x20049ffa);
    break;
  }
}
