...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000340, "./file0", 8));
    syscall(__NR_mkdir, 0x20000340, 0);
    break;
  case 1:
    NONFAILING(memcpy((void*)0x200000c0, "./file0//ile0", 14));
    NONFAILING(memcpy((void*)0x20000080, "./file0", 8));
    NONFAILING(memcpy((void*)0x20000200, "cgroup2", 8));
    syscall(__NR_mount, 0x200000c0, 0x20000080, 0x20000200, 0, 0);
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000040, "./file0//ile0", 14));
    res = syscall(__NR_open, 0x20000040, 0, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 3:
    NONFAILING(memcpy((void*)0x200001c0, "cgroup.procs", 13));
    res = syscall(__NR_openat, r[0], 0x200001c0, 2, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 4:
    NONFAILING(sprintf((char*)0x20000100, "0x%016llx", (long long)0));
    syscall(__NR_write, r[1], 0x20000100, 0x12);
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20000280, "xfs", 4));
    NONFAILING(memcpy((void*)0x200002c0, "./file0//ile0", 14));
    NONFAILING(*(uint8_t*)0x20000800 = 0);
    syz_mount_image(0x20000280, 0x200002c0, 0, 0, 0x20000740, 0, 0x20000800);
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x20000240 = 0xc);
    syscall(__NR_getsockopt, r[0], 1, 0x11, 0x20000180, 0x20000240);
    break;
  case 7:
    NONFAILING(memcpy((void*)0x20000040, "./file0//ile0", 14));
    res = syscall(__NR_open, 0x20000040, 0, 0);
  ...
  case 8:
    ...
    NONFAILING(*(uint32_t*)0x20000284 = 0xfffffffe);
    NONFAILING(*(uint64_t*)0x20000288 = 7);
    NONFAILING(*(uint64_t*)0x20000290 = 0x401);
    NONFAILING(*(uint64_t*)0x20000298 = 7);
    NONFAILING(*(uint64_t*)0x200002a0 = 0x7d);
    NONFAILING(*(uint64_t*)0x200002a8 = 0x1c);
    NONFAILING(*(uint64_t*)0x200002b0 = 0xd8);
    NONFAILING(*(uint32_t*)0x200002b8 = 0xb7);
    NONFAILING(*(uint32_t*)0x200002bc = 2);
    NONFAILING(*(uint32_t*)0x200002c0 = 3);
    ...
    syscall(__NR_write, r[2], 0x20000280, 0x60);
    break;
  case 9:
    NONFAILING(memcpy((void*)0x200001c0, "memory.max", 11));
    res = syscall(__NR_openat, r[2], 0x200001c0, 2, 0);
    if (res != -1)
      r[3] = res;
    break;
  case 10:
    NONFAILING(sprintf((char*)0x200000c0, "0x%016llx", (long long)0));
    syscall(__NR_write, r[3], 0x200000c0, 0x12);
    break;
  }
}
int main()
