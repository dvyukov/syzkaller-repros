...
// https://syzkaller.appspot.com/bug?id=fa0abe20d13faf06353d
// status:6
...
void execute_call(int call)
{
  switch (call) {
  case 0:
    NONFAILING(*(uint8_t*)0x20000500 = 0x12);
    NONFAILING(*(uint8_t*)0x20000501 = 1);
    NONFAILING(*(uint16_t*)0x20000502 = 0x200);
    NONFAILING(*(uint8_t*)0x20000504 = 0x1f);
    NONFAILING(*(uint8_t*)0x20000505 = 0xd0);
    NONFAILING(*(uint8_t*)0x20000506 = 0x61);
    NONFAILING(*(uint8_t*)0x20000507 = 0x10);
    NONFAILING(*(uint16_t*)0x20000508 = 0x1d50);
    NONFAILING(*(uint16_t*)0x2000050a = 0x60c6);
    NONFAILING(*(uint16_t*)0x2000050c = 0x67c7);
    NONFAILING(*(uint8_t*)0x2000050e = 0);
    NONFAILING(*(uint8_t*)0x2000050f = 0);
    NONFAILING(*(uint8_t*)0x20000510 = 0);
    NONFAILING(*(uint8_t*)0x20000511 = 1);
    NONFAILING(*(uint8_t*)0x20000512 = 9);
    NONFAILING(*(uint8_t*)0x20000513 = 2);
    NONFAILING(*(uint16_t*)0x20000514 = 0x24);
    NONFAILING(*(uint8_t*)0x20000516 = 1);
    ...
    NONFAILING(*(uint8_t*)0x2000051b = 9);
    NONFAILING(*(uint8_t*)0x2000051c = 4);
    NONFAILING(*(uint8_t*)0x2000051d = 0x30);
    NONFAILING(*(uint8_t*)0x2000051e = 0);
    NONFAILING(*(uint8_t*)0x2000051f = 2);
    NONFAILING(*(uint8_t*)0x20000520 = 0xf5);
    NONFAILING(*(uint8_t*)0x20000521 = 0x1d);
    NONFAILING(*(uint8_t*)0x20000522 = 0x3c);
    NONFAILING(*(uint8_t*)0x20000523 = 0);
    NONFAILING(*(uint8_t*)0x20000524 = 9);
    NONFAILING(*(uint8_t*)0x20000525 = 5);
    NONFAILING(*(uint8_t*)0x20000526 = 0xb);
    NONFAILING(*(uint8_t*)0x20000527 = 0xa);
    NONFAILING(*(uint16_t*)0x20000528 = 0x20);
    NONFAILING(*(uint8_t*)0x2000052a = 0);
    NONFAILING(*(uint8_t*)0x2000052b = 0xfc);
    NONFAILING(*(uint8_t*)0x2000052c = 0);
    NONFAILING(*(uint8_t*)0x2000052d = 9);
    NONFAILING(*(uint8_t*)0x2000052e = 5);
    NONFAILING(*(uint8_t*)0x2000052f = 0x81);
    NONFAILING(*(uint8_t*)0x20000530 = 2);
    NONFAILING(*(uint16_t*)0x20000531 = 0x20);
    NONFAILING(*(uint8_t*)0x20000533 = 0);
    NONFAILING(*(uint8_t*)0x20000534 = 0);
    NONFAILING(*(uint8_t*)0x20000535 = 0);
    NONFAILING(syz_usb_connect(0, 0x36, 0x20000500, 0));
    break;
  }
}
int main(void)
