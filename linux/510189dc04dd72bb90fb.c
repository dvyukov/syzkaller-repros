...
// https://syzkaller.appspot.com/bug?id=510189dc04dd72bb90fb
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(*(uint32_t*)0x20000000 = htobe32(0xe0000001));
    NONFAILING(*(uint32_t*)0x20000004 = htobe32(0xe0000001));
    NONFAILING(*(uint32_t*)0x20000008 = htobe32(-1));
    syscall(__NR_setsockopt, -1, 0, 0, 0x20000000ul, 0xcul);
    break;
  case 1:
    res = syscall(__NR_pipe, 0x200002c0ul);
    if (res != -1) {
      NONFAILING(r[0] = *(uint32_t*)0x200002c0);
      NONFAILING(r[1] = *(uint32_t*)0x200002c4);
    }
    break;
  case 2:
  ...
  case 4:
    ...
    break;
  case 5:
    NONFAILING(memcpy((void*)0x200001c0, "\xa2\xe6\x99\x9b", 4));
  ...
  case 6:
    ...
    break;
  case 7:
    NONFAILING(memcpy((void*)0x20000000, "\x38\x03", 2));
