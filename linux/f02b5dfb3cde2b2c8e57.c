...
// https://syzkaller.appspot.com/bug?id=f02b5dfb3cde2b2c8e57
// status:6
...
void execute_call(int call)
{
  ...
  case 5:
    ...
    *(uint32_t*)0x20000128 = htobe32(0x7f000001);
    *(uint32_t*)0x20000138 = htobe32(0x10000);
    ...
    *(uint32_t*)0x20000160 = 0xfffffffe;
