...
int main(void)
{
  ...
  *(uint8_t*)0x20000604 = 0xc9;
  *(uint8_t*)0x20000605 = 0xf;
  *(uint8_t*)0x20000606 = 0x13;
  *(uint8_t*)0x20000607 = 8;
  *(uint16_t*)0x20000608 = 0xccd;
  *(uint16_t*)0x2000060a = 0x39;
  *(uint16_t*)0x2000060c = 0xd3c;
  ...
  *(uint16_t*)0x20000614 = 0x12;
  *(uint8_t*)0x20000616 = 1;
  *(uint8_t*)0x20000617 = 0;
  *(uint8_t*)0x20000618 = 0;
  *(uint8_t*)0x20000619 = 0x40;
  *(uint8_t*)0x2000061a = 0;
  *(uint8_t*)0x2000061b = 9;
  *(uint8_t*)0x2000061c = 4;
  *(uint8_t*)0x2000061d = 0xf6;
  *(uint8_t*)0x2000061e = 0;
  *(uint8_t*)0x2000061f = 0;
  *(uint8_t*)0x20000620 = 0xbb;
  *(uint8_t*)0x20000621 = 0xfa;
  *(uint8_t*)0x20000622 = 0xec;
  *(uint8_t*)0x20000623 = 0;
  syz_usb_connect(0x400000000006, 0x24, 0x20000600, 0);
  return 0;
}
