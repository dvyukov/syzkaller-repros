...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint32_t*)0x20000184 = 0xfffffea6);
    NONFAILING(*(uint8_t*)0x20000188 = 0xe5);
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200001a8, 2, 4, 1));
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200001a8, 3, 8, 1));
    ...
    NONFAILING(
        STORE_BY_BITMASK(uint64_t, 0x200001a8, 0xfffffffffffffffe, 21, 1));
    ...
    NONFAILING(*(uint64_t*)0x200001d0 = 5);
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20001440, "/dev/vsock", 11));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20001440, 0xe000, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 2:
    syscall(__NR_ioctl, r[1], 0x5429, 0x20001480);
    break;
  case 3:
    syscall(__NR_semget, 0, 0x4007, 0);
    break;
  case 4:
    syscall(__NR_ioctl, r[0], 0x2282, 0x200014c0);
    break;
  case 5:
    NONFAILING(*(uint32_t*)0x20000140 = 0x80);
    syscall(__NR_accept4, r[0], 0x200012c0, 0x20000140, 0x80000);
    break;
  case 6:
    NONFAILING(*(uint16_t*)0x20001340 = 0x71ab);
    syscall(__NR_setsockopt, r[1], 0x112, 0xb, 0x20001340, 2);
    break;
  }
}
int main(void)
