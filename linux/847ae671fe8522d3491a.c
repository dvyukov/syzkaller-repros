...
// https://syzkaller.appspot.com/bug?id=847ae671fe8522d3491a
// status:6
...
void loop(void)
{
  ...
  NONFAILING(memcpy((void*)0x200002c0, "nl80211\000", 8));
  res = -1;
  NONFAILING(res = syz_genetlink_get_family_id(0x200002c0));
  if (res != -1)
    r[2] = res;
  ...
  NONFAILING(*(uint16_t*)0x20000184 = r[2]);
  NONFAILING(*(uint16_t*)0x20000186 = 0x801);
  NONFAILING(*(uint32_t*)0x20000188 = 0);
  NONFAILING(*(uint32_t*)0x2000018c = 0);
  NONFAILING(*(uint8_t*)0x20000190 = 0xc);
  ...
  NONFAILING(*(uint32_t*)0x20000198 = r[1]);
  NONFAILING(*(uint16_t*)0x2000019c = 0xa);
  NONFAILING(*(uint16_t*)0x2000019e = 6);
  NONFAILING(*(uint8_t*)0x200001a0 = 8);
  NONFAILING(*(uint8_t*)0x200001a1 = 2);
  NONFAILING(*(uint8_t*)0x200001a2 = 0x11);
  NONFAILING(*(uint8_t*)0x200001a3 = 0);
  NONFAILING(*(uint8_t*)0x200001a4 = 0);
  NONFAILING(*(uint8_t*)0x200001a5 = 1);
