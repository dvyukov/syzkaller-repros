...
// https://syzkaller.appspot.com/bug?id=788d546d9c28a63d40069ab8adeff309941945dd
// status:fixed
...
void execute_one(void)
{
  ...
  *(uint16_t*)0x20000016 = 2;
  memcpy((void*)0x20000018, "wireguard0\000\000\000\000\000\000", 16);
  *(uint16_t*)0x20000028 = 8;
  *(uint16_t*)0x2000002a = 5;
  *(uint32_t*)0x2000002c = 1;
  *(uint16_t*)0x20000030 = 0x68;
  STORE_BY_BITMASK(uint16_t, , 0x20000032, 8, 0, 14);
  STORE_BY_BITMASK(uint16_t, , 0x20000033, 0, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x20000033, 1, 7, 1);
  *(uint16_t*)0x20000034 = 0x64;
  STORE_BY_BITMASK(uint16_t, , 0x20000036, 0, 0, 14);
  ...
  *(uint8_t*)0x2000003c = 0xcc;
  *(uint8_t*)0x2000003d = 0xcc;
  *(uint8_t*)0x2000003e = 0xcc;
  *(uint8_t*)0x2000003f = 0xcc;
  *(uint8_t*)0x20000040 = 0xcc;
  ...
  *(uint8_t*)0x20000047 = 0xcc;
  *(uint8_t*)0x20000048 = 0xcc;
  *(uint8_t*)0x20000049 = 0xcc;
  *(uint8_t*)0x2000004a = 0xcc;
  *(uint8_t*)0x2000004b = 0xcc;
  *(uint8_t*)0x2000004c = 0xcc;
  *(uint8_t*)0x2000004d = 0xcc;
  *(uint8_t*)0x2000004e = 0xcc;
  *(uint8_t*)0x2000004f = 0xcc;
  *(uint8_t*)0x20000050 = 0xcc;
  *(uint8_t*)0x20000051 = 0xcc;
  *(uint8_t*)0x20000052 = 0xcc;
  *(uint8_t*)0x20000053 = 0xcc;
  *(uint8_t*)0x20000054 = 0xcc;
  *(uint8_t*)0x20000055 = 0xcc;
  *(uint8_t*)0x20000056 = 0xcc;
  *(uint8_t*)0x20000057 = 0xcc;
  *(uint8_t*)0x20000058 = 0xcc;
  *(uint8_t*)0x20000059 = 0xcc;
  *(uint8_t*)0x2000005a = 0xcc;
  *(uint8_t*)0x2000005b = 0xcc;
  *(uint16_t*)0x2000005c = 0x3c;
  ...
  *(uint16_t*)0x20000060 = 0x1c;
  STORE_BY_BITMASK(uint16_t, , 0x20000062, 0, 0, 14);
  ...
  *(uint8_t*)0x20000078 = 0xb;
  *(uint16_t*)0x2000007c = 0x1c;
  STORE_BY_BITMASK(uint16_t, , 0x2000007e, 0, 0, 14);
