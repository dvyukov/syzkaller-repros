...
// https://syzkaller.appspot.com/bug?id=e9aa33ddeb22edc68920f5848d7c6f64a748118f
// status:fixed
...
int main(void)
{
  ...
  *(uint8_t*)0x2000005d = 0x92;
  *(uint8_t*)0x2000005e = 0;
  *(uint8_t*)0x2000005f = 0;
  *(uint8_t*)0x20000060 = 0xf3;
  *(uint8_t*)0x20000061 = 0xd;
  *(uint8_t*)0x20000062 = 0xa6;
  ...
  *(uint32_t*)0x20000640 = 0x54;
  *(uint64_t*)0x20000644 = 0x20000300;
  ...
  *(uint64_t*)0x2000068c = 0;
  syz_usb_control_io(r[0], 0x200002c0, 0x20000640);
  return 0;
}
