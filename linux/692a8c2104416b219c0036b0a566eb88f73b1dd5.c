...
// https://syzkaller.appspot.com/bug?id=692a8c2104416b219c0036b0a566eb88f73b1dd5
// status:fixed
...
void loop()
{
  ...
  *(uint32_t*)0x2000000c = 0xffffff22;
  ...
  *(uint8_t*)0x2000002b = 0;
  r[0] = syscall(__NR_bpf, 0, 0x20000000, 0x2c);
  *(uint32_t*)0x20eed000 = r[0];
  *(uint64_t*)0x20eed008 = 0x204e5000;
  *(uint64_t*)0x20eed010 = 0x20914000;
  memcpy((void*)0x204e5000, "\x49\xa9\x60\xb6\xca\x79\x1e\x19", 8);
  syscall(__NR_bpf, 1, 0x20eed000, 0x18);
}
