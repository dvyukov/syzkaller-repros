...
// https://syzkaller.appspot.com/bug?id=de957f291723d26aedc2b5b4b9c898ad929dcd12
// status:open
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[0] = res;
  NONFAILING(*(uint16_t*)0x20000400 = 0);
  NONFAILING(*(uint16_t*)0x20000402 = 0);
  NONFAILING(*(uint16_t*)0x20000404 = 0);
  NONFAILING(*(uint16_t*)0x20000406 = 0);
  NONFAILING(memcpy((void*)0x20000408,
                    "syz0\000\000\377\377\377\377\000\000\000\000\000\000@"
