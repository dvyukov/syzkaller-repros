...
// https://syzkaller.appspot.com/bug?id=ef4b654b49ed7ff049bf
// status:6
...
uint64_t r[7] = {0xffffffffffffffff, 0x0, 0x0, 0x0,
...
int main(void)
{
  ...
  *(uint32_t*)0x200000f4 = 0;
  res = -1;
  res = syz_io_uring_setup(0x7e5a, 0x20000080, 0x20ffa000, 0x20ffb000,
                           0x20000180, 0x20000040);
  if (res != -1)
  ...
  *(uint8_t*)0x2000013f = 0;
  syz_io_uring_submit(r[1], r[3], 0x20000100, 0);
  *(uint8_t*)0x20000100 = 0x15;
  ...
  *(uint32_t*)0x200000f4 = 0;
  ...
  if (res != -1) {
    r[4] = res;
    r[5] = *(uint64_t*)0x20000180;
    r[6] = *(uint64_t*)0x20000040;
  }
  *(uint8_t*)0x20000100 = 0xb;
  *(uint8_t*)0x20000101 = 3;
  *(uint16_t*)0x20000102 = 0;
  ...
  *(uint8_t*)0x2000013e = 0;
  *(uint8_t*)0x2000013f = 0;
  syz_io_uring_submit(r[5], r[6], 0x20000100, 0);
  syscall(__NR_io_uring_enter, r[4], 0x450c, 0, 0ul, 0ul, 0ul);
  return 0;
}
