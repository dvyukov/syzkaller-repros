...
{
  memset(r, -1, sizeof(r));
  syscall(__NR_mmap, 0x20000000, 0xb3f000, 3, 0x32, -1, 0);
  r[0] = syscall(__NR_socket, 2, 2, 0);
  syscall(__NR_setsockopt, r[0], 0, 0x30, 0x20000000, 0);
  r[1] = syscall(__NR_socket, 2, 3, 3);
  ...
  *(uint64_t*)0x20001038 = 0;
  syscall(__NR_setsockopt, r[1], 0, 0x40, 0x20002d08, 0x2f8);
}
