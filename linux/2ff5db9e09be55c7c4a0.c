...
// https://syzkaller.appspot.com/bug?id=2ff5db9e09be55c7c4a0
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint64_t*)0x2001d038 = 0x20000040);
  ...
  case 3:
    ...
    NONFAILING(*(uint32_t*)0x20000344 = htobe32(0xe0000001));
    syscall(__NR_connect, r[0], 0x20000340ul, 0x10ul);
    break;
  case 4:
    syscall(__NR_sendmmsg, r[0], 0x20007fc0ul, 0x400000000000010ul, 0x2000ul);
    break;
  case 5:
    NONFAILING(syz_80211_inject_frame(0, 0, 0x37e));
    break;
  }
}
int main(void)
