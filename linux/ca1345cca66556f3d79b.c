...
// https://syzkaller.appspot.com/bug?id=ca1345cca66556f3d79b
// status:0
...
void loop(void)
{
  ...
  *(uint32_t*)0x20000094 = 0;
  memcpy((void*)0x20000098, "pcrypt(generic-gcm-aesni)"
  ...
  *(uint32_t*)0x20000058 = 0;
  syscall(__NR_bind, r[2], 0x20000040ul, 0x1cul);
  ...
  *(uint32_t*)0x20000298 = 0;
  syscall(__NR_sendto, r[1], 0ul, 0x16ul, 0x20000004ul, 0x20000280ul, 0x1cul);
  memcpy((void*)0x20000080, "tls\000", 4);
  syscall(__NR_setsockopt, r[1], 6, 0x1f, 0x20000080ul, 0x152ul);
  *(uint16_t*)0x200000c0 = 0x303;
  *(uint16_t*)0x200000c2 = 0x34;
  memcpy((void*)0x200000c4, "\x66\xda\xd6\xd0\x8a\x5f\x9e\x3c", 8);
  memcpy((void*)0x200000cc, "\xe9\xce\x54\x75\x80\x56\x00\x00\x00\x00\x00\x00"
                            "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                            "\x00\x00\x00\x00\x00\x00\x00\x00",
         32);
  memcpy((void*)0x200000ec, "\x00\xfe\xff\x00", 4);
  memcpy((void*)0x200000f0, "\000\000\000\000\000\000\000\000", 8);
  syscall(__NR_setsockopt, r[1], 0x11a, 1, 0x200000c0ul, 0x38ul);
  syscall(__NR_sendto, r[1], 0x200005c0ul, 0xe0fffffful, 0ul, 0ul, 0xd8ul);
  close_fds();
}
int main(void)
{
