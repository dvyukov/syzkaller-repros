...
// https://syzkaller.appspot.com/bug?id=e998d854a38412d9d484c1f6e827ddda9472d56d
// status:invalid
...
void execute_one(void)
{
  ...
  res = syscall(__NR_io_uring_setup, 0xd, 0x20000000ul);
  if (res != -1)
    r[0] = res;
  ...
  syscall(__NR_io_uring_register, r[0], 2ul, 0x20000180ul, 1ul);
  NONFAILING(*(uint32_t*)0x20000140 = 0);
  NONFAILING(*(uint64_t*)0x20000148 = 0x20000100);
  NONFAILING(*(uint32_t*)0x20000100 = -1);
  syscall(__NR_io_uring_register, r[0], 6ul, 0x20000140ul, 1ul);
}
int main(void)
{
