...
// https://syzkaller.appspot.com/bug?id=13fd939a0d36ec4d046fa989e1e11caf2c8898d1
// status:open
...
void execute_one(void)
{
  ...
  res = syscall(__NR_openat, 0xffffffffffffff9c, 0x200000c0, 0x101001, 0);
  if (res != -1)
    r[0] = res;
  ...
  NONFAILING(*(uint8_t*)0x203b9fec = 1);
