...
// https://syzkaller.appspot.com/bug?id=d062e7b7d76a11f049bb
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    NONFAILING(
        memcpy((void*)0x20000000,
               "\x12\x01\x07\x00\x00\x00\x00\x40\x25\x05\xa1\xa4\x40\x00\x00"
               "\x00\x01\x01\x09\x02\x3b\x00\x01\x01\x00\x00\x00\x09\x04\x00"
               "\x00\x02\x02\x06\x00\x00\x05\x24\x06\x00\x00\x05\x24\x00\x00"
               "\x00\x0d\x24\x0f\x01\x00\x00\x00\x00\x1f\x00\x00\x00\x00\x09"
               "\x05\x82\x02\x00\x02\x00\x00\x00\x09\x05\x03\x02\x00\x02",
               74));
    res = -1;
    NONFAILING(res = syz_usb_connect(0, 0x4d, 0x20000000, 0));
    if (res != -1)
      r[0] = res;
    break;
  case 1:
  ...
  case 4:
    NONFAILING(memcpy(
        (void*)0x200000c0,
        "\xa3\x40\xc3\x43\x05\xc7\x3b\x34\x60\x17\xd9\x06\xe1\x8f\xac\x74\x7c"
        "\x9e\xf5\x22\x0c\xfe\xa3\x90\x39\xb2\x98\x39\x04\x01\xa3",
        31));
    NONFAILING(syz_usb_ep_write(r[0], 0x82, 0x1f, 0x200000c0));
    break;
  }
}
int main(void)
