// memory leak in nf_hook_entries_grow (2)
// https://syzkaller.appspot.com/bug?id=050de9f900eb45b94ef9
// status:3
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    memcpy((void*)0x200000c0, "cpuacct.stat\000", 13);
  ...
  case 2:
    ...
    *(uint64_t*)0x20000050 = 0x248000009;
    ...
    *(uint64_t*)0x200000b8 = 0;
    ...
    break;
  case 3:
    *(uint64_t*)0x20000040 = 0x20004;
    syscall(__NR_ioctl, r[0], 0x4030582a, 0x20000040ul);
    break;
  case 4:
    syscall(__NR_mmap, 0x20000000ul, 0x800000ul, 0x3800004ul, 0x12ul, -1, 0ul);
    break;
  }
}
int main(void)
