...
// https://syzkaller.appspot.com/bug?id=7c2040d10ec37c803235830730636be5231076b5
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint64_t*)0x20000290 = 0x7f);
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 8, 25, 1));
    ...
    syscall(__NR_perf_event_open, 0x20000280, 0, 0, -1, 0);
    break;
  case 1:
  ...
  case 5:
    ...
    NONFAILING(*(uint8_t*)0x20000088 = -1);
  ...
  case 6:
    ...
    NONFAILING(*(uint32_t*)0x2000004a = r[0]);
    ...
    syscall(__NR_connect, r[1], 0x20000040, 0x2e);
    break;
  case 7:
    syscall(__NR_sendmmsg, r[1], 0x20005fc0, 0x800000000000059, 0);
    break;
  case 8:
    ...
    break;
  case 9:
    syscall(__NR_getpeername, r[2], 0x200000c0, 0);
    break;
  }
}
int main(void)
