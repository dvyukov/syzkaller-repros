// WARNING in kvm_mmu_uninit_tdp_mmu (2)
// https://syzkaller.appspot.com/bug?id=a8ad3ee1525a0c4b40ec
// status:0
...
int main(void)
{
  ...
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x20000040, "blkio.bfq.idle_time\000", 20);
  res = syscall(__NR_openat, 0xffffff9c, 0x20000040ul, 0x275aul, 0ul);
  if (res != -1)
    r[2] = res;
  syscall(__NR_write, r[2], 0x20000180ul, 0x208e24bul);
  syscall(__NR_mmap, 0x20000000ul, 0xb36000ul, 2ul, 0x28011ul, r[2], 0ul);
  *(uint64_t*)0x200015c0 = 0x20000080;
  *(uint64_t*)0x200015c8 = 0xffffff23;
  syscall(__NR_preadv, r[2], 0x200015c0ul, 1ul, 0, 0);
  ...
  *(uint64_t*)0x20000150 = 0;
  syz_kvm_setup_cpu(-1, r[3], 0x20000000, 0x20000140, 1, 0x44, 0, 0);
  memcpy((void*)0x20000100, "smaps_rollup\000", 13);
  syz_open_procfs(-1, 0x20000100);
