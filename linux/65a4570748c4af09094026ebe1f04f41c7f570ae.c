...
// https://syzkaller.appspot.com/bug?id=65a4570748c4af09094026ebe1f04f41c7f570ae
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    memcpy((void*)0x20000080,
           "\x73\x74\x61\x74\x09\xc0\xd2\xfe\xbc\xf9\xdf\x2d\xea\xc8\xc1\x77"
  ...
  case 3:
    ...
    break;
  case 4:
    syscall(__NR_ioctl, r[1], 0x660c);
    break;
  case 5:
    syscall(__NR_ioctl, r[1], 0x6611);
    break;
  case 6:
    syscall(__NR_fallocate, r[2], 0x20, 0x7f, 6);
    break;
  case 7:
