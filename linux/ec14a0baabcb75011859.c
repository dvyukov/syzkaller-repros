...
// https://syzkaller.appspot.com/bug?id=ec14a0baabcb75011859
// status:6
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000200 = 0x20010000;
  memcpy((void*)0x20010000,
         ...
         "\x00\x00\x00\x00\x00\x00\x00\x00\x01\x11\x00\x00\x00\x00\x00\x00\x0b"
  ...
  *(uint64_t*)0x20000248 = 0x20010400;
  memcpy((void*)0x20010400, "\x03\x00\x00\x00\x13\x00\x00\x00\x23\x00", 10);
  *(uint64_t*)0x20000250 = 0xa;
  ...
  *(uint8_t*)0x20013800 = 0;
  syz_mount_image(0x20000000, 0x20000100, 0x40000, 0xc, 0x20000200, 0,
                  0x20013800);
}
int main(void)
{
