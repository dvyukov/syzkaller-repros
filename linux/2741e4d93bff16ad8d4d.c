...
// https://syzkaller.appspot.com/bug?id=2741e4d93bff16ad8d4d
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint32_t*)0x20000034 = 0x2000000);
  ...
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_ioctl, -1, 0x4601, 0ul);
    break;
  }
}
int main(void)
