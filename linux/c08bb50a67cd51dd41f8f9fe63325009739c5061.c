...
// https://syzkaller.appspot.com/bug?id=c08bb50a67cd51dd41f8f9fe63325009739c5061
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    *(uint32_t*)0x20000300 = 0x80;
    syscall(__NR_setsockopt, (intptr_t)r[0], 6, 2, 0x20000300, 4);
    break;
  case 2:
    *(uint16_t*)0x20000180 = 2;
    *(uint16_t*)0x20000182 = htobe16(0x4e23);
    *(uint32_t*)0x20000184 = htobe32(0xe0000001);
    syscall(__NR_bind, (intptr_t)r[0], 0x20000180, 0x10);
    break;
  case 3:
    ...
    *(uint8_t*)0x20e68007 = 0xaa;
    syscall(__NR_sendto, (intptr_t)r[0], 0, 0, 0x200007fd, 0x20e68000, 0x10);
    break;
  case 4:
    *(uint32_t*)0x20000000 = 0;
    syscall(__NR_setsockopt, (intptr_t)r[0], 1, 8, 0x20000000, 4);
    break;
  case 5:
    *(uint32_t*)0x20000100 = -1;
    *(uint16_t*)0x20000104 = 0;
    syscall(__NR_write, (intptr_t)r[0], 0x20000100, 0xff5a);
    break;
  case 6:
    *(uint32_t*)0x200000c0 = 0;
    *(uint32_t*)0x200000c4 = 0;
    *(uint32_t*)0x200000c8 = 0x200015c0;
    *(uint32_t*)0x200015c0 = 0x20000400;
    *(uint32_t*)0x200015c4 = 0xf7e9;
    *(uint32_t*)0x200000cc = 1;
    *(uint32_t*)0x200000d0 = 0;
    *(uint32_t*)0x200000d4 = 0xaaa4756f;
    *(uint32_t*)0x200000d8 = 0;
    syscall(__NR_recvmsg, (intptr_t)r[0], 0x200000c0, 0x100);
    break;
  case 7:
    ...
    break;
  case 8:
    syscall(__NR_fsetxattr, (intptr_t)r[1], 0, 0, 0, 1);
    break;
  case 9:
    syscall(__NR_splice, (intptr_t)r[0], 0, (intptr_t)r[1], 0, 0x80000000, 0);
    break;
  }
}
int main(void)
