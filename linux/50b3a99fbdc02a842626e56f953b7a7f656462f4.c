...
// https://syzkaller.appspot.com/bug?id=50b3a99fbdc02a842626e56f953b7a7f656462f4
// status:open
...
void loop(void)
{
  ...
  *(uint8_t*)0x2000003e = 0x80;
  *(uint8_t*)0x2000003f = 0;
  *(uint16_t*)0x20000040 = htobe16(0);
  ...
  *(uint16_t*)0x20000044 = htobe16(0);
  ...
  csum_inet_update(&csum_1, (const uint8_t*)0x2000003e, 8);
  *(uint16_t*)0x20000040 = csum_inet_digest(&csum_1);
  syz_emit_ethernet(0x46, 0x20000000, 0);
}
int main(void)
{
