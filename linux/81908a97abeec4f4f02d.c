...
// https://syzkaller.appspot.com/bug?id=81908a97abeec4f4f02d
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    *(uint16_t*)0x20000740 = 0x11;
    *(uint16_t*)0x20000742 = htobe16(0);
    *(uint32_t*)0x20000744 = 0;
    *(uint16_t*)0x20000748 = 1;
    *(uint8_t*)0x2000074a = 0;
    *(uint8_t*)0x2000074b = 6;
    *(uint8_t*)0x2000074c = 1;
    *(uint8_t*)0x2000074d = 0x80;
    *(uint8_t*)0x2000074e = 0xc2;
    *(uint8_t*)0x2000074f = 0;
    *(uint8_t*)0x20000750 = 0;
    *(uint8_t*)0x20000751 = 0;
    *(uint8_t*)0x20000752 = 0;
    *(uint8_t*)0x20000753 = 0;
    syscall(__NR_connect, r[0], 0x20000740ul, 0x80ul);
    break;
  case 2:
  ...
  case 3:
    ...
    *(uint32_t*)0x20000150 = 0;
    res = syscall(__NR_ioctl, r[0], 0x8933, 0x20000140ul);
    if (res != -1)
  ...
  case 4:
    ...
    *(uint32_t*)0x200003c4 = r[2];
    *(uint16_t*)0x200003c8 = 1;
    *(uint8_t*)0x200003ca = 0;
    *(uint8_t*)0x200003cb = 6;
    memcpy((void*)0x200003cc, "\x39\x58\x97\x3c\xda\xf2", 6);
    *(uint8_t*)0x200003d2 = 0;
    *(uint8_t*)0x200003d3 = 0;
    syscall(__NR_bind, r[1], 0x200003c0ul, 0x14ul);
    break;
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_recvfrom, r[0], 0x20000040ul, 0x32ul, 0ul, 0ul, 0ul);
    break;
  case 7:
  ...
  case 8:
    ...
    *(uint16_t*)0x20000300 = 0x1d;
    *(uint32_t*)0x20000304 = r[4];
    *(uint32_t*)0x20000308 = 0;
    *(uint32_t*)0x2000030c = 0x8000000;
    *(uint32_t*)0x20000008 = 0x10;
    *(uint64_t*)0x20000010 = 0x200002c0;
    *(uint64_t*)0x200002c0 = 0x20000400;
    memcpy((void*)0x20000400,
           "\x01\x00\x00\x00\x7f\xff\xff\xff\x02\x00\x00\x00\x00\x00\x00\x00",
           16);
    *(uint64_t*)0x20000410 = 0;
    *(uint64_t*)0x20000418 = r[3];
    *(uint64_t*)0x20000420 = 0;
    *(uint64_t*)0x20000428 = 0;
    memcpy((void*)0x20000430, "\x01\xd9\xae\x26\xb7", 5);
    *(uint64_t*)0x200002c8 = 0x4058;
