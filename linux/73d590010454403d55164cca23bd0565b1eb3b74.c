...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(*(uint64_t*)0x20003140 = 0x20001400);
    NONFAILING(*(uint32_t*)0x20003148 = 0x80);
    ...
    NONFAILING(*(uint32_t*)0x20003170 = 0);
    NONFAILING(*(uint32_t*)0x20003178 = 0);
    syscall(__NR_recvmmsg, -1, 0x20003140, 1, 0, 0);
    break;
  case 1:
    syscall(__NR_ioctl, -1, 0x890c, 0);
    break;
  case 2:
    syscall(__NR_sysinfo, 0);
    break;
  case 3:
  ...
  case 8:
    ...
    break;
  case 9:
    syz_open_dev(0, 0 + procid * 4, 2);
    break;
  case 10:
    syscall(__NR_ioctl, r[1], 0x40082404, 0);
    break;
  case 11:
    syscall(__NR_socket, 0x1f, 3, 4);
    break;
  case 12:
    syscall(__NR_ioctl, -1, 0xc0285628, 0);
    break;
  case 13:
    NONFAILING(memcpy((void*)0x20000180,
                      "ip6gre0\000\000\000t\374\223\002\000\000", 16));
    NONFAILING(*(uint16_t*)0x20000190 = 0);
    syscall(__NR_ioctl, r[0], 0x89f1, 0x20000180);
    break;
  case 14:
    NONFAILING(memcpy((void*)0x200000c0, "fd/3\000", 5));
