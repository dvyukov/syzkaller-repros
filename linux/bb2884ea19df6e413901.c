...
// https://syzkaller.appspot.com/bug?id=bb2884ea19df6e413901
// status:0
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x200002c0, "k", 1);
  syscall(__NR_setsockopt, r[1], 0, 8, 0x200002c0ul, 1ul);
  *(uint32_t*)0x20000080 = 7;
  res = syscall(__NR_getsockopt, r[1], 0, 8, 0x20000040ul, 0x20000080ul);
  if (res != -1)
  ...
  *(uint16_t*)0x20000336 = 3;
  *(uint32_t*)0x20000338 = 0x2c;
  ...
  *(uint16_t*)0x20000264 = 0xd;
  *(uint16_t*)0x20000266 = 1;
  memcpy((void*)0x20000268, "fq_codel\000", 9);
  *(uint16_t*)0x20000274 = 0x1c01;
  ...
  *(uint32_t*)0x20000830 = 0;
  syscall(__NR_sendmsg, r[5], 0x20000800ul, 0ul);
}
int main(void)
{
