...
// https://syzkaller.appspot.com/bug?id=b4a81dc8727e513f364d
// status:0
...
void loop(void)
{
  ...
  res = -1;
  NONFAILING(res = syz_io_uring_setup(0x85, 0x20000080, 0x20ffc000, 0x206d4000,
  ...
  NONFAILING(*(uint32_t*)0x20000204 = r[0]);
