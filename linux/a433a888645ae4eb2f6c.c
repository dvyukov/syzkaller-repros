...
// https://syzkaller.appspot.com/bug?id=a433a888645ae4eb2f6c
// status:6
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0ul, 0x400002ul, 0ul);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    syscall(__NR_ioctl, r[0], 0x40285107, 0);
    break;
  case 2:
    syscall(__NR_ioctl, r[0], 0x40085112, 0ul);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000080, "/dev/sequencer2\000", 16));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000080ul, 0ul, 0ul);
    if (res != -1)
      r[1] = res;
    break;
  case 4:
    syscall(__NR_ioctl, r[1], 0x40085112, 0ul);
    break;
  case 5:
    syscall(__NR_ioctl, r[1], 0x5100, 0);
    break;
  case 6:
    syscall(__NR_ioctl, r[1], 0x5100, 0);
    break;
