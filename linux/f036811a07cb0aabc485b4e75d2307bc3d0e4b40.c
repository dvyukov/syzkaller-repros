...
void execute_call(int call)
{
  ...
  case 4:
    ...
    break;
  case 5:
    NONFAILING(*(uint32_t*)0x20000080 = 0x18);
    NONFAILING(*(uint32_t*)0x20000084 = 0);
    NONFAILING(*(uint64_t*)0x20000088 = 0);
    NONFAILING(*(uint64_t*)0x20000090 = 0);
    syscall(__NR_write, r[2], 0x20000080, 0xfffffe47);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000000, "./file0\000", 8));
    NONFAILING(memcpy((void*)0x20000140, "9p\000", 3));
    NONFAILING(memcpy((void*)0x20000480, "trans=fd,", 9));
    NONFAILING(memcpy((void*)0x20000489, "rfdno", 5));
    NONFAILING(*(uint8_t*)0x2000048e = 0x3d);
    NONFAILING(sprintf((char*)0x2000048f, "0x%016llx", (long long)r[0]));
    NONFAILING(*(uint8_t*)0x200004a1 = 0x2c);
    NONFAILING(memcpy((void*)0x200004a2, "wfdno", 5));
    NONFAILING(*(uint8_t*)0x200004a7 = 0x3d);
    NONFAILING(sprintf((char*)0x200004a8, "0x%016llx", (long long)r[1]));
    NONFAILING(*(uint8_t*)0x200004ba = 0x2c);
    NONFAILING(*(uint8_t*)0x200004bb = 0);
    syscall(__NR_mount, 0, 0x20000000, 0x20000140, 0, 0x20000480);
    break;
  case 7:
    syscall(__NR_lsetxattr, 0, 0, 0, 0, 2);
    break;
  }
}
int main(void)
