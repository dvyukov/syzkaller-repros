...
// https://syzkaller.appspot.com/bug?id=ea48ca29949b1820e745
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    *(uint8_t*)0x200021b2 = 0;
    ...
    break;
  case 3:
    syscall(__NR_socketpair, 1ul, 3ul, 0, 0ul);
    break;
  case 4:
    syscall(__NR_dup, -1);
    break;
  case 5:
    res = syscall(__NR_read, r[0], 0x20004280ul, 0x2020ul);
    if (res != -1)
      r[1] = *(uint64_t*)0x20004288;
    break;
  case 6:
    *(uint32_t*)0x20000080 = 0x28;
    *(uint32_t*)0x20000084 = 0;
    *(uint64_t*)0x20000088 = r[1];
    *(uint64_t*)0x20000090 = 7;
    *(uint64_t*)0x20000098 = 0;
    *(uint32_t*)0x200000a0 = 0;
    *(uint32_t*)0x200000a4 = 0;
    syscall(__NR_write, r[0], 0x20000080ul, 0x28ul);
    break;
  case 7:
  ...
  case 9:
    ...
    syscall(__NR_stat, 0x200004c0ul, 0ul);
    break;
  case 10:
    memcpy((void*)0x20000000, "./file0\000", 8);
    syscall(__NR_mkdir, 0x20000000ul, 0x91ul);
    break;
  case 11:
