...
// https://syzkaller.appspot.com/bug?id=eccff039f7129ec4e46163781c8f2c2ab531413f
// status:fixed
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    break;
  case 4:
    res = syscall(__NR_socket, 0x1d, 2, 7);
    if (res != -1)
      r[3] = res;
    break;
  case 5:
  ...
  case 6:
    ...
    res = syscall(__NR_ioctl, r[4], 0x8933, 0x20001840);
    if (res != -1)
  ...
  case 7:
    ...
    syscall(__NR_bind, r[3], 0x20000240, 0x18);
    break;
  case 8:
    ...
    NONFAILING(*(uint32_t*)0x20000008 = 0x3f00);
    ...
    NONFAILING(*(uint64_t*)0x20000108 = 0x6fffff9);
    ...
    syscall(__NR_sendmsg, r[3], 0x20000140, 0);
    break;
  }
}
int main(void)
