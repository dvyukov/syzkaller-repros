...
void* thr(void* arg)
{
  switch ((long)arg) {
  case 0:
    r[0] = syscall(__NR_mmap, 0x20000000ul, 0xfe7000ul, 0x3ul, 0x32ul,
  ...
  case 3:
    ...
    break;
  case 4:
    *(uint64_t*)0x20af0000 = (uint64_t)0x40;
    *(uint64_t*)0x20af0008 = (uint64_t)0x20b6af80;
    *(uint64_t*)0x20af0010 = (uint64_t)0x80;
    memcpy((void*)0x20b6af80,
           "\x66\xba\xf8\x0c\xb8\xcc\xe3\x74\x8f\xef\xb9\x19\x09\x00"
           "\x00\xb8\x2a\x39\x00\x00\xba\x00\x00\x00\x00\x0f\x30\xc8"
           "\xe2\xe3\x09\x66\xba\xf8\x0c\xb8\x88\x08\x15\xaf\x80\x80"
           "\x66\xba\xfc\x0c\x66\xb8\xb0\x23\x66\xef\x0f\xc7\x1c\x88"
           "\x66\xba\xf8\x0c\xb8\xd4\x60\x6e\x83\xef\x66\xba\xfc\x0c"
           "\x66\xb8\xe3\x6d\x66\xef\xc7\x44\x24\x00\x33\x00\x00\x00"
           "\xc7\x5c\x24\xe0\x00\x3d\xae\x00\x00\x00\x1c\x24\x66\xb8"
           "\x8f\x00\x0f\x00\xd0\x65\x66\x0f\x2c\x8f\x27\xec\x05\x16"
           "\x0f\x20\xd8\x35\x08\x00\x00\x00\x0f\x22\xd8\x8f\x29\x28"
           "\x91\xf0",
           128);
    r[9] = syz_kvm_setup_cpu(r[3], r[4], 0x20b13000ul, 0x20af0000ul,
                             0x1ul, 0x40ul, 0x20fe6000ul, 0x0ul);
    break;
  case 5:
    r[10] = syscall(__NR_ioctl, r[4], 0xae80ul, 0x0ul);
    break;
  case 6:
    r[11] = syscall(__NR_ioctl, r[4], 0xaeb7ul);
    break;
  }
  return 0;
}
