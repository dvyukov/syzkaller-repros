...
// https://syzkaller.appspot.com/bug?id=0f32d05d8b6cd8d7ea3e
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20001a68 = 0;
  syscall(__NR_io_uring_register, r[0], 0ul, 0x20001a40ul, 3ul);
}
int main(void)
{
