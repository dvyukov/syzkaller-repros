...
void execute_one(void)
{
  ...
  *(uint32_t*)0x200000c0 = 1;
  syscall(__NR_setsockopt, r[0], 1, 0x3c, 0x200000c0, 4);
  ...
  *(uint8_t*)0x20000047 = 0;
  syscall(__NR_sendto, r[0], 0, 0, 0x4008040, 0x20000040, 0x10);
  memcpy((void*)0x20000100, "\xf0", 1);
  syscall(__NR_sendto, r[0], 0x20000100, 1, 0x4004000, 0, 0);
}
int main(void)
{
