...
// https://syzkaller.appspot.com/bug?id=485cc00ea7cf41dfdbf1
// status:6
...
void loop(void)
{
  memcpy((void*)0x20000100,
         "\x12\x01\x00\x00\x92\x90\x81\x08\xac\x05\x15\x82\x58\x8f\x00\x00\x00"
         "\x01\x09\x02\x2d\x00\x01\x00\x00\x00\x00\x09\x04\x00\x00\x03\x0b\x3d"
         "\xb7\x00\x09\x05\x8d\x1f\xff\xb0\x00\x00\x00\x09\x05\x05\x02\x00\x00"
         "\x00\x00\x00\x09\x05\x8b\x1e\xa6",
         59);
  syz_usb_connect(0, 0x3f, 0x20000100, 0);
  close_fds();
}
int main(void)
{
