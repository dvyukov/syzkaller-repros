...
// https://syzkaller.appspot.com/bug?id=bf496bbdeb93c384379e02177738f6f027b58fb0
// status:open
...
void loop(void)
{
  ...
  NONFAILING(*(uint8_t*)0x20000084 = 0x45);
  NONFAILING(*(uint8_t*)0x20000085 = 0xad);
  NONFAILING(*(uint8_t*)0x20000086 = 0x8b);
  NONFAILING(*(uint8_t*)0x20000087 = 8);
  NONFAILING(*(uint16_t*)0x20000088 = 0x1631);
  NONFAILING(*(uint16_t*)0x2000008a = 0x6200);
  NONFAILING(*(uint16_t*)0x2000008c = 0x3950);
  ...
  NONFAILING(*(uint8_t*)0x2000009d = 0x91);
  NONFAILING(*(uint8_t*)0x2000009e = 0);
  NONFAILING(*(uint8_t*)0x2000009f = 0);
  NONFAILING(*(uint8_t*)0x200000a0 = 0x8d);
  NONFAILING(*(uint8_t*)0x200000a1 = 0x7d);
  NONFAILING(*(uint8_t*)0x200000a2 = 0x32);
  ...
  syz_usb_control_io(r[0], 0, 0);
  syz_usb_control_io(r[0], 0, 0);
  NONFAILING(*(uint32_t*)0x20001c00 = 0x2c);
  NONFAILING(*(uint64_t*)0x20001c04 = 0x200019c0);
  NONFAILING(*(uint8_t*)0x200019c0 = 0);
  NONFAILING(*(uint8_t*)0x200019c1 = 0xa);
  NONFAILING(*(uint32_t*)0x200019c2 = 0);
  ...
  syz_usb_control_io(r[0], 0, 0x20001c00);
  close_fds();
}
int main(void)
{
