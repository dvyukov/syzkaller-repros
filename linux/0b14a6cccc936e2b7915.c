...
// https://syzkaller.appspot.com/bug?id=0b14a6cccc936e2b7915
// status:6
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x20000108 = 4;
  syscall(__NR_connect, r[1], 0x20000100ul, 0xaul);
  ...
  *(uint32_t*)0x2000011c = 0;
  syscall(__NR_getsockopt, -1, 0x29, 0x20, 0x20000100ul, 0ul);
  memcpy((void*)0x20000100, "syz_tun\000\000\000\000\000\000\000\000\000", 16);
  *(uint32_t*)0x20000110 = 0;
  syscall(__NR_ioctl, -1, 0x8933, 0x20000100ul);
  res = syz_init_net_socket(0x1f, 1, 3);
  if (res != -1)
    r[2] = res;
  syscall(__NR_ioctl, r[2], 0x400452c8, 0x20000100ul);
}
int main(void)
{
