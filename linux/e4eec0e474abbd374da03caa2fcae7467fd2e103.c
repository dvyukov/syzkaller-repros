...
// https://syzkaller.appspot.com/bug?id=e4eec0e474abbd374da03caa2fcae7467fd2e103
// status:open
...
void execute_call(int call)
{
  ...
  case 7:
    ...
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000180, 0x800, 0);
    if (res != -1)
      r[2] = res;
    break;
  case 8:
    NONFAILING(*(uint32_t*)0x200001c0 = 8);
    syscall(__NR_ioctl, r[2], 0x400445a0, 0x200001c0);
    break;
  case 9:
  ...
  case 10:
    ...
    res = syscall(__NR_open, 0x20000580, 0x200000, 0);
    if (res != -1)
      r[3] = res;
    break;
  case 11:
    ...
    syscall(__NR_symlinkat, 0x20000540, r[3], 0x200005c0);
    break;
  }
}
