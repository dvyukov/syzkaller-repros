...
// https://syzkaller.appspot.com/bug?id=cae65bcdcf43a3593dd6
// status:0
...
void execute_one(void)
{
  ...
  syscall(__NR_socketpair, 0x1eul, 5ul, 0, 0ul);
  syscall(__NR_ioctl, -1, 0x8912, 0x400308ul);
  ...
  *(uint32_t*)0x2000000c = 0;
  ...
  syscall(__NR_sendmmsg, r[0], 0x20000080ul, 0x1a1ul, 0xc000000ul);
  syz_open_dev(0, 6, 0x657bd058077820bd);
}
int main(void)
{
