...
void execute_one()
{
  ...
  NONFAILING(*(uint64_t*)0x20000108 = 0x20000040);
  NONFAILING(*(uint64_t*)0x20000110 = 0x20000000);
  NONFAILING(memcpy((void*)0x20000000,
                    "\x47\x50\x4c\x00\xbc\x30\x47\xeb\x52\x5f\x48\x4f\x89\xfc"
                    "\x96\xdd\x6c\xa6\x4d\xa4\x0f\xf0\x23\x12\x2e\x66\xf6",
                    27));
  NONFAILING(*(uint32_t*)0x20000118 = 0);
  NONFAILING(*(uint32_t*)0x2000011c = 0xce);
  NONFAILING(*(uint64_t*)0x20000120 = 0x20000300);
  ...
  syscall(__NR_bpf, 5, 0x20000100, 0x48);
  NONFAILING(*(uint32_t*)0x200000c0 = 0);
  NONFAILING(*(uint32_t*)0x200000c4 = 3);
  NONFAILING(*(uint64_t*)0x200000c8 = 0x20000040);
  NONFAILING(memcpy((void*)0x20000040,
                    "\x18\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\x80"
                    "\x00\x00\x6a\x0a\x00\xff\xff\xff\xf6\x00\x61\x18",
                    26));
  NONFAILING(*(uint64_t*)0x200000d0 = 0x20000080);
  NONFAILING(memcpy((void*)0x20000080, "syzkalleP", 10));
  NONFAILING(*(uint32_t*)0x200000d8 = 0);
  NONFAILING(*(uint32_t*)0x200000dc = 0xce);
  NONFAILING(*(uint64_t*)0x200000e0 = 0x20000180);
  ...
  NONFAILING(*(uint32_t*)0x20000100 = 0);
  NONFAILING(*(uint32_t*)0x20000104 = 0);
  syscall(__NR_bpf, 5, 0x200000c0, 0x48);
  NONFAILING(*(uint32_t*)0x20000240 = 0x12);
  NONFAILING(*(uint32_t*)0x20000244 = 5);
  NONFAILING(*(uint64_t*)0x20000248 = 0x20000040);
  NONFAILING(*(uint8_t*)0x20000040 = 0x18);
  NONFAILING(STORE_BY_BITMASK(uint8_t, 0x20000041, 0, 0, 4));
  ...
  NONFAILING(STORE_BY_BITMASK(uint8_t, 0x20000050, 5, 0, 3));
  NONFAILING(STORE_BY_BITMASK(uint8_t, 0x20000050, 0, 3, 1));
  NONFAILING(STORE_BY_BITMASK(uint8_t, 0x20000050, 0, 4, 4));
  NONFAILING(STORE_BY_BITMASK(uint8_t, 0x20000051, 0, 0, 4));
  NONFAILING(STORE_BY_BITMASK(uint8_t, 0x20000051, 0, 4, 4));
  NONFAILING(*(uint16_t*)0x20000052 = 0);
  NONFAILING(*(uint32_t*)0x20000054 = 0);
  NONFAILING(*(uint8_t*)0x20000060 = 0x95);
  ...
  NONFAILING(memcpy((void*)0x20000200, "syzkaller", 10));
  NONFAILING(*(uint32_t*)0x20000258 = 0x80000001);
  NONFAILING(*(uint32_t*)0x2000025c = 0x4bb);
  NONFAILING(*(uint64_t*)0x20000260 = 0x20000300);
  ...
  NONFAILING(*(uint32_t*)0x20000284 = 0xb);
  write_file("/sys/kernel/debug/failslab/ignore-gfp-wait", "N");
  write_file("/sys/kernel/debug/fail_futex/ignore-private", "N");
  inject_fault(35);
  syscall(__NR_bpf, 5, 0x20000240, 0x48);
}
