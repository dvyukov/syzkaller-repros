...
// https://syzkaller.appspot.com/bug?id=f058ddd6dc1059d6e3db91c92c8a740615572b44
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    memcpy((void*)0x20000140, "/dev/uinput\000", 12);
  ...
  case 1:
    ...
    *(uint16_t*)0x200000c6 = 0;
    memcpy((void*)0x200000c8,
           ...
           80);
    *(uint32_t*)0x20000118 = 0x42;
    syscall(__NR_ioctl, r[0], 0x405c5503ul, 0x200000c0ul);
    break;
  case 2:
    syscall(__NR_ioctl, r[0], 0x5501ul, 0);
    break;
  case 3:
