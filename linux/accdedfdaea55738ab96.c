...
// https://syzkaller.appspot.com/bug?id=accdedfdaea55738ab96
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000780, "./bus/file0\000", 12));
    NONFAILING(*(uint64_t*)0x20000d80 = 0x200007c0);
    NONFAILING(memcpy((void*)0x200007c0, "order=strict", 12));
    NONFAILING(*(uint64_t*)0x20000d88 = 0x20000800);
    NONFAILING(memset((void*)0x20000800, 0, 1));
    NONFAILING(*(uint64_t*)0x20000d90 = 0x20000c40);
    NONFAILING(memcpy((void*)0x20000c40, "nobarrier", 9));
    NONFAILING(*(uint64_t*)0x20000d98 = 0x20000c80);
    NONFAILING(memcpy((void*)0x20000c80, "!^\\\253\273@[)/\000", 10));
    NONFAILING(*(uint64_t*)0x20000da0 = 0x20000cc0);
    NONFAILING(memcpy((void*)0x20000cc0, ".\000", 2));
    NONFAILING(*(uint64_t*)0x20000da8 = 0x20000d00);
    NONFAILING(memcpy((void*)0x20000d00, "tmpfs\000", 6));
    NONFAILING(*(uint64_t*)0x20000db0 = 0x20000d40);
    NONFAILING(memcpy((void*)0x20000d40, "{!*^!!\000", 7));
    NONFAILING(*(uint64_t*)0x20000f40 = 0x20000dc0);
    NONFAILING(memcpy((void*)0x20000dc0, "\']]@(.*\000", 8));
    NONFAILING(*(uint64_t*)0x20000f48 = 0x20000e00);
    NONFAILING(memcpy((void*)0x20000e00, "/\304\\\000", 4));
    NONFAILING(*(uint64_t*)0x20000f50 = 0);
    NONFAILING(*(uint64_t*)0x20000f58 = 0x20000e80);
    NONFAILING(memcpy((void*)0x20000e80, "#! ", 3));
    NONFAILING(*(uint64_t*)0x20000f60 = 0);
    NONFAILING(*(uint64_t*)0x20000f68 = 0x20000f00);
    NONFAILING(memcpy((void*)0x20000f00, ")[$*#(+/-\\-\000", 12));
    syscall(__NR_execve, 0x20000780ul, 0x20000d80ul, 0x20000f40ul);
    break;
  case 2:
    ...
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000580, "./bus\000", 6));
  ...
  case 4:
    ...
    syscall(__NR_mount, 0ul, 0x20000040ul, 0x20000080ul, 0x40ul, 0x20000340ul);
    break;
  case 5:
  ...
  case 6:
    ...
    res = syscall(__NR_open, 0x20000200ul, 0x1612c2ul, 0ul);
    if (res != -1)
      r[0] = res;
    break;
  case 7:
    NONFAILING(memcpy((void*)0x200000c0, "/proc/timer_list\000", 17));
  ...
  case 8:
    ...
    break;
  case 9:
    NONFAILING(memcpy((void*)0x20000400, "stack\000", 6));
    res = -1;
    NONFAILING(res = syz_open_procfs(0, 0x20000400));
    if (res != -1)
      r[2] = res;
    break;
  case 10:
    NONFAILING(*(uint64_t*)0x20001ac0 = 0);
    NONFAILING(*(uint32_t*)0x20001ac8 = 0);
    NONFAILING(*(uint64_t*)0x20001ad0 = 0x200003c0);
    NONFAILING(*(uint64_t*)0x200003c0 = 0);
    NONFAILING(*(uint64_t*)0x200003c8 = 0);
    NONFAILING(*(uint64_t*)0x20001ad8 = 1);
    NONFAILING(*(uint64_t*)0x20001ae0 = 0);
    NONFAILING(*(uint64_t*)0x20001ae8 = 0);
    NONFAILING(*(uint32_t*)0x20001af0 = 0xa6ff8034);
    NONFAILING(*(uint32_t*)0x20001af8 = 0);
    syscall(__NR_sendmmsg, -1, 0x20001ac0ul, 1ul, 0ul);
    break;
  case 11:
    syscall(__NR_preadv, r[2], 0x200017c0ul, 0x3dul, 0, 0);
    break;
  }
}
int main(void)
