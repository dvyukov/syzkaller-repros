...
// https://syzkaller.appspot.com/bug?id=fa44367615d6e8d12311
// status:0
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x2000009f = 0;
  res = syscall(__NR_write, r[0], 0x20000080ul, 0x22ul);
  if (res != -1)
  ...
  *(uint8_t*)0x2000002c = 0xfe;
  *(uint8_t*)0x2000002d = 0x80;
  ...
  *(uint32_t*)0x20000044 = 0;
  syscall(__NR_write, r[0], 0x20000000ul, 0x48ul);
  *(uint32_t*)0x20000140 = 3;
  *(uint16_t*)0x20000144 = 0x40;
  ...
  *(uint32_t*)0x20000184 = 0xffff7fff;
  syscall(__NR_write, r[0], 0x20000140ul, 0x48ul);
}
int main(void)
{
