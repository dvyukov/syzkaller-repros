...
// https://syzkaller.appspot.com/bug?id=6038e5964bf567082212
// status:0
...
void execute_one(void)
{
  ...
  syscall(__NR_mknod, 0x20000300ul, 0ul, 0);
  res = syscall(__NR_pipe2, 0x20000240ul, 0ul);
  if (res != -1) {
    NONFAILING(r[0] = *(uint32_t*)0x20000240);
    NONFAILING(r[1] = *(uint32_t*)0x20000244);
  }
  NONFAILING(memcpy((void*)0x200005c0, "\x15\x00\x00\x00\x65\xff\xff\x01\x80"
                                       "\x40\x00\x08\x00\x39\x50\x32\x30\x30"
                                       "\x30",
                    19));
  syscall(__NR_write, r[1], 0x200005c0ul, 0x15ul);
  ...
  inject_fault(24);
  syscall(__NR_mount, 0ul, 0x20000180ul, 0x200001c0ul, 0ul, 0x20000380ul);
}
int main(void)
{
