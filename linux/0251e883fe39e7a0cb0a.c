...
// https://syzkaller.appspot.com/bug?id=0251e883fe39e7a0cb0a
// status:6 arch:386
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x200007c4 = 0xf1ffffff;
  *(uint32_t*)0x200007c8 = 0x20000780;
  *(uint32_t*)0x20000780 = 0x20000100;
  ...
  *(uint32_t*)0x20000114 = r[1];
  memcpy((void*)0x20000118,
         ...
         "\x66\x71\x00\x4b\x00\x02\x00\x00\x00\x00\x7b\x61\x25\xcf\x00\x00\x00"
         ...
         "\x00\x00\x00\x00\x00\x08\x00\x00\x00\x00\x00",
         96);
  *(uint32_t*)0x20000784 = 0x78;
