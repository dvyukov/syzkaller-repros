...
// https://syzkaller.appspot.com/bug?id=32ab713350c43e6736ca
// status:0
...
void execute_one(void)
{
  ...
  syscall(__NR_ioctl, r[0], 0x400455c8ul, 2ul);
  ...
  syscall(__NR_setsockopt, r[1], 0x84ul, 0x64ul, 0x20000040ul, 0x10ul);
  NONFAILING(memcpy((void*)0x203cef9f, "7", 1));
  NONFAILING(*(uint16_t*)0x20618000 = 2);
  NONFAILING(*(uint16_t*)0x20618002 = htobe16(0x4e20));
  NONFAILING(*(uint32_t*)0x20618004 = htobe32(0x7f000001));
  syscall(__NR_sendto, r[1], 0x203cef9ful, 1ul, 0ul, 0x20618000ul, 0x10ul);
  NONFAILING(*(uint32_t*)0x20a8a000 = 0);
  syscall(__NR_getsockopt, r[1], 0x84ul, 0x1dul, 0ul, 0x20a8a000ul);
  NONFAILING(*(uint32_t*)0x200000c0 = 0);
  syscall(__NR_ioctl, r[0], 0x5412ul, 0x200000c0ul);
}
int main(void)
{
