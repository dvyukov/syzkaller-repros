...
// https://syzkaller.appspot.com/bug?id=909a91e75919efd2b557
// status:0
...
void loop(void)
{
  NONFAILING(memcpy((void*)0x20000000, "\x12\x01\x00\x00\x0a\x87\x4e\x40\x48"
                                       "\x0b\x03\x10\x34\xdf\x00\x00\x00\x01"
                                       "\x09\x02\x12\x00\x01\x00\x00\x00\x00"
                                       "\x09\x04\x01",
                    30));
  NONFAILING(syz_usb_connect(0, 0x24, 0x20000000, 0));
  close_fds();
}
int main(void)
{
