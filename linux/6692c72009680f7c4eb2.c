...
// https://syzkaller.appspot.com/bug?id=6692c72009680f7c4eb2
// status:0
...
{
  *(uint8_t*)0x20000500 = 0x12;
  *(uint8_t*)0x20000501 = 1;
  *(uint16_t*)0x20000502 = 0x200;
  *(uint8_t*)0x20000504 = -1;
  *(uint8_t*)0x20000505 = -1;
  *(uint8_t*)0x20000506 = -1;
  *(uint8_t*)0x20000507 = 0x40;
  *(uint16_t*)0x20000508 = 0xcf3;
  *(uint16_t*)0x2000050a = 0x9271;
  *(uint16_t*)0x2000050c = 0x108;
  *(uint8_t*)0x2000050e = 1;
  *(uint8_t*)0x2000050f = 2;
  *(uint8_t*)0x20000510 = 3;
  *(uint8_t*)0x20000511 = 1;
  *(uint8_t*)0x20000512 = 9;
  *(uint8_t*)0x20000513 = 2;
  *(uint16_t*)0x20000514 = 0x48;
  *(uint8_t*)0x20000516 = 1;
  *(uint8_t*)0x20000517 = 1;
  *(uint8_t*)0x20000518 = 0;
  *(uint8_t*)0x20000519 = 0x80;
  *(uint8_t*)0x2000051a = 0xfa;
  *(uint8_t*)0x2000051b = 9;
  *(uint8_t*)0x2000051c = 4;
  *(uint8_t*)0x2000051d = 0;
  *(uint8_t*)0x2000051e = 0;
  *(uint8_t*)0x2000051f = 6;
  *(uint8_t*)0x20000520 = -1;
  *(uint8_t*)0x20000521 = 0;
  *(uint8_t*)0x20000522 = 0;
  *(uint8_t*)0x20000523 = 0;
  *(uint8_t*)0x20000524 = 9;
  *(uint8_t*)0x20000525 = 5;
  *(uint8_t*)0x20000526 = 1;
  *(uint8_t*)0x20000527 = 2;
  *(uint16_t*)0x20000528 = 0x200;
  *(uint8_t*)0x2000052a = 0;
  *(uint8_t*)0x2000052b = 0;
  *(uint8_t*)0x2000052c = 0;
  *(uint8_t*)0x2000052d = 9;
  *(uint8_t*)0x2000052e = 5;
  *(uint8_t*)0x2000052f = 0x82;
  *(uint8_t*)0x20000530 = 2;
