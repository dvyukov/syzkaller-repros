...
// https://syzkaller.appspot.com/bug?id=b03d9adc7aef10ab78bbd92a3803ecdebdedb9de
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_ioctl, r[0], 0x400455c8, 9);
    break;
  case 3:
    NONFAILING(*(uint32_t*)0x200001c0 = 2);
    syscall(__NR_ioctl, r[0], 0x5412, 0x200001c0);
    break;
  }
}
int main(void)
