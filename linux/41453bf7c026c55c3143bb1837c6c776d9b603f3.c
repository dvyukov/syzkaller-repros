...
// https://syzkaller.appspot.com/bug?id=41453bf7c026c55c3143bb1837c6c776d9b603f3
// status:dup
...
void execute_call(int call)
{
  ...
  case 0:
    NONFAILING(memcpy(
        ...
        "\x0a\x84\x5f\xf9\xf1\xc3\xb2\x59\x2b\x1c\x7b\xf2\x32\x64\xe0\x73\x61"
  ...
  case 3:
    ...
    break;
  case 4:
    syscall(__NR_ioctl, r[1], 0xc0404806, 0x20000240);
    break;
  case 5:
    NONFAILING(memcpy((void*)0x200000c0, "\xf9\x2e\xf3\xaf\xfd\x3a\xf2", 7));
    syscall(__NR_ioctl, r[1], 0xc0404806, 0x200000c0);
    break;
  case 6:
  ...
  case 7:
    ...
    res = syz_open_dev(0x20000000, 7, 0xef53431cdd500933);
    if (res != -1)
      r[2] = res;
    break;
  case 8:
    NONFAILING(memcpy((void*)0x20000080, "/dev/hidraw#\000", 13));
    syz_open_dev(0x20000080, 0, 0x800);
    break;
  case 9:
    syscall(__NR_ioctl, r[2], 0x80404806, 0);
    break;
  case 10:
    NONFAILING(memcpy((void*)0x200000c0,
                      "\x12\x01\x00\x00\xb3\xd2\x6c\x08\xe1\x06\x09\x7f\x76\xa8"
                      "\xe0\x00\x00\x01\x09\x02\x12\x00\x01\x00\x00\x00\x09\x04"
                      "\xdd\x00\x10\x36\x50\x80\x00",
                      35));
    syz_usb_connect(0, 0x24, 0x200000c0, 0);
    break;
  }
}
int main(void)
