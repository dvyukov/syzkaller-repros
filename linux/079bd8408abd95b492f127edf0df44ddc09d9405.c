...
void execute_call(int call)
{
  ...
  case 3:
    ...
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20001a00, "/dev/net/tun\000", 13));
  ...
  case 5:
    NONFAILING(memcpy((void*)0x20000300,
                      "nr0\001\000\000\000\000\000\000\000\000\000\000\000\000",
                      16));
    NONFAILING(*(uint16_t*)0x20000310 = 0x802);
  ...
  case 9:
    ...
    syscall(__NR_sendmsg, r[1], 0x20000240, 0x20008844);
    break;
  }
}
int main(void)
