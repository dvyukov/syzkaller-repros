...
// https://syzkaller.appspot.com/bug?id=aea3f4c9a02ede7fb2284c59a9b966c123a30ccf
// status:open
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x20000005 = 0;
  memcpy((void*)0x20000006, "\xe2\x70\x1b\xb6\x06\x89", 6);
  ...
  *(uint16_t*)0x20000014 = htobe16(0xe000);
  ...
  *(uint16_t*)0x20000018 = csum_inet_digest(&csum_2);
  syz_emit_ethernet(0x3e, 0x20000000, 0);
}
int main(void)
{
