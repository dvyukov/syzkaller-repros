// possible deadlock in kvm_synchronize_tsc
// https://syzkaller.appspot.com/bug?id=9a89b866d3fc11acc3b6
// status:3 arch:386
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x20000277 = 0;
  syscall(__NR_ioctl, (intptr_t)r[1], 0x4038ae7a, 0x20000240);
  syscall(__NR_ioctl, (intptr_t)r[1], 0xae41, 0);
}
int main(void)
{
