...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000080, "/dev/binder#\000", 13));
    res = syz_open_dev(0x20000080, 0 + procid * 1, 2);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x200000c0 = 0x73622a85);
    NONFAILING(*(uint32_t*)0x200000c4 = 0x100);
    NONFAILING(*(uint64_t*)0x200000c8 = 0);
    NONFAILING(*(uint64_t*)0x200000d0 = 0);
    syscall(__NR_ioctl, r[0], 0x4018620d, 0x200000c0);
    break;
  case 2:
    syscall(__NR_mmap, 0x200a0000, 0x3000, 1, 0x11, r[0], 0);
    break;
  case 3:
    res = syz_open_dev(0, 0 + procid * 1, 2);
    if (res != -1)
      r[1] = res;
    break;
  case 4:
    NONFAILING(*(uint64_t*)0x20000140 = 0x44);
    NONFAILING(*(uint64_t*)0x20000148 = 0);
    NONFAILING(*(uint64_t*)0x20000150 = 0x20000180);
    NONFAILING(memcpy((void*)0x20000180,
                      "\x11\x63\x48\x40\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                      "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                      "\x00\x00\x00\x00\x00\x00\x00\x00\x58\x00\x00\x00\x00\x00"
                      "\x00\x00\x18\x00\x00\x00\x00\x00\x00\x00",
                      52));
    NONFAILING(*(uint64_t*)0x200001b4 = 0x20000200);
    NONFAILING(memcpy(
        (void*)0x20000200,
        "\x85\x2a\x62\x73\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
        "\x00\x00\x00\x00\x00\x00\x00\x85\x2a\x64\x66\x00\x00\x00\x00",
        32));
    NONFAILING(*(uint32_t*)0x20000220 = r[0]);
    NONFAILING(memcpy((void*)0x20000224, "\000~Q\000\000\000", 6));
    NONFAILING(*(uint64_t*)0x2000022a = 0);
    NONFAILING(memcpy((void*)0x20000232,
                      "\n\000\000\000\000\000\000\000\000\000\000\000\000\000"
                      "\000\000\000\000\000\000\000\000\000\000",
                      24));
    NONFAILING(*(uint64_t*)0x200001bc = 0);
    NONFAILING(*(uint64_t*)0x20000158 = 0);
    NONFAILING(*(uint64_t*)0x20000160 = 0);
    NONFAILING(*(uint64_t*)0x20000168 = 0);
    syscall(__NR_ioctl, r[1], 0xc0306201, 0x20000140);
    break;
  }
}
int main(void)
