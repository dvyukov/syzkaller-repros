...
// https://syzkaller.appspot.com/bug?id=d9bf7577474c7f30b0a2
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(*(uint16_t*)0x20000400 = 1);
    NONFAILING(*(uint64_t*)0x20000408 = 0x20000000);
    NONFAILING(*(uint16_t*)0x20000000 = 6);
    NONFAILING(*(uint8_t*)0x20000002 = 0);
    NONFAILING(*(uint8_t*)0x20000003 = 0);
    NONFAILING(*(uint32_t*)0x20000004 = 0x7fffffff);
    res = syscall(__NR_seccomp, 1ul, 0ul, 0x20000400ul);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    ...
    break;
  case 2:
    NONFAILING(memcpy((void*)0x200003c0, "ethtool\000", 8));
