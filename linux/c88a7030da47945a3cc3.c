...
// https://syzkaller.appspot.com/bug?id=c88a7030da47945a3cc3
// status:0
...
void loop(void)
{
  ...
  res = -1;
  NONFAILING(res = syz_io_uring_setup(0x187, 0x200002c0, 0x20ee7000, 0x206d4000,
                                      0x20000540, 0x20000100));
  if (res != -1) {
    r[0] = res;
    NONFAILING(r[1] = *(uint64_t*)0x20000540);
