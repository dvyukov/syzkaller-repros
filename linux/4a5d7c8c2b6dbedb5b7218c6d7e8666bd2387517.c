...
void loop(void)
{
  ...
  *(uint8_t*)0x20000185 = 0xb4;
  *(uint8_t*)0x20000186 = 0x52;
  *(uint8_t*)0x20000187 = 8;
  *(uint16_t*)0x20000188 = 0x187f;
  *(uint16_t*)0x2000018a = 0x600;
  *(uint16_t*)0x2000018c = 0x9079;
  ...
  *(uint16_t*)0x20000194 = 0x67;
  *(uint8_t*)0x20000196 = 1;
  *(uint8_t*)0x20000197 = 0;
  *(uint8_t*)0x20000198 = 4;
  *(uint8_t*)0x20000199 = 0;
  *(uint8_t*)0x2000019a = 0xe1;
  *(uint8_t*)0x2000019b = 9;
  *(uint8_t*)0x2000019c = 4;
  *(uint8_t*)0x2000019d = 0;
  *(uint8_t*)0x2000019e = 0;
  *(uint8_t*)0x2000019f = 0;
  *(uint8_t*)0x200001a0 = 0x8e;
  *(uint8_t*)0x200001a1 = 0xdd;
  *(uint8_t*)0x200001a2 = 0xbd;
  *(uint8_t*)0x200001a3 = 0;
  *(uint8_t*)0x200001a4 = 5;
  *(uint8_t*)0x200001a5 = 0x24;
  *(uint8_t*)0x200001a6 = 0x15;
  *(uint16_t*)0x200001a7 = 0;
  *(uint8_t*)0x200001a9 = 7;
  *(uint8_t*)0x200001aa = 0x24;
  *(uint8_t*)0x200001ab = 0x14;
  *(uint16_t*)0x200001ac = 4;
  *(uint16_t*)0x200001ae = 0x360;
  *(uint8_t*)0x200001b0 = 8;
  *(uint8_t*)0x200001b1 = 0x24;
  *(uint8_t*)0x200001b2 = 0x1c;
  *(uint16_t*)0x200001b3 = 0x5d;
  *(uint8_t*)0x200001b5 = -1;
  *(uint16_t*)0x200001b6 = 0;
  *(uint8_t*)0x200001b8 = 4;
  *(uint8_t*)0x200001b9 = 0x24;
  *(uint8_t*)0x200001ba = 2;
  *(uint8_t*)0x200001bb = 6;
  *(uint8_t*)0x200001bc = 7;
  *(uint8_t*)0x200001bd = 0x24;
  *(uint8_t*)0x200001be = 0xa;
  *(uint8_t*)0x200001bf = 0x3a;
  *(uint8_t*)0x200001c0 = 1;
  *(uint8_t*)0x200001c1 = 0;
  *(uint8_t*)0x200001c2 = 4;
  *(uint8_t*)0x200001c3 = 5;
  *(uint8_t*)0x200001c4 = 0x24;
  *(uint8_t*)0x200001c5 = 0;
  *(uint16_t*)0x200001c6 = 0x8000;
  *(uint8_t*)0x200001c8 = 4;
  *(uint8_t*)0x200001c9 = 0x24;
  *(uint8_t*)0x200001ca = 1;
  *(uint8_t*)0x200001cb = 2;
  *(uint8_t*)0x200001cc = 0xc;
  *(uint8_t*)0x200001cd = 0x24;
  *(uint8_t*)0x200001ce = 7;
  *(uint8_t*)0x200001cf = 5;
  *(uint16_t*)0x200001d0 = 0x4d;
  *(uint16_t*)0x200001d2 = 2;
  *(uint16_t*)0x200001d4 = 2;
  *(uint16_t*)0x200001d6 = 8;
  *(uint8_t*)0x200001d8 = 5;
  *(uint8_t*)0x200001d9 = 0x24;
  *(uint8_t*)0x200001da = 0;
  *(uint16_t*)0x200001db = 0xcee2;
  *(uint8_t*)0x200001dd = 4;
  *(uint8_t*)0x200001de = 0x24;
  *(uint8_t*)0x200001df = 1;
  *(uint8_t*)0x200001e0 = 3;
  *(uint8_t*)0x200001e1 = 4;
  *(uint8_t*)0x200001e2 = 0x24;
  *(uint8_t*)0x200001e3 = 0x13;
  *(uint8_t*)0x200001e4 = 1;
  *(uint8_t*)0x200001e5 = 5;
  *(uint8_t*)0x200001e6 = 0x24;
  *(uint8_t*)0x200001e7 = 6;
  *(uint8_t*)0x200001e8 = 1;
  *(uint8_t*)0x200001e9 = -1;
  *(uint8_t*)0x200001ea = 0xf;
  *(uint8_t*)0x200001eb = 0x21;
  *(uint16_t*)0x200001ec = 0;
  *(uint8_t*)0x200001ee = 5;
  *(uint8_t*)0x200001ef = 3;
  *(uint8_t*)0x200001f0 = 0;
  *(uint16_t*)0x200001f1 = 0x402;
  *(uint8_t*)0x200001f3 = 0x22;
  *(uint16_t*)0x200001f4 = 0x73a;
  *(uint8_t*)0x200001f6 = 0x22;
  *(uint16_t*)0x200001f7 = 0xb68;
  syz_usb_connect(1, 0x79, 0x20000180, 0);
  close_fds();
}
int main(void)
{
