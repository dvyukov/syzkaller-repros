...
int main(void)
{
  ...
  *(uint16_t*)0x20000042 = 0xfe01;
  *(uint8_t*)0x20000044 = 0x47;
  *(uint8_t*)0x20000045 = 0xdc;
  *(uint8_t*)0x20000046 = 0x89;
  *(uint8_t*)0x20000047 = 8;
  *(uint16_t*)0x20000048 = 0x10cf;
  *(uint16_t*)0x2000004a = 0x8068;
  *(uint16_t*)0x2000004c = 0xe68d;
  ...
  *(uint8_t*)0x2000005d = 0x75;
  *(uint8_t*)0x2000005e = 0;
  *(uint8_t*)0x2000005f = 0;
  *(uint8_t*)0x20000060 = 0xc5;
  *(uint8_t*)0x20000061 = 9;
  *(uint8_t*)0x20000062 = 0x7c;
  *(uint8_t*)0x20000063 = 0;
  *(uint8_t*)0x20000064 = 0x15;
  *(uint8_t*)0x20000065 = 0x21;
  *(uint16_t*)0x20000066 = 1;
  *(uint8_t*)0x20000068 = 7;
  *(uint8_t*)0x20000069 = 5;
  *(uint8_t*)0x2000006a = 0x22;
  *(uint16_t*)0x2000006b = 0xeb;
  *(uint8_t*)0x2000006d = 0x21;
  *(uint16_t*)0x2000006e = 0x213;
  *(uint8_t*)0x20000070 = 0x22;
  *(uint16_t*)0x20000071 = 0x813;
  *(uint8_t*)0x20000073 = 0x23;
  *(uint16_t*)0x20000074 = 0x60;
  *(uint8_t*)0x20000076 = 0x23;
  *(uint16_t*)0x20000077 = 0x53c;
  *(uint32_t*)0x20000000 = 0;
  *(uint64_t*)0x20000004 = 0;
  *(uint32_t*)0x2000000c = 0;
  *(uint64_t*)0x20000010 = 0;
  *(uint32_t*)0x20000018 = 0;
  syz_usb_connect(5, 0x39, 0x20000040, 0x20000000);
  return 0;
}
