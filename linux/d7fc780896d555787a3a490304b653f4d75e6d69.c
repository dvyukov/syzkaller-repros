...
// https://syzkaller.appspot.com/bug?id=d7fc780896d555787a3a490304b653f4d75e6d69
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    NONFAILING(memcpy((void*)0x20000100,
                      "\x0b\x00\x02\x00\x00\x00\x00\x00\x00\x00\x64\xe1", 12));
    ...
    syscall(__NR_sendto, r[0], 0x20000100, 0xc, 0, 0x20000080, 0x1c);
    break;
  case 2:
    NONFAILING(*(uint64_t*)0x20000000 = 0x20000140);
    NONFAILING(*(uint64_t*)0x20000008 = 0x1000);
    syscall(__NR_readv, r[0], 0x20000000, 1);
    break;
  case 3:
    syz_extract_tcp_res(0x200004c0, 0x80000001, 0xfffffff9);
    break;
  }
}
