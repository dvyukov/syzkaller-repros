...
// https://syzkaller.appspot.com/bug?id=3d90a19b8cf81688ed481ae7e6b12d4b6a4a20cf
// status:open
...
int main(void)
{
  ...
  *(uint32_t*)0x20000082 = 0x22;
  STORE_BY_BITMASK(uint8_t, , 0x20000086, 2, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000086, 1, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000086, 9, 4, 4);
  memcpy((void*)0x20000087, "\x23\x13", 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000089, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000089, 1, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000089, 2, 4, 4);
  memcpy((void*)0x2000008a, "\xd4\x7a\x77\xd5", 4);
  STORE_BY_BITMASK(uint8_t, , 0x2000008e, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000008e, 1, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000008e, 0, 4, 4);
  memcpy((void*)0x2000008f, "\f\000\000\000", 4);
  STORE_BY_BITMASK(uint8_t, , 0x20000093, 2, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000093, 2, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000093, 2, 4, 4);
  memcpy((void*)0x20000094, "\x90\x00", 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000096, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000096, 1, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000096, 0, 4, 4);
  memcpy((void*)0x20000097, "\x09\x00\xbe\x00", 4);
  STORE_BY_BITMASK(uint8_t, , 0x2000009b, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000009b, 0, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000009b, 8, 4, 4);
  memcpy((void*)0x2000009c, "\000\000\000\000", 4);
  STORE_BY_BITMASK(uint8_t, , 0x200000a0, 2, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x200000a0, 2, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x200000a0, 0, 4, 4);
  memcpy((void*)0x200000a1, "\xa9\x73", 2);
  STORE_BY_BITMASK(uint8_t, , 0x200000a3, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x200000a3, 0, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x200000a3, 8, 4, 4);
  memcpy((void*)0x200000a4, "\x72\xf9\xff\x83", 4);
