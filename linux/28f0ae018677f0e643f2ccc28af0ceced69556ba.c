...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_ioctl, -1, 0x400000000008912, 0x20000480);
    break;
  case 2:
  ...
  case 3:
    ...
    NONFAILING(memcpy((void*)0x200004fb, "noextend", 8));
    NONFAILING(*(uint8_t*)0x20000503 = 0x2c);
    NONFAILING(*(uint8_t*)0x20000504 = 0);
    syscall(__NR_mount, 0, 0x20000380, 0x200003c0, 0, 0x200004c0);
    break;
  case 4:
    NONFAILING(
        memcpy((void*)0x200002c0,
               "\x2a\x00\x00\x00\x29\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00"
               "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
               "\x00\x00\x00\x07\x00\x2e\x2f\x66\x69\x6c\x65\x30",
               42));
    syscall(__NR_write, r[1], 0x200002c0, 0x2a);
    break;
  case 5:
    ...
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x20000180 = 0xb);
    NONFAILING(*(uint8_t*)0x20000184 = 0x77);
    NONFAILING(*(uint16_t*)0x20000185 = 1);
    NONFAILING(*(uint32_t*)0x20000187 = 0);
    syscall(__NR_write, r[1], 0x20000180, 0xb);
    break;
  case 7:
    NONFAILING(*(uint32_t*)0x20000640 = 0xa0);
    NONFAILING(*(uint8_t*)0x20000644 = 0x19);
    NONFAILING(*(uint16_t*)0x20000645 = 1);
    NONFAILING(*(uint64_t*)0x20000647 = 0);
    ...
    syscall(__NR_write, r[1], 0x20000640, 0xa0);
    break;
  case 8:
    NONFAILING(*(uint32_t*)0x20000940 = 9);
    NONFAILING(*(uint8_t*)0x20000944 = 0x6f);
    NONFAILING(*(uint16_t*)0x20000945 = 1);
    NONFAILING(*(uint16_t*)0x20000947 = 0);
    syscall(__NR_write, r[1], 0x20000940, 9);
    break;
  case 9:
    NONFAILING(*(uint32_t*)0x20000440 = 0xb);
    NONFAILING(*(uint8_t*)0x20000444 = 0x75);
    NONFAILING(*(uint16_t*)0x20000445 = 1);
    NONFAILING(*(uint32_t*)0x20000447 = 0);
    syscall(__NR_write, r[1], 0x20000440, 0xb);
    break;
  case 10:
    syscall(__NR_write, r[1], 0x20000980, 0);
    break;
  case 11:
    NONFAILING(memcpy(
        (void*)0x20000040,
    ...
    NONFAILING(*(uint32_t*)0x20000600 = 0x24);
    syscall(__NR_getsockopt, -1, 0x29, 0x41, 0x20000040, 0x20000600);
    break;
  case 12:
    NONFAILING(memcpy((void*)0x20000300, "./file0/file0", 14));
