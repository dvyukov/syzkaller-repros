...
// https://syzkaller.appspot.com/bug?id=6921abfb75d6fc79c0eb
// status:0
...
void loop(void)
{
  ...
  memcpy((void*)0x20000040,
         "\x12\x01\x00\x00\x00\x00\x18\x10\x5e\x04\xda\x07\x00\x00\x00\x00\x1e"
         "\x01\x09\x02\x24\x00\x01\x00\x00\x00\x00\x09\x04\x00\x00\x09\x03\x00"
         "\x00\x00\x09\x21\x00\x00\x00\x01\x22\x22\x00\x09\x05\x81\x03",
         49);
  ...
  *(uint64_t*)0x2000018c = 0x20000200;
  *(uint8_t*)0x20000200 = 0;
  *(uint8_t*)0x20000201 = 3;
  *(uint32_t*)0x20000202 = 2;
  ...
  *(uint64_t*)0x200001d4 = 0x20000000;
  memcpy((void*)0x20000000, "\x00\x22\x22\x00\x00\x00\x96\x23\x03\x02\x0f\x01"
                            "\x58\x27\x0c\x4a\xc2\xc2\x06\xe5\x3f\x07\x01\x00"
                            "\x00\x08\x2a\x54\x08\x57\x30\x0f\x12\x53\xb2\x34"
                            "\xae\xad\x5c\x90\x00\x17\x09\x00\xbe\x00\x83",
         47);
