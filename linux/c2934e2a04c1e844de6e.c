...
// https://syzkaller.appspot.com/bug?id=c2934e2a04c1e844de6e
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    *(uint64_t*)0x20000098 = 0x80b4;
    *(uint64_t*)0x200000a0 = 0xe;
  ...
  case 1:
    ...
    *(uint64_t*)0x2001d078 = 0;
    ...
    break;
  case 2:
    syscall(__NR_mmap, 0x20ffd000ul, 0x3000ul, 0ul, 0x11ul, r[1], 0ul);
    break;
  case 3:
  ...
  case 5:
    ...
    syscall(__NR_write, r[2], 0x20000200ul, 0x806013ul);
    break;
  }
}
int main(void)
