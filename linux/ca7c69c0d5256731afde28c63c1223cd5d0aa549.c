...
void loop(void)
{
  ...
  *(uint16_t*)0x20000b64 = 0xa;
  *(uint16_t*)0x20000b66 = 1;
  memcpy((void*)0x20000b68, "rsvp6\000", 6);
  *(uint16_t*)0x20000b70 = 8;
  *(uint16_t*)0x20000b72 = 2;
  *(uint16_t*)0x20000b74 = 4;
  *(uint16_t*)0x20000b76 = 2;
  *(uint64_t*)0x20000188 = 0x38;
