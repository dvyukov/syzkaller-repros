...
// https://syzkaller.appspot.com/bug?id=0f84f6eed90503da72fc
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(*(uint16_t*)0x20000000 = 0x2a);
    NONFAILING(*(uint32_t*)0x20000004 = 1);
    NONFAILING(*(uint32_t*)0x20000008 = 0);
    syscall(__NR_connect, r[0], 0x20000000ul, 0xcul);
    break;
  case 2:
    syscall(__NR_write, r[0], 0x20000040ul, 0x4aul);
    break;
  case 3:
    NONFAILING(*(uint32_t*)0x20000040 = 0xa);
    NONFAILING(*(uint32_t*)0x20000044 = 8);
    NONFAILING(*(uint32_t*)0x20000048 = 0x1ff);
    NONFAILING(*(uint32_t*)0x2000004c = 0x84800);
    ...
    syscall(__NR_ioctl, -1, 0xc0405610, 0x20000040ul);
    break;
  }
}
int main(void)
