...
// https://syzkaller.appspot.com/bug?id=e461831dbf6e2be9e30aba93b1fd444665c0172b
// status:dup
...
void execute_one()
{
  ...
  memcpy((void*)0x200004c0, "lockproto=lock_nolock", 21);
  *(uint8_t*)0x200004d5 = 0x2c;
  memcpy((void*)0x200004d6, "locktable", 9);
  *(uint8_t*)0x200004df = 0x3d;
  memcpy((void*)0x200004e0, "gfs2meta", 9);
  *(uint8_t*)0x200004e9 = 0x2c;
