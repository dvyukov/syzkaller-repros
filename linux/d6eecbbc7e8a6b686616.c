...
// https://syzkaller.appspot.com/bug?id=d6eecbbc7e8a6b686616
// status:0
...
void execute_one(void)
{
  ...
  res =
      syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000000ul, 0x1e9143ul, 0ul);
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x20000040, "/dev/loop-control\000", 18);
  res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000040ul, 0x8000ul, 0ul);
  if (res != -1)
    r[1] = res;
