...
// https://syzkaller.appspot.com/bug?id=b024befb3ca7990fea37
// status:0
...
void execute_call(int call)
{
  ...
  case 3:
    *(uint32_t*)0x200002c0 = 0x14;
    res = syscall(__NR_getsockname, r[0], 0x20001a00ul, 0x200002c0ul);
    if (res != -1)
      r[1] = *(uint32_t*)0x20001a04;
    break;
  case 4:
  ...
  case 7:
    ...
    *(uint32_t*)0x200000d8 = 0x32b;
    *(uint32_t*)0x200000dc = 0;
    *(uint16_t*)0x200000e0 = 0x24;
    STORE_BY_BITMASK(uint16_t, , 0x200000e2, 0x12, 0, 14);
    ...
    *(uint16_t*)0x200000e6 = 1;
    memcpy((void*)0x200000e8, "geneve\000", 7);
    ...
    *(uint16_t*)0x200000f4 = 6;
    *(uint16_t*)0x200000f6 = 5;
    *(uint16_t*)0x200000f8 = htobe16(0);
    *(uint16_t*)0x200000fc = 5;
    *(uint16_t*)0x200000fe = 0xa;
    *(uint8_t*)0x20000100 = 1;
    *(uint16_t*)0x20000104 = 0x14;
    *(uint16_t*)0x20000106 = 3;
    memcpy((void*)0x20000108, "netpci0\000\000\000\000\000\000\000\000\000",
           16);
    *(uint16_t*)0x20000118 = 8;
    *(uint16_t*)0x2000011a = 0xa;
    *(uint32_t*)0x2000011c = r[1];
    *(uint64_t*)0x20000148 = 0x60;
    *(uint64_t*)0x20000098 = 1;
    *(uint64_t*)0x200000a0 = 0;
    *(uint64_t*)0x200000a8 = 0;
    *(uint32_t*)0x200000b0 = 0x40004;
