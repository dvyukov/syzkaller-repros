...
void execute_call(int call)
{
  ...
  case 3:
    ...
    res = syscall(__NR_accept, r[0], 0x20000040, 0x200001c0);
    if (res != -1)
      r[1] = res;
    break;
  case 4:
  ...
  case 5:
    ...
    syscall(__NR_sendto, r[2], 0x20000280, 0xfffffffffffffedd, 0x20000004,
            0x20000080, 0x1c);
    break;
  case 6:
    ...
    NONFAILING(*(uint64_t*)0x20000140 = 0x20000280);
    ...
    NONFAILING(*(uint64_t*)0x20000148 = 0x14);
