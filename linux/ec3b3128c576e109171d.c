...
// https://syzkaller.appspot.com/bug?id=ec3b3128c576e109171d
// status:6
...
int main(void)
{
  ...
  memcpy((void*)0x20000180,
         ...
         "\x59\x00\x09\x05\x82\xef\x10\x00\x00\x00\x01\x02\x00\x09\x05\x02\x12",
         51);
  res = -1;
  res = syz_usb_connect(0, 0x4a, 0x20000180, 0);
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x20000140 = 0x14;
  *(uint64_t*)0x20000144 = 0;
  *(uint64_t*)0x2000014c = 0x200000c0;
  ...
  *(uint32_t*)0x20000ac0 = 0x1c;
  *(uint64_t*)0x20000ac4 = 0x20000000;
  memcpy((void*)0x20000000, "\x00\x00\x01\x00\x00\x00\x77", 7);
  *(uint64_t*)0x20000acc = 0;
  *(uint64_t*)0x20000ad4 = 0;
  syz_usb_control_io(-1, 0, 0x20000ac0);
  memcpy((void*)0x20000000, "\x02\x00\x00\x0e\xff\x11", 6);
