// BUG: soft lockup in sys_mbind
// https://syzkaller.appspot.com/bug?id=a1361300da931b3e3373
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint64_t*)0x20000110 = 0x3c4b);
    NONFAILING(*(uint64_t*)0x20000118 = 0);
    NONFAILING(*(uint64_t*)0x20000120 = 5);
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_mmap, 0x20000000ul, 0xff5000ul, 0ul, 0x200000005c831ul, -1,
            0ul);
    break;
  case 3:
  ...
  case 5:
    ...
    syscall(__NR_vmsplice, -1, 0x200001c0ul, 1ul, 0ul);
    break;
  case 6:
    NONFAILING(*(uint64_t*)0x200006c0 = 0x20000000);
    NONFAILING(*(uint64_t*)0x200006c8 = 0x18);
    NONFAILING(*(uint64_t*)0x200006d0 = 0);
    NONFAILING(*(uint64_t*)0x200006d8 = 0);
    NONFAILING(*(uint64_t*)0x200006e0 = 0x20000400);
    NONFAILING(*(uint64_t*)0x200006e8 = 0xcb);
    syscall(__NR_readv, -1, 0x200006c0ul, 3ul);
    break;
  case 7:
    NONFAILING(*(uint64_t*)0x20000280 = 0x20001700);
    NONFAILING(*(uint64_t*)0x20000288 = 0x1000);
    syscall(__NR_preadv, -1, 0x20000280ul, 1ul, 0x7ff, 0);
    break;
  case 8:
    NONFAILING(*(uint32_t*)0x20000380 = 0xc);
    syscall(__NR_getsockopt, -1, 0, 8, 0x20000340ul, 0x20000380ul);
    break;
  case 9:
    syscall(__NR_sendmsg, -1, 0ul, 0x20008144ul);
    break;
  case 10:
    syscall(__NR_mbind, 0x20196000ul, 0x2000ul, 0ul, 0ul, 0ul, 3ul);
    break;
  case 11:
    syscall(__NR_remap_file_pages, 0x204e3000ul, 0x2000ul, 7ul, 2ul, 0ul);
    break;
  case 12:
  ...
  case 13:
    ...
    NONFAILING(*(uint64_t*)0x20000148 = 0x989680);
    NONFAILING(*(uint64_t*)0x20000150 = 0);
    NONFAILING(*(uint64_t*)0x20000158 = 0x1c9c380);
    syscall(__NR_timer_settime, 0, 0ul, 0x20000140ul, 0ul);
    break;
  case 14:
    NONFAILING(memcpy((void*)0x200000c0, ".log\000", 5));
    syscall(__NR_openat, -1, 0x200000c0ul, 2ul, 0x111ul);
    break;
  case 15:
    NONFAILING(*(uint64_t*)0x20000080 = 0);
    NONFAILING(*(uint32_t*)0x20000088 = 0x18);
    NONFAILING(*(uint32_t*)0x2000008c = 2);
    NONFAILING(*(uint64_t*)0x20000090 = 0x20000040);
    NONFAILING(memcpy((void*)0x20000040,
                      "\x21\xb0\x48\xf0\xb6\x36\x85\x60\x20\x24", 10));
    NONFAILING(*(uint64_t*)0x20000098 = 0x20000200);
    NONFAILING(memcpy(
        (void*)0x20000200,
        "\x2f\x90\xe7\x07\x3f\x41\xc2\x90\xe3\x01\x10\xc5\x0a\x4e\x0d\x9d\x04"
        "\x90\x2c\x58\x7b\x52\xba\x31\xb8\x2b\x1e\xdb\xe1\x03\xb8\xf5\xf7\x52"
        "\x17\xc9\xe7\xbc\xcd\x0f\xef\xd8\xd1\xb2\xd8\x8d\x95\x54\x7f\x0d\x90"
        "\xb9\x06\x05\x18\xed\x61\x5b\xdc\x9f\x4f\xb1\x48\x4e\x89\x80\xdb\xdd"
        "\x8e\xbf\x89\x45\xeb\x26\xea\xb5\x70\xc3",
        78));
    syscall(__NR_timer_create, 4ul, 0x20000080ul, 0ul);
    break;
  case 16:
