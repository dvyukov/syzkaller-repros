...
void execute_one(void)
{
  ...
  *(uint16_t*)0x20000190 = 8;
  STORE_BY_BITMASK(uint16_t, , 0x20000192, 2, 0, 14);
  ...
  *(uint16_t*)0x20000198 = 8;
  STORE_BY_BITMASK(uint16_t, , 0x2000019a, 1, 0, 14);
