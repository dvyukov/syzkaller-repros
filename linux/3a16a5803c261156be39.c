...
// https://syzkaller.appspot.com/bug?id=3a16a5803c261156be39
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(syz_init_net_socket(0x1f, 4, 0));
    break;
  case 2:
    res = -1;
    ...
    break;
  case 3:
    syscall(__NR_ioctl, r[0], 0x5411, 0ul);
    break;
  case 4:
    syscall(__NR_getsockopt, r[0], 1, 3, 0ul, 0ul);
    break;
  case 5:
    syscall(__NR_ioctl, -1, 0x40049409, -1);
    break;
  case 6:
    res = -1;
    ...
    break;
  case 7:
    NONFAILING(*(uint16_t*)0x200000c0 = 0x1f);
    ...
    syscall(__NR_connect, r[1], 0x200000c0ul, 0xeul);
    break;
  case 8:
    NONFAILING(*(uint16_t*)0x20000100 = 0x1f);
    ...
    syscall(__NR_bind, r[1], 0x20000100ul, 0xeul);
    break;
  }
}
int main(void)
