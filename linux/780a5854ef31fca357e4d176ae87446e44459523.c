...
void execute_call(int call)
{
  ...
  case 2:
    ...
    *(uint32_t*)0x20000008 = 0x14;
    *(uint32_t*)0x2000000c = 0;
    *(uint64_t*)0x20000010 = 0;
    *(uint64_t*)0x20000018 = 0;
    res = syscall(__NR_timer_create, 0ul, 0x20000000ul, 0x20000200ul);
    if (res != -1)
      r[0] = *(uint32_t*)0x20000200;
    break;
  case 3:
    *(uint64_t*)0x20000180 = 0;
    *(uint64_t*)0x20000188 = 0x1c9c380;
    *(uint64_t*)0x20000190 = 0;
    *(uint64_t*)0x20000198 = 0x1c9c380;
    syscall(__NR_timer_settime, r[0], 0ul, 0x20000180ul, 0ul);
    break;
  case 4:
    memcpy((void*)0x20000040, "./file0\000", 8);
    res = syscall(__NR_open, 0x20000040ul, 0x2fcul, 0ul);
    if (res != -1)
      r[1] = res;
    break;
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_flock, r[2], 2ul);
    break;
  case 7:
    syscall(__NR_flock, r[1], 1ul);
    break;
  case 8:
    memcpy((void*)0x20000000, "./file0\000", 8);
    res = syscall(__NR_open, 0x20000000ul, 0ul, 0ul);
