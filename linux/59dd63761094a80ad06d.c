...
// https://syzkaller.appspot.com/bug?id=59dd63761094a80ad06d
// status:6
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(*(uint32_t*)0x20000580 = 1);
    ...
    NONFAILING(*(uint64_t*)0x20000590 = 0x3c40);
    ...
    syscall(__NR_perf_event_open, 0x20000580ul, 0, -1ul, -1, 0ul);
    break;
  case 1:
    NONFAILING(memcpy((void*)0x200000c0, "msdos\000", 6));
    NONFAILING(memcpy((void*)0x20000000, "./file0\000", 8));
    NONFAILING(*(uint64_t*)0x20000180 = 0x20000040);
    NONFAILING(memcpy((void*)0x20000040,
                      "\x04\x08\x00\x09\x00\x00\xff\x01\xe6\x61\x74\x00\x04\x10"
                      "\x09\x0a\x02\x00\x02\x74\x00\xf8",
                      22));
    NONFAILING(*(uint64_t*)0x20000188 = 0x16);
    NONFAILING(*(uint64_t*)0x20000190 = 0);
    NONFAILING(*(uint64_t*)0x20000198 = 0x200004c0);
    NONFAILING(memcpy((void*)0x200004c0, "\xdb\xed\x7d\x4c\xac\x17", 6));
    NONFAILING(*(uint64_t*)0x200001a0 = 6);
    NONFAILING(*(uint64_t*)0x200001a8 = 0x1f);
    res = -1;
    NONFAILING(res = syz_mount_image(0x200000c0, 0x20000000, 0xffc0000b, 2,
                                     0x20000180, 0, 0x20000540));
    if (res != -1)
      r[0] = res;
    break;
  case 2:
  ...
  case 6:
    ...
    syscall(__NR_openat, r[0], 0x20000200ul, 0x28800ul, 1ul);
    break;
  case 7:
    syscall(__NR_mkdir, 0ul, 0ul);
    break;
  case 8:
    NONFAILING(memcpy((void*)0x20000040, "/dev/vhost-vsock\000", 17));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000040ul, 2ul, 0ul);
    if (res != -1)
      r[2] = res;
    break;
  case 9:
    syscall(__NR_ioctl, r[2], 0xaf01, 0ul);
    break;
  case 10:
    ...
    syscall(__NR_ioctl, r[2], 0x4028af11, 0x20000180ul);
    break;
  case 11:
    syscall(__NR_ioctl, r[2], 0x4028af11, 0ul);
    break;
  case 12:
    NONFAILING(memcpy((void*)0x20000000, "./file0\000", 8));
    ...
    break;
  case 13:
    syscall(__NR_splice, -1, 0ul, -1, 0ul, 0x2fffful, 0x500000000000000ul);
    break;
  case 14:
    NONFAILING(memcpy((void*)0x20000300, "./file0\000", 8));
    syscall(__NR_inotify_add_watch, -1, 0x20000300ul, 0x1000060ul);
    break;
  case 15:
    NONFAILING(
        memcpy((void*)0x200027c0, "\x00\x00\x00\x00\xc3\xde\xad\x03", 8));
    syscall(__NR_ioctl, r[2], 0x4008af03, 0x200027c0ul);
    break;
  case 16:
    NONFAILING(memcpy((void*)0x20000240, "./file0\000", 8));
    syscall(__NR_stat, 0x20000240ul, 0x20000280ul);
    break;
  case 17:
    NONFAILING(*(uint32_t*)0x20000080 = 1);
    syscall(__NR_ioctl, r[2], 0x4004af61, 0x20000080ul);
    break;
  case 18:
    NONFAILING(*(uint64_t*)0x20000140 = 0);
    syscall(__NR_ioctl, r[2], 0x4008af04, 0x20000140ul);
    break;
  case 19:
