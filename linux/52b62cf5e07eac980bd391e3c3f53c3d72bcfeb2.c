...
// https://syzkaller.appspot.com/bug?id=52b62cf5e07eac980bd391e3c3f53c3d72bcfeb2
// status:fixed
...
void execute_one(void)
{
  ...
  NONFAILING(memcpy((void*)0x20000180, "sysfs\000", 6));
  syscall(__NR_mount, 0x20000600ul, 0x20000280ul, 0x20000180ul, 0ul, 0ul);
  NONFAILING(memcpy((void*)0x20000180, "mounts\000", 7));
