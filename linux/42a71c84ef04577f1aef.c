...
// https://syzkaller.appspot.com/bug?id=42a71c84ef04577f1aef
// status:0
...
int main(void)
{
  ...
  intptr_t res = 0;
  memcpy((void*)0x200007c0, "/dev/kvm\000", 9);
  res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x200007c0ul, 0ul, 0ul);
  if (res != -1)
    r[0] = res;
