...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20005d40,
                      "vcan0\000\000\000\000\000\000\000\000\000\000\000", 16));
    NONFAILING(*(uint32_t*)0x20005d50 = 0);
    res = syscall(__NR_ioctl, r[1], 0x8933ul, 0x20005d40ul);
    if (res != -1)
      NONFAILING(r[2] = *(uint32_t*)0x20005d50);
    break;
  case 3:
    ...
    NONFAILING(*(uint8_t*)0x20000254 = -1);
  ...
  case 4:
    ...
    syscall(__NR_bind, r[0], 0x200000c0ul, 0x18ul);
    break;
  }
}
int main(void)
