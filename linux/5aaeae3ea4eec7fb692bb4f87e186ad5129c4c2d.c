...
// https://syzkaller.appspot.com/bug?id=5aaeae3ea4eec7fb692bb4f87e186ad5129c4c2d
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_mmap, 0x20000000, 0xe7e000, 4, 0x31, -1, 0);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x200000c0, "./file1", 8));
    syscall(__NR_fchownat, r[1], 0x200000c0, 0, 0, 0x1100);
    break;
  }
}
int main(void)
