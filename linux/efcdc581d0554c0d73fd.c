...
// https://syzkaller.appspot.com/bug?id=efcdc581d0554c0d73fd
// status:0
...
void execute_call(int call)
{
  ...
  case 3:
    memcpy((void*)0x20000100, "./file0\000", 8);
    res = syscall(__NR_open, 0x20000100ul, 0x102ul, 2ul);
    if (res != -1)
      r[1] = res;
    break;
  case 4:
  ...
  case 5:
    ...
    break;
  case 6:
    memset((void*)0x20001400, 59, 1);
    syscall(__NR_write, r[0], 0x20001400ul, 1ul);
    break;
  case 7:
    syscall(__NR_sendfile, r[0], r[1], 0ul, 0x10000ul);
    break;
  case 8:
    syscall(__NR_fallocate, r[2], 0x10ul, 2ul, 0x1fful);
    break;
  }
}
int main(void)
