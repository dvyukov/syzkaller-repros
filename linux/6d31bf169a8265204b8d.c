...
// https://syzkaller.appspot.com/bug?id=6d31bf169a8265204b8d
// status:6
...
int main(void)
{
  ...
  memcpy((void*)0x20000500,
         ...
         51);
  res = -1;
  res = syz_usb_connect(0, 0x4a, 0x20000500, 0);
  if (res != -1)
    r[0] = res;
  ...
  *(uint16_t*)0x200000c8 = 0;
  ...
  memcpy((void*)0x20000000, "\xa5\x00\x00\x4e\x9f\x06\x73", 7);
  syz_usb_ep_write(r[0], 0x82, 8, 0x20000000);
  return 0;
}
