// BUG: unable to handle kernel NULL pointer dereference in rpcb_enc_getaddr
// https://syzkaller.appspot.com/bug?id=8b37ae892b243444669d09e0a8f4420c141ee818
// status:invalid
...
void execute_one()
{
  ...
  *(uint16_t*)0x2000a06e = 0;
  ...
  memcpy((void*)0x208deff8, "./file0", 8);
