...
// https://syzkaller.appspot.com/bug?id=232aca9e5015191a5703e86be689cc7f00365428
// status:dup
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    *(uint32_t*)0x200070c0 = 0;
    *(uint16_t*)0x200070c4 = 0x18;
    *(uint16_t*)0x200070c6 = 0xfa00;
    *(uint64_t*)0x200070c8 = 0;
    *(uint64_t*)0x200070d0 = 0x20007080;
    *(uint16_t*)0x200070d8 = 0x13f;
    ...
    *(uint8_t*)0x200070df = 0;
    res = syscall(__NR_write, r[0], 0x200070c0, 0x20);
    if (res != -1)
      r[1] = *(uint32_t*)0x20007080;
    break;
  case 2:
    *(uint32_t*)0x20007100 = r[1];
    memcpy((void*)0x20007104, "\x00\x00\x00\x00", 4);
    syscall(__NR_write, r[0], 0x20007100, 8);
    break;
  }
}
