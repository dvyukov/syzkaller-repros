...
// https://syzkaller.appspot.com/bug?id=f7e6e8b913da52b0842907b4cb663269468f34bd
// status:dup
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint32_t*)0x2000004c = 0x403);
    ...
    syscall(__NR_bpf, 0, 0x20000040, 0x3c);
    break;
  case 1:
  ...
  case 7:
    ...
    syscall(__NR_setsockopt, r[0], 6, 0x1f, 0x200001c0, 4);
    break;
  }
}
int main(void)
