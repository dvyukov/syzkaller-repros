// KASAN: use-after-free Write in l2tp_session_create
// https://syzkaller.appspot.com/bug?id=dc1f6389bcff6714230b7c05784f2bf98aff041a
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint8_t*)0x20000252 = -1);
    NONFAILING(*(uint8_t*)0x20000253 = -1);
    NONFAILING(*(uint32_t*)0x20000254 = htobe32(0xe0000001));
    NONFAILING(*(uint32_t*)0x20000258 = 0);
    syscall(__NR_connect, r[0], 0x20000240, 0x1c);
    break;
  case 2:
