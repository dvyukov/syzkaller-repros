...
// https://syzkaller.appspot.com/bug?id=c6bfc3db991edc918432
// status:6
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    *(uint16_t*)0x20000482 = htobe16(0x4e24);
    ...
    *(uint8_t*)0x20000487 = 0xaa;
    ...
    break;
  case 3:
    syscall(__NR_recvfrom, r[0], 0x200004c0ul, 0x1000ul, 0x40000000ul, 0ul,
            0ul);
    break;
  case 4:
    *(uint64_t*)0x20000200 = 0x200000c0;
    memcpy((void*)0x200000c0, "X", 1);
    *(uint64_t*)0x20000208 = 0xd4010000;
