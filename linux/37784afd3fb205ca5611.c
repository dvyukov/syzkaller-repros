...
// https://syzkaller.appspot.com/bug?id=37784afd3fb205ca5611
// status:0
...
void execute_call(int call)
{
  ...
  case 6:
    *(uint32_t*)0x200004c0 = r[1];
    syscall(__NR_ioctl, r[2], 0x89e2, 0x200004c0ul);
    break;
  case 7:
    ...
    *(uint16_t*)0x20000366 = 1;
    memcpy((void*)0x20000368, "vlan\000", 5);
    *(uint16_t*)0x20000370 = 0x18;
  ...
  case 8:
    ...
    *(uint16_t*)0x200002e0 = 0x28;
    STORE_BY_BITMASK(uint16_t, , 0x200002e2, 0x12, 0, 14);
    STORE_BY_BITMASK(uint16_t, , 0x200002e3, 0, 6, 1);
    STORE_BY_BITMASK(uint16_t, , 0x200002e3, 1, 7, 1);
    *(uint16_t*)0x200002e4 = 9;
    *(uint16_t*)0x200002e6 = 1;
    memcpy((void*)0x200002e8, "vlan\000", 5);
    *(uint16_t*)0x200002f0 = 0x18;
    STORE_BY_BITMASK(uint16_t, , 0x200002f2, 2, 0, 14);
    ...
    *(uint16_t*)0x200002f8 = 3;
    *(uint16_t*)0x200002fc = 0xc;
    *(uint16_t*)0x200002fe = 2;
    *(uint32_t*)0x20000300 = 0x1c;
    *(uint32_t*)0x20000304 = 0xf;
    *(uint16_t*)0x20000308 = 8;
    *(uint16_t*)0x2000030a = 5;
    *(uint32_t*)0x2000030c = r[3];
    *(uint64_t*)0x20000008 = 0x50;
    *(uint64_t*)0x20000158 = 1;
    *(uint64_t*)0x20000160 = 0;
    *(uint64_t*)0x20000168 = 0;
