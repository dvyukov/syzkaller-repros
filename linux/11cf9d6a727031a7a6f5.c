// BUG: soft lockup in mgmt_set_connectable_complete
// https://syzkaller.appspot.com/bug?id=11cf9d6a727031a7a6f5
// status:0
...
void execute_one(void)
{
  ...
  *(uint16_t*)0x20000004 = 3;
  syscall(__NR_bind, r[0], 0x20000000ul, 6ul);
  *(uint32_t*)0x20000040 = 0x40007;
