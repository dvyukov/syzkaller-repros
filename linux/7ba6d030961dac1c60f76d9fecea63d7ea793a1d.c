...
// https://syzkaller.appspot.com/bug?id=7ba6d030961dac1c60f76d9fecea63d7ea793a1d
// status:fixed
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(
        STORE_BY_BITMASK(uint64_t, 0x20000228, 0xffff7ffffffffffb, 5, 1));
  ...
  case 4:
    ...
    syscall(__NR_inotify_add_watch, r[1], 0x20000200, 0x80000002);
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20ac5000, "./file0", 8));
    syscall(__NR_inotify_add_watch, r[0], 0x20ac5000, 0xa400295c);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20fa3000, "./file0", 8));
    res = syscall(__NR_open, 0x20fa3000, 0, 0);
    if (res != -1)
      r[2] = res;
    break;
  case 7:
    NONFAILING(memcpy((void*)0x20000040, "./file0", 8));
    syscall(__NR_rmdir, 0x20000040);
    break;
  case 8:
    NONFAILING(memcpy((void*)0x20000080, "./file0", 8));
    syscall(__NR_openat, r[2], 0x20000080, 0x200000, 4);
    break;
  case 9:
    syscall(__NR_dup2, r[0], r[2]);
    break;
  }
}
int main()
