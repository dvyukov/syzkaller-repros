...
// https://syzkaller.appspot.com/bug?id=dbd5c927457cd84fb324
// status:0
...
void execute_one(void)
{
  intptr_t res = 0;
  res = -1;
  res = syz_init_net_socket(0x1f, 2, 0);
  if (res != -1)
    r[0] = res;
  *(uint16_t*)0x200000c0 = 3;
  *(uint16_t*)0x200000c2 = 0xfff;
  *(uint16_t*)0x200000c4 = 7;
  *(uint8_t*)0x200000c6 = 4;
  *(uint8_t*)0x200000c7 = 0xfc;
  *(uint8_t*)0x200000c8 = 6;
  *(uint16_t*)0x200000ca = 4;
  syscall(__NR_setsockopt, r[0], 6, 1, 0x200000c0ul, 0xcul);
  ...
  *(uint16_t*)0x2000008a = 0x8001;
  *(uint8_t*)0x2000008c = 0;
  syscall(__NR_connect, r[0], 0x20000080ul, 0xeul);
}
int main(void)
{
