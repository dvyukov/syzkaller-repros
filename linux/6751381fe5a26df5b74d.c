...
// https://syzkaller.appspot.com/bug?id=6751381fe5a26df5b74d
// status:0
...
void loop(void)
{
  ...
  *(uint16_t*)0x200000cc = htobe16(0x24);
  *(uint16_t*)0x200000ce = htobe16(0);
  *(uint16_t*)0x200000d0 = htobe16(0);
  *(uint8_t*)0x200000d2 = 0;
  *(uint8_t*)0x200000d3 = 0x84;
  *(uint16_t*)0x200000d4 = htobe16(0);
  *(uint8_t*)0x200000d6 = 0xac;
  *(uint8_t*)0x200000d7 = 0x14;
  *(uint8_t*)0x200000d8 = 0x14;
  *(uint8_t*)0x200000d9 = 0xbb;
  *(uint8_t*)0x200000da = 0xac;
  *(uint8_t*)0x200000db = 0x14;
  *(uint8_t*)0x200000dc = 0x14;
  *(uint8_t*)0x200000dd = 0xaa;
  *(uint16_t*)0x200000de = htobe16(0);
  *(uint16_t*)0x200000e0 = htobe16(0);
  *(uint8_t*)0x200000e2 = 4;
  STORE_BY_BITMASK(uint8_t, , 0x200000e3, 1, 0, 4);
  STORE_BY_BITMASK(uint8_t, , 0x200000e3, 0, 4, 4);
  *(uint16_t*)0x200000e4 = htobe16(0);
  STORE_BY_BITMASK(uint8_t, , 0x200000e6, 0, 0, 1);
  STORE_BY_BITMASK(uint8_t, , 0x200000e6, 0, 1, 4);
  STORE_BY_BITMASK(uint8_t, , 0x200000e6, 0, 5, 3);
  memcpy((void*)0x200000e7, "\xf4\x26\xe6", 3);
  *(uint8_t*)0x200000ea = 1;
  memcpy((void*)0x200000eb, "\x07\x00\x05", 3);
  struct csum_inet csum_1;
  csum_inet_init(&csum_1);
  csum_inet_update(&csum_1, (const uint8_t*)0x200000d6, 4);
  ...
  csum_inet_update(&csum_1, (const uint8_t*)0x200000de, 16);
