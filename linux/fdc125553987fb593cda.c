...
// https://syzkaller.appspot.com/bug?id=fdc125553987fb593cda
// status:6
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_openat, 0xffffffffffffff9cul, 0ul, 0xcc240ul, 0ul);
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x20000180 = 0);
    NONFAILING(*(uint32_t*)0x20000184 = 2);
  ...
  case 5:
    ...
    NONFAILING(syz_kvm_setup_cpu(-1, r[2], 0x20000000, 0x20000100, 1, 0, 0, 0));
    {
      int i;
      for (i = 0; i < 32; i++) {
        NONFAILING(
            syz_kvm_setup_cpu(-1, r[2], 0x20000000, 0x20000100, 1, 0, 0, 0));
      }
    }
    break;
  case 6:
    NONFAILING(*(uint64_t*)0x200000c0 = 0x20);
    NONFAILING(*(uint64_t*)0x200000c8 = 0);
    NONFAILING(*(uint64_t*)0x200000d0 = 0);
    NONFAILING(syz_kvm_setup_cpu(r[1], -1, 0x20000000, 0x200000c0, 1, 0, 0, 0));
    break;
  case 7:
  ...
  case 8:
    ...
    NONFAILING(syz_io_uring_setup(0x4a5e, 0x20000240, 0x2000d000, 0x20004000,
                                  0x200002c0, 0));
    break;
  }
}
