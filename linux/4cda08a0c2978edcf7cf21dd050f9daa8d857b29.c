...
void execute_call(int call)
{
  ...
  case 1:
    ...
    if (res != -1)
      NONFAILING(r[1] = *(uint32_t*)0x20000310);
    break;
  case 2:
  ...
  case 3:
    ...
    NONFAILING(memcpy((void*)0x20000180,
                      "\x28\x00\x00\x00\x13\x00\x05\x02\x00\x00\x00\x00\x00\x00"
                      "\x00\x00\x00\x00\x00\x00",
                      20));
    NONFAILING(*(uint32_t*)0x20000194 = r[1]);
    NONFAILING(memcpy(
        (void*)0x20000198,
        "\x1c\x00\x00\x06\x00\x00\x00\x00\x08\x00\x0a\x00\x10\x00\x00\x00",
        16));
