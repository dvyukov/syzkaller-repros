...
// https://syzkaller.appspot.com/bug?id=42d685ccd71d27232b90
// status:0
...
void loop(void)
{
  ...
  NONFAILING(memcpy(
      ...
      "\x49\x73\x45\x72\x33\x46\x73\x00\x00\x00\x02\x00\x00\x00\x02",
      69));
  NONFAILING(*(uint64_t*)0x20000048 = 0x45);
  NONFAILING(*(uint64_t*)0x20000050 = 0x2000);
  NONFAILING(*(uint64_t*)0x20000058 = 0x20011200);
  NONFAILING(memcpy(
      (void*)0x20011200,
      "\x00\x00\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x12\x00\x00\x00\x00\x00"
      "\x00\x00\x84\x3d\x00\x00\x00\x04\x00\x00\x73\x56\x4d\x38\x84\x03",
      34));
  NONFAILING(*(uint64_t*)0x20000060 = 0x22);
  NONFAILING(*(uint64_t*)0x20000068 = 0x3d96000);
  ...
  NONFAILING(memcpy(
      ...
      "\x00\x00\x00\x00\x04\x00\x2c\x00\xd4\x0f\x01\x00\x01\x00\x00\x00\x03\x00"
      "\x00\x00\x01\x00\x00\x00\xf4\x01\x00\x00\x02\x00\x30\x00\xa4\x0f",
      70));
  NONFAILING(*(uint64_t*)0x20000078 = 0x46);
  NONFAILING(*(uint64_t*)0x20000080 = 0x3d97000);
  NONFAILING(*(uint64_t*)0x20000088 = 0x20011400);
  NONFAILING(
      memcpy((void*)0x20011400,
             ...
             "\x00\x00\x00\x00\xed\x41\x00\x00\x03",
             57));
  NONFAILING(*(uint64_t*)0x20000090 = 0x39);
  NONFAILING(*(uint64_t*)0x20000098 = 0x3d97fa0);
  NONFAILING(*(uint8_t*)0x20011500 = 0);
  NONFAILING(syz_mount_image(0x20000000, 0x20000100, 0, 4, 0x20000040, 0x208403,
                             0x20011500));
  close_fds();
}
int main(void)
