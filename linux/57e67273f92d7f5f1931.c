// possible deadlock in io_disarm_next
// https://syzkaller.appspot.com/bug?id=57e67273f92d7f5f1931
// status:0
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000198 = -1;
  ...
  res = -1;
  res = syz_io_uring_setup(0x183, 0x20000180, 0x20ee8000, 0x20ffb000,
                           0x20000540, 0x20000200);
  if (res != -1) {
    r[0] = res;
    r[1] = *(uint64_t*)0x20000540;
    r[2] = *(uint64_t*)0x20000200;
  }
  *(uint8_t*)0x20000040 = 0xb;
  *(uint8_t*)0x20000041 = 4;
  *(uint16_t*)0x20000042 = 0;
  *(uint32_t*)0x20000044 = 0;
  *(uint64_t*)0x20000048 = 5;
  ...
  *(uint16_t*)0x2000006a = 0;
  ...
  syz_io_uring_submit(r[1], r[2], 0x20000040, 0x1ff);
  res = syscall(__NR_clock_gettime, 0ul, 0x20000a00ul);
  if (res != -1)
    r[3] = *(uint64_t*)0x20000a08;
  *(uint8_t*)0x20000340 = 0xf;
  ...
  *(uint64_t*)0x20000288 = r[3] + 60000000;
  ...
  *(uint16_t*)0x2000036a = 0;
  ...
  syz_io_uring_submit(r[1], r[2], 0x20000340, 8);
  syscall(__NR_io_uring_enter, r[0], 0x3ed9, 0, 0ul, 0ul, 0ul);
}
int main(void)
{
