...
// https://syzkaller.appspot.com/bug?id=b64c3e0ed576fc1d70e5
// status:0
...
void execute_call(int call)
{
  switch (call) {
  case 0:
    NONFAILING(*(uint32_t*)0x20000044 = 0x7cc);
    NONFAILING(*(uint32_t*)0x20000048 = 2);
    NONFAILING(*(uint32_t*)0x2000004c = 2);
    NONFAILING(*(uint32_t*)0x20000050 = 0x2f7);
    ...
    NONFAILING(
        syz_io_uring_setup(0x6ced, 0x20000040, 0x20ffb000, 0x20ffc000, 0, 0));
    break;
  case 1:
    NONFAILING(syz_io_uring_setup(0x87, 0, 0x20ee7000, 0x20ffc000, 0x20000000,
                                  0x20000040));
    break;
  case 2:
