...
// https://syzkaller.appspot.com/bug?id=dfd0b1c6705301cc4847
// status:0
...
void execute_call(int call)
{
  ...
  case 8:
    ...
    *(uint16_t*)0x20000046 = 0x400;
    *(uint16_t*)0x20000048 = 0x100;
    *(uint16_t*)0x2000004a = 0;
    syscall(__NR_ioctl, r[4], 0x541c, 0x20000040ul);
    break;
  case 9:
    res = -1;
    res = syz_open_dev(0xc, 4, 1);
  ...
  case 10:
    *(uint8_t*)0x20000080 = 3;
    syscall(__NR_ioctl, r[5], 0x541c, 0x20000080ul);
    break;
  }
}
int main(void)
