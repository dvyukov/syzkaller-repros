...
// https://syzkaller.appspot.com/bug?id=fa2fdb06a9489df021a7
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    NONFAILING(memcpy(
        ...
        "\x59\x00\x09\x05\x82\xeb\x10\x00\x00\x00\x01\x02\x00\x09\x05\x02\x76",
        51));
    res = -1;
    NONFAILING(res = syz_usb_connect(0, 0x4a, 0x200004c0, 0));
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x200001c0 = 0x2c);
    NONFAILING(*(uint64_t*)0x200001c4 = 0);
    NONFAILING(*(uint64_t*)0x200001cc = 0);
    NONFAILING(*(uint64_t*)0x200001d4 = 0);
    NONFAILING(*(uint64_t*)0x200001dc = 0);
    NONFAILING(*(uint64_t*)0x200001e4 = 0);
    NONFAILING(syz_usb_control_io(r[0], 0x200001c0, 0));
    break;
  }
}
int main(void)
