...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(*(uint32_t*)0x20000000 = 0xb);
    NONFAILING(*(uint32_t*)0x20000004 = 0x40);
    NONFAILING(*(uint32_t*)0x20000008 = 0xa9);
    NONFAILING(*(uint32_t*)0x2000000c = 0xa37);
  ...
  case 1:
    ...
    NONFAILING(*(uint64_t*)0x20000088 = 0x20000040);
    NONFAILING(memcpy((void*)0x20000040,
                      "\x18\x00\x00\x00\x00\x00\x19\x00\x00\x00\x00\x00\x02\x80"
                      "\x00\x00\x85\x00\x00\x00\x00\x00\x00\x00\x95",
                      25));
  ...
  case 2:
    ...
    break;
  case 3:
    NONFAILING(*(uint32_t*)0x20000780 = 6);
    NONFAILING(*(uint32_t*)0x20000784 = 4);
    NONFAILING(*(uint64_t*)0x20000788 = 0x20000040);
    NONFAILING(*(uint8_t*)0x20000040 = 0x18);
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000041, 2, 0, 4));
    ...
    NONFAILING(*(uint32_t*)0x20000054 = 0x17);
    NONFAILING(*(uint64_t*)0x20000790 = 0x20000140);
    NONFAILING(memcpy((void*)0x20000140, "GPL\x00", 4));
    NONFAILING(*(uint32_t*)0x20000798 = 0x41);
    NONFAILING(*(uint32_t*)0x2000079c = 0xffc4);
    NONFAILING(*(uint64_t*)0x200007a0 = 0x200004c0);
    NONFAILING(*(uint32_t*)0x200007a8 = 0);
    NONFAILING(*(uint32_t*)0x200007ac = 0);
    NONFAILING(*(uint8_t*)0x200007b0 = 0);
    NONFAILING(*(uint8_t*)0x200007b1 = 0);
    NONFAILING(*(uint8_t*)0x200007b2 = 0);
    NONFAILING(*(uint8_t*)0x200007b3 = 0);
    ...
    NONFAILING(*(uint8_t*)0x200007be = 0);
    NONFAILING(*(uint8_t*)0x200007bf = 0);
    NONFAILING(*(uint32_t*)0x200007c0 = 0);
    NONFAILING(*(uint32_t*)0x200007c4 = 0);
    syscall(__NR_bpf, 5, 0x20000780, 0x48);
    break;
  case 4:
