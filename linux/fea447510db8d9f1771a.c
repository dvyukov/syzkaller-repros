// UBSAN: undefined-behaviour in red_enqueue
// https://syzkaller.appspot.com/bug?id=fea447510db8d9f1771a
// status:0
...
void loop(void)
{
  ...
  NONFAILING(*(uint64_t*)0x20000780 = 0x20000100);
  NONFAILING(*(uint32_t*)0x20000100 = 0x148);
  NONFAILING(*(uint16_t*)0x20000104 = 0x24);
  NONFAILING(*(uint16_t*)0x20000106 = 0xf0b);
  ...
  NONFAILING(*(uint32_t*)0x20000114 = r[1]);
  NONFAILING(*(uint16_t*)0x20000118 = 0);
  NONFAILING(*(uint16_t*)0x2000011a = 0);
  NONFAILING(*(uint16_t*)0x2000011c = -1);
  NONFAILING(*(uint16_t*)0x2000011e = -1);
  NONFAILING(*(uint16_t*)0x20000120 = 0);
  NONFAILING(*(uint16_t*)0x20000122 = 0);
  NONFAILING(*(uint16_t*)0x20000124 = 8);
  NONFAILING(*(uint16_t*)0x20000126 = 1);
  NONFAILING(memcpy((void*)0x20000128, "red\000", 4));
  NONFAILING(*(uint16_t*)0x2000012c = 0x11c);
  NONFAILING(*(uint16_t*)0x2000012e = 2);
  NONFAILING(*(uint16_t*)0x20000130 = 0x104);
  NONFAILING(*(uint16_t*)0x20000132 = 2);
  NONFAILING(memcpy(
      (void*)0x20000134,
      "\x67\xcc\x49\xfa\x3e\x06\xdf\x46\x0e\xa0\x76\x77\x0e\x9a\x29\x6a\x7a\xac"
      "\x43\xc6\x04\xe4\xff\x80\xe9\xed\xfa\x2c\xd5\x9a\xa4\xb8\x77\xef\x13\xc9"
      "\x7a\xb9\xd8\x96\x14\xb6\x58\x74\x17\x56\x45\x00\xd2\xe4\xbc\x18\x15\x7d"
      "\xfc\x3f\x1a\x43\x7b\xd8\x4f\xa2\x8f\xde\xba\xff\x0c\xc7\x27\xf3\x4d\x4c"
      "\x7b\x61\xfe\x2e\x61\x67\x8b\x5a\x1b\xd2\xf0\x53\xfe\xd7\x2d\xb2\x30\x86"
      "\x57\x08\x7b\xbe\x41\x50\x89\x9c\x21\xc5\x34\xd2\x1b\xdf\x7a\x55\x34\x27"
      "\xc3\xb4\x37\x9e\x07\xf6\xa6\xee\x8a\x22\xf5\xd8\x13\x32\x3c\xd8\x9b\x3c"
      "\x28\x03\x05\x2e\x4a\x54\x84\x3b\x84\x57\xd1\x5c\x9c\x3a\xce\xab\x01\x61"
      "\xd2\x86\x47\xad\xa7\x98\x71\xa9\x20\x0e\x8d\x0e\x07\x1d\x47\xb2\xcc\x0f"
      "\x1f\x8a\x8c\xb2\x08\xc2\x63\xa4\x6f\x4c\xbc\x93\xfd\x82\x21\x5a\x9d\x7d"
      "\xc1\x22\x1e\x23\x57\x86\xa2\x07\xe9\x7f\x35\x50\x65\x41\x31\x66\xdc\x72"
      "\x2f\xcc\xe8\x85\xcc\x53\x29\xb9\x08\xcd\x01\xa9\xf9\x36\x0e\xf1\x52\xc5"
      "\x64\xf0\x16\xa1\x13\x8b\x8e\x11\xd9\x64\x35\x36\xe8\xdd\x9d\x0a\x07\xcd"
      "\x1b\xbc\x51\x6a\xc0\x59\x56\x44\xd7\x28\xf4\x6f\x1d\xe1\x46\x67\x9f\xfc"
      "\x3f\xb8\x8a\xdf",
      256));
  NONFAILING(*(uint16_t*)0x20000234 = 0x14);
  NONFAILING(*(uint16_t*)0x20000236 = 1);
  ...
  NONFAILING(*(uint8_t*)0x20000247 = 4);
