...
// https://syzkaller.appspot.com/bug?id=d4d7ee170da887c2d831
// status:0
...
void loop(void)
{
  ...
  *(uint16_t*)0x20000058 = 0x28;
  *(uint16_t*)0x2000005a = 0;
  *(uint32_t*)0x2000005c = 0xffffd8ef;
  ...
  *(uint64_t*)0x20000098 = 0x20000340;
  memcpy((void*)0x20000340, "veth0_macvtap\000\000\000", 16);
  *(uint64_t*)0x200000a0 = 0;
  *(uint64_t*)0x200000a8 = 0x400000;
  *(uint16_t*)0x200000b0 = 0x114;
  ...
  *(uint32_t*)0x20000028 = htobe32(0x7f000001);
  memcpy((void*)0x20000034, "bond0\000\000\000\000\000\000\000\000\000\000\000",
         16);
  syscall(__NR_ioctl, -1, 0x8953, 0x20000000ul);
  ...
  *(uint32_t*)0x2000004c = 2;
  memcpy((void*)0x20000050,
         "wlc\000\000\000\000\000\000\000\000\000\000\000\000\000", 16);
  *(uint32_t*)0x20000060 = 0;
  *(uint32_t*)0x20000064 = 0;
  *(uint32_t*)0x20000068 = htobe32(0);
  syscall(__NR_setsockopt, -1, 0, 0x482, 0x20000040ul, 0x2cul);
  memcpy((void*)0x20000240, ".\000", 2);
  memcpy((void*)0x2015bffc, "nfs\000", 4);
  syscall(__NR_mount, 0ul, 0x20000240ul, 0x2015bffcul, 0ul, 0x20000000ul);
}
int main(void)
{
