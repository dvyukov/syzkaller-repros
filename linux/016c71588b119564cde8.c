...
// https://syzkaller.appspot.com/bug?id=016c71588b119564cde8
// status:0
...
int main(void)
{
  ...
  *(uint64_t*)0x20000218 = 0x20000040;
  memcpy((void*)0x20000040, "\000NSR03", 6);
  ...
  *(uint64_t*)0x200002d8 = 0x200000c0;
  memcpy((void*)0x200000c0,
         "\x08\x01\x03\x00\x2e\x00\x01\x00\xc0\x59\x08\x00\xa1\xbe\x99\x36\x9a"
         "\x02\x9b\xa7\x8b\x6f\x6f\x98\x00\x00\x00\x00\xa0\x02\x00\x00\x54\x00"
         "\x5b\x13\x3a\x78\x7f\x1f\x05\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
         "\x00\x00\x00\x00\x79\x80\x82\xa0\x35\x2f\xe7\xfd\xfe\x70\x10\xa4\x37"
         "\xea\x07\x9b\xa9\xff",
         73);
  *(uint64_t*)0x200002e0 = 0x49;
  *(uint64_t*)0x200002e8 = 0xa4000;
  ...
  *(uint64_t*)0x20000308 = 0x20000500;
  memcpy(
      (void*)0x20000500,
  ...
  *(uint64_t*)0x20000330 = 0xb0000;
  res = -1;
  res = syz_mount_image(0x20000000, 0x20000700, 0, 0xd, 0x20000200, 0,
                        0x20000180);
  if (res != -1)
    r[0] = res;
  ...
  inject_fault(12);
  syscall(__NR_renameat, r[0], 0x20000180ul, r[1], 0x200001c0ul);
  return 0;
}
