...
// https://syzkaller.appspot.com/bug?id=845b30a8595fc959cd4b5a19e3a4d8173fa6507b
// status:open
...
int main(void)
{
  ...
  *(uint8_t*)0x20000004 = 0xc5;
  *(uint8_t*)0x20000005 = 0x44;
  *(uint8_t*)0x20000006 = 0xba;
  *(uint8_t*)0x20000007 = 0x10;
  *(uint16_t*)0x20000008 = 0x15a4;
  *(uint16_t*)0x2000000a = 0x9020;
  *(uint16_t*)0x2000000c = 0xba2a;
  ...
  *(uint8_t*)0x2000001d = 0x69;
  *(uint8_t*)0x2000001e = 0;
  *(uint8_t*)0x2000001f = 0;
  *(uint8_t*)0x20000020 = 0x36;
  *(uint8_t*)0x20000021 = 0x43;
  *(uint8_t*)0x20000022 = 0x18;
