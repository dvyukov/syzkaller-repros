...
// https://syzkaller.appspot.com/bug?id=255273ac0964bf0423f2
// status:0
...
int main(void)
{
  ...
  *(uint64_t*)0x20000230 = 0x20010b00;
  memcpy((void*)0x20010b00, "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                            ...
                            "\x00\x00\x00\x00\x80\xd8\x7d\x5a\x01\x00\x03\x00"
  ...
  *(uint64_t*)0x20000248 = 0x20010c00;
  memcpy((void*)0x20010c00, "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                            "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                            "\x00\x00\x00\x06\x00\x00\x00\x00\x00\x01\x0c\x80",
         36);
  *(uint64_t*)0x20000250 = 0x24;
  *(uint64_t*)0x20000258 = 0x2011e0;
  *(uint64_t*)0x20000260 = 0x20010d00;
  memcpy((void*)0x20010d00, "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01",
         12);
  ...
  *(uint64_t*)0x200002f0 = 0x20011700;
  memcpy((void*)0x20011700, "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                            "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                            "\x00\x00\x00\x00\x80\xd8\x7d\x5a",
         32);
  ...
  *(uint64_t*)0x20000338 = 0x20000380;
  memcpy((void*)0x20000380, "\xed\x62\x00\x00\x5c\x00\x00\x00\x02\x00\x00\x00"
                            "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                            "\x00\x10",
         26);
  ...
  *(uint8_t*)0x20000040 = 0;
  syz_mount_image(0x20000000, 0x20000100, 0, 0xf, 0x20000200, 0, 0x20000040);
  return 0;
}
