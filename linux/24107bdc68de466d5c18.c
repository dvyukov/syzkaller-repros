...
// https://syzkaller.appspot.com/bug?id=24107bdc68de466d5c18
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(*(uint64_t*)0x20000048 = 0x400);
  syscall(__NR_prlimit64, 0, 7ul, 0x20000040ul, 0ul);
  NONFAILING(memcpy((void*)0x20000000, "/dev/kvm\000", 9));
  syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000000ul, 0x40000ul, 0ul);
