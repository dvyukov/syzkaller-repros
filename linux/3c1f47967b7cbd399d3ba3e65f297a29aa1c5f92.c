...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    memcpy((void*)0x200000c0, "/dev/sg#", 9);
    res = syz_open_dev(0x200000c0, 0, 2);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    memcpy((void*)0x20000000, "\xb6\x3d\xb8\x5e\x1e\x8d\x02\x00\x00\x00\x00\x00"
                              "\x3e\xf0\x01\x1d\xcc\x60\x6a\xed\x69\xd2\xbc\x70"
                              "\x37\xce\xbc\x9b\xc2\xfe\xff\xff\xff\xff\xff\xff"
                              "\xff\xe2\x2c\x9b\x16\x00\x96\xaa\x1f\xae",
           46);
