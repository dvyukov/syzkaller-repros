...
// https://syzkaller.appspot.com/bug?id=b53bbea2ad64f9cf80d8
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_setsockopt, r[0], 1, 0x3c, 0ul, 0ul);
    break;
  case 3:
    syscall(__NR_sendmmsg, r[0], 0ul, 0ul, 0x400000aul);
    break;
  case 4:
  ...
  case 5:
    ...
    break;
  case 6:
    NONFAILING(*(uint64_t*)0x20000180 = 0xffffffffffffff9b);
    syscall(__NR_ioctl, r[1], 0x5421, 0x20000180ul);
    break;
  case 7:
    ...
    syscall(__NR_bind, r[1], 0x20000080ul, 0x10ul);
    break;
  case 8:
    ...
    syscall(__NR_connect, r[1], 0x20000480ul, 0x10ul);
    break;
  }
}
int main(void)
