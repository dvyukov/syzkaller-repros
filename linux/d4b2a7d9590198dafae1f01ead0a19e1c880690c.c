// WARNING in usb_submit_urb (5)
// https://syzkaller.appspot.com/bug?id=d4b2a7d9590198dafae1f01ead0a19e1c880690c
// status:invalid
  ...
  case 0:
    NONFAILING(
        memcpy((void*)0x20000080,
               "\x12\x01\x00\x00\xd1\x3a\xb3\x08\x4a\x12\x17\x40\xb8\x30\x00"
               "\x00\x00\x01\x09\x02\x1b\x00\x01\x00\x00\x00\x00\x09\x04\xfb"
               "\x00\x01\x96\x35\x44\x00\x07\x05\x81\x12\x01\x00\x00\x00\x00",
               45));
    syz_usb_connect(1, 1, 0x20000080, 0);
    break;
  }
}
int main(void)
