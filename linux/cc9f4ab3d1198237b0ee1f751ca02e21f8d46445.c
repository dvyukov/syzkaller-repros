...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    memcpy((void*)0x200000c0, "/dev/input/mice", 16);
    res = syz_open_dev(0x200000c0, 0, 0x42);
    if (res != -1)
      r[1] = res;
    break;
  case 3:
    ...
    *(uint8_t*)0x200003e7 = 0x3d;
    sprintf((char*)0x200003e8, "0x%016llx", (long long)r[0]);
    *(uint8_t*)0x200003fa = 0x2c;
    *(uint8_t*)0x200003fb = 0;
    syscall(__NR_mount, 0, 0x20000000, 0x20000900, 0, 0x200003c0);
    break;
  }
}
int main()
