// KMSAN: uninit-value in flush_tlb_func_remote
// https://syzkaller.appspot.com/bug?id=4626f086b98887bee1fe46caabfee95dd479ae30
// status:invalid
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint32_t*)0x20000284 = 0xa);
    ...
    syscall(__NR_bpf, 0, 0x20000280, 0x2c);
    break;
  case 2:
    ...
    syscall(__NR_ioctl, r[0], 0xc008240a, 0x20000000);
    break;
  }
}
