...
// https://syzkaller.appspot.com/bug?id=fcbcd11cca8dd50a7096
// status:6
...
void execute_call(int call)
{
  ...
  case 9:
    ...
    NONFAILING(*(uint16_t*)0x20000244 = r[7]);
    NONFAILING(*(uint16_t*)0x20000246 = 1);
    NONFAILING(*(uint32_t*)0x20000248 = 0);
    NONFAILING(*(uint32_t*)0x2000024c = 0);
    NONFAILING(*(uint8_t*)0x20000250 = 0x37);
    NONFAILING(*(uint8_t*)0x20000251 = 0);
    NONFAILING(*(uint16_t*)0x20000252 = 0);
    NONFAILING(*(uint16_t*)0x20000254 = 8);
    NONFAILING(*(uint16_t*)0x20000256 = 3);
    NONFAILING(*(uint32_t*)0x20000258 = r[6]);
    NONFAILING(*(uint16_t*)0x2000025c = 8);
    NONFAILING(*(uint16_t*)0x2000025e = 0x26);
    NONFAILING(*(uint32_t*)0x20000260 = 0x14a0);
    NONFAILING(*(uint16_t*)0x20000264 = 8);
    NONFAILING(*(uint16_t*)0x20000266 = 0x57);
    NONFAILING(*(uint32_t*)0x20000268 = 0x80);
