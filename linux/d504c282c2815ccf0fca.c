...
// https://syzkaller.appspot.com/bug?id=d504c282c2815ccf0fca
// status:2
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_write, r[0], 0x200001c0ul, 0xeul);
    break;
  case 2:
    ...
    res = -1;
    NONFAILING(res = syz_io_uring_setup(0x12d6, 0x20000080, 0x20ee7000,
  ...
  case 5:
    ...
    NONFAILING(
        syz_io_uring_setup(0x5682, 0x200002c0, 0x20414000, 0x206d3000, 0, 0));
    break;
  case 6:
