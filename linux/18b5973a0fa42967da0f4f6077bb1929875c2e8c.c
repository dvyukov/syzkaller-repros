...
// https://syzkaller.appspot.com/bug?id=18b5973a0fa42967da0f4f6077bb1929875c2e8c
// status:fixed
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200000a8, 3, 5, 1));
    ...
    NONFAILING(*(uint64_t*)0x200000b8 = 0x20000000);
    ...
    syscall(__NR_perf_event_open, 0x20000080, 0, 0, -1, 0);
    break;
  case 1:
  ...
  case 2:
    ...
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000240, ".", 2));
    syscall(__NR_inotify_add_watch, r[0], 0x20000240, 0x80000002);
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000280, "\x7f", 1));
    syscall(__NR_write, r[1], 0x20000280, 1);
    break;
  }
}
