...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x20210000 = 2);
    syscall(__NR_setsockopt, r[0], 0x107, 0xa, 0x20210000, 4);
    break;
  case 2:
    NONFAILING(*(uint32_t*)0x200000c0 = 0x1000);
    NONFAILING(*(uint32_t*)0x200000c4 = 0xffff8000);
    NONFAILING(*(uint32_t*)0x200000c8 = 0);
    NONFAILING(*(uint32_t*)0x200000cc = 0);
    NONFAILING(*(uint32_t*)0x200000d0 = 0);
    NONFAILING(*(uint32_t*)0x200000d4 = 0x15c7);
    NONFAILING(*(uint32_t*)0x200000d8 = 0);
    syscall(__NR_setsockopt, r[0], 0x107, 5, 0x200000c0, 0x1c);
    break;
  }
}
