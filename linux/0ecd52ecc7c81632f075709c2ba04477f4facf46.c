...
// https://syzkaller.appspot.com/bug?id=0ecd52ecc7c81632f075709c2ba04477f4facf46
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_ioctl, -1, 0xc010640b, 0);
    break;
  case 1:
    syscall(__NR_setsockopt, -1, 0x11, 0x64, 0, 0);
    break;
  case 2:
    syscall(__NR_openat, 0xffffffffffffff9c, 0, 0x4000000004002, 0);
    break;
  case 3:
    syscall(__NR_mmap, 0x20000000, 0xe7e000, 0, 0x13, -1, 0);
    break;
  case 4:
    syscall(__NR_perf_event_open, 0, 0, 0, -1, 0);
    break;
  case 5:
    memcpy((void*)0x200002c0, "/dev/loop-control\000", 18);
