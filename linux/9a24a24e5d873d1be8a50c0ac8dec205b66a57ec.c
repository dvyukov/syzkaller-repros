...
// https://syzkaller.appspot.com/bug?id=9a24a24e5d873d1be8a50c0ac8dec205b66a57ec
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    NONFAILING(memcpy(
        (void*)0x20000640,
        "\000\000\000\000\000egy\305\216\313\034\370\343\312;\243?"
        "\255\256\017\265\227ao3\253\315Y\232\343\345\341\000\207\254\255\200"
        "\243P\214\352\027f%;\234\307\000\353\364X#\3434\200O]"
        "\207\335\2114\332l;w\370\370\v?v\360\270\332=|\244\272\273iq!"
        "\330g\267I\022\200\035\225WM\232\306\225\230\355\351\312\236\346\313"
        "\216\357\36659-"
        "\357\265\311\362\"\025\2639T\201\031\314\315\265\r\020G\026(~"
        "\025\321\336\236\261s\240\2064hb\252\243\030V\027xE\275\302QD\245P\017"
        "\216\037\2108\266\356\306N\322\0236\353\244\035\252p\306\236\334\0007h"
        "\f\226g\"_"
        "\261\033\333\206\306\311\261\314\241\237\330h\314\022\361k\350\206:"
        "D\322\321\002I\376\226t\345C\206)\360M\304\2435\314\233\236\2735\030["
        "\2258D\\~3\312O\227M\257\2230\375\023\243\336\3160\0355I\272\305;"
        "T\334\257\310\246\n\222\0166>\031*",
        260));
    res = syz_open_procfs(0, 0x20000640);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    NONFAILING(memcpy(
        (void*)0x20000480,
        "mem\000\001y7SwaS."
        "\006ur\211\311B\253\343\372rent\000\252\032\375\256\v\277\330d\273\257"
        "9Q\336\373\037Y\373\215o\321\026\316(\202\361\277{"
        ...
        "\020\321\n(\250="
        "\3654\251\313\351\227T\317\317\207t\201\372\252\3630\213\267\352\374^"
        "\266\225\207E\021\211\177\240m\323&"
        ...
        "\305\234\311Rw\220G\363J\234\217\221\241\326\0055?m\355\224\234\267("
        "\017\323\274\272\306T\335\025\367+*Z3\216_"
        "Z\243k\344R\036\310\vYV\212\215\255\214I\210\fM\031JX\037\377e#|"
        "\006\37286\313\223\352\253\314\2064fC*I\177M\t7\224}\006\035\303\234o-"
        "\335\246\033\250_\037Bl\304:\256\3764\236\251T\221\331w\005\370{\326@",
        395));
    res = syscall(__NR_openat, r[0], 0x20000480, 0, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_lseek, r[2], 0x20400000, 0);
    break;
  case 4:
    syscall(__NR_ioctl, r[1], 0x2400, 3);
    break;
  case 5:
  ...
  case 7:
    ...
    syscall(__NR_write, r[2], 0x20000080, 0x2000008f);
    break;
  case 8:
    syscall(__NR_ioctl, r[2], 0x89e0, 0);
    break;
  case 9:
    syscall(__NR_mremap, 0x20433000, 0x1000, 0x1000, 3, 0x2007f000);
    break;
  case 10:
    syscall(__NR_madvise, 0x200d9000, 0x600000, 8);
    break;
  case 11:
    syscall(__NR_setsockopt, -1, 0x11, 0x64, 0, 0);
    break;
  case 12:
    NONFAILING(memcpy((void*)0x20000000, "security.SMACK64TRANSMUTE\000", 26));
    NONFAILING(memcpy((void*)0x200000c0, "TRUE", 4));
    syscall(__NR_fsetxattr, r[1], 0x20000000, 0x200000c0, 4, 3);
    break;
  case 13:
    NONFAILING(*(uint32_t*)0x20000100 = 0);
    NONFAILING(*(uint32_t*)0x20000104 = 0x10001);
    NONFAILING(*(uint16_t*)0x20000108 = 0x30);
    NONFAILING(*(uint32_t*)0x20000140 = 0xc);
    syscall(__NR_getsockopt, r[0], 0x84, 0x72, 0x20000100, 0x20000140);
    break;
  case 14:
    syscall(__NR_getsockopt, r[2], 0x84, 0x77, 0, 0);
    break;
  }
}
int main(void)
