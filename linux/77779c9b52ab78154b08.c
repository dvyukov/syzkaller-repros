...
// https://syzkaller.appspot.com/bug?id=77779c9b52ab78154b08
// status:6
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000218 = 0x20010100;
  memcpy(
      (void*)0x20010100,
      "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x82\xe3\x67\x24\xc6\xf3"
      "\x4c\xaa\x84\x6e\xd2\xe5\x27\x70\x33\x78\x01\x00\x40\x00\x0c\x00\x00",
      35);
  *(uint64_t*)0x20000220 = 0x23;
  *(uint64_t*)0x20000228 = 0x4e0;
  *(uint64_t*)0x20000230 = 0x20000080;
  memcpy((void*)0x20000080, "\x03\x00\x00\x00\x04", 5);
  ...
  *(uint64_t*)0x20000278 = 0x20012600;
  memcpy((void*)0x20012600,
         ...
         "\x00\x00\x00\x00\x00\x01\x00\x00\x00\x10",
         61);
