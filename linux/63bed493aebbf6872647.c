...
// https://syzkaller.appspot.com/bug?id=63bed493aebbf6872647
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000000, "/dev/rfkill\000", 12));
  ...
  case 5:
    ...
    NONFAILING(*(uint32_t*)0x200000c0 = 0x24);
    ...
    NONFAILING(*(uint8_t*)0x200000d0 = 0x5c);
    NONFAILING(*(uint8_t*)0x200000d1 = 0);
    NONFAILING(*(uint16_t*)0x200000d2 = 0);
    NONFAILING(*(uint16_t*)0x200000d4 = 8);
    NONFAILING(*(uint16_t*)0x200000d6 = 3);
    NONFAILING(*(uint32_t*)0x200000d8 = r[3]);
    NONFAILING(*(uint16_t*)0x200000dc = 8);
    NONFAILING(*(uint16_t*)0x200000de = 0x6b);
    NONFAILING(*(uint32_t*)0x200000e0 = 0x14);
    NONFAILING(*(uint64_t*)0x20000148 = 0x24);
