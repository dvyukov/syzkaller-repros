...
// https://syzkaller.appspot.com/bug?id=c5e32344981ad9f33750
// status:0
...
void loop(void)
{
  ...
  *(uint64_t*)0x20000180 = 0x77359400;
  *(uint64_t*)0x20000188 = 0;
  *(uint16_t*)0x20000190 = 0;
  *(uint16_t*)0x20000192 = 1;
  *(uint32_t*)0x20000194 = 0;
  syscall(__NR_write, r[0], 0x20000180ul, 0xfc57ul);
  res = syscall(__NR_socket, 2ul, 1ul, 0);
  if (res != -1)
    r[1] = res;
  *(uint16_t*)0x2099e000 = 2;
  *(uint16_t*)0x2099e002 = htobe16(0x4e20);
  *(uint8_t*)0x2099e004 = 0xac;
  *(uint8_t*)0x2099e005 = 0x14;
  *(uint8_t*)0x2099e006 = 0x14;
  *(uint8_t*)0x2099e007 = 0;
  syscall(__NR_bind, r[1], 0x2099e000ul, 0x10ul);
  *(uint16_t*)0x20000100 = 2;
  *(uint16_t*)0x20000102 = htobe16(0x4e20);
  *(uint32_t*)0x20000104 = htobe32(0);
  syscall(__NR_sendto, r[1], 0x20000140ul, 0xffffffffffffff58ul, 0x20008005ul,
          0x20000100ul, 0x10ul);
}
int main(void)
{
