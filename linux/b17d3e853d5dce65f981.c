...
// https://syzkaller.appspot.com/bug?id=b17d3e853d5dce65f981
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(memcpy(
      (void*)0x200000c0,
      "\x12\x01\x00\x00\x00\x80\x00\x40\x26\x09\x33\x33\x40\x00\x00\x00\x00\x01"
  ...
  NONFAILING(*(uint32_t*)0x20000d00 = 0x24);
  NONFAILING(*(uint64_t*)0x20000d04 = 0);
  NONFAILING(*(uint64_t*)0x20000d0c = 0);
  NONFAILING(*(uint64_t*)0x20000d14 = 0x20000c80);
  NONFAILING(*(uint8_t*)0x20000c80 = 0);
  NONFAILING(*(uint8_t*)0x20000c81 = 0x22);
  NONFAILING(*(uint32_t*)0x20000c82 = 5);
  NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000c86, 3, 0, 2));
  NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000c86, 2, 2, 2));
  NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000c86, 0, 4, 4));
  NONFAILING(memcpy((void*)0x20000c87, "\x82\x81\x2f\x0d", 4));
  NONFAILING(*(uint64_t*)0x20000d1c = 0);
  NONFAILING(syz_usb_control_io(r[0], 0x20000d00, 0));
  NONFAILING(memcpy(
      (void*)0x20000100,
      "\x63\xf5\xcf\x41\x3b\x58\xd9\x69\xb9\x56\x03\x00\x00\x00\x00\x00\x00\x00"
      "\x00\xab\x23\xff\x1f\xe3\x86\x7f\x9e\xde\x0d\x00\x2b\xf8\x83\x46\xca\x43"
      "\x14\x86\xa8\x55\xf5\x46\x71\x5e\x52\x11\x7d\x6a\x42\x4f\x26\xa3\xb1\x32"
      "\x8f\x75\xea\xac\xe6\x03\x02\x10\xd4\x0d\x32\xba\xae\x8c\x85\xc7\xd0\xd4"
      "\x4a\x46\x17\xc4\x6e\xef\x54\xa4\xee\x02\x3b\xac\xd3\xe5\x79\xb5\x8d\x79"
      "\xcc\x0f\x9c\x3f\xeb\xe0\x7d\xb7\xa0\xdd\xd9\x01\x7c\x0f\x35\x67\x69\x06"
      "\x1e\x36\xa4\x91\xac\x77\x00\x04\x38\xc9\x2e\xb4\xd5\x1e\x3a\x7f\xcc\xb2"
      "\xaf\xe4\x13\xb9\xdf\xe8\xf6\x64\xea\x7d\x3c\x6a\x50\xe8\x87\x8a\xa8\x00"
      "\x00\x73\xbe\x03\xe0\x14\x47\xdf\x1f\x33\xeb\x22\x0b\xb5\xbb\xdf\x69\x29"
      "\x3b\x6f\x82\xe8\xbb\xfd\xe4\x66\x02\xc0\xef\xbb\x0a\xec\x19\x24\x6e\x25"
      "\x72\xe5\x7c\xda\x6d\x08\xc9\x96\x10\x96\xc7\x0b\xd7\xd0\x48\xfe\xfe\x20"
      "\x20\xb6\x8a\xc9\x04\x5a\xb6\x0e\xde\xfa\xd2\x56\x96\xc3\x2e\x5a\x96\x57"
      "\x75\x62\x89\x9e\xb5\x00\x00\x00\x00\x00\x0b\x7d\x6e\x8d\xf1\xf1\xff\x6e"
      "\x54\xc2\x25\xf1\xc5\xfd\x35\xd4\x21\x08\xc4\x66\x2e\xa2\xb6\x61\x00\x00"
      "\x00\x00\x00\x00",
      256));
  NONFAILING(syz_usb_ep_write(r[0], 0, 0x100, 0x20000100));
}
int main(void)
{
