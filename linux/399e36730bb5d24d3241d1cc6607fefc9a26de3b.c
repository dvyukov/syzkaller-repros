...
void loop()
{
  ...
  NONFAILING(memcpy((void*)0x20000040,
                    "\x57\x1d\x7d\x91\x29\x11\x61\xbe\xff\xff\x45\x76\x3f\x7a"
                    "\x94\x67\x4c\x05\x00\xc6\xe5\x8b\xa2\x29\x94\x1a\x08\x32"
                    "\x57\xdf\xdd\x9d\x40\x37\xad\x64\x80\xba\xf0\xfd",
                    40));
  NONFAILING(*(uint64_t*)0x20000288 = 0x28);
  ...
  NONFAILING(STORE_BY_BITMASK(uint16_t, 0x2000000e, 7, 0, 3));
  NONFAILING(STORE_BY_BITMASK(uint16_t, 0x2000000e, 7, 3, 1));
  NONFAILING(STORE_BY_BITMASK(uint16_t, 0x2000000e, 4, 4, 12));
  NONFAILING(*(uint16_t*)0x20000010 = htobe16(0x8100));
  NONFAILING(STORE_BY_BITMASK(uint16_t, 0x20000012, 3, 0, 3));
  NONFAILING(STORE_BY_BITMASK(uint16_t, 0x20000012, 5, 3, 1));
  NONFAILING(STORE_BY_BITMASK(uint16_t, 0x20000012, 2, 4, 12));
  NONFAILING(*(uint16_t*)0x20000014 = htobe16(0x8848));
  NONFAILING(STORE_BY_BITMASK(uint32_t, 0x20000016, htobe32(2), 0, 8));
  NONFAILING(STORE_BY_BITMASK(uint32_t, 0x20000016, htobe32(0x100), 8, 1));
  NONFAILING(STORE_BY_BITMASK(uint32_t, 0x20000016, htobe32(7), 9, 3));
  NONFAILING(STORE_BY_BITMASK(uint32_t, 0x20000016, htobe32(0xa45a), 12, 20));
  NONFAILING(*(uint8_t*)0x2000001a = 0);
  NONFAILING(*(uint8_t*)0x2000001b = 0xaa);
  NONFAILING(memcpy((void*)0x2000001c, "N", 1));
  NONFAILING(memcpy((void*)0x2000001d, "\x2a\x34\xa5", 3));
  NONFAILING(*(uint16_t*)0x20000020 = htobe16(0xe86c));
  NONFAILING(*(uint32_t*)0x20000100 = 0);
  NONFAILING(*(uint32_t*)0x20000104 = 3);
  NONFAILING(*(uint32_t*)0x20000108 = 0x2d6);
  NONFAILING(*(uint32_t*)0x2000010c = 0x6d5);
  NONFAILING(*(uint32_t*)0x20000110 = 0x4ec);
  NONFAILING(*(uint32_t*)0x20000114 = 0x531);
  syz_emit_ethernet(0x22, 0x20000000, 0x20000100);
}
