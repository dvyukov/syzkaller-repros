...
// https://syzkaller.appspot.com/bug?id=18efe83d139c3ace5c78
// status:0
...
void execute_call(int call)
{
  ...
  case 5:
    ...
    *(uint16_t*)0x20000184 = 0x53d4;
    *(uint16_t*)0x20000186 = 0;
    *(uint32_t*)0x20000188 = r[4];
    *(uint16_t*)0x2000018c = 0;
    *(uint16_t*)0x2000018e = 0;
    syscall(__NR_poll, 0x20000180ul, 0x20000049ul, 0);
    break;
  case 6:
    *(uint32_t*)0x20006ffc = 0x200;
    syscall(__NR_setsockopt, r[3], 0x107, 0xf, 0x20006ffcul,
            0xe50fb6c50bc849c9ul);
    break;
  case 7:
  ...
  case 8:
    ...
    res = syscall(__NR_ioctl, r[5], 0x8933, 0x200000c0ul);
    if (res != -1)
      r[6] = *(uint32_t*)0x200000d0;
    break;
  case 9:
    *(uint16_t*)0x20000000 = 0x11;
    *(uint16_t*)0x20000002 = htobe16(0);
    *(uint32_t*)0x20000004 = r[6];
    ...
    *(uint8_t*)0x20000013 = 0;
    syscall(__NR_bind, r[3], 0x20000000ul, 0x14ul);
    break;
  case 10:
    memcpy((void*)0x20000180, "\x17\x03\x04\x00", 4);
    syscall(__NR_sendto, -1, 0x20000180ul, 4ul, 0ul, 0ul, 0ul);
    break;
  case 11:
    syscall(__NR_write, r[1], 0x20000180ul, 0xfffffed2ul);
    break;
  case 12:
