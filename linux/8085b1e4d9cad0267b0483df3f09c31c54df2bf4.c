...
void execute_call(int call)
{
  ...
  case 2:
    ...
    *(uint32_t*)0x20000084 = htobe32(0);
    syscall(__NR_sendto, r[0], 0, 0, 0x1000000020000000, 0x20000080, 0x10);
    break;
  case 3:
    syscall(__NR_sendto, r[0], 0x20000240, 0x13f698e4b9e296e3, 0, 0,
            0xffffffffffffff06);
    break;
  case 4:
    *(uint32_t*)0x20000240 = 1;
    syscall(__NR_setsockopt, r[0], 6, 0x13, 0x20000240, 4);
    break;
  case 5:
    *(uint32_t*)0x20000180 = 2;
    syscall(__NR_setsockopt, r[0], 6, 0x14, 0x20000180, 4);
    break;
  }
}
int main(void)
