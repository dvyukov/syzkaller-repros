...
// https://syzkaller.appspot.com/bug?id=95eec132c4bd9b1d8430
// status:0
...
void execute_call(int call)
{
  ...
  case 14:
    ...
    *(uint64_t*)0x20000180 = 0x20004bc0;
    *(uint32_t*)0x20004bc0 = 0x24;
    *(uint16_t*)0x20004bc4 = 0x11;
    *(uint16_t*)0x20004bc6 = 0xd27;
    *(uint32_t*)0x20004bc8 = 0;
    *(uint32_t*)0x20004bcc = 0;
    *(uint8_t*)0x20004bd0 = 0;
    *(uint8_t*)0x20004bd1 = 0;
    *(uint16_t*)0x20004bd2 = 0;
    *(uint32_t*)0x20004bd4 = r[3];
    *(uint16_t*)0x20004bd8 = 0;
    *(uint16_t*)0x20004bda = 0;
    *(uint16_t*)0x20004bdc = 0;
    *(uint16_t*)0x20004bde = 0;
    *(uint16_t*)0x20004be0 = 0;
    *(uint16_t*)0x20004be2 = 0;
