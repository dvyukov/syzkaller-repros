...
// https://syzkaller.appspot.com/bug?id=cc8495ea4052b9b79b72
// status:0
...
void loop(void)
{
  ...
  *(uint16_t*)0x200006e4 = 0xb;
  *(uint16_t*)0x200006e6 = 1;
  memcpy((void*)0x200006e8, "taprio\000", 7);
  *(uint16_t*)0x200006f0 = 0x8c;
  *(uint16_t*)0x200006f2 = 2;
  *(uint16_t*)0x200006f4 = 0x56;
  *(uint16_t*)0x200006f6 = 1;
  *(uint8_t*)0x200006f8 = 2;
  ...
  *(uint16_t*)0x20000756 = 4;
  *(uint32_t*)0x20000758 = 0x80000001;
  *(uint16_t*)0x2000075c = 5;
  *(uint16_t*)0x2000075e = 2;
  *(uint8_t*)0x20000760 = 0x80;
  *(uint16_t*)0x20000764 = 8;
  *(uint16_t*)0x20000766 = 4;
  *(uint32_t*)0x20000768 = 0x80;
  *(uint16_t*)0x2000076c = 5;
  *(uint16_t*)0x2000076e = 2;
  *(uint8_t*)0x20000770 = 0x81;
  *(uint16_t*)0x20000774 = 8;
  *(uint16_t*)0x20000776 = 5;
  *(uint32_t*)0x20000778 = 0;
  *(uint64_t*)0x20000788 = 0xbc;
