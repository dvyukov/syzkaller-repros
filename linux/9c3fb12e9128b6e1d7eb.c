...
// https://syzkaller.appspot.com/bug?id=9c3fb12e9128b6e1d7eb
// status:0
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000080, "syz1\000", 5));
    res = syscall(__NR_openat, r[0], 0x20000080ul, 0x200002ul, 0ul);
    if (res != -1)
      r[1] = res;
    break;
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_sendfile, r[2], r[2], 0ul, 3ul);
    break;
  }
}
int main(void)
