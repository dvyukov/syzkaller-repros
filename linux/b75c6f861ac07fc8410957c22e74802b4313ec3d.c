...
// https://syzkaller.appspot.com/bug?id=b75c6f861ac07fc8410957c22e74802b4313ec3d
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(*(uint32_t*)0x20000200 = 0x12);
    NONFAILING(*(uint32_t*)0x20000204 = 1);
    NONFAILING(*(uint32_t*)0x20000208 = 4);
    NONFAILING(*(uint32_t*)0x2000020c = 1);
    ...
    NONFAILING(*(uint32_t*)0x20000230 = 0xffffff9c);
    NONFAILING(*(uint32_t*)0x20000234 = 0);
    NONFAILING(*(uint32_t*)0x20000238 = 0);
    syscall(__NR_bpf, 0, 0x20000200, 0x3c);
    break;
  case 1:
    syscall(__NR_socket, 0x21, 2, 2);
    break;
  case 2:
  ...
  case 3:
    ...
    syscall(__NR_setsockopt, r[0], 6, 0x13, 0x20000040, 4);
    break;
  case 4:
  ...
  case 5:
    ...
    NONFAILING(*(uint32_t*)0x20000018 = 0x400000);
    ...
    syscall(__NR_bpf, 0, 0x20000000, 0x3c);
    break;
  case 6:
    ...
    syscall(__NR_bpf, 2, 0x20003000, 0x2c);
    break;
  case 7:
    NONFAILING(memcpy((void*)0x20000080, "tls\000", 4));
    syscall(__NR_setsockopt, r[0], 6, 0x1f, 0x20000080, 4);
    break;
  case 8:
    res = syscall(__NR_socket, 0xa, 1, 0);
    if (res != -1)
  ...
  case 13:
    ...
    syscall(__NR_setsockopt, r[1], 6, 0x1f, 0x20000200, 4);
    break;
  case 14:
