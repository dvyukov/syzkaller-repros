...
// https://syzkaller.appspot.com/bug?id=d9ae59d4662c941e39c6
// status:6
...
void execute_call(int call)
{
  ...
  case 5:
    ...
    syscall(__NR_creat, 0x20000280ul, 1ul);
    break;
  case 6:
    ...
    break;
  case 7:
    NONFAILING(memcpy((void*)0x20000000, "fdinfo/3\000", 9));
  ...
  case 8:
    ...
    break;
  case 9:
    syscall(__NR_sendfile, r[1], r[0], 0ul, 0x283ul);
    break;
  case 10:
    NONFAILING(memcpy((void*)0x20000040, "personality\000", 12));
  ...
  case 12:
    ...
    break;
  case 13:
    syscall(__NR_shutdown, -1, 0ul);
    break;
  case 14:
    syscall(__NR_socket, 2ul, 0x80001ul, 0x84);
    break;
  case 15:
    syscall(__NR_sendfile, r[3], r[2], 0ul, 0x200020000000009cul);
    break;
  case 16:
    syscall(__NR_ioctl, -1, 0x8030560aul, 0ul);
    break;
  }
}
int main(void)
