...
// https://syzkaller.appspot.com/bug?id=04e804c8c2224b6a9497
// status:0
...
void execute_one(void)
{
  ...
  syscall(__NR_write, r[0], 0x20000200ul, 2ul);
  ...
  if (res != -1)
    r[1] = res;
  NONFAILING(*(uint16_t*)0x20000080 = 0x1f);
  NONFAILING(*(uint16_t*)0x20000082 = 0);
  NONFAILING(*(uint16_t*)0x20000084 = 1);
  syscall(__NR_bind, r[1], 0x20000080ul, 6ul);
}
int main(void)
{
