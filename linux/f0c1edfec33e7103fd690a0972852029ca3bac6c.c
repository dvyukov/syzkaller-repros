...
// https://syzkaller.appspot.com/bug?id=f0c1edfec33e7103fd690a0972852029ca3bac6c
// status:open
...
void loop(void)
{
  ...
  *(uint32_t*)0x20000144 = htobe32(-1);
  syscall(__NR_bind, r[0], 0x20000140, 0x10);
  ...
  *(uint8_t*)0x20000107 = 0xa;
  syscall(__NR_sendto, r[0], 0, 0xffffffffffffff94, 0x20000802, 0x20000100,
          0x10);
}
int main(void)
{
