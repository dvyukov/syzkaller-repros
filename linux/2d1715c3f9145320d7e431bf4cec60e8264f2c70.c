// WARNING in add_uevent_var (2)
// https://syzkaller.appspot.com/bug?id=2d1715c3f9145320d7e431bf4cec60e8264f2c70
// status:invalid
...
int main(void)
{
  ...
  *(uint32_t*)0x20000002 = 0x22;
  ...
  memcpy((void*)0x2000000d, "\x17\xe7\x8f\x44", 4);
  ...
  memcpy((void*)0x20000012, "\x97\x01", 2);
  ...
  memcpy((void*)0x2000001f, "\x09\x00\x7a\x15", 4);
  STORE_BY_BITMASK(uint8_t, , 0x20000023, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000023, 0, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000023, 0, 4, 4);
  memcpy((void*)0x20000024, "\x06\x00\xff\x83", 4);
