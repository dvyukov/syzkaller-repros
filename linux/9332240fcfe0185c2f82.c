// SYZFAIL: netlink_send_ext: short netlink read
// https://syzkaller.appspot.com/bug?id=9332240fcfe0185c2f82
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_setsockopt, r[0], 0x29, 0x3b, 0ul, 8ul);
    break;
  case 2:
    syscall(__NR_setsockopt, r[0], 0x29, 0x20, 0ul, 0ul);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000200, "ethtool\000", 8));
    NONFAILING(syz_genetlink_get_family_id(0x20000200, -1));
    break;
  case 4:
    syscall(__NR_sendmsg, -1, 0ul, 1ul);
    break;
  case 5:
    syscall(__NR_setsockopt, r[0], 0x29, 0x37, 0ul, 8ul);
    break;
  case 6:
  ...
  case 9:
    ...
    break;
  case 10:
    NONFAILING(*(uint16_t*)0x20000380 = 0xa);
    NONFAILING(*(uint16_t*)0x20000382 = htobe16(0x4e22));
    NONFAILING(*(uint32_t*)0x20000384 = htobe32(0));
    NONFAILING(*(uint64_t*)0x20000388 = htobe64(0));
    NONFAILING(*(uint64_t*)0x20000390 = htobe64(1));
    NONFAILING(*(uint32_t*)0x20000398 = 0);
    syscall(__NR_sendto, r[1], 0ul, 0ul, 0x240540c3ul, 0x20000380ul, 0x1cul);
    break;
  case 11:
    NONFAILING(memset((void*)0x200000c0, 9, 1));
    syscall(__NR_sendto, r[1], 0x200000c0ul, 1ul, 0x20042041ul, 0ul, 0ul);
    break;
  case 12:
    syscall(__NR_poll, 0ul, 0ul, 0x200);
    break;
  }
}
int main(void)
