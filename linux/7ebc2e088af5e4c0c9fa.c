...
// https://syzkaller.appspot.com/bug?id=7ebc2e088af5e4c0c9fa
// status:6
...
void loop(void)
{
  ...
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x20000200, "geneve0\000\000\000\000\000\000\000\000\000", 16);
  *(uint32_t*)0x20000210 = 0;
  res = syscall(__NR_ioctl, r[1], 0x8933, 0x20000200ul);
  if (res != -1)
  ...
  *(uint16_t*)0x20000060 = 0x1c;
  STORE_BY_BITMASK(uint16_t, , 0x20000062, 0x12, 0, 14);
