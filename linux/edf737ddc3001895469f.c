...
// https://syzkaller.appspot.com/bug?id=edf737ddc3001895469f
// status:0
...
void execute_call(int call)
{
  switch (call) {
  case 0:
    NONFAILING(*(uint32_t*)0x20000084 = 0x6e69);
    NONFAILING(*(uint32_t*)0x20000088 = 2);
    NONFAILING(*(uint32_t*)0x2000008c = 1);
    NONFAILING(*(uint32_t*)0x20000090 = 0x80014d);
    ...
    syscall(__NR_io_uring_setup, 0x1f7b, 0x20000080ul);
    break;
  }
}
int main(void)
