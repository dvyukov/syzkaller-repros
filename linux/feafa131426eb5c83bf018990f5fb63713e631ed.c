...
// https://syzkaller.appspot.com/bug?id=feafa131426eb5c83bf018990f5fb63713e631ed
// status:open
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000018 = 0;
  ...
  memcpy((void*)0x20000080, "\x12\x01\x00\x00\x80\xdd\x27\x20\xe6\x0f\x00\x98"
                            "\xb8\x3c\x00\x00\x00\x01\x09\x02\x12\x00\x01\x00"
                            "\x00\x00\x00\x09\x04\x9f\x00\x00\x7e\x05\x22\x00",
         36);
  res = syz_usb_connect(0, 0x3e5, 0x20000080, 0);
  if (res != -1)
    r[1] = res;
  syz_usb_control_io(r[1], 0, 0);
  *(uint32_t*)0x20001740 = 0xac;
  *(uint64_t*)0x20001744 = 0;
  *(uint64_t*)0x2000174c = 0;
  *(uint64_t*)0x20001754 = 0;
  *(uint64_t*)0x2000175c = 0;
  *(uint64_t*)0x20001764 = 0;
  *(uint64_t*)0x2000176c = 0;
  *(uint64_t*)0x20001774 = 0;
  *(uint64_t*)0x2000177c = 0;
  *(uint64_t*)0x20001784 = 0;
  *(uint64_t*)0x2000178c = 0;
  *(uint64_t*)0x20001794 = 0;
  *(uint64_t*)0x2000179c = 0;
  *(uint64_t*)0x200017a4 = 0;
  *(uint64_t*)0x200017ac = 0;
  *(uint64_t*)0x200017b4 = 0x20001580;
  *(uint8_t*)0x20001580 = 0x40;
  *(uint8_t*)0x20001581 = 0x13;
  *(uint32_t*)0x20001582 = 6;
  *(uint8_t*)0x20001586 = 0xaa;
  *(uint8_t*)0x20001587 = 0xaa;
  *(uint8_t*)0x20001588 = 0xaa;
  *(uint8_t*)0x20001589 = 0xaa;
  *(uint8_t*)0x2000158a = 0xaa;
  *(uint8_t*)0x2000158b = 0xbb;
  *(uint64_t*)0x200017bc = 0;
  *(uint64_t*)0x200017c4 = 0;
  *(uint64_t*)0x200017cc = 0;
  *(uint64_t*)0x200017d4 = 0;
  *(uint64_t*)0x200017dc = 0;
  *(uint64_t*)0x200017e4 = 0;
  syz_usb_control_io(r[1], 0, 0x20001740);
  ...
  *(uint64_t*)0x200004a4 = 0;
  syz_usb_control_io(r[1], 0, 0x20000480);
  syz_usb_control_io(r[1], 0, 0);
  syz_usb_control_io(r[1], 0, 0);
  syz_usb_control_io(r[1], 0, 0);
  syz_usb_control_io(r[1], 0, 0);
  *(uint32_t*)0x20000300 = 0x44;
  *(uint64_t*)0x20000304 = 0x200000c0;
  *(uint8_t*)0x200000c0 = 0;
  *(uint8_t*)0x200000c1 = 0;
  *(uint32_t*)0x200000c2 = 0;
  ...
  *(uint64_t*)0x2000033c = 0;
  syz_usb_control_io(r[1], 0, 0x20000300);
  *(uint32_t*)0x20000380 = 0x2c;
  *(uint64_t*)0x20000384 = 0;
  *(uint64_t*)0x2000038c = 0x20000280;
  *(uint8_t*)0x20000280 = 0;
  *(uint8_t*)0x20000281 = 0xa;
  *(uint32_t*)0x20000282 = 1;
  *(uint8_t*)0x20000286 = 3;
  *(uint64_t*)0x20000394 = 0x200002c0;
  *(uint8_t*)0x200002c0 = 0;
  *(uint8_t*)0x200002c1 = 8;
  *(uint32_t*)0x200002c2 = 1;
  *(uint8_t*)0x200002c6 = 0x1f;
  *(uint64_t*)0x2000039c = 0x20000300;
  *(uint8_t*)0x20000300 = 0x20;
  *(uint8_t*)0x20000301 = 1;
  *(uint32_t*)0x20000302 = 0;
  *(uint64_t*)0x200003a4 = 0;
  syz_usb_control_io(r[1], 0, 0x20000380);
}
int main(void)
{
