...
// https://syzkaller.appspot.com/bug?id=92833989808cfa785fb7
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    *(uint64_t*)0x20000290 = 0x200005c0;
  ...
  case 4:
    ...
    *(uint64_t*)0x20000000 = 0x20000380;
    memcpy((void*)0x20000380,
           "\x3c\x00\x00\x00\x10\x00\x85\x46\x0e\x05\x00\x00\x00\x00\xff\x01"
           "\x00\x00\x00\x00",
           20);
    *(uint32_t*)0x20000394 = r[2];
    memcpy(
        (void*)0x20000398,
        "\x01\xdf\xb3\xff\xcc\x22\x00\x00\x1c\x00\x12\x00\x0c\x00\x01\x00\x62"
  ...
  case 6:
    *(uint32_t*)0x20000440 = 0x14;
    res = syscall(__NR_getsockname, r[1], 0x20000100ul, 0x20000440ul);
    if (res != -1)
  ...
  case 9:
    ...
    *(uint32_t*)0x200001f0 = 4;
    syscall(__NR_sendmsg, r[6], 0x200001c0ul, 0x24000010ul);
    break;
  case 10:
  ...
  case 11:
    ...
    *(uint64_t*)0x200006c0 = 0x20000700;
    *(uint32_t*)0x20000700 = 0x34;
    ...
    *(uint32_t*)0x20000714 = r[7];
    *(uint32_t*)0x20000718 = 0x60749;
    *(uint32_t*)0x2000071c = 0;
    *(uint16_t*)0x20000720 = 0x14;
    ...
    *(uint16_t*)0x20000724 = 0xb;
    *(uint16_t*)0x20000726 = 1;
    memcpy((void*)0x20000728, "batadv\000", 7);
    ...
    *(uint32_t*)0x200004f0 = 0;
    syscall(__NR_sendmsg, r[5], 0x200004c0ul, 0x20004000ul);
    break;
  case 12:
    *(uint64_t*)0x20000040 = 0;
    *(uint32_t*)0x20000048 = 0x6d8e0600;
    *(uint64_t*)0x20000050 = 0x20000140;
    *(uint64_t*)0x20000140 = 0x20000600;
    *(uint32_t*)0x20000600 = 0x54;
