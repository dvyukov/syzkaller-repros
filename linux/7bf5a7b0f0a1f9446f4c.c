...
// https://syzkaller.appspot.com/bug?id=7bf5a7b0f0a1f9446f4c
// status:6
...
void execute_one(void)
{
  ...
  NONFAILING(memcpy(
      (void*)0x20001240,
      "\x12\x01\x00\x00\x00\x00\x00\x40\x6a\x05\x61\x00\x40\x00\x00\x00\x00\x01"
      "\x09\x02\x24\x00\x01\x00\x00\x00\x00\x09\x04\x00\x00\x01\x03\x01\x00\x00"
      "\x09\x21\x00\x00\x00\x01\x22\x01\x00\x09\x05\x81\x03\x00\x04\x02\x00\x00"
      "\xf8\xf5\xc0\x09\x05\x42\xee\x66\x92\x10\x62\xd2\x15\x92\x17\x5f\xa7\x2e"
      "\xe5\x37\x8e\x87\x9f\xe2\xa5\x72\x9c\x9c\x73\x9a\xae\x05\x49\x31\xa0\x77"
      "\x19\x1e\x1f\x75\xd1\x10\x00\x24\x79\x37\x94\x8e",
      102));
  ...
  if (res != -1)
    r[1] = res;
  syscall(__NR_ioctl, r[1], 0x80284504, -1ul);
  syscall(__NR_ioctl, r[1], 0x40044590, 0ul);
  syscall(__NR_ioctl, r[1], 0x80404532, 0ul);
