...
// https://syzkaller.appspot.com/bug?id=1e187f7a299448d2427a37b17a42f71592544fd6
// status:fixed
...
int main(void)
{
  ...
  *(uint8_t*)0x20000044 = 0x9f;
  *(uint8_t*)0x20000045 = 0x7d;
  *(uint8_t*)0x20000046 = 0x2b;
  *(uint8_t*)0x20000047 = 8;
  *(uint16_t*)0x20000048 = 0x1286;
  *(uint16_t*)0x2000004a = 0x2046;
  *(uint16_t*)0x2000004c = 0x331a;
