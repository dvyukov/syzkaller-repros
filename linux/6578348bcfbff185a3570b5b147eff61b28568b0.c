...
void execute_call(int call)
{
  ...
  case 4:
    ...
    *(uint32_t*)0x2005fffc = 0;
    syscall(__NR_sendto, r[1], 0x20000040, 1, 0, 0x2005ffe4, 0x1c);
    break;
  case 5:
  ...
  case 7:
    *(uint64_t*)0x20000000 = 0x20000140;
    memcpy((void*)0x20000140,
           ...
           "\x0a\x84\x47\x00\x69\xff\xe0\x06\x4e\x23\x0f\x00\x00\x00\x00\xa2"
    ...
    *(uint64_t*)0x20000008 = 0x48;
    syscall(__NR_writev, r[2], 0x20000000, 1);
    break;
  }
}
int main(void)
