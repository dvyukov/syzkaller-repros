// KASAN: use-after-free Read in tipc_udp_xmit
// https://syzkaller.appspot.com/bug?id=88458b50d3fe169b97b5
// status:0
...
void execute_call(int call)
{
  ...
  case 6:
    ...
    NONFAILING(*(uint64_t*)0x20000080 = 0x200017c0);
    NONFAILING(*(uint32_t*)0x200017c0 = 0x6c);
    NONFAILING(*(uint16_t*)0x200017c4 = r[3]);
    NONFAILING(*(uint16_t*)0x200017c6 = 1);
    NONFAILING(*(uint32_t*)0x200017c8 = 0);
    NONFAILING(*(uint32_t*)0x200017cc = 0);
    NONFAILING(*(uint8_t*)0x200017d0 = 3);
    NONFAILING(*(uint8_t*)0x200017d1 = 0);
    NONFAILING(*(uint16_t*)0x200017d2 = 0);
    NONFAILING(*(uint16_t*)0x200017d4 = 0x58);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200017d6, 1, 0, 14));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200017d7, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200017d7, 1, 7, 1));
    NONFAILING(*(uint16_t*)0x200017d8 = 0xd);
    NONFAILING(*(uint16_t*)0x200017da = 1);
    NONFAILING(memcpy((void*)0x200017dc, "udp:syz0\000", 9));
    NONFAILING(*(uint16_t*)0x200017e8 = 0x44);
    NONFAILING(*(uint16_t*)0x200017ea = 4);
    NONFAILING(*(uint16_t*)0x200017ec = 0x20);
    NONFAILING(*(uint16_t*)0x200017ee = 1);
    NONFAILING(*(uint16_t*)0x200017f0 = 0xa);
    NONFAILING(*(uint16_t*)0x200017f2 = htobe16(0));
    NONFAILING(*(uint32_t*)0x200017f4 = htobe32(0));
    NONFAILING(*(uint64_t*)0x200017f8 = htobe64(0));
    NONFAILING(*(uint64_t*)0x20001800 = htobe64(1));
    NONFAILING(*(uint32_t*)0x20001808 = 0);
    NONFAILING(*(uint16_t*)0x2000180c = 0x20);
    NONFAILING(*(uint16_t*)0x2000180e = 2);
    NONFAILING(*(uint16_t*)0x20001810 = 0xa);
    NONFAILING(*(uint16_t*)0x20001812 = htobe16(0));
    NONFAILING(*(uint32_t*)0x20001814 = htobe32(0));
    NONFAILING(*(uint8_t*)0x20001818 = 0xfe);
    NONFAILING(*(uint8_t*)0x20001819 = 0x80);
    NONFAILING(memset((void*)0x2000181a, 0, 13));
    NONFAILING(*(uint8_t*)0x20001827 = 0);
    NONFAILING(*(uint32_t*)0x20001828 = 0);
    NONFAILING(*(uint64_t*)0x20000088 = 0x6c);
  ...
  case 7:
    ...
    NONFAILING(*(uint64_t*)0x20000780 = 0x20000280);
    NONFAILING(*(uint32_t*)0x20000280 = 0x28);
    NONFAILING(*(uint16_t*)0x20000284 = r[3]);
    NONFAILING(*(uint16_t*)0x20000286 = 0xdc43);
    NONFAILING(*(uint32_t*)0x20000288 = 0);
    NONFAILING(*(uint32_t*)0x2000028c = 5);
    NONFAILING(*(uint8_t*)0x20000290 = 2);
    NONFAILING(*(uint8_t*)0x20000291 = 0);
    NONFAILING(*(uint16_t*)0x20000292 = 0);
    NONFAILING(*(uint16_t*)0x20000294 = 0x14);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000296, 1, 0, 14));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000297, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000297, 1, 7, 1));
    NONFAILING(*(uint16_t*)0x20000298 = 0xd);
    NONFAILING(*(uint16_t*)0x2000029a = 1);
    NONFAILING(memcpy((void*)0x2000029c, "udp:syz0\000", 9));
    NONFAILING(*(uint64_t*)0x20000788 = 0x28);
    ...
    syscall(__NR_sendmsg, r[1], 0x200007c0ul, 0ul);
    break;
  }
}
int main(void)
