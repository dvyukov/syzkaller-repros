// INFO: task hung in __drain_all_pages (2)
// https://syzkaller.appspot.com/bug?id=ef4bb06ce1e14f09f852
// status:2
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    *(uint32_t*)0x20011fd4 = 3;
    *(uint32_t*)0x20011fd8 = 4;
    *(uint32_t*)0x20011fdc = 4;
    *(uint32_t*)0x20011fe0 = 0x80007cb;
    *(uint32_t*)0x20011fe4 = 0;
    *(uint32_t*)0x20011fe8 = 0xffffff9c;
    *(uint32_t*)0x20011fec = 0x1000;
    memset((void*)0x20011ff0, 0, 16);
    *(uint32_t*)0x20012000 = 0;
    *(uint32_t*)0x20012004 = -1;
    *(uint32_t*)0x20012008 = 0;
    *(uint32_t*)0x2001200c = 0;
    *(uint32_t*)0x20012010 = 0;
    syscall(__NR_bpf, 0ul, 0x20011fd4ul, 0x40ul);
    break;
  case 1:
  ...
  case 3:
    ...
    break;
  case 4:
    syscall(__NR_ioctl, r[0], 0x4008af20, 0ul);
    break;
  }
}
int main(void)
