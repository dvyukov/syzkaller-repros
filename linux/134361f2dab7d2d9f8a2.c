...
// https://syzkaller.appspot.com/bug?id=134361f2dab7d2d9f8a2
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_poll, 0ul, 0ul, 0x101);
    break;
  case 2:
    res = -1;
  ...
  case 3:
    ...
    NONFAILING(*(uint16_t*)0x20000042 = 7);
    NONFAILING(memset((void*)0x20000044, 170, 5));
