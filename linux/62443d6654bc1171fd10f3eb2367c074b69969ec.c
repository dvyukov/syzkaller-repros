// KMSAN: uninit-value in print_stack_trace
// https://syzkaller.appspot.com/bug?id=62443d6654bc1171fd10f3eb2367c074b69969ec
// status:invalid
...
void execute_call(int call)
{
  ...
  case 1:
    *(uint32_t*)0x200000c0 = 0x74;
    syscall(__NR_setsockopt, r[0], 6, 0x80000000000002, 0x200000c0, 4);
    break;
  case 2:
    *(uint16_t*)0x20000180 = 2;
    *(uint16_t*)0x20000182 = htobe16(0x4e23);
    *(uint32_t*)0x20000184 = htobe32(0xe0000001);
    syscall(__NR_bind, r[0], 0x20000180, 0x10);
    break;
  case 3:
  ...
  case 4:
    ...
    *(uint8_t*)0x20e68007 = 0xaa;
    syscall(__NR_sendto, r[0], 0, 0, 0x200007fd, 0x20e68000, 0x10);
    break;
  case 5:
    syscall(__NR_openat, 0xffffffffffffff9c, 0, 0, 0);
    break;
  case 6:
    memcpy((void*)0x200001c0, "\xa6", 1);
    syscall(__NR_sendto, r[0], 0x200001c0, 1, 0, 0, 0);
    break;
  case 7:
    *(uint32_t*)0x20000080 = 0xda9;
    syscall(__NR_setsockopt, r[0], 1, 8, 0x20000080, 4);
    break;
  case 8:
    *(uint32_t*)0x20000100 = -1;
    *(uint16_t*)0x20000104 = 0;
    syscall(__NR_write, r[0], 0x20000100, 0xff5a);
    break;
  }
}
int main(void)
