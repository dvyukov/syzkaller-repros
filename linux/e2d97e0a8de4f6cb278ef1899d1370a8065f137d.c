...
// https://syzkaller.appspot.com/bug?id=e2d97e0a8de4f6cb278ef1899d1370a8065f137d
// status:open
...
void execute_call(int call)
{
  ...
  case 5:
    ...
    syscall(__NR_mount, 0, 0x200002c0, 0, 0x100000, 0);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000180, "./file0/file0\000", 14));
    syscall(__NR_mount, 0x20000000, 0x20000180, 0, 0x2001002, 0);
    break;
  case 7:
  ...
  case 8:
    ...
    syscall(__NR_mount, 0x20000000, 0x20000300, 0, 0x5004, 0);
    break;
  case 9:
    NONFAILING(memcpy((void*)0x200004c0, "./file0/file0\000", 14));
    syscall(__NR_mount, 0x20000000, 0x200004c0, 0, 0x588e, 0);
    break;
  case 10:
    NONFAILING(memcpy((void*)0x200005c0, "./file0/file0\000", 14));
    NONFAILING(memcpy((void*)0x20000a40, "bpf\000", 4));
    syscall(__NR_mount, 0, 0x200005c0, 0x20000a40, 0, 0);
    break;
  case 11:
  ...
  case 12:
    ...
    break;
  case 13:
    NONFAILING(memcpy((void*)0x20000140, "mountinfo\000", 10));
  ...
  case 14:
    ...
    NONFAILING(memcpy((void*)0x20000300, "trans=fd,", 9));
    NONFAILING(memcpy((void*)0x20000309, "rfdno", 5));
    NONFAILING(*(uint8_t*)0x2000030e = 0x3d);
    NONFAILING(sprintf((char*)0x2000030f, "0x%016llx", (long long)r[0]));
    NONFAILING(*(uint8_t*)0x20000321 = 0x2c);
    NONFAILING(memcpy((void*)0x20000322, "wfdno", 5));
    NONFAILING(*(uint8_t*)0x20000327 = 0x3d);
    NONFAILING(sprintf((char*)0x20000328, "0x%016llx", (long long)-1));
    NONFAILING(*(uint8_t*)0x2000033a = 0x2c);
    NONFAILING(*(uint8_t*)0x2000033b = 0);
    syscall(__NR_mount, 0, 0x20000200, 0x20000000, 0, 0x20000300);
    break;
  }
}
int main(void)
