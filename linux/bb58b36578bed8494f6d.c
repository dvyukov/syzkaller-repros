...
// https://syzkaller.appspot.com/bug?id=bb58b36578bed8494f6d
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2025c028, 1, 5, 1));
  ...
  case 3:
    ...
    NONFAILING(*(uint16_t*)0x20000482 = htobe16(0));
    NONFAILING(*(uint32_t*)0x20000484 = htobe32(0xe0000001));
  ...
  case 4:
    ...
    break;
  case 5:
    NONFAILING(*(uint32_t*)0x20000300 = htobe32(0xe0000001));
    NONFAILING(*(uint8_t*)0x20000304 = 0xac);
    NONFAILING(*(uint8_t*)0x20000305 = 0x14);
    NONFAILING(*(uint8_t*)0x20000306 = 0x14);
    NONFAILING(*(uint8_t*)0x20000307 = 0xaa);
    NONFAILING(*(uint32_t*)0x20000308 = 0);
    syscall(__NR_setsockopt, r[1], 0, 0x27, 0x20000300ul, 0xcul);
    break;
  case 6:
