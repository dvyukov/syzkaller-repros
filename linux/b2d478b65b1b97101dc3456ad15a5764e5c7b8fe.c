...
void execute_one()
{
  ...
  *(uint32_t*)0x20000bf0 = 0x20004805;
  syscall(__NR_sendmsg, r[1], 0x20000bc0, 0x4010);
  *(uint32_t*)0x20000500 = 3;
  *(uint32_t*)0x20000504 = 0x70;
  *(uint8_t*)0x20000508 = 0x67;
  *(uint8_t*)0x20000509 = -1;
  *(uint8_t*)0x2000050a = 1;
  *(uint8_t*)0x2000050b = 6;
  *(uint32_t*)0x2000050c = 0;
  *(uint64_t*)0x20000510 = 0x78b1;
  *(uint64_t*)0x20000518 = 1;
  *(uint64_t*)0x20000520 = 0;
  STORE_BY_BITMASK(uint64_t, 0x20000528, 0x4992c766, 0, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 0xff, 1, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 0x81, 2, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 0x100, 3, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 0x40, 4, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 3, 5, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 9, 6, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 8, 7, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 1, 8, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 0x10000, 9, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 0x1182, 10, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 6, 11, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 0x90e, 12, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 9, 13, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 0x7ff, 14, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 0x5da, 15, 2);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 8, 17, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 0, 18, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 0x30, 19, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 0x20, 20, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 0x7fffffff, 21, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 6, 22, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 0x401, 23, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 2, 24, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 0x1000, 25, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 0x8001, 26, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 0x1ff, 27, 1);
  STORE_BY_BITMASK(uint64_t, 0x20000528, 0xfffffffffffffff8, 28, 1);
  ...
  *(uint64_t*)0x20000548 = 0x1ab23;
  *(uint64_t*)0x20000550 = 0x3f;
  *(uint32_t*)0x20000558 = 8;
  *(uint32_t*)0x2000055c = 5;
  *(uint64_t*)0x20000560 = 6;
  *(uint32_t*)0x20000568 = 0;
  *(uint16_t*)0x2000056c = 6;
  *(uint16_t*)0x2000056e = 0;
  res = syscall(__NR_perf_event_open, 0x20000500, -1, 0x10, r[0], 1);
  if (res != -1)
    r[2] = res;
  ...
  *(uint64_t*)0x20000690 = 0x20000600;
  memcpy((void*)0x20000600, "syzkaller", 10);
  *(uint32_t*)0x20000698 = 0;
  *(uint32_t*)0x2000069c = 0x30;
  *(uint64_t*)0x200006a0 = 0x20000640;
  *(uint32_t*)0x200006a8 = 0x41f00;
  ...
  *(uint32_t*)0x200006c0 = 0;
  res = syscall(__NR_bpf, 5, 0x20000680, 0x48);
  if (res != -1)
    r[3] = res;
  syscall(__NR_ioctl, r[2], 0x40042408, r[3]);
  *(uint64_t*)0x20000000 = 0x20000080;
  memcpy((void*)0x20000080, "./file0/file0", 14);
  *(uint32_t*)0x20000008 = r[0];
  syscall(__NR_bpf, 6, 0x20000000, 0x10);
  *(uint64_t*)0x20000380 = 0x20000c00;
  *(uint16_t*)0x20000c00 = 3;
  memcpy((void*)0x20000c02, "\x02\xf4\x7b\x37\x23\xe0\x3d", 7);
  *(uint32_t*)0x20000c0c = 0;
  *(uint32_t*)0x20000388 = 0xfffffe7c;
  *(uint64_t*)0x20000390 = 0x20000200;
  *(uint64_t*)0x20000398 = 0;
  *(uint64_t*)0x200003a0 = 0x20000040;
  *(uint64_t*)0x200003a8 = 0;
  *(uint32_t*)0x200003b0 = 0x24004046;
  syscall(__NR_sendmsg, r[1], 0x20000380, 0x4008001);
