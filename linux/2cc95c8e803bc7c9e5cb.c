...
// https://syzkaller.appspot.com/bug?id=2cc95c8e803bc7c9e5cb
// status:3
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    *(uint64_t*)0x20000270 = 0x4400;
    syz_mount_image(0x20000080, 0x20000100, 0x200000, 5, 0x20000200, 0,
                    0x200000c0);
    break;
  case 1:
  ...
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_write, r[0], 0x20000040ul, 0x3dul);
    break;
  case 4:
    *(uint32_t*)0x20000000 = 0;
    *(uint32_t*)0x20000004 = -1;
    *(uint64_t*)0x20000008 = 0xf4ffffff;
    *(uint64_t*)0x20000010 = 0xfffffffe;
