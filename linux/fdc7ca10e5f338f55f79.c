...
// https://syzkaller.appspot.com/bug?id=fdc7ca10e5f338f55f79
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint64_t*)0x20000190 = 0x50d);
    ...
    NONFAILING(*(uint64_t*)0x200001e0 = 7);
    ...
    break;
  case 1:
    NONFAILING(*(uint64_t*)0x200001c0 = 0x401);
    NONFAILING(*(uint64_t*)0x200001c8 = 0x400000008d);
  ...
  case 6:
    ...
    syscall(__NR_ioctl, r[1], 0x4020ae46ul, 0x20000400ul);
    break;
  case 7:
  ...
  case 8:
    NONFAILING(*(uint64_t*)0x200001c0 = 0);
    NONFAILING(*(uint32_t*)0x200001c8 = 0x11c000);
    NONFAILING(*(uint32_t*)0x200001cc = 0);
    syscall(__NR_ioctl, r[1], 0x4010ae67ul, 0x200001c0ul);
    break;
  case 9:
    syz_kvm_setup_cpu(-1, r[2], 0x20000000, 0, 0, 0, 0, 0);
    break;
  case 10:
    syscall(__NR_ioctl, r[2], 0xae9aul, 0);
    break;
  case 11:
