...
// https://syzkaller.appspot.com/bug?id=47d69b834738f86cd774713f4c96fd5be7ad9202
// status:dup
...
void execute_call(int call)
{
  switch (call) {
  case 0:
    memcpy((void*)0x20cb3ff8, "./file0", 8);
    syscall(__NR_mkdir, 0x20cb3ff8, 0);
    break;
  case 1:
    memcpy((void*)0x20cd2ff8, "./file0", 8);
    syscall(__NR_chdir, 0x20cd2ff8);
    break;
  case 2:
    memcpy((void*)0x200012c0, "../file0", 9);
    memcpy((void*)0x200000c0, "./file0", 8);
    syz_fuseblk_mount(0x200012c0, 0x200000c0, 0, 0, 0, 0, 0, 0);
    break;
  case 3:
    memcpy((void*)0x20000100, "../file0", 9);
    write_file("/sys/kernel/debug/failslab/ignore-gfp-wait", "N");
    write_file("/sys/kernel/debug/fail_futex/ignore-private", "N");
    inject_fault(78);
    syz_fuse_mount(0x20000100, 0xc000, 0, 0, 0, 0);
    break;
  }
}
