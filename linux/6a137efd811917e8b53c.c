...
// https://syzkaller.appspot.com/bug?id=6a137efd811917e8b53c
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    NONFAILING(*(uint32_t*)0x20000050 = 0x101);
    ...
    res = syscall(__NR_bpf, 0ul, 0x20000040ul, 0x40ul);
    if (res != -1)
      r[1] = res;
    break;
  case 3:
    ...
    NONFAILING(*(uint32_t*)0x200007a0 = 0x1081);
    NONFAILING(*(uint32_t*)0x200007a4 = r[1]);
    NONFAILING(*(uint64_t*)0x200007a8 = 0);
    NONFAILING(*(uint64_t*)0x200007b0 = 0);
    syscall(__NR_bpf, 0x1aul, 0x20000780ul, 0x38ul);
    break;
  }
}
int main(void)
