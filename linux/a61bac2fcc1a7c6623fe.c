...
// https://syzkaller.appspot.com/bug?id=a61bac2fcc1a7c6623fe
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_write, r[0], 0ul, 0x208e24bul);
    break;
  case 2:
    syscall(__NR_setsockopt, r[0], 0x114, 5, 0ul, 0ul);
    break;
  case 3:
  ...
  case 6:
    ...
    break;
  case 7:
    syscall(__NR_getsockopt, r[2], 1, 0x39, 0ul, 0ul);
    break;
  case 8:
    NONFAILING(*(uint16_t*)0x20000140 = 0x28);
    NONFAILING(*(uint16_t*)0x20000142 = 0);
    NONFAILING(*(uint32_t*)0x20000144 = 0);
    NONFAILING(*(uint32_t*)0x20000148 = 2);
    NONFAILING(*(uint32_t*)0x2000014c = 0);
    syscall(__NR_bind, r[1], 0x20000140ul, 0x10ul);
    break;
  case 9:
  ...
  case 11:
    ...
    syscall(__NR_connect, r[3], 0x20000040ul, 0x10ul);
    break;
  case 12:
    NONFAILING(*(uint32_t*)0x20000140 = r[3]);
    NONFAILING(*(uint16_t*)0x20000144 = 0);
    NONFAILING(*(uint16_t*)0x20000146 = 0);
    syscall(__NR_poll, 0x20000140ul, 1ul, 0);
    break;
  }
}
int main(void)
