...
// https://syzkaller.appspot.com/bug?id=5334f62e4d22804e646a
// status:6
...
void loop(void)
{
  ...
  *(uint32_t*)0x20000040 = 0x80;
  ...
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x200001c0, "vcan0\000\000\000\000\000\000\000\000\000\000\000",
         16);
  *(uint32_t*)0x200001d0 = 0;
  res = syscall(__NR_ioctl, r[1], 0x8933, 0x200001c0ul);
  if (res != -1)
  ...
  *(uint64_t*)0x20000108 = 0x20000;
  *(uint32_t*)0x20000110 = 0x1000;
  *(uint32_t*)0x20000114 = 0;
  *(uint32_t*)0x20000118 = 0;
  syscall(__NR_setsockopt, r[3], 0x11b, 4, 0x20000100ul, 0x18ul);
  *(uint32_t*)0x20000800 = 8;
  syscall(__NR_setsockopt, r[3], 0x11b, 5, 0x20000800ul, 4ul);
  *(uint32_t*)0x20000040 = 0x80;
  syscall(__NR_setsockopt, r[3], 0x11b, 2, 0x20000040ul, 4ul);
  *(uint32_t*)0x20000080 = 0x80;
  syscall(__NR_setsockopt, r[3], 0x11b, 6, 0x20000080ul, 4ul);
  ...
  memcpy((void*)0x200001c0, "veth0\000\000\000\000\000\000\000\000\000\000\000",
         16);
  *(uint32_t*)0x200001d0 = 0;
  res = syscall(__NR_ioctl, r[4], 0x8933, 0x200001c0ul);
  if (res != -1)
    r[5] = *(uint32_t*)0x200001d0;
  *(uint16_t*)0x20000300 = 0x2c;
  *(uint16_t*)0x20000302 = 0;
  *(uint32_t*)0x20000304 = r[5];
  *(uint32_t*)0x20000308 = 0;
  *(uint32_t*)0x2000030c = -1;
  syscall(__NR_bind, r[3], 0x20000300ul, 0x10ul);
  *(uint16_t*)0x20000000 = 0x2c;
  *(uint16_t*)0x20000002 = 1;
  *(uint32_t*)0x20000004 = r[2];
  *(uint32_t*)0x20000008 = 0;
  *(uint32_t*)0x2000000c = r[3];
