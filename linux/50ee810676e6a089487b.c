...
// https://syzkaller.appspot.com/bug?id=50ee810676e6a089487b
// status:0
...
void execute_one(void)
{
  ...
  res = syscall(__NR_creat, 0x20001200ul, 0ul);
  if (res != -1)
    r[1] = res;
  syscall(__NR_dup2, r[0], r[1]);
  syscall(__NR_recvfrom, r[1], 0x20000080ul, 0xbdul, 2ul, 0ul, 0ul);
}
int main(void)
{
