...
// https://syzkaller.appspot.com/bug?id=6048aa700d088954b0fc
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    NONFAILING(memcpy(
        (void*)0x20000080,
        "\x02\xc8\x00\x25\x00\x21\x00\x01\x00\x11\x01\x02\x00\x00\x00\x02\x09"
        "\x04\x00\x03\x00\x80\x00\x04\xbf\x0f\x00\x40\x00\x08\x00\x04",
        32));
    NONFAILING(*(uint16_t*)0x200000a0 = -1);
    NONFAILING(syz_emit_vhci(0x20000080, 0x2a));
    break;
  case 1:
    NONFAILING(*(uint8_t*)0x20000180 = 4);
    NONFAILING(*(uint8_t*)0x20000181 = 0x40);
    NONFAILING(*(uint8_t*)0x20000182 = 2);
    NONFAILING(*(uint8_t*)0x20000183 = 0);
    NONFAILING(*(uint8_t*)0x20000184 = 0);
    NONFAILING(syz_emit_vhci(0x20000180, 5));
    break;
  }
}
int main(void)
