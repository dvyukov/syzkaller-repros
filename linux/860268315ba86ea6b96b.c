...
// https://syzkaller.appspot.com/bug?id=860268315ba86ea6b96b
// status:0
...
void execute_one(void)
{
  ...
  res = -1;
  res = syz_genetlink_get_family_id(0x20005540, -1);
  if (res != -1)
    r[1] = res;
