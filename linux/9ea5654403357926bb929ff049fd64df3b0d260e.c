...
// https://syzkaller.appspot.com/bug?id=9ea5654403357926bb929ff049fd64df3b0d260e
// status:open
...
int main(void)
{
  ...
  *(uint16_t*)0x20000088 = 0x11c0;
  *(uint16_t*)0x2000008a = 0x5506;
  ...
  *(uint8_t*)0x200000b5 = 2;
  res = syz_usb_connect(3, 0x36, 0x20000080, 0);
  if (res != -1)
    r[0] = res;
  ...
  *(uint16_t*)0x20000108 = 0x46d;
  *(uint16_t*)0x2000010a = 0xc626;
  ...
  *(uint8_t*)0x2000012a = 0x22;
  *(uint16_t*)0x2000012b = 0;
  *(uint8_t*)0x2000012d = 9;
  *(uint8_t*)0x2000012e = 5;
  *(uint8_t*)0x2000012f = 0x81;
  *(uint8_t*)0x20000130 = 3;
  *(uint16_t*)0x20000131 = 0;
  *(uint8_t*)0x20000133 = 0;
  *(uint8_t*)0x20000134 = 0;
  *(uint8_t*)0x20000135 = 0;
  res = syz_usb_connect(0, 0x36, 0x20000100, 0);
  if (res != -1)
    r[1] = res;
  ...
  *(uint64_t*)0x20000454 = 0x20000040;
  *(uint8_t*)0x20000040 = 0;
  *(uint8_t*)0x20000041 = 0x22;
  *(uint32_t*)0x20000042 = 0x22;
  STORE_BY_BITMASK(uint8_t, , 0x20000046, 1, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000046, 1, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000046, 0, 4, 4);
  memcpy((void*)0x20000047, "\xa3", 1);
  STORE_BY_BITMASK(uint8_t, , 0x20000048, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000048, 2, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000048, 0, 4, 4);
  memcpy((void*)0x20000049, "\000\000\b\000", 4);
  STORE_BY_BITMASK(uint8_t, , 0x2000004d, 1, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000004d, 1, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000004d, 9, 4, 4);
  memcpy((void*)0x2000004e, "\xbb", 1);
  STORE_BY_BITMASK(uint8_t, , 0x2000004f, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000004f, 0, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000004f, 9, 4, 4);
  memcpy((void*)0x20000050, "Wg7\n", 4);
  STORE_BY_BITMASK(uint8_t, , 0x20000054, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000054, 1, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000054, 0, 4, 4);
  memcpy((void*)0x20000055, "\x07\xb9\xfc\x0c", 4);
  STORE_BY_BITMASK(uint8_t, , 0x20000059, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000059, 0, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000059, 0, 4, 4);
  memcpy((void*)0x2000005a, "\x77\xdd\xb6\x0f", 4);
  STORE_BY_BITMASK(uint8_t, , 0x2000005e, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000005e, 0, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x2000005e, 0, 4, 4);
  memcpy((void*)0x2000005f, "\xa2\xd4\x0b\x77", 4);
  STORE_BY_BITMASK(uint8_t, , 0x20000063, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000063, 0, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000063, 0, 4, 4);
  memcpy((void*)0x20000064, "\xb9\x7e\x2c\x85", 4);
  *(uint64_t*)0x2000045c = 0;
  syz_usb_control_io(r[1], 0x20000440, 0);
  return 0;
}
