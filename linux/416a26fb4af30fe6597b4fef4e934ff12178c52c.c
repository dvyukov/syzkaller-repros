// BUG: Bad page map (2)
// https://syzkaller.appspot.com/bug?id=416a26fb4af30fe6597b4fef4e934ff12178c52c
// status:invalid
...
{
  long res = 0;
  NONFAILING(*(uint32_t*)0x204f9fe4 = 5);
  NONFAILING(*(uint32_t*)0x204f9fe8 = 0xa);
  NONFAILING(*(uint32_t*)0x204f9fec = 6);
  NONFAILING(*(uint32_t*)0x204f9ff0 = 0x1ff);
  NONFAILING(*(uint32_t*)0x204f9ff4 = 0);
  NONFAILING(*(uint32_t*)0x204f9ff8 = -1);
  NONFAILING(*(uint32_t*)0x204f9ffc = 0);
  NONFAILING(*(uint8_t*)0x204fa000 = 0);
  NONFAILING(*(uint8_t*)0x204fa001 = 0);
  NONFAILING(*(uint8_t*)0x204fa002 = 0);
  NONFAILING(*(uint8_t*)0x204fa003 = 0);
  NONFAILING(*(uint8_t*)0x204fa004 = 0);
  NONFAILING(*(uint8_t*)0x204fa005 = 0);
  NONFAILING(*(uint8_t*)0x204fa006 = 0);
  NONFAILING(*(uint8_t*)0x204fa007 = 0);
  NONFAILING(*(uint8_t*)0x204fa008 = 0);
  NONFAILING(*(uint8_t*)0x204fa009 = 0);
  NONFAILING(*(uint8_t*)0x204fa00a = 0);
  NONFAILING(*(uint8_t*)0x204fa00b = 0);
  NONFAILING(*(uint8_t*)0x204fa00c = 0);
  NONFAILING(*(uint8_t*)0x204fa00d = 0);
  NONFAILING(*(uint8_t*)0x204fa00e = 0);
  NONFAILING(*(uint8_t*)0x204fa00f = 0);
  res = syscall(__NR_bpf, 0, 0x204f9fe4, 0x2c);
  if (res != -1)
    r[0] = res;
  syscall(__NR_pread64, r[0], 0x20000080, 0xbb, 0);
}
