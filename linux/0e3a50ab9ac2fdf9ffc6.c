...
// https://syzkaller.appspot.com/bug?id=0e3a50ab9ac2fdf9ffc6
// status:3 arch:386
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x200000c0, "/dev/fb0\000", 9));
  ...
  case 1:
    ...
    NONFAILING(*(uint32_t*)0x20000108 = 0x556);
    NONFAILING(*(uint32_t*)0x2000010c = 0x280);
    ...
    NONFAILING(*(uint32_t*)0x20000150 = 2);
    ...
    NONFAILING(*(uint32_t*)0x2000018c = 0xb);
    ...
    syscall(__NR_ioctl, (intptr_t)r[0], 0x4601, 0x20000100);
    break;
  }
}
int main(void)
