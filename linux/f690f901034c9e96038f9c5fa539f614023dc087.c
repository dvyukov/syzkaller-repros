...
// https://syzkaller.appspot.com/bug?id=f690f901034c9e96038f9c5fa539f614023dc087
// status:dup
...
void* thr(void* arg)
{
  switch ((long)arg) {
  case 0:
    syscall(__NR_mmap, 0x20000000ul, 0xb02000ul, 0x3ul, 0x32ul,
            0xfffffffffffffffful, 0x0ul);
    break;
  case 1:
    memcpy((void*)0x20ad8000, "/dev/kvm", 9);
    r[0] = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20ad8000ul,
                   0x0ul, 0x0ul);
    break;
  case 2:
  ...
  case 3:
    ...
    break;
  case 4:
    *(uint64_t*)0x20b01fe8 = (uint64_t)0x40;
    *(uint64_t*)0x20b01ff0 = (uint64_t)0x20867000;
    *(uint64_t*)0x20b01ff8 = (uint64_t)0x47;
    memcpy((void*)0x20867000,
           "\x66\x26\x0f\x45\xcc\x0f\x00\x5e\x6e\x66\xb8\xdd\x00\x0f"
           "\x00\xd0\xc4\x02\xd1\xde\x7e\x05\xc4\xc3\x79\x05\xc1\x00"
           "\x3e\x0f\x00\x17\xf3\x0f\x22\xa6\x48\xb8\x00\x20\x00\x00"
           "\x00\x00\x00\x00\x0f\x23\xc8\x0f\x21\xf8\x35\x0c\x00\xa0"
           "\x00\x0f\x23\xf8\x0f\x35\x66\x49\x0f\x2d\xa6\xb2\x00\x00"
           "\x00",
           71);
    syz_kvm_setup_cpu(0xfffffffffffffffful, r[2], 0x2012a000ul,
                      0x20b01fe8ul, 0x1ul, 0x0ul, 0x20b00000ul, 0x0ul);
    break;
  }
  return 0;
}
