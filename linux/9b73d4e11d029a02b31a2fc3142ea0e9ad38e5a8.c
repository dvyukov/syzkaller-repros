// BUG: lock held when returning to user space in fuse_lock_inode
// https://syzkaller.appspot.com/bug?id=9b73d4e11d029a02b31a2fc3142ea0e9ad38e5a8
// status:invalid
