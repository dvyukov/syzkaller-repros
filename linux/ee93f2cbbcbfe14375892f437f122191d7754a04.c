...
// https://syzkaller.appspot.com/bug?id=ee93f2cbbcbfe14375892f437f122191d7754a04
// status:fixed
...
void loop(void)
{
  NONFAILING(memcpy((void*)0x20000200, "./file0/file0\000", 14));
  NONFAILING(memcpy((void*)0x20000240, "./file0\000", 8));
  syscall(__NR_symlink, 0x20000200, 0x20000240);
