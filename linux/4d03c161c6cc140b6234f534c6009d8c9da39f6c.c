...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_setsockopt, -1, 0x119, 1, 0, 0);
    break;
  case 3:
  ...
  case 5:
    ...
    NONFAILING(*(uint64_t*)0x20000050 = 0x20000200);
    NONFAILING(*(uint64_t*)0x20000200 = 0x20000000);
    NONFAILING(
        memcpy((void*)0x20000000,
               "\x39\x00\x00\x00\x14\x00\x81\xae\x00\xd1\x75\x04\x0f\x62\xb0"
               "\x4a\x2b\x54\x6f\xc5\x4c\x19\x60\xb8\x9c\x40\xeb\xb3\x73\x58"
               "\x58\x06\xdb\xb7\xd5\x53\xb4\xa4\x00\x00\x00\x00\x00\x00\x00"
               "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
               57));
    NONFAILING(*(uint64_t*)0x20000208 = 0x39);
