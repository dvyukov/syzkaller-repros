// BUG: unable to handle kernel paging request in ath9k_htc_rxep
// https://syzkaller.appspot.com/bug?id=dc6c749aec286992cea2
// status:0
...
int main(void)
{
  ...
  *(uint16_t*)0x200008c2 = 0x200;
  *(uint8_t*)0x200008c4 = -1;
  *(uint8_t*)0x200008c5 = -1;
  *(uint8_t*)0x200008c6 = -1;
  *(uint8_t*)0x200008c7 = 0x40;
  *(uint16_t*)0x200008c8 = 0xcf3;
  *(uint16_t*)0x200008ca = 0x9271;
  *(uint16_t*)0x200008cc = 0x108;
  *(uint8_t*)0x200008ce = 1;
  *(uint8_t*)0x200008cf = 2;
  *(uint8_t*)0x200008d0 = 3;
  *(uint8_t*)0x200008d1 = 1;
  *(uint8_t*)0x200008d2 = 9;
  *(uint8_t*)0x200008d3 = 2;
  *(uint16_t*)0x200008d4 = 0x48;
  *(uint8_t*)0x200008d6 = 1;
  *(uint8_t*)0x200008d7 = 1;
  *(uint8_t*)0x200008d8 = 0;
  *(uint8_t*)0x200008d9 = 0x80;
  *(uint8_t*)0x200008da = 0xfa;
  ...
  *(uint16_t*)0x20000242 = htobe16(0);
  memcpy((void*)0x20000244, "\x7f\xa3\x70\xff", 4);
  ...
  *(uint8_t*)0x20000251 = 8;
  syz_usb_ep_write(r[0], 0x83, 0xfffffffffffffd18, 0x20000240);
