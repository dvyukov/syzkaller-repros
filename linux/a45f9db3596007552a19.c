...
// https://syzkaller.appspot.com/bug?id=a45f9db3596007552a19
// status:6
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000140 = 0x200005c0;
  memcpy((void*)0x200005c0,
         "\x40\x01\x00\x00\x24\x00\x0b\x0f\x00\xe4\x00\x00\x00\x00\xf1\x0f\xeb"
         "\xca\x07\x46",
         20);
  *(uint32_t*)0x200005d4 = r[2];
  memcpy((void*)0x200005d8,
         "\x00\x00\x00\x00\xff\xff\xff\xff\x00\x00\x00\xf6\x09\x00\x01\x00\x6e"
         "\x65\x74\x65\x6d\x00\x18\x00\x10\x01\x02\x00\xca\x00\x00\x00\xb0",
         33);
  ...
  *(uint32_t*)0x200001b0 = 0;
  ...
  if (res != -1)
    r[3] = res;
  *(uint32_t*)0x20000040 = 0x8000;
  *(uint32_t*)0x20000044 = 0x200;
  *(uint32_t*)0x20000048 = 0x80;
  *(uint32_t*)0x2000004c = 0x20000;
  *(uint32_t*)0x20000050 = 0;
  *(uint32_t*)0x20000054 = 0;
  *(uint32_t*)0x20000058 = 0;
  syscall(__NR_setsockopt, r[3], 0x107, 5, 0x20000040ul, 0x1cul);
  *(uint32_t*)0x20000e00 = 3;
  syscall(__NR_setsockopt, r[3], 0x107, 7, 0x20000e00ul, 4ul);
  ...
  *(uint32_t*)0x20000530 = 0;
  syscall(__NR_recvmsg, r[3], 0x20000500ul, 0ul, 0);
}
int main(void)
{
