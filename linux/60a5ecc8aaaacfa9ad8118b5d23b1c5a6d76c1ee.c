// KASAN: use-after-free Read in device_destroy
// https://syzkaller.appspot.com/bug?id=60a5ecc8aaaacfa9ad8118b5d23b1c5a6d76c1ee
// status:invalid
...
{
  intptr_t res = 0;
  *(uint8_t*)0x20001900 = 0x12;
  *(uint8_t*)0x20001901 = 1;
  *(uint16_t*)0x20001902 = 0;
  *(uint8_t*)0x20001904 = 0x8e;
  *(uint8_t*)0x20001905 = 0x32;
  *(uint8_t*)0x20001906 = 0xf7;
  *(uint8_t*)0x20001907 = 0x20;
  *(uint16_t*)0x20001908 = 0xaf0;
  *(uint16_t*)0x2000190a = 0xd257;
  *(uint16_t*)0x2000190c = 0x4e87;
  *(uint8_t*)0x2000190e = 0;
  *(uint8_t*)0x2000190f = 0;
  *(uint8_t*)0x20001910 = 0;
  *(uint8_t*)0x20001911 = 1;
  *(uint8_t*)0x20001912 = 9;
  *(uint8_t*)0x20001913 = 2;
  *(uint16_t*)0x20001914 = 0x12;
  *(uint8_t*)0x20001916 = 1;
  *(uint8_t*)0x20001917 = 0;
  *(uint8_t*)0x20001918 = 0;
  *(uint8_t*)0x20001919 = 0;
  *(uint8_t*)0x2000191a = 0;
  *(uint8_t*)0x2000191b = 9;
  *(uint8_t*)0x2000191c = 4;
  *(uint8_t*)0x2000191d = 0xf;
  *(uint8_t*)0x2000191e = 0;
  *(uint8_t*)0x2000191f = 0;
  *(uint8_t*)0x20001920 = -1;
  *(uint8_t*)0x20001921 = 0xa5;
  *(uint8_t*)0x20001922 = 0x2c;
  *(uint8_t*)0x20001923 = 0;
  res = syz_usb_connect(0, 0x24, 0x20001900, 0);
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x20000540 = 0x34;
  *(uint64_t*)0x20000544 = 0x20000180;
  *(uint8_t*)0x20000180 = 0;
  *(uint8_t*)0x20000181 = 0;
  *(uint32_t*)0x20000182 = 0x11;
  memcpy((void*)0x20000186,
         "\x85\x10\x49\xe2\x1f\xec\x4c\x13\x67\xf2\xe1\x57\xed\x8c\x3a\x08\x73",
         17);
