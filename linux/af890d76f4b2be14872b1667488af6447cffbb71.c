...
// https://syzkaller.appspot.com/bug?id=af890d76f4b2be14872b1667488af6447cffbb71
// status:open
...
void execute_call(int call)
{
  ...
  case 2:
    *(uint16_t*)0x20000000 = 0x26;
    memcpy((void*)0x20000002, "aead\000\000\000\000\000\000\000\000\000\000",
           14);
    *(uint32_t*)0x20000010 = 0;
    *(uint32_t*)0x20000014 = 0;
    memcpy((void*)0x20000018, "aegis128-"
  ...
  case 6:
    ...
    *(uint8_t*)0x200000c7 = 0xaa;
    ...
    break;
  case 7:
    syscall(__NR_splice, r[2], 0ul, r[0], 0ul, 0xd86dac9ul, 0ul);
    break;
  }
}
int main(void)
