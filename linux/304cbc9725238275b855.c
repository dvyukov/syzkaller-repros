// INFO: task hung in cgroup_can_fork
// https://syzkaller.appspot.com/bug?id=304cbc9725238275b855
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    *(uint64_t*)0x20000080 = 0x280000000;
    ...
    *(uint32_t*)0x200000d0 = r[1];
    syscall(__NR_clone3, 0x20000080ul, 0x58ul);
    {
      int i;
      for (i = 0; i < 64; i++) {
        syscall(__NR_clone3, 0x20000080ul, 0x58ul);
