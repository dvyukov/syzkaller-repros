...
// https://syzkaller.appspot.com/bug?id=4418e3d8aea63d756dce642b94a0ec3987cb8220
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    *(uint16_t*)0x2000035c = 7;
    *(uint16_t*)0x2000035e = 1;
    memcpy((void*)0x20000360, "xt\000", 3);
    *(uint16_t*)0x20000364 = 0x40;
    STORE_BY_BITMASK(uint16_t, , 0x20000366, 2, 0, 14);
    STORE_BY_BITMASK(uint16_t, , 0x20000367, 0, 6, 1);
    STORE_BY_BITMASK(uint16_t, , 0x20000367, 1, 7, 1);
    *(uint16_t*)0x20000368 = 0x2a;
    *(uint16_t*)0x2000036a = 6;
    *(uint16_t*)0x2000036c = 0;
    memcpy((void*)0x2000036e, "mangle\000\000\000\000\000\000\000\000\000\000"
    ...
    *(uint16_t*)0x2000039e = 2;
    *(uint32_t*)0x200003a0 = 0;
    *(uint16_t*)0x200003a4 = 4;
    *(uint16_t*)0x200003a6 = 6;
