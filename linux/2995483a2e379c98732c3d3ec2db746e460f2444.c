...
// https://syzkaller.appspot.com/bug?id=2995483a2e379c98732c3d3ec2db746e460f2444
// status:open
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x200004c3 = 0x3d;
  memcpy((void*)0x200004c4, "wfdno", 5);
  *(uint8_t*)0x200004c9 = 0x25;
  memcpy((void*)0x200004ca, "access=user", 11);
  *(uint8_t*)0x200004d5 = 0x2c;
  *(uint8_t*)0x200004d6 = 0;
  syscall(__NR_mount, 0, 0x20000040, 0x20000100, 0, 0x20000480);
}
int main(void)
{
