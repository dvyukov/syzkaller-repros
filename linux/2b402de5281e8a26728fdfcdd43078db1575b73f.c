...
// https://syzkaller.appspot.com/bug?id=2b402de5281e8a26728fdfcdd43078db1575b73f
// status:open
...
void loop(void)
{
  ...
  *(uint16_t*)0x20000240 = 0x26;
  memcpy((void*)0x20000242, "aead\000\000\000\000\000\000\000\000\000\000", 14);
  *(uint32_t*)0x20000250 = 0;
  *(uint32_t*)0x20000254 = 0;
  memcpy((void*)0x20000258, "pcrypt(generic-gcm-aesni)"
                            "\000\000\000\000\000\000\000\000\000\000\000\000"
                            "\000\000\000\000\000\000\000\000\000\000\000\000"
                            "\000\000\000\000\000\000\000\000\000\000\000\000"
                            "\000\000\000",
         64);
  syscall(__NR_bind, r[0], 0x20000240ul, 0x58ul);
  ...
  *(uint32_t*)0x20000298 = 0;
  syscall(__NR_sendto, r[1], 0ul, 0ul, 0x20000004ul, 0x20000280ul, 0x1cul);
  memcpy((void*)0x20000080, "tls\000", 4);
  syscall(__NR_setsockopt, r[1], 6ul, 0x1ful, 0x20000080ul, 0x152ul);
  ...
  *(uint16_t*)0x20000102 = 0x33;
  ...
  syscall(__NR_setsockopt, r[1], 0x11aul, 1ul, 0x20000100ul, 0x28ul);
