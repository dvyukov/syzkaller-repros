...
// https://syzkaller.appspot.com/bug?id=1c98095bbb6f3a9d7cc7
// status:0
...
{
  intptr_t res = 0;
  NONFAILING(memcpy((void*)0x20000240, "\x04\x40", 2));
  NONFAILING(syz_emit_vhci(0x20000240, 2));
  res = -1;
  ...
  syscall(__NR_connect, r[0], 0x200000c0ul, 8ul);
}
int main(void)
{
