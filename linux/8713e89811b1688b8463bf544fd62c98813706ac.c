// general protection fault in yurex_interrupt
// https://syzkaller.appspot.com/bug?id=8713e89811b1688b8463bf544fd62c98813706ac
// status:dup
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint8_t*)0x20000084 = 0x2b);
    NONFAILING(*(uint8_t*)0x20000085 = 0x47);
    NONFAILING(*(uint8_t*)0x20000086 = 0xdb);
    NONFAILING(*(uint8_t*)0x20000087 = 0x40);
    NONFAILING(*(uint16_t*)0x20000088 = 0xc45);
    NONFAILING(*(uint16_t*)0x2000008a = 0x1010);
    NONFAILING(*(uint16_t*)0x2000008c = 0x83ae);
    ...
    NONFAILING(*(uint8_t*)0x2000009d = 0x96);
    NONFAILING(*(uint8_t*)0x2000009e = 0);
    NONFAILING(*(uint8_t*)0x2000009f = 1);
    NONFAILING(*(uint8_t*)0x200000a0 = 0x51);
    NONFAILING(*(uint8_t*)0x200000a1 = 0xc6);
    NONFAILING(*(uint8_t*)0x200000a2 = 0xec);
