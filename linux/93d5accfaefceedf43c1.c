...
// https://syzkaller.appspot.com/bug?id=93d5accfaefceedf43c1
// status:6
...
void loop(void)
{
  ...
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x200004c0, "devlink\000", 8);
  res = -1;
  res = syz_genetlink_get_family_id(0x200004c0, -1);
  if (res != -1)
    r[1] = res;
  ...
  *(uint8_t*)0x20000510 = 0x25;
  *(uint8_t*)0x20000511 = 0;
  *(uint16_t*)0x20000512 = 0;
  *(uint16_t*)0x20000514 = 0xe;
  *(uint16_t*)0x20000516 = 1;
  memcpy((void*)0x20000518, "netdevsim\000", 10);
  *(uint16_t*)0x20000524 = 0xf;
  *(uint16_t*)0x20000526 = 2;
  memcpy((void*)0x20000528, "netdevsim", 9);
  *(uint8_t*)0x20000531 = 0x30;
  *(uint8_t*)0x20000532 = 0;
  *(uint16_t*)0x20000534 = 8;
  *(uint16_t*)0x20000536 = 0x8b;
  *(uint32_t*)0x20000538 = r[2];
