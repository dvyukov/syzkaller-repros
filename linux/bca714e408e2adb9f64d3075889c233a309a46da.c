...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_listen, r[0], 0x80000001);
    break;
  case 3:
    res = syscall(__NR_socket, 0xaul, 1ul, 0x84ul);
    if (res != -1)
      r[1] = res;
    break;
  case 4:
    ...
    syscall(__NR_setsockopt, r[1], 0x84ul, 0x6bul, 0x2055bfe4ul, 0x1cul);
    break;
  case 5:
    res = syscall(__NR_socketpair, 1ul, 5ul, 0ul, 0x20000140ul);
    if (res != -1)
      NONFAILING(r[2] = *(uint32_t*)0x20000140);
    break;
  case 6:
  ...
  case 7:
    ...
    break;
  case 8:
    syscall(__NR_socket, 0xaul, 0x80000000000003ul, 3);
    break;
  case 9:
    NONFAILING(memcpy((void*)0x200000c0,
                      "vcan0\000\000\000\000\000\000\000\000\000\000\000", 16));
    syscall(__NR_setsockopt, r[1], 1ul, 0x19ul, 0x200000c0ul, 0x10ul);
    break;
  case 10:
    NONFAILING(*(uint32_t*)0x20000440 = 0);
    NONFAILING(*(uint16_t*)0x20000444 = 0xa);
    NONFAILING(*(uint16_t*)0x20000446 = htobe16(0));
    NONFAILING(*(uint8_t*)0x20000448 = 0xac);
    NONFAILING(*(uint8_t*)0x20000449 = 0x14);
    NONFAILING(*(uint8_t*)0x2000044a = 0x14);
    NONFAILING(*(uint8_t*)0x2000044b = 0xaa);
    NONFAILING(*(uint32_t*)0x200004c4 = 0);
    NONFAILING(*(uint16_t*)0x200004c8 = 0);
    NONFAILING(*(uint32_t*)0x200004ca = 0);
    NONFAILING(*(uint32_t*)0x200004ce = 0);
    NONFAILING(*(uint32_t*)0x200004d2 = 0x2e);
    syscall(__NR_setsockopt, r[1], 0x84ul, 9ul, 0x20000440ul, 0x98ul);
    break;
  }
}
int main(void)
