...
// https://syzkaller.appspot.com/bug?id=0f719294463916a3fc0e
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint32_t*)0x200001c4 = 0x70);
    NONFAILING(*(uint8_t*)0x200001c8 = 0xea);
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 3, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 4, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 5, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 6, 1));
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 10, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 11, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 12, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 13, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 14, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 15, 2));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 17, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 18, 1));
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001e8, 0, 29, 35));
  ...
  case 1:
    ...
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000180, "l2tp\000", 5));
