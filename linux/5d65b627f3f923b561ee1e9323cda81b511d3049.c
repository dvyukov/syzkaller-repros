...
// https://syzkaller.appspot.com/bug?id=5d65b627f3f923b561ee1e9323cda81b511d3049
// status:open
...
void execute_one(void)
{
  ...
  NONFAILING(memcpy((void*)0x20000000, "net/ipv6_route\000", 15));
  res = syz_open_procfs(-1, 0x20000000);
  if (res != -1)
    r[0] = res;
  NONFAILING(memcpy((void*)0x20000080,
                    "/sys/kernel/debug/bluetooth/6lowpan_enable\000", 43));
  res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000080ul, 2ul, 0ul);
  if (res != -1)
    r[1] = res;
  syscall(__NR_sendfile, r[1], r[0], 0ul, 0x5000ul);
