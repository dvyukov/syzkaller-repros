...
// https://syzkaller.appspot.com/bug?id=6b7fc56a7391b8277521
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_clone, 0x1000000218007fbul, 0ul, 0x9999999999999999ul, 0ul,
            -1ul);
    break;
  case 1:
    res = -1;
  ...
  case 2:
    ...
    NONFAILING(memset((void*)0x20000042, 255, 6));
