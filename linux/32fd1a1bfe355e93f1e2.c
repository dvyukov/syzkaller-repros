...
// https://syzkaller.appspot.com/bug?id=32fd1a1bfe355e93f1e2
// status:6
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x20000013 = 0;
  ...
  memcpy((void*)0x200000c0,
         "\x03\x04\x2a\x01\x09\x32\x60\x01\x00\x00\x00\x00\x00\x00", 14);
  syscall(__NR_sendto, r[0], 0x200000c0ul, 0xeul, 0x4800ul, 0ul, 0ul);
}
int main(void)
{
