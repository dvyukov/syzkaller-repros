...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint64_t*)0x20000440 = 0x20001600);
    NONFAILING(memcpy((void*)0x20001600,
                      "\x28\x00\x00\x00\x22\x00\x01\x00\x00\x00\x00\x00\x00\x00"
                      "\x00\x00\x04\x00\x00\x00\x14\x00\x17\x00\x02\x00\x00\x00"
                      "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x06\x00\x01",
                      40));
    NONFAILING(*(uint64_t*)0x20000448 = 1);
