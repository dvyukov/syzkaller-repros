...
// https://syzkaller.appspot.com/bug?id=3edda08c51e262e7751654c03af50b947c58fe40
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    res = syscall(__NR_perf_event_open, 0, 0, 0, -1, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
  ...
  case 4:
    ...
    res = syscall(__NR_open, 0x20000100, 0x101002, 0);
    if (res != -1)
      r[2] = res;
    break;
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_getsockopt, r[2], 0, 8, 0, 0);
    break;
  case 7:
    syscall(__NR_sendmmsg, r[1], 0, 0, 0x10);
    break;
  case 8:
    syz_genetlink_get_family_id(0);
    break;
  case 9:
    syscall(__NR_sendmsg, r[2], 0, 0x50);
    break;
  case 10:
    NONFAILING(memcpy((void*)0x20001840, "./bus\000", 6));
    res = syscall(__NR_open, 0x20001840, 0, 0);
    if (res != -1)
      r[3] = res;
    break;
  case 11:
  ...
  case 14:
    ...
    break;
  case 15:
    syscall(__NR_fchownat, r[2], 0, 0, r[5], 0x1500);
    break;
  case 16:
    NONFAILING(*(uint64_t*)0x20000540 = 0x20000680);
    NONFAILING(*(uint64_t*)0x20000548 = 0x1000);
    NONFAILING(*(uint64_t*)0x200003c0 = 0x20001880);
    NONFAILING(*(uint64_t*)0x200003c8 = 0x2000074c);
    syscall(__NR_process_vm_writev, r[4], 0x20000540, 1, 0x200003c0, 1, 0);
    break;
  }
}
int main(void)
