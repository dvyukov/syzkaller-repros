...
void execute_call(int call)
{
  ...
  case 4:
    ...
    break;
  case 5:
    NONFAILING(*(uint64_t*)0x20000140 = 0xaa);
    NONFAILING(*(uint64_t*)0x20000148 = 0x40);
    NONFAILING(*(uint64_t*)0x20000150 = 0);
    syscall(__NR_ioctl, r[2], 0xc018aa3f, 0x20000140);
    break;
  case 6:
    syscall(__NR_read, r[2], 0x20000000, 0x80);
    break;
  }
}
int main(void)
