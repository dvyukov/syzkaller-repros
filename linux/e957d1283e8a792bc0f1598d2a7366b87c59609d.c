// KMSAN: uninit-value in __crc32c_le
// https://syzkaller.appspot.com/bug?id=e957d1283e8a792bc0f1598d2a7366b87c59609d
// status:invalid
...
void loop()
{
  ...
  *(uint32_t*)0x20b48014 = 0;
  memcpy((void*)0x20b48018,
         "\x63\x72\x63\x33\x32\x63\x2d\x67\x65\x6e\x65\x72\x69\x63\x00\x00\x00"
  ...
  *(uint64_t*)0x20816ff8 = 0x49;
  syscall(__NR_sendfile, r[1], r[2], 0x20816ff8, 1);
}
