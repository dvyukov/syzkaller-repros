...
// https://syzkaller.appspot.com/bug?id=5a09e4a5db32eae7ce650db6307dc69f92a809f6
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    if (res != -1)
      NONFAILING(r[0] = *(uint32_t*)0x20000084);
    break;
  case 1:
    res = syscall(__NR_io_setup, 6, 0x20000400);
    if (res != -1)
      NONFAILING(r[1] = *(uint64_t*)0x20000400);
    break;
  case 2:
  ...
  case 3:
    ...
    NONFAILING(*(uint16_t*)0x20000190 = 5);
    ...
    syscall(__NR_io_submit, r[1], 1, 0x20000600);
    break;
  case 4:
    ...
    break;
  case 5:
    NONFAILING(*(uint64_t*)0x20009fe8 = 0xaa);
    NONFAILING(*(uint64_t*)0x20009ff0 = 0x22);
    NONFAILING(*(uint64_t*)0x20009ff8 = 0);
    syscall(__NR_ioctl, r[2], 0xc018aa3f, 0x20009fe8);
    break;
  case 6:
    syscall(__NR_read, r[2], 0x20000400, 0x64);
    break;
  }
}
int main(void)
