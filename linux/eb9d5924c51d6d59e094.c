...
// https://syzkaller.appspot.com/bug?id=eb9d5924c51d6d59e094
// status:6
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20003e10 = 0x20000000;
  ...
  *(uint16_t*)0x2000016c = 8;
  ...
  STORE_BY_BITMASK(uint16_t, , 0x2000016f, 1, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x2000016f, 0, 7, 1);
  *(uint32_t*)0x20000170 = htobe32(0);
  *(uint32_t*)0x20000174 = 0x5c;
  *(uint8_t*)0x20000178 = 0x18;
  *(uint8_t*)0x20000179 = 0xa;
  *(uint16_t*)0x2000017a = 0x101;
  ...
  *(uint16_t*)0x2000018a = 2;
  memcpy((void*)0x2000018c, "syz2\000", 5);
  *(uint16_t*)0x20000194 = 9;
  *(uint16_t*)0x20000196 = 1;
  memcpy((void*)0x20000198, "syz0\000", 5);
  *(uint16_t*)0x200001a0 = 0x30;
  STORE_BY_BITMASK(uint16_t, , 0x200001a2, 3, 0, 14);
  STORE_BY_BITMASK(uint16_t, , 0x200001a3, 0, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x200001a3, 1, 7, 1);
  *(uint16_t*)0x200001a4 = 0x2c;
  ...
  *(uint16_t*)0x200001aa = 1;
  memcpy((void*)0x200001ac, "macsec0\000\000\000\000\000\000\000\000\000", 16);
  *(uint16_t*)0x200001bc = 0x14;
  *(uint16_t*)0x200001be = 1;
  memcpy((void*)0x200001c0, "veth1_to_bridge\000", 16);
  *(uint32_t*)0x200001d0 = 0x14;
  ...
  *(uint16_t*)0x200001e2 = htobe16(0xa);
