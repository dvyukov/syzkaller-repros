...
// https://syzkaller.appspot.com/bug?id=9671693590ef5aad8953
// status:6
...
void loop(void)
{
  ...
  *(uint32_t*)0x20000118 = -1;
  ...
  res = -1;
  res = syz_io_uring_setup(0x289, 0x20000100, 0x20771000, 0x20ffa000,
                           0x20000280, 0x20000040);
  if (res != -1) {
    r[0] = res;
  ...
  *(uint16_t*)0x200001ea = 0;
  ...
  syscall(__NR_io_uring_enter, r[0], 0x52fe, 0, 0ul, 0ul, 0ul);
}
int main(void)
{
