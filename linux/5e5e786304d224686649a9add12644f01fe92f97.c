...
// https://syzkaller.appspot.com/bug?id=5e5e786304d224686649a9add12644f01fe92f97
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(*(uint64_t*)0x20001380 = 0x20000180);
    NONFAILING(*(uint64_t*)0x20001388 = 0x94);
    syscall(__NR_preadv, -1, 0x20001380, 1, 0);
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000240, "stack\x00", 6));
    res = syz_open_procfs(0, 0x20000240);
    if (res != -1)
      r[1] = res;
    break;
  case 3:
    syscall(__NR_preadv, r[1], 0x20000480, 0x1000000000000156, 0);
    break;
  case 4:
