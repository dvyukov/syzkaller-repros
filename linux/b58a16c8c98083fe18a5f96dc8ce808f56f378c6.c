...
// https://syzkaller.appspot.com/bug?id=b58a16c8c98083fe18a5f96dc8ce808f56f378c6
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x200001c0, "IPVS", 5));
    syz_genetlink_get_family_id(0x200001c0);
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000240, "/selinux/policy", 16));
  ...
  case 3:
    ...
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000440, "/dev/keychord", 14));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000440, 2, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 5:
    syscall(__NR_ioctl, r[0], 0x5608);
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x20000280 = 0x80);
    syscall(__NR_getpeername, -1, 0x20000140, 0x20000280);
    break;
  case 7:
    NONFAILING(*(uint32_t*)0x20000680 = 0);
    NONFAILING(*(uint32_t*)0x20000684 = 0);
    NONFAILING(*(uint32_t*)0x20000688 = 0x1000);
    NONFAILING(*(uint32_t*)0x2000068c = 1);
    NONFAILING(*(uint32_t*)0x20000690 = -1);
    NONFAILING(*(uint64_t*)0x20000698 = 7);
    NONFAILING(*(uint64_t*)0x200006a0 = 0xe049);
    ...
    syscall(__NR_ioctl, -1, 0xc0505405, 0x20000680);
    break;
  case 8:
    NONFAILING(*(uint8_t*)0x20000140 = 0xfe);
    NONFAILING(*(uint8_t*)0x20000141 = 0x80);
    ...
    NONFAILING(*(uint8_t*)0x2000014f = 0xaa);
    ...
    NONFAILING(*(uint8_t*)0x20000161 = 2);
    ...
    NONFAILING(*(uint8_t*)0x2000016f = 1);
    NONFAILING(*(uint32_t*)0x20000170 = 0);
    NONFAILING(*(uint16_t*)0x20000174 = 0x78);
    ...
    syscall(__NR_ioctl, -1, 0x890c, 0x20000140);
    break;
  case 9:
  ...
  case 10:
    ...
    NONFAILING(*(uint64_t*)0x20000020 = 0xffff);
    NONFAILING(*(uint64_t*)0x20000028 = 0);
    syscall(__NR_sched_setattr, 0, 0x20000000, 0);
    break;
  case 11:
    NONFAILING(*(uint16_t*)0x20000080 = 0x11);
    NONFAILING(*(uint64_t*)0x20000088 = 0x20000380);
    NONFAILING(*(uint16_t*)0x20000380 = 4);
    NONFAILING(*(uint16_t*)0x20000382 = 0x7fff);
    syscall(__NR_ioctl, r[1], 0x4b67, 0x20000080);
    break;
  case 12:
    syscall(__NR_ioctl, r[2], 0x4c81, 0);
    break;
  case 13:
    syscall(__NR_ioctl, -1, 0x4c82);
    break;
  case 14:
    syscall(__NR_setsockopt, -1, 0, 0x485, 0, 0);
    break;
  case 15:
    syscall(__NR_ioctl, r[2], 0x4c80, 0);
    break;
  case 16:
    NONFAILING(*(uint32_t*)0x200002c0 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200002c4 = htobe32(-1));
    NONFAILING(*(uint8_t*)0x200002c8 = 0xac);
    NONFAILING(*(uint8_t*)0x200002c9 = 0x14);
    NONFAILING(*(uint8_t*)0x200002ca = 0x14);
    NONFAILING(*(uint8_t*)0x200002cb = 0x18);
    syscall(__NR_setsockopt, -1, 0, 0, 0x200002c0, 0xc);
    break;
  case 17:
    NONFAILING(memcpy(
        (void*)0x20000840,
        "\x00\x95\xd6\x9a\xf8\xd4\x56\x59\x26\xd4\xf2\x5e\xe4\xf1\x60\x64\x99"
        "\xec\x2c\xde\x38\xdf\x95\x81\xe8\xdc\x19\x61\xc4\x23\xef\xcc\xdb\x0d"
        "\x76\x83\x34\x6c\x14\x2f\xd6\x89\x52\x58\x1f\xa7\x66\xbc\x1d\x91\xc9"
        "\xe5\x86\x4b\xfa\x5f\xa1\xf8\x6b\xd5\x91\x0e\xe6\x02\xad\x27\xc4\x45"
        "\xf0\xf5\xc8\x67\x00\x00\x00\x00\xda\x82\x42\xfb\x88\xc9\xc8\x3f\xd3"
        "\x31\x40\x73\x2e\x9b\x1e\xd5\x98\x75\x0e\x34\xe9\x5d\x05\x18\x95\xa8"
        "\xe7\xe4\x1a\x9a\x99\x65\x69\x3a\x5a\x9c\x65\x01\x69\x96\xa4\x4e\x54"
        "\x36\x02\x1b\xa1\x81\x88\x8f\x69\xbb\x9e\x5d\x6d\xd3\x49\xd8\x6d\x8b"
        "\x14\x59\x13\xe2\x2b\xa1\xbf\xb3\x5a\xff\x25\x1d\x5a\x1b\xf0\x89\x6a"
        "\xef\x48\x2e\xf9\x15\xb2\xec\xc1\x37\xa5\x56\xd3\x6b\xcf\xb0\x6e\x39"
        "\x62\xdc\x30\xf5\xe7\x06\x66\x35\x39\xcb\x48\xe3\xb4\x38\x45\xdb\x72"
        "\x2c",
        188));
    syscall(__NR_write, -1, 0x20000840, 0xbc);
    break;
  case 18:
    syscall(__NR_ioctl, -1, 0x5441, 0x80000001ff);
    break;
  case 19:
    syscall(__NR_mmap, 0x20ffa000, 0x2000, 8, 0x10, r[2], 0);
    break;
  case 20:
    NONFAILING(memcpy((void*)0x20000080, "./bus", 6));
    res = syscall(__NR_creat, 0x20000080, 0);
    if (res != -1)
      r[3] = res;
    break;
  case 21:
    syscall(__NR_fcntl, r[3], 4, 0x8000000000044000);
    break;
  case 22:
    res = syscall(__NR_io_setup, 8, 0x20000200);
    if (res != -1)
      NONFAILING(r[4] = *(uint64_t*)0x20000200);
    break;
  case 23:
    NONFAILING(memcpy((void*)0x20000700, "./bus", 6));
    res = syscall(__NR_creat, 0x20000700, 0);
    if (res != -1)
      r[5] = res;
    break;
  case 24:
    res = syscall(__NR_socketpair, 1, 5, 0, 0x200001c0);
    if (res != -1)
      NONFAILING(r[6] = *(uint32_t*)0x200001c4);
    break;
  case 25:
    syscall(__NR_ioctl, r[6], 0x8912, 0x400200);
    break;
  case 26:
    syscall(__NR_ftruncate, r[5], 0x148204);
    break;
  case 27:
    NONFAILING(*(uint64_t*)0x20000540 = 0x200000c0);
    NONFAILING(*(uint64_t*)0x200000c0 = 0);
    NONFAILING(*(uint32_t*)0x200000c8 = 0);
    NONFAILING(*(uint32_t*)0x200000cc = 3);
    NONFAILING(*(uint16_t*)0x200000d0 = 1);
    NONFAILING(*(uint16_t*)0x200000d2 = 0);
    NONFAILING(*(uint32_t*)0x200000d4 = r[3]);
    ...
    syscall(__NR_io_submit, r[4], 8, 0x20000540);
    break;
  }
}
int main(void)
