...
// https://syzkaller.appspot.com/bug?id=832ccf42c61e3c63654e
// status:3
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000288 = 0x640;
  *(uint32_t*)0x2000028c = 0;
  *(uint32_t*)0x20000290 = 0xfffffffd;
  *(uint32_t*)0x20000294 = 2;
  ...
  *(uint32_t*)0x2000031c = 0;
  syscall(__NR_ioctl, r[0], 0x4601, 0x20000280ul);
}
int main(void)
{
