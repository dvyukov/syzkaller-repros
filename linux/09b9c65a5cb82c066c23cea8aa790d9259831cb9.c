...
// https://syzkaller.appspot.com/bug?id=09b9c65a5cb82c066c23cea8aa790d9259831cb9
// status:invalid
...
void execute_one()
{
  ...
  memcpy((void*)0x200002c0, "ramfs", 6);
  syscall(__NR_mount, 0x20000440, 0x20026ff8, 0x200002c0, 0, 0x20000480);
  memcpy((void*)0x20d04000, "./file0", 8);
  memcpy((void*)0x20903000, "./file0", 8);
  memcpy((void*)0x200001c0, "bdev", 5);
  syscall(__NR_mount, 0x20d04000, 0x20903000, 0x200001c0, 0x100000, 0x200002c0);
  ...
  memcpy((void*)0x20000340, "iso9660", 8);
  syscall(__NR_mount, 0x200000c0, 0x20000140, 0x20000340, 0x101000, 0x20000380);
  ...
  memcpy((void*)0x200004c0, "./file0/file0", 14);
  memcpy((void*)0x20000500, "./file0", 8);
  memcpy((void*)0x20000540, "proc", 5);
  write_file("/sys/kernel/debug/failslab/ignore-gfp-wait", "N");
  write_file("/sys/kernel/debug/fail_futex/ignore-private", "N");
  inject_fault(36);
  syscall(__NR_mount, 0x200004c0, 0x20000500, 0x20000540, 0, 0x20000580);
}
