...
// https://syzkaller.appspot.com/bug?id=2e5d791c70d2a810b3a5
// status:0
...
void execute_one(void)
{
  ...
  *(uint16_t*)0x20000244 = r[4];
  memcpy((void*)0x20000246, "\x05\x00\x00\x00\x00\x00\x00\x00\x00\x00\x06\x00"
                            "\x00\x00\x08\x00\x03\x00",
         18);
  *(uint32_t*)0x20000258 = r[5];
  memcpy((void*)0x2000025c, "\x08\x00\x05\x00\x09\x00\x00\x00", 8);
  *(uint64_t*)0x20000308 = 0x24;
  *(uint64_t*)0x20000358 = 1;
  *(uint64_t*)0x20000360 = 0;
  *(uint64_t*)0x20000368 = 0;
