...
// https://syzkaller.appspot.com/bug?id=0fcc85e6f5c0a7d5c5bd69568ff8605ad377d896
// status:fixed
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000600, "./bus\000", 6));
    res = syscall(__NR_open, 0x20000600, 2, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000000, "^posix_acl_accessppp1\\\000", 23));
  ...
  case 3:
    ...
    syscall(__NR_write, r[0], 0x20000080, 0xfffffff4);
    break;
  case 4:
    syscall(__NR_splice, r[0], 0, r[1], 0, 0x1000000007ff, 0);
    break;
  }
}
int main(void)
