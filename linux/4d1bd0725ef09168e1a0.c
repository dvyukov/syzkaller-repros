...
// https://syzkaller.appspot.com/bug?id=4d1bd0725ef09168e1a0
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    syscall(__NR_futex, 0x2000cffcul, 0x80000000000bul, 4, 0ul, 0x20048000ul,
            0);
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x2000cffc = 0);
    NONFAILING(*(uint32_t*)0x20048000 = 0);
    syscall(__NR_futex, 0x2000cffcul, 0xcul, 1, 0ul, 0x20048000ul, 0);
    break;
  }
}
int main(void)
