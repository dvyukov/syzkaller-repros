// KMSAN: uninit-value in hci_event_packet (3)
// https://syzkaller.appspot.com/bug?id=b12240a286aa7cd4f3fb
// status:0
...
{
  memcpy((void*)0x20000000, "\x04\x04\x00\x00\x00\x00\x00\x00\x00", 9);
  syz_emit_vhci(0x20000000, 9);
}
int main(void)
{
