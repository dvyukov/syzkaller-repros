...
// https://syzkaller.appspot.com/bug?id=fea54aca8efd61c5541d4df20fd1b7c25fd2d81f
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    syscall(__NR_mknod, 0x20000200, 0x1120, 0);
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000040, "./file0\000", 8));
    res = syscall(__NR_open, 0x20000040, 0x27e, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
  ...
  case 3:
    ...
    NONFAILING(memcpy((void*)0x20000140, "trans=fd,", 9));
    NONFAILING(memcpy((void*)0x20000149, "rfdno", 5));
    NONFAILING(*(uint8_t*)0x2000014e = 0x3d);
    NONFAILING(sprintf((char*)0x2000014f, "0x%016llx", (long long)r[1]));
    NONFAILING(*(uint8_t*)0x20000161 = 0x2c);
    NONFAILING(memcpy((void*)0x20000162, "wfdno", 5));
    NONFAILING(*(uint8_t*)0x20000167 = 0x3d);
    NONFAILING(sprintf((char*)0x20000168, "0x%016llx", (long long)r[1]));
    NONFAILING(*(uint8_t*)0x2000017a = 0x2c);
    NONFAILING(*(uint8_t*)0x2000017b = 0);
    syscall(__NR_mount, 0, 0x200000c0, 0x20000100, 0, 0x20000140);
    break;
  case 4:
    syscall(__NR_read, r[1], 0x20000240, 0x1000);
    break;
  case 5:
    ...
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x20000000 = 0x20);
    ...
    syscall(__NR_write, r[2], 0x20000000, 0x20);
    break;
  case 7:
    res = syscall(__NR_ioctl, r[1], 0x5429, 0x20000180);
    if (res != -1)
      NONFAILING(r[3] = *(uint32_t*)0x20000180);
    break;
  case 8:
    syscall(__NR_kcmp, r[3], 0, 7, r[2], 0);
    break;
  }
}
int main(void)
