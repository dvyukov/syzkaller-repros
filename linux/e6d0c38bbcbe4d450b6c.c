...
// https://syzkaller.appspot.com/bug?id=e6d0c38bbcbe4d450b6c
// status:0
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000370 = 0;
  ...
  memcpy((void*)0x20000700, "wlan0\000\000\000\000\000\000\000\000\000\000\000",
         16);
  res = syscall(__NR_ioctl, r[5], 0x8933, 0x20000700ul);
  if (res != -1)
  ...
  *(uint16_t*)0x200001de = 0x27;
  *(uint32_t*)0x200001e0 = 2;
  *(uint16_t*)0x200001e4 = 8;
  *(uint16_t*)0x200001e6 = 0x26;
  *(uint32_t*)0x200001e8 = 0x999;
