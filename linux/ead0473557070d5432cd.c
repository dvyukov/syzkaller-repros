...
// https://syzkaller.appspot.com/bug?id=ead0473557070d5432cd
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000050 = 0;
  syz_kvm_setup_cpu(r[1], r[2], 0x2003a000, 0x20000040, 1, 0x40, 0, 0);
  syscall(__NR_ioctl, r[2], 0xae80, 0ul);
  *(uint64_t*)0x200000c0 = 0x40;
  *(uint64_t*)0x200000c8 = 0;
  *(uint64_t*)0x200000d0 = 0;
  syz_kvm_setup_cpu(-1, r[2], 0x20037000, 0x200000c0, 1, 0, 0, 0);
}
int main(void)
{
