...
// https://syzkaller.appspot.com/bug?id=e42ae441c3b10acf9e9d
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(memcpy((void*)0x20000040, "cgroup2\000", 8));
  syscall(__NR_mount, 0ul, 0x20000140ul, 0x20000040ul, 0ul, 0ul);
  NONFAILING(memcpy((void*)0x20000180, "./file0\000", 8));
  res = syscall(__NR_open, 0x20000180ul, 0ul, 0ul);
  if (res != -1)
    r[0] = res;
  NONFAILING(memcpy((void*)0x200001c0, "cgroup.subtree_control\000", 23));
  res = syscall(__NR_openat, r[0], 0x200001c0ul, 2ul, 0ul);
  if (res != -1)
    r[1] = res;
  NONFAILING(*(uint8_t*)0x20000080 = 0x2d);
  NONFAILING(memcpy((void*)0x20000081, "pids", 4));
  NONFAILING(*(uint8_t*)0x20000085 = 0x20);
  syscall(__NR_write, r[1], 0x20000080ul, 6ul);
  NONFAILING(*(uint8_t*)0x200000c0 = 0x2b);
  NONFAILING(memcpy((void*)0x200000c1, "pids", 4));
  NONFAILING(*(uint8_t*)0x200000c5 = 0x20);
  inject_fault(38);
  syscall(__NR_write, r[1], 0x200000c0ul, 6ul);
}
int main(void)
{
