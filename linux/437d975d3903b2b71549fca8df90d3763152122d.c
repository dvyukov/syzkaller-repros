...
// https://syzkaller.appspot.com/bug?id=437d975d3903b2b71549fca8df90d3763152122d
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(memcpy((void*)0x20000200, "devtmpfs\000", 9));
  ...
  case 4:
    NONFAILING(memcpy((void*)0x20000040,
                      "\x11\xdc\xa5\x0d\x5e\x0b\xcf\xe4\x7b\xf0\x70", 11));
    syscall(__NR_ioctl, r[0], 0x1000008912, 0x20000040);
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20000240,
                      ...
                      "\006\360\274\254JY\347\262\214w\244U.\244\342u\035!jVL}#"
                      "O\t\262`\016\351\306*\367\370Uh\216\001\361b\365;"
                      "\212\027\232\017q\001\221pSR\202-H\n\037P\266*"
                      "\311\375\211\265\177\207m\"\252\316\355\a\362\375<"
                      "\020\270\317\372c\314\017\322\335\315#"
                      "8\"\213\362\314A\v\337\365\215\245-\002\252|"
                      "\335\320az\310,)\355f\211x>\a\023",
                      258));
    ...
    break;
  case 6:
    syscall(__NR_mmap, 0x20ffa000, 0x4000, 0, 0x12, r[1], 0);
    break;
  case 7:
    inject_fault(59);
