...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_sendmsg, r[0], 0, 0x20000000);
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x20b7a000 = 1);
    NONFAILING(*(uint32_t*)0x20b7a004 = 3);
    NONFAILING(*(uint64_t*)0x20b7a008 = 0x20346fc8);
    ...
    NONFAILING(*(uint8_t*)0x20346fd8 = 0x95);
    NONFAILING(*(uint8_t*)0x20346fd9 = 0);
    NONFAILING(*(uint16_t*)0x20346fda = 0);
    NONFAILING(*(uint32_t*)0x20346fdc = 0);
    NONFAILING(*(uint64_t*)0x20b7a010 = 0x20f6bffb);
    NONFAILING(memcpy((void*)0x20f6bffb, "GPL\000", 4));
    NONFAILING(*(uint32_t*)0x20b7a018 = 1);
    NONFAILING(*(uint32_t*)0x20b7a01c = 0xfb);
    NONFAILING(*(uint64_t*)0x20b7a020 = 0x200002c0);
    ...
    syscall(__NR_bpf, 5, 0x20b7a000, 0x48);
    break;
  case 5:
    syscall(__NR_socket, 0x29, 0x2000000002, 0);
    break;
  }
}
int main(void)
