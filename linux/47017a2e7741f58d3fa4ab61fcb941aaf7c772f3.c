...
{
  long res = 0;
  res = syscall(__NR_socket, 0x11, 0x4000000000080002, 0);
  if (res != -1)
    r[0] = res;
  *(uint64_t*)0x20000100 = 0x20000040;
  *(uint16_t*)0x20000040 = 0x1f;
  *(uint16_t*)0x20000042 = 0xdd86;
  ...
  *(uint64_t*)0x20000120 = 0x20000340;
  ...
  *(uint8_t*)0x200000c1 = 4;
  syscall(__NR_setsockopt, -1, 0x112, 4, 0x200000c0, 2);
}
