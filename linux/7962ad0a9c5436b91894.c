// WARNING: ODEBUG bug in batadv_nc_mesh_free (2)
// https://syzkaller.appspot.com/bug?id=7962ad0a9c5436b91894
// status:0
...
int main(void)
{
  ...
  *(uint64_t*)0x20000090 = 0x20000280;
  *(uint64_t*)0x20000280 = 0x200003c0;
