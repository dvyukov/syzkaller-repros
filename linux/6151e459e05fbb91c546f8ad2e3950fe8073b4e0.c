...
// https://syzkaller.appspot.com/bug?id=6151e459e05fbb91c546f8ad2e3950fe8073b4e0
// status:open
...
int main(void)
{
  ...
  *(uint8_t*)0x20000075 = 0;
  ...
  memcpy((void*)0x20005380, "\x12\x01\x00\x00\x00\x00\x00\x00\x5e\x04\xdb\x00"
                            "\x00\x00\x00\x00\x00\x01\x09\x02\x66\xff\x01\x00"
                            "\x00\x00\x00\x09\x04\x00\x00\x00\x03\x00\x00\x00"
                            "\x09\x21\x00\x00\x00\x01\x22\x00\x00\x09\x05\x81"
  ...
  *(uint64_t*)0x200001dc = 0;
  ...
  res = syz_open_dev(0x20000100, 4, 0x80000);
  if (res != -1)
    r[2] = res;
  *(uint8_t*)0x20000140 = 9;
  *(uint8_t*)0x20000141 = 4;
  *(uint16_t*)0x20000142 = 0x401;
  *(uint32_t*)0x20000144 = 0xd9;
  memcpy((void*)0x20000148, "\x29\xae\xc6\xe8\x65\xb1\x6a\x5e\xdb\xfc\x45\x66"
                            "\x7e\x7a\x83\xec\x6b\xb8\x74\x46\x36\x8e\x29\x3b"
                            "\xd7\xaf\xf5\xca\x00\x32\x37\xc9",
         32);
  syscall(__NR_ioctl, r[2], 0x40284504ul, 0x20000140ul);
  return 0;
}
