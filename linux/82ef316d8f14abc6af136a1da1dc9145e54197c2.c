...
void execute_call(int call)
{
  ...
  case 2:
    ...
    res = syscall(__NR_ioctl, r[1], 0x8933ul, 0x20001840ul);
    if (res != -1)
      NONFAILING(r[2] = *(uint32_t*)0x20001850);
    break;
  case 3:
    NONFAILING(*(uint16_t*)0x20000240 = 0x1d);
    NONFAILING(*(uint32_t*)0x20000244 = r[2]);
    ...
    break;
  case 4:
    NONFAILING(*(uint64_t*)0x20000140 = 0x200000c0);
    NONFAILING(*(uint16_t*)0x200000c0 = 0x1d);
    NONFAILING(*(uint16_t*)0x200000c2 = 0);
    NONFAILING(*(uint32_t*)0x200000c4 = 0xe);
    ...
    NONFAILING(memcpy((void*)0x20000000, "\x04\x08\x00\x00", 4));
    NONFAILING(*(uint16_t*)0x20000004 = 0);
    NONFAILING(*(uint64_t*)0x20000108 = 3);
  ...
  case 5:
    ...
    NONFAILING(*(uint32_t*)0x20001438 = 0);
    syscall(__NR_recvmmsg, r[0], 0x200013c0ul, 2ul, 0ul, 0ul);
    break;
  case 6:
    res = syscall(__NR_socket, 0x1dul, 2ul, 7ul);
    if (res != -1)
  ...
  case 8:
    NONFAILING(memcpy((void*)0x20001840,
                      "vcan0\000\000\000\000\000\000\000\000\000\000\000", 16));
    NONFAILING(*(uint32_t*)0x20001850 = 0);
    res = syscall(__NR_ioctl, r[4], 0x8933ul, 0x20001840ul);
    if (res != -1)
      NONFAILING(r[5] = *(uint32_t*)0x20001850);
    break;
  case 9:
    NONFAILING(*(uint16_t*)0x20000240 = 0x1d);
    NONFAILING(*(uint32_t*)0x20000244 = r[5]);
    NONFAILING(*(uint64_t*)0x20000248 = 0);
    NONFAILING(*(uint8_t*)0x20000250 = 0);
    NONFAILING(*(uint8_t*)0x20000251 = 0);
    NONFAILING(*(uint8_t*)0x20000252 = 0);
    NONFAILING(*(uint8_t*)0x20000253 = 0);
    NONFAILING(*(uint8_t*)0x20000254 = 0);
    syscall(__NR_bind, r[3], 0x20000240ul, 0x18ul);
    break;
  case 10:
    NONFAILING(*(uint64_t*)0x20000140 = 0x200000c0);
    NONFAILING(*(uint16_t*)0x200000c0 = 0x1d);
    ...
    NONFAILING(*(uint32_t*)0x200000c4 = 0xe);
    NONFAILING(*(uint32_t*)0x200000c8 = 0);
    NONFAILING(*(uint32_t*)0x20000148 = 0x200000cc);
    NONFAILING(*(uint64_t*)0x20000150 = 0x20000100);
    NONFAILING(*(uint64_t*)0x20000100 = 0x20000000);
    ...
    NONFAILING(*(uint8_t*)0x20000010 = 6);
    NONFAILING(*(uint8_t*)0x20000011 = 0);
    NONFAILING(*(uint16_t*)0x20000012 = 0);
    NONFAILING(*(uint64_t*)0x20000108 = 0x1f3);
    NONFAILING(*(uint64_t*)0x20000158 = 1);
    NONFAILING(*(uint64_t*)0x20000160 = 0);
    NONFAILING(*(uint64_t*)0x20000168 = 0);
    NONFAILING(*(uint32_t*)0x20000170 = 0);
