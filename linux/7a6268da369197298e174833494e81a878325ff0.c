...
// https://syzkaller.appspot.com/bug?id=7a6268da369197298e174833494e81a878325ff0
// status:fixed
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    NONFAILING(*(uint32_t*)0x20e68004 = htobe32(0x7f000001));
    ...
    syscall(__NR_sendto, r[0], 0x20000000, 0, 0x20000801, 0x20e68000, 0x10);
    break;
  case 3:
    NONFAILING(*(uint64_t*)0x200000c0 = 0x20000240);
    NONFAILING(*(uint64_t*)0x200000c8 = 0x6e);
    syscall(__NR_readv, r[0], 0x200000c0, 1);
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x20000100 = 7);
    syscall(__NR_setsockopt, r[0], 1, 0x40000000a, 0x20000100, 4);
    break;
  case 5:
    NONFAILING(
        memcpy((void*)0x20000000,
               "\x69\x63\x6d\x70\x36\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
               "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
               29));
    NONFAILING(*(uint8_t*)0x2000001d = 0);
    NONFAILING(*(uint32_t*)0x20000140 = 0x1e);
    syscall(__NR_getsockopt, r[0], 0, 0x42, 0x20000000, 0x20000140);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000180, "\x13", 1));
    NONFAILING(*(uint16_t*)0x20000040 = 2);
    NONFAILING(*(uint16_t*)0x20000042 = htobe16(0));
    NONFAILING(*(uint32_t*)0x20000044 = htobe32(0xe0000002));
    ...
    syscall(__NR_sendto, r[0], 0x20000180, 1, 0x87fd, 0x20000040, 0x10);
    break;
  }
}
