...
// https://syzkaller.appspot.com/bug?id=5828cf97028fd9e118957fd0febe8832d18d07c2
// status:open
...
void execute_one(void)
{
  ...
  syscall(__NR_mknod, 0x20000140, 0x1420, 0);
  memcpy((void*)0x20000200, "./file0\000", 8);
  res = syscall(__NR_open, 0x20000200, 0x20000000002, 0);
  if (res != -1)
    r[0] = res;
  ...
  *(uint8_t*)0x2000004e = 0x3d;
  sprintf((char*)0x2000004f, "0x%016llx", (long long)r[0]);
  *(uint8_t*)0x20000061 = 0x2c;
  memcpy((void*)0x20000062, "wfdno", 5);
  *(uint8_t*)0x20000067 = 0x3d;
  sprintf((char*)0x20000068, "0x%016llx", (long long)r[0]);
  *(uint8_t*)0x2000007a = 0x2c;
  memcpy((void*)0x2000007b, "version=9p2000.u", 16);
  ...
  *(uint8_t*)0x2000008c = 0;
  ...
  inject_fault(37);
  syscall(__NR_mount, 0, 0x20000580, 0x200005c0, 0, 0x20000040);
}
int main(void)
{
