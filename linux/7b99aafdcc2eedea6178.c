...
// https://syzkaller.appspot.com/bug?id=7b99aafdcc2eedea6178
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    sprintf((char*)0x20000280, "0x%016llx", (long long)-1);
    memcpy((void*)0x20000292, "\x2c\x72\x6f\x4a\xdd\xd0\x74\x2b\x65\x3d\x30\x30"
                              "\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30"
                              "\x30\x30\x30\x31\x73\x65\x72\x5f\x69\x60\x3d\x00"
                              "\x00\x00\x00\x00\x00",
           41);
    sprintf((char*)0x200002bb, "%020llu", (long long)0);
    memcpy((void*)0x200002cf, ",group_id=", 10);
    sprintf((char*)0x200002d9, "%020llu", (long long)0);
    memcpy((void*)0x200002ed, ",max_read=0x00000000000000b1,\000", 30);
    syz_mount_image(0x20000000, 0x20000040, 0, 0, 0, 0, 0x20000280);
    break;
  case 1:
    syscall(__NR_process_vm_writev, 0, 0ul, 0ul, 0x20c22fa0ul, 0ul, 0ul);
    break;
  case 2:
    syscall(__NR_gettid);
    break;
  case 3:
    ...
    break;
  case 4:
    *(uint32_t*)0x200005c0 = 0x169;
    syscall(__NR_setsockopt, r[0], 6, 2, 0x200005c0ul, 4ul);
    break;
  case 5:
    *(uint16_t*)0x20deb000 = 2;
    *(uint16_t*)0x20deb002 = htobe16(0x4e23);
    *(uint32_t*)0x20deb004 = htobe32(0xe0000001);
    syscall(__NR_bind, r[0], 0x20deb000ul, 0x10ul);
    break;
  case 6:
    ...
    *(uint8_t*)0x200008c7 = 0xaa;
    syscall(__NR_sendto, r[0], 0ul, 0ul, 0x200007fdul, 0x200008c0ul, 0x10ul);
    break;
  case 7:
    *(uint32_t*)0x20000100 = 0;
    syscall(__NR_setsockopt, r[0], 1, 8, 0x20000100ul, 4ul);
    break;
  case 8:
    *(uint64_t*)0x20000240 = 0;
    *(uint32_t*)0x20000248 = 0xfffffd83;
    *(uint64_t*)0x20000250 = 0x20000180;
    *(uint64_t*)0x20000180 = 0x20003ac0;
    *(uint64_t*)0x20000188 = 0x5801;
    *(uint64_t*)0x20000258 = 1;
    *(uint64_t*)0x20000260 = 0;
    *(uint64_t*)0x20000268 = 0xf080;
    *(uint32_t*)0x20000270 = 0;
    syscall(__NR_recvmsg, r[0], 0x20000240ul, 0x100ul, 0);
    break;
  case 9:
    syscall(__NR_membarrier, 0ul, 0ul);
    break;
  case 10:
    syscall(__NR_write, r[0], 0x200001c0ul, 0x1000001bdul);
    break;
  }
}
int main(void)
