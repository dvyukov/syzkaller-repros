...
// https://syzkaller.appspot.com/bug?id=3662a8e6ca7465ab7e833304cf942020f48e3f27
// status:open
...
void execute_one(void)
{
  ...
  NONFAILING(*(uint8_t*)0x2001d008 = 0x71);
  ...
  NONFAILING(*(uint32_t*)0x20001580 = 1);
  NONFAILING(*(uint32_t*)0x20001584 = 0x70);
  NONFAILING(*(uint8_t*)0x20001588 = 0);
  NONFAILING(*(uint8_t*)0x20001589 = 0);
  NONFAILING(*(uint8_t*)0x2000158a = 0);
  NONFAILING(*(uint8_t*)0x2000158b = 0);
  NONFAILING(*(uint32_t*)0x2000158c = 0);
  NONFAILING(*(uint64_t*)0x20001590 = 0x50d);
  NONFAILING(*(uint64_t*)0x20001598 = 0);
  NONFAILING(*(uint64_t*)0x200015a0 = 0);
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 0, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 1, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0x61, 2, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 3, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 4, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 5, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 6, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 7, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 8, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 9, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 10, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 11, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 12, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 13, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 14, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 15, 2));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 17, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 18, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 19, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 20, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 21, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 22, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 23, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 24, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 25, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 26, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 27, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 28, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, 0x200015a8, 0, 29, 35));
  NONFAILING(*(uint32_t*)0x200015b0 = 0);
  NONFAILING(*(uint32_t*)0x200015b4 = 0);
  NONFAILING(*(uint64_t*)0x200015b8 = 0x20000000);
  NONFAILING(*(uint64_t*)0x200015c0 = 0);
  NONFAILING(*(uint64_t*)0x200015c8 = 0x8000000000);
  NONFAILING(*(uint64_t*)0x200015d0 = 0);
  NONFAILING(*(uint32_t*)0x200015d8 = 0xfffffffd);
  NONFAILING(*(uint32_t*)0x200015dc = 0);
  NONFAILING(*(uint64_t*)0x200015e0 = 0);
  NONFAILING(*(uint32_t*)0x200015e8 = 1);
  NONFAILING(*(uint16_t*)0x200015ec = 0);
  NONFAILING(*(uint16_t*)0x200015ee = 0);
  syscall(__NR_perf_event_open, 0x20001580, 0, 0, -1, 0);
  ...
  NONFAILING(
      memcpy((void*)0x20000140,
             "\x3b\x87\x36\xd3\x8c\x7c\x2c\x51\xec\x57\x60\x85\xf3\x98\xd6\x46"
             "\xc8\x78\x90\xcd\x11\x92\x5c\x3f\x5c\xc2\x84\xf1\xbd\xc9\xc3\x40"
             "\x63\x48\x5a\x39\x80\xfb\xd6\x5f\x51\x00\x00\x00\x00\x00\x00\x00",
             48));
  syscall(__NR_write, r[0], 0x20000140, 0x30);
}
int main(void)
{
