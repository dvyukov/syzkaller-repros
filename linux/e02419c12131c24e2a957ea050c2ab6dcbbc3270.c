...
void execute_call(int call)
{
  ...
  case 1:
    *(uint32_t*)0x20000540 = -1;
    ...
    break;
  case 2:
    memcpy((void*)0x20000100, "/dev/ashmem", 12);
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000100, 0, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 3:
    syscall(__NR_ioctl, r[1], 0x40087703, 0xfffffffd);
    break;
  case 4:
    syscall(__NR_mmap, 0x206fc000, 0x4000, 0, 0x12, r[1], 0);
    break;
  case 5:
    memcpy((void*)0x20000040, "", 1);
    syscall(__NR_ioctl, r[1], 0x40087708, 0x20000040);
    break;
  case 6:
