...
void loop(void)
{
  ...
  *(uint32_t*)0x20000158 = 3;
  syscall(__NR_bind, r[0], 0x20000140, 0x1c);
  *(uint16_t*)0x20419000 = 0xa;
  *(uint16_t*)0x20419002 = htobe16(0x4e20);
  *(uint32_t*)0x20419004 = 0;
  *(uint8_t*)0x20419008 = 0xfe;
  *(uint8_t*)0x20419009 = 0x80;
  *(uint8_t*)0x2041900a = 0;
  *(uint8_t*)0x2041900b = 0;
  *(uint8_t*)0x2041900c = 0;
  *(uint8_t*)0x2041900d = 0;
  *(uint8_t*)0x2041900e = 0;
  *(uint8_t*)0x2041900f = 0;
  *(uint8_t*)0x20419010 = 0;
  *(uint8_t*)0x20419011 = 0;
  *(uint8_t*)0x20419012 = 0;
  *(uint8_t*)0x20419013 = 0;
  *(uint8_t*)0x20419014 = 0;
  *(uint8_t*)0x20419015 = 0;
  *(uint8_t*)0x20419016 = 0;
  *(uint8_t*)0x20419017 = 0xf;
  *(uint32_t*)0x20419018 = 0;
  syscall(__NR_connect, r[0], 0x20419000, 0x1c);
}
int main(void)
{
