...
// https://syzkaller.appspot.com/bug?id=ddc7b4944bc61da19b81
// status:6
...
void loop(void)
{
  ...
  *(uint64_t*)0x200000c8 = 0x12a000;
  *(uint32_t*)0x200000d0 = 0x1000;
  *(uint32_t*)0x200000d4 = 0;
  *(uint32_t*)0x200000d8 = 0;
  syscall(__NR_setsockopt, r[3], 0x11b, 4, 0x200000c0ul, 0x20ul);
  ...
  *(uint32_t*)0x20000080 = 0x80;
  ...
  if (res != -1)
    r[4] = res;
  memcpy((void*)0x20000140, "veth0_to_bond\000\000\000", 16);
  res = syscall(__NR_ioctl, r[4], 0x8933, 0x20000140ul);
  if (res != -1)
  ...
  *(uint32_t*)0x2000000c = r[3];
  inject_fault(0);
  syscall(__NR_bind, r[0], 0x20000000ul, 0x30ul);
}
int main(void)
{
