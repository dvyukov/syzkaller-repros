...
// https://syzkaller.appspot.com/bug?id=62904d6fe6bc658ae12a6446d5f28140920d8d96
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000380, "/dev/infiniband/rdma_cm\000", 24));
  ...
  case 2:
    ...
    break;
  case 3:
    NONFAILING(*(uint32_t*)0x20000080 = 0x12);
    ...
    syscall(__NR_write, r[2], 0x20000080, 0x18);
    break;
  case 4:
    ...
    NONFAILING(*(uint32_t*)0x20000110 = r[1]);
    NONFAILING(*(uint32_t*)0x20000114 = 0);
    syscall(__NR_write, r[0], 0x20000100, 0x20000118);
    break;
  }
}
int main(void)
