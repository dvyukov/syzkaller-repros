...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    memcpy((void*)0x20000100, "/dev/video35\x00", 13);
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000100, 2, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    syscall(__NR_ioctl, r[0], 0x80885659, 0x20000000);
    break;
  case 2:
    *(uint32_t*)0x200000c0 = 3;
    *(uint32_t*)0x200000c4 = 0x980914;
    *(uint32_t*)0x200000c8 = 0xfdfd;
    *(uint32_t*)0x200000cc = 0;
    *(uint32_t*)0x200000d0 = 0;
    *(uint32_t*)0x200000d4 = 0;
    *(uint32_t*)0x200000d8 = 0;
    *(uint32_t*)0x200000dc = 0;
    syscall(__NR_ioctl, r[0], 0x4020565a, 0x200000c0);
    break;
  }
}
int main(void)
