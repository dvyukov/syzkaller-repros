...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    *(uint32_t*)0x20000100 = 0x3fc;
    *(uint32_t*)0x20000104 = 0;
    *(uint32_t*)0x20000108 = 0;
    *(uint32_t*)0x2000010c = 0;
    syscall(__NR_setsockopt, r[1], 0x10f, 0x87, 0x20000100, 0x10);
    break;
  case 3:
    ...
    *(uint32_t*)0x2026500c = 0;
    ...
    break;
  case 4:
    syscall(__NR_sendmmsg, r[1], 0x20000000, 0x142, 0);
    break;
  case 5:
    syscall(__NR_setsockopt, r[1], 0x10f, 0x88);
    break;
  }
}
int main(void)
