...
// https://syzkaller.appspot.com/bug?id=08e3d39f3eb8643216be
// status:6
...
void execute_call(int call)
{
  ...
  case 7:
    ...
    *(uint32_t*)0x200001d8 = 0xebb;
    *(uint32_t*)0x200001dc = 0;
    *(uint16_t*)0x200001e0 = 0x2c;
    ...
    *(uint16_t*)0x200001e4 = 9;
    *(uint16_t*)0x200001e6 = 1;
    memcpy((void*)0x200001e8, "vlan\000", 5);
    ...
    *(uint32_t*)0x20000204 = 0xa;
    *(uint16_t*)0x20000208 = 4;
    STORE_BY_BITMASK(uint16_t, , 0x2000020a, 3, 0, 14);
    STORE_BY_BITMASK(uint16_t, , 0x2000020b, 0, 6, 1);
    STORE_BY_BITMASK(uint16_t, , 0x2000020b, 1, 7, 1);
    *(uint16_t*)0x2000020c = 8;
    *(uint16_t*)0x2000020e = 5;
