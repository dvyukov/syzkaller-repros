...
// https://syzkaller.appspot.com/bug?id=d0ddd88c9a7432f041e6
// status:6
...
void loop(void)
{
  ...
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x200000c0, "vcan0\000\000\000\000\000\000\000\000\000\000\000",
         16);
  ...
  *(uint8_t*)0x20000314 = 0;
  inject_fault(1);
  syscall(__NR_bind, r[2], 0x20000300ul, 0x18ul);
}
int main(void)
{
