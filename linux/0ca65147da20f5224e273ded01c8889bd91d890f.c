...
// https://syzkaller.appspot.com/bug?id=0ca65147da20f5224e273ded01c8889bd91d890f
// status:open
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x2000004c = 0xc3;
  syscall(__NR_connect, r[0], 0x20000040, 0xe);
  memcpy((void*)0x20000100, "\x05\x00\x00\xe4\xad\x27\xb3\xc8\x5a\xb8\xca\x66"
                            "\xf1\x00\x00\x04\x04\x00\x00\x00\x06",
         21);
  memcpy((void*)0x20000100,
         "i\212z\000\000\b\000\000\000\000\000\000\000\000\000\000", 16);
