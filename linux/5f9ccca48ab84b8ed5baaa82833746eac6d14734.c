...
void execute_one(void)
{
  ...
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x200005c0, "TIPCv2\000", 7);
  res = syz_genetlink_get_family_id(0x200005c0);
  if (res != -1)
    r[1] = res;
  *(uint64_t*)0x20000680 = 0;
  *(uint32_t*)0x20000688 = 0;
  *(uint64_t*)0x20000690 = 0x20000640;
  *(uint64_t*)0x20000640 = 0x20000000;
  *(uint32_t*)0x20000000 = 0x18;
  *(uint16_t*)0x20000004 = r[1];
  *(uint16_t*)0x20000006 = 0x323;
