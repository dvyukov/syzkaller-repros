// INFO: task hung in loop_control_ioctl (2)
// https://syzkaller.appspot.com/bug?id=bae47d79c35d962a0b62152c4265814f5ee37ad8
// status:open
...
{
  intptr_t res = 0;
  syz_read_part_table(0x100000000000, 0, 0);
  syscall(__NR_ioctl, -1, 0x8912ul, 0x400200ul);
  syscall(__NR_io_setup, 9, 0ul);
  NONFAILING(memcpy((void*)0x20000500, "/dev/loop-control\000", 18));
  ...
  if (res != -1)
    r[1] = res;
  syscall(__NR_ioctl, r[1], 0x4c81ul, 0x9999999999999999ul);
}
int main(void)
{
