...
// https://syzkaller.appspot.com/bug?id=0fe4efc137563eac3894
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_clone, 0x2000000000340700ul, 0ul, 0x9999999999999999ul, 0ul,
            -1ul);
    break;
  case 2:
  ...
  case 4:
    ...
    *(uint16_t*)0x20000044 = 0;
    syscall(__NR_connect, r[0], 0x20000040ul, 0x80ul);
    break;
  }
}
int main(void)
