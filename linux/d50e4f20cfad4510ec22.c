...
// https://syzkaller.appspot.com/bug?id=d50e4f20cfad4510ec22
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    *(uint32_t*)0x20000458 = -1;
    ...
    res = -1;
    res = syz_io_uring_setup(0x2de3, 0x20000440, 0x20002000, 0x20611000,
                             0x20000340, 0x200003c0);
    if (res != -1) {
      r[0] = res;
  ...
  case 1:
    ...
    break;
  case 2:
    *(uint8_t*)0x20000040 = 0x19;
    *(uint8_t*)0x20000041 = 0x1a;
    *(uint16_t*)0x20000042 = 0;
    *(uint32_t*)0x20000044 = 0;
    *(uint64_t*)0x20000048 = 0;
    *(uint64_t*)0x20000050 = 0x2020d000;
    *(uint32_t*)0x20000058 = 0x8000;
    ...
    *(uint16_t*)0x2000006a = 0;
    ...
    break;
  case 3:
    syscall(__NR_io_uring_enter, r[0], 0xe40, 0, 0ul, 0ul, 0ul);
    break;
  case 4:
    syscall(__NR_preadv, -1, 0ul, 0ul, 9, 0);
    break;
  case 5:
    syscall(__NR_io_uring_enter, r[0], 0x302, 0, 0ul, 0ul, 0ul);
    break;
  }
}
int main(void)
