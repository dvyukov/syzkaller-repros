...
void loop(void)
{
  ...
  *(uint64_t*)0x20000110 = 0x20001300;
  *(uint64_t*)0x20001300 = 0x20000000;
  *(uint32_t*)0x20000000 = 0x98;
  ...
  *(uint16_t*)0x20000014 = 0x70;
  STORE_BY_BITMASK(uint16_t, , 0x20000016, 8, 0, 14);
  STORE_BY_BITMASK(uint16_t, , 0x20000017, 0, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x20000017, 1, 7, 1);
  *(uint16_t*)0x20000018 = 0x38;
  ...
  *(uint16_t*)0x2000004c = 0x1000;
  *(uint16_t*)0x20000050 = 0x34;
  ...
  *(uint16_t*)0x20000054 = 0x20;
  *(uint16_t*)0x20000056 = 4;
  *(uint16_t*)0x20000058 = 0xa;
  *(uint16_t*)0x2000005a = htobe16(0x4e20);
  *(uint32_t*)0x2000005c = htobe32(5);
  ...
  *(uint16_t*)0x200004e8 = 0x24;
  *(uint16_t*)0x200004ea = 3;
  *(uint8_t*)0x200004ec = 0xbb;
  *(uint8_t*)0x200004ed = 0xbb;
  *(uint8_t*)0x200004ee = 0xbb;
  *(uint8_t*)0x200004ef = 0xbb;
  *(uint8_t*)0x200004f0 = 0xbb;
  *(uint8_t*)0x200004f1 = 0xbb;
  *(uint8_t*)0x200004f2 = 0xbb;
  *(uint8_t*)0x200004f3 = 0xbb;
  *(uint8_t*)0x200004f4 = 0xbb;
  *(uint8_t*)0x200004f5 = 0xbb;
  *(uint8_t*)0x200004f6 = 0xbb;
  *(uint8_t*)0x200004f7 = 0xbb;
  *(uint8_t*)0x200004f8 = 0xbb;
  *(uint8_t*)0x200004f9 = 0xbb;
  *(uint8_t*)0x200004fa = 0xbb;
  *(uint8_t*)0x200004fb = 0xbb;
  *(uint8_t*)0x200004fc = 0xbb;
  *(uint8_t*)0x200004fd = 0xbb;
  *(uint8_t*)0x200004fe = 0xbb;
  *(uint8_t*)0x200004ff = 0xbb;
  *(uint8_t*)0x20000500 = 0xbb;
  *(uint8_t*)0x20000501 = 0xbb;
  *(uint8_t*)0x20000502 = 0xbb;
  *(uint8_t*)0x20000503 = 0xbb;
  *(uint8_t*)0x20000504 = 0xbb;
  *(uint8_t*)0x20000505 = 0xbb;
  *(uint8_t*)0x20000506 = 0xbb;
  *(uint8_t*)0x20000507 = 0xbb;
  *(uint8_t*)0x20000508 = 0xbb;
  *(uint8_t*)0x20000509 = 0xbb;
  *(uint8_t*)0x2000050a = 0xbb;
  *(uint8_t*)0x2000050b = 0xbb;
