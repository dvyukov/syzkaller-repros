...
// https://syzkaller.appspot.com/bug?id=2da49cf28199dad792b6
// status:0
...
{
  intptr_t res = 0;
  syscall(__NR_sendmsg, -1, 0ul, 0x8000ul);
  syscall(__NR_ioctl, -1, 0xab00, -1);
  ...
  *(uint64_t*)0x20000200 = 0x20000540;
  memcpy((void*)0x20000540, "\x28\x00\x00\x00\x10\x00\x01\x08\x00\x00\x00\x00"
                            "\x00\x00\x5c\x54\x00\x00\x00\x00",
         20);
  *(uint32_t*)0x20000554 = 0;
  memcpy((void*)0x20000558, "\x00\x00\x00\x00\xd7\xfa\xf0\x00\x08\x00\x1b", 11);
  ...
  *(uint32_t*)0x20000170 = 0;
  ...
  memcpy((void*)0x20000380, "wlan0\000", 6);
  *(uint8_t*)0x20000700 = 1;
  *(uint8_t*)0x20000701 = 1;
  *(uint8_t*)0x20000702 = 1;
  *(uint8_t*)0x20000703 = 1;
  *(uint8_t*)0x20000704 = 1;
  *(uint8_t*)0x20000705 = 1;
  syz_80211_join_ibss(0x20000380, 0x20000700, 6, 0);
}
int main(void)
{
