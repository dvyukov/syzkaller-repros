...
// https://syzkaller.appspot.com/bug?id=59f777bdcbdd7eea5305
// status:6
...
void execute_one(void)
{
  ...
  memcpy((void*)0x20000000,
         "\x12\x01\x00\x00\x53\xac\x69\x10\x08\x16\x04\x00\x85\x40\x00\x00\x00"
         "\x01\x09\x02\x2d\x00\x01\x00\x00\x00\x00\x09\x04\x3c\x00\x03\x83\x6f"
         "\xbd\x00\x09\x05\x8d\x1f\x00\x70\xd3\x00\x00\x09\x05\x05\x02\x00\x00"
         "\x00\x00\x00\x09\x05\x8f\x1e",
         58);
  res = -1;
  res = syz_usb_connect(0, 0x3f, 0x20000000, 0);
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x20000300 = 0x2c;
  *(uint64_t*)0x20000304 = 0x20000040;
  *(uint8_t*)0x20000040 = 0;
  *(uint8_t*)0x20000041 = 0;
  *(uint32_t*)0x20000042 = 0x18;
  memcpy((void*)0x20000046,
         "\x8b\x09\x63\x50\xe4\xbe\x70\xe4\x47\xdd\x0f\xa8\x58\x9f\x59\xb5\x46"
         "\x49\x62\xae\xae\x9b\x81\x1c",
         24);
