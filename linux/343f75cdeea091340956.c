...
// https://syzkaller.appspot.com/bug?id=343f75cdeea091340956
// status:6 arch:386
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_vmsplice, (intptr_t)r[0], 0, 0, 0);
    break;
  case 3:
  ...
  case 7:
    ...
    syscall(__NR_io_submit, (intptr_t)r[2], 1, 0x200005c0);
    break;
  case 8:
    ...
    break;
  case 9:
    syscall(__NR_pidfd_open, (intptr_t)r[3], 0);
    break;
  }
}
int main(void)
