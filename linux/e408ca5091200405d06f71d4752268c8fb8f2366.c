...
// https://syzkaller.appspot.com/bug?id=e408ca5091200405d06f71d4752268c8fb8f2366
// status:open
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    NONFAILING(*(uint32_t*)0x2000008c = 0x2e);
    ...
    syscall(__NR_bpf, 0xc00000000000000, 0x20000080, 0x3c);
    break;
  case 4:
    syscall(__NR_memfd_create, 0, 0);
    break;
  case 5:
    syscall(__NR_sendmsg, -1, 0, 0x804);
    break;
  case 6:
  ...
  case 8:
    ...
    break;
  case 9:
    syscall(__NR_ioctl, r[0], 0xae01, 0);
    break;
  case 10:
    syscall(__NR_keyctl, 0x1c, 0, 0, 0, 0);
    break;
  }
}
int main(void)
