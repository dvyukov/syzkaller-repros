...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_clone, 0x200, 0, 0, 0, 0);
    break;
  case 1:
  ...
  case 3:
    ...
    if (res != -1) {
      r[0] = *(uint32_t*)0x20000300;
      r[1] = *(uint32_t*)0x20000304;
    }
    break;
  case 4:
    syscall(__NR_write, r[1], 0x20000040, 0xfffffdea);
    break;
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_splice, r[0], 0, r[2], 0, 0x20000000003, 9);
    break;
  }
}
int main(void)
