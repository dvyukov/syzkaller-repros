...
// https://syzkaller.appspot.com/bug?id=c49fe6089f295a05e6f8
// status:0
...
{
  intptr_t res = 0;
  syscall(__NR_mkdirat, 0xffffff9c, 0ul, 0ul);
  ...
  *(uint8_t*)0x205befec = 0;
  memcpy((void*)0x205befed, "\000\000\000\000\000\000\000\000\000\000\000\000"
         ...
         19);
  syscall(__NR_ioctl, r[1], 0x40045431, 0x205befdcul);
  res = -1;
  ...
  *(uint32_t*)0x20000040 = 0x15;
  inject_fault(9);
  syscall(__NR_ioctl, r[2], 0x5423, 0x20000040ul);
}
int main(void)
{
