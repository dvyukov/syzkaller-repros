...
// https://syzkaller.appspot.com/bug?id=e11117b179efa2af11e5ff07958eac8db8ba32a3
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_ioctl, r[0], 0x1269, 0);
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000000, "/dev/vhost-net\000", 15));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000000, 2, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 3:
    syscall(__NR_ioctl, r[1], 0x40000000af01, 0);
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000180, "/dev/audio\000", 11));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000180, 0, 0);
    if (res != -1)
      r[2] = res;
    break;
  case 5:
    syz_init_net_socket(3, 3, 0xf8);
    break;
  case 6:
    syscall(__NR_close, r[2]);
    break;
  case 7:
    syscall(__NR_ioctl, r[1], 0x4008af03, 0x20001100);
    break;
  case 8:
    NONFAILING(*(uint32_t*)0x20d7c000 = 0);
    NONFAILING(*(uint32_t*)0x20d7c004 = r[2]);
    syscall(__NR_ioctl, r[1], 0x4008af30, 0x20d7c000);
    break;
  }
}
int main(void)
