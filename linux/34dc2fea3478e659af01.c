...
// https://syzkaller.appspot.com/bug?id=34dc2fea3478e659af01
// status:6
...
void loop(void)
{
  ...
  *(uint16_t*)0x20000152 = 2;
  memcpy((void*)0x20000154, "syz2\000", 5);
  ...
  *(uint16_t*)0x20000166 = 0x33;
  memcpy((void*)0x20000168, "macvlan0\000\000\000\000\000\000\000\000", 16);
