...
// https://syzkaller.appspot.com/bug?id=18e38290a2a263b31aa0
// status:0
...
{
  intptr_t res = 0;
  NONFAILING(memcpy((void*)0x20000180, "\x04\x40\x00", 3));
  NONFAILING(syz_emit_vhci(0x20000180, 0x22));
  res = -1;
  ...
  NONFAILING(*(uint8_t*)0x20000007 = 0xe);
