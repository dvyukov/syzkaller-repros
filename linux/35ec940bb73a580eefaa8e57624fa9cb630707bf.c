...
// https://syzkaller.appspot.com/bug?id=35ec940bb73a580eefaa8e57624fa9cb630707bf
// status:fixed
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_socketpair, 1, 0x80002, 0, 0x20000080);
    break;
  case 4:
  ...
  case 12:
    NONFAILING(memcpy(
        ...
        421));
    syscall(__NR_ioctl, r[2], 0x8914, 0x20000780);
    break;
  case 13:
  ...
  case 16:
    ...
    syscall(__NR_write, r[3], 0x20000000, 0x17b);
    break;
  }
}
int main(void)
