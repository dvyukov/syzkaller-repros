// possible deadlock in iter_file_splice_write (2)
// https://syzkaller.appspot.com/bug?id=4bdbcaa79e8ee36fe6af
// status:3
...
void execute_call(int call)
{
  ...
  case 7:
    ...
    break;
  case 8:
    memcpy((void*)0x20000140, "./bus/file0\000", 12);
    syscall(__NR_creat, 0x20000140ul, 0ul);
    break;
  case 9:
    syscall(__NR_splice, r[0], 0ul, r[2], 0ul, 0x4ffdcul, 0ul);
    break;
  }
}
int main(void)
