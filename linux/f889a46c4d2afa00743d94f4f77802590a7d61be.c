...
// https://syzkaller.appspot.com/bug?id=f889a46c4d2afa00743d94f4f77802590a7d61be
// status:open
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x20000084 = 0xca;
  *(uint8_t*)0x20000085 = 0xd4;
  *(uint8_t*)0x20000086 = 0xe5;
  *(uint8_t*)0x20000087 = 0x10;
  *(uint16_t*)0x20000088 = 0x573;
  *(uint16_t*)0x2000008a = 0x4450;
  *(uint16_t*)0x2000008c = 0x76e;
