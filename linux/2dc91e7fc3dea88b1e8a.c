...
// https://syzkaller.appspot.com/bug?id=2dc91e7fc3dea88b1e8a
// status:6
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000100 = 0x200000c0;
  memcpy((void*)0x200000c0,
         "\x20\x00\x00\x00\x14\x00\x01\x04\x00\x00\x00\x00\x00\xe2\xfe\x5a\x23"
         "\x00\x00\x00",
         20);
  *(uint32_t*)0x200000d4 = r[2];
  memcpy((void*)0x200000d8, "\x08\x00\x02", 3);
  ...
  *(uint32_t*)0x200001b0 = 0;
  ...
  if (res != -1)
    r[3] = res;
  syscall(__NR_ioctl, r[3], 0x89ed, 0ul);
