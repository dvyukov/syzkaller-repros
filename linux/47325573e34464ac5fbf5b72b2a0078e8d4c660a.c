// KASAN: use-after-free Write in ld_usb_interrupt_in_callback
// https://syzkaller.appspot.com/bug?id=47325573e34464ac5fbf5b72b2a0078e8d4c660a
// status:dup
...
{
  intptr_t res = 0;
  memcpy((void*)0x20000000, "\x13\x01\x00\x00\x01\x3b\x98\x08\x11\x0f\x20\x20"
                            "\xc9\x48\x00\x00\x00\x01\x09\x02\x24\x00\x01\x00"
                            "\x00\x00\x00\x09\x04\x1c\x00\x02\x91\x26\xc9\x00"
                            "\x09\x05\x16\x1f\xb8\xf8\xff\x00\x00\x09\x05\x87"
                            "\x03\xa4\x7e\xe0\x64\x89",
         54);
