...
void test()
{
  ...
  syscall(__NR_mkdir, 0x20000000, 0x60);
  memcpy((void*)0x20b79ff8, "./file0", 8);
  memcpy((void*)0x20000100, "./file0", 8);
  memcpy((void*)0x20f9cffb, "proc", 5);
  syscall(__NR_mount, 0x20b79ff8, 0x20000100, 0x20f9cffb, 0, 0x20cde000);
  res = syscall(__NR_socket, 0x10, 3, 6);
  if (res != -1)
    r[0] = res;
  *(uint64_t*)0x20000000 = 0x20000ff4;
  ...
  *(uint32_t*)0x20000080 = 0xd0;
  *(uint16_t*)0x20000084 = 0x13;
  *(uint16_t*)0x20000086 = 0x601;
  *(uint32_t*)0x20000088 = 0x70bd27;
  *(uint32_t*)0x2000008c = 0x25dfdbfd;
  *(uint32_t*)0x20000090 = htobe32(0xe0000001);
  ...
  *(uint8_t*)0x200000af = 0x17;
  *(uint16_t*)0x200000b0 = htobe16(0x4e23);
  *(uint16_t*)0x200000b2 = htobe16(4);
  *(uint16_t*)0x200000b4 = htobe16(0x4e22);
  *(uint16_t*)0x200000b6 = htobe16(7);
  *(uint16_t*)0x200000b8 = 0xa;
  *(uint8_t*)0x200000ba = 0;
  *(uint8_t*)0x200000bb = 0xa0;
  ...
  *(uint64_t*)0x200000e0 = 6;
  *(uint64_t*)0x200000e8 = 0xc4;
  *(uint64_t*)0x200000f0 = 3;
  *(uint64_t*)0x200000f8 = 4;
  *(uint64_t*)0x20000100 = 0x708;
  *(uint64_t*)0x20000108 = 0xa54;
  *(uint64_t*)0x20000110 = 0x80000001;
  *(uint64_t*)0x20000118 = 6;
  *(uint64_t*)0x20000120 = 0x10001;
  *(uint32_t*)0x20000128 = 4;
  *(uint32_t*)0x2000012c = 0x6e6bb6;
  *(uint8_t*)0x20000130 = 2;
  *(uint8_t*)0x20000131 = 0;
  *(uint8_t*)0x20000132 = 2;
  *(uint8_t*)0x20000133 = 3;
  *(uint16_t*)0x20000138 = 0x10;
  *(uint16_t*)0x2000013a = 0xf;
  *(uint64_t*)0x20000140 = 0x81;
  *(uint16_t*)0x20000148 = 8;
  *(uint16_t*)0x2000014a = 0xb;
  *(uint32_t*)0x2000014c = 0x918b0c00;
