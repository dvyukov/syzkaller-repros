...
// https://syzkaller.appspot.com/bug?id=88a6c9cb23c5d25506d7
// status:3
...
void execute_call(int call)
{
  ...
  case 2:
    memcpy((void*)0x20000280,
           "\x15\x00\x00\x00\x65\xff\xff\x01\x84\x00\x11\x08\x00\x39\x50\x32"
           "\x30\x30\x30",
           19);
    syscall(__NR_write, r[1], 0x20000280ul, 0x15ul);
    break;
  case 3:
  ...
  case 4:
    ...
    *(uint64_t*)0x20000090 = 0;
    syscall(__NR_write, r[2], 0x20000080ul, 0x18ul);
    break;
  case 5:
  ...
  case 7:
    ...
    *(uint32_t*)0x200000ec = 0;
    ...
    break;
  case 8:
    memcpy((void*)0x200001c0, "/dev/nullb0\000", 12);
    memcpy((void*)0x200002c0, "./file0\000", 8);
    syscall(__NR_mount, 0x200001c0ul, 0x200002c0ul, 0ul, 0x408ul, 0ul);
    break;
  case 9:
    memcpy((void*)0x20000000, "./file0\000", 8);
    memcpy((void*)0x20000200, "9p\000", 3);
    memcpy((void*)0x20000600, "trans=fd,rfdno=", 15);
    sprintf((char*)0x2000060f, "0x%016llx", (long long)r[0]);
    memcpy((void*)0x20000621, ",wfdno=", 7);
    sprintf((char*)0x20000628, "0x%016llx", (long long)r[1]);
    syscall(__NR_mount, 0ul, 0x20000000ul, 0x20000200ul, 0ul, 0x20000600ul);
    break;
  case 10:
    syscall(__NR_read, -1, 0x20008a40ul, 0x2020ul);
    break;
  case 11:
    memcpy((void*)0x20000580, "./file0\000", 8);
    syscall(__NR_lchown, 0x20000580ul, 0, 0);
    break;
  case 12:
    ...
    break;
  case 13:
    syscall(__NR_getdents, r[3], 0ul, 2ul);
    break;
  case 14:
    syscall(__NR_getdents64, r[3], 0ul, 0x34ul);
    break;
  case 15:
