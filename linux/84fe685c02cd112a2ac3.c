...
// https://syzkaller.appspot.com/bug?id=84fe685c02cd112a2ac3
// status:0
...
void loop(void)
{
  ...
  res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000000ul, 0x2242ul, 0ul);
  if (res != -1)
    r[0] = res;
  NONFAILING(*(uint32_t*)0x200000c0 = 0x30);
  ...
  syscall(__NR_write, r[0], 0x200000c0ul, 0x18ul);
}
int main(void)
{
