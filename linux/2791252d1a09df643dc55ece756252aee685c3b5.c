...
// https://syzkaller.appspot.com/bug?id=2791252d1a09df643dc55ece756252aee685c3b5
// status:open
...
void execute_call(int call)
{
  ...
  case 7:
    ...
    *(uint8_t*)0x20000003 = 0xfc;
    syscall(__NR_setsockopt, r[3], 0x107, 0x12, 0x20000000, 4);
    break;
  case 8:
    ...
    *(uint8_t*)0x200001c7 = 0xaa;
    syscall(__NR_bind, r[2], 0x200001c0, 0x10);
    break;
  case 9:
    *(uint16_t*)0x20000040 = 2;
    *(uint16_t*)0x20000042 = htobe16(0);
    *(uint32_t*)0x20000044 = htobe32(0xe0000001);
    syscall(__NR_connect, r[2], 0x20000040, 0x10);
    break;
  case 10:
    syscall(__NR_splice, r[0], 0, r[2], 0, 0x200010005, 0);
    break;
  }
}
int main(void)
