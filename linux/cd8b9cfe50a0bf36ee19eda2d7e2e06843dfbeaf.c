...
void loop(void)
{
  ...
  *(uint8_t*)0x20000304 = 0x57;
  *(uint8_t*)0x20000305 = 0xa2;
  *(uint8_t*)0x20000306 = 0x8e;
  *(uint8_t*)0x20000307 = 0x40;
  *(uint16_t*)0x20000308 = 0xcf3;
  *(uint16_t*)0x2000030a = 0x9374;
  *(uint16_t*)0x2000030c = 0x9e2c;
  ...
  *(uint8_t*)0x2000031d = 0x51;
  *(uint8_t*)0x2000031e = 0;
  *(uint8_t*)0x2000031f = 1;
  *(uint8_t*)0x20000320 = 0x1d;
  *(uint8_t*)0x20000321 = 0x4a;
  *(uint8_t*)0x20000322 = 0x1d;
  *(uint8_t*)0x20000323 = 0;
  *(uint8_t*)0x20000324 = 7;
  *(uint8_t*)0x20000325 = 5;
  *(uint8_t*)0x20000326 = 0;
  *(uint8_t*)0x20000327 = 1;
  *(uint16_t*)0x20000328 = 2;
  *(uint8_t*)0x2000032a = 0x17;
  *(uint8_t*)0x2000032b = 0xf8;
  *(uint8_t*)0x2000032c = 8;
  *(uint8_t*)0x2000032d = 2;
  *(uint8_t*)0x2000032e = 0x1f;
  *(uint8_t*)0x2000032f = 2;
  *(uint8_t*)0x20000330 = 0x10;
  syz_usb_connect(0x8000000004, 0x31, 0x20000300, 0);
  close_fds();
}
int main(void)
{
