...
// https://syzkaller.appspot.com/bug?id=55fc56e39caaf4f597fdbf388108892196d55f3f
// status:open
...
void loop(void)
{
  ...
  *(uint32_t*)0x20000108 = 0x6c000000;
  *(uint64_t*)0x20000110 = 0x200001c0;
  *(uint64_t*)0x200001c0 = 0x200005c0;
  ...
  *(uint16_t*)0x200005d8 = 0x10;
  *(uint16_t*)0x200005da = 1;
  memcpy((void*)0x200005dc, "udp:syz0\000", 9);
  *(uint16_t*)0x200005e8 = 0x2c;
  *(uint16_t*)0x200005ea = 4;
  *(uint16_t*)0x200005ec = 0x14;
  *(uint16_t*)0x200005ee = 1;
  *(uint16_t*)0x200005f0 = 2;
  *(uint16_t*)0x200005f2 = htobe16(0);
  *(uint32_t*)0x200005f4 = htobe32(0xac141410);
  *(uint16_t*)0x20000600 = 0x14;
  *(uint16_t*)0x20000602 = 2;
  *(uint16_t*)0x20000604 = 2;
