...
// https://syzkaller.appspot.com/bug?id=1eb40bc37200013752ad
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000480, "nl80211\000", 8));
    NONFAILING(syz_genetlink_get_family_id(0x20000480, -1));
    break;
  }
}
int main(void)
