...
// https://syzkaller.appspot.com/bug?id=e2efa3efc15a1c9e95c3
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint64_t*)0x20000258 = 0x1000);
    ...
    NONFAILING(memcpy(
        ...
        "\xff",
        4098));
    NONFAILING(*(uint64_t*)0x20000268 = 0x1002);
    NONFAILING(*(uint64_t*)0x20000270 = 0x2000);
    NONFAILING(*(uint64_t*)0x20000278 = 0x20012600);
    NONFAILING(memcpy(
        (void*)0x20012600,
        ...
        61));
    NONFAILING(*(uint64_t*)0x20000280 = 0x3d);
    NONFAILING(*(uint64_t*)0x20000288 = 0x4400);
    NONFAILING(syz_mount_image(0x20000000, 0x20000100, 0x200000, 6, 0x20000200,
                               0, 0x200000c0));
    break;
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_mmap, 0x20000000ul, 0x800000ul, 0x180000bul, 0x12ul, r[0],
            0ul);
    break;
  case 3:
    ...
    NONFAILING(*(uint64_t*)0x2001d010 = 0x20);
  ...
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_ioctl, -1, 0x8940, 0ul);
    break;
  case 6:
    syscall(__NR_ioctl, r[1], 0x89f0, 0ul);
    break;
  case 7:
    res = syscall(__NR_socket, 2ul, 2ul, 0x88);
    if (res != -1)
    ...
    break;
  case 8:
    syscall(__NR_ioctl, r[2], 0x89f0, 0ul);
    break;
  case 9:
  ...
  case 12:
    ...
    NONFAILING(*(uint32_t*)0x20005788 = 0);
    ...
    NONFAILING(*(uint32_t*)0x200057b0 = 0x890);
    NONFAILING(*(uint32_t*)0x200057b8 = 0);
    NONFAILING(*(uint64_t*)0x200057c0 = 0);
    NONFAILING(*(uint32_t*)0x200057c8 = 0);
    NONFAILING(*(uint64_t*)0x200057d0 = 0);
    NONFAILING(*(uint64_t*)0x200057d8 = 0);
    NONFAILING(*(uint64_t*)0x200057e0 = 0);
    NONFAILING(*(uint64_t*)0x200057e8 = 0xd0);
    NONFAILING(*(uint32_t*)0x200057f0 = 0x8000);
    NONFAILING(*(uint32_t*)0x200057f8 = 0);
    NONFAILING(*(uint64_t*)0x20005800 = 0);
    NONFAILING(*(uint32_t*)0x20005808 = 0);
    NONFAILING(*(uint64_t*)0x20005810 = 0x20000f00);
    ...
    NONFAILING(*(uint64_t*)0x20000f40 = 0x20000d80);
    NONFAILING(memcpy(
        (void*)0x20000d80,
        "\x35\x4d\x24\x1e\x53\xc7\xf7\xb2\xd8\x7d\xa7\x6d\xe6\x2d\xb2\xc2\x3e"
        "\x94\x38\xb0\x73\x86\xd8\xb5\x0a\x5f\x28\xc7\x71\x5e\xbe\x05\xe4\xfb"
        "\x13\xa3\x10\x93\xb2\x1b\x4f\x0e\x7d\xef\x51\x07\xdc\x0e\x0e\x05\xa7"
        "\x1e\x62\xfa\xac\x65\x74\x57\xab\x73\x66\xd5\x6e\xd1\xae\xe1\x40\xcf"
        "\xb0\x6d\xbc\x52\xba\x5e\xe0\xe8\xc5\x8e\xa3\x3c\x3a\x79\x3f\xc6\x24"
        "\x0e\x2c\x35\x1f\x00\xef\xcf\xe2\x41\x72\xd3\x83\xcf\xf3\xb7\xe3\xb1"
        "\x65\xa8\xec\x21\x6f\x2c\x2f\xd6\x76\x2c\x94\x17\xb4\x45\xef\x65\x8f"
        "\xfd\x41\x9c\xce\x1b\x4b\x87\xce\xe9\xbf\xa5\x5d\x34\xbe\x96\xd4\x39"
        "\xba\xd1\x81\x63\x2f\x59\x91\x24\x23\x2d\xe3\x95\xf9\xc3\x3a\x66\x36"
        "\x36\x94\x2d\x8a\xa7\x30\xfc\xd2\x8b\x9b\x04\xbf\x8e\x26\xab\x0b\x05"
        "\xae\xcc\x7c\x2b\x93\xf8\x2c\xce\x34\x32\xfc\xa3\x4c\x12\x31\x9b\xd7"
        "\x05\x00\xb7\x23\x97\x09\x3c\x80\xf4\xb4\x7f\xeb\x8d\x37\x01\xff\xbd"
        "\xcd\x2a\x89\xee\x39\x64\xd7\x30\xee\xc5\x3c\x38\xcb\x0a\xa5\x82\xbb"
        "\xc3\x44\xf1\xad\xd8\xad\xcd\x1c\x4f\x2f\xb9\x78\x09\xff",
        235));
    NONFAILING(*(uint64_t*)0x20000f48 = 0xeb);
    NONFAILING(*(uint64_t*)0x20000f50 = 0);
    NONFAILING(*(uint64_t*)0x20000f58 = 0);
    NONFAILING(*(uint64_t*)0x20005818 = 6);
    NONFAILING(*(uint64_t*)0x20005820 = 0);
    NONFAILING(*(uint64_t*)0x20005828 = 0x98);
    NONFAILING(*(uint32_t*)0x20005830 = 4);
    NONFAILING(*(uint32_t*)0x20005838 = 0);
    NONFAILING(*(uint64_t*)0x20005840 = 0);
    NONFAILING(*(uint32_t*)0x20005848 = 0);
    ...
    NONFAILING(*(uint32_t*)0x20005870 = 0x8000045);
    NONFAILING(*(uint32_t*)0x20005878 = 0);
    NONFAILING(*(uint64_t*)0x20005880 = 0);
    NONFAILING(*(uint32_t*)0x20005888 = 0);
    ...
    NONFAILING(*(uint32_t*)0x200058b0 = 0x20000014);
    NONFAILING(*(uint32_t*)0x200058b8 = 0);
    syscall(__NR_sendmmsg, -1, 0x20005780ul, 5ul, 0x20000000ul);
    break;
  case 13:
    syscall(__NR_stat, 0ul, 0ul);
    break;
  case 14:
    syscall(__NR_lchown, 0ul, 0, 0xee01);
    break;
  case 15:
    NONFAILING(*(uint64_t*)0x20000440 = 0);
    NONFAILING(*(uint64_t*)0x20000448 = 0);
    NONFAILING(*(uint64_t*)0x20000450 = 0x3ff);
    NONFAILING(*(uint64_t*)0x20000458 = 0);
    NONFAILING(*(uint64_t*)0x20000460 = 0);
    NONFAILING(*(uint64_t*)0x20000468 = 0x430d);
    NONFAILING(*(uint64_t*)0x20000470 = 0);
    NONFAILING(*(uint64_t*)0x20000478 = 0);
    NONFAILING(*(uint64_t*)0x20000480 = 0x4afb);
    NONFAILING(*(uint64_t*)0x20000488 = 0);
    NONFAILING(*(uint64_t*)0x20000490 = 0);
    NONFAILING(*(uint64_t*)0x20000498 = 8);
    NONFAILING(syz_mount_image(0, 0, 5, 4, 0x20000440, 0x50401, 0));
    break;
  case 16:
    syscall(__NR_preadv, r[0], 0ul, 0ul, 0xd9f, 0);
    break;
  case 17:
    NONFAILING(memcpy((void*)0x20000400, "./file0/file1\000", 14));
    res = syscall(__NR_creat, 0x20000400ul, 0ul);
    if (res != -1)
      r[3] = res;
    break;
  case 18:
