...
// https://syzkaller.appspot.com/bug?id=53db445acb5569d6ec2d55c3ee599ceb5a41dfd2
// status:open
...
{
  long res = 0;
  memcpy((void*)0x20000040, "./cgroup.cpu\000", 13);
  ...
  *(uint32_t*)0x2000001c = 0;
  ...
  syscall(__NR_fcntl, r[1], 4, 0x4002);
  res = syscall(__NR_io_setup, 8, 0x20000080);
  if (res != -1)
  ...
  *(uint64_t*)0x20000200 = 9;
  syscall(__NR_ioctl, r[1], 0x40086602, 0x20000200);
}
int main(void)
{
