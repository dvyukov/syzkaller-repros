...
// https://syzkaller.appspot.com/bug?id=7ba9b744545379f0653a
// status:0
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[0] = res;
  NONFAILING(memcpy((void*)0x20000080, "cpu.stat\000", 9));
  res = syscall(__NR_openat, 0xffffff9c, 0x20000080ul, 0x275aul, 0ul);
  if (res != -1)
    r[1] = res;
  syscall(__NR_mmap, 0x20000000ul, 0x3000ul, 1ul, 0x12ul, r[1], 0ul);
  syscall(__NR_ftruncate, r[1], 0x40ul);
  NONFAILING(memcpy((void*)0x20000080, "./file0\000", 8));
  syscall(__NR_execveat, r[0], 0x20000080ul, 0ul, 0ul, 0x1000ul);
}
int main(void)
{
