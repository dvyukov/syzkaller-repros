...
// https://syzkaller.appspot.com/bug?id=f31660cf279b0557160c
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(memcpy(
        (void*)0x20000800,
        "\x14\x00\x00\x00\x10\x00\x01\x00\x00\x80\x00\x00\x00\x00\x00\x00\x00"
        ...
        67));
    NONFAILING(*(uint64_t*)0x20000188 = 0x50);
  ...
  case 3:
    ...
    NONFAILING(*(uint64_t*)0x20000d90 = 0x20000d40);
    NONFAILING(*(uint64_t*)0x20000d40 = 0x20000000);
    NONFAILING(
        memcpy((void*)0x20000000,
               "\x20\x00\x00\x00\x0a\x0a\xdf\x03\x00\xd7\x00\x00\x00\x00\x00"
               "\x00\x00\x00\x00\x03\x09\x00\x01\x00\x73\x79\x7a\x30",
               28));
    NONFAILING(*(uint64_t*)0x20000d48 = 0x20);
    NONFAILING(*(uint64_t*)0x20000d98 = 1);
    NONFAILING(*(uint64_t*)0x20000da0 = 0xf00);
    NONFAILING(*(uint64_t*)0x20000da8 = 0);
    NONFAILING(*(uint32_t*)0x20000db0 = 0);
    syscall(__NR_sendmsg, r[1], 0x20000d80ul, 0ul);
    break;
  }
}
int main(void)
