...
// https://syzkaller.appspot.com/bug?id=2392b215ef79ffb19d835a1be0f5b5996564fd2d
// status:fixed
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_openat, 0xffffffffffffff9cul, 0ul, 0x80000000000a01ul, 0ul);
    break;
  case 1:
  ...
  case 4:
    ...
    NONFAILING(*(uint32_t*)0x2000020c = 0x1f);
    NONFAILING(*(uint8_t*)0x20000210 = 0);
    NONFAILING(memcpy((void*)0x20000211,
                      "\000\000\000\000\000\000\000\000\000\000\000\000\000\000"
                      "\000\000\000\000\000",
                      19));
    syscall(__NR_ioctl, r[1], 0x5403ul, 0x20000200ul);
    break;
  case 5:
    syscall(__NR_ioctl, r[1], 0x5403ul, 0ul);
    break;
  case 6:
