...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000000, "/dev/uhid", 10));
  ...
  case 1:
    ...
    NONFAILING(memcpy(
        ...
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
        64));
    NONFAILING(*(uint64_t*)0x20000604 = 0x200011c0);
    NONFAILING(*(uint16_t*)0x2000060c = 0x1000);
    NONFAILING(*(uint16_t*)0x2000060e = 0);
    ...
    syscall(__NR_write, r[0], 0x20000500, 0x120);
    break;
  }
}
int main(void)
