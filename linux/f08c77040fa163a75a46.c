...
// https://syzkaller.appspot.com/bug?id=f08c77040fa163a75a46
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    memcpy(
        (void*)0x20000040,
        "\x05\x01\x00\x00\xb2\x4b\x4a\x10\xe6\x04\x03\x00\x77\x01\x00\x00\x00"
        ...
        49);
    res = -1;
    res = syz_usb_connect(0, 0x10b, 0x20000040, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
