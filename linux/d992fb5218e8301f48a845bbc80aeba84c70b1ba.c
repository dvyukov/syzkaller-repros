...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000000, "/dev/sequencer", 15));
  ...
  case 1:
    ...
    res = syz_open_dev(0x20000040, 0xe440, 1);
    if (res != -1)
      r[1] = res;
    break;
  case 2:
    ...
    syscall(__NR_setsockopt, r[0], 1, 0x15, 0x20000080, 8);
    break;
  case 3:
    NONFAILING(*(uint32_t*)0x20000100 = 0);
    NONFAILING(*(uint32_t*)0x20000104 = 0x800);
    NONFAILING(*(uint32_t*)0x20000108 = 7);
    NONFAILING(*(uint32_t*)0x2000010c = 0x71f);
    ...
    syscall(__NR_ioctl, r[1], 0xc0205710, 0x20000100);
    break;
  case 4:
    NONFAILING(*(uint64_t*)0x20000700 = 0);
    NONFAILING(*(uint32_t*)0x20000708 = 0);
    NONFAILING(*(uint64_t*)0x20000710 = 0x20000600);
    NONFAILING(*(uint64_t*)0x20000600 = 0x200002c0);
    NONFAILING(*(uint64_t*)0x20000608 = 0);
    NONFAILING(*(uint64_t*)0x20000718 = 1);
    NONFAILING(*(uint64_t*)0x20000720 = 0x20000680);
    NONFAILING(*(uint64_t*)0x20000728 = 0);
    NONFAILING(*(uint32_t*)0x20000730 = 0);
    syscall(__NR_sendmsg, -1, 0x20000700, 0);
    break;
  case 5:
    syscall(__NR_ftruncate, r[1], 0x226);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x200000c0, "threaded", 9));
    syscall(__NR_write, r[1], 0x200000c0, 0xff4c);
    break;
  }
}
