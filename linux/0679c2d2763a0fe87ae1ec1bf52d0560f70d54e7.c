...
// https://syzkaller.appspot.com/bug?id=0679c2d2763a0fe87ae1ec1bf52d0560f70d54e7
// status:open
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x20000060 = 0x47;
  *(uint8_t*)0x20000061 = 0x28;
  *(uint8_t*)0x20000062 = 0x7d;
  *(uint8_t*)0x20000063 = 3;
  syz_usb_connect(0x1000000, 0x24, 0x20000040, 0);
}
int main(void)
{
