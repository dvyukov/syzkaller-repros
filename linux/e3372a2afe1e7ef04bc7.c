...
// https://syzkaller.appspot.com/bug?id=e3372a2afe1e7ef04bc7
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint32_t*)0x20000088 = 6);
    ...
    res = syscall(__NR_ioctl, r[0], 0xc02064b2, 0x20000080ul);
    if (res != -1)
      NONFAILING(r[1] = *(uint32_t*)0x20000090);
    break;
  case 2:
    NONFAILING(*(uint32_t*)0x200000c0 = r[1]);
    syscall(__NR_ioctl, r[0], 0xc00464b4, 0x200000c0ul);
    break;
  }
}
int main(void)
