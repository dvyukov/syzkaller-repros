...
// https://syzkaller.appspot.com/bug?id=771a9fd5d128e0a5708c
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20001000ul, 0ul, 0ul);
    if (res != -1)
      r[3] = res;
    break;
  case 2:
    syscall(__NR_mmap, 0x20002000ul, 0x4000ul, 0ul, 0x12ul, r[0], 0x8000000ul);
    break;
  case 3:
    NONFAILING(*(uint64_t*)0x20000040 = 0x7c0);
    syscall(__NR_ioctl, r[3], 0x1264, 0x20000040ul);
    break;
  case 4:
    ...
    NONFAILING(*(uint32_t*)0x20000018 = 0xfffffded);
    ...
    break;
  case 5:
    syscall(__NR_io_uring_enter, r[0], 3, 0, 0ul, 0ul, 0ul);
    break;
  }
}
int main(void)
