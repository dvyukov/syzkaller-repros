// KASAN: invalid-free in bdev_free_inode (2)
// https://syzkaller.appspot.com/bug?id=5fa698422954b6b9307b
// status:0
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    res = -1;
    NONFAILING(res = syz_genetlink_get_family_id(0x20001040, r[1]));
    if (res != -1)
      r[2] = res;
    break;
  case 4:
    NONFAILING(*(uint64_t*)0x20000540 = 0);
    NONFAILING(*(uint32_t*)0x20000548 = 0x5000);
    NONFAILING(*(uint64_t*)0x20000550 = 0x20000500);
    NONFAILING(*(uint64_t*)0x20000500 = 0x200002c0);
    NONFAILING(memcpy((void*)0x200002c0, ",\000\000\000", 4));
    NONFAILING(*(uint16_t*)0x200002c4 = r[2]);
    NONFAILING(memcpy((void*)0x200002c6,
                      "\x01\x00\x00\x00\x00\x00\xff\x00\x00\x00\x01\x00\x00\x00"
                      "\x04\x00\x07\x80\x0c\x00\x02\x00\x00\x00\x00\x00\x00\x00"
