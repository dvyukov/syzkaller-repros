...
// https://syzkaller.appspot.com/bug?id=ffad4c74b3b3ea3aa9c3
// status:6
...
void loop(void)
{
  memcpy((void*)0x20000080,
         "\x12\x01\x00\x00\x95\x2b\xb6\x20\x1e\x73\x8c\x12\x06\xed\x00\x00\x00"
         "\x01\x09\x02\x22\x00\x01\x08\x00\x00\x00\x09\x04\x00\x00\x01\x01\x03",
         34);
  syz_usb_connect(0, 0x34, 0x20000080, 0);
  close_fds();
}
int main(void)
{
