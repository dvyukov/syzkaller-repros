...
// https://syzkaller.appspot.com/bug?id=a063bbf0b15737362592
// status:0
...
{
  intptr_t res = 0;
  NONFAILING(syz_80211_inject_frame(0, 0, 0));
  NONFAILING(memcpy((void*)0x20000100, "nl80211\000", 8));
  res = -1;
  NONFAILING(res = syz_genetlink_get_family_id(0x20000100));
  if (res != -1)
    r[0] = res;
  ...
  NONFAILING(*(uint32_t*)0x20000258 = r[3]);
  NONFAILING(*(uint16_t*)0x2000025c = 0x47);
  NONFAILING(*(uint16_t*)0x2000025e = 0x33);
  NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000260, 0, 0, 2));
  NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000260, 0, 2, 2));
  NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000260, 4, 4, 4));
  NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000261, 0, 0, 1));
  NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000261, 0, 1, 1));
  NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000261, 0, 2, 1));
  NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000261, 0, 3, 1));
  NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000261, 0, 4, 1));
  NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000261, 0, 5, 1));
  NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000261, 0, 6, 1));
  NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000261, 0, 7, 1));
  NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000262, 0, 0, 15));
  NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000263, 0, 7, 1));
  NONFAILING(*(uint8_t*)0x20000264 = 8);
  NONFAILING(*(uint8_t*)0x20000265 = 2);
  NONFAILING(*(uint8_t*)0x20000266 = 0x11);
  NONFAILING(*(uint8_t*)0x20000267 = 0);
  NONFAILING(*(uint8_t*)0x20000268 = 0);
  NONFAILING(*(uint8_t*)0x20000269 = 0);
  NONFAILING(*(uint8_t*)0x2000026a = 8);
  NONFAILING(*(uint8_t*)0x2000026b = 2);
  NONFAILING(*(uint8_t*)0x2000026c = 0x11);
  NONFAILING(*(uint8_t*)0x2000026d = 0);
  NONFAILING(*(uint8_t*)0x2000026e = 0);
  NONFAILING(*(uint8_t*)0x2000026f = 0);
  NONFAILING(*(uint8_t*)0x20000270 = 0x50);
  NONFAILING(*(uint8_t*)0x20000271 = 0x50);
  NONFAILING(*(uint8_t*)0x20000272 = 0x50);
  NONFAILING(*(uint8_t*)0x20000273 = 0x50);
  NONFAILING(*(uint8_t*)0x20000274 = 0x50);
  NONFAILING(*(uint8_t*)0x20000275 = 0x50);
  NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000276, 0, 0, 4));
  NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000276, 0, 4, 12));
  ...
  NONFAILING(*(uint8_t*)0x2000027c = 3);
  NONFAILING(*(uint8_t*)0x2000027d = 1);
  NONFAILING(*(uint8_t*)0x2000027e = 0);
  NONFAILING(*(uint8_t*)0x2000027f = 0x2d);
  NONFAILING(*(uint8_t*)0x20000280 = 0x1a);
  NONFAILING(*(uint16_t*)0x20000281 = 0);
  NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000283, 0, 0, 2));
  NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000283, 0, 2, 3));
  NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000283, 0, 5, 3));
  NONFAILING(*(uint64_t*)0x20000284 = 0);
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2000028c, 0, 0, 13));
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2000028d, 0, 5, 3));
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2000028e, 0, 0, 10));
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2000028f, 0, 2, 6));
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000290, 0, 0, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000290, 0, 1, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000290, 0, 2, 2));
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000290, 0, 4, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000290, 0, 5, 27));
  NONFAILING(*(uint16_t*)0x20000294 = 0);
  NONFAILING(*(uint32_t*)0x20000296 = 0);
  NONFAILING(*(uint8_t*)0x2000029a = 0);
  NONFAILING(*(uint8_t*)0x2000029b = 0x72);
  NONFAILING(*(uint8_t*)0x2000029c = 6);
  NONFAILING(*(uint8_t*)0x2000029d = 3);
  NONFAILING(*(uint8_t*)0x2000029e = 3);
  NONFAILING(*(uint8_t*)0x2000029f = 3);
  NONFAILING(*(uint8_t*)0x200002a0 = 3);
  NONFAILING(*(uint8_t*)0x200002a1 = 3);
  NONFAILING(*(uint8_t*)0x200002a2 = 3);
  NONFAILING(*(uint64_t*)0x20000148 = 0x64);
