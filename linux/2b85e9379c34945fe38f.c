...
// https://syzkaller.appspot.com/bug?id=2b85e9379c34945fe38f
// status:0
...
int main(void)
{
  ...
  *(uint32_t*)0x200002d8 = -1;
  ...
  res = -1;
  res = syz_io_uring_setup(0x187, 0x200002c0, 0x20ee7000, 0x206d4000,
                           0x20000540, 0x20000100);
  if (res != -1) {
    r[0] = res;
  ...
  *(uint16_t*)0x200001aa = 0;
  ...
  syz_io_uring_submit(r[1], r[2], 0x20000180, 5);
  ...
  *(uint16_t*)0x2000022a = 0;
  ...
  syscall(__NR_io_uring_enter, r[0], 0x45f5, 0, 0ul, 0ul, 0ul);
  return 0;
}
