...
// https://syzkaller.appspot.com/bug?id=2a1fbb63416c7de754497ce4ffcea605ea75f191
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_clone, 0x2102005ffc, 0, 0x9999999999999999, 0, -1);
    break;
  case 3:
    syscall(__NR_clone, 0xa01ffff, 0, 0x9999999999999999, 0, -1);
    break;
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_tkill, r[1], 0x15);
    break;
  case 6:
    syscall(__NR_ptrace, 0x4206, r[1], 0, 0);
    break;
  case 7:
    syscall(__NR_ptrace, 8, r[1], 0, 0);
    break;
  }
}
int main(void)
