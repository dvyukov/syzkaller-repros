...
// https://syzkaller.appspot.com/bug?id=60b55f8368659c5bb4b9
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    res = syscall(__NR_open, 0ul, 0x80ul, 0x101ul);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
  ...
  case 4:
    ...
    break;
  case 5:
    NONFAILING(*(uint16_t*)0x200001c0 = 0x1f);
    ...
    NONFAILING(*(uint8_t*)0x200001cc = 2);
    syscall(__NR_bind, r[2], 0x200001c0ul, 0xeul);
    break;
  case 6:
