...
// https://syzkaller.appspot.com/bug?id=c049c907576aa79e5673
// status:3
...
int main(void)
{
  ...
  syscall(__NR_openat, 0xffffff9c, 0ul, 0x4121c0ul, 0x80ul);
  ...
  NONFAILING(memcpy((void*)0x20002180, "./file0/file0\000", 14));
  syscall(__NR_openat, 0xffffff9c, 0x20002180ul, 0ul, 0ul);
  return 0;
}
