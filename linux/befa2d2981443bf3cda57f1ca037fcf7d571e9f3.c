...
// https://syzkaller.appspot.com/bug?id=befa2d2981443bf3cda57f1ca037fcf7d571e9f3
// status:dup
...
{
  memcpy((void*)0x20000000, "\x12\x01\x00\x00\x06\x17\x5d\x08\x07\x0a\x82\x00"
                            "\x42\xb9\x00\x00\x00\x01\x09\x02\x24\x00\x01\x00"
                            "\x00\x00\x00\x09\x04\x16\x00\x02\x45\x3e\x75\x00"
                            "\x09\x05\x0f\x9f\x00\x00\x00\x00\x00\x09\x05\x83"
                            "\x03\x04\x00\x00\x00\x00",
         54);
  syz_usb_connect(0, 0x36, 0x20000000, 0);
  syz_open_dev(0xc, 0xb4, 0x8000);
}
int main(void)
{
