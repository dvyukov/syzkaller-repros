...
// https://syzkaller.appspot.com/bug?id=a8b4b0c60155e87e9484
// status:0
...
int main(void)
{
  ...
  *(uint64_t*)0x20000218 = 0x20010200;
  memcpy((void*)0x20010200, "\x01\x00\x00\x00\x00\x00\x05\x00\x11\x00\x00\x00"
                            "\x00\x00\x00\x00\x04\x00\x00\x00\x3c\x00\x00",
         23);
  *(uint64_t*)0x20000220 = 0x17;
  ...
  *(uint64_t*)0x20000248 = 0x20010400;
  memcpy((void*)0x20010400,
         "\x03\x00\x00\x00\x13\x00\x00\x00\x23\x00\x00\x00\xce\x00", 14);
