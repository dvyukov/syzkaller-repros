...
{
  intptr_t res = 0;
  memcpy((void*)0x20000100, "\x15\x00\x00\xcf\xad\x27\xba\xc8\x5a\x11\x77\x2f"
                            "\x04\x00\x00\x00\x00\x00\x00\x00\x06",
         21);
  ...
  *(uint16_t*)0x20000110 = 0;
  ...
  if (res != -1)
    r[0] = res;
  syscall(__NR_ioctl, r[0], 0x400452c8, 0x20000100);
  res = syz_init_net_socket(0x1f, 1, 3);
  if (res != -1)
    r[1] = res;
  ...
  *(uint8_t*)0x2000000c = 0;
  syscall(__NR_connect, r[1], 0x20000000, 0xe);
}
int main(void)
{
