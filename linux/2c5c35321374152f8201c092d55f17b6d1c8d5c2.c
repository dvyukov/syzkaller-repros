...
// https://syzkaller.appspot.com/bug?id=2c5c35321374152f8201c092d55f17b6d1c8d5c2
// status:invalid
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint8_t*)0x200000c3 = 0x20);
    ...
    syscall(__NR_setsockopt, -1, 0x84, 0xb, 0x200000c0, 0xb);
    break;
  case 1:
    ...
    NONFAILING(*(uint32_t*)0x200005fc = 2);
    ...
    res = syscall(__NR_io_uring_setup, 0xe, 0x200005c0);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
    syscall(__NR_dup3, r[0], -1, 0);
    break;
  }
}
int main(void)
