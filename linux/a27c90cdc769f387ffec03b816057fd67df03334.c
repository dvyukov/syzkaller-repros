...
// https://syzkaller.appspot.com/bug?id=a27c90cdc769f387ffec03b816057fd67df03334
// status:open
...
void loop(void)
{
  ...
  NONFAILING(memcpy((void*)0x20000080,
                    "batadv0\000\000\000\000\000\000\000\000\000", 16));
  NONFAILING(*(uint32_t*)0x20000090 = 0);
  res = syscall(__NR_ioctl, r[0], 0x8933ul, 0x20000080ul);
  if (res != -1)
    NONFAILING(r[1] = *(uint32_t*)0x20000090);
  res = syscall(__NR_socket, 0x10ul, 3ul, 0ul);
  if (res != -1)
    r[2] = res;
  ...
  NONFAILING(*(uint32_t*)0x20000100 = 0x40);
  NONFAILING(*(uint16_t*)0x20000104 = 0x10);
  NONFAILING(*(uint16_t*)0x20000106 = 0x705);
  ...
  NONFAILING(*(uint16_t*)0x20000120 = 0x20);
  NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000122, 0x12, 0, 14));
  NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000123, 0, 6, 1));
  NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000123, 1, 7, 1));
  NONFAILING(*(uint16_t*)0x20000124 = 8);
  NONFAILING(*(uint16_t*)0x20000126 = 1);
  NONFAILING(memcpy((void*)0x20000128, "hsr\000", 4));
  NONFAILING(*(uint16_t*)0x2000012c = 0x14);
  NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x2000012e, 2, 0, 14));
  NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x2000012f, 0, 6, 1));
  NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x2000012f, 1, 7, 1));
  NONFAILING(*(uint16_t*)0x20000130 = 8);
  NONFAILING(*(uint16_t*)0x20000132 = 2);
  NONFAILING(*(uint32_t*)0x20000134 = r[1]);
  NONFAILING(*(uint16_t*)0x20000138 = 8);
  NONFAILING(*(uint16_t*)0x2000013a = 1);
  NONFAILING(*(uint32_t*)0x2000013c = r[4]);
