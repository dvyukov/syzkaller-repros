...
// https://syzkaller.appspot.com/bug?id=5b49c9695968d7250a26
// status:0
...
void execute_one(void)
{
  ...
  *(uint16_t*)0x20000008 = 0x56a;
  *(uint16_t*)0x2000000a = 0xbb;
  ...
  *(uint64_t*)0x20000544 = 0x20000040;
  memcpy((void*)0x20000040,
         "\x00\x00\x29\x00\x00\x00\x29\x00\x4b\xff\x59\xd0\xfd\xc4", 14);
  *(uint64_t*)0x2000054c = 0;
  *(uint64_t*)0x20000554 = 0;
  *(uint64_t*)0x2000055c = 0;
  syz_usb_control_io(r[0], 0x20000540, 0);
}
int main(void)
{
