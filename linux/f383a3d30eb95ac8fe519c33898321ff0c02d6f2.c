...
// https://syzkaller.appspot.com/bug?id=f383a3d30eb95ac8fe519c33898321ff0c02d6f2
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0, 0xc0000, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
    syscall(__NR_ioctl, r[0], 0x5605, 0);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000380, "security.selinux\000", 17));
    res = syscall(__NR_memfd_create, 0x20000380, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 4:
    syscall(__NR_mmap, 0x20001000, 0x1000, 4, 0x11, r[1], 0);
    break;
  case 5:
    syscall(__NR_writev, r[1], 0, 0);
    break;
  case 6:
  ...
  case 11:
    ...
    NONFAILING(*(uint32_t*)0x2000019e = 0x400004);
