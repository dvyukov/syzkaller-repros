...
// https://syzkaller.appspot.com/bug?id=abbc768b560c84d92fd3
// status:6
...
void loop(void)
{
  ...
  *(uint8_t*)0x20000044 = 0xee;
  *(uint8_t*)0x20000045 = 0xe;
  *(uint8_t*)0x20000046 = 0xec;
  *(uint8_t*)0x20000047 = 0x40;
  *(uint16_t*)0x20000048 = 0x7b8;
  *(uint16_t*)0x2000004a = 0x401a;
  *(uint16_t*)0x2000004c = 0x3d3d;
  ...
  *(uint8_t*)0x20000060 = 5;
  *(uint8_t*)0x20000061 = 0xba;
  ...
  *(uint64_t*)0x20000744 = 0x20000100;
  memcpy((void*)0x20000100, "\x00\x00\x01", 3);
