...
// https://syzkaller.appspot.com/bug?id=b53a709f04722ca12a3c
// status:0
...
void execute_call(int call)
{
  ...
  case 5:
    ...
    res = syscall(__NR_ioctl, r[2], 0x8933, 0x20000600ul);
    if (res != -1)
      NONFAILING(r[3] = *(uint32_t*)0x20000610);
    break;
  case 6:
    NONFAILING(*(uint64_t*)0x200007c0 = 0);
    NONFAILING(*(uint32_t*)0x200007c8 = 0);
    NONFAILING(*(uint64_t*)0x200007d0 = 0x20000780);
    NONFAILING(*(uint64_t*)0x20000780 = 0x20000380);
    NONFAILING(*(uint32_t*)0x20000380 = 0x48);
    NONFAILING(*(uint16_t*)0x20000384 = 0x24);
    NONFAILING(*(uint16_t*)0x20000386 = 0xf0b);
    ...
    NONFAILING(*(uint16_t*)0x20000398 = 0);
    NONFAILING(*(uint16_t*)0x2000039a = 0);
    NONFAILING(*(uint16_t*)0x2000039c = 0);
    NONFAILING(*(uint16_t*)0x2000039e = -1);
    NONFAILING(*(uint16_t*)0x200003a0 = 0);
    NONFAILING(*(uint16_t*)0x200003a2 = 0);
    NONFAILING(*(uint16_t*)0x200003a4 = 8);
    NONFAILING(*(uint16_t*)0x200003a6 = 1);
    NONFAILING(memcpy((void*)0x200003a8, "htb\000", 4));
    NONFAILING(*(uint16_t*)0x200003ac = 0x1c);
    NONFAILING(*(uint16_t*)0x200003ae = 2);
    NONFAILING(*(uint16_t*)0x200003b0 = 0x18);
    NONFAILING(*(uint16_t*)0x200003b2 = 2);
    NONFAILING(*(uint32_t*)0x200003b4 = 3);
    ...
    NONFAILING(*(uint64_t*)0x20000788 = 0x48);
    NONFAILING(*(uint64_t*)0x200007d8 = 1);
    NONFAILING(*(uint64_t*)0x200007e0 = 0);
    NONFAILING(*(uint64_t*)0x200007e8 = 0);
    NONFAILING(*(uint32_t*)0x200007f0 = 0);
  ...
  case 8:
    NONFAILING(memcpy((void*)0x20000600,
                      "team0\000\000\000\000\000\000\000\000\000\000\000", 16));
    res = syscall(__NR_ioctl, r[4], 0x8933, 0x20000600ul);
    if (res != -1)
      NONFAILING(r[5] = *(uint32_t*)0x20000610);
    break;
  case 9:
    NONFAILING(*(uint64_t*)0x200007c0 = 0);
    NONFAILING(*(uint32_t*)0x200007c8 = 0);
    ...
    NONFAILING(*(uint8_t*)0x20000391 = 0);
    NONFAILING(*(uint16_t*)0x20000392 = 0);
    NONFAILING(*(uint32_t*)0x20000394 = r[5]);
    NONFAILING(*(uint16_t*)0x20000398 = 0);
    NONFAILING(*(uint16_t*)0x2000039a = -1);
    NONFAILING(*(uint16_t*)0x2000039c = -1);
    NONFAILING(*(uint16_t*)0x2000039e = -1);
    NONFAILING(*(uint16_t*)0x200003a0 = 0);
    NONFAILING(*(uint16_t*)0x200003a2 = 0);
    NONFAILING(*(uint16_t*)0x200003a4 = 8);
