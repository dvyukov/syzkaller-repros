...
// https://syzkaller.appspot.com/bug?id=62e474dd92a35e3060d8
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_ioctl, -1, 0x890b, 0ul);
    break;
  case 3:
    ...
    NONFAILING(*(uint64_t*)0x200001a0 = 0x20001400);
  ...
  case 4:
    ...
    NONFAILING(*(uint32_t*)0x20000028 = r[2]);
    NONFAILING(*(uint16_t*)0x2000002c = 8);
    NONFAILING(*(uint16_t*)0x2000002e = 0x1b);
  ...
  case 5:
    ...
    NONFAILING(*(uint16_t*)0x20000006 = 0x801);
    NONFAILING(*(uint32_t*)0x20000008 = 0);
    NONFAILING(*(uint32_t*)0x2000000c = 0xf0ffffff);
    NONFAILING(*(uint8_t*)0x20000010 = 0);
    NONFAILING(*(uint8_t*)0x20000011 = 0);
    NONFAILING(*(uint16_t*)0x20000012 = 0);
    NONFAILING(*(uint32_t*)0x20000014 = 0);
    ...
    NONFAILING(*(uint16_t*)0x20000024 = 8);
    NONFAILING(*(uint16_t*)0x20000026 = 1);
    NONFAILING(*(uint32_t*)0x20000028 = -1);
    NONFAILING(*(uint16_t*)0x2000002c = 8);
    NONFAILING(*(uint16_t*)0x2000002e = 0x1b);
    NONFAILING(*(uint32_t*)0x20000030 = 0);
    NONFAILING(*(uint64_t*)0x20000088 = 0x34);
    NONFAILING(*(uint64_t*)0x20000158 = 1);
    NONFAILING(*(uint64_t*)0x20000160 = 0xa002ac7c);
    NONFAILING(*(uint64_t*)0x20000168 = 0);
    NONFAILING(*(uint32_t*)0x20000170 = 0);
