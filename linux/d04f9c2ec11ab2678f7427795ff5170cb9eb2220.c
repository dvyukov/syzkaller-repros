...
void execute_call(int call)
{
  switch (call) {
  case 0:
    syscall(__NR_mount, 0x20000000, 0, 0, 0x2001001, 0);
    break;
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_prctl, 0x23, 0xf, 0x20000040, 0);
    break;
  case 3:
    NONFAILING(*(uint32_t*)0x20000080 = 5);
    NONFAILING(*(uint32_t*)0x20000084 = 3);
    NONFAILING(*(uint64_t*)0x20000088 = 0x20001fd8);
    ...
    NONFAILING(*(uint32_t*)0x20001fdc = 7);
    NONFAILING(*(uint8_t*)0x20001fe0 = 0x25);
    ...
    NONFAILING(memcpy(
        (void*)0x20000000,
        "PL "
        "\000L\367\321*\361\034\351%7\265\343\031\036f\336]N\301\216L-"
        "\360\024\204\250mw\204/"
        "bIF\352\343\020yL\214\226\377\024f#.%\225\0219\275\245\322\231\016R?"
        "\216\303\b\017\374\022$\330\334L\204\251\310\350\2531Wh\006qU#"
        "\372t\236\206\025\306\020I\270\261\276j\247t\a\002\314Z\335",
        100));
    NONFAILING(*(uint32_t*)0x20000098 = 5);
    NONFAILING(*(uint32_t*)0x2000009c = 0x252);
    NONFAILING(*(uint64_t*)0x200000a0 = 0x2000cf3d);
