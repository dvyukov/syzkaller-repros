...
// https://syzkaller.appspot.com/bug?id=ff8e1b9f2f36481e2efc
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    *(uint64_t*)0x20000990 = 0x20000000;
    memcpy((void*)0x20000000,
           "\x73\x79\x7a\x74\x6e\x6c\x31\x00\x00\x00\x00\x00\x00\x00\x00\x80",
           16);
    *(uint32_t*)0x20000010 = 0;
    memcpy((void*)0x20000014,
           "\x00\x00\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x45\x00\x00\x14"
           "\x00\x00\x00\x00\x00\x2f\x90\x78\x00\x00\x00\x00\x00\x00",
           30);
    syscall(__NR_ioctl, r[0], 0x89f3, 0x20000980ul);
    break;
  case 2:
  ...
  case 6:
    ...
    syscall(__NR_setsockopt, r[4], 0x107, 0xf, 0x200001c0ul, 4ul);
    break;
  case 7:
    *(uint16_t*)0x20000080 = 0x11;
    memcpy((void*)0x20000082,
           "\x00\x00\x03\x00\x00\x00\x00\x00\x08\x00\x44\x94\x4e\xeb\xa7\x1a"
           "\x49\x76\xe2\x52\xa2\x2c\xb1\x8f\x6e\x2e\x2a\xba\x00\x00\x00\x01"
    ...
    break;
  case 8:
    *(uint16_t*)0x20000000 = 0x103;
    *(uint8_t*)0x20000002 = 0;
    *(uint8_t*)0x20000003 = 0;
    *(uint32_t*)0x20000004 = 0xfd9f;
    *(uint32_t*)0x20000008 = 0;
    *(uint32_t*)0x2000000c = 0;
    *(uint32_t*)0x20000010 = 0;
    *(uint32_t*)0x20000014 = 0;
    *(uint32_t*)0x20000018 = 8;
    *(uint32_t*)0x2000001c = 0x34000;
    syscall(__NR_write, -1, 0x20000000ul, 0x20ul);
    break;
  case 9:
    syscall(__NR_write, r[2], 0x20000000ul, 0xfffffeccul);
    break;
  case 10:
    syscall(__NR_splice, r[1], 0ul, r[3], 0ul, 0xfffffffful, 0ul);
    break;
  }
}
int main(void)
