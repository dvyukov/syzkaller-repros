...
// https://syzkaller.appspot.com/bug?id=afea9ed76a23a523078c90db91357c7f63019754
// status:open
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x20000280 = 0x77);
    NONFAILING(*(uint32_t*)0x20000284 = 0);
    NONFAILING(*(uint64_t*)0x20000288 = 0x4b564d03);
    ...
    NONFAILING(*(uint8_t*)0x200002ab = 0xc0);
    ...
    NONFAILING(*(uint8_t*)0x200002d4 = 0);
    NONFAILING(*(uint8_t*)0x200002d5 = 0);
    ...
    syscall(__NR_ioctl, r[2], 0x4008ae89, 0x20000280);
    break;
  }
}
int main(void)
