...
// https://syzkaller.appspot.com/bug?id=ac5c11d2959a8b3c4806
// status:0
...
int main(void)
{
  ...
  *(uint64_t*)0x20000098 = 0x300000003;
  *(uint16_t*)0x200000a0 = 0xc;
  *(uint16_t*)0x200000a2 = 6;
  *(uint64_t*)0x200000a4 = 0x200000000;
  *(uint16_t*)0x200000ac = 0xc;
  *(uint16_t*)0x200000ae = 6;
  *(uint64_t*)0x200000b0 = 0x300000003;
  *(uint16_t*)0x200000b8 = 0xc;
  *(uint16_t*)0x200000ba = 6;
  *(uint64_t*)0x200000bc = 0x100000001;
  *(uint64_t*)0x20000108 = 0x44;
  *(uint64_t*)0x20000158 = 1;
  *(uint64_t*)0x20000160 = 0;
  *(uint64_t*)0x20000168 = 0;
  *(uint32_t*)0x20000170 = 4;
  syscall(__NR_sendmsg, r[0], 0x20000140ul, 0x20000000ul);
  return 0;
}
