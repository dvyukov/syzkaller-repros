...
// https://syzkaller.appspot.com/bug?id=d00808b55445133eca1e
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    NONFAILING(memcpy(
        (void*)0x20000500,
        "\x12\x01\x00\x00\x55\x20\xf0\x10\x40\x20\x38\xb1\x42\x01\x04\x00\x00"
        "\x01\x09\x02\x38\x00\x01\x00\x00\x00\x00\x09\x04\x00\x00\x03\x71\x05"
        "\x59\x00\x09\x05\x82\xef\x10\x00\x00\x00\x01\x02\x00\x09\x05\x02",
        50));
    res = -1;
    NONFAILING(res = syz_usb_connect(0, 0x4a, 0x20000500, 0));
    if (res != -1)
      r[1] = res;
    break;
  case 3:
    ...
    NONFAILING(syz_usb_control_io(r[1], 0x20000000, 0));
    break;
  case 4:
    ...
    NONFAILING(*(uint16_t*)0x20000048 = 0x11ff);
    NONFAILING(*(uint16_t*)0x2000004a = 0x3331);
    ...
    NONFAILING(*(uint16_t*)0x2000006b = 0);
    ...
    NONFAILING(*(uint8_t*)0x20000074 = 4);
