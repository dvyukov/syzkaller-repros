...
// https://syzkaller.appspot.com/bug?id=aaae7b6f4f5090642b2d36abe57ceb253f2ddd5a
// status:invalid
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint8_t*)0x20000084 = 0x20);
    NONFAILING(*(uint8_t*)0x20000085 = 0xc5);
    NONFAILING(*(uint8_t*)0x20000086 = 0x2b);
    NONFAILING(*(uint8_t*)0x20000087 = 8);
    NONFAILING(*(uint16_t*)0x20000088 = 0x2040);
    NONFAILING(*(uint16_t*)0x2000008a = 0x4982);
    NONFAILING(*(uint16_t*)0x2000008c = 0xd38f);
    ...
    NONFAILING(*(uint16_t*)0x20000094 = 0x1b);
    ...
    NONFAILING(*(uint8_t*)0x2000009d = 0xed);
    NONFAILING(*(uint8_t*)0x2000009e = 0);
    NONFAILING(*(uint8_t*)0x2000009f = 1);
    NONFAILING(*(uint8_t*)0x200000a0 = 0xbe);
    NONFAILING(*(uint8_t*)0x200000a1 = 0x64);
    NONFAILING(*(uint8_t*)0x200000a2 = 0x6b);
    NONFAILING(*(uint8_t*)0x200000a3 = 0);
    NONFAILING(*(uint8_t*)0x200000a4 = 7);
    NONFAILING(*(uint8_t*)0x200000a5 = 5);
    NONFAILING(*(uint8_t*)0x200000a6 = 0x81);
    NONFAILING(*(uint8_t*)0x200000a7 = 0x12);
  ...
  case 1:
    ...
    NONFAILING(*(uint64_t*)0x200005c4 = 0x20000280);
    NONFAILING(*(uint8_t*)0x20000280 = 0);
    NONFAILING(*(uint8_t*)0x20000281 = 0);
    NONFAILING(*(uint32_t*)0x20000282 = 0x2e);
    NONFAILING(memcpy(
        (void*)0x20000286,
        "\xc1\x7f\x11\xe0\x5b\x40\xbb\x2e\x0a\x33\xbb\xbb\xb7\x39\x1f\x9a\x27"
        "\x80\x41\xb1\x2e\x65\x29\x2c\x7a\xe5\x21\x49\x92\x53\xfc\xdf\x98\xce"
        "\x16\xac\xf8\x42\xea\x1a\xe2\xdb\x27\xc0\x65\x6e",
        46));
