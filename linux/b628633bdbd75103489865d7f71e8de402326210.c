...
// https://syzkaller.appspot.com/bug?id=b628633bdbd75103489865d7f71e8de402326210
// status:open
...
{
  intptr_t res = 0;
  res = syscall(__NR_socket, 2ul, 0x200000000000001ul, 0ul);
  if (res != -1)
    r[0] = res;
  ...
  syscall(__NR_sendmsg, r[0], 0ul, 0x20000000ul);
}
int main(void)
{
