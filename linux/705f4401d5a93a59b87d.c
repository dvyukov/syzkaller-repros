...
// https://syzkaller.appspot.com/bug?id=705f4401d5a93a59b87d
// status:6
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    NONFAILING(*(uint64_t*)0x2001d010 = 0x41c0);
  ...
  case 6:
    ...
    NONFAILING(*(uint64_t*)0x200001f0 = 0x800);
    ...
    NONFAILING(*(uint64_t*)0x20000248 = 0x5211);
    syscall(__NR_ioctl, r[2], 0x4090ae82, 0x200001c0ul);
    break;
  case 7:
    NONFAILING(*(uint32_t*)0x20000300 = 0);
    NONFAILING(*(uint32_t*)0x20000304 = 0);
    NONFAILING(*(uint64_t*)0x20000308 = 0xd000);
    NONFAILING(*(uint32_t*)0x20000310 = 0);
    NONFAILING(*(uint32_t*)0x20000314 = -1);
    ...
    NONFAILING(*(uint8_t*)0x2000035a = 0);
    NONFAILING(*(uint8_t*)0x2000035b = 0);
    ...
    NONFAILING(*(uint8_t*)0x20000360 = 3);
    ...
    NONFAILING(*(uint8_t*)0x20000380 = 2);
    ...
    NONFAILING(*(uint8_t*)0x20000392 = 3);
    ...
    syscall(__NR_ioctl, r[1], 0x8208ae63, 0x20000300ul);
    break;
  }
}
int main(void)
