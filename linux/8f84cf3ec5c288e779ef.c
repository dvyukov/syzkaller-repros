// KMSAN: uninit-value in hci_conn_request_evt
// https://syzkaller.appspot.com/bug?id=8f84cf3ec5c288e779ef
// status:0
...
{
  *(uint8_t*)0x20001100 = 4;
  *(uint8_t*)0x20001101 = 4;
  *(uint8_t*)0x20001102 = 1;
  *(uint8_t*)0x20001103 = 0;
  syz_emit_vhci(0x20001100, 4);
}
int main(void)
{
