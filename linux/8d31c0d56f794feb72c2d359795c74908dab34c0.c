...
void loop(void)
{
  ...
  if (res != -1)
    r[0] = res;
  NONFAILING(memcpy((void*)0x20000000, "ethtool\000", 8));
  ...
  NONFAILING(*(uint64_t*)0x200001c0 = 0x20001540);
  NONFAILING(*(uint32_t*)0x20001540 = 0x40);
  NONFAILING(*(uint16_t*)0x20001544 = r[1]);
  NONFAILING(*(uint16_t*)0x20001546 = 1);
  NONFAILING(*(uint32_t*)0x20001548 = 0);
  NONFAILING(*(uint32_t*)0x2000154c = 0);
  NONFAILING(*(uint8_t*)0x20001550 = 5);
  NONFAILING(*(uint8_t*)0x20001551 = 0);
  NONFAILING(*(uint16_t*)0x20001552 = 0);
  NONFAILING(*(uint16_t*)0x20001554 = 0x18);
  NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20001556, 1, 0, 14));
  NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20001557, 0, 6, 1));
  NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20001557, 1, 7, 1));
  NONFAILING(*(uint16_t*)0x20001558 = 0x14);
  NONFAILING(*(uint16_t*)0x2000155a = 2);
  NONFAILING(memcpy((void*)0x2000155c,
                    "syz_tun\000\000\000\000\000\000\000\000\000", 16));
  NONFAILING(*(uint16_t*)0x2000156c = 0x14);
  NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x2000156e, 3, 0, 14));
  NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x2000156f, 0, 6, 1));
  NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x2000156f, 1, 7, 1));
  NONFAILING(*(uint16_t*)0x20001570 = 4);
  NONFAILING(*(uint16_t*)0x20001572 = 4);
  NONFAILING(*(uint16_t*)0x20001574 = 8);
  NONFAILING(*(uint16_t*)0x20001576 = 2);
  NONFAILING(*(uint32_t*)0x20001578 = 0xfffffff0);
  NONFAILING(*(uint16_t*)0x2000157c = 4);
  NONFAILING(*(uint16_t*)0x2000157e = 5);
