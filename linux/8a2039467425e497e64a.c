...
// https://syzkaller.appspot.com/bug?id=8a2039467425e497e64a
// status:0 arch:386
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    *(uint16_t*)0x2000010a = 0;
    syscall(__NR_ioctl, (intptr_t)r[0], 0x4b61, 0x20000100);
    break;
  case 2:
  ...
  case 3:
    ...
    *(uint16_t*)0x20000188 = 0x200;
    *(uint16_t*)0x2000018a = 0;
    syscall(__NR_ioctl, (intptr_t)r[1], 0x541c, 0x20000180);
    break;
  }
}
int main(void)
