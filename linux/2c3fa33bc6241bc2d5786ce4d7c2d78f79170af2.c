...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_ftruncate, r[1], 0x2081fd);
    break;
  case 3:
    res = syscall(__NR_semget, 0x798e2635 + procid * 4, 0, 1);
    if (res != -1)
      r[2] = res;
    break;
  case 4:
    syscall(__NR_semctl, r[2], 0, 0xe, 0x200001c0);
    break;
  case 5:
    syscall(__NR_fcntl, r[0], 4, 0x6000);
    break;
  case 6:
    res = syscall(__NR_io_setup, 1, 0x20000000);
    if (res != -1)
      NONFAILING(r[3] = *(uint64_t*)0x20000000);
    break;
  case 7:
    ...
    syscall(__NR_io_submit, r[3], 0x605, 0x20000540);
    break;
  }
}
int main(void)
