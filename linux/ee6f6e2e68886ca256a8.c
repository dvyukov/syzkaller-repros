...
// https://syzkaller.appspot.com/bug?id=ee6f6e2e68886ca256a8
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000454 = 0x200003c0;
  *(uint8_t*)0x200003c0 = 0;
  *(uint8_t*)0x200003c1 = 0x22;
  *(uint32_t*)0x200003c2 = 1;
  STORE_BY_BITMASK(uint8_t, , 0x200003c6, 0, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x200003c6, 1, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x200003c6, 0, 4, 4);
