...
// https://syzkaller.appspot.com/bug?id=a7c030a05218db921de5
// status:0
...
void execute_call(int call)
{
  ...
  case 4:
    memcpy((void*)0x20000040,
           "\xc4\xf2\x38\xf3\x0d\x37\x61\xde\xd4\x8b\x63\x86\x3a\xbe\x02\x83"
           "\xdb\xda",
           18);
    memcpy((void*)0x20000100,
           "\x2d\xe3\x19\x02\x48\x29\x89\xfc\x2d\x56\x60\xed\xff\x91\xea\x23"
           "\x42\x14\x60\xaf",
           20);
    res = -1;
    res = syz_clone(0x46000080, 0x20000040, 0x12, 0x20000080, 0x200000c0,
                    0x20000100);
    if (res != -1)
      r[1] = res;
    break;
  case 5:
    ...
    syscall(__NR_write, -1, 0x20000140ul, 0x12ul);
    break;
  case 6:
    memcpy((void*)0x20000000, "blkio.bfq.io_serviced_recursive\000", 32);
  ...
  case 7:
    ...
    break;
  case 8:
    sprintf((char*)0x20000140, "0x%016llx", (long long)r[3]);
    syscall(__NR_write, r[2], 0x20000140ul, 0x12ul);
    break;
  case 9:
    *(uint32_t*)0x20000900 = 0;
    *(uint32_t*)0x20000904 = 0xfffffffb;
    *(uint32_t*)0x20000908 = 0x10;
    res = syscall(__NR_bpf, 0xeul, 0x20000900ul, 0xcul);
    if (res != -1)
      r[4] = res;
    break;
  case 10:
    *(uint32_t*)0x20000980 = 0x1f;
    *(uint32_t*)0x20000984 = 0xe;
    *(uint64_t*)0x20000988 = 0x20000280;
    memcpy((void*)0x20000280,
           "\xc9\x17\x30\x00\xff\x23\x00\x00\x00\x00\x00\x00", 12);
    *(uint32_t*)0x2000028c = -1;
    memcpy((void*)0x20000290,
           "\x00\x00\x00\x00\x47\x00\x00\x00\x85\x20\x00\x00\x04\x00\x00\x00"
           "\x18\x11\x00\x00",
           20);
    *(uint32_t*)0x200002a4 = -1;
    memcpy((void*)0x200002a8,
           "\x00\x00\x00\x00\x00\x00\x00\x00\x95\x00\x00\x00\x00\x00\x00\x00"
           "\x18\x00\x00\x00\x75\x0a\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00"
           "\x18\x63\x00\x00\x08\x00\x00\x00\x00\x00\x00\x00\x04\x00\x00\x00"
           "\x18\x13\x00\x00",
           52);
    *(uint32_t*)0x200002dc = -1;
    memcpy((void*)0x200002e0,
           "\x00\x00\x00\x00\x00\x00\x00\x00\x65\x05\xfe\xff\xf0\xff\xff\xff",
           16);
    *(uint64_t*)0x20000990 = 0x20000200;
    memcpy((void*)0x20000200, "GPL\000", 4);
    *(uint32_t*)0x20000998 = 9;
    *(uint32_t*)0x2000099c = 0xe1;
    *(uint64_t*)0x200009a0 = 0x20000300;
    *(uint32_t*)0x200009a8 = 0x40f00;
    *(uint32_t*)0x200009ac = 5;
    memset((void*)0x200009b0, 0, 16);
    *(uint32_t*)0x200009c0 = 0;
    *(uint32_t*)0x200009c4 = 0x24;
    *(uint32_t*)0x200009c8 = -1;
    *(uint32_t*)0x200009cc = 8;
    *(uint64_t*)0x200009d0 = 0;
    *(uint32_t*)0x200009d8 = 0;
    *(uint32_t*)0x200009dc = 0x10;
    *(uint64_t*)0x200009e0 = 0x20000440;
    *(uint32_t*)0x20000440 = 2;
    *(uint32_t*)0x20000444 = 6;
    *(uint32_t*)0x20000448 = 0x7fff;
    *(uint32_t*)0x2000044c = 5;
    *(uint32_t*)0x200009e8 = 0x10;
    *(uint32_t*)0x200009ec = 0;
    *(uint32_t*)0x200009f0 = -1;
    *(uint32_t*)0x200009f4 = 0;
    *(uint64_t*)0x200009f8 = 0x20000940;
    *(uint32_t*)0x20000940 = -1;
    *(uint32_t*)0x20000944 = -1;
    *(uint32_t*)0x20000948 = -1;
    *(uint32_t*)0x2000094c = -1;
    *(uint32_t*)0x20000950 = r[2];
    *(uint32_t*)0x20000954 = r[4];
    syscall(__NR_bpf, 5ul, 0x20000980ul, 0x80ul);
    break;
  case 11:
    syz_clone(0, 0x20000440, 0, 0x200004c0, 0, 0);
    break;
  case 12:
    memcpy((void*)0x20000040, "memory.max\000", 11);
    res = syscall(__NR_openat, r[0], 0x20000040ul, 2ul, 0ul);
    if (res != -1)
      r[5] = res;
    break;
  case 13:
    syscall(__NR_socket, 0xaul, 5ul, 0);
    break;
  case 14:
    ...
    break;
  case 15:
    syscall(__NR_ioctl, r[6], 0x2402, 0ul);
    break;
  case 16:
    syz_clone(0x8040400, 0, 0, 0, 0, 0);
    break;
  case 17:
    ...
    *(uint8_t*)0x200000ca = 6;
    *(uint8_t*)0x200000cb = 0x80;
    *(uint32_t*)0x200000cc = 0;
    *(uint64_t*)0x200000d0 = 9;
    ...
    *(uint64_t*)0x200000e0 = 0;
    ...
    STORE_BY_BITMASK(uint64_t, , 0x200000e8, 1, 14, 1);
    STORE_BY_BITMASK(uint64_t, , 0x200000e8, 3, 15, 2);
    ...
    *(uint64_t*)0x20000108 = 0x2bcc52a5f498fa8d;
    ...
    *(uint32_t*)0x20000130 = 0x40;
    *(uint32_t*)0x20000134 = 0;
    *(uint64_t*)0x20000138 = 0;
    syscall(__NR_perf_event_open, 0x200000c0ul, 0, 0ul, -1, 1ul);
    break;
  case 18:
    syscall(__NR_ioctl, -1, 0x40082406, 0ul);
    break;
  case 19:
    sprintf((char*)0x20000240, "0x%016llx", (long long)0);
    syscall(__NR_write, r[5], 0x20000240ul, 0x12ul);
    break;
  }
}
int main(void)
