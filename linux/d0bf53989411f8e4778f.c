...
// https://syzkaller.appspot.com/bug?id=d0bf53989411f8e4778f
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(*(uint32_t*)0x20000204 = 0x80);
  ...
  NONFAILING(*(uint64_t*)0x20000210 = 0x41bd);
  ...
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000228, 0, 31, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000228, 0, 32, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000228, 0, 33, 1));
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000228, 0, 34, 1));
  ...
  NONFAILING(*(uint32_t*)0x2000025c = 5);
  ...
  syscall(__NR_io_submit, r[1], 2ul, 0x20000540ul);
  {
    int i;
    for (i = 0; i < 64; i++) {
      syscall(__NR_io_submit, r[1], 2ul, 0x20000540ul);
