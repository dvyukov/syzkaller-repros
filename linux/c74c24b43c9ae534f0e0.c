...
// https://syzkaller.appspot.com/bug?id=c74c24b43c9ae534f0e0
// status:0
...
int main(void)
{
  ...
  memcpy((void*)0x20000100,
         "\x12\x01\x00\x00\x02\x00\x00\x08\x24\x04\x00\x9e\x40\x00\x01\x08\x03"
         "\x01\x09\x02\x3f\x00\x01\x01\x00\x00\x00\x09\x04\x00\x00\x03\x42\xba"
         "\x01\x00\x05\x24\x06\x00\x00\x05\x24\x00\x00\x00\x0d\x24\x0f\x01\x00"
         "\x00\x00\x00\x00\x00\x00\x00\x00\x04\x24\x13\x00\x09\x05\x82\x02\xf7"
         "\x00\x00\x00\x00\x09\x05\x03\x02\x34",
         77);
  res = -1;
  ...
  *(uint64_t*)0x20000404 = 0x200001c0;
