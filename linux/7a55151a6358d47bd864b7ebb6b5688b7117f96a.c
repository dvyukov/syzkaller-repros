...
void execute_one()
{
  ...
  if (res != -1)
    r[0] = res;
  *(uint16_t*)0x20e13000 = 2;
  *(uint16_t*)0x20e13002 = htobe16(0x4e20);
  *(uint32_t*)0x20e13004 = htobe32(0xe0000001);
  *(uint8_t*)0x20e13008 = 0;
  *(uint8_t*)0x20e13009 = 0;
  *(uint8_t*)0x20e1300a = 0;
  *(uint8_t*)0x20e1300b = 0;
  *(uint8_t*)0x20e1300c = 0;
  *(uint8_t*)0x20e1300d = 0;
  *(uint8_t*)0x20e1300e = 0;
  *(uint8_t*)0x20e1300f = 0;
  syscall(__NR_bind, r[0], 0x20e13000, 0x10);
  res = syscall(__NR_socket, 0xa, 0x2000000000001, 0);
  if (res != -1)
    r[1] = res;
  *(uint32_t*)0x20687000 = 0x5c802861;
  syscall(__NR_setsockopt, r[1], 1, 0xf, 0x20687000, 4);
  ...
  *(uint32_t*)0x20402018 = 0;
  syscall(__NR_bind, r[1], 0x20402000, 0x1c);
  ...
  *(uint32_t*)0x20000218 = 0;
  syscall(__NR_sendto, r[1], 0x20000240, 0, 0xfffffefffffffffe, 0x20000200,
          0x1c);
  ...
  *(uint16_t*)0x2000000c = htobe16(0x800);
  STORE_BY_BITMASK(uint8_t, 0x2000000e, 6, 0, 4);
  ...
  *(uint16_t*)0x20000010 = htobe16(0x20);
  ...
  *(uint8_t*)0x2000002a = 0xac;
  *(uint8_t*)0x2000002b = 0x14;
  *(uint8_t*)0x2000002c = -1;
  *(uint8_t*)0x2000002d = 0xaa;
  ...
  *(uint32_t*)0x20000114 = 0;
  ...
  csum_inet_update(&csum_1, (const uint8_t*)0x20000026, 8);
  *(uint16_t*)0x20000028 = csum_inet_digest(&csum_1);
  struct csum_inet csum_2;
  csum_inet_init(&csum_2);
  csum_inet_update(&csum_2, (const uint8_t*)0x2000000e, 24);
