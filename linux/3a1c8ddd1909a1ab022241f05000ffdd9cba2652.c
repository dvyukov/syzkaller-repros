...
// https://syzkaller.appspot.com/bug?id=3a1c8ddd1909a1ab022241f05000ffdd9cba2652
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    memcpy((void*)0x20000380, "/dev/ptmx", 10);
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000380, 5, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
