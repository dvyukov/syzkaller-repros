...
// https://syzkaller.appspot.com/bug?id=dae804a5c85a54c84091e3e971b8e43613da38f9
// status:fixed
...
void* thr(void* arg)
{
  ...
  case 2:
    ...
    *(uint32_t*)0x2000003c = (uint32_t)0x0;
    r[14] = syscall(__NR_ioctl, 0xfffffffffffffffful, 0xc04064a0ul,
                    0x20000000ul);
    break;
  case 3:
    r[15] = syscall(__NR_setsockopt, r[1], 0x29ul, 0x23ul, 0x20000000ul,
                    0x264ul);
    break;
  case 4:
    r[16] = syscall(__NR_socket, 0xful, 0x4000000000000003ul, 0x2ul);
    break;
  case 5:
    *(uint16_t*)0x20776ff6 = (uint16_t)0x1;
    memcpy((void*)0x20776ff8, "\x2e\x2f\x66\x69\x6c\x65\x30\x00", 8);
    r[19] = syscall(__NR_recvfrom, r[16], 0x20d27fb0ul, 0x0ul, 0x0ul,
                    0x20776ff6ul, 0xaul);
    break;
  case 6:
    ...
    *(uint32_t*)0x206d704c = (uint32_t)0x401;
    r[48] = syscall(__NR_sendmsg, r[16], 0x2023dfc8ul, 0x0ul);
    break;
  }
  return 0;
}
