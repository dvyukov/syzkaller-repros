...
// https://syzkaller.appspot.com/bug?id=342beb2b368a43cbb6533c00d758759b10fbc8d8
// status:open
...
void execute_call(int call)
{
  ...
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_sendto, -1, 0, 0, 0x4000, 0, 0);
    break;
  case 6:
  ...
  case 8:
    ...
    break;
  case 9:
    syscall(__NR_accept4, r[0], 0, 0, 0x80000);
    break;
  case 10:
  ...
  case 28:
    ...
    break;
  case 29:
    res = syscall(__NR_socket, 0x10, 0x800000000080002, 0);
    if (res != -1)
      r[5] = res;
    break;
  case 30:
    NONFAILING(*(uint32_t*)0x200000c0 = 0);
    syscall(__NR_getsockopt, r[5], 0x84, 0x1f, 0, 0x200000c0);
    break;
  case 31:
  ...
  case 36:
    ...
    syscall(__NR_getsockname, -1, 0, 0x20000240);
    break;
  case 37:
    syscall(__NR_ioctl, -1, 0x8907, 0);
    break;
  case 38:
    syscall(__NR_getsockopt, -1, 0x84, 8, 0x20001500, 0);
    break;
  case 39:
  ...
  case 41:
    ...
    break;
  case 42:
    syscall(__NR_ioctl, r[6], 0x1000008912, 0);
    break;
  case 43:
    NONFAILING(*(uint64_t*)0x200000c0 = 0);
    NONFAILING(*(uint32_t*)0x200000c8 = 0);
