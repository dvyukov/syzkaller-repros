...
// https://syzkaller.appspot.com/bug?id=dd94e1d44f61c258d538
// status:6
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000000, "/dev/snd/controlC#\000", 19));
    res = -1;
  ...
  case 1:
    ...
    break;
  case 2:
    res = syscall(__NR_epoll_create, 0x20000001);
    if (res != -1)
      r[1] = res;
    break;
  case 3:
    ...
    break;
  case 4:
    res = syscall(__NR_epoll_create, 0x63);
    if (res != -1)
      r[2] = res;
    break;
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_io_uring_setup, 0x8ca, 0ul);
    break;
  case 7:
  ...
  case 9:
    ...
    syscall(__NR_epoll_ctl, r[3], 1ul, r[1], 0x20000180ul);
    break;
  }
}
int main(void)
