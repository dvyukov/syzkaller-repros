...
// https://syzkaller.appspot.com/bug?id=4f2929501f42dc9ddb860487051185cd62713a07
// status:open
...
int main(void)
{
  ...
  *(uint8_t*)0x20000035 = 0;
  res = syz_usb_connect(0, 0x200, 0x20000000, 0);
  if (res != -1)
    r[0] = res;
  ...
  *(uint64_t*)0x20000364 = 0;
  ...
  memcpy((void*)0x20000440, "/dev/usb/hiddev#\000", 17);
  ...
  *(uint32_t*)0x2000010c = 0x80000001;
  *(uint32_t*)0x20000110 = 0x5b;
  *(uint32_t*)0x20000114 = 0;
  syscall(__NR_ioctl, r[1], 0xc018480b, 0x20000100);
  return 0;
}
