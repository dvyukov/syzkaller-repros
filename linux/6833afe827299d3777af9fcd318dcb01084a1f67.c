...
// https://syzkaller.appspot.com/bug?id=6833afe827299d3777af9fcd318dcb01084a1f67
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_unshare, 0x44000600ul);
    break;
  case 1:
  ...
  case 3:
    ...
    NONFAILING(*(uint16_t*)0x20000132 = htobe16(0));
