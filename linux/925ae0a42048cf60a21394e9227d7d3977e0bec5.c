...
// https://syzkaller.appspot.com/bug?id=925ae0a42048cf60a21394e9227d7d3977e0bec5
// status:open
...
void execute_call(int call)
{
  ...
  case 4:
    ...
    res = syscall(__NR_ioctl, r[2], 0x8933ul, 0x20001840ul);
    if (res != -1)
      NONFAILING(r[3] = *(uint32_t*)0x20001850);
    break;
  case 5:
    NONFAILING(*(uint16_t*)0x20000240 = 0x1d);
    NONFAILING(*(uint32_t*)0x20000244 = r[3]);
    ...
    syscall(__NR_bind, r[1], 0x20000240ul, 0x18ul);
    break;
  case 6:
