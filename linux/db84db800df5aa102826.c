...
// https://syzkaller.appspot.com/bug?id=db84db800df5aa102826
// status:0
...
{
  intptr_t res = 0;
  res = syscall(__NR_socket, 0xaul, 0x40000080806ul, 0);
  if (res != -1)
    r[0] = res;
  *(uint16_t*)0x2047b000 = 0xa;
  *(uint16_t*)0x2047b002 = htobe16(0x4e20);
  *(uint32_t*)0x2047b004 = htobe32(0);
  memcpy((void*)0x2047b008,
         "\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000",
         16);
  *(uint32_t*)0x2047b018 = 0;
  syscall(__NR_bind, r[0], 0x2047b000ul, 0x1cul);
  ...
  *(uint32_t*)0x20419004 = htobe32(0);
  *(uint64_t*)0x20419008 = htobe64(0);
  *(uint64_t*)0x20419010 = htobe64(1);
  *(uint32_t*)0x20419018 = 0;
  syscall(__NR_connect, r[1], 0x20419000ul, 0x1cul);
  res = syscall(__NR_accept4, r[0], 0ul, 0ul, 0ul);
  if (res != -1)
    r[2] = res;
  syscall(__NR_setsockopt, r[2], 0x29, 0x37, 0x20000000ul, 8ul);
