...
// https://syzkaller.appspot.com/bug?id=96e916d6f6f7617bc9fc
// status:0
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[0] = res;
  res = syscall(__NR_socket, 2ul, 5ul, 0x84);
  if (res != -1)
    r[1] = res;
  syscall(__NR_dup3, r[0], r[1], 0ul);
  NONFAILING(*(uint16_t*)0x20d6cff0 = 2);
  NONFAILING(*(uint16_t*)0x20d6cff2 = htobe16(0x4e20));
  NONFAILING(*(uint32_t*)0x20d6cff4 = htobe32(0x7f000001));
  syscall(__NR_setsockopt, r[1], 0x84, 0x64, 0x20d6cff0ul, 0x10ul);
