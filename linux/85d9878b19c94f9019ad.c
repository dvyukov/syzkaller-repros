...
// https://syzkaller.appspot.com/bug?id=85d9878b19c94f9019ad
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    res = syscall(__NR_ioctl, r[0], 0x8933, 0x20000200ul);
    if (res != -1)
      NONFAILING(r[1] = *(uint32_t*)0x20000210);
    break;
  case 2:
    ...
    syscall(__NR_bind, r[0], 0x20000240ul, 0x5cul);
    break;
  case 3:
    res = syscall(__NR_socket, 0x1dul, 2ul, 7);
    if (res != -1)
  ...
  case 4:
    ...
    if (res != -1)
      NONFAILING(r[3] = *(uint32_t*)0x20000210);
    break;
  case 5:
    NONFAILING(*(uint16_t*)0x20000240 = 0x1d);
