...
// https://syzkaller.appspot.com/bug?id=5ca552d10251920ab7e2
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    res = -1;
    NONFAILING(res = syz_io_uring_setup(0x1ede, 0x20000240, 0x20002000,
                                        0x20ffd000, 0x20000100, 0x20000140));
    if (res != -1) {
      r[0] = res;
  ...
  case 1:
    ...
    NONFAILING(*(uint64_t*)0x20000088 = 0x3938700);
    ...
    NONFAILING(syz_io_uring_submit(r[1], r[2], 0x200000c0, 0xa99));
    break;
  case 2:
