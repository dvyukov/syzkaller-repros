...
uint64_t r[11] = {0xffffffffffffffff, 0xffffffffffffffff, 0xffffffffffffffff,
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(*(uint16_t*)0x20000440 = 0x26);
    NONFAILING(memcpy((void*)0x20000442,
    ...
    NONFAILING(memcpy(
        (void*)0x20000458,
        "jitterentropy_"
        "rng\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
        64));
    syscall(__NR_bind, r[0], 0x20000440, 0x58);
    break;
  case 2:
    syscall(__NR_accept, r[0], 0, 0);
    break;
  case 3:
    ...
    break;
  case 4:
    syscall(__NR_signalfd4, -1, 0, 0, 0);
    break;
  case 5:
    NONFAILING(*(uint16_t*)0x20000440 = 0x26);
    NONFAILING(memcpy((void*)0x20000442,
    ...
    NONFAILING(memcpy(
        ...
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
        64));
    syscall(__NR_bind, -1, 0x20000440, 0x58);
    break;
  case 6:
  ...
  case 8:
    ...
    break;
  case 9:
    NONFAILING(memcpy((void*)0x200002c0, "\x10", 1));
    syscall(__NR_memfd_create, 0x200002c0, 0);
    break;
  case 10:
    NONFAILING(memcpy((void*)0x20000700, "/dev/snd/seq\x00", 13));
    syz_open_dev(0x20000700, 0, 0x100000000000001);
    break;
  case 11:
    res = syscall(__NR_socket, 0x26, 5, 0);
    if (res != -1)
  ...
  case 14:
    ...
    syscall(__NR_setsockopt, -1, 6, 0x13, 0x200000c0, 0x151);
    break;
  case 15:
    NONFAILING(*(uint16_t*)0x20000180 = 0xa);
    NONFAILING(*(uint16_t*)0x20000182 = htobe16(0));
    ...
    syscall(__NR_connect, -1, 0x20000180, 0x1c);
    break;
  case 16:
    NONFAILING(*(uint8_t*)0x20000340 = 0x7f);
    NONFAILING(*(uint8_t*)0x20000341 = 0x45);
    NONFAILING(*(uint8_t*)0x20000342 = 0x4c);
    NONFAILING(*(uint8_t*)0x20000343 = 0x46);
    NONFAILING(*(uint8_t*)0x20000344 = 0);
    NONFAILING(*(uint8_t*)0x20000345 = 0);
    NONFAILING(*(uint8_t*)0x20000346 = 0);
    NONFAILING(*(uint8_t*)0x20000347 = 0);
    NONFAILING(*(uint64_t*)0x20000348 = 0);
    NONFAILING(*(uint16_t*)0x20000350 = 0);
    NONFAILING(*(uint16_t*)0x20000352 = 0);
    NONFAILING(*(uint32_t*)0x20000354 = 0);
    NONFAILING(*(uint64_t*)0x20000358 = 0);
    NONFAILING(*(uint64_t*)0x20000360 = 0x40);
    NONFAILING(*(uint64_t*)0x20000368 = 0);
    NONFAILING(*(uint32_t*)0x20000370 = 0);
    NONFAILING(*(uint16_t*)0x20000374 = 0);
    NONFAILING(*(uint16_t*)0x20000376 = 0x38);
    NONFAILING(*(uint16_t*)0x20000378 = 0x78);
    NONFAILING(*(uint16_t*)0x2000037a = 0);
    NONFAILING(*(uint16_t*)0x2000037c = 0);
    NONFAILING(*(uint16_t*)0x2000037e = 0);
    ...
    syscall(__NR_write, -1, 0x20000340, 0x78);
    break;
  case 17:
  ...
  case 25:
    ...
    NONFAILING(*(uint32_t*)0x20005b88 = 0);
    NONFAILING(*(uint64_t*)0x20005b90 = 0x200002c0);
    NONFAILING(*(uint64_t*)0x200002c0 = 0x20001b40);
    NONFAILING(*(uint64_t*)0x200002c8 = 0x7ffff000);
    NONFAILING(*(uint64_t*)0x20005b98 = 1);
    NONFAILING(*(uint64_t*)0x20005ba0 = 0);
    NONFAILING(*(uint64_t*)0x20005ba8 = 0);
    NONFAILING(*(uint32_t*)0x20005bb0 = 0);
    NONFAILING(*(uint32_t*)0x20005bb8 = 0);
    NONFAILING(*(uint64_t*)0x20005bc0 = 0x20000780);
    NONFAILING(*(uint32_t*)0x20005bc8 = 0x80);
    NONFAILING(*(uint64_t*)0x20005bd0 = 0);
    NONFAILING(*(uint64_t*)0x20005bd8 = 0);
    NONFAILING(*(uint64_t*)0x20005be0 = 0);
    NONFAILING(*(uint64_t*)0x20005be8 = 0x1d8);
    NONFAILING(*(uint32_t*)0x20005bf0 = 0);
    NONFAILING(*(uint32_t*)0x20005bf8 = 0);
    syscall(__NR_recvmmsg, r[2], 0x20005b80, 0x3df, 0x2003, 0);
    break;
  case 26:
    NONFAILING(memcpy((void*)0x200002c0, "\x10", 1));
  ...
  case 27:
    ...
    NONFAILING(memcpy((void*)0x2000014c,
                      ...
                      "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                      "\x00\x00\x00\x00\x00\x00\x06\x00\x00\x00\x00\x00\xcc\xbf"
                      "}\xdd\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                      "\x00\xb2\x1e\x00\x00\x00",
                      64));
    ...
    syscall(__NR_ioctl, -1, 0xc08c5332, 0x20000140);
    break;
  case 28:
  ...
  case 29:
    ...
    NONFAILING(*(uint8_t*)0x20000003 = 0xfd);
    ...
    syscall(__NR_write, r[4], 0x20000000, 0xffffff76);
    break;
  case 30:
    NONFAILING(*(uint16_t*)0x20000440 = 0x26);
    NONFAILING(memcpy((void*)0x20000442,
  ...
  case 33:
    ...
    NONFAILING(*(uint64_t*)0x20004ed0 = 0x200006c0);
    NONFAILING(*(uint64_t*)0x200006c0 = 0x20000000);
    NONFAILING(*(uint64_t*)0x200006c8 = 0x54);
    NONFAILING(*(uint64_t*)0x20004ed8 = 1);
  ...
  case 37:
    ...
    NONFAILING(*(uint8_t*)0x20000022 = 0);
    NONFAILING(*(uint8_t*)0x20000023 = 0);
    syscall(__NR_write, r[5], 0x20000000, 0xffffff76);
    break;
  case 38:
  ...
  case 39:
    NONFAILING(*(uint32_t*)0x200000c0 = 1);
    syscall(__NR_setsockopt, r[6], 6, 0x13, 0x200000c0, 0x151);
    break;
  case 40:
    NONFAILING(*(uint16_t*)0x20000100 = 0x303);
    NONFAILING(*(uint16_t*)0x20000102 = 0x33);
    syscall(__NR_setsockopt, r[6], 0x11a, 1, 0x20000100, 0x28);
    break;
  case 41:
    res = syscall(__NR_socketpair, 1, 3, 0, 0x20000000);
    if (res != -1)
      NONFAILING(r[7] = *(uint32_t*)0x20000004);
    break;
  case 42:
  ...
  case 43:
    ...
    NONFAILING(*(uint8_t*)0x20000022 = 0);
    NONFAILING(*(uint8_t*)0x20000023 = 0);
    syscall(__NR_write, -1, 0x20000000, 0xffffff76);
    break;
  case 44:
    res = syscall(__NR_socket, 0x10, 3, 0xfe);
    if (res != -1)
      r[8] = res;
    break;
  case 45:
  ...
  case 47:
    ...
    syscall(__NR_getsockopt, -1, 0, 0x10, 0, 0x20000780);
    break;
  case 48:
    NONFAILING(*(uint32_t*)0x20000200 = 0x34);
    ...
    syscall(__NR_ioctl, r[8], 0xc0184908, 0x20000200);
    break;
  case 49:
    NONFAILING(memcpy((void*)0x20000600, "/dev/rfkill\x00", 12));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000600, 0, 0);
    if (res != -1)
      r[9] = res;
    break;
  case 50:
    syscall(__NR_mmap, 0x2003e000, 0x2000, 0, 0x10, r[9], 0x402);
    break;
  case 51:
    syscall(__NR_semget, 0, 2, 0x40);
    break;
  case 52:
    res = syz_init_net_socket(6, 5, 0);
    if (res != -1)
  ...
  case 55:
    ...
    NONFAILING(*(uint8_t*)0x20000002 = 0xbb);
    NONFAILING(*(uint8_t*)0x20000003 = 0xbb);
    NONFAILING(*(uint8_t*)0x20000004 = 0xbb);
    NONFAILING(*(uint8_t*)0x20000005 = 1);
    NONFAILING(*(uint8_t*)0x20000006 = 0);
    NONFAILING(*(uint32_t*)0x2000000c = 0);
    NONFAILING(*(uint8_t*)0x20000010 = 0xbb);
    NONFAILING(*(uint8_t*)0x20000011 = 0xbb);
    NONFAILING(*(uint8_t*)0x20000012 = 0xbb);
    NONFAILING(*(uint8_t*)0x20000013 = 1);
    NONFAILING(*(uint8_t*)0x20000014 = 0);
    NONFAILING(*(uint8_t*)0x20000017 = 0xbb);
    NONFAILING(*(uint8_t*)0x20000018 = 0xbb);
    NONFAILING(*(uint8_t*)0x20000019 = 0xbb);
    NONFAILING(*(uint8_t*)0x2000001a = 1);
    NONFAILING(*(uint8_t*)0x2000001b = 0);
    NONFAILING(*(uint8_t*)0x2000001e = 0x98);
    NONFAILING(*(uint8_t*)0x2000001f = 0x92);
    NONFAILING(*(uint8_t*)0x20000020 = 0x9c);
    NONFAILING(*(uint8_t*)0x20000021 = 0xaa);
    NONFAILING(*(uint8_t*)0x20000022 = 0xb0);
    NONFAILING(*(uint8_t*)0x20000023 = 0x40);
    NONFAILING(*(uint8_t*)0x20000024 = 2);
    NONFAILING(*(uint8_t*)0x20000025 = 0xbb);
    NONFAILING(*(uint8_t*)0x20000026 = 0xbb);
    NONFAILING(*(uint8_t*)0x20000027 = 0xbb);
    NONFAILING(*(uint8_t*)0x20000028 = 0xbb);
    NONFAILING(*(uint8_t*)0x20000029 = 0xbb);
    NONFAILING(*(uint8_t*)0x2000002a = 0);
    NONFAILING(*(uint8_t*)0x2000002b = 0);
    NONFAILING(*(uint8_t*)0x2000002c = 0xbb);
    NONFAILING(*(uint8_t*)0x2000002d = 0xbb);
    NONFAILING(*(uint8_t*)0x2000002e = 0xbb);
    NONFAILING(*(uint8_t*)0x2000002f = 0xbb);
    NONFAILING(*(uint8_t*)0x20000030 = 0xbb);
    NONFAILING(*(uint8_t*)0x20000031 = 0);
    NONFAILING(*(uint8_t*)0x20000032 = 0);
    NONFAILING(*(uint8_t*)0x20000033 = 0xbb);
    NONFAILING(*(uint8_t*)0x20000034 = 0xbb);
    NONFAILING(*(uint8_t*)0x20000035 = 0xbb);
    NONFAILING(*(uint8_t*)0x20000036 = 1);
    NONFAILING(*(uint8_t*)0x20000037 = 0);
    NONFAILING(*(uint8_t*)0x2000003a = 0xbb);
    NONFAILING(*(uint8_t*)0x2000003b = 0xbb);
    NONFAILING(*(uint8_t*)0x2000003c = 0xbb);
    NONFAILING(*(uint8_t*)0x2000003d = 1);
    NONFAILING(*(uint8_t*)0x2000003e = 0);
    NONFAILING(*(uint8_t*)0x20000041 = 0xcc);
    NONFAILING(*(uint8_t*)0x20000042 = 0xcc);
    NONFAILING(*(uint8_t*)0x20000043 = 0xcc);
    NONFAILING(*(uint8_t*)0x20000044 = 0xcc);
    NONFAILING(*(uint8_t*)0x20000045 = 0xcc);
    NONFAILING(*(uint8_t*)0x20000046 = 0xcc);
    NONFAILING(*(uint8_t*)0x20000047 = 0);
    syscall(__NR_connect, r[10], 0x20000000, 0x48);
    break;
  case 56:
    syscall(__NR_listen, r[10], 0);
    break;
  case 57:
  ...
  case 62:
    NONFAILING(memcpy((void*)0x20000100,
                      "\xaa\xaa\xaa\xaa\xaa\xaa\x42\x1d\x95\x31\x72\x06\x01\xcc"
                      "\x0d\xc2\x65\x2b\x00\x14\x00\x00\xfe\x80\x00\x00\x00\x00"
                      "\xaa\xfe\xfe\xff\xff\xff\xff\xff\xff\xff\xff\xff",
                      40));
    syz_emit_ethernet(1, 0x20000100, 0);
    break;
  case 63:
    NONFAILING(*(uint16_t*)0x20000180 = 0xa);
    NONFAILING(*(uint16_t*)0x20000182 = htobe16(0));
    ...
    break;
  case 64:
    syscall(__NR_setsockopt, -1, 0x11a, 1, 0, 0);
    break;
  case 65:
    NONFAILING(*(uint8_t*)0x20000340 = 0x7f);
    NONFAILING(*(uint8_t*)0x20000341 = 0x45);
    ...
    NONFAILING(*(uint16_t*)0x20000374 = 0);
    NONFAILING(*(uint16_t*)0x20000376 = 0x38);
    NONFAILING(*(uint16_t*)0x20000378 = 0x1802);
    NONFAILING(*(uint16_t*)0x2000037a = 0);
    NONFAILING(*(uint16_t*)0x2000037c = 0);
    NONFAILING(*(uint16_t*)0x2000037e = 0);
    NONFAILING(*(uint32_t*)0x20000380 = 0);
