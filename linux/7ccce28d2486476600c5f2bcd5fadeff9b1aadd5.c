...
// https://syzkaller.appspot.com/bug?id=7ccce28d2486476600c5f2bcd5fadeff9b1aadd5
// status:fixed
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint16_t*)0x20000042 = 0x800);
    NONFAILING(*(uint8_t*)0x20000044 = 0xd6);
    NONFAILING(*(uint8_t*)0x20000045 = 0x3e);
    NONFAILING(*(uint8_t*)0x20000046 = 0x91);
    NONFAILING(*(uint8_t*)0x20000047 = 8);
    NONFAILING(*(uint16_t*)0x20000048 = 0x19d2);
    NONFAILING(*(uint16_t*)0x2000004a = 0xffb5);
    NONFAILING(*(uint16_t*)0x2000004c = 0x4a51);
    ...
    NONFAILING(*(uint8_t*)0x2000005d = 0x88);
    ...
    NONFAILING(*(uint8_t*)0x20000062 = -1);
    NONFAILING(*(uint8_t*)0x20000063 = 0);
    NONFAILING(memcpy(
        (void*)0x20001840,
        "\x59\xff\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00\x19\x00\x00\x00",
        16));
    NONFAILING(*(uint64_t*)0x20001850 = 0);
    syz_usb_connect(0, 0x24, 0x20000040, 0x20001840);
    break;
  }
}
int main(void)
