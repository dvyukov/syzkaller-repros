...
// https://syzkaller.appspot.com/bug?id=45a3394a0899c7930c9b
// status:0
...
{
  intptr_t res = 0;
  syscall(__NR_mount, 0x20000000ul, 0ul, 0ul, 0x7a04ul, 0ul);
  NONFAILING(memcpy((void*)0x20000300, "./bus\000", 6));
  res = syscall(__NR_creat, 0x20000300ul, 0ul);
  if (res != -1)
    r[0] = res;
  syscall(__NR_fallocate, r[0], 1ul, 0x4791ul, 0x800000006ul);
}
int main(void)
{
