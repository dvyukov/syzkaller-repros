...
// https://syzkaller.appspot.com/bug?id=71f2afe3d5b1c2d61d88028c5d4ba415859b5741
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    syscall(__NR_perf_event_open, 0x20000180, 0, 0xbfffffffffffffff, -1, 0);
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x20000100 = 8);
    NONFAILING(*(uint32_t*)0x20000104 = 3);
    NONFAILING(*(uint64_t*)0x20000108 = 0x20c91000);
    NONFAILING(*(uint8_t*)0x20c91000 = 0x85);
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20c91001, 0, 0, 4));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20c91001, 0, 4, 4));
    NONFAILING(*(uint16_t*)0x20c91002 = 0);
    NONFAILING(*(uint32_t*)0x20c91004 = 0x2f);
    NONFAILING(*(uint8_t*)0x20c91008 = 0x57);
    NONFAILING(*(uint8_t*)0x20c91009 = 0);
    NONFAILING(*(uint16_t*)0x20c9100a = 0);
    NONFAILING(*(uint32_t*)0x20c9100c = 0);
    NONFAILING(*(uint8_t*)0x20c91010 = 0x95);
    NONFAILING(*(uint8_t*)0x20c91011 = 0);
    NONFAILING(*(uint16_t*)0x20c91012 = 0);
    NONFAILING(*(uint32_t*)0x20c91014 = 0);
