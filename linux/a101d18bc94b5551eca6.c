// SYZFAIL: netlink_send_ext: netlink read failed
// https://syzkaller.appspot.com/bug?id=a101d18bc94b5551eca6
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000280, "wireguard\000", 10));
    NONFAILING(syz_genetlink_get_family_id(0x20000280, -1));
    break;
  case 1:
  ...
  case 2:
    ...
    NONFAILING(*(uint32_t*)0x200035c8 = 0);
    NONFAILING(*(uint64_t*)0x200035d0 = 0);
    NONFAILING(*(uint64_t*)0x200035d8 = 1);
    NONFAILING(*(uint64_t*)0x200035e0 = 0);
    NONFAILING(*(uint64_t*)0x200035e8 = 0);
    NONFAILING(*(uint32_t*)0x200035f0 = 0);
    syscall(__NR_sendmsg, r[0], 0x200035c0ul, 0ul);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000280, "wireguard\000", 10));
    NONFAILING(syz_genetlink_get_family_id(0x20000280, -1));
  ...
  case 7:
    ...
    break;
  case 8:
    NONFAILING(*(uint32_t*)0x20000200 = 0x18);
    ...
    NONFAILING(*(uint32_t*)0x2000008c = 9);
    NONFAILING(*(uint8_t*)0x20000090 = 0x18);
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000091, 2, 0, 4));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000091, 2, 4, 4));
    NONFAILING(*(uint16_t*)0x20000092 = 0);
    NONFAILING(*(uint32_t*)0x20000094 = r[1]);
    NONFAILING(*(uint8_t*)0x20000098 = 0);
    NONFAILING(*(uint8_t*)0x20000099 = 0);
    NONFAILING(*(uint16_t*)0x2000009a = 0);
    NONFAILING(*(uint32_t*)0x2000009c = 0x2cf);
    NONFAILING(*(uint8_t*)0x200000a0 = 0x95);
    ...
    break;
  case 9:
    syscall(__NR_openat, r[1], 0ul, 0ul, 0ul);
    break;
  case 10:
    NONFAILING(*(uint64_t*)0x200035c0 = 0);
    NONFAILING(*(uint32_t*)0x200035c8 = 0);
    NONFAILING(*(uint64_t*)0x200035d0 = 0x20003580);
    NONFAILING(*(uint64_t*)0x20003580 = 0x200002c0);
    NONFAILING(*(uint32_t*)0x200002c0 = 0x74);
    ...
    NONFAILING(*(uint8_t*)0x200002d0 = 1);
    NONFAILING(*(uint8_t*)0x200002d1 = 0);
    NONFAILING(*(uint16_t*)0x200002d2 = 0);
    NONFAILING(*(uint16_t*)0x200002d4 = 0x4c);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200002d6, 8, 0, 14));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200002d7, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200002d7, 1, 7, 1));
    NONFAILING(*(uint16_t*)0x200002d8 = 3);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200002da, 0, 0, 14));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200002db, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200002db, 1, 7, 1));
    NONFAILING(*(uint16_t*)0x200002dc = 0x20);
    NONFAILING(*(uint16_t*)0x200002de = 4);
    NONFAILING(*(uint16_t*)0x200002e0 = 0xa);
    NONFAILING(*(uint16_t*)0x200002e2 = htobe16(0));
    NONFAILING(*(uint32_t*)0x200002e4 = htobe32(0));
    NONFAILING(*(uint8_t*)0x200002e8 = 0xfc);
    NONFAILING(*(uint8_t*)0x200002e9 = 1);
    ...
    NONFAILING(*(uint16_t*)0x200002fc = 0x24);
    NONFAILING(*(uint16_t*)0x200002fe = 1);
    NONFAILING(memcpy(
        (void*)0x20000300,
        "\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"
        "\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000",
        32));
    NONFAILING(*(uint16_t*)0x20000320 = 0x14);
    NONFAILING(*(uint16_t*)0x20000322 = 2);
    NONFAILING(memcpy((void*)0x20000324,
                      "wg2\000\000\000\000\000\000\000\000\000\000\000\000\000",
                      16));
    NONFAILING(*(uint64_t*)0x20003588 = 0x74);
    NONFAILING(*(uint64_t*)0x200035d8 = 1);
    NONFAILING(*(uint64_t*)0x200035e0 = 0);
    NONFAILING(*(uint64_t*)0x200035e8 = 0);
    NONFAILING(*(uint32_t*)0x200035f0 = 0);
    syscall(__NR_sendmsg, -1, 0x200035c0ul, 0ul);
    break;
  case 11:
