...
// https://syzkaller.appspot.com/bug?id=884a3f49171f5c3fbb050707a10374f9acbe4e95
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint8_t*)0x20000084 = 0x18);
    NONFAILING(*(uint8_t*)0x20000085 = 0xb7);
    NONFAILING(*(uint8_t*)0x20000086 = 0xc5);
    NONFAILING(*(uint8_t*)0x20000087 = 0x40);
    NONFAILING(*(uint16_t*)0x20000088 = 0x15c2);
    NONFAILING(*(uint16_t*)0x2000008a = 0x35);
    NONFAILING(*(uint16_t*)0x2000008c = 0xd265);
    ...
    NONFAILING(*(uint8_t*)0x200000a0 = 0x45);
    NONFAILING(*(uint8_t*)0x200000a1 = 0xe5);
    NONFAILING(*(uint8_t*)0x200000a2 = 0x4f);
    NONFAILING(*(uint8_t*)0x200000a3 = 0);
    NONFAILING(*(uint8_t*)0x200000a4 = 9);
    NONFAILING(*(uint8_t*)0x200000a5 = 5);
    NONFAILING(*(uint8_t*)0x200000a6 = 0x84);
    NONFAILING(*(uint8_t*)0x200000a7 = 3);
    NONFAILING(*(uint16_t*)0x200000a8 = 0x333e);
  ...
  case 2:
    NONFAILING(
        memcpy((void*)0x20000000, "\x8e\xd1\xdf\x23\xda\x44\x51\x86", 8));
    syz_usb_ep_write(r[0], 0, 8, 0x20000000);
    break;
  }
}
int main(void)
