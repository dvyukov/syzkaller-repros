...
// https://syzkaller.appspot.com/bug?id=a9b58a6aa2a3e1d37f87
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(*(uint8_t*)0x200001c0 = 4);
    NONFAILING(*(uint8_t*)0x200001c1 = 3);
    NONFAILING(*(uint8_t*)0x200001c2 = 0xb);
    NONFAILING(*(uint8_t*)0x200001c3 = 4);
    NONFAILING(*(uint16_t*)0x200001c4 = 0xc8);
    ...
    NONFAILING(*(uint8_t*)0x200001cc = 1);
    NONFAILING(*(uint8_t*)0x200001cd = 0);
    NONFAILING(syz_emit_vhci(0x200001c0, 0xe));
    break;
  case 1:
    res = -1;
  ...
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_getsockopt, r[1], 0x112, 0xf, 0ul, 0ul);
    break;
  case 4:
    syscall(__NR_bind, r[0], 0ul, 0ul);
    break;
  case 5:
    NONFAILING(syz_emit_vhci(0, 0xa));
    break;
  case 6:
    res = -1;
  ...
  case 7:
    ...
    syscall(__NR_connect, r[2], 0x20000000ul, 8ul);
    break;
  }
}
int main(void)
