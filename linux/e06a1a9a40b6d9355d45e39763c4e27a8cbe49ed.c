...
// https://syzkaller.appspot.com/bug?id=e06a1a9a40b6d9355d45e39763c4e27a8cbe49ed
// status:open
...
void execute_one(void)
{
  ...
  syscall(__NR_mknod, 0x20000000, 0x6009, 0x701 + procid * 2);
  NONFAILING(memcpy((void*)0x20001e00, "./file0\000", 8));
  NONFAILING(memcpy((void*)0x20000180, "./file0\000", 8));
  NONFAILING(memcpy((void*)0x200000c0, "iso9660\000", 8));
  syscall(__NR_mount, 0x20001e00, 0x20000180, 0x200000c0, 0, 0);
}
int main(void)
{
