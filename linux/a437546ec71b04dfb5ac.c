...
// https://syzkaller.appspot.com/bug?id=a437546ec71b04dfb5ac
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    NONFAILING(memcpy(
        (void*)0x20000140,
        "\x12\x01\x00\x00\xd3\x92\x62\x08\x7f\x18\x00\x02\x31\x1f\x00\x00\x00"
        "\x01\x09\x02\x24\x00\x01\x00\xdd\x00\x00\x09\x04\x00\x00\x02\x4b\x92"
        "\x16\x00\x09\x05\x0b\x00\x00\x00\x00\x00\x00\x09\x05\x8a",
        48));
    NONFAILING(syz_usb_connect(0, 0x36, 0x20000140, 0));
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x200001c0 = 0);
    NONFAILING(*(uint64_t*)0x200001c4 = 0);
    NONFAILING(*(uint32_t*)0x200001cc = 0x31);
    ...
    NONFAILING(*(uint32_t*)0x200001e8 = 0x69);
    NONFAILING(*(uint64_t*)0x200001ec = 0x20000140);
    NONFAILING(*(uint8_t*)0x20000140 = 0x69);
    NONFAILING(*(uint8_t*)0x20000141 = 3);
    NONFAILING(
        memcpy((void*)0x20000142,
               "\x03\xf7\xd5\xb3\xe7\xa2\x55\x23\x32\x8c\xac\x4c\x54\x2e\x85"
               "\xe4\x73\xd6\xde\xd0\x96\x3a\x42\xa1\xa0\xd7\x8f\x3e\xe6\x63"
               "\x5d\x84\x72\x46\x65\xbe\x9b\x0f\x90\x28\x5e\xdc\x23\x51\xd1"
               "\x96\x7e\x6f\x0e\x9c\x95\x47\xe0\x24\xe7\xa6\x24\x68\x15\xc5"
               "\x4c\xfb\x69\xb3\x92\x87\x01\x86\xf7\x67\x8b\xc0\xba\x9c\x2f"
               "\x2a\x41\x0c\x58\x6e\xc8\xd5\x0d\x05\x81\x5f\x65\x65\xb2\xbd"
               "\x83\x89\x13\xd6\x77\x98\xae\x8c\xaa\x69\xf4\xd0\x7c",
               103));
    NONFAILING(syz_usb_connect(1, 0, 0, 0x200001c0));
    break;
  }
}
int main(void)
