...
// https://syzkaller.appspot.com/bug?id=d40a01556c761b2cb385
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    res = syscall(__NR_io_setup, 9, 0x20000040ul);
    if (res != -1)
  ...
  case 5:
    ...
    *(uint64_t*)0x20000298 = 0x200000c0;
    memset((void*)0x200000c0, 9, 1);
    *(uint64_t*)0x200002a0 = 1;
    *(uint64_t*)0x200002a8 = 0;
    *(uint64_t*)0x200002b0 = 0;
    *(uint32_t*)0x200002b8 = 2;
    *(uint32_t*)0x200002bc = -1;
    syscall(__NR_io_submit, r[0], 1ul, 0x20000340ul);
    break;
  case 6:
