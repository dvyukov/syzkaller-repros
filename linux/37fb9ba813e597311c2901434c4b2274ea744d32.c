...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x200000c0, "/dev/autofs", 12));
    syscall(__NR_openat, 0xffffffffffffff9c, 0x200000c0, 0x8000, 0);
    break;
  case 1:
  ...
  case 3:
    ...
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x20000040 = 0x4d2);
    NONFAILING(*(uint32_t*)0x20000044 = 0);
    syscall(__NR_ioctl, r[1], 0x4008af60, 0x20000040);
    break;
  case 5:
