...
// https://syzkaller.appspot.com/bug?id=305d215819b712c3c0ecc6519956ed681775ee53
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    syscall(__NR_openat, 0xffffff9c, 0x200000c0, 0x40, 0);
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000440, "./file0\000", 8));
    syscall(__NR_acct, 0x20000440);
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000700, "./file1\000", 8));
    syscall(__NR_mkdir, 0x20000700, 4);
    break;
  case 3:
