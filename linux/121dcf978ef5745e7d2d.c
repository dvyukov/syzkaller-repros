...
// https://syzkaller.appspot.com/bug?id=121dcf978ef5745e7d2d
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000070 = 0x20000280;
  memcpy(
      ...
      70);
  *(uint64_t*)0x20000078 = 0x46;
  *(uint64_t*)0x20000080 = 0x3d97000;
  *(uint64_t*)0x20000088 = 0x20011400;
  memcpy((void*)0x20011400,
         ...
         "\x00\xed\x41\x00\x00\x03",
         57);
  *(uint64_t*)0x20000090 = 0x39;
  *(uint64_t*)0x20000098 = 0x3d97fa0;
  *(uint8_t*)0x20011500 = 0;
  syz_mount_image(0x20000000, 0x20000100, 0, 4, 0x20000040, 0x208403,
                  0x20011500);
}
int main(void)
{
