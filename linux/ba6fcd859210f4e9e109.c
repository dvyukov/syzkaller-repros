...
// https://syzkaller.appspot.com/bug?id=ba6fcd859210f4e9e109
// status:6
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000098 = -1;
  ...
  res = -1;
  res = syz_io_uring_setup(0x2ab2, 0x20000080, 0x20ee6000, 0x206d6000,
  ...
  *(uint8_t*)0x200005c0 = 0x15;
  *(uint8_t*)0x200005c1 = 0;
  *(uint16_t*)0x200005c2 = 0;
  *(uint32_t*)0x200005c4 = 0xffffff9c;
  ...
  *(uint16_t*)0x200005ea = 0;
  memset((void*)0x200005ec, 0, 20);
  syz_io_uring_submit(r[1], r[2], 0x200005c0, 0);
  *(uint8_t*)0x20000380 = 2;
  *(uint8_t*)0x20000381 = 2;
  *(uint16_t*)0x20000382 = 0;
  *(uint32_t*)0x20000384 = r[0];
  ...
  *(uint16_t*)0x200003aa = 0;
  memset((void*)0x200003ac, 0, 20);
  syz_io_uring_submit(r[1], r[2], 0x20000380, 3);
  syscall(__NR_io_uring_enter, r[0], 0x4510, 0, 0ul, 0ul, 0xf0fffffful);
}
int main(void)
{
