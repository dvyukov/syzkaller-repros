...
// https://syzkaller.appspot.com/bug?id=47b26cd837ececfc666d
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000494 = 0x20000400;
  *(uint8_t*)0x20000400 = 0;
  *(uint8_t*)0x20000401 = 0x22;
  *(uint32_t*)0x20000402 = 5;
  STORE_BY_BITMASK(uint8_t, , 0x20000406, 3, 0, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000406, 2, 2, 2);
  STORE_BY_BITMASK(uint8_t, , 0x20000406, 0, 4, 4);
  memcpy((void*)0x20000407, "\x21\x33\x8b\xd2", 4);
  *(uint64_t*)0x2000049c = 0;
  syz_usb_control_io(r[0], 0x20000480, 0);
  memcpy((void*)0x20000a40,
         "\x9a\xe3\x3c\x5f\xd8\xb0\xc0\xea\xc1\x00\xb8\x9d\x52\x46\xd4\xf3\x63"
         "\x62\x53\x38\x3b\x4b\x3e\x90\x23\x0c\xdf\x03\x01\xcd\x07\xf8\x6d\xe7"
         "\x82\x51\xc2\xff\xff\x1f\x9d\x09\x00\x00\x00\x00\x00\x00\x00\x79\xce"
         "\x9a\x13\x5f\x56\x38\x45\x6c\x2a\x01\x23\xf0\x6f\xea\x7f\x1c\x07\xdf"
         "\x6d\xae\xda\x54\xd0\xde\x1b\xde\xd6\x0c\xbd\x14\x32\x51\x69\x49\xe0"
         "\x75\x16\x5c\xc0\x32\x22\xd3\x81\x9f\xfb\x66\x04\xf7\x50\xff\x37\x75"
         "\x82\x99\x51\xb0\x2a\x82\x4f\xde\x40\x47\x1b\xa0\xd1\x0b\x36\x6c\xae",
         119);
  syz_usb_ep_write(r[0], 0, 0x77, 0x20000a40);
}
int main(void)
{
