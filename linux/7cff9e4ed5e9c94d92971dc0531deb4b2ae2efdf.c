...
// https://syzkaller.appspot.com/bug?id=7cff9e4ed5e9c94d92971dc0531deb4b2ae2efdf
// status:open
...
void execute_call(int call)
{
  ...
  case 8:
    ...
    break;
  case 9:
    syscall(__NR_mkdirat, r[0], 0, 0);
    break;
  case 10:
    syscall(__NR_removexattr, 0, 0);
    break;
  case 11:
    syscall(__NR_ioctl, -1, 0x8004e500, 0);
    break;
  case 12:
  ...
  case 13:
    ...
    break;
  case 14:
    syscall(__NR_setsockopt, -1, 0x29, 0xca, 0, 0);
    break;
  case 15:
