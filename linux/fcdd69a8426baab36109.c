...
// https://syzkaller.appspot.com/bug?id=fcdd69a8426baab36109
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(memcpy(
        (void*)0x20010100,
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x03"
    ...
    NONFAILING(memcpy(
        ...
        "\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff"
        "\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff"
        "\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\x0f\x00"
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\xff\xff\xff\xff\xff\xff\xff\xff"
        "\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff"
        "\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff"
        "\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff"
        "\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff"
        ...
        4096));
    NONFAILING(*(uint64_t*)0x20000238 = 0x1000);
    NONFAILING(*(uint64_t*)0x20000240 = 0x11000);
    NONFAILING(*(uint64_t*)0x20000248 = 0x20011200);
    NONFAILING(memcpy(
        (void*)0x20011200,
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x12\x00\x00\x00\x00"
        "\x00\x00\x00\x00\x02\x00\x00\x00\x01\x00\x00\x61\x1c\xad\x49\xe1\x00"
        "\x00\x00\x1e\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
        48));
    NONFAILING(*(uint64_t*)0x20000250 = 0x30);
    NONFAILING(*(uint64_t*)0x20000258 = 0x212000);
    NONFAILING(*(uint64_t*)0x20000260 = 0x20011300);
    NONFAILING(memcpy(
        (void*)0x20011300,
    ...
    NONFAILING(*(uint64_t*)0x20000270 = 0x213000);
    NONFAILING(*(uint64_t*)0x20000278 = 0x20011400);
    NONFAILING(memcpy(
        (void*)0x20011400,
    ...
    NONFAILING(*(uint64_t*)0x20000288 = 0x213fa0);
    NONFAILING(*(uint8_t*)0x20011500 = 0);
    NONFAILING(syz_mount_image(0x20000000, 0x20000100, 0x400000, 6, 0x20000200,
                               0, 0x20011500));
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000240, "./file0\000", 8));
    res = syscall(__NR_creat, 0x20000240ul, 0x11ul);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
    ...
    break;
  case 3:
    NONFAILING(memcpy((void*)0x200000c0, "/dev/dri/renderD128\000", 20));
  ...
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_ioctl, r[1], 0xf50f, 0ul);
    break;
  }
}
int main(void)
