...
// https://syzkaller.appspot.com/bug?id=273e8da41acf6c1d7956
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x2025c000 = 1);
    NONFAILING(*(uint32_t*)0x2025c004 = 0x80);
    NONFAILING(*(uint8_t*)0x2025c008 = 5);
    ...
    NONFAILING(*(uint64_t*)0x2025c018 = 0x8090);
    NONFAILING(*(uint64_t*)0x2025c020 = 0xf);
  ...
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_mmap, 0x20ffc000ul, 0x3000ul, 0ul, 0x10ul, -1, 0ul);
    break;
  case 6:
