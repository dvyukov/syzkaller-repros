// WARNING in io_poll_task_func
// https://syzkaller.appspot.com/bug?id=50a186b2a3a0139929ab
// status:2
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    *(uint16_t*)0x2000002a = 0;
    ...
    break;
  case 4:
    *(uint64_t*)0x20002040 = 0x20001380;
    *(uint16_t*)0x20001380 = 0xa;
    *(uint16_t*)0x20001382 = htobe16(0);
    *(uint32_t*)0x20001384 = htobe32(0);
    *(uint8_t*)0x20001388 = 0xfe;
    *(uint8_t*)0x20001389 = 0x80;
    memset((void*)0x2000138a, 0, 13);
    *(uint8_t*)0x20001397 = 0xaa;
  ...
  case 5:
    ...
    *(uint64_t*)0x200003e0 = 0;
    ...
    STORE_BY_BITMASK(uint64_t, , 0x200003e8, 1, 5, 1);
    ...
    *(uint64_t*)0x20000438 = 0;
    syscall(__NR_perf_event_open, 0x200003c0ul, 0, 0ul, -1, 8ul);
    break;
  case 6:
    syscall(__NR_io_uring_enter, r[0], 0x2ff, 0, 0ul, 0ul, 0ul);
    break;
  case 7:
    syscall(__NR_shutdown, r[4], 0ul);
    break;
  }
}
int main(void)
