...
// https://syzkaller.appspot.com/bug?id=607ad2b77fe8f8137629
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    *(uint64_t*)0x20000600 = 0x200002c0;
    memcpy((void*)0x200002c0,
           ...
           23);
    *(uint64_t*)0x20000608 = 0x17;
    *(uint64_t*)0x20000610 = 0;
    *(uint64_t*)0x20000618 = 0;
    *(uint64_t*)0x20000620 = 0;
    *(uint64_t*)0x20000628 = 0xffffffffffff8001;
    syz_mount_image(0x20000200, 0x20000100, 0, 2, 0x20000600, 0, 0x20000180);
    break;
  case 1:
  ...
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_ftruncate, -1, 0x10099b8ul);
    {
      int i;
      for (i = 0; i < 64; i++) {
        syscall(__NR_ftruncate, -1, 0x10099b8ul);
