...
// https://syzkaller.appspot.com/bug?id=7d42d68643a35f71ac8a
// status:6
...
{
  intptr_t res = 0;
  *(uint8_t*)0x20000400 = 0x12;
  *(uint8_t*)0x20000401 = 1;
  *(uint16_t*)0x20000402 = 0;
  *(uint8_t*)0x20000404 = 0x22;
  *(uint8_t*)0x20000405 = 0xe0;
  *(uint8_t*)0x20000406 = 0x37;
  *(uint8_t*)0x20000407 = 8;
  *(uint16_t*)0x20000408 = 0xb3b;
  *(uint16_t*)0x2000040a = 0x1601;
  *(uint16_t*)0x2000040c = 0x173;
  *(uint8_t*)0x2000040e = 0;
  *(uint8_t*)0x2000040f = 0;
  *(uint8_t*)0x20000410 = 0;
  *(uint8_t*)0x20000411 = 1;
  *(uint8_t*)0x20000412 = 9;
  *(uint8_t*)0x20000413 = 2;
  *(uint16_t*)0x20000414 = 0x1b;
  ...
  *(uint8_t*)0x20000420 = 0xb0;
  *(uint8_t*)0x20000421 = 0x87;
  *(uint8_t*)0x20000422 = 0x22;
  *(uint8_t*)0x20000423 = 0;
  *(uint8_t*)0x20000424 = 7;
  *(uint8_t*)0x20000425 = 5;
  *(uint8_t*)0x20000426 = 0x81;
  *(uint8_t*)0x20000427 = 2;
  *(uint16_t*)0x20000428 = 0x200;
  *(uint8_t*)0x2000042a = 0;
  *(uint8_t*)0x2000042b = 0;
  *(uint8_t*)0x2000042c = 0;
  res = syz_usb_connect(0, 0x2d, 0x20000400, 0);
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x20000040,
         "\x40\x47\xcf\x12\x3f\x66\x96\xb3\x1f\x22\xa8\xf3\x1d\x6c\x77\x99\xa2"
         "\xaa\x73\xb6\xd5\xc2\xf7\xd4\x88\xbb\x1c\x06\xf6\x91\xc3\x8c\xf0\xf0"
         "\xb7\xbd\x52\x39\x31\xeb\x1b\x14\x36\x7b\xd7\x4c\x1c\xd3\xf0\x81\x4d"
         "\x22\xbb\x2c\x92\x2d\x2a\xa3\xed\x00\x00\x1d\x9e\xce\x10\x7f\xad\x9a"
         "\x50\xf0\x8c\x25\x31",
         73);
  syz_usb_ep_write(r[0], 0, 0x49, 0x20000040);
}
int main(void)
{
