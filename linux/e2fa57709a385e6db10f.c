...
// https://syzkaller.appspot.com/bug?id=e2fa57709a385e6db10f
// status:0
...
void execute_one(void)
{
  ...
  *(uint16_t*)0x200000e6 = 1;
  memcpy((void*)0x200000e8, "gtp\000", 4);
  *(uint16_t*)0x200000ec = 0x24;
  STORE_BY_BITMASK(uint16_t, , 0x200000ee, 2, 0, 14);
  ...
  *(uint16_t*)0x20000182 = htobe16(0x4001);
  ...
  *(uint32_t*)0x20000198 = 0xd;
  syscall(__NR_connect, r[2], 0x20000180ul, 0x1cul);
  *(uint32_t*)0x200001c0 = 3;
  *(uint16_t*)0x200001c8 = 0xa;
  *(uint16_t*)0x200001ca = htobe16(0x4e22);
  *(uint32_t*)0x200001cc = htobe32(0xea59);
  ...
  *(uint32_t*)0x200001e0 = -1;
  syscall(__NR_setsockopt, r[2], 0x29, 0x2a, 0x200001c0ul, 0x88ul);
}
int main(void)
{
