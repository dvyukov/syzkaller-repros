...
// https://syzkaller.appspot.com/bug?id=ee1632e4ebbb7489a005df12f813deac8f1bbdeb
// status:open
...
void test()
{
  ...
  *(uint32_t*)0x205faffc = 0;
  ...
  syscall(__NR_clone, 0x49800900, 0x20001340, 0x200013c0, 0x20001400,
          0x20001440);
}
