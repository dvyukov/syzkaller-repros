...
// https://syzkaller.appspot.com/bug?id=17c16b868e6af41acdd4
// status:6
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000000, "/dev/snd/timer\000", 15));
  ...
  case 1:
    ...
    syscall(__NR_ioctl, r[0], 0x40045402, 0x20000140ul);
    break;
  case 2:
  ...
  case 3:
    ...
    NONFAILING(memset((void*)0x20000114, 0, 32));
    syscall(__NR_ioctl, r[0], 0x40345410, 0x20000100ul);
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x20000440 = 0);
    NONFAILING(*(uint32_t*)0x20000444 = 0x20000006);
    NONFAILING(*(uint32_t*)0x20000448 = 0);
    NONFAILING(*(uint32_t*)0x2000044c = 0);
    NONFAILING(*(uint32_t*)0x20000450 = 0xd);
    NONFAILING(memset((void*)0x20000454, 0, 60));
  ...
  case 6:
    ...
    break;
  case 7:
    syscall(__NR_fcntl, r[1], 0x10ul, 0ul);
    break;
  case 8:
