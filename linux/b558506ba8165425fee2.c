...
// https://syzkaller.appspot.com/bug?id=b558506ba8165425fee2
// status:0
...
{
  intptr_t res = 0;
  NONFAILING(*(uint8_t*)0x20000a40 = 0x12);
  NONFAILING(*(uint8_t*)0x20000a41 = 1);
  NONFAILING(*(uint16_t*)0x20000a42 = 0);
  NONFAILING(*(uint8_t*)0x20000a44 = 2);
  NONFAILING(*(uint8_t*)0x20000a45 = 0);
  NONFAILING(*(uint8_t*)0x20000a46 = 0);
  NONFAILING(*(uint8_t*)0x20000a47 = 0x20);
  NONFAILING(*(uint16_t*)0x20000a48 = 0x424);
  NONFAILING(*(uint16_t*)0x20000a4a = 0x7505);
  NONFAILING(*(uint16_t*)0x20000a4c = 0x40);
  NONFAILING(*(uint8_t*)0x20000a4e = 1);
  NONFAILING(*(uint8_t*)0x20000a4f = 2);
  NONFAILING(*(uint8_t*)0x20000a50 = 3);
  NONFAILING(*(uint8_t*)0x20000a51 = 1);
  NONFAILING(*(uint8_t*)0x20000a52 = 9);
  NONFAILING(*(uint8_t*)0x20000a53 = 2);
  NONFAILING(*(uint16_t*)0x20000a54 = 0x3b);
  NONFAILING(*(uint8_t*)0x20000a56 = 1);
  NONFAILING(*(uint8_t*)0x20000a57 = 1);
  NONFAILING(*(uint8_t*)0x20000a58 = 0);
  NONFAILING(*(uint8_t*)0x20000a59 = 0);
  NONFAILING(*(uint8_t*)0x20000a5a = 0);
  NONFAILING(*(uint8_t*)0x20000a5b = 9);
  NONFAILING(*(uint8_t*)0x20000a5c = 4);
  NONFAILING(*(uint8_t*)0x20000a5d = 0);
  NONFAILING(*(uint8_t*)0x20000a5e = 0);
  NONFAILING(*(uint8_t*)0x20000a5f = 3);
  NONFAILING(*(uint8_t*)0x20000a60 = 2);
  NONFAILING(*(uint8_t*)0x20000a61 = 6);
  NONFAILING(*(uint8_t*)0x20000a62 = 0);
  NONFAILING(*(uint8_t*)0x20000a63 = 0);
  NONFAILING(*(uint8_t*)0x20000a64 = 5);
  NONFAILING(*(uint8_t*)0x20000a65 = 0x24);
  NONFAILING(*(uint8_t*)0x20000a66 = 6);
  NONFAILING(*(uint8_t*)0x20000a67 = 0);
  NONFAILING(*(uint8_t*)0x20000a68 = 0);
  NONFAILING(*(uint8_t*)0x20000a69 = 5);
  NONFAILING(*(uint8_t*)0x20000a6a = 0x24);
  NONFAILING(*(uint8_t*)0x20000a6b = 0);
  NONFAILING(*(uint16_t*)0x20000a6c = 0);
  NONFAILING(*(uint8_t*)0x20000a6e = 0xd);
  NONFAILING(*(uint8_t*)0x20000a6f = 0x24);
  NONFAILING(*(uint8_t*)0x20000a70 = 0xf);
  NONFAILING(*(uint8_t*)0x20000a71 = 1);
  NONFAILING(*(uint32_t*)0x20000a72 = 0);
  NONFAILING(*(uint16_t*)0x20000a76 = 0);
  NONFAILING(*(uint16_t*)0x20000a78 = 0);
  NONFAILING(*(uint8_t*)0x20000a7a = 0);
  NONFAILING(*(uint8_t*)0x20000a7b = 9);
  NONFAILING(*(uint8_t*)0x20000a7c = 5);
  NONFAILING(*(uint8_t*)0x20000a7d = 0x82);
  NONFAILING(*(uint8_t*)0x20000a7e = 2);
  NONFAILING(*(uint16_t*)0x20000a7f = 0xf7);
  NONFAILING(*(uint8_t*)0x20000a81 = 0);
  NONFAILING(*(uint8_t*)0x20000a82 = 0);
  NONFAILING(*(uint8_t*)0x20000a83 = 0);
  NONFAILING(*(uint8_t*)0x20000a84 = 9);
  NONFAILING(*(uint8_t*)0x20000a85 = 5);
  NONFAILING(*(uint8_t*)0x20000a86 = 3);
  NONFAILING(*(uint8_t*)0x20000a87 = 2);
  NONFAILING(*(uint16_t*)0x20000a88 = 0x10);
  NONFAILING(*(uint8_t*)0x20000a8a = 0);
  NONFAILING(*(uint8_t*)0x20000a8b = 0);
  NONFAILING(*(uint8_t*)0x20000a8c = 0);
  res = -1;
  NONFAILING(res = syz_usb_connect(0, 0x4d, 0x20000a40, 0));
  if (res != -1)
    r[0] = res;
