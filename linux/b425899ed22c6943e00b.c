...
// https://syzkaller.appspot.com/bug?id=b425899ed22c6943e00b
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000740 = 0x20000600;
  memcpy((void*)0x20000600,
         ...
         57);
  *(uint64_t*)0x20000748 = 0x39;
  syscall(__NR_writev, r[0], 0x20000740ul, 1ul);
  res = syscall(__NR_socket, 0x2bul, 1ul, 0);
  if (res != -1)
    r[1] = res;
  *(uint32_t*)0x20000000 = 1;
  syscall(__NR_setsockopt, r[1], 6, 0x13, 0x20000000ul, 4ul);
  *(uint32_t*)0x20007980 = 2;
  syscall(__NR_setsockopt, r[1], 6, 0x14, 0x20007980ul, 4ul);
  ...
  *(uint8_t*)0x20000087 = 0;
  syscall(__NR_connect, r[1], 0x20000080ul, 0x10ul);
  *(uint32_t*)0x20001240 = 0;
  syscall(__NR_setsockopt, r[1], 6, 0x13, 0x20001240ul, 4ul);
}
int main(void)
{
