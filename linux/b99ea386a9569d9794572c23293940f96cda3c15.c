...
void execute_call(int call)
{
  ...
  case 3:
    ...
    NONFAILING(*(uint32_t*)0x20000048 = 0xc);
    NONFAILING(*(uint64_t*)0x20000050 = 0x2000d379);
    NONFAILING(*(uint64_t*)0x2000d379 = 0x20000200);
    NONFAILING(*(uint32_t*)0x20000200 = 0x18);
    NONFAILING(*(uint16_t*)0x20000204 = 0x14);
    NONFAILING(*(uint16_t*)0x20000206 = 0x301);
    NONFAILING(*(uint32_t*)0x20000208 = 0);
    NONFAILING(*(uint32_t*)0x2000020c = 0);
    NONFAILING(*(uint8_t*)0x20000210 = 0x1e);
    NONFAILING(*(uint8_t*)0x20000211 = 0);
    NONFAILING(*(uint16_t*)0x20000212 = 0);
    NONFAILING(memcpy((void*)0x20000214, "\xc1", 1));
    NONFAILING(*(uint64_t*)0x2000d381 = 0x18);
