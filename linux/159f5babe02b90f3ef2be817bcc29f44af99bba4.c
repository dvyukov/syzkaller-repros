...
// https://syzkaller.appspot.com/bug?id=159f5babe02b90f3ef2be817bcc29f44af99bba4
// status:open
...
void loop(void)
{
  ...
  *(uint8_t*)0x2000008e = 0xaa;
  *(uint8_t*)0x2000008f = 0xaa;
  *(uint8_t*)0x20000090 = 0xaa;
  *(uint8_t*)0x20000091 = 0xaa;
  *(uint8_t*)0x20000092 = 0;
  *(uint8_t*)0x20000093 = 0;
  syscall(__NR_bind, r[0], 0x20000080, 0x14);
  memcpy((void*)0x200000c0,
         "\x5d\xd1\x9a\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", 14);
  syscall(__NR_sendto, r[0], 0x200000c0, 0xe, 0, 0, 0);
}
int main(void)
{
