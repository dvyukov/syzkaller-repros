...
// https://syzkaller.appspot.com/bug?id=587a843fe6b38420a209
// status:0
...
void loop(void)
{
  ...
  *(uint32_t*)0x20000000 = 0xa4;
  *(uint16_t*)0x20000004 = 0x24;
  *(uint16_t*)0x20000006 = 0xf0b;
  *(uint32_t*)0x20000008 = 0;
  *(uint32_t*)0x2000000c = 0;
  *(uint8_t*)0x20000010 = 0;
  *(uint8_t*)0x20000011 = 0;
  *(uint16_t*)0x20000012 = 0x12;
  ...
  *(uint16_t*)0x20000026 = 1;
  memcpy((void*)0x20000028, "taprio\000", 7);
  *(uint16_t*)0x20000030 = 0x74;
  *(uint16_t*)0x20000032 = 2;
  *(uint16_t*)0x20000034 = 0x56;
  *(uint16_t*)0x20000036 = 1;
  *(uint8_t*)0x20000038 = 2;
  ...
  *(uint16_t*)0x2000004a = 8;
  *(uint16_t*)0x2000004c = 4;
  *(uint16_t*)0x2000004e = 0;
  ...
  *(uint16_t*)0x2000008c = 0x10;
  STORE_BY_BITMASK(uint16_t, , 0x2000008e, 2, 0, 14);
  STORE_BY_BITMASK(uint16_t, , 0x2000008f, 0, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x2000008f, 1, 7, 1);
  ...
  *(uint32_t*)0x20000098 = 0x80000001;
  *(uint16_t*)0x2000009c = 8;
  *(uint16_t*)0x2000009e = 5;
  ...
  *(uint64_t*)0x20000300 = 0x1d5;
  *(uint64_t*)0x20000308 = 1;
  *(uint64_t*)0x20000310 = 8;
  *(uint64_t*)0x20000318 = 2;
  *(uint64_t*)0x20000320 = 1;
  *(uint64_t*)0x20000328 = 0;
  *(uint64_t*)0x20000330 = 0x3ff;
  *(uint64_t*)0x20000338 = 6;
  *(uint64_t*)0x20000340 = 0x10001;
  *(uint64_t*)0x20000348 = 0x80000000;
  *(uint64_t*)0x20000350 = 0;
  *(uint64_t*)0x20000358 = 0x1f;
  *(uint64_t*)0x20000360 = 0;
  *(uint64_t*)0x20000368 = 0x200;
  *(uint64_t*)0x20000370 = 0xffffffffffffff7f;
  *(uint64_t*)0x20000378 = 0x40;
  *(uint64_t*)0x20000380 = 1;
  *(uint64_t*)0x20000388 = 6;
  *(uint64_t*)0x20000390 = 9;
  *(uint64_t*)0x20000398 = 0;
  *(uint64_t*)0x200003a0 = 0x80000000;
  *(uint64_t*)0x200003a8 = 8;
  *(uint64_t*)0x200003b0 = 7;
  *(uint64_t*)0x200003b8 = 6;
  *(uint64_t*)0x200003c0 = 8;
  *(uint64_t*)0x200003c8 = 3;
  syscall(__NR_clock_adjtime, 0ul, 0x20000300ul);
}
int main(void)
{
