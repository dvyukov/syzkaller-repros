...
void execute_call(int call)
{
  ...
  case 5:
    ...
    syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000300ul, 0ul, 0ul);
    break;
  case 6:
  ...
  case 18:
    ...
    break;
  case 19:
    syscall(__NR_socketpair, 1ul, 1ul, 0ul, 0x20000000ul);
    break;
  case 20:
    syscall(__NR_dup, -1);
    break;
  ...
  case 27:
    *(uint32_t*)0x20000080 = 0x14;
    res = syscall(__NR_getpeername, r[6], 0x20000000ul, 0x20000080ul);
    if (res != -1)
      r[7] = *(uint32_t*)0x20000004;
    break;
  case 28:
    res = syscall(__NR_socketpair, 1ul, 1ul, 0ul, 0x20000000ul);
    if (res != -1)
      r[8] = *(uint32_t*)0x20000004;
    break;
  case 29:
  ...
  case 30:
    *(uint32_t*)0x20000040 = 0x12;
    res = syscall(__NR_getpeername, r[9], 0x20000000ul, 0x20000040ul);
    if (res != -1)
      r[10] = *(uint32_t*)0x20000004;
    break;
  case 31:
