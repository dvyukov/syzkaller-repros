...
// https://syzkaller.appspot.com/bug?id=7b2b13f4943374609532
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint32_t*)0x20000014 = 0xa8);
    ...
    NONFAILING(*(uint32_t*)0x2000011c = 0xeb);
    NONFAILING(*(uint64_t*)0x20000120 = 0x20000200);
    ...
    syscall(__NR_bpf, 5ul, 0x20000100ul, 0x74ul);
    break;
  }
}
int main(void)
