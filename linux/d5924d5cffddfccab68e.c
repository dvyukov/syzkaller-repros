...
// https://syzkaller.appspot.com/bug?id=d5924d5cffddfccab68e
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(*(uint64_t*)0x2001d010 = 0x41c2);
  NONFAILING(*(uint64_t*)0x2001d018 = 0);
  NONFAILING(*(uint64_t*)0x2001d020 = 2);
  ...
  NONFAILING(*(uint64_t*)0x2001d038 = 4);
  NONFAILING(*(uint64_t*)0x2001d040 = 0xffffffffffffff80);
  NONFAILING(*(uint64_t*)0x2001d048 = 0);
  NONFAILING(*(uint64_t*)0x2001d050 = 0);
  NONFAILING(*(uint32_t*)0x2001d058 = 0xffffff7d);
  NONFAILING(*(uint32_t*)0x2001d05c = 0);
  NONFAILING(*(uint64_t*)0x2001d060 = 0);
  NONFAILING(*(uint32_t*)0x2001d068 = 0x297);
  ...
  syscall(__NR_perf_event_open, 0x2001d000ul, 0, -1ul, -1, 0xbul);
  syscall(__NR_bind, -1, 0ul, 0ul);
  syscall(__NR_socket, 0x10ul, 3ul, 0x10);
  NONFAILING(syz_genetlink_get_family_id(0, -1));
  syscall(__NR_mmap, 0x20ffe000ul, 0x2000ul, 0x1000008ul, 0x10ul, -1,
          0x898ca000ul);
  syscall(__NR_setns, -1, 0x20000ul);
  syscall(__NR_ioctl, -1, 0x81f8943c, 0ul);
  syscall(__NR_bind, -1, 0ul, 0ul);
  syscall(__NR_ioctl, -1, 0xc020660b, 0ul);
  ...
  if (res != -1)
    r[0] = res;
  NONFAILING(memcpy((void*)0x200014c0, "nl80211\000", 8));
  res = -1;
  NONFAILING(res = syz_genetlink_get_family_id(0x200014c0, -1));
  if (res != -1)
    r[1] = res;
  res = syscall(__NR_socketpair, 1ul, 5ul, 0, 0x20000140ul);
  if (res != -1)
  ...
  if (res != -1)
    NONFAILING(r[3] = *(uint32_t*)0x20000010);
  NONFAILING(*(uint64_t*)0x20000200 = 0);
  NONFAILING(*(uint32_t*)0x20000208 = 0);
  NONFAILING(*(uint64_t*)0x20000210 = 0x200001c0);
  NONFAILING(*(uint64_t*)0x200001c0 = 0x20000240);
  NONFAILING(*(uint32_t*)0x20000240 = 0x2c);
  ...
  NONFAILING(*(uint8_t*)0x20000250 = 0x66);
  ...
  NONFAILING(*(uint16_t*)0x2000025e = 0x26);
  NONFAILING(*(uint32_t*)0x20000260 = 0x98f);
  NONFAILING(*(uint16_t*)0x20000264 = 8);
  NONFAILING(*(uint16_t*)0x20000266 = 0xb7);
  NONFAILING(*(uint32_t*)0x20000268 = 0xa5);
  NONFAILING(*(uint64_t*)0x200001c8 = 0x2c);
  ...
  syscall(__NR_sendmsg, r[0], 0x20000200ul, 0x48000ul);
  ...
  syscall(__NR_bind, r[4], 0x20000140ul, 0x1cul);
  syscall(__NR_listen, r[4], 0x10003);
  res = syscall(__NR_socket, 0xaul, 0x800000000000001ul, 0x84);
  if (res != -1)
    r[5] = res;
  syscall(__NR_sched_setscheduler, 0, 5ul, 0ul);
  ...
  syscall(__NR_setsockopt, r[5], 0x84, 0x6b, 0x2055bfe4ul, 0x1cul);
  syscall(__NR_setsockopt, -1, 0x84, 0x6b, 0ul, 0ul);
