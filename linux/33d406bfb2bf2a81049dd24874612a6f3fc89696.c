...
// https://syzkaller.appspot.com/bug?id=33d406bfb2bf2a81049dd24874612a6f3fc89696
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    res = syscall(__NR_socket, 2, 0x80003, 0xa);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    ...
    break;
  case 2:
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0, 0x200000, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 3:
    syscall(__NR_ioctl, r[1], 0x4b49, 0);
    break;
  case 4:
    ...
    NONFAILING(*(uint8_t*)0x200000a8 = 0xac);
    NONFAILING(*(uint8_t*)0x200000a9 = 0x14);
    NONFAILING(*(uint8_t*)0x200000aa = 0x14);
    NONFAILING(*(uint8_t*)0x200000ab = 0xbb);
  ...
  case 5:
    ...
    NONFAILING(*(uint8_t*)0x20000646 = -1);
    NONFAILING(*(uint8_t*)0x20000647 = -1);
    NONFAILING(*(uint8_t*)0x20000648 = -1);
    NONFAILING(*(uint8_t*)0x20000649 = -1);
    NONFAILING(*(uint8_t*)0x2000064a = -1);
    NONFAILING(*(uint8_t*)0x2000064b = -1);
    NONFAILING(*(uint16_t*)0x2000064c = htobe16(0x800));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x2000064e, 5, 0, 4));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x2000064e, 4, 4, 4));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x2000064f, 0, 0, 2));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x2000064f, 0, 2, 6));
    NONFAILING(*(uint16_t*)0x20000650 = htobe16(0x1c));
    NONFAILING(*(uint16_t*)0x20000652 = htobe16(0));
    NONFAILING(*(uint16_t*)0x20000654 = htobe16(0));
    NONFAILING(*(uint8_t*)0x20000656 = 0);
    NONFAILING(*(uint8_t*)0x20000657 = 2);
    NONFAILING(*(uint16_t*)0x20000658 = htobe16(0));
    NONFAILING(*(uint32_t*)0x2000065a = htobe32(0));
    NONFAILING(*(uint32_t*)0x2000065e = htobe32(-1));
    NONFAILING(*(uint8_t*)0x20000662 = 0x11);
    NONFAILING(*(uint8_t*)0x20000663 = 0);
    NONFAILING(*(uint16_t*)0x20000664 = htobe16(0));
    NONFAILING(*(uint32_t*)0x20000666 = htobe32(0xe0000001));
    struct csum_inet csum_1;
    csum_inet_init(&csum_1);
    NONFAILING(csum_inet_update(&csum_1, (const uint8_t*)0x20000662, 8));
    NONFAILING(*(uint16_t*)0x20000664 = csum_inet_digest(&csum_1));
    struct csum_inet csum_2;
    csum_inet_init(&csum_2);
    NONFAILING(csum_inet_update(&csum_2, (const uint8_t*)0x2000064e, 20));
    NONFAILING(*(uint16_t*)0x20000658 = csum_inet_digest(&csum_2));
    syz_emit_ethernet(0x2a, 0x20000640, 0);
    break;
  }
}
int main(void)
