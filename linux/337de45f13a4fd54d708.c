...
// https://syzkaller.appspot.com/bug?id=337de45f13a4fd54d708
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    NONFAILING(
        syz_io_uring_setup(0xa53, 0, 0x20000000, 0x20008000, 0x20000180, 0));
    break;
  case 1:
    ...
    NONFAILING(memset((void*)0x2000005c, 0, 12));
    res = syscall(__NR_io_uring_setup, 0x17d6, 0x20000040ul);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
    syscall(__NR_io_uring_register, r[0], 0x13ul, 0x20004000ul, 2ul);
    break;
  }
}
int main(void)
