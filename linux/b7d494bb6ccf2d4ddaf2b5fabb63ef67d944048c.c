...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    NONFAILING(memcpy((void*)0x200000c0, "/dev/bus/usb/00#/00#", 21));
    syz_open_dev(0x200000c0, 0x400, 0x420000);
    break;
  case 3:
    syscall(__NR_clone, 0x20002100, 0, 0x9999999999999999, 0x20000340, -1);
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000000, "/dev/nullb0", 12));
    NONFAILING(memcpy((void*)0x200002c0, "./file0", 8));
    NONFAILING(memcpy((void*)0x20000300, "gfs2", 5));
    syscall(__NR_mount, 0x20000000, 0x200002c0, 0x20000300, 0, 0);
    break;
  }
}
int main(void)
