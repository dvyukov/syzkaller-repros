...
// https://syzkaller.appspot.com/bug?id=f02b92479b7065807a2a
// status:0
...
void execute_call(int call)
{
  switch (call) {
  case 0:
    syscall(__NR_mknod, 0ul, 0x1040ul, 0);
    break;
  case 1:
    ...
    NONFAILING(*(uint64_t*)0x20000740 = 6);
  ...
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_clock_gettime, 0ul, 0x20001780ul);
    break;
  case 6:
  ...
  case 7:
    ...
    break;
  case 8:
    syscall(__NR_sendfile, -1, -1, 0ul, 0x4000000000010046ul);
    break;
  case 9:
    syscall(__NR_epoll_pwait, -1, 0ul, 0ul, 4, 0ul, 0ul);
    break;
  case 10:
    syscall(__NR_gettid);
    break;
