// general protection fault in vgem_fence_attach_ioctl
// https://syzkaller.appspot.com/bug?id=1b5240d1111ab4dadb95
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint32_t*)0x20940004 = 0x80);
    NONFAILING(*(uint8_t*)0x20940008 = 0xb6);
    ...
    NONFAILING(*(uint64_t*)0x20940020 = 0xb);
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20940028, 0, 29, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20940028, 0, 30, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20940028, 0, 31, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20940028, 0, 32, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20940028, 0, 33, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20940028, 0, 34, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20940028, 0, 35, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20940028, 0, 36, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20940028, 0, 37, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20940028, 0, 38, 26));
    NONFAILING(*(uint32_t*)0x20940030 = 0);
    NONFAILING(*(uint32_t*)0x20940034 = 0);
    NONFAILING(*(uint64_t*)0x20940038 = 0);
    NONFAILING(*(uint64_t*)0x20940040 = 0);
    NONFAILING(*(uint64_t*)0x20940048 = 0x3228);
    ...
    NONFAILING(*(uint16_t*)0x2094006c = 9);
    NONFAILING(*(uint16_t*)0x2094006e = 0);
    NONFAILING(*(uint32_t*)0x20940070 = 0);
    NONFAILING(*(uint32_t*)0x20940074 = 0);
    NONFAILING(*(uint64_t*)0x20940078 = 0);
    syscall(__NR_perf_event_open, 0x20940000ul, 0, -1ul, -1, 0ul);
    break;
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_setxattr, 0ul, 0ul, 0ul, 0x54ul, 0ul);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000100, "/dev/dri/card#\000", 15));
    res = -1;
    NONFAILING(res = syz_open_dev(0x20000100, 0, 0));
    if (res != -1)
      r[0] = res;
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x200000c0 = 6);
    NONFAILING(*(uint32_t*)0x200000c4 = 0x1f);
    NONFAILING(*(uint32_t*)0x200000c8 = 1);
    NONFAILING(*(uint32_t*)0x200000cc = 0);
    res = syscall(__NR_ioctl, r[0], 0xc02064b2, 0x200000c0ul);
    if (res != -1)
      NONFAILING(r[1] = *(uint32_t*)0x200000d0);
    break;
  case 5:
    NONFAILING(*(uint32_t*)0x20000140 = r[1]);
    syscall(__NR_ioctl, r[0], 0xc10c5541, 0x20000140ul);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000100, "/dev/dri/card#\000", 15));
    res = -1;
  ...
  case 7:
    ...
    NONFAILING(*(uint32_t*)0x200000c8 = 1);
    NONFAILING(*(uint32_t*)0x200000cc = 0);
    res = syscall(__NR_ioctl, r[2], 0xc02064b2, 0x200000c0ul);
    if (res != -1)
      NONFAILING(r[3] = *(uint32_t*)0x200000d0);
    break;
  case 8:
    NONFAILING(*(uint32_t*)0x20000000 = r[3]);
    syscall(__NR_ioctl, r[0], 0xc00464b4, 0x20000000ul);
    break;
  case 9:
    NONFAILING(*(uint32_t*)0x20000040 = r[3]);
    syscall(__NR_ioctl, -1, 0xc00464b4, 0x20000040ul);
    break;
  case 10:
  ...
  case 11:
    NONFAILING(
        memcpy((void*)0x20000280,
               "\x1c\x00\x00\x00\x1a\x00\x9b\x8a\x14\xe5\xf4\x07\x00\x09\x04"
               "\x24\x00\x00\x00\x00\xff\x00\x00\x00\x00\x00\x00\x00",
               28));
    syscall(__NR_write, r[4], 0x20000280ul, 0x1e5ul);
    break;
  case 12:
    NONFAILING(*(uint64_t*)0x200001c0 = 0x77359400);
    NONFAILING(*(uint64_t*)0x200001c8 = 0);
    syscall(__NR_recvmmsg, r[4], 0ul, 0ul, 0x1aul, 0x200001c0ul);
    break;
  case 13:
    NONFAILING(syz_init_net_socket(9, 5, 0));
    break;
  case 14:
    syscall(__NR_preadv, -1, 0ul, 0ul, 0xd9f, 0);
    break;
  }
}
int main(void)
