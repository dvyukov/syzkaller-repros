// BUG: stack guard page was hit in sys_setxattr (3)
// https://syzkaller.appspot.com/bug?id=6bf9a20ada3ea4d2b75a
// status:3
...
int main(void)
{
  ...
  syscall(__NR_setxattr, 0x20000140ul, 0ul, 0ul, 0ul, 0ul);
  return 0;
}
