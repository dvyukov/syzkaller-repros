...
void execute_call(int call)
{
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000000, "reiserfs", 9));
    NONFAILING(memcpy((void*)0x20000100, "./file0", 8));
    NONFAILING(*(uint64_t*)0x20000200 = 0x20010000);
    NONFAILING(
        memcpy((void*)0x20010000,
               "\x00\x08\x00\x00\xec\x05\x00\x00\x13\x02\x00\x00\x12\x00\x00"
               "\x00\x00\x00\x00\x00\x00\x02\x00\x00\x00\x01\x00\x00\xba\x55"
               "\x39\x4c\xe1\x00\x00\x00\x1e\x00\x00\x00\x00\x00\x00\x00\x00"
               "\x10\xcc\x03\x02\x00\x01\x00\x52\x65\x49\x73\x45\x72\x33\x46"
               "\x73\x00\x00\x00\x03\x00\x00\x00\x02\x00\x01\x00",
               72));
    NONFAILING(*(uint64_t*)0x20000208 = 0x48);
    ...
    NONFAILING(*(uint64_t*)0x20000288 = 0x213000);
    NONFAILING(*(uint64_t*)0x20000290 = 0x20011400);
    NONFAILING(*(uint64_t*)0x20000298 = 0);
    NONFAILING(*(uint64_t*)0x200002a0 = 0x213fa0);
    NONFAILING(*(uint8_t*)0x20011500 = 0);
    syz_mount_image(0x20000000, 0x20000100, 0x800000, 7, 0x20000200, 0,
                    0x20011500);
    break;
  }
}
