...
// https://syzkaller.appspot.com/bug?id=a4ce41cc542d66d69c89
// status:0
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000264 = 0;
  res = -1;
  res = syz_io_uring_setup(0x2de5, 0x20000240, 0x20002000, 0x20ffd000,
  ...
  *(uint8_t*)0x200000ff = 0;
  syz_io_uring_submit(r[1], r[2], 0x200000c0, 3);
  *(uint8_t*)0x200004c0 = 6;
  *(uint8_t*)0x200004c1 = 6;
  ...
  *(uint8_t*)0x200004ff = 0;
  syz_io_uring_submit(r[1], r[2], 0x200004c0, 0);
  inject_fault(2);
  syscall(__NR_io_uring_enter, r[0], 2, 0, 0ul, 0ul, 0ul);
}
int main(void)
{
