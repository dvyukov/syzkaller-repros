...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    memcpy((void*)0x2000fffa, "./bus\x00", 6);
    syscall(__NR_open, 0x2000fffa, 0x141042, 0);
    break;
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_ftruncate, r[0], 0x208200);
    break;
  case 3:
    memcpy((void*)0x20000780, "./bus\x00", 6);
    res = syscall(__NR_open, 0x20000780, 0x14103e, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 4:
    syscall(__NR_mmap, 0x20000000, 0x600000, 0x7ffffe, 0x4002011, r[1], 0);
    break;
  case 5:
