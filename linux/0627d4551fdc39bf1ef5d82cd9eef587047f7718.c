...
void loop()
{
  ...
  *(uint64_t*)0x20000200 = 0x20010000;
  memcpy((void*)0x20010000,
         "\x00\x08\x00\x00\xec\x05\x00\x00\x13\x02\x00\x00\x12\x00\x00\x00\x00"
         "\x12\x00\x00\x00\x02\x00\x00\x00\x12\x00\x00\x24\xd9\x64\x43\xe1\x00"
  ...
  *(uint64_t*)0x20000210 = 0x10000;
  memcpy((void*)0x20000500, "jdev", 4);
  *(uint8_t*)0x20000504 = 0x3d;
  memcpy((void*)0x20000505, "%/file0", 8);
  *(uint8_t*)0x2000050d = 0x2c;
  *(uint8_t*)0x2000050e = 0;
  syz_mount_image(0x20000000, 0x20000100, 0x800000, 1, 0x20000200, 0,
                  0x20000500);
}
