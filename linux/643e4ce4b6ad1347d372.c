...
// https://syzkaller.appspot.com/bug?id=643e4ce4b6ad1347d372
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    *(uint64_t*)0x20000528 = 0x1e4;
    *(uint64_t*)0x20000530 = 0;
    *(uint64_t*)0x20000538 = 0;
    *(uint64_t*)0x20000540 = 0x600;
    *(uint64_t*)0x20000548 = 0;
    *(uint64_t*)0x20000550 = 0;
    *(uint64_t*)0x20000558 = 0x1000;
    syz_mount_image(0x20000000, 0x200001c0, 0, 4, 0x20000500, 0, 0x20010d00);
    break;
  case 1:
  ...
  case 2:
    ...
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20001580ul, 0x121a02ul,
                  0ul);
    if (res != -1)
      r[0] = res;
    break;
  case 3:
    sprintf((char*)0x20000000, "0x%016llx", (long long)0x905);
    syscall(__NR_write, r[0], 0x20000000ul, 0x2000fdeful);
    break;
  case 4:
  ...
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_sendfile, r[2], r[1], 0ul, 0xfffffffeul);
    break;
  }
}
int main(void)
