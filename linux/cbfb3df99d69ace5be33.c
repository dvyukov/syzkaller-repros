// general protection fault in hsr_dev_change_mtu (2)
// https://syzkaller.appspot.com/bug?id=cbfb3df99d69ace5be33
// status:0
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x20000040, "batadv0\000\000\000\000\000\000\000\000\000", 16);
  res = syscall(__NR_ioctl, r[0], 0x8933, 0x20000040ul);
  if (res != -1)
    r[1] = *(uint32_t*)0x20000050;
  res = syscall(__NR_socket, 0xaul, 5ul, 0);
  if (res != -1)
    r[2] = res;
  *(uint32_t*)0x20000040 = 0xd3;
  syscall(__NR_setsockopt, r[2], 0, 8, 0x20000040ul, 4ul);
  *(uint32_t*)0x20000340 = 0xc;
  res = syscall(__NR_getsockopt, r[2], 0, 8, 0x200003c0ul, 0x20000340ul);
  if (res != -1)
    r[3] = *(uint32_t*)0x200003c0;
  ...
  *(uint16_t*)0x20000306 = 0xff0f;
  *(uint32_t*)0x20000308 = 0x4c706;
  ...
  *(uint16_t*)0x20000326 = 1;
  memcpy((void*)0x20000328, "hsr\000", 4);
  ...
  *(uint32_t*)0x20000334 = r[1];
  *(uint16_t*)0x20000338 = 8;
  *(uint16_t*)0x2000033a = 2;
  *(uint32_t*)0x2000033c = r[3];
  ...
  *(uint64_t*)0x20000610 = 0x20000040;
  *(uint64_t*)0x20000040 = 0x200005c0;
  memcpy((void*)0x200005c0, "\x2e\x00\x00\x00\x10\x00\x81\x88\x04\x0f\x80\xec"
                            "\x59\xac\xbc\x04\x13\xa1\xf8\x48\x45\x00\x00\x00"
                            "\xe3\xbd\x6e\xfb\x44\x0e\x09\x00\x0e\x00\x0a\x00"
                            "\x0f\x00\x00\x00\x02\x80\x00\x00\x12\x1f",
         46);
  ...
  *(uint32_t*)0x20000630 = 0;
  syscall(__NR_sendmsg, r[4], 0x20000600ul, 0ul);
}
int main(void)
{
