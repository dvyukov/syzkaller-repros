...
// https://syzkaller.appspot.com/bug?id=0d421618746e37d0559c
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    *(uint64_t*)0x20001690 = 0x20000240;
    ...
    *(uint32_t*)0x200016b8 = 0;
    syscall(__NR_recvmmsg, -1, 0x20001680ul, 1ul, 0ul, 0ul);
    break;
  case 1:
    res = syscall(__NR_socketpair, 1ul, 2ul, 0, 0x200001c0ul);
    if (res != -1)
  ...
  case 2:
    ...
    break;
  case 3:
    memcpy((void*)0x20004d00, "rdma.current\000", 13);
    syscall(__NR_openat, -1, 0x20004d00ul, 0ul, 0ul);
    break;
  case 4:
    syscall(__NR_fork);
    break;
  case 5:
    ...
    break;
  case 6:
    memcpy((void*)0x20004d40, "./file0\000", 8);
    syscall(__NR_lstat, 0x20004d40ul, 0x20004d80ul);
    break;
  case 7:
  ...
  case 9:
    ...
    break;
  case 10:
    syscall(__NR_sendmmsg, r[0], 0x200bd000ul, 0x318ul, 0ul);
    break;
  }
}
int main(void)
