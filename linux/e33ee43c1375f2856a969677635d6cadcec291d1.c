// KASAN: use-after-free Read in __pm_runtime_resume
// https://syzkaller.appspot.com/bug?id=e33ee43c1375f2856a969677635d6cadcec291d1
// status:dup
...
void execute_one(void)
{
  ...
  *(uint16_t*)0x20000148 = 0x46d;
  *(uint16_t*)0x2000014a = 0xc219;
  *(uint16_t*)0x2000014c = 0x40;
  ...
  *(uint16_t*)0x2000016b = 1;
  *(uint8_t*)0x2000016d = 9;
  *(uint8_t*)0x2000016e = 5;
  *(uint8_t*)0x2000016f = 0x81;
  *(uint8_t*)0x20000170 = 3;
  *(uint16_t*)0x20000171 = 0;
  ...
  *(uint16_t*)0x2000017a = 0x2cc;
  *(uint8_t*)0x2000017c = 0x7e;
  *(uint8_t*)0x2000017d = 0x1f;
  *(uint8_t*)0x2000017e = 1;
  res = syz_usb_connect(0, 0x3f, 0x20000140, 0);
  if (res != -1)
    r[0] = res;
  syz_usb_control_io(r[0], 0, 0);
  *(uint32_t*)0x20002e80 = 0xfffffcb3;
  *(uint64_t*)0x20002e84 = 0;
  *(uint64_t*)0x20002e8c = 0;
  *(uint64_t*)0x20002e94 = 0;
  *(uint64_t*)0x20002e9c = 0x20000000;
  *(uint8_t*)0x20000000 = 0;
  *(uint8_t*)0x20000001 = 0x22;
  *(uint32_t*)0x20000002 = 2;
  *(uint8_t*)0x20000006 = 0;
  *(uint8_t*)0x20000007 = 0x29;
  *(uint8_t*)0x20000008 = 0;
  *(uint16_t*)0x20000009 = 0;
  *(uint8_t*)0x2000000b = 0;
  *(uint8_t*)0x2000000c = 0;
  memcpy((void*)0x2000000d, "\000\000\000\000", 4);
  memcpy((void*)0x20000011, "\000\000\000\000", 4);
  *(uint64_t*)0x20002ea4 = 0;
  *(uint32_t*)0x20003640 = 0xcc;
  *(uint64_t*)0x20003644 = 0;
  *(uint64_t*)0x2000364c = 0;
  *(uint64_t*)0x20003654 = 0;
  *(uint64_t*)0x2000365c = 0;
  *(uint64_t*)0x20003664 = 0;
  *(uint64_t*)0x2000366c = 0;
  *(uint64_t*)0x20003674 = 0;
  *(uint64_t*)0x2000367c = 0;
  *(uint64_t*)0x20003684 = 0;
  *(uint64_t*)0x2000368c = 0;
  *(uint64_t*)0x20003694 = 0;
  *(uint64_t*)0x2000369c = 0;
  *(uint64_t*)0x200036a4 = 0;
  *(uint64_t*)0x200036ac = 0;
  *(uint64_t*)0x200036b4 = 0;
  *(uint64_t*)0x200036bc = 0;
  *(uint64_t*)0x200036c4 = 0;
  *(uint64_t*)0x200036cc = 0;
  *(uint64_t*)0x200036d4 = 0;
  *(uint64_t*)0x200036dc = 0;
  *(uint64_t*)0x200036e4 = 0;
  syz_usb_control_io(r[0], 0x20002e80, 0x20003640);
  memcpy((void*)0x20000000, "/dev/hidraw#\000", 13);
  syz_open_dev(0x20000000, 0, 0x2040);
}
int main(void)
{
