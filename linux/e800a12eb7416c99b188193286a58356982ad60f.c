// KMSAN: uninit-value in __crc32c_pcl_intel_finup
// https://syzkaller.appspot.com/bug?id=e800a12eb7416c99b188193286a58356982ad60f
// status:invalid
...
void loop()
{
  ...
  if (res != -1)
    r[0] = res;
  *(uint16_t*)0x20b48000 = 0x26;
  memcpy((void*)0x20b48002,
         "\x68\x61\x73\x68\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", 14);
  *(uint32_t*)0x20b48010 = 0;
  *(uint32_t*)0x20b48014 = 0;
  memcpy((void*)0x20b48018,
         "\x63\x72\x63\x33\x32\x63\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
         "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
         "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
         "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
         64);
  syscall(__NR_bind, r[0], 0x20b48000, 0x58);
  ...
  if (res != -1)
    r[2] = res;
  syscall(__NR_fallocate, r[2], 0, 0, 0x1ff);
  *(uint64_t*)0x20000240 = 0x13;
  syscall(__NR_sendfile, r[1], r[2], 0x20000240, 6);
}
