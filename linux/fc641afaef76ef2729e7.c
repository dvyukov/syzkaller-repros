// INFO: task hung in blkdev_get
// https://syzkaller.appspot.com/bug?id=fc641afaef76ef2729e7
// status:0
...
{
  NONFAILING(syz_read_part_table(0xd103, 0, 0));
  NONFAILING(memcpy((void*)0x20000000, "./file0\000", 8));
  syscall(__NR_mknod, 0x20000000ul, 0x6000ul, 0x701 + procid * 2);
  NONFAILING(memcpy((void*)0x20000080, "./file0", 7));
  NONFAILING(memcpy((void*)0x20000140, "./file0\000", 8));
  NONFAILING(memcpy((void*)0x20000040, "udf\000", 4));
  syscall(__NR_mount, 0x20000080ul, 0x20000140ul, 0x20000040ul, 0ul, 0ul);
}
int main(void)
{
