  ...
  case 2:
    ...
    *(uint64_t*)0x20000200 = 0x20010000;
    memcpy((void*)0x20010000,
           "\x00\x08\x00\x00\xec\x05\x00\x00\x13\x02\x00\x00\x12\x00\x00\x00"
           "\x00\x00\x00\x00\x00\x02\x00\x00\x00\x01\x00\x00\xba\x55\x39\x4c"
           ...
           "\x03\x00\x00\x00\x02\x00\x01\x00\x02",
           73);
    ...
    *(uint64_t*)0x20000248 = 0x20011400;
    *(uint64_t*)0x20000250 = 0;
    *(uint64_t*)0x20000258 = 0x213fa0;
    *(uint8_t*)0x20011500 = 0;
    syz_mount_image(0x20000000, 0x20000100, 0x800000, 4, 0x20000200, 0,
                    0x20011500);
    break;
  case 3:
    memcpy((void*)0x20000300,
           ...
           "\x73",
           97);
    syscall(__NR_write, r[0], 0x20000300, 0x61);
    break;
  case 4:
    *(uint64_t*)0x20000040 = 0;
    syscall(__NR_sendfile, r[0], r[0], 0x20000040, 0x7527fb3200000000);
    break;
  case 5:
