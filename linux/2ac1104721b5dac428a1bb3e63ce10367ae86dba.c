...
// https://syzkaller.appspot.com/bug?id=2ac1104721b5dac428a1bb3e63ce10367ae86dba
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    *(uint64_t*)0x200003a8 = 0;
    syscall(__NR_ioctl, r[0], 0xc0306201, 0x20000380);
    break;
  }
}
int main(void)
