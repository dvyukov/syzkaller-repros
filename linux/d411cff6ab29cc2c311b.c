...
// https://syzkaller.appspot.com/bug?id=d411cff6ab29cc2c311b
// status:6
...
void execute_one(void)
{
  ...
  *(uint16_t*)0x20000026 = 1;
  memcpy((void*)0x20000028, "atm\000", 4);
  ...
  *(uint32_t*)0x20000230 = 0;
  ...
  if (res != -1)
    r[4] = res;
  inject_fault(16);
  syscall(__NR_sendmmsg, r[4], 0x20000200ul, 0x10efe10675dec16ul, 0ul);
}
int main(void)
{
