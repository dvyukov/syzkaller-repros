...
// https://syzkaller.appspot.com/bug?id=4c004c5495e2eea0408ac9f131a8204379aeeba8
// status:invalid
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x200000c0, "/dev/net/tun", 13));
  ...
  case 8:
    ...
    syscall(__NR_setsockopt, r[2], 0x107, 7, 0x20000080, 4);
    break;
  case 9:
    NONFAILING(memcpy((void*)0x20000280,
                      "\x00\x03\x00\x00\x08\x00\x00\x00\x00\x00\x60\xce\x38\x45"
                      "\x00\x14\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                      "\x00\x00\x00\x00\x00\x00\xfe\x80\x00\x00\x00\x00\x00\x00"
                      "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
                      54));
    NONFAILING(*(uint32_t*)0x200002b6 = 0x41424344);
    NONFAILING(*(uint32_t*)0x200002ba = 0x41424344);
    NONFAILING(memcpy((void*)0x200002be,
                      "\x69\x9e\xf4\x47\x0c\xea\x84\xce\xd6\x5b\x50", 11));
    syscall(__NR_write, r[1], 0x20000280, 4);
    break;
  }
}
