// memory leak in __build_skb
// https://syzkaller.appspot.com/bug?id=ebe9c5fcdf558afb5a7e7e3940019a07103897b1
// status:invalid
...
{
  *(uint8_t*)0x20000180 = 0xaa;
  *(uint8_t*)0x20000181 = 0xaa;
  *(uint8_t*)0x20000182 = 0xaa;
  *(uint8_t*)0x20000183 = 0xaa;
  *(uint8_t*)0x20000184 = 0xaa;
  *(uint8_t*)0x20000185 = 0xaa;
  ...
  *(uint16_t*)0x2000018c = htobe16(0x86dd);
  STORE_BY_BITMASK(uint8_t, , 0x2000018e, 0, 0, 4);
  STORE_BY_BITMASK(uint8_t, , 0x2000018e, 6, 4, 4);
  memcpy((void*)0x2000018f, "\xd8\x65\x2b", 3);
  *(uint16_t*)0x20000192 = htobe16(0x14);
  *(uint8_t*)0x20000194 = 0x2c;
  *(uint8_t*)0x20000195 = 0;
  *(uint8_t*)0x20000196 = 0xfe;
  *(uint8_t*)0x20000197 = 0x80;
  ...
  *(uint8_t*)0x200001a6 = 0xfe;
  *(uint8_t*)0x200001a7 = 0x80;
  ...
  *(uint8_t*)0x200001b5 = 0xaa;
  *(uint16_t*)0x200001b6 = htobe16(0);
  *(uint16_t*)0x200001b8 = htobe16(0xfffe);
  *(uint32_t*)0x200001ba = 0x41424344;
  *(uint32_t*)0x200001be = 0x41424344;
  STORE_BY_BITMASK(uint8_t, , 0x200001c2, 0, 0, 1);
  STORE_BY_BITMASK(uint8_t, , 0x200001c2, 0, 1, 3);
  STORE_BY_BITMASK(uint8_t, , 0x200001c2, 5, 4, 4);
  *(uint8_t*)0x200001c3 = 0;
  *(uint16_t*)0x200001c4 = htobe16(0);
  *(uint16_t*)0x200001c6 = htobe16(0);
  *(uint16_t*)0x200001c8 = htobe16(0);
  struct csum_inet csum_1;
  csum_inet_init(&csum_1);
  csum_inet_update(&csum_1, (const uint8_t*)0x20000196, 16);
  csum_inet_update(&csum_1, (const uint8_t*)0x200001a6, 16);
  ...
  csum_inet_update(&csum_1, (const uint8_t*)0x200001b6, 20);
  *(uint16_t*)0x200001c6 = csum_inet_digest(&csum_1);
  syz_emit_ethernet(0x4a, 0x20000180, 0);
}
int main(void)
{
