...
// https://syzkaller.appspot.com/bug?id=ab00de412848eb7414ef83d4139d21a91f09c96d
// status:open
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    NONFAILING(*(uint32_t*)0x20000140 = 5);
    NONFAILING(*(uint32_t*)0x20000144 = 5);
    ...
    res = syscall(__NR_ioctl, r[0], 0xc02064b2ul, 0x20000140ul);
    if (res != -1)
      NONFAILING(r[1] = *(uint32_t*)0x20000150);
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x200001c0 = r[1]);
    syscall(__NR_ioctl, r[0], 0xc00464b4ul, 0x200001c0ul);
    break;
  }
}
int main(void)
