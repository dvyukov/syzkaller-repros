...
// https://syzkaller.appspot.com/bug?id=671808ee0357bad4ecc810b476cb414d3ab001ac
// status:open
...
void execute_call(int call)
{
  ...
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_recvmmsg, -1, 0ul, 0ul, 0x10000ul, 0ul);
    break;
  case 6:
    syscall(__NR_mkdir, 0ul, 0ul);
    break;
  case 7:
    syscall(__NR_preadv, -1, 0ul, 0x145ul, 4ul);
    break;
  case 8:
    syscall(__NR_fsetxattr, -1, 0ul, 0ul, 0ul, 0ul);
    break;
  case 9:
    syscall(__NR_getsockopt, -1, 0ul, 0x24ul, 0ul, 0ul);
    break;
  case 10:
    syscall(__NR_perf_event_open, 0ul, 0, 0ul, -1, 0ul);
    break;
  case 11:
    syscall(__NR_ioctl, -1, 0x401070cdul, 0ul);
    break;
  case 12:
  ...
  case 16:
    ...
    *(uint64_t*)0x20000108 = 0x209ff000;
    memcpy((void*)0x209ff000, "\x18\x00\x00\x00\x03\x00\x00\x00\x00\x00\x00\x00"
                              "\x00\xa5\x00\x00\x95\x00\x2b\x00\x00\x00\x00"
                              "\x00",
           24);
  ...
  case 17:
    ...
    break;
  case 18:
    syscall(__NR_recvmmsg, r[2], 0x20003540ul, 0x400000000000310ul, 0ul, 0ul);
    break;
  case 19:
    *(uint32_t*)0x2031aff8 = r[0];
    *(uint32_t*)0x2031affc = r[1];
    syscall(__NR_ioctl, r[2], 0x89e0ul, 0x2031aff8ul);
    break;
  case 20:
    *(uint64_t*)0x20002940 = 0;
    *(uint32_t*)0x20002948 = 0;
    *(uint64_t*)0x20002950 = 0x20002800;
    *(uint64_t*)0x20002800 = 0x200004c0;
    *(uint64_t*)0x20002808 = 0x1000;
  ...
  case 21:
    *(uint32_t*)0x20000300 = 0x80;
    syscall(__NR_setsockopt, r[2], 0x119ul, 1ul, 0x20000300ul, 4ul);
    break;
  }
}
int main(void)
