// WARNING: stack going in the wrong direction? ip=__schedule (2)
// https://syzkaller.appspot.com/bug?id=077a02ca1d0305162fc2
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000080, "/proc/vmallocinfo\000", 18));
  ...
  case 5:
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0x40000, 35, 1));
  ...
  case 11:
    NONFAILING(memcpy((void*)0x20000200, "./bus\000", 6));
    syscall(__NR_chdir, 0x20000200ul);
    break;
  case 12:
    NONFAILING(*(uint64_t*)0x20001b00 = 0x20000680);
    NONFAILING(*(uint64_t*)0x20001b08 = 0x56);
    syscall(__NR_preadv, -1, 0x20001b00ul, 1ul, 0, 0);
    break;
  case 13:
    NONFAILING(memcpy((void*)0x20000000, "stack\000", 6));
    res = -1;
