...
// https://syzkaller.appspot.com/bug?id=b3b63b6bff456bd95294
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint64_t*)0x2001d010 = 0x41c4);
    ...
    NONFAILING(*(uint64_t*)0x2001d048 = 0x2000);
    NONFAILING(*(uint64_t*)0x2001d050 = 0);
    NONFAILING(*(uint32_t*)0x2001d058 = 0x1000);
    NONFAILING(*(uint32_t*)0x2001d05c = 3);
  ...
  case 1:
    ...
    NONFAILING(STORE_BY_BITMASK(uint32_t, , 0x200001c8, 0, 0, 1));
    NONFAILING(
    ...
    syscall(__NR_ioctl, -1, 0xc08c5332, 0x200001c0ul);
    break;
  case 2:
    syscall(__NR_write, -1, 0x20000380ul, 0ul);
    break;
  case 3:
    ...
    NONFAILING(*(uint32_t*)0x20000054 = 0x1d84);
    syscall(__NR_ioctl, -1, 0x40184810, 0x20000040ul);
    break;
  case 4:
  ...
  case 5:
    ...
    syscall(__NR_sched_setscheduler, r[0], 5ul, 0x200002c0ul);
    break;
  case 6:
    syscall(__NR_write, -1, 0ul, 0x1acul);
    break;
  case 7:
    ...
    syscall(__NR_write, -1, 0x20000280ul, 0x18ul);
    break;
  case 8:
    syscall(__NR_ioctl, -1, 0x40445637, 0ul);
    break;
  case 9:
    syscall(__NR_clone, 0xe900e57cul, 0ul, 0x9999999999999999ul, 0ul, -1ul);
    break;
  case 10:
    syscall(__NR_ioctl, -1, 0xc058534f, 0ul);
    break;
  case 11:
  ...
  case 12:
    ...
    syscall(__NR_ioctl, r[1], 0xc0206434, 0x20000180ul);
    break;
  }
}
int main(void)
