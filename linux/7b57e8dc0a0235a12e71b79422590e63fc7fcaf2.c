...
// https://syzkaller.appspot.com/bug?id=7b57e8dc0a0235a12e71b79422590e63fc7fcaf2
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    res = syscall(__NR_socket, 0xaul, 0x80000ul, 0x84);
    if (res != -1)
      r[1] = res;
    break;
  case 3:
    NONFAILING(*(uint16_t*)0x20000040 = 0xa);
    NONFAILING(*(uint16_t*)0x20000042 = htobe16(0x4e21));
    ...
    break;
  case 4:
    syscall(__NR_setsockopt, r[1], 0x29ul, 0x43ul, 0ul, 0ul);
    break;
  case 5:
    ...
    break;
  case 6:
    res = syscall(__NR_socket, 0x18ul, 1ul, 1ul);
    if (res != -1)
      r[3] = res;
    break;
  case 7:
    NONFAILING(*(uint16_t*)0x200001c0 = 0x18);
    NONFAILING(*(uint32_t*)0x200001c2 = 1);
    NONFAILING(*(uint32_t*)0x200001c6 = 0);
    NONFAILING(*(uint32_t*)0x200001ca = r[2]);
    NONFAILING(*(uint16_t*)0x200001ce = 4);
    NONFAILING(*(uint16_t*)0x200001d0 = 0);
    NONFAILING(*(uint16_t*)0x200001d2 = 0);
    NONFAILING(*(uint16_t*)0x200001d4 = 0);
    NONFAILING(*(uint16_t*)0x200001d6 = 0xa);
    NONFAILING(*(uint16_t*)0x200001d8 = htobe16(0));
    NONFAILING(*(uint32_t*)0x200001da = htobe32(0));
    ...
    NONFAILING(*(uint32_t*)0x200001ee = 0);
    syscall(__NR_connect, r[3], 0x200001c0ul, 0x32ul);
    break;
  case 8:
    ...
    syscall(__NR_bind, r[2], 0x20000000ul, 0x1cul);
    break;
  case 9:
    syscall(__NR_setsockopt, r[2], 0x29ul, 0x3bul, 0x20000080ul, 1ul);
    break;
  case 10:
