...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000080, "./file0/file0", 14));
    NONFAILING(memcpy((void*)0x20000040, "bpf ", 4));
    syscall(__NR_mount, 0, 0x20000080, 0x20000040, 0, 0x20000500);
    break;
  case 3:
    NONFAILING(*(uint32_t*)0x20000000 = 0x12);
    NONFAILING(*(uint32_t*)0x20000004 = 8);
    NONFAILING(*(uint64_t*)0x20000008 = 0x20000140);
    NONFAILING(memcpy(
        (void*)0x20000140,
        "\x7a\x0a\xf8\xff\x00\x00\x00\x00\xbf\xa1\x00\x00\x00\x00\x00\x00\x07"
        "\x01\x00\x00\xf8\xff\xff\xff\xb7\x02\x00\x00\x08\x00\x00\x00\xbd\x12"
    ...
    NONFAILING(*(uint32_t*)0x20000044 = 0xa);
    syscall(__NR_bpf, 5, 0x20000000, 0x48);
    break;
  case 4:
    NONFAILING(*(uint64_t*)0x20002180 = 0x20000b40);
    NONFAILING(*(uint32_t*)0x20002188 = 0x80);
    NONFAILING(*(uint64_t*)0x20002190 = 0x20002000);
    NONFAILING(*(uint64_t*)0x20002000 = 0x20000bc0);
    NONFAILING(*(uint64_t*)0x20002008 = 0x90);
    NONFAILING(*(uint64_t*)0x20002010 = 0x20001f00);
    NONFAILING(*(uint64_t*)0x20002018 = 0xf5);
    NONFAILING(*(uint64_t*)0x20002198 = 2);
    NONFAILING(*(uint64_t*)0x200021a0 = 0x20002080);
    NONFAILING(*(uint64_t*)0x200021a8 = 0xe0);
    NONFAILING(*(uint32_t*)0x200021b0 = 0);
    syscall(__NR_recvmsg, 0xffffff9c, 0x20002180, 0x2021);
    break;
  }
}
int main(void)
