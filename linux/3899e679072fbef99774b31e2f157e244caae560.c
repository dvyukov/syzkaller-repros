...
// https://syzkaller.appspot.com/bug?id=3899e679072fbef99774b31e2f157e244caae560
// status:open
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    syscall(__NR_getpeername, r[0], 0, 0x200000c0);
    break;
  case 4:
  ...
  case 6:
    ...
    syscall(__NR_sched_setscheduler, r[1], 5, 0x20000040);
    break;
  case 7:
    NONFAILING(memcpy((void*)0x20000440, "./file1\000", 8));
    syscall(__NR_mkdir, 0x20000440, 0);
    break;
  case 8:
    NONFAILING(memcpy((void*)0x20000040, "./file0/f.le.\000", 14));
    NONFAILING(memcpy((void*)0x20000140, ".//ile0\000", 8));
    syscall(__NR_symlink, 0x20000040, 0x20000140);
    break;
  case 9:
  ...
  case 11:
    ...
    break;
  case 12:
    NONFAILING(memcpy((void*)0x20000240, ".//ile0\000", 8));
    NONFAILING(memcpy((void*)0x200007c0, "./file0/f.le.\000", 14));
    syscall(__NR_renameat, r[2], 0x20000240, r[2], 0x200007c0);
    break;
  }
}
int main(void)
