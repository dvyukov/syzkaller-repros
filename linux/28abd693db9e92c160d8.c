...
// https://syzkaller.appspot.com/bug?id=28abd693db9e92c160d8
// status:0
...
uint64_t r[7] = {
    0xffffffffffffffff, 0x0, 0x0, 0xffffffffffffffff, 0xffffffffffffffff,
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_perf_event_open, 0ul, -1, 8ul, -1, 8ul);
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000340, "/dev/audio1\000", 12));
    syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000340ul, 0x1c9402ul, 0ul);
    break;
  case 2:
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2001d028, 1, 5, 1));
    ...
    NONFAILING(*(uint64_t*)0x2001d050 = 0x2000);
  ...
  case 3:
    ...
    res = -1;
    NONFAILING(res = syz_io_uring_setup(0x87, 0x20000080, 0x20ee7000,
                                        0x206d4000, 0x20000000, 0x20000040));
    if (res != -1) {
      r[0] = res;
    ...
    break;
  case 4:
    res = syscall(__NR_socket, 2ul, 1ul, 0x84);
    if (res != -1)
      r[3] = res;
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20000100, "/dev/null\000", 10));
    res =
        syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000100ul, 0x8800ul, 0ul);
    if (res != -1)
      r[4] = res;
    break;
  case 6:
  ...
  case 7:
    NONFAILING(memcpy((void*)0x20000000,
                      "ip6gre0\000\000\000\000\000\000\000\000\000", 16));
    NONFAILING(*(uint64_t*)0x20000010 = 0x200001c0);
    NONFAILING(memcpy((void*)0x200001c0,
                      "\x1a\x61\x4b\xea\xb7\x60\x00\x00\x36\xc6\x4b\x2f\x76\x92"
                      "\x2a\xa4\x74\x1c\xa6\xdd\x05\x21\x00\x00\x00\x00\xff\xff"
                      "\x2e\x41\xba\xc8\xd1\xe8\x3e\xcf\x8c\x0d\x08\x79\xd3\x0a"
                      "\x8e\xfc\x06\x85\x00\x00\xff\xff\xff\xe9",
                      52));
    syscall(__NR_ioctl, r[5], 0x89f1, 0x20000000ul);
    break;
  case 8:
    res = -1;
    ...
    break;
  case 9:
    NONFAILING(*(uint64_t*)0x20000100 = 0x20000240);
    NONFAILING(*(uint16_t*)0x20000240 = 0x10);
    NONFAILING(*(uint16_t*)0x20000242 = 0);
    NONFAILING(*(uint32_t*)0x20000244 = 0);
    NONFAILING(*(uint32_t*)0x20000248 = 0xd490010);
    NONFAILING(*(uint32_t*)0x20000108 = 0xc);
    ...
    NONFAILING(*(uint32_t*)0x20000130 = 0x4c051);
    syscall(__NR_sendmsg, r[5], 0x20000100ul, 1ul);
    break;
  case 10:
    NONFAILING(*(uint64_t*)0x200002c0 = 0);
    NONFAILING(*(uint32_t*)0x200002c8 = 0);
    NONFAILING(*(uint64_t*)0x200002d0 = 0x20000180);
    NONFAILING(*(uint64_t*)0x20000180 = 0x20000980);
    NONFAILING(memcpy(
        (void*)0x20000980,
        "\x9f\x89\x7f\x86\x1f\x8c\xeb\x54\x48\x7d\xa5\xa9\x8d\xf1\x8d\x32\xf1"
        "\xbf\x7f\xa3\xc4\xb3\xfb\x5a\x2b\xf4\x07\xd8\x01\x22\x9f\x7f\x67\x00"
        "\x00\x00\x00\x00\x00\x00\x00\x00\x6c\x3d\xa4\xb3\x8d\x39\xef\xc6\xff"
        "\x18\xc4\xbf\x71\x10\xea\x46\xae\x54\x51\x1b\x52\xaa\x9c\x16\x94\xc5"
        "\x18\xd8\xfa\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
        84));
    NONFAILING(*(uint16_t*)0x200009d4 = r[6]);
    NONFAILING(memcpy(
        (void*)0x200009d6,
        "\x00\x02\x2a\xbd\x70\x00\xfd\xdb\xdf\x25\x3f\xcc\x64\x2f\x02\x00\x00"
        "\x00\x2b\x3c\xf7\xb0\xd0\x44\xf1\x4d\x88\x00\x05\x00\x03\x00\x00\x00"
        "\x44\x00\x03\x5f\x31\x00\x00\x00\x00\x06\x00\x04\x00\x07\x00\x00\x00"
        "\x06\x00\x07\x00\x4e\x08\x00\x01\x00\x00\x00\x14\x00\x06\x05\x00\x00"
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x20\x00\x03"
        "\x81\x08\x00\x05\x00\x7f\x00\x00\x01\x14\x00\x02\x00\x6d\x61\x63\x73"
        "\x65\x63\x30\x00\x00\x00\x00\x00\x00\x00\x00\x00\x08\xba\x72\x00\xa8"
        "\x0a\x00\x00\x00\x00\x00\x00\x00",
        127));
    NONFAILING(*(uint64_t*)0x20000188 = 0x90);
    NONFAILING(*(uint64_t*)0x200002d8 = 1);
    NONFAILING(*(uint64_t*)0x200002e0 = 0);
    NONFAILING(*(uint64_t*)0x200002e8 = 0);
    NONFAILING(*(uint32_t*)0x200002f0 = 0x20004801);
    syscall(__NR_sendmsg, r[4], 0x200002c0ul, 0ul);
    break;
  case 11:
    ...
    NONFAILING(*(uint32_t*)0x20000084 = 0);
    NONFAILING(*(uint32_t*)0x20000088 = 0x80000000);
    NONFAILING(*(uint32_t*)0x200001c8 = 0xc);
    NONFAILING(*(uint64_t*)0x200001d0 = 0x20000180);
    NONFAILING(*(uint64_t*)0x20000180 = 0x20000100);
    NONFAILING(memcpy((void*)0x20000100, "\xa1\x6e\x02\xb3", 4));
    NONFAILING(*(uint16_t*)0x20000104 = r[6]);
    ...
    NONFAILING(*(uint32_t*)0x200001f0 = 0x4004001);
    syscall(__NR_sendmsg, -1, 0x200001c0ul, 0x24000000ul);
    break;
  case 12:
    NONFAILING(*(uint64_t*)0x20000140 = 0x20000000);
    ...
    NONFAILING(*(uint32_t*)0x20000148 = 0xc);
    NONFAILING(*(uint64_t*)0x20000150 = 0x200000c0);
    NONFAILING(*(uint64_t*)0x200000c0 = 0x20000900);
    NONFAILING(*(uint16_t*)0x20000900 = r[6]);
    NONFAILING(
        memcpy((void*)0x20000902,
               "\x08\x00\x28\xbd\x70\x00\xfe\xdb\xc4\x24\x7b\xdf\x25\xe6\xff"
               "\xff\xff\x07\x00\x04\x00\x01\x80\x08\x00\x0b\x00\x73\x69\x50"
               "\x00\x08\x00\x08\x00\x06\x00\x00\x00\x07\x00\x06\x00\x73\x68"
               "\x00\x00\x08\x00\x04\x00\x91\xfd\x00\x00\x21\x82\x08\x00\x04"
               "\x00\x08\x00\x00\x00\x10\x00\x01\x80\x0c\x00\x07\x00\x02\x00"
               "\x00\x00\x00\x00\x00\x00\x04\x00\x03\x80\x08\x00\x05\x00\x18"
               "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
               105));
    NONFAILING(*(uint64_t*)0x200000c8 = 0x6c);
    NONFAILING(*(uint64_t*)0x20000158 = 1);
    NONFAILING(*(uint64_t*)0x20000160 = 0);
    NONFAILING(*(uint64_t*)0x20000168 = 0);
    NONFAILING(*(uint32_t*)0x20000170 = 0x800);
    syscall(__NR_sendmsg, -1, 0x20000140ul, 0x40841ul);
    break;
  case 13:
    NONFAILING(*(uint64_t*)0x200000c0 = 0x20000040);
    ...
    NONFAILING(*(uint64_t*)0x20000088 = 0x16c);
    NONFAILING(*(uint64_t*)0x200000d8 = 1);
    NONFAILING(*(uint64_t*)0x200000e0 = 0);
    NONFAILING(*(uint64_t*)0x200000e8 = 0);
    NONFAILING(*(uint32_t*)0x200000f0 = 0x24040040);
    syscall(__NR_sendmsg, -1, 0x200000c0ul, 0x88a1ul);
    break;
  case 14:
    NONFAILING(*(uint64_t*)0x20000400 = 0x20000240);
    NONFAILING(*(uint16_t*)0x20000240 = 0x10);
    NONFAILING(*(uint16_t*)0x20000242 = 0);
    NONFAILING(*(uint32_t*)0x20000244 = 0);
    NONFAILING(*(uint32_t*)0x20000248 = 0x100000);
    NONFAILING(*(uint32_t*)0x20000408 = 0xc);
    NONFAILING(*(uint64_t*)0x20000410 = 0x200003c0);
    NONFAILING(*(uint64_t*)0x200003c0 = 0x20000640);
    NONFAILING(*(uint32_t*)0x20000640 = 0xbc);
    NONFAILING(*(uint16_t*)0x20000644 = r[6]);
    NONFAILING(*(uint16_t*)0x20000646 = 0x20);
    NONFAILING(*(uint32_t*)0x20000648 = 0x70bd27);
    NONFAILING(*(uint32_t*)0x2000064c = 0x25dfdbfc);
    NONFAILING(*(uint8_t*)0x20000650 = 5);
    NONFAILING(*(uint8_t*)0x20000651 = 0);
    NONFAILING(*(uint16_t*)0x20000652 = 0);
    NONFAILING(*(uint16_t*)0x20000654 = 0x60);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000656, 3, 0, 14));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000657, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000657, 1, 7, 1));
    NONFAILING(*(uint16_t*)0x20000658 = 0x14);
    NONFAILING(*(uint16_t*)0x2000065a = 6);
    NONFAILING(*(uint64_t*)0x2000065c = htobe64(0));
    NONFAILING(*(uint64_t*)0x20000664 = htobe64(1));
    NONFAILING(*(uint16_t*)0x2000066c = 0x14);
    NONFAILING(*(uint16_t*)0x2000066e = 6);
    NONFAILING(*(uint8_t*)0x20000670 = 0);
    NONFAILING(*(uint8_t*)0x20000671 = 0);
    NONFAILING(*(uint8_t*)0x20000672 = 0);
    NONFAILING(*(uint8_t*)0x20000673 = 0);
    NONFAILING(*(uint8_t*)0x20000674 = 0);
    NONFAILING(*(uint8_t*)0x20000675 = 0);
    NONFAILING(*(uint8_t*)0x20000676 = 0);
    NONFAILING(*(uint8_t*)0x20000677 = 0);
    NONFAILING(*(uint8_t*)0x20000678 = 0);
    NONFAILING(*(uint8_t*)0x20000679 = 0);
    NONFAILING(*(uint8_t*)0x2000067a = -1);
    NONFAILING(*(uint8_t*)0x2000067b = -1);
    NONFAILING(*(uint8_t*)0x2000067c = 0xac);
    NONFAILING(*(uint8_t*)0x2000067d = 0x14);
    NONFAILING(*(uint8_t*)0x2000067e = 0x14);
    NONFAILING(*(uint8_t*)0x2000067f = 0xbb);
    NONFAILING(*(uint16_t*)0x20000680 = 0x14);
    NONFAILING(*(uint16_t*)0x20000682 = 2);
    NONFAILING(memcpy((void*)0x20000684, "bridge_slave_1\000\000", 16));
    NONFAILING(*(uint16_t*)0x20000694 = 8);
    NONFAILING(*(uint16_t*)0x20000696 = 1);
    NONFAILING(*(uint32_t*)0x20000698 = 2);
    NONFAILING(*(uint16_t*)0x2000069c = 5);
    NONFAILING(*(uint16_t*)0x2000069e = 8);
    NONFAILING(*(uint8_t*)0x200006a0 = 0x80);
    NONFAILING(*(uint16_t*)0x200006a4 = 6);
    NONFAILING(*(uint16_t*)0x200006a6 = 7);
    NONFAILING(*(uint16_t*)0x200006a8 = htobe16(0x4e24));
    NONFAILING(*(uint16_t*)0x200006ac = 6);
    NONFAILING(*(uint16_t*)0x200006ae = 7);
    NONFAILING(*(uint16_t*)0x200006b0 = htobe16(0x4e20));
    NONFAILING(*(uint16_t*)0x200006b4 = 8);
    NONFAILING(*(uint16_t*)0x200006b6 = 6);
    NONFAILING(*(uint32_t*)0x200006b8 = 2);
    NONFAILING(*(uint16_t*)0x200006bc = 0x40);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200006be, 2, 0, 14));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200006bf, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200006bf, 1, 7, 1));
    NONFAILING(*(uint16_t*)0x200006c0 = 8);
    NONFAILING(*(uint16_t*)0x200006c2 = 4);
    NONFAILING(*(uint32_t*)0x200006c4 = 0x100);
    NONFAILING(*(uint16_t*)0x200006c8 = 8);
    NONFAILING(*(uint16_t*)0x200006ca = 6);
    NONFAILING(*(uint32_t*)0x200006cc = 4);
    NONFAILING(*(uint16_t*)0x200006d0 = 8);
    NONFAILING(*(uint16_t*)0x200006d2 = 5);
    NONFAILING(*(uint32_t*)0x200006d4 = 1);
    NONFAILING(*(uint16_t*)0x200006d8 = 5);
    NONFAILING(*(uint16_t*)0x200006da = 0xd);
    NONFAILING(*(uint8_t*)0x200006dc = 1);
    NONFAILING(*(uint16_t*)0x200006e0 = 8);
    NONFAILING(*(uint16_t*)0x200006e2 = 5);
    NONFAILING(*(uint32_t*)0x200006e4 = 0x8000002);
    NONFAILING(*(uint16_t*)0x200006e8 = 0x14);
    NONFAILING(*(uint16_t*)0x200006ea = 1);
    NONFAILING(*(uint32_t*)0x200006ec = htobe32(0x64010102));
    NONFAILING(*(uint64_t*)0x200003c8 = 0xbc);
    ...
    syscall(__NR_sendmsg, -1, 0x20000400ul, 0x24000080ul);
    break;
  case 15:
    NONFAILING(*(uint64_t*)0x20000280 = 0x20000180);
    NONFAILING(*(uint16_t*)0x20000180 = 0x10);
    NONFAILING(*(uint16_t*)0x20000182 = 0);
    NONFAILING(*(uint32_t*)0x20000184 = 0);
    NONFAILING(*(uint32_t*)0x20000188 = 0x10000000);
    NONFAILING(*(uint32_t*)0x20000288 = 0xc);
    NONFAILING(*(uint64_t*)0x20000290 = 0x20000240);
    NONFAILING(*(uint64_t*)0x20000240 = 0x200001c0);
    NONFAILING(*(uint32_t*)0x200001c0 = 0x24);
    NONFAILING(*(uint16_t*)0x200001c4 = r[6]);
    NONFAILING(*(uint16_t*)0x200001c6 = 2);
    NONFAILING(*(uint32_t*)0x200001c8 = 0x70bd29);
    NONFAILING(*(uint32_t*)0x200001cc = 0x25dfdbf9);
    ...
    NONFAILING(*(uint16_t*)0x200001d6 = 5);
    NONFAILING(*(uint32_t*)0x200001d8 = 0xe1df);
    NONFAILING(*(uint16_t*)0x200001dc = 8);
    NONFAILING(*(uint16_t*)0x200001de = 6);
    NONFAILING(*(uint32_t*)0x200001e0 = 7);
    NONFAILING(*(uint64_t*)0x20000248 = 0x24);
    ...
    syscall(__NR_sendmsg, -1, 0x20000280ul, 0x4000000ul);
    break;
  case 16:
    syscall(__NR_getsockopt, r[3], 0x84, 0xc, 0ul, 0ul);
    break;
  case 17:
