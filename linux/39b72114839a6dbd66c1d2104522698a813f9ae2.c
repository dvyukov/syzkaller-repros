...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x200005c0 = 0x8d);
    syscall(__NR_setsockopt, r[0], 1, 0x3f, 0x200005c0, 4);
    break;
  case 2:
    NONFAILING(*(uint16_t*)0x20000840 = 2);
    NONFAILING(*(uint16_t*)0x20000842 = htobe16(0));
    NONFAILING(*(uint32_t*)0x20000844 = htobe32(0x7f000001));
    syscall(__NR_bind, r[0], 0x20000840, 0x10);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000040, "nat\000\000\000\000\000\000\000\000"
    ...
    NONFAILING(*(uint32_t*)0x200000a0 = 1);
    NONFAILING(*(uint64_t*)0x200000a8 = 0x20000000);
    NONFAILING(*(uint64_t*)0x200000b0 = 0);
    NONFAILING(*(uint64_t*)0x200000b8 = 0);
    NONFAILING(*(uint64_t*)0x200000c0 = 0);
    syscall(__NR_setsockopt, -1, 0, 0x81, 0x20000040, 0x88);
    break;
  case 4:
    syscall(__NR_recvmmsg, r[0], 0x20000080, 0x400000000000085, 0, 0);
    break;
  case 5:
    NONFAILING(*(uint16_t*)0x2069affb = 2);
    NONFAILING(*(uint16_t*)0x2069affd = htobe16(0));
    NONFAILING(*(uint32_t*)0x2069afff = htobe32(0x7f000001));
    syscall(__NR_sendto, r[0], 0, 0, 0, 0x2069affb, 0x10);
    break;
  }
}
int main(void)
