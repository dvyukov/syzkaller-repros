...
// https://syzkaller.appspot.com/bug?id=569a9f38546d62a570d2
// status:2
...
void loop(void)
{
  ...
  *(uint32_t*)0x200002d8 = -1;
  ...
  res = -1;
  res = syz_io_uring_setup(0x387, 0x200002c0, 0x20ff9000, 0x205c0000,
