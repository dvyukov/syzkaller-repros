...
// https://syzkaller.appspot.com/bug?id=91525b2bd4b5dff71619
// status:6
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000600, "/dev/fb1\000", 9));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000600ul, 0ul, 0ul);
    if (res != -1)
      r[2] = res;
    break;
  case 5:
    syscall(__NR_mmap, 0x20000000ul, 0x800000ul, 0x1000006ul, 0x12ul, r[2],
            0ul);
    break;
  case 6:
    NONFAILING(*(uint16_t*)0x20000280 = 0xa);
    NONFAILING(*(uint16_t*)0x20000282 = htobe16(0x4e22));
    NONFAILING(*(uint32_t*)0x20000284 = htobe32(0));
    NONFAILING(*(uint64_t*)0x20000288 = htobe64(0));
    NONFAILING(*(uint64_t*)0x20000290 = htobe64(1));
    NONFAILING(*(uint32_t*)0x20000298 = 0);
    syscall(__NR_sendto, r[0], 0ul, 0ul, 0x20000004ul, 0x20000280ul, 0x1cul);
    break;
  case 7:
    syscall(__NR_mmap, 0x20166000ul, 0x2000ul, 0ul, 0x13ul, r[1], 0ul);
    break;
  case 8:
    syscall(__NR_sendto, r[0], 0ul, 0ul, 0xe00ul, 0ul, 0ul);
    break;
  }
}
int main(void)
