...
// https://syzkaller.appspot.com/bug?id=4ea78af6ad1c826a825b
// status:0
...
static void execute_one(void)
{
  ...
  for (call = 0; call < 37; call++) {
    for (thread = 0; thread < (int)(sizeof(threads) / sizeof(threads[0]));
      ...
      event_set(&th->ready);
      if (call == 19 || call == 20 || call == 21 || call == 22 || call == 23 ||
          call == 24 || call == 26 || call == 27 || call == 28 || call == 30 ||
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint32_t*)0x20000430 = 0x40000);
  ...
  case 2:
    ...
    break;
  case 3:
    NONFAILING(memcpy((void*)0x200000c0, "/proc/keys\000", 11));
  ...
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_sendfile, r[1], r[0], 0ul, 0x7ffff06cul);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000180, "./file0\000", 8));
    res = syscall(__NR_statx, r[0], 0x20000180ul, 0x4000ul, 6ul, 0x200001c0ul);
    if (res != -1)
      NONFAILING(r[2] = *(uint32_t*)0x200001d4);
    break;
  case 7:
    NONFAILING(memcpy((void*)0x20000040, "./file0\000", 8));
    NONFAILING(memcpy((void*)0x20000080, "security.capability\000", 20));
    NONFAILING(*(uint32_t*)0x200002c0 = 0x3000000);
    NONFAILING(*(uint32_t*)0x200002c4 = 0xfff);
    NONFAILING(*(uint32_t*)0x200002c8 = 8);
    NONFAILING(*(uint32_t*)0x200002cc = 3);
    NONFAILING(*(uint32_t*)0x200002d0 = 0);
    NONFAILING(*(uint32_t*)0x200002d4 = r[2]);
    syscall(__NR_lsetxattr, 0x20000040ul, 0x20000080ul, 0x200002c0ul, 0x18ul,
            3ul);
    break;
  case 8:
    syscall(__NR_sendmsg, -1, 0ul, 0x44805ul);
    break;
  case 9:
    syscall(__NR_fcntl, -1, 4ul, 0x2800ul);
    break;
  case 10:
    NONFAILING(memcpy((void*)0x20000040, "IPVS\000", 5));
    res = -1;
    NONFAILING(res = syz_genetlink_get_family_id(0x20000040, -1));
    if (res != -1)
      r[3] = res;
    break;
  case 11:
  ...
  case 12:
    ...
    break;
  case 13:
    NONFAILING(*(uint64_t*)0x20000580 = 0x20000440);
    NONFAILING(*(uint16_t*)0x20000440 = 0x10);
    NONFAILING(*(uint16_t*)0x20000442 = 0);
    NONFAILING(*(uint32_t*)0x20000444 = 0);
    NONFAILING(*(uint32_t*)0x20000448 = 0x400);
    NONFAILING(*(uint32_t*)0x20000588 = 0xc);
    ...
    NONFAILING(*(uint32_t*)0x200005b0 = 0x10);
    syscall(__NR_sendmsg, -1, 0x20000580ul, 0x40090ul);
    break;
  case 14:
    NONFAILING(memset((void*)0x200000c0, 139, 1));
    syscall(__NR_setsockopt, -1, 0x117, 1, 0x200000c0ul, 1ul);
    break;
  case 15:
    ...
    break;
  case 16:
    syscall(__NR_connect, r[5], 0ul, 0ul);
    break;
  case 17:
    NONFAILING(*(uint8_t*)0x200006c0 = 0);
    NONFAILING(*(uint8_t*)0x200006c1 = 0);
    NONFAILING(*(uint8_t*)0x200006c2 = 0);
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x200006c3, 0, 0, 1));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x200006c3, 0, 1, 2));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x200006c3, 0, 3, 5));
    NONFAILING(*(uint32_t*)0x200006c4 = 0);
    syscall(__NR_setsockopt, r[5], 0x29, 0, 0x200006c0ul, 8ul);
    break;
  case 18:
    NONFAILING(*(uint64_t*)0x20006d00 = 0);
    NONFAILING(*(uint32_t*)0x20006d08 = 0x1002002);
    NONFAILING(*(uint64_t*)0x20006d10 = 0);
    NONFAILING(*(uint64_t*)0x20006d18 = 0);
    NONFAILING(*(uint64_t*)0x20006d20 = 0);
    NONFAILING(*(uint64_t*)0x20006d28 = 0);
    NONFAILING(*(uint32_t*)0x20006d30 = 0x5000000);
    NONFAILING(*(uint32_t*)0x20006d38 = 0);
    syscall(__NR_sendmmsg, r[5], 0x20006d00ul, 0xc6ul, 0ul);
    break;
  case 19:
  ...
  case 24:
    NONFAILING(memcpy((void*)0x20000180, "./file0\000", 8));
    syscall(__NR_statx, r[0], 0x20000180ul, 0x4000ul, 6ul, 0x200001c0ul);
    break;
  case 25:
    NONFAILING(memcpy((void*)0x20000040, "./file0\000", 8));
    NONFAILING(memcpy((void*)0x20000080, "security.capability\000", 20));
  ...
  case 27:
    ...
    NONFAILING(*(uint16_t*)0x20000300 = 0x10);
    NONFAILING(*(uint16_t*)0x20000302 = 0);
    NONFAILING(*(uint32_t*)0x20000304 = 0);
    NONFAILING(*(uint32_t*)0x20000308 = 0x1000);
    ...
    NONFAILING(*(uint32_t*)0x200003f0 = 0x800);
    syscall(__NR_sendmsg, r[0], 0x200003c0ul, 0x40000ul);
    break;
  case 28:
    syscall(__NR_fcntl, -1, 4ul, 0x2800ul);
    break;
  case 29:
    NONFAILING(memcpy((void*)0x20000040, "IPVS\000", 5));
    NONFAILING(syz_genetlink_get_family_id(0x20000040, -1));
    break;
  case 30:
  ...
  case 32:
    ...
    NONFAILING(*(uint32_t*)0x20000448 = 0x400);
    NONFAILING(*(uint32_t*)0x20000588 = 0xc);
    NONFAILING(*(uint64_t*)0x20000590 = 0x20000540);
    NONFAILING(*(uint64_t*)0x20000540 = 0x20000480);
    NONFAILING(*(uint32_t*)0x20000480 = 0x98);
    NONFAILING(*(uint16_t*)0x20000484 = r[3]);
    NONFAILING(*(uint16_t*)0x20000486 = 0x200);
    NONFAILING(*(uint32_t*)0x20000488 = 0x70bd26);
    NONFAILING(*(uint32_t*)0x2000048c = 0x25dfdbfb);
    NONFAILING(*(uint8_t*)0x20000490 = 2);
    NONFAILING(*(uint8_t*)0x20000491 = 0);
    NONFAILING(*(uint16_t*)0x20000492 = 0);
    NONFAILING(*(uint16_t*)0x20000494 = 0x20);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000496, 2, 0, 14));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000497, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000497, 1, 7, 1));
    NONFAILING(*(uint16_t*)0x20000498 = 0x14);
    NONFAILING(*(uint16_t*)0x2000049a = 1);
    NONFAILING(*(uint64_t*)0x2000049c = htobe64(0));
    NONFAILING(*(uint64_t*)0x200004a4 = htobe64(1));
    NONFAILING(*(uint16_t*)0x200004ac = 8);
    NONFAILING(*(uint16_t*)0x200004ae = 7);
    NONFAILING(*(uint32_t*)0x200004b0 = 1);
    NONFAILING(*(uint16_t*)0x200004b4 = 8);
    NONFAILING(*(uint16_t*)0x200004b6 = 6);
    NONFAILING(*(uint32_t*)0x200004b8 = 0);
    NONFAILING(*(uint16_t*)0x200004bc = 8);
    NONFAILING(*(uint16_t*)0x200004be = 6);
    NONFAILING(*(uint32_t*)0x200004c0 = 0xb1);
    NONFAILING(*(uint16_t*)0x200004c4 = 0x24);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200004c6, 1, 0, 14));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200004c7, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200004c7, 1, 7, 1));
    NONFAILING(*(uint16_t*)0x200004c8 = 7);
    NONFAILING(*(uint16_t*)0x200004ca = 6);
    NONFAILING(memcpy((void*)0x200004cc, "rr\000", 3));
    NONFAILING(*(uint16_t*)0x200004d0 = 8);
    NONFAILING(*(uint16_t*)0x200004d2 = 9);
    NONFAILING(*(uint32_t*)0x200004d4 = 0x61);
    NONFAILING(*(uint16_t*)0x200004d8 = 6);
    NONFAILING(*(uint16_t*)0x200004da = 4);
    NONFAILING(*(uint16_t*)0x200004dc = htobe16(0x4e23));
    NONFAILING(*(uint16_t*)0x200004e0 = 7);
    NONFAILING(*(uint16_t*)0x200004e2 = 6);
    NONFAILING(memcpy((void*)0x200004e4, "dh\000", 3));
    NONFAILING(*(uint16_t*)0x200004e8 = 0x30);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200004ea, 3, 0, 14));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200004eb, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200004eb, 1, 7, 1));
    NONFAILING(*(uint16_t*)0x200004ec = 6);
    NONFAILING(*(uint16_t*)0x200004ee = 7);
    NONFAILING(*(uint16_t*)0x200004f0 = htobe16(0x4e24));
    NONFAILING(*(uint16_t*)0x200004f4 = 8);
    NONFAILING(*(uint16_t*)0x200004f6 = 1);
    NONFAILING(*(uint32_t*)0x200004f8 = 1);
    NONFAILING(*(uint16_t*)0x200004fc = 8);
    NONFAILING(*(uint16_t*)0x200004fe = 3);
    NONFAILING(*(uint32_t*)0x20000500 = 1);
    NONFAILING(*(uint16_t*)0x20000504 = 0x14);
    NONFAILING(*(uint16_t*)0x20000506 = 6);
    NONFAILING(memset((void*)0x20000508, 0, 16));
    NONFAILING(*(uint64_t*)0x20000548 = 0x98);
    NONFAILING(*(uint64_t*)0x20000598 = 1);
    NONFAILING(*(uint64_t*)0x200005a0 = 0);
    NONFAILING(*(uint64_t*)0x200005a8 = 0);
    NONFAILING(*(uint32_t*)0x200005b0 = 0x10);
  ...
  case 34:
    ...
    NONFAILING(memset((void*)0x2000000a, 0, 13));
    NONFAILING(*(uint8_t*)0x20000017 = 0xaa);
    NONFAILING(*(uint32_t*)0x20000018 = 9);
    syscall(__NR_connect, r[5], 0x20000000ul, 0x1cul);
    break;
  case 35:
    syscall(__NR_setsockopt, r[5], 0x29, 0, 0ul, 0ul);
    break;
  case 36:
    NONFAILING(*(uint64_t*)0x20006d00 = 0);
    NONFAILING(*(uint32_t*)0x20006d08 = 0x1002002);
