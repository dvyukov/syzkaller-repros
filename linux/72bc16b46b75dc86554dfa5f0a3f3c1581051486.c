...
// https://syzkaller.appspot.com/bug?id=72bc16b46b75dc86554dfa5f0a3f3c1581051486
// status:open
...
void execute_call(int call)
{
  ...
  case 6:
    ...
    NONFAILING(*(uint32_t*)0x20000004 = 7);
    NONFAILING(*(uint32_t*)0x20000008 = 7);
    NONFAILING(*(uint32_t*)0x2000000c = 0xfffffeff);
    NONFAILING(*(uint8_t*)0x20000010 = -1);
    NONFAILING(*(uint8_t*)0x20000011 = 4);
    NONFAILING(*(uint8_t*)0x20000012 = 0);
    NONFAILING(*(uint8_t*)0x20000013 = -1);
    NONFAILING(*(uint32_t*)0x20000014 = 0xffffffb3);
    NONFAILING(*(uint32_t*)0x20000018 = 0xf15b);
    NONFAILING(*(uint32_t*)0x2000001c = 0x3ff);
    NONFAILING(*(uint32_t*)0x20000020 = 0x10001);
    syscall(__NR_ioctl, r[1], 0x5404, 0x20000000);
    break;
  case 7:
    NONFAILING(*(uint16_t*)0x20000040 = 0);
    NONFAILING(*(uint16_t*)0x20000042 = 0xfffd);
    NONFAILING(*(uint16_t*)0x20000044 = 0xfffa);
    NONFAILING(*(uint16_t*)0x20000046 = 0x7ff);
    NONFAILING(*(uint8_t*)0x20000048 = 0xb0);
    NONFAILING(*(uint8_t*)0x20000049 = 0);
    NONFAILING(*(uint8_t*)0x2000004a = 0);
    NONFAILING(*(uint8_t*)0x2000004b = 0);
    NONFAILING(*(uint32_t*)0x2000004c = 0xfffffffc);
