...
// https://syzkaller.appspot.com/bug?id=e0fbad7ccbe8e2b58949c5e42c1333d3af926d39
// status:open
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    NONFAILING(memcpy((void*)0x20000000, "min_batch_time", 14));
    NONFAILING(*(uint8_t*)0x2000000e = 0x3d);
    NONFAILING(sprintf((char*)0x2000000f, "0x%016llx", (long long)0x5000000));
    NONFAILING(*(uint8_t*)0x20000021 = 0x2c);
    NONFAILING(memcpy((void*)0x20000022, "max_batch_time", 14));
    NONFAILING(*(uint8_t*)0x20000030 = 0x3d);
    NONFAILING(sprintf((char*)0x20000031, "0x%016llx", (long long)0));
    NONFAILING(*(uint8_t*)0x20000043 = 0x2c);
    NONFAILING(*(uint8_t*)0x20000044 = 0);
    syz_mount_image(0, 0x20000080, 0, 0, 0, 0x38028b8, 0x20000000);
    break;
  }
}
int main(void)
