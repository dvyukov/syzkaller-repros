...
// https://syzkaller.appspot.com/bug?id=c4199edd5d559780b6f0fb3874fcc253f070786f
// status:fixed
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x200000c5 = 0x68;
  *(uint8_t*)0x200000c6 = 0x9e;
  *(uint8_t*)0x200000c7 = 0x20;
  *(uint16_t*)0x200000c8 = 0x7d1;
  *(uint16_t*)0x200000ca = 0x3c05;
  *(uint16_t*)0x200000cc = 0xe414;
  ...
  *(uint8_t*)0x200000dd = 0xd7;
  *(uint8_t*)0x200000de = 0;
  *(uint8_t*)0x200000df = 0;
  *(uint8_t*)0x200000e0 = 0xee;
  *(uint8_t*)0x200000e1 = 0xee;
  *(uint8_t*)0x200000e2 = 0x41;
  *(uint8_t*)0x200000e3 = 0;
  res = syz_usb_connect(0, 0x24, 0x200000c0, 0);
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x20000080 = 0x47;
  ...
  *(uint32_t*)0x20000e00 = 0x54;
  *(uint64_t*)0x20000e04 = 0x20000900;
  ...
  *(uint64_t*)0x20000e4c = 0;
  syz_usb_control_io(r[0], 0x20000080, 0x20000e00);
}
int main(void)
{
