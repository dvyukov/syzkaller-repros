...
// https://syzkaller.appspot.com/bug?id=20fef510634faf733060
// status:0
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x20000504 = 4;
  *(uint8_t*)0x20000505 = 0x5e;
  *(uint8_t*)0x20000506 = 0x7c;
  *(uint8_t*)0x20000507 = 0x10;
  *(uint16_t*)0x20000508 = 0x11ba;
  *(uint16_t*)0x2000050a = 0x1003;
  *(uint16_t*)0x2000050c = 0x3b05;
  ...
  *(uint16_t*)0x20000514 = 0x2d;
  *(uint8_t*)0x20000516 = 2;
  ...
  *(uint8_t*)0x2000051d = 0x8a;
  *(uint8_t*)0x2000051e = 9;
  *(uint8_t*)0x2000051f = 2;
  *(uint8_t*)0x20000520 = 0xde;
  *(uint8_t*)0x20000521 = 0xe0;
  *(uint8_t*)0x20000522 = 0x62;
  ...
  *(uint16_t*)0x20000531 = 0;
  *(uint8_t*)0x20000533 = 0;
  *(uint8_t*)0x20000534 = 0;
  *(uint8_t*)0x20000535 = 0;
  *(uint8_t*)0x20000536 = 9;
  *(uint8_t*)0x20000537 = 4;
  *(uint8_t*)0x20000538 = 0;
  *(uint8_t*)0x20000539 = 0;
  *(uint8_t*)0x2000053a = 0;
  *(uint8_t*)0x2000053b = 0xd0;
  *(uint8_t*)0x2000053c = 0x21;
  *(uint8_t*)0x2000053d = 0x3e;
  *(uint8_t*)0x2000053e = 0;
  res = -1;
  res = syz_usb_connect(0, 0x3f, 0x20000500, 0);
  if (res != -1)
    r[0] = res;
  syz_usb_ep_read(r[0], 1, 0x4b, 0x200010c0);
}
int main(void)
{
