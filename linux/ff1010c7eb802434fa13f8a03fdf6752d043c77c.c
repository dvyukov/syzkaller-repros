...
void execute_one(void)
{
  ...
  *(uint16_t*)0x20000800 = 0xa;
  *(uint16_t*)0x20000802 = htobe16(0x4e21);
  *(uint32_t*)0x20000804 = htobe32(0);
  *(uint64_t*)0x20000808 = htobe64(0);
  *(uint64_t*)0x20000810 = htobe64(1);
  *(uint32_t*)0x20000818 = 0;
  syscall(__NR_bind, r[0], 0x20000800, 0x1c);
}
int main(void)
{
