...
// https://syzkaller.appspot.com/bug?id=2a3d1055d123616150126ef71abfe2331028caae
// status:open
...
void loop(void)
{
  ...
  *(uint64_t*)0x20000080 = 0x20000d00;
  *(uint32_t*)0x20000d00 = 0x58;
  *(uint16_t*)0x20000d04 = 0x24;
  *(uint16_t*)0x20000d06 = 0x507;
  *(uint32_t*)0x20000d08 = 0;
  *(uint32_t*)0x20000d0c = 0;
  *(uint8_t*)0x20000d10 = 0;
  *(uint32_t*)0x20000d14 = r[3];
  *(uint16_t*)0x20000d18 = 0;
  *(uint16_t*)0x20000d1a = 0;
  *(uint16_t*)0x20000d1c = -1;
  *(uint16_t*)0x20000d1e = -1;
  *(uint16_t*)0x20000d20 = 0;
  *(uint16_t*)0x20000d22 = 0;
  *(uint16_t*)0x20000d24 = 8;
  *(uint16_t*)0x20000d26 = 1;
  memcpy((void*)0x20000d28, "sfb\000", 4);
  *(uint16_t*)0x20000d2c = 0x2c;
  *(uint16_t*)0x20000d2e = 2;
  *(uint16_t*)0x20000d30 = 0x28;
  ...
  *(uint32_t*)0x20000d4c = 0xfffffffd;
