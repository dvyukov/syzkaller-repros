...
// https://syzkaller.appspot.com/bug?id=f7d9295d2565ee819d21
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20006000, "/dev/snd/controlC#\000", 19));
    res = -1;
    NONFAILING(res = syz_open_dev(0x20006000, 0, 0));
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x200001c0 = 0);
    syscall(__NR_ioctl, r[0], 0x40045532, 0x200001c0ul);
    break;
  case 2:
    NONFAILING(memcpy((void*)0x200002c0, "/dev/audio\000", 11));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x200002c0ul, 0x140202ul,
                  0ul);
    if (res != -1)
      r[1] = res;
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000480, "/dev/snd/pcmC#D#p\000", 18));
    res = -1;
    NONFAILING(res = syz_open_dev(0x20000480, 0, 0x405));
    if (res != -1)
      r[2] = res;
    break;
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_ioctl, r[2], 0x4112, 0ul);
    break;
  }
}
int main(void)
