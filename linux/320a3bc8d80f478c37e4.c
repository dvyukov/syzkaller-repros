...
// https://syzkaller.appspot.com/bug?id=320a3bc8d80f478c37e4
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    *(uint32_t*)0x200006c0 = 1;
    ...
    break;
  case 3:
    memcpy((void*)0x200001c0, "syz_tun\000\000\000\000\000\000\000\000\000",
           16);
  ...
  case 6:
    ...
    *(uint32_t*)0x20000578 = 0;
    syscall(__NR_recvmmsg, r[1], 0x20000540ul, 0x422ul, 0ul, 0ul);
    break;
  }
}
int main(void)
