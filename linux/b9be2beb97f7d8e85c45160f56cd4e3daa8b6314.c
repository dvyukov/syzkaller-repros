...
// https://syzkaller.appspot.com/bug?id=b9be2beb97f7d8e85c45160f56cd4e3daa8b6314
// status:invalid
...
void loop(void)
{
  ...
  *(uint8_t*)0x20000005 = 0x4d;
  *(uint8_t*)0x20000006 = 0xd8;
  *(uint8_t*)0x20000007 = 0x40;
  *(uint16_t*)0x20000008 = 0x424;
  *(uint16_t*)0x2000000a = 0xc001;
  *(uint16_t*)0x2000000c = 0x747c;
  ...
  *(uint8_t*)0x2000001d = 0x12;
  *(uint8_t*)0x2000001e = -1;
  *(uint8_t*)0x2000001f = 1;
  *(uint8_t*)0x20000020 = 0xed;
  *(uint8_t*)0x20000021 = 0xb1;
  *(uint8_t*)0x20000022 = 0x61;
  ...
  *(uint8_t*)0x2000002c = 0;
  syz_usb_connect(0xfffffffffffffffd, 0x2d, 0x20000000, 0);
  close_fds();
}
int main(void)
{
