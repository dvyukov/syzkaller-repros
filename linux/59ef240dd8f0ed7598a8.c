...
// https://syzkaller.appspot.com/bug?id=59ef240dd8f0ed7598a8
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20002040, "/dev/fuse\000", 10));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20002040ul, 0x42ul, 0ul);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
    ...
    NONFAILING(memcpy((void*)0x20004300, "fd", 2));
    NONFAILING(*(uint8_t*)0x20004302 = 0x3d);
    NONFAILING(sprintf((char*)0x20004303, "0x%016llx", (long long)r[0]));
    NONFAILING(*(uint8_t*)0x20004315 = 0x2c);
    NONFAILING(memcpy((void*)0x20004316, "rootmode", 8));
    NONFAILING(*(uint8_t*)0x2000431e = 0x3d);
    NONFAILING(sprintf((char*)0x2000431f, "%023llo", (long long)0x4000));
    NONFAILING(*(uint8_t*)0x20004336 = 0x2c);
    NONFAILING(memcpy((void*)0x20004337, "user_id", 7));
    NONFAILING(*(uint8_t*)0x2000433e = 0x3d);
    NONFAILING(sprintf((char*)0x2000433f, "%020llu", (long long)0));
    NONFAILING(*(uint8_t*)0x20004353 = 0x2c);
    NONFAILING(memcpy((void*)0x20004354, "group_id", 8));
    NONFAILING(*(uint8_t*)0x2000435c = 0x3d);
    NONFAILING(sprintf((char*)0x2000435d, "%020llu", (long long)0));
    NONFAILING(*(uint8_t*)0x20004371 = 0x2c);
    NONFAILING(*(uint8_t*)0x20004372 = 0);
  ...
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_ioctl, r[2], 0x401070c9, 0x1190002ul);
    break;
  }
}
int main(void)
