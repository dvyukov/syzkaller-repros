...
// https://syzkaller.appspot.com/bug?id=b962be759f1c186a76fe71ba99eda6e23708dcd9
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000340, "TIPCv2\000", 7));
  ...
  case 2:
    ...
    syscall(__NR_sendmsg, r[0], 0x20000000, 4);
    break;
  }
}
int main(void)
