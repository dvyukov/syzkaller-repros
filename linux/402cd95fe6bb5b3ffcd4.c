...
// https://syzkaller.appspot.com/bug?id=402cd95fe6bb5b3ffcd4
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    syscall(__NR_bpf, 0x11ul, 0x20000400ul, 1ul);
    break;
  case 1:
  ...
  case 2:
    ...
    NONFAILING(*(uint8_t*)0x2000004b = 7);
    NONFAILING(*(uint32_t*)0x2000004c = 0);
    NONFAILING(*(uint64_t*)0x20000050 = 0x248000009);
    ...
    NONFAILING(*(uint64_t*)0x20000078 = 0xd5);
    NONFAILING(*(uint64_t*)0x20000080 = 0);
    NONFAILING(*(uint64_t*)0x20000088 = 4);
    ...
    syscall(__NR_perf_event_open, 0x20000040ul, 0, 0xcul, -1, 0ul);
    break;
  case 3:
  ...
  case 6:
    ...
    break;
  case 7:
    NONFAILING(memcpy((void*)0x20000100, "memory.events\000", 14));
    res = syscall(__NR_openat, 0xffffff9c, 0x20000100ul, 0x100002ul, 0ul);
    if (res != -1)
      r[3] = res;
    break;
  case 8:
    syscall(__NR_ioctl, r[3], 0x6611, 0ul);
    break;
  case 9:
    NONFAILING(*(uint32_t*)0x20000280 = 1);
    NONFAILING(*(uint32_t*)0x20000284 = 0x80);
    ...
    NONFAILING(*(uint64_t*)0x20000290 = 0x3c43);
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 2, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 3, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 4, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 5, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 7, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 8, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 9, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 10, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 11, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 12, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 13, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 14, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 15, 2));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 17, 1));
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 22, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 23, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 24, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 25, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 26, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 27, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 28, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 29, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 30, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 31, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 32, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 33, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 34, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 35, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 36, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 37, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 38, 26));
    ...
    NONFAILING(*(uint64_t*)0x200002c8 = 0x1000);
    ...
    syscall(__NR_perf_event_open, 0x20000280ul, 0, -1ul, -1, 0ul);
    break;
  case 10:
    syscall(__NR_perf_event_open, 0ul, 0, 4ul, -1, 1ul);
    break;
  case 11:
    syscall(__NR_openat, 0xffffff9c, 0ul, 0x7a05ul, 0x1700ul);
    break;
  case 12:
    syscall(__NR_openat, r[2], 0ul, 0ul, 0ul);
    break;
  }
}
int main(void)
