...
// https://syzkaller.appspot.com/bug?id=60b82e07e657b65556283d1f419e8151cc4a0ae4
// status:open
...
void execute_one(void)
{
  ...
  memcpy((void*)0x20000080, "/dev/md0\000", 9);
  ...
  inject_fault(12);
  syscall(__NR_mount, 0x20000080, 0x20000100, 0x20000140, 0, 0);
}
int main(void)
{
