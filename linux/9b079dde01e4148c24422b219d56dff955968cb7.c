...
// https://syzkaller.appspot.com/bug?id=9b079dde01e4148c24422b219d56dff955968cb7
// status:open
...
again:
  for (call = 0; call < 18; call++) {
    for (thread = 0; thread < (int)(sizeof(threads) / sizeof(threads[0]));
      ...
      if (collide && (call % 2) == 0)
        break;
      event_timedwait(&th->done, 45 + (call == 17 ? 100 : 0));
      break;
    }
  }
...
void execute_call(int call)
{
  ...
  case 8:
    ...
    break;
  case 9:
    syscall(__NR_setsockopt, -1, 6ul, 1ul, 0ul, 0ul);
    break;
  case 10:
    syscall(__NR_socket, 0x26ul, 5ul, 0ul);
    break;
  case 11:
    NONFAILING(memcpy((void*)0x2068b000, "io\000", 3));
    res = syz_open_procfs(0, 0x2068b000);
    if (res != -1)
      r[1] = res;
    break;
  case 12:
    syscall(__NR_sendfile, -1, r[1], 0ul, 6ul);
    break;
  case 13:
    NONFAILING(memcpy((void*)0x20000100, "fdinfo/3\000", 9));
  ...
  case 14:
    ...
    break;
  case 15:
    syscall(__NR_sendfile, r[3], r[2], 0ul, 0x209ul);
    break;
  case 16:
    syscall(__NR_mknod, 0ul, 0ul, 0);
    break;
  case 17:
    syz_mount_image(0, 0, 8, 0, 0, 0x1000800, 0);
    break;
  }
}
int main(void)
