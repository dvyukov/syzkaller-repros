...
int main(void)
{
  ...
  *(uint8_t*)0x20001904 = 0xf9;
  *(uint8_t*)0x20001905 = 0x3e;
  *(uint8_t*)0x20001906 = 4;
  *(uint8_t*)0x20001907 = 8;
  *(uint16_t*)0x20001908 = 0x1385;
  *(uint16_t*)0x2000190a = 0x5f02;
  *(uint16_t*)0x2000190c = 0x6486;
  ...
  *(uint16_t*)0x20001914 = 0x1b;
  *(uint8_t*)0x20001916 = 1;
  *(uint8_t*)0x20001917 = 0;
  *(uint8_t*)0x20001918 = 0;
  *(uint8_t*)0x20001919 = 0;
  *(uint8_t*)0x2000191a = 0x90;
  *(uint8_t*)0x2000191b = 9;
  *(uint8_t*)0x2000191c = 4;
  *(uint8_t*)0x2000191d = 0x3d;
  *(uint8_t*)0x2000191e = 0;
  *(uint8_t*)0x2000191f = 1;
  *(uint8_t*)0x20001920 = 0xec;
  *(uint8_t*)0x20001921 = 0xc;
  *(uint8_t*)0x20001922 = 0x4d;
  *(uint8_t*)0x20001923 = 0;
  *(uint8_t*)0x20001924 = 7;
  *(uint8_t*)0x20001925 = 5;
  *(uint8_t*)0x20001926 = 0x81;
  *(uint8_t*)0x20001927 = 0x12;
  *(uint16_t*)0x20001928 = 0xfffc;
  *(uint8_t*)0x2000192a = 0;
  *(uint8_t*)0x2000192b = 0;
  *(uint8_t*)0x2000192c = 0;
  syz_usb_connect(1, 0x2d, 0x20001900, 0);
  return 0;
}
