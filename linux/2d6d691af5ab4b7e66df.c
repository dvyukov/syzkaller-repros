...
// https://syzkaller.appspot.com/bug?id=2d6d691af5ab4b7e66df
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    NONFAILING(memcpy((void*)0x20000000,
                      ...
                      "\x04\x00\x00\x01\x03\x00\x00\x00\x09\x05\x84",
                      39));
    NONFAILING(memcpy((void*)0x20000027, "\xcb", 1));
    res = -1;
    NONFAILING(res = syz_usb_connect(0, 0x2d, 0x20000000, 0));
    if (res != -1)
      r[1] = res;
    break;
  case 3:
  ...
  case 4:
    ...
    break;
  case 5:
    NONFAILING(*(uint8_t*)0x20000180 = 0x1b);
    NONFAILING(*(uint8_t*)0x20000181 = 0x9b);
    NONFAILING(*(uint8_t*)0x20000182 = 7);
    NONFAILING(*(uint8_t*)0x20000183 = 7);
    ...
    NONFAILING(*(uint16_t*)0x20000190 = 0);
    NONFAILING(*(uint16_t*)0x20000192 = 0);
    NONFAILING(*(uint32_t*)0x20000194 = 0);
    NONFAILING(*(uint64_t*)0x20000198 = 0);
    NONFAILING(*(uint64_t*)0x200001a0 = 0x40);
    NONFAILING(*(uint64_t*)0x200001a8 = 0);
    NONFAILING(*(uint32_t*)0x200001b0 = 0);
    NONFAILING(*(uint16_t*)0x200001b4 = 0);
    NONFAILING(*(uint16_t*)0x200001b6 = 0x38);
    NONFAILING(*(uint16_t*)0x200001b8 = 0);
    NONFAILING(*(uint16_t*)0x200001ba = 0);
    NONFAILING(*(uint16_t*)0x200001bc = 0);
    NONFAILING(*(uint16_t*)0x200001be = 0);
    ...
    syscall(__NR_write, r[2], 0x20000180ul, 0x78ul);
    break;
  }
}
int main(void)
