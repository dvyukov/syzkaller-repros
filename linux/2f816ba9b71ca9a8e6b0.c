...
// https://syzkaller.appspot.com/bug?id=2f816ba9b71ca9a8e6b0
// status:0 arch:386
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint64_t*)0x20000110 = 0x3c40);
    ...
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x20000000 = 6);
    NONFAILING(*(uint32_t*)0x20000004 = 4);
    NONFAILING(*(uint32_t*)0x20000008 = 0x7ffd);
    NONFAILING(*(uint32_t*)0x2000000c = 0x17);
    NONFAILING(*(uint32_t*)0x20000010 = 0);
    NONFAILING(*(uint32_t*)0x20000014 = 1);
    NONFAILING(*(uint32_t*)0x20000018 = 0);
    NONFAILING(memset((void*)0x2000001c, 0, 16));
    ...
    syscall(__NR_bpf, 0, 0x20000000, 0x40);
    break;
  }
}
int main(void)
