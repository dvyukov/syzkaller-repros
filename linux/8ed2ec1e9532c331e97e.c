...
// https://syzkaller.appspot.com/bug?id=8ed2ec1e9532c331e97e
// status:6
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000000, "/dev/input/mouse#\000", 18));
    res = -1;
    NONFAILING(res = syz_open_dev(0x20000000, 0, 0x1142));
    if (res != -1)
      r[0] = res;
    break;
  case 1:
