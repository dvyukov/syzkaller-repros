...
// https://syzkaller.appspot.com/bug?id=7d9487e3d0194dbd2de9582c58bfd9659871f406
// status:open
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    *(uint64_t*)0x2025c020 = 0xf;
    ...
    STORE_BY_BITMASK(uint64_t, 0x2025c028, 9, 2, 1);
  ...
  case 4:
    ...
    *(uint64_t*)0x2001d020 = 0;
    ...
    STORE_BY_BITMASK(uint64_t, 0x2001d028, -1, 7, 1);
    ...
    *(uint16_t*)0x2001d06e = 0;
    res = syscall(__NR_perf_event_open, 0x2001d000, 0, -1, r[2], 0);
    if (res != -1)
      r[3] = res;
    break;
  case 5:
    syscall(__NR_mmap, 0x20ffd000, 0x3000, 0, 0x4000000000011, r[3], 0);
    break;
  case 6:
  ...
  case 7:
    ...
    *(uint64_t*)0x20000008 = 0x3528a9c0;
    syscall(__NR_vmsplice, r[0], 0x20000000, 1, 0);
    break;
  }
}
int main(void)
