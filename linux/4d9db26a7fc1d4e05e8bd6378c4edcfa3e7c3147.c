...
// https://syzkaller.appspot.com/bug?id=4d9db26a7fc1d4e05e8bd6378c4edcfa3e7c3147
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000000, "auxv", 5));
    res = syz_open_procfs(0, 0x20000000);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    NONFAILING(memcpy((void*)0x200000c0, "oom_score_adj", 14));
    res = syz_open_procfs(0, 0x200000c0);
    if (res != -1)
      r[1] = res;
    break;
  case 2:
    NONFAILING(*(uint64_t*)0x20000100 = 0x5d);
    syscall(__NR_sendfile, r[1], r[0], 0x20000100, 0x79ffff00000011);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x200003c0, "/selinux/commit_pending_bools", 30));
  ...
  case 4:
    ...
    if (res != -1) {
      NONFAILING(r[3] = *(uint32_t*)0x200001c0);
      NONFAILING(r[4] = *(uint32_t*)0x200001c4);
    }
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20000200, "p", 1));
    syscall(__NR_write, r[4], 0x20000200, 1);
    break;
  case 6:
    NONFAILING(*(uint64_t*)0x20000100 = 0);
    syscall(__NR_splice, r[3], 0, r[2], 0x20000100, 0x400000000003, 0);
    break;
  case 7:
    NONFAILING(memcpy((void*)0x200056c0, "./file0", 8));
    syscall(__NR_mknod, 0x200056c0, 0x1040, 0);
    break;
  case 8:
    NONFAILING(memcpy((void*)0x20f8aff8, "./file0", 8));
    syscall(__NR_execve, 0x20f8aff8, 0x20000380, 0x200001c0);
    break;
  case 9:
    NONFAILING(memcpy((void*)0x20000000, "./cgroup.cpu", 13));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000000, 0x200002, 0);
    if (res != -1)
      r[5] = res;
    break;
  case 10:
    syscall(__NR_fchdir, r[5]);
    break;
  case 11:
    NONFAILING(memcpy((void*)0x20000340, "net/rt_cache", 13));
    res = syz_open_procfs(0, 0x20000340);
    if (res != -1)
      r[6] = res;
    break;
  case 12:
    NONFAILING(memcpy((void*)0x20000140, "./bus", 6));
  ...
  case 13:
    NONFAILING(*(uint64_t*)0x20000100 = 0);
    syscall(__NR_sendfile, r[7], r[6], 0x20000100, 0x10013c93e);
    break;
  }
}
int main(void)
