...
{
  *(uint8_t*)0x20003740 = 0x12;
  *(uint8_t*)0x20003741 = 1;
  *(uint16_t*)0x20003742 = 0;
  *(uint8_t*)0x20003744 = 0;
  *(uint8_t*)0x20003745 = 0x47;
  *(uint8_t*)0x20003746 = 0x16;
  *(uint8_t*)0x20003747 = 8;
  *(uint16_t*)0x20003748 = 0x6615;
  *(uint16_t*)0x2000374a = 0x12;
  *(uint16_t*)0x2000374c = 0x9206;
  *(uint8_t*)0x2000374e = 0;
  *(uint8_t*)0x2000374f = 0;
  *(uint8_t*)0x20003750 = 0;
  *(uint8_t*)0x20003751 = 1;
  *(uint8_t*)0x20003752 = 9;
  *(uint8_t*)0x20003753 = 2;
  *(uint16_t*)0x20003754 = 0x27;
  *(uint8_t*)0x20003756 = 1;
  *(uint8_t*)0x20003757 = 0;
  *(uint8_t*)0x20003758 = 0;
  *(uint8_t*)0x20003759 = 0;
  *(uint8_t*)0x2000375a = 1;
  *(uint8_t*)0x2000375b = 9;
  *(uint8_t*)0x2000375c = 4;
  *(uint8_t*)0x2000375d = 0xdb;
  *(uint8_t*)0x2000375e = 0;
  *(uint8_t*)0x2000375f = 1;
  *(uint8_t*)0x20003760 = 9;
  *(uint8_t*)0x20003761 = 0x4c;
  *(uint8_t*)0x20003762 = 0x4e;
  *(uint8_t*)0x20003763 = 0;
  *(uint8_t*)0x20003764 = 6;
  *(uint8_t*)0x20003765 = 0x21;
  *(uint16_t*)0x20003766 = 0;
  *(uint8_t*)0x20003768 = 8;
  *(uint8_t*)0x20003769 = 0;
  *(uint8_t*)0x2000376a = 2;
  *(uint8_t*)0x2000376b = 9;
  *(uint8_t*)0x2000376c = 7;
  *(uint8_t*)0x2000376d = 5;
  *(uint8_t*)0x2000376e = 0x84;
  *(uint8_t*)0x2000376f = 0;
  *(uint16_t*)0x20003770 = 0;
  *(uint8_t*)0x20003772 = 0;
  *(uint8_t*)0x20003773 = 0;
  *(uint8_t*)0x20003774 = 0;
  *(uint8_t*)0x20003775 = 2;
  *(uint8_t*)0x20003776 = 0;
  *(uint8_t*)0x20003777 = 2;
  *(uint8_t*)0x20003778 = 0x31;
  syz_usb_connect(1, 0x39, 0x20003740, 0);
}
int main(void)
{
