...
// https://syzkaller.appspot.com/bug?id=8cd1170fa5f813384e6c3fe16d93ac359fb43553
// status:open
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    NONFAILING(*(uint64_t*)0x20000040 = 0x20000300);
    NONFAILING(memcpy((void*)0x20000300,
                      "\x14\x00\x00\x00\x13\x00\x05\x07\xed\x0a\x80\x64\xd2\x00"
                      "\x10\x00\x3d\x00\x00\x80",
                      20));
