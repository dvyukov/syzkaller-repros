...
// https://syzkaller.appspot.com/bug?id=4bbd9999c2d828b56326539e0d681eea0c836019
// status:fixed
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_mprotect, 0x20000000, 0x800000, 1);
    break;
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_ioctl, -1, 0x5424, 0x20000080);
    break;
  case 3:
  ...
  case 4:
    ...
    syscall(__NR_fchownat, r[0], 0x20000180, 0, 0, 0x1000);
    break;
  }
}
int main()
