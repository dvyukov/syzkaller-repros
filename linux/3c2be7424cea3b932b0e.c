...
// https://syzkaller.appspot.com/bug?id=3c2be7424cea3b932b0e
// status:0
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x20000104 = 0xea;
  *(uint8_t*)0x20000105 = 0x77;
  *(uint8_t*)0x20000106 = 0x16;
  *(uint8_t*)0x20000107 = 0x40;
  *(uint16_t*)0x20000108 = 0x10fd;
  *(uint16_t*)0x2000010a = 0x1513;
  *(uint16_t*)0x2000010c = 0x1094;
  ...
  *(uint8_t*)0x20000120 = 0xf8;
  *(uint8_t*)0x20000121 = 0xc6;
  *(uint8_t*)0x20000122 = 0xe0;
  *(uint8_t*)0x20000123 = 0;
  syz_usb_connect(0, 0x44, 0x20000100, 0);
}
int main(void)
{
