...
// https://syzkaller.appspot.com/bug?id=b90df26038d1d5d85c97
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint32_t*)0x20000588 = 0x10);
    NONFAILING(*(uint32_t*)0x2000058c = 0);
    NONFAILING(*(uint32_t*)0x20000590 = 0);
    NONFAILING(*(uint32_t*)0x20000598 = -1);
    NONFAILING(*(uint32_t*)0x2000059c = 0);
    NONFAILING(*(uint32_t*)0x200005a0 = 0);
    NONFAILING(*(uint32_t*)0x200005a4 = 0);
    NONFAILING(
        syz_io_uring_setup(0x6b52, 0x20000580, 0x200ab000, 0x205ea000, 0, 0));
    break;
  case 2:
    syscall(__NR_madvise, 0x20000000ul, 0x600003ul, 3ul);
    break;
  }
}
int main(void)
