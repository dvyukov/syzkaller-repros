...
// https://syzkaller.appspot.com/bug?id=78b76ebc91042904f34e
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000080, "/dev/audio\000", 11));
  ...
  case 1:
    ...
    res = -1;
    NONFAILING(res = syz_io_uring_setup(0x3631, 0x20000340, 0x20ee9000,
                                        0x20eea000, 0x20000000, 0x200001c0));
    if (res != -1) {
      r[1] = res;
