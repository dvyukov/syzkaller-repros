...
// https://syzkaller.appspot.com/bug?id=22e87cdf94021b984aa6
// status:0
...
void loop(void)
{
  ...
  *(uint8_t*)0x20e68007 = 0xaa;
  ...
  memcpy((void*)0x200012c0,
         "\x0c\x26\x8a\x92\x7f\x1f\x65\x88\xb9\x67\x48\x12\x41\xba\x78\x60\x00"
  ...
  res = -1;
  res = syz_open_dev(0x20000080, 0xc, 0x121041);
  if (res != -1)
    r[1] = res;
  *(uint64_t*)0x20000000 = 7;
  syscall(__NR_ioctl, r[1], 0x5452, 0x20000000ul);
  *(uint16_t*)0x200000c0 = 0;
  *(uint16_t*)0x200000c2 = 0;
  *(uint16_t*)0x200000c4 = 0;
  *(uint16_t*)0x200000c6 = 0;
  *(uint16_t*)0x200000c8 = 1;
  *(uint16_t*)0x200000ca = 0x4a;
  ...
  *(uint16_t*)0x200000da = 0;
  ...
  syscall(__NR_write, r[1], 0x20000040ul, 0x373ul);
}
int main(void)
{
