...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20632000, "./file0\000", 8));
  ...
  case 2:
    ...
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20032ff8, "./file0\000", 8));
    res = syscall(__NR_open, 0x20032ff8, 0, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 4:
    NONFAILING(memcpy((void*)0x200001c0, "\263", 1));
    res = syscall(__NR_memfd_create, 0x200001c0, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 5:
    syscall(__NR_write, r[1], 0x20000080, 0x29);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000040, "./file0\000", 8));
    NONFAILING(memcpy((void*)0x20000100, "./file0\000", 8));
    syscall(__NR_move_mount, r[0], 0x20000040, 0xffffff9c, 0x20000100, 0x66);
    break;
  case 7:
    syscall(__NR_mmap, 0x20000000, 0x2000, 0x81, 0x11, r[1], 0);
    break;
  }
}
int main(void)
