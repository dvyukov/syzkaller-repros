...
// https://syzkaller.appspot.com/bug?id=95632cde252ddaed5a8e
// status:0
...
void loop(void)
{
  ...
  *(uint8_t*)0x20000157 = 0xaa;
  syscall(__NR_ioctl, r[1], 0x8914, 0x20000140ul);
  *(uint8_t*)0x20000240 = 0x11;
  *(uint8_t*)0x20000241 = 0;
  *(uint16_t*)0x20000242 = 0;
  *(uint16_t*)0x20000244 = 0;
  *(uint16_t*)0x20000246 = 0x15;
  *(uint16_t*)0x20000248 = 0;
  STORE_BY_BITMASK(uint8_t, , 0x2000024a, 5, 0, 4);
  ...
  *(uint16_t*)0x2000024c = htobe16(0x29);
  *(uint16_t*)0x2000024e = htobe16(0);
  *(uint16_t*)0x20000250 = htobe16(0);
  *(uint8_t*)0x20000252 = 0;
  *(uint8_t*)0x20000253 = 0x84;
  *(uint16_t*)0x20000254 = htobe16(0);
  *(uint8_t*)0x20000256 = 0xac;
  *(uint8_t*)0x20000257 = 0x14;
  *(uint8_t*)0x20000258 = 0x14;
  *(uint8_t*)0x20000259 = 0xbb;
  *(uint8_t*)0x2000025a = 0xac;
  *(uint8_t*)0x2000025b = 0x14;
  *(uint8_t*)0x2000025c = 0x14;
  *(uint8_t*)0x2000025d = 0xaa;
  *(uint16_t*)0x2000025e = htobe16(0);
  *(uint16_t*)0x20000260 = htobe16(0);
  *(uint8_t*)0x20000262 = 6;
  STORE_BY_BITMASK(uint8_t, , 0x20000263, 1, 0, 4);
  STORE_BY_BITMASK(uint8_t, , 0x20000263, 0, 4, 4);
  *(uint16_t*)0x20000264 = htobe16(0);
  STORE_BY_BITMASK(uint8_t, , 0x20000266, 0, 0, 1);
  STORE_BY_BITMASK(uint8_t, , 0x20000266, 0, 1, 4);
  STORE_BY_BITMASK(uint8_t, , 0x20000266, 0, 5, 3);
  memcpy((void*)0x20000267, "\xf4\x26\xe6", 3);
  *(uint8_t*)0x2000026a = 4;
  memcpy((void*)0x2000026b, "\xc8\x00\x05", 3);
  memcpy((void*)0x2000026e, "\x2b\x7c\x55\x42\xb5", 5);
  struct csum_inet csum_1;
  csum_inet_init(&csum_1);
  csum_inet_update(&csum_1, (const uint8_t*)0x20000256, 4);
  ...
  csum_inet_update(&csum_1, (const uint8_t*)0x2000025e, 16);
  ...
  *(uint16_t*)0x20000254 = csum_inet_digest(&csum_2);
  syscall(__NR_write, r[0], 0x20000240ul, 0xfdeful);
}
int main(void)
{
