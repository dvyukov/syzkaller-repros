...
// https://syzkaller.appspot.com/bug?id=a1c17e56a8a62294c714
// status:0
...
void execute_one(void)
{
  ...
  *(uint16_t*)0x200000ae = 0;
  ...
  syscall(__NR_socket, 2ul, 0ul, 2);
  syscall(__NR_ioctl, -1, 0x8914, 0ul);
  memcpy((void*)0x20000380, "FROZEN\000", 7);
  inject_fault(1);
  syscall(__NR_write, r[0], 0x20000380ul, 0x2001016ful);
}
int main(void)
{
