...
// https://syzkaller.appspot.com/bug?id=23cb11132b266936d251c62cf6092fbee4b4bc03
// status:fixed
...
int main(void)
{
  ...
  *(uint8_t*)0x20000044 = 0x97;
  *(uint8_t*)0x20000045 = 0x34;
  *(uint8_t*)0x20000046 = 0x13;
  *(uint8_t*)0x20000047 = 8;
  *(uint16_t*)0x20000048 = 0xc72;
  *(uint16_t*)0x2000004a = 0xd;
  *(uint16_t*)0x2000004c = 0xdad3;
  ...
  *(uint8_t*)0x2000005d = 0xf1;
  *(uint8_t*)0x2000005e = 0;
  *(uint8_t*)0x2000005f = 0;
  *(uint8_t*)0x20000060 = 0xa;
  *(uint8_t*)0x20000061 = 0x72;
  *(uint8_t*)0x20000062 = 0x24;
  *(uint8_t*)0x20000063 = 0;
  res = syz_usb_connect(0, 0x181, 0x20000040, 0);
  if (res != -1)
    r[0] = res;
  ...
  *(uint32_t*)0x20000680 = 0xcc;
  *(uint64_t*)0x20000684 = 0x20000380;
  *(uint8_t*)0x20000380 = 0;
  *(uint8_t*)0x20000381 = 0;
  *(uint32_t*)0x20000382 = 0;
  *(uint64_t*)0x2000068c = 0;
  *(uint64_t*)0x20000694 = 0;
  *(uint64_t*)0x2000069c = 0;
  *(uint64_t*)0x200006a4 = 0;
  *(uint64_t*)0x200006ac = 0;
  *(uint64_t*)0x200006b4 = 0;
  syz_usb_control_io(r[0], 0x20000340, 0x20000680);
  *(uint32_t*)0x20001f80 = 0x34;
  *(uint64_t*)0x20001f84 = 0;
  *(uint64_t*)0x20001f8c = 0;
  *(uint64_t*)0x20001f94 = 0;
  *(uint64_t*)0x20001f9c = 0;
  *(uint64_t*)0x20001fa4 = 0;
  *(uint64_t*)0x20001fac = 0;
  *(uint32_t*)0x20002280 = 0xcc;
  *(uint64_t*)0x20002284 = 0x20000080;
  *(uint8_t*)0x20000080 = 0;
  *(uint8_t*)0x20000081 = 0;
  *(uint32_t*)0x20000082 = 0;
  *(uint64_t*)0x2000228c = 0;
  *(uint64_t*)0x20002294 = 0;
  *(uint64_t*)0x2000229c = 0;
  *(uint64_t*)0x200022a4 = 0;
  *(uint64_t*)0x200022ac = 0;
  *(uint64_t*)0x200022b4 = 0;
  syz_usb_control_io(r[0], 0x20001f80, 0x20002280);
  return 0;
}
