...
// https://syzkaller.appspot.com/bug?id=61dd115ec7be95ed476f287e9ed9b11e67fce516
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    syscall(__NR_futex, 0x20000280, 0x800000000006, 1, 0, 0, 2);
    break;
  case 2:
    syscall(__NR_timer_create, 0, 0, 0);
    break;
  case 3:
    syscall(__NR_ioctl, -1, 0x5412, 0);
    break;
  }
}
int main(void)
