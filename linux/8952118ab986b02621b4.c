...
// https://syzkaller.appspot.com/bug?id=8952118ab986b02621b4
// status:6
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[0] = res;
  NONFAILING(*(uint32_t*)0x20000000 = 0x502);
  ...
  if (res != -1)
    r[1] = res;
  syscall(__NR_prctl, 0x29ul, 0ul, 0, 0);
  NONFAILING(memcpy((void*)0x20000580, "|", 1));
