...
// https://syzkaller.appspot.com/bug?id=3227d097b95b4207b570
// status:0
...
void execute_call(int call)
{
  switch (call) {
  case 0:
    NONFAILING(syz_memcpy_off(0, 0x40, 0, 0, 4));
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x20000244 = 0xcc85);
    NONFAILING(*(uint32_t*)0x20000248 = 2);
    NONFAILING(*(uint32_t*)0x2000024c = 1);
    NONFAILING(*(uint32_t*)0x20000250 = 0x320);
    ...
    NONFAILING(syz_io_uring_setup(0x7e71, 0x20000240, 0x206d4000, 0x206d5000, 0,
                                  0x20000100));
    break;
  }
}
