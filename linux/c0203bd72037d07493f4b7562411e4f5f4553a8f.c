...
void execute_one(void)
{
  ...
  *(uint8_t*)0x2000005d = 0xfb;
  *(uint8_t*)0x2000005e = 3;
  *(uint8_t*)0x2000005f = 0;
  *(uint8_t*)0x20000060 = 0xec;
  *(uint8_t*)0x20000061 = 0xc;
  *(uint8_t*)0x20000062 = 0xcb;
  *(uint8_t*)0x20000063 = 0;
  syz_usb_connect(7, 0x21c, 0x20000040, 0);
}
int main(void)
{
