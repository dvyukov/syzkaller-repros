...
// https://syzkaller.appspot.com/bug?id=6907109007182934fd61
// status:0
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    NONFAILING(memcpy((void*)0x20000000, "nfs", 3));
    NONFAILING(*(uint8_t*)0x20000003 = 0x2c);
    NONFAILING(*(uint8_t*)0x20000004 = 0);
    inject_fault(64);
    NONFAILING(syz_mount_image(0x20000440, 0x20000100, 0, 0, 0x20000400, 0,
                               0x20000000));
    break;
  }
}
