...
// https://syzkaller.appspot.com/bug?id=6ca9f7867b77c2d316ac
// status:0
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x20000484 = 0x38;
  *(uint8_t*)0x20000485 = 0x86;
  *(uint8_t*)0x20000486 = 0x64;
  *(uint8_t*)0x20000487 = 0x40;
  *(uint16_t*)0x20000488 = 0x411;
  *(uint16_t*)0x2000048a = 0x6e;
  *(uint16_t*)0x2000048c = 0x9f7;
  ...
  *(uint16_t*)0x20000494 = 0x12;
  *(uint8_t*)0x20000496 = 1;
  ...
  *(uint8_t*)0x200004a0 = 0x4a;
  *(uint8_t*)0x200004a1 = 0xf2;
  *(uint8_t*)0x200004a2 = 0x4f;
  *(uint8_t*)0x200004a3 = 0;
  res = -1;
  res = syz_usb_connect(0, 0x24, 0x20000480, 0);
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x20000940 = 0x84;
  ...
  *(uint64_t*)0x2000098c = 0x200006c0;
  *(uint8_t*)0x200006c0 = 0x40;
  *(uint8_t*)0x200006c1 = 0x13;
  *(uint32_t*)0x200006c2 = 6;
  memset((void*)0x200006c6, 170, 5);
  *(uint8_t*)0x200006cb = 0xbb;
  ...
  *(uint64_t*)0x2000081c = 0x20000680;
  *(uint8_t*)0x20000680 = 0x40;
  *(uint8_t*)0x20000681 = 0x19;
  *(uint32_t*)0x20000682 = 2;
  memcpy((void*)0x20000686, "\xe0\x35", 2);
  *(uint64_t*)0x20000824 = 0;
  *(uint64_t*)0x2000082c = 0;
  *(uint64_t*)0x20000834 = 0;
  *(uint64_t*)0x2000083c = 0;
  syz_usb_control_io(r[0], 0, 0x200007c0);
  {
    int i;
    for (i = 0; i < 64; i++) {
      syz_usb_control_io(r[0], 0, 0x200007c0);
