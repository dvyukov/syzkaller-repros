...
// https://syzkaller.appspot.com/bug?id=13bef047dbfffa5cd1af
// status:6
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x2031e004 = htobe32(0);
  memcpy((void*)0x2031e008,
         "\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000",
         16);
  *(uint32_t*)0x2031e018 = 0;
  syscall(__NR_sendto, r[1], 0ul, 0ul, 0x20000004ul, 0x2031e000ul, 0x1cul);
  syscall(__NR_accept4, r[0], 0ul, 0ul, 0ul);
  syscall(__NR_mmap, 0x20002000ul, 0x1000ul, 2ul, 0x840000000000a132ul, -1,
          0ul);
  ...
  *(uint64_t*)0x20000200 = 0x20000440;
  memcpy((void*)0x20000440,
         ...
         "\x06\x7f\xbc\x45\xff\x81\x05\x00\x00\x00\x00\x00\x00\x58\x00\x0b\x48"
         "\x04\x00\x94\x5f\x64\x00\x94\x00\x05\x00\x28\x92\x5a\x01\x00\x00\x00"
         "\x00\x00\x00\x00\x80\x00\xf0\xff\xfe\xff\xe8\x09\x00\x00\x00\xff\xf5"
         "\xdd\x00\x00\x00\x10\x00\x01\x00\x0c\x08\x10\x00\x41\x49\x00\x00\x00"
         "\x04\xfc\xff",
         88);
  *(uint64_t*)0x20000208 = 0x58;
  syscall(__NR_writev, r[2], 0x20000200ul, 1ul);
}
int main(void)
{
