...
// https://syzkaller.appspot.com/bug?id=ebc9ec4cb9279189117a
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000000, "iso9660\000", 8));
    NONFAILING(*(uint64_t*)0x20000380 = 0x20000240);
    NONFAILING(memcpy(
        (void*)0x20000240,
        "\x01\x43\x44\x30\x30\x31\x01\x00\x4c\x49\x4e\x55\x58\x20\x20\x20\x20"
        "\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20"
        "\x20\x20\x20\x20\x20\x20\x43\x44\x52\x4f\x4d\x20\x20\x20\x20\x20\x20"
        "\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20"
        "\x20\x20\x20\x20\xff\xff\xff\xf6\x00\x00\x00\x00\xb9\x1e\x1d\x14\x00"
        "\x00\x01\xb9\x00\x00\x00\x00\x00\x0a\x00\x00\x00\x00\x00\x00\x00\x00"
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
        "\x00\x01\x00\x00\x01\x01\x00\x00\x01\x00\x08",
        130));
    NONFAILING(*(uint64_t*)0x20000388 = 0x82);
    NONFAILING(*(uint64_t*)0x20000390 = 0x8000);
    NONFAILING(*(uint64_t*)0x20000398 = 0);
    NONFAILING(*(uint64_t*)0x200003a0 = 0);
    NONFAILING(*(uint64_t*)0x200003a8 = 0x8b800);
    NONFAILING(*(uint64_t*)0x200003b0 = 0x20000300);
    NONFAILING(memcpy((void*)0x20000300,
                      "\xd0\x6f\xce\x69\x1c\x2f\xc8\x4d\x53\x15\xc8\xe8\x2a\x9d"
                      "\xf3\x11\xc6\xb7\x99\xc2\x05\x82",
                      22));
    NONFAILING(*(uint64_t*)0x200003b8 = 0x16);
    NONFAILING(*(uint64_t*)0x200003c0 = 4);
    NONFAILING(memcpy((void*)0x20000a40, "session", 7));
    NONFAILING(*(uint8_t*)0x20000a47 = 0x3d);
    NONFAILING(sprintf((char*)0x20000a48, "0x%016llx", (long long)0));
    NONFAILING(*(uint8_t*)0x20000a5a = 0x2c);
    NONFAILING(*(uint8_t*)0x20000a5b = 0);
    NONFAILING(syz_mount_image(0x20000000, 0, 0, 3, 0x20000380, 0, 0x20000a40));
    break;
  case 1:
  ...
  case 2:
    ...
    if (res != -1) {
      NONFAILING(r[0] = *(uint32_t*)0x200001c0);
      NONFAILING(r[1] = *(uint32_t*)0x200001c4);
    }
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000000, "./file0\000", 8));
    NONFAILING(memcpy((void*)0x20000140, "9p\000", 3));
    NONFAILING(memcpy((void*)0x20000580, "trans=fd,rfdno=", 15));
    NONFAILING(sprintf((char*)0x2000058f, "0x%016llx", (long long)r[0]));
    NONFAILING(memcpy((void*)0x200005a1, ",wfdno=", 7));
    NONFAILING(sprintf((char*)0x200005a8, "0x%016llx", (long long)r[1]));
  ...
  case 6:
    ...
    syscall(__NR_connect, r[3], 0x20000080ul, 0xcul);
    break;
  case 7:
  ...
  case 8:
    ...
    NONFAILING(*(uint64_t*)0x200000c0 = 0x20000240);
    NONFAILING(memcpy((void*)0x20000240,
                      "\x44\x00\x00\x00\x10\x00\x01\x04\x00\x10\x00\x00\x00\x00"
                      "\x00\xc1\x00\x00\x00\x00",
                      20));
    NONFAILING(*(uint32_t*)0x20000254 = r[4]);
    NONFAILING(memcpy(
        (void*)0x20000258,
        "\x01\x00\x00\x00\x00\x00\x00\x00\x24\x00\x12\x00\x0c\x00\x01\x00\x62"
        "\x72\x69\x64\x67\x65\x00\x0e\x14\x00\x02\x00\x08\x00\x07\x00\x4a",
        33));
  ...
  case 10:
    ...
    break;
  case 11:
    NONFAILING(*(uint32_t*)0x200002c0 = 6);
    res = syscall(__NR_getsockname, r[6], 0x20000100ul, 0x200002c0ul);
    if (res != -1)
  ...
  case 13:
    ...
    NONFAILING(*(uint64_t*)0x20000448 = 0x24);
  ...
  case 14:
    ...
    res = syscall(__NR_getsockname, -1, 0x20000100ul, 0x20000380ul);
    if (res != -1)
      NONFAILING(r[9] = *(uint32_t*)0x20000104);
    break;
  case 15:
    ...
    NONFAILING(memcpy((void*)0x20000040,
                      "\x3c\x00\x00\x00\x10\x00\x01\x04\x00\x47\x55\xff\xff\xff"
                      "\xff\xff\xbf\x00\x00\x00",
                      20));
    NONFAILING(*(uint32_t*)0x20000054 = r[9]);
    NONFAILING(memcpy((void*)0x20000058,
                      "\x01\x40\x00\x00\x01\x00\x00\x00\x1c\x00\x12\x00\x0c\x00"
    ...
    syscall(__NR_sendmsg, r[8], 0x20000000ul, 0ul);
    break;
  case 16:
    ...
    NONFAILING(*(uint32_t*)0x20000300 = 0x4c);
    NONFAILING(*(uint16_t*)0x20000304 = 0x10);
    NONFAILING(*(uint16_t*)0x20000306 = 0x401);
    NONFAILING(*(uint32_t*)0x20000308 = 0x4000000);
    NONFAILING(*(uint32_t*)0x2000030c = 0);
    NONFAILING(*(uint8_t*)0x20000310 = 0);
    NONFAILING(*(uint8_t*)0x20000311 = 0);
    NONFAILING(*(uint16_t*)0x20000312 = 0x7a);
    NONFAILING(*(uint32_t*)0x20000314 = 0);
    NONFAILING(*(uint32_t*)0x20000318 = 0);
    NONFAILING(*(uint32_t*)0x2000031c = 0);
    NONFAILING(*(uint16_t*)0x20000320 = 0x1c);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000322, 0x12, 0, 14));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000323, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000323, 1, 7, 1));
    NONFAILING(*(uint16_t*)0x20000324 = 9);
    NONFAILING(*(uint16_t*)0x20000326 = 1);
    NONFAILING(memcpy((void*)0x20000328, "vlan\000", 5));
    NONFAILING(*(uint16_t*)0x20000330 = 0xc);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000332, 2, 0, 14));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000333, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x20000333, 1, 7, 1));
    NONFAILING(*(uint16_t*)0x20000334 = 6);
    NONFAILING(*(uint16_t*)0x20000336 = 1);
    NONFAILING(*(uint16_t*)0x20000338 = 0);
    NONFAILING(*(uint16_t*)0x2000033c = 8);
    NONFAILING(*(uint16_t*)0x2000033e = 5);
    NONFAILING(*(uint32_t*)0x20000340 = r[9]);
    NONFAILING(*(uint16_t*)0x20000344 = 8);
    NONFAILING(*(uint16_t*)0x20000346 = 0xa);
    NONFAILING(*(uint32_t*)0x20000348 = r[7]);
    NONFAILING(*(uint64_t*)0x20000148 = 0x4c);
  ...
  case 17:
    ...
    NONFAILING(*(uint32_t*)0x20000130 = 0xfffffffd);
    NONFAILING(*(uint32_t*)0x20000134 = 0);
    NONFAILING(*(uint64_t*)0x20000138 = 0x20000000);
    ...
    break;
  case 18:
    NONFAILING(memcpy((void*)0x20000280, "memory.events\000", 14));
    syscall(__NR_openat, 0xffffff9c, 0x20000280ul, 0x26e1ul, 0ul);
    break;
  }
}
int main(void)
