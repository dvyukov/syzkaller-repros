...
// https://syzkaller.appspot.com/bug?id=c0d52d0b3c0c3ffb9525
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    *(uint32_t*)0x200000a4 = 0;
    res = -1;
    res = syz_io_uring_setup(0x86, 0x20000080, 0x20ee7000, 0x206d4000,
  ...
  case 5:
    ...
    *(uint8_t*)0x2000033f = 0;
    syz_io_uring_submit(r[1], r[2], 0x20000300, 0);
    break;
  }
}
int main(void)
