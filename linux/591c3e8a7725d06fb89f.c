...
// https://syzkaller.appspot.com/bug?id=591c3e8a7725d06fb89f
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(*(uint16_t*)0x20000202 = 2);
  NONFAILING(memcpy((void*)0x20000204, "\xdc\x69\x0f", 3));
  NONFAILING(*(uint8_t*)0x20000207 = 0x7f);
  NONFAILING(*(uint8_t*)0x20000208 = 2);
  syscall(__NR_ioctl, r[0], 0x800448f0, 0x20000200ul);
}
int main(void)
{
