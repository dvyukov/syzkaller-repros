// memory leak in packet_sendmsg
// https://syzkaller.appspot.com/bug?id=989efe781c74de1ddb54
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(*(uint64_t*)0x20000190 = 0x203);
  ...
  NONFAILING(*(uint64_t*)0x20000050 = 0xffffffffc6553532);
  ...
  NONFAILING(memcpy((void*)0x20000380, "FROZEN\000", 7));
