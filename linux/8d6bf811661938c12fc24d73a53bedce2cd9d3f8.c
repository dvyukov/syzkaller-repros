...
// https://syzkaller.appspot.com/bug?id=8d6bf811661938c12fc24d73a53bedce2cd9d3f8
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    syscall(__NR_connect, -1, 0x20000000, 0xfffffffffffffffa);
    break;
  case 2:
    ...
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000240, "\xb1\x00\x48\x5c\xaa\x2a", 6));
    NONFAILING(*(uint8_t*)0x20000246 = 1);
    NONFAILING(*(uint8_t*)0x20000247 = 0x80);
    NONFAILING(*(uint8_t*)0x20000248 = 0xc2);
    NONFAILING(*(uint8_t*)0x20000249 = 0);
    NONFAILING(*(uint8_t*)0x2000024a = 0);
    NONFAILING(*(uint8_t*)0x2000024b = 0);
    NONFAILING(*(uint16_t*)0x2000024c = htobe16(0x800));
    NONFAILING(STORE_BY_BITMASK(uint8_t, 0x2000024e, 5, 0, 4));
    NONFAILING(STORE_BY_BITMASK(uint8_t, 0x2000024e, 4, 4, 4));
    NONFAILING(STORE_BY_BITMASK(uint8_t, 0x2000024f, 0, 0, 2));
    NONFAILING(STORE_BY_BITMASK(uint8_t, 0x2000024f, 0, 2, 6));
    NONFAILING(*(uint16_t*)0x20000250 = htobe16(0x1c));
    NONFAILING(*(uint16_t*)0x20000252 = htobe16(0));
    NONFAILING(*(uint16_t*)0x20000254 = htobe16(0));
    NONFAILING(*(uint8_t*)0x20000256 = 0);
    NONFAILING(*(uint8_t*)0x20000257 = 2);
    NONFAILING(*(uint16_t*)0x20000258 = htobe16(0));
    NONFAILING(*(uint32_t*)0x2000025a = htobe32(0));
    NONFAILING(*(uint32_t*)0x2000025e = htobe32(-1));
    NONFAILING(*(uint8_t*)0x20000262 = 0x11);
    NONFAILING(*(uint8_t*)0x20000263 = 0);
    NONFAILING(*(uint16_t*)0x20000264 = htobe16(0));
    NONFAILING(*(uint32_t*)0x20000266 = htobe32(0xe0000001));
    ...
    NONFAILING(*(uint32_t*)0x20000154 = 0x2000);
    struct csum_inet csum_1;
    csum_inet_init(&csum_1);
    NONFAILING(csum_inet_update(&csum_1, (const uint8_t*)0x20000262, 8));
    NONFAILING(*(uint16_t*)0x20000264 = csum_inet_digest(&csum_1));
    struct csum_inet csum_2;
    csum_inet_init(&csum_2);
    NONFAILING(csum_inet_update(&csum_2, (const uint8_t*)0x2000024e, 20));
    NONFAILING(*(uint16_t*)0x20000258 = csum_inet_digest(&csum_2));
    syz_emit_ethernet(0x2a, 0x20000240, 0x20000140);
    break;
  }
}
int main(void)
