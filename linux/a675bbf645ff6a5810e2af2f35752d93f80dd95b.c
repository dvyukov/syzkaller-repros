...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000200, "TIPC\x00", 5));
  ...
  case 2:
    ...
    NONFAILING(memcpy((void*)0x20000000, "0\x00\x00\x00", 4));
    NONFAILING(*(uint16_t*)0x20000004 = r[1]);
    NONFAILING(
        memcpy((void*)0x20000006,
               "\x11\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00"
               "\x00\x00\x00\x0c\x41\x00\x00\x00\x14\x00\x14\x62\x72\x6f\x61"
               "\x64\x63\x61\x73\x74\x2d\x15\x45\x5f\x6c\x69\x6e\x6b\x00\x00",
               45));
    NONFAILING(*(uint64_t*)0x20000188 = 3);
