...
// https://syzkaller.appspot.com/bug?id=c97097e0408c6c6f60ac89b78faaf0e42663cbac
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint64_t*)0x20000318 = 0x8090);
  ...
  case 1:
    ...
    NONFAILING(*(uint64_t*)0x2001d010 = 0x7fc);
    ...
    break;
  case 2:
    res = syscall(__NR_pipe, 0x20000340);
    if (res != -1) {
      NONFAILING(r[1] = *(uint32_t*)0x20000340);
