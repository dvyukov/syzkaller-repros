...
// https://syzkaller.appspot.com/bug?id=a9db0ab6a8e0ca14351d
// status:0
...
void loop(void)
{
  ...
  *(uint32_t*)0x2000003c = 0;
  res = syscall(__NR_bpf, 0ul, 0x20000000ul, 0x40ul);
  if (res != -1)
    r[0] = res;
  *(uint64_t*)0x200008c0 = 0;
  *(uint64_t*)0x200008c8 = 0;
  *(uint64_t*)0x200008d0 = 0x20000040;
  *(uint64_t*)0x200008d8 = 0x20000800;
  *(uint32_t*)0x200008e0 = 8;
  *(uint32_t*)0x200008e4 = r[0];
  *(uint64_t*)0x200008e8 = 0;
  *(uint64_t*)0x200008f0 = 0;
  syscall(__NR_bpf, 0x1aul, 0x200008c0ul, 0x38ul);
}
int main(void)
{
