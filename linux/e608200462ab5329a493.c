// SYZFAIL: netlink_send_ext: bad netlink ack type
// https://syzkaller.appspot.com/bug?id=e608200462ab5329a493
// status:0
...
{
  NONFAILING(syz_80211_inject_frame(0, 0x20000880, 0x37e));
}
int main(void)
{
