...
void execute_one(void)
{
  ...
  *(uint8_t*)0x2000046f = 1 + procid * 1;
  *(uint32_t*)0x20000470 = 0;
  *(uint16_t*)0x20000474 = 4;
  *(uint16_t*)0x20000476 = 4;
  *(uint32_t*)0x20000478 = 0x400;
  *(uint64_t*)0x20000480 = 0x10000;
  *(uint32_t*)0x20000488 = 0x6109e526;
  *(uint32_t*)0x2000048c = 0;
  syscall(__NR_ioctl, -1, 0x890c, 0x20000440);
  *(uint32_t*)0x20000240 = 0x3e73;
  syscall(__NR_setsockopt, r[0], 0x103, 7, 0x20000240, 4);
