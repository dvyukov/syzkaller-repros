...
// https://syzkaller.appspot.com/bug?id=5da4d8b36c360984e4bc3cab37a028ebd602f1f5
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20001940, "./file0", 8));
    syscall(__NR_mknod, 0x20001940, 0x1040, 0);
    break;
  case 1:
  ...
  case 3:
    ...
    res = syscall(__NR_openat, 0xffffff9c, 0x200001c0, 0, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 4:
    NONFAILING(*(uint64_t*)0x20000240 = 0x7ffd);
    syscall(__NR_splice, (long)r[1], 0x20000240, (long)r[0], 0, 0x1ff, 1);
    break;
  case 5:
    ...
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x200023c0 = 0x200012c0);
    NONFAILING(*(uint32_t*)0x200023c4 = 0x1000);
    syscall(__NR_preadv, (long)r[2], 0x200023c0, 1, 0);
    break;
  }
}
int main(void)
