...
// https://syzkaller.appspot.com/bug?id=8383687a88291286e925f9b69399d28d8260dde2
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    res = syscall(__NR_socket, 0x2000000000000021, 2, 0xa);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
    NONFAILING(*(uint16_t*)0x200001c0 = 0x21);
    NONFAILING(*(uint16_t*)0x200001c2 = 0);
    NONFAILING(*(uint16_t*)0x200001c4 = 2);
    NONFAILING(*(uint16_t*)0x200001c6 = 0x1c);
    NONFAILING(*(uint16_t*)0x200001c8 = 0xa);
    NONFAILING(*(uint16_t*)0x200001ca = htobe16(0));
    NONFAILING(*(uint32_t*)0x200001cc = htobe32(0));
    NONFAILING(*(uint8_t*)0x200001d0 = 0xfe);
    NONFAILING(*(uint8_t*)0x200001d1 = 0x88);
    ...
    NONFAILING(*(uint8_t*)0x200001df = 1 + procid * 1);
    NONFAILING(*(uint32_t*)0x200001e0 = 0);
    syscall(__NR_connect, r[0], 0x200001c0, 0x24);
    break;
  case 3:
    NONFAILING(*(uint64_t*)0x20005c00 = 0);
    NONFAILING(*(uint32_t*)0x20005c08 = 0x7b);
    NONFAILING(*(uint64_t*)0x20005c10 = 0);
    NONFAILING(*(uint64_t*)0x20005c18 = 0);
    NONFAILING(*(uint64_t*)0x20005c20 = 0x200000c0);
    NONFAILING(*(uint64_t*)0x200000c0 = 0x18);
    NONFAILING(*(uint32_t*)0x200000c8 = 0x110);
    NONFAILING(*(uint32_t*)0x200000cc = 1);
    NONFAILING(memcpy(
        (void*)0x200000d0,
        "\x43\x4b\x1a\x0e\xcc\xcf\x80\xa7\x28\x1c\x59\x12\x44\xd4\x89\x2e\x79"
        "\xae\x7f\xd0\xa5\x8f\x33\x88\xaf\xf1\x43\xce\x6b\x75\x76\x2a\x72\x6d"
        "\x60\x2f\xe6\xa1\xd4\x65\x2c\x81\x51\xa1\x31\x10\x57\x92\xe1\x69\xe2"
        "\xef\xea\xe0\xf5\xec\x65\xfe\x9e\xd2\x16\xe3\xc8\xe6\xbb\x29\xa6\xb4"
        "\x57\x2c\xb0\xa5\xd5\xf8\xe5\x90\x06\xaa\x0d\x49\x0b\x32\xb4\x90\x37"
        "\x8f\x7e\x19\x3a\xc2\xd0\x80\x87\x2d\xf2\x43\x9c\x6d\x39\xf0\x82\x5e"
        "\x35\xfe\xa6\x24\xc1\x8a\x68\x54\x87\xb6\x23\x38\x9f\x7c\x27\x75\x20"
        "\xe1\xa9\x68\x8a\xcb\x70\xe6\xd7\x31\x22\x8c\x09\xe1\xbd\x99\x1c\x21"
        "\x7f\xaa\x80\x85\x3a\xca\x5f\xd4\x2e\x68\x20\x37\x34\x7f\xf1\xbf\x13"
        "\x4f\xda\x7e\x12\x8b\x99\xcf\xec\x9b\x1e\xdb\x1b\x99\x20\xdb\x3a\xd2"
        "\xf7\x43\x7c\x0e\x4c\x2e\x2a\x00\xa8\x15\xf1",
        181));
    NONFAILING(*(uint64_t*)0x20005c28 = 0x18);
    NONFAILING(*(uint32_t*)0x20005c30 = 0);
    NONFAILING(*(uint32_t*)0x20005c38 = 0);
    syscall(__NR_sendmmsg, r[0], 0x20005c00, 0x40000000000037b, 0xc000);
    break;
  case 4:
    res = syscall(__NR_socket, 0x2000000000000021, 2, 0xa);
    if (res != -1)
  ...
  case 5:
    ...
    NONFAILING(*(uint8_t*)0x200001df = 1 + procid * 1);
    NONFAILING(*(uint32_t*)0x200001e0 = 0);
    syscall(__NR_connect, r[1], 0x200001c0, 0x24);
    break;
  case 6:
    NONFAILING(*(uint64_t*)0x20005c00 = 0);
    NONFAILING(*(uint32_t*)0x20005c08 = 0x7b);
    ...
    NONFAILING(memcpy(
        ...
        "\x43\x4b\x1a\x0e\xcc\xcf\x80\xa7\x28\x1c\x59\x12\x44\xd4\x89\x2e\x79"
        "\xae\x7f\xd0\xa5\x8f\x33\x88\xaf\xf1\x43\xce\x6b\x75\x76\x2a\x72\x6d"
        "\x60\x2f\xe6\xa1\xd4\x65\x2c\x81\x51\xa1\x31\x0c\x57\x92\xe1\x69\xe2"
        "\xef\xea\xe0\xf5\xec\x65\xfe\x9e\xd2\x16\xe3\xc8\xe6\xbb\x29\xa6\xb4"
        "\x57\x2c\xb0\xa5\xd5\xf8\xe5\x90\x06\xaa\x0d\x49\x0b\x32\xb4\x90\x37"
        "\x8f\x7e\x19\x3a\xc2\xd0\x80\x87\x2d\xf2\x43\x9c\x6d\x39\xf0\x82\x5e"
        "\x35\xfe\xa6\x24\xc1\x8a\x68\x54\x87\xb6\x23\x38\x9f\x7c\x27\x75\x20"
    ...
    NONFAILING(*(uint32_t*)0x20005c30 = 0);
    NONFAILING(*(uint32_t*)0x20005c38 = 0);
    syscall(__NR_sendmmsg, r[1], 0x20005c00, 0x40000000000037b, 0xc000);
    break;
  }
}
int main(void)
