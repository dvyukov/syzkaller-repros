// general protection fault in __io_arm_poll_handler
// https://syzkaller.appspot.com/bug?id=ba74b85fa15fd7a96437
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    *(uint32_t*)0x20000098 = -1;
    ...
    res = -1;
    res = syz_io_uring_setup(0x6e4, 0x20000080, 0x20ee8000, 0x20656000,
                             0x20000100, 0x20000440);
    if (res != -1) {
  ...
  case 1:
    *(uint32_t*)0x20000140 = 0x307e;
    syz_memcpy_off(r[0], 0x40, 0x20000140, 0, 4);
    break;
  case 2:
    ...
    *(uint16_t*)0x200002aa = 0;
    ...
    syz_io_uring_submit(r[0], r[1], 0x20000280, 0);
    break;
  case 3:
    *(uint8_t*)0x20001240 = 9;
    *(uint8_t*)0x20001241 = 2;
    ...
    *(uint64_t*)0x20001260 = 1;
    *(uint16_t*)0x20001268 = 0;
    *(uint16_t*)0x2000126a = 0;
    memset((void*)0x2000126c, 0, 20);
    syz_io_uring_submit(r[0], r[1], 0x20001240, 0x80);
    break;
  }
}
int main(void)
