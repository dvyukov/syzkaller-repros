...
void execute_one(void)
{
  ...
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x20000740 = htobe32(0xe0000002);
  *(uint32_t*)0x20000744 = htobe32(0x7f000001);
  *(uint32_t*)0x20000748 = 0;
  syscall(__NR_setsockopt, r[0], 0, 0x23, 0x20000740, 0xc);
  ...
  *(uint32_t*)0x20000050 = htobe32(-1);
  syscall(__NR_setsockopt, r[0], 0, 0x29, 0x20000040, 0x14);
  memcpy((void*)0x20000080,
         "lo\000\000\000$\000\000\000\000\000\000\b\000\000\021", 16);
