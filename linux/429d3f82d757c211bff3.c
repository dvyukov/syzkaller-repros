...
// https://syzkaller.appspot.com/bug?id=429d3f82d757c211bff3
// status:6
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x200001c0, "nbd\000", 4);
  res = -1;
  ...
  *(uint16_t*)0x20000260 = 4;
  STORE_BY_BITMASK(uint16_t, , 0x20000262, 7, 0, 14);
  STORE_BY_BITMASK(uint16_t, , 0x20000263, 0, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x20000263, 1, 7, 1);
  *(uint16_t*)0x20000264 = 0xc;
  *(uint16_t*)0x20000266 = 4;
