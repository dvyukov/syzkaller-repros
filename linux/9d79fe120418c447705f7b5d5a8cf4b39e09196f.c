// BUG: using __this_cpu_read() in preemptible [ADDR] code: syzkaller8NUM/3341
// https://syzkaller.appspot.com/bug?id=9d79fe120418c447705f7b5d5a8cf4b39e09196f
// status:invalid
...
void test()
{
  ...
  *(uint16_t*)0x20397fec = (uint16_t)0x11;
  *(uint16_t*)0x20397fee = (uint16_t)0x700;
  *(uint32_t*)0x20397ff0 = (uint32_t)0x0;
  *(uint16_t*)0x20397ff4 = (uint16_t)0x1;
  *(uint8_t*)0x20397ff6 = (uint8_t)0x8000;
  *(uint8_t*)0x20397ff7 = (uint8_t)0x6;
  *(uint8_t*)0x20397ff8 = (uint8_t)0xbb;
  *(uint8_t*)0x20397ff9 = (uint8_t)0xbb;
  *(uint8_t*)0x20397ffa = (uint8_t)0xbb;
  *(uint8_t*)0x20397ffb = (uint8_t)0xbb;
  *(uint8_t*)0x20397ffc = (uint8_t)0xbb;
  *(uint8_t*)0x20397ffd = (uint8_t)0x0;
  *(uint8_t*)0x20397ffe = (uint8_t)0x0;
  *(uint8_t*)0x20397fff = (uint8_t)0x0;
  r[15] =
      syscall(__NR_connect, 0xfffffffffffffffful, 0x20397fecul, 0x14ul);
  r[16] = syscall(__NR_socket, 0xful, 0x3ul, 0x2ul);
  ...
  *(uint32_t*)0x208fe01c = (uint32_t)0x0;
  ...
  *(uint8_t*)0x208fe04f = (uint8_t)0x0;
  r[74] = syscall(__NR_sendmsg, r[16], 0x205f5000ul, 0x0ul);
}
