...
// https://syzkaller.appspot.com/bug?id=653090db2562495901dc
// status:6
...
void execute_call(int call)
{
  ...
  case 9:
    ...
    NONFAILING(*(uint64_t*)0x20000140 = 0x200004c0);
    ...
    NONFAILING(memcpy(
        ...
        "\x66\x73\x63\x00\x00\x00\x00\x08\x00\x02\x00\x00\x00\x00\x00\x4a\x1f"
        "\x0f\x80\x75\xcb\xdb\xe2\x4a\x6c\x44\x8e\xe4\xbb\xaa\xcb\xb0\xc9\x9a"
        "\x2e\xeb\x46\x42\x7c\xe6\x72\x43\xcc\x8e\xe2\xa6\x1c\x16\xfc\x24\xa4"
        "\xb5\x0d\x99\xea\x72\x7e\x6b\x48\x72\xef\x09\x0f\xd8\x37\xd6\x68\x63"
        "\x18\x61\x53\x12\x08\x88\xf3\x64\xdc\xbc\xa4\x9f\xb8\x71\x5a\x7f\x6f"
        "\x73\x2c\x3d\x02\x07\xec\x02\xa9\xa9",
        111));
  ...
  case 10:
    ...
    NONFAILING(*(uint64_t*)0x20000180 = 0x20000600);
    NONFAILING(*(uint32_t*)0x20000600 = 0x44);
    NONFAILING(*(uint16_t*)0x20000604 = 0x2c);
    NONFAILING(*(uint16_t*)0x20000606 = 0xd27);
    ...
    NONFAILING(*(uint32_t*)0x20000614 = r[4]);
    NONFAILING(*(uint16_t*)0x20000618 = 0);
    NONFAILING(*(uint16_t*)0x2000061a = 0);
    NONFAILING(*(uint16_t*)0x2000061c = 0);
    NONFAILING(*(uint16_t*)0x2000061e = 0);
    NONFAILING(*(uint16_t*)0x20000620 = 4);
    NONFAILING(*(uint16_t*)0x20000622 = 0xfff1);
    NONFAILING(*(uint16_t*)0x20000624 = 0xc);
    NONFAILING(*(uint16_t*)0x20000626 = 1);
    NONFAILING(memcpy((void*)0x20000628, "tcindex\000", 8));
    NONFAILING(*(uint16_t*)0x20000630 = 0x14);
    NONFAILING(*(uint16_t*)0x20000632 = 2);
    NONFAILING(*(uint16_t*)0x20000634 = 8);
    NONFAILING(*(uint16_t*)0x20000636 = 5);
    NONFAILING(*(uint16_t*)0x20000638 = 0xd);
    NONFAILING(*(uint16_t*)0x2000063a = 0);
    NONFAILING(*(uint16_t*)0x2000063c = 6);
    NONFAILING(*(uint16_t*)0x2000063e = 2);
    NONFAILING(*(uint16_t*)0x20000640 = 0);
