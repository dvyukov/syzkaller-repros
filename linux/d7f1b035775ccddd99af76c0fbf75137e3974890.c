...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20004ff6, "/dev/dsp#", 10));
    r[0] = syz_open_dev(0x20004ff6, 1, 0);
    break;
  case 2:
    NONFAILING(*(uint64_t*)0x20006ff8 = 0);
    syscall(__NR_ioctl, r[0], 0x800000c004500a, 0x20006ff8);
    break;
  case 3:
    syscall(__NR_read, r[0], 0x20a26000, 0x97);
    break;
  }
}
