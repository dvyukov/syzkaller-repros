...
// https://syzkaller.appspot.com/bug?id=ed76a01d848d958557c1
// status:0
...
uint64_t r[5] = {0xffffffffffffffff, 0x0, 0xffffffffffffffff, 0x0, 0x0};
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_ioctl, -1, 0xc0709411, 0ul);
    break;
  case 2:
    NONFAILING(*(uint64_t*)0x20000000 = 0x81);
    syscall(__NR_ioctl, r[0], 0x40082404, 0x20000000ul);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000280, "{\201!)\\\360\000", 7));
    syscall(__NR_ioctl, r[0], 0x40082406, 0x20000280ul);
    break;
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_sched_setscheduler, r[1], 5ul, 0ul);
    break;
  case 6:
    syscall(__NR_sendfile, r[0], -1, 0ul, 9ul);
    break;
  case 7:
  ...
  case 8:
    ...
    NONFAILING(memset((void*)0x20000040, 2, 6));
    NONFAILING(syz_80211_join_ibss(0x20000140, 0x20000040, 6, 0));
    break;
  case 9:
  ...
  case 11:
    ...
    syscall(__NR_lsetxattr, 0x200001c0ul, 0ul, 0ul, 0x5cul, 0ul);
    break;
  case 12:
    ...
    if (res != -1)
      NONFAILING(r[4] = *(uint32_t*)0x20000710);
    break;
  case 13:
  ...
  case 16:
    ...
    NONFAILING(*(uint64_t*)0x20000350 = 0x200001c0);
