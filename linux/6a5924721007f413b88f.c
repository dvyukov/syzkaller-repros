// BUG: stack guard page was hit in file_open (10)
// https://syzkaller.appspot.com/bug?id=6a5924721007f413b88f
// status:3
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    syz_mount_image(0x20000080, 0x200000c0, 0, 0, 0, 0x40000, 0x20000500);
    {
      int i;
      for (i = 0; i < 64; i++) {
        syz_mount_image(0x20000080, 0x200000c0, 0, 0, 0, 0x40000, 0x20000500);
