...
// https://syzkaller.appspot.com/bug?id=f728811dddf8a78ac760
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    res = -1;
    NONFAILING(res = syz_usbip_server_init(2));
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x20004780 = htobe32(3));
    NONFAILING(*(uint32_t*)0x20004784 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004788 = htobe32(0));
    NONFAILING(*(uint32_t*)0x2000478c = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004790 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004794 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004798 = htobe32(0));
    NONFAILING(*(uint32_t*)0x2000479c = htobe32(0));
    NONFAILING(*(uint32_t*)0x200047a0 = htobe32(0x12));
    NONFAILING(*(uint32_t*)0x200047a4 = htobe32(0));
    NONFAILING(*(uint64_t*)0x200047a8 = htobe64(0));
    NONFAILING(*(uint32_t*)0x200047b0 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200047b4 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200047b8 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200047bc = htobe32(0));
    NONFAILING(*(uint32_t*)0x200047c0 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200047c4 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200047c8 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200047cc = htobe32(0));
    NONFAILING(*(uint32_t*)0x200047d0 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200047d4 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200047d8 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200047dc = htobe32(0));
    NONFAILING(*(uint32_t*)0x200047e0 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200047e4 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200047e8 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200047ec = htobe32(0));
    NONFAILING(*(uint32_t*)0x200047f0 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200047f4 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200047f8 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200047fc = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004800 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004804 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004808 = htobe32(0));
    NONFAILING(*(uint32_t*)0x2000480c = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004810 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004814 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004818 = htobe32(0));
    NONFAILING(*(uint32_t*)0x2000481c = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004820 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004824 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004828 = htobe32(0));
    NONFAILING(*(uint32_t*)0x2000482c = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004830 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004834 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004838 = htobe32(0));
    NONFAILING(*(uint32_t*)0x2000483c = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004840 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004844 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004848 = htobe32(0));
    NONFAILING(*(uint32_t*)0x2000484c = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004850 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004854 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004858 = htobe32(0));
    NONFAILING(*(uint32_t*)0x2000485c = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004860 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004864 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004868 = htobe32(0));
    NONFAILING(*(uint32_t*)0x2000486c = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004870 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004874 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004878 = htobe32(0));
    NONFAILING(*(uint32_t*)0x2000487c = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004880 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004884 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004888 = htobe32(0));
    NONFAILING(*(uint32_t*)0x2000488c = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004890 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004894 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20004898 = htobe32(0));
    NONFAILING(*(uint32_t*)0x2000489c = htobe32(0));
    NONFAILING(*(uint32_t*)0x200048a0 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200048a4 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200048a8 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200048ac = htobe32(0));
    NONFAILING(*(uint32_t*)0x200048b0 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200048b4 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200048b8 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200048bc = htobe32(0));
    NONFAILING(*(uint32_t*)0x200048c0 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200048c4 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200048c8 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200048cc = htobe32(0));
    syscall(__NR_write, r[0], 0x20004780ul, 0x150ul);
    break;
  }
}
int main(void)
