...
// https://syzkaller.appspot.com/bug?id=04649b68561aae62c5ff
// status:0
...
void execute_call(int call)
{
  ...
  case 3:
    *(uint32_t*)0x20000280 = 0x14;
    syscall(__NR_getsockname, r[1], 0x20000100ul, 0x20000280ul);
    break;
  case 4:
    syscall(__NR_ioctl, r[0], 0x400454da, 0ul);
    break;
  case 5:
  ...
  case 10:
    ...
    *(uint64_t*)0x20000200 = 0x200006c0;
    *(uint32_t*)0x200006c0 = 0x20;
    *(uint16_t*)0x200006c4 = 0x11;
    *(uint16_t*)0x200006c6 = 0x40d;
    *(uint32_t*)0x200006c8 = 0;
    *(uint32_t*)0x200006cc = 0;
    *(uint8_t*)0x200006d0 = 0;
    *(uint8_t*)0x200006d1 = 0;
    *(uint16_t*)0x200006d2 = 0;
    *(uint32_t*)0x200006d4 = r[4];
