...
// https://syzkaller.appspot.com/bug?id=6e14de8b553308b5507c
// status:0
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x2000027f = 0;
  syz_io_uring_submit(r[1], r[2], 0x20000240, 0x1000);
  memcpy((void*)0x20000280, "./bus\000", 6);
  res = syscall(__NR_open, 0x20000280ul, 0x127842ul, 0ul);
  if (res != -1)
    r[3] = res;
  ...
  *(uint64_t*)0x20000500 = 0x20000100;
  *(uint64_t*)0x20000508 = 0x14;
  *(uint32_t*)0x20000018 = 0x3a;
  ...
  *(uint8_t*)0x2000003f = 0;
  ...
  syscall(__NR_io_uring_enter, r[0], 0x450c, 0, 0ul, 0ul, 0x34ul);
}
int main(void)
{
