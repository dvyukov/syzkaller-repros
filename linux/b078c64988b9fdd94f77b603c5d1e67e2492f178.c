...
// https://syzkaller.appspot.com/bug?id=b078c64988b9fdd94f77b603c5d1e67e2492f178
// status:open
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000094 = htobe32(0xe0000002);
  *(uint32_t*)0x20000098 = 0;
  syscall(__NR_connect, r[0], 0x20000080, 0x1c);
  syscall(__NR_sendmmsg, r[1], 0x20005fc0, 0x80000000000001b, 0);
}
int main(void)
{
