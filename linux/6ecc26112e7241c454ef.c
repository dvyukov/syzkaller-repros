...
// https://syzkaller.appspot.com/bug?id=6ecc26112e7241c454ef
// status:0
...
int main(void)
{
  ...
  *(uint8_t*)0x200006d9 = 0;
  ...
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x20000000, "\x08\xe3\x00\x4e", 4);
  syz_usb_ep_write(r[0], 0x82, 0xc, 0x20000000);
  *(uint16_t*)0x20000040 = 0;
  *(uint16_t*)0x20000042 = 0x4e00;
  syz_usb_ep_write(r[0], 0x82, 4, 0x20000040);
  return 0;
}
