...
// https://syzkaller.appspot.com/bug?id=343d2f641a74d6243b9bc9d1816bd99652e4c606
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000080, "/dev/uinput", 12));
  ...
  case 3:
    ...
    NONFAILING(*(uint16_t*)0x20000306 = 0);
    NONFAILING(memcpy(
        (void*)0x20000308,
    ...
    syscall(__NR_ioctl, r[0], 0x5501, 0x20000300);
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000180, "/dev/input/event#", 18));
    syz_open_dev(0x20000180, 4, 0);
    break;
  }
}
int main(void)
