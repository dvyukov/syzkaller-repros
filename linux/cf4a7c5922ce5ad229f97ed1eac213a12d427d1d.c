...
// https://syzkaller.appspot.com/bug?id=cf4a7c5922ce5ad229f97ed1eac213a12d427d1d
// status:open
...
{
  long res = 0;
  res = syscall(__NR_socket, 0xa, 0x100000000002, 0);
  if (res != -1)
    r[0] = res;
  ...
  *(uint32_t*)0x200000d8 = 0;
  syscall(__NR_sendto, r[0], 0x20000300, 0xfd90, 0x400806e, 0x200000c0, 0x1c);
  ...
  *(uint32_t*)0x20000198 = 0;
  syscall(__NR_sendto, r[0], 0x20000100, 0xe, 0, 0x20000180, 0x1c);
}
int main(void)
{
