...
// https://syzkaller.appspot.com/bug?id=452e9465a3b2817fa4c2
// status:0
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    break;
  case 4:
    syscall(__NR_getsockopt, r[1], 1, 3, 0ul, 0ul);
    break;
  case 5:
    res = -1;
    NONFAILING(res = syz_init_net_socket(0x1f, 5, 2));
  ...
  case 6:
    ...
    break;
  case 7:
    syscall(__NR_ioctl, r[2], 0x40049409, r[3]);
    break;
  case 8:
    syscall(__NR_ioctl, r[0], 0x8935, 0ul);
    break;
  case 9:
  ...
  case 11:
    ...
    syscall(__NR_connect, r[4], 0x200000c0ul, 0xeul);
    break;
  case 12:
    ...
    syscall(__NR_bind, r[4], 0x20000100ul, 0xeul);
    break;
  }
}
int main(void)
