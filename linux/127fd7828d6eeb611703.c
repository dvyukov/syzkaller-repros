...
// https://syzkaller.appspot.com/bug?id=127fd7828d6eeb611703
// status:6
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    res = syscall(__NR_ioctl, -1, 0xae01, 0ul);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    NONFAILING(*(uint64_t*)0x200000c0 = 8);
    NONFAILING(*(uint64_t*)0x200000c8 = 0x20000080);
    NONFAILING(
        memcpy((void*)0x20000080,
               "\xba\xa1\x00\xb0\x00\xee\xf3\x6c\xba\x21\x00\xec\x66\xb9\x80"
               "\x00\x00\xc0\x0f\x32\x66\x35\x00\x10\x00\x00\x0f\x30\xba\xd1"
               "\x04\xec\xc8\x00\x80\xd2\x67\xd9\xf8\xf3\x0f\x1b\xb4\x29\x00"
               "\x0f\x20\xc0\x66\x35\x20\x00\x00\x00\x0f\x22\xc0\x67\xf3\xaf",
               60));
    NONFAILING(*(uint64_t*)0x200000d0 = 0x3c);
    NONFAILING(syz_kvm_setup_cpu(-1, -1, 0x20016000, 0x200000c0, 1, 0, 0, 0));
    break;
  case 2:
    syscall(__NR_ioctl, r[0], 0xae60, 0);
    break;
  case 3:
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000728, 1, 5, 1));
  ...
  case 4:
    ...
    NONFAILING(*(uint32_t*)0x20000288 = 0x100000);
    NONFAILING(*(uint32_t*)0x2000028c = 0);
    syscall(__NR_ioctl, r[0], 0x4010ae67, 0x20000280ul);
    break;
  case 5:
  ...
  case 6:
    ...
    break;
  case 7:
    NONFAILING(*(uint8_t*)0x20000300 = 0x7f);
    NONFAILING(*(uint8_t*)0x20000301 = 0x45);
    NONFAILING(*(uint8_t*)0x20000302 = 0x4c);
    NONFAILING(*(uint8_t*)0x20000303 = 0x46);
    NONFAILING(*(uint8_t*)0x20000304 = 0xc7);
    NONFAILING(*(uint8_t*)0x20000305 = 0);
    NONFAILING(*(uint8_t*)0x20000306 = 0);
    NONFAILING(*(uint8_t*)0x20000307 = 0x60);
    NONFAILING(*(uint64_t*)0x20000308 = 0);
    NONFAILING(*(uint16_t*)0x20000310 = 2);
    NONFAILING(*(uint16_t*)0x20000312 = 0x3e);
    NONFAILING(*(uint32_t*)0x20000314 = 9);
    NONFAILING(*(uint64_t*)0x20000318 = 0x19b);
    NONFAILING(*(uint64_t*)0x20000320 = 0x40);
    NONFAILING(*(uint64_t*)0x20000328 = 0);
    NONFAILING(*(uint32_t*)0x20000330 = 4);
    NONFAILING(*(uint16_t*)0x20000334 = 0);
    NONFAILING(*(uint16_t*)0x20000336 = 0x38);
    NONFAILING(*(uint16_t*)0x20000338 = 1);
    NONFAILING(*(uint16_t*)0x2000033a = 2);
    NONFAILING(*(uint16_t*)0x2000033c = 0);
    NONFAILING(*(uint16_t*)0x2000033e = 1);
    NONFAILING(*(uint32_t*)0x20000340 = 5);
    NONFAILING(*(uint32_t*)0x20000344 = 0);
    NONFAILING(*(uint64_t*)0x20000348 = 9);
    NONFAILING(*(uint64_t*)0x20000350 = 6);
    NONFAILING(*(uint64_t*)0x20000358 = 1);
    NONFAILING(*(uint64_t*)0x20000360 = 0x101);
    NONFAILING(*(uint64_t*)0x20000368 = 0xbb);
    NONFAILING(*(uint64_t*)0x20000370 = 0);
    NONFAILING(memcpy(
        (void*)0x20000378,
        "\x2e\x13\x18\xea\x9a\xde\xd7\xa4\xeb\x20\x56\x6d\xf2\x28\x3c\x2b\x5d"
        "\x0e\x1d\xf1\x37\x3f\xe4\x97\x30\x0b\xae\x77\x68\x2c\xda\x19\xa9\xe5"
        "\x67\x32\x8d\xdf\xf3\x22\x3c\xa1\xfd\x95\xa6\x9f\x5a\x04\x31\x18\x45"
        "\xe7\x00\xb8\x3d\x34\xb9\xd2\x0b\xf3\xf7\x1a\x6c\x81\xd6\xf5\x8f\x96"
        "\x9c\x98\xca\x4d\x8a\xfb\x94\xfe\xf9\x06\xc9\x8e\x20\xc2\xaa\x14\x50"
        "\xee\x68\x4a\x90\x0d\x6c\xda\xf2\x17\xc6\x58\xc6\x46\xe5\xd1\xff\x95"
        "\x7b\xa3\x9d\x05\x7b\xf0\x84\x97\xaf\xa9\xe3\xef\xff\x1d\xfb\xce\xfe"
        "\xb0\xd0\xcc\xf8\xd0\x02\xc5\xea\x60\xaa\x45\x8b\x93\xa8\x7e\x89\x12"
        "\x21\xb2\xf9\xae\xd4\x9e\x08\x15\x32",
        145));
    NONFAILING(memset((void*)0x20000409, 0, 256));
    NONFAILING(memset((void*)0x20000509, 0, 256));
    NONFAILING(memset((void*)0x20000609, 0, 256));
    NONFAILING(memset((void*)0x20000709, 0, 256));
    NONFAILING(memset((void*)0x20000809, 0, 256));
    NONFAILING(memset((void*)0x20000909, 0, 256));
    NONFAILING(memset((void*)0x20000a09, 0, 256));
    NONFAILING(memset((void*)0x20000b09, 0, 256));
    NONFAILING(memset((void*)0x20000c09, 0, 256));
    syscall(__NR_write, r[2], 0x20000300ul, 0xa09ul);
    break;
  case 8:
    syscall(__NR_preadv, r[2], 0x20000280ul, 0x18ul, 0xd9f, 0);
    break;
  case 9:
    NONFAILING(*(uint64_t*)0x20000440 = 0x20000140);
    NONFAILING(*(uint64_t*)0x20000140 = 0);
    NONFAILING(*(uint32_t*)0x20000148 = 0);
    NONFAILING(*(uint32_t*)0x2000014c = 0);
    NONFAILING(*(uint16_t*)0x20000150 = 5);
    NONFAILING(*(uint16_t*)0x20000152 = 0);
    NONFAILING(*(uint32_t*)0x20000154 = r[1]);
    NONFAILING(*(uint64_t*)0x20000158 = 0x200002c0);
    NONFAILING(memcpy(
        (void*)0x200002c0,
        "\x1d\xfb\xbd\x1f\x30\x01\x60\x1a\xd8\xef\x42\x0d\xca\xac\x8f\xaa\x66"
        "\x9f\x41\x59\xc7\x68\x02\x1f\x15\xfc\x64\x02\x97\x50\x26\xa4\x1d\x94"
        "\x44\x9d\x19\x91\x67\x81\xdb\x24\x25\xcc\xb7\xb4\x55\x05\x24\x1b\xe6"
        "\x95\xa1\x53\xbb\x28\xe5\xb7\x65\x17\xdf\xf9\xff\x44\x98\x67\x18\xa2"
        "\x02\x2d\x0f\x1d\xdf\x5d\x62\xa2\x45\xf5\x02\xf5\x87\xe3\xa2\xc2\xd0"
        "\x1b\x00\x49\xdd\xd6\xb1\xcf\xa9\x6f\x59\x72\x3d\x0f\xdf\xd6\x49\xe8"
        "\xb9\xdb\xb3\xbd\x96\x6f\x7c\x3d\x4f\xe8\x57\x6e\x58\x7c\x4c\xe1\xa1"
        "\x10\x4e\xd1\x55\xc9\x8c\x5f\x79\xd9\x5a\xff\xff\xec\x61\x79\x17\xd5"
        "\x0f\x55\xd7\xa4\x8f\x02\x3b\xe7\x6a\xde\xec\xe3\xf8\x98\x82\xfe\x3e"
        "\xda\x25\xb4\xea\x4b\x50\xa6\x07\x0f\x87\xbb\x5b\x08\xf5\xb8\xe5\x43"
        "\x36\xf9\xd2\xde\x4a\xf6\x54\xe9\x3f\x15\xbd\xc5\xc1\x0f\x9c\xe1\xa1"
        "\x90\x6d\xf8\x38\xe8\xe2\x55\xcf\x05\x3d\x4a\x63\x26\xa5\xa1\x21\xff"
        "\x70\x7b\xe0\x9e\x0b\x0d\x0e\xf3\xa4\xb6\x1e\xb3",
        216));
    NONFAILING(*(uint64_t*)0x20000160 = 0xd8);
    NONFAILING(*(uint64_t*)0x20000168 = 0x80000001);
    NONFAILING(*(uint64_t*)0x20000170 = 0);
    NONFAILING(*(uint32_t*)0x20000178 = 3);
    NONFAILING(*(uint32_t*)0x2000017c = r[2]);
    NONFAILING(*(uint64_t*)0x20000448 = 0x20000180);
    NONFAILING(*(uint64_t*)0x20000180 = 0);
    NONFAILING(*(uint32_t*)0x20000188 = 0);
    NONFAILING(*(uint32_t*)0x2000018c = 0);
    NONFAILING(*(uint16_t*)0x20000190 = 0x1014);
    NONFAILING(*(uint16_t*)0x20000192 = 3);
    NONFAILING(*(uint32_t*)0x20000194 = r[0]);
    NONFAILING(*(uint64_t*)0x20000198 = 0x200003c0);
    NONFAILING(
        memcpy((void*)0x200003c0,
               "\xdc\xce\xa4\x2e\x39\x8f\x67\xaa\xb0\x5b\x46\xf8\xb0\x1e\x9c"
               "\xf0\x8b\x10\x9f\xe3\x8e\x98\x74\xc9\x68\x7b\x36\x4d\x34\xed"
               "\x7e\x2b\x77\xc6\x8d\x14\x00\xf3\x1a\x59\xc9\xd6\x91\x7a\x66"
               "\xcd\xfd\x3f\xd4\xb9\x48\x79\xbe\xe1\x54\x7f\xf5\x24\x05",
               59));
    NONFAILING(*(uint64_t*)0x200001a0 = 0x3b);
    NONFAILING(*(uint64_t*)0x200001a8 = 0xb173);
    NONFAILING(*(uint64_t*)0x200001b0 = 0);
    NONFAILING(*(uint32_t*)0x200001b8 = 2);
    NONFAILING(*(uint32_t*)0x200001bc = -1);
    syscall(__NR_io_submit, 0ul, 2ul, 0x20000440ul);
    break;
  case 10:
    res = syscall(__NR_ioctl, r[0], 0xae41, 0ul);
    if (res != -1)
      r[3] = res;
    break;
  case 11:
    ...
    syscall(__NR_ioctl, r[0], 0x4020ae46, 0x20000000ul);
    break;
  case 12:
    NONFAILING(*(uint32_t*)0x20000040 = 0x1ff);
    NONFAILING(*(uint32_t*)0x20000044 = 1);
    NONFAILING(*(uint64_t*)0x20000048 = 0);
    NONFAILING(*(uint64_t*)0x20000050 = 0x2000);
    NONFAILING(*(uint64_t*)0x20000058 = 0x2001f000);
    syscall(__NR_ioctl, r[0], 0x4020ae46, 0x20000040ul);
    break;
  case 13:
    NONFAILING(*(uint64_t*)0x200001c0 = 0);
    NONFAILING(*(uint64_t*)0x200001c8 = 0);
    NONFAILING(*(uint64_t*)0x200001d0 = 0x10007f4);
    NONFAILING(*(uint64_t*)0x200001d8 = 0);
    NONFAILING(*(uint64_t*)0x200001e0 = 0);
    NONFAILING(*(uint64_t*)0x200001e8 = 0);
    NONFAILING(*(uint64_t*)0x200001f0 = 0x10000020000000fb);
    NONFAILING(*(uint64_t*)0x200001f8 = 0);
    NONFAILING(*(uint64_t*)0x20000200 = 0);
    NONFAILING(*(uint64_t*)0x20000208 = 0xfffffffffffffffc);
    ...
    NONFAILING(*(uint64_t*)0x20000240 = 0x100000);
    NONFAILING(*(uint64_t*)0x20000248 = 0x200400);
    syscall(__NR_ioctl, r[3], 0x4090ae82, 0x200001c0ul);
    break;
  case 14:
  ...
  case 15:
    ...
    break;
  case 16:
    NONFAILING(*(uint32_t*)0x20001500 = 1);
    NONFAILING(*(uint32_t*)0x20001504 = 0x80);
    NONFAILING(*(uint8_t*)0x20001508 = 0);
    NONFAILING(*(uint8_t*)0x20001509 = 0);
    NONFAILING(*(uint8_t*)0x2000150a = 0);
    NONFAILING(*(uint8_t*)0x2000150b = -1);
    NONFAILING(*(uint32_t*)0x2000150c = 0);
    NONFAILING(*(uint64_t*)0x20001510 = 0x7fffffff);
    NONFAILING(*(uint64_t*)0x20001518 = 0x24000);
    NONFAILING(*(uint64_t*)0x20001520 = 0);
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 0, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 1, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 1, 2, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 3, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 4, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 5, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 7, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 8, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 9, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 1, 10, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 11, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 12, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 1, 13, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 1, 14, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 15, 2));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 17, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 18, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 19, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 20, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 21, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 1, 22, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 23, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 24, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 25, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 26, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 27, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 1, 28, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 29, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 30, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 31, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 1, 32, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 33, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 1, 34, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 35, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 36, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 1, 37, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001528, 0, 38, 26));
    NONFAILING(*(uint32_t*)0x20001530 = 0);
    NONFAILING(*(uint32_t*)0x20001534 = 4);
    NONFAILING(*(uint64_t*)0x20001538 = 0);
    NONFAILING(*(uint64_t*)0x20001540 = 0xea13);
    NONFAILING(*(uint64_t*)0x20001548 = 0x2000);
    NONFAILING(*(uint64_t*)0x20001550 = 0x1397);
    NONFAILING(*(uint32_t*)0x20001558 = 0);
    NONFAILING(*(uint32_t*)0x2000155c = 9);
    NONFAILING(*(uint64_t*)0x20001560 = 0);
    NONFAILING(*(uint32_t*)0x20001568 = 0x4fa2);
    NONFAILING(*(uint16_t*)0x2000156c = 1);
    NONFAILING(*(uint16_t*)0x2000156e = 0);
    NONFAILING(*(uint32_t*)0x20001570 = 0);
    NONFAILING(*(uint32_t*)0x20001574 = 0);
    NONFAILING(*(uint64_t*)0x20001578 = 0);
    syscall(__NR_perf_event_open, 0x20001500ul, 0, 4ul, r[4], 0xbul);
    break;
  }
}
int main(void)
