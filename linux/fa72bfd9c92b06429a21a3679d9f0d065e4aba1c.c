// WARNING: bad usercopy in corrupted
// https://syzkaller.appspot.com/bug?id=fa72bfd9c92b06429a21a3679d9f0d065e4aba1c
// status:invalid
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x200001c0, "/dev/kvm", 9));
  ...
  case 3:
    ...
    NONFAILING(memcpy(
        (void*)0x20000000,
        "\x47\x0f\xc7\x3d\x6e\x00\x00\x00\x66\x44\xf4\x42\x0f\xc7\xae\x47\x00"
        "\x00\x00\x3e\x45\xdf\xdc\xf2\x3e\xf3\x7b\xb7\x66\xba\xf8\x0c\xb8\x67"
        "\x49\x31\x8d\xef\x66\xba\xfc\x0c\xb0\x1e\xee\xb9\x0d\x03\x00\x00\xb8"
        "\x00\x00\xc0\xfe\xba\x00\x00\x00\x00\x0f\x30\xb9\x51\x08\x00\x00\x0f"
        "\x32\x0f\x38\x08\x57\x00\x0f\x01\xca",
        77));
    NONFAILING(*(uint64_t*)0x20000090 = 0x4d);
    syz_kvm_setup_cpu(r[1], r[2], 0x20fdd000, 0x20000080, 1, -1, 0x200000c0, 0);
    break;
  case 4:
