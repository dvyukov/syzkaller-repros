...
// https://syzkaller.appspot.com/bug?id=4be0cca7a67a1c49b8be
// status:0
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    break;
  case 4:
    syscall(__NR_preadv, r[1], 0ul, 0ul, 0, 0);
    break;
  case 5:
    syscall(__NR_fcntl, r[1], 0x40eul, 0ul);
    break;
  case 6:
    syscall(__NR_creat, 0ul, 0xful);
    break;
  case 7:
    syscall(__NR_sendmsg, r[0], 0ul, 0x40ul);
    break;
  case 8:
    memcpy((void*)0x20000b80, "/dev/vbi#\000", 10);
    res = -1;
    res = syz_open_dev(0x20000b80, 2 + procid * 4, 2);
    if (res != -1)
      r[2] = res;
    break;
  case 9:
    syscall(__NR_sendfile, r[2], r[0], 0ul, 9ul);
    break;
  case 10:
