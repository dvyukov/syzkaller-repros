...
// https://syzkaller.appspot.com/bug?id=8044ba05d216071301de0b17ee6d3e13064412f3
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    memcpy((void*)0x200004c0, "/dev/infiniband/rdma_cm\000", 24);
  ...
  case 7:
    ...
    *(uint32_t*)0x2000020c = 4;
    ...
    break;
  case 8:
    syscall(__NR_openat, 0xffffff9c, 0, 0x26e1, 0);
    break;
  }
}
int main(void)
