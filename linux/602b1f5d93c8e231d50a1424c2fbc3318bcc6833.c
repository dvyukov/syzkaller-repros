...
// https://syzkaller.appspot.com/bug?id=602b1f5d93c8e231d50a1424c2fbc3318bcc6833
// status:open
...
void execute_call(int call)
{
  ...
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_sendto, r[2], 0x20000000, 0, 0, 0, 0);
    break;
  case 6:
    syscall(__NR_splice, r[0], 0, r[1], 0, 0x10000200, 0);
    break;
  }
}
int main(void)
