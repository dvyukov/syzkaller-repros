// BUG: soft lockup in __tasklet_hrtimer_trampoline
// https://syzkaller.appspot.com/bug?id=c8080eddd85122401e4f
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint64_t*)0x20000050 = 0x3c43);
  ...
  case 1:
    ...
    NONFAILING(*(uint8_t*)0x2025c008 = 0x15);
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2025c028, 0, 29, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2025c028, 0, 30, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2025c028, 0, 31, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2025c028, 0, 32, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2025c028, 0, 33, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2025c028, 0, 34, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2025c028, 0, 35, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2025c028, 0, 36, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2025c028, 0, 37, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2025c028, 0, 38, 26));
    ...
    NONFAILING(*(uint32_t*)0x2025c074 = 0);
    NONFAILING(*(uint64_t*)0x2025c078 = 0);
    syscall(__NR_perf_event_open, 0x2025c000ul, 0, 0xff7ffffffffffffful, -1,
            0ul);
    break;
  case 2:
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200000e8, 0, 36, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200000e8, 0, 37, 1));
    ...
    res = syscall(__NR_perf_event_open, 0x200000c0ul, 0, -1ul, -1, 0ul);
    if (res != -1)
      r[0] = res;
    break;
  case 3:
    syscall(__NR_mmap, 0x20ffc000ul, 0x3000ul, 0ul, 0x11ul, r[0], 0ul);
    break;
  case 4:
    syscall(__NR_mmap, 0x20000000ul, 0xe7e000ul, 0ul, 0x40031ul, -1, 0ul);
    break;
  }
}
int main(void)
