...
// https://syzkaller.appspot.com/bug?id=c4b9303500a21750b250
// status:0
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x200002d8 = -1;
  ...
  res = -1;
  res = syz_io_uring_setup(0x495a, 0x200002c0, 0x20ee7000, 0x20ffc000,
  ...
  *(uint32_t*)0x2000002c = r[0];
  ...
  syscall(__NR_io_uring_enter, r[0], 0x409e, 0, 0ul, 0ul, 0ul);
}
int main(void)
{
