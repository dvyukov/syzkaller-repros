...
// https://syzkaller.appspot.com/bug?id=08e6343a8cbd89b0c9d8
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_setsockopt, -1, 0x29, 0x40, 0ul, 0ul);
    break;
  case 1:
  ...
  case 2:
    ...
    NONFAILING(*(uint32_t*)0x200002e4 = 3);
    NONFAILING(*(uint32_t*)0x200002e8 = 0x238);
    ...
    NONFAILING(*(uint32_t*)0x200002fc = 0xd0);
    NONFAILING(*(uint32_t*)0x20000300 = 0x1a0);
    NONFAILING(*(uint32_t*)0x20000304 = 0x1a0);
    NONFAILING(*(uint32_t*)0x20000308 = 0x1a0);
    NONFAILING(*(uint32_t*)0x2000030c = 0x1a0);
    NONFAILING(*(uint32_t*)0x20000310 = 0x1a0);
    NONFAILING(*(uint32_t*)0x20000314 = 3);
    NONFAILING(*(uint64_t*)0x20000318 = 0);
    NONFAILING(*(uint8_t*)0x20000320 = 0xac);
    NONFAILING(*(uint8_t*)0x20000321 = 0x14);
    NONFAILING(*(uint8_t*)0x20000322 = 0x14);
    NONFAILING(*(uint8_t*)0x20000323 = 0xaa);
    NONFAILING(*(uint32_t*)0x20000324 = htobe32(0xe0000001));
    NONFAILING(*(uint32_t*)0x20000328 = htobe32(0));
    NONFAILING(*(uint32_t*)0x2000032c = htobe32(-1));
    NONFAILING(memcpy((void*)0x20000330,
                      "team0\000\000\000\000\000\000\000\000\000\000\000", 16));
    NONFAILING(memcpy((void*)0x20000340, "veth1_to_bond\000\000\000", 16));
    NONFAILING(*(uint8_t*)0x20000350 = 0);
    NONFAILING(*(uint8_t*)0x20000360 = 0);
    NONFAILING(*(uint16_t*)0x20000370 = 0);
    NONFAILING(*(uint8_t*)0x20000372 = 0);
    NONFAILING(*(uint8_t*)0x20000373 = 0);
    NONFAILING(*(uint32_t*)0x20000374 = 0);
    NONFAILING(*(uint16_t*)0x20000378 = 0x70);
    NONFAILING(*(uint16_t*)0x2000037a = 0xd0);
    NONFAILING(*(uint32_t*)0x2000037c = 0);
    NONFAILING(*(uint64_t*)0x20000380 = 0);
    NONFAILING(*(uint64_t*)0x20000388 = 0);
    NONFAILING(*(uint16_t*)0x20000390 = 0x60);
    NONFAILING(memcpy((void*)0x20000392,
    ...
    NONFAILING(*(uint8_t*)0x200003b4 = 1);
    NONFAILING(*(uint8_t*)0x200003b5 = 0x80);
    NONFAILING(*(uint8_t*)0x200003b6 = 0xc2);
    NONFAILING(*(uint8_t*)0x200003b7 = 0);
    NONFAILING(*(uint8_t*)0x200003b8 = 0);
    NONFAILING(*(uint8_t*)0x200003b9 = 0);
    NONFAILING(*(uint16_t*)0x200003ba = 0);
    NONFAILING(*(uint16_t*)0x200003bc = 0);
    NONFAILING(*(uint16_t*)0x200003be = 0);
    NONFAILING(*(uint16_t*)0x200003c0 = 0);
    NONFAILING(*(uint16_t*)0x200003c2 = 0);
    NONFAILING(*(uint16_t*)0x200003c4 = 0);
    NONFAILING(*(uint16_t*)0x200003c6 = 0);
    NONFAILING(*(uint16_t*)0x200003c8 = 0);
    NONFAILING(*(uint16_t*)0x200003ca = 0);
    NONFAILING(*(uint16_t*)0x200003cc = 0);
    NONFAILING(*(uint16_t*)0x200003ce = 0);
    NONFAILING(*(uint16_t*)0x200003d0 = 0);
    NONFAILING(*(uint16_t*)0x200003d2 = 0);
    NONFAILING(*(uint16_t*)0x200003d4 = 0);
    NONFAILING(*(uint16_t*)0x200003d6 = 0);
    NONFAILING(*(uint16_t*)0x200003d8 = 0);
    NONFAILING(*(uint16_t*)0x200003da = 0);
    NONFAILING(*(uint16_t*)0x200003dc = 0);
    NONFAILING(*(uint32_t*)0x200003e0 = 0);
    NONFAILING(*(uint32_t*)0x200003e4 = 0);
    NONFAILING(*(uint64_t*)0x200003e8 = 0);
    NONFAILING(*(uint32_t*)0x200003f0 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200003f4 = htobe32(-1));
    NONFAILING(*(uint32_t*)0x200003f8 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200003fc = htobe32(0));
    NONFAILING(memcpy((void*)0x20000400,
                      "wg0\000\000\000\000\000\000\000\000\000\000\000\000\000",
                      16));
    NONFAILING(memcpy((void*)0x20000410, "team_slave_1\000\000\000\000", 16));
    NONFAILING(*(uint8_t*)0x20000420 = 0);
    ...
    NONFAILING(*(uint16_t*)0x20000448 = 0x70);
    NONFAILING(*(uint16_t*)0x2000044a = 0xd0);
    NONFAILING(*(uint32_t*)0x2000044c = 0);
    NONFAILING(*(uint64_t*)0x20000450 = 0);
    NONFAILING(*(uint64_t*)0x20000458 = 0);
    NONFAILING(*(uint16_t*)0x20000460 = 0x60);
    NONFAILING(memcpy((void*)0x20000462,
                      "CLUSTERIP\000\000\000\000\000\000\000\000\000\000\000"
                      "\000\000\000\000\000\000\000\000\000",
                      29));
    NONFAILING(*(uint8_t*)0x2000047f = 0);
    NONFAILING(*(uint32_t*)0x20000480 = 1);
    NONFAILING(memset((void*)0x20000484, 170, 5));
    NONFAILING(*(uint8_t*)0x20000489 = 0xaa);
    NONFAILING(*(uint16_t*)0x2000048a = 0);
    NONFAILING(*(uint16_t*)0x2000048c = 0);
    NONFAILING(*(uint16_t*)0x2000048e = 0);
    NONFAILING(*(uint16_t*)0x20000490 = 0);
    NONFAILING(*(uint16_t*)0x20000492 = 0);
    NONFAILING(*(uint16_t*)0x20000494 = 0);
    NONFAILING(*(uint16_t*)0x20000496 = 0);
    NONFAILING(*(uint16_t*)0x20000498 = 0);
    NONFAILING(*(uint16_t*)0x2000049a = 0);
    NONFAILING(*(uint16_t*)0x2000049c = 0);
    NONFAILING(*(uint16_t*)0x2000049e = 0);
    NONFAILING(*(uint16_t*)0x200004a0 = 0);
    NONFAILING(*(uint16_t*)0x200004a2 = 0);
    NONFAILING(*(uint16_t*)0x200004a4 = 0);
    NONFAILING(*(uint16_t*)0x200004a6 = 0);
    NONFAILING(*(uint16_t*)0x200004a8 = 0);
    NONFAILING(*(uint16_t*)0x200004aa = 0);
    ...
    NONFAILING(memset((void*)0x200004c0, 0, 84));
    NONFAILING(*(uint32_t*)0x20000514 = 0);
    NONFAILING(*(uint16_t*)0x20000518 = 0x70);
    NONFAILING(*(uint16_t*)0x2000051a = 0x98);
    NONFAILING(*(uint32_t*)0x2000051c = 0);
    NONFAILING(*(uint64_t*)0x20000520 = 0);
    NONFAILING(*(uint64_t*)0x20000528 = 0);
    NONFAILING(*(uint16_t*)0x20000530 = 0x28);
    NONFAILING(memset((void*)0x20000532, 0, 29));
    NONFAILING(*(uint8_t*)0x2000054f = 4);
    NONFAILING(*(uint32_t*)0x20000550 = 0xfffffffe);
    syscall(__NR_setsockopt, r[0], 0, 0x40, 0x200002c0ul, 0x298ul);
    break;
  case 3:
    res = syscall(__NR_socket, 2ul, 1ul, 0);
    if (res != -1)
  ...
  case 4:
    ...
    NONFAILING(*(uint32_t*)0x200002f0 = 0);
    NONFAILING(*(uint32_t*)0x200002f4 = 0);
    NONFAILING(*(uint32_t*)0x200002f8 = 0x3e01);
    NONFAILING(*(uint32_t*)0x200002fc = 0xd0);
    NONFAILING(*(uint32_t*)0x20000300 = 0x1a0);
    NONFAILING(*(uint32_t*)0x20000304 = 0x1a0);
    NONFAILING(*(uint32_t*)0x20000308 = 0x1a0);
    ...
    NONFAILING(*(uint8_t*)0x2000054f = 4);
    NONFAILING(*(uint32_t*)0x20000550 = 0xfffffffe);
    syscall(__NR_setsockopt, r[1], 0, 0x40, 0x200002c0ul, 0x298ul);
    break;
  case 5:
    NONFAILING(*(uint32_t*)0x200000c0 = -1);
    NONFAILING(*(uint32_t*)0x200000c4 = -1);
    NONFAILING(*(uint32_t*)0x200000c8 = 0);
    syscall(__NR_kcmp, -1, -1, 7ul, r[0], 0x200000c0ul);
    break;
  }
}
int main(void)
