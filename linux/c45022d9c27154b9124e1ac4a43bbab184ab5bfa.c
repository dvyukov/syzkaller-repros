...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    res = syscall(__NR_socketpair, 1, 5, 0, 0x20000040);
    if (res != -1)
      NONFAILING(r[0] = *(uint32_t*)0x20000044);
    break;
  case 1:
    res = syscall(__NR_io_setup, 8, 0x20000000);
    if (res != -1)
      NONFAILING(r[1] = *(uint64_t*)0x20000000);
    break;
  case 2:
    NONFAILING(memcpy((void*)0x200001c0, "/dev/audio\000", 11));
    syscall(__NR_openat, 0xffffffffffffff9c, 0x200001c0, 0x82, 0);
    break;
  case 3:
    ...
    syscall(__NR_io_submit, r[1], 0x1ffffffffffffd70, 0x20000600);
    break;
  }
}
int main(void)
