// kernel panic: sysrq triggered crash
// https://syzkaller.appspot.com/bug?id=bb2f6cd982c1758fbfd4f19b2a5e242dc0a58646
// status:invalid
...
int main(void)
{
  ...
  *(uint8_t*)0x200000b5 = 0;
  ...
  syscall(__NR_ioctl, -1, 0x4802ul, 7);
  *(uint32_t*)0x20000440 = 0x24;
  *(uint64_t*)0x20000444 = 0;
  *(uint64_t*)0x2000044c = 0;
  *(uint64_t*)0x20000454 = 0x20002580;
  memcpy((void*)0x20002580, "\000\"\"", 3);
  *(uint64_t*)0x2000045c = 0;
  syz_usb_control_io(r[0], 0x20000440, 0);
  memcpy((void*)0x20000900, "\x94\x4d\x25\x46\xb5\x06", 6);
  syz_usb_ep_write(r[0], 0, 6, 0x20000900);
  return 0;
}
