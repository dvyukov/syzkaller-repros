...
// https://syzkaller.appspot.com/bug?id=df623b51c417453842cc
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000140, "/dev/ion\000", 9));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000140ul, 0ul, 0ul);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    NONFAILING(*(uint64_t*)0x20000040 = 3);
  ...
  case 4:
    ...
    res = syscall(__NR_ioctl, r[3], 0xc00c642e, 0x20000240ul);
    if (res != -1)
      NONFAILING(r[4] = *(uint32_t*)0x20000240);
    break;
  case 5:
    syscall(__NR_ioctl, -1, 0xc0086421, 0ul);
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x20000200 = r[4]);
    NONFAILING(*(uint32_t*)0x20000204 = 0);
    syscall(__NR_ioctl, r[3], 0xc10c5541, 0x20000200ul);
    break;
  case 7:
    NONFAILING(*(uint64_t*)0x20000000 = 2);
    syscall(__NR_ioctl, r[2], 0x40086200, 0x20000000ul);
    break;
  case 8:
    NONFAILING(*(uint32_t*)0x20000100 = r[1]);
    NONFAILING(*(uint16_t*)0x20000104 = 0x6005);
    NONFAILING(*(uint16_t*)0x20000106 = 0);
    syscall(__NR_poll, 0x20000100ul, 1ul, 0);
    break;
  case 9:
    syscall(__NR_dup3, r[2], r[3], 0ul);
    break;
  }
}
int main(void)
