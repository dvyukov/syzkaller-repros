...
// https://syzkaller.appspot.com/bug?id=6cecfe1e95afc37b7c257ff1ab60059e78b6b06d
// status:open
...
void loop(void)
{
  ...
  *(uint8_t*)0x20000653 = 0;
  syscall(__NR_bind, r[0], 0x20000640, 0x14);
  memcpy((void*)0x20000040,
         "\x05\x03\x00\x00\x06\x00\x3e\x00\x00\x00\x01\x00\x89\x2f", 14);
  syscall(__NR_sendto, r[0], 0x20000040, 0xe, 0, 0, 0);
}
int main(void)
{
