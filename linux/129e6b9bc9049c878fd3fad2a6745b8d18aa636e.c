...
void loop()
{
  ...
  *(uint8_t*)0x20000204 = 0;
  res = syscall(__NR_add_key, 0x200000c0, 0x20000200, 0, 0, r[0]);
  if (res != -1)
    r[1] = res;
  ...
  *(uint8_t*)0x20000284 = 0;
  ...
  res = syscall(__NR_add_key, 0x203bd000, 0x20000280, 0x20000440, 1, r[1]);
  if (res != -1)
    r[2] = res;
  ...
  *(uint8_t*)0x20752fff = 0;
  ...
  memcpy((void*)0x20000480,
         ...
         "\x86\x4a\x68\x67\x9f",
         192);
  syscall(__NR_keyctl, 2, r[3], 0x20000480, 0xc0);
  ...
  *(uint64_t*)0x20c61fc8 = 0x20000140;
  memcpy((void*)0x20000140,
         "\x73\x68\x61\x33\x38\x34\x2d\x61\x76\x78\x32\x00\x00\x00\x00\x00\x00"
  ...
  *(uint32_t*)0x20c61ff8 = 0;
  syscall(__NR_keyctl, 0x17, 0x20000100, 0x20a53ffb, 0x53, 0x20c61fc8);
}
