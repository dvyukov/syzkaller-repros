...
// https://syzkaller.appspot.com/bug?id=f7cadfbade40ef9b1e06d69a4697a5bbe9a34795
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x200002c0, "/dev/loop#\000", 11));
    res = syz_open_dev(0x200002c0, 0, 0x82);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2001d028, 6, 0, 1));
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2001d028, 9, 7, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0, 8, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0, 9, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0x80000000000, 10, 1));
    ...
    NONFAILING(
        STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0xfffffffffffffffd, 15, 2));
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2001d028, 1, 20, 1));
    ...
    NONFAILING(
        STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0xfffffffffffffffc, 24, 1));
    ...
    NONFAILING(*(uint16_t*)0x2001d06c = 0x800);
    NONFAILING(*(uint16_t*)0x2001d06e = 0);
    syscall(__NR_perf_event_open, 0x2001d000, 0, -1, -1, 0);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x200002c0, "/dev/loop#\000", 11));
    res = syz_open_dev(0x200002c0, 0x950, 0x82);
    if (res != -1)
      r[1] = res;
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000100,
                      "t\bnu\000\000\000\000\205nG\023g\246\005", 15));
  ...
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_ioctl, r[1], 0x4c01, 0);
    break;
  case 7:
