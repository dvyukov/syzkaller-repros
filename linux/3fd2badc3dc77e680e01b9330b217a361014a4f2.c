...
void execute_call(int call)
{
  ...
  case 3:
    ...
    break;
  case 4:
    NONFAILING(memcpy((void*)0x200001c0, "./file0\x00", 8));
    res = syscall(__NR_open, 0x200001c0, 0, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 5:
    ...
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000200, "./file1\x00", 8));
    syscall(__NR_mkdir, 0x20000200, 0);
    break;
  case 7:
    NONFAILING(memcpy((void*)0x20000040, "./file0/f.le.\x00", 14));
    NONFAILING(memcpy((void*)0x20000340, ".//ile0\x00", 8));
    syscall(__NR_symlink, 0x20000040, 0x20000340);
    break;
  case 8:
    NONFAILING(memcpy((void*)0x200000c0, "./file0\x00", 8));
    syscall(__NR_mkdir, 0x200000c0, 0);
    break;
  case 9:
    NONFAILING(memcpy((void*)0x20000300, "./file0\x00", 8));
    NONFAILING(memcpy((void*)0x20000100, "overlay\x00", 8));
    ...
    break;
  case 10:
    NONFAILING(memcpy((void*)0x20000080, "./file0\x00", 8));
    res = syscall(__NR_open, 0x20000080, 0, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 11:
    NONFAILING(memcpy((void*)0x20000140, ".//ile0\x00", 8));
    syscall(__NR_execveat, r[1], 0x20000140, 0, 0, 0);
    break;
  case 12:
    NONFAILING(memcpy((void*)0x20000240, ".//ile0\x00", 8));
    NONFAILING(memcpy((void*)0x200007c0, "./file0/f.le.\x00", 14));
    syscall(__NR_renameat, r[1], 0x20000240, r[1], 0x200007c0);
    break;
  }
}
int main(void)
