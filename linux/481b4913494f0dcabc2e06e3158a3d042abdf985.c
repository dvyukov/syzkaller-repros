...
// https://syzkaller.appspot.com/bug?id=481b4913494f0dcabc2e06e3158a3d042abdf985
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint64_t*)0x20000090 = 0x200016c0);
    NONFAILING(*(uint64_t*)0x200016c0 = 0x20000040);
    NONFAILING(memcpy((void*)0x20000040,
                      "\x20\x00\x00\x00\x26\x00\x01\x00\x00\x00\x00\x00\x00\x00"
                      "\x00\x00\x01\x00\x00\x00\x0c\x00\x03\x00\xc5\x65\xfa\x75"
                      "\xc2\x00\x63\x7d\x96\x1c\xca\x00\x00",
                      37));
    NONFAILING(*(uint64_t*)0x200016c8 = 1);
