...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    res = syscall(__NR_socket, 0xa, 0x80002, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 3:
  ...
  case 5:
    ...
    NONFAILING(*(uint32_t*)0x20000088 = 0x386);
  ...
  case 6:
    ...
    NONFAILING(*(uint64_t*)0x200bfff0 = 0x20000140);
    NONFAILING(*(uint32_t*)0x20000140 = 0xb8);
    NONFAILING(*(uint16_t*)0x20000144 = 0x15);
    ...
    NONFAILING(*(uint32_t*)0x20000160 = htobe32(0xe0000001));
    NONFAILING(*(uint16_t*)0x20000170 = htobe16(0));
    NONFAILING(*(uint16_t*)0x20000172 = htobe16(0));
    NONFAILING(*(uint16_t*)0x20000174 = htobe16(0));
    NONFAILING(*(uint16_t*)0x20000176 = htobe16(0));
    NONFAILING(*(uint16_t*)0x20000178 = 0xa);
