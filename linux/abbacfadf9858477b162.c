...
// https://syzkaller.appspot.com/bug?id=abbacfadf9858477b162
// status:0
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000ff0 = 0;
  ...
  res = syscall(__NR_socketpair, 1ul, 0x20000000000001ul, 0, 0x20000100ul);
  if (res != -1)
    r[1] = *(uint32_t*)0x20000104;
  memcpy((void*)0x20000040,
         "lo\000\226o\326Q\271Y\251\3107,\000\322\227\004\003\334\r", 20);
