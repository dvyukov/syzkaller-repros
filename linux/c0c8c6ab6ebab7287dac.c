// INFO: rcu detected stall in mmap_pgoff
// https://syzkaller.appspot.com/bug?id=c0c8c6ab6ebab7287dac
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint64_t*)0x2001d010 = 1);
    NONFAILING(*(uint64_t*)0x2001d018 = 0);
    NONFAILING(*(uint64_t*)0x2001d020 = 5);
    ...
    NONFAILING(*(uint32_t*)0x2001d034 = 2);
    ...
    NONFAILING(*(uint32_t*)0x2001d05c = 4);
    NONFAILING(*(uint64_t*)0x2001d060 = 0);
    NONFAILING(*(uint32_t*)0x2001d068 = 5);
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_openat, r[0], 0ul, 0ul, 0ul);
    break;
  case 3:
    syscall(__NR_fcntl, -1, 0x40bul, 0ul);
    break;
  case 4:
  ...
  case 5:
    ...
    break;
  case 6:
    NONFAILING(*(uint64_t*)0x20000200 = 2);
    syscall(__NR_msgsnd, 0, 0x20000200ul, 8ul, 0ul);
    break;
  case 7:
    NONFAILING(memcpy((void*)0x20000240, "\x03", 1));
    syscall(__NR_msgsnd, 0, 0x20000240ul, 0x82ul, 0ul);
    break;
  case 8:
    syscall(__NR_msgrcv, 0, 0ul, 0ul, 0ul, 0ul);
    break;
  case 9:
    syscall(__NR_mmap, 0x20200000ul, 0x400017ul, 0x2000006ul, 0x2012ul, r[1],
            0ul);
    break;
  case 10:
  ...
  case 11:
    ...
    break;
  case 12:
    syscall(__NR_timer_create, 5ul, 0ul, 0x20000100ul);
    break;
  }
}
int main(void)
