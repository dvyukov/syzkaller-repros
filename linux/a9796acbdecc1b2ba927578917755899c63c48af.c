...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_prctl, 0x19, 0x20000000, 0, 0);
    break;
  case 1:
  ...
  case 3:
    ...
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x20000140 = 3);
    NONFAILING(*(uint16_t*)0x20000144 = 0x40);
    NONFAILING(*(uint16_t*)0x20000146 = 0xfa00);
    NONFAILING(*(uint16_t*)0x20000148 = 0xa);
    NONFAILING(*(uint16_t*)0x2000014a = htobe16(0x4e22));
    NONFAILING(*(uint32_t*)0x2000014c = htobe32(0x80000001));
    NONFAILING(*(uint64_t*)0x20000150 = htobe64(0));
    NONFAILING(*(uint64_t*)0x20000158 = htobe64(1));
    NONFAILING(*(uint32_t*)0x20000160 = 0);
    NONFAILING(*(uint16_t*)0x20000164 = 0xa);
    NONFAILING(*(uint16_t*)0x20000166 = htobe16(0x4e23));
    NONFAILING(*(uint32_t*)0x20000168 = htobe32(6));
    NONFAILING(*(uint8_t*)0x2000016c = -1);
    NONFAILING(*(uint8_t*)0x2000016d = 1);
