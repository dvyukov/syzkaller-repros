...
// https://syzkaller.appspot.com/bug?id=f65ada862fcd638b0ca5
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint64_t*)0x20000210 = 3);
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000228, 0, 29, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000228, 0, 30, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000228, 2, 31, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000228, 0, 32, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000228, 0, 33, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000228, 0x40000, 34, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000228, 0, 35, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000228, 0, 36, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000228, 0, 37, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000228, 0, 38, 26));
    ...
    syscall(__NR_perf_event_open, 0x20000200ul, 0, 0xfffffdfffffffffful, -1,
            0ul);
    break;
  case 1:
    NONFAILING(memcpy((void*)0x200000c0, "ext4\000", 5));
    NONFAILING(memcpy((void*)0x20000180, "./file0\000", 8));
    NONFAILING(*(uint64_t*)0x20001700 = 0);
    NONFAILING(*(uint64_t*)0x20001708 = 0);
    NONFAILING(*(uint64_t*)0x20001710 = 2);
    NONFAILING(*(uint64_t*)0x20001718 = 0);
    NONFAILING(*(uint64_t*)0x20001720 = 0);
    NONFAILING(*(uint64_t*)0x20001728 = 0x2d70);
    NONFAILING(*(uint64_t*)0x20001730 = 0);
    NONFAILING(*(uint64_t*)0x20001738 = 0);
    NONFAILING(*(uint64_t*)0x20001740 = 5);
    NONFAILING(*(uint64_t*)0x20001748 = 0);
    NONFAILING(*(uint64_t*)0x20001750 = 0);
    NONFAILING(*(uint64_t*)0x20001758 = 0xfffffffffffffffe);
    NONFAILING(*(uint64_t*)0x20001760 = 0x20000700);
    NONFAILING(*(uint64_t*)0x20001768 = 0);
    NONFAILING(*(uint64_t*)0x20001770 = 0x400);
    NONFAILING(memcpy((void*)0x20001780, "user_xattr", 10));
    NONFAILING(*(uint8_t*)0x2000178a = 0x2c);
    NONFAILING(memcpy((void*)0x2000178b, "max_dir_size_kb", 15));
    NONFAILING(*(uint8_t*)0x2000179a = 0x3d);
    NONFAILING(sprintf((char*)0x2000179b, "0x%016llx", (long long)6));
    NONFAILING(*(uint8_t*)0x200017ad = 0x2c);
    NONFAILING(memcpy((void*)0x200017ae, "usrjquota", 9));
    NONFAILING(*(uint8_t*)0x200017b7 = 0x3d);
    NONFAILING(memcpy((void*)0x200017b8, "./file0", 7));
    NONFAILING(*(uint8_t*)0x200017bf = 0x2c);
    NONFAILING(memcpy((void*)0x200017c0, "abort", 5));
    NONFAILING(*(uint8_t*)0x200017c5 = 0x2c);
    NONFAILING(memcpy((void*)0x200017c6, "pcr", 3));
    NONFAILING(*(uint8_t*)0x200017c9 = 0x3d);
    NONFAILING(sprintf((char*)0x200017ca, "%020llu", (long long)0x3c));
    NONFAILING(*(uint8_t*)0x200017de = 0x2c);
    NONFAILING(*(uint8_t*)0x200017df = 0);
    NONFAILING(syz_mount_image(0x200000c0, 0x20000180, 0, 5, 0x20001700, 1,
                               0x20001780));
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000100, "syscall\000", 8));
    NONFAILING(syz_open_procfs(0, 0x20000100));
    break;
  case 3:
  ...
  case 7:
    ...
    NONFAILING(*(uint64_t*)0x20000000 = 0x200003c0);
    NONFAILING(memcpy((void*)0x200003c0,
                      "\x9c\x00\x00\x00\x10\x00\x01\x04\x27\xbd\x70\x00\xfd\xdb"
                      "\xdf\x25\x00\x00\x00\x00",
                      20));
    NONFAILING(*(uint32_t*)0x200003d4 = 0);
    NONFAILING(memcpy(
        (void*)0x200003d8,
        "\x00\x00\x00\x00\x00\x00\x00\x00\x74\x00\x12\x80\x0e\x00\x01\x00\x69"
        "\x70\x36\x65\x72\x73\x70\x61\x6e\x00\x00\x00\x60\x00\x02\x80\x08\x00"
        "\x15\x00\x05\x26\x08\x00\x06\x00\x0f\x00\x02\x00\x00\x00\x04\x00\x12"
        "\x00\x08\x00\x0c\x00\x09\x00\x00\x00\x05\x00\x16\x00\x01\x00\x00\x00"
        "\x08\x00\x15\x00\xe8\xbd\x09\x00\x14\x00\x06\x00\x20\x01\x00\x00\x00"
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\x14\x00\x06\x00\x00\x00"
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x05\x00\x08"
        "\x00\xa9\x00\x00\x00\x08\x00\x03\x00",
        128));
    NONFAILING(*(uint32_t*)0x20000458 = r[2]);
    NONFAILING(*(uint64_t*)0x20000008 = 0x9c);
  ...
  case 8:
    ...
    break;
  case 9:
    syscall(__NR_perf_event_open, 0ul, 0, 0xfffffdfffffffffful, -1, 0ul);
    break;
  case 10:
    syscall(__NR_sendmsg, -1, 0ul, 0x8010ul);
    break;
  case 11:
