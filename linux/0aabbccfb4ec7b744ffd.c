// WARNING: refcount bug in nfc_llcp_local_put
// https://syzkaller.appspot.com/bug?id=0aabbccfb4ec7b744ffd
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    res = -1;
    NONFAILING(res = syz_init_net_socket(0x27, 2, 1));
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    ...
    NONFAILING(memcpy(
        (void*)0x20000012,
        "\x36\xd8\xd1\xb1\xd7\xd1\xab\x73\xf9\x2f\xb7\x0f\x74\xd3\xb1\xa2\x75"
        "\xc4\xbb\xbd\xc6\x5f\xd3\x82\xfd\x5e\x3a\x37\x0b\x1f\x5e\x8a\x75\xb0"
        "\x82\x26\x9f\x9b\x24\x25\x0d\xe0\xfb\x34\x65\xe2\x95\xef\xd8\x3d\x45"
        "\x53\xc9\x6b\xa4\x7b\x09\x30\x71\x41\x02\xa9\x87",
        63));
    NONFAILING(*(uint64_t*)0x20000058 = 0);
    syscall(__NR_bind, r[0], 0x20000000ul, 0x60ul);
    break;
  case 2:
    NONFAILING(*(uint64_t*)0x20003400 = 0x20000080);
    NONFAILING(*(uint16_t*)0x20000080 = 0x27);
    ...
    NONFAILING(memcpy(
        (void*)0x20000092,
        "\xd8\x2d\xec\x64\x77\x62\x10\x7d\xd2\xfa\x8f\x50\x5b\x99\x82\x5b\x3f"
        "\xa9\x60\xa7\x23\x09\x6c\x18\x2c\x38\xd7\x46\x45\x2b\x1b\x4a\xd5\x0a"
        "\xd2\x93\xd4\xe8\xd7\xa5\x34\x92\x0a\xc7\x1c\xcf\xe9\x7e\xab\xac\xf1"
        "\x18\x75\x31\x4a\x88\x9e\xed\x2b\xfe\x9e\x13\x4d",
        63));
    NONFAILING(*(uint64_t*)0x200000d8 = 0);
    NONFAILING(*(uint32_t*)0x20003408 = 0x60);
    ...
    NONFAILING(*(uint32_t*)0x20003430 = 0);
    NONFAILING(*(uint64_t*)0x20003438 = 0);
    NONFAILING(*(uint32_t*)0x20003440 = 0);
    NONFAILING(*(uint64_t*)0x20003448 = 0);
    NONFAILING(*(uint64_t*)0x20003450 = 0);
    NONFAILING(*(uint64_t*)0x20003458 = 0x200004c0);
    NONFAILING(*(uint64_t*)0x200004c0 = 0x10);
    NONFAILING(*(uint32_t*)0x200004c8 = 0);
    NONFAILING(*(uint32_t*)0x200004cc = 0);
    NONFAILING(*(uint64_t*)0x20003460 = 0x10);
    NONFAILING(*(uint32_t*)0x20003468 = 0);
