...
// https://syzkaller.appspot.com/bug?id=09b4a3f42f32d58b8982
// status:6
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x20000280, "devlink\000", 8);
  ...
  *(uint16_t*)0x20000006 = 0x7dd;
  *(uint32_t*)0x20000008 = 0x80000000;
  *(uint32_t*)0x2000000c = 0;
  *(uint8_t*)0x20000010 = 0x2e;
  *(uint8_t*)0x20000011 = 0;
  *(uint16_t*)0x20000012 = 0;
  *(uint16_t*)0x20000014 = 0xe;
  *(uint16_t*)0x20000016 = 1;
  memcpy((void*)0x20000018, "netdevsim\000", 10);
  *(uint16_t*)0x20000024 = 0xf;
  *(uint16_t*)0x20000026 = 2;
  memcpy((void*)0x20000028, "netdevsim", 9);
  *(uint8_t*)0x20000031 = 0x30 + procid * 1;
  *(uint8_t*)0x20000032 = 0;
  *(uint64_t*)0x20000208 = 0x34;
