...
// https://syzkaller.appspot.com/bug?id=92c72345f7e12876205219afbc342a2b2cc4eae7
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_arch_prctl, 0x1004, 0x20000080);
    break;
  case 1:
  ...
  case 2:
    ...
    NONFAILING(*(uint64_t*)0x20000178 = 0x9be);
    NONFAILING(*(uint64_t*)0x20000180 = 0x80000000);
    ...
    res = syscall(__NR_perf_event_open, 0x20000140, 0, 0, -1, 8);
    if (res != -1)
      r[0] = res;
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000280, "/dev/loop-control\000", 18));
  ...
  case 5:
    ...
    res = syscall(__NR_open, 0x20000040, 0x200c2, 0);
    if (res != -1)
      r[2] = res;
    break;
  case 6:
    syscall(__NR_write, r[2], 0x20000380, 1);
    break;
  case 7:
    NONFAILING(*(uint64_t*)0x20000200 = 0);
    syscall(__NR_sendfile, r[2], r[2], 0x20000200, 0xa198);
    break;
  case 8:
    NONFAILING(memcpy((void*)0x20000000, "./file0\000", 8));
    res = syscall(__NR_openat, r[2], 0x20000000, 0x218102, 8);
    if (res != -1)
      r[3] = res;
    break;
  case 9:
    NONFAILING(*(uint32_t*)0x20000040 = 0x400);
    syscall(__NR_setsockopt, r[3], 0x10e, 5, 0x20000040, 4);
    break;
  case 10:
    res = syscall(__NR_socket, 0x1c, 6, 6);
    if (res != -1)
      r[4] = res;
    break;
  case 11:
    NONFAILING(*(uint32_t*)0x20000100 = 0x14);
    res = syscall(__NR_accept, -1, 0x200000c0, 0x20000100);
    if (res != -1)
      r[5] = res;
    break;
  case 12:
    NONFAILING(memcpy((void*)0x20000240, "syz0\000", 5));
    res = syscall(__NR_openat, -1, 0x20000240, 0x200002, 0);
    if (res != -1)
      r[6] = res;
    break;
  case 13:
    NONFAILING(memcpy((void*)0x20000280, "/dev/loop#\000", 11));
  ...
  case 14:
    NONFAILING(memcpy(
        (void*)0x20000380,
        "\000\000\000\000\000\000\000\001\000\000\000\001\000\000\000v\216\005"
        "\367\301U\255}\306\224|W>Zi$Nv8,\n\246=W^\243Y\177\213\027(\'~"
        "\367k0TM{\251-\317\227\217\037\201\334\033\177\217{"
        "4Q\332\332\002\354\264\361\335\314\213RA\332\211Efn\000s\302Zb\001\000"
        "M\276\243z\253\323\353\230\210\304\306)"
        "A\237P\223zhH\340\322\201\333\356V\214M\351\2406\302o\031\"\366Iq\324"
        "\337\227\373\253\004\350\316I8\263\035\317%"
        "\233K\306\t\001\341\206a\372\270\373)\210\315+\302`\302\365r5>"
        "k\260\240\002\374\026MO\030\233\006\200b\321\001\000\000\000\000\000"
        "\000\000@\f\fL\245{Tk\2240\027.\2456.\340\024\033="
        "\360j\3225\350\025\330\236\352\323\331G4\t\300\234.\'\251R3z$"
        "\362\001\210\300\023\022<"
        "\3001j3\330\264CE7s\344\240\236\335\2001\022M\356\023\316\234u(\217."
        "\3103\307\346j\365\261\232\000\000\000\000\000\000\000",
        276));
  ...
  case 15:
    ...
    NONFAILING(memcpy((void*)0x20000180, "\x13", 1));
    NONFAILING(*(uint64_t*)0x20000348 = 1);
    syscall(__NR_pwritev, r[8], 0x20000340, 1, 0x8180a);
    break;
  case 16:
    syscall(__NR_ioctl, r[7], 0x4c00, r[8]);
    break;
  case 17:
    syscall(__NR_sendfile, r[7], r[8], 0, 0x20000102000007);
    break;
  case 18:
    NONFAILING(*(uint32_t*)0x200002c0 = r[0]);
    NONFAILING(*(uint16_t*)0x200002c4 = 0x203);
    NONFAILING(*(uint16_t*)0x200002c6 = 0);
    NONFAILING(*(uint32_t*)0x200002c8 = r[6]);
    NONFAILING(*(uint16_t*)0x200002cc = 8);
    NONFAILING(*(uint16_t*)0x200002ce = 0);
    NONFAILING(*(uint32_t*)0x200002d0 = r[8]);
    NONFAILING(*(uint16_t*)0x200002d4 = 0x408);
    NONFAILING(*(uint16_t*)0x200002d6 = 0);
    syscall(__NR_poll, 0x200002c0, 3, 0x80);
    break;
  case 19:
    NONFAILING(*(uint32_t*)0x200001c0 = 0);
    NONFAILING(*(uint32_t*)0x200001c4 = r[5]);
    NONFAILING(*(uint64_t*)0x200001c8 = 2);
    NONFAILING(*(uint64_t*)0x200001d0 = 7);
    NONFAILING(*(uint64_t*)0x200001d8 = 0x100000001);
    NONFAILING(*(uint64_t*)0x200001e0 = 5);
    syscall(__NR_ioctl, r[4], 0xc028660f, 0x200001c0);
    break;
  }
}
int main(void)
