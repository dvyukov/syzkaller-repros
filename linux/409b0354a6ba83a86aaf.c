...
// https://syzkaller.appspot.com/bug?id=409b0354a6ba83a86aaf
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    *(uint16_t*)0x20000082 = htobe16(0x4001);
    ...
    *(uint8_t*)0x20000097 = 0x37;
    *(uint32_t*)0x20000098 = 0;
    syscall(__NR_connect, r[0], 0x20000080ul, 0x1cul);
    break;
  case 2:
    memcpy((void*)0x20000000, "\xb1", 1);
    syscall(__NR_write, r[0], 0x20000000ul, 1ul);
    break;
  }
}
int main(void)
