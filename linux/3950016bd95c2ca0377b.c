...
// https://syzkaller.appspot.com/bug?id=3950016bd95c2ca0377b
// status:0 arch:386
...
void execute_one(void)
{
  intptr_t res = 0;
  syscall(__NR_getpid);
  syscall(__NR_socketpair, 0x1e, 5, 0, 0);
  syscall(__NR_write, -1, 0, 0);
  syscall(__NR_clone, 0x103, 0, 0x99999999, 0, -1);
  syscall(__NR_socket, 0xa, 0x80806, 0);
  ...
  *(uint8_t*)0x20000194 = 0xac;
  *(uint8_t*)0x20000195 = 0x14;
  *(uint8_t*)0x20000196 = 0x14;
  *(uint8_t*)0x20000197 = 0xbb;
  *(uint32_t*)0x20000198 = 0;
  *(uint16_t*)0x2000019c = 2;
  *(uint16_t*)0x2000019e = htobe16(0);
  *(uint8_t*)0x200001a0 = 0xac;
  *(uint8_t*)0x200001a1 = 0x14;
  *(uint8_t*)0x200001a2 = 0x14;
  *(uint8_t*)0x200001a3 = 0xbb;
  syscall(__NR_setsockopt, (intptr_t)r[0], 0x84, 0x64, 0x20000180, 0x2c);
  ...
  *(uint16_t*)0x20000012 = htobe16(0x4e22);
  *(uint8_t*)0x20000014 = 0xac;
  *(uint8_t*)0x20000015 = 0x14;
  *(uint8_t*)0x20000016 = 0x14;
  *(uint8_t*)0x20000017 = 0xaa;
  syscall(__NR_setsockopt, (intptr_t)r[0], 0x84, 0x6e, 0x20000000, 0x20);
  res = syscall(__NR_socket, 0xa, 5, 0x84);
  if (res != -1)
    r[1] = res;
  *(uint16_t*)0x20000180 = 0xa;
  ...
  *(uint8_t*)0x200001a2 = 0x14;
  *(uint8_t*)0x200001a3 = 0xbb;
  syscall(__NR_setsockopt, (intptr_t)r[1], 0x84, 0x64, 0x20000180, 0x2c);
  *(uint16_t*)0x20000000 = 2;
  *(uint16_t*)0x20000002 = htobe16(0x4e22);
  *(uint8_t*)0x20000004 = 0xac;
  *(uint8_t*)0x20000005 = 0x14;
  ...
  *(uint8_t*)0x20000016 = 0x14;
  *(uint8_t*)0x20000017 = 0xaa;
  syscall(__NR_setsockopt, (intptr_t)r[1], 0x84, 0x6e, 0x20000000, 0x20);
}
int main(void)
{
