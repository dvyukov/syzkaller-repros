...
// https://syzkaller.appspot.com/bug?id=138c9e58e3cb22eae3b4
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(memcpy((void*)0x20000080, "/dev/nbd", 8));
  NONFAILING(*(uint8_t*)0x20000088 = 0x30 + procid * 1);
  NONFAILING(*(uint8_t*)0x20000089 = 0);
  NONFAILING(memcpy((void*)0x200000c0, "./file0\000", 8));
  NONFAILING(memcpy((void*)0x20000100, "ext4\000", 5));
  inject_fault(66);
  syscall(__NR_mount, 0x20000080ul, 0x200000c0ul, 0x20000100ul, 0ul, 0ul);
}
int main(void)
{
