...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000300, "/dev/loop#", 11));
    res = syz_open_dev(0x20000300, 0, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    NONFAILING(memcpy((void*)0x200001c0, "/dev/loop#", 11));
  ...
  case 2:
    ...
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000000, "/proc/self/net/pfkey", 21));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000000, 0, 0);
    if (res != -1)
      r[2] = res;
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000100, "/dev/loop#", 11));
