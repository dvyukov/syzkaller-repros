...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x2000bff6, "/dev/dsp#", 10));
    syz_open_dev(0x2000bff6, 1, 2);
    break;
  case 1:
    ...
    break;
  case 2:
    NONFAILING(*(uint32_t*)0x20000140 = 0xa0);
    syscall(__NR_getsockopt, -1, 0x84, 0x74, 0x20000340, 0x20000140);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000100, "/dev/snd/seq", 13));
  ...
  case 4:
    ...
    NONFAILING(*(uint64_t*)0x20000040 = 0x77359400);
    NONFAILING(*(uint64_t*)0x20000048 = 0);
    NONFAILING(*(uint64_t*)0x20000280 = 0);
    syscall(__NR_ppoll, 0x20000000, 1, 0x20000040, 0x20000280, 8);
    break;
  case 5:
    NONFAILING(*(uint8_t*)0x200001c0 = 0x80);
    NONFAILING(*(uint8_t*)0x200001c1 = 0);
    NONFAILING(memcpy(
        (void*)0x200001c2,
        "\x70\x6f\x72\xff\x07\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
        "\x0b\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x1f\x00\x00\xff\xff\xff"
        "\x03\x00\x00\x00\xef\x00\x00\x03\xff\x02\x00\x00\x00\x00\x00\x12\x00"
        "\x00\x00\x00\x00\x00\x00\x40\x00\x00\x06\x00\x00\x00",
        64));
    NONFAILING(*(uint32_t*)0x20000204 = 0xc7);
    NONFAILING(*(uint32_t*)0x20000208 = 0x80003);
    ...
    NONFAILING(*(uint8_t*)0x20000243 = 0);
    ...
    NONFAILING(*(uint8_t*)0x20000260 = 0);
    ...
    syscall(__NR_ioctl, r[0], 0xc0a85320, 0x200001c0);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000180, "/dev/sequencer2", 16));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000180, 0x2000000080003,
                  0);
    if (res != -1)
      r[1] = res;
    break;
