...
// https://syzkaller.appspot.com/bug?id=22ce6648b3f46426a825
// status:0
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[0] = res;
  syscall(__NR_mmap, 0x20000000ul, 0x800000ul, 0x800003ul, 0x12ul, r[0], 0ul);
  res = syscall(__NR_socket, 0x2bul, 1ul, 0);
  if (res != -1)
    r[1] = res;
  syscall(__NR_listen, r[1], 0);
  syscall(__NR_clone, 0x4412c580ul, 0ul, 0ul, 0ul, 0ul);
}
int main(void)
{
