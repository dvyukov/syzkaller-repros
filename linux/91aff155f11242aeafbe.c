...
// https://syzkaller.appspot.com/bug?id=91aff155f11242aeafbe
// status:6 arch:386
...
void execute_call(int call)
{
  ...
  case 4:
    ...
    NONFAILING(*(uint32_t*)0x20000288 = 0x20000180);
    ...
    syscall(__NR_sendmsg, (intptr_t)r[2], 0x20000280, 0);
    break;
  case 5:
    NONFAILING(*(uint32_t*)0x200002c0 = 0x14);
    res = syscall(__NR_getsockname, (intptr_t)r[2], 0x20000100, 0x200002c0);
    if (res != -1)
  ...
  case 6:
    ...
    NONFAILING(*(uint32_t*)0x20000248 = 0x20000140);
    NONFAILING(*(uint32_t*)0x20000140 = 0x200003c0);
    ...
    NONFAILING(memcpy(
        ...
        32));
    NONFAILING(*(uint32_t*)0x20000144 = 0x38);
  ...
  case 7:
    ...
    NONFAILING(*(uint32_t*)0x200001c8 = 0x20000180);
    NONFAILING(*(uint32_t*)0x20000180 = 0x20000580);
    ...
    NONFAILING(*(uint32_t*)0x20000594 = r[3]);
    ...
    NONFAILING(*(uint32_t*)0x20000184 = 0x3c);
  ...
  case 8:
    ...
    NONFAILING(*(uint32_t*)0x200001c4 = 0);
    NONFAILING(*(uint32_t*)0x200001c8 = 0x20000180);
    NONFAILING(*(uint32_t*)0x20000180 = 0x20000400);
    ...
    NONFAILING(*(uint32_t*)0x20000414 = r[3]);
