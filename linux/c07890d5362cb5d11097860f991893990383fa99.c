...
// https://syzkaller.appspot.com/bug?id=c07890d5362cb5d11097860f991893990383fa99
// status:invalid
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(memcpy((void*)0x20000280, "devtmpfs\000", 9));
  ...
  case 2:
    NONFAILING(memcpy((void*)0x20000780,
                      ...
                      258));
    res = syscall(__NR_openat, 0xffffff9c, 0x20000780, 0x275a, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 3:
    ...
    break;
  case 4:
    syscall(__NR_mremap, 0x20ffc000, 0x1000, 0x1000, 3, 0x20ffb000);
    break;
  case 5:
