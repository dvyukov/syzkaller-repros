...
// https://syzkaller.appspot.com/bug?id=bb7ba8dd62c3cb6e3c78
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(*(uint32_t*)0x2000028c = 0x43fb);
  ...
  NONFAILING(*(uint32_t*)0x200002b0 = -1);
  NONFAILING(*(uint32_t*)0x200002b4 = 0);
  NONFAILING(*(uint32_t*)0x200002b8 = 0);
  NONFAILING(*(uint32_t*)0x200002bc = 0);
  syscall(__NR_bpf, 0ul, 0x20000280ul, 0x40ul);
  NONFAILING(memcpy((void*)0x200001c0, "cgroup.controllers\000", 19));
  syscall(__NR_openat, 0xffffff9c, 0x200001c0ul, 0x26e1ul, 0ul);
  res = syscall(__NR_socket, 2ul, 0x200000000000001ul, 0);
  if (res != -1)
    r[0] = res;
  NONFAILING(*(uint64_t*)0x20000fc0 = 0x200002c0);
  NONFAILING(*(uint16_t*)0x200002c0 = 2);
  NONFAILING(*(uint16_t*)0x200002c2 = htobe16(0x4001));
  NONFAILING(*(uint8_t*)0x200002c4 = 0xac);
  NONFAILING(*(uint8_t*)0x200002c5 = 0x14);
  NONFAILING(*(uint8_t*)0x200002c6 = 0x14);
  NONFAILING(*(uint8_t*)0x200002c7 = 0xbb);
  NONFAILING(*(uint32_t*)0x20000fc8 = 0x10);
  ...
  NONFAILING(*(uint32_t*)0x20000ff0 = 0);
  syscall(__NR_sendmsg, r[0], 0x20000fc0ul, 0x24000844ul);
  ...
  NONFAILING(*(uint32_t*)0x20003000 = 3);
  NONFAILING(*(uint32_t*)0x20003004 = 0);
  NONFAILING(*(uint32_t*)0x20003008 = 0x77fffb);
  NONFAILING(*(uint32_t*)0x2000300c = 0);
  NONFAILING(*(uint32_t*)0x20003010 = 0x20000000);
  NONFAILING(*(uint32_t*)0x20003014 = 0);
  NONFAILING(*(uint32_t*)0x20003018 = 0);
  NONFAILING(*(uint8_t*)0x2000301c = 0);
  NONFAILING(*(uint8_t*)0x2000301d = 0);
  NONFAILING(*(uint8_t*)0x2000301e = 0);
  NONFAILING(*(uint8_t*)0x2000301f = 0);
  NONFAILING(*(uint8_t*)0x20003020 = 0);
  NONFAILING(*(uint8_t*)0x20003021 = 0);
  NONFAILING(*(uint8_t*)0x20003022 = 0);
  NONFAILING(*(uint8_t*)0x20003023 = 0);
  NONFAILING(*(uint8_t*)0x20003024 = 0);
  NONFAILING(*(uint8_t*)0x20003025 = 0);
  NONFAILING(*(uint8_t*)0x20003026 = 0);
  NONFAILING(*(uint8_t*)0x20003027 = 0);
  NONFAILING(*(uint8_t*)0x20003028 = 0);
  NONFAILING(*(uint8_t*)0x20003029 = 0);
  NONFAILING(*(uint8_t*)0x2000302a = 0);
  NONFAILING(*(uint8_t*)0x2000302b = 0);
  NONFAILING(*(uint32_t*)0x2000302c = 0);
  NONFAILING(*(uint32_t*)0x20003030 = -1);
  NONFAILING(*(uint32_t*)0x20003034 = 0);
  NONFAILING(*(uint32_t*)0x20003038 = 0);
  NONFAILING(*(uint32_t*)0x2000303c = 0);
  syscall(__NR_bpf, 2ul, 0x20003000ul, 0x2cul);
  ...
  syscall(__NR_recvmsg, r[0], 0x20000c40ul, 0ul);
}
int main(void)
{
