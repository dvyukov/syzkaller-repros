...
void execute_call(int call)
{
  ...
  case 4:
    ...
    NONFAILING(*(uint64_t*)0x20000088 = 0x12c000);
    NONFAILING(*(uint32_t*)0x20000090 = 0x800);
    NONFAILING(*(uint32_t*)0x20000094 = 0);
    syscall(__NR_setsockopt, r[1], 0x11b, 4, 0x20000080, 0x18);
    break;
  case 5:
    NONFAILING(*(uint32_t*)0x20001ac0 = 0x200);
    syscall(__NR_setsockopt, r[1], 0x11b, 5, 0x20001ac0, 4);
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x20003a80 = 0x40);
  ...
  case 7:
    ...
    NONFAILING(*(uint32_t*)0x2000028c = 0xf59);
  ...
  case 8:
    ...
    NONFAILING(*(uint64_t*)0x20000108 = 0x200001c0);
    NONFAILING(*(uint64_t*)0x20000110 = 0x20000040);
