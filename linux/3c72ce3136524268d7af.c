...
// https://syzkaller.appspot.com/bug?id=3c72ce3136524268d7af
// status:3
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    res = -1;
    NONFAILING(res = syz_io_uring_setup(0x6b52, 0x20000080, 0x20ffa000,
                                        0x205ea000, 0x20000180, 0x20000040));
    if (res != -1) {
      r[0] = res;
      NONFAILING(r[1] = *(uint64_t*)0x20000180);
  ...
  case 2:
    ...
    NONFAILING(*(uint8_t*)0x200001c1 = 4);
    NONFAILING(*(uint16_t*)0x200001c2 = 0);
    NONFAILING(*(uint32_t*)0x200001c4 = 6);
    NONFAILING(*(uint64_t*)0x200001c8 = 0);
    NONFAILING(*(uint64_t*)0x200001d0 = 0);
    NONFAILING(*(uint32_t*)0x200001d8 = 0);
    NONFAILING(*(uint16_t*)0x200001dc = 0x20);
    NONFAILING(*(uint16_t*)0x200001de = 0);
    ...
    NONFAILING(syz_io_uring_submit(r[1], r[2], 0x200001c0, 7));
    break;
  case 3:
    ...
    NONFAILING(*(uint8_t*)0x20000246 = 0x14);
    ...
    NONFAILING(syz_io_uring_submit(r[1], r[2], 0x20000100, 0));
    break;
  case 4:
  ...
  case 5:
    ...
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000000, "ah\000\000\000\000\000\000\000\000"
    ...
    syscall(__NR_getsockopt, r[4], 0, 0x43, 0x20000000ul, 0x20000140ul);
    break;
  case 7:
