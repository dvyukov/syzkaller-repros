// KMSAN: uninit-value in tipc_nl_compat_link_set
// https://syzkaller.appspot.com/bug?id=68e9146b9a72baa2b026d9d8599b02f7edf153e7
// status:invalid
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint16_t*)0x20000042 = 0x4000);
    ...
    NONFAILING(memcpy((void*)0x200000c0,
                      "\x2c\x00\x00\x00\x29\x00\x01\x00\x00\x00\x00\x00\x00\x00"
                      "\x00\x00\x01\x00\x00\x00\x18\x00\x00\x00\x09\x41\x00\x00"
                      "\x00\x00\x00\x18\x00\x00\x00\x6b\x6e\x67\x80\x3e\x65\xc6"
                      "\x65\xa9\x6e\x00\x00\x00\xff\xff\xac\x14\x14\xbb",
                      54));
