...
// https://syzkaller.appspot.com/bug?id=ea46a31df5253b18deb1e18c429c1483b111cbce
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint32_t*)0x20003508 = 0);
    NONFAILING(*(uint64_t*)0x20003510 = 0x20002580);
    NONFAILING(*(uint64_t*)0x20002580 = 0x200012c0);
    NONFAILING(*(uint64_t*)0x20002588 = 0x73);
    NONFAILING(*(uint64_t*)0x20003518 = 1);
    NONFAILING(*(uint64_t*)0x20003520 = 0);
    NONFAILING(*(uint64_t*)0x20003528 = 0);
    NONFAILING(*(uint32_t*)0x20003530 = 0);
    NONFAILING(*(uint32_t*)0x20003538 = 0);
    syscall(__NR_recvmmsg, -1, 0x20003500, 1, 0, 0);
    break;
  case 2:
    ...
    break;
  case 3:
    NONFAILING(memcpy((void*)0x200001c0, "TIPCv2\x00", 7));
    res = syz_genetlink_get_family_id(0x200001c0);
    if (res != -1)
      r[1] = res;
    break;
  case 4:
    NONFAILING(*(uint64_t*)0x200003c0 = 0);
    NONFAILING(*(uint32_t*)0x200003c8 = 2);
    NONFAILING(*(uint64_t*)0x200003d0 = 0x20000380);
    NONFAILING(*(uint64_t*)0x20000380 = 0x20000200);
    NONFAILING(*(uint32_t*)0x20000200 = 0x54);
    NONFAILING(*(uint16_t*)0x20000204 = r[1]);
    NONFAILING(*(uint16_t*)0x20000206 = 1);
    NONFAILING(*(uint32_t*)0x20000208 = 0);
    NONFAILING(*(uint32_t*)0x2000020c = 0);
    NONFAILING(*(uint8_t*)0x20000210 = 3);
    NONFAILING(*(uint8_t*)0x20000211 = 0);
    NONFAILING(*(uint16_t*)0x20000212 = 0);
    NONFAILING(*(uint16_t*)0x20000214 = 0x40);
    NONFAILING(*(uint16_t*)0x20000216 = 1);
    NONFAILING(*(uint16_t*)0x20000218 = 0x2c);
    NONFAILING(*(uint16_t*)0x2000021a = 4);
    NONFAILING(*(uint16_t*)0x2000021c = 0x14);
    NONFAILING(*(uint16_t*)0x2000021e = 1);
    NONFAILING(*(uint16_t*)0x20000220 = 2);
    NONFAILING(*(uint16_t*)0x20000222 = htobe16(0));
    NONFAILING(*(uint32_t*)0x20000224 = htobe32(0xac141425));
    NONFAILING(*(uint16_t*)0x20000230 = 0x14);
    NONFAILING(*(uint16_t*)0x20000232 = 2);
    NONFAILING(*(uint16_t*)0x20000234 = 2);
    NONFAILING(*(uint16_t*)0x20000236 = htobe16(0));
    NONFAILING(*(uint8_t*)0x20000238 = 0xac);
    NONFAILING(*(uint8_t*)0x20000239 = 0x14);
    NONFAILING(*(uint8_t*)0x2000023a = 0x14);
    NONFAILING(*(uint8_t*)0x2000023b = 0xbb);
    NONFAILING(*(uint16_t*)0x20000244 = 0x10);
    NONFAILING(*(uint16_t*)0x20000246 = 1);
    NONFAILING(memcpy((void*)0x20000248, "udp:syz1\x00", 9));
    NONFAILING(*(uint64_t*)0x20000388 = 0x54);
    ...
    syscall(__NR_sendmsg, r[0], 0x200003c0, 0);
    break;
  }
}
int main(void)
