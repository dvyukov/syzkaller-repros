...
// https://syzkaller.appspot.com/bug?id=05c0f3930ca1ea12abd291d0b65538dfdefe3fec
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000040, "/dev/ptmx", 10));
  ...
  case 1:
    ...
    NONFAILING(*(uint8_t*)0x203b9fef = 1);
  ...
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_fadvise64, r[0], 0, 0x544, 7);
    break;
  case 4:
    syscall(__NR_ioctl, r[1], 0x5437, 0x20000080);
    break;
  case 5:
    ...
    NONFAILING(*(uint8_t*)0x200000d0 = 0x3f);
    ...
    syscall(__NR_ioctl, r[0], 0x5402, 0x200000c0);
    break;
  case 6:
    ...
    break;
  case 7:
    syscall(__NR_socketpair, 0xa, 1, 0, 0x20000180);
    break;
  }
}
int main(void)
