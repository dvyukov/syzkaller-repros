...
// https://syzkaller.appspot.com/bug?id=6bc4138fabfa3250140fb1a7bd7fe1bed3417233
// status:open
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    NONFAILING(*(uint16_t*)0x20000118 = 0x14);
    ...
    NONFAILING(*(uint32_t*)0x20000128 = htobe32(0));
    NONFAILING(*(uint16_t*)0x2000012c = 0x14);
    NONFAILING(*(uint16_t*)0x2000012e = 2);
    NONFAILING(*(uint64_t*)0x20000130 = htobe64(0));
    NONFAILING(*(uint64_t*)0x20000138 = htobe64(1));
    NONFAILING(*(uint64_t*)0x200056c8 = 0x40);
