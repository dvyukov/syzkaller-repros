...
// https://syzkaller.appspot.com/bug?id=6ad11779184a3afe9f7e
// status:3 arch:386
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000280, ".\000", 2));
    syscall(__NR_open, 0x20000280, 0, 0);
    break;
  case 1:
  ...
  case 2:
    ...
    NONFAILING(*(uint32_t*)0x200002c8 = 0x640);
    NONFAILING(*(uint32_t*)0x200002cc = 0x1e0);
    NONFAILING(*(uint32_t*)0x200002d0 = 0);
    NONFAILING(*(uint32_t*)0x200002d4 = 0x400000);
    NONFAILING(*(uint32_t*)0x200002d8 = 4);
    ...
    NONFAILING(*(uint32_t*)0x20000304 = 0x800000);
    NONFAILING(*(uint32_t*)0x20000308 = 0x4000);
    NONFAILING(*(uint32_t*)0x2000030c = 0);
    NONFAILING(*(uint32_t*)0x20000310 = 3);
    NONFAILING(*(uint32_t*)0x20000314 = 0x40);
    ...
    syscall(__NR_ioctl, (intptr_t)r[0], 0x4601, 0x200002c0);
    break;
  }
}
int main(void)
