...
// https://syzkaller.appspot.com/bug?id=3b27c24cd871399e250f
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(memcpy(
        ...
        "\x07\x09\x13\x14\x2c\x16\x43\x09\x2d\x00\x2a\x4c\x69\x6e\x75\x78\x20"
    ...
    NONFAILING(*(uint64_t*)0x200002d0 = 0x10000);
    NONFAILING(*(uint64_t*)0x200002d8 = 0x20000040);
    NONFAILING(
        memcpy((void*)0x20000040,
               "\x02\x00\x03\x00\xfe\x00\x01\x00\x8f\x77\xf0\x01\x00\x01\x00"
               "\x00\x00\x40\x00\x00\x60\x00\x00\x00\x00\x40\x00\x00\xc0\x07",
               30));
    NONFAILING(*(uint64_t*)0x200002e0 = 0x1e);
    ...
    NONFAILING(memcpy((void*)0x20011200,
                      ...
                      25));
    NONFAILING(*(uint64_t*)0x200002f8 = 0x19);
    NONFAILING(*(uint64_t*)0x20000300 = 0xa4000);
    NONFAILING(*(uint64_t*)0x20000308 = 0x20011300);
    NONFAILING(memcpy(
        (void*)0x20011300,
        "\x00\x01\x03\x00\x6e\x00\x01\x00\x3a\x1e\xf0\x01\x20\x00\x00\x00\x78"
        "\x10\xe4\x07\x09\x13\x14\x2c\x16\x43\x09\x2d\x03\x00\x03\x00\x01\x00"
        ...
        "\x44\x46",
        121));
    NONFAILING(*(uint64_t*)0x20000310 = 0x79);
    NONFAILING(*(uint64_t*)0x20000318 = 0xa8000);
    ...
    NONFAILING(memcpy(
        ...
        245));
    NONFAILING(*(uint64_t*)0x20000328 = 0xf5);
    NONFAILING(*(uint64_t*)0x20000330 = 0xa80e0);
    NONFAILING(*(uint64_t*)0x20000338 = 0x20011700);
    NONFAILING(memcpy(
        (void*)0x20011700,
        "\x0a\x01\x03\x00\xed\x00\x01\x00\xc6\xe7\xd0\x01\x60\x00\x00\x00\x00"
        ...
        "\x00\x00\x00\x00\x00\x08\x01\x00\x00\x00\x00\x00\x00\x08\x01\x00\x00"
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x10\xe4\x07\x09"
        "\x13\x12\x2c\x16\x43\x09\x2d\x00\x10\xe4\x07\x09\x13\x12\x2c\x17\x09"
        "\x36\x35\x00\x10\xe4\x07\x09\x13\x12\x2c\x16\x43\x09\x2d\x00\x10\xe4"
        "\x07\x09\x13\x12\x2c\x17\x09\x36\x35\x01\x00\x00\x00\x00\x00\x00\x00"
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
        ...
        "\x00\x00\x00\x00\x00\x04\x05\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
        "\x00\x00\x00\x00\x00\x00\x00\x00\x08\x01\x00\x00\x01\x01\x03\x00\x85"
        "\x00\x01\x00\x33\xd4\x18\x00\x60\x00\x00\x00\x01\x00\x0a\x00\x00\x02"
        "\x00\x00\x60\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
        "\x00\x01\x01\x03\x00\x87\x00\x01\x00\xe8\x1d\x1c\x00\x60\x00\x00\x00"
        "\x01\x00\x02\x06\x00\x02\x00\x00\x61\x00\x00\x00\x00\x00\x00\x00\x10"
        "\x00\x00\x00\x00\x00\x08\x66\x69\x6c\x65\x30\x01\x01\x03\x00\x9e\x00"
        "\x01\x00\x1f\xfd\x1c\x00\x60\x00\x00\x00\x01\x00\x00\x06\x00\x02\x00"
        "\x00\x67\x00\x00\x00\x00\x00\x00\x00\x13\x00\x00\x00\x00\x00\x08\x66"
        "\x69\x6c\x65\x31\x01\x01\x03\x00\x09\x00\x01\x00\x97\xf0\x1c\x00\x60"
        "\x00\x00\x00\x01\x00\x00\x06\x00\x02\x00\x00\x68\x00\x00\x00\x00\x00"
        "\x00\x00\x14\x00\x00\x00\x00\x00\x08\x66\x69\x6c\x65\x32\x01\x01\x03"
        "\x00\x28\x00\x01\x00\xc3\xe3\x1c\x00\x60\x00\x00\x00\x01\x00\x00\x06"
        "\x00\x02\x00\x00\x68\x00\x00\x00\x00\x00\x00\x00\x15\x00\x00\x00\x00"
        "\x00\x08\x66\x69\x6c\x65\x33\x01\x01\x03\x00\xe4\x00\x01\x00\xb7\xa7"
        "\x20\x00\x60\x00\x00\x00\x01\x00\x00\x0a\x00\x02\x00\x00\x7b\x00\x00"
        "\x00\x00\x00\x00\x00\x16\x00\x00\x00\x00\x00\x08\x66\x69\x6c\x65\x2e"
        "\x63\x6f\x6c\x64",
        480));
    NONFAILING(*(uint64_t*)0x20000340 = 0x1e0);
    NONFAILING(*(uint64_t*)0x20000348 = 0xb0000);
    NONFAILING(memcpy((void*)0x20000080, "noadinicb", 9));
    NONFAILING(*(uint8_t*)0x20000089 = 0x2c);
    NONFAILING(*(uint8_t*)0x2000008a = 0);
    NONFAILING(syz_mount_image(0x20000000, 0x20000100, 0, 0xe, 0x20000200, 0,
                               0x20000080));
    break;
  case 1:
