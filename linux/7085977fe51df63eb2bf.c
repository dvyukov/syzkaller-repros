...
// https://syzkaller.appspot.com/bug?id=7085977fe51df63eb2bf
// status:0
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000258 = -1;
  ...
  res = -1;
  res = syz_io_uring_setup(0x1db2, 0x20000240, 0x20002000, 0x20ffd000,
                           0x20000080, 0x20000140);
  if (res != -1) {
    r[0] = res;
  ...
  *(uint16_t*)0x2000002a = 0;
  ...
  syscall(__NR_mkdirat, -1, 0x20002040ul, 0ul);
  syscall(__NR_io_uring_enter, r[0], 0x2c, 7, 1ul, 0ul, 0x70cul);
}
int main(void)
{
