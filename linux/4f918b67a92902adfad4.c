...
// https://syzkaller.appspot.com/bug?id=4f918b67a92902adfad4
// status:0
...
{
  intptr_t res = 0;
  memcpy((void*)0x20000040, "\x12\x01\x40\x00\xe5\xe7\xf9\x08\x95\x0b\x2a\x17"
                            "\x22\x78\x00\x00\x00\x01\x09\x02\x12\x00\x01\x00"
                            "\x00\x00\x00\x09\x04\x00\x00\x00\x92\x71\x39\x00",
         36);
  res = syz_usb_connect(0, 0x24, 0x20000040, 0);
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x20000b80 = 0x2c;
  *(uint64_t*)0x20000b84 = 0x20000980;
  *(uint8_t*)0x20000980 = 0;
  *(uint8_t*)0x20000981 = 0;
  *(uint32_t*)0x20000982 = 0;
  *(uint64_t*)0x20000b8c = 0;
  *(uint64_t*)0x20000b94 = 0;
  *(uint64_t*)0x20000b9c = 0;
  *(uint64_t*)0x20000ba4 = 0;
  syz_usb_control_io(r[0], 0, 0x20000b80);
}
int main(void)
{
