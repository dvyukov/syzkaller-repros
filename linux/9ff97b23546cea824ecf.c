...
// https://syzkaller.appspot.com/bug?id=9ff97b23546cea824ecf
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000080, "\xb9", 1));
    syscall(__NR_write, r[0], 0x20000080ul, 1ul);
    break;
  case 3:
    syscall(__NR_fallocate, r[0], 3ul, 0ul, 0x8020003ul);
    break;
  case 4:
    syscall(__NR_open, 0ul, 0x20440ul, 0ul);
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20000280, "./file0", 7));
    NONFAILING(memcpy((void*)0x20000180, "./file0\000", 8));
    syscall(__NR_mount, 0x20000280ul, 0x20000180ul, 0ul, 0x2099050ul, 0ul);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000080, "./file0\000", 8));
    NONFAILING(memcpy((void*)0x200001c0, "dax", 3));
    NONFAILING(*(uint8_t*)0x200001c3 = 0x2c);
    NONFAILING(*(uint8_t*)0x200001c4 = 0);
    syz_mount_image(0, 0x20000080, 0, 0, 0, 0x1a768b0, 0x200001c0);
    break;
  }
}
int main(void)
