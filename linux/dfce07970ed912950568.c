...
// https://syzkaller.appspot.com/bug?id=dfce07970ed912950568
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000280 = 0x20003f40;
  memcpy((void*)0x20003f40, "\x74\x00\x00\x00\x24\x00\x07\x05\x00\x00\x00\x00"
         ...
         20);
  *(uint32_t*)0x20003f54 = r[3];
  memcpy((void*)0x20003f58, "\x00\x00\x00\x00\xff\xff\xff\xff\x00\x00\x00\x00"
  ...
  *(uint64_t*)0x20000080 = 0x200007c0;
  *(uint32_t*)0x200007c0 = 0x34;
  *(uint16_t*)0x200007c4 = 0x28;
  ...
  *(uint32_t*)0x200007d4 = r[3];
  *(uint16_t*)0x200007d8 = 0xffe0;
  ...
  *(uint32_t*)0x200001b0 = 0;
  inject_fault(7);
  syscall(__NR_sendmmsg, r[4], 0x20000180ul, 0x492492492492642ul, 0ul);
}
int main(void)
{
