...
// https://syzkaller.appspot.com/bug?id=3ae233f384d5b0aaa9e0
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    NONFAILING(syz_emit_vhci(0, 0xa6));
    break;
  case 3:
    NONFAILING(syz_emit_vhci(0, 0x2e));
    break;
  case 4:
    res = -1;
  ...
  case 5:
    ...
    NONFAILING(*(uint16_t*)0x2000004a = 3);
    NONFAILING(*(uint8_t*)0x2000004c = 0);
    syscall(__NR_bind, r[0], 0x20000040ul, 0xeul);
    break;
  case 6:
    NONFAILING(*(uint16_t*)0x20000040 = 0x1f);
    NONFAILING(*(uint16_t*)0x20000042 = 0x1f);
