...
// https://syzkaller.appspot.com/bug?id=0591ccf54ee05344e4eb
// status:0
...
int main(void)
{
  ...
  *(uint8_t*)0x20000084 = 0xf8;
  *(uint8_t*)0x20000085 = 0xba;
  *(uint8_t*)0x20000086 = 0x4e;
  *(uint8_t*)0x20000087 = 8;
  *(uint16_t*)0x20000088 = 0x1964;
  *(uint16_t*)0x2000008a = 1;
  *(uint16_t*)0x2000008c = 0x40c4;
  ...
  *(uint8_t*)0x200000a0 = 0xed;
  *(uint8_t*)0x200000a1 = 0x98;
