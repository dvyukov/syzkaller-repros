...
// https://syzkaller.appspot.com/bug?id=7d941e89dd48bcf42573
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000250 = 0x20000480;
  ...
  *(uint16_t*)0x200001e0 = 0x1c;
  STORE_BY_BITMASK(uint16_t, , 0x200001e2, 0x1a, 0, 14);
  STORE_BY_BITMASK(uint16_t, , 0x200001e3, 0, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x200001e3, 1, 7, 1);
  *(uint16_t*)0x200001e4 = 0x18;
  STORE_BY_BITMASK(uint16_t, , 0x200001e6, 0xa, 0, 14);
  STORE_BY_BITMASK(uint16_t, , 0x200001e7, 0, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x200001e7, 1, 7, 1);
  *(uint16_t*)0x200001e8 = 0x14;
  *(uint16_t*)0x200001ea = 7;
  *(uint8_t*)0x200001ec = 0xfe;
  *(uint8_t*)0x200001ed = 0x88;
  memset((void*)0x200001ee, 0, 12);
  *(uint8_t*)0x200001fa = 0;
  *(uint8_t*)0x200001fb = 1 + procid * 1;
  ...
  *(uint32_t*)0x200001c8 = 0;
  *(uint64_t*)0x200001d0 = 0x20000dc0;
  *(uint64_t*)0x20000dc0 = 0;
  *(uint64_t*)0x20000dc8 = 0x4d;
  ...
  *(uint64_t*)0x200000c0 = 0x20000000;
  memcpy((void*)0x20000000,
         "\x34\x00\x00\x00\x10\x00\x01\x04\x00\x00\x00\x00\x00\x00\x00\x00\x00"
         "\x00\x00\x00",
         20);
