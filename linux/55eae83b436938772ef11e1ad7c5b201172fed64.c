...
// https://syzkaller.appspot.com/bug?id=55eae83b436938772ef11e1ad7c5b201172fed64
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint32_t*)0x20000004 = 0x30);
    NONFAILING(*(uint32_t*)0x20000008 = 0);
    NONFAILING(*(uint32_t*)0x2000000c = 0x1c0);
    ...
    NONFAILING(*(uint32_t*)0x20000024 = 0x7f);
    NONFAILING(*(uint32_t*)0x20000028 = 0);
    NONFAILING(*(uint32_t*)0x2000002c = 0);
    NONFAILING(*(uint32_t*)0x20000030 = 0x100);
    NONFAILING(*(uint32_t*)0x20000034 = 0x20);
    ...
    NONFAILING(*(uint32_t*)0x20000054 = 0x40);
    ...
    NONFAILING(*(uint32_t*)0x2000006c = 6);
