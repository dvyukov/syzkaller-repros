...
// https://syzkaller.appspot.com/bug?id=5b142e89a1b402a24801
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_setsockopt, -1, 0x29, 0x2d, 0ul, 0ul);
    break;
  case 2:
    ...
    syscall(__NR_bind, -1, 0x20000000ul, 0x1cul);
    break;
  case 3:
    syscall(__NR_clone, 0x2000000000200500ul, 0ul, 0x9999999999999999ul, 0ul,
            -1ul);
    break;
  case 4:
    NONFAILING(
        memcpy((void*)0x20000180,
               "B\'%nod\005\000\000\035-v\312k\367\314X\342^)]"
    ...
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20002000, "/", 1));
    syscall(__NR_write, r[0], 0x20002000ul, 1ul);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000040, "/dev/vcs\000", 9));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000040ul, 0x105000ul,
                  0ul);
    if (res != -1)
      r[1] = res;
    break;
  case 7:
    res = syscall(__NR_socket, 0xaul, 0x10000000005ul, 0x84);
    if (res != -1)
      r[2] = res;
    break;
  case 8:
    NONFAILING(*(uint64_t*)0x20000340 = 0x20000240);
    ...
    NONFAILING(*(uint32_t*)0x20000348 = 0xc);
    ...
    NONFAILING(*(uint32_t*)0x20000370 = 0x4001);
    syscall(__NR_sendmsg, -1, 0x20000340ul, 0x32cfa6a46f5078f2ul);
    break;
  case 9:
    syscall(__NR_getsockopt, r[2], 0x84, 0x1d, 0ul, 0ul);
    break;
  case 10:
    NONFAILING(*(uint32_t*)0x20000140 = 0);
    syscall(__NR_getsockopt, -1, 0x84, 0x1f, 0ul, 0x20000140ul);
    break;
  case 11:
    NONFAILING(*(uint32_t*)0x200001c0 = 0);
    NONFAILING(*(uint32_t*)0x200001c4 = 0x1ff);
    syscall(__NR_getsockopt, r[1], 0x84, 0x11, 0x200001c0ul, 0ul);
    break;
  case 12:
    syscall(__NR_mmap, 0x20000000ul, 0x3000ul, 4ul, 0x11ul, r[0], 0ul);
    break;
  case 13:
  ...
  case 15:
    ...
    break;
  case 16:
    NONFAILING(memcpy((void*)0x20187ff8, ".", 1));
    syscall(__NR_mount, 0x20000000ul, 0x20187ff8ul, 0ul, 0x5010ul, 0ul);
    break;
  case 17:
    syscall(__NR_tkill, r[3], 0x36);
    break;
  }
}
int main(void)
