...
// https://syzkaller.appspot.com/bug?id=bb950e68b400ab4f65f8
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000080, "/dev/snd/seq\000", 13));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000080ul, 2ul, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 2:
    NONFAILING(memcpy((void*)0x200000c0, "/dev/kvm\000", 9));
  ...
  case 3:
    ...
    break;
  case 4:
    syscall(__NR_ioctl, r[2], 0xae41, 0ul);
    break;
  case 5:
  ...
  case 6:
    ...
    NONFAILING(STORE_BY_BITMASK(uint32_t, , 0x20000288, 0, 0, 1));
    NONFAILING(
        memcpy((void*)0x20000289,
               "queue0\000\000\000\000\000\000\000\000\000\000\000\000\000\000"
               "\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"
               "\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"
               "\000\000\000\000\000\000\000\000\000\000\000\000\000\000",
               64));
    NONFAILING(*(uint32_t*)0x200002cc = 0);
    NONFAILING(memset((void*)0x200002d0, 0, 60));
    syscall(__NR_ioctl, r[0], 0xc08c5332, 0x20000280ul);
    break;
  case 7:
    NONFAILING(*(uint32_t*)0x20001340 = 1);
    NONFAILING(*(uint32_t*)0x20001344 = 0x80);
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001368, 0, 29, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001368, 0, 30, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001368, 0, 31, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001368, 0, 32, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001368, 0, 33, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001368, 0, 34, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001368, 0, 35, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001368, 0, 36, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001368, 0, 37, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20001368, 0, 38, 26));
    NONFAILING(*(uint32_t*)0x20001370 = 0);
    NONFAILING(*(uint32_t*)0x20001374 = 0);
    NONFAILING(*(uint64_t*)0x20001378 = 0x20000000);
    ...
    NONFAILING(*(uint32_t*)0x200013b4 = 0);
    NONFAILING(*(uint64_t*)0x200013b8 = 0);
    syscall(__NR_perf_event_open, 0x20001340ul, 0, -1ul, -1, 9ul);
    break;
  case 8:
    ...
    NONFAILING(memcpy((void*)0x200000d0,
                      "\xa3\x57\xb6\xb1\x40\xcb\xb6\x21\x5d\xd3\x34\x59", 12));
