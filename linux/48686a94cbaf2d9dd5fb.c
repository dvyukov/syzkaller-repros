...
// https://syzkaller.appspot.com/bug?id=48686a94cbaf2d9dd5fb
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    res = syscall(__NR_socket, 0x11ul, 0x800000003ul, 8);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    NONFAILING(*(uint16_t*)0x20000280 = 0x11);
    NONFAILING(memcpy(
        (void*)0x20000282,
  ...
  case 2:
    ...
    break;
  case 3:
    NONFAILING(*(uint32_t*)0x20000040 = 0x76);
    syscall(__NR_setsockopt, r[1], 6, 2, 0x20000040ul, 4ul);
    break;
  case 4:
    NONFAILING(*(uint16_t*)0x20000280 = 2);
    NONFAILING(*(uint16_t*)0x20000282 = htobe16(0x4e23));
    NONFAILING(*(uint32_t*)0x20000284 = htobe32(-1));
    syscall(__NR_bind, r[1], 0x20000280ul, 0x10ul);
    break;
  case 5:
    NONFAILING(*(uint16_t*)0x20000480 = 1);
    NONFAILING(*(uint64_t*)0x20000488 = 0x20000100);
    NONFAILING(*(uint16_t*)0x20000100 = 6);
    NONFAILING(*(uint8_t*)0x20000102 = 0);
    NONFAILING(*(uint8_t*)0x20000103 = 0);
    NONFAILING(*(uint32_t*)0x20000104 = 0xeb);
    syscall(__NR_setsockopt, r[1], 1, 0x1a, 0x20000480ul, 0x10ul);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x200000c0, "dctcp\000", 6));
    syscall(__NR_setsockopt, -1, 6, 0xd, 0x200000c0ul, 6ul);
    break;
  case 7:
    ...
    break;
  case 8:
    NONFAILING(memcpy((void*)0x200007c0, "bbr\000", 4));
    syscall(__NR_setsockopt, r[1], 6, 0xd, 0x200007c0ul, 4ul);
    break;
  case 9:
  ...
  case 10:
    NONFAILING(memcpy(
        (void*)0x20000300,
        "\xba\x40\xf6\xea\xa2\x2e\x32\xd8\xe4\x40\x10\x75\x8b\xd0\xf2\xb1\x5f"
        "\xcb\x5a\x37\x1d\xeb\x2b\xc9\xbd\xdb\xf9\x0b\xc2\xa6\x26\x52\x79\xfc"
        "\xae\x3f\x30\xcf\x93\xaa\x9e\xc8\x7f\xb4\xe9\x7d\x79\x58\x67\xcd\x46"
        "\x0c\xb3\x5a\x39\x05\x20\xb5\x16\xd4\x3e\xd1\x96\xd1\xb4\x62\xf8\x2c"
        "\x8c\x0a\x44\xe6\x2f\x31\x54\x0f\xb0\x20\x0f\x4f\xc1\xfe\x8b\x69\x08"
        "\xd0\x05\xf9\xb8\x20\xf1\x40\xc5\x01\x5c\xcd\x66\x7c\x5b\x48\x99\x91"
        "\x26\xe8\xb3\x85\x76\x22\x27\xaa\xb9\x65\x93\x97\x7e\x77\xed\xbb\xc3"
        "\xbd\xe1\x7a\x09\x5f\x0c\xa0\x40\x43\x28\x5c\xe4\xa0\xaf\x67\xa5\x8f"
        "\x02\xc3\x40\xcc\x98\x0c\x5f\xd4\xbe\xa1\x9f\x9e\x96\x51\x17\xe8\x63"
        "\x33\xb8\x56\xad\x1b\xa1\x6b\xe8\xf2\x02\x40\x86\x5c\xc8\x12\x20",
        169));
    syscall(__NR_sendto, r[0], 0x20000300ul, 0xa9ul, 0ul, 0ul, 0ul);
    break;
  case 11:
    NONFAILING(memcpy(
        (void*)0x200012c0,
        "\x0c\x26\x8a\x92\x7f\x1f\x65\x88\xb9\x67\x48\x12\x41\xba\x78\x60\xac"
        "\x5c\xf6\x5a\xc6\x18\xde\xd8\x97\x48\x95\xab\xea\xf4\xb4\x83\x4f\xf9"
        "\x22\xb3\xf1\xe0\xb0\x2b\xd6\x7a\xa0\x30\x59\xbc\xec\xc7\xa9\x54\x25"
        "\xa3\xa0\x7e\x75\x80\x44\xab\x4e\xa6\xf7\xae\x55\xd8\x8f\xec\xf9\x3a"
        "\x1a\x75\x11\xbf\x74\x6b\xec\x66\xba",
        77));
    syscall(__NR_sendto, r[1], 0x200012c0ul, 0xfe6aul, 0x20c49aul, 0ul, 0x27ul);
    break;
  }
}
int main(void)
