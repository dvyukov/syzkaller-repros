...
void execute_one(void)
{
  ...
  memcpy((void*)0x20000300, "cgroup2\000", 8);
  syscall(__NR_mount, 0, 0x20000380, 0x20000300, 0, 0);
  memcpy((void*)0x20000240, "./file0//ile0\000", 14);
  syscall(__NR_rmdir, 0x20000240);
  memcpy((void*)0x20000000, "./file0//ile0\000", 14);
  inject_fault(65);
