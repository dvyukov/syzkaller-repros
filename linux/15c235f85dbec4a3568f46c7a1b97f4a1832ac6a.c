...
// https://syzkaller.appspot.com/bug?id=15c235f85dbec4a3568f46c7a1b97f4a1832ac6a
// status:dup
...
void* thr(void* arg)
{
  ...
  case 3:
    ...
    break;
  case 4:
    syscall(__NR_ioctl, r[2], 0xae80ul, 0x0ul);
    break;
  case 5:
    *(uint64_t*)0x20782000 = (uint64_t)0x40;
    *(uint64_t*)0x20782008 = (uint64_t)0x2090cfae;
    *(uint64_t*)0x20782010 = (uint64_t)0x52;
    memcpy((void*)0x2090cfae,
           "\xc4\xa1\x11\xde\x06\x64\x2e\x2e\x4f\x0f\xc7\xa8\xf6\x1f"
           "\x00\x00\x66\xba\x61\x00\x66\xed\xc4\xe2\x91\x07\x18\xc7"
           "\x44\x24\x00\x53\x00\x00\x00\xc7\x44\x24\x02\x1e\x80\x8d"
           "\xd1\xff\x1c\x24\xb9\xb3\x03\x00\x00\xb8\x06\x00\x00\x00"
           "\xba\x00\x00\x00\x00\x0f\x30\x40\x0f\x01\xca\x0f\x07\xc4"
           "\xe2\x79\xdb\x9a\x27\x99\x98\xfb\x2e\x0f\xc1\xf9",
           82);
    syz_kvm_setup_cpu(0xfffffffffffffffful, r[2], 0x206a2000ul,
                      0x20782000ul, 0x1ul, 0x0ul, 0x20574000ul, 0x0ul);
    break;
  }
  return 0;
}
