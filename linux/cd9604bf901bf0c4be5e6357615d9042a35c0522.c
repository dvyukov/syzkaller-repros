// WARNING in kmem_cache_free (2)
// https://syzkaller.appspot.com/bug?id=cd9604bf901bf0c4be5e6357615d9042a35c0522
// status:dup
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x2001d028, 5, 2, 1));
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, 0x2001d028, 1, 26, 1));
  ...
  case 2:
    ...
    NONFAILING(*(uint16_t*)0x2047b002 = htobe16(0x4e20));
    NONFAILING(*(uint32_t*)0x2047b004 = 0);
    NONFAILING(*(uint8_t*)0x2047b008 = 0);
    NONFAILING(*(uint8_t*)0x2047b009 = 0);
    NONFAILING(*(uint8_t*)0x2047b00a = 0);
    NONFAILING(*(uint8_t*)0x2047b00b = 0);
    NONFAILING(*(uint8_t*)0x2047b00c = 0);
    NONFAILING(*(uint8_t*)0x2047b00d = 0);
    NONFAILING(*(uint8_t*)0x2047b00e = 0);
    NONFAILING(*(uint8_t*)0x2047b00f = 0);
    NONFAILING(*(uint8_t*)0x2047b010 = 0);
    NONFAILING(*(uint8_t*)0x2047b011 = 0);
    NONFAILING(*(uint8_t*)0x2047b012 = 0);
    NONFAILING(*(uint8_t*)0x2047b013 = 0);
    NONFAILING(*(uint8_t*)0x2047b014 = 0);
    NONFAILING(*(uint8_t*)0x2047b015 = 0);
    NONFAILING(*(uint8_t*)0x2047b016 = 0);
    NONFAILING(*(uint8_t*)0x2047b017 = 0);
    NONFAILING(*(uint32_t*)0x2047b018 = 0);
    syscall(__NR_bind, r[0], 0x2047b000, 0x1c);
    break;
  case 3:
    syscall(__NR_listen, r[0], 0x20000003);
    break;
  case 4:
  ...
  case 5:
    ...
    NONFAILING(*(uint16_t*)0x20419002 = htobe16(0x4e20));
    NONFAILING(*(uint32_t*)0x20419004 = 0);
    ...
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x20047ffc = 0xc);
    res = syscall(__NR_accept4, r[0], 0x204d4000, 0x20047ffc, 0);
    if (res != -1)
      r[2] = res;
    break;
  case 7:
    ...
    NONFAILING(memcpy(
        (void*)0x20000002,
        "\x8c\x36\xb0\x43\xd0\x81\xc3\xc1\x50\x3a\xf6\xa7\x68\x40\x6b\x92\x67"
        "\xf6\x0a\xc2\x86\xda\x23\x38\xbd\x8e\x3f\x6b\xa9\x90\x18\x99\x77\x17"
        "\x0a\x07\x05\xea\x90\xc1\x3e\x26\xba\x0b\x96\x6b\x9b\x9d\x32\x89\xc8"
        "\x78\x4f\x16\x96\x3c\xe7\xc3\x12\x64\x9c\xe2\x99\x6c\xd4\xe7\x12\x6f"
        "\x70\x4a\xb2\x54\x6e\x51\x6d\x21\x6e\xd2\xfb\x7a\x95\xff\x90\x61\x85"
        "\x87\x4a\x2d\x44\x02\x9a\x01\xf4\x6a\x38\x0e\x73\xc5\x47\x7e\xfe\x9e"
        "\x01\x54\x86\x12\xaf\xd6\xc6\x67\xbe\x50\x0d\x74\x80\x38\xf4\x99\xa4"
        "\x92\xef\x8f\xe4\xe6\x26\x53",
        126));
    syscall(__NR_connect, r[2], 0x20000000, 0x6c);
    break;
  case 8:
