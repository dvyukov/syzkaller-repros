// INFO: task hung in io_wq_put_and_exit (3)
// https://syzkaller.appspot.com/bug?id=adb05ed2853417be49ce
// status:0
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000258 = -1;
  ...
  res = -1;
  res = syz_io_uring_setup(0x3ee4, 0x20000240, 0x20002000, 0x20ffd000,
  ...
  res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000040ul, 0x8a04ul, 0ul);
  if (res != -1)
    r[3] = res;
  ...
  *(uint32_t*)0x20000580 = 3;
  syscall(__NR_ioctl, r[3], 0x5423, 0x20000580ul);
