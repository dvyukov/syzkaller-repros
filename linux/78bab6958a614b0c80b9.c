...
// https://syzkaller.appspot.com/bug?id=78bab6958a614b0c80b9
// status:0
...
void execute_call(int call)
{
  ...
  case 4:
    ...
    *(uint16_t*)0x20000054 = 8;
    STORE_BY_BITMASK(uint16_t, , 0x20000056, 7, 0, 14);
    STORE_BY_BITMASK(uint16_t, , 0x20000057, 1, 6, 1);
    STORE_BY_BITMASK(uint16_t, , 0x20000057, 0, 7, 1);
    *(uint32_t*)0x20000058 = htobe32(0x518);
    *(uint64_t*)0x20000108 = 0x1c;
    *(uint64_t*)0x20000158 = 1;
    *(uint64_t*)0x20000160 = 0;
    *(uint64_t*)0x20000168 = 0;
    *(uint32_t*)0x20000170 = 0x8001;
    syscall(__NR_sendmsg, r[2], 0x20000140ul, 0x10ul);
    break;
  case 5:
