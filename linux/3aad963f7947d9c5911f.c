...
// https://syzkaller.appspot.com/bug?id=3aad963f7947d9c5911f
// status:0
...
void loop(void)
{
  ...
  *(uint32_t*)0x20000718 = 0x3085d;
  *(uint32_t*)0x2000071c = 0;
  *(uint16_t*)0x20000720 = 0x14;
  *(uint16_t*)0x20000722 = 3;
  memcpy((void*)0x20000724, "ipvlan1\000\000\000\000\000\000\000\000\000", 16);
  *(uint16_t*)0x20000734 = 0x1c;
  STORE_BY_BITMASK(uint16_t, , 0x20000736, 0x12, 0, 14);
  STORE_BY_BITMASK(uint16_t, , 0x20000737, 0, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x20000737, 1, 7, 1);
  *(uint16_t*)0x20000738 = 0xb;
  *(uint16_t*)0x2000073a = 1;
  memcpy((void*)0x2000073c, "ipvlan\000", 7);
  *(uint16_t*)0x20000744 = 0xc;
  STORE_BY_BITMASK(uint16_t, , 0x20000746, 2, 0, 14);
  STORE_BY_BITMASK(uint16_t, , 0x20000747, 0, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x20000747, 1, 7, 1);
  ...
  *(uint32_t*)0x200000b0 = 0x10;
  syscall(__NR_sendmsg, r[0], 0x20000080ul, 0ul);
  res = syscall(__NR_socketpair, 1ul, 5ul, 0, 0x20000340ul);
  if (res != -1) {
  ...
  if (res != -1)
    r[3] = res;
  memcpy((void*)0x200000c0, "ipvlan1\000\000\000\000\000\000\000\000\000", 16);
  res = syscall(__NR_ioctl, r[2], 0x8933, 0x200000c0ul);
  if (res != -1)
  ...
  *(uint8_t*)0x20000213 = 0;
  syscall(__NR_bind, r[3], 0x20000200ul, 0x14ul);
  *(uint32_t*)0x20000300 = 8;
  syscall(__NR_setsockopt, r[3], 0x107, 0x14, 0x20000300ul, 4ul);
  res = syscall(__NR_io_setup, 7, 0x20000280ul);
  if (res != -1)
    r[5] = *(uint64_t*)0x20000280;
  *(uint64_t*)0x20000080 = 0x20000540;
  *(uint64_t*)0x20000540 = 0;
  *(uint32_t*)0x20000548 = 0;
  *(uint32_t*)0x2000054c = 0;
  *(uint16_t*)0x20000550 = 1;
  *(uint16_t*)0x20000552 = 0;
  *(uint32_t*)0x20000554 = r[1];
  *(uint64_t*)0x20000558 = 0x20000040;
  memcpy((void*)0x20000040,
         "\xf1\x2d\x55\xa3\xf3\x82\x7f\xc9\x8d\xa6\xc0\x9c\xe8\x19", 14);
  *(uint64_t*)0x20000560 = 0xe;
  *(uint64_t*)0x20000568 = 0;
  *(uint64_t*)0x20000570 = 0;
  *(uint32_t*)0x20000578 = 0;
  *(uint32_t*)0x2000057c = -1;
  syscall(__NR_io_submit, r[5], 1ul, 0x20000080ul);
}
int main(void)
{
