...
// https://syzkaller.appspot.com/bug?id=1db9cf841c8e310e224b9eba480f0bcfc0f2d69e
// status:open
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000154 = 0;
  memcpy((void*)0x20000158, "generic-gcm-"
                            "aesni\000\000\000\000\000\000\000\000\000\000\000"
  ...
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x20c18000, "\xad\x56\xb6\xc5\x82\x0f\x05\x00\x00\x00\x32\x92"
                            "\xea\x54\xc7\xbe\xef\x91\x5d\x56\x4c\x90\xc2\x00",
         24);
  syscall(__NR_setsockopt, r[0], 0x117ul, 1ul, 0x20c18000ul, 0x18ul);
  *(uint64_t*)0x20001240 = 0;
  *(uint32_t*)0x20001248 = 0;
  *(uint64_t*)0x20001250 = 0x20000540;
  *(uint64_t*)0x20000540 = 0x20000440;
  memcpy((void*)0x20000440,
         "\x1a\xf0\x29\x63\xc6\xf0\xd5\x88\xbe\x90\x61\xbf\xf1\x5c\xac\xd0",
         16);
  *(uint64_t*)0x20000548 = 0x10;
  *(uint64_t*)0x20001258 = 1;
  *(uint64_t*)0x20001260 = 0;
  *(uint64_t*)0x20001268 = 0;
  *(uint32_t*)0x20001270 = 0;
  syscall(__NR_sendmmsg, r[1], 0x20001240ul, 1ul, 0ul);
  syscall(__NR_recvfrom, r[1], 0x20003240ul, 0x100000205ul, 0ul, 0ul, 0x415ul);
}
int main(void)
{
