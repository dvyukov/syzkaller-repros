...
// https://syzkaller.appspot.com/bug?id=2e14b29255294d1caa46
// status:6
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_epoll_create, 5);
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000040, "/dev/audio1\000", 12));
    res =
  ...
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_epoll_ctl, r[3], 1ul, r[1], 0ul);
    break;
  case 7:
  ...
  case 8:
    ...
    syscall(__NR_epoll_ctl, r[3], 1ul, r[0], 0x20000080ul);
    break;
  }
}
int main(void)
