...
// https://syzkaller.appspot.com/bug?id=47bbc6b678d317cccbe0
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x200003c0, "TIPC\000", 5));
  ...
  case 2:
    ...
    NONFAILING(*(uint64_t*)0x20000650 = 0x20000680);
    ...
    NONFAILING(*(uint16_t*)0x20000058 = 0x4101);
    NONFAILING(*(uint16_t*)0x2000005a = 0);
    NONFAILING(*(uint16_t*)0x2000005c = htobe16(0x18));
    NONFAILING(*(uint16_t*)0x2000005e = htobe16(0x17));
    NONFAILING(*(uint32_t*)0x20000060 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20000064 = htobe32(0));
    NONFAILING(memcpy((void*)0x20000068, "eth", 3));
    NONFAILING(*(uint8_t*)0x2000006b = 0x3a);
    NONFAILING(memcpy((void*)0x2000006c, "macsec0\000", 8));
    NONFAILING(*(uint64_t*)0x20000688 = 0x34);
    ...
    break;
  case 3:
    syscall(__NR_write, -1, 0ul, 0x32600ul);
    break;
  case 4:
    syscall(__NR_ioctl, -1, 0x8b04, 0ul);
    break;
  case 5:
    syscall(__NR_openat, 0xffffffffffffff9cul, 0ul, 0x80ul, 0ul);
    break;
  case 6:
    res = syscall(__NR_socket, 0x10ul, 3ul, 0x10);
    if (res != -1)
  ...
  case 8:
    ...
    NONFAILING(*(uint32_t*)0x20000488 = 0x68);
    NONFAILING(*(uint64_t*)0x20000490 = 0x20000040);
    NONFAILING(*(uint64_t*)0x20000040 = 0x200004c0);
    NONFAILING(*(uint32_t*)0x200004c0 = 0x54);
    ...
    NONFAILING(*(uint8_t*)0x200004d0 = 0x17);
    NONFAILING(*(uint8_t*)0x200004d1 = 0);
    NONFAILING(*(uint16_t*)0x200004d2 = 0);
    NONFAILING(*(uint16_t*)0x200004d4 = 0x40);
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200004d6, 6, 0, 14));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200004d7, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint16_t, , 0x200004d7, 1, 7, 1));
    NONFAILING(*(uint16_t*)0x200004d8 = 0x3c);
    ...
    NONFAILING(memcpy((void*)0x200004dc,
                      ...
                      32));
    NONFAILING(*(uint32_t*)0x200004fc = 0x14);
    NONFAILING(memcpy((void*)0x20000500,
                      "\x71\xf0\xfc\xf2\xaa\x12\x02\x40\xb1\x71\x3a\x97\x6c\x10"
                      "\x48\x20\xde\x2b\x91\x00",
                      20));
    NONFAILING(*(uint64_t*)0x20000048 = 0x54);
  ...
  case 10:
    NONFAILING(memcpy((void*)0x200003c0, "TIPC\000", 5));
    syz_genetlink_get_family_id(0x200003c0);
    break;
  }
}
int main(void)
