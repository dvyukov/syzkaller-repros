// INFO: task hung in dev_deactivate_many
// https://syzkaller.appspot.com/bug?id=840a27d9d9dd0e8a71c884c0c0734a4c859e42bb
// status:invalid
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_sigaltstack, 0x20ff8000, 0x200001c0);
    break;
  case 3:
    NONFAILING(*(uint8_t*)0x200019c0 = 0x20);
    syscall(__NR_setsockopt, -1, 0x84, 0x15, 0x200019c0, 1);
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000040, "/proc/self/net/pfkey", 21));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000040, 2, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 5:
    syscall(__NR_setsockopt, r[0], 0x111, 5, 0xc4, 4);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000080, "/dev/dsp#", 10));
    res = syz_open_dev(0x20000080, 1, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 7:
    NONFAILING(*(uint64_t*)0x20000000 = 0x1000);
    syscall(__NR_ioctl, r[1], 0x800000c0045005, 0x20000000);
    break;
  case 8:
  ...
  case 9:
    ...
    res = syscall(__NR_ioctl, r[1], 0x8933, 0x20000100);
    if (res != -1)
      NONFAILING(r[2] = *(uint32_t*)0x20000110);
    break;
  case 10:
    NONFAILING(*(uint8_t*)0x20000280 = -1);
    NONFAILING(*(uint8_t*)0x20000281 = 2);
    ...
    NONFAILING(*(uint32_t*)0x20000290 = 2);
    NONFAILING(*(uint32_t*)0x20000294 = r[2]);
    syscall(__NR_ioctl, -1, 0x8936, 0x20000280);
    break;
  case 11:
    NONFAILING(*(uint32_t*)0x200000c0 = r[0]);
    syscall(__NR_ioctl, r[1], 0x4004af07, 0x200000c0);
    break;
  case 12:
    syscall(__NR_ioctl, -1, 0x8905, 0x20000180);
    break;
  case 13:
