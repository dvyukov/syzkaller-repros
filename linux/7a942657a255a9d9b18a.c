...
// https://syzkaller.appspot.com/bug?id=7a942657a255a9d9b18a
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(memcpy(
      (void*)0x20000140,
      "\x12\x01\x00\x00\x00\x00\x18\x10\x5e\x04\xda\x07\x00\x00\x00\x00\x00\x01"
      "\x09\x02\x24\x00\x01\x00\x00\x00\x00\x09\x04\x00\x00\x09\x03\x00\x00\x00"
      "\x09\x21\x00\x00\x00\x01\x22\x22\x00\x09\x05\x81\x03\xee",
      50));
  res = -1;
  NONFAILING(res = syz_usb_connect(0, 0x36, 0x20000140, 0));
  if (res != -1)
    r[0] = res;
  NONFAILING(syz_usb_control_io(r[0], 0, 0));
  NONFAILING(*(uint32_t*)0x20000080 = 0x24);
  NONFAILING(*(uint64_t*)0x20000084 = 0);
  NONFAILING(*(uint64_t*)0x2000008c = 0);
  NONFAILING(*(uint64_t*)0x20000094 = 0x20000000);
  NONFAILING(memcpy((void*)0x20000000,
                    "\x00\x22\x26\x00\x00\x00\x96\x23\x13\x02\x0f\x01\x58\x27"
                    "\xb3\xad\xbf\x52\x06\xf8\x3f\x07\x01\x00\x00\x08\x2a\xd0"
                    "\x33\xb9\x8e\x24\xb0\x60\x35\xbd",
                    36));
