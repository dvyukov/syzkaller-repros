...
// https://syzkaller.appspot.com/bug?id=9f57216a517eb79b590e
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    if (res != -1)
      NONFAILING(r[1] = *(uint32_t*)0x200003c4);
    break;
  case 3:
  ...
  case 4:
    ...
    NONFAILING(*(uint32_t*)0x20000400 = 0x148);
    NONFAILING(*(uint16_t*)0x20000404 = 0x24);
    NONFAILING(*(uint16_t*)0x20000406 = 0xd0b);
    ...
    NONFAILING(*(uint32_t*)0x20000414 = r[1]);
    NONFAILING(*(uint16_t*)0x20000418 = 0);
    NONFAILING(*(uint16_t*)0x2000041a = 0);
    NONFAILING(*(uint16_t*)0x2000041c = 0);
    NONFAILING(*(uint16_t*)0x2000041e = -1);
    NONFAILING(*(uint16_t*)0x20000420 = 0);
    NONFAILING(*(uint16_t*)0x20000422 = 0);
    NONFAILING(*(uint16_t*)0x20000424 = 8);
    NONFAILING(*(uint16_t*)0x20000426 = 1);
    NONFAILING(memcpy((void*)0x20000428, "red\000", 4));
    NONFAILING(*(uint16_t*)0x2000042c = 0x11c);
    NONFAILING(*(uint16_t*)0x2000042e = 2);
    NONFAILING(*(uint16_t*)0x20000430 = 0x104);
    ...
    NONFAILING(memcpy(
        ...
        "\x47",
        256));
    NONFAILING(*(uint16_t*)0x20000534 = 0x14);
    NONFAILING(*(uint16_t*)0x20000536 = 1);
    NONFAILING(*(uint32_t*)0x20000538 = 0x1000);
    ...
    NONFAILING(*(uint8_t*)0x20000547 = 6);
    NONFAILING(*(uint64_t*)0x20000788 = 0x148);
    NONFAILING(*(uint64_t*)0x200007d8 = 1);
    NONFAILING(*(uint64_t*)0x200007e0 = 0);
    NONFAILING(*(uint64_t*)0x200007e8 = 0);
    NONFAILING(*(uint32_t*)0x200007f0 = 0x8040);
  ...
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_write, -1, 0ul, 0xff01ul);
    break;
  case 7:
  ...
  case 12:
    ...
    if (res != -1)
      NONFAILING(r[4] = *(uint32_t*)0x200003c4);
    break;
  case 13:
    res = syscall(__NR_socket, 0x10ul, 3ul, 0);
    if (res != -1)
  ...
  case 14:
    ...
    NONFAILING(*(uint16_t*)0x20000418 = 0);
    NONFAILING(*(uint16_t*)0x2000041a = 0);
    NONFAILING(*(uint16_t*)0x2000041c = 0xfff1);
    NONFAILING(*(uint16_t*)0x2000041e = -1);
    NONFAILING(*(uint16_t*)0x20000420 = 0);
    NONFAILING(*(uint16_t*)0x20000422 = 0);
    NONFAILING(*(uint16_t*)0x20000424 = 8);
