...
// https://syzkaller.appspot.com/bug?id=19f4fe2052e66ee13a6a
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0ul, 0x100000ul, 0ul);
    if (res != -1)
      r[1] = res;
    break;
  case 2:
  ...
  case 3:
    ...
    break;
  case 4:
    syscall(__NR_ioctl, r[2], 0x40045108, 0ul);
    break;
  case 5:
    syscall(__NR_ioctl, r[1], 0x5402, 0);
    break;
  case 6:
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0ul, 0x10882ul, 0ul);
    if (res != -1)
      r[3] = res;
    break;
  case 7:
    syscall(__NR_ioctl, r[3], 0x8004510b, 0ul);
    break;
  case 8:
    syscall(__NR_write, r[0], 0ul, 0ul);
    break;
  case 9:
    syscall(__NR_ioctl, r[0], 0x5100, 0);
    break;
  case 10:
    syscall(__NR_ioctl, r[0], 0x5100, 0);
    break;
