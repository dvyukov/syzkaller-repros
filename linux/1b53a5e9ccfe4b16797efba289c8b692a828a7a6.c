...
int main(void)
{
  ...
  *(uint8_t*)0x20000004 = 0xe4;
  *(uint8_t*)0x20000005 = 0xec;
  *(uint8_t*)0x20000006 = 6;
  *(uint8_t*)0x20000007 = 0x40;
  *(uint16_t*)0x20000008 = 0x77d;
  *(uint16_t*)0x2000000a = 0x627a;
  *(uint16_t*)0x2000000c = 1;
  *(uint8_t*)0x2000000e = 1;
  *(uint8_t*)0x2000000f = 0x40;
  *(uint8_t*)0x20000010 = -1;
  *(uint8_t*)0x20000011 = 1;
  *(uint8_t*)0x20000012 = 9;
  *(uint8_t*)0x20000013 = 2;
  *(uint16_t*)0x20000014 = 0x35;
  *(uint8_t*)0x20000016 = 1;
  *(uint8_t*)0x20000017 = 0xfb;
  *(uint8_t*)0x20000018 = -1;
  *(uint8_t*)0x20000019 = 0x40;
  *(uint8_t*)0x2000001a = 0xb9;
  *(uint8_t*)0x2000001b = 9;
  *(uint8_t*)0x2000001c = 4;
  *(uint8_t*)0x2000001d = 0x6a;
  *(uint8_t*)0x2000001e = 9;
  *(uint8_t*)0x2000001f = 3;
  *(uint8_t*)0x20000020 = 3;
  *(uint8_t*)0x20000021 = 0x52;
  *(uint8_t*)0x20000022 = 0xb5;
  ...
  *(uint64_t*)0x20001bf4 = 0;
  *(uint32_t*)0x20001bfc = 0;
  *(uint64_t*)0x20001c00 = 0;
  *(uint32_t*)0x20001c08 = 0;
  *(uint64_t*)0x20001c0c = 0;
  syz_usb_connect(2, 0x47, 0x20000000, 0x20001b80);
  return 0;
}
