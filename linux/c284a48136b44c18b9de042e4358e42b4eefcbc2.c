...
// https://syzkaller.appspot.com/bug?id=c284a48136b44c18b9de042e4358e42b4eefcbc2
// status:open
...
void execute_call(int call)
{
  switch (call) {
  case 0:
    NONFAILING(*(uint32_t*)0x2000cffc = 4);
    NONFAILING(*(uint32_t*)0x20048000 = 0);
    syscall(__NR_futex, 0x2000cffc, 0x80000000000b, 4, 0, 0x20048000, 0);
    break;
  case 1:
    NONFAILING(*(uint32_t*)0x2000cffc = 2);
    syscall(__NR_futex, 0x2000cffc, 0, 3, 0, 0, 0);
    break;
  case 2:
    NONFAILING(*(uint32_t*)0x2000cffc = 4);
    NONFAILING(*(uint32_t*)0x20048000 = 0);
    syscall(__NR_futex, 0x2000cffc, 0xb, 4, 0, 0x20048000, 0);
    break;
  case 3:
    NONFAILING(*(uint32_t*)0x2000cffc = 0);
    NONFAILING(*(uint64_t*)0x2000d000 = 0);
    NONFAILING(*(uint64_t*)0x2000d008 = 0x7f);
    NONFAILING(*(uint32_t*)0x20048000 = 0xc0000000);
    syscall(__NR_futex, 0x2000cffc, 0xc, 1, 0x2000d000, 0x20048000, 0);
    break;
  }
}
int main(void)
