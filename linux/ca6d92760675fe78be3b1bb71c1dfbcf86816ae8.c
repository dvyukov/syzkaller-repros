...
// https://syzkaller.appspot.com/bug?id=ca6d92760675fe78be3b1bb71c1dfbcf86816ae8
// status:fixed
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000000, "cgroup.controllers", 19));
  ...
  case 2:
    ...
    break;
  case 3:
    res = syscall(__NR_socketpair, 0, 0x80002, 0, 0x20000080);
    if (res != -1)
  ...
  case 4:
    ...
    syscall(__NR_ioctl, -1, 0xc008240a, 0x20000140);
    break;
  case 5:
    NONFAILING(memcpy((void*)0x200001c0, "cpuacct.stat", 13));
    syscall(__NR_openat, r[2], 0x200001c0, 0, 0);
    break;
  case 6:
  ...
  case 10:
    ...
    break;
  case 11:
    NONFAILING(memcpy((void*)0x20000100, "rdma.current", 13));
    syscall(__NR_openat, r[0], 0x20000100, 0, 0);
    break;
  case 12:
  ...
  case 15:
    NONFAILING(memcpy(
        ...
        421));
    syscall(__NR_ioctl, r[4], 0x8914, 0x20000780);
    break;
  case 16:
    NONFAILING(memcpy((void*)0x20001a00, "/dev/net/tun", 13));
  ...
  case 17:
    NONFAILING(memcpy(
        ...
        16));
    NONFAILING(*(uint16_t*)0x20000310 = 0x1132);
    syscall(__NR_ioctl, r[5], 0x400454ca, 0x20000300);
    break;
  case 18:
    NONFAILING(sprintf((char*)0x20000000, "0x%016llx", (long long)0));
    syscall(__NR_write, r[5], 0x20000000, 0x17b);
    break;
  case 19:
