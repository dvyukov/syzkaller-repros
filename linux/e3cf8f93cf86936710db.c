...
// https://syzkaller.appspot.com/bug?id=e3cf8f93cf86936710db
// status:0 arch:386
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000080, "/dev/dsp1\000", 10));
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_epoll_ctl, (intptr_t)r[1], 1, (intptr_t)r[0], 0);
    break;
  case 3:
    res = syscall(__NR_epoll_create1, 0);
    if (res != -1)
  ...
  case 5:
    ...
    syscall(__NR_epoll_ctl, (intptr_t)r[3], 1, (intptr_t)r[2], 0x20000000);
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x20000240 = 0);
    NONFAILING(*(uint64_t*)0x20000244 = 0);
    syscall(__NR_epoll_ctl, (intptr_t)r[2], 1, (intptr_t)r[0], 0x20000240);
    break;
  }
}
int main(void)
