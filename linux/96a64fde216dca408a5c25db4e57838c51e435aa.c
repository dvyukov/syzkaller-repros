...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_bpf, 0xa, 0, 0);
    break;
  case 2:
    syscall(__NR_socketpair, 1, 0, 0, 0x20000000);
    break;
  case 3:
    syscall(__NR_socket, 0x29, 0, 0);
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000200, "rdma.current\000", 13));
    syscall(__NR_openat, -1, 0x20000200, 0, 0);
    break;
  case 5:
    syscall(__NR_ioctl, -1, 0x2400, 0xffffffffffffff49);
    break;
  case 6:
  ...
  case 8:
    ...
    NONFAILING(*(uint64_t*)0x200007e0 = 0x20000c80);
    NONFAILING(*(uint64_t*)0x200007e8 = 0xb2);
    NONFAILING(*(uint32_t*)0x200007f0 = 0);
    syscall(__NR_recvmsg, -1, 0x200007c0, 0);
    break;
  case 9:
  ...
  case 10:
    ...
    syscall(__NR_openat, -1, 0x20000140, 0x7a05, 0x1700);
    break;
  case 11:
    ...
    NONFAILING(
        STORE_BY_BITMASK(uint64_t, , 0x20000068, 0xfffffffffffffffd, 12, 1));
    ...
    NONFAILING(*(uint32_t*)0x2000009c = 5);
  ...
  case 14:
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0, 11, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0, 12, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 1, 13, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0, 14, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0, 15, 2));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 1, 17, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0, 18, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 1, 19, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0, 20, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0, 21, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0, 22, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0, 23, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0, 24, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0, 25, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 1, 26, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0, 27, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0, 28, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0, 29, 35));
    NONFAILING(*(uint32_t*)0x200001b0 = 0);
  ...
  case 15:
    NONFAILING(memcpy(
        (void*)0x200003c0,
        "/group.stat\000<#\373W*"
        "\037\002\224\346\363x\264\032\325KM\235\232\037c\370xZ\321\210\247\341"
        "\310\210u\340[\030\244\313:\234\321-\316\244@\330\231\302,e+:"
        "G\033J\177\242\363\375\366\3404\330\004\345\360\337K\035\356H;\025v$"
        "\305\234\001\000\350\236j5|\000\000\000",
        96));
    res = syscall(__NR_openat, -1, 0x200003c0, 0x2761, 0);
    if (res != -1)
      r[1] = res;
    break;
  case 16:
    NONFAILING(sprintf((char*)0x20000080, "0x%016llx", (long long)0x1b00));
    syscall(__NR_write, r[1], 0x20000080, 0x297ef);
    break;
  case 17:
    NONFAILING(memcpy((void*)0x20000280, "veth0_to_bridge\000", 16));
    NONFAILING(*(uint16_t*)0x20000290 = 0);
    syscall(__NR_ioctl, -1, 0x400454d9, 0x20000280);
    break;
  case 18:
    res = syscall(__NR_socket, 2, 0, 0);
    if (res != -1)
      r[2] = res;
    break;
  case 19:
    ...
    syscall(__NR_recvmsg, -1, 0x20000a80, 0);
    break;
  case 20:
    NONFAILING(*(uint32_t*)0x20000000 = -1);
    syscall(__NR_ioctl, r[2], 0x890b, 0x20000000);
    break;
  }
}
int main(void)
