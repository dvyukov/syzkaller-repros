...
// https://syzkaller.appspot.com/bug?id=4b71bb3365e7d5228913
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint32_t*)0x200004c4 = 0x80);
    NONFAILING(*(uint8_t*)0x200004c8 = 0xde);
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 0, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 1, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 2, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 3, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 4, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 5, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 7, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 8, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 9, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 10, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 11, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 12, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 13, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 14, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 15, 2));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 17, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 18, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 19, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 20, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 21, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 22, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 23, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 24, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 25, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 26, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 27, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 28, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 29, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 30, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 31, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 32, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 33, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 34, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 35, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 36, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 37, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200004e8, 0, 38, 26));
    ...
    NONFAILING(*(uint16_t*)0x2000052c = 0);
    NONFAILING(*(uint16_t*)0x2000052e = 0);
    NONFAILING(*(uint32_t*)0x20000530 = 0);
    NONFAILING(*(uint32_t*)0x20000534 = 0);
    NONFAILING(*(uint64_t*)0x20000538 = 0);
    syscall(__NR_perf_event_open, 0x200004c0ul, 0, -1ul, -1, 0ul);
    break;
  case 1:
  ...
  case 2:
    ...
    syscall(__NR_ioctl, r[0], 0xc0045006, 0x20000080ul);
    break;
  case 3:
    NONFAILING(*(uint32_t*)0x200000c0 = 0);
    syscall(__NR_ioctl, r[0], 0xc004500a, 0x200000c0ul);
    break;
  case 4:
    syscall(__NR_mmap, 0x20000000ul, 0x800000ul, 0x1800003ul, 0x12ul, r[0],
            0ul);
    break;
  case 5:
  ...
  case 7:
    ...
    NONFAILING(*(uint32_t*)0x20000444 = 0x80);
    ...
    NONFAILING(*(uint64_t*)0x20000450 = 0x3c29);
    NONFAILING(*(uint64_t*)0x20000458 = 0);
    NONFAILING(*(uint64_t*)0x20000460 = 0);
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 0, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 1, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 2, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 3, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 4, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 5, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 7, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 8, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 9, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 10, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 11, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 12, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 13, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 14, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 15, 2));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 17, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 18, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 19, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 20, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 21, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 22, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 23, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 24, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 25, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 26, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 27, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 28, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 29, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 30, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 31, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 32, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 33, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 34, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 35, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 36, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 37, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x20000468, 0, 38, 26));
    NONFAILING(*(uint32_t*)0x20000470 = 3);
  ...
  case 11:
    ...
    NONFAILING(*(uint64_t*)0x200001a0 = 8);
    ...
    res = syscall(__NR_perf_event_open, 0x20000180ul, -1, 0ul, -1, 0ul);
    if (res != -1)
      r[1] = res;
    break;
  case 12:
    NONFAILING(memcpy((void*)0x20000140, "/dev/input/event#\000", 18));
    res = -1;
    NONFAILING(res = syz_open_dev(0x20000140, 0, 0));
    if (res != -1)
      r[2] = res;
    break;
  case 13:
    NONFAILING(*(uint64_t*)0x200002c0 = 0x20422f69);
    NONFAILING(*(uint64_t*)0x200002c8 = 0x7ffff000);
    syscall(__NR_readv, r[2], 0x200002c0ul, 1ul);
    break;
  case 14:
