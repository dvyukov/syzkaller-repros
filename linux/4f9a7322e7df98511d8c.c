...
// https://syzkaller.appspot.com/bug?id=4f9a7322e7df98511d8c
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    res = -1;
    NONFAILING(res = syz_open_dev(0x200000c0, 0, 0));
    if (res != -1)
      r[1] = res;
    break;
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_ioctl, r[1], 0x641e, 0);
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x20000180 = 0xfffffffc);
    NONFAILING(*(uint32_t*)0x20000184 = 1);
    NONFAILING(*(uint32_t*)0x20000188 = 0x101);
    NONFAILING(*(uint32_t*)0x2000018c = 0);
    NONFAILING(*(uint32_t*)0x20000190 = 6);
    syscall(__NR_ioctl, r[2], 0xc0145401, 0x20000180ul);
    break;
  }
}
int main(void)
