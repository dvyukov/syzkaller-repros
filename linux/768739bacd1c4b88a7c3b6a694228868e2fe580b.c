...
// https://syzkaller.appspot.com/bug?id=768739bacd1c4b88a7c3b6a694228868e2fe580b
// status:open
...
void execute_one()
{
  ...
  *(uint32_t*)0x200003d0 = 0;
  res = syscall(__NR_ioctl, r[0], 0x8933, 0x200003c0);
  if (res != -1)
    r[1] = *(uint32_t*)0x200003d0;
  ...
  *(uint16_t*)0x2000009a = 1;
  *(uint8_t*)0x2000009c = -1;
  ...
  *(uint8_t*)0x200000b0 = 0xfe;
  *(uint8_t*)0x200000b1 = 0x80;
