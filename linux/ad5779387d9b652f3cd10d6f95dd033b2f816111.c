// WARNING: held lock freed in pppol2tp_release (2)
// https://syzkaller.appspot.com/bug?id=ad5779387d9b652f3cd10d6f95dd033b2f816111
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_socket, 0x18ul, 1ul, 1ul);
    break;
  case 1:
  ...
  case 3:
    ...
    NONFAILING(*(uint32_t*)0x20000002 = 1);
    NONFAILING(*(uint32_t*)0x20000006 = 3);
    NONFAILING(*(uint32_t*)0x2000000a = r[1]);
    NONFAILING(*(uint16_t*)0x2000000e = 2);
    NONFAILING(*(uint16_t*)0x20000010 = htobe16(0));
    NONFAILING(*(uint8_t*)0x20000012 = 0xac);
    NONFAILING(*(uint8_t*)0x20000013 = 0x14);
    NONFAILING(*(uint8_t*)0x20000014 = 0x14);
    NONFAILING(*(uint8_t*)0x20000015 = 0);
    NONFAILING(*(uint32_t*)0x2000001e = 2);
    NONFAILING(*(uint32_t*)0x20000022 = 0);
    NONFAILING(*(uint32_t*)0x20000026 = 0);
    NONFAILING(*(uint32_t*)0x2000002a = 0);
