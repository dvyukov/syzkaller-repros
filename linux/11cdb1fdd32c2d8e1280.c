// SYZFAIL: command has bad number of arguments
// https://syzkaller.appspot.com/bug?id=11cdb1fdd32c2d8e1280
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    NONFAILING(*(uint64_t*)0x200002c0 = 0x44aa);
    syscall(__NR_sendfile, -1, r[0], 0x200002c0ul, 9ul);
    break;
  }
}
int main(void)
