...
// https://syzkaller.appspot.com/bug?id=a57b24d359dc5577634a
// status:3
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x2000042c = 0;
  ...
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x20000040, "\x80", 1);
  syz_usb_ep_write(r[0], 0, 1, 0x20000040);
  syz_usb_connect(0, 0, 0, 0);
  res = syz_usb_connect(0, 0, 0, 0);
  if (res != -1)
    r[1] = res;
  syz_usb_ep_write(r[1], 0, 0, 0);
}
int main(void)
{
