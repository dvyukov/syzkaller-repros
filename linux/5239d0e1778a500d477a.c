...
// https://syzkaller.appspot.com/bug?id=5239d0e1778a500d477a
// status:0
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x20000000, "team0\000\000\000\000\000\000\000\000\000\000\000",
         16);
  ...
  *(uint64_t*)0x20000048 = 0x100000000004;
  *(uint64_t*)0x20000050 = 0;
  syscall(__NR_ioctl, -1, 0xc020662a, 0x20000040ul);
  ...
  *(uint32_t*)0x200039c8 = 0x1e;
  *(uint64_t*)0x200039d0 = 0;
  *(uint64_t*)0x200039d8 = 0;
  *(uint64_t*)0x200039e0 = 0;
  *(uint64_t*)0x200039e8 = 0;
  *(uint32_t*)0x200039f0 = 0xa;
  *(uint32_t*)0x200039f8 = 0xffffa200;
  syscall(__NR_sendmmsg, r[2], 0x200039c0ul, 0x311ul, 0ul);
}
int main(void)
{
