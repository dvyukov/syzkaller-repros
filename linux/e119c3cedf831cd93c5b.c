...
// https://syzkaller.appspot.com/bug?id=e119c3cedf831cd93c5b
// status:6
...
int main(void)
{
  ...
  NONFAILING(*(uint64_t*)0x20000018 = 0x20000780);
  NONFAILING(memcpy(
      (void*)0x20000780,
  ...
  syz_mount_image(0x20000180, 0x20000040, -1, 2, 0x20000000, 0x80, 0);
