...
// https://syzkaller.appspot.com/bug?id=eabfc7851ff90a5237b3
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    res = -1;
    NONFAILING(res = syz_open_procfs(0, -1));
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_sendfile, r[0], -1, 0ul, 0ul);
    break;
  case 3:
  ...
  case 6:
    ...
    NONFAILING(*(uint16_t*)0x20000080 = 0x21);
    NONFAILING(*(uint16_t*)0x20000082 = 0);
    NONFAILING(*(uint16_t*)0x20000084 = 2);
    NONFAILING(*(uint16_t*)0x20000086 = 0x10);
    NONFAILING(*(uint16_t*)0x20000088 = 2);
    NONFAILING(*(uint16_t*)0x2000008a = htobe16(0));
    NONFAILING(*(uint8_t*)0x2000008c = 0xac);
    NONFAILING(*(uint8_t*)0x2000008d = 0x14);
    NONFAILING(*(uint8_t*)0x2000008e = 0x14);
    NONFAILING(*(uint8_t*)0x2000008f = 0);
    NONFAILING(*(uint32_t*)0x20000008 = 0x80);
    NONFAILING(*(uint64_t*)0x20000010 = 0x20001640);
    NONFAILING(*(uint64_t*)0x20000018 = 0);
    NONFAILING(*(uint64_t*)0x20000020 = 0x20001a00);
    NONFAILING(memcpy(
        (void*)0x20001a00,
        ...
        "\x00\x00\x04\x00\x00\x00\x2b\x24\xe8\x10\x06\x4b\x6f\xb1\x4b\xcc\xed"
        "\xfb\x71\x8a\xef\x93\x2f\x38\x89\xd1\xfd\xda\x5b\x91\x34\x01\x5a\x86"
        "\x0f\x58\x78\xc3\x7f\xfe\x36\xe1\x16\x5d\x14\xd4\x35\xbe\x5b\x31\x7c"
        "\x6c\x81\x89\x76\x7d\x2f\x97\x87\x9f\x07\xa7\x15\xbb\x7c\x16\x9f\x46"
        ...
        170));
    NONFAILING(*(uint64_t*)0x20000028 = 0x10b8);
