...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(*(uint16_t*)0x20000040 = 0x1e);
  ...
  case 2:
    ...
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000440, "TIPC\000", 5));
  ...
  case 4:
    ...
    NONFAILING(*(uint32_t*)0x20000508 = 0x9000000);
    NONFAILING(*(uint64_t*)0x20000510 = 0x200004c0);
    NONFAILING(*(uint64_t*)0x200004c0 = 0x20000480);
    NONFAILING(*(uint32_t*)0x20000480 = 0x30);
    NONFAILING(*(uint16_t*)0x20000484 = r[2]);
    NONFAILING(*(uint16_t*)0x20000486 = 0x805);
    NONFAILING(*(uint32_t*)0x20000488 = 0);
    NONFAILING(*(uint32_t*)0x2000048c = 0);
    NONFAILING(*(uint8_t*)0x20000490 = 1);
    NONFAILING(*(uint8_t*)0x20000491 = 0);
    NONFAILING(*(uint16_t*)0x20000492 = 0);
    NONFAILING(*(uint32_t*)0x20000494 = 0);
    NONFAILING(*(uint16_t*)0x20000498 = 6);
    NONFAILING(*(uint16_t*)0x2000049a = 0);
    NONFAILING(*(uint16_t*)0x2000049c = htobe16(0x14));
    NONFAILING(*(uint16_t*)0x2000049e = htobe16(0x19));
    NONFAILING(*(uint32_t*)0x200004a0 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200004a4 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200004a8 = htobe32(0));
    NONFAILING(*(uint32_t*)0x200004ac = htobe32(0));
    NONFAILING(*(uint64_t*)0x200004c8 = 0x30);
    ...
    syscall(__NR_sendmsg, r[1], 0x20000500, 0);
    break;
  }
}
int main(void)
