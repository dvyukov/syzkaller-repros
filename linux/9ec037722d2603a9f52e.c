...
// https://syzkaller.appspot.com/bug?id=9ec037722d2603a9f52e
// status:0
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x20000300, "NLBL_CIPSOv4\000", 13);
  res = -1;
  ...
  *(uint32_t*)0x20000570 = 0;
  ...
  memcpy((void*)0x20000040, "/proc/thread-self/attr/current\000", 31);
  res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000040ul, 2ul, 0ul);
  if (res != -1)
    r[2] = res;
  sprintf((char*)0x20000000, "0x%016llx", (long long)-1);
  syscall(__NR_write, r[2], 0x20000000ul, 0x1dul);
  syscall(__NR_socket, 0x40000000002ul, 3ul, 2);
}
int main(void)
{
