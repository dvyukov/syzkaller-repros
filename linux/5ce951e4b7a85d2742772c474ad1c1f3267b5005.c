...
// https://syzkaller.appspot.com/bug?id=5ce951e4b7a85d2742772c474ad1c1f3267b5005
// status:open
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint8_t*)0x2001d008 = 6);
    NONFAILING(*(uint8_t*)0x2001d009 = 1);
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20fd5ff8, "./file0\000", 8));
    syscall(__NR_mkdir, 0x20fd5ff8, 0);
    break;
  case 2:
    NONFAILING(memcpy((void*)0x200001c0, "./file0/bus\000", 12));
    res = syscall(__NR_creat, 0x200001c0, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 3:
