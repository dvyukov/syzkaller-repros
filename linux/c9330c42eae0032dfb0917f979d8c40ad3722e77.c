...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    memcpy((void*)0x20000340, "/dev/fuse", 10);
  ...
  case 3:
    ...
    break;
  case 4:
    *(uint32_t*)0x20000280 = 0x33;
    *(uint32_t*)0x20000284 = 6;
    *(uint64_t*)0x20000288 = 0;
    *(uint64_t*)0x20000290 = 1;
    *(uint64_t*)0x20000298 = 6;
    *(uint32_t*)0x200002a0 = 0xa;
    *(uint32_t*)0x200002a4 = 0;
    memcpy((void*)0x200002a8, "/dev/fuse", 10);
    *(uint8_t*)0x200002b2 = 0;
    syscall(__NR_write, r[0], 0x20000280, 0x33);
    break;
  case 5:
