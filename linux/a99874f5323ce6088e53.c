...
// https://syzkaller.appspot.com/bug?id=a99874f5323ce6088e53
// status:3
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_sendmsg, r[1], 0ul, 0x4008000ul);
    break;
  case 4:
  ...
  case 5:
    ...
    NONFAILING(*(uint32_t*)0x20000008 = 0x400);
    NONFAILING(*(uint32_t*)0x2000000c = 0x640);
    ...
    syscall(__NR_ioctl, r[2], 0x4601, 0x20000000ul);
    break;
  }
}
int main(void)
