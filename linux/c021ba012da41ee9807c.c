...
// https://syzkaller.appspot.com/bug?id=c021ba012da41ee9807c
// status:0
...
void loop(void)
{
  ...
  *(uint64_t*)0x20000200 = 0x20010000;
  memcpy((void*)0x20010000,
         ...
         "\x00\x00\x00\x03\x00\x0c\x00\xe0\x00\x02\x00\x04\x00\x00\x00\x1a\x00"
         "\x99\x00\x00\x00\x00\x00\xf5\x01\x00\x00\x00\x00\x00\x00\xa4\x01\x00"
  ...
  *(uint64_t*)0x20000210 = 0;
  syz_mount_image(0x20000000, 0x200000c0, 0x80000000001f5, 1, 0x20000200, 0,
                  0x20010200);
  close_fds();
}
int main(void)
