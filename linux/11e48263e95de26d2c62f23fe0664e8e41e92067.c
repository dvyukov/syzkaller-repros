...
// https://syzkaller.appspot.com/bug?id=11e48263e95de26d2c62f23fe0664e8e41e92067
// status:invalid
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    res = syscall(__NR_semget, 0, 7, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000040, "/dev/usbmon#", 13));
    syz_open_dev(0x20000040, 6, 2);
    break;
  case 2:
    NONFAILING(*(uint16_t*)0x200001c0 = 0);
    NONFAILING(*(uint16_t*)0x200001c2 = 9);
    NONFAILING(*(uint16_t*)0x200001c4 = 0x1800);
    NONFAILING(*(uint16_t*)0x200001c6 = 4);
    NONFAILING(*(uint16_t*)0x200001c8 = 0xfffd);
    NONFAILING(*(uint16_t*)0x200001ca = 0x800);
    NONFAILING(*(uint16_t*)0x200001cc = 1);
    NONFAILING(*(uint16_t*)0x200001ce = 0x77c2);
    NONFAILING(*(uint16_t*)0x200001d0 = 0x1800);
    NONFAILING(*(uint16_t*)0x200001d2 = 3);
    NONFAILING(*(uint16_t*)0x200001d4 = 3);
    NONFAILING(*(uint16_t*)0x200001d6 = 0x1000);
    syscall(__NR_semop, r[0], 0x200001c0, 4);
    break;
  }
}
