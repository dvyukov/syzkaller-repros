...
// https://syzkaller.appspot.com/bug?id=251463bfa779ca087ad1
// status:0
...
void loop(void)
{
  ...
  *(uint64_t*)0x20000780 = 0x20000040;
  *(uint32_t*)0x20000040 = 0x174;
  ...
  *(uint16_t*)0x20000066 = 1;
  memcpy((void*)0x20000068, "taprio\000", 7);
  *(uint16_t*)0x20000070 = 0x144;
  *(uint16_t*)0x20000072 = 2;
  *(uint16_t*)0x20000074 = 0x56;
  ...
  *(uint16_t*)0x2000008a = 8;
  *(uint16_t*)0x2000008c = 4;
  ...
  *(uint32_t*)0x200000d0 = 0x8001;
  *(uint16_t*)0x200000d4 = 8;
  *(uint16_t*)0x200000d6 = 5;
  *(uint32_t*)0x200000d8 = 0;
  *(uint16_t*)0x200000dc = 0xd8;
  ...
  *(uint16_t*)0x200000e0 = 0xc;
  STORE_BY_BITMASK(uint16_t, , 0x200000e2, 1, 0, 14);
  ...
  *(uint32_t*)0x20000114 = 6;
  *(uint16_t*)0x20000118 = 8;
  *(uint16_t*)0x2000011a = 4;
  *(uint32_t*)0x2000011c = 4;
  *(uint16_t*)0x20000120 = 8;
  *(uint16_t*)0x20000122 = 4;
  *(uint32_t*)0x20000124 = 0x80000001;
  *(uint16_t*)0x20000128 = 8;
  *(uint16_t*)0x2000012a = 3;
  *(uint32_t*)0x2000012c = 0x7f;
  *(uint16_t*)0x20000130 = 8;
  *(uint16_t*)0x20000132 = 4;
  *(uint32_t*)0x20000134 = 0x1000;
  *(uint16_t*)0x20000138 = 0x2c;
  STORE_BY_BITMASK(uint16_t, , 0x2000013a, 1, 0, 14);
  ...
  *(uint32_t*)0x20000158 = 0xfffffffa;
  *(uint16_t*)0x2000015c = 8;
  *(uint16_t*)0x2000015e = 4;
  *(uint32_t*)0x20000160 = 0x4e;
  *(uint16_t*)0x20000164 = 0xfed5;
  STORE_BY_BITMASK(uint16_t, , 0x20000166, 1, 0, 14);
  ...
  *(uint32_t*)0x2000016c = 9;
  *(uint16_t*)0x20000170 = 5;
  *(uint16_t*)0x20000172 = 2;
  *(uint8_t*)0x20000174 = 0x59;
