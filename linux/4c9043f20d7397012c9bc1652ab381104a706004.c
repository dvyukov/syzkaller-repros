...
// https://syzkaller.appspot.com/bug?id=4c9043f20d7397012c9bc1652ab381104a706004
// status:open
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    break;
  case 4:
    syz_kvm_setup_cpu(r[1], -1, 0x20000000, 0, 0xfffffffffffffeaf, 0, 0,
                      0xffffffae);
    break;
  case 5:
    NONFAILING(*(uint64_t*)0x20000000 = 0);
    NONFAILING(*(uint32_t*)0x20000008 = 0x102000);
    NONFAILING(*(uint32_t*)0x2000000c = 0);
    syscall(__NR_ioctl, r[1], 0x4010ae67, 0x20000000);
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000040, "io.stat\000", 8));
    syscall(__NR_openat, 0xffffff9c, 0x20000040, 0, 0);
    break;
  case 7:
    NONFAILING(memcpy((void*)0x20000080,
                      "\x00\x3e\x9d\xe9\x00\xc2\x1c\x2c\x41\x65\xba\x99\xea\xdc"
                      "\xc6\xd2\x34\xd0\x1e\xd1\x41\x69\xf5\xa7\x92\x3e\xb5\x5d"
                      "\xa8\x68\x03\x62\x50\x8e\x00\x08\x00\x00\xcc\x66\xcc",
                      41));
    syscall(__NR_write, -1, 0x20000080, 0x29);
    break;
  case 8:
