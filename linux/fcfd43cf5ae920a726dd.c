...
// https://syzkaller.appspot.com/bug?id=fcfd43cf5ae920a726dd
// status:6
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000100, "/dev/snd/pcmC#D#p\000", 18));
    res = -1;
  ...
  case 6:
    ...
    break;
  case 7:
    NONFAILING(*(uint32_t*)0x20000040 = 0x6000000);
    NONFAILING(*(uint64_t*)0x20000044 = 0);
    syscall(__NR_epoll_ctl, r[4], 1ul, r[3], 0x20000040ul);
    break;
  }
}
int main(void)
