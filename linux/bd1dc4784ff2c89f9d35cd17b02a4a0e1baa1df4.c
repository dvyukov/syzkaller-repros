...
int main(void)
{
  ...
  NONFAILING(*(uint8_t*)0x20000004 = 0x9d);
  NONFAILING(*(uint8_t*)0x20000005 = 0x89);
  NONFAILING(*(uint8_t*)0x20000006 = 0);
  NONFAILING(*(uint8_t*)0x20000007 = 8);
  NONFAILING(*(uint16_t*)0x20000008 = 0x61c);
  NONFAILING(*(uint16_t*)0x2000000a = 0xc0a4);
  NONFAILING(*(uint16_t*)0x2000000c = 0x4ea0);
  ...
  NONFAILING(*(uint16_t*)0x20000014 = 0x26);
  ...
  NONFAILING(*(uint8_t*)0x2000001d = 0x2f);
  NONFAILING(*(uint8_t*)0x2000001e = 0);
  NONFAILING(*(uint8_t*)0x2000001f = 2);
  NONFAILING(*(uint8_t*)0x20000020 = 0xae);
  NONFAILING(*(uint8_t*)0x20000021 = 0xb0);
  NONFAILING(*(uint8_t*)0x20000022 = 0xdf);
  NONFAILING(*(uint8_t*)0x20000023 = 0);
  NONFAILING(*(uint8_t*)0x20000024 = 9);
  NONFAILING(*(uint8_t*)0x20000025 = 5);
  NONFAILING(*(uint8_t*)0x20000026 = 0xb);
  ...
  NONFAILING(*(uint8_t*)0x2000002f = 0x8a);
  ...
  NONFAILING(*(uint8_t*)0x20000035 = 0xa1);
  NONFAILING(*(uint8_t*)0x20000036 = 2);
  NONFAILING(*(uint8_t*)0x20000037 = 0x21);
  res = syz_usb_connect(4, 0x38, 0x20000000, 0);
  if (res != -1)
    r[0] = res;
