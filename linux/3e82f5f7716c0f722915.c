...
// https://syzkaller.appspot.com/bug?id=3e82f5f7716c0f722915
// status:2
...
void loop(void)
{
  ...
  res = syscall(__NR_open, 0x20000400ul, 0x1145042ul, 0ul);
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x20001604 = 0;
  *(uint32_t*)0x20001608 = 1;
  *(uint32_t*)0x2000160c = 0;
  *(uint32_t*)0x20001610 = 0;
  *(uint32_t*)0x20001618 = -1;
  memset((void*)0x2000161c, 0, 12);
  res = -1;
  res = syz_io_uring_setup(0x2de7, 0x20001600, 0x20002000, 0x20ff8000,
                           0x200000c0, 0x20000000);
  if (res != -1) {
    r[1] = res;
  ...
  *(uint64_t*)0x20000050 = 0x20000180;
  memset((void*)0x20000180, 207, 1);
  *(uint32_t*)0x20000058 = 0xfffffd0c;
  *(uint32_t*)0x2000005c = 0;
  *(uint64_t*)0x20000060 = 0;
  *(uint16_t*)0x20000068 = 0;
  *(uint16_t*)0x2000006a = 0;
  memset((void*)0x2000006c, 0, 20);
  syz_io_uring_submit(r[2], r[3], 0x20000040, 9);
  syscall(__NR_io_uring_enter, r[1], 0x7cdc, 0, 0ul, 0ul, 0ul);
}
int main(void)
{
