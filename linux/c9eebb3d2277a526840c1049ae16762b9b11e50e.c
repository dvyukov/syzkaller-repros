...
void execute_call(int call)
{
  ...
  case 1:
    ...
    *(uint32_t*)0x200000d8 = 0;
    syscall(__NR_bind, r[0], 0x200000c0, 0x1c);
    break;
  case 2:
    syscall(__NR_setsockopt, r[0], 0x84, 0x72, 0, 0);
    break;
  case 3:
    *(uint32_t*)0x20000500 = 0;
    *(uint32_t*)0x20000504 = 1;
    syscall(__NR_setsockopt, r[0], 0x84, 0x7b, 0x20000500, 8);
    break;
  case 4:
  ...
  case 5:
    ...
    *(uint8_t*)0x2000004a = 0xa;
    syscall(__NR_write, r[0], 0x20000040, 0x10094);
    break;
  case 6:
    inject_fault(1);
    syscall(__NR_write, r[0], 0x20000000, 0x1a000);
    break;
  }
}
int main(void)
