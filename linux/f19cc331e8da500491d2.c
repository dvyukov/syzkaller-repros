...
// https://syzkaller.appspot.com/bug?id=f19cc331e8da500491d2
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000780 = 0x200004c0;
  memcpy((void*)0x200004c0,
         "\x3c\x00\x00\x00\x24\x00\x0b\x0e\x00\x00\x00\x00\x00\x00\x00\x00\x00"
         "\x00\x00\x00",
         20);
  *(uint32_t*)0x200004d4 = r[3];
  memcpy((void*)0x200004d8,
         "\x00\x00\x00\x00\xff\xff\xff\xff\x00\x00\x00\x00\x09\x00\x01\x00\x63"
         "\x61\x6b\x65\x00\x00\x00\x00\x0c\x00\x02\x00\x08\x00\x05\x00\xb2",
         33);
  ...
  *(uint16_t*)0x20000300 = 0x11;
  *(uint16_t*)0x20000302 = htobe16(0);
  *(uint32_t*)0x20000304 = r[3];
  *(uint16_t*)0x20000308 = 1;
  *(uint8_t*)0x2000030a = 0;
  *(uint8_t*)0x2000030b = 6;
  *(uint8_t*)0x2000030c = 1;
  *(uint8_t*)0x2000030d = 0x80;
  *(uint8_t*)0x2000030e = 0xc2;
  *(uint8_t*)0x2000030f = 0;
  *(uint8_t*)0x20000310 = 0;
  *(uint8_t*)0x20000311 = 0;
  memset((void*)0x20000312, 0, 2);
  syscall(__NR_bind, r[0], 0x20000300ul, 0x14ul);
  memcpy((void*)0x20000080,
         "\x03\x04\xff\x1f\x5c\x00\x60\x00\x40\x03\x00\x2c\xff\xf5\x7b\x01\x6d"
         "\x27\x63\xbd\x56\x37\x37\x80\x39\x8d\x53\x75\x03\xe5\x06\x02\x59\x1f"
         "\x03\x1e\xe6\x16\xd5\xc0\x18\x43\x74\xa7\xff\xe4\xec\x55\xe0\x65\x47"
         "\x86\xa7\x01\x00\x93\x5b\xa5\x14\xd4\x08\x08\xef\xa0\x00\x80\x16\x01"
         ...
         108);
  syscall(__NR_sendto, r[0], 0x20000080ul, 0x3287ul, 0x4000002ul, 0ul, 0x2fful);
}
int main(void)
{
