...
void execute_one()
{
  ...
  if (res != -1)
    r[0] = res;
  NONFAILING(*(uint16_t*)0x202aafe4 = 0xa);
  NONFAILING(*(uint16_t*)0x202aafe6 = htobe16(0x4e23));
  NONFAILING(*(uint32_t*)0x202aafe8 = 0);
  NONFAILING(*(uint8_t*)0x202aafec = 0);
  NONFAILING(*(uint8_t*)0x202aafed = 0);
  NONFAILING(*(uint8_t*)0x202aafee = 0);
  NONFAILING(*(uint8_t*)0x202aafef = 0);
  NONFAILING(*(uint8_t*)0x202aaff0 = 0);
  NONFAILING(*(uint8_t*)0x202aaff1 = 0);
  NONFAILING(*(uint8_t*)0x202aaff2 = 0);
  NONFAILING(*(uint8_t*)0x202aaff3 = 0);
  NONFAILING(*(uint8_t*)0x202aaff4 = 0);
  NONFAILING(*(uint8_t*)0x202aaff5 = 0);
  NONFAILING(*(uint8_t*)0x202aaff6 = -1);
  NONFAILING(*(uint8_t*)0x202aaff7 = -1);
  NONFAILING(*(uint32_t*)0x202aaff8 = htobe32(0));
  NONFAILING(*(uint32_t*)0x202aaffc = 0);
  syscall(__NR_bind, r[0], 0x202aafe4, 0x1c);
  syscall(__NR_listen, r[0], 0x40);
  res = syscall(__NR_socket, 0xa, 1, 0x84);
  if (res != -1)
    r[1] = res;
  NONFAILING(*(uint32_t*)0x200004c0 = 0);
  NONFAILING(*(uint32_t*)0x200004c4 = 3);
  NONFAILING(*(uint32_t*)0x200004c8 = 7);
  NONFAILING(*(uint32_t*)0x200004cc = 1);
  syscall(__NR_setsockopt, r[0], 0x84, 0, 0x200004c0, 0x10);
  NONFAILING(memcpy((void*)0x2087dffe, "F", 1));
  ...
  syscall(__NR_sendto, r[1], 0x2087dffe, 1, 0x20000080, 0x2005ffe4, 0x1c);
}
