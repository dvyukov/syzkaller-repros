// SYZFAIL: using non-main thread in non-thread mode
// https://syzkaller.appspot.com/bug?id=8f0b00688fc4ae3f22d1
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint32_t*)0x20000004 = 0x101);
    NONFAILING(memcpy(
        (void*)0x20000008,
        "\xed\x00\x54\x00\x00\x00\x00\x00\x3e\xc1\x3e\x20\x00\x00\x00\x00\x01"
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
        32));
    syscall(__NR_ioctl, r[0], 0x80104592, 0x20000000ul);
    break;
  case 2:
    ...
    NONFAILING(*(uint16_t*)0x2000000a = 0x100);
    NONFAILING(*(uint16_t*)0x2000000c = 0);
    NONFAILING(*(uint16_t*)0x20000010 = 0x401);
    NONFAILING(*(uint16_t*)0x20000012 = 0x480a);
    syscall(__NR_ioctl, r[0], 0x40304580, 0x20000000ul);
    break;
  case 3:
    NONFAILING(syz_open_dev(0xffffffffff600000, 0, 0x123fc2));
    break;
  case 4:
    NONFAILING(syz_open_dev(0xffffffffff600000, 0, 0x161f42));
    break;
  }
}
int main(void)
