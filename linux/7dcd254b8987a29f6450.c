...
// https://syzkaller.appspot.com/bug?id=7dcd254b8987a29f6450
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    NONFAILING(*(uint32_t*)0x200001c0 = 0x7fffffff);
    NONFAILING(memcpy(
        (void*)0x200001c4,
        ...
        32));
    res = syscall(__NR_ioctl, r[1], 0xc0285700, 0x200001c0ul);
    if (res != -1)
      NONFAILING(r[2] = *(uint32_t*)0x200001e4);
    break;
  case 3:
    NONFAILING(
        memcpy((void*)0x20000000, "/sys/kernel/debug/sync/sw_sync\000", 31));
  ...
  case 4:
    ...
    NONFAILING(memcpy(
        ...
        "\xe4\xc5\xba\xc9\xdd\x82\x59\xbe\x4e\xe6\x4b\x32\xc6\x5e\x0a",
        32));
    res = syscall(__NR_ioctl, r[3], 0xc0285700, 0x200001c0ul);
    if (res != -1)
      NONFAILING(r[4] = *(uint32_t*)0x200001e4);
    break;
  case 5:
    NONFAILING(memcpy(
        (void*)0x20000040,
        ...
        32));
    NONFAILING(*(uint32_t*)0x20000060 = r[2]);
    NONFAILING(*(uint32_t*)0x20000068 = 0);
    NONFAILING(*(uint32_t*)0x2000006c = 0);
    res = syscall(__NR_ioctl, r[4], 0xc0303e03, 0x20000040ul);
    if (res != -1)
      NONFAILING(r[5] = *(uint32_t*)0x20000064);
    break;
  case 6:
    NONFAILING(memcpy(
        (void*)0x20000080,
        "\xf8\x2c\x27\x25\x39\xa5\x0b\x38\x3d\x06\xff\x12\x90\x73\x99\xde\x00"
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\x00",
        32));
    NONFAILING(*(uint32_t*)0x200000a0 = r[4]);
    NONFAILING(*(uint32_t*)0x200000a8 = 0);
    NONFAILING(*(uint32_t*)0x200000ac = 0);
    res = syscall(__NR_ioctl, r[4], 0xc0303e03, 0x20000080ul);
    if (res != -1)
      NONFAILING(r[6] = *(uint32_t*)0x200000a4);
    break;
  case 7:
    NONFAILING(*(uint32_t*)0x200000c0 = r[5]);
    NONFAILING(*(uint16_t*)0x200000c4 = 0);
    NONFAILING(*(uint16_t*)0x200000c6 = 0);
    NONFAILING(*(uint32_t*)0x200000c8 = r[6]);
    NONFAILING(*(uint16_t*)0x200000cc = 0);
    NONFAILING(*(uint16_t*)0x200000ce = 0);
    syscall(__NR_ppoll, 0x200000c0ul, 2ul, 0ul, 0ul, 0ul);
    break;
  case 8:
  ...
  case 9:
    NONFAILING(
        memcpy((void*)0x200011c0, "/sys/kernel/debug/sync/info\000", 28));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x200011c0ul, 0ul, 0ul);
    if (res != -1)
      r[7] = res;
    break;
  case 10:
    syscall(__NR_read, r[7], 0x20001540ul, 0x2020ul);
    break;
  }
}
int main(void)
