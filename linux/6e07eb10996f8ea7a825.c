...
// https://syzkaller.appspot.com/bug?id=6e07eb10996f8ea7a825
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    *(uint32_t*)0x20000040 = 0x10000;
    syscall(__NR_ioctl, r[0], 0x7a7, 0x20000040ul);
    break;
  case 2:
  ...
  case 4:
    ...
    break;
  case 5:
    *(uint32_t*)0x20000040 = 0xb0000;
    syscall(__NR_ioctl, r[1], 0x7a7, 0x20000040ul);
    break;
  case 6:
    *(uint32_t*)0x20000080 = 1;
    *(uint32_t*)0x20000084 = 0;
    syscall(__NR_ioctl, r[1], 0x7a0, 0x20000080ul);
    break;
  case 7:
    *(uint32_t*)0x20000640 = 0x4d3;
    *(uint32_t*)0x20000644 = 0;
  ...
  case 8:
    ...
    *(uint16_t*)0x20000906 = 0;
    syscall(__NR_ppoll, 0x20000900ul, 1ul, 0ul, 0ul, 0ul);
    break;
  }
}
int main(void)
