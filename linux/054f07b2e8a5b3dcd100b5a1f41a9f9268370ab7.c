// KASAN: use-after-free Write in copy_net_ns
// https://syzkaller.appspot.com/bug?id=054f07b2e8a5b3dcd100b5a1f41a9f9268370ab7
// status:invalid
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    NONFAILING(*(uint16_t*)0x20000080 = 0xfff9);
    NONFAILING(*(uint16_t*)0x20000082 = 6);
    NONFAILING(*(uint16_t*)0x20000084 = 0xb31);
    ...
    syscall(__NR_ioctl, r[0], 0x405c5503, 0x20000080);
    break;
  case 3:
  ...
  case 4:
    ...
    break;
  case 5:
    NONFAILING(*(uint16_t*)0x20000100 = 0xb9);
    NONFAILING(*(uint8_t*)0x20000104 = 0xac);
    NONFAILING(*(uint8_t*)0x20000105 = 0x14);
    NONFAILING(*(uint8_t*)0x20000106 = 0x14);
    NONFAILING(*(uint8_t*)0x20000107 = 0x1d);
    NONFAILING(*(uint16_t*)0x20000108 = htobe16(0x4e20));
    NONFAILING(*(uint32_t*)0x2000010c = 0);
    NONFAILING(memcpy(
        (void*)0x20000110,
        "lc\000\000\000\000\000\000\000\000\000\000\000\000\000\000", 16));
    NONFAILING(*(uint32_t*)0x20000120 = 0x20);
    NONFAILING(*(uint32_t*)0x20000124 = 7);
    NONFAILING(*(uint32_t*)0x20000128 = htobe32(0x7a));
    syscall(__NR_setsockopt, r[0], 0, 0x483, 0x20000100, 0x2c);
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x20000180 = 7);
    NONFAILING(*(uint32_t*)0x20000184 = 0x70);
    NONFAILING(*(uint8_t*)0x20000188 = 0);
    NONFAILING(*(uint8_t*)0x20000189 = 5);
    NONFAILING(*(uint8_t*)0x2000018a = 8);
    NONFAILING(*(uint8_t*)0x2000018b = 0x5e);
    NONFAILING(*(uint32_t*)0x2000018c = 0);
    NONFAILING(*(uint64_t*)0x20000190 = 2);
    NONFAILING(*(uint64_t*)0x20000198 = 0x200);
    NONFAILING(*(uint64_t*)0x200001a0 = 0xc);
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 6, 0, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0, 1, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0, 2, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 8, 3, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0, 4, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 8, 5, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 1, 6, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 6, 7, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0, 8, 1));
    NONFAILING(
        STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0xfffffffffffffffc, 9, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0xffffffff, 10, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 5, 11, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0, 12, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0, 13, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0x100000001, 14, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 7, 15, 2));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0x401, 17, 1));
    NONFAILING(
        STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0xfffffffffffffffc, 18, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 2, 19, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0x4c62, 20, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 2, 21, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0x7e6, 22, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 3, 23, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0xd5, 24, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 2, 25, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 2, 26, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 1, 27, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0x401, 28, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200001a8, 0, 29, 35));
    NONFAILING(*(uint32_t*)0x200001b0 = 8);
    NONFAILING(*(uint32_t*)0x200001b4 = 0);
    NONFAILING(*(uint64_t*)0x200001b8 = 0);
    NONFAILING(*(uint64_t*)0x200001c0 = 2);
    NONFAILING(*(uint64_t*)0x200001c8 = 0x100);
    NONFAILING(*(uint64_t*)0x200001d0 = 1);
    NONFAILING(*(uint32_t*)0x200001d8 = 2);
    NONFAILING(*(uint32_t*)0x200001dc = 0x5c05dc30);
    NONFAILING(*(uint64_t*)0x200001e0 = 1);
    NONFAILING(*(uint32_t*)0x200001e8 = 0x200);
    NONFAILING(*(uint16_t*)0x200001ec = 8);
    NONFAILING(*(uint16_t*)0x200001ee = 0);
    syscall(__NR_perf_event_open, 0x20000180, r[0], 6, r[2], 9);
    break;
  case 7:
    syscall(__NR_socket, 0x10, 3, 0);
    break;
  case 8:
    NONFAILING(memcpy((void*)0x20000280, "/dev/cec#\000", 10));
    res = syz_open_dev(0x20000280, 0 + procid * 4, 2);
    if (res != -1)
      r[3] = res;
    break;
  case 9:
    syscall(__NR_getsockopt, r[0], 0x84, 0x1a, 0, 0);
    break;
  case 10:
    NONFAILING(*(uint32_t*)0x200005c0 = 0);
    NONFAILING(*(uint32_t*)0x200005c4 = 0);
    syscall(__NR_getsockopt, r[0], 0x84, 0x1b, 0x200005c0, 0);
    break;
  case 11:
    NONFAILING(*(uint32_t*)0x20000300 = 0);
    syscall(__NR_getsockopt, r[0], 0x84, 0xd, 0, 0x20000300);
    break;
  case 12:
    syscall(__NR_getsockopt, r[3], 0x84, 0x6c, 0, 0);
    break;
  case 13:
    syscall(__NR_ioctl, r[0], 0x400c4301, 0);
    break;
  case 14:
    syscall(__NR_getsockopt, r[0], 0x107, 0xe, 0x20000200, 0);
    break;
  case 15:
    syscall(__NR_setsockopt, r[0], 0x112, 7, 0, 0x1cb);
    break;
  case 16:
    NONFAILING(memcpy((void*)0x20000140, "lc\000", 3));
    syscall(__NR_finit_module, r[1], 0x20000140, 0);
    break;
  case 17:
    syscall(__NR_ioperm, 5, 7, 4);
    break;
  case 18:
    inject_fault(3);
