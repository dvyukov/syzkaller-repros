...
// https://syzkaller.appspot.com/bug?id=f78c3bd6c9e1bafbc879
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000940,
                      "wlan1\000\000\000\000\000\000\000\000\000\000\000", 16));
    syscall(__NR_ioctl, r[0], 0x8914, 0x20000940ul);
    break;
  case 2:
  ...
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_writev, r[3], 0ul, 0ul);
    break;
  case 6:
    res = -1;
    NONFAILING(res = syz_open_procfs(0, 0));
    ...
    break;
  case 7:
    syscall(__NR_writev, r[4], 0ul, 0ul);
    break;
  case 8:
    syscall(__NR_bpf, 8ul, 0ul, 0ul);
    break;
  case 9:
    syscall(__NR_ioctl, r[2], 0x8912, 0x400200ul);
    break;
  case 10:
    syscall(__NR_sendmsg, r[4], 0ul, 0x44ul);
    break;
  case 11:
    syscall(__NR_shmget, 0ul, 0x3000ul, 0ul, 0x20ffc000ul);
    break;
  case 12:
    NONFAILING(memcpy((void*)0x20000000, "wlan1\000", 6));
    NONFAILING(*(uint8_t*)0x20000040 = 1);
    NONFAILING(*(uint8_t*)0x20000041 = 1);
    NONFAILING(*(uint8_t*)0x20000042 = 0xc);
    NONFAILING(*(uint8_t*)0x20000043 = 1);
    NONFAILING(*(uint8_t*)0x20000044 = 1);
    NONFAILING(*(uint8_t*)0x20000045 = 1);
    NONFAILING(syz_80211_join_ibss(0x20000000, 0x20000040, 6, 0));
    break;
  }
}
int main(void)
