// UBSAN: undefined-behaviour in ieee80211_del_key
// https://syzkaller.appspot.com/bug?id=f0e95380c225e3c9f1af
// status:0
...
void loop(void)
{
  ...
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x20000140, "wlan0\000\000\000\000\000\000\000\000\000\000\000",
         16);
  ...
  *(uint16_t*)0x20000244 = r[3];
  memcpy((void*)0x20000246, "\x11\xf4\x1f\x00\x00\x00\x00\x00\x00\x00\x0c\xbd"
                            "\x5d\xc8\x08\x00\x03\x00",
         18);
