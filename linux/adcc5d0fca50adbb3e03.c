...
// https://syzkaller.appspot.com/bug?id=adcc5d0fca50adbb3e03
// status:0
...
int main(void)
{
  ...
  *(uint32_t*)0x20000164 = 0;
  res = -1;
  res = syz_io_uring_setup(0x76d1, 0x20000140, 0x20555000, 0x20ffe000,
  ...
  *(uint32_t*)0x2000009c = 0x40000000;
  *(uint64_t*)0x200000a0 = 0;
  *(uint16_t*)0x200000a8 = 3;
  ...
  *(uint8_t*)0x200000bf = 0;
  syz_io_uring_submit(r[3], r[4], 0x20000080, 0);
  syscall(__NR_io_uring_enter, r[2], 6, 0, 0ul, 0ul, 0ul);
  return 0;
}
