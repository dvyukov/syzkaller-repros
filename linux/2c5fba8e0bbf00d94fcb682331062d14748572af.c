...
// https://syzkaller.appspot.com/bug?id=2c5fba8e0bbf00d94fcb682331062d14748572af
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    *(uint32_t*)0x20f5dffc = 0;
    syscall(__NR_bind, (long)r[0], 0x20f5dfe4, 0x1c);
    break;
  case 2:
    ...
    *(uint32_t*)0x20000018 = 5;
    syscall(__NR_sendto, (long)r[0], 0x20000040, 0, 0x8001, 0x20000000, 0x1c);
    break;
  case 3:
    syscall(__NR_read, (long)r[0], 0x20000340, 0x6c);
    break;
  case 4:
    syscall(__NR_write, (long)r[0], 0x20000200, 0xffdc);
    break;
  case 5:
    syscall(__NR_read, (long)r[0], 0x20000140, 0xeb);
    break;
  }
}
int main(void)
