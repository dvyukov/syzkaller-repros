...
// https://syzkaller.appspot.com/bug?id=1d2fdcdd5c3164b28c58
// status:0
...
void loop(void)
{
  ...
  *(uint16_t*)0x20004540 = 0xa;
  *(uint16_t*)0x20004542 = htobe16(0x4e23);
  *(uint32_t*)0x20004544 = htobe32(0);
  memset((void*)0x20004548, 0, 10);
  memset((void*)0x20004552, 255, 2);
  *(uint32_t*)0x20004554 = htobe32(0xe0000002);
  *(uint32_t*)0x20004558 = 0;
  syscall(__NR_connect, r[1], 0x20004540ul, 0x1cul);
  ...
  *(uint32_t*)0x20004db0 = 0xffffffe0;
  *(uint32_t*)0x20004db8 = 0;
  syscall(__NR_sendmmsg, r[1], 0x20004d80ul, 1ul, 0x4000000ul);
}
int main(void)
{
