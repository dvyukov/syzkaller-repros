...
// https://syzkaller.appspot.com/bug?id=e96aae4bf7ce37e2eaef
// status:0
...
void execute_call(int call)
{
  ...
  case 5:
    ...
    break;
  case 6:
    NONFAILING(memcpy((void*)0x20000080, "syscall\000", 8));
    res = -1;
    NONFAILING(res = syz_open_procfs(-1, 0x20000080));
    if (res != -1)
      r[0] = res;
    break;
  case 7:
    ...
    break;
  case 8:
    syscall(__NR_sendfile, r[1], r[0], 0ul, 7ul);
    break;
  }
}
int main(void)
