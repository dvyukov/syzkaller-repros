...
// https://syzkaller.appspot.com/bug?id=b47bc4f247856fb4d9e1
// status:6
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000180, "dctcp\000", 6));
    syscall(__NR_setsockopt, r[0], 6, 0xd, 0x20000180ul, 6ul);
    break;
  case 2:
  ...
  case 7:
    ...
    NONFAILING(memcpy((void*)0x20000098,
  ...
  case 8:
    ...
    NONFAILING(*(uint64_t*)0x20000140 = 0x200014c0);
    NONFAILING(memcpy((void*)0x200014c0,
                      "\x38\x00\x00\x00\x24\x00\x07\x05\x00\x00\x00\x40\x07\xa2"
                      "\xa3\x00\x05\x00\x00\x00",
                      20));
    NONFAILING(*(uint32_t*)0x200014d4 = r[3]);
    NONFAILING(memcpy((void*)0x200014d8,
  ...
  case 9:
    ...
    NONFAILING(*(uint64_t*)0x20000210 = 0x20000180);
    NONFAILING(*(uint64_t*)0x20000180 = 0x200003c0);
    NONFAILING(*(uint32_t*)0x200003c0 = 0x84);
    NONFAILING(*(uint16_t*)0x200003c4 = 0x2c);
    NONFAILING(*(uint16_t*)0x200003c6 = 0xd27);
    ...
    NONFAILING(*(uint32_t*)0x200003d4 = r[3]);
    NONFAILING(*(uint16_t*)0x200003d8 = 0);
    NONFAILING(*(uint16_t*)0x200003da = 0);
    NONFAILING(*(uint16_t*)0x200003dc = 0);
    NONFAILING(*(uint16_t*)0x200003de = 0);
    NONFAILING(*(uint16_t*)0x200003e0 = 8);
    NONFAILING(*(uint16_t*)0x200003e2 = 0);
    NONFAILING(*(uint16_t*)0x200003e4 = 0xa);
    NONFAILING(*(uint16_t*)0x200003e6 = 1);
    NONFAILING(memcpy((void*)0x200003e8, "basic\000", 6));
    NONFAILING(*(uint16_t*)0x200003f0 = 0x4c);
    NONFAILING(*(uint16_t*)0x200003f2 = 2);
    NONFAILING(*(uint16_t*)0x200003f4 = 0x48);
    NONFAILING(*(uint16_t*)0x200003f6 = 4);
    NONFAILING(*(uint16_t*)0x200003f8 = 0x3c);
    NONFAILING(*(uint16_t*)0x200003fa = 1);
    ...
    NONFAILING(*(uint16_t*)0x20000414 = 0);
    NONFAILING(*(uint16_t*)0x20000416 = 0);
    ...
    NONFAILING(*(uint16_t*)0x20000422 = 0);
    ...
    NONFAILING(*(uint16_t*)0x20000436 = 4);
    NONFAILING(*(uint32_t*)0x20000438 = 6);
    NONFAILING(*(uint16_t*)0x2000043c = 6);
    NONFAILING(*(uint16_t*)0x2000043e = 5);
    NONFAILING(*(uint8_t*)0x20000440 = 0);
    NONFAILING(*(uint8_t*)0x20000441 = 0);
    NONFAILING(*(uint64_t*)0x20000188 = 0x84);
  ...
  case 10:
    ...
    break;
  case 11:
    syscall(__NR_sendmmsg, r[4], 0x20000200ul, 0x4924924924926d3ul, 0ul);
    break;
  case 12:
    NONFAILING(*(uint64_t*)0x20000180 = 0);
    NONFAILING(*(uint32_t*)0x20000188 = 0);
    NONFAILING(*(uint64_t*)0x20000190 = 0x20000040);
    NONFAILING(*(uint64_t*)0x20000040 = 0x20000080);
    NONFAILING(memcpy(
        (void*)0x20000080,
        "\x30\x00\x00\x00\x32\x00\x09\x03\x00\x05\x00\x00\x00\x00\x00\x00\x02"
        "\x00\x00\x00\x14\x00\x01\x00\x10\x00\x01\x40\x0b\x00\x01\x00\x70\x6f"
        "\x6c\x69\x63\x65\x00\x06\x08\x00\x04\x00\x00\x00\x00\xc0",
        48));
