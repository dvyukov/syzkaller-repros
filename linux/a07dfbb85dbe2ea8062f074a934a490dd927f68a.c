...
// https://syzkaller.appspot.com/bug?id=a07dfbb85dbe2ea8062f074a934a490dd927f68a
// status:open
...
void execute_call(int call)
{
  ...
  case 4:
    ...
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20000080, "/dev/md0\000", 9));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000080ul, 0ul, 0ul);
    if (res != -1)
      r[0] = res;
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x20001200 = 0);
    NONFAILING(*(uint32_t*)0x20001204 = 8);
    NONFAILING(*(uint32_t*)0x20001208 = 3);
    NONFAILING(*(uint64_t*)0x20001210 = 0);
    syscall(__NR_ioctl, r[0], 0x40140921ul, 0x20001200ul);
    break;
  case 7:
