...
// https://syzkaller.appspot.com/bug?id=21c6da0a2f3ee4be6339
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    NONFAILING(*(uint32_t*)0x20d4a000 = 0);
    NONFAILING(*(uint64_t*)0x20d4a004 = 0);
    syscall(__NR_epoll_ctl, r[1], 1ul, r[0], 0x20d4a000ul);
    break;
  case 4:
    syscall(__NR_epoll_ctl, r[2], 1ul, r[0], 0ul);
    break;
  case 5:
    syscall(__NR_socketpair, 1ul, 1ul, 0, 0ul);
    break;
  case 6:
    syscall(__NR_prctl, 0x2bul, 0, 0, 0);
    break;
  case 7:
  ...
  case 8:
    ...
    break;
  case 9:
    syscall(__NR_sendmsg, r[3], 0ul, 0x800ul);
    break;
  case 10:
    syscall(__NR_socketpair, 1ul, 1ul, 0, 0ul);
    break;
  ...
  case 13:
    ...
    break;
  case 14:
    syscall(__NR_ioctl, r[5], 0x8912, 0x400200ul);
    break;
  case 15:
    syscall(__NR_ioctl, r[5], 0x89e0, 0ul);
    break;
  case 16:
    syscall(__NR_ioctl, r[4], 0x8912, 0x400200ul);
    break;
  case 17:
    NONFAILING(*(uint32_t*)0x20fe0ff4 = 0);
    NONFAILING(*(uint64_t*)0x20fe0ff8 = 0);
    syscall(__NR_epoll_ctl, r[2], 1ul, r[1], 0x20fe0ff4ul);
    break;
  }
}
int main(void)
