// WARNING in usb_start_wait_urb/usb_submit_urb
// https://syzkaller.appspot.com/bug?id=d69b9a9915016775708fe878507ee495781f899a
// status:invalid
...
int main(void)
{
  ...
  *(uint8_t*)0x2000006e = 0x32;
  memcpy((void*)0x2000006f, "\x75\x09\xd6", 3);
  *(uint8_t*)0x20000072 = 2;
  *(uint8_t*)0x20000073 = 3;
  *(uint8_t*)0x20000074 = 7;
  *(uint8_t*)0x20000075 = 5;
  *(uint8_t*)0x20000076 = 0;
  *(uint8_t*)0x20000077 = 0;
  *(uint16_t*)0x20000078 = 0xfffe;
  *(uint8_t*)0x2000007a = 0;
  *(uint8_t*)0x2000007b = 0xfe;
  *(uint8_t*)0x2000007c = 0;
  syz_usb_connect(3, 0x3d, 0x20000040, 0);
  return 0;
}
