...
// https://syzkaller.appspot.com/bug?id=301cccce1b286fa6449e
// status:0
...
{
  intptr_t res = 0;
  res = syscall(__NR_socket, 0x200000000000011ul, 2ul, 0);
  if (res != -1)
    r[0] = res;
  res = syscall(__NR_socket, 0xaul, 1ul, 0);
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x200005c0, "/proc/thread-self/attr/exec\000", 28);
  res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x200005c0ul, 2ul, 0ul);
  if (res != -1)
    r[2] = res;
  ...
  *(uint32_t*)0x20000040 = 0x10eef0f1;
  res = syscall(__NR_getsockname, r[0], 0x20000500ul, 0x20000040ul);
  if (res != -1)
    r[5] = *(uint32_t*)0x20000504;
  res = syscall(__NR_socket, 0x200000000000011ul, 3ul, 0);
  if (res != -1)
    r[6] = res;
  memcpy((void*)0x20000200, "macvlan1\000\000\000\000\000\000\000\000", 16);
  *(uint32_t*)0x20000210 = 0;
  res = syscall(__NR_ioctl, r[6], 0x8933, 0x20000200ul);
  if (res != -1)
    r[7] = *(uint32_t*)0x20000210;
  *(uint16_t*)0x20000100 = 0x11;
  *(uint16_t*)0x20000102 = htobe16(0);
  *(uint32_t*)0x20000104 = r[7];
  *(uint16_t*)0x20000108 = 1;
  *(uint8_t*)0x2000010a = 0;
  *(uint8_t*)0x2000010b = 6;
  *(uint8_t*)0x2000010c = 0xaa;
  ...
  *(uint8_t*)0x20000112 = 0;
  *(uint8_t*)0x20000113 = 0;
  syscall(__NR_bind, r[6], 0x20000100ul, 0x14ul);
  *(uint32_t*)0x20000040 = 0x10eef0f1;
  res = syscall(__NR_getsockname, r[6], 0x20000500ul, 0x20000040ul);
  if (res != -1)
    r[8] = *(uint32_t*)0x20000504;
  *(uint64_t*)0x200000c0 = 0;
  *(uint32_t*)0x200000c8 = 0;
  *(uint64_t*)0x200000d0 = 0x20000000;
  *(uint64_t*)0x20000000 = 0x20000240;
  memcpy((void*)0x20000240, "\x54\x00\x00\x00\x10\x00\x0f\xff\x2a\xbd\x70\x00"
                            "\x00\x00\x00\x00\x00\x00\x00\x00",
         20);
  *(uint32_t*)0x20000254 = 0;
  memcpy((void*)0x20000258, "\x00\x00\x00\x00\x00\x00\x00\x00\x34\x00\x12\x80"
                            "\x08\x00\x01\x00\x68\x73\x72\x00\x28\x00\x02\x80"
                            "\x08\x00\x02\x00",
         28);
  *(uint32_t*)0x20000274 = r[5];
  memcpy((void*)0x20000278,
         "\x0a\x00\x04\x00\x01\x80\xc2\x00\x00\x02\x00\x00\x08\x00\x01\x00",
         16);
  *(uint32_t*)0x20000288 = r[8];
  ...
  *(uint32_t*)0x200000f0 = 0;
  ...
  if (res != -1)
    r[9] = res;
  syscall(__NR_sendmmsg, r[9], 0x200000c0ul, 0x492492492492627ul, 0ul);
}
int main(void)
{
