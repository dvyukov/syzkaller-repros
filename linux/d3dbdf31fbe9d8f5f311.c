// KMSAN: uninit-value in ax88179_led_setting
// https://syzkaller.appspot.com/bug?id=d3dbdf31fbe9d8f5f311
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(*(uint8_t*)0x20000800 = 0x12);
    NONFAILING(*(uint8_t*)0x20000801 = 1);
    NONFAILING(*(uint16_t*)0x20000802 = 0);
    NONFAILING(*(uint8_t*)0x20000804 = 0x3a);
    NONFAILING(*(uint8_t*)0x20000805 = 0x12);
    NONFAILING(*(uint8_t*)0x20000806 = 0x1a);
    NONFAILING(*(uint8_t*)0x20000807 = 0x40);
    NONFAILING(*(uint16_t*)0x20000808 = 0x2001);
    NONFAILING(*(uint16_t*)0x2000080a = 0x4a00);
    NONFAILING(*(uint16_t*)0x2000080c = 0xcb01);
    NONFAILING(*(uint8_t*)0x2000080e = 0);
    NONFAILING(*(uint8_t*)0x2000080f = 0);
    NONFAILING(*(uint8_t*)0x20000810 = 0);
    NONFAILING(*(uint8_t*)0x20000811 = 1);
    NONFAILING(*(uint8_t*)0x20000812 = 9);
    NONFAILING(*(uint8_t*)0x20000813 = 2);
    NONFAILING(*(uint16_t*)0x20000814 = 0x12);
    NONFAILING(*(uint8_t*)0x20000816 = 1);
    ...
    NONFAILING(*(uint8_t*)0x2000081b = 9);
    NONFAILING(*(uint8_t*)0x2000081c = 4);
    NONFAILING(*(uint8_t*)0x2000081d = 0xfc);
    NONFAILING(*(uint8_t*)0x2000081e = -1);
    NONFAILING(*(uint8_t*)0x2000081f = 0);
    NONFAILING(*(uint8_t*)0x20000820 = 0x67);
    NONFAILING(*(uint8_t*)0x20000821 = 0x9a);
    NONFAILING(*(uint8_t*)0x20000822 = 0x84);
    NONFAILING(*(uint8_t*)0x20000823 = 0);
    res = -1;
    NONFAILING(res = syz_usb_connect(0, 0x24, 0x20000800, 0));
    if (res != -1)
      r[0] = res;
    break;
  case 1:
