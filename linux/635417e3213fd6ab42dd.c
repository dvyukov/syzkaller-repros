...
// https://syzkaller.appspot.com/bug?id=635417e3213fd6ab42dd
// status:6
...
void execute_call(int call)
{
  switch (call) {
  case 0:
    NONFAILING(*(uint8_t*)0x20000000 = 3);
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000001, 1, 0, 7));
    NONFAILING(STORE_BY_BITMASK(uint8_t, , 0x20000001, 1, 7, 1));
    NONFAILING(*(uint32_t*)0x20000004 = 0);
    NONFAILING(*(uint32_t*)0x20000008 = 0);
    NONFAILING(*(uint64_t*)0x20000010 = 0x200001c0);
    NONFAILING(memcpy((void*)0x200001c0, "\xcf", 1));
    ...
    syscall(__NR_ioctl, -1, 0x8038550a, 0x20000000ul);
    break;
  case 1:
    syscall(__NR_pread64, -1, 0x20000b40ul, 0xb2ul, 8ul);
    break;
  case 2:
