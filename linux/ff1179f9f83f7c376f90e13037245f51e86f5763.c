...
void execute_one(void)
{
  ...
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x20000600, "gretap0\000\000\000\000\000\000\000\000\000", 16);
  *(uint32_t*)0x20000610 = 0;
  res = syscall(__NR_ioctl, r[0], 0x8933, 0x20000600);
  if (res != -1)
  ...
  *(uint16_t*)0x200001e6 = 1;
  memcpy((void*)0x200001e8, "cbs\000", 4);
  *(uint16_t*)0x200001ec = 0x1c;
  *(uint16_t*)0x200001ee = 2;
