...
void execute_call(int call)
{
  ...
  case 2:
    ...
    syscall(__NR_setsockopt, r[1], 6ul, 0x13ul, 0x20000100ul, 4ul);
    break;
  case 3:
    NONFAILING(*(uint16_t*)0x20000300 = 0xa);
    NONFAILING(*(uint16_t*)0x20000302 = htobe16(0));
    ...
    NONFAILING(*(uint8_t*)0x20000312 = -1);
    NONFAILING(*(uint8_t*)0x20000313 = -1);
    NONFAILING(*(uint8_t*)0x20000314 = 0xac);
    NONFAILING(*(uint8_t*)0x20000315 = 0x14);
    NONFAILING(*(uint8_t*)0x20000316 = 0x14);
    NONFAILING(*(uint8_t*)0x20000317 = 0xaa);
    NONFAILING(*(uint32_t*)0x20000318 = 0);
    syscall(__NR_connect, r[1], 0x20000300ul, 0x1cul);
    break;
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_getsockopt, -1, 0x84ul, 0x1dul, 0ul, 0ul);
    break;
  case 6:
    res = syscall(__NR_socket, 2ul, 5ul, 0x84ul);
    if (res != -1)
    ...
    break;
  case 7:
    res = syscall(__NR_socket, 0xaul, 0x10000000005ul, 0x84ul);
    if (res != -1)
      r[4] = res;
    break;
  case 8:
    syscall(__NR_getsockopt, r[4], 0x84ul, 0x1dul, 0ul, 0ul);
    break;
  case 9:
    syscall(__NR_setsockopt, r[3], 0x84ul, 0x71ul, 0ul, 0ul);
    break;
  case 10:
    syscall(__NR_getsockopt, r[2], 0x84ul, 0xeul, 0ul, 0ul);
    break;
  case 11:
    syscall(__NR_getsockopt, r[0], 0x84ul, 0x6dul, 0ul, 0ul);
    break;
  case 12:
    NONFAILING(memcpy((void*)0x20000340, "tls\000", 4));
    syscall(__NR_setsockopt, r[1], 6ul, 0x1ful, 0x20000340ul, 4ul);
    break;
  case 13:
    NONFAILING(*(uint16_t*)0x20000180 = 0x303);
    NONFAILING(*(uint16_t*)0x20000182 = 0x34);
    NONFAILING(
        memcpy((void*)0x20000184, "\xe5\x73\x86\x12\xdc\x00\xdd\x02", 8));
    NONFAILING(memcpy(
        (void*)0x2000018c,
        ...
        32));
    NONFAILING(memcpy((void*)0x200001ac, "\000\000\000\000", 4));
    NONFAILING(
        memcpy((void*)0x200001b0, "\xff\xff\xff\xff\xff\xff\xff\xfe", 8));
    syscall(__NR_setsockopt, r[1], 0x11aul, 1ul, 0x20000180ul, 0x38ul);
    break;
  case 14:
    NONFAILING(*(uint32_t*)0x20000040 = 2);
    syscall(__NR_setsockopt, r[1], 0x29ul, 1ul, 0x20000040ul, 4ul);
    break;
  }
}
int main(void)
