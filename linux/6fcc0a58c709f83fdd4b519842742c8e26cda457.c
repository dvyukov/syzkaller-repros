// BUG: soft lockup in rcu_read_lock_sched_held
// https://syzkaller.appspot.com/bug?id=6fcc0a58c709f83fdd4b519842742c8e26cda457
// status:open
...
void execute_one(void)
{
  ...
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2001d028, 2, 15, 2));
  ...
  NONFAILING(*(uint64_t*)0x2001d048 = 4);
  ...
  syscall(__NR_keyctl, 4ul, 0, 0, 0, 0);
  NONFAILING(*(uint32_t*)0x20000280 = htobe32(0x6000000));
  ...
  NONFAILING(memcpy(
      (void*)0x20000290,
      "\xa3\xef\x41\x74\x9f\xa5\x27\xab\x78\xfc\x57\xf1\x80\xbd\x82\x09\x9c\xba"
      "\xb3\x5a\x2f\xdb\xed\xf1\xfb\xb1\x1b\xed\xfb\x1f\x8c\xd5\x57\xb0\xbd\xfc"
      "\xd7\xf4\x2f\x63\xaf\x87\x2a\x0a\x11\xe3\x2f\x7a\x0e\xb6\xbb\x02\xf6\xb7"
      "\x8b\x1e\xa5\x80\xf6\xba\x18\x59\x47\x30\x6a\x84\xc6\xc5\xe7\xbe\x78\xab"
      "\x94\x06\xa3\xea\x21\xad\x85\x14\xd0\x24\xca\xcb\x81\xe3\xba\x56",
      88));
  syscall(__NR_write, -1, 0x20000280ul, 0x68ul);
  syscall(__NR_ioctl, -1, 0xae01ul, 0ul);
}
int main(void)
{
