...
// https://syzkaller.appspot.com/bug?id=b0c9d1588ae92866515f
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    res = -1;
    NONFAILING(res = syz_io_uring_setup(0x885, 0x20000080, 0x20ee7000,
                                        0x200d8000, 0x20000040, 0x20000100));
    if (res != -1) {
      r[0] = res;
    ...
    break;
  case 2:
    NONFAILING(syz_memcpy_off(r[1], 0x40, 0, 0, 4));
    break;
  case 3:
    NONFAILING(*(uint8_t*)0x20000480 = 0xe);
    ...
    NONFAILING(*(uint64_t*)0x20000490 = 0x12345);
    ...
    NONFAILING(memset((void*)0x200004ac, 0, 20));
    NONFAILING(syz_io_uring_submit(r[1], r[2], 0x20000480, 0));
    break;
  case 4:
    res = syscall(__NR_mmap, 0x20608000ul, 0x2000ul, 2ul, 0x13ul, r[0],
                  0x10000000ul);
    if (res != -1)
      r[3] = res;
    break;
  case 5:
    NONFAILING(*(uint8_t*)0x20000280 = 0x19);
    NONFAILING(*(uint8_t*)0x20000281 = 5);
    NONFAILING(*(uint16_t*)0x20000282 = 0);
    NONFAILING(*(uint32_t*)0x20000284 = 0);
    NONFAILING(*(uint64_t*)0x20000288 = 0);
    NONFAILING(*(uint64_t*)0x20000290 = 0x206c8000);
    NONFAILING(*(uint32_t*)0x20000298 = 0x3000);
    ...
    NONFAILING(syz_io_uring_submit(r[1], r[3], 0x20000280, 0x5f));
    break;
  case 6:
    syscall(__NR_io_uring_enter, r[0], 0x688c, 0, 0ul, 0ul, 0ul);
    break;
  }
}
int main(void)
