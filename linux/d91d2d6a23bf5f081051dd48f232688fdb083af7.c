...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    res = syscall(__NR_socket, 0x11, 0x10000000002, 0x300);
    if (res != -1)
      r[1] = res;
    break;
  case 2:
    syscall(__NR_read, r[0], 0x20000000, 0x19);
    break;
  case 3:
    ...
    *(uint32_t*)0x20000050 = 0;
    res = syscall(__NR_ioctl, r[1], 0x8933, 0x20000040);
    if (res != -1)
  ...
  case 4:
    ...
    *(uint64_t*)0x20003090 = 0x20000480;
    *(uint64_t*)0x20003098 = 0;
    *(uint64_t*)0x200030a0 = 0x20000500;
    *(uint64_t*)0x200030a8 = 0;
    *(uint32_t*)0x200030b0 = 0;
    *(uint32_t*)0x200030b8 = 0;
    syscall(__NR_sendmmsg, r[1], 0x20003080, 1, 0);
    break;
  case 5:
