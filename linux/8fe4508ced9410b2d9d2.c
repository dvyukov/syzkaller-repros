...
// https://syzkaller.appspot.com/bug?id=8fe4508ced9410b2d9d2
// status:0
...
void execute_call(int call)
{
  ...
  case 4:
    ...
    break;
  case 5:
    syscall(__NR_fallocate, r[0], 0ul, 0ul, 0x8800000ul);
    break;
  case 6:
    syscall(__NR_fallocate, -1, 0x20ul, 0ul, 0xffff77ff000ul);
    break;
  }
}
int main(void)
