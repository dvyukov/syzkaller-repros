...
// https://syzkaller.appspot.com/bug?id=6b8ca13e289f2735a68122c7efdaefbc7f7affd1
// status:open
...
void execute_call(int call)
{
  ...
  case 2:
    NONFAILING(memcpy(
        ...
        16));
    NONFAILING(*(uint16_t*)0x20000010 = 0xfffd);
  ...
  case 3:
    NONFAILING(memcpy(
        ...
        "\x62\x72\x69\x64\x67\x65\x30\x00\x00\x00\x00\x00\x00\x00\x00\x00",
        16));
    NONFAILING(*(uint16_t*)0x20000110 = 0x2001);
    syscall(__NR_ioctl, r[0], 0x8914, 0x20000100);
    break;
  case 4:
    ...
    break;
  case 5:
    NONFAILING(*(uint64_t*)0x20001cc0 = 0x20000080);
    ...
    NONFAILING(*(uint32_t*)0x20001cc8 = 0xc);
    NONFAILING(*(uint64_t*)0x20001cd0 = 0x20000200);
    NONFAILING(*(uint64_t*)0x20000200 = 0x20000380);
    NONFAILING(memcpy((void*)0x20000380,
                      "\x30\x00\x00\x00\x10\x00\x01\x08\x00\x00\x00\x00\x00\x00"
                      "\x00\x00\x00\x00\x00\x00",
                      20));
    NONFAILING(*(uint32_t*)0x20000394 = 0);
    NONFAILING(memcpy((void*)0x20000398,
                      "\x00\x00\x00\x00\x00\x00\x00\x00\x08\x00\x0d\x00\x01\x00"
                      "\x00\x00\x08\x00\x1b\x00\x00\x00\x00\x00",
                      24));
    NONFAILING(*(uint64_t*)0x20000208 = 3);
    NONFAILING(*(uint64_t*)0x20001cd8 = 1);
    NONFAILING(*(uint64_t*)0x20001ce0 = 0);
    NONFAILING(*(uint64_t*)0x20001ce8 = 0);
    NONFAILING(*(uint32_t*)0x20001cf0 = 0);
    syscall(__NR_sendmsg, r[2], 0x20001cc0, 0);
    break;
  }
}
