...
// https://syzkaller.appspot.com/bug?id=0bc9e858900bb1cbbf0c45d8d7c3e8f82223d5d0
// status:open
...
void execute_call(int call)
{
  ...
  case 9:
    ...
    NONFAILING(*(uint32_t*)0x20000088 = 0x4000);
    ...
    NONFAILING(*(uint16_t*)0x200000c6 = 0x801);
    ...
    NONFAILING(*(uint32_t*)0x200000d4 = r[4]);
    NONFAILING(*(uint32_t*)0x200000d8 = 0x150d1);
    NONFAILING(*(uint32_t*)0x200000dc = 0);
    NONFAILING(*(uint16_t*)0x200000e0 = 8);
    NONFAILING(*(uint16_t*)0x200000e2 = 0xa);
    NONFAILING(*(uint8_t*)0x200000e4 = 0x14);
