...
// https://syzkaller.appspot.com/bug?id=060491062397016be7860319d126d41c44fe21a4
// status:open
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    NONFAILING(*(uint64_t*)0x20000a08 = 0x989680);
    NONFAILING(*(uint32_t*)0x20048000 = 0);
    syscall(__NR_futex, 0x2000cffc, 0xc, 1, 0x20000a00, 0x20048000, 0);
    break;
  case 4:
    syscall(__NR_exit, 0x100011);
    break;
  case 5:
