...
// https://syzkaller.appspot.com/bug?id=02e11c3715230d29ff51b424ff08e3e2d090077c
// status:dup
...
void execute_one(void)
{
  ...
  *(uint16_t*)0x20000186 = 0;
  memcpy((void*)0x20000188,
         ...
         80);
  *(uint32_t*)0x200001d8 = 0x23;
  syscall(__NR_ioctl, (long)r[0], 0x405c5503, 0x20000180);
  syscall(__NR_ioctl, (long)r[0], 0x5501, 0);
  memcpy((void*)0x20000040, "/dev/input/event#\000", 18);
  syz_open_dev(0x20000040, 4, 0);
  ...
  inject_fault(7);
  syscall(__NR_ioctl, (long)r[0], 0x5502, 0);
}
int main(void)
{
