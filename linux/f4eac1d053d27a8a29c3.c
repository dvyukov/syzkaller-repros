...
// https://syzkaller.appspot.com/bug?id=f4eac1d053d27a8a29c3
// status:6
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000000, "/dev/vcs\000", 9));
  ...
  case 3:
    ...
    break;
  case 4:
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0ul, 0x14000ul, 0ul);
    if (res != -1)
      r[3] = res;
    break;
  case 5:
    syscall(__NR_epoll_wait, r[3], 0ul, 0ul, 2);
    break;
  case 6:
    res = syscall(__NR_epoll_create1, 0ul);
    if (res != -1)
  ...
  case 7:
    ...
    syscall(__NR_epoll_ctl, r[4], 1ul, r[2], 0x20000040ul);
    break;
  case 8:
