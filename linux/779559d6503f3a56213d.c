...
// https://syzkaller.appspot.com/bug?id=779559d6503f3a56213d
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000440, "NET_DM\000", 7));
    res = -1;
    NONFAILING(res = syz_genetlink_get_family_id(0x20000440, r[0]));
    if (res != -1)
      r[2] = res;
    break;
  case 3:
    ...
    NONFAILING(*(uint32_t*)0x20000480 = 0x14);
    NONFAILING(*(uint16_t*)0x20000484 = r[2]);
    NONFAILING(*(uint16_t*)0x20000486 = 1);
    NONFAILING(*(uint32_t*)0x20000488 = 0);
    NONFAILING(*(uint32_t*)0x2000048c = 0);
    NONFAILING(*(uint8_t*)0x20000490 = 3);
    ...
    NONFAILING(*(uint32_t*)0x20000530 = 0x2000c055);
    inject_fault(12);
    syscall(__NR_sendmsg, r[1], 0x20000500ul, 0x800ul);
    break;
  }
}
int main(void)
