...
// https://syzkaller.appspot.com/bug?id=240f556416233f5f94bc
// status:0
...
void execute_call(int call)
{
  ...
  case 5:
    ...
    *(uint64_t*)0x20000140 = 0x20000040;
    memcpy((void*)0x20000040, "\x3c\x00\x00\x00\x10\x00\x01\x04\x00\xee\xff\xff"
                              "\xff\xff\xff\xff\xfd\x01\x00\x00",
           20);
    *(uint32_t*)0x20000054 = r[3];
    memcpy((void*)0x20000058, "\x01\x04\x00\x00\x00\x00\x00\x00\x1c\x00\x12\x00"
  ...
  case 6:
    ...
    *(uint64_t*)0x20000780 = 0x20000340;
    memcpy((void*)0x20000340, "M\000\000\000-\v", 6);
    *(uint32_t*)0x20000346 = r[3];
    memcpy((void*)0x2000034a,
           "\x00\x00\x00\x00\xff\xff\xff\xff\x00\x00\x00\x00\x0a\x00\x01\x00"
           "\x6e\x65\x74\x65\x6d\x00\x00\x00\x1c\x00\x02\x00\x00\x00\x00\x00"
           "\x00\x01\x00\x00\xfc\xff\xff\xff\x00\x00\x00\x00\xfc\xff\xff\xff",
           48);
    *(uint64_t*)0x20000788 = 0x4c;
