...
// https://syzkaller.appspot.com/bug?id=492b55475c5c790d1eed
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(syz_80211_join_ibss(0, 0, 0, 2));
    break;
  case 1:
  ...
  case 3:
    ...
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000340, "nl80211\000", 8));
    res = -1;
    NONFAILING(res = syz_genetlink_get_family_id(0x20000340));
    if (res != -1)
      r[3] = res;
    break;
  case 5:
    ...
    NONFAILING(*(uint64_t*)0x20000410 = 0x20000380);
    NONFAILING(*(uint64_t*)0x20000380 = 0x20000000);
    NONFAILING(*(uint32_t*)0x20000000 = 0x2c);
    NONFAILING(*(uint16_t*)0x20000004 = r[3]);
    NONFAILING(*(uint16_t*)0x20000006 = 0x7d);
    NONFAILING(*(uint32_t*)0x20000008 = 0);
    NONFAILING(*(uint32_t*)0x2000000c = 0);
    NONFAILING(*(uint8_t*)0x20000010 = 0x66);
    NONFAILING(*(uint8_t*)0x20000011 = 0);
    NONFAILING(*(uint16_t*)0x20000012 = 0);
    NONFAILING(*(uint16_t*)0x20000014 = 8);
    NONFAILING(*(uint16_t*)0x20000016 = 3);
    NONFAILING(*(uint32_t*)0x20000018 = r[2]);
    NONFAILING(*(uint16_t*)0x2000001c = 8);
    NONFAILING(*(uint16_t*)0x2000001e = 0xb7);
    NONFAILING(*(uint32_t*)0x20000020 = 0);
    NONFAILING(*(uint16_t*)0x20000024 = 8);
    NONFAILING(*(uint16_t*)0x20000026 = 0x26);
    NONFAILING(*(uint32_t*)0x20000028 = 0x971);
    NONFAILING(*(uint64_t*)0x20000388 = 0x2c);
  ...
  case 7:
    NONFAILING(memcpy((void*)0x200016c0,
                      "wlan1\000\000\000\000\000\000\000\000\000\000\000", 16));
    syscall(__NR_ioctl, r[4], 0x8914, 0x200016c0ul);
    break;
  }
}
int main(void)
