...
// https://syzkaller.appspot.com/bug?id=3360da629681aa0d22fe
// status:6
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x200017d0 = 0x20001480;
  *(uint64_t*)0x20001480 = 0x20000080;
  *(uint64_t*)0x20001488 = 0xca;
  *(uint64_t*)0x20001490 = 0x20000480;
  *(uint64_t*)0x20001498 = 0x1000;
  *(uint64_t*)0x200017d8 = 2;
  ...
  *(uint64_t*)0x20001810 = 0x20003480;
  *(uint64_t*)0x20003480 = 0x20006d80;
  *(uint64_t*)0x20003488 = 0x100d;
  *(uint64_t*)0x20001818 = 1;
  *(uint64_t*)0x20001820 = 0;
  *(uint64_t*)0x20001828 = 0;
  *(uint32_t*)0x20001830 = 0;
  *(uint32_t*)0x20001838 = 0;
  syscall(__NR_recvmmsg, r[0], 0x200017c0ul, 2ul, 0x100ul, 0ul);
}
int main(void)
{
