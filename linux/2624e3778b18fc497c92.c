...
// https://syzkaller.appspot.com/bug?id=2624e3778b18fc497c92
// status:6
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x200002b0 = 0x40090;
  syscall(__NR_sendmsg, r[1], 0x20000280ul, 0x44004ul);
  ...
  *(uint16_t*)0x200004e0 = 0x72b3;
  *(uint16_t*)0x200004e2 = 0;
  *(uint16_t*)0x200004e4 = 0xb;
  *(uint16_t*)0x200004e6 = 1;
  memcpy((void*)0x200004e8, "flower\000", 7);
  *(uint16_t*)0x200004f0 = 0x24;
  *(uint16_t*)0x200004f2 = 2;
  *(uint16_t*)0x200004f4 = 0x18;
  STORE_BY_BITMASK(uint16_t, , 0x200004f6, 0x54, 0, 14);
  STORE_BY_BITMASK(uint16_t, , 0x200004f7, 0, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x200004f7, 1, 7, 1);
  *(uint16_t*)0x200004f8 = 0x14;
  ...
  *(uint8_t*)0x20000500 = 1;
  *(uint16_t*)0x20000504 = 8;
  *(uint16_t*)0x20000506 = 2;
  *(uint32_t*)0x20000508 = 0;
  *(uint16_t*)0x2000050c = 8;
  STORE_BY_BITMASK(uint16_t, , 0x2000050e, 0x55, 0, 14);
  STORE_BY_BITMASK(uint16_t, , 0x2000050f, 0, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x2000050f, 1, 7, 1);
  *(uint16_t*)0x20000510 = 0xfcba;
  STORE_BY_BITMASK(uint16_t, , 0x20000512, 3, 0, 14);
  STORE_BY_BITMASK(uint16_t, , 0x20000513, 0, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x20000513, 1, 7, 1);
