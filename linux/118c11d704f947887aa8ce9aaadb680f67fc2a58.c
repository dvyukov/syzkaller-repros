...
// https://syzkaller.appspot.com/bug?id=118c11d704f947887aa8ce9aaadb680f67fc2a58
// status:dup
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    res = syscall(__NR_socketpair, 2, 0xa, 0, 0x200000c0);
    if (res != -1)
      NONFAILING(r[1] = *(uint32_t*)0x200000c0);
    break;
  case 2:
    NONFAILING(*(uint32_t*)0x20000100 = r[1]);
    syscall(__NR_ioctl, r[0], 0x89e2, 0x20000100);
    break;
  case 3:
  ...
  case 4:
    ...
    NONFAILING(memcpy((void*)0x20000140, "%/file0/file0", 14));
    NONFAILING(*(uint32_t*)0x20000208 = 0);
    NONFAILING(*(uint32_t*)0x2000020c = 0x10);
    syscall(__NR_bpf, 7, 0x20000200, 0x10);
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20000000, "%/file0", 8));
    NONFAILING(memcpy((void*)0x20000040, "/", 2));
    NONFAILING(memcpy((void*)0x20000080, "nfs", 4));
    syscall(__NR_mount, 0x20000000, 0x20000040, 0x20000080, 0x860020,
            0x200000c0);
    break;
  }
}
