...
// https://syzkaller.appspot.com/bug?id=c255a740b81b994d1ab42bc76171a1187b3d25d0
// status:invalid
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    res = syscall(__NR_add_key, 0x20000000, 0x20000040, 0, 0, 0xfffffffc);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    syscall(__NR_keyctl, 0x10, r[0]);
    break;
  }
}
int main(void)
