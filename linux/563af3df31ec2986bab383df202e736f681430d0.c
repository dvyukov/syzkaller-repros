...
// https://syzkaller.appspot.com/bug?id=563af3df31ec2986bab383df202e736f681430d0
// status:open
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_ioctl, r[2], 0x5460ul, 0ul);
    break;
  case 4:
    syscall(__NR_setsockopt, r[2], 0x10eul, 7ul, 0ul, 0ul);
    break;
  case 5:
    NONFAILING(*(uint32_t*)0x20000280 = 8);
    NONFAILING(*(uint32_t*)0x20000284 = 0xa8d4);
    NONFAILING(*(uint32_t*)0x20000288 = 9);
    ...
    res = syscall(__NR_ioctl, r[0], 0xc02064b2ul, 0x20000280ul);
    if (res != -1)
      NONFAILING(r[3] = *(uint32_t*)0x20000290);
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x200002c0 = r[3]);
    NONFAILING(*(uint32_t*)0x200002c4 = 0);
    NONFAILING(*(uint64_t*)0x200002c8 = 0);
    syscall(__NR_ioctl, r[0], 0xc0585609ul, 0x200002c0ul);
    break;
  }
}
int main(void)
