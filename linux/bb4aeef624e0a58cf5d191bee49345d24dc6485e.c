...
// https://syzkaller.appspot.com/bug?id=bb4aeef624e0a58cf5d191bee49345d24dc6485e
// status:open
...
void execute_call(int call)
{
  ...
  case 4:
    ...
    NONFAILING(*(uint16_t*)0x20000044 = r[2]);
    NONFAILING(*(uint16_t*)0x20000046 = 0x805);
    ...
    NONFAILING(*(uint16_t*)0x20000058 = 6);
    NONFAILING(*(uint16_t*)0x2000005a = 0);
    NONFAILING(*(uint16_t*)0x2000005c = htobe16(0x14));
    NONFAILING(*(uint16_t*)0x2000005e = htobe16(0x19));
    NONFAILING(*(uint32_t*)0x20000060 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20000064 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20000068 = htobe32(0));
    NONFAILING(*(uint32_t*)0x2000006c = htobe32(0));
    NONFAILING(*(uint64_t*)0x200004c8 = 0x3fb);
