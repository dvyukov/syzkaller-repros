// SYZFAIL: output overflow
// https://syzkaller.appspot.com/bug?id=507f980ce2c0294e0bda
// status:0
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    NONFAILING(*(uint32_t*)0x20000248 = 0xfffffffe);
    NONFAILING(*(uint32_t*)0x2000024c = 3);
    NONFAILING(*(uint32_t*)0x20000348 = 0x80);
  ...
  case 2:
    ...
    NONFAILING(*(uint32_t*)0x20000208 = 0x80);
    NONFAILING(*(uint64_t*)0x20000210 = 0x20000000);
    NONFAILING(*(uint64_t*)0x20000218 = 0x5a);
    NONFAILING(*(uint64_t*)0x20000220 = 0x200001c0);
    NONFAILING(*(uint64_t*)0x20000228 = 4);
    NONFAILING(*(uint32_t*)0x20000230 = 0x7301);
    syscall(__NR_recvmsg, r[0], 0x20000200ul, 0x13f9cul, 0);
    break;
  case 3:
    NONFAILING(*(uint64_t*)0x200001c0 = 0);
    NONFAILING(*(uint32_t*)0x200001c8 = 0);
    NONFAILING(*(uint64_t*)0x200001d0 = 0x20000100);
    NONFAILING(*(uint64_t*)0x200001d8 = 0x21);
    NONFAILING(*(uint64_t*)0x200001e0 = 0x20000000);
