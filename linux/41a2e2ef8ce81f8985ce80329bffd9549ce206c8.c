// kernel BUG at mm/usercopy.c:LINE! (2)
...
{
  memset(r, -1, sizeof(r));
  r[0] = syscall(__NR_mmap, 0x20000000ul, 0xaff000ul, 0x3ul, 0x32ul,
                 0xfffffffffffffffful, 0x0ul);
  memcpy((void*)0x20afa000, "\x2f\x64\x65\x76\x2f\x6b\x76\x6d\x00", 9);
  r[2] = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20afa000ul, 0x0ul,
                 0x0ul);
  r[3] = syscall(__NR_ioctl, r[2], 0xae01ul, 0x0ul);
  r[4] = syscall(__NR_ioctl, r[3], 0xae41ul, 0x0ul);
  *(uint64_t*)0x20969fe8 = (uint64_t)0x10;
  *(uint64_t*)0x20969ff0 = (uint64_t)0x20650fc2;
  *(uint64_t*)0x20969ff8 = (uint64_t)0x3e;
  memcpy((void*)0x20650fc2,
         "\x67\x0f\x9b\x33\x0f\xc7\x5a\x00\x0f\xb0\x06\x73\x00\x2e\x66"
         "\x0f\x1b\x4f\x06\xf3\x3e\x0f\x00\xda\x0f\x35\x3e\x02\xaa\x07"
         "\x00\x0f\x01\x78\x3d\x66\x0f\x3a\x17\xc9\x00\x66\xb8\x40\x8e"
         "\x00\x00\x0f\x23\xd0\x0f\x21\xf8\x66\x35\x10\x00\x00\x02\x0f"
         "\x23\xf8",
         62);
  *(uint64_t*)0x20237000 = (uint64_t)0x6;
  *(uint64_t*)0x20237008 = (uint64_t)0x6;
  *(uint64_t*)0x20237010 = (uint64_t)0x1;
  *(uint64_t*)0x20237018 = (uint64_t)0x44000;
  r[13] = syz_kvm_setup_cpu(r[3], r[4], 0x20a96000ul, 0x20969fe8ul,
                            0x1ul, 0x0ul, 0x20237000ul, 0x2ul);
}
