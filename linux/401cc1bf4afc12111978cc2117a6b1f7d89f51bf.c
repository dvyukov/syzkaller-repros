...
// https://syzkaller.appspot.com/bug?id=401cc1bf4afc12111978cc2117a6b1f7d89f51bf
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_ioctl, -1, 0xc0105303ul, 0ul);
    break;
  case 1:
    syscall(__NR_ioctl, -1, 0xab04ul, 0);
    break;
  case 2:
    NONFAILING(*(uint32_t*)0x200002c0 = 0);
    syscall(__NR_accept4, -1, 0ul, 0x200002c0ul, 0x7fffcul);
    break;
  case 3:
    syscall(__NR_symlinkat, 0ul, -1, 0ul);
    break;
  case 4:
  ...
  case 8:
    ...
    syscall(__NR_setsockopt, r[1], 0x84ul, 0x6bul, 0x20000000ul, 0x10ul);
    break;
  case 9:
    syscall(__NR_clone, 0ul, 0ul, 0x9999999999999999ul, 0ul, -1ul);
    break;
  case 10:
    syz_open_dev(0, 2 + procid * 4, 2);
    break;
  case 11:
  ...
  case 14:
    ...
    NONFAILING(*(uint64_t*)0x20000310 = 0x20000100);
    NONFAILING(*(uint64_t*)0x20000100 = 0x20000040);
    NONFAILING(memcpy((void*)0x20000040,
                      "\x2f\x00\x00\x00\x1c\x00\x05\xc5\xff\xff\xff\x00\x0d\x00"
                      "\x00\x00\x02\x00\x00\x00\x0b\x00\x00\x00\xec\x00\x79\xc9"
                      "\x13\x00\x01\x80\xf0\xff\xff\xeb\xff\xff\x6e\x26\x3f",
                      41));
    NONFAILING(*(uint64_t*)0x20000108 = 0x29);
    NONFAILING(*(uint64_t*)0x20000318 = 1);
    NONFAILING(*(uint64_t*)0x20000320 = 0);
    NONFAILING(*(uint64_t*)0x20000328 = 0x1bb);
    NONFAILING(*(uint32_t*)0x20000330 = 0);
    syscall(__NR_sendmsg, -1, 0x20000300ul, 0ul);
    break;
  case 15:
    NONFAILING(*(uint64_t*)0x20000180 = 0);
    NONFAILING(*(uint32_t*)0x20000188 = 0xff);
    NONFAILING(*(uint64_t*)0x20000190 = 0x20000080);
    NONFAILING(*(uint64_t*)0x20000080 = 0x20000040);
    NONFAILING(memcpy((void*)0x20000040,
                      "\x2f\x00\x00\x00\x1c\x00\x05\xc5\xff\xff\xff\x08\x0d\x00"
                      "\x00\x00\x02\x00\x00\x1f\x01\x00\x00\x00\x19\x01\x02",
                      27));
    NONFAILING(*(uint64_t*)0x20000088 = 0x1cb);
