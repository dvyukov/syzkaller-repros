...
// https://syzkaller.appspot.com/bug?id=d5f1d9a688ae7edbefca711fd5c4aae4f148bc3a
// status:fixed
                                   ...
                                   uintptr_t a6, uintptr_t a7)
{
  ...
  if (text_type == 8) {
    if (flags & KVM_SETUP_SMM) {
      ...
      if (flags & KVM_SETUP_PAGING) {
        ...
        NONFAILING(pd[0] = PDE32_PRESENT | PDE32_RW | PDE32_USER |
                           PDE32_PS);
        sregs.cr3 = pd_addr;
        sregs.cr4 |= CR4_PSE;
    ...
    if (flags & KVM_SETUP_SMM) {
      ...
      uint64_t* pd = (uint64_t*)(host_mem + ADDR_PD);
      NONFAILING(pd[0] =
                     PDE32_PRESENT | PDE32_RW | PDE32_USER | PDE32_PS);
      sregs.cr3 = pd_addr;
      sregs.cr4 |= CR4_PSE;
    ...
    uint64_t* pd = (uint64_t*)(host_mem + ADDR_PD);
    NONFAILING(pml4[0] =
                   PDE64_PRESENT | PDE64_RW | PDE64_USER | pdpt_addr);
    NONFAILING(pdpt[0] =
                   PDE64_PRESENT | PDE64_RW | PDE64_USER | pd_addr);
    NONFAILING(pd[0] =
    ...
    if (flags & KVM_SETUP_VM) {
      ...
      NONFAILING(*((uint64_t*)(host_mem + ADDR_VAR_VMXON_PTR)) =
                     ADDR_VAR_VMXON);
      NONFAILING(*((uint64_t*)(host_mem + ADDR_VAR_VMCS_PTR)) =
                     ADDR_VAR_VMCS);
      NONFAILING(memcpy(host_mem + ADDR_VAR_VMEXIT_CODE,
                        kvm_asm64_vm_exit,
  ...
  if (text_prefix) {
    ...
    void* patch = 0;
    NONFAILING(patch = memmem(host_text, text_prefix_size,
                              "\xde\xc0\xad\x0b", 4));
    if (patch)
      NONFAILING(*((uint32_t*)patch) = guest_mem + ADDR_TEXT +
                                       ((char*)patch - host_text) + 6);
    uint16_t magic = PREFIX_SIZE;
    patch = 0;
    NONFAILING(patch = memmem(host_text, text_prefix_size, &magic,
                              sizeof(magic)));
    if (patch)
  ...
  for (i = 0; i < opt_count; i++) {
    ...
    case 8:
      NONFAILING(*(uint64_t*)(host_mem + ADDR_VAR_VMWRITE_FLD) =
                     (val & 0xffff));
      NONFAILING(*(uint64_t*)(host_mem + ADDR_VAR_VMWRITE_VAL) =
                     (val >> 16));
      break;
    default:
...
void* thr(void* arg)
{
  switch ((long)arg) {
  case 0:
    r[0] = syscall(__NR_timer_gettime, 0x0ul, 0x20317fe0ul);
    break;
  case 1:
    r[1] = syscall(__NR_clock_gettime, 0x4ul, 0x20dc1000ul);
    break;
  case 2:
    r[2] = syscall(__NR_pipe, 0x20acc000ul);
    if (r[2] != -1)
      NONFAILING(r[3] = *(uint32_t*)0x20acc000);
    if (r[2] != -1)
      NONFAILING(r[4] = *(uint32_t*)0x20acc004);
    break;
  case 3:
    NONFAILING(*(uint16_t*)0x20620901 = (uint16_t)0xa);
    NONFAILING(*(uint16_t*)0x20620903 = (uint16_t)0x234e);
    NONFAILING(*(uint32_t*)0x20620905 = (uint32_t)0xffffffff7fffffff);
    NONFAILING(*(uint64_t*)0x20620909 = (uint64_t)0x0);
    NONFAILING(*(uint64_t*)0x20620911 = (uint64_t)0x100000000000000);
    NONFAILING(*(uint32_t*)0x20620919 = (uint32_t)0x100);
    r[11] = syscall(__NR_bind, r[3], 0x20620901ul, 0x1cul);
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x2025c000 = (uint32_t)0x2);
    NONFAILING(*(uint32_t*)0x2025c004 = (uint32_t)0x78);
    NONFAILING(*(uint8_t*)0x2025c008 = (uint8_t)0x3e3);
    ...
    NONFAILING(*(uint64_t*)0x2025c048 = (uint64_t)0x400);
    ...
    r[39] = syscall(__NR_perf_event_open, 0x2025c000ul, 0x0ul,
                    0xfffffffffffffffful, 0xfffffffffffffffful, 0x0ul);
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20ff1000,
                      "\x2e\x2f\x66\x69\x6c\x65\x30\x00", 8));
    r[41] = syscall(__NR_open, 0x20ff1000ul, 0x2ul, 0x0ul);
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x20ff1ff8 = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x20ff1ffc = (uint32_t)0x8);
    r[44] = syscall(__NR_setsockopt, r[41], 0x84ul, 0x76ul,
                    0x20ff1ff8ul, 0x8ul);
    break;
  case 7:
    r[45] = syscall(__NR_socket, 0xaul, 0x1ul, 0x0ul);
    break;
  case 8:
    NONFAILING(*(uint8_t*)0x20fe2000 = (uint8_t)0xfe);
    NONFAILING(*(uint8_t*)0x20fe2001 = (uint8_t)0x80);
    NONFAILING(*(uint8_t*)0x20fe2002 = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x20fe2003 = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x20fe2004 = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x20fe2005 = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x20fe2006 = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x20fe2007 = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x20fe2008 = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x20fe2009 = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x20fe200a = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x20fe200b = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x20fe200c = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x20fe200d = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x20fe200e = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x20fe200f = (uint8_t)0xbb);
    NONFAILING(*(uint32_t*)0x20fe2010 = (uint32_t)0x0);
    NONFAILING(*(uint8_t*)0x20fe2014 = (uint8_t)0x3);
    NONFAILING(*(uint8_t*)0x20fe2015 = (uint8_t)0x20000000002);
    NONFAILING(*(uint16_t*)0x20fe2016 = (uint16_t)0x1);
    NONFAILING(*(uint16_t*)0x20fe2018 = (uint16_t)0x0);
    NONFAILING(*(uint16_t*)0x20fe201a = (uint16_t)0x0);
    NONFAILING(*(uint32_t*)0x20fe201c = (uint32_t)0x0);
    r[69] = syscall(__NR_setsockopt, r[45], 0x29ul, 0x20ul,
                    0x20fe2000ul, 0x20ul);
    break;
  case 9:
    NONFAILING(*(uint32_t*)0x2001d000 = (uint32_t)0x1);
    NONFAILING(*(uint32_t*)0x2001d004 = (uint32_t)0x78);
    NONFAILING(*(uint8_t*)0x2001d008 = (uint8_t)0x1);
    NONFAILING(*(uint8_t*)0x2001d009 = (uint8_t)0x2);
    ...
    NONFAILING(*(uint8_t*)0x2001d028 = (uint8_t)0xfffffffff7fffffe);
    ...
    NONFAILING(*(uint32_t*)0x2001d070 = (uint32_t)0x2);
    NONFAILING(*(uint16_t*)0x2001d074 = (uint16_t)0x0);
    NONFAILING(*(uint16_t*)0x2001d076 = (uint16_t)0x0);
    r[97] = syscall(__NR_perf_event_open, 0x2001d000ul, 0x0ul,
                    0xfffffffffffffffful, 0xfffffffffffffffful, 0x0ul);
    break;
  case 10:
    r[98] = syscall(__NR_unshare, 0x20000000ul);
    break;
  case 11:
    r[99] = syscall(__NR_clone, 0x20000002000000ul, 0x205b6000ul,
                    0x20190ffcul, 0x20c35ffcul, 0x20e1e000ul);
    break;
  case 12:
    r[100] = syscall(__NR_sync);
    break;
  case 13:
    NONFAILING(memcpy((void*)0x204c1000, "\x75\x73\x65\x72\x00", 5));
    NONFAILING(*(uint8_t*)0x20ff2000 = (uint8_t)0x73);
    NONFAILING(*(uint8_t*)0x20ff2001 = (uint8_t)0x79);
    NONFAILING(*(uint8_t*)0x20ff2002 = (uint8_t)0x7a);
    NONFAILING(*(uint8_t*)0x20ff2003 = (uint8_t)0x20);
    NONFAILING(*(uint8_t*)0x20ff2004 = (uint8_t)0x0);
    r[107] = syscall(__NR_add_key, 0x204c1000ul, 0x20ff2000ul,
                     0x20f88faaul, 0x0ul, 0xfffffffffffffffbul);
    break;
  case 14:
    r[108] = syscall(__NR_io_setup, 0xb91ul, 0x20a4c000ul);
    break;
  case 15:
    r[109] = syscall(__NR_ioctl, 0xfffffffffffffffful, 0x540ful,
                     0x2065c000ul);
    break;
  case 16:
    NONFAILING(*(uint8_t*)0x20d31fd8 = (uint8_t)0x5);
    NONFAILING(*(uint64_t*)0x20d31fe0 = (uint64_t)0x7f);
    NONFAILING(*(uint64_t*)0x20d31fe8 = (uint64_t)0x2);
    NONFAILING(*(uint64_t*)0x20d31ff0 = (uint64_t)0x1);
    NONFAILING(*(uint64_t*)0x20d31ff8 = (uint64_t)0xfff);
    r[115] = syscall(__NR_ioctl, r[4], 0x541cul, 0x20d31fd8ul);
    break;
  case 17:
    r[116] = syscall(__NR_clone, 0x20003fdul, 0x209d7ffdul,
                     0x2072a000ul, 0x204d7000ul, 0x2027b000ul);
    break;
  case 18:
    r[117] = syscall(__NR_socket, 0x2ul, 0x1ul, 0x0ul);
    break;
  case 19:
    r[118] = syscall(__NR_pipe, 0x2042a000ul);
    if (r[118] != -1)
      NONFAILING(r[119] = *(uint32_t*)0x2042a004);
    break;
  case 20:
    NONFAILING(*(uint16_t*)0x208aa000 = (uint16_t)0x0);
    NONFAILING(*(uint16_t*)0x208aa002 = (uint16_t)0x0);
    NONFAILING(*(uint16_t*)0x208aa004 = (uint16_t)0x1);
    NONFAILING(*(uint32_t*)0x208aa008 = (uint32_t)0x5);
    NONFAILING(*(uint32_t*)0x208aa00c = (uint32_t)0xffffffffffffff01);
    NONFAILING(*(uint32_t*)0x208aa010 = (uint32_t)0x8d);
    NONFAILING(*(uint32_t*)0x208aa014 = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x208aa018 = (uint32_t)0x119ced7b);
    NONFAILING(*(uint32_t*)0x208aa01c = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x20be3ad5 = (uint32_t)0x20);
    r[130] = syscall(__NR_getsockopt, r[117], 0x84ul, 0xaul,
                     0x208aa000ul, 0x20be3ad5ul);
    if (r[130] != -1)
      NONFAILING(r[131] = *(uint32_t*)0x208aa01c);
    break;
  case 21:
    NONFAILING(*(uint32_t*)0x20918000 = r[131]);
    NONFAILING(*(uint32_t*)0x20918004 = (uint32_t)0x3f5d);
    NONFAILING(*(uint32_t*)0x20fe6ffc = (uint32_t)0x8);
    r[135] = syscall(__NR_getsockopt, r[119], 0x84ul, 0xdul,
                     0x20918000ul, 0x20fe6ffcul);
    break;
  case 22:
    NONFAILING(*(uint32_t*)0x20211ffc = (uint32_t)0x10);
    r[137] = syscall(__NR_accept, 0xfffffffffffffffful, 0x2074cff0ul,
                     0x20211ffcul);
    break;
  case 23:
    NONFAILING(*(uint32_t*)0x20c79000 = (uint32_t)0x2);
    NONFAILING(*(uint32_t*)0x20c79004 = (uint32_t)0x78);
    NONFAILING(*(uint8_t*)0x20c79008 = (uint8_t)0xe3);
    NONFAILING(*(uint8_t*)0x20c79009 = (uint8_t)0x6);
    NONFAILING(*(uint8_t*)0x20c7900a = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x20c7900b = (uint8_t)0x0);
    NONFAILING(*(uint32_t*)0x20c7900c = (uint32_t)0x0);
    NONFAILING(*(uint64_t*)0x20c79010 = (uint64_t)0x0);
    NONFAILING(*(uint64_t*)0x20c79018 = (uint64_t)0xfffffffffffffffc);
    NONFAILING(*(uint64_t*)0x20c79020 = (uint64_t)0x0);
    NONFAILING(*(uint8_t*)0x20c79028 = (uint8_t)0x11464);
    NONFAILING(*(uint8_t*)0x20c79029 = (uint8_t)0x8001);
    NONFAILING(*(uint8_t*)0x20c7902a = (uint8_t)0xff);
    NONFAILING(*(uint8_t*)0x20c7902b = (uint8_t)0x0);
    NONFAILING(*(uint32_t*)0x20c7902c = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x20c79030 = (uint32_t)0x4);
    NONFAILING(*(uint32_t*)0x20c79034 = (uint32_t)0x0);
    NONFAILING(*(uint64_t*)0x20c79038 = (uint64_t)0x0);
    NONFAILING(*(uint64_t*)0x20c79040 = (uint64_t)0x0);
    NONFAILING(*(uint64_t*)0x20c79048 = (uint64_t)0x0);
    NONFAILING(*(uint64_t*)0x20c79050 = (uint64_t)0x0);
    NONFAILING(*(uint64_t*)0x20c79058 = (uint64_t)0x1);
    NONFAILING(*(uint32_t*)0x20c79060 = (uint32_t)0x2);
    NONFAILING(*(uint64_t*)0x20c79068 = (uint64_t)0x9);
    NONFAILING(*(uint32_t*)0x20c79070 = (uint32_t)0x0);
    NONFAILING(*(uint16_t*)0x20c79074 = (uint16_t)0x0);
    NONFAILING(*(uint16_t*)0x20c79076 = (uint16_t)0x0);
    r[165] = syscall(__NR_perf_event_open, 0x20c79000ul, 0x0ul,
                     0xfffffffffffffffful, 0xfffffffffffffffful, 0x0ul);
    break;
  case 24:
    NONFAILING(memcpy((void*)0x209fa000,
                      "\x2f\x64\x65\x76\x2f\x6b\x76\x6d\x00", 9));
    r[167] = syscall(__NR_openat, 0xffffffffffffff9cul, 0x209fa000ul,
                     0x0ul, 0x0ul);
    break;
  case 25:
    r[168] = syscall(__NR_ioctl, r[167], 0xae01ul, 0x0ul);
    break;
  case 26:
    r[169] = syscall(__NR_ioctl, r[168], 0xae41ul, 0x0ul);
    break;
  case 27:
    NONFAILING(*(uint32_t*)0x20a61fc0 = (uint32_t)0x3);
    NONFAILING(*(uint32_t*)0x20a61fc4 = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x20a61fc8 = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x20a61fcc = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x20a61fd0 = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x20a61fd4 = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x20a61fd8 = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x20a61fdc = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x20a61fe0 = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x20a61fe4 = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x20a61fe8 = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x20a61fec = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x20a61ff0 = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x20a61ff4 = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x20a61ff8 = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x20a61ffc = (uint32_t)0x0);
    r[186] = syscall(__NR_ioctl, r[168], 0x4040ae77ul, 0x20a61fc0ul);
    break;
  case 28:
    NONFAILING(*(uint32_t*)0x2004ef90 = (uint32_t)0x0);
    NONFAILING(*(uint16_t*)0x2004ef94 = (uint16_t)0x0);
    NONFAILING(*(uint8_t*)0x2004ef96 = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x2004ef97 = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x2004ef98 = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x2004ef99 = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x2004ef9a = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x2004ef9b = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x2004ef9c = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x2004ef9d = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x2004ef9e = (uint8_t)0x0);
    NONFAILING(*(uint8_t*)0x2004ef9f = (uint8_t)0x0);
    NONFAILING(*(uint64_t*)0x2004efa0 = (uint64_t)0x1ff0);
    NONFAILING(*(uint32_t*)0x2004efa8 = (uint32_t)0x6cb2);
    NONFAILING(*(uint16_t*)0x2004efac = (uint16_t)0x5);
    NONFAILING(*(uint8_t*)0x2004efae = (uint8_t)0x100000001);
    NONFAILING(*(uint8_t*)0x2004efaf = (uint8_t)0x4);
    NONFAILING(*(uint8_t*)0x2004efb0 = (uint8_t)0x7);
    NONFAILING(*(uint8_t*)0x2004efb1 = (uint8_t)0x94d);
    NONFAILING(*(uint8_t*)0x2004efb2 = (uint8_t)0x6);
    NONFAILING(*(uint8_t*)0x2004efb3 = (uint8_t)0x8001);
    NONFAILING(*(uint8_t*)0x2004efb4 = (uint8_t)0x6bf);
    NONFAILING(*(uint8_t*)0x2004efb5 = (uint8_t)0x401);
    NONFAILING(*(uint8_t*)0x2004efb6 = (uint8_t)0x6);
    NONFAILING(*(uint8_t*)0x2004efb7 = (uint8_t)0x4);
    NONFAILING(*(uint64_t*)0x2004efb8 = (uint64_t)0x5);
    NONFAILING(*(uint32_t*)0x2004efc0 = (uint32_t)0x7);
    NONFAILING(*(uint16_t*)0x2004efc4 = (uint16_t)0xa0);
    NONFAILING(*(uint8_t*)0x2004efc6 = (uint8_t)0x3f);
    NONFAILING(*(uint8_t*)0x2004efc7 = (uint8_t)0x7fffffff);
    NONFAILING(*(uint8_t*)0x2004efc8 = (uint8_t)0xfffffffffffff000);
    NONFAILING(*(uint8_t*)0x2004efc9 = (uint8_t)0xfff);
    NONFAILING(*(uint8_t*)0x2004efca = (uint8_t)0x600a);
    NONFAILING(*(uint8_t*)0x2004efcb = (uint8_t)0x2);
    NONFAILING(*(uint8_t*)0x2004efcc = (uint8_t)0x81);
    NONFAILING(*(uint8_t*)0x2004efcd = (uint8_t)0x5);
    NONFAILING(*(uint8_t*)0x2004efce = (uint8_t)0x93bf69f);
    NONFAILING(*(uint8_t*)0x2004efcf = (uint8_t)0x1);
    NONFAILING(*(uint64_t*)0x2004efd0 = (uint64_t)0x100000001);
    NONFAILING(*(uint32_t*)0x2004efd8 = (uint32_t)0x1f);
    NONFAILING(*(uint32_t*)0x2004efdc = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x2004efe0 = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x2004efe4 = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x2004efe8 = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x2004efec = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x2004eff0 = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x2004eff4 = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x2004eff8 = (uint32_t)0x0);
    NONFAILING(*(uint32_t*)0x2004effc = (uint32_t)0x0);
    r[236] = syscall(__NR_ioctl, r[168], 0x4070aea0ul, 0x2004ef90ul);
    break;
  case 29:
    NONFAILING(*(uint64_t*)0x201418f4 = (uint64_t)0x10);
    NONFAILING(*(uint64_t*)0x201418fc = (uint64_t)0x203cf000);
    NONFAILING(*(uint64_t*)0x20141904 = (uint64_t)0x58);
    NONFAILING(memcpy(
        (void*)0x203cf000,
        "\xba\x41\x00\xed\xba\xf8\x0c\x66\xb8\x2c\x6c\xd0\x8f\x66\xef"
        "\xba\xfc\x0c\x66\xb8\xcd\x82\x00\x00\x66\xef\x0f\x01\xc9\x0f"
        "\x08\xda\xbd\x00\x00\x0f\x01\xc9\xba\xf8\x0c\x66\xb8\x24\x8f"
        "\x77\x83\x66\xef\xba\xfc\x0c\x66\xb8\x00\x00\x00\x00\x66\xef"
        "\x0f\x21\x35\x66\xb8\xe1\xb1\x00\x00\x0f\x23\xc8\x0f\x21\xf8"
        "\x66\x35\x08\x00\x80\x00\x0f\x23\xf8\xf3\x0f\x01\xc3",
        88));
    NONFAILING(*(uint64_t*)0x2070b000 = (uint64_t)0x4);
    NONFAILING(*(uint64_t*)0x2070b008 = (uint64_t)0xf);
    r[243] =
        syz_kvm_setup_cpu(r[168], r[169], 0x20168000ul, 0x201418f4ul,
                          0x1ul, 0x40ul, 0x2070b000ul, 0x1ul);
    break;
  case 30:
    r[244] = syscall(__NR_ioctl, r[169], 0xae80ul, 0x0ul);
    break;
  }
  return 0;
}
...
void test()
{
  ...
  for (i = 0; i < 31; i++) {
    pthread_create(&th[31 + i], 0, thr, (void*)i);
    if (rand() % 2)
      usleep(rand() % 10000);
  }
  usleep(rand() % 100000);
