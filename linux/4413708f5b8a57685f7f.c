...
// https://syzkaller.appspot.com/bug?id=4413708f5b8a57685f7f
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    break;
  case 3:
    NONFAILING(*(uint16_t*)0x20000340 = 0x18);
    NONFAILING(*(uint32_t*)0x20000342 = 1);
    NONFAILING(*(uint32_t*)0x20000346 = 3);
    NONFAILING(*(uint32_t*)0x2000034a = r[1]);
    NONFAILING(*(uint16_t*)0x2000034e = 2);
    NONFAILING(*(uint16_t*)0x20000350 = htobe16(0));
    NONFAILING(*(uint32_t*)0x20000352 = htobe32(0xe0000001));
    NONFAILING(*(uint32_t*)0x2000035e = 2);
    NONFAILING(*(uint32_t*)0x20000362 = 0);
    NONFAILING(*(uint32_t*)0x20000366 = 0);
    NONFAILING(*(uint32_t*)0x2000036a = 0);
    syscall(__NR_connect, r[0], 0x20000340ul, 0x2eul);
    break;
  case 4:
    ...
    NONFAILING(*(uint8_t*)0x20000097 = 0xaa);
    NONFAILING(*(uint32_t*)0x20000098 = 4);
