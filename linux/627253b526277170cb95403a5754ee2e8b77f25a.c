...
int main(void)
{
  ...
  *(uint32_t*)0x20000104 = htobe32(0x7f000001);
  syscall(__NR_bind, r[0], 0x20000100ul, 0x10ul);
  *(uint32_t*)0x20000000 = 0;
  *(uint32_t*)0x20000004 = 7;
  syscall(__NR_setsockopt, r[0], 0x84ul, 0x75ul, 0x20000000ul, 8ul);
  *(uint32_t*)0x20000580 = 0;
  *(uint32_t*)0x20000584 = 5;
  syscall(__NR_setsockopt, r[0], 0x84ul, 0x76ul, 0x20000580ul, 8ul);
  ...
  *(uint32_t*)0x2001aff8 = 0;
  syscall(__NR_sendmsg, r[0], 0x2001afc8ul, 0ul);
  *(uint32_t*)0x20000040 = 0;
  *(uint16_t*)0x20000044 = 0x200;
  *(uint16_t*)0x20000046 = 0x3840;
  inject_fault(0);
  syscall(__NR_setsockopt, r[0], 0x84ul, 0x79ul, 0x20000040ul, 8ul);
  return 0;
}
