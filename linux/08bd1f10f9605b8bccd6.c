...
// https://syzkaller.appspot.com/bug?id=08bd1f10f9605b8bccd6
// status:0
...
void execute_one(void)
{
  ...
  res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000000ul, 0x82ul, 0ul);
  if (res != -1)
    r[1] = res;
  syscall(__NR_mmap, 0x20000000ul, 0xe7e000ul, 0x2000009ul, 0xc011ul, r[1],
          0ul);
