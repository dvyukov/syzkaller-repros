...
// https://syzkaller.appspot.com/bug?id=60f9ee7f99afe29ef9fa
// status:2
...
{
  intptr_t res = 0;
  memcpy((void*)0x20000000, "\x12\x01\x00\x00\x3a\xb3\xf1\x10\x40\x1c\x34\x05"
                            "\xce\x63\x08\x00\x03\x01\x09\x02\x12\x00\x01\x00"
                            "\x00\x00\x00\x09\x04",
         29);
