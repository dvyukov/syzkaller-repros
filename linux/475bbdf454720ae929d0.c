...
// https://syzkaller.appspot.com/bug?id=475bbdf454720ae929d0
// status:0
...
void loop(void)
{
  ...
  *(uint32_t*)0x20000370 = 0;
  ...
  memcpy((void*)0x20000280, "wlan1\000\000\000\000\000\000\000\000\000\000\000",
         16);
  res = syscall(__NR_ioctl, r[0], 0x8933, 0x20000280ul);
  if (res != -1)
  ...
  *(uint8_t*)0x20002460 = -1;
  *(uint8_t*)0x20002461 = -1;
  *(uint8_t*)0x20002462 = -1;
  *(uint8_t*)0x20002463 = -1;
  *(uint8_t*)0x20002464 = -1;
  *(uint8_t*)0x20002465 = -1;
  *(uint64_t*)0x20002488 = 0x28;
  *(uint64_t*)0x200024d8 = 1;
  *(uint64_t*)0x200024e0 = 0;
  *(uint64_t*)0x200024e8 = 0;
  *(uint32_t*)0x200024f0 = 0x4014050;
  syscall(__NR_sendmsg, r[0], 0x200024c0ul, 0x4004ul);
}
int main(void)
{
