...
// https://syzkaller.appspot.com/bug?id=2b5c1669f6d06e18d6544f01fb8b7d9122569961
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_ioctl, r[0], 0x400455c8, 2);
    break;
  case 3:
  ...
  case 6:
    ...
    break;
  case 7:
    syscall(__NR_sendto, r[1], 0x20000000, 0xff19, 0, 0, 0x101aa);
    break;
  case 8:
    syscall(__NR_ioctl, -1, 0x89e0, 0);
    break;
  case 9:
    syscall(__NR_fcntl, -1, 0x10, 0);
    break;
  case 10:
    syscall(__NR_setgroups, 0, 0);
    break;
  case 11:
    NONFAILING(memcpy((void*)0x200000c0, "./bus\000", 6));
    syscall(__NR_open, 0x200000c0, 0x800000141042, 0);
    break;
  case 12:
    NONFAILING(*(uint32_t*)0x20000080 = 0);
    syscall(__NR_ioctl, r[0], 0x5412, 0x20000080);
    break;
  }
}
int main(void)
