...
// https://syzkaller.appspot.com/bug?id=2698183e871d8a137f9d
// status:0
...
void execute_one(void)
{
  ...
  syscall(__NR_clone, 0x80100900ul, 0ul, 0x9999999999999999ul, 0ul, -1ul);
  ...
  if (res != -1)
    r[1] = res;
  syscall(__NR_mmap, 0x20000000ul, 0x800000ul, 0x3000002ul, 0x12ul, r[1], 0ul);
  NONFAILING(*(uint64_t*)0x20000100 = 0xffffffffff600000);
  NONFAILING(*(uint64_t*)0x20000108 = 0);
  syscall(__NR_vmsplice, -1, 0x20000100ul, 1ul, 0ul);
  syscall(__NR_ptrace, 0x4206ul, r[0], 0ul, 0ul);
  syscall(__NR_tkill, r[0], 0x40);
  ...
  syscall(__NR_rt_sigqueueinfo, r[2], 0x3c, 0x20000040ul);
}
int main(void)
{
