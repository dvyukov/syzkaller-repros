...
// https://syzkaller.appspot.com/bug?id=9b57a46bf1801ce2a2ca
// status:6
...
int main(void)
{
  ...
  *(uint64_t*)0x20000114 = 0x20000640;
  ...
  *(uint32_t*)0x20000642 = 1;
  ...
  STORE_BY_BITMASK(uint8_t, , 0x20000646, 8, 4, 4);
  *(uint64_t*)0x2000011c = 0;
  ...
  if (res != -1)
    r[1] = res;
  syscall(__NR_ioctl, r[1], 0x4805, 0ul);
  return 0;
}
