...
// https://syzkaller.appspot.com/bug?id=fb195f91dc044978c1b186f1288b1eff61edcc20
// status:open
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000040, "/dev/vhost-net\x00", 15));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000040, 2, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 3:
    syscall(__NR_ioctl, r[0], 0x4008af00, 0);
    break;
  case 4:
  ...
  case 5:
    ...
    break;
  case 6:
    syscall(__NR_ioctl, r[0], 0x4028af11, 0);
    break;
  case 7:
    syz_init_net_socket(3, 3, 6);
    break;
  case 8:
    NONFAILING(memcpy((void*)0x200000c0, "/dev/audio\x00", 11));
  ...
  case 10:
    ...
    break;
  case 11:
    NONFAILING(*(uint32_t*)0x20f1dff8 = 0);
    NONFAILING(*(uint32_t*)0x20f1dffc = r[1]);
