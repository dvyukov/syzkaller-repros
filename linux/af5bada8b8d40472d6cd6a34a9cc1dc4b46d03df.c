...
void execute_call(int call)
{
  ...
  case 3:
    ...
    NONFAILING(memcpy((void*)0x200013c0, "trans=fd,", 9));
    NONFAILING(memcpy((void*)0x200013c9, "rfdno", 5));
    NONFAILING(*(uint8_t*)0x200013ce = 0x3d);
    NONFAILING(sprintf((char*)0x200013cf, "0x%016llx", (long long)r[0]));
    NONFAILING(*(uint8_t*)0x200013e1 = 0x2c);
    NONFAILING(memcpy((void*)0x200013e2, "wfdno", 5));
    NONFAILING(*(uint8_t*)0x200013e7 = 0x3d);
    NONFAILING(sprintf((char*)0x200013e8, "0x%016llx", (long long)r[1]));
    NONFAILING(*(uint8_t*)0x200013fa = 0x2c);
    NONFAILING(*(uint8_t*)0x200013fb = 0);
    ...
    inject_fault(20);
    syscall(__NR_mount, 0, 0x200000c0, 0x20000100, 0, 0x200013c0);
    break;
  case 4:
    ...
    break;
  case 5:
    NONFAILING(*(uint32_t*)0x20000180 = 0x20);
    NONFAILING(*(uint32_t*)0x20000184 = 0xfeffffff);
    ...
    syscall(__NR_write, r[2], 0x20000180, 0x20);
    break;
  }
}
int main(void)
