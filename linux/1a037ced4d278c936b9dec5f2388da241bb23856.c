...
void execute_call(int call)
{
  ...
  case 3:
    ...
    break;
  case 4:
    NONFAILING(memcpy((void*)0x20000040, "tls", 4));
    syscall(__NR_setsockopt, r[0], 6, 0x1f, 0x20000040, 0x13a);
    break;
  case 5:
    NONFAILING(*(uint32_t*)0x20002e40 = 0x12);
    NONFAILING(*(uint32_t*)0x20002e44 = 0);
    NONFAILING(*(uint32_t*)0x20002e48 = 4);
    NONFAILING(*(uint32_t*)0x20002e4c = 0x6e);
    NONFAILING(*(uint32_t*)0x20002e50 = 0);
    NONFAILING(*(uint32_t*)0x20002e54 = 1);
    NONFAILING(*(uint32_t*)0x20002e58 = 0);
    NONFAILING(*(uint8_t*)0x20002e5c = 0);
    NONFAILING(*(uint8_t*)0x20002e5d = 0);
    NONFAILING(*(uint8_t*)0x20002e5e = 0);
    NONFAILING(*(uint8_t*)0x20002e5f = 0);
    NONFAILING(*(uint8_t*)0x20002e60 = 0);
    NONFAILING(*(uint8_t*)0x20002e61 = 0);
    NONFAILING(*(uint8_t*)0x20002e62 = 0);
    NONFAILING(*(uint8_t*)0x20002e63 = 0);
    NONFAILING(*(uint8_t*)0x20002e64 = 0);
    NONFAILING(*(uint8_t*)0x20002e65 = 0);
    NONFAILING(*(uint8_t*)0x20002e66 = 0);
    NONFAILING(*(uint8_t*)0x20002e67 = 0);
    NONFAILING(*(uint8_t*)0x20002e68 = 0);
    NONFAILING(*(uint8_t*)0x20002e69 = 0);
    NONFAILING(*(uint8_t*)0x20002e6a = 0);
    NONFAILING(*(uint8_t*)0x20002e6b = 0);
    res = syscall(__NR_bpf, 0, 0x20002e40, 0x68);
    if (res != -1)
      r[1] = res;
    break;
  case 6:
