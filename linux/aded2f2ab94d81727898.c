...
// https://syzkaller.appspot.com/bug?id=aded2f2ab94d81727898
// status:6
...
int main(void)
{
  ...
  NONFAILING(memcpy((void*)0x20000100, "bdev\000", 5));
  syscall(__NR_mount, 0ul, 0x200000c0ul, 0x20000100ul, 0ul, 0ul);
  return 0;
}
