...
// https://syzkaller.appspot.com/bug?id=72c5cf124089bc318016
// status:0
...
void execute_one(void)
{
  ...
  if (res != -1)
    r[0] = res;
  NONFAILING(memcpy((void*)0x20000380, "syz1\000", 5));
  res = syscall(__NR_openat, r[0], 0x20000380ul, 0x200002ul, 0ul);
  if (res != -1)
    r[1] = res;
