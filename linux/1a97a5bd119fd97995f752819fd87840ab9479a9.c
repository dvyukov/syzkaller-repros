...
void execute_one()
{
  ...
  if (res != -1)
    r[1] = res;
  *(uint64_t*)0x20000280 = r[0];
  syscall(__NR_ioctl, r[1], 0x40086602, 0x20000280);
  ...
  *(uint8_t*)0x200002ab = 0;
  syscall(__NR_bpf, 0, 0x20000280, 0xfffffffffffffd45);
