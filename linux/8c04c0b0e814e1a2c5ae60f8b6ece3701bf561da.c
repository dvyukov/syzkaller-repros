...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    syscall(__NR_sendmsg, r[0], 0, 0x4000010);
    break;
  case 3:
  ...
  case 4:
    ...
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20000440, "TIPC", 5));
    res = syz_genetlink_get_family_id(0x20000440);
    if (res != -1)
      r[2] = res;
    break;
  case 6:
    NONFAILING(*(uint16_t*)0x200001c0 = 0x1e);
    ...
    syscall(__NR_bind, r[1], 0x200001c0, 0x10);
    break;
  case 7:
    ...
    NONFAILING(*(uint32_t*)0x200000c0 = 0x68);
    NONFAILING(*(uint16_t*)0x200000c4 = r[2]);
    NONFAILING(*(uint16_t*)0x200000c6 = 0x205);
    NONFAILING(*(uint32_t*)0x200000c8 = 0);
    NONFAILING(*(uint32_t*)0x200000cc = 0);
    NONFAILING(*(uint8_t*)0x200000d0 = 1);
    NONFAILING(*(uint8_t*)0x200000d1 = 0);
    NONFAILING(*(uint16_t*)0x200000d2 = 0);
    NONFAILING(*(uint32_t*)0x200000d4 = 0);
    NONFAILING(*(uint16_t*)0x200000d8 = 6);
    NONFAILING(*(uint16_t*)0x200000da = 0);
    NONFAILING(*(uint16_t*)0x200000dc = htobe16(0x4c));
    NONFAILING(*(uint16_t*)0x200000de = htobe16(0x18));
    NONFAILING(*(uint32_t*)0x200000e0 = htobe32(0));
    NONFAILING(*(uint8_t*)0x200000e4 = 0x3a);
    NONFAILING(*(uint64_t*)0x20000148 = 0x68);
