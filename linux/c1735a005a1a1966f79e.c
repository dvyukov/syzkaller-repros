...
// https://syzkaller.appspot.com/bug?id=c1735a005a1a1966f79e
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000048 = 0x48000000;
  ...
  *(uint64_t*)0x20000388 = 0;
  ...
  syscall(__NR_getdents64, -1, 0ul, 0ul);
  syscall(__NR_sendmmsg, -1, 0ul, 0ul, 0x24008020ul);
  memcpy((void*)0x20000180, "/dev/bus/usb/00#/00#\000", 21);
  res = -1;
  res = syz_open_dev(0x20000180, 0x77, 1);
  if (res != -1)
  ...
  *(uint32_t*)0x20000044 = 0x5517;
  *(uint64_t*)0x20000048 = 0x48000000;
  syscall(__NR_ioctl, r[1], 0x80045505, 0x20000040ul);
  memcpy((void*)0x20000180, "/dev/bus/usb/00#/00#\000", 21);
  res = -1;
  res = syz_open_dev(0x20000180, 0x77, 1);
  if (res != -1)
  ...
  *(uint64_t*)0x20000048 = 0x48000000;
  inject_fault(3);
  syscall(__NR_ioctl, r[2], 0x80045505, 0x20000040ul);
}
int main(void)
{
