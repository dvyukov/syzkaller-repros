...
// https://syzkaller.appspot.com/bug?id=2f6d7c28bb4bf7e82060
// status:0
...
void execute_call(int call)
{
  ...
  case 3:
    ...
    break;
  case 4:
    syscall(__NR_ioctl, -1, 0x400443c9, 0ul);
    break;
  case 5:
  ...
  case 9:
    ...
    *(uint8_t*)0x20000187 = -1;
    syscall(__NR_connect, r[1], 0x20000180ul, 8ul);
    break;
  }
}
int main(void)
