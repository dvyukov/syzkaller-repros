...
int main(void)
{
  ...
  long res = 0;
  syscall(__NR_socketpair, 1, 1, 0, 0x20000400);
  ...
  *(uint64_t*)0x20000340 = 0x20000240;
  memcpy((void*)0x20000240, "\x14\x5f\x42\x00\x00\x00\x00\x00\x00\x00\x07\xff"
                            "\x00\x00\x00\x00\x03\x00\x14\x00\x06\x00\x00\x8b"
                            "\x57\x32\x81\x0f\xf6\x85\x0c\xfb\x00\x00\x00\x00"
                            "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x08\x00\x08"
                            "\x00\x05\x00\xac\x14\x14\x1a",
         55);
  ...
  *(uint32_t*)0x200003b0 = 0;
  ...
  syscall(__NR_socketpair, 0, 0, 0, 0x20000200);
  *(uint32_t*)0x20000140 = 0;
  *(uint32_t*)0x20000144 = 0xede;
  *(uint32_t*)0x200001c0 = 8;
  syscall(__NR_getsockopt, -1, 0x84, 0x76, 0x20000140, 0x200001c0);
  res = syscall(__NR_ioctl, r[1], 0xae41, 0);
  if (res != -1)
    r[2] = res;
  *(uint64_t*)0x20000040 = 0x40;
  *(uint64_t*)0x20000048 = 0x200002c0;
  memcpy((void*)0x200002c0, "\xb8\x01\x00\x00\x00\x0f\x01\xc1\x66\xb8\xe2\x00"
                            "\x0f\x00\xd8\xb9\x80\x00\x00\xc0\x0f\x32\x35\x00"
                            "\x40\x00\x00\x0f\x30\x4a\x0f\xc7\x5f\x20\xc4\x43"
                            "\x79\x60\x8d\x00\x00\x01\x00\xf2\x2e\x0f\x01\xca"
                            "\x67\x44\x0f\xf6\x14\x3f\x66\xba\x40\x00\xb8\x46"
                            "\xc9\x51\x82\xef\x0f\x01\xcf\x40\x0f\x01\xdf",
         71);
  *(uint64_t*)0x20000050 = 0x47;
  syz_kvm_setup_cpu(r[1], -1, 0x20000000, 0x20000040, 0x26a, 0, 0x20000100,
                    0xffffffffffffe82);
