...
// https://syzkaller.appspot.com/bug?id=e4f5deeeccdd5a4873fe
// status:2
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000258 = -1;
  ...
  res = -1;
  res = syz_io_uring_setup(0x1db, 0x20000240, 0x20002000, 0x20ffd000,
  ...
  syz_open_dev(0x20000040, 0x401, 2);
  ...
  *(uint16_t*)0x2000002a = 0;
  ...
  syscall(__NR_io_uring_enter, r[0], 0x2ff, 0, 0ul, 0ul, 0xf5fffffful);
}
int main(void)
{
