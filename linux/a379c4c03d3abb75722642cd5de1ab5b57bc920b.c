...
// https://syzkaller.appspot.com/bug?id=a379c4c03d3abb75722642cd5de1ab5b57bc920b
// status:open
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000440, "/selinux/relabel\x00", 17));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000440, 2, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    syscall(__NR_write, r[0], 0x20000d80, 0);
    break;
  case 2:
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0x8000, 1, 1));
    ...
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2001d028, 2, 9, 1));
    NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x2001d028, 2, 10, 1));
    ...
    NONFAILING(*(uint32_t*)0x2001d034 = 1);
  ...
  case 4:
    ...
    NONFAILING(*(uint32_t*)0x200002cc = 0x50);
    NONFAILING(*(uint64_t*)0x200002d0 = 0x200001c0);
    NONFAILING(*(uint32_t*)0x200002d8 = 9);
    syscall(__NR_bpf, 0x10, 0x200002c0, 0x20);
    break;
  case 5:
  ...
  case 8:
    ...
    break;
  case 9:
    NONFAILING(memcpy((void*)0x20000240, "threaded\x00", 9));
    syscall(__NR_write, r[4], 0x20000240, 0xf96d);
    break;
  case 10:
    syscall(__NR_fallocate, r[4], 0, 0x8000, 0x8001);
    break;
  case 11:
    syscall(__NR_fallocate, r[4], 3, 0x5e89, 0xfff9);
    break;
  case 12:
    syscall(__NR_unshare, 0);
    break;
  case 13:
    NONFAILING(*(uint32_t*)0x20000300 = 0xe8);
    res = syscall(__NR_getsockopt, r[4], 0x29, 0x22, 0x20000480, 0x20000300);
    if (res != -1)
      NONFAILING(r[5] = *(uint32_t*)0x200004b0);
    break;
  case 14:
    NONFAILING(*(uint16_t*)0x20000340 = 0x11);
    NONFAILING(*(uint16_t*)0x20000342 = htobe16(0x1b));
    NONFAILING(*(uint32_t*)0x20000344 = r[5]);
    NONFAILING(*(uint16_t*)0x20000348 = 1);
    NONFAILING(*(uint8_t*)0x2000034a = 0xf7);
    NONFAILING(*(uint8_t*)0x2000034b = 6);
    NONFAILING(memcpy((void*)0x2000034c, "\x22\xff\xff\x4a\x32\xa3", 6));
    NONFAILING(*(uint8_t*)0x20000352 = 0);
    NONFAILING(*(uint8_t*)0x20000353 = 0);
    syscall(__NR_bind, r[2], 0x20000340, 0x14);
    break;
  case 15:
    syscall(__NR_sched_getattr, r[3], 0x20000180, 0x30, 0);
    break;
  case 16:
    NONFAILING(*(uint16_t*)0x200003c0 = 2);
    NONFAILING(*(uint16_t*)0x200003c2 = htobe16(0));
    NONFAILING(*(uint32_t*)0x200003c4 = htobe32(0));
    NONFAILING(*(uint16_t*)0x200003d0 = 0x306);
    NONFAILING(*(uint8_t*)0x200003d2 = 0xaa);
    NONFAILING(*(uint8_t*)0x200003d3 = 0xaa);
    NONFAILING(*(uint8_t*)0x200003d4 = 0xaa);
    NONFAILING(*(uint8_t*)0x200003d5 = 0xaa);
    NONFAILING(*(uint8_t*)0x200003d6 = 0xaa);
    NONFAILING(*(uint8_t*)0x200003d7 = 0xaa);
    NONFAILING(*(uint32_t*)0x200003e0 = 4);
    NONFAILING(*(uint16_t*)0x200003e8 = 2);
    NONFAILING(*(uint16_t*)0x200003ea = htobe16(0));
    NONFAILING(*(uint8_t*)0x200003ec = 0xac);
    NONFAILING(*(uint8_t*)0x200003ed = 0x14);
    NONFAILING(*(uint8_t*)0x200003ee = 0x14);
    NONFAILING(*(uint8_t*)0x200003ef = 0xbb);
    NONFAILING(memcpy((void*)0x200003f8,
                      "nr0\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
                      16));
    syscall(__NR_ioctl, r[1], 0x8953, 0x200003c0);
    break;
  case 17:
    NONFAILING(*(uint32_t*)0x20000b80 = 0xfffffd2c);
    syscall(__NR_getsockopt, r[4], 1, 0x39, 0x20000100, 0x20000b80);
    break;
  case 18:
    NONFAILING(memcpy((void*)0x20000140, "/dev/full\x00", 10));
    res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000140, 0, 0);
    if (res != -1)
      r[6] = res;
    break;
  case 19:
    syscall(__NR_lstat, 0, 0x20000240);
    break;
  case 20:
    ...
    break;
  case 21:
    NONFAILING(memcpy((void*)0x20000400, "/selinux/avc/cache_stats\x00", 25));
    syscall(__NR_openat, 0xffffffffffffff9c, 0x20000400, 0, 0);
    break;
  case 22:
    ...
    break;
  case 23:
    syscall(__NR_ioctl, r[6], 0x800454d7, 0x20000380);
    break;
  case 24:
    syscall(__NR_fcntl, -1, 0x10, 0x200003c0);
    break;
  case 25:
    NONFAILING(*(uint64_t*)0x200000c0 = 0);
    syscall(__NR_ioctl, -1, 0x40086602, 0x200000c0);
    break;
  }
}
int main(void)
