...
// https://syzkaller.appspot.com/bug?id=e506fd8bdabf082fbb9e
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    res = syscall(__NR_socket, 0xaul, 0x401000000001ul, 0);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
  ...
  case 2:
    ...
    break;
  case 3:
    syscall(__NR_perf_event_open, 0ul, 0, 0ul, -1, 8ul);
    break;
  case 4:
    syscall(__NR_connect, r[1], 0ul, 0ul);
    break;
  case 5:
    res = syscall(__NR_open, 0ul, 0x11250c2ul, 0ul);
    if (res != -1)
      r[2] = res;
    break;
  case 6:
    ...
    break;
  case 7:
    syscall(__NR_ftruncate, r[3], 0x208200ul);
    break;
  case 8:
    syscall(__NR_sendfile, r[0], r[2], 0ul, 0x8000fffffffeul);
    break;
  case 9:
    res = syscall(__NR_socket, 0xaul, 0x401000000001ul, 0);
    if (res != -1)
  ...
  case 15:
    ...
    break;
  case 16:
    syscall(__NR_ftruncate, r[7], 0x208200ul);
    break;
  case 17:
    syscall(__NR_sendfile, r[4], r[6], 0ul, 0x8000fffffffeul);
    break;
  case 18:
    ...
    break;
  case 19:
    syscall(__NR_mmap, 0x20000000ul, 0x800000ul, 0x1800003ul, 0x12ul, r[8],
            0ul);
    break;
  case 20:
    syscall(__NR_preadv, r[8], 0ul, 0ul, 0xd9f, 0);
    break;
  case 21:
    ...
    break;
  case 22:
    syscall(__NR_write, r[9], 0ul, 0xd8ul);
    break;
  case 23:
    NONFAILING(memset((void*)0x20000000, 0, 1));
    syscall(__NR_execveat, r[9], 0x20000000ul, 0ul, 0ul, 0x1000ul);
    break;
  case 24:
    ...
    break;
  case 25:
    syscall(__NR_mmap, 0x20000000ul, 0x800000ul, 0x1800003ul, 0x12ul, r[10],
            0ul);
    break;
  case 26:
    syscall(__NR_preadv, r[10], 0ul, 0ul, 0xd9f, 0);
    break;
  }
}
int main(void)
