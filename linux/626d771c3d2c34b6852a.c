...
// https://syzkaller.appspot.com/bug?id=626d771c3d2c34b6852a
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(*(uint64_t*)0x20000308 = 0xbe);
  NONFAILING(*(uint64_t*)0x20000310 = 0x20000180);
  NONFAILING(*(uint64_t*)0x20000318 = 0xa9);
  NONFAILING(*(uint64_t*)0x20000320 = 0);
  NONFAILING(*(uint64_t*)0x20000328 = 0);
  NONFAILING(*(uint64_t*)0x20000330 = 0x20000280);
  NONFAILING(*(uint64_t*)0x20000338 = 0x61);
  syscall(__NR_preadv, r[1], 0x20000300ul, 4ul, 0x101, 0x8000);
