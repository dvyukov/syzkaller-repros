...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    NONFAILING(memcpy((void*)0x20000140, "/dev/net/tun", 13));
  ...
  case 2:
    NONFAILING(memcpy(
        ...
        16));
    NONFAILING(*(uint16_t*)0x20000050 = 0x4001);
    syscall(__NR_ioctl, r[1], 0x400454ca, 0x20000040);
    break;
  case 3:
    NONFAILING(*(uint32_t*)0x20000100 = 1);
    syscall(__NR_ioctl, r[1], 0x400454de, 0x20000100);
    break;
  case 4:
    NONFAILING(memcpy(
        (void*)0x20000000,
  ...
  case 5:
    NONFAILING(memcpy(
        (void*)0x20000180,
        "\x00\x00\x88\xa8\x00\x00\x00\x01\x00\xff\xff\x49\xc2\x46\x5f\x6c\x31"
        "\x90\x95\x70\x69\x91\xe9\x24\x4a\x83\x63\xac\x5e\x49\x00\x14\x00\x00"
        "\x00\x00\x00\x00\x00\x00\xfd\x00\x00\x00\x00\x00\x00\x00\x00\x01\xfe"
        "\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
        63));
    NONFAILING(*(uint32_t*)0x200001bf = 0x41424344);
    NONFAILING(*(uint32_t*)0x200001c3 = 0x41424344);
    NONFAILING(
        memcpy((void*)0x200001c7, "\x50\x00\x00\x00\x90\x78\x00\x00", 8));
    syscall(__NR_write, r[1], 0x20000180, 4);
    break;
  }
}
