...
// https://syzkaller.appspot.com/bug?id=b1c61e5f11be5782f192
// status:6
...
int main(void)
{
  ...
  NONFAILING(*(uint16_t*)0x20000042 = 0x200);
  ...
  NONFAILING(*(uint16_t*)0x20000048 = 0xcf3);
  NONFAILING(*(uint16_t*)0x2000004a = 0x9271);
  NONFAILING(*(uint16_t*)0x2000004c = 0x108);
  NONFAILING(*(uint8_t*)0x2000004e = 1);
  NONFAILING(*(uint8_t*)0x2000004f = 2);
  ...
  NONFAILING(*(uint16_t*)0x20000054 = 0x48);
  NONFAILING(*(uint8_t*)0x20000056 = 1);
  NONFAILING(*(uint8_t*)0x20000057 = 1);
  NONFAILING(*(uint8_t*)0x20000058 = 0);
  NONFAILING(*(uint8_t*)0x20000059 = 0x80);
  NONFAILING(*(uint8_t*)0x2000005a = 0xfa);
  ...
  NONFAILING(*(uint8_t*)0x2000005f = 6);
  ...
  NONFAILING(*(uint8_t*)0x20000066 = 1);
  NONFAILING(*(uint8_t*)0x20000067 = 2);
  NONFAILING(*(uint16_t*)0x20000068 = 0x200);
  ...
  NONFAILING(*(uint8_t*)0x2000006f = 0x82);
  NONFAILING(*(uint8_t*)0x20000070 = 2);
  NONFAILING(*(uint16_t*)0x20000071 = 0x200);
  ...
  NONFAILING(*(uint8_t*)0x20000078 = 0x83);
  NONFAILING(*(uint8_t*)0x20000079 = 3);
  NONFAILING(*(uint16_t*)0x2000007a = 0x40);
  NONFAILING(*(uint8_t*)0x2000007c = 1);
  NONFAILING(*(uint8_t*)0x2000007d = 0);
  NONFAILING(*(uint8_t*)0x2000007e = 0);
  NONFAILING(*(uint8_t*)0x2000007f = 9);
  NONFAILING(*(uint8_t*)0x20000080 = 5);
  NONFAILING(*(uint8_t*)0x20000081 = 4);
  NONFAILING(*(uint8_t*)0x20000082 = 3);
  NONFAILING(*(uint16_t*)0x20000083 = 0x40);
  ...
  NONFAILING(*(uint8_t*)0x20000089 = 5);
  NONFAILING(*(uint8_t*)0x2000008a = 5);
  NONFAILING(*(uint8_t*)0x2000008b = 2);
  NONFAILING(*(uint16_t*)0x2000008c = 0x200);
  ...
  NONFAILING(*(uint8_t*)0x20000093 = 6);
  NONFAILING(*(uint8_t*)0x20000094 = 2);
  NONFAILING(*(uint16_t*)0x20000095 = 0x200);
  NONFAILING(*(uint8_t*)0x20000097 = 0);
  NONFAILING(*(uint8_t*)0x20000098 = 0);
  NONFAILING(*(uint8_t*)0x20000099 = 0);
  res = syz_usb_connect_ath9k(3, 0x5a, 0x20000040, 0);
  if (res != -1)
    r[0] = res;
  NONFAILING(*(uint8_t*)0x200002c0 = 0);
  NONFAILING(*(uint8_t*)0x200002c1 = 0);
  NONFAILING(*(uint16_t*)0x200002c2 = htobe16(0xa));
  NONFAILING(memcpy((void*)0x200002c4, "\x0a\x38\x5f\x9a", 4));
  NONFAILING(*(uint16_t*)0x200002c8 = htobe16(3));
  NONFAILING(*(uint16_t*)0x200002ca = htobe16(0));
  NONFAILING(*(uint8_t*)0x200002cc = 0);
  NONFAILING(*(uint8_t*)0x200002cd = 0xc3);
  NONFAILING(*(uint16_t*)0x200002ce = htobe16(0x326));
  NONFAILING(*(uint8_t*)0x200002d0 = 0);
  NONFAILING(*(uint8_t*)0x200002d1 = 6);
  syz_usb_ep_write(r[0], 0x83, 0x12, 0x200002c0);
  return 0;
}
