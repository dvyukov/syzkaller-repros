...
// https://syzkaller.appspot.com/bug?id=b5682890261cb6ae9636
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    res =
        syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000100ul, 0x800ul, 0ul);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
  ...
  case 2:
    ...
    break;
  case 3:
    NONFAILING(sprintf((char*)0x20000180, "%020llu", (long long)-1));
  ...
  case 5:
    ...
    NONFAILING(*(uint64_t*)0x20000410 = 0x20002000);
  ...
  case 6:
    ...
    break;
  case 7:
    NONFAILING(*(uint64_t*)0x20000140 = 0x40);
