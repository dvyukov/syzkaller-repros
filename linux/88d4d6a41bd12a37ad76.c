// WARNING: can't dereference registers at (null) for ip apic_timer_interrupt
// https://syzkaller.appspot.com/bug?id=88d4d6a41bd12a37ad76
// status:0
...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000360 = 0;
  ...
  STORE_BY_BITMASK(uint64_t, , 0x20000368, 0, 5, 1);
  ...
  STORE_BY_BITMASK(uint64_t, , 0x20000368, 0, 28, 1);
