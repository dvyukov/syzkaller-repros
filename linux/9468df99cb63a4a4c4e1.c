...
// https://syzkaller.appspot.com/bug?id=9468df99cb63a4a4c4e1
// status:0
...
void execute_one(void)
{
  ...
  *(uint8_t*)0x20000044 = 0xea;
  *(uint8_t*)0x20000045 = 0x75;
  *(uint8_t*)0x20000046 = 0x54;
  *(uint8_t*)0x20000047 = 0x20;
  *(uint16_t*)0x20000048 = 0x409;
  *(uint16_t*)0x2000004a = 0x249;
  *(uint16_t*)0x2000004c = 0xf78e;
  ...
  *(uint8_t*)0x2000008a = 0xc6;
  *(uint16_t*)0x2000008b = 0xff;
  *(uint8_t*)0x2000008d = 9;
  *(uint8_t*)0x2000008e = 5;
  *(uint8_t*)0x2000008f = 0xb;
  *(uint8_t*)0x20000090 = 8;
  *(uint16_t*)0x20000091 = 0;
  *(uint8_t*)0x20000093 = 0x7f;
  ...
  *(uint16_t*)0x200000ca = 8;
  syz_usb_connect(2, 0x8c, 0x20000040, 0);
}
int main(void)
{
