...
void loop(void)
{
  ...
  *(uint16_t*)0x2000000c = htobe16(0x800);
  STORE_BY_BITMASK(uint8_t, , 0x2000000e, 7, 0, 4);
  ...
  *(uint8_t*)0x20000022 = 0x83;
  *(uint8_t*)0x20000023 = 3;
  *(uint8_t*)0x20000024 = 0xef;
  *(uint8_t*)0x20000025 = 0x89;
  *(uint8_t*)0x20000026 = 3;
  *(uint8_t*)0x20000027 = 4;
  *(uint8_t*)0x2000002a = 0;
  *(uint8_t*)0x2000002b = 0;
  *(uint16_t*)0x2000002c = htobe16(0);
  *(uint32_t*)0x2000002e = htobe32(-1);
  struct csum_inet csum_1;
  csum_inet_init(&csum_1);
  csum_inet_update(&csum_1, (const uint8_t*)0x2000002a, 8);
  *(uint16_t*)0x2000002c = csum_inet_digest(&csum_1);
  struct csum_inet csum_2;
  csum_inet_init(&csum_2);
  csum_inet_update(&csum_2, (const uint8_t*)0x2000000e, 28);
  *(uint16_t*)0x20000018 = csum_inet_digest(&csum_2);
  syz_emit_ethernet(0x32, 0x20000000, 0);
}
int main(void)
{
