...
void execute_call(int call)
{
  ...
  case 0:
    ...
    *(uint32_t*)0x200000fc = 0;
    res = syscall(__NR_bpf, 0ul, 0x200000c0ul, 0x40ul);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    ...
    *(uint32_t*)0x20000060 = 0x4000010e;
    *(uint32_t*)0x20000064 = r[0];
    *(uint64_t*)0x20000068 = 0;
    *(uint64_t*)0x20000070 = 0;
    syscall(__NR_bpf, 0x1aul, 0x20000040ul, 0x38ul);
    break;
  case 2:
    ...
    *(uint32_t*)0x20fc703c = 0;
    ...
    break;
  case 3:
    *(uint32_t*)0x20fcb000 = r[1];
    *(uint64_t*)0x20fcb008 = 0x20fcbfff;
    *(uint64_t*)0x20fcb010 = 0x20172000;
    *(uint64_t*)0x20fcb018 = 0;
    syscall(__NR_bpf, 2ul, 0x20fcb000ul, 0x20ul);
    break;
  case 4:
