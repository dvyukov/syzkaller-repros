...
// https://syzkaller.appspot.com/bug?id=74ab2079df15699ca121
// status:6
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    syscall(__NR_ioctl, -1, 0x40305829ul, 0ul);
    break;
  case 1:
    syscall(__NR_ioctl, -1, 0x4004743cul, 0ul);
    break;
  case 2:
    ...
    NONFAILING(*(uint64_t*)0x20000110 = 0x3c46);
    ...
    break;
  case 3:
    syz_open_dev(0, 0 + procid * 1, 0);
    break;
  case 4:
    syscall(__NR_bpf, 9ul, 0ul, 0ul);
    break;
  case 5:
    NONFAILING(memcpy((void*)0x20000440, "/dev/infiniband/rdma_cm\000", 24));
  ...
  case 6:
    ...
    NONFAILING(*(uint16_t*)0x20000344 = 0x18);
    NONFAILING(*(uint16_t*)0x20000346 = 0xfa00);
    NONFAILING(*(uint64_t*)0x20000348 = 0);
    NONFAILING(*(uint64_t*)0x20000350 = 0x20000380);
    NONFAILING(*(uint16_t*)0x20000358 = 0x13f);
    ...
    if (res != -1)
      NONFAILING(r[1] = *(uint32_t*)0x20000380);
    break;
  case 7:
    NONFAILING(*(uint32_t*)0x200003c0 = 3);
    NONFAILING(*(uint16_t*)0x200003c4 = 0x40);
    NONFAILING(*(uint16_t*)0x200003c6 = 0xfa00);
    NONFAILING(*(uint16_t*)0x200003c8 = 0xa);
    NONFAILING(*(uint16_t*)0x200003ca = htobe16(0x4e21));
    NONFAILING(*(uint32_t*)0x200003cc = htobe32(0));
    ...
    NONFAILING(*(uint8_t*)0x200003da = -1);
    NONFAILING(*(uint8_t*)0x200003db = -1);
    NONFAILING(*(uint32_t*)0x200003dc = htobe32(0));
    NONFAILING(*(uint32_t*)0x200003e0 = 0);
    NONFAILING(*(uint16_t*)0x200003e4 = 0xa);
    NONFAILING(*(uint16_t*)0x200003e6 = htobe16(0));
    NONFAILING(*(uint32_t*)0x200003e8 = htobe32(0));
    NONFAILING(memcpy(
        (void*)0x200003ec,
        "\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000",
        16));
    NONFAILING(*(uint32_t*)0x200003fc = 0);
    NONFAILING(*(uint32_t*)0x20000400 = r[1]);
