...
// https://syzkaller.appspot.com/bug?id=6fcd3e62f67b669a80f9
// status:0
...
void execute_one(void)
{
  ...
  *(uint16_t*)0x20000324 = 0xb;
  *(uint16_t*)0x20000326 = 1;
  memcpy((void*)0x20000328, "ipvlan\000", 7);
