...
// https://syzkaller.appspot.com/bug?id=d6219cf21f26bdfcc22e
// status:0
...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(syz_open_dev(0xc, 4, 1));
    break;
  case 1:
    ...
    NONFAILING(*(uint64_t*)0x2001d010 = 0x3ff);
    ...
    NONFAILING(*(uint32_t*)0x2001d030 = 0xfffffffe);
    ...
    break;
  case 2:
    syscall(__NR_socketpair, 1ul, 2ul, 0, 0x20000380ul);
    break;
  case 3:
    syscall(__NR_mmap, 0x20ffc000ul, 0x3000ul, 0ul, 0x11ul, r[0], 0ul);
    break;
  case 4:
    res = syscall(__NR_clock_gettime, 0ul, 0x20000180ul);
    if (res != -1)
      NONFAILING(r[1] = *(uint64_t*)0x20000188);
    break;
  case 5:
    ...
    NONFAILING(*(uint64_t*)0x20000140 = 0x1ff);
    ...
    NONFAILING(*(uint64_t*)0x200001c8 = r[1] + 30000000);
    syscall(__NR_pselect6, 0x40ul, 0x200000c0ul, 0ul, 0x20000140ul,
            0x200001c0ul, 0ul);
    break;
  }
}
