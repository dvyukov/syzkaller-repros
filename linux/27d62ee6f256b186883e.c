...
// https://syzkaller.appspot.com/bug?id=27d62ee6f256b186883e
// status:6
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x200002d8 = -1;
  ...
  res = -1;
  res = syz_io_uring_setup(0x187, 0x200002c0, 0x206d5000, 0x20ffc000,
                           0x20000280, 0x20000100);
  if (res != -1) {
    r[0] = res;
    r[1] = *(uint64_t*)0x20000280;
  ...
  *(uint64_t*)0x20000008 = 0xfffffffffffffffd;
  syscall(__NR_setrlimit, 0ul, 0x20000000ul);
