...
// https://syzkaller.appspot.com/bug?id=20b90969babe05609947
// status:0
...
void execute_call(int call)
{
  ...
  case 2:
    ...
    NONFAILING(*(uint32_t*)0x20000280 = 0x38);
    NONFAILING(*(uint16_t*)0x20000284 = 0x1403);
    NONFAILING(*(uint16_t*)0x20000286 = 1);
    NONFAILING(*(uint32_t*)0x20000288 = 0);
    NONFAILING(*(uint32_t*)0x2000028c = 0);
    NONFAILING(*(uint16_t*)0x20000290 = 9);
    NONFAILING(*(uint16_t*)0x20000292 = 2);
    NONFAILING(memcpy((void*)0x20000294, "syz0\000", 5));
    NONFAILING(*(uint16_t*)0x2000029c = 8);
    NONFAILING(*(uint16_t*)0x2000029e = 0x41);
    NONFAILING(memcpy((void*)0x200002a0, "rxe\000", 4));
    NONFAILING(*(uint16_t*)0x200002a4 = 0x14);
    NONFAILING(*(uint16_t*)0x200002a6 = 0x33);
    NONFAILING(
        memcpy((void*)0x200002a8, "virt_wifi0\000\000\000\000\000\000", 16));
