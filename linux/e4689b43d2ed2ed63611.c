...
// https://syzkaller.appspot.com/bug?id=e4689b43d2ed2ed63611
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_listen, -1, 9);
    break;
  case 2:
    syscall(__NR_ioctl, -1, 0x89e2, 0ul);
    break;
  case 3:
    ...
    NONFAILING(memcpy(
        (void*)0x20000012,
        "\x75\xa8\x00\x00\x00\x00\x00\x00\x00\x00\x19\x16\x08\x00\x00\x8f\x74"
        "\xfa\x00\x04\x00\x00\x00\x00\x00\x00\x47\x97\x60\x8d\xd0\xe7\x31\x6d"
        "\x1d\x4f\x4d\xba\xa0\xa6\x7b\xe4\x71\x4b\x7c\xce\xfa\x8a\x00\x00\x00"
    ...
    break;
  case 4:
    NONFAILING(*(uint32_t*)0x20001300 = 0x2880008);
    ...
    syscall(__NR_ioctl, -1, 0xc028660f, 0x20001300ul);
    break;
  case 5:
    syscall(__NR_getsockopt, -1, 0x118, 4, 0ul, 0ul);
    break;
  case 6:
    NONFAILING(*(uint32_t*)0x200004c0 = 0);
    NONFAILING(*(uint16_t*)0x200004c4 = 2);
    NONFAILING(*(uint16_t*)0x200004c6 = htobe16(0));
    NONFAILING(*(uint32_t*)0x200004c8 = htobe32(0));
    NONFAILING(*(uint32_t*)0x20000544 = 0);
    NONFAILING(*(uint16_t*)0x20000548 = 0);
    NONFAILING(*(uint32_t*)0x2000054a = 0);
    NONFAILING(*(uint32_t*)0x2000054e = 0);
    NONFAILING(*(uint32_t*)0x20000552 = 0xb4);
    NONFAILING(*(uint32_t*)0x20000556 = 0);
    NONFAILING(*(uint8_t*)0x2000055a = 0);
    syscall(__NR_setsockopt, -1, 0x84, 9, 0x200004c0ul, 0x9cul);
    break;
  }
}
int main(void)
