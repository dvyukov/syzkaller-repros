...
// https://syzkaller.appspot.com/bug?id=19e6dd9943972fa1c58a
// status:0
...
void execute_one(void)
{
  ...
  NONFAILING(*(uint8_t*)0x200000c8 = 0x72);
  NONFAILING(*(uint8_t*)0x200000c9 = 1);
  ...
  NONFAILING(STORE_BY_BITMASK(uint64_t, , 0x200000e8, 3, 5, 1));
  ...
  syscall(__NR_mmap, 0x20000000ul, 0xb36000ul, 2ul, 0x28011ul, -1, 0ul);
}
int main(void)
{
