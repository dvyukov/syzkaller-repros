...
// https://syzkaller.appspot.com/bug?id=fcf8ca5817d6e92c6567
// status:6
...
void execute_call(int call)
{
  ...
  case 1:
    ...
    break;
  case 2:
    NONFAILING(*(uint16_t*)0x20000480 = 2);
    NONFAILING(*(uint16_t*)0x20000482 = htobe16(0x4e24));
    NONFAILING(*(uint8_t*)0x20000484 = 0xac);
    NONFAILING(*(uint8_t*)0x20000485 = 0x14);
    NONFAILING(*(uint8_t*)0x20000486 = 0x14);
    NONFAILING(*(uint8_t*)0x20000487 = 0xaa);
    syscall(__NR_connect, r[0], 0x20000480ul, 0x10ul);
    break;
  case 3:
    NONFAILING(memcpy((void*)0x20000100, "\xf6", 1));
    syscall(__NR_sendto, r[0], 0x20000100ul, 0xffffffe7ul, 0xc000ul, 0ul, 0ul);
    break;
  case 4:
    ...
    break;
  case 5:
    NONFAILING(*(uint64_t*)0x20000600 = 0x200000c0);
    NONFAILING(memcpy((void*)0x200000c0, "\000", 1));
    NONFAILING(*(uint64_t*)0x20000608 = 1);
    syscall(__NR_writev, r[1], 0x20000600ul, 1ul);
    break;
  case 6:
    syscall(__NR_mmap, 0x20000000ul, 0x4000ul, 1ul, 0x10012ul, r[1], 0ul);
    break;
  case 7:
    NONFAILING(*(uint16_t*)0x200002c0 = 0x18);
    NONFAILING(*(uint32_t*)0x200002c2 = 1);
    NONFAILING(*(uint32_t*)0x200002c6 = 0);
    NONFAILING(*(uint32_t*)0x200002ca = -1);
    NONFAILING(*(uint32_t*)0x200002ce = 0);
    NONFAILING(*(uint32_t*)0x200002d2 = 0);
    NONFAILING(*(uint32_t*)0x200002d6 = 0);
    NONFAILING(*(uint32_t*)0x200002da = 0);
    NONFAILING(*(uint16_t*)0x200002de = 0xa);
    NONFAILING(*(uint16_t*)0x200002e0 = htobe16(0));
    NONFAILING(*(uint32_t*)0x200002e2 = htobe32(0));
    NONFAILING(*(uint8_t*)0x200002e6 = -1);
    NONFAILING(*(uint8_t*)0x200002e7 = 1);
    ...
    NONFAILING(*(uint8_t*)0x200002f5 = 1);
    NONFAILING(*(uint32_t*)0x200002f6 = 0);
    syscall(__NR_connect, r[0], 0x200002c0ul, 0x80ul);
    break;
  }
}
int main(void)
