...
// https://syzkaller.appspot.com/bug?id=96ff6cfc4551fcc29342
// status:0
...
void execute_call(int call)
{
  ...
  case 0:
    ...
    NONFAILING(*(uint32_t*)0x20000588 = 7);
    ...
    syscall(__NR_io_uring_setup, 0xf1, 0x20000580ul);
    break;
  case 1:
    NONFAILING(*(uint64_t*)0x20000000 = 0xb);
    NONFAILING(*(uint64_t*)0x20000008 = 0x8d);
    syscall(__NR_prlimit64, 0, 0xeul, 0x20000000ul, 0ul);
    break;
  case 2:
