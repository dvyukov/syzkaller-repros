...
void execute_call(int call)
{
  ...
  case 1:
    ...
    *(uint8_t*)0x20000047 = 0;
    ...
    break;
  case 2:
    syscall(__NR_listen, r[0], 0x81);
    break;
  case 3:
    syscall(__NR_ioctl, -1, 0x4030ae7b, 0);
    break;
  case 4:
    ...
    *(uint64_t*)0x2001d020 = 0;
    STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0x9aa, 0, 1);
    ...
    STORE_BY_BITMASK(uint64_t, , 0x2001d028, 0x80, 9, 1);
    ...
    *(uint16_t*)0x2001d06e = 0;
    syscall(__NR_perf_event_open, 0x2001d000, 0, 0xfffffbffffffffff, -1, 0);
    break;
  case 5:
